...
cluster_1   = listing "Lexicon's properties"
 ...
 |> "' .g d" <| [
    ...
    HICAL                     `noun`    {- IiygAd -}           [ unwords [ "EGAD", "(", "Economic", "Growth", "and", "Agricultural", "Development", ")" ] ],

    FICAL                     `noun`    {- IiygAd -}           [ unwords [ "EGAD", "(", "Economic", "Growth", "and", "Agricultural", "Development", ")" ] ] ]
 ...
 |> "' .g r" <| [
    ...
    FaCUL |< aT               `noun`    {- Oaguwrap -}         [ unwords [ "agura", "(", "Israeli", "cent", ")" ], unwords [ "agurot", "(", "Israeli", "cents", ")" ] ]
                           {- `others`  [ "'a.guwruwt N0" ] -},
 ...
 |> "' .g r q" <| [
    ...
    KiRDIS |< Iy              `adj`     {- Iigoriyqiy~ -}      [ "Greek" ]
                              `plural`     KiRDIS
                              `plural`     KiRDIS |< Iy |< Un
                              `plural`     KaRADiS |< aT ]
 ...
 |> "' .h d" <| [
    ...
    FaCCaL                    `verb`    {- OaH~ad -}           [ "unite", "unify" ],

    FaCaL                     `noun`    {- OaHad -}            [ "one", "someone" ]
                              `plural`     FiCLY
                              `plural`     HACAL,

    FaCaL                     `noun`    {- OaHad -}            [ "Sunday" ]
                              `plural`     HACAL,

    FuCAL |<< "a"             `adv`     {- OuHAda -}           [ unwords [ "one", "-", "by", "-", "one" ] ],
...
cluster_3   = listing "Lexicon's properties"
 ...
 |> "' .s l" <| [
    ...
    FaCuL                     `verb`    {- OaSul-u -}          [ unwords [ "be", "rooted" ], unwords [ "be", "established" ] ]
                              `imperf`     FCuL,

    FaCCaL                    `verb`    {- OaS~al -}           [ "root", "anchor" ],

    TaFaCCaL                  `verb`    {- taOaS~al -}         [ unwords [ "take", "root" ], unwords [ "be", "indigenized" ] ],

    IstaFCaL                  `verb`    {- AisotaOoSal -}      [ "uproot", "extirpate" ],

    FaCL                      `noun`    {- OaSol -}            [ "origin", "root", "principles" ]
                              `plural`     FuCUL,
    ...
    FaCaL |< aT               `noun`    {- OaSalap -}          [ "boa", "python" ]
                              `plural`     FaCaL,
    ...
    HACAL                     `noun`    {- \|SAl -}            [ unwords [ "late", "afternoons" ] ],
    ...
    TaFaCCuL                  `noun`    {- taOaS~ul -}         [ unwords [ "deep", "-", "rootedness" ] ]
                              `plural`     TaFaCCuL |< At,
    ...
    MutaFaCCiL                `noun`    {- mutaOaS~il -}       [ unwords [ "deep", "-", "rooted" ] ]
                              `plural`     MutaFaCCiL |< Un,

    MutaFaCCiL |< aT          `noun`    {- DERIVED -}          [ unwords [ "deep", "-", "rooted" ] ]
                              `plural`     MutaFaCCiL |< At,

    MutaFACiL                 `noun`    {- muta|Sil -}         [ unwords [ "of", "common", "origin" ] ]
                              `plural`     MutaFACiL |< Un,

    MutaFACiL |< aT           `noun`    {- DERIVED -}          [ unwords [ "of", "common", "origin" ] ]
                              `plural`     MutaFACiL |< At ]
...
cluster_4   = listing "Lexicon's properties"
 ...
 |> "' .s q l" <| [
    ...
    KiRDAS |< aT              `noun`    {- IiSoqAlap -}        [ "scaffold", "ladder" ]
                              `plural`     KaRADIS ]

 |> "' .s r" <| [

    FiCL                      `noun`    {- IiSor -}            [ "covenant", "pact" ]
                              `plural`     HACAL,

    FiCL                      `noun`    {- IiSor -}            [ "burden" ]
                              `plural`     HACAL,

    HACiL |< aT               `noun`    {- \|Sirap -}          [ "attachment", "bond" ]
                              `plural`     FawACiL,

    FACiL |< aT               `noun`    {- \|Sirap -}          [ "attachment", "bond" ]
                              `plural`     FawACiL,
 ...
 |> "' .t m" <| [
    ...
    FuCuL                     `noun`    {- OuTum -}            [ "blockhouse", "pillbox" ]
                              `plural`     HACAL,
...
cluster_5   = listing "Lexicon's properties"
 ...
 |> "' .t r" <| [
    ...
    FaCCaL                    `verb`    {- OaT~ar -}           [ "frame", "contextualize" ],

    FiCAL                     `noun`    {- IiTAr -}            [ "framework", "context" ]
                              `plural`     FuCuL
                              `plural`     FiCAL |< At,

    FiCAL |< Iy               `adj`     {- IiTAriy~ -}         [ "contextual", unwords [ "frame", "-", "like" ] ],

    MuFaCCaL                  `noun`    {- muWaT~ar -}         [ "framed", unwords [ "in", "context" ] ]
                              `plural`     MuFaCCaL |< Un,

    MuFaCCaL |< aT            `noun`    {- DERIVED -}          [ "framed", unwords [ "in", "context" ] ]
                              `plural`     MuFaCCaL |< At ]

 |> "' ^g .s" <| [

    FiCCAL |< aT              `noun`    {- Iij~ASap -}         [ "pear" ]
                              `plural`     FiCCAL ]
 ...
 |> "' ^g ^g" <| [
    ...
    FaCCaL                    `verb`    {- Oaj~aj -}           [ "kindle", "light", unwords [ "be", "lit" ] ],

    TaFaCCaL                  `verb`    {- taOaj~aj -}         [ unwords [ "blaze", "up" ], unwords [ "be", "kindled" ] ],

    FaCIL                     `noun`    {- Oajiyj -}           [ "burning", "blazing" ],

    FaCAL                     `noun`    {- OajAj -}            [ unwords [ "salted", "fish" ] ],
    ...
    MutaFaCCiL |< aT          `noun`    {- DERIVED -}          [ "burning", "blazing" ]
                              `plural`     MutaFaCCiL |< At ]
...
cluster_6   = listing "Lexicon's properties"
 ...
 |> "' ^g l" <| [
    ...
    FaCCaL                    `verb`    {- Oaj~al -}           [ "postpone", "delay" ],

    TaFaCCaL                  `verb`    {- taOaj~al -}         [ unwords [ "be", "postponed" ], unwords [ "be", "adjourned" ] ],

    IstaFCaL                  `verb`    {- AisotaOojal -}      [ unwords [ "request", "postponement" ], unwords [ "seek", "a", "reprieve" ] ],

    FaCL                      `noun`    {- Oajol -}            [ unwords [ "for", "sake", "of" ], unwords [ "because", "of" ] ],

    FaCaL                     `noun`    {- Oajal -}            [ "period", "term" ]
                              `plural`     HACAL,
    ...
    FACiL |< aT               `noun`    {- DERIVED -}          [ "future", "deferred" ]
                              `plural`     FACiL |< At,
    ...
    HACiL |< aT               `noun`    {- DERIVED -}          [ "future", "deferred" ]
                              `plural`     HACiL |< At,
    ...
    MuFaCCaL |< aT            `noun`    {- DERIVED -}          [ "postponed", "delayed" ]
                              `plural`     MuFaCCaL |< At ]

 |> "' ^g m" <| [

    FaCaL |< aT               `noun`    {- Oajamap -}          [ "thicket", "bush" ]
                              `plural`     HACAL
                              `plural`     FuCuL
                              `plural`     FaCaL,
 ...
 |> "' ^g n" <| [
    ...
    FACiL |< aT               `noun`    {- DERIVED -}          [ "putrid", "brackish" ]
                              `plural`     FACiL |< At,
    ...
    HACiL |< aT               `noun`    {- DERIVED -}          [ "putrid", "brackish" ]
                              `plural`     HACiL |< At,
...
cluster_7   = listing "Lexicon's properties"
 ...
 |> "' ^g r" <| [
    ...
    FaCCaL                    `verb`    {- Oaj~ar -}           [ "lease", "lend", unwords [ "be", "lent" ] ],

    HACaL                     `verb`    {- \|jar -}            [ "lend", unwords [ "hire", "out" ] ],

    FACaL                     `verb`    {- \|jar -}            [ "lend", unwords [ "hire", "out" ] ],

    TaFaCCaL                  `verb`    {- taOaj~ar -}         [ unwords [ "hire", "out" ] ],

    IstaFCaL                  `verb`    {- AisotaOojar -}      [ "hire", "rent" ],

    FaCL                      `noun`    {- Oajor -}            [ "remuneration", "recompense" ],

    FaCL                      `noun`    {- Oajor -}            [ "wage", "fee" ]
                              `plural`     FuCUL,

    FaCL |< Iy                `adj`     {- Oajoriy~ -}         [ "salaried", "remunerated" ],

    FuCL |< aT                `noun`    {- Oujorap -}          [ "fee", "charge" ]
                              `plural`     FuCaL,

    FaCIL                     `noun`    {- Oajiyr -}           [ "laborer", "employee" ]
                              `plural`     FaCIL |< Un
                              `plural`     FuCaLA',

    FaCIL |< aT               `noun`    {- DERIVED -}          [ "laborer", "employee" ]
                              `plural`     FaCIL |< At,
    ...
    MaFCUL |< aT              `noun`    {- DERIVED -}          [ "salaried" ]
                              `plural`     MaFCUL |< At,

    MaFCUL                    `noun`    {- maOojuwr -}         [ "bribed", "mercenary" ]
                              `plural`     MaFCUL |< Un,

    MaFCUL |< aT              `noun`    {- DERIVED -}          [ "bribed", "mercenary" ]
                              `plural`     MaFCUL |< At,
    ...
    MuFaCCiL |< aT            `noun`    {- DERIVED -}          [ "lessor", "landlord" ]
                              `plural`     MuFaCCiL |< At,

    MustaFCiL                 `noun`    {- musotaOojir -}      [ "leaseholder", "lessee" ]
                              `plural`     MustaFCiL |< Un,

    MustaFCiL |< aT           `noun`    {- DERIVED -}          [ "leaseholder", "lessee" ]
                              `plural`     MustaFCiL |< At,

    MustaFCaL                 `noun`    {- musotaOojar -}      [ "rented", "salaried" ]
                              `plural`     MustaFCaL |< Un,

    MustaFCaL |< aT           `noun`    {- DERIVED -}          [ "rented", "salaried" ]
                              `plural`     MustaFCaL |< At ]
...
cluster_8   = listing "Lexicon's properties"
 ...
 |> "' ^s b" <| [
    ...
    FaCiL                     `verb`    {- Oa$ib-a -}          [ unwords [ "make", "an", "alloy" ] ]
                              `imperf`     FCaL,

    FaCCaL                    `verb`    {- Oa$~ab -}           [ "alloy" ],

    TaFaCCaL                  `verb`    {- taOa$~ab -}         [ unwords [ "be", "mixed" ], unwords [ "be", "heterogeneous" ] ],

    FaCaL                     `noun`    {- Oa$ab -}            [ "alloy" ],

    FuCAL |< aT               `noun`    {- Ou$Abap -}          [ "alloy", "mixture" ]
                              `plural`     FaCA'iL ]

 |> "' ^s b l" <| [

    KiRDIS |< Iy              `adj`     {- Ii$obiyliy~ -}      [ unwords [ "from", "/", "of", "Seville" ] ],
...
cluster_9   = listing "Lexicon's properties"
 ...
 |> "' ^s r" <| [
    ...
    FaCaL                     `verb`    {- Oa$ar-u -}          [ unwords [ "cut", "with", "a", "saw" ] ]
                              `imperf`     FCuL,

    FaCaL                     `verb`    {- Oa$ar-i -}          [ "sharpen", "file" ]
                              `imperf`     FCiL,

    FaCCaL                    `verb`    {- Oa$~ar -}           [ "indicate", "register" ],
 ...
 |> "' _d '" <| [
    ...
    FICAL                     `noun`    {- Iiy*A' -}           [ "damage", "injury" ]
                              `plural`     FICAL |< At
                              `plural`     HICAL |< At,

    HICAL                     `noun`    {- Iiy*A' -}           [ "damage", "injury" ]
                              `plural`     FICAL |< At
                              `plural`     HICAL |< At ]
...
cluster_10  = listing "Lexicon's properties"
 ...
 |> "' _d n" <| [
    ...
    TaFaCCaL                  `verb`    {- taOa*~an -}         [ unwords [ "be", "informed" ], "learn" ],

    IstaFCaL                  `verb`    {- AisotaOo*an -}      [ unwords [ "request", "authorization" ] ],

    FaCAL                     `noun`    {- Oa*An -}            [ unwords [ "call", "to", "prayer" ] ],

    FuCuL                     `noun`    {- Ou*un -}            [ "ear" ]
                              `plural`     HACAL,
    ...
    FuCayL |< aT              `noun`    {- Ou*ayonap -}        [ unwords [ "ear", "lobe" ] ],
    ...
    FACiL                     `noun`    {- \|*in -}            [ unwords [ "door", "-", "keeper" ], "porter" ]
                              `plural`     HACiL |< Un
                              `plural`     FACiL |< Un,

    FACiL |< aT               `noun`    {- DERIVED -}          [ unwords [ "door", "-", "keeper" ], "porter" ]
                              `plural`     FACiL |< At,

    HACiL                     `noun`    {- \|*in -}            [ unwords [ "door", "-", "keeper" ], "porter" ]
                              `plural`     HACiL |< Un
                              `plural`     FACiL |< Un,

    HACiL |< aT               `noun`    {- DERIVED -}          [ unwords [ "door", "-", "keeper" ], "porter" ]
                              `plural`     HACiL |< At,

    MaFCUL                    `noun`    {- maOo*uwn -}         [ "authorized", "licensed" ]
                              `plural`     MaFCUL |< Un,

    MaFCUL |< aT              `noun`    {- DERIVED -}          [ "authorized", "licensed" ]
                              `plural`     MaFCUL |< At,

    MaFCUL |< Iy |< aT        `noun`    {- maOo*uwniy~ap -}    [ "leave", "furlough" ],

    MiFCaL |< aT              `noun`    {- mi}o*anap -}        [ "minaret" ]
                              `plural`     MaFACiL
                              `plural`     MaFCaL,

    MuFaCCiL                  `noun`    {- muWa*~in -}         [ "muezzin", unwords [ "caller", "to", "prayer" ] ]
                              `plural`     MuFaCCiL |< Un,

    MuFaCCiL |< aT            `noun`    {- DERIVED -}          [ "muezzin", unwords [ "caller", "to", "prayer" ] ]
                              `plural`     MuFaCCiL |< At,
...
cluster_11  = listing "Lexicon's properties"
 ...
 |> "' _d y" <| [
    ...
    FaCI                      `verb`    {- Oa*iy-a -}          [ unwords [ "suffer", "damage" ] ]
                              `imperf`     FCY,

    FACY                      `verb`    {- \|*aY -}            [ "injure", "prejudice" ],

    HACY                      `verb`    {- \|*aY -}            [ "injure", "prejudice" ],

    TaFaCCY                   `verb`    {- taOa*~aY -}         [ unwords [ "be", "injured" ], unwords [ "be", "offended" ] ],
...
cluster_12  = listing "Lexicon's properties"
 ...
 |> "' _h _d" <| [
    ...
    FaCCaL                    `verb`    {- Wax~a* -}           [ "enchant", "bewitch" ],
    ...
    UFtuCiL                   `verb`    {- Aut~uxi* -}         [ unwords [ "be", "taken" ], unwords [ "be", "adopted" ] ],
    ...
    FACiL |< aT               `noun`    {- DERIVED -}          [ "taking", "captivating", "engrossing" ]
                              `plural`     FACiL |< At,
    ...
    HACiL |< aT               `noun`    {- DERIVED -}          [ "taking", "captivating", "engrossing" ]
                              `plural`     HACiL |< At,

    FaCCAL                    `noun`    {- Oax~A* -}           [ "fascinating", "captivating" ]
                              `plural`     FaCCAL |< Un,

    FaCCAL |< aT              `noun`    {- DERIVED -}          [ "fascinating", "captivating" ]
                              `plural`     FaCCAL |< At,

    FaCIL                     `noun`    {- Oaxiy* -}           [ "prisoner", "captive" ]
                              `plural`     FaCIL |< Un
                              `plural`     FaCLY,

    FaCIL |< aT               `noun`    {- DERIVED -}          [ "prisoner", "captive" ]
                              `plural`     FaCIL |< At,
    ...
    MaFCUL |< aT              `noun`    {- DERIVED -}          [ "taken", "seized" ]
                              `plural`     MaFCUL |< At,

    MaFCUL |< At              `noun`    {- maOoxuw*At -}       [ "receipts", "returns" ]
                              `plural`     MaFCUL |< At,

    MaFCaL                    `noun`    {- maOoxa* -}          [ "source", "method", "procedure", "references" ]
                              `plural`     MaFACiL,
    ...
    MuFACaL |< aT             `noun`    {- DERIVED -}          [ "responsible", "accountable" ]
                              `plural`     MuFACaL |< At,
...
cluster_13  = listing "Lexicon's properties"
 ...
 |> "' _h _h" <| [
    ...
    FaL                       `pron`    {- Oax -}              [ "brother", unwords [ "brother", "+", "my" ] ]
                              `plural`     FaCI
                              `plural`     FaCU
                              `plural`     FaCA
                           {- `others`  [ "'a_haw NAn_Nayn" ] -},
...
cluster_14  = listing "Lexicon's properties"
 ...
 |> "' _h r" <| [
    ...
    FaCCaL                    `verb`    {- Wax~ar -}           [ "delay", "postpone" ],
    ...
    FACiL |< aT               `noun`    {- DERIVED -}          [ "last", "end" ]
                              `plural`     FACiL |< At,
    ...
    MuFaCCaL |< aT            `noun`    {- DERIVED -}          [ "delayed", "deferred" ]
                              `plural`     MuFaCCaL |< At,

    MuFaCCaL                  `noun`    {- muWax~ar -}         [ "rear", "back" ]
                              `plural`     MuFaCCaL |< Un,

    MuFaCCaL |< aT            `noun`    {- DERIVED -}          [ "rear", "back" ]
                              `plural`     MuFaCCaL |< At,

    MuFaCCaL |< aN            `adv`     {- muWax~arAF -}       [ "recently", "finally" ]
                              `plural`     MuFaCCaL,

    MuFaCCaL |< aT            `noun`    {- muWax~arap -}       [ "rear", unwords [ "rear", "positions" ] ],
    ...
    MutaFaCCiL |< aT          `noun`    {- DERIVED -}          [ "late", "delayed" ]
                              `plural`     MutaFaCCiL |< At,
...
cluster_15  = listing "Lexicon's properties"
 ...
 |> "' _h w" <| [
    ...
    FaC                       `pron`    {- Oax -}              [ "brother", unwords [ "brother", "+", "my" ] ]
                              `plural`     FaCI
                              `plural`     FaCU
                              `plural`     FaCaL
                              `plural`     FaCA,

    HACY                      `verb`    {- \|xaY -}            [ "fraternize", unwords [ "be", "fraternized", "with" ] ],

    FACY                      `verb`    {- \|xaY -}            [ "fraternize", unwords [ "be", "fraternized", "with" ] ],

    TaFaCCY                   `verb`    {- taOax~aY -}         [ unwords [ "be", "fraternal" ] ],
...
cluster_16  = listing "Lexicon's properties"
 ...
 |> "' _t _t" <| [
    ...
    FaCL                      `verb`    {- Oav~-uia -}         [ unwords [ "be", "luxuriant" ], unwords [ "grow", "profusely" ] ]
                              `imperf`     FiCL
                              `imperf`     FuCL
                              `pfirst`     FaCaL,
    ...
    FaCCaL                    `verb`    {- Oav~av -}           [ "furnish" ],

    TaFaCCaL                  `verb`    {- taOav~av -}         [ unwords [ "be", "furnished" ], unwords [ "be", "wealthy" ] ],

    FaCIL                     `noun`    {- Oaviyv -}           [ "abundant" ]
                              `plural`     FaCIL |< Un,

    FaCIL |< aT               `noun`    {- DERIVED -}          [ "abundant" ]
                              `plural`     FaCIL |< At,
    ...
    MuFaCCaL |< aT            `noun`    {- DERIVED -}          [ "furnished" ]
                              `plural`     MuFaCCaL |< At,
 ...
 |> "' _t f" <| [
    ...
    FuCL |< Iy |< aT          `noun`    {- Ouvofiy~ap -}       [ "trivet", "tripod" ]
                              `plural`     FaCALI ]
...
cluster_17  = listing "Lexicon's properties"
 ...
 |> "' _t l" <| [
    ...
    FaCCaL                    `verb`    {- Oav~al -}           [ "consolidate", unwords [ "become", "rich" ] ],

    TaFaCCaL                  `verb`    {- taOav~al -}         [ unwords [ "be", "consolidated" ], unwords [ "become", "rich" ] ],

    FaCL                      `noun`    {- Oavol -}            [ "tamarisk" ]
                              `plural`     FuCUL,

    FaCL |< aT                `noun`    {- Oavolap -}          [ "tamarisk" ]
                              `plural`     FaCaL |< At,

    FaCIL                     `noun`    {- Oaviyl -}           [ unwords [ "deep", "-", "rooted" ], "highborn" ]
                              `plural`     FaCIL |< Un,

    FaCIL |< aT               `noun`    {- DERIVED -}          [ unwords [ "deep", "-", "rooted" ], "highborn" ]
                              `plural`     FaCIL |< At,
    ...
    MuFaCCaL |< aT            `noun`    {- DERIVED -}          [ unwords [ "deep", "-", "rooted" ], "highborn" ]
                              `plural`     MuFaCCaL |< At ]
...
cluster_18  = listing "Lexicon's properties"
 ...
 |> "' _t m" <| [
    ...
    FaCiL                     `verb`    {- Oavim-a -}          [ unwords [ "do", "wrong" ], unwords [ "commit", "a", "sin" ] ]
                              `imperf`     FCaL,

    FaCCaL                    `verb`    {- Oav~am -}           [ "transgress", unwords [ "accuse", "of", "sin" ], unwords [ "be", "accused", "of", "sin" ] ],

    TaFaCCaL                  `verb`    {- taOav~am -}         [ "restrain", unwords [ "shun", "evil" ] ],

    FiCL                      `noun`    {- Iivom -}            [ "offense", "misdeed", "sins" ]
                              `plural`     HACAL,

    FaCaL                     `noun`    {- Oavam -}            [ "sin", "error" ],

    MaFCaL                    `noun`    {- maOovam -}          [ "offense", "sin" ]
                              `plural`     MaFACiL,
    ...
    HACiL |< aT               `noun`    {- DERIVED -}          [ "sinful", "evil" ]
                              `plural`     HACiL |< At,
    ...
    FACiL |< aT               `noun`    {- DERIVED -}          [ "sinful", "evil" ]
                              `plural`     FACiL |< At,
...
cluster_19  = listing "Lexicon's properties"
 ...
 |> "' _t r" <| [
    ...
    FiCL |<< "a"              `prep`    {- Iivora -}           [ unwords [ "right", "after" ] ],

    FaCaL                     `verb`    {- Oavar-iu -}         [ "report", "transmit" ]
                              `imperf`     FCiL
                              `imperf`     FCuL,

    FaCCaL                    `verb`    {- Oav~ar -}           [ "affect", "influence" ],

    FACaL                     `verb`    {- \|var -}            [ "prefer" ],

    TaFaCCaL                  `verb`    {- taOav~ar -}         [ unwords [ "be", "influenced" ], unwords [ "be", "affected" ] ],
    ...
    FaCiL |< aT               `noun`    {- DERIVED -}          [ "egoistic" ]
                              `plural`     FaCiL |< At,

    FaCIL                     `noun`    {- Oaviyr -}           [ "favored", "favorite" ]
                              `plural`     FaCIL |< Un,

    FaCIL |< aT               `noun`    {- DERIVED -}          [ "favored", "favorite" ]
                              `plural`     FaCIL |< At,
    ...
    MaFCaL |< aT              `noun`    {- maOovarap -}        [ "feat", "exploit" ]
                              `plural`     MaFACiL
                           {- `others`  [ "ma'_tur Napdu" ] -},

    MaFCUL                    `noun`    {- maOovuwr -}         [ "transmitted", "memorable" ]
                              `plural`     MaFCUL |< Un,

    MaFCUL |< aT              `noun`    {- DERIVED -}          [ "transmitted", "memorable" ]
                              `plural`     MaFCUL |< At,
    ...
    MutaFaCCiL                `adv`     {- mutaOav~ir -}       [ unwords [ "because", "of" ], unwords [ "due", "to" ], unwords [ "as", "a", "result", "of" ] ]
                              `plural`     MutaFaCCiL |< Un,

    MutaFaCCiL |< aT          `adv`     {- DERIVED -}          [ unwords [ "because", "of" ], unwords [ "due", "to" ], unwords [ "as", "a", "result", "of" ] ]
                              `plural`     MutaFaCCiL |< At,
...
cluster_21  = listing "Lexicon's properties"
 ...
 |> "' b b" <| [
    ...
    FaL                       `pron`    {- Oab -}              [ "father", unwords [ "father", "+", "my" ] ]
                              `plural`     FaCI
                              `plural`     FaCU
                              `plural`     FaCA,
...
cluster_22  = listing "Lexicon's properties"
 ...
 |> "' b d" <| [
    ...
    FaCaL                     `verb`    {- Oabad-ui -}         [ unwords [ "be", "untamed" ], "escape" ]
                              `imperf`     FCuL
                              `imperf`     FCiL,

    FuCUL                     `noun`    {- Oubuwd -}           [ "persisting", "remaining", "staying" ],

    FaCCaL                    `verb`    {- Oab~ad -}           [ "perpetuate", "immortalize" ],

    TaFaCCaL                  `verb`    {- taOab~ad -}         [ unwords [ "self", "-", "perpetuate" ], unwords [ "self", "-", "immortalize" ] ],

    FaCaL                     `noun`    {- Oabad -}            [ "eternity", unwords [ "all", "time" ], "forever" ],

    HACAL                     `noun`    {- \|bAd -}            [ "eternity", "forever" ],

    FaCaL |< aN               `adv`     {- OabadAF -}          [ "never", unwords [ "not", "at", "all" ] ]
                              `plural`     FaCaL,
    ...
    FACiL                     `noun`    {- \|bid -}            [ unwords [ "non", "-", "migratory" ], "sedentary" ],

    FACiL |< aT               `noun`    {- \|bidap -}          [ "archaism", "sedentary" ]
                              `plural`     FawACiL,

    TaFCIL                    `noun`    {- taOobiyd -}         [ "perpetuation", "immortalization" ]
                              `plural`     TaFCIL |< At,

    MuFaCCaL                  `noun`    {- muWab~ad -}         [ unwords [ "life", "-", "long" ], "perpetual" ],
...
cluster_23  = listing "Lexicon's properties"
 ...
 |> "' b h" <| [
    ...
    FaCaL                     `verb`    {- Oabah-a -}          [ unwords [ "be", "interested" ], unwords [ "be", "sensitive" ] ]
                              `imperf`     FCaL,

    FaCiL                     `verb`    {- Oabih-a -}          [ unwords [ "be", "interested" ], unwords [ "be", "sensitive" ] ]
                              `imperf`     FCaL,

    TaFaCCaL                  `verb`    {- taOab~ah -}         [ unwords [ "be", "haughty" ], unwords [ "be", "aloof" ] ],
    ...
    FACiL |< aT               `noun`    {- DERIVED -}          [ "concerned" ]
                              `plural`     FACiL |< At,

    FuCCaL |< aT              `noun`    {- Oub~ahap -}         [ "pomp", "splendor" ],

    FaCIL                     `noun`    {- Oabiyh -}           [ "Abbe" ] ]

 |> "' b k" <| [

    FaCIL                     `noun`    {- Oabiyk -}           [ unwords [ "APEC", "(", "Asia", "-", "Pacific", "Economic", "Cooperation", ")" ] ],
 ...
 |> "' b l z" <| [
    ...
    KiRDIS                    `noun`    {- Iiboliyz -}         [ unwords [ "alluvial", "deposits" ] ] ]
...
cluster_24  = listing "Lexicon's properties"
 ...
 |> "' b q" <| [
    ...
    FACiL                     `noun`    {- \|biq -}            [ "fugitive" ]
                              `plural`     FuCCAL
                              `plural`     HACiL |< Un
                              `plural`     FACiL |< Un,

    FACiL |< aT               `noun`    {- DERIVED -}          [ "fugitive" ]
                              `plural`     FACiL |< At ]
 ...
 |> "' b r" <| [
    ...
    FaCCaL                    `verb`    {- Oab~ar -}           [ unwords [ "practice", "acupuncture" ], "pollinate", unwords [ "be", "acupunctured" ] ],

    FiCL |< aT                `noun`    {- Iiborap -}          [ "indicator", "needle" ]
                              `plural`     FiCaL,

    FiCL |< aT                `noun`    {- Iiborap -}          [ "needle", "injection" ]
                              `plural`     FiCaL,

    FiCaL |< Iy               `adj`     {- Iibariy~ -}         [ unwords [ "needle", "-", "like" ] ],

    MiFCaL                    `noun`    {- mi}obar -}          [ "needlecase", "anther" ]
                              `plural`     MaFACiL,
    ...
    MuFaCCiL |< aT            `noun`    {- DERIVED -}          [ "acupuncturist" ]
                              `plural`     MuFaCCiL |< At ]
 ...
 |> "' b r q" <| [
    ...
    KiRDIS                    `noun`    {- Iiboriyq -}         [ "pitcher", "jug" ]
                              `plural`     KaRADIS
                              `plural`     KaRADiS |< aT
                           {- `others`  [ "bariyq Ndu" ] -} ]
 ...
 |> "' b r z" <| [
    ...
    KiRDIS                    `noun`    {- Iiboriyz -}         [ unwords [ "pure", "gold" ] ],
...
cluster_25  = listing "Lexicon's properties"
 ...
 |> "' b w" <| [
    ...
    FaC                       `pron`    {- Oab -}              [ "father", unwords [ "father", "+", "my" ] ]
                              `plural`     FaCI
                              `plural`     FaCU
                              `plural`     FaCA,
 ...
 |> "' b z m" <| [
    ...
    KiRDIS                    `noun`    {- Iiboziym -}         [ "buckle", "clasp" ]
                              `plural`     KaRADIS ]

 |> "' b z n" <| [

    KaRDaS                    `noun`    {- Oabozan -}          [ "washbowl" ]
                              `plural`     KaRADiS ]
...
cluster_27  = listing "Lexicon's properties"
 ...
 |> "' d b" <| [
    ...
    FaCuL                     `verb`    {- Oadub-u -}          [ unwords [ "be", "urbane" ], unwords [ "be", "courteous" ] ]
                              `imperf`     FCuL,

    FaCaL                     `verb`    {- Oadab-i -}          [ "invite", "entertain" ]
                              `imperf`     FCiL,

    FaCCaL                    `verb`    {- Oad~ab -}           [ "discipline", "educate" ],

    FACaL                     `verb`    {- \|dab -}            [ "invite" ],

    TaFaCCaL                  `verb`    {- taOad~ab -}         [ unwords [ "be", "disciplined" ], unwords [ "be", "educated" ] ],

    FaCL                      `noun`    {- Oadob -}            [ "invitation", "entertainment" ],

    FaCaL                     `noun`    {- Oadab -}            [ "literature", unwords [ "good", "manners" ], "etiquette" ]
                              `plural`     HACAL,
    ...
    FaCIL                     `noun`    {- Oadiyb -}           [ "writer", "author" ]
                              `plural`     FaCIL |< Un
                              `plural`     FuCaLA',

    FaCIL |< aT               `noun`    {- DERIVED -}          [ "writer", "author" ]
                              `plural`     FaCIL |< At,
    ...
    MuFaCCiL |< aT            `noun`    {- DERIVED -}          [ "educator" ]
                              `plural`     MuFaCCiL |< At,

    MuFaCCaL                  `noun`    {- muWad~ab -}         [ unwords [ "well", "-", "bred" ], "urbane" ]
                              `plural`     MuFaCCaL |< Un,

    MuFaCCaL |< aT            `noun`    {- DERIVED -}          [ unwords [ "well", "-", "bred" ], "urbane" ]
                              `plural`     MuFaCCaL |< At,
    ...
    MutaFaCCiL |< aT          `noun`    {- DERIVED -}          [ "courteous" ]
                              `plural`     MutaFaCCiL |< At,
...
cluster_28  = listing "Lexicon's properties"
 ...
 |> "' d r s" <| [
    ...
    KiRDIS |< Iy              `adj`     {- Iidoriysiy~ -}      [ "Idrisid" ]
                              `plural`     KiRDIS |< Iy |< Un
                              `plural`     KaRADiS |< aT ]
...
cluster_29  = listing "Lexicon's properties"
 ...
 |> "' d y" <| [
    ...
    FaCCY                     `verb`    {- Oad~aY -}           [ "direct", "guide", "lead", unwords [ "be", "lead" ] ],

    TaFaCCY                   `verb`    {- taOad~aY -}         [ "contribute", "arrive" ],

    IstaFCY                   `verb`    {- AisotaOodaY -}      [ "demand", "claim" ],

    FaCA'                     `noun`    {- OadA' -}            [ "performance", "fulfillment" ],

    FaCA' |< Iy               `adj`     {- OadA}iy~ -}         [ "functional", unwords [ "performance", "-", "related" ] ],
    ...
    MuFaCCY                   `noun`    {- muWad~aY -}         [ "task", "content", "significance" ]
                              `plural`     MuFaCCY |< At ]
...
cluster_30  = listing "Lexicon's properties"
 ...
 |> "' f f" <| [
    ...
    MutaFaCCiL |< aT          `noun`    {- DERIVED -}          [ "grumpy", "grouch", "complaining", "grumbling" ]
                              `plural`     MutaFaCCiL |< At ]
 ...
 |> "' f k" <| [
    ...
    FaCIL |< aT               `noun`    {- Oafiykap -}         [ "lie", "untruth" ]
                              `plural`     FaCA'iL,
 ...
 |> "' f l" <| [
    ...
    FaCaL                     `verb`    {- Oafal-ui -}         [ "disappear", unwords [ "fade", "away" ] ]
                              `imperf`     FCiL
                              `imperf`     FCuL,

    FuCUL                     `noun`    {- Oufuwl -}           [ "disappearance", "decline", unwords [ "fading", "away" ] ],

    HACiL                     `noun`    {- \|fil -}            [ "passing", "fading", "transitory" ]
                              `plural`     HACiL |< Un
                              `plural`     FACiL |< Un,

    HACiL |< aT               `noun`    {- DERIVED -}          [ "passing", "fading", "transitory" ]
                              `plural`     HACiL |< At,
    ...
    FACiL |< aT               `noun`    {- DERIVED -}          [ "passing", "fading", "transitory" ]
                              `plural`     FACiL |< At ]
...
cluster_31  = listing "Lexicon's properties"
 ...
 |> "' f n" <| [
    ...
    FaCiL                     `verb`    {- Oafin-a -}          [ unwords [ "be", "foolish" ] ]
                              `imperf`     FCaL,
    ...
    FaCIL |< aT               `noun`    {- DERIVED -}          [ "stupid", "dull" ]
                              `plural`     FaCIL |< At,

    MaFCUL                    `noun`    {- maOofuwn -}         [ "stupid", "dull" ]
                              `plural`     MaFCUL |< Un,

    MaFCUL |< aT              `noun`    {- DERIVED -}          [ "stupid", "dull" ]
                              `plural`     MaFCUL |< At,
 ...
 |> "' f q" <| [
    ...
    FuCuL                     `noun`    {- Oufuq -}            [ "horizon", "provinces" ]
                              `plural`     HACAL,
    ...
    FaCCAL                    `noun`    {- Oaf~Aq -}           [ "vagabond", unwords [ "globe", "-", "trotter" ] ]
                              `plural`     FaCCAL |< Un,

    FaCCAL |< aT              `noun`    {- DERIVED -}          [ "vagabond", unwords [ "globe", "-", "trotter" ] ]
                              `plural`     FaCCAL |< At,

    MiFCAL                    `noun`    {- mi}ofAq -}          [ "periscope" ]
                              `plural`     MaFACiL,
 ...
 |> "' f r q" <| [
    ...
    TaKaRDaS                  `verb`    {- taOaforaq -}        [ unwords [ "become", "Africanized" ] ],

    KaRDaS |< aT              `noun`    {- Oaforaqap -}        [ "Africanization" ],

    KaRDIS |< Iy              `adj`     {- Oaforiyqiy~ -}      [ "African" ]
                              `plural`     KaRDIS |< Iy |< Un
                              `plural`     KaRADiS |< aT,
    ...
    MutaKaRDiS |< aT          `noun`    {- DERIVED -}          [ "Africanized" ]
                              `plural`     MutaKaRDiS |< At ]

 |> "' f r z" <| [

    KiRDIS                    `noun`    {- Iiforiyz -}         [ "curb", "sidewalk", "edge" ]
                              `plural`     KaRADIS ]
...
cluster_32  = listing "Lexicon's properties"
 ...
 |> "' h b" <| [
    ...
    FaCCaL                    `verb`    {- Oah~ab -}           [ "equip", unwords [ "put", "on", "alert" ], unwords [ "be", "put", "on", "alert" ] ],

    TaFaCCaL                  `verb`    {- taOah~ab -}         [ unwords [ "be", "ready" ], unwords [ "be", "on", "alert" ] ],

    TaFaCCaL                  `verb`    {- taOah~ab -}         [ unwords [ "be", "equipped" ] ],
    ...
    MutaFaCCiL                `noun`    {- mutaOah~ib -}       [ "prepared", unwords [ "on", "alert" ] ]
                              `plural`     MutaFaCCiL |< Un,

    MutaFaCCiL |< aT          `noun`    {- DERIVED -}          [ "prepared", unwords [ "on", "alert" ] ]
                              `plural`     MutaFaCCiL |< At,
...
cluster_33  = listing "Lexicon's properties"
 ...
 |> "' h l" <| [
    ...
    FaCaL                     `verb`    {- Oahal-ui -}         [ unwords [ "get", "married" ] ]
                              `imperf`     FCiL
                              `imperf`     FCuL,

    FaCiL                     `verb`    {- Oahil-a -}          [ unwords [ "be", "familiar" ] ]
                              `imperf`     FCaL,

    FuCiL                     `verb`    {- Ouhil-a -}          [ unwords [ "be", "populated" ] ],

    FaCCaL                    `verb`    {- Oah~al -}           [ "train", "certify", "qualify", "capacitate" ],

    TaFaCCaL                  `verb`    {- taOah~al -}         [ unwords [ "be", "qualified" ], "merit" ],

    IstaFCaL                  `verb`    {- AisotaOohal -}      [ "merit", unwords [ "consider", "worthy" ] ],

    FaCL                      `noun`    {- Oahol -}            [ "family", "people", "folk", unwords [ "indigenous", "people" ] ]
                              `plural`     FaCALI
                           {- `others`  [ "'ahluwn N" ] -},
    ...
    FaCL |< aT                `noun`    {- DERIVED -}          [ "qualified" ]
                              `plural`     FaCL |< At,

    FaCL |< aN                `adv`     {- OaholAF -}          [ unwords [ "welcome", "!" ] ]
                              `plural`     FaCL,
    ...
    HACiL |< aT               `noun`    {- DERIVED -}          [ "populated" ]
                              `plural`     HACiL |< At,
    ...
    FACiL |< aT               `noun`    {- DERIVED -}          [ "populated" ]
                              `plural`     FACiL |< At,

    MaFCUL                    `noun`    {- maOohuwl -}         [ "populated", "manned" ]
                              `plural`     MaFCUL |< Un,

    MaFCUL |< aT              `noun`    {- DERIVED -}          [ "populated", "manned" ]
                              `plural`     MaFCUL |< At,
    ...
    MutaFaCCiL |< aT          `noun`    {- DERIVED -}          [ "qualified", "married" ]
                              `plural`     MutaFaCCiL |< At,

    MustaFCiL                 `noun`    {- musotaOohil -}      [ "worthy", "entitled", "qualified" ]
                              `plural`     MustaFCiL |< Un,

    MustaFCiL |< aT           `noun`    {- DERIVED -}          [ "worthy", "entitled", "qualified" ]
                              `plural`     MustaFCiL |< At ]
...
cluster_34  = listing "Lexicon's properties"
 ...
 |> "' k d" <| [
    ...
    FaCCaL                    `verb`    {- Oak~ad -}           [ "affirm", "assure", "confirm", "guarantee" ],
    ...
    MuFaCCiL |< aT            `noun`    {- DERIVED -}          [ "assuring", "confirming", "affirming", "guaranteeing" ]
                              `plural`     MuFaCCiL |< At,
    ...
    MutaFaCCiL |< aT          `noun`    {- DERIVED -}          [ "certain", "sure" ]
                              `plural`     MutaFaCCiL |< At ]
...
cluster_35  = listing "Lexicon's properties"
 ...
 |> "' k l" <| [
    ...
    FaCCaL                    `verb`    {- Oak~al -}           [ "feed", unwords [ "be", "fed" ] ],

    FACaL                     `verb`    {- \|kal -}            [ "feed" ],

    TaFaCCaL                  `verb`    {- taOak~al -}         [ unwords [ "be", "corroded" ], unwords [ "be", "eaten" ] ],

    TaFACaL                   `verb`    {- ta|kal -}           [ unwords [ "be", "corroded" ], unwords [ "be", "eaten" ] ],
    ...
    FaCL |< aT                `noun`    {- Oakolap -}          [ "meal", "food", "dish" ]
                              `plural`     FaCaL |< At,
    ...
    FACiL |< aT               `noun`    {- DERIVED -}          [ "eater", "eating" ]
                              `plural`     FACiL |< At,

    FACiL |< aT               `noun`    {- \|kilap -}          [ "gangrenous" ],

    MuFACiL                   `noun`    {- muWAkil -}          [ unwords [ "dinning", "companion" ] ]
                              `plural`     MuFACiL |< Un,

    MuFACiL |< aT             `noun`    {- DERIVED -}          [ unwords [ "dinning", "companion" ] ]
                              `plural`     MuFACiL |< At,
    ...
    FaCIL |< aT               `noun`    {- DERIVED -}          [ "voracious", "glutton" ]
                              `plural`     FaCIL |< At,
...
cluster_36  = listing "Lexicon's properties"
 ...
 |> "' k m" <| [
    ...
    FaCaL |< aT               `noun`    {- Oakamap -}          [ "hill", "reef", "heap" ]
                              `plural`     FuCuL
                              `plural`     FaCaL
                              `plural`     HACAL
                              `plural`     FiCAL,
 ...
 |> "' k r" <| [
    ...
    FaCCAL |< aT              `noun`    {- DERIVED -}          [ "farmer", "plowman" ]
                              `plural`     FaCCAL |< At,
    ...
    MuFACiL |< aT             `noun`    {- DERIVED -}          [ "farmer", "sharecropper" ]
                              `plural`     MuFACiL |< At,

    FuCL |< aT                `noun`    {- Oukorap -}          [ unwords [ "ball", "bearing" ] ]
                              `plural`     FuCaL ]
 ...
 |> "' k s ^g" <| [
    ...
    TaKaRDaS                  `verb`    {- taOakosaj -}        [ unwords [ "be", "oxygenated" ] ],
...
cluster_37  = listing "Lexicon's properties"
 ...
 |> "' k s d" <| [
    ...
    TaKaRDaS                  `verb`    {- taOakosad -}        [ unwords [ "be", "oxidized" ], unwords [ "be", "rusty" ] ],

    KaRDaS |< aT              `noun`    {- Oakosadap -}        [ "oxidation" ],

    KuRDIS                    `noun`    {- Oukosiyd -}         [ "oxide" ]
                              `plural`     KaRADIS,

    MuKaRDiS                  `noun`    {- muWakosid -}        [ "oxidant", unwords [ "oxidizing", "agent" ] ]
                              `plural`     MuKaRDiS |< Un,

    MuKaRDiS |< aT            `noun`    {- DERIVED -}          [ "oxidant", unwords [ "oxidizing", "agent" ] ]
                              `plural`     MuKaRDiS |< At,

    MuKaRDaS                  `noun`    {- muWakosad -}        [ "oxidized" ]
                              `plural`     MuKaRDaS |< Un,

    MuKaRDaS |< aT            `noun`    {- DERIVED -}          [ "oxidized" ]
                              `plural`     MuKaRDaS |< At,
...
cluster_38  = listing "Lexicon's properties"
 ...
 |> "' l b" <| [
    ...
    FaCCaL                    `verb`    {- Oal~ab -}           [ "rally", "assemble", "gather" ],
    ...
    TaFaCCuL                  `noun`    {- taOal~ub -}         [ "gathering", "rally", "assembly" ]
                              `plural`     TaFaCCuL |< At,

    MuFaCCiL                  `noun`    {- muWal~ib -}         [ unwords [ "rally", "leader" ] ]
                              `plural`     MuFaCCiL |< Un,

    MuFaCCiL |< aT            `noun`    {- DERIVED -}          [ unwords [ "rally", "leader" ] ]
                              `plural`     MuFaCCiL |< At,
...
cluster_39  = listing "Lexicon's properties"
 ...
 |> "' l f" <| [
    ...
    FaCiL                     `verb`    {- Oalif-a -}          [ unwords [ "be", "familiar", "with" ], unwords [ "be", "/", "become", "tame" ] ]
                              `imperf`     FCaL,

    FaCCaL                    `verb`    {- Oal~af -}           [ "compose", "constitute" ],

    FACaL                     `verb`    {- \|laf -}            [ "befriend", unwords [ "adapt", "to" ] ],

    HACaL                     `verb`    {- \|laf -}            [ "befriend", unwords [ "adapt", "to" ] ],

    FACaL                     `verb`    {- \|laf -}            [ "adapt", "familiarize" ],

    HACaL                     `verb`    {- \|laf -}            [ "adapt", "familiarize" ],

    TaFaCCaL                  `verb`    {- taOal~af -}         [ unwords [ "consist", "of" ] ],

    TaFACaL                   `verb`    {- ta|laf -}           [ unwords [ "live", "in", "harmony" ], unwords [ "have", "mutual", "contact" ] ],

    IFtaCaL                   `verb`    {- Ai}otalaf -}        [ unwords [ "be", "accustomed" ], unwords [ "be", "harmonious" ] ],

    IFtaCaL                   `verb`    {- Ai}otalaf -}        [ unwords [ "form", "a", "coalition" ] ],

    IstaFCaL                  `verb`    {- AisotaOolaf -}      [ unwords [ "attempt", "to", "befriend" ] ],

    FaCiL                     `noun`    {- Oalif -}            [ "beginning" ],

    FaCiL                     `noun`    {- Oalif -}            [ unwords [ "alif", "(", "Arabic", "letter", ")" ] ]
                              `plural`     FaCiL |< At,

    FaCL                      `noun`    {- Oalof -}            [ "thousand" ]
                              `plural`     FuCUL
                              `plural`     HACAL,

    FaCL |< Iy                `adj`     {- Oalofiy~ -}         [ "millenary", unwords [ "one", "thousandth" ] ],

    FuCL |< aT                `noun`    {- Oulofap -}          [ "familiarity", "friendship", "harmony" ],

    FaCIL                     `noun`    {- Oaliyf -}           [ "companion", "familiar", "domesticated" ]
                              `plural`     FaCA'iL,

    FiCL                      `noun`    {- Iilof -}            [ "companion", "confidant" ]
                              `plural`     FuCCAL,

    FACiL                     `noun`    {- \|lif -}            [ "companion", "confidant" ]
                              `plural`     FawACiL
                              `plural`     HACiL |< Un
                              `plural`     FACiL |< Un,

    FACiL |< aT               `noun`    {- DERIVED -}          [ "companion", "confidant" ]
                              `plural`     FACiL |< At,

    HACiL                     `noun`    {- \|lif -}            [ "companion", "confidant" ]
                              `plural`     FawACiL
                              `plural`     HACiL |< Un
                              `plural`     FACiL |< Un,

    HACiL |< aT               `noun`    {- DERIVED -}          [ "companion", "confidant" ]
                              `plural`     HACiL |< At,

    FACaL                     `noun`    {- \|laf -}            [ "friendlier", "friendliest", unwords [ "more", "/", "most", "accustomed" ] ],

    HACaL                     `noun`    {- \|laf -}            [ "friendlier", "friendliest", unwords [ "more", "/", "most", "accustomed" ] ],

    MaFCUL                    `noun`    {- maOoluwf -}         [ "familiar", "usual", "customary" ]
                              `plural`     MaFCUL |< Un,

    MaFCUL |< aT              `noun`    {- DERIVED -}          [ "familiar", "usual", "customary" ]
                              `plural`     MaFCUL |< At,
    ...
    MuFaCCiL |< aT            `noun`    {- DERIVED -}          [ "author", "composer" ]
                              `plural`     MuFaCCiL |< At,

    MuFaCCaL                  `noun`    {- muWal~af -}         [ "composition", "publication", "composed", "synthesized" ]
                              `plural`     MuFaCCaL |< At,

    MuFACaL |< aT             `noun`    {- muWAlafap -}        [ "adaptation", unwords [ "association", "with" ] ],
    ...
    MutaFACiL                 `noun`    {- muta|lif -}         [ "harmonious", unwords [ "in", "accord", "with" ] ]
                              `plural`     MutaFACiL |< Un,

    MutaFACiL |< aT           `noun`    {- DERIVED -}          [ "harmonious", unwords [ "in", "accord", "with" ] ]
                              `plural`     MutaFACiL |< At,
...
cluster_41  = listing "Lexicon's properties"
 ...
 |> "' l m" <| [
    ...
    FaCiL                     `verb`    {- Oalim-a -}          [ unwords [ "feel", "pain" ], "suffer" ]
                              `imperf`     FCaL,

    FaCCaL                    `verb`    {- Oal~am -}           [ "afflict", "distress" ],

    HACaL                     `verb`    {- \|lam -}            [ "afflict", "distress" ],

    FACaL                     `verb`    {- \|lam -}            [ "afflict", "distress" ],

    TaFaCCaL                  `verb`    {- taOal~am -}         [ unwords [ "be", "distressed" ], "suffer" ],
    ...
    FaCIL |< aT               `noun`    {- DERIVED -}          [ "painful", "cruel" ]
                              `plural`     FaCIL |< At,

    HACaL                     `noun`    {- \|lam -}            [ unwords [ "more", "/", "most", "painful" ] ],

    FACaL                     `noun`    {- \|lam -}            [ unwords [ "more", "/", "most", "painful" ] ],
    ...
    MuFCiL |< aT              `noun`    {- DERIVED -}          [ "painful", "distressing" ]
                              `plural`     MuFCiL |< At,

    MutaFaCCiL                `noun`    {- mutaOal~im -}       [ "afflicted", "suffering" ]
                              `plural`     MutaFaCCiL |< Un,

    MutaFaCCiL |< aT          `noun`    {- DERIVED -}          [ "afflicted", "suffering" ]
                              `plural`     MutaFaCCiL |< At,
...
cluster_42  = listing "Lexicon's properties"
 ...
 |> "' l m n" <| [
    ...
    KaRDaS                    `verb`    {- Oaloman -}          [ "Germanize", unwords [ "make", "German" ] ],

    TaKaRDaS                  `verb`    {- taOaloman -}        [ unwords [ "become", "German" ], unwords [ "be", "Germanized" ] ],
 ...
 |> "' l m s" <| [
    ...
    MuKaRDiS |< aT            `noun`    {- DERIVED -}          [ "diamond" ]
                              `plural`     MuKaRDiS |< At ]
 ...
 |> "' l q" <| [
    ...
    MutaFaCCiL |< aT          `noun`    {- DERIVED -}          [ "brilliant", "resplendent" ]
                              `plural`     MutaFaCCiL |< At ]

 |> "' l s" <| [

    FaCCaL                    `verb`    {- Oal~as -}           [ "belittle", "disparage" ],
    ...
    MuFaCCiL |< aT            `noun`    {- DERIVED -}          [ "belittling", "disparaging" ]
                              `plural`     MuFaCCiL |< At ]
...
cluster_43  = listing "Lexicon's properties"
 ...
 |> "' l w" <| [
    ...
    FaCA                      `verb`    {- OalA-u -}           [ "neglect", unwords [ "desist", "from" ], unwords [ "be", "desisted", "from" ] ]
                              `imperf`     FCU,

    HACY                      `verb`    {- \|laY -}            [ "promise", unwords [ "take", "an", "oath" ], unwords [ "be", "taken", "(", "oath", ")" ] ],

    FACY                      `verb`    {- \|laY -}            [ "promise", unwords [ "take", "an", "oath" ], unwords [ "be", "taken", "(", "oath", ")" ] ],

    HICA'                     `noun`    {- IiylA' -}           [ "oath" ]
                              `plural`     HICA' |< At,

    FaCL |< aT                `noun`    {- Oalowap -}          [ "aloe" ]
                              `plural`     FaCaL |< At,
 ...
 |> "' l y" <| [
    ...
    TaFaCCY                   `verb`    {- taOal~aY -}         [ unwords [ "be", "automated" ], unwords [ "be", "mechanized" ] ],

    TaFaCCI                   `noun`    {- taOal~iy -}         [ "automation", "mechanization" ]
                              `plural`     TaFaCCI |< At,

    FaCL |< aT                `noun`    {- Oaloyap -}          [ "buttock", "backside" ]
                              `plural`     FaCALY
                              `plural`     FaCY |< At,
...
cluster_44  = listing "Lexicon's properties"
 ...
 |> "' m d" <| [
    ...
    FaCaL                     `noun`    {- Oamad -}            [ "term", "period", "extent", "range", "duration" ]
                              `plural`     HACAL ]
 ...
 |> "' m l" <| [
    ...
    FaCaL                     `verb`    {- Oamal-a -}          [ unwords [ "hope", "for" ], unwords [ "wish", "for" ] ]
                              `imperf`     FCaL,

    FaCCaL                    `verb`    {- Oam~al -}           [ unwords [ "hope", "for" ], "expect", unwords [ "be", "hoped", "for" ] ],

    TaFaCCaL                  `verb`    {- taOam~al -}         [ "consider", "ponder", "contemplate" ],

    FaCaL                     `noun`    {- Oamal -}            [ "hope", "wish" ]
                              `plural`     HACAL,
    ...
    MaFCUL                    `noun`    {- maOomuwl -}         [ "expected", unwords [ "hoped", "for" ] ]
                              `plural`     MaFCUL |< Un,

    MaFCUL |< aT              `noun`    {- DERIVED -}          [ "expected", unwords [ "hoped", "for" ] ]
                              `plural`     MaFCUL |< At,

    MuFaCCiL                  `noun`    {- muWam~il -}         [ "hopeful" ]
                              `plural`     MuFaCCiL |< Un,

    MuFaCCiL |< aT            `noun`    {- DERIVED -}          [ "hopeful" ]
                              `plural`     MuFaCCiL |< At,

    MuFaCCaL                  `noun`    {- muWam~al -}         [ "expected", unwords [ "hoped", "for" ] ]
                              `plural`     MuFaCCaL |< Un,

    MuFaCCaL |< aT            `noun`    {- DERIVED -}          [ "expected", unwords [ "hoped", "for" ] ]
                              `plural`     MuFaCCaL |< At,
    ...
    MutaFaCCiL |< aT          `noun`    {- DERIVED -}          [ "contemplative", "speculative" ]
                              `plural`     MutaFaCCiL |< At ]
...
cluster_45  = listing "Lexicon's properties"
 ...
 |> "' m m" <| [
    ...
    FaCCaL                    `verb`    {- Oam~am -}           [ "nationalize" ],

    TaFaCCaL                  `verb`    {- taOam~am -}         [ unwords [ "go", "to", "see" ] ],

    IFtaCL                    `verb`    {- Ai}otam~ -}         [ "emulate", "follow" ],

    FuCL                      `noun`    {- Oum~ -}             [ "mother", "maternal" ],
    ...
    FaCAL |<< "a"             `prep`    {- OamAma -}           [ unwords [ "in", "front", "of" ], "facing" ]
                              `plural`     FaCAL
                           {- `others`  [ "'amAmi FW-Wa FW-Wa-i" ] -},
    ...
    FaL |< aT                 `noun`    {- Oamap -}            [ "bondmaid", unwords [ "slave", "girl" ] ]
                              `plural`     FiCA',
...
cluster_46  = listing "Lexicon's properties"
 ...
 |> "' m n" <| [
    ...
    FaCuL                     `verb`    {- Oamun-u -}          [ unwords [ "be", "loyal" ], unwords [ "be", "reliable" ] ]
                              `imperf`     FCuL,

    FaCiL                     `verb`    {- Oamin-a -}          [ unwords [ "be", "safe" ], unwords [ "be", "secure" ] ]
                              `imperf`     FCaL,
    ...
    IstaFCaL                  `verb`    {- AisotaOoman -}      [ unwords [ "have", "confidence" ], unwords [ "be", "confident" ] ],
    ...
    FaCIL                     `noun`    {- Oamiyn -}           [ "secretary", "trustees" ]
                              `plural`     FuCaLA',
    ...
    FACiL |< aT               `noun`    {- DERIVED -}          [ "secure", "safe" ]
                              `plural`     FACiL |< At,
    ...
    HACiL |< aT               `noun`    {- DERIVED -}          [ "secure", "safe" ]
                              `plural`     HACiL |< At,
    ...
    MaFCUL |< aT              `noun`    {- DERIVED -}          [ "trustworthy", "loyal" ]
                              `plural`     MaFCUL |< At,

    MaFCaL                    `noun`    {- maOoman -}          [ "shelter", "refuge" ]
                              `plural`     MaFACiL,
    ...
    MuFaCCiL |< aT            `noun`    {- DERIVED -}          [ "guarantor", "insurer" ]
                              `plural`     MuFaCCiL |< At,

    MuFaCCaL                  `noun`    {- muWam~an -}         [ "guaranteed", "insured" ]
                              `plural`     MuFaCCaL |< Un,

    MuFaCCaL |< aT            `noun`    {- DERIVED -}          [ "guaranteed", "insured" ]
                              `plural`     MuFaCCaL |< At,
    ...
    MuFCiL |< aT              `noun`    {- DERIVED -}          [ "believer" ]
                              `plural`     MuFCiL |< At,

    MuFCiL                    `noun`    {- muWomin -}          [ unwords [ "believer", "(", "Muslim", ")" ] ]
                              `plural`     MuFCiL |< Un,

    MuFCiL |< aT              `noun`    {- DERIVED -}          [ unwords [ "believer", "(", "Muslim", ")" ] ]
                              `plural`     MuFCiL |< At,

    MustaFCiL                 `noun`    {- musotaOomin -}      [ "protege" ]
                              `plural`     MustaFCiL |< Un,

    MustaFCiL |< aT           `noun`    {- DERIVED -}          [ "protege" ]
                              `plural`     MustaFCiL |< At,

    MuFtaCaL                  `noun`    {- muWotaman -}        [ "trustworthy", "entrusted" ]
                              `plural`     MuFtaCaL |< Un,

    MuFtaCaL |< aT            `noun`    {- DERIVED -}          [ "trustworthy", "entrusted" ]
                              `plural`     MuFtaCaL |< At,
...
cluster_48  = listing "Lexicon's properties"
 ...
 |> "' m r" <| [
    ...
    FaCCaL                    `verb`    {- Oam~ar -}           [ "empower", "authorize" ],

    FACaL                     `verb`    {- \|mar -}            [ "consult" ],

    TaFaCCaL                  `verb`    {- taOam~ar -}         [ unwords [ "come", "to", "power" ] ],

    TaFACaL                   `verb`    {- ta|mar -}           [ unwords [ "co", "-", "conspire" ], unwords [ "deliberate", "together" ] ],

    IFtaCaL                   `verb`    {- Ai}otamar -}        [ "deliberate", "conspire" ],

    FaCL                      `noun`    {- Oamor -}            [ "matter", "issue" ]
                              `plural`     FuCUL,

    FaCL                      `noun`    {- Oamor -}            [ "order", "command" ]
                              `plural`     FawACiL,

    FiCL |< aT                `noun`    {- Iimorap -}          [ "authority", "command" ],

    FiCAL |< aT               `noun`    {- IimArap -}          [ "Emirate" ]
                              `plural`     FiCAL |< At,

    FiCAL |< At |< Iy         `adj`     {- IimArAtiy~ -}       [ unwords [ "Emirati", "(", "of", "/", "from", "the", "UAE", ")" ] ],

    FaCAL |< aT               `noun`    {- OamArap -}          [ "sign", "indication" ],

    FaCIL                     `noun`    {- Oamiyr -}           [ "Emir" ]
                              `plural`     FuCaLA',

    FaCIL                     `noun`    {- Oamiyr -}           [ "prince" ]
                              `plural`     FuCaLA',
    ...
    FACiL |< aT               `noun`    {- DERIVED -}          [ "commander", "commandant" ]
                              `plural`     FACiL |< At,

    FaCCAL                    `noun`    {- Oam~Ar -}           [ "instigator", "inciting" ]
                              `plural`     FaCCAL |< Un,

    FaCCAL |< aT              `noun`    {- DERIVED -}          [ "instigator", "inciting" ]
                              `plural`     FaCCAL |< At,

    MaFCUL                    `noun`    {- maOomuwr -}         [ "officer", "subordinate" ]
                              `plural`     MaFACIL
                              `plural`     MaFCUL |< Un,

    MaFCUL |< aT              `noun`    {- DERIVED -}          [ "officer", "subordinate" ]
                              `plural`     MaFCUL |< At,

    MuFaCCaL                  `noun`    {- muWam~ar -}         [ "empowered" ]
                              `plural`     MuFaCCaL |< Un,

    MuFaCCaL |< aT            `noun`    {- DERIVED -}          [ "empowered" ]
                              `plural`     MuFaCCaL |< At,
    ...
    MutaFACiL                 `noun`    {- muta|mir -}         [ "conspirator", unwords [ "co", "-", "conspirator" ] ]
                              `plural`     MutaFACiL |< Un,

    MutaFACiL |< aT           `noun`    {- DERIVED -}          [ "conspirator", unwords [ "co", "-", "conspirator" ] ]
                              `plural`     MutaFACiL |< At,
    ...
    MuFtaCiL                  `noun`    {- muWotamir -}        [ unwords [ "conference", "participants" ], "conferees" ]
                              `plural`     MuFtaCiL |< Un,
...
cluster_49  = listing "Lexicon's properties"
 ...
 |> "' m r k" <| [
    ...
    TaKaRDaS                  `verb`    {- taOamorak -}        [ unwords [ "become", "Americanized" ] ],
    ...
    KaRDIS |< Iy              `adj`     {- Oamoriykiy~ -}      [ "American" ]
                           {- `others`  [ "'amiyrkAn N", "'amriykAn N" ] -} ]
 ...
 |> "' m w" <| [
    ...
    FaC |< aT                 `noun`    {- Oamap -}            [ "bondmaid", unwords [ "slave", "girl" ] ]
                              `plural`     FaCaL |< At
                              `plural`     FiCA',
...
cluster_50  = listing "Lexicon's properties"
 ...
 |> "' n '" <| [
    ...
    lA >| FaCA                `noun`    {- lAOanA -}           [ unwords [ "non", "-", "ego" ] ],

    FaCY                      `verb`    {- OanaY-i -}          [ "mature", "approach" ]
                              `imperf`     FCI,

    TaFaCCY                   `verb`    {- taOan~aY -}         [ unwords [ "act", "slowly" ], unwords [ "be", "cautious" ] ],
    ...
    FiCAL                     `noun`    {- IinA' -}            [ "vessel", "container", "receptacle" ]
                              `plural`     FawACI
                              `plural`     HACI |< aT
                              `plural`     FACI |< aT,
    ...
    FaCCY                     `conj`    {- Oan~aY -}           [ unwords [ "where", "?" ], unwords [ "how", "?" ], "however" ] ]

 |> "' n .g l" <| [

    KaRDUS |< Iy              `adj`     {- Oanoguwliy~ -}      [ "Angolan", "Angolim", "Engoulime", unwords [ "Ingoulimes", "?", "?" ] ] ]
...
cluster_51  = listing "Lexicon's properties"
 ...
 |> "' n ^g l" <| [
    ...
    TaKaRDaS                  `verb`    {- taOanojal -}        [ unwords [ "be", "Anglicized" ] ],

    KaRDaS |< aT              `noun`    {- Oanojalap -}        [ "Anglicization" ],

    KiRDIS                    `noun`    {- Iinojiyl -}         [ "gospel" ]
                              `plural`     KaRADIS,
 ...
 |> "' n _t" <| [
    ...
    FaCuL                     `verb`    {- Oanuv-u -}          [ unwords [ "be", "feminine" ], unwords [ "be", "effeminate" ] ]
                              `imperf`     FCuL,

    FaCCaL                    `verb`    {- Oan~av -}           [ "feminize", unwords [ "make", "feminine" ], unwords [ "be", "made", "feminine" ] ],

    TaFaCCaL                  `verb`    {- taOan~av -}         [ unwords [ "be", "feminine" ], unwords [ "be", "effeminate" ] ],

    FuCLY                     `noun`    {- OunovaY -}          [ "female", "feminine" ]
                              `plural`     FuCLY |< At,
    ...
    MuFaCCaL |< aT            `noun`    {- DERIVED -}          [ "feminine", "effeminate" ]
                              `plural`     MuFaCCaL |< At ]

 |> "' n _t y" <| [

    KuRDY                     `noun`    {- OunovaY -}          [ "female", "feminine" ]
                              `plural`     KuRDY |< At,
...
cluster_52  = listing "Lexicon's properties"
 ...
 |> "' n b" <| [
    ...
    FaCCaL                    `verb`    {- Oan~ab -}           [ "censure", "reprimand" ],
 ...
 |> "' n b ^s" <| [
    ...
    KuRDAS |< Iy |< aT        `noun`    {- DERIVED -}          [ "corporal" ]
                              `plural`     KuRDAS |< Iy |< At ]

 |> "' n b q" <| [

    KiRDIS                    `noun`    {- Iinobiyq -}         [ "alembic", "retort" ]
                              `plural`     KaRADIS ]

 |> "' n b r" <| [

    KaRDAS                    `noun`    {- OanobAr -}          [ "warehouse", "storeroom" ]
                              `plural`     KaRADIS
                              `plural`     KaRADiS ]
...
cluster_53  = listing "Lexicon's properties"
 ...
 |> "' n f" <| [
    ...
    IstaFCaL                  `verb`    {- AisotaOonaf -}      [ "resume", unwords [ "start", "over" ], "appeal" ],

    FaCL                      `noun`    {- Oanof -}            [ "nose", "pride" ]
                              `plural`     FuCUL,
    ...
    FaCUL |< aT               `noun`    {- DERIVED -}          [ "proud", "haughty" ]
                              `plural`     FaCUL |< At,

    MuFtaCaL                  `noun`    {- muWotanaf -}        [ "primordial", "beginning" ]
                              `plural`     MuFtaCaL |< Un,

    MuFtaCaL |< aT            `noun`    {- DERIVED -}          [ "primordial", "beginning" ]
                              `plural`     MuFtaCaL |< At,
 ...
 |> "' n h" <| [
    ...
    FAL                       `noun`    {- \|h -}              [ unwords [ "ah", "!" ], unwords [ "ouch", "!" ] ]
                              `plural`     FaL,

    FAL |< aN                 `noun`    {- \|hAF -}            [ unwords [ "ah", "!" ], unwords [ "ouch", "!" ] ]
                              `plural`     FAL ]
...
cluster_54  = listing "Lexicon's properties"
 ...
 |> "' n n" <| [
    ...
    FiL                       `part`    {- Iin -}              [ unwords [ "if", "/", "whether" ] ],

    FiCL |<< "a"              `part`    {- Iin~a -}            [ unwords [ "that", "/", "indeed" ] ]
                              `plural`     FiCL,
    ...
    FaCCAL |< aT              `noun`    {- DERIVED -}          [ "lamenting", "moaning" ]
                              `plural`     FaCCAL |< At,
    ...
    FaCLAn |< aT              `noun`    {- DERIVED -}          [ "lamenting", "moaning" ]
                              `plural`     FaCLAn |< At,
...
cluster_55  = listing "Lexicon's properties"
 ...
 |> "' n q" <| [
    ...
    FaCiL                     `verb`    {- Oaniq-a -}          [ unwords [ "be", "elegant" ], unwords [ "be", "delighted" ] ]
                              `imperf`     FCaL,
    ...
    TaFaCCaL                  `verb`    {- taOan~aq -}         [ unwords [ "be", "elegant" ] ],

    FaCUL                     `noun`    {- Oanuwq -}           [ unwords [ "Egyptian", "vulture" ] ],
    ...
    FaCIL |< aT               `noun`    {- DERIVED -}          [ "elegant", "graceful" ]
                              `plural`     FaCIL |< At,

    MuFCiL                    `noun`    {- muWoniq -}          [ "pleasing", "attractive" ]
                              `plural`     MuFCiL |< Un,

    MuFCiL |< aT              `noun`    {- DERIVED -}          [ "pleasing", "attractive" ]
                              `plural`     MuFCiL |< At,
    ...
    MutaFaCCiL |< aT          `noun`    {- DERIVED -}          [ "elegant" ]
                              `plural`     MutaFaCCiL |< At ]

 |> "' n q r" <| [

    KaRDaS |< aT              `noun`    {- Oanoqarap -}        [ "Ankara" ]
                           {- `others`  [ "'ankarah N0", "'anqarah N0" ] -},
...
cluster_56  = listing "Lexicon's properties"
 ...
 |> "' n s" <| [
    ...
    FaCiL                     `verb`    {- Oanis-a -}          [ unwords [ "be", "companionable" ], unwords [ "be", "sociable" ] ]
                              `imperf`     FCaL,

    FaCCaL                    `verb`    {- Oan~as -}           [ "domesticate", unwords [ "put", "at", "ease" ], unwords [ "be", "put", "at", "ease" ] ],

    HACaL                     `verb`    {- \|nas -}            [ unwords [ "be", "friendly" ], "entertain" ],

    FACaL                     `verb`    {- \|nas -}            [ unwords [ "be", "friendly" ], "entertain" ],

    HACaL                     `verb`    {- \|nas -}            [ "entertain", "perceive" ],

    FACaL                     `verb`    {- \|nas -}            [ "entertain", "perceive" ],

    TaFaCCaL                  `verb`    {- taOan~as -}         [ unwords [ "be", "accustomed" ], unwords [ "be", "familiar" ] ],

    IstaFCaL                  `verb`    {- AisotaOonas -}      [ unwords [ "be", "domesticated" ], unwords [ "be", "sociable" ] ],
    ...
    MaFCUL |< aT              `noun`    {- DERIVED -}          [ "familiar", "accustomed" ]
                              `plural`     MaFCUL |< At,
    ...
    MuFCiL |< aT              `noun`    {- DERIVED -}          [ "courteous", "friendly" ]
                              `plural`     MuFCiL |< At,
    ...
    MustaFCaL |< aT           `noun`    {- DERIVED -}          [ "domesticated", "sociable" ]
                              `plural`     MustaFCaL |< At ]
...
cluster_57  = listing "Lexicon's properties"
 ...
 |> "' q .t" <| [
    ...
    FaCiL                     `noun`    {- OaqiT -}            [ unwords [ "cottage", "cheese" ] ] ]
...
cluster_58  = listing "Lexicon's properties"
 ...
 |> "' q l m" <| [
    ...
    MuKaRDaS |< aT            `noun`    {- DERIVED -}          [ "acclimated", "adjusted" ]
                              `plural`     MuKaRDaS |< At ]

 |> "' q q" <| [

    FuCL |< aT                `noun`    {- Ouq~ap -}           [ unwords [ "okka", "(", "weight", "measure", ")" ] ] ]

 |> "' q t" <| [

    FaCCaL                    `verb`    {- Oaq~at -}           [ unwords [ "stamp", "the", "time", "/", "date" ], unwords [ "be", "stamped", "with", "a", "time", "/", "date" ] ],
 ...
 |> "' r .d" <| [
    ...
    FaCCaL                    `verb`    {- Oar~aD -}           [ unwords [ "ground", "(", "antenna,", "airplane", ")" ], "earth", unwords [ "be", "grounded", "(", "antenna,", "airplane", ")" ] ],

    FaCL                      `noun`    {- OaroD -}            [ "earth", "territory", "land" ]
                              `plural`     FaCALI
                           {- `others`  [ "'ara.duwn Ndip" ] -},

    FaCL |< Iy                `adj`     {- OaroDiy~ -}         [ "land", "ground" ],

    FaCaL |< aT               `noun`    {- OaraDap -}          [ "termite" ],

    MaFCaL |< aT              `noun`    {- maOoraDap -}        [ unwords [ "ant", "-", "hill" ], "termitary" ],

    FaCL |< Iy |< aT          `noun`    {- OaroDiy~ap -}       [ "background", "groundwork" ],

    FaCIL                     `noun`    {- OariyD -}           [ "wide", "extensive" ],

    TaFCIL                    `noun`    {- taOoriyD -}         [ unwords [ "grounding", "(", "antenna,", "airplane", ")" ] ]
                              `plural`     TaFCIL |< At,

    MuFaCCaL                  `noun`    {- muWar~aD -}         [ unwords [ "grounded", "(", "antenna,", "airplane", ")" ] ]
                              `plural`     MuFaCCaL |< Un,

    MuFaCCaL |< aT            `noun`    {- DERIVED -}          [ unwords [ "grounded", "(", "antenna,", "airplane", ")" ] ]
                              `plural`     MuFaCCaL |< At ]
...
cluster_59  = listing "Lexicon's properties"
 ...
 |> "' r .g n" <| [
    ...
    KuRDuS                    `noun`    {- Ourogun -}          [ unwords [ "organ", "(", "music", ")" ], unwords [ "organs", "(", "music", ")" ] ]
                              `plural`     KaRADiS ]

 |> "' r .t" <| [

    FuCL |< aT                `noun`    {- OuroTap -}          [ "battalion" ]
                              `plural`     FuCaL
                              `plural`     FUCL ]
 ...
 |> "' r ^g" <| [
    ...
    FaCiL                     `verb`    {- Oarij-a -}          [ unwords [ "be", "aromatic" ] ]
                              `imperf`     FCaL,

    TaFaCCaL                  `verb`    {- taOar~aj -}         [ unwords [ "be", "aromatic" ] ],

    FaCaL                     `noun`    {- Oaraj -}            [ "fragrance" ],

    FaCiL                     `noun`    {- Oarij -}            [ "fragrant" ],

    FaCIL                     `noun`    {- Oariyj -}           [ "fragrance" ]
                              `plural`     FaCA'iL,
 ...
 |> "' r ^g .h" <| [
    ...
    MutaKaRDiS |< aT          `noun`    {- DERIVED -}          [ "fluctuating", "oscillating" ]
                              `plural`     MutaKaRDiS |< At,

    KaRDUS |< aT              `noun`    {- OarojuwHap -}       [ "swing", "seesaw" ]
                              `plural`     KaRADIS ]

 |> "' r ^g l" <| [

    KaRDIS |< aT              `noun`    {- Oarojiylap -}       [ "narghile", "hookah" ]
                              `plural`     KaRADIS ]
 ...
 |> "' r ^s" <| [
    ...
    FaCL                      `noun`    {- Oaro$ -}            [ "indemnity", unwords [ "blood", "money" ] ]
                              `plural`     FuCUL ]

 |> "' r ^s f" <| [

    KaRDIS                    `noun`    {- Oaro$iyf -}         [ "archive" ]
                              `plural`     KaRADIS
                              `plural`     KaRDIS |< At ]
...
cluster_61  = listing "Lexicon's properties"
 ...
 |> "' r b" <| [
    ...
    FACaL                     `verb`    {- \|rab -}            [ unwords [ "try", "to", "outwit" ] ],

    FaCaL                     `noun`    {- Oarab -}            [ "desire", "goal" ],

    FiCL                      `noun`    {- Iirob -}            [ "limb" ]
                              `plural`     HACAL,

    HACAL                     `noun`    {- \|rAb -}            [ "desires", "goals" ],

    FuCL                      `noun`    {- Ourob -}            [ "knot", "adversity" ]
                              `plural`     FuCaL,

    FiCL |< aN                `adv`     {- IirobAF -}          [ unwords [ "piece", "by", "piece" ], unwords [ "to", "shreds" ] ]
                              `plural`     FiCL,

    FaCIL                     `noun`    {- Oariyb -}           [ "astute", "industrious" ]
                              `plural`     FaCIL |< Un,

    FaCIL |< aT               `noun`    {- DERIVED -}          [ "astute", "industrious" ]
                              `plural`     FaCIL |< At,
    ...
    MaFCaL                    `noun`    {- maOorab -}          [ "desire", "intent" ]
                              `plural`     MaFACiL,
 ...
 |> "' r b d" <| [
    ...
    KiRDiS |< Iy              `adj`     {- Iirobidiy~ -}       [ unwords [ "of", "/", "from", "Irbid" ] ],
...
cluster_62  = listing "Lexicon's properties"
 ...
 |> "' r f" <| [
    ...
    FaCCaL                    `verb`    {- Oar~af -}           [ "survey", "mark", "delimit" ],

    FuCL |< aT                `noun`    {- Ourofap -}          [ "marker", "limit" ]
                              `plural`     FuCaL,
    ...
    FuCayL |< aT              `noun`    {- Ourayofap -}        [ unwords [ "columella", "(", "middle", "ear", "bone", ")" ] ] ]

 |> "' r k" <| [

    FaCIL |< aT               `noun`    {- Oariykap -}         [ "sofa", "bed" ]
                              `plural`     FaCIL
                              `plural`     FaCA'iL,
 ...
 |> "' r m" <| [
    ...
    FaCCaL                    `verb`    {- Oar~am -}           [ unwords [ "mark", "out" ], unwords [ "be", "marked", "out" ] ],

    FiCaL                     `noun`    {- Iiram -}            [ "boulder", "milestone" ]
                              `plural`     HACAL,
    ...
    MiFCaL                    `noun`    {- mi}oram -}          [ unwords [ "root", "(", "tooth", ")" ] ] ]
...
cluster_63  = listing "Lexicon's properties"
 ...
 |> "' r n k" <| [
    ...
    KuRDIS                    `noun`    {- Ouroniyk -}         [ "pattern", "form" ]
                              `plural`     KaRADIS ]

 |> "' r q" <| [

    FaCiL                     `verb`    {- Oariq-a -}          [ unwords [ "be", "sleepless" ] ]
                              `imperf`     FCaL,

    FaCCaL                    `verb`    {- Oar~aq -}           [ unwords [ "keep", "awake" ], unwords [ "make", "sleepless" ], unwords [ "be", "kept", "awake" ], unwords [ "be", "made", "sleepless" ] ],
    ...
    HACiL |< aT               `noun`    {- DERIVED -}          [ "insomniac" ]
                              `plural`     HACiL |< At,
    ...
    FACiL |< aT               `noun`    {- DERIVED -}          [ "insomniac" ]
                              `plural`     FACiL |< At,
    ...
    FaCL |< aT                `noun`    {- Oaroqap -}          [ "aphid", "greenfly" ]
                              `plural`     FaCaL |< At ]

 |> "' r r" <| [

    FAL                       `noun`    {- \|r -}              [ unwords [ "area", "(", "surface", "measure", ")" ] ]
                              `plural`     FAL |< At,
 ...
 |> "' r s" <| [
    ...
    FaCaL                     `verb`    {- Oaras-i -}          [ unwords [ "till", "the", "land" ] ]
                              `imperf`     FCiL,
...
cluster_64  = listing "Lexicon's properties"
 ...
 |> "' s .t" <| [
    ...
    FaCALIn                   `noun`    {- OasATiyn -}         [ "celebrities" ],

    FuCLY                     `noun`    {- OusoTaY -}          [ "boss", "chief" ]
                           {- `others`  [ "'us.taw NAn_Nayn" ] -} ]

 |> "' s .t l" <| [

    KuRDUS                    `noun`    {- OusoTuwl -}         [ "fleet", "squadron" ]
                              `plural`     KaRADIS ]
 ...
 |> "' s .t r" <| [
    ...
    KuRDUS |< aT              `noun`    {- OusoTuwrap -}       [ "myth", "legend", "tale" ]
                              `plural`     KaRADIS,
 ...
 |> "' s b" <| [
    ...
    FiCLAn |< Iy              `adj`     {- IisobAniy~ -}       [ "Spanish", "Spaniard" ]
                              `plural`     FiCLAn
                              `plural`     FiCLAn |< Iy |< Un ]

 |> "' s b n" <| [

    KiRDAS |< Iy              `adj`     {- IisobAniy~ -}       [ "Spanish", "Spaniard" ]
                              `plural`     KiRDAS
                              `plural`     KiRDAS |< Iy |< Un ]
...
cluster_65  = listing "Lexicon's properties"
 ...
 |> "' s d" <| [
    ...
    IstaFCaL                  `verb`    {- AisotaOosad -}      [ unwords [ "seize", "control" ] ],

    FaCaL                     `noun`    {- Oasad -}            [ "Asad" ],

    FaCaL                     `noun`    {- Oasad -}            [ "lion", "lioness" ]
                              `plural`     FuCuL
                              `plural`     HACAL
                              `plural`     FuCUL
                              `plural`     FuCL,
    ...
    FaCaL |< Iy               `adj`     {- Oasadiy~ -}         [ unwords [ "lion", "-", "related" ], unwords [ "lion", "-", "like" ], "leonine" ],

    MaFCaL                    `noun`    {- maOosad -}          [ unwords [ "lion's", "den" ], "lair" ]
                              `plural`     MaFACiL ]

 |> "' s f" <| [

    FaCiL                     `verb`    {- Oasif-a -}          [ unwords [ "be", "sorry" ], "regret" ]
                              `imperf`     FCaL,
    ...
    MaFCUL |< aT              `noun`    {- DERIVED -}          [ "regrettable", "mourned" ]
                              `plural`     MaFCUL |< At,
    ...
    MutaFaCCiL                `noun`    {- mutaOas~if -}       [ unwords [ "sorry", "!" ] ],

    MutaFaCCiL                `noun`    {- mutaOas~if -}       [ "sorry", "regretful" ]
                              `plural`     MutaFaCCiL |< Un,

    MutaFaCCiL |< aT          `noun`    {- DERIVED -}          [ "sorry", "regretful" ]
                              `plural`     MutaFaCCiL |< At ]
...
cluster_66  = listing "Lexicon's properties"
 ...
 |> "' s f n" <| [
    ...
    KiRDIS |< Iy              `adj`     {- Iisofiyniy~ -}      [ unwords [ "wedge", "-", "like" ], "cuneiform" ] ]
 ...
 |> "' s l" <| [
    ...
    FaCCaL                    `verb`    {- Oas~al -}           [ "sharpen", "taper" ],
    ...
    MuFaCCaL |< aT            `noun`    {- DERIVED -}          [ "pointed", "tapered" ]
                              `plural`     MuFaCCaL |< At ]
 ...
 |> "' s l m" <| [
    ...
    MuKaRDaS |< aT            `noun`    {- DERIVED -}          [ "Islamicized", "Islamified" ]
                              `plural`     MuKaRDaS |< At ]
...
cluster_67  = listing "Lexicon's properties"
 ...
 |> "' s n" <| [
    ...
    FACiL |< aT               `noun`    {- DERIVED -}          [ "contaminated", "brackish" ]
                              `plural`     FACiL |< At,
    ...
    HACiL |< aT               `noun`    {- DERIVED -}          [ "contaminated", "brackish" ]
                              `plural`     HACiL |< At,

    MutaFaCCiL                `noun`    {- mutaOas~in -}       [ "putrid", "brackish" ]
                              `plural`     MutaFaCCiL |< Un,

    MutaFaCCiL |< aT          `noun`    {- DERIVED -}          [ "putrid", "brackish" ]
                              `plural`     MutaFaCCiL |< At ]

 |> "' s q f" <| [

    KuRDuS                    `noun`    {- Ousoquf -}          [ "bishop" ]
                              `plural`     KaRADiS |< aT,
 ...
 |> "' s r" <| [
    ...
    FaCaL                     `verb`    {- Oasar-i -}          [ "capture", unwords [ "take", "prisoner" ] ]
                              `imperf`     FCiL,

    IstaFCaL                  `verb`    {- AisotaOosar -}      [ "surrender" ],

    FaCL                      `noun`    {- Oasor -}            [ "capture", "captivity" ],

    FuCL                      `noun`    {- Ousor -}            [ unwords [ "urine", "retention" ] ],

    FuCL |< aT                `noun`    {- Ousorap -}          [ "family", "community" ]
                              `plural`     FuCaL,
    ...
    TaFCIL                    `noun`    {- taOosiyr -}         [ unwords [ "webbing", "(", "chair", ")" ] ]
                              `plural`     TaFCIL |< At,

    MaFCUL                    `noun`    {- maOosuwr -}         [ unwords [ "held", "prisoner" ], unwords [ "held", "captive" ] ]
                              `plural`     MaFCUL |< Un,

    MaFCUL |< aT              `noun`    {- DERIVED -}          [ unwords [ "held", "prisoner" ], unwords [ "held", "captive" ] ]
                              `plural`     MaFCUL |< At ]
...
cluster_68  = listing "Lexicon's properties"
 ...
 |> "' s s" <| [
    ...
    FaCCaL                    `verb`    {- Oas~as -}           [ "establish", "found" ],

    TaFaCCaL                  `verb`    {- taOas~as -}         [ unwords [ "be", "established" ], unwords [ "be", "founded" ] ],

    FuCL                      `noun`    {- Ous~ -}             [ "exponent", "basis" ]
                              `plural`     FiCAL,
    ...
    FaCAL                     `noun`    {- OasAs -}            [ "foundation", "basis" ]
                              `plural`     FuCuL
                              `plural`     FaCAL |< At,
    ...
    FaCIL |< aT               `noun`    {- Oasiysap -}         [ "infrastructure" ]
                              `plural`     FaCA'iL,
    ...
    MuFaCCaL |< aT            `noun`    {- muWas~asap -}       [ "institution", "organization" ]
                              `plural`     MuFaCCaL |< At,
...
cluster_69  = listing "Lexicon's properties"
 ...
 |> "' s t k" <| [
    ...
    KaRDiS                    `noun`    {- Oasotik -}          [ "elastic", unwords [ "rubber", "band" ] ]
                              `plural`     KaRADiS,

    KuRDIS                    `noun`    {- Ousotiyk -}         [ unwords [ "watch", "band" ] ]
                              `plural`     KaRADIS,

    KaRDIS |< aT              `noun`    {- Oasotiykap -}       [ unwords [ "rubber", "eraser" ] ] ]
...
cluster_70  = listing "Lexicon's properties"
 ...
 |> "' s w" <| [
    ...
    FaCCY                     `verb`    {- Oas~aY -}           [ "console", "comfort" ],
    ...
    TaFACY                    `verb`    {- ta|saY -}           [ unwords [ "console", "mutually" ] ],
    ...
    FuCL |< aT |< aN          `adv`     {- OusowapF -}         [ unwords [ "just", "like" ] ],

    MaFCY |< aT               `noun`    {- maOosAp -}          [ "tragedy" ]
                              `plural`     MaFACI,
...
cluster_71  = listing "Lexicon's properties"
 ...
 |> "' s y .t" <| [
    ...
    KaRDUS |< Iy              `adj`     {- OasoyuwTiy~ -}      [ unwords [ "from", "/", "of", "Asyut" ] ],
...
cluster_72  = listing "Lexicon's properties"
 ...
 |> "' t n" <| [
    ...
    FaCAL                     `noun`    {- OatAn -}            [ unwords [ "she", "-", "ass" ] ]
                              `plural`     FuCuL,

    FiCL |< Iy                `adj`     {- Iitoniy~ -}         [ "ethnic" ],

    FiCL |< Iy |< aT          `noun`    {- Iitoniy~ap -}       [ "ethnicity", unwords [ "ethnic", "background" ] ],

    FaCCUL                    `noun`    {- Oat~uwn -}          [ "furnace", "oven" ]
                              `plural`     FaCACIL ]
...
cluster_73  = listing "Lexicon's properties"
 ...
 |> "' t y" <| [
    ...
    IstaFCY                   `verb`    {- AisotaOotaY -}      [ unwords [ "ask", "to", "come" ], unwords [ "induce", "to", "come" ], unwords [ "be", "asked", "to", "come" ], unwords [ "be", "induced", "to", "come" ] ],
...
cluster_74  = listing "Lexicon's properties"
 ...
 |> "' w ^s" <| [
    ...
    FUL |< Iy |< aT           `noun`    {- Ouw$iy~ap -}        [ "prayer", "oration" ]
                              `plural`     FaCALI ]
 ...
 |> "' w b" <| [
    ...
    FaCCAL |< aT              `noun`    {- DERIVED -}          [ "penitent" ]
                              `plural`     FaCCAL |< At,
 ...
 |> "' w b b" <| [
    ...
    KuRDiS                    `noun`    {- Ouwbib -}           [ unwords [ "OPEP", "(", "French", "for", "OPEC", ")" ] ] ]
 ...
 |> "' w d" <| [
    ...
    FaCiL                     `verb`    {- Oawid-a -}          [ "bend", unwords [ "be", "bent" ] ]
                              `imperf`     FCaL,

    FaCCaL                    `verb`    {- Oaw~ad -}           [ "bend", "fold", unwords [ "be", "bent" ] ],

    TaFaCCaL                  `verb`    {- taOaw~ad -}         [ unwords [ "be", "bent" ], unwords [ "be", "folded" ] ],

    FaCL |< aT                `noun`    {- Oawodap -}          [ "burden", "load" ]
                              `plural`     FiCAL,
...
cluster_75  = listing "Lexicon's properties"
 ...
 |> "' w f" <| [
    ...
    MaFUL |< aT               `noun`    {- DERIVED -}          [ "damaged", "epidemical" ]
                              `plural`     MaFUL |< At,
 ...
 |> "' w h" <| [
    ...
    MutaFaCCiL |< aT          `noun`    {- DERIVED -}          [ "sighing", "exclaiming" ]
                              `plural`     MutaFaCCiL |< At ]
...
cluster_76  = listing "Lexicon's properties"
 ...
 |> "' w l" <| [
    ...
    FaCCaL                    `verb`    {- Oaw~al -}           [ "explain", "interpret" ],
    ...
    FaCA'iL                   `noun`    {- OawA}il -}          [ "early", "beginning" ],
...
cluster_77  = listing "Lexicon's properties"
 ...
 |> "' w l w" <| [
    ...
    KuRDU                     `pron`    {- Ouwluw -}           [ unwords [ "they", "/", "those" ] ] ]
...
cluster_78  = listing "Lexicon's properties"
 ...
 |> "' w q" <| [
    ...
    FAL                       `verb`    {- \|q-u -}            [ unwords [ "bring", "bad", "luck" ], unwords [ "cause", "hardship" ] ]
                              `imperf`     FUL
                              `pfirst`     FuL,

    FaCCaL                    `verb`    {- Oaw~aq -}           [ "burden", "impose" ],

    FUL |< Iy |< aT           `noun`    {- Ouwqiy~ap -}        [ "ounce" ]
                              `plural`     FaCALI ]
 ...
 |> "' w r" <| [
    ...
    FuCAL |< Iy               `adj`     {- OuwAriy~ -}         [ unwords [ "blazing", "thirst" ] ] ]

 |> "' w r b" <| [

    KaRDaS                    `verb`    {- Oaworab -}          [ "Europeanize" ],

    TaKaRDaS                  `verb`    {- taOaworab -}        [ unwords [ "be", "Europeanized" ] ],

    MuKaRDaS                  `noun`    {- muWaworab -}        [ "Europeanized" ]
                              `plural`     MuKaRDaS |< Un,

    MuKaRDaS |< aT            `noun`    {- DERIVED -}          [ "Europeanized" ]
                              `plural`     MuKaRDaS |< At,

    MutaKaRDiS                `noun`    {- mutaOaworib -}      [ "Europeanized" ]
                              `plural`     MutaKaRDiS |< Un,

    MutaKaRDiS |< aT          `noun`    {- DERIVED -}          [ "Europeanized" ]
                              `plural`     MutaKaRDiS |< At ]
...
cluster_79  = listing "Lexicon's properties"
 ...
 |> "' w y" <| [
    ...
    HICA'                     `noun`    {- IiywA' -}           [ "accommodation", "housing" ]
                              `plural`     HICA' |< At,

    MaFCY                     `noun`    {- maOowaY -}          [ "refuge", "shelter" ]
                              `plural`     MaFACI ]
 ...
 |> "' y .g d" <| [
    ...
    KiRDAS                    `noun`    {- IiygAd -}           [ unwords [ "EGAD", "(", "Economic", "Growth", "and", "Agricultural", "Development", ")" ] ] ]
...
cluster_80  = listing "Lexicon's properties"
 ...
 |> "' y b" <| [
    ...
    FACiL |< aT               `noun`    {- DERIVED -}          [ "coming", "returning" ]
                              `plural`     FACiL |< At,
    ...
    HACiL |< aT               `noun`    {- DERIVED -}          [ "coming", "returning" ]
                              `plural`     HACiL |< At,
...
cluster_81  = listing "Lexicon's properties"
 ...
 |> "' y k" <| [
    ...
    FaCL |< aT                `noun`    {- Oayokap -}          [ "jungle", "thicket" ]
                              `plural`     FaCL ]
 ...
 |> "' y l" <| [
    ...
    FaCCiL |< Iy              `adj`     {- Oay~iliy~ -}        [ "cervidae", "cervid", unwords [ "deer", "-", "related" ] ],
...
cluster_82  = listing "Lexicon's properties"
 ...
 |> "' y m" <| [
    ...
    FAL                       `verb`    {- \|m-i -}            [ unwords [ "be", "widowed" ] ]
                              `imperf`     FIL,

    TaFaCCaL                  `verb`    {- taOay~am -}         [ unwords [ "be", "widowed" ] ],

    FaCCiL                    `noun`    {- Oay~im -}           [ "widowed" ],

    FaCA'iL                   `noun`    {- OayA}im -}          [ "widows" ]
                              `plural`     FaCALY,
...
cluster_83  = listing "Lexicon's properties"
 ...
 |> "' y n" <| [
    ...
    TaFaCCaL                  `verb`    {- taOay~an -}         [ unwords [ "be", "ionized" ] ],
...
cluster_84  = listing "Lexicon's properties"
 ...
 |> "' y s" <| [
    ...
    FaCiL                     `verb`    {- Oayis-a -}          [ unwords [ "lose", "hope" ], "despair" ]
                              `imperf`     FCaL,
 ...
 |> "' y y" <| [
    ...
    FaL                       `conj`    {- Oayo -}             [ "i.e.", unwords [ "in", "other", "words" ] ],

    FaC                       `conj`    {- Oayo -}             [ "i.e.", unwords [ "in", "other", "words" ] ],

    FaCL                      `pron`    {- Oay~ -}             [ "any", "what", "which" ]
                           {- `others`  [ "'ayyaT FW-WaBi" ] -},
    ...
    FaCL                      `part`    {- Oay~ -}             [ "which", unwords [ "which", "one", "of", "the", "two" ], unwords [ "which", "one", "of", "them" ], unwords [ "which", "one", "of", "you", "two" ], unwords [ "which", "one", "of", "you" ], unwords [ "which", "one", "of", "us" ] ]
                           {- `others`  [ "'ayyhmA FW-WaBi", "'ayytknna FW-WaBi", "'ayythA FW-WaBi", "'ayyhm FW-WaBi", "'ayyaT FW-WaBi", "'ayytkmA FW-WaBi", "'ayynA FW-WaBi", "'ayykum FW-WaBi", "'ayykumA FW-WaBi", "'ayythmA FW-WaBi", "'ayykunna FW-WaBi", "'ayythnna FW-WaBi", "'ayytnA FW-WaBi", "'ayyhA FW-WaBi", "'ayyhnna FW-WaBi" ] -},
 ...
 |> "' z '" <| [
    ...
    FiCAL                     `prep`    {- IizA' -}            [ "towards", "facing", "regarding", unwords [ "vis", "-", "a", "-", "vis" ] ]
...
cluster_85  = listing "Lexicon's properties"
 ...
 |> "' z ^g" <| [
    ...
    FaCaL                     `noun`    {- Oazaj -}            [ unwords [ "ant", "-", "hill" ], "termitary" ]
                              `plural`     HACAL ]
 ...
 |> "' z b" <| [
    ...
    MiFCAL                    `noun`    {- mi}ozAb -}          [ "drain", "gutter" ]
                              `plural`     MaFACiL
                              `plural`     MaFACIL
                              `plural`     MICAL,
...
cluster_86  = listing "Lexicon's properties"
 ...
 |> "' z m" <| [
    ...
    FaCCaL                    `verb`    {- Oaz~am -}           [ "aggravate", unwords [ "make", "critical" ], unwords [ "be", "made", "critical" ] ],

    TaFaCCaL                  `verb`    {- taOaz~am -}         [ unwords [ "get", "worse" ], unwords [ "become", "critical" ] ],
 ...
 |> "' z q" <| [
    ...
    FaCaL                     `verb`    {- Oazaq-i -}          [ unwords [ "be", "narrow" ] ]
                              `imperf`     FCiL,

    TaFaCCaL                  `verb`    {- taOaz~aq -}         [ unwords [ "be", "narrow" ] ],
...
cluster_87  = listing "Lexicon's properties"
 ...
 |> "' z r" <| [
    ...
    TaFaCCaL                  `verb`    {- taOaz~ar -}         [ unwords [ "be", "wrapped", "in", "a", "shawl" ] ],

    TaFACaL                   `verb`    {- ta|zar -}           [ "collaborate", "cooperate" ],

    IFtaCaL                   `verb`    {- Ai}otazar -}        [ unwords [ "wear", "a", "shawl" ] ],

    FaCL                      `noun`    {- Oazor -}            [ "strength" ],

    FiCAL                     `noun`    {- IizAr -}            [ "shawl" ]
                              `plural`     FuCuL,

    MiFCaL                    `noun`    {- mi}ozar -}          [ "apron", "covering", "veil" ]
                              `plural`     MaFACiL,
...
cluster_88  = listing "Lexicon's properties"
 ...
 |> "'AfirIn" <| [
    ...
    Identity                  `noun`    {- \|firiyn -}         [ unwords [ "bravo", "!" ], unwords [ "well", "done", "!" ] ] ]

 |> "'AmIn" <| [

    Identity                  `noun`    {- \|miyn -}           [ unwords [ "amen", "!" ] ] ]
 ...
 |> "'Ana'i_diN" <| [
    ...
    Identity                  `adv`     {- \|na}i*K -}         [ "then", unwords [ "at", "that", "time" ] ] ]

 |> "'Ana_dAk" <| [

    Identity                  `adv`     {- \|na*Ak -}          [ "then", unwords [ "at", "that", "time" ] ] ]
...
cluster_91  = listing "Lexicon's properties"
 ...
 |> "'IyA-" <| [
    ...
    Identity                  `part`    {- Iiy~A- -}           [ "to", "for", unwords [ "(", "accus.", ")" ] ] ]
...
cluster_92  = listing "Lexicon's properties"
 ...
 |> "'UkAziyUn" <| [
    ...
    Identity                  `noun`    {- OuwkAziyuwn -}      [ unwords [ "clearing", "sale" ] ] ]
 ...
 |> "'UlA'ik" <| [
    ...
    Identity |<< "a"          `pron`    {- OuwlA}ika -}        [ unwords [ "they", "/", "those" ] ] ]
...
cluster_93  = listing "Lexicon's properties"
 ...
 |> "'UnurwA" <| [
    ...
    Identity                  `noun`    {- OuwnurowA -}        [ unwords [ "UNRWA", "(", "UN", "Relief", "and", "Works", "Agency", ")" ] ] ]
...
cluster_96  = listing "Lexicon's properties"
 ...
 |> "'a_hInUs" <| [
    ...
    Identity                  `noun`    {- Oaxiynuws -}        [ unwords [ "sea", "urchin" ] ] ]
 ...
 |> "'abU.gunaym" <| [
    ...
    Identity                  `noun`    {- Oabuwgunayom -}     [ unwords [ "Abu", "Ghunaim" ] ] ]

 |> "'abU.zabI" <| [

    Identity                  `noun`    {- OabuwZabiy -}       [ unwords [ "Abu", "Dhabi" ] ] ]
 ...
 |> "'abU^sanab" <| [
    ...
    Identity                  `noun`    {- Oabuw$anab -}       [ unwords [ "Abu", "Shanab" ], "Abushanab" ] ]
...
cluster_97  = listing "Lexicon's properties"
 ...
 |> "'abUmAzin" <| [
    ...
    Identity                  `noun`    {- OabuwmAzin -}       [ unwords [ "Abu", "Mazen" ], unwords [ "Abu", "Mazin" ] ] ]

 |> "'abUrudayn" <| [

    Identity |< aT            `noun`    {- Oabuwrudayonap -}   [ unwords [ "Abu", "Rudaina" ] ] ]

 |> "'abUzayd" <| [

    Identity                  `noun`    {- Oabuwzayod -}       [ unwords [ "Abu", "Zeid" ] ] ]
 ...
 |> "'abuwAi_tnayn" <| [
    ...
    Identity                  `noun`    {- OabuwAivonayon -}   [ unwords [ "Abu", "Thnain" ], "Abuthain" ] ]

 |> "'abuwAllrA.gib" <| [

    Identity                  `noun`    {- OabuwAl~rAgib -}    [ unwords [ "Abu", "Al", "-", "Raghib" ] ] ]
...
cluster_98  = listing "Lexicon's properties"
 ...
 |> "'afrU'asyY" <| [
    ...
    Identity |< Iy            `adj`     {- OaforuwOasoyawiy~ -} [ unwords [ "Afro", "-", "Asiatic" ], unwords [ "African", "-", "Asian" ] ] ]
...
cluster_102 = listing "Lexicon's properties"
 ...
 |> "'an^gilUsaksUn" <| [
    ...
    Identity                  `noun`    {- Oanojiluwsakosuwn -} [ unwords [ "Anglo", "-", "Saxons" ] ],

    Identity |< Iy            `adj`     {- Oanojiluwsakosuwniy~ -} [ unwords [ "Anglo", "-", "Saxon" ] ] ]
...
cluster_103 = listing "Lexicon's properties"
 ...
 |> "'ankilUsaksUn" <| [
    ...
    Identity                  `noun`    {- Oanokiluwsakosuwn -} [ unwords [ "Anglo", "-", "Saxons" ] ],

    Identity |< Iy            `adj`     {- Oanokiluwsakosuwniy~ -} [ unwords [ "Anglo", "-", "Saxon" ] ] ]
...
cluster_104 = listing "Lexicon's properties"
 ...
 |> "'antumA" <| [
    ...
    Identity                  `pron`    {- OanotumA -}         [ unwords [ "you", "both" ] ] ]

 |> "'antunn" <| [

    Identity |<< "a"          `pron`    {- Oanotun~a -}        [ "you" ] ]
...
cluster_105 = listing "Lexicon's properties"
 ...
 |> "'ardabb" <| [
    ...
    Identity                  `noun`    {- Oarodab~ -}         [ unwords [ "ardeb", "(", "capacity", "/", "weight", "measure", ")" ], unwords [ "ardebs", "(", "capacity", "/", "weight", "measure", ")" ] ] ]
...
cluster_106 = listing "Lexicon's properties"
 ...
 |> "'arzdara_ht" <| [
    ...
    Identity                  `noun`    {- Oarozodaraxt -}     [ unwords [ "China", "tree" ], unwords [ "paradise", "tree" ] ] ]
...
cluster_107 = listing "Lexicon's properties"
 ...
 |> "'asafAh" <| [
    ...
    Identity                  `noun`    {- OasafAh -}          [ unwords [ "too", "bad", "!" ], unwords [ "how", "unfortunate", "!" ] ] ]
 ...
 |> "'asmAn^gUn" <| [
    ...
    Identity |< Iy            `adj`     {- OasomAnojuwniy~ -}  [ "azure", unwords [ "sky", "-", "blue" ] ] ]
...
cluster_108 = listing "Lexicon's properties"
 ...
 |> "'azdara_ht" <| [
    ...
    Identity                  `noun`    {- Oazodaraxt -}       [ unwords [ "China", "tree" ], unwords [ "paradise", "tree" ] ] ]
 ...
 |> "'i.sfahAn" <| [
    ...
    Identity |< Iy            `adj`     {- IiSofahAniy~ -}     [ unwords [ "from", "/", "of", "Isfahan" ] ],
...
cluster_111 = listing "Lexicon's properties"
 ...
 |> "'imma`" <| [
    ...
    Identity                  `noun`    {- Iim~aE -}           [ unwords [ "yes", "-", "man" ], "opportunist" ],
...
cluster_112 = listing "Lexicon's properties"
 ...
 |> "'inqlIz" <| [
    ...
    Identity |< Iy |< aT      `noun`    {- Iinoqliyziy~ap -}   [ unwords [ "English", "(", "language", ")" ] ] ]
...
cluster_113 = listing "Lexicon's properties"
 ...
 |> "'is.tAnbUl" <| [
    ...
    Identity |< Iy            `adj`     {- IisoTAnobuwliy~ -}  [ unwords [ "of", "/", "from", "Istanbul" ] ] ]
...
cluster_114 = listing "Lexicon's properties"
 ...
 |> "'iskUdU" <| [
    ...
    Identity                  `noun`    {- Iisokuwduw -}       [ unwords [ "escudo", "(", "monetary", "unit", ")" ] ] ]
...
cluster_115 = listing "Lexicon's properties"
 ...
 |> "'iskutlandyArd" <| [
    ...
    Identity                  `noun`    {- IisokutolanodoyArd -} [ unwords [ "Scotland", "Yard" ] ] ]

 |> "'iskwA^s" <| [

    Identity                  `noun`    {- IisokwA$ -}         [ unwords [ "squash", "(", "sport", ")" ] ] ]

 |> "'islAmbUl" <| [

    Identity |< Iy            `adj`     {- IisolAmobuwliy~ -}  [ "Islambuli" ],

    Identity |< Iy            `adj`     {- IisolAmobuwliy~ -}  [ unwords [ "from", "/", "of", "Istanbul" ] ] ]
 ...
 |> "'ismA`Il" <| [
    ...
    Identity |< Iy            `adj`     {- IisomAEiyliy~ -}    [ unwords [ "from", "/", "of", "Ismailia" ] ],
...
cluster_116 = listing "Lexicon's properties"
 ...
 |> "'istanbUl" <| [
    ...
    Identity |< Iy            `adj`     {- Iisotanobuwliy~ -}  [ unwords [ "from", "/", "of", "Istanbul" ] ] ]
 ...
 |> "'istu.gmAy" <| [
    ...
    Identity |< aT            `noun`    {- IisotugomAyap -}    [ unwords [ "blind", "-", "mans'", "buff" ] ] ]
...
cluster_117 = listing "Lexicon's properties"
 ...
 |> "'unmUfIk" <| [
    ...
    Identity                  `noun`    {- Ounomuwfiyk -}      [ unwords [ "UNMOVIC", "(", "UN", "Monitoring,", "Verification", "and", "Inspection", "Commission", ")" ] ] ]
...
cluster_118 = listing "Lexicon's properties"
 ...
 |> "_huway" <| [
    ...
    Identity                  `pron`    {- xuway -}            [ unwords [ "little", "brother" ], unwords [ "little", "brother", "+", "my" ] ] ]

 |> "bi'an" <| [

    Identity                  `part`    {- biOan -}            [ unwords [ "with", "+", "that" ] ] ]

 |> "bi'ann" <| [

    Identity |<< "a"          `part`    {- biOan~a -}          [ unwords [ "with", "+", "that" ] ] ]
...
cluster_119 = listing "Lexicon's properties"
 ...
 |> "ka'annamA" <| [
    ...
    Identity                  `conj`    {- kaOan~amA -}        [ unwords [ "as", "if" ] ] ]
 ...
 |> "li'allA" <| [
    ...
    Identity                  `conj`    {- li}al~A -}          [ unwords [ "in", "order", "not", "to" ] ] ]

 |> "li'an" <| [

    Identity                  `conj`    {- liOan -}            [ unwords [ "in", "order", "to" ] ] ]
 ...
 |> "rI.hA'" <| [
    ...
    Identity |< Iy            `adj`     {- riyHAwiy~ -}        [ unwords [ "from", "/", "of", "Jericho" ] ],
 ...
 |> "ta'an^glaz" <| [
    ...
    Identity                  `verb`    {- taOanojlaz -}       [ unwords [ "be", "Anglicized" ] ] ]

 |> "ta'anklaz" <| [

    Identity                  `verb`    {- taOanoklaz -}       [ unwords [ "be", "Anglicized" ] ] ]

 |> "ta'anqlaz" <| [

    Identity                  `verb`    {- taOanoqlaz -}       [ unwords [ "be", "Anglicized" ] ] ]
...
cluster_120 = listing "Lexicon's properties"
 ...
 |> "yA'ayyuhA" <| [
    ...
    Identity                  `part`    {- yAOay~uhA -}        [ unwords [ "O", "!" ] ] ]
