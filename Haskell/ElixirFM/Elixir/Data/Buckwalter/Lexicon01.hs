...
lexicon = listing "Lexicon's properties"
 ...
 |> "' .s l" <| [
    ...
    FaCuL                     `noun`       {- OaSul -}          [ "be rooted", "be established" ]
                              `plural`     FCuL
                              {- `others` [ "'.sul IV_no-Pref-A" ] -},
 ...
 |> "'a_d" <| [
    ...
    Identity |< Iy |< aT      `noun`       {- Oa*iy~ap -}       [ "malice", "prejudice" ] ]
