...
lexicon = listing "Lexicon's properties"
 ...
 |> "^g ' ^g '" <| [
    ...
    KuRDuS                    `noun`       {- juWojuW -}        [ "breast", "prow", "breasts", "prows" ]
                              `plural`     KaRADiS
                              {- `others` [ "^ga'A^gi' Ndip" ] -} ]
 ...
 |> "^g ' ^s" <| [
    ...
    FaCaL                     `verb`       {- jaOa$-a -}        [ "be agitated", "be convulsed" ]
                              `imperf`     FCaL
 ...
 |> "^g .h ^s" <| [
    ...
    FaCL                      `noun`       {- jaHo$ -}          [ "young donkey", "young donkeys" ]
                              `plural`     FiCAL
                              `plural`     HaFCAL
                              `plural`     FiCLAn
 ...
 |> "^g .h f" <| [
    ...
    FaCaL                     `verb`       {- jaHaf-a -}        [ "peel off", "side" ]
                              `imperf`     FCaL
                              {- `others` [ "^g.haf IV" ] -},
    ...
    HaFCaL                    `verb`       {- OajoHaf -}        [ "harm", "ruin", "be harmed", "be ruined" ]
                              {- `others` [ "^g.haf IV_Pass_yu", "^g.hif IV_yu" ] -},
 ...
 |> "^g .h f l" <| [
    ...
    KaRDaS                    `noun`       {- jaHofal -}        [ "multitude", "army", "multitudes", "armies" ]
                              `plural`     KaRADiS
 ...
 |> "^g .h r" <| [
    ...
    IFtaCaL                   `verb`       {- {ijotaHar -}      [ "seek refuge" ]
                              {- `others` [ "^gta.hir IV" ] -},
    ...
    FuCL                      `noun`       {- juHor -}          [ "hole", "burrow", "holes", "burrows" ]
                              `plural`     FuCUL
                              `plural`     HaFCAL
 ...
 |> "^g .s .s" <| [
    ...
    FaCCaL                    `verb`       {- jaS~aS -}         [ "plaster", "whitewash", "bleach" ]
                              {- `others` [ "^ga.s.si.s IV_yu" ] -},

    -- ;; jiS~_1
    -- jS      jiS~    N       gypsum;plaster of Paris

    FiCL                      `noun`       {- jiS~ -}           [ "gypsum", "plaster of Paris" ],
 ...
 |> "^g ^s `" <| [
    ...
    FaCiL                     `verb`       {- ja$iE-a -}        [ "be covetous", "be greedy" ]
                              `imperf`     FCaL
                              {- `others` [ "^g^sa` IV_intr" ] -},
    ...
    TaFaCCaL                  `verb`       {- taja$~aE -}       [ "be covetous", "be greedy" ],
 ...
 |> "^g _d _d" <| [
    ...
    FaCCaL                    `verb`       {- ja*~a* -}         [ "be isolated" ]
                              {- `others` [ "^ga_d_di_d IV_intr_yu" ] -},

    -- ;; taja*~a*_1
    -- tj**    taja*~a*        PV_intr be divided;break up
    -- tj**    taja*~a*        IV_intr be divided;break up

    TaFaCCaL                  `verb`       {- taja*~a* -}       [ "be divided", "break up" ],
 ...
 |> "^g _d `" <| [
    ...
    FaCaL |< aT               `noun`       {- ja*aEap -}        [ "again", "once more" ],
 ...
 |> "^g _d b" <| [
    ...
    InFaCaL                   `verb`       {- {inoja*ab -}      [ "gravitate", "be attracted" ]
                              {- `others` [ "n^ga_dib IV" ] -},
    ...
    IFtaCaL                   `verb`       {- {ijota*ab -}      [ "attract", "allure" ]
                              {- `others` [ "^gta_dib IV" ] -},
    ...
    HaFCaL                    `noun`       {- Oajo*ab -}        [ "more/most attractive" ],
    ...
    InFiCAL                   `noun`       {- {inoji*Ab -}      [ "attraction", "tendency", "enticement" ]
                              `plural`     IFtiCAL |< At
                              {- `others` [ "i^gti_dAb NduAt" ] -},
    ...
    MutaFACiL                 `noun`       {- mutajA*ib -}      [ "mutually attracted" ],
 ...
 |> "^g _d f" <| [
    ...
    FaCCaL                    `verb`       {- ja*~af -}         [ "row" ]
                              {- `others` [ "^ga_d_dif IV_yu" ] -},

    -- ;; mijo*Af_1
    -- mj*Af   mijo*Af Ndu     oar
    -- mjA*yf  majA*iyf        Ndip    oars

    MiFCAL                    `noun`       {- mijo*Af -}        [ "oar", "oars" ]
                              `plural`     MaFACIL
 ...
 |> "^g _d l" <| [
    ...
    FaCiL                     `verb`       {- ja*il-a -}        [ "be happy", "rejoice" ]
                              `imperf`     FCaL
    ...
    HaFCaL                    `verb`       {- Oajo*al -}        [ "make happy", "gladden", "be made happy", "be gladdened" ]
                              {- `others` [ "^g_dil IV_yu", "^g_dal IV_Pass_yu" ] -},
 ...
 |> "^g _d m" <| [
    ...
    FaCiL                     `verb`       {- ja*im-a -}        [ "have leprosy" ]
                              `imperf`     FCaL
                              {- `others` [ "^g_dam IV" ] -},
 ...
 |> "^g _d m r" <| [
    ...
    KuRDUS                    `noun`       {- ju*omuwr -}       [ "stump", "stumps" ]
                              `plural`     KaRADIS
 ...
 |> "^g _d r" <| [
    ...
    FaCCaL                    `verb`       {- ja*~ar -}         [ "extract the root", "take root" ]
                              {- `others` [ "^ga_d_dir IV_yu" ] -},
    ...
    InFaCaL                   `verb`       {- {inoja*ar -}      [ "be extracted", "be uprooted" ]
                              {- `others` [ "n^ga_dir IV_intr" ] -},
    ...
    TaFCIL                    `noun`       {- tajo*iyr -}       [ "evolution", "root extraction" ] ]
 ...
 |> "^g _d w" <| [
    ...
    FaCL |< aT                `noun`       {- ja*owap -}        [ "firebrand", "burning log", "firebrands", "burning logs" ]
                              `plural`     FiCA'
                              `plural`     FiCY
 ...
 |> "^g _t _t" <| [
    ...
    IFtaCL                    `verb`       {- {ijotav~ -}       [ "tear out", "uproot" ]
                              {- `others` [ "^gta_ti_t IV_C", "^gta_t_t IV_V", "i^gta_ta_t PV_C" ] -},
    ...
    IFtiCAL                   `noun`       {- {ijotivAv -}      [ "uprooting", "tearing out" ],
 ...
 |> "^g _t l q" <| [
    ...
    KiRDIS                    `noun`       {- jivoliyq -}       [ "catholicos", "primate of the Armenian church", "primates of the Armenian church" ]
                              `plural`     KaRADiS |< aT
                              {- `others` [ "^ga_tAliq Nap" ] -} ]
 ...
 |> "^g _t r" <| [
    ...
    FaCA                      `verb`       {- javA-u -}         [ "kneel", "genuflect", "be knelt", "be genuflected" ]
                              `imperf`     FCuL
                              {- `others` [ "^g_tY IV_0_Pass_yu", "^g_tuw IV_0hAnn" ] -},
 ...
 |> "^g ` b" <| [
    ...
    FaCL |< aT                `noun`       {- jaEobap -}        [ "quiver", "pipe", "gun barrel", "quivers", "pipes", "gun barrels" ]
                              `plural`     FiCAL
                              `plural`     FuCL |< aT
                              {- `others` [ "^gi`Ab N", "^gu`b Nap" ] -} ]
 ...
 |> "^g ` d" <| [
    ...
    FaCuL                     `verb`       {- jaEud-u -}        [ "curl", "be wrinkled" ]
                              `imperf`     FCuL
                              {- `others` [ "^g`ud IV" ] -},
    ...
    TaFaCCaL                  `verb`       {- tajaE~ad -}       [ "be curly", "be wrinkled", "be wavy" ],
 ...
 |> "^g ` l" <| [
    ...
    FACaL                     `verb`       {- jAEal -}          [ "try to bribe", "try to win" ]
                              {- `others` [ "^gA`il IV_yu" ] -},
    ...
    FuCL |< Iy                `adj`        {- juEoliy~ -}       [ "piece-work" ],
 ...
 |> "^g ` r" <| [
    ...
    FaCaL                     `verb`       {- jaEar-a -}        [ "drop manure" ]
                              `imperf`     FCaL
                              {- `others` [ "^g`ar IV" ] -},
 ...
 |> "^g b .h" <| [
    ...
    FaCL                      `noun`       {- jaboH -}          [ "beehive", "beehives" ]
                              `plural`     HaFCAL
                              `plural`     FiCAL
 ...
 |> "^g b _h" <| [
    ...
    FaCLAn |< aT              `noun`       {- jaboxAnap -}      [ "powder magazine", "ammunition" ] ]
 ...
 |> "^g b _h n" <| [
    ...
    KaRDAS |< aT              `noun`       {- jaboxAnap -}      [ "powder magazine", "ammunition" ] ]
 ...
 |> "^g b b" <| [
    ...
    FuCL |< aT                `noun`       {- jub~ap -}         [ "jubbah", "jubbahs" ]
                              `plural`     FuCaL
                              `plural`     FiCAL
    ...
    FaCLAn                    `noun`       {- jab~An -}         [ "cheese merchant" ],
    ...
    FaCLY                     `verb`       {- jab~aY -}         [ "kneel", "prostrate" ]
                              {- `others` [ "^gabbiy IV_0hAnn_yu", "^gabb IV_0hwnyn_yu PV_ttAw" ] -} ]
 ...
 |> "^g b n" <| [
    ...
    FaCCaL                    `verb`       {- jab~an -}         [ "make curdle", "call a coward" ]
                              {- `others` [ "^gabbin IV-n_yu" ] -},
    ...
    FaCCAL                    `noun`       {- jab~An -}         [ "cheese merchant" ],
    ...
    HaFCaL                    `noun`       {- Oajoban -}        [ "more/most cowardly" ],
    ...
    MaFCaL |< aT              `noun`       {- majobanap -}      [ "cheese dairy" ],

    -- ;; tajobiyn_1
    -- tjbyn   tajobiyn        NduAt   cheese making

    TaFCIL                    `noun`       {- tajobiyn -}       [ "cheese making" ] ]
 ...
 |> "^g b r" <| [
    ...
    TaFaCCaL                  `verb`       {- tajab~ar -}       [ "act arrogantly", "show strength" ],
    ...
    InFaCaL                   `verb`       {- {inojabar -}      [ "be mended", "be restored" ]
                              {- `others` [ "n^gabir IV_intr" ] -},
    ...
    FiCAL |< aT               `noun`       {- jibArap -}        [ "bone setting" ],

    -- ;; jabiyrap_1
    -- jbyr    jabiyr  Napdu   splint
    -- jbA}r   jabA}ir Ndip    splints

    FaCIL |< aT               `noun`       {- jabiyrap -}       [ "splint", "splints" ],
    ...
    MuFaCCiL                  `noun`       {- mujab~ir -}       [ "bone setter" ],
    ...
    FaCY                      `verb`       {- jabaY-i -}        [ "collect", "levy", "be collected", "be levied" ]
                              `imperf`     FCiL
                              {- `others` [ "^gbiy IV_0hAnn", "^gbY IV_0_Pass_yu", "^gabA PV_h" ] -},
    ...
    IFtaCY                    `verb`       {- {ijotabaY -}      [ "choose", "elect", "be chosen", "be elected" ]
                              {- `others` [ "^gtabY IV_0_Pass_yu", "^gtabiy IV_0hAnn" ] -},
 ...
 |> "^g d '" <| [
    ...
    IstiFCAL                  `noun`       {- {isotijodA' -}    [ "plea", "supplication", "pleas", "supplications" ] ]
 ...
 |> "^g d ^g d" <| [
    ...
    KuRDuS                    `noun`       {- judojud -}        [ "cricket", "crickets" ]
                              `plural`     KaRADiS
 ...
 |> "^g d _t" <| [
    ...
    FaCaL                     `noun`       {- jadav -}          [ "grave", "tomb", "graves", "tombs" ]
                              `plural`     HaFCAL
                              {- `others` [ "'a^gdA_t N" ] -} ]
 ...
 |> "^g d b" <| [
    ...
    HaFCaL                    `verb`       {- Oajodab -}        [ "be barren", "explode in the barrel" ]
                              {- `others` [ "^gdib IV_intr_yu" ] -},
 ...
 |> "^g d d" <| [
    ...
    IstaFaCL                  `verb`       {- {isotajad~ -}     [ "be new", "consider as new" ]
                              {- `others` [ "ista^gdad PV_C_intr" ] -},
    ...
    FaCL                      `noun`       {- jad~ -}           [ "good luck" ],

    -- ;; juduwd_1
    -- jdwd    juduwd  N       good luck

    FuCUL                     `noun`       {- juduwd -}         [ "good luck" ],
    ...
    HaFaCL                    `noun`       {- Oajad~ -}         [ "newer", "more serious" ],
 ...
 |> "^g d l" <| [
    ...
    FaCiL                     `verb`       {- jadil-a -}        [ "broaden out", "grow", "be reinforced" ]
                              `imperf`     FCaL
                              {- `others` [ "^gdal IV" ] -},
    ...
    FaCIL |< aT               `noun`       {- jadiylap -}       [ "braid", "tress", "braids", "tresses" ],
 ...
 |> "^g d m" <| [
    ...
    FaCA                      `verb`       {- jadA-u -}         [ "bestow", "be bestown" ]
                              `imperf`     FCuL
                              {- `others` [ "^gduw IV_0hAnn", "^gdY IV_0_Pass_yu" ] -},
    ...
    HaFCY                     `verb`       {- OajodaY -}        [ "be useful" ]
                              {- `others` [ "^gdiy IV_0hAnn_yu", "^gdY IV_0_Pass_yu" ] -},
    ...
    IstaFCY                   `verb`       {- {isotajodaY -}    [ "implore", "beg", "be implored", "be begged" ],
    ...
    IstiFCA'                  `noun`       {- {isotijodA' -}    [ "plea", "supplication", "pleas", "supplications" ],
 ...
 |> "^g d r" <| [
    ...
    FaCiL                     `verb`       {- jadir-a -}        [ "have smallpox" ]
                              `imperf`     FCaL
                              {- `others` [ "^gdar IV" ] -},
    ...
    FaCCaL                    `verb`       {- jad~ar -}         [ "have smallpox" ]
                              {- `others` [ "^gaddir IV_yu" ] -},
    ...
    HaFCaL                    `verb`       {- Oajodar -}        [ "make worthy", "become worthy" ]
                              {- `others` [ "^gdir IV_yu" ] -},
    ...
    MaFCUL                    `noun`       {- majoduwr -}       [ "having smallpox", "pock-marked" ],

    -- ;; mujad~ar_1
    -- mjdr    mujad~ar        Nall    having smallpox;pock-marked

    MuFaCCaL                  `noun`       {- mujad~ar -}       [ "having smallpox", "pock-marked" ],

    -- ;; mujad~arap_1
    -- mjdr    mujad~ar        Nap     mujaddara (cracked wheat cooked with lentils & browned candied onions)

    MuFaCCaL |< aT            `noun`       {- mujad~arap -}     [ "mujaddara (cracked wheat cooked with lentils & browned candied onions)" ] ]
 ...
 |> "^g f '" <| [
    ...
    FaCaL                     `verb`       {- jafaO-a -}        [ "form dross", "deposit debris" ]
                              `imperf`     FCaL
                              {- `others` [ "^gfa' IV IV_wn IV_yn" ] -},
 ...
 |> "^g f f" <| [
    ...
    FaCCaL                    `verb`       {- jaf~af -}         [ "be dry", "make dry", "dehydrate" ]
                              {- `others` [ "^gaffif IV_intr_yu" ] -},

    -- ;; tajaf~af_1
    -- tjff    tajaf~af        PV_intr be dried;become dry
    -- tjff    tajaf~af        IV_intr be dried;become dry

    TaFaCCaL                  `verb`       {- tajaf~af -}       [ "be dried", "become dry" ],
    ...
    IFtaCL                    `verb`       {- {ijotaf~ -}       [ "be dehydrated", "make dry" ]
                              {- `others` [ "^gtafif IV_C_intr", "i^gtafaf PV_C_intr", "^gtaff IV_V_intr" ] -},
 ...
 |> "^g f l" <| [
    ...
    HaFCaL                    `verb`       {- Oajofal -}        [ "bolt", "be startled" ]
                              {- `others` [ "^gfil IV_yu" ] -},
 ...
 |> "^g f n" <| [
    ...
    FaCL                      `noun`       {- jafon -}          [ "eyelid", "eyelids" ]
                              `plural`     FuCUL
                              `plural`     HaFCAL
    ...
    FACY                      `verb`       {- jAfaY -}          [ "avoid", "offend", "be avoided", "be offended" ]
                              {- `others` [ "^gAfiy IV_0hAnn_yu" ] -},
    ...
    TaFACY                    `verb`       {- tajAfaY -}        [ "shun", "be rude" ],
 ...
 |> "^g h .d" <| [
    ...
    HaFCaL                    `verb`       {- OajohaD -}        [ "abort", "miscarry", "be aborted", "be miscarried" ]
                              {- `others` [ "^ghi.d IV_yu", "^gha.d IV_Pass_yu" ] -},

    -- ;; jihoD_1
    -- jhD     jihoD   N       miscarried fetus

    FiCL                      `noun`       {- jihoD -}          [ "miscarried fetus" ],

    -- ;; jahiyD_1
    -- jhyD    jahiyD  Nall    miscarried fetus

    FaCIL                     `noun`       {- jahiyD -}         [ "miscarried fetus" ],
 ...
 |> "^g h b _d" <| [
    ...
    KaRDaS                    `noun`       {- jahoba* -}        [ "brilliant", "erudite", "genius" ]
                              ...
                              `plural`     KiRDIS |< aT
                              `plural`     KaRADiS |< aT
                              {- `others` [ "^gihbi_d N/ap", "^gihbiy_d N/ap", "^gahAbi_d Nap" ] -} ]
 ...
 |> "^g h d" <| [
    ...
    IFtaCaL                   `verb`       {- {ijotahad -}      [ "work hard", "strive" ]
                              {- `others` [ "^gtahid IV" ] -},
    ...
    FaCIL                     `noun`       {- jahiyd -}         [ "sought", "worked hard for" ],
    ...
    FiCAL |< Iy               `adj`        {- jihAdiy~ -}       [ "Jihadist", "holy warfare" ],
    ...
    IFtiCAL                   `noun`       {- {ijotihAd -}      [ "effort", "independent thinking" ],
    ...
    MaFCUL                    `adj`        {- majohuwd -}       [ "efforts", "endeavors", "expended (efforts)" ],
 ...
 |> "^g h l" <| [
    ...
    FaCCaL                    `verb`       {- jah~al -}         [ "call stupid", "stupefy" ]
                              {- `others` [ "^gahhil IV_yu" ] -},
    ...
    IstaFCaL                  `verb`       {- {isotajohal -}    [ "consider ignorant" ],
    ...
    MaFCaL                    `noun`       {- majohal -}        [ "unknown territory" ]
                              `plural`     MaFACiL
 ...
 |> "^g h m" <| [
    ...
    HaFCaL                    `verb`       {- Oajoham -}        [ "frown", "be gloomy" ]
                              {- `others` [ "^ghim IV_yu" ] -},
    ...
    TaFaCCaL                  `verb`       {- tajah~am -}       [ "scowl", "be gloomy" ],
 ...
 |> "^g h r" <| [
    ...
    FaCuL                     `verb`       {- jahur-u -}        [ "be loud", "be audible" ]
                              `imperf`     FCuL
                              {- `others` [ "^ghur IV_intr" ] -},
    ...
    FaCL |< Iy                `adj`        {- jahoriy~ -}       [ "public", "out-loud" ],
    ...
    MiFCAL                    `noun`       {- mijohAr -}        [ "loud-voiced", "megaphone", "megaphones" ],
 ...
 |> "^g h w r" <| [
    ...
    KaRDaS                    `verb`       {- jahowar -}        [ "talk out loud" ]
                              {- `others` [ "^gahwir IV_yu" ] -},
 ...
 |> "^g h z" <| [
    ...
    FaCaL                     `verb`       {- jahaz-a -}        [ "finish off", "give a coup de grace" ]
                              `imperf`     FCaL
                              {- `others` [ "^ghaz IV" ] -},
    ...
    HaFCaL                    `verb`       {- Oajohaz -}        [ "finish off", "give a coup de grace" ]
                              {- `others` [ "^ghiz IV_yu" ] -},
    ...
    TaFaCCaL                  `verb`       {- tajah~az -}       [ "be equipped", "be furnished", "get ready" ],
 ...
 |> "^g l '" <| [
    ...
    IFtiCAL                   `noun`       {- {ijotilA' -}      [ "unveiling", "revelation", "unveilings", "revelations" ],
    ...
    IstiFCAL                  `noun`       {- {isotijolA' -}    [ "clarification", "elucidation", "clarifications" ] ]
 ...
 |> "^g l .h" <| [
    ...
    FaCiL                     `verb`       {- jaliH-a -}        [ "become bald", "lose hair" ]
                              `imperf`     FCaL
 ...
 |> "^g l .t" <| [
    ...
    FuCL |< aT                `noun`       {- juloTap -}        [ "clot", "clots" ]
                              `plural`     FaCaL |< At
                              {- `others` [ "^gala.t NAt" ] -},
 ...
 |> "^g l ^g l" <| [
    ...
    KaRDaS                    `verb`       {- jalojal -}        [ "resound", "reverberate", "rattle" ]
                              {- `others` [ "^gal^gil IV_yu" ] -},

    -- ;; julojul_1
    -- jljl    julojul Ndu     bell;jingle
    -- jlAjl   jalAjil Ndip    bells;jingles

    KuRDuS                    `noun`       {- julojul -}        [ "bell", "jingle", "bells", "jingles" ]
                              `plural`     KaRADiS
 ...
 |> "^g l b" <| [
    ...
    HaFCaL                    `verb`       {- Oajolab -}        [ "earn", "acquire", "be earned", "be acquired" ]
                              {- `others` [ "^glib IV_yu", "^glab IV_Pass_yu" ] -},
    ...
    InFaCaL                   `verb`       {- {inojalab -}      [ "be brought", "be procured" ]
                              {- `others` [ "n^galib IV_intr" ] -},
    ...
    IFtaCaL                   `verb`       {- {ijotalab -}      [ "bring", "procure" ]
                              {- `others` [ "^gtalib IV" ] -},
    ...
    IstaFCaL                  `verb`       {- {isotajolab -}    [ "attract", "fetch" ],

    -- ;; julAb_1
    -- jlAb    julAb   N       rose water;julep

    FuCAL                     `noun`       {- julAb -}          [ "rose water", "julep" ],

    -- ;; jul~Ab_1
    -- jlAb    jul~Ab  N       rose water;julep

    FuCCAL                    `noun`       {- jul~Ab -}         [ "rose water", "julep" ],
    ...
    FaCCAL |< Iy |< aT        `noun`       {- jal~Abiy~ap -}    [ "gallabiya (gown)" ],

    -- ;; >ajolab_2
    -- >jlb    >ajolab Nel     more/most attractive
    -- Ajlb    >ajolab Nel     more/most attractive

    HaFCaL                    `noun`       {- Oajolab -}        [ "more/most attractive" ],

    -- ;; majolabap_1
    -- mjlb    majolab Napdu   cause;motive
    -- mjAlb   majAlib Ndip    causes;motives

    MaFCaL |< aT              `noun`       {- majolabap -}      [ "cause", "motive", "causes", "motives" ]
                              `plural`     MaFACiL
    ...
    IstiFCAL                  `noun`       {- {isotijolAb -}    [ "acquisition", "promotion" ],
 ...
 |> "^g l b b" <| [
    ...
    TaKaRDaS                  `verb`       {- tajalobab -}      [ "be clothed", "be clad" ],
 ...
 |> "^g l b t" <| [
    ...
    KaRDUS                    `noun`       {- jalobuwt -}       [ "boat", "boats" ]
                              `plural`     KaRADIS
 ...
 |> "^g l d" <| [
    ...
    FaCuL                     `verb`       {- jalud-u -}        [ "be steadfast" ]
                              `imperf`     FCuL
                              {- `others` [ "^glud IV_intr" ] -},
    ...
    HaFCaL                    `verb`       {- Oajolad -}        [ "freeze", "be frozen" ]
                              {- `others` [ "^glid IV_yu", "^glad IV_Pass_yu" ] -},

    -- ;; tajal~ad_1
    -- tjld    tajal~ad        PV_intr be patient;be frozen
    -- tjld    tajal~ad        IV_intr be patient;be frozen

    TaFaCCaL                  `verb`       {- tajal~ad -}       [ "be patient", "be frozen" ],

    -- ;; tajAlad_1
    -- tjAld   tajAlad PV      cross swords
    -- tjAld   tajAlad IV      cross swords

    TaFACaL                   `verb`       {- tajAlad -}        [ "cross swords" ],
    ...
    FaCL |< aT                `noun`       {- jalodap -}        [ "lash", "lashes" ]
                              `plural`     FaCaL |< At
                              {- `others` [ "^galad NAt" ] -},
    ...
    FaCCAL                    `noun`       {- jal~Ad -}         [ "leather merchant" ],
 ...
 |> "^g l f" <| [
    ...
    InFaCaL                   `verb`       {- {inojalaf -}      [ "be scratched", "be grazed" ]
                              {- `others` [ "n^galif IV_intr" ] -},
 ...
 |> "^g l l" <| [
    ...
    HaFaCL                    `verb`       {- Oajal~ -}         [ "venerate" ]
                              {- `others` [ "^glil IV_C_yu", "^gill IV_V_yu", "'a^glal PV_C" ] -},

    -- ;; tajal~al_1
    -- tjll    tajal~al        PV_intr be superior
    -- tjll    tajal~al        IV_intr be superior

    TaFaCCaL                  `verb`       {- tajal~al -}       [ "be superior" ],
    ...
    TaFACL                    `verb`       {- tajAl~ -}         [ "be superior" ]
                              {- `others` [ "ta^gAlal PV_C_intr" ] -},
    ...
    IstaFaCL                  `verb`       {- {isotajal~ -}     [ "be great", "be exalted" ]
                              {- `others` [ "ista^glal PV_C_intr" ] -},
    ...
    FuCLY                     `noun`       {- jul~aY -}         [ "feat", "exploit", "feats", "exploits" ]
                              `plural`     FuCaL
                              {- `others` [ "^gulal N" ] -},
    ...
    FaCAL |< aT               `noun`       {- jalAlap -}        [ "His/Her Majesty" ],
    ...
    FaCLY                     `verb`       {- jal~aY -}         [ "make clear", "reveal", "represent", "be made clear", "be revealed", "be represented" ]
                              {- `others` [ "^galliy IV_0hAnn_yu", "^gall IV_0hwnyn_yu PV_ttAw" ] -},
 ...
 |> "^g l m d" <| [
    ...
    TaKaRDaS                  `verb`       {- tajalomad -}      [ "be petrified" ],

    -- ;; jalomad_1
    -- jlmd    jalomad Ndu     boulder;rock
    -- jlAmd   jalAmid Ndip    boulders;rocks

    KaRDaS                    `noun`       {- jalomad -}        [ "boulder", "rock", "boulders", "rocks" ]
                              `plural`     KaRADiS
                              {- `others` [ "^galAmid Ndip" ] -},
    ...
    KuRDUS                    `noun`       {- julomuwd -}       [ "boulder", "rock", "boulders", "rocks" ]
                              `plural`     KaRADIS
 ...
 |> "^g l s" <| [
    ...
    HaFCaL                    `verb`       {- Oajolas -}        [ "seat", "make sit", "be seated", "be made to sit" ]
                              {- `others` [ "^glas IV_Pass_yu", "^glis IV_yu" ] -},
    ...
    MuFACaL |< aT             `noun`       {- mujAlasap -}      [ "social intercourse" ],
 ...
 |> "^g l w" <| [
    ...
    FaCA                      `verb`       {- jalA-u -}         [ "make clear", "shine", "depart", "be made clear" ]
                              `imperf`     FCuL
                              {- `others` [ "^glY IV_0_Pass_yu", "^gluw IV_0hAnn", "^galaw PV_Atn" ] -},
    ...
    FaCY                      `verb`       {- jalaY-i -}        [ "polish", "burnish", "be polished", "be burnished" ]
                              `imperf`     FCiL
                              {- `others` [ "^glY IV_0_Pass_yu", "^gliy IV_0hAnn", "^galA PV_h" ] -},
    ...
    HaFCY                     `verb`       {- OajolaY -}        [ "oust", "evacuate", "clear", "be ousted", "be evacuated", "be cleared" ]
                              {- `others` [ "^glY IV_0_Pass_yu", "^gliy IV_0hAnn_yu" ] -},
    ...
    InFaCY                    `verb`       {- {inojalaY -}      [ "be cleaned", "be polished", "be ousted" ]
                              {- `others` [ "n^galY IV_0_Pass_yu", "n^galiy IV_0hAnn" ] -},
    ...
    IFtaCY                    `verb`       {- {ijotalaY -}      [ "reveal", "disclose", "be revealed", "be disclosed" ]
                              {- `others` [ "^gtalY IV_0_Pass_yu", "^gtaliy IV_0hAnn" ] -},
    ...
    IstaFCY                   `verb`       {- {isotajolaY -}    [ "seek to clarify", "discover", "clarify", "be discovered", "be clarified" ],
    ...
    IFtiCA'                   `noun`       {- {ijotilA' -}      [ "unveiling", "revelation", "unveilings", "revelations" ],
    ...
    IstiFCA'                  `noun`       {- {isotijolA' -}    [ "clarification", "elucidation", "clarifications" ],
 ...
 |> "^g m .h" <| [
    ...
    FaCaL                     `verb`       {- jamaH -}          [ "be defiant", "be obstinate" ]
                              {- `others` [ "^gma.h IV_intr" ] -},
 ...
 |> "^g m `" <| [
    ...
    IFtaCaL                   `verb`       {- {ijotamaE -}      [ "meet", "confer" ]
                              {- `others` [ "^gtami` IV" ] -},
    ...
    IstaFCaL                  `verb`       {- {isotajomaE -}    [ "gather", "summarize" ],
    ...
    IFtiCAL                   `noun`       {- {ijotimAE -}      [ "meeting", "gathering", "meetings", "gatherings" ],
    ...
    MuFCaL                    `noun`       {- mujomaE -}        [ "unanimous", "in agreement" ],
 ...
 |> "^g m d" <| [
    ...
    InFaCaL                   `verb`       {- {inojamad -}      [ "freeze" ]
                              {- `others` [ "n^gamid IV_intr" ] -},
    ...
    InFiCAL                   `noun`       {- {inojimAd -}      [ "freezing" ],
 ...
 |> "^g m l" <| [
    ...
    FACaL                     `verb`       {- jAmal -}          [ "be courteous", "be amiable" ]
                              {- `others` [ "^gAmil IV_intr_yu" ] -},
    ...
    HaFCaL                    `verb`       {- Oajomal -}        [ "add", "summarize", "be added", "be summarized" ]
                              {- `others` [ "^gmal IV_Pass_yu", "^gmil IV_yu" ] -},

    -- ;; tajam~al_1
    -- tjml    tajam~al        PV      adorn oneself
    -- tjml    tajam~al        IV      adorn oneself

    TaFaCCaL                  `verb`       {- tajam~al -}       [ "adorn oneself" ],

    -- ;; tajAmal_1
    -- tjAml   tajAmal PV_intr be courteous
    -- tjAml   tajAmal IV_intr be courteous

    TaFACaL                   `verb`       {- tajAmal -}        [ "be courteous" ],
    ...
    FaCCAL                    `noun`       {- jam~Al -}         [ "camel driver" ],
 ...
 |> "^g m m" <| [
    ...
    FaCCaL                    `verb`       {- jam~am -}         [ "grow", "fill up" ]
                              {- `others` [ "^gammim IV_yu" ] -},
    ...
    TaFaCCaL                  `verb`       {- tajam~am -}       [ "grow exuberantly" ],
    ...
    IstaFaCL                  `verb`       {- {isotajam~ -}     [ "recover", "relax", "rest" ]
                              {- `others` [ "ista^gmam PV_C" ] -},
    ...
    IstiFCAL                  `noun`       {- {isotijomAm -}    [ "relaxation", "recreation" ],

    -- ;; {isotijomAmiy~_1
    -- <stjmAmy        {isotijomAmiy~  Nall    recreational;relaxing
    -- AstjmAmy        {isotijomAmiy~  Nall    recreational;relaxing

    IstiFCAL |< Iy            `adj`        {- {isotijomAmiy~ -} [ "recreational", "relaxing" ] ]
 ...
 |> "^g m r" <| [
    ...
    IFtaCaL                   `verb`       {- {ijotamar -}      [ "burn incense" ]
                              {- `others` [ "^gtamir IV" ] -},
    ...
    FaCL                      `noun`       {- jamor -}          [ "embers", "ember", "pebble", "pebbles" ]
                              `plural`     FaCaL |< At
                              {- `others` [ "^gamar NAt" ] -},
    ...
    FuCCAL                    `noun`       {- jum~Ar -}         [ "palm core" ],

    -- ;; mijomarap_1
    -- mjmr    mijomar Napdu   brazier
    -- mjAmr   majAmir Ndip    braziers

    MiFCaL |< aT              `noun`       {- mijomarap -}      [ "brazier", "braziers" ]
                              `plural`     MaFACiL
 ...
 |> "^g m r k" <| [
    ...
    MuKaRDaS                  `noun`       {- mujamorak -}      [ "duty paid" ] ]
 ...
 |> "^g m s" <| [
    ...
    FACUL |< aT               `noun`       {- jAmuwsap -}       [ "buffalo cow", "buffaloes" ]
                              `plural`     FawACIL
 ...
 |> "^g n .h" <| [
    ...
    FaCCaL                    `verb`       {- jan~aH -}         [ "incline", "give wings" ]
                              {- `others` [ "^ganni.h IV_yu" ] -},
    ...
    HaFCaL                    `verb`       {- OajonaH -}        [ "be inclined", "tend", "be stranded" ]
                              {- `others` [ "^gni.h IV_intr_yu" ] -},
    ...
    FuCL |< aT                `noun`       {- junoHap -}        [ "misdemeanor", "misdemeanors" ]
                              `plural`     FuCaL
                              {- `others` [ "^guna.h N" ] -},
    ...
    HaFCaL                    `noun`       {- OajonaH -}        [ "more/most inclined" ],
    ...
    FACiL                     `noun`       {- jAniH -}          [ "wing", "flank", "wings", "flanks" ]
                              `plural`     FawACiL
    ...
    FACiL |< aT               `noun`       {- jAniHap -}        [ "rib", "ribs", "inside", "heart", "soul" ]
                              `plural`     FawACiL
                              {- `others` [ "^gawAni.h Ndip" ] -},
 ...
 |> "^g n b" <| [
    ...
    FaCL |< aT                `noun`       {- janobap -}        [ "side", "sides" ]
                              `plural`     FaCaL |< At
                              {- `others` [ "^ganab NAt" ] -},
    ...
    FaCAL                     `noun`       {- janAb -}          [ "Right Honorable" ],

    -- ;; janAbap_1
    -- jnAb    janAb   Nap     ritual impurity

    FaCAL |< aT               `noun`       {- janAbap -}        [ "ritual impurity" ],
    ...
    FaCCAL |< Iy |< aT        `noun`       {- jan~Abiy~ap -}    [ "embankment", "side channel" ],
    ...
    IFtiCAL                   `noun`       {- {ijotinAb -}      [ "avoidance" ],

    -- ;; mujan~ibap_1
    -- mjnb    mujan~ib        NapAt   flank;wing (mil.)

    MuFaCCiL |< aT            `noun`       {- mujan~ibap -}     [ "flank", "wing (mil.)" ] ]
 ...
 |> "^g n b n" <| [
    ...
    KaRDUS                    `noun`       {- janobuwn -}       [ "ham (Fr. jambon)" ] ]
 ...
 |> "^g n d" <| [
    ...
    TaFaCCaL                  `verb`       {- tajan~ad -}       [ "be recruited", "be enlisted", "be mobilized" ],
    ...
    FuCL |< Iy |< aT          `noun`       {- junodiy~ap -}     [ "militarism", "military art" ],
    ...
    TaFaCCuL                  `noun`       {- tajan~ud -}       [ "military service" ],
 ...
 |> "^g n d b" <| [
    ...
    KuRDuS                    `noun`       {- junodub -}        [ "grasshopper", "grasshoppers" ]
                              `plural`     KaRADiS
                              {- `others` [ "^ganAdib Ndip" ] -} ]
 ...
 |> "^g n d l" <| [
    ...
    KaRDaS                    `verb`       {- janodal -}        [ "bring down", "fell" ]
                              {- `others` [ "^gandil IV_yu" ] -},
    ...
    KaRDaS                    `noun`       {- janodal -}        [ "cataract", "cataracts" ]
                              `plural`     KaRADiS
                              {- `others` [ "^ganAdil Ndip" ] -},
    ...
    KuRDUS                    `noun`       {- junoduwl -}       [ "gondola", "gondolas" ]
                              `plural`     KaRADIS
 ...
 |> "^g n d r" <| [
    ...
    KiRDAS |< Iy              `adj`        {- jinodAriy~ -}     [ "standard-bearer", "cornetist", "standard-bearers", "cornetists" ]
                              `plural`     KaRADiS |< aT
                              {- `others` [ "^ganAdir Nap" ] -} ]
 ...
 |> "^g n k" <| [
    ...
    FuCL |< Iy                `adj`        {- junokiy~ -}       [ "harpist", "harpists" ] ]
 ...
 |> "^g n n" <| [
    ...
    FaCCaL                    `verb`       {- jan~an -}         [ "drive insane", "make crazy", "infuriate" ]
                              {- `others` [ "^gannin IV-n_yu" ] -},
    ...
    HaFaCL                    `verb`       {- Oajan~ -}         [ "cover", "conceal" ]
                              {- `others` [ "^gnin IV_C_yu", "'a^gnan PV_Cn", "^ginn IV_V_yu" ] -},

    -- ;; tajan~an_1
    -- tjnn    tajan~an        PV-n    go crazy;become insane
    -- tjnn    tajan~an        IV-n    go crazy;become insane

    TaFaCCaL                  `verb`       {- tajan~an -}       [ "go crazy", "become insane" ],
    ...
    IstaFaCL                  `verb`       {- {isotajan~ -}     [ "regard as crazy", "be covered", "be concealed" ]
                              {- `others` [ "ista^gnan PV_Cn" ] -},
    ...
    FuCayL |< aT              `noun`       {- junayonap -}      [ "garden", "gardens" ],
    ...
    MiFaCL                    `noun`       {- mijan~ -}         [ "shield", "shields" ]
                              `plural`     MaFACL
                              {- `others` [ "ma^gAnn Ndip" ] -},
 ...
 |> "^g n q" <| [
    ...
    FaCaL                     `verb`       {- janaq-i -}        [ "catapult", "be catapulted" ]
                              `imperf`     FCiL
 ...
 |> "^g n s" <| [
    ...
    FACaL                     `verb`       {- jAnas -}          [ "be related to", "be of same kind as" ]
                              {- `others` [ "^gAnis IV_yu" ] -},
    ...
    FiCL                      `noun`       {- jinos -}          [ "type", "kind", "types", "kinds" ]
                              `plural`     HaFCAL
                              {- `others` [ "'a^gnAs N" ] -},
 ...
 |> "^g n w" <| [
    ...
    IFtaCY                    `verb`       {- {ijotanaY -}      [ "gather", "harvest" ]
                              {- `others` [ "^gtaniy IV_0hAnn", "^gtanY IV_0" ] -},
    ...
    MaFCY                     `noun`       {- majonaY -}        [ "crop", "harvest", "crops", "harvests" ]
                              `plural`     MaFACI
 ...
 |> "^g n z" <| [
    ...
    FuCCAL                    `noun`       {- jun~Az -}         [ "funeral", "funerals" ]
                              `plural`     FaCACIL
 ...
 |> "^g n z r" <| [
    ...
    KaRDaS                    `verb`       {- janozar -}        [ "be verdigris" ]
                              {- `others` [ "^ganzir IV_intr_yu" ] -},
    ...
    KiRDIS                    `noun`       {- jinoziyr -}       [ "chain", "track", "chains", "tracks" ]
                              `plural`     KaRADIS
    ...
    KiRDIS                    `noun`       {- jinoziyr -}       [ "jinzeer (c. 20 meters)", "jinzeers (c. 20 meters)" ]
                              `plural`     KaRADIS
                              {- `others` [ "^ganAziyr Ndip" ] -},
    ...
    MuKaRDaS                  `noun`       {- mujanozar -}      [ "tracked", "having tracks (vehicle)" ] ]
 ...
 |> "^g r '" <| [
    ...
    IFtaCaL                   `verb`       {- {ijotaraO -}      [ "be daring" ]
                              {- `others` [ "^gtari' IV_intr" ] -},
 ...
 |> "^g r .d" <| [
    ...
    FaCiL                     `verb`       {- jariD-a -}        [ "choke", "be upset", "be moved" ]
                              `imperf`     FCaL
                              {- `others` [ "^gra.d IV" ] -},
    ...
    HaFCaL                    `verb`       {- OajoraD -}        [ "alarm", "unnerve", "be alarmed", "be unnerved" ]
                              {- `others` [ "^gra.d IV_Pass_yu", "^gri.d IV_yu" ] -},
 ...
 |> "^g r .h" <| [
    ...
    InFaCaL                   `verb`       {- {inojaraH -}      [ "be wounded", "be injured" ]
                              {- `others` [ "n^gari.h IV_intr" ] -},
 ...
 |> "^g r ^s" <| [
    ...
    FACUL |< aT               `noun`       {- jAruw$ap -}       [ "quern", "hand mill", "querns", "hand mills" ]
                              `plural`     FawACIL
    ...
    FaCaL                     `noun`       {- jara$ -}          [ "Jerash", "Jarash (Jor.)" ] ]
 ...
 |> "^g r _t m" <| [
    ...
    TaKaRDaS                  `verb`       {- tajarovam -}      [ "take root", "germinate" ],
 ...
 |> "^g r `" <| [
    ...
    IFtaCaL                   `verb`       {- {ijotaraE -}      [ "swallow", "gulp down" ]
                              {- `others` [ "^gtari` IV" ] -},
 ...
 |> "^g r b" <| [
    ...
    FaCiL                     `verb`       {- jarib-a -}        [ "be mangy", "fade" ]
                              `imperf`     FCaL
                              {- `others` [ "^grab IV_intr" ] -},
    ...
    HaFCaL                    `noun`       {- Oajorab -}        [ "mangy", "scabby" ]
                              ...
                              `plural`     FuCL
                              `plural`     FaCLA'
                              {- `others` [ "^garbAn N/ap", "^gurb N", "^garbA' Nh N0_Nh Nhy" ] -},
    ...
    FiCAL                     `noun`       {- jirAb -}          [ "sack", "case", "sacks", "cases" ]
                              `plural`     HaFCiL |< aT
                              `plural`     FuCuL
                              {- `others` [ "'a^grib Nap", "^gurub N" ] -},
    ...
    FaCIL                     `noun`       {- jariyb -}         [ "patch of land" ],
 ...
 |> "^g r b _d" <| [
    ...
    KuRDuS                    `noun`       {- jurobu* -}        [ "impostor", "swindler", "impostors", "swindlers" ]
                              `plural`     KaRADiS |< aT
                              {- `others` [ "^garAbi_d Nap" ] -} ]
 ...
 |> "^g r b `" <| [
    ...
    KaRDUS                    `noun`       {- jarobuwE -}       [ "jerboa", "jerboas" ]
                              `plural`     KaRADIS
                              {- `others` [ "^garAbiy` Ndip" ] -} ]
 ...
 |> "^g r b z" <| [
    ...
    KuRDuS                    `noun`       {- jurobuz -}        [ "impostor", "swindler", "impostors", "swindlers" ]
                              `plural`     KaRADiS |< aT
                              {- `others` [ "^garAbiz Nap" ] -} ]
 ...
 |> "^g r d" <| [
    ...
    FaCaL                     `verb`       {- jarad-u -}        [ "remove", "strip", "take stock" ]
                              `imperf`     FCuL
                              {- `others` [ "^grud IV" ] -},
    ...
    FaCAL                     `noun`       {- jarAd -}          [ "locusts", "locust" ],

    -- ;; jariyd_1
    -- jryd    jariyd  N       palm branches;javelin

    FaCIL                     `noun`       {- jariyd -}         [ "palm branches", "javelin" ],
    ...
    FuCUL                     `noun`       {- juruwd -}         [ "barren areas" ] ]
 ...
 |> "^g r d l" <| [
    ...
    KaRDaS                    `noun`       {- jarodal -}        [ "bucket", "pail", "buckets", "pails" ]
                              `plural`     KaRADiS
                              {- `others` [ "^garAdil Ndip" ] -} ]
 ...
 |> "^g r f" <| [
    ...
    FaCCaL                    `verb`       {- jar~af -}         [ "carry away", "wash away" ]
                              {- `others` [ "^garrif IV_yu" ] -},
    ...
    InFaCaL                   `verb`       {- {inojaraf -}      [ "be swept away", "be carried away" ]
                              {- `others` [ "n^garif IV_intr" ] -},
    ...
    IFtaCaL                   `verb`       {- {ijotaraf -}      [ "carry away", "wash away", "tear out" ]
                              {- `others` [ "^gtarif IV" ] -},
    ...
    FuCL                      `noun`       {- jurof -}          [ "bluff", "cliff", "bluffs", "cliffs" ]
                              `plural`     FuCUL
                              {- `others` [ "^guruwf N" ] -},
    ...
    MiFCaL |< aT              `noun`       {- mijorafap -}      [ "shovel", "trowel", "scoop", "shovels", "scoops" ]
                              `plural`     MaFACIL
                              `plural`     MiFCAL
 ...
 |> "^g r k s" <| [
    ...
    KaRDaS |< Iy              `adj`        {- jarokasiy~ -}     [ "Circassian", "Circassians" ]
                              `plural`     KaRADiS |< aT
                              {- `others` [ "^garAkis Nap" ] -} ]
 ...
 |> "^g r m" <| [
    ...
    HaFCaL                    `verb`       {- Oajoram -}        [ "commit a crime", "sin", "do wrong", "be sinned against", "be done wrong" ]
                              {- `others` [ "^grim IV_yu", "^gram IV_Pass_yu" ] -},
    ...
    IFtaCaL                   `verb`       {- {ijotaram -}      [ "incriminate" ]
                              {- `others` [ "^gtarim IV" ] -},
    ...
    FaCL                      `noun`       {- jarom -}          [ "barge", "barges", "crimes" ]
                              `plural`     FuCUL
                              {- `others` [ "^guruwm N" ] -},
    ...
    FiCL                      `noun`       {- jirom -}          [ "body", "bulk", "mass", "bodies", "crimes" ]
                              `plural`     HaFCAL
                              {- `others` [ "'a^grAm N" ] -},
 ...
 |> "^g r n l" <| [
    ...
    KuRDAS                    `noun`       {- juronAl -}        [ "journal", "newspaper", "journals", "newspapers" ]
                              `plural`     KaRADIS
 ...
 |> "^g r r" <| [
    ...
    HaFaCL                    `verb`       {- Oajar~ -}         [ "ruminate" ]
                              {- `others` [ "^grir IV_C_yu", "^girr IV_V_yu", "'a^grar PV_C" ] -},
    ...
    InFaCL                    `verb`       {- {inojar~ -}       [ "be pulled", "be dragged", "be towed" ]
                              {- `others` [ "n^garr IV_V_intr", "in^garar PV_C_intr", "n^garir IV_C_intr" ] -},
    ...
    IFtaCL                    `verb`       {- {ijotar~ -}       [ "ruminate", "repeat" ]
                              {- `others` [ "^gtarir IV_C", "^gtarr IV_V", "i^gtarar PV_C" ] -},
    ...
    FACUL                     `noun`       {- jAruwr -}         [ "drawer", "drawers" ]
                              `plural`     FawACIL
    ...
    InFiCAL |< Iy             `adj`        {- {inojirAriy~ -}   [ "towage" ],
    ...
    MaFCUL                    `noun`       {- majoruwr -}       [ "drain", "sewer", "drains", "sewers" ]
                              `plural`     MaFACIL
 ...
 |> "^g r s" <| [
    ...
    FaCCaL                    `verb`       {- jar~as -}         [ "make inure", "sorely try", "discredit" ]
                              {- `others` [ "^garris IV_yu" ] -},
 ...
 |> "^g r z" <| [
    ...
    FaCaL                     `verb`       {- jaraz-u -}        [ "annihilate", "cut off" ]
                              `imperf`     FCuL
                              {- `others` [ "^gruz IV" ] -},
    ...
    FuCL |< aT                `noun`       {- jurozap -}        [ "bundle", "ponytail", "bundles", "ponytails" ]
                              `plural`     FuCaL
                              {- `others` [ "^guraz N" ] -} ]
 ...
 |> "^g s m" <| [
    ...
    FaCuL                     `verb`       {- jasum-u -}        [ "be large", "be bulky" ]
                              `imperf`     FCuL
                              {- `others` [ "^gsum IV_intr" ] -},
    ...
    TaFaCCaL                  `verb`       {- tajas~am -}       [ "take shape", "be materialized" ],
    ...
    HaFCaL                    `noun`       {- Oajosam -}        [ "larger", "more corpulent" ],
 ...
 |> "^g s r" <| [
    ...
    IFtaCaL                   `verb`       {- {ijotasar -}      [ "cross", "span", "traverse" ]
                              {- `others` [ "^gtasir IV" ] -},
 ...
 |> "^g s s" <| [
    ...
    IFtaCL                    `verb`       {- {ijotas~ -}       [ "feel", "handle", "reconnoiter" ]
                              {- `others` [ "i^gtasas PV_C", "^gtass IV_V", "^gtasis IV_C" ] -},
 ...
 |> "^g s w" <| [
    ...
    FaCA                      `verb`       {- jasA-u -}         [ "become hard", "become solid" ]
                              `imperf`     FCuL
                              {- `others` [ "^gsY IV_0", "^gsuw IV_0hAnn", "^gasaw PV_Atn" ] -} ]
 ...
 |> "^g t _t" <| [
    ...
    IFCaLL                    `verb`       {- {ijotav~ -}       [ "tear out", "uproot" ]
                              {- `others` [ "^gta_t_t IV_V" ] -},
    ...
    IFCiLAL                   `noun`       {- {ijotivAv -}      [ "uprooting", "tearing out" ],
 ...
 |> "^g t f" <| [
    ...
    IFCaLL                    `verb`       {- {ijotaf~ -}       [ "be dehydrated", "make dry" ]
                              {- `others` [ "^gtaff IV_V_intr" ] -} ]
 ...
 |> "^g t r" <| [
    ...
    IFCaLL                    `verb`       {- {ijotar~ -}       [ "ruminate", "repeat" ]
                              {- `others` [ "^gtarr IV_V" ] -} ]
 ...
 |> "^g t s" <| [
    ...
    IFCaLL                    `verb`       {- {ijotas~ -}       [ "feel", "handle", "reconnoiter" ]
                              {- `others` [ "^gtass IV_V" ] -} ]
 ...
 |> "^g w .h" <| [
    ...
    HaFAL                     `verb`       {- OajAH -}          [ "annihilate", "ruin", "flood", "be annihilated", "be ruined", "be flooded" ]
                              {- `others` [ "^giy.h IV_V_yu", "^gA.h IV_V_Pass_yu" ] -},
    ...
    IFtAL                     `verb`       {- {ijotAH -}        [ "invade", "be invaded" ]
                              {- `others` [ "^gtA.h IV_V" ] -},
    ...
    IFtiyAL                   `noun`       {- {ijotiyAH -}      [ "invasion", "strike" ],
 ...
 |> "^g w .t" <| [
    ...
    FaCIL |< aT               `noun`       {- jawiyTap -}       [ "dowel", "peg", "dowels", "pegs" ]
                              `plural`     FawA'iL
 ...
 |> "^g w `" <| [
    ...
    HaFAL                     `verb`       {- OajAE -}          [ "make starve", "famish", "be starved" ]
                              {- `others` [ "^gA` IV_V_Pass_yu", "^giy` IV_V_yu" ] -},
    ...
    HiFAL |< aT               `noun`       {- IijAEap -}        [ "making starve" ] ]
 ...
 |> "^g w b" <| [
    ...
    InFAL                     `verb`       {- {inojAb -}        [ "break up", "be dispelled", "fade" ]
                              {- `others` [ "n^gAb IV_V" ] -},
    ...
    IstaFAL                   `verb`       {- {isotajAb -}      [ "comply", "reply", "be complied with", "be replied to" ],
    ...
    IstaFCaL                  `verb`       {- {isotajowab -}    [ "interrogate" ],
 ...
 |> "^g w d" <| [
    ...
    IstaFAL                   `verb`       {- {isotajAd -}      [ "think well of", "approve of" ],

    -- ;; juwdap_1
    -- jwd     juwd    Nap     excellence;high quality

    FuCL |< aT                `noun`       {- juwdap -}         [ "excellence", "high quality" ],
 ...
 |> "^g w f" <| [
    ...
    FaCCaL                    `verb`       {- jaw~af -}         [ "make hollow", "hollow out" ]
                              {- `others` [ "^gawwif IV_yu" ] -},
    ...
    FaCL                      `noun`       {- jawof -}          [ "belly", "cavity", "middle", "cavities", "insides" ]
                              `plural`     HaFCAL
                              {- `others` [ "'a^gwAf N" ] -},
    ...
    MuFaCCaL                  `adj`        {- mujaw~af -}       [ "hollow", "hollowed out" ] ]
 ...
 |> "^g w h r" <| [
    ...
    TaKaRDaS                  `verb`       {- tajawohar -}      [ "become substance", "be substantiated" ],
 ...
 |> "^g w l" <| [
    ...
    HaFAL                     `verb`       {- OajAl -}          [ "circulate", "ponder", "be circulated", "be pondered" ]
                              {- `others` [ "^gAl IV_V_Pass_yu", "^giyl IV_V_yu" ] -},
 ...
 |> "^g w n" <| [
    ...
    FuCCAL |< Iy              `adj`        {- juw~Aniy~ -}      [ "inner", "interior", "intimate" ],
    ...
    FuCCAL |< Iy |< aT        `noun`       {- juw~Aniy~ap -}    [ "intimacy" ],
 ...
 |> "^g w r" <| [
    ...
    FACaL                     `verb`       {- jAwar -}          [ "be adjacent to", "be close to" ]
                              {- `others` [ "^gAwir IV_intr_yu" ] -},
    ...
    HaFAL                     `verb`       {- OajAr -}          [ "grant asylum", "protect", "be granted asylum", "be protected" ]
                              {- `others` [ "^gAr IV_V_Pass_yu", "^giyr IV_V_yu" ] -},

    -- ;; tajAwar_1
    -- tjAwr   tajAwar PV_intr be adjacent
    -- tjAwr   tajAwar IV_intr be adjacent

    TaFACaL                   `verb`       {- tajAwar -}        [ "be adjacent" ],
    ...
    IstaFAL                   `verb`       {- {isotajAr -}      [ "seek protection", "seek aid" ],
    ...
    FuCL |< aT                `noun`       {- juwrap -}         [ "pit", "hole", "pits", "holes" ]
                              `plural`     FuCaL
                              {- `others` [ "^guwar N" ] -},
 ...
 |> "^g w s" <| [
    ...
    IFtAL                     `verb`       {- {ijotAs -}        [ "search", "investigate" ]
                              {- `others` [ "^gtAs IV_V" ] -} ]
 ...
 |> "^g w s q" <| [
    ...
    KaRDaS                    `noun`       {- jawosaq -}        [ "palace", "villa", "palaces", "villas" ]
                              `plural`     KaRADiS
                              {- `others` [ "^gawAsiq Ndip" ] -} ]
 ...
 |> "^g w w" <| [
    ...
    FuCLAn |< Iy              `adj`        {- juw~Aniy~ -}      [ "inner", "interior", "intimate" ],

    -- ;; juw~Aniy~ap_1
    -- jwAny   juw~Aniy~       Nap     intimacy

    FuCLAn |< Iy |< aT        `noun`       {- juw~Aniy~ap -}    [ "intimacy" ] ]
 ...
 |> "^g w y" <| [
    ...
    TaFaCCY                   `verb`       {- tajaw~aY -}       [ "crumble" ]
                              {- `others` [ "ta^gawway PV_Atn IV_Ann" ] -},
    ...
    IFtaCY                    `verb`       {- {ijotawaY -}      [ "feel intensely" ]
                              {- `others` [ "i^gtaway PV_Atn", "^gtawY IV_0", "^gtawiy IV_0hAnn" ] -},
 ...
 |> "^g w z" <| [
    ...
    IFtAL                     `verb`       {- {ijotAz -}        [ "surmount", "overcome", "be surmounted", "be overcome" ]
                              {- `others` [ "^gtAz IV_V" ] -},
    ...
    IstaFAL                   `verb`       {- {isotajAz -}      [ "deem permissible", "ask permission" ],
    ...
    IFtiyAL                   `noun`       {- {ijotiyAz -}      [ "traversing", "overcoming" ],
 ...
 |> "^g w z l" <| [
    ...
    KaRDaS                    `noun`       {- jawozal -}        [ "pigeon", "pigeons" ]
                              `plural`     KaRADiS
                              {- `others` [ "^gawAzil Ndip" ] -} ]
 ...
 |> "^g w z m" <| [
    ...
    KaRADiS                   `noun`       {- jawAzim -}        [ "apocopating (gram.)" ] ]
 ...
 |> "^g y '" <| [
    ...
    FiCL |< aT                `noun`       {- jiy}ap -}         [ "coming", "arrival" ],
 ...
 |> "^g y .h" <| [
    ...
    IFtiCAL                   `noun`       {- {ijotiyAH -}      [ "invasion", "strike" ] ]
 ...
 |> "^g y ^s" <| [
    ...
    IstaFAL                   `verb`       {- {isotajA$ -}      [ "raise", "mobilize" ],
 ...
 |> "^g y b" <| [
    ...
    MuFiCL                    `noun`       {- mujiyb -}         [ "responding", "answering" ],

    -- ;; musotajiyb_1
    -- mstjyb  musotajiyb      Nall    responsive;answering

    MustaFiCL                 `noun`       {- musotajiyb -}     [ "responsive", "answering" ],
 ...
 |> "^g y d" <| [
    ...
    MuFiCL                    `noun`       {- mujiyd -}         [ "proficient", "efficient" ] ]
 ...
 |> "^g y f" <| [
    ...
    FaCCaL                    `verb`       {- jay~af -}         [ "be putrid", "stink" ]
                              {- `others` [ "^gayyif IV_intr_yu" ] -},

    -- ;; tajay~af_1
    -- tjyf    tajay~af        PV_intr be putrid;stink
    -- tjyf    tajay~af        IV_intr be putrid;stink

    TaFaCCaL                  `verb`       {- tajay~af -}       [ "be putrid", "stink" ],
    ...
    FiCL |< aT                `noun`       {- jiyfap -}         [ "cadaver", "cadavers" ]
                              `plural`     HaFCAL
                              `plural`     FiCaL
 ...
 |> "^g y l" <| [
    ...
    FiCL |< Iy                `adj`        {- jiyliy~ -}        [ "generational", "secular" ] ]
 ...
 |> "^g y r" <| [
    ...
    FiCL |< aT                `noun`       {- jiyrap -}         [ "neighborhood" ],

    -- ;; mujiyr_1
    -- mjyr    mujiyr  Nall    protector

    MuFiCL                    `noun`       {- mujiyr -}         [ "protector" ],
    ...
    FaCCAL                    `noun`       {- jay~Ar -}         [ "unslaked lime" ],

    -- ;; jay~Arap_1
    -- jyAr    jay~Ar  NapAt   lime kiln

    FaCCAL |< aT              `noun`       {- jay~Arap -}       [ "lime kiln" ] ]
 ...
 |> "^g y z" <| [
    ...
    IFtiCAL                   `noun`       {- {ijotiyAz -}      [ "traversing", "overcoming" ],
 ...
 |> "^g y z '" <| [
    ...
    KiRDAS |< Iy              `adj`        {- jiyzAwiy~ -}      [ "of/from Giza" ] ]
 ...
 |> "^g z '" <| [
    ...
    FaCaL                     `verb`       {- jazaO-a -}        [ "be content" ]
                              `imperf`     FCaL
                              {- `others` [ "^gza' IV_wn IV_intr IV_yn" ] -},
    ...
    IFtaCaL                   `verb`       {- {ijotazaO -}      [ "be content" ]
                              {- `others` [ "^gtazi' IV_intr" ] -},
    ...
    IFtiCAL                   `noun`       {- {ijotizA' -}      [ "being content", "being sufficient" ],
    ...
    FICAL |< Iy               `adj`        {- jiyzAwiy~ -}      [ "of/from Giza" ] ]
 ...
 |> "^g z `" <| [
    ...
    FaCiL                     `verb`       {- jaziE-a -}        [ "be concerned", "be worried", "regret" ]
                              `imperf`     FCaL
                              {- `others` [ "^gza` IV_intr" ] -},
    ...
    TaFaCCaL                  `verb`       {- tajaz~aE -}       [ "be broken", "break apart", "snap" ],
 ...
 |> "^g z f" <| [
    ...
    FaCaL                     `verb`       {- jazaf-u -}        [ "be reckless", "risk" ]
                              `imperf`     FCuL
                              {- `others` [ "^gzuf IV_intr" ] -},
 ...
 |> "^g z l" <| [
    ...
    FaCuL                     `verb`       {- jazul-u -}        [ "be prudent", "be considerable", "be plentiful" ]
                              `imperf`     FCuL
                              {- `others` [ "^gzul IV_intr" ] -},
    ...
    HaFCaL                    `verb`       {- Oajozal -}        [ "be generous", "give liberally", "be given liberally" ]
                              {- `others` [ "^gzal IV_Pass_yu", "^gzil IV_intr_yu" ] -},
    ...
    IFtaCaL                   `verb`       {- {ijotazal -}      [ "write shorthand" ]
                              {- `others` [ "^gtazil IV" ] -},
 ...
 |> "^g z m" <| [
    ...
    FaCaL                     `verb`       {- jazam-i -}        [ "cut short", "be certain", "impose" ]
                              `imperf`     FCiL
                              {- `others` [ "^gzim IV" ] -},
    ...
    FawACiL                   `noun`       {- jawAzim -}        [ "apocopating (gram.)" ],

    -- ;; majozuwm_1
    -- mjzwm   majozuwm        Nall    cut short;clipped

    MaFCUL                    `noun`       {- majozuwm -}       [ "cut short", "clipped" ],
 ...
 |> "^g z n" <| [
    ...
    IFtiCA'                   `noun`       {- {ijotizA' -}      [ "being content", "being sufficient" ],
    ...
    FaCY                      `verb`       {- jazaY-i -}        [ "reward", "repay", "requite", "be rewarded", "be repaid", "be requited" ]
                              `imperf`     FCiL
                              {- `others` [ "^gazA PV_h", "^gziy IV_0hAnn", "^gzY IV_0_Pass_yu" ] -},
    ...
    HaFCY                     `verb`       {- OajozaY -}        [ "suffice", "replace", "be replaced" ]
                              {- `others` [ "^gziy IV_0hAnn_yu", "^gzY IV_0_Pass_yu" ] -},
 ...
 |> "^g z r" <| [
    ...
    FaCL |< aT                `noun`       {- jazorap -}        [ "blood sacrifice" ],

    -- ;; jazuwr_1
    -- jzwr    jazuwr  N       slaughter camel

    FaCUL                     `noun`       {- jazuwr -}         [ "slaughter camel" ],
 ...
 |> "^g z z" <| [
    ...
    IFtaCL                    `verb`       {- {ijotaz~ -}       [ "shear", "clip" ]
                              {- `others` [ "^gtazz IV_V", "i^gtazaz PV_C", "^gtaziz IV_C" ] -},
    ...
    FiCL |< aT                `noun`       {- jiz~ap -}         [ "fleece", "shorn wool" ]
                              `plural`     FiCaL
                              {- `others` [ "^gizaz N" ] -},
    ...
    FaCCAL                    `noun`       {- jaz~Az -}         [ "wool shearer" ],

    -- ;; mijaz~_1
    -- mjz     mijaz~  N       wool shears

    MiFaCL                    `noun`       {- mijaz~ -}         [ "wool shears" ] ]
 ...
 |> "^giniyh" <| [
    ...
    Identity                  `noun`       {- jiniyh -}         [ "pound", "pounds" ] ]
 ...
 |> "^guwAntiy" <| [
    ...
    Identity                  `noun`       {- juwAnotiy -}      [ "glove", "gloves" ] ]
