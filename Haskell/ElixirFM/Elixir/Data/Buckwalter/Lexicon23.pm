...
$Lexicon->{'l y y'}[6]{'types'} = $Lexicon->{'l y y'}[4]{'types'};
$Lexicon->{'l y y'}[6]{'lines'} = $Lexicon->{'l y y'}[4]{'lines'};
$Lexicon->{'l y y'}[6]{'glosses'} = $Lexicon->{'l y y'}[4]{'glosses'};
...
$Lexicon->{'l y n y'}[1]{'types'} = $Lexicon->{'l y n y'}[0]{'types'};
$Lexicon->{'l y n y'}[1]{'lines'} = $Lexicon->{'l y n y'}[0]{'lines'};
$Lexicon->{'l y n y'}[1]{'glosses'} = $Lexicon->{'l y n y'}[0]{'glosses'};
...
$Lexicon->{'l y f y'}[1]{'types'} = $Lexicon->{'l y f y'}[0]{'types'};
$Lexicon->{'l y f y'}[1]{'lines'} = $Lexicon->{'l y f y'}[0]{'lines'};
$Lexicon->{'l y f y'}[1]{'glosses'} = $Lexicon->{'l y f y'}[0]{'glosses'};
...
$Lexicon->{'l q \''}[2]{'types'} = $Lexicon->{'l q y'}[11]{'types'};
$Lexicon->{'l q \''}[2]{'lines'} = $Lexicon->{'l q y'}[11]{'lines'};
$Lexicon->{'l q \''}[2]{'glosses'} = $Lexicon->{'l q y'}[11]{'glosses'};
$Lexicon->{'l q \''}[3]{'types'} = $Lexicon->{'l q y'}[12]{'types'};
$Lexicon->{'l q \''}[3]{'lines'} = $Lexicon->{'l q y'}[12]{'lines'};
$Lexicon->{'l q \''}[3]{'glosses'} = $Lexicon->{'l q y'}[12]{'glosses'};
$Lexicon->{'l q \''}[4]{'types'} = $Lexicon->{'l q y'}[13]{'types'};
$Lexicon->{'l q \''}[4]{'lines'} = $Lexicon->{'l q y'}[13]{'lines'};
$Lexicon->{'l q \''}[4]{'glosses'} = $Lexicon->{'l q y'}[13]{'glosses'};
$Lexicon->{'l q \''}[5]{'types'} = $Lexicon->{'l q y'}[16]{'types'};
$Lexicon->{'l q \''}[5]{'lines'} = $Lexicon->{'l q y'}[16]{'lines'};
$Lexicon->{'l q \''}[5]{'glosses'} = $Lexicon->{'l q y'}[16]{'glosses'};
$Lexicon->{'l q \''}[6]{'types'} = $Lexicon->{'l q y'}[19]{'types'};
$Lexicon->{'l q \''}[6]{'lines'} = $Lexicon->{'l q y'}[19]{'lines'};
$Lexicon->{'l q \''}[6]{'glosses'} = $Lexicon->{'l q y'}[19]{'glosses'};
...
$Lexicon->{'l w \''}[0]{'types'} = $Lexicon->{'l w y'}[8]{'types'};
$Lexicon->{'l w \''}[0]{'lines'} = $Lexicon->{'l w y'}[8]{'lines'};
$Lexicon->{'l w \''}[0]{'glosses'} = $Lexicon->{'l w y'}[8]{'glosses'};
$Lexicon->{'l w \''}[1]{'types'} = $Lexicon->{'l w y'}[9]{'types'};
$Lexicon->{'l w \''}[1]{'lines'} = $Lexicon->{'l w y'}[9]{'lines'};
$Lexicon->{'l w \''}[1]{'glosses'} = $Lexicon->{'l w y'}[9]{'glosses'};
$Lexicon->{'l w \''}[2]{'types'} = $Lexicon->{'l w y'}[10]{'types'};
$Lexicon->{'l w \''}[2]{'lines'} = $Lexicon->{'l w y'}[10]{'lines'};
$Lexicon->{'l w \''}[2]{'glosses'} = $Lexicon->{'l w y'}[10]{'glosses'};
$Lexicon->{'l w \''}[3]{'types'} = $Lexicon->{'l w y'}[11]{'types'};
$Lexicon->{'l w \''}[3]{'lines'} = $Lexicon->{'l w y'}[11]{'lines'};
$Lexicon->{'l w \''}[3]{'glosses'} = $Lexicon->{'l w y'}[11]{'glosses'};
$Lexicon->{'l w \''}[4]{'types'} = $Lexicon->{'l w y'}[13]{'types'};
$Lexicon->{'l w \''}[4]{'lines'} = $Lexicon->{'l w y'}[13]{'lines'};
$Lexicon->{'l w \''}[4]{'glosses'} = $Lexicon->{'l w y'}[13]{'glosses'};
$Lexicon->{'l w \''}[5]{'types'} = $Lexicon->{'l w y'}[14]{'types'};
$Lexicon->{'l w \''}[5]{'lines'} = $Lexicon->{'l w y'}[14]{'lines'};
$Lexicon->{'l w \''}[5]{'glosses'} = $Lexicon->{'l w y'}[14]{'glosses'};
...
$Lexicon->{'l w w'}[3]{'types'} = $Lexicon->{'l w w'}[2]{'types'};
$Lexicon->{'l w w'}[3]{'lines'} = $Lexicon->{'l w w'}[2]{'lines'};
$Lexicon->{'l w w'}[3]{'glosses'} = $Lexicon->{'l w w'}[2]{'glosses'};
$Lexicon->{'l w w'}[4]{'types'} = $Lexicon->{'l w w'}[2]{'types'};
$Lexicon->{'l w w'}[4]{'lines'} = $Lexicon->{'l w w'}[2]{'lines'};
$Lexicon->{'l w w'}[4]{'glosses'} = $Lexicon->{'l w w'}[2]{'glosses'};
