...
module Elixir.Data.Sunny.Regular.H (section) where
...
cluster_1   = cluster
 ...
 |> "s .h l" <| [
    ...
    MiFCaL                    `noun`    {- <mis.hal> -}        [ unwords [ ['p','l','a','n','e'], "(", ['t','o','o','l'], ")" ], unwords [ ['f','i','l','e'], "(", ['t','o','o','l'], ")" ] ]
                              `plural`     MaFACiL,
    ...
    FACiL |< Iy               `noun`    {- <sA.hilIy> -}       [ unwords [ ['c','o','a','s','t','a','l'], ['i','n','h','a','b','i','t','a','n','t'] ] ]
                              `plural`     FawACiL |< aT
                           
    `derives` otherwise,

    FACiL |< Iy               `adj`     {- <sA.hilIy> -}       [ ['c','o','a','s','t','a','l'] ]
                              `plural`     FawACiL |< aT,
    ...
    FuCayL |< Iy              `noun`    {- <su.haylIy> -}      [ ['S','u','h','a','i','l','i'] ] ]
...
cluster_15  = cluster
 ...
 |> "s d r" <| [
    ...
    FACiL                     `adj`     {- <sAdir> -}          [ ['t','h','o','u','g','h','t','l','e','s','s'], ['i','n','d','i','f','f','e','r','e','n','t'] ],

    FuCayL |< Iy              `noun`    {- <sudayrIy> -}       [ ['S','u','d','a','i','r','i'], ['S','u','d','e','i','r','i'] ] ]
...
cluster_24  = cluster
 ...
 |> "s r b" <| [
    ...
    TaFCIL                    `noun`    {- <tasrIb> -}         [ unwords [ ['l','e','a','k','i','n','g'], "(", ['n','e','w','s',','], ['i','n','f','o','r','m','a','t','i','o','n'], ")" ], unwords [ ['d','i','s','c','l','o','s','i','n','g'], "(", ['s','e','c','r','e','t','s'], ")" ], ['p','l','a','n','t','i','n','g'], unwords [ ['p','l','a','c','i','n','g'], "(", ['a','g','e','n','t',','], ['s','p','y',','], ['m','o','l','e'], ")" ] ]
                              `plural`     TaFCIL |< At,
...
cluster_26  = cluster
 ...
 |> "s r ^g" <| [
    ...
    FaCaL |< Iy               `noun`    {- <sara^gIy> -}       [ ['S','a','r','a','j','i'] ],
    ...
    FuCUL |< Iy               `noun`    {- <surU^gIy> -}       [ ['s','a','d','d','l','e','r'] ]
                              `plural`     FuCUL |< Iy |< Un
...
cluster_29  = cluster
 ...
 |> "s r .h" <| [
    ...
    MaFCaL |< Iy |< aT        `noun`    {- <masra.hIyaT> -}    [ unwords [ ['p','l','a','y'], "(", ['t','h','e','a','t','e','r'], ")" ] ]
                              `plural`     MaFCaL |< Iy |< At,
    ...
    FACiL                     `adj`     {- <sAri.h> -}         [ unwords [ ['r','o','a','m','i','n','g'], ['f','r','e','e','l','y'] ], ['d','i','s','t','r','a','c','t','e','d'] ],
...
cluster_32  = cluster
 ...
 |> "s r d" <| [
    ...
    FaCL                      `noun`    {- <sard> -}           [ ['e','n','u','m','e','r','a','t','i','o','n'], ['p','r','e','s','e','n','t','a','t','i','o','n'], ['n','a','r','r','a','t','i','v','i','t','y'] ],

    FaCL |< Iy                `adj`     {- <sardIy> -}         [ ['n','a','r','r','a','t','i','v','e'] ],
...
cluster_35  = cluster
 ...
 |> ['s','u','r','A','d','i','q'] <| [
    ...
    _____                     `noun`    {- <surAdiq> -}        [ ['p','a','v','i','l','i','o','n'], ['c','a','n','o','p','y'] ] ]
...
cluster_41  = cluster
 ...
 |> "s r f" <| [
    ...
    HaFCaL                    `verb`    {- <'asraf> -}         [ unwords [ ['b','e'], ['e','x','c','e','s','s','i','v','e'] ], ['o','v','e','r','d','o'] ],

    FaCaL                     `noun`    {- <saraf> -}          [ ['e','x','c','e','s','s'], ['e','x','t','r','a','v','a','g','a','n','c','e'] ],

    HiFCAL                    `noun`    {- <'isrAf> -}         [ ['e','x','c','e','s','s'], ['e','x','t','r','a','v','a','g','a','n','c','e'] ],
...
cluster_48  = cluster
 ...
 |> ['s','a','r','d','I','n'] <| [
    ...
    _____                     `noun`    {- <sardIn> -}         [ ['s','a','r','d','i','n','e'] ]
                              `plural`     _____ |< At ]
...
cluster_49  = cluster
 ...
 |> ['s','a','r','`','a','s','k','a','r'] <| [
    ...
    _____                     `noun`    {- <sar`askar> -}      [ ['g','e','n','e','r','a','l'] ] ]
...
cluster_52  = cluster
 ...
 |> ['s','I','z','U','f','r','I','n'] <| [
    ...
    _____ |< iyA              `noun`    {- <sIzUfrIniyA> -}    [ ['s','c','h','i','z','o','p','h','r','e','n','i','a'] ],

    _____ |< Iy               `adj`     {- <sIzUfrInIy> -}     [ ['s','c','h','i','z','o','p','h','r','e','n','i','c'] ] ]
...
cluster_53  = cluster
 ...
 |> ['s','i','z','m','U','.','g','r','A','f'] <| [
    ...
    _____                     `noun`    {- <sizmU.grAf> -}     [ ['s','e','i','s','m','o','g','r','a','p','h'] ],

    _____ |< Iy               `adj`     {- <sizmU.grAfIy> -}   [ ['s','e','i','s','m','o','g','r','a','p','h','i','c'] ] ]
...
cluster_54  = cluster
 ...
 |> ['s','A','s','A','n'] <| [
    ...
    _____ |< Iy               `adj`     {- <sAsAnIy> -}        [ ['S','a','s','s','a','n','i','d'] ] ]
...
cluster_55  = cluster
 ...
 |> ['s','U','s','t'] <| [
    ...
    _____ |< aT               `noun`    {- <sUstaT> -}         [ ['z','i','p','p','e','r'] ] ]
...
cluster_58  = cluster
 ...
 |> "s .t .h" <| [
    ...
    MuFaCCaL                  `adj`     {- <musa.t.ta.h> -}    [ unwords [ ['l','e','v','e','l'], ['p','l','a','n','e'] ], ['f','l','a','t'] ] ]
...
cluster_60  = cluster
 ...
 |> "s .t `" <| [
    ...
    HaFCaL                    `adj`     {- <'as.ta`> -}        [ unwords [ ['b','r','i','g','h','t','e','r'], "/", ['b','r','i','g','h','t','e','s','t'] ], unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['b','r','i','l','l','i','a','n','t'] ] ],
...
cluster_64  = cluster
 ...
 |> "s ` d" <| [
    ...
    FaCLA' |< Iy              `noun`    {- <sa`dAwIy> -}       [ ['S','a','a','d','a','w','i'], ['S','a','d','a','w','i'] ],
    ...
    FaCUL                     `noun`    {- <sa`Ud> -}          [ ['S','a','u','d'] ],

    FaCUL |< Iy               `adj`     {- <sa`UdIy> -}        [ ['S','a','u','d','i'] ],

    FaCUL |< Iy               `noun`    {- <sa`UdIy> -}        [ ['S','a','u','d','i'] ]
                              `plural`     FaCUL |< Iy |< Un
...
cluster_66  = cluster
 ...
 |> "s ` r" <| [
    ...
    MiFCaL |< Iy              `noun`    {- <mis`arIy> -}       [ ['M','i','s','a','r','i'] ],
    ...
    TaFCiL |< aT              `noun`    {- <tas`iraT> -}       [ ['q','u','o','t','a','t','i','o','n'] ],
...
cluster_73  = cluster
 ...
 |> "s f t ^g" <| [
    ...
    KuRDaS |< aT              `noun`    {- <sufta^gaT> -}      [ unwords [ ['b','i','l','l'], ['o','f'], ['e','x','c','h','a','n','g','e'] ] ]
                              `plural`     KaRADiS ]
...
cluster_76  = cluster
 ...
 |> "s f r" <| [
    ...
    FuCL |<< "a" |<< "^g" |< Iy `noun`    {- <sufra^gIy> -}      [ ['w','a','i','t','e','r'], ['s','t','e','w','a','r','d'] ]
                              `plural`     FuCL |<< "a" |<< "^g" |< Iy |< Un,

    FuCL |<< "a" |<< "^g" |< Iy |< aT `noun`    {- <sufra^gIyaT> -}    [ ['w','a','i','t','e','r','e','s','s'], ['s','t','e','w','a','r','d','e','s','s'] ]
                              `plural`     FuCL |<< "a" |<< "^g" |< Iy |< At,
...
cluster_78  = cluster
 ...
 |> ['s','a','f','a','r','^','g','a','l'] <| [
    ...
    _____                     `noun`    {- <safar^gal> -}      [ ['q','u','i','n','c','e'] ] ]
...
cluster_84  = cluster
 ...
 |> "s f k" <| [
    ...
    FaCCAL                    `adj`     {- <saffAk> -}         [ ['b','l','o','o','d','s','h','e','d'] ] ]
...
cluster_85  = cluster
 ...
 |> "s f l" <| [
    ...
    FiCL |< aT                `noun`    {- <siflaT> -}         [ unwords [ ['l','o','w','l','y'], ['l','e','v','e','l'] ] ],
...
cluster_90  = cluster
 ...
 |> ['s','i','f','a','n','^','g'] <| [
    ...
    _____                     `noun`    {- <sifan^g> -}        [ ['s','p','o','n','g','e'] ] ]
...
cluster_94  = cluster
 ...
 |> "s q .t" <| [
    ...
    HaFCaL                    `verb`    {- <'asqa.t> -}        [ unwords [ ['s','h','o','o','t'], ['d','o','w','n'] ], unwords [ ['m','a','k','e'], ['f','a','l','l'] ], ['a','b','o','r','t'] ],

    TaFaCCaL                  `verb`    {- <tasaqqa.t> -}      [ ['g','a','t','h','e','r'] ],

    TaFACaL                   `verb`    {- <tasAqa.t> -}       [ ['c','o','l','l','a','p','s','e'], unwords [ ['f','a','l','l'], ['s','u','c','c','e','s','s','i','v','e','l','y'] ] ],
    ...
    FaCaL |< Iy               `noun`    {- <saqa.tIy> -}       [ unwords [ ['j','u','n','k'], ['d','e','a','l','e','r'] ] ]
                              `plural`     FaCaL |< Iy |< Un
...
cluster_96  = cluster
 ...
 |> "s q f" <| [
    ...
    FaCaL                     `verb`    {- <saqaf> -}          [ unwords [ ['p','u','t'], "a", ['r','o','o','f'], ['o','v','e','r'] ] ]
                              `imperf`     FCuL
                              `masdar`     FaCL,
...
cluster_100 = cluster
 ...
 |> ['s','u','q','r','A','.','t'] <| [
    ...
    _____                     `noun`    {- <suqrA.t> -}        [ ['S','o','c','r','a','t','e','s'] ],

    _____ |< Iy               `adj`     {- <suqrA.tIy> -}      [ ['S','o','c','r','a','t','i','c'] ] ]
