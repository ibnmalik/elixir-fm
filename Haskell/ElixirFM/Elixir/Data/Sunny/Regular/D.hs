...
cluster_20  = cluster
 ...
 |> "dImU.grAf" <| [
    ...
    _____ |< Iy               `adj`     {- <dImU.grAfIy> -}    [ ['d','e','m','o','g','r','a','p','h','e','r'] ] ]
...
cluster_30  = cluster
 ...
 |> "dUmAn^g" <| [
    ...
    _____ |< Iy               `adj`     {- <dUmAn^gIy> -}      [ ['h','e','l','m','s','m','a','n'], ['s','t','e','e','r','s','m','a','n'] ] ]
...
cluster_50  = cluster
 ...
 |> "dInAmIk" <| [
    ...
    _____ |< Iy               `adj`     {- <dInAmIkIy> -}      [ ['d','y','n','a','m','i','c'], ['d','y','n','a','m','i','s','m'] ] ]
