...
cluster_26  = cluster
 ...
 |> "s l .h f" <| [
    ...
    KuRDuSY |< aT             `noun`    {- <sul.hufAT> -}      [ ['t','u','r','t','l','e'] ]
                              `plural`     KaRADiS,

    KuRaDSY |< aT             `noun`    {- <sula.hfAT> -}      [ ['t','u','r','t','l','e'] ]
                              `plural`     KaRADiS,

    KuRaDSY                   `noun`    {- <sula.hfY> -}       [ ['t','u','r','t','l','e'] ]
                              `plural`     KaRADiS,

    KaRDUS                    `noun`    {- <sal.hUf> -}        [ ['t','u','r','t','l','e'], unwords [ ['l','i','t','t','l','e'], ['t','u','r','t','l','e'] ] ],

    KuRaDSA' |< Iy            `adj`     {- <sula.hfA'Iy> -}    [ unwords [ ['t','u','r','t','l','e'], "-", ['l','i','k','e'] ], ['s','l','o','w'] ],

    KuRaDSA' |< Iy |< aT      `noun`    {- <sula.hfA'IyaT> -}  [ ['d','a','w','d','l','i','n','g'], ['d','i','l','a','t','o','r','i','n','e','s','s'] ] ]
...
cluster_34  = cluster
 ...
 |> "s l `" <| [
    ...
    FaCCaL                    `verb`    {- <salla`> -}         [ ['c','o','m','m','o','d','i','f','y'] ],
    ...
    TaFCIL                    `noun`    {- <taslI`> -}         [ ['c','o','m','m','o','d','i','f','i','c','a','t','i','o','n'] ],

    FiCaL |< Iy               `adj`     {- <sila`Iy> -}        [ ['c','o','m','m','e','r','c','i','a','l'], unwords [ ['c','o','m','m','o','d','i','t','y'], "-", ['r','e','l','a','t','e','d'] ] ] ]
...
cluster_35  = cluster
 ...
 |> "s l f" <| [
    ...
    FaCaL                     `noun`    {- <salaf> -}          [ ['a','n','c','e','s','t','o','r'] ]
                              `plural`     HaFCAL,
...
cluster_40  = cluster
 ...
 |> "s l m" <| [
    ...
    FACiL                     `adj`     {- <sAlim> -}          [ ['s','e','c','u','r','e'], ['s','o','u','n','d'], ['i','n','t','a','c','t'] ],
...
cluster_46  = cluster
 ...
 |> ['s','a','l','f','A','d','U','r'] <| [
    ...
    _____                     `xtra`    {- <salfAdUr> -}       [ ['S','a','l','v','a','d','o','r'] ],
...
cluster_58  = cluster
 ...
 |> "s m s m" <| [
    ...
    KiRDiS                    `noun`    {- <simsim> -}         [ ['s','e','s','a','m','e'] ],
...
cluster_66  = cluster
 ...
 |> "s m n" <| [
    ...
    FuCCAL                    `noun`    {- <summAn> -}         [ ['q','u','a','i','l'] ]
                              `plural`     FuCCAL |< At
                           
    `derives` otherwise,

    FuCCuL                    `noun`    {- <summun> -}         [ ['q','u','a','i','l'] ]
                              `plural`     FaCACiL
...
cluster_87  = cluster
 ...
 |> "s n d" <| [
    ...
    MuFtaCaL                  `noun`    {- <mustanad> -}       [ ['c','a','u','s','e'], ['m','o','t','i','v','e'], ['d','o','c','u','m','e','n','t'], ['d','e','e','d'], ['v','o','u','c','h','e','r'], ['r','e','c','e','i','p','t'] ]
                              `plural`     MuFtaCaL |< At ]
...
cluster_94  = cluster
 ...
 |> ['s','I','n','i','.','g','A','l'] <| [
    ...
    _____                     `noun`    {- <sIni.gAl> -}       [ ['S','e','n','e','g','a','l'] ],

    _____ |< Iy               `adj`     {- <sIni.gAlIy> -}     [ ['S','e','n','e','g','a','l','e','s','e'] ],

    _____ |< Iy               `noun`    {- <sIni.gAlIy> -}     [ ['S','e','n','e','g','a','l','e','s','e'] ]
                              `plural`     _____ |< Iy |< Un
...
cluster_98  = cluster
 ...
 |> "s n k r" <| [
    ...
    KaRDaS |< Iy              `noun`    {- <sankarIy> -}       [ ['t','i','n','s','m','i','t','h'] ]
                              `plural`     KaRDaS |< Iy |< Un
                              `plural`     KaRADiS |< aT
...
cluster_99  = cluster
 ...
 |> ['s','i','n','a','k','s','A','r'] <| [
    ...
    _____                     `noun`    {- <sinaksAr> -}       [ ['s','y','n','a','x','a','r','i','o','n'], ['m','a','r','t','y','r','o','l','o','g','i','u','m'], ['m','a','r','t','y','r','o','l','o','g','y'] ] ]
...
cluster_100 = cluster
 ...
 |> "s n m" <| [
    ...
    MuFaCCaL                  `adj`     {- <musannam> -}       [ ['v','a','u','l','t','e','d'], ['c','o','n','v','e','x'], ['a','r','c','h','e','d'] ] ]
