...
cluster_26  = cluster
 ...
 |> "r m q" <| [
    ...
    FaCaL                     `noun`    {- <ramaq> -}          [ unwords [ ['l','a','s','t'], ['s','i','g','n'], ['o','f'], ['l','i','f','e'] ], unwords [ ['l','a','s','t'], ['b','r','e','a','t','h'], ['o','f'], ['l','i','f','e'] ] ]
                              `plural`     HaFCAL,
...
cluster_28  = cluster
 ...
 |> "r m l" <| [
    ...
    HaFCaL                    `noun`    {- <'armal> -}         [ ['w','i','d','o','w','e','r'] ]
                              `plural`     HaFACiL,
...
cluster_29  = cluster
 ...
 |> ['r','U','m','A','n'] <| [
    ...
    _____ |< iyA              `xtra`    {- <rUmAniyA> -}       [ ['R','o','m','a','n','i','a'] ],

    _____ |< Iy               `adj`     {- <rUmAnIy> -}        [ ['R','o','m','a','n','i','a','n'] ] ]
...
cluster_31  = cluster
 ...
 |> ['r','U','m','A','n','t','I','k'] <| [
    ...
    _____ |< Iy               `adj`     {- <rUmAntIkIy> -}     [ ['r','o','m','a','n','t','i','c'] ],

    _____ |< Iy |< aT         `noun`    {- <rUmAntIkIyaT> -}   [ ['r','o','m','a','n','t','i','c','i','s','m'] ] ]
...
cluster_34  = cluster
 ...
 |> ['r','U','m','A','n','.','t','I','q'] <| [
    ...
    _____ |< Iy               `adj`     {- <rUmAn.tIqIy> -}    [ ['r','o','m','a','n','t','i','c'] ],

    _____ |< Iy |< aT         `noun`    {- <rUmAn.tIqIyaT> -}  [ ['r','o','m','a','n','t','i','c','i','s','m'] ] ]
...
cluster_38  = cluster
 ...
 |> "r n q" <| [
    ...
    FaCL                      `adj`     {- <ranq> -}           [ ['t','u','r','b','i','d'], ['c','l','o','u','d','e','d'] ],

    FawCaL                    `noun`    {- <rawnaq> -}         [ ['s','p','l','e','n','d','o','r'], ['l','u','s','t','e','r'] ] ]
...
cluster_41  = cluster
 ...
 |> "r h b" <| [
    ...
    TaFaCCaL                  `verb`    {- <tarahhab> -}       [ ['t','h','r','e','a','t','e','n'], unwords [ ['b','e','c','o','m','e'], "a", ['m','o','n','k'] ] ],

    FaCL |< aT                `noun`    {- <rahbaT> -}         [ ['f','e','a','r'], ['a','l','a','r','m'] ],

    FaCLY                     `noun`    {- <rahbY> -}          [ ['f','e','a','r'] ],

    FuCLY                     `noun`    {- <ruhbY> -}          [ ['f','e','a','r'] ],
    ...
    HiFCAL |< Iy              `noun`    {- <'irhAbIy> -}       [ ['t','e','r','r','o','r','i','s','t'] ]
                              `plural`     HiFCAL |< Iy |< Un
...
cluster_51  = cluster
 ...
 |> "r h n" <| [
    ...
    HaFCaL                    `verb`    {- <'arhan> -}         [ unwords [ ['d','e','p','o','s','i','t'], ['i','n'], ['p','l','e','d','g','e'] ], unwords [ ['g','i','v','e'], ['a','s'], "a", ['s','e','c','u','r','i','t','y'] ] ],
...
cluster_52  = cluster
 ...
 |> "z b d" <| [
    ...
    FaCaL |< Iy               `noun`    {- <zabadIy> -}        [ ['Z','a','b','a','d','i'] ],
    ...
    FuCayL |< Iy              `noun`    {- <zubaydIy> -}       [ ['Z','u','b','a','i','d','i'], ['Z','u','b','e','i','d','i'] ],

    FaCIL |< Iy               `noun`    {- <zabIdIy> -}        [ ['Z','a','b','i','d','i'], ['Z','a','b','e','e','d','i'] ],

    FaCAL                     `noun`    {- <zabAd> -}          [ ['c','i','v','e','t'] ],

    FaCAL |< Iy               `noun`    {- <zabAdIy> -}        [ unwords [ ['c','u','r','d','l','e','d'], ['m','i','l','k'] ], ['y','o','g','u','r','t'] ],
...
cluster_53  = cluster
 ...
 |> "z b r" <| [
    ...
    FawACiL |< Iy             `noun`    {- <zawAbirIy> -}      [ ['Z','o','u','a','b','r','i'] ] ]
...
cluster_57  = cluster
 ...
 |> "z b `" <| [
    ...
    FawCaL |< aT              `noun`    {- <zawba`aT> -}       [ ['s','t','o','r','m'], ['h','u','r','r','i','c','a','n','e'] ]
                              `plural`     FawACiL ]
...
cluster_62  = cluster
 ...
 |> "z ^g l" <| [
    ...
    FaCaL                     `noun`    {- <za^gal> -}         [ unwords [ ['z','a','j','a','l'], "(", ['p','o','e','m'], ")" ] ]
                              `plural`     HaFCAL,
...
cluster_65  = cluster
 ...
 |> "z .h f" <| [
    ...
    FaCCAL                    `adj`     {- <za.h.hAf> -}       [ ['c','r','e','e','p','i','n','g'], ['c','r','a','w','l','i','n','g'] ],
...
cluster_66  = cluster
 ...
 |> "z .h l" <| [
    ...
    FaCLY |< Iy               `noun`    {- <za.hlawIy> -}      [ ['Z','a','h','l','a','o','u','i'], ['Z','a','h','l','a','w','i'] ] ]
...
cluster_67  = cluster
 ...
 |> "z .h l q" <| [
    ...
    TaKaRDaS                  `verb`    {- <taza.hlaq> -}      [ ['s','l','i','d','e'], ['s','l','i','p'], ['s','k','a','t','e'], ['s','k','i'] ],
...
cluster_69  = cluster
 ...
 |> "z _h r" <| [
    ...
    FACiL                     `adj`     {- <zA_hir> -}         [ ['o','v','e','r','f','l','o','w','i','n','g'], ['p','r','o','f','u','s','e'], ['e','x','u','b','e','r','a','n','t'] ],

    FaCCAL                    `adj`     {- <za_h_hAr> -}       [ ['o','v','e','r','f','l','o','w','i','n','g'], ['p','r','o','f','u','s','e'], ['e','x','u','b','e','r','a','n','t'] ] ]
...
cluster_78  = cluster
 ...
 |> "z r `" <| [
    ...
    MaFCaL |< aT              `noun`    {- <mazra`aT> -}       [ ['f','a','r','m'], unwords [ ['a','r','a','b','l','e'], ['l','a','n','d'] ], ['p','l','a','n','t','a','t','i','o','n'] ]
                              `plural`     MaFACiL,
...
cluster_80  = cluster
 ...
 |> "z r q" <| [
    ...
    FaCLAn |< Iy              `noun`    {- <zarqAnIy> -}       [ ['Z','a','r','q','a','n','i'] ],
...
cluster_82  = cluster
 ...
 |> "z r k ^s" <| [
    ...
    MuKaRDaS                  `adj`     {- <muzarka^s> -}      [ ['b','r','o','c','a','d','e','d'], ['e','m','b','e','l','l','i','s','h','e','d'] ] ]
...
cluster_84  = cluster
 ...
 |> "z r h n" <| [
    ...
    KaRDUS |< Iy              `noun`    {- <zarhUnIy> -}       [ ['Z','e','r','h','o','u','n','i'], ['Z','a','r','h','o','u','n','i'] ] ]
...
cluster_85  = cluster
 ...
 |> "z ` b" <| [
    ...
    FuCL |< Iy                `noun`    {- <zu`bIy> -}         [ ['Z','u','\'','b','i'] ],

    FaCAL |< Iy               `noun`    {- <za`AbIy> -}        [ ['Z','a','a','b','i'] ] ]
...
cluster_90  = cluster
 ...
 |> "z ` r" <| [
    ...
    FaCiL                     `adj`     {- <za`ir> -}          [ unwords [ ['t','h','i','n'], "-", ['h','a','i','r','e','d'] ] ],
    ...
    FuCLUL                    `adj`     {- <zu`rUr> -}         [ unwords [ ['i','l','l'], "-", ['t','e','m','p','e','r','e','d'] ], ['i','r','a','s','c','i','b','l','e'] ]
                              `plural`     FaCALIL ]
...
cluster_91  = cluster
 ...
 |> "z ` z `" <| [
    ...
    KaRDUS                    `adj`     {- <za`zU`> -}         [ ['s','k','i','n','n','y'], ['l','a','n','k','y'] ],
...
cluster_93  = cluster
 ...
 |> "z ` f" <| [
    ...
    HaFCaL                    `verb`    {- <'az`af> -}         [ unwords [ ['k','i','l','l'], ['i','n','s','t','a','n','t','l','y'] ] ],
...
cluster_95  = cluster
 ...
 |> "z ` l" <| [
    ...
    HaFCaL                    `verb`    {- <'az`al> -}         [ ['a','n','n','o','y'], unwords [ ['m','a','k','e'], ['a','n','g','r','y'] ] ],

    FaCaL                     `noun`    {- <za`al> -}          [ ['a','n','g','e','r'], ['d','i','s','p','l','e','a','s','u','r','e'] ],

    FaCiL                     `adj`     {- <za`il> -}          [ ['a','n','n','o','y','e','d'], ['a','n','g','r','y'] ],
