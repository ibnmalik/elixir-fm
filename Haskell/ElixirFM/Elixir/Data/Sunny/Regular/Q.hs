...
cluster_1   = cluster
 ...
 |> "n s _h" <| [
    ...
    FACiL                     `adj`     {- <nAsi_h> -}         [ ['a','b','r','o','g','a','t','i','n','g'], ['a','b','o','l','i','s','h','i','n','g'] ],
...
cluster_8   = cluster
 ...
 |> "n s k" <| [
    ...
    FuCuL                     `noun`    {- <nusuk> -}          [ ['p','i','e','t','y'], ['d','e','v','o','u','t','n','e','s','s'], ['r','e','c','l','u','s','i','o','n'] ],

    FuCL                      `noun`    {- <nusk> -}           [ ['p','i','e','t','y'], ['d','e','v','o','u','t','n','e','s','s'], ['r','e','c','l','u','s','i','o','n'] ],

    FuCuL |< Iy               `adj`     {- <nusukIy> -}        [ ['a','s','c','e','t','i','c'] ],

    FuCuL                     `noun`    {- <nusuk> -}          [ ['s','a','c','r','i','f','i','c','e'], unwords [ ['p','i','l','g','r','i','m','a','g','e'], ['c','e','r','e','m','o','n','i','e','s'] ] ],

    FACiL                     `adj`     {- <nAsik> -}          [ ['h','e','r','m','i','t'], ['a','s','c','e','t','i','c'], ['p','i','o','u','s'] ]
                              `plural`     FuCCAL,
...
cluster_13  = cluster
 ...
 |> "n ^s b" <| [
    ...
    MaFCUL |< Iy |< aT        `noun`    {- <man^sUbIyaT> -}    [ unwords [ ['m','o','n','k','\'','s'], ['c','e','l','l'] ] ],
...
cluster_15  = cluster
 ...
 |> "n ^s d" <| [
    ...
    HaFCaL                    `verb`    {- <'an^sad> -}        [ ['s','e','e','k'], ['s','i','n','g'], ['r','e','c','i','t','e'] ],
...
cluster_17  = cluster
 ...
 |> "n ^s r" <| [
    ...
    FaCaL                     `verb`    {- <na^sar> -}         [ ['p','u','b','l','i','s','h'], ['a','n','n','o','u','n','c','e'], ['s','p','r','e','a','d'] ]
                              `imperf`     FCuL,
...
cluster_19  = cluster
 ...
 |> "n ^s .t" <| [
    ...
    HaFCaL                    `verb`    {- <'an^sa.t> -}       [ ['s','t','i','m','u','l','a','t','e'], ['i','n','v','i','g','o','r','a','t','e'], unwords [ ['t','i','e'], ['u','p'] ] ],
    ...
    MuFaCCiL                  `noun`    {- <muna^s^si.t> -}    [ ['s','t','i','m','u','l','a','n','t'], ['d','o','p','e'] ]
                              `plural`     MuFaCCiL |< At,
...
cluster_24  = cluster
 ...
 |> "n ^s n" <| [
    ...
    FiCAL |<< "^g" |< Iy      `noun`    {- <ni^sAn^gIy> -}     [ ['s','h','a','r','p','s','h','o','o','t','e','r'], ['m','a','r','k','s','m','a','n'], ['s','n','i','p','e','r'] ]
                              `plural`     FiCAL |<< "^g" |< Iy |< aT
...
cluster_26  = cluster
 ...
 |> "n .s b" <| [
    ...
    HaFCaL                    `verb`    {- <'an.sab> -}        [ ['e','x','h','a','u','s','t'], unwords [ ['w','e','a','r'], ['o','u','t'] ] ],
    ...
    FACIL                     `noun`    {- <nA.sIb> -}         [ ['l','o','t','t','e','r','y'] ],

    "yA" >>| FaCIL            `noun`    {- <yAna.sIb> -}       [ ['l','o','t','t','e','r','y'] ],

    "yA" >>| FaCIL |< Iy      `adj`     {- <yAna.sIbIy> -}     [ ['l','o','t','t','e','r','y'] ],
...
cluster_27  = cluster
 ...
 |> "n .s t" <| [
    ...
    MutaFaCCiL                `noun`    {- <mutana.s.sit> -}   [ ['e','a','v','e','s','d','r','o','p','p','e','r'] ]
                              `plural`     MutaFaCCiL |< Un
                           
    `derives` otherwise,

    MutaFaCCiL                `adj`     {- <mutana.s.sit> -}   [ ['e','a','v','e','s','d','r','o','p','p','i','n','g'] ] ]
...
cluster_28  = cluster
 ...
 |> "n .s .h" <| [
    ...
    FaCIL |< aT               `noun`    {- <na.sI.haT> -}      [ ['a','d','v','i','c','e'], unwords [ ['w','o','r','d'], ['o','f'], ['a','d','v','i','c','e'] ] ]
                              `plural`     FaCA'iL,
...
cluster_29  = cluster
 ...
 |> "n .s r" <| [
    ...
    FaCL |<< "Aw" |< Iy       `noun`    {- <na.srAwIy> -}      [ ['N','a','s','r','a','w','i'], ['N','a','s','r','a','o','u','i'] ],
    ...
    MaFCaL                    `noun`    {- <man.sar> -}        [ unwords [ ['g','a','n','g'], ['o','f'], ['t','h','i','e','v','e','s'] ] ]
                              `plural`     MaFACiL,
    ...
    FuwayCiL                  `noun`    {- <nuway.sir> -}      [ ['N','u','w','a','y','s','i','r'], ['N','u','w','a','i','s','i','r'] ],
...
cluster_31  = cluster
 ...
 |> "n .s f" <| [
    ...
    MuFaCCiL                  `adj`     {- <muna.s.sif> -}     [ ['b','i','s','e','c','t','i','n','g'], unwords [ ['d','i','v','i','d','i','n','g'], ['i','n'], ['h','a','l','f'] ] ],
...
cluster_34  = cluster
 ...
 |> "n .d b" <| [
    ...
    FACiL                     `adj`     {- <nA.dib> -}         [ ['b','a','r','r','e','n'], ['s','t','e','r','i','l','e'], ['a','r','i','d'] ]
                              `plural`     FuCCaL,
...
cluster_35  = cluster
 ...
 |> "n .d ^g" <| [
    ...
    HaFCaL                    `verb`    {- <'an.da^g> -}       [ ['r','i','p','e','n'], unwords [ ['b','r','i','n','g'], ['t','o'], ['m','a','t','u','r','i','t','y'] ], unwords [ ['c','o','o','k'], ['w','e','l','l'] ] ],
...
cluster_40  = cluster
 ...
 |> "n .d l" <| [
    ...
    MuFACiL                   `noun`    {- <munA.dil> -}       [ ['c','o','m','b','a','t','a','n','t'], ['f','i','g','h','t','e','r'] ]
                              `plural`     MuFACiL |< Un
                           
    `derives` otherwise,

    MuFACiL                   `adj`     {- <munA.dil> -}       [ ['f','i','g','h','t','i','n','g'] ] ]
...
cluster_45  = cluster
 ...
 |> "n .t s" <| [
    ...
    FaCL                      `adj`     {- <na.ts> -}          [ unwords [ ['w','e','l','l'], "-", ['i','n','f','o','r','m','e','d'] ], ['e','x','p','e','r','i','e','n','c','e','d'], ['s','k','i','l','l','e','d'] ],
...
cluster_48  = cluster
 ...
 |> "n .t q" <| [
    ...
    FaCaL                     `verb`    {- <na.taq> -}         [ ['s','p','e','a','k'], ['u','t','t','e','r'], ['p','r','o','n','o','u','n','c','e'] ]
                              `imperf`     FCuL
                              `masdar`     FuCL
                              `masdar`     MaFCiL,
...
cluster_51  = cluster
 ...
 |> "n .z r" <| [
    ...
    FaCaL                     `verb`    {- <na.zar> -}         [ ['l','o','o','k'], ['o','b','s','e','r','v','e'], ['s','e','e'], ['e','x','a','m','i','n','e'], unwords [ ['l','o','o','k'], ['i','n','t','o'] ] ]
                              `imperf`     FCuL
                              `masdar`     FaCaL,
    ...
    IFtaCaL                   `verb`    {- <inta.zar> -}       [ ['e','x','p','e','c','t'], unwords [ ['w','a','i','t'], ['f','o','r'] ] ],
    ...
    FaCaL |< Iy               `noun`    {- <na.zarIy> -}       [ ['t','h','e','o','r','e','t','i','c','i','a','n'] ]
                              `plural`     FaCaL |< Iy |< Un
    ...
    FaCCAL                    `adj`     {- <na.z.zAr> -}       [ unwords [ ['s','h','a','r','p'], "-", ['e','y','e','d'] ] ],
    ...
    FaCCAL |< At |< Iy        `noun`    {- <na.z.zArAtIy> -}   [ ['o','p','t','o','m','e','t','r','i','s','t'], ['o','p','t','i','c','i','a','n'] ]
                              `plural`     FaCCAL |< At |< Iy |< Un
    ...
    lA >| MaFCUL              `adj`     {- <lA-man.zUr> -}     [ ['i','n','v','i','s','i','b','l','e'] ],

    MuFACiL                   `noun`    {- <munA.zir> -}       [ ['c','o','m','p','e','t','i','t','o','r'], ['r','i','v','a','l'] ]
                              `plural`     MuFACiL |< Un
                           
    `derives` otherwise,

    MuFACiL                   `adj`     {- <munA.zir> -}       [ ['s','i','m','i','l','a','r'] ],

    MuFtaCiL                  `adj`     {- <munta.zir> -}      [ ['w','a','i','t','i','n','g'], ['a','n','t','i','c','i','p','a','t','i','n','g'] ],
...
cluster_54  = cluster
 ...
 |> "n .z m" <| [
    ...
    FiCAL                     `noun`    {- <ni.zAm> -}         [ ['r','e','g','i','m','e'], ['g','o','v','e','r','n','m','e','n','t'] ]
                              `plural`     HaFCiL |< aT
                              `plural`     FiCAL |< At
                              `plural`     FuCuL,

    FiCAL                     `noun`    {- <ni.zAm> -}         [ ['s','y','s','t','e','m'], ['o','r','d','e','r'], ['m','e','t','h','o','d','o','l','o','g','y'] ]
                              `plural`     HaFCiL |< aT
                              `plural`     FuCuL,
    ...
    MuFtaCiL                  `adj`     {- <munta.zim> -}      [ ['r','e','g','u','l','a','r'], ['o','r','d','e','r','l','y'], ['s','y','s','t','e','m','a','t','i','c'] ] ]
...
cluster_55  = cluster
 ...
 |> "n ` b" <| [
    ...
    FuCAL                     `adj`     {- <nu`Ab> -}          [ ['c','r','o','a','k','i','n','g'], ['c','a','w','i','n','g'] ],

    FaCCAL                    `adj`     {- <na``Ab> -}         [ ['o','m','i','n','o','u','s'], ['c','r','o','a','k','i','n','g'], ['c','a','w','i','n','g'] ] ]
...
cluster_58  = cluster
 ...
 |> "n ` r" <| [
    ...
    FACUL |< aT               `noun`    {- <nA`UraT> -}        [ unwords [ ['n','o','r','i','a'], "(", ['w','a','t','e','r'], ['w','h','e','e','l'], ['w','i','t','h'], ['b','u','c','k','e','t','s'], ")" ] ]
                              `plural`     FawACIL ]
...
cluster_81  = cluster
 ...
 |> "n f s" <| [
    ...
    FaCL |< Iy |< aT          `noun`    {- <nafsIyaT> -}       [ ['p','s','y','c','h','e'], unwords [ ['i','n','n','e','r'], ['l','i','f','e'] ], unwords [ ['f','r','a','m','e'], ['o','f'], ['m','i','n','d'] ] ],
...
cluster_94  = cluster
 ...
 |> "n q r" <| [
    ...
    FaCaL                     `verb`    {- <naqar> -}          [ ['c','l','i','c','k'], ['s','t','r','i','k','e'], ['p','e','c','k'] ]
                              `imperf`     FCuL,

    FaCaL                     `verb`    {- <naqar> -}          [ ['e','n','g','r','a','v','e'], ['e','x','c','a','v','a','t','e'] ]
                              `imperf`     FCuL,
    ...
    FaCL                      `noun`    {- <naqr> -}           [ ['c','l','i','c','k','i','n','g'], ['s','t','r','i','k','i','n','g'], ['p','e','c','k','i','n','g'] ],

    FaCL                      `noun`    {- <naqr> -}           [ ['e','n','g','r','a','v','i','n','g'], ['e','x','c','a','v','a','t','i','o','n'], ['h','o','l','l','o','w'], ['c','a','v','i','t','y'] ],
