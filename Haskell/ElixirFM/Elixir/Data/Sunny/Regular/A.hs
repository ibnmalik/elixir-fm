...
cluster_5   = cluster
 ...
 |> "t b `" <| [
    ...
    FaCIL                     `noun`    {- <tabI`> -}          [ ['f','o','l','l','o','w','e','r'], ['a','d','h','e','r','e','n','t'], ['p','a','r','t','i','s','a','n'] ]
                              `plural`     FaCA'iL,
    ...
    FACiL |< Iy               `noun`    {- <tAbi`Iy> -}        [ ['T','a','b','i','e'], ['T','a','b','i','i'] ],
    ...
    MuFACaL                   `adj`     {- <mutAba`> -}        [ ['f','o','l','l','o','w','e','d'], ['a','g','r','e','e','d'] ],

    MuFACiL                   `adj`     {- <mutAbi`> -}        [ ['f','o','l','l','o','w','i','n','g'], ['c','o','n','t','i','n','u','i','n','g'] ],

    MutaFaCCiL                `adj`     {- <mutatabbi`> -}     [ ['p','u','r','s','u','i','n','g'], unwords [ ['k','e','e','p','i','n','g'], ['u','p'], ['w','i','t','h'] ], unwords [ ['i','n','f','o','r','m','e','d'], ['a','b','o','u','t'] ] ],

    MutaFACiL                 `adj`     {- <mutatAbi`> -}      [ ['c','o','n','s','e','c','u','t','i','v','e'], ['s','u','c','c','e','s','s','i','v','e'] ],

    MuFtaCaL                  `adj`     {- <muttaba`> -}       [ ['f','o','l','l','o','w','e','d'], ['o','b','s','e','r','v','e','d'], ['a','d','h','e','r','e','d'] ] ]
...
cluster_8   = cluster
 ...
 |> "t b l" <| [
    ...
    FaCaL                     `verb`    {- <tabal> -}          [ ['c','o','n','s','u','m','e'], ['w','a','s','t','e'] ]
                              `imperf`     FCiL,

    FaCCaL                    `verb`    {- <tabbal> -}         [ ['s','p','i','c','e'], ['s','e','a','s','o','n'] ],

    FACaL                     `verb`    {- <tAbal> -}          [ ['s','p','i','c','e'], ['s','e','a','s','o','n'] ],

    FACaL                     `noun`    {- <tAbal> -}          [ ['c','o','r','i','a','n','d','e','r'] ],

    FACiL                     `noun`    {- <tAbil> -}          [ ['c','o','r','i','a','n','d','e','r'] ],

    FACiL                     `noun`    {- <tAbil> -}          [ ['s','p','i','c','e'], ['c','o','n','d','i','m','e','n','t'] ]
                              `plural`     FawACiL,

    FaCCUL |< aT              `noun`    {- <tabbUlaT> -}       [ ['t','a','b','b','o','u','l','e','h'], ['s','a','l','a','d'] ],

    MaFCUL                    `adj`     {- <matbUl> -}         [ unwords [ ['l','o','v','e'], "-", ['s','i','c','k'] ], ['r','a','v','a','g','e','d'] ],

    MuFaCCaL                  `adj`     {- <mutabbal> -}       [ ['s','p','i','c','e','d'], ['s','t','u','f','f','e','d'] ] ]
...
cluster_10  = cluster
 ...
 |> ['t','a','b','r','I','z'] <| [
    ...
    _____                     `noun`    {- <tabrIz> -}         [ ['T','a','b','r','i','z'] ],

    _____ |< Iy               `adj`     {- <tabrIzIy> -}       [ ['T','a','b','r','i','z','i'], unwords [ ['o','f'], "/", ['f','r','o','m'], ['T','a','b','r','i','z'] ] ] ]
...
cluster_15  = cluster
 ...
 |> "t ^g n" <| [
    ...
    FICAL |< Iy               `noun`    {- <tI^gAnIy> -}       [ ['T','i','j','a','n','i'] ] ]
...
cluster_16  = cluster
 ...
 |> "t .h t" <| [
    ...
    FaCL |<< "a"              `prep`    {- <ta.hta> -}         [ ['b','e','l','o','w'], ['u','n','d','e','r'], ['u','n','d','e','r','n','e','a','t','h'] ],

    FaCL                      `noun`    {- <ta.ht> -}          [ ['b','o','t','t','o','m'], unwords [ ['l','o','w','e','r'], ['p','a','r','t'] ] ],

    FaCL |< Iy                `adj`     {- <ta.htIy> -}        [ ['l','o','w','e','r'], unwords [ ['s','u','b'], "-" ], unwords [ ['i','n','f','r','a'], "-" ] ],

    FaCLAn |< Iy              `adj`     {- <ta.htAnIy> -}      [ ['l','o','w','e','r'], unwords [ ['s','u','b'], "-" ], unwords [ ['i','n','f','r','a'], "-" ], ['b','a','s','e'] ] ]
...
cluster_21  = cluster
 ...
 |> "t _h m" <| [
    ...
    FuCL |< aT                `noun`    {- <tu_hmaT> -}        [ ['i','n','d','i','g','e','s','t','i','o','n'] ],

    MaFCUL                    `adj`     {- <mat_hUm> -}        [ ['d','y','s','p','e','p','t','i','c'], unwords [ ['h','a','v','i','n','g'], ['i','n','d','i','g','e','s','t','i','o','n'] ] ],
 ...
 |> "t _h m" <| [
    ...
    FuCL                      `noun`    {- <tu_hm> -}          [ ['b','o','u','n','d','a','r','y'], ['l','i','m','i','t'] ]
                              `plural`     FuCUL,

    MuFACiL                   `adj`     {- <mutA_him> -}       [ ['n','e','i','g','h','b','o','r','i','n','g'], ['a','d','j','a','c','e','n','t'] ] ]
...
cluster_23  = cluster
 ...
 |> ['t','a','d','m','u','r'] <| [
    ...
    _____ |< Iy               `noun`    {- <tadmurIy> -}       [ ['T','a','d','m','u','r','i'] ],

    lA >| _____               `noun`    {- <lA-tadmur> -}      [ ['n','o','b','o','d','y'], unwords [ ['n','o'], ['o','n','e'] ] ] ]
...
cluster_24  = cluster
 ...
 |> "t r b" <| [
    ...
    FaCiL                     `adj`     {- <tarib> -}          [ ['d','u','s','t','y'] ],

    FuCL |< aT                `noun`    {- <turbaT> -}         [ ['d','u','s','t'], ['g','r','a','v','e','y','a','r','d'] ]
                              `plural`     FuCaL,

    FuCaL |< Iy               `noun`    {- <turabIy> -}        [ ['g','r','a','v','e','d','i','g','g','e','r'] ]
                              `plural`     FuCaL |< Iy |< aT
    ...
    FuCAL |< Iy               `noun`    {- <turAbIy> -}        [ ['T','u','r','a','b','i'] ],
...
cluster_27  = cluster
 ...
 |> ['t','a','r','A','^','g','I','d'] <| [
    ...
    _____ |< iyA              `noun`    {- <tarA^gIdiyA> -}    [ ['t','r','a','g','e','d','y'] ],

    _____ |< Iy               `adj`     {- <tarA^gIdIy> -}     [ ['t','r','a','g','i','c'] ] ]

 |> ['t','r','a','^','g','I','d'] <| [

    _____ |< iyA              `noun`    {- <tra^gIdiyA> -}     [ ['t','r','a','g','e','d','y'] ],

    _____ |< Iy               `adj`     {- <tra^gIdIy> -}      [ ['t','r','a','g','i','c'] ] ]
...
cluster_28  = cluster
 ...
 |> "t r ^g m" <| [
    ...
    KuRDuSAn                  `noun`    {- <tur^gumAn> -}      [ ['t','r','a','n','s','l','a','t','o','r'], ['i','n','t','e','r','p','r','e','t','e','r'], ['d','r','a','g','o','m','a','n'] ]
                              `plural`     KaRADiS |< aT
                              `plural`     KaRADIS,

    MuKaRDiS                  `noun`    {- <mutar^gim> -}      [ ['t','r','a','n','s','l','a','t','o','r'], ['i','n','t','e','r','p','r','e','t','e','r'], ['b','i','o','g','r','a','p','h','e','r'] ]
                              `plural`     MuKaRDiS |< Un
                           
    `derives` otherwise,

    MuKaRDaS                  `adj`     {- <mutar^gam> -}      [ ['t','r','a','n','s','l','a','t','e','d'] ] ]
...
cluster_30  = cluster
 ...
 |> ['t','a','r','A','_','h','U','m'] <| [
    ...
    _____ |<< "A"             `noun`    {- <tarA_hUmA> -}      [ ['t','r','a','c','h','o','m','a'] ] ]
...
cluster_31  = cluster
 ...
 |> "t r z" <| [
    ...
    FaCL |< Iy                `noun`    {- <tarzIy> -}         [ ['t','a','i','l','o','r'] ],

    FaCL |< Iy |< aT          `noun`    {- <tarzIyaT> -}       [ ['t','a','i','l','o','r','i','n','g'] ] ]
...
cluster_32  = cluster
 ...
 |> "t r s" <| [
    ...
    FuCL                      `noun`    {- <turs> -}           [ ['s','h','i','e','l','d'], ['d','i','s','k'] ]
                              `plural`     FuCUL
                              `plural`     HaFCAL,

    FiCL                      `noun`    {- <tirs> -}           [ ['g','e','a','r'], ['c','o','g','w','h','e','e','l'] ]
                              `plural`     FuCUL,

    FaCL |<< "_hAn" |< aT     `noun`    {- <tars_hAnaT> -}     [ ['a','r','s','e','n','a','l'], ['s','h','i','p','y','a','r','d'], ['d','o','c','k','y','a','r','d'] ],

    MaFCaL                    `noun`    {- <matras> -}         [ ['b','o','l','t'], ['b','a','r','r','i','c','a','d','e'] ]
                              `plural`     MaFACiL,

    MiFCaL                    `noun`    {- <mitras> -}         [ ['b','o','l','t'], ['b','a','r','r','i','c','a','d','e'] ]
                              `plural`     MaFACiL,
...
cluster_36  = cluster
 ...
 |> "t r f" <| [
    ...
    FaCiL                     `adj`     {- <tarif> -}          [ ['o','p','u','l','e','n','t'], ['l','u','x','u','r','i','o','u','s'] ],

    MuFCaL                    `adj`     {- <mutraf> -}         [ ['w','e','a','l','t','h','y'], ['l','u','x','u','r','i','o','u','s'] ] ]
...
cluster_42  = cluster
 ...
 |> "t r m _d" <| [
    ...
    KiRDiS |< Iy              `noun`    {- <tirmi_dIy> -}      [ ['T','i','r','m','i','d','h','i'] ] ]
...
cluster_53  = cluster
 ...
 |> ['t','i','r','s','A','n'] <| [
    ...
    _____ |< aT               `noun`    {- <tirsAnaT> -}       [ ['a','r','s','e','n','a','l'], ['s','h','i','p','y','a','r','d'] ]
                              `plural`     _____ |< At,

    _____ |< aT               `noun`    {- <tirsAnaT> -}       [ ['T','e','r','s','a','n','a'], ['T','i','r','s','a','n','a'] ] ]
...
cluster_59  = cluster
 ...
 |> "t s `" <| [
    ...
    FiCL |< In |< At          `noun`    {- <tis`InAt> -}       [ ['n','i','n','e','t','i','e','s'] ]
                              `plural`     FiCL |< In |< At
                           
    `limited` "-------P--",

    FiCL |< In |< Iy          `adj`     {- <tis`InIy> -}       [ ['n','i','n','e','t','i','e','s'] ] ]
...
cluster_61  = cluster
 ...
 |> "t ` b" <| [
    ...
    MuFCiL                    `adj`     {- <mut`ib> -}         [ ['t','r','o','u','b','l','e','s','o','m','e'], ['t','i','r','e','s','o','m','e'] ],

    MuFCaL                    `adj`     {- <mut`ab> -}         [ ['t','i','r','e','d'], ['w','e','a','r','y'] ] ]
...
cluster_63  = cluster
 ...
 |> "t ` s" <| [
    ...
    FaCIL                     `adj`     {- <ta`Is> -}          [ ['w','r','e','t','c','h','e','d'], ['m','i','s','e','r','a','b','l','e'] ]
                              `plural`     FuCaLA',

    MaFCUL                    `adj`     {- <mat`Us> -}         [ ['w','r','e','t','c','h','e','d'], ['m','i','s','e','r','a','b','l','e'] ]
                              `plural`     MaFACIL ]
...
cluster_69  = cluster
 ...
 |> "t f l" <| [
    ...
    FaCiL                     `adj`     {- <tafil> -}          [ ['m','a','l','o','d','o','r','o','u','s'] ],
...
cluster_70  = cluster
 ...
 |> "t f h" <| [
    ...
    FACiL                     `adj`     {- <tAfih> -}          [ ['t','r','i','v','i','a','l'], ['c','o','m','m','o','n','p','l','a','c','e'] ],

    HaFCaL                    `adj`     {- <'atfah> -}         [ unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['t','r','i','v','i','a','l'] ] ],
...
cluster_71  = cluster
 ...
 |> "t q n" <| [
    ...
    FiCaL |< Iy               `adj`     {- <tiqanIy> -}        [ ['t','e','c','h','n','i','c','a','l'] ],
    ...
    HaFCaL                    `adj`     {- <'atqan> -}         [ unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['p','e','r','f','e','c','t'] ] ],
...
cluster_76  = cluster
 ...
 |> ['t','a','k','n','I','k'] <| [
    ...
    _____                     `noun`    {- <taknIk> -}         [ ['t','e','c','h','n','i','q','u','e'] ],

    _____ |< Iy               `adj`     {- <taknIkIy> -}       [ ['t','e','c','h','n','i','c','a','l'] ] ]
...
cluster_80  = cluster
 ...
 |> "t l d" <| [
    ...
    FaCIL                     `adj`     {- <talId> -}          [ ['i','n','h','e','r','i','t','e','d'], unwords [ ['t','i','m','e'], "-", ['h','o','n','o','r','e','d'] ] ],

    FACiL                     `adj`     {- <tAlid> -}          [ ['i','n','h','e','r','i','t','e','d'], unwords [ ['t','i','m','e'], "-", ['h','o','n','o','r','e','d'] ] ],

    FiCAL                     `adj`     {- <tilAd> -}          [ ['i','n','h','e','r','i','t','e','d'], unwords [ ['t','i','m','e'], "-", ['h','o','n','o','r','e','d'] ] ] ]
...
cluster_81  = cluster
 ...
 |> "t l s" <| [
    ...
    FaCCIL                    `noun`    {- <tallIs> -}         [ ['s','a','c','k'] ]
                              `plural`     FaCACIL,

    FiCCIL                    `noun`    {- <tillIs> -}         [ ['s','a','c','k'] ]
                              `plural`     FaCACIL ]
...
cluster_83  = cluster
 ...
 |> "t l `" <| [
    ...
    FaCIL                     `adj`     {- <talI`> -}          [ ['l','o','n','g'], ['e','x','t','e','n','d','e','d'] ] ]
...
cluster_85  = cluster
 ...
 |> "t l f" <| [
    ...
    FACiL                     `adj`     {- <tAlif> -}          [ ['r','u','i','n','e','d'], ['b','r','o','k','e','n'] ],

    MaFCUL                    `adj`     {- <matlUf> -}         [ ['r','u','i','n','e','d'], ['b','r','o','k','e','n'] ],

    MuFCiL                    `adj`     {- <mutlif> -}         [ ['d','a','m','a','g','i','n','g'], ['h','a','r','m','f','u','l'] ] ]
...
cluster_95  = cluster
 ...
 |> "t l h" <| [
    ...
    FACiL                     `adj`     {- <tAlih> -}          [ ['b','e','w','i','l','d','e','r','e','d'], ['d','i','s','t','r','a','c','t','e','d'] ],

    MutaFaCCaL                `adj`     {- <mutatallah> -}     [ ['b','e','w','i','l','d','e','r','e','d'], ['d','i','s','t','r','a','c','t','e','d'] ] ]
...
cluster_96  = cluster
 ...
 |> "t m t m" <| [
    ...
    KaRDaS                    `verb`    {- <tamtam> -}         [ ['s','t','a','m','m','e','r'], ['m','u','t','t','e','r'] ],

    KaRDaS |< aT              `noun`    {- <tamtamaT> -}       [ ['m','u','r','m','u','r','i','n','g'], ['b','a','b','b','l','e'] ] ]
...
cluster_97  = cluster
 ...
 |> "t m r" <| [
    ...
    FaCL                      `noun`    {- <tamr> -}           [ unwords [ ['d','a','t','e'], "(", ['f','r','u','i','t'], ")" ] ],

    FACiL                     `noun`    {- <tAmir> -}          [ ['T','a','m','i','r'], ['T','a','m','e','r'] ],

    FayCUL                    `noun`    {- <taymUr> -}         [ ['T','a','y','m','o','u','r'], ['T','a','i','m','u','r'] ],

    FaCaL |<< "^g" |< Iy      `noun`    {- <tamar^gIy> -}      [ ['n','u','r','s','e'], unwords [ ['h','o','s','p','i','t','a','l'], ['a','t','t','e','n','d','a','n','t'] ] ]
...
cluster_98  = cluster
 ...
 |> "t m s .h" <| [
    ...
    KiRDAS                    `noun`    {- <timsA.h> -}        [ ['c','r','o','c','o','d','i','l','e'] ]
                              `plural`     KaRADIS ]
...
cluster_99  = cluster
 ...
 |> "t m .g" <| [
    ...
    FaCL |< aT                `noun`    {- <tam.gaT> -}        [ ['s','t','a','m','p'] ] ]
