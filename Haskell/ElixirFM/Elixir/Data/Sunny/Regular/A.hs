...
module Elixir.Data.Sunny.Regular.A where
...
cluster_2   = cluster
 ...
 |> "d" <| [
    ...
    _____                     `xtra`    {- <d> -}              [ "D", ['4','t','h'] ],

    _____                     `ynit`    {- <d> -}              [ ['D','r','.'], unwords [ "(", ['m','i','n','u','t','e'], ")" ], unwords [ "(", ['d','i','n','a','r'], ")" ], unwords [ "(", ['d','i','r','h','a','m'], ")" ] ] ]
...
cluster_5   = cluster
 ...
 |> "^s" <| [
    ...
    _____                     `noun`    {- <^s> -}             [ ['S','H'], ['2','1','s','t'], unwords [ "(", ['s','t','r','e','e','t'], ")" ] ] ]
...
cluster_12  = cluster
 ...
 |> "t" <| [
    ...
    _____                     `noun`    {- <t> -}              [ "T", unwords [ "(", ['d','a','t','e'], ")" ], unwords [ "(", ['t','i','m','e'], "/", ['t','i','m','i','n','g'], ")" ], unwords [ "(", ['d','i','e','d'], ")" ], ['2','2','n','d'] ] ]
...
cluster_14  = cluster
 ...
 |> "r" <| [
    ...
    _____                     `noun`    {- <r> -}              [ "R", ['2','0','t','h'], unwords [ "(", ['R','e','u','t','e','r','s'], ")" ], unwords [ "(", ['r','i','a','l'], ")" ], unwords [ "(", ['n','u','m','e','r','i','c'], ['c','o','m','m','a'], ")" ] ] ]
...
cluster_22  = cluster
 ...
 |> "li'ann" <| [
    ...
    _____ |<< "a"             `conj`    {- <li'anna> -}        [ ['b','e','c','a','u','s','e'] ] ]
...
cluster_23  = cluster
 ...
 |> "li'an" <| [
    ...
    _____                     `conj`    {- <li'an> -}          [ unwords [ ['i','n'], ['o','r','d','e','r'], ['t','o'] ] ] ]
...
cluster_24  = cluster
 ...
 |> "li'allA" <| [
    ...
    _____                     `conj`    {- <li'allA> -}        [ unwords [ ['i','n'], ['o','r','d','e','r'], ['n','o','t'], ['t','o'] ] ] ]
...
cluster_25  = cluster
 ...
 |> "la'inn" <| [
    ...
    _____ |<< "a"             `part`    {- <la'inna> -}        [ ['t','r','u','l','y'], ['i','n','d','e','e','d'] ] ]
...
cluster_111 = cluster
 ...
 |> "tUbA.gU" <| [
    ...
    _____                     `noun`    {- <tUbA.gU> -}        [ ['T','o','b','a','g','o'] ] ]
...
cluster_114 = cluster
 ...
 |> "tAyland" <| [
    ...
    _____                     `noun`    {- <tAyland> -}        [ ['T','h','a','i','l','a','n','d'] ],
...
cluster_120 = cluster
 ...
 |> "tUlstUy" <| [
    ...
    _____                     `noun`    {- <tUlstUy> -}        [ ['T','o','l','s','t','o','y'], ['T','o','l','s','t','o','i'] ] ]
...
cluster_141 = cluster
 ...
 |> "tarA^gIdiyA" <| [
    ...
    _____                     `noun`    {- <tarA^gIdiyA> -}    [ ['t','r','a','g','e','d','y'] ] ]
