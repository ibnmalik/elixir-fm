...
cluster_1   = cluster
 ...
 |> "z k r" <| [
    ...
    FuCL |< aT                `noun`    {- <zukraT> -}         [ unwords [ ['s','m','a','l','l'], ['w','i','n','e','s','k','i','n'] ], unwords [ ['z','u','k','r','a'], "(", ['o','b','o','e'], "-", ['l','i','k','e'], ['i','n','s','t','r','u','m','e','n','t'], ")" ] ]
                              `plural`     FuCaL ]
...
cluster_5   = cluster
 ...
 |> ['z','U','l','U','^','g'] <| [
    ...
    _____ |< iyA              `noun`    {- <zUlU^giyA> -}      [ ['z','o','o','l','o','g','y'] ],

    _____ |< Iy               `adj`     {- <zUlU^gIy> -}       [ ['z','o','o','l','o','g','i','c','a','l'] ] ]
...
cluster_13  = cluster
 ...
 |> ['z','I','l','A','n','d'] <| [
    ...
    _____ |<< "A"             `xtra`    {- <zIlAndA> -}        [ ['Z','e','a','l','a','n','d'] ],
...
cluster_19  = cluster
 ...
 |> "z m z m" <| [
    ...
    KaRDaS                    `adj`     {- <zamzam> -}         [ ['a','b','u','n','d','a','n','t'] ],

    KaRDaS |< Iy |< aT        `noun`    {- <zamzamIyaT> -}     [ ['c','a','n','t','e','e','n'], ['t','h','e','r','m','o','s'] ],

    KaRDaS |< aT              `noun`    {- <zamzamaT> -}       [ unwords [ ['l','i','o','n','\'','s'], ['r','o','a','r'] ], unwords [ ['r','o','l','l'], ['o','f'], ['t','h','u','n','d','e','r'] ] ]
                              `plural`     KaRADiS ]
...
cluster_24  = cluster
 ...
 |> "z m n" <| [
    ...
    lA >| MutaFACiL           `adj`     {- <lA-mutazAmin> -}   [ unwords [ ['n','o','n'], "-", ['s','i','m','u','l','t','a','n','e','o','u','s'] ] ] ]
...
cluster_27  = cluster
 ...
 |> "z n b" <| [
    ...
    FayCaL                    `noun`    {- <zaynab> -}         [ ['Z','e','i','n','a','b'] ] ]
...
cluster_41  = cluster
 ...
 |> ['z','i','n','t','a','r'] <| [
    ...
    _____ |< Iy |< aT         `noun`    {- <zintarIyaT> -}     [ ['d','y','s','e','n','t','e','r','y'] ] ]
...
cluster_46  = cluster
 ...
 |> ['z','i','n','.','t','A','r'] <| [
    ...
    _____ |< Iy |< aT         `noun`    {- <zin.tArIyaT> -}    [ ['d','y','s','e','n','t','e','r','y'] ] ]
...
cluster_50  = cluster
 ...
 |> "z h d" <| [
    ...
    FACiL                     `adj`     {- <zAhid> -}          [ ['a','s','c','e','t','i','c'], ['a','b','s','t','i','n','e','n','t'] ]
                              `plural`     FuCCAL ]
...
cluster_51  = cluster
 ...
 |> "z h r" <| [
    ...
    FaCL                      `noun`    {- <zahr> -}           [ ['f','l','o','w','e','r'], ['b','l','o','s','s','o','m'] ]
                              `plural`     FuCUL
                              `plural`     HaFCuL
                              `plural`     HaFCAL
                              `plural`     HaFACiL
    ...
    FaCL |< aT                `noun`    {- <zahraT> -}         [ ['s','p','l','e','n','d','o','r'], ['b','e','a','u','t','y'] ],

    FuCayL                    `noun`    {- <zuhayr> -}         [ ['Z','u','h','e','i','r'], ['Z','u','h','a','y','r'] ],

    FuCL |< aT                `noun`    {- <zuhraT> -}         [ ['b','r','i','l','l','i','a','n','c','y'], ['b','e','a','u','t','y'] ],
    ...
    FaCLAn |< Iy              `noun`    {- <zahrAnIy> -}       [ ['Z','a','h','r','a','n','i'] ],

    FaCLA' |< Iy              `adj`     {- <zahrAwIy> -}       [ ['c','h','e','e','r','f','u','l'], ['m','e','r','r','y'] ],

    FaCLA' |< Iy              `noun`    {- <zahrAwIy> -}       [ ['Z','a','h','r','a','w','i'], ['Z','a','h','r','a','o','u','i'] ],
    ...
    HaFCaL |< Iy              `noun`    {- <'azharIy> -}       [ ['A','z','h','a','r','i'] ],
...
cluster_63  = cluster
 ...
 |> ['s','I','b','I','r'] <| [
    ...
    _____ |< iyA              `xtra`    {- <sIbIriyA> -}       [ ['S','i','b','e','r','i','a'] ],

    _____ |< Iy               `adj`     {- <sIbIrIy> -}        [ ['S','i','b','e','r','i','a','n'] ] ]
...
cluster_69  = cluster
 ...
 |> "s b `" <| [
    ...
    FaCL |< In |< Iy          `adj`     {- <sab`InIy> -}       [ ['s','e','v','e','n','t','i','e','s'] ],
...
cluster_70  = cluster
 ...
 |> "s b .g" <| [
    ...
    HaFCaL                    `verb`    {- <'asba.g> -}        [ unwords [ ['b','e','s','t','o','w'], ['a','m','p','l','y'] ], unwords [ ['i','m','p','a','r','t'], ['l','i','b','e','r','a','l','l','y'] ] ],
...
cluster_71  = cluster
 ...
 |> "s b q" <| [
    ...
    FaCaL                     `noun`    {- <sabaq> -}          [ unwords [ ['s','t','a','k','e'], "(", ['i','n'], "a", ['r','a','c','e'], ")" ] ]
                              `plural`     HaFCAL,
    ...
    FaCCAL                    `adj`     {- <sabbAq> -}         [ ['a','n','t','i','c','i','p','a','t','o','r','y'], ['e','x','p','r','e','s','s'] ],
    ...
    HaFCaL                    `adj`     {- <'asbaq> -}         [ ['p','r','e','v','i','o','u','s'], ['f','o','r','m','e','r'], ['e','a','r','l','i','e','r'] ],
...
cluster_73  = cluster
 ...
 |> "s b l" <| [
    ...
    HaFCaL                    `verb`    {- <'asbal> -}         [ unwords [ ['l','e','t'], ['h','a','n','g'], ['d','o','w','n'] ], ['l','o','w','e','r'] ],

    FaCaL                     `noun`    {- <sabal> -}          [ unwords [ ['e','a','r'], ['o','f'], ['c','e','r','e','a','l'] ] ],
    ...
    FACiL                     `adj`     {- <sAbil> -}          [ unwords [ ['p','u','b','l','i','c'], ['r','o','a','d'] ] ],
...
cluster_76  = cluster
 ...
 |> "s b h" <| [
    ...
    FiCAL |< Iy               `noun`    {- <sibAhIy> -}        [ unwords [ ['s','i','b','a','h','i'], "(", ['A','l','g','e','r','i','a','n'], ['c','a','v','a','l','r','y'], ")" ] ],
...
cluster_77  = cluster
 ...
 |> ['s','a','b','a','h','l','a','l'] <| [
    ...
    _____ |<< "aN"            `noun`    {- <sabahlalaN> -}     [ ['a','i','m','l','e','s','s','l','y'], unwords [ ['a','t'], ['r','a','n','d','o','m'] ] ] ]
...
cluster_79  = cluster
 ...
 |> "s t r" <| [
    ...
    FuCaL |< Iy               `noun`    {- <sutarIy> -}        [ ['c','l','o','w','n'] ],
...
cluster_94  = cluster
 ...
 |> "s .h b" <| [
    ...
    FaCAL |< aT               `noun`    {- <sa.hAbaT> -}       [ ['u','m','b','r','e','l','l','a'] ]
                              `plural`     FaCAL |< At,

    FaCAL |< aT |<< "a"       `noun`    {- <sa.hAbaTa> -}      [ ['d','u','r','i','n','g'], unwords [ ['i','n'], ['t','h','e'], ['c','o','u','r','s','e'], ['o','f'] ] ],
