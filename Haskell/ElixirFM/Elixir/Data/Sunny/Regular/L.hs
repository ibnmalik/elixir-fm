...
cluster_27  = cluster
 ...
 |> ['^','s','a','m','`','a','d','A','n'] <| [
    ...
    _____                     `noun`    {- <^sam`adAn> -}      [ ['c','a','n','d','e','l','a','b','r','u','m'], ['c','a','n','d','l','e','h','o','l','d','e','r'] ]
                              `plural`     _____ |< At ]
...
cluster_70  = cluster
 ...
 |> ".s d r" <| [
    ...
    FACiL |< At               `noun`    {- <.sAdirAt> -}       [ ['e','x','p','o','r','t','s'] ],
...
cluster_85  = cluster
 ...
 |> ".s r m" <| [
    ...
    FuCLAy |< aT              `noun`    {- <.surmAyaT> -}      [ ['s','h','o','e','s'] ]
                              `plural`     FaCALI
                              `plural`     FuCLAy |< At,

    FuCaL |< At |< Iy         `noun`    {- <.suramAtIy> -}     [ ['c','o','b','b','l','e','r'] ]
                              `plural`     FuCaL |< At |< Iy |< aT ]
