...
cluster_35  = cluster
 ...
 |> "n .s b" <| [
    ...
    FACiL                     `adj`     {- <nA.sib> -}         [ ['t','i','r','i','n','g'], ['e','x','h','a','u','s','t','i','n','g'], unwords [ ['w','o','r','d','s'], "(", ['e','g','.'], ['p','r','e','p','o','s','i','t','i','o','n','s'], ")", ['g','o','v','e','r','n','i','n','g'], ['t','h','e'], ['s','u','b','j','u','n','c','t','i','v','e'] ] ]
                              `plural`     FawACiL,
...
cluster_77  = cluster
 ...
 |> "n ^s z" <| [
    ...
    FACiL                     `noun`    {- <nA^siz> -}         [ ['r','e','b','e','l','i','o','u','s'], ['d','i','s','o','b','e','d','i','e','n','t'] ]
                              `plural`     FACiL |< Un
                           
    `derives` otherwise,

    FACiL |< aT               `noun`    {- <nA^sizaT> -}       [ unwords [ ['r','e','b','e','l','i','o','u','s'], ['w','i','f','e'], "(", ['i','s','l','.'], ['l','a','w'], ")" ], ['s','h','r','e','w'], unwords [ ['r','e','b','e','l','i','o','u','s'], ['w','i','v','e','s'], "(", ['i','s','l','.'], ['l','a','w'], ")" ] ]
                              `plural`     FawACiL ]
