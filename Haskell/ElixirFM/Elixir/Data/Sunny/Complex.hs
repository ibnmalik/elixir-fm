...
cluster_18  = cluster
 ...
 |> "t w ' " <| [
    ...
    FAL                       `noun`    {- <tA'> -}            [ unwords [ "ta'", "(", "" {- "Arabic" -}, "letter", ")" ] ]
                              `plural`     FAL |< At ]
...
cluster_59  = cluster
 ...
 |> "_t  w '" <| [
    ...
    FAL                       `noun`    {- <_tA'> -}           [ unwords [ "va'", "(", "" {- "Arabic" -}, "letter", ")" ] ]
                              `plural`     FAL |< At ]
...
cluster_64  = cluster
 ...
 |> "_t n y" <| [
    ...
    FACI |<< "aN"             `adj`     {- <_tAniyaN> -}       [ "secondly" ],

    FACI |< aT                `noun`    {- <_tAniyaT> -}       [ unwords [ "second", "(", "time", "span", ")" ] ]
                              `plural`     FawACI,
...
cluster_71  = cluster
 ...
 |> "_t w r" <| [
    ...
    FA'iL                     `noun`    {- <_tA'ir> -}         [ "insurgent", "revolutionary" ]
                              `plural`     FUCAL,
...
cluster_84  = cluster
 ...
 |> "d ` w" <| [
    ...
    FACI                      `noun`    {- <dA`I> -}           [ "inviter", "propagandist", "caller" ]
                              `plural`     FuCY |< aT
    ...
    MuFtaCY                   `noun`    {- <mudda`Y> -}        [ "claim", "pretension" ]
                              `plural`     MuFtaCY |< At ]
...
cluster_129 = cluster
 ...
 |> "d w r" <| [
    ...
    HiFAL |< Iy |<< "aN"      `adj`     {- <'idArIyaN> -}      [ "administratively", "officially" ],
...
cluster_177 = cluster
 ...
 |> "_d w w" <| [
    ...
    "_d" |<< "U"              `noun`    {- <_dU> -}            [ "of", "with" ],

    "_dAt"                    `noun`    {- <_dAt> -}           [ "self", "being" ]
                              `plural`     "_daw" |< At,

    "_daw" |< At |< Iy        `adj`     {- <_dawAtIy> -}       [ unwords [ "high", "-", "class" ], "exclusive" ] ]
...
cluster_179 = cluster
 ...
 |> "_d y l" <| [
    ...
    FaCL                      `noun`    {- <_dayl> -}          [ "tail", "end", "supplement", "addendum", "consequence" ]
                              `plural`     HaFCAL
                              `plural`     FuCUL,
...
cluster_182 = cluster
 ...
 |> "r w '" <| [
    ...
    FAL                       `noun`    {- <rA'> -}            [ unwords [ "ra'", "(", "" {- "Arabic" -}, "letter", ")" ] ]
                              `plural`     FAL |< At ]
...
cluster_199 = cluster
 ...
 |> "r ` y" <| [
    ...
    FaCY |< Iy |< aT          `noun`    {- <ra`awIyaT> -}      [ "citizenship", "nationality" ],

    FaCA' |< Iy               `adj`     {- <ra`A'Iy> -}        [ "pastoral", "bucolic" ],

    FaCY |< Iy                `adj`     {- <ra`awIy> -}        [ "pastoral", "bucolic" ],
...
cluster_217 = cluster
 ...
 |> "r s w" <| [
    ...
    FaCA                      `verb`    {- <rasA> -}           [ unwords [ "set", "anchor" ], "disembark", unwords [ "be", "moored" ] ]
                              `imperf`     FCU,

    FaCCY                     `verb`    {- <rassY> -}          [ "grant", "award" ],

    HaFCY                     `verb`    {- <'arsY> -}          [ unwords [ "lay", "plans" ], unwords [ "set", "anchor" ], unwords [ "be", "moored" ] ],
...
cluster_243 = cluster
 ...
 |> "r w q" <| [
    ...
    FiCAL                     `noun`    {- <riwAq> -}          [ "hall", "portico", "gallery" ]
                              `plural`     HaFCiL |< aT,
...
cluster_251 = cluster
 ...
 |> "r w y" <| [
    ...
    MaFCIL |< aT              `noun`    {- <marwIyaT> -}       [ "tale", "story", "report" ]
                              `plural`     MaFCIL |< At ]
...
cluster_260 = cluster
 ...
 |> "r y b" <| [
    ...
    HaFAL                     `verb`    {- <'arAb> -}          [ "disquiet", unwords [ "fill", "with", "misgivings" ] ],
...
cluster_276 = cluster
 ...
 |> "z  w '" <| [
    ...
    FAL                       `noun`    {- <zA'> -}            [ unwords [ "za'", "(", "" {- "Arabic" -}, "letter", ")" ] ]
                              `plural`     FAL |< At ]
...
cluster_311 = cluster
 ...
 |> "z y t" <| [
    ...
    FaCLUn                    `noun`    {- <zaytUn> -}         [ "olives", unwords [ "olive", "tree" ] ],

    FaCLUn |< aT              `noun`    {- <zaytUnaT> -}       [ "olive" ]
                              `plural`     FaCLUn |< At,

    FaCLUn |< Iy              `adj`     {- <zaytUnIy> -}       [ unwords [ "olive", "-", "like" ], "olive" ],

    FaCLUn |< aT              `noun`    {- <zaytUnaT> -}       [ "" {- "Zaitouna" -} ],

    FaCLUn |< Iy              `adj`     {- <zaytUnIy> -}       [ "" {- "Zaitounite" -} ],
...
cluster_312 = cluster
 ...
 |> "z y r" <| [
    ...
    FIL                       `noun`    {- <zIr> -}            [ unwords [ "water", "pot" ] ]
                              `plural`     HaFCAL
                              `plural`     FiCAL ]
...
cluster_317 = cluster
 ...
 |> "s ' d" <| [
    ...
    "sAd" |< Iy |< aT         `noun`    {- <sAdIyaT> -}        [ "sadism" ],

    "sAd" |< Iy               `adj`     {- <sAdIy> -}          [ "sadistic" ] ]
...
cluster_327 = cluster
 ...
 |> "s ^g w" <| [
    ...
    FaCIy |< aT               `noun`    {- <sa^gIyaT> -}       [ unwords [ "natural", "disposition" ], unwords [ "character", "trait" ], "characteristics" ]
                              `plural`     FaCAyY,
...
cluster_341 = cluster
 ...
 |> "s m y" <| [
    ...
    MuFaCCY                   `noun`    {- <musammY> -}        [ "title", "name" ]
                              `plural`     MuFaCCY |< At,
...
cluster_358 = cluster
 ...
 |> "s w `" <| [
    ...
    FAL |< At |< Iy           `noun`    {- <sA`AtIy> -}        [ "watchmaker" ],
...
cluster_379 = cluster
 ...
 |> "s w y" <| [
    ...
    FaCIL |<< "aN"            `adj`     {- <sawIyaN> -}        [ "together", "jointly", unwords [ "in", "common" ] ],
...
cluster_417 = cluster
 ...
 |> "^s f y" <| [
    ...
    FaCY |< Iy                `adj`     {- <^safawIy> -}       [ "oral", "verbal", "orally", "verbally" ] ]
...
cluster_571 = cluster
 ...
 |> ".t w `" <| [
    ...
    FaCL |< Iy |<< "aN"       `adj`     {- <.taw`IyaN> -}      [ "voluntarily" ],
...
cluster_576 = cluster
 ...
 |> ".t w l" <| [
    ...
    FaCIL |<< "aN"            `adj`     {- <.tawIlaN> -}       [ unwords [ "for", "a", "long", "time" ], unwords [ "at", "length" ], "extensively" ],
...
cluster_621 = cluster
 ...
 |> "l q y" <| [
    ...
    TiFCA' |< Iy |<< "aN"     `adj`     {- <tilqA'IyaN> -}     [ "automatically", "spontaneously" ],
...
cluster_688 = cluster
 ...
 |> "n m y" <| [
    ...
    TaFCI |< Iy               `adj`     {- <tanmawIy> -}       [ "developmental", unwords [ "growth", "-", "related" ] ],
