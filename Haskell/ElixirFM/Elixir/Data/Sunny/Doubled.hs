...
cluster_2   = cluster
 ...
 |> "t b b" <| [
    ...
    FaCL |<< "aN"             `noun`    {- <tabbaN> -}         [ unwords [ "perish", "!" ] ]
                              `plural`     FaCL,

    IstiFCAL                  `noun`    {- <istitbAb> -}       [ "normalcy", "stability" ]
                              `plural`     IstiFCAL |< At,

    FaCLAn                    `noun`    {- <tabbAn> -}         [ unwords [ "straw", "vendor" ] ]
                              `plural`     FaCLAn |< Un
                           
    `derives` feminine,

    FaCLAn |< aT              `noun`    {- <tabbAnaT> -}       [ "Milky" ] ]
...
cluster_3   = cluster
 ...
 |> "t f f" <| [
    ...
    FuCL |<< "aN"             `noun`    {- <tuffaN> -}         [ unwords [ "phew", "!" ] ]
                              `plural`     FuCL,
...
cluster_7   = cluster
 ...
 |> "t m m" <| [
    ...
    FaCAL |<< "aN"            `noun`    {- <tamAmaN> -}        [ "exactly", "completely" ]
                              `plural`     FaCAL,
    ...
    FACL                      `noun`    {- <tAmm> -}           [ "complete", "concluded" ] ]
...
cluster_10  = cluster
 ...
 |> "_t b b" <| [
    ...
    FaL |< At                 `noun`    {- <_tabAt> -}         [ "reliability", "constancy" ],

    FaL |< At |< Iy           `adj`     {- <_tabAtIy> -}       [ "stable", "static" ],

    FaL |< At |< Iy |< aT     `noun`    {- <_tabAtIyaT> -}     [ "stability" ] ]
...
cluster_12  = cluster
 ...
 |> "_t m m" <| [
    ...
    FuCL |<< "a"              `noun`    {- <_tumma> -}         [ "then", "thereupon" ],

    FaCL |<< "a"              `noun`    {- <_tamma> -}         [ "therefore", unwords [ "there", "(", "is", "/", "are", ")" ] ],

    FaCL |< aT |<< "a"        `noun`    {- <_tammaTa> -}       [ unwords [ "there", "(", "is", "/", "are", ")" ] ],
...
cluster_17  = cluster
 ...
 |> "d ` b b" <| [
    ...
    KaRDUS                    `noun`    {- <da`bUb> -}         [ "Daboub", "Dabob" ] ]
...
cluster_32  = cluster
 ...
 |> "r .g .g" <| [
    ...
    FaCLA'                    `noun`    {- <ra.g.gA'> -}       [ "garrulous", "chatterbox" ] ]
...
cluster_33  = cluster
 ...
 |> "r .h .h" <| [
    ...
    FaL |<< "awIy"            `adj`     {- <ra.hawIy> -}       [ "rotating", "rotatory" ] ]
...
cluster_38  = cluster
 ...
 |> "r _h _h" <| [
    ...
    FaL |<< "awIy"            `noun`    {- <ra_hawIy> -}       [ "mollusks" ] ]
...
cluster_40  = cluster
 ...
 |> "r ` d d" <| [
    ...
    KiRDIS                    `adj`     {- <ri`dId> -}         [ "coward", "cowardly" ]
                              `plural`     KaRADIS ]
...
cluster_42  = cluster
 ...
 |> "r b s s" <| [
    ...
    KuRDUS                    `noun`    {- <rubsUs> -}         [ unwords [ "licorice", "rob" ] ] ]
...
cluster_43  = cluster
 ...
 |> "r d d" <| [
    ...
    FaCL |<< "aN"             `noun`    {- <raddaN> -}         [ unwords [ "in", "reply", "to" ], unwords [ "in", "answer", "to" ] ]
                              `plural`     FaCL,
...
cluster_48  = cluster
 ...
 |> "r n n" <| [
    ...
    FaCLAn                    `adj`     {- <rannAn> -}         [ "resounding", "resonating", "ringing", "reverberating" ]
                              `plural`     FaCLAn |< Un
                              `plural`     FaCCAL |< Un,
...
cluster_50  = cluster
 ...
 |> "r t t" <| [
    ...
    FuCL                      `noun`    {- <rutt> -}           [ unwords [ "having", "a", "speech", "defect" ] ] ]
...
cluster_58  = cluster
 ...
 |> "z k k" <| [
    ...
    FaL |<< "aN"              `noun`    {- <zakaN> -}          [ "alms", "purity", "honesty", "integrity" ]
                              `plural`     FaCA ]
...
cluster_66  = cluster
 ...
 |> "s .h t t" <| [
    ...
    KaRDUS                    `noun`    {- <sa.htUt> -}        [ unwords [ "sahtout", "(", "surface", "measure", ")" ] ],

    KuRDUS                    `noun`    {- <su.htUt> -}        [ "penny" ] ]
...
cluster_68  = cluster
 ...
 |> "s d d" <| [
    ...
    FaCCaL                    `verb`    {- <saddad> -}         [ "obstruct", "aim", "direct" ],
...
cluster_73  = cluster
 ...
 |> "s n n" <| [
    ...
    FaCLAn                    `noun`    {- <sannAn> -}         [ "grinder", "sharpener" ]
                              `plural`     FaCLAn |< Un
                              `plural`     FaCCAL |< Un
...
cluster_74  = cluster
 ...
 |> "s q q" <| [
    ...
    FaCLA'                    `noun`    {- <saqqA'> -}         [ unwords [ "water", "carrier" ] ]
                              `plural`     FaCLA' |< Un,

    FaCLA'                    `noun`    {- <saqqA'> -}         [ "Saqqa" ],
...
cluster_75  = cluster
 ...
 |> "s r r" <| [
    ...
    FiCL |<< "aN"             `noun`    {- <sirraN> -}         [ "secretly", "privately" ]
                              `plural`     FiCL,
...
cluster_78  = cluster
 ...
 |> "^s .h r r" <| [
    ...
    KaRDUS                    `noun`    {- <^sa.hrUr> -}       [ "Shahrur" ],

    KuRDUS                    `noun`    {- <^su.hrUr> -}       [ "thrush", "blackbird" ]
                              `plural`     KaRADIS ]
...
cluster_81  = cluster
 ...
 |> "^s ^g ^g" <| [
    ...
    FaL |<< "aN"              `noun`    {- <^sa^gaN> -}        [ "sadness", "distress", "anxiety" ],

    FaL |<< "awIy"            `adj`     {- <^sa^gawIy> -}      [ "worried", "distressed" ] ]
...
cluster_82  = cluster
 ...
 |> "^s _d _d" <| [
    ...
    FaL |<< "aN"              `noun`    {- <^sa_daN> -}        [ "perfume", "aroma", "fragrance", "bouquet" ]
                              `plural`     FaCA
                              `plural`     FaCY ]
...
cluster_88  = cluster
 ...
 |> "^s f f" <| [
    ...
    FaL |< aT                 `noun`    {- <^safaT> -}         [ "lip" ]
                              `plural`     FaCA'iL,

    FaL |<< "awIy"            `adj`     {- <^safawIy> -}       [ "oral", "verbal", "orally", "verbally" ],

    FaL |<< "aN"              `noun`    {- <^safaN> -}         [ "brink", "verge", "edge" ]
                              `plural`     HaFCA'
                              `plural`     FaCA ]
...
cluster_91  = cluster
 ...
 |> "^s l l" <| [
    ...
    FiCL |< aT                `noun`    {- <^sillaT> -}        [ "group", "clique" ]
                              `plural`     FiCaL,

    FaCCAL                    `noun`    {- <^sallAl> -}        [ "cataract", "cascade" ]
                              `plural`     FaCCAL |< At,
...
cluster_93  = cluster
 ...
 |> "^s m m" <| [
    ...
    FaL |< At                 `noun`    {- <^samAt> -}         [ "gloating", unwords [ "malicious", "joy" ] ] ]
...
cluster_95  = cluster
 ...
 |> "^s q q" <| [
    ...
    FaL |<< "aN"              `noun`    {- <^saqaN> -}         [ "hardship", "distress", "suffering", "misery" ]
                              `plural`     FaCA ]
...
cluster_97  = cluster
 ...
 |> "^s t t" <| [
    ...
    FaL |< At                 `noun`    {- <^satAt> -}         [ "dispersed", "scattered" ]
                              `plural`     FaCIL |< aT,
...
cluster_98  = cluster
 ...
 |> ".s .g .g" <| [
    ...
    FaL |<< "aN"              `noun`    {- <.sa.gaN> -}        [ "inclination", "disposition", "benevolence" ] ]
...
cluster_99  = cluster
 ...
 |> ".s .h .h" <| [
    ...
    MaFaCL |< aT              `noun`    {- <ma.sa.h.haT> -}    [ "sanatorium" ],
...
cluster_100 = cluster
 ...
 |> ".s b b" <| [
    ...
    FiL |<< "aN"              `noun`    {- <.sibaN> -}         [ "youth", "childhood" ],
...
cluster_102 = cluster
 ...
 |> ".s f f" <| [
    ...
    FaL |<< "aN"              `noun`    {- <.safaN> -}         [ "stones", "rocks" ]
                              `plural`     FaCA ]
...
cluster_105 = cluster
 ...
 |> ".s m m" <| [
    ...
    FaCCaL                    `verb`    {- <.sammam> -}        [ unwords [ "be", "determined" ], unwords [ "be", "persistent" ] ],
...
cluster_115 = cluster
 ...
 |> ".d m m" <| [
    ...
    FaCIL |< aT               `noun`    {- <.damImaT> -}       [ "addition", "increase" ]
                              `plural`     FaCA'iL,
...
cluster_117 = cluster
 ...
 |> ".d r r" <| [
    ...
    FawALI                    `noun`    {- <.dawArI> -}        [ unwords [ "predatory", "animals" ] ] ]
...
cluster_118 = cluster
 ...
 |> ".t .h r r" <| [
    ...
    KuRDUS                    `noun`    {- <.tu.hrUr> -}       [ "cloud", "cirrus" ]
                              `plural`     KaRADIS,

    KuRDUS |< Iy              `adj`     {- <.tu.hrUrIy> -}     [ "stratosphere", "cloudy" ] ]
...
cluster_119 = cluster
 ...
 |> ".t _h r r" <| [
    ...
    KuRDUS                    `noun`    {- <.tu_hrUr> -}       [ "cloud", "cirrus" ]
                              `plural`     KaRADiS,

    KuRDUS |< Iy              `adj`     {- <.tu_hrUrIy> -}     [ "stratosphere", "cloudy" ] ]
...
cluster_125 = cluster
 ...
 |> ".t n n" <| [
    ...
    FaCLAn                    `noun`    {- <.tannAn> -}        [ "resounding", "ringing" ]
                              `plural`     FaCLAn |< Un
                              `plural`     FaCCAL |< Un
                              `plural`     HiFCAL
                              `plural`     HiFCAL |< At
...
cluster_126 = cluster
 ...
 |> ".t r r" <| [
    ...
    FuCL                      `noun`    {- <.turr> -}          [ "altogether", unwords [ "one", "and", "all" ] ],
...
cluster_127 = cluster
 ...
 |> ".z l l" <| [
    ...
    FaCL |<< "a"              `noun`    {- <.zalla> -}         [ "remain", "continue" ]
                              `plural`     FaCiL
                              `plural`     FaCL
                              `plural`     FCaL,
    ...
    MiFaCL |< Iy              `adj`     {- <mi.zallIy> -}      [ "parachutists", "paratrooper" ],
...
cluster_132 = cluster
 ...
 |> "l .g .g" <| [
    ...
    FuL |< aT                 `noun`    {- <lu.gaT> -}         [ "language" ],

    FuL |<< "awIy"            `adj`     {- <lu.gawIy> -}       [ "language", "linguistic" ],

    FuL |<< "awIy"            `adj`     {- <lu.gawIy> -}       [ "linguist" ] ]
...
cluster_137 = cluster
 ...
 |> "l _t _t" <| [
    ...
    FiL |< aT                 `noun`    {- <li_taT> -}         [ "gums" ]
                              `plural`     FiCY,

    FiL |<< "awIy"            `adj`     {- <li_tawIy> -}       [ "gingival", unwords [ "of", "the", "gums" ] ] ]
...
cluster_140 = cluster
 ...
 |> "l d d" <| [
    ...
    FiCL                      `noun`    {- <lidd> -}           [ "Lydda" ],

    FaCaL                     `noun`    {- <ladad> -}          [ "quarrel", "dispute" ],

    FaCUL                     `noun`    {- <ladUd> -}          [ "implacable", "mortal" ],

    HaFaCL                    `noun`    {- <'aladd> -}         [ "implacable", "mortal" ],

    FaCLA'                    `noun`    {- <laddA'> -}         [ "implacable", "mortal" ]
                              `plural`     FuCL
                              `plural`     FiCAL
                              `plural`     HaFiCLA',
...
cluster_149 = cluster
 ...
 |> "n .h .h" <| [
    ...
    FaCL |< At                `noun`    {- <na.h.hAt> -}       [ "sculptor", "stonemason" ]
                              `plural`     FaCL |< At |< Un
                           
    `derives` feminine,

    FaCL |< At                `noun`    {- <na.h.hAt> -}       [ "Nahhat" ],

    FaL |<< "awIy"            `adj`     {- <na.hawIy> -}       [ "grammarian" ] ]
...
cluster_150 = cluster
 ...
 |> "n .h r r" <| [
    ...
    KiRDIS                    `noun`    {- <ni.hrIr> -}        [ "skilled", "experience" ]
                              `plural`     KaRADIS
...
cluster_153 = cluster
 ...
 |> "n ^g ^g" <| [
    ...
    FaL |<< "aN"              `noun`    {- <na^gaN> -}         [ "rescue", "survival", "escape", "salvation" ]
                              `plural`     FaCA ]
...
cluster_154 = cluster
 ...
 |> "n ^s ^s" <| [
    ...
    FaL |<< "aN"              `noun`    {- <na^saN> -}         [ "aroma", "scent", "perfume", "starch" ]
                              `plural`     FaCA,

    FaL |<< "awIy"            `adj`     {- <na^sawIy> -}       [ "starchy" ],

    FaL |<< "awIy" |< At      `noun`    {- <na^sawIyAt> -}     [ "starches", unwords [ "starchy", "foodstuffs" ] ] ]
...
cluster_160 = cluster
 ...
 |> "n k k" <| [
    ...
    FaCL |< At                `noun`    {- <nakkAt> -}         [ "witty", "joker" ]
                              `plural`     FaCL |< At |< Un
...
cluster_161 = cluster
 ...
 |> "n m m" <| [
    ...
    FuCL |< Iy                `adj`     {- <nummIy> -}         [ "numismatic", "coin" ] ]
...
cluster_163 = cluster
 ...
 |> "n s s" <| [
    ...
    FaCLA'                    `noun`    {- <nassA'> -}         [ "forgetful", "oblivious" ]
                              `plural`     FaCLA' |< Un ]
