...
module Elixir.Data.Sunny.Complex.C (section) where
...
cluster_2   = cluster
 ...
 |> "r .d y" <| [
    ...
    FiCA                      `noun`    {- <ri.dA> -}          [ ['R','i','d','a'], ['R','e','z','a'] ],

    FiCwAn                    `noun`    {- <ri.dwAn> -}        [ ['a','p','p','r','o','v','a','l'], ['a','c','c','e','p','t','a','n','c','e'], ['s','a','t','i','s','f','a','c','t','i','o','n'] ],

    FiCwAn                    `noun`    {- <ri.dwAn> -}        [ ['R','e','d','w','a','n'], ['R','a','d','w','a','n'] ],
...
cluster_4   = cluster
 ...
 |> "r ` w" <| [
    ...
    FaCLY                     `noun`    {- <ra`wY> -}          [ ['r','e','p','e','n','t','a','n','c','e'], ['c','o','n','v','e','r','s','i','o','n'] ],
 ...
 |> "r ` y" <| [
    ...
    FACY                      `verb`    {- <rA`Y> -}           [ ['o','b','s','e','r','v','e'], ['h','e','e','d'], unwords [ ['s','h','o','w'], ['d','e','f','e','r','e','n','c','e'] ] ],

    HaFCY                     `verb`    {- <'ar`Y> -}          [ ['w','a','t','c','h'], unwords [ ['p','a','y'], ['a','t','t','e','n','t','i','o','n'] ] ],
...
cluster_6   = cluster
 ...
 |> "r f '" <| [
    ...
    MaFCaL                    `noun`    {- <marfa'> -}         [ ['p','o','r','t'], ['h','a','r','b','o','r'], unwords [ ['l','a','n','d','i','n','g'], ['p','l','a','c','e'] ] ]
                              `plural`     MaFACiL
                              `plural`     MaFCaL |< At ]
...
cluster_9   = cluster
 ...
 |> ['r','A','f','i','y','A'] <| [
    ...
    _____                     `noun`    {- <rAfiyA> -}         [ ['r','a','f','f','i','a'], unwords [ ['r','a','f','f','i','a'], ['p','a','l','m'] ] ] ]
...
cluster_11  = cluster
 ...
 |> "r q q" <| [
    ...
    HaFaCL                    `adj`     {- <'araqq> -}         [ unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['g','e','n','t','l','e'] ], unwords [ ['t','h','i','n','n','e','r'], "/", ['t','h','i','n','n','e','s','t'] ], unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['d','e','l','i','c','a','t','e'] ] ],
...
cluster_13  = cluster
 ...
 |> "r q y" <| [
    ...
    HaFCY                     `adj`     {- <'arqY> -}          [ ['h','i','g','h','e','r'], ['s','u','p','e','r','i','o','r'], unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['a','d','v','a','n','c','e','d'] ] ],
...
cluster_14  = cluster
 ...
 |> "r k k" <| [
    ...
    FuCAL                     `adj`     {- <rukAk> -}          [ ['w','e','a','k'], ['f','e','e','b','l','e'] ],
...
cluster_16  = cluster
 ...
 |> "r m m" <| [
    ...
    FuCAL                     `adj`     {- <rumAm> -}          [ ['d','e','c','a','y','e','d'], ['r','o','t','t','e','n'] ],

    FuCLAn                    `noun`    {- <rummAn> -}         [ ['p','o','m','e','g','r','a','n','a','t','e'] ],

    FuCLAn |< aT              `noun`    {- <rummAnaT> -}       [ ['k','n','o','b'], ['p','o','m','m','e','l'], ['g','r','e','n','a','d','e'] ],
...
cluster_17  = cluster
 ...
 |> "r m y" <| [
    ...
    FaCY                      `verb`    {- <ramY> -}           [ ['t','h','r','o','w'], ['f','l','i','n','g'], ['s','h','o','o','t'] ]
                              `imperf`     FCI,
    ...
    FACI                      `adj`     {- <rAmI> -}           [ ['t','h','r','o','w','i','n','g'], unwords [ ['a','i','m','e','d'], "(", ['a','t'], ")" ], unwords [ ['a','t','t','e','m','p','t','i','n','g'], "(", ['t','o'], ")" ] ],

    FACI                      `noun`    {- <rAmI> -}           [ ['t','h','r','o','w','e','r'], ['r','i','f','l','e','m','a','n'], ['a','r','c','h','e','r'] ]
                              `plural`     FuCY |< aT,
...
cluster_27  = cluster
 ...
 |> "r w ^g" <| [
    ...
    HaFCaL                    `adj`     {- <'arwa^g> -}        [ unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['w','i','d','e','s','p','r','e','a','d'] ], unwords [ ['i','n'], ['w','i','d','e','r'], "/", ['w','i','d','e','s','t'], ['c','i','r','c','u','l','a','t','i','o','n'] ] ],
...
cluster_28  = cluster
 ...
 |> "r w .h" <| [
    ...
    FIL |<< "Aw" |< Iy        `noun`    {- <rI.hAwIy> -}       [ ['R','i','h','a','w','i'] ],

    FIL |<< "Aw" |< Iy        `adj`     {- <rI.hAwIy> -}       [ unwords [ ['f','r','o','m'], "/", ['o','f'], ['J','e','r','i','c','h','o'] ] ],
...
cluster_32  = cluster
 ...
 |> "r w .d" <| [
    ...
    FiyAL |< Iy               `adj`     {- <riyA.dIy> -}       [ ['s','p','o','r','t','s'], ['s','p','o','r','t','i','v','e'], ['m','a','t','h','e','m','a','t','i','c','a','l'] ],
...
cluster_33  = cluster
 ...
 |> "r w `" <| [
    ...
    FaCCaL                    `verb`    {- <rawwa`> -}         [ ['t','e','r','r','i','f','y'], ['f','r','i','g','h','t','e','n'] ],
    ...
    HaFCaL                    `adj`     {- <'arwa`> -}         [ unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['m','a','g','n','i','f','i','c','e','n','t'] ] ],

    TaFCIL                    `noun`    {- <tarwI`> -}         [ ['t','e','r','r','i','f','y','i','n','g'], ['f','r','i','g','h','t','e','n','i','n','g'] ],
...
cluster_34  = cluster
 ...
 |> "r w .g" <| [
    ...
    HaFCaL                    `adj`     {- <'arwa.g> -}        [ unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['c','u','n','n','i','n','g'] ] ],
...
cluster_38  = cluster
 ...
 |> ['r','A','w','a','n','d'] <| [
    ...
    _____                     `noun`    {- <rAwand> -}         [ ['r','h','u','b','a','r','b'] ] ]
...
cluster_39  = cluster
 ...
 |> "r w y" <| [
    ...
    FiCA'                     `adj`     {- <riwA'> -}          [ unwords [ ['w','e','l','l'], ['i','r','r','i','g','a','t','e','d'] ], ['p','l','u','m','p'] ],

    FayLAn                    `adj`     {- <rayyAn> -}         [ unwords [ ['w','e','l','l'], ['i','r','r','i','g','a','t','e','d'] ], ['v','e','r','d','a','n','t'], ['p','l','u','m','p'] ]
                              `plural`     FiCA'
                              `femini`     FayLY,

    FayLY                     `noun`    {- <rayyY> -}          [ ['f','r','a','g','r','a','n','c','e'], ['a','r','o','m','a'], ['s','c','e','n','t'] ],
...
cluster_40  = cluster
 ...
 |> "r y b" <| [
    ...
    HaFCaL                    `adj`     {- <'aryab> -}         [ unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['s','k','e','p','t','i','c','a','l'] ] ],
...
cluster_41  = cluster
 ...
 |> "r y _t" <| [
    ...
    FaCL |<< "a" |<< "mA"     `conj`    {- <ray_tamA> -}       [ unwords [ ['a','s'], ['l','o','n','g'], ['a','s'] ], ['u','n','t','i','l'] ],
...
cluster_42  = cluster
 ...
 |> "r y ^s" <| [
    ...
    FiCAL |< Iy               `noun`    {- <riyA^sIy> -}       [ ['R','i','y','a','c','h','i'] ],
...
cluster_51  = cluster
 ...
 |> ['z','A','y'] <| [
    ...
    _____                     `noun`    {- <zAy> -}            [ unwords [ ['z','a','y'], "(", ['A','r','a','b','i','c'], ['l','e','t','t','e','r'], ")" ] ]
                              `plural`     _____ |< At ]
...
cluster_55  = cluster
 ...
 |> "z ' m" <| [
    ...
    FuCAL                     `adj`     {- <zu'Am> -}          [ ['s','u','d','d','e','n'], ['v','i','o','l','e','n','t'] ] ]
...
cluster_74  = cluster
 ...
 |> ['z','I','m','b','A','b','w'] <| [
    ...
    _____ |<< "I"             `xtra`    {- <zImbAbwI> -}       [ ['Z','i','m','b','a','b','w','e'] ],
...
cluster_78  = cluster
 ...
 |> "z h w" <| [
    ...
    HaFCY                     `adj`     {- <'azhY> -}          [ unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['s','p','l','e','n','d','i','d'] ], unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['c','o','n','c','e','i','t','e','d'] ] ],
...
cluster_79  = cluster
 ...
 |> "z w ^g" <| [
    ...
    FaCCaL                    `verb`    {- <zawwa^g> -}        [ ['c','o','u','p','l','e'], ['j','o','i','n'], unwords [ ['m','a','r','r','y'], ['o','f','f'] ] ],

    FACaL                     `verb`    {- <zAwa^g> -}         [ ['c','o','u','p','l','e'], ['j','o','i','n'], ['m','a','r','r','y'] ],
...
cluster_81  = cluster
 ...
 |> "z w d" <| [
    ...
    FuCCAL |< aT              `noun`    {- <zuwwAdaT> -}       [ ['p','r','o','v','i','s','i','o','n','s'] ],
...
cluster_82  = cluster
 ...
 |> "z w r" <| [
    ...
    HaFAL                     `verb`    {- <'azAr> -}          [ unwords [ ['m','a','k','e'], ['v','i','s','i','t'] ] ],
...
cluster_85  = cluster
 ...
 |> "z w q" <| [
    ...
    MuFaCCaL                  `adj`     {- <muzawwaq> -}       [ ['e','m','b','e','l','l','i','s','h','e','d'], ['f','l','o','w','e','r','y'], ['d','e','c','o','r','a','t','e','d'] ] ]
...
cluster_93  = cluster
 ...
 |> "z y d" <| [
    ...
    HaFCaL                    `adj`     {- <'azyad> -}         [ unwords [ ['h','i','g','h','e','r'], "/", ['h','i','g','h','e','s','t'] ], unwords [ ['g','r','e','a','t','e','r'], "/", ['g','r','e','a','t','e','s','t'] ] ],
    ...
    FA'iL                     `adj`     {- <zA'id> -}          [ ['a','d','d','i','t','i','o','n','a','l'], ['e','x','c','e','e','d','i','n','g'], ['e','x','c','e','s','s','i','v','e'] ],
