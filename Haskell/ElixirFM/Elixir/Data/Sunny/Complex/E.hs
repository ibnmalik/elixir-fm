...
cluster_4   = cluster
 ...
 |> "^s t t" <| [
    ...
    FaCL                      `noun`    {- <^satt> -}          [ ['v','a','r','i','e','t','y'], ['d','i','s','p','e','r','s','e','d'], ['s','c','a','t','t','e','r','e','d'] ]
                              `plural`     HaFCAL,
...
cluster_7   = cluster
 ...
 |> "^s ^g w" <| [
    ...
    HaFCY                     `verb`    {- <'a^s^gY> -}        [ ['g','r','i','e','v','e'], ['w','o','r','r','y'] ],
    ...
    FaCA |< Iy                `adj`     {- <^sa^gawIy> -}      [ ['w','o','r','r','i','e','d'], ['d','i','s','t','r','e','s','s','e','d'] ],

    FaCIy                     `adj`     {- <^sa^gIy> -}        [ ['w','o','r','r','i','e','d'], ['g','r','i','e','v','e','d'], ['s','e','n','t','i','m','e','n','t','a','l'] ],
...
cluster_12  = cluster
 ...
 |> "^s d d" <| [
    ...
    HaFaCL                    `adj`     {- <'a^sadd> -}        [ unwords [ ['s','t','r','o','n','g','e','r'], "/", ['s','t','r','o','n','g','e','s','t'] ], unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['i','n','t','e','n','s','e'] ] ],
...
cluster_15  = cluster
 ...
 |> "^s _d _d" <| [
    ...
    FACL                      `adj`     {- <^sA_d_d> -}        [ ['d','e','v','i','a','n','t'], ['a','b','n','o','r','m','a','l'] ]
                              `plural`     FuCCAL
                              `plural`     FawACL,

    FawACL                    `noun`    {- <^sawA_d_d> -}      [ ['e','x','c','e','p','t','i','o','n','s'] ]
                              `plural`     FawACL
...
cluster_18  = cluster
 ...
 |> "^s r ' b" <| [
    ...
    MuKRaDiSS                 `adj`     {- <mu^sra'ibb> -}     [ unwords [ ['c','r','a','n','i','n','g'], ['t','h','e'], ['n','e','c','k'] ], unwords [ ['s','t','r','e','t','c','h','i','n','g'], ['t','h','e'], ['n','e','c','k'] ] ] ]
...
cluster_19  = cluster
 ...
 |> "^s r r" <| [
    ...
    FaCIL                     `adj`     {- <^sarIr> -}         [ ['b','a','d'], ['w','i','c','k','e','d'], ['e','v','i','l'] ]
                              `plural`     HaFiCL |< aT
                              `plural`     HaFCAL,

    FiCCIL                    `adj`     {- <^sirrIr> -}        [ ['w','i','c','k','e','d'], ['e','v','i','l'], ['b','a','d'] ],

    FiCCIL                    `noun`    {- <^sirrIr> -}        [ ['S','a','t','a','n'] ],
...
cluster_21  = cluster
 ...
 |> "^s r y" <| [
    ...
    MuFtaCI                   `adj`     {- <mu^starI> -}       [ ['b','u','y','i','n','g'], ['p','u','r','c','h','a','s','i','n','g'] ],
    ...
    MuFtaCY                   `adj`     {- <mu^starY> -}       [ ['b','o','u','g','h','t'], ['p','u','r','c','h','a','s','e','d'] ],
...
cluster_26  = cluster
 ...
 |> "^s ` `" <| [
    ...
    HaFaCL                    `verb`    {- <'a^sa``> -}        [ ['r','a','d','i','a','t','e'], unwords [ ['e','m','i','t'], ['r','a','y','s'] ] ],
...
cluster_27  = cluster
 ...
 |> "^s ` w" <| [
    ...
    HaFCY                     `adj`     {- <'a^s`Y> -}         [ ['r','u','t','h','l','e','s','s'], ['d','e','v','a','s','t','a','t','i','n','g'] ]
                              `femini`     FaCLA' ]
...
cluster_29  = cluster
 ...
 |> "^s f f" <| [
    ...
    FaCA'iL                   `noun`    {- <^safA'if> -}       [ ['l','i','p','s'] ]
                              `plural`     FaCA'iL
                           
    `limited` "-------P--",

    FaCAyiL                   `noun`    {- <^safAyif> -}       [ ['l','i','p','s'] ]
                              `plural`     FaCAyiL
...
cluster_30  = cluster
 ...
 |> "^s f w" <| [
    ...
    MuFCI                     `adj`     {- <mu^sfI> -}         [ unwords [ ['d','o','o','m','e','d'], ['t','o'], ['d','e','a','t','h'] ] ] ]
...
cluster_32  = cluster
 ...
 |> "^s q q" <| [
    ...
    FaCIL                     `adj`     {- <^saqIq> -}         [ ['f','r','a','t','e','r','n','a','l'], ['b','r','o','t','h','e','r','l','y'], ['s','i','s','t','e','r','l','y'] ],
...
cluster_33  = cluster
 ...
 |> "^s q w" <| [
    ...
    FaCIy                     `adj`     {- <^saqIy> -}         [ ['m','i','s','e','r','a','b','l','e'], ['w','r','e','t','c','h'], ['d','a','m','n','e','d'] ]
                              `plural`     HaFCiyA',
...
cluster_44  = cluster
 ...
 |> "^s h w" <| [
    ...
    MuFaCCI                   `adj`     {- <mu^sahhI> -}       [ ['a','p','p','e','t','i','z','i','n','g'] ],
...
cluster_47  = cluster
 ...
 |> "^s w r" <| [
    ...
    HiFAL |<< "^g" |< Iy      `noun`    {- <'i^sAr^gIy> -}     [ ['s','i','g','n','a','l','m','a','n'] ]
                              `plural`     HiFAL |<< "^g" |< Iy |< aT
...
cluster_57  = cluster
 ...
 |> "^s w k" <| [
    ...
    FaCL |< aT                `noun`    {- <^sawkaT> -}        [ ['f','o','r','k'], ['t','h','o','r','n'] ]
                              `plural`     FaCL |< At,
...
cluster_66  = cluster
 ...
 |> "^s y '" <| [
    ...
    lA >| FaCL |< Iy          `adj`     {- <lA-^say'Iy> -}     [ ['n','o','n','e','x','i','s','t','e','n','t'], unwords [ ['n','o','n'], "-", ['b','e','i','n','g'] ] ],

    lA >| FaCL |< Iy |< aT    `noun`    {- <lA-^say'IyaT> -}   [ ['n','o','n','e','x','i','s','t','e','n','c','e'] ],
...
cluster_68  = cluster
 ...
 |> "^s y t" <| [
    ...
    FaCCAL                    `noun`    {- <^sayyAt> -}        [ unwords [ ['s','h','o','e'], "-", ['s','h','i','n','e'] ] ] ]
...
cluster_69  = cluster
 ...
 |> "^s y .h" <| [
    ...
    HaFAL                     `verb`    {- <'a^sA.h> -}        [ unwords [ ['a','v','e','r','t'], ['t','h','e'], ['e','y','e','s'] ], unwords [ ['t','u','r','n'], ['a','w','a','y'] ] ],
...
cluster_71  = cluster
 ...
 |> "^s y d" <| [
    ...
    HaFAL                     `verb`    {- <'a^sAd> -}         [ ['p','r','a','i','s','e'], ['c','o','m','m','e','n','d'], ['b','u','i','l','d'] ],
...
cluster_76  = cluster
 ...
 |> "^s y `" <| [
    ...
    MuFACiL                   `adj`     {- <mu^sAyi`> -}       [ ['p','a','r','t','i','s','a','n'], ['b','i','a','s','e','d'] ],
...
cluster_80  = cluster
 ...
 |> "^s y m" <| [
    ...
    FIL |<< "I" |< aT         `noun`    {- <^sImiyaT> -}       [ ['v','o','r','t','e','x'], ['w','h','i','r','l','p','o','o','l'] ]
                              `plural`     FaCALI,
...
cluster_83  = cluster
 ...
 |> ".s ' b" <| [
    ...
    FuCAL |< aT               `noun`    {- <.su'AbaT> -}       [ ['n','i','t'], unwords [ ['l','o','u','s','e'], ['e','g','g'] ] ]
                              `plural`     FILAn
                              `plural`     FuCAL
                              `plural`     FiCLAn ]
...
cluster_89  = cluster
 ...
 |> ".s b w" <| [
    ...
    FaCA                      `verb`    {- <.sabA> -}          [ unwords [ ['s','t','r','i','v','e'], ['f','o','r'] ], unwords [ ['a','s','p','i','r','e'], ['t','o'] ] ]
                              `imperf`     FCU,
...
cluster_90  = cluster
 ...
 |> ".s b y" <| [
    ...
    FaCw |< aT                `noun`    {- <.sabwaT> -}        [ unwords [ ['y','o','u','t','h','f','u','l'], ['z','e','a','l'] ], unwords [ ['c','h','i','l','d','i','s','h'], ['m','a','n','n','e','r','s'] ] ],

    FuCUw |< aT               `noun`    {- <.subUwaT> -}       [ ['c','h','i','l','d','h','o','o','d'], ['y','o','u','t','h'] ],

    FuCUw                     `noun`    {- <.subUw> -}         [ unwords [ ['y','o','u','t','h','f','u','l'], ['z','e','a','l'] ], unwords [ ['c','h','i','l','d','i','s','h'], ['m','a','n','n','e','r','s'] ] ],
...
cluster_91  = cluster
 ...
 |> ".s .h .h" <| [
    ...
    HaFaCL                    `adj`     {- <'a.sa.h.h> -}      [ unwords [ ['m','o','r','e'], ['c','o','r','r','e','c','t'] ] ],
    ...
    MuFaCCiL                  `adj`     {- <mu.sa.h.hi.h> -}   [ ['c','o','r','r','e','c','t','i','n','g'], ['c','o','r','r','e','c','t','i','v','e'] ] ]
...
cluster_93  = cluster
 ...
 |> ".s d '" <| [
    ...
    HaFCaL                    `verb`    {- <'a.sda'> -}        [ ['o','x','i','d','i','z','e'], unwords [ ['m','a','k','e'], ['r','u','s','t','y'] ] ],

    FaCaL                     `noun`    {- <.sada'> -}         [ ['r','u','s','t'], ['o','x','i','d','a','t','i','o','n'] ],

    FaCAL |< aT               `noun`    {- <.sadA'aT> -}       [ ['r','u','s','t'], ['o','x','i','d','a','t','i','o','n'] ],

    FaCiL                     `adj`     {- <.sadi'> -}         [ ['r','u','s','t','y'], ['o','x','i','d','i','z','e','d'] ],
...
cluster_99  = cluster
 ...
 |> ".s .g w" <| [
    ...
    HaFCY                     `verb`    {- <'a.s.gY> -}        [ unwords [ ['p','a','y'], ['a','t','t','e','n','t','i','o','n'] ], ['h','e','e','d'] ],
