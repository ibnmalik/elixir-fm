...
cluster_3   = cluster
 ...
 |> "s ' l" <| [
    ...
    MutaFACiL                 `adj`     {- <mutasA'il> -}      [ ['a','s','k','i','n','g'], ['w','o','n','d','e','r','i','n','g'] ] ]
...
cluster_6   = cluster
 ...
 |> "s b b" <| [
    ...
    FaCaL                     `noun`    {- <sabab> -}          [ ['r','e','a','s','o','n'], ['c','a','u','s','e'] ]
                              `plural`     HaFCAL,
    ...
    FaCIL                     `noun`    {- <sabIb> -}          [ unwords [ ['s','t','r','a','n','d'], ['o','f'], ['h','a','i','r'] ] ]
                              `plural`     FaCA'iL,
...
cluster_9   = cluster
 ...
 |> "s t t" <| [
    ...
    FiCL |< In |< Iy          `adj`     {- <sittInIy> -}       [ ['s','i','x','t','i','e','s'] ],
...
cluster_15  = cluster
 ...
 |> "s d d" <| [
    ...
    HaFaCL                    `adj`     {- <'asadd> -}         [ unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['o','p','p','o','s','i','t','e'] ], unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['r','e','l','e','v','a','n','t'] ] ],
...
cluster_18  = cluster
 ...
 |> ['s','I','r','A','l','i','y','U','n'] <| [
    ...
    _____                     `xtra`    {- <sIrAliyUn> -}      [ unwords [ ['S','i','e','r','r','a'], ['L','e','o','n'] ] ],
...
cluster_19  = cluster
 ...
 |> "s r w" <| [
    ...
    FaCA |< aT                `noun`    {- <sarAT> -}          [ ['c','h','i','e','f'], ['l','e','a','d','e','r'] ]
                              `plural`     FaCA |< At,
...
cluster_21  = cluster
 ...
 |> ['s','a','r','A','y'] <| [
    ...
    _____ |< aT               `noun`    {- <sarAyaT> -}        [ ['p','a','l','a','c','e'], ['a','s','y','l','u','m'] ]
                              `plural`     _____ |< At,

    _____                     `noun`    {- <sarAy> -}          [ ['S','a','r','a','i'], ['S','a','r','a','y'] ],

    _____                     `noun`    {- <sarAy> -}          [ ['p','a','l','a','c','e'] ]
                              `plural`     _____ |< At ]
...
cluster_32  = cluster
 ...
 |> "s f y" <| [
    ...
    MaFCY                     `adj`     {- <masfY> -}          [ unwords [ ['w','h','i','r','l','e','d'], ['u','p'] ], ['p','l','a','y','t','h','i','n','g'] ],

    FACiLA'                   `noun`    {- <sAfiyA'> -}        [ unwords [ ['f','i','n','e'], ['d','u','s','t'] ] ],

    FuCLAn                    `noun`    {- <sufyAn> -}         [ ['S','o','u','f','i','a','n'], ['S','u','f','i','a','n'] ] ]
...
cluster_36  = cluster
 ...
 |> "s q y" <| [
    ...
    FiCAw |< aT               `noun`    {- <siqAwaT> -}        [ ['g','l','a','n','d','e','r','s'] ],
    ...
    FaCY |< Iy                `adj`     {- <saqawIy> -}        [ ['i','r','r','i','g','a','t','i','o','n','a','l'] ],
...
cluster_37  = cluster
 ...
 |> "s k k" <| [
    ...
    FuCLAn                    `noun`    {- <sukkAn> -}         [ ['r','u','d','d','e','r'], ['h','e','l','m'] ]
                              `plural`     FuCLAn |< At,
...
cluster_38  = cluster
 ...
 |> "s l '" <| [
    ...
    FaCaL                     `verb`    {- <sala'> -}          [ unwords [ ['c','l','a','r','i','f','y'], "(", ['b','u','t','t','e','r'], ")" ] ]
                              `imperf`     FCaL,
...
cluster_41  = cluster
 ...
 |> "s l w" <| [
    ...
    FaCA                      `verb`    {- <salA> -}           [ ['f','o','r','g','e','t'], unwords [ ['g','e','t'], ['r','i','d'], ['o','f'] ] ]
                              `imperf`     FCU,

    FaCI                      `verb`    {- <salI> -}           [ ['f','o','r','g','e','t'], unwords [ ['g','e','t'], ['r','i','d'], ['o','f'] ] ]
                              `imperf`     FCY,

    FaCCY                     `verb`    {- <sallY> -}          [ ['c','o','m','f','o','r','t'], ['d','i','s','t','r','a','c','t'], ['c','o','n','s','o','l','e'], ['e','n','t','e','r','t','a','i','n'] ],
...
cluster_42  = cluster
 ...
 |> ['s','U','l','A','w','I','s'] <| [
    ...
    _____ |<< "I"             `xtra`    {- <sUlAwIsI> -}       [ ['S','u','l','a','w','e','s','i'] ],
...
cluster_43  = cluster
 ...
 |> ['s','A','m','a','r','r','A','\''] <| [
    ...
    _____                     `noun`    {- <sAmarrA'> -}       [ ['S','a','m','a','r','r','a'] ] ]
...
cluster_45  = cluster
 ...
 |> "s m w" <| [
    ...
    HaFCY                     `adj`     {- <'asmY> -}          [ unwords [ ['h','i','g','h','e','r'], "/", ['h','i','g','h','e','s','t'] ], unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['e','m','i','n','e','n','t'] ] ],
...
cluster_46  = cluster
 ...
 |> "s m y" <| [
    ...
    FaCCY                     `verb`    {- <sammY> -}          [ ['n','a','m','e'], ['d','e','s','i','g','n','a','t','e'] ],
...
cluster_48  = cluster
 ...
 |> "s n n" <| [
    ...
    HaFaCL                    `verb`    {- <'asann> -}         [ unwords [ ['g','r','o','w'], ['o','l','d'] ], ['a','g','e'], unwords [ ['b','e'], ['a','d','v','a','n','c','e','d'], ['i','n'], ['y','e','a','r','s'] ] ],

    IFtaCL                    `verb`    {- <istann> -}         [ ['f','o','l','l','o','w'], ['p','r','e','s','c','r','i','b','e'] ],

    FaCL                      `noun`    {- <sann> -}           [ ['e','n','a','c','t','m','e','n','t'], ['p','r','e','s','c','r','i','p','t','i','o','n'] ],

    FiCL                      `noun`    {- <sinn> -}           [ ['t','o','o','t','h'], ['p','o','i','n','t'], ['t','i','p'] ]
                              `plural`     HaFCAL
                              `plural`     HaFiCL |< aT,

    FiCL                      `noun`    {- <sinn> -}           [ ['a','g','e'] ]
                              `plural`     HaFCAL,
    ...
    MuFiCL                    `adj`     {- <musinn> -}         [ ['o','l','d'], ['a','g','e','d'], ['s','e','n','i','o','r'], unwords [ ['a','d','v','a','n','c','e','d'], ['i','n'], ['y','e','a','r','s'] ] ] ]
...
cluster_49  = cluster
 ...
 |> "s n w" <| [
    ...
    FaCA |< Iy                `adj`     {- <sanawIy> -}        [ ['y','e','a','r','l','y'], ['a','n','n','u','a','l'], unwords [ ['p','e','r'], ['a','n','n','u','m'] ] ],
 ...
 |> "s n w" <| [
    ...
    HaFCY                     `adj`     {- <'asnY> -}          [ unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['r','a','d','i','a','n','t'] ] ],
...
cluster_55  = cluster
 ...
 |> "s w '" <| [
    ...
    HaFAL                     `verb`    {- <'asA'> -}          [ unwords [ ['d','o'], ['b','a','d','l','y'] ], ['m','i','s','m','a','n','a','g','e'] ],
    ...
    HaFCaL                    `adj`     {- <'aswa'> -}         [ unwords [ ['w','o','r','s','e'], "/", ['w','o','r','s','t'] ] ],
...
cluster_58  = cluster
 ...
 |> "s w .h" <| [
    ...
    FAL                       `verb`    {- <sA.h> -}           [ ['t','r','a','v','e','l'], ['r','o','v','e'], unwords [ ['r','o','a','m'], ['a','b','o','u','t'] ] ]
                              `imperf`     FUL,

    FAL |< aT                 `noun`    {- <sA.haT> -}         [ ['s','c','e','n','e'], ['f','i','e','l','d'], ['a','r','e','n','a'], ['f','o','r','u','m'] ]
                              `plural`     FAL |< At,

    FaCCAL                    `noun`    {- <sawwA.h> -}        [ ['t','o','u','r','i','s','t'], ['t','r','a','v','e','l','e','r'] ]
                              `plural`     FaCCAL |< Un
...
cluster_60  = cluster
 ...
 |> "s w d" <| [
    ...
    FuCayLA'                  `noun`    {- <suwaydA'> -}       [ ['m','e','l','a','n','c','h','o','l','y'] ],
...
cluster_64  = cluster
 ...
 |> ['s','u','w','A','z','I','l','A','n','d'] <| [
    ...
    _____                     `xtra`    {- <suwAzIlAnd> -}     [ ['S','w','a','z','i','l','a','n','d'] ],
...
cluster_65  = cluster
 ...
 |> "s w s" <| [
    ...
    FiyAL |< Iy               `noun`    {- <siyAsIy> -}        [ ['p','o','l','i','t','i','c','i','a','n'], ['s','t','a','t','e','s','m','a','n'] ]
                              `plural`     FiyAL |< Iy |< Un
                              `plural`     FAL |< aT
...
cluster_69  = cluster
 ...
 |> "s w `" <| [
    ...
    FAL |< aT |<< "a" |<< "'i_diN" `adv`     {- <sA`aTa'i_diN> -}   [ unwords [ ['a','t'], ['t','h','a','t'], ['h','o','u','r'], "/", ['t','i','m','e'] ] ],
...
cluster_77  = cluster
 ...
 |> "s w m" <| [
    ...
    FA'iL |< aT               `noun`    {- <sA'imaT> -}        [ unwords [ ['f','r','e','e','l','y'], ['g','r','a','z','i','n','g'], ['l','i','v','e','s','t','o','c','k'] ] ]
                              `plural`     FawA'iL,

    FUL |< aT                 `noun`    {- <sUmaT> -}          [ ['s','i','g','n'], ['c','h','a','r','a','c','t','e','r','i','s','t','i','c'] ],

    FIL |< aT                 `noun`    {- <sImaT> -}          [ ['s','i','g','n'], ['c','h','a','r','a','c','t','e','r','i','s','t','i','c'] ]
                              `plural`     FiyaL,

    FILA'                     `noun`    {- <sImA'> -}          [ ['s','i','g','n'], ['c','h','a','r','a','c','t','e','r','i','s','t','i','c'] ],

    FIL |<< "A"               `noun`    {- <sImA> -}           [ ['s','i','g','n'], ['c','h','a','r','a','c','t','e','r','i','s','t','i','c'] ],

    FILY                      `noun`    {- <sImY> -}           [ ['s','i','g','n'], ['c','h','a','r','a','c','t','e','r','i','s','t','i','c'] ],

    FILiyA'                   `noun`    {- <sImiyA'> -}        [ unwords [ ['n','a','t','u','r','a','l'], ['m','a','g','i','c'] ] ],

    FIL |<< "iyA"             `noun`    {- <sImiyA> -}         [ unwords [ ['n','a','t','u','r','a','l'], ['m','a','g','i','c'] ] ] ]
...
cluster_78  = cluster
 ...
 |> "s w m r" <| [
    ...
    KUDiS                     `noun`    {- <sUmir> -}          [ ['S','u','m','e','r'] ],

    KUDiS |< Iy               `adj`     {- <sUmirIy> -}        [ ['S','u','m','e','r','i','a','n'] ] ]
...
cluster_84  = cluster
 ...
 |> "s y r" <| [
    ...
    HaFAL                     `verb`    {- <'asAr> -}          [ unwords [ ['s','e','t'], ['i','n'], ['m','o','t','i','o','n'] ], ['d','i','s','p','a','t','c','h'] ],
...
cluster_89  = cluster
 ...
 |> "s y n" <| [
    ...
    FILA'                     `noun`    {- <sInA'> -}          [ ['S','i','n','a','i'] ]
                           
    `excepts` Diptote,

    FIL |<< "A"               `noun`    {- <sInA> -}           [ ['S','i','n','a','i'] ] ]
...
cluster_95  = cluster
 ...
 |> "^s ' b" <| [
    ...
    FuCLUL                    `noun`    {- <^su'bUb> -}        [ ['d','o','w','n','p','o','u','r'], ['s','h','o','w','e','r'] ]
                              `plural`     FaCALIL ]
...
cluster_99  = cluster
 ...
 |> "^s ' n" <| [
    ...
    FaCL                      `noun`    {- <^sa'n> -}          [ ['m','a','t','t','e','r'], ['a','f','f','a','i','r'], ['c','o','n','c','e','r','n'], ['r','e','g','a','r','d'] ]
                              `plural`     FuCUL ]
...
cluster_100 = cluster
 ...
 |> "^s ' w" <| [
    ...
    FaCA                      `verb`    {- <^sa'A> -}          [ ['o','u','t','r','a','c','e'], ['o','v','e','r','t','a','k','e'] ]
                              `imperf`     FCU,
