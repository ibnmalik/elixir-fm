...
cluster_1   = cluster
 ...
 |> ".s f w" <| [
    ...
    FACY                      `verb`    {- <.sAfY> -}          [ unwords [ ['b','e'], ['s','i','n','c','e','r','e'], ['w','i','t','h'] ], unwords [ ['d','e','a','l'], ['h','o','n','e','s','t','l','y'], ['w','i','t','h'] ] ],

    HaFCY                     `verb`    {- <'a.sfY> -}         [ ['c','h','o','o','s','e'], ['p','r','e','f','e','r'] ],
    ...
    FaCA |< aT                `noun`    {- <.safAT> -}         [ ['s','t','o','n','e'], ['r','o','c','k'] ]
                              `plural`     FaCA |< At,
...
cluster_2   = cluster
 ...
 |> ['.','s','i','q','i','l','l'] <| [
    ...
    _____ |< Iy |< aT         `noun`    {- <.siqillIyaT> -}    [ ['S','i','c','i','l','y'] ]
                           
    `excepts` Diptote,

    _____ |< Iy               `adj`     {- <.siqillIy> -}      [ ['S','i','c','i','l','i','a','n'] ] ]
...
cluster_5   = cluster
 ...
 |> ".s l w" <| [
    ...
    FaCA |< aT                `noun`    {- <.salAT> -}         [ ['p','r','a','y','e','r'], ['s','a','l','a','t'] ]
                              `plural`     FaCA |< At,

    MuFaCCI                   `adj`     {- <mu.sallI> -}       [ ['p','r','a','y','i','n','g'], ['w','o','r','s','h','i','p','p','i','n','g'] ],

    MuFaCCY                   `noun`    {- <mu.sallY> -}       [ unwords [ ['p','l','a','c','e'], ['o','f'], ['p','r','a','y','e','r'] ], ['o','r','a','t','o','r','y'] ]
                              `plural`     MuFaCCY |< At ]
...
cluster_7   = cluster
 ...
 |> ".s m m" <| [
    ...
    HaFaCL                    `verb`    {- <'a.samm> -}        [ ['d','e','a','f','e','n'], unwords [ ['m','a','k','e'], ['d','e','a','f'] ] ],
...
cluster_8   = cluster
 ...
 |> ".s m y" <| [
    ...
    HaFCY                     `verb`    {- <'a.smY> -}         [ unwords [ ['d','e','a','l'], "a", ['f','a','t','a','l'], ['b','l','o','w'] ] ] ]
...
cluster_19  = cluster
 ...
 |> ".s w _h" <| [
    ...
    HaFAL                     `verb`    {- <'a.sA_h> -}        [ ['l','i','s','t','e','n'], unwords [ ['l','e','n','d'], ['a','n'], ['e','a','r'] ] ],
...
cluster_20  = cluster
 ...
 |> ".s w r" <| [
    ...
    FUL |< aT                 `noun`    {- <.sUraT> -}         [ ['p','i','c','t','u','r','e'], ['i','m','a','g','e'], ['i','l','l','u','s','t','r','a','t','i','o','n'], ['p','h','o','t','o'], ['p','h','o','t','o','g','r','a','p','h'] ]
                              `plural`     FuCaL,
    ...
    MuFaCCiL                  `adj`     {- <mu.sawwir> -}      [ ['p','h','o','t','o','g','r','a','p','h','i','n','g'] ],
...
cluster_23  = cluster
 ...
 |> ".s w `" <| [
    ...
    FAL                       `noun`    {- <.sA`> -}           [ unwords [ ['s','a','a'], "(", ['c','u','b','i','c'], ['d','r','y'], ['m','e','a','s','u','r','e'], ")" ] ]
                              `plural`     HaFCAL,
...
cluster_28  = cluster
 ...
 |> ".s w m l" <| [
    ...
    KUDAS                     `noun`    {- <.sUmAl> -}         [ ['S','o','m','a','l','i','a'] ],

    KUDAS |< Iy               `adj`     {- <.sUmAlIy> -}       [ ['S','o','m','a','l','i'] ]
                              `plural`     KUDAS |< Iy |< Un
                              `plural`     KaRADiS |< aT ]
...
cluster_40  = cluster
 ...
 |> ".s y n" <| [
    ...
    FIL |< Iy |< aT           `noun`    {- <.sInIyaT> -}       [ ['p','o','r','c','e','l','a','i','n'], ['c','h','i','n','a'] ]
                              `plural`     FawALIy
                              `plural`     FawALI ]
...
cluster_42  = cluster
 ...
 |> ".d ' l" <| [
    ...
    HaFCaL                    `adj`     {- <'a.d'al> -}        [ unwords [ ['s','m','a','l','l','e','r'], "/", ['s','m','a','l','l','e','s','t'] ] ],
...
cluster_47  = cluster
 ...
 |> ".d .h y" <| [
    ...
    HaFCY                     `verb`    {- <'a.d.hY> -}        [ unwords [ ['b','r','i','n','g'], ['t','o'], ['l','i','g','h','t'] ], ['b','e','c','o','m','e'], ['b','e','g','i','n'] ],

    FaCw |< aT                `noun`    {- <.da.hwaT> -}       [ ['f','o','r','e','n','o','o','n'], ['m','o','r','n','i','n','g'] ]
                              `plural`     FaCA |< At,

    FuCY                      `noun`    {- <.du.hY> -}         [ ['f','o','r','e','n','o','o','n'] ],
    ...
    FACI |< Iy                `adj`     {- <.dA.hawIy> -}      [ ['s','u','b','u','r','b','a','n'] ] ]
...
cluster_50  = cluster
 ...
 |> ".d r r" <| [
    ...
    FaCUL |< Iy               `adj`     {- <.darUrIy> -}       [ ['n','e','c','e','s','s','a','r','y'], ['r','e','q','u','i','s','i','t','e'] ],

    FaCUL |< Iy |< aT         `noun`    {- <.darUrIyaT> -}     [ ['n','e','c','e','s','s','i','t','y'], ['r','e','q','u','i','s','i','t','e'] ]
                              `plural`     FaCUL |< Iy |< At,
...
cluster_51  = cluster
 ...
 |> ".d r w" <| [
    ...
    FaCAL |< aT               `noun`    {- <.darAwaT> -}       [ ['f','e','r','o','c','i','t','y'], ['z','e','a','l'], ['g','r','e','e','d'], ['v','o','r','a','c','i','t','y'] ],

    FACI                      `adj`     {- <.dArI> -}          [ ['v','o','r','a','c','i','o','u','s'], ['p','r','e','d','a','t','o','r','y'], ['f','e','r','o','c','i','o','u','s'], ['s','a','v','a','g','e'], ['z','e','a','l','o','u','s'] ],

    FACI                      `noun`    {- <.dArI> -}          [ unwords [ ['p','r','e','d','a','t','o','r','y'], ['a','n','i','m','a','l'] ], unwords [ ['b','e','a','s','t'], ['o','f'], ['p','r','e','y'] ] ]
                              `plural`     FawACI ]
...
cluster_53  = cluster
 ...
 |> ".d f w" <| [
    ...
    HaFCY                     `verb`    {- <'a.dfY> -}         [ ['g','r','a','n','t'], ['c','o','n','f','e','r'] ],
    ...
    FACI                      `adj`     {- <.dAfI> -}          [ ['a','m','p','l','e'], ['e','l','a','b','o','r','a','t','e'] ] ]
...
cluster_54  = cluster
 ...
 |> ".d l l" <| [
    ...
    HaFaCL                    `verb`    {- <'a.dall> -}        [ ['m','i','s','l','e','a','d'], ['d','e','c','e','i','v','e'] ],
    ...
    FACL                      `adj`     {- <.dAll> -}          [ ['e','r','r','o','n','e','o','u','s'], ['m','i','s','g','u','i','d','e','d'] ]
                              `plural`     FuCCAL
                              `plural`     FawACL,

    FACL |< aT                `noun`    {- <.dAllaT> -}        [ ['a','m','b','i','t','i','o','n'], ['o','b','j','e','c','t','i','v','e'] ],

    MuFaCCiL                  `adj`     {- <mu.dallil> -}      [ ['m','i','s','l','e','a','d','i','n','g'], ['d','e','c','e','p','t','i','v','e'] ],

    MuFiCL                    `adj`     {- <mu.dill> -}        [ ['m','i','s','l','e','a','d','i','n','g'], ['d','e','c','e','p','t','i','v','e'] ] ]
...
cluster_58  = cluster
 ...
 |> ".d h y" <| [
    ...
    FACY                      `verb`    {- <.dAhY> -}          [ unwords [ ['c','o','m','p','a','r','e'], ['w','i','t','h'] ], ['r','e','s','e','m','b','l','e'], unwords [ ['b','e'], ['a','n','a','l','o','g','o','u','s'] ] ],
...
cluster_64  = cluster
 ...
 |> ".d w y" <| [
    ...
    FaCY                      `verb`    {- <.dawY> -}          [ unwords [ ['r','e','s','o','r','t'], ['t','o'] ], unwords [ ['s','e','e','k'], ['r','e','f','u','g','e'], ['i','n'] ] ]
                              `imperf`     FCI,

    HaFCY                     `verb`    {- <'a.dwY> -}         [ ['w','e','a','k','e','n'], ['i','n','j','u','r','e'] ],

    InFaCY                    `verb`    {- <in.dawY> -}        [ unwords [ ['r','a','l','l','y'], ['a','r','o','u','n','d'] ], ['f','o','l','l','o','w'], unwords [ ['f','l','o','c','k'], ['t','o'] ] ],
...
cluster_66  = cluster
 ...
 |> ".d y `" <| [
    ...
    FiCAL                     `noun`    {- <.diyA`> -}         [ ['l','o','s','s'], ['w','a','s','t','e'] ],
...
cluster_67  = cluster
 ...
 |> ".d y f" <| [
    ...
    HaFAL                     `verb`    {- <'a.dAf> -}         [ ['a','d','d'], ['a','t','t','a','c','h'], unwords [ ['r','e','c','e','i','v','e'], ['a','s'], ['g','u','e','s','t'] ] ],
    ...
    MuFIL                     `adj`     {- <mu.dIf> -}         [ ['a','d','d','i','n','g'], ['a','t','t','a','c','h','i','n','g'], ['h','o','s','t','i','n','g'] ],
    ...
    MuFAL                     `adj`     {- <mu.dAf> -}         [ ['a','d','d','e','d'], ['a','t','t','a','c','h','e','d'], ['h','o','s','t','e','d'] ],
...
cluster_68  = cluster
 ...
 |> ".d y q" <| [
    ...
    HaFCaL                    `adj`     {- <'a.dyaq> -}        [ unwords [ ['n','a','r','r','o','w','e','r'], "/", ['n','a','r','r','o','w','e','s','t'] ], unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['c','o','n','f','i','n','e','d'] ] ],
...
cluster_74  = cluster
 ...
 |> ".t b b" <| [
    ...
    MutaFaCCiL                `noun`    {- <muta.tabbib> -}    [ ['q','u','a','c','k'], unwords [ ['f','a','k','e'], ['p','h','y','s','i','c','i','a','n'] ] ]
                              `plural`     MutaFaCCiL |< Un
...
cluster_79  = cluster
 ...
 |> ".t r w" <| [
    ...
    FaCIy                     `adj`     {- <.tarIy> -}         [ ['f','r','e','s','h'], ['t','e','n','d','e','r'] ],
...
cluster_83  = cluster
 ...
 |> ".t f '" <| [
    ...
    MiFCaL |< aT              `noun`    {- <mi.tfa'aT> -}      [ unwords [ ['f','i','r','e'], ['e','x','t','i','n','g','u','i','s','h','e','r'] ], unwords [ ['f','i','r','e'], ['f','i','g','h','t','e','r'] ] ]
                              `plural`     MaFACiL,

    HiFCAL                    `noun`    {- <'i.tfA'> -}        [ ['e','x','t','i','n','g','u','i','s','h','i','n','g'], unwords [ ['f','i','r','e'], ['f','i','g','h','t','i','n','g'] ] ]
                              `plural`     HiFCAL |< At,

    HiFCAL |< Iy              `noun`    {- <'i.tfA'Iy> -}      [ unwords [ ['f','i','r','e'], ['f','i','g','h','t','e','r'] ] ]
                              `plural`     HiFCAL |< Iy |< Un
...
cluster_87  = cluster
 ...
 |> ".t l l" <| [
    ...
    HaFaCL                    `verb`    {- <'a.tall> -}        [ ['o','v','e','r','l','o','o','k'], ['f','a','c','e'], unwords [ ['l','o','o','k'], ['o','u','t'] ], ['v','i','e','w'] ],
...
cluster_93  = cluster
 ...
 |> ".t m y" <| [
    ...
    FaCY                      `verb`    {- <.tamY> -}          [ unwords [ ['f','l','o','w'], ['o','v','e','r'] ] ]
                              `imperf`     FCI,

    FaCA                      `verb`    {- <.tamA> -}          [ unwords [ ['f','l','o','w'], ['o','v','e','r'] ] ]
                              `imperf`     FCU,
    ...
    FuCUw                     `noun`    {- <.tumUw> -}         [ unwords [ ['f','l','o','w','i','n','g'], ['o','v','e','r'] ] ],
...
cluster_96  = cluster
 ...
 |> ".t w b" <| [
    ...
    FUL |<< "^g" |< Iy        `noun`    {- <.tUb^gIy> -}       [ ['a','r','t','i','l','l','e','r','y','m','a','n'] ],

    FUL |<< "^g" |< Iy |< aT  `noun`    {- <.tUb^gIyaT> -}     [ ['a','r','t','i','l','l','e','r','y'] ] ]
...
cluster_97  = cluster
 ...
 |> ".t w .h" <| [
    ...
    HaFAL                     `verb`    {- <'a.tA.h> -}        [ ['o','v','e','r','t','h','r','o','w'], ['t','o','p','p','l','e'] ],
...
cluster_99  = cluster
 ...
 |> ".t w r" <| [
    ...
    TaFaCCuL                  `noun`    {- <ta.tawwur> -}      [ ['d','e','v','e','l','o','p','m','e','n','t'], ['p','r','o','g','r','e','s','s'], ['e','v','e','n','t'] ]
                              `plural`     TaFaCCuL |< At,
