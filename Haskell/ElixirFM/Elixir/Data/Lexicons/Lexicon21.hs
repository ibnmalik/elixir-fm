...
lexicon = listing "Lexicon properties"
 ...
 |> "'iqliyd" <| [
    ...
    noun     Identity                  {- Iiqoliyd -}       -- `others` [ "'aqAliyd Ndip" ]
                                                            `gloss`  [ "key", "keys" ] ]
 ...
 |> "'istiqwA'" <| [
    ...
    noun     Identity                  {- IisotiqowA' -}    `gloss`  [ "becoming strong", "being strengthened" ] ]
 ...
 |> "'uq.huwAn" <| [
    ...
    noun     Identity                  {- OuqoHuwAn -}      -- `others` [ "qu.hwAn N", "'aqA.hiy N0_Nh", "'aqA.hiyy N0_Nh", "'aqA.h NK" ]
 ...
 |> "'uq.sur" <| [
    ...
    noun     Identity                  {- OuqoSur -}        `gloss`  [ "Luxor" ] ]
 ...
 |> "'uq.suw.s" <| [
    ...
    noun     Identity |< aT            {- OuqoSuwSap -}     -- `others` [ "'aqA.siy.s Ndip" ]
 ...
 |> "'uqnuwm" <| [
    ...
    noun     Identity                  {- Ouqonuwm -}       -- `others` [ "'aqAniym Ndip" ]
 ...
 |> "'uqsuwm" <| [
    ...
    noun     Identity |< aT            {- Ouqosuwmap -}     -- `others` [ "'aqAsiym Ndip" ]
 ...
 |> "istiq.sA'iyy" <| [
    ...
    noun     Identity                  {- {isotiqoSA}iy~ -} `gloss`  [ "penetrating", "thorough", "probing [ [ { isotiqoSA } iy ~ / ADJ ] ]" ] ]
 ...
 |> "istiqrA'iyy" <| [
    ...
    noun     Identity                  {- {isotiqorA}iy~ -} `gloss`  [ "inductive", "investigative [ [ { isotiqorA } iy ~ / ADJ ] ]" ] ]
 ...
 |> "maqbur" <| [
    ...
    noun     Identity |< Iy            {- maqoburiy~ -}     -- `others` [ "maqbariyy Nall" ]
                                                            `gloss`  [ "gravedigger [ [ maqoburiy ~ / ADJ ] ]", "gravedigger [ [ maqobariy ~ / ADJ ] ]" ],
 ...
 |> "muqA.s.s" <| [
    ...
    noun     Identity |< aT            {- muqAS~ap -}       `gloss`  [ "settlement of accounts", "balancing", "compensation" ] ]
 ...
 |> "muq^sa`irr" <| [
    ...
    noun     Identity                  {- muqo$aEir~ -}     `gloss`  [ "trembling", "shaking", "quivering [ [ muqo $ aEir ~ / ADJ ] ]" ] ]
 ...
 |> "q ' d" <| [
    ...
    noun     FaCUL                     {- qaWuwd -}         -- `others` [ "qawuwd N-ap" ]
 ...
 |> "q ' m" <| [
    ...
    noun     FACiL |< aT               {- qA}imap -}        `gloss`  [ "support", "base" ],
    ...
    noun     FACiL |< aT               {- qA}imap -}        -- `others` [ "qawA'im Ndip", "qA'im NAt" ]
 ...
 |> "q .d '" <| [
    ...
    noun     InFiCAL                   {- {inoqiDA' -}      `gloss`  [ "termination", "expiration" ],
    ...
    noun     IFtiCAL                   {- {iqotiDA' -}      `gloss`  [ "requirement", "exigency", "requirements", "exigencies" ] ]
 ...
 |> "q .d ' y" <| [
    ...
    noun     KaRADIS                   {- qaDA}iy~ -}       `gloss`  [ "judicial", "legal [ [ qaDA } iy ~ / ADJ ] ]" ] ]
 ...
 |> "q .d .d" <| [
    ...
    verb     HaFaCL                    {- OaqaD~ -}         -- `others` [ "'aq.da.d PV_C_intr", "qi.d.d IV_V_intr_yu", "q.di.d IV_C_intr_yu" ]
 ...
 |> "q .d b" <| [
    ...
    noun     FuCAL |< aT               {- quDAbap -}        `gloss`  [ "trimmings", "cut off" ],
 ...
 |> "q .d m" <| [
    ...
    noun     FaCL |< aT                {- qaDomap -}        `gloss`  [ "snack" ],

    -- ;; qaDAmap_1
    -- qDAm    qaDAm   Nap     roasted chick-peas;assorted nuts

    noun     FaCAL |< aT               {- qaDAmap -}        `gloss`  [ "roasted chick-peas", "assorted nuts" ],
 ...
 |> "q .d y" <| [
    ...
    noun     FaCY |< Iy |< aT          {- qaDawiy~ap -}     `gloss`  [ "jurisdiction [ [ qaDawiy ~ / NOUN ] ]" ],

    -- ;; qaDiy~ap_1
    -- qDy     qaDiy~  Napdu   problem;issue     [[qaDiy~/NOUN]]
    -- qDAyA   qaDAyA  N0_Nhy  problems;issues

    noun     FaCIL |< aT               {- qaDiy~ap -}       -- `others` [ "qa.dAyA N0_Nhy" ]
    ...
    noun     MuFACY |< aT              {- muqADAp -}        -- `others` [ "muqA.day NAt" ]
    ...
    noun     TaFACI                    {- taqADiy -}        -- `others` [ "taqA.d NK" ]
                                                            `gloss`  [ "litigation" ],
    ...
    noun     FawACiL                   {- qawADiy -}        -- `others` [ "qawA.d NK" ]
                                                            `gloss`  [ "requirements", "exigencies" ],

    -- ;; maqoDiy~_1
    -- mqDy    maqoDiy~        N-ap    settled;finished     [[maqoDiy~/ADJ]]

    noun     MaFCIy                    {- maqoDiy~ -}       `gloss`  [ "settled", "finished [ [ maqoDiy ~ / ADJ ] ]" ],
    ...
    noun     MutaFACY                  {- mutaqADaY -}      `gloss`  [ "subject to legal prosecution" ],
    ...
    noun     MuFtaCY                   {- muqotaDaY -}      -- `others` [ "muqta.dA Napdu Nhy", "muqta.day NAn_Nayn" ]
    ...
    noun     MuFtaCY                   {- muqotaDaY -}      -- `others` [ "muqta.dA Nhy", "muqta.day NAt NAn_Nayn" ]
 ...
 |> "q .h .t" <| [
    ...
    verb     HaFCaL                    {- OaqoHaT -}        -- `others` [ "q.hi.t IV_intr_yu" ]
                                                            `gloss`  [ "be rainless" ],
    ...
    noun     FACiL                     {- qAHiT -}          `gloss`  [ "rainless", "sterile [ [ qAHiT / ADJ ] ]" ],
 ...
 |> "q .h b" <| [
    ...
    noun     FaCL |< aT                {- qaHobap -}        -- `others` [ "qi.hAb N" ]
 ...
 |> "q .h f" <| [
    ...
    noun     FuCAL                     {- quHAf -}          `gloss`  [ "torrential [ [ quHAf / ADJ ] ]" ],

    -- ;; qaH~Afap_1
    -- qHAf    qaH~Af  NapAt   truck;cart

    noun     FaCCAL |< aT              {- qaH~Afap -}       `gloss`  [ "truck", "cart" ] ]
 ...
 |> "q .h l" <| [
    ...
    noun     FuCUL |< aT               {- quHuwlap -}       `gloss`  [ "dryness", "aridity" ] ]
 ...
 |> "q .h l '" <| [
    ...
    noun     KaRDAS                    {- qaHolA' -}        -- `others` [ "qA.hil N-ap" ]
                                                            `gloss`  [ "arid", "dry [ [ qaHolA ' / ADJ ] ]", "dry" ] ]
 ...
 |> "q .h m" <| [
    ...
    verb     HaFCaL                    {- OaqoHam -}        -- `others` [ "q.ham IV_Pass_yu", "q.him IV_yu" ]
    ...
    noun     FuCL |< aT                {- quHomap -}        -- `others` [ "qu.ham N" ]
    ...
    noun     HiFCAL                    {- IiqoHAm -}        `gloss`  [ "involvement", "implicating" ],
 ...
 |> "q .s '" <| [
    ...
    noun     FaCAL                     {- qaSA' -}          `gloss`  [ "remoteness", "distance" ],
    ...
    noun     IstiFCAL                  {- {isotiqoSA' -}    `gloss`  [ "investigation", "examination", "investigations", "examinations" ] ]
 ...
 |> "q .s .s" <| [
    ...
    noun     FaCL |< aT                {- qaS~ap -}         `gloss`  [ "cut" ],

    -- ;; qiS~ap_1
    -- qS      qiS~    Napdu   story
    -- qSS     qiSaS   N       stories

    noun     FiCL |< aT                {- qiS~ap -}         -- `others` [ "qi.sa.s N" ]
                                                            `gloss`  [ "story", "stories" ],
    ...
    noun     FaCaL |< Iy               {- qaSaSiy~ -}       `gloss`  [ "fictional", "narrative [ [ qaSaSiy ~ / ADJ ] ]" ],

    -- ;; qaSaSiy~_2
    -- qSSy    qaSaSiy~        Nall    novelist;storyteller     [[qaSaSiy~/ADJ]]

    noun     FaCaL |< Iy               {- qaSaSiy~ -}       `gloss`  [ "novelist", "storyteller [ [ qaSaSiy ~ / ADJ ] ]" ],
    ...
    noun     FuCAL |< aT               {- quSASap -}        `gloss`  [ "clippings" ],
    ...
    noun     MaFACL                    {- maqAS~ -}         `gloss`  [ "scissors", "shears" ],
    ...
    noun     FiCAL |< Iy               {- qiSASiy~ -}       `gloss`  [ "punitive [ [ qiSASiy ~ / ADJ ] ]" ],
    ...
    noun     MaFCUL |< aT              {- maqoSuwSap -}     `gloss`  [ "skimming ladle" ],
 ...
 |> "q .s `" <| [
    ...
    noun     FaCL |< aT                {- qaSoEap -}        -- `others` [ "qa.sa` NAt", "qi.sa` N", "qi.sA` N" ]
 ...
 |> "q .s b" <| [
    ...
    noun     FiCAL |< aT               {- qiSAbap -}        `gloss`  [ "butchery" ],

    -- ;; quSayobap_1
    -- qSyb    quSayob Nap     oats

    noun     FuCayL |< aT              {- quSayobap -}      `gloss`  [ "oats" ],
    ...
    noun     FuCCAL |< aT              {- quS~Abap -}       `gloss`  [ "reed pipe" ],

    -- ;; muqaS~ab_1
    -- mqSb    muqaS~ab        N-ap    embroidered;brocaded     [[muqaS~ab/ADJ]]

    noun     MuFaCCaL                  {- muqaS~ab -}       `gloss`  [ "embroidered", "brocaded [ [ muqaS ~ ab / ADJ ] ]" ] ]
 ...
 |> "q .s d" <| [
    ...
    verb     HaFCaL                    {- OaqoSad -}        -- `others` [ "q.sad IV_Pass_yu", "q.sid IV_yu" ]
    ...
    noun     FaCL |< aN                {- qaSodAF -}        -- `others` [ "qa.sd NF" ]
                                                            `gloss`  [ "intentionally [ [ qaSod / ADV ] ]" ],

    -- ;; qaSodiy~_1
    -- qSdy    qaSodiy~        N-ap    intentional     [[qaSodiy~/ADJ]]

    noun     FaCL |< Iy                {- qaSodiy~ -}       `gloss`  [ "intentional [ [ qaSodiy ~ / ADJ ] ]" ],
    ...
    noun     FaCIL |< aT               {- qaSiydap -}       -- `others` [ "qa.sA'id Ndip" ]
                                                            `gloss`  [ "poem", "poems" ],
    ...
    noun     HaFCaL                    {- OaqoSad -}        `gloss`  [ "more / most direct" ],
    ...
    noun     MaFACiL                   {- maqASid -}        `gloss`  [ "Maqasid" ],
    ...
    noun     IFtiCAL |< Iy             {- {iqotiSAdiy~ -}   `gloss`  [ "economist [ [ { iqotiSAdiy ~ / NOUN ] ]" ],

    -- ;; {iqotiSAdiy~_2
    -- <qtSAdy {iqotiSAdiy~    N-ap    economic;economical     [[{iqotiSAdiy~/ADJ]]
    -- AqtSAdy {iqotiSAdiy~    N-ap    economic;economical     [[{iqotiSAdiy~/ADJ]]

    noun     IFtiCAL |< Iy             {- {iqotiSAdiy~ -}   `gloss`  [ "economic", "economical [ [ { iqotiSAdiy ~ / ADJ ] ]" ],

    -- ;; qASid_1
    -- qASd    qASid   N-ap    direct;straight     [[qASid/ADJ]]

    noun     FACiL                     {- qASid -}          `gloss`  [ "direct", "straight [ [ qASid / ADJ ] ]" ],
    ...
    noun     FiCAL |< aT               {- qiSAdap -}        `gloss`  [ "legation" ],
 ...
 |> "q .s d r" <| [
    ...
    verb     KaRDaS                    {- qaSodar -}        -- `others` [ "qa.sdir IV_yu" ]
                                                            `gloss`  [ "plate with tin" ],

    -- ;; qaSodiyr_1
    -- qSdyr   qaSodiyr        N       tin plating

    noun     KaRDIS                    {- qaSodiyr -}       `gloss`  [ "tin plating" ],

    -- ;; muqaSodir_1
    -- mqSdr   muqaSodir       Nall    tinsmith

    noun     MuKaRDiS                  {- muqaSodir -}      `gloss`  [ "tinsmith" ],

    -- ;; muqaSodar_1
    -- mqSdr   muqaSodar       N-ap    tin plated     [[muqaSodar/ADJ]]

    noun     MuKaRDaS                  {- muqaSodar -}      `gloss`  [ "tin plated [ [ muqaSodar / ADJ ] ]" ] ]
 ...
 |> "q .s f" <| [
    ...
    noun     FaCiL                     {- qaSif -}          `gloss`  [ "frail", "fragile [ [ qaSif / ADJ ] ]" ],

    -- ;; qaSiyf_1
    -- qSyf    qaSiyf  N/ap    frail;fragile     [[qaSiyf/ADJ]]

    noun     FaCIL                     {- qaSiyf -}         `gloss`  [ "frail", "fragile [ [ qaSiyf / ADJ ] ]" ],
 ...
 |> "q .s l" <| [
    ...
    noun     MiFCaL |< aT              {- miqoSalap -}      -- `others` [ "maqA.sil Ndip" ]
                                                            `gloss`  [ "guillotine", "guillotines" ],

    -- ;; qASil_1
    -- qASl    qASil   N-ap    sharp;cutting     [[qASil/ADJ]]

    noun     FACiL                     {- qASil -}          `gloss`  [ "sharp", "cutting [ [ qASil / ADJ ] ]" ] ]
 ...
 |> "q .s m" <| [
    ...
    noun     FaCiL                     {- qaSim -}          `gloss`  [ "fragile [ [ qaSim / ADJ ] ]" ],

    -- ;; qaSiym_1
    -- qSym    qaSiym  N/ap    fragile     [[qaSiym/ADJ]]

    noun     FaCIL                     {- qaSiym -}         `gloss`  [ "fragile [ [ qaSiym / ADJ ] ]" ],
    ...
    noun     FACiL                     {- qASim -}          -- `others` [ "qawA.sim Ndip" ]
                                                            `gloss`  [ "breaking", "crushing [ [ qASim / ADJ ] ]", "crushing" ] ]
 ...
 |> "q .s q .s" <| [
    ...
    verb     KaRDaS                    {- qaSoqaS -}        -- `others` [ "qa.sqi.s IV_yu" ]
                                                            `gloss`  [ "break", "shatter", "trim" ],

    -- ;; qaSoqaSap_1
    -- qSqS    qaSoqaS Nap     breaking;shattering;trimming

    noun     KaRDaS |< aT              {- qaSoqaSap -}      `gloss`  [ "breaking", "shattering", "trimming" ] ]
 ...
 |> "q .s r" <| [
    ...
    verb     HaFCaL                    {- OaqoSar -}        -- `others` [ "q.sar IV_Pass_yu", "q.sir IV_yu" ]
    ...
    noun     FaCL |< Iy |< aT          {- qaSoriy~ap -}     -- `others` [ "qa.sAriy N0_Nh", "qa.sAr NK" ]
                                                            `gloss`  [ "flower pot", "chamber pot [ [ qaSoriy ~ / NOUN ] ]", "flower pots", "chamber pots" ],
    ...
    noun     FiCAL |< aT               {- qiSArap -}        `gloss`  [ "bleacher 's trade" ],

    -- ;; >aqoSar_2
    -- >qSr    >aqoSar Nel     shorter/shortest
    -- AqSr    >aqoSar Nel     shorter/shortest

    noun     HaFCaL                    {- OaqoSar -}        `gloss`  [ "shorter / shortest" ],
    ...
    noun     MaFCUL |< aT              {- maqoSuwrap -}     -- `others` [ "maqA.sir Ndip" ]
 ...
 |> "q .s w" <| [
    ...
    verb     FaCA                      {- qaSA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "q.suw IV_0hAnn", "qa.s PV_ttAw_intr", "q.s IV_0hwnyn", "qa.saw PV_Atn" ]
                                                            `gloss`  [ "be distant" ],
    ...
    verb     HaFCY                     {- OaqoSaY -}        -- `others` [ "'aq.sA PV_h", "q.sY IV_0_Pass_yu", "q.say IV_Ann_Pass_yu", "'aq.s PV_ttAw", "'aq.say PV_Atn", "q.s IV_0hwnyn_yu", "q.siy IV_0hAnn_yu" ]
    ...
    noun     FaCY                      {- qaSaY -}          -- `others` [ "qa.saN FW-WaBi", "qa.sA N0_Nhy" ]
                                                            `gloss`  [ "remoteness", "distance", "distance [ [ qaSAF / NOUN ] ]" ],
    ...
    noun     HaFCY                     {- OaqoSaY -}        -- `others` [ "'aq.sA Nhy", "qu.swA Nhy", "qu.sway NAt NAn_Nayn", "'aq.say NAn_Nayn", "'aqA.siy N0_Nh", "'aqA.s NK", "qu.swY N0" ]
    ...
    noun     HaFCY                     {- OaqoSaY -}        -- `others` [ "'aq.sA Nhy" ]
                                                            `gloss`  [ "maximum" ],
    ...
    noun     TaFaCCI                   {- taqaS~iy -}       -- `others` [ "taqa.s.s NK" ]
 ...
 |> "q .s y" <| [
    ...
    verb     FaCiL                     {- qaSiy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "q.sY IV_0", "q.say IV_Ann", "qa.s PV_w_intr", "q.sa IV_0hwnyn" ]
                                                            `gloss`  [ "be distant" ],
    ...
    noun     FaCIL                     {- qaSiy~ -}         -- `others` [ "'aq.sA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "distant", "remote [ [ qaSiy ~ / ADJ ] ]", "remote" ],
 ...
 |> "q .t ' f" <| [
    ...
    noun     KaRADiS                   {- qaTA}if -}        -- `others` [ "qa.tAyif Ndip" ]
 ...
 |> "q .t .t" <| [
    ...
    noun     FiCL |< aT                {- qiT~ap -}         `gloss`  [ "female cat" ],

    -- ;; quTayoTap_1
    -- qTyT    quTayoT Napdu   kitten
    -- qTyT    quTayoT NAt     kittens

    noun     FuCayL |< aT              {- quTayoTap -}      -- `others` [ "qu.tay.t NAt" ]
 ...
 |> "q .t `" <| [
    ...
    verb     HaFCaL                    {- OaqoTaE -}        -- `others` [ "q.ta` IV_Pass_yu", "q.ti` IV_yu" ]
    ...
    noun     FaCL |< aT                {- qaToEap -}        -- `others` [ "qa.ta` NAt N" ]
                                                            `gloss`  [ "stump", "stumps" ],
    ...
    noun     FiCAL |< Iy               {- qiTAEiy~ -}       `gloss`  [ "sector", "section [ [ qiTAEiy ~ / ADJ ] ]" ],
    ...
    noun     FaCIL |< Iy               {- qaTiyEiy~ -}      `gloss`  [ "group", "herd [ [ qaTiyEiy ~ / ADJ ] ]" ],

    -- ;; qaTiyEap_1
    -- qTyE    qaTiyE  Nap     breaking;rupture;rift

    noun     FaCIL |< aT               {- qaTiyEap -}       `gloss`  [ "breaking", "rupture", "rift" ],

    -- ;; qaTiyEap_2
    -- qTyE    qaTiyE  Napdu   feudal estate;fief
    -- qTA}E   qaTA}iE Ndip    feudal estates;fiefs

    noun     FaCIL |< aT               {- qaTiyEap -}       -- `others` [ "qa.tA'i` Ndip" ]
    ...
    noun     HaFCaL                    {- OaqoTaE -}        `gloss`  [ "more / most convincing / conclusive" ],
    ...
    noun     HaFCaL                    {- OaqoTaE -}        -- `others` [ "qa.t`A' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "amputee", "mute" ],
    ...
    noun     MaFCaL |< Iy              {- maqoTaEiy~ -}     `gloss`  [ "cross-section [ [ maqoTaEiy ~ / ADJ ] ]" ],
    ...
    noun     InFiCAL |< Iy |< aT       {- {inoqiTAEiy~ap -} `gloss`  [ "separatism [ [ { inoqiTAEiy ~ / NOUN ] ]" ],
    ...
    noun     FACiL |< aT               {- qATiEap -}        `gloss`  [ "interrupter", "circuit breaker" ],
    ...
    noun     MaFCUL |< aT              {- maqoTuwEap -}     -- `others` [ "maqA.tiy` Ndip" ]
                                                            `gloss`  [ "piece", "selection ( music / poetry )", "short poems" ],

    -- ;; maqoTuwEiy~ap_1
    -- mqTwEy  maqoTuwEiy~     Nap     piece work     [[maqoTuwEiy~/NOUN]]

    noun     MaFCUL |< Iy |< aT        {- maqoTuwEiy~ap -}  `gloss`  [ "piece work [ [ maqoTuwEiy ~ / NOUN ] ]" ],

    -- ;; muqaT~aE_1
    -- mqTE    muqaT~aE        N-ap    torn;shredded     [[muqaT~aE/ADJ]]

    noun     MuFaCCaL                  {- muqaT~aE -}       `gloss`  [ "torn", "shredded [ [ muqaT ~ aE / ADJ ] ]" ],
    ...
    noun     MutaFACiL                 {- mutaqATiE -}      `gloss`  [ "intersecting [ [ mutaqATiE / ADJ ] ]" ],
 ...
 |> "q .t b" <| [
    ...
    noun     FuCL |< Iy                {- quTobiy~ -}       `gloss`  [ "polar [ [ quTobiy ~ / ADJ ] ]" ],

    -- ;; quTobiy~ap_1
    -- qTby    quTobiy~        Nap     polarity     [[quTobiy~/NOUN]]

    noun     FuCL |< Iy |< aT          {- quTobiy~ap -}     `gloss`  [ "polarity [ [ quTobiy ~ / NOUN ] ]" ],

    -- ;; quTobap_1
    -- qTb     quTob   NapAt   stitch

    noun     FuCL |< aT                {- quTobap -}        `gloss`  [ "stitch" ],

    -- ;; qaTuwb_1
    -- qTwb    qaTuwb  N-ap    frowning;scowling     [[qaTuwb/ADJ]]

    noun     FaCUL                     {- qaTuwb -}         `gloss`  [ "frowning", "scowling [ [ qaTuwb / ADJ ] ]" ],

    -- ;; taqoTiybap_1
    -- tqTyb   taqoTiyb        Napdu   frown;scowl

    noun     TaFCIL |< aT              {- taqoTiybap -}     `gloss`  [ "frown", "scowl" ],
    ...
    noun     FACiL |< aT               {- qATibap -}        `gloss`  [ "all without exception", "one and all" ] ]
 ...
 |> "q .t f" <| [
    ...
    noun     FuCaL                     {- quTaf -}          `gloss`  [ "sideburns" ],
    ...
    noun     FaCIL |< aT               {- qaTiyfap -}       `gloss`  [ "pastry" ],
 ...
 |> "q .t l" <| [
    ...
    noun     FaCIL |< aT               {- qaTiylap -}       `gloss`  [ "towel", "floor rag" ] ]
 ...
 |> "q .t m" <| [
    ...
    noun     FaCL |< aT                {- qaTomap -}        -- `others` [ "qa.tam NAt" ]
 ...
 |> "q .t m r" <| [
    ...
    noun     KiRDIS                    {- qiTomiyr -}       `gloss`  [ "pellicle", "red cent" ] ]
 ...
 |> "q .t n" <| [
    ...
    noun     FuCL |< Iy                {- quToniy~ -}       `gloss`  [ "cotton [ [ quToniy ~ / ADJ ] ]" ],

    -- ;; quToniy~ap_1
    -- qTny    quToniy~        Nap     legumes     [[quToniy~/NOUN]]

    noun     FuCL |< Iy |< aT          {- quToniy~ap -}     `gloss`  [ "legumes [ [ quToniy ~ / NOUN ] ]" ],

    -- ;; quTAniy~ap_1
    -- qTAny   quTAniy~        Nap     maize     [[quTAniy~/NOUN]]
    -- qTAny   qiTAniy~        Nap     maize     [[qiTAniy~/NOUN]]

    noun     FuCAL |< Iy |< aT         {- quTAniy~ap -}     -- `others` [ "qi.tAniyy Nap" ]
                                                            `gloss`  [ "maize [ [ quTAniy ~ / NOUN ] ]", "maize [ [ qiTAniy ~ / NOUN ] ]" ],
    ...
    noun     MaFCaL |< aT              {- maqoTanap -}      `gloss`  [ "cotton plantation" ],
 ...
 |> "q .t q .t" <| [
    ...
    noun     KaRDUS |< aT              {- qaToquwTap -}     `gloss`  [ "young girl" ] ]
 ...
 |> "q .t r" <| [
    ...
    noun     FaCaL |< Iy               {- qaTariy~ -}       `gloss`  [ "Qatari [ [ qaTariy ~ / NOUN ] ]", "Qatari [ [ qaTariy ~ / ADJ ] ]" ],
    ...
    noun     FaCL |< aT                {- qaTorap -}        -- `others` [ "qa.tar NAt" ]
                                                            `gloss`  [ "drop", "drops" ],
    ...
    noun     FuCL |< Iy                {- quToriy~ -}       `gloss`  [ "regional [ [ quToriy ~ / ADJ ] ]" ],

    -- ;; qaT~Arap_1
    -- qTAr    qaT~Ar  Napdu   pipette;dropper

    noun     FaCCAL |< aT              {- qaT~Arap -}       `gloss`  [ "pipette", "dropper" ],
    ...
    noun     FACiL |< aT               {- qATirap -}        `gloss`  [ "locomotive", "tractor truck" ],
 ...
 |> "q .t r n" <| [
    ...
    verb     KaRDaS                    {- qaToran -}        -- `others` [ "qa.trin IV-n_yu" ]
                                                            `gloss`  [ "coat with tar" ],

    -- ;; qaToranap_1
    -- qTrn    qaToran Nap     coating with tar

    noun     KaRDaS |< aT              {- qaToranap -}      `gloss`  [ "coating with tar" ],

    -- ;; qaTorAn_1
    -- qTrAn   qaTorAn N       tar

    noun     KaRDAS                    {- qaTorAn -}        `gloss`  [ "tar" ],

    -- ;; qaTorAniy~_1
    -- qTrAny  qaTorAniy~      Nall    tar-like     [[qaTorAniy~/ADJ]]

    noun     KaRDAS |< Iy              {- qaTorAniy~ -}     `gloss`  [ "tar-like [ [ qaTorAniy ~ / ADJ ] ]" ] ]
 ...
 |> "q .t w" <| [
    ...
    noun     FaCY |< aT                {- qaTAp -}          -- `others` [ "qa.taw NAt" ]
 ...
 |> "q ^s .t" <| [
    ...
    noun     FiCL |< aT                {- qi$oTap -}        -- `others` [ "qa^s.t Nap" ]
                                                            `gloss`  [ "cream" ],
    ...
    noun     MiFCaL |< aT              {- miqo$aTap -}      -- `others` [ "maqA^si.t Ndip" ]
 ...
 |> "q ^s .t l" <| [
    ...
    noun     KaRDAS |< aT              {- qa$oTAlap -}      `gloss`  [ "Castile" ],

    -- ;; qa$oTiyliy~_1
    -- q$Tyly  qa$oTiyliy~     N-ap    Castilian     [[qa$oTiyliy~/ADJ]]
    -- q$ATl   qa$ATil Nap     Castilians

    noun     KaRDIS |< Iy              {- qa$oTiyliy~ -}    -- `others` [ "qa^sA.til Nap" ]
                                                            `gloss`  [ "Castilian [ [ qa $ oTiyliy ~ / ADJ ] ]", "Castilians" ] ]
 ...
 |> "q ^s ^s" <| [
    ...
    noun     FaCL |< aT                {- qa$~ap -}         `gloss`  [ "straw" ],
    ...
    noun     MiFaCL |< aT              {- miqa$~ap -}       `gloss`  [ "broom", "brush" ],

    -- ;; qa$~A$ap_1
    -- q$A$    qa$~A$  NapAt   rake;comb

    noun     FaCCAL |< aT              {- qa$~A$ap -}       `gloss`  [ "rake", "comb" ],
 ...
 |> "q ^s `" <| [
    ...
    verb     HaFCaL                    {- Oaqo$aE -}        -- `others` [ "q^sa` IV_Pass_yu", "q^si` IV_yu" ]
    ...
    noun     FaCAL |< aT               {- qa$AEap -}        `gloss`  [ "spit", "phlegm" ],
 ...
 |> "q ^s ` m" <| [
    ...
    noun     KaRDaS                    {- qa$oEam -}        -- `others` [ "qa^sA`im Ndip" ]
                                                            `gloss`  [ "lion", "lions" ] ]
 ...
 |> "q ^s b" <| [
    ...
    noun     FaCAL |< aT               {- qa$Abap -}        -- `others` [ "qa^sA^sib Ndip" ]
                                                            `gloss`  [ "tunic", "blouse" ] ]
 ...
 |> "q ^s d" <| [
    ...
    noun     FiCL |< aT                {- qi$odap -}        `gloss`  [ "cream" ],

    -- ;; qi$odiy~_1
    -- q$dy    qi$odiy~        N-ap    creamy;cream-colored     [[qi$odiy~/ADJ]]

    noun     FiCL |< Iy                {- qi$odiy~ -}       `gloss`  [ "creamy", "cream-colored [ [ qi $ odiy ~ / ADJ ] ]" ],

    -- ;; qA$idap_1
    -- qA$d    qA$id   Napdu   creamer;skimmer

    noun     FACiL |< aT               {- qA$idap -}        `gloss`  [ "creamer", "skimmer" ],
 ...
 |> "q ^s f" <| [
    ...
    noun     FiCL |< aT                {- qi$ofap -}        -- `others` [ "qi^saf N" ]
    ...
    noun     TaFaCCuL |< Iy            {- taqa$~ufiy~ -}    `gloss`  [ "austere", "austerity [ [ taqa $ ~ ufiy ~ / ADJ ] ]" ],
 ...
 |> "q ^s l" <| [
    ...
    noun     FaCL |< aT                {- qa$olap -}        -- `others` [ "qi^sal N" ]
 ...
 |> "q ^s l q" <| [
    ...
    noun     KuRDAS                    {- qu$olAq -}        `gloss`  [ "barracks" ] ]
 ...
 |> "q ^s m ^s" <| [
    ...
    noun     KiRDiS                    {- qi$omi$ -}        `gloss`  [ "currants", "seedless raisins" ] ]
 ...
 |> "q ^s q ^s" <| [
    ...
    verb     KaRDaS                    {- qa$oqa$ -}        -- `others` [ "qa^sqi^s IV_yu" ]
                                                            `gloss`  [ "cure", "sweep away" ],

    -- ;; qa$oqa$ap_1
    -- q$q$    qa$oqa$ Nap     curing;sweeping away

    noun     KaRDaS |< aT              {- qa$oqa$ap -}      `gloss`  [ "curing", "sweeping away" ] ]
 ...
 |> "q ^s r" <| [
    ...
    noun     FiCL |< aT                {- qi$orap -}        `gloss`  [ "dandruff" ],
    ...
    noun     MuFaCCaL                  {- muqa$~ar -}       `gloss`  [ "peeled", "skinned [ [ muqa $ ~ ar / ADJ ] ]" ],
 ...
 |> "q ^s t l" <| [
    ...
    noun     KaRDIS |< Iy              {- qa$otiyliy~ -}    -- `others` [ "qa^sAtil Nap" ]
                                                            `gloss`  [ "Castilian [ [ qa $ otiyliy ~ / ADJ ] ]", "Castilians" ] ]
 ...
 |> "q ^s y ^s" <| [
    ...
    noun     KaRADiS |< Iy             {- qa$Ayi$iy~ -}     `gloss`  [ "antiques merchant", "antiques merchants [ [ qa $ Ayi $ iy ~ / NOUN ] ]" ] ]
 ...
 |> "q _d _d" <| [
    ...
    noun     FuCL |< aT                {- qu*~ap -}         -- `others` [ "qi_dA_d N", "qu_da_d N" ]
 ...
 |> "q _d `" <| [
    ...
    verb     HaFCaL                    {- Oaqo*aE -}        -- `others` [ "q_da` IV_Pass_yu", "q_di` IV_yu" ]
    ...
    noun     FaCIL |< aT               {- qa*iyEap -}       -- `others` [ "qa_dA'i` Ndip" ]
                                                            `gloss`  [ "slander", "insult", "insults", "affronts" ],

    -- ;; muqo*iE_1
    -- mq*E    muqo*iE N-ap    virulent;biting     [[muqo*iE/ADJ]]

    noun     MuFCiL                    {- muqo*iE -}        `gloss`  [ "virulent", "biting [ [ muqo*iE / ADJ ] ]" ] ]
 ...
 |> "q _d f" <| [
    ...
    noun     FaCL |< aT                {- qa*ofap -}        -- `others` [ "qa_daf NAt" ]
                                                            `gloss`  [ "shot", "volley", "shots", "volleys" ],

    -- ;; qa*ofiy~_1
    -- q*fy    qa*ofiy~        N-ap    slanderous;defamatory     [[qa*ofiy~/ADJ]]

    noun     FaCL |< Iy                {- qa*ofiy~ -}       `gloss`  [ "slanderous", "defamatory [ [ qa*ofiy ~ / ADJ ] ]" ],

    -- ;; qa*ofiy~_2
    -- q*fy    qa*ofiy~        N-ap    ejection     [[qa*ofiy~/ADJ]]

    noun     FaCL |< Iy                {- qa*ofiy~ -}       `gloss`  [ "ejection [ [ qa*ofiy ~ / ADJ ] ]" ],

    -- ;; qi*Afap_1
    -- q*Af    qi*Af   Nap     ballistics

    noun     FiCAL |< aT               {- qi*Afap -}        `gloss`  [ "ballistics" ],
    ...
    noun     FaCIL |< aT               {- qa*iyfap -}       -- `others` [ "qa_dA'if Ndip" ]
    ...
    noun     FACiL |< aT               {- qA*ifap -}        -- `others` [ "qawA_dif Ndip" ]
 ...
 |> "q _d l" <| [
    ...
    noun     FaCAL |< Iy               {- qa*Aliy~ -}       `gloss`  [ "occipital", "nape [ [ qa*Aliy ~ / ADJ ] ]" ] ]
 ...
 |> "q _d r" <| [
    ...
    noun     FaCUL                     {- qa*uwr -}         `gloss`  [ "fastidious [ [ qa*uwr / ADJ ] ]" ],

    -- ;; qa*Arap_1
    -- q*Ar    qa*Ar   Nap     filth;dirtiness;littering

    noun     FaCAL |< aT               {- qa*Arap -}        `gloss`  [ "filth", "dirtiness", "littering" ],

    -- ;; qA*uwrap_1
    -- qA*wr   qA*uwr  NapAt   rubbish;filth

    noun     FACUL |< aT               {- qA*uwrap -}       `gloss`  [ "rubbish", "filth" ],

    -- ;; maqo*arap_1
    -- mq*r    maqo*ar Nap     sewer;cesspool
    -- mqA*r   maqA*ir Ndip    sewer;cesspools;filth

    noun     MaFCaL |< aT              {- maqo*arap -}      -- `others` [ "maqA_dir Ndip" ]
 ...
 |> "q _d y" <| [
    ...
    verb     HaFCY                     {- Oaqo*aY -}        -- `others` [ "q_dY IV_0_Pass_yu", "q_day IV_Ann_Pass_yu", "'aq_d PV_ttAw", "q_diy IV_0hAnn_yu", "q_d IV_0hwnyn_yu", "'aq_dA PV_h", "'aq_day PV_Atn" ]
    ...
    noun     FaCY |< aT                {- qa*Ap -}          `gloss`  [ "speck", "mote" ],
    ...
    noun     FiCY                      {- qi*aY -}          -- `others` [ "'aq_dA' Nh Nhy N0_Nh", "qi_dA Nhy" ]
 ...
 |> "q _t '" <| [
    ...
    noun     FiCCAL |< aT              {- qiv~A'ap -}       -- `others` [ "qu_t_tA' Nh NapAt Nhy N0_Nh" ]
                                                            `gloss`  [ "cucumber" ] ]
 ...
 |> "q _t t r" <| [
    ...
    noun     KaRDaS                    {- qavotar -}        -- `others` [ "qa_t.tar Napdu Ndu", "qa_tAtir Ndip", "qa_tA.tir Ndip" ]
 ...
 |> "q ` d" <| [
    ...
    verb     HaFCaL                    {- OaqoEad -}        -- `others` [ "q`id IV_yu", "q`ad IV_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- qaEodap -}        `gloss`  [ "sitting place", "seat" ],

    -- ;; qiEodap_1
    -- qEd     qiEod   Nap     posture;manner of sitting

    noun     FiCL |< aT                {- qiEodap -}        `gloss`  [ "posture", "manner of sitting" ],

    -- ;; quEadap_1
    -- qEd     quEad   Nap     seated firmly;not budging

    noun     FuCaL |< aT               {- quEadap -}        `gloss`  [ "seated firmly", "not budging" ],

    -- ;; quEodiy~_1
    -- qEdy    quEodiy~        Nall    seated firmly;not budging     [[quEodiy~/ADJ]]

    noun     FuCL |< Iy                {- quEodiy~ -}       `gloss`  [ "seated firmly", "not budging [ [ quEodiy ~ / ADJ ] ]" ],
    ...
    noun     FaCIL |< aT               {- qaEiydap -}       -- `others` [ "qa`A'id Ndip" ]
    ...
    noun     HiFCAL                    {- IiqoEAd -}        `gloss`  [ "disability" ],
    ...
    noun     FACiL |< aT               {- qAEidap -}        `gloss`  [ "Qaida", "Qaeda", "Qa'ida" ],

    -- ;; qAEidap_2
    -- qAEd    qAEid   Napdu   base
    -- qwAEd   qawAEid Ndip    bases

    noun     FACiL |< aT               {- qAEidap -}        -- `others` [ "qawA`id Ndip" ]
                                                            `gloss`  [ "base", "bases" ],
    ...
    noun     FACiL |< Iy               {- qAEidiy~ -}       `gloss`  [ "basic", "fundamental [ [ qAEidiy ~ / ADJ ] ]" ],
    ...
    noun     MuFCaL                    {- muqoEad -}        `gloss`  [ "stopped", "interrupted [ [ muqoEad / ADJ ] ]" ],
 ...
 |> "q ` q `" <| [
    ...
    verb     KaRDaS                    {- qaEoqaE -}        -- `others` [ "qa`qi` IV_yu" ]
    ...
    noun     KaRDaS |< aT              {- qaEoqaEap -}      -- `others` [ "qa`Aqi` Ndip" ]
                                                            `gloss`  [ "noise", "rattle", "high-sounding words" ],

    -- ;; qaEoqaE_2
    -- qEqE    qaEoqaE N       magpie

    noun     KaRDaS                    {- qaEoqaE -}        `gloss`  [ "magpie" ] ]
 ...
 |> "q ` r" <| [
    ...
    verb     HaFCaL                    {- OaqoEar -}        -- `others` [ "q`ir IV_yu", "q`ar IV_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- qaEorap -}        `gloss`  [ "hole", "hollow", "pit" ],
    ...
    noun     FaCIL                     {- qaEiyr -}         `gloss`  [ "deep [ [ qaEiyr / ADJ ] ]" ],
 ...
 |> "q ` s" <| [
    ...
    noun     HaFCaL                    {- OaqoEas -}        `gloss`  [ "pigeon-breasted", "firmly established" ],
    ...
    noun     MutaFACiL                 {- mutaqAEis -}      `gloss`  [ "negligent", "hesitant [ [ mutaqAEis / ADJ ] ]" ] ]
 ...
 |> "q ` y" <| [
    ...
    verb     HaFCY                     {- OaqoEaY -}        -- `others` [ "'aq` PV_ttAw", "q`iy IV_0hAnn_yu", "'aq`A PV_h", "q` IV_0hwnyn_yu", "'aq`ay PV_Atn" ]
                                                            `gloss`  [ "crouch", "squat" ] ]
 ...
 |> "q b '" <| [
    ...
    noun     FiCAL                     {- qibA' -}          `gloss`  [ "interval", "distance" ],
 ...
 |> "q b ' l" <| [
    ...
    noun     KaRADiS                   {- qabA}il -}        `gloss`  [ "Kabylia" ],

    -- ;; qabA}iliy~_1
    -- qbA}ly  qabA}iliy~      Nall    tribal     [[qabA}iliy~/NOUN]]
    -- qbA}ly  qabA}iliy~      Nall    tribal     [[qabA}iliy~/ADJ]]

    noun     KaRADiS |< Iy             {- qabA}iliy~ -}     `gloss`  [ "tribal [ [ qabA } iliy ~ / NOUN ] ]", "tribal [ [ qabA } iliy ~ / ADJ ] ]" ],

    -- ;; qabA}iliy~_2
    -- qbA}ly  qabA}iliy~      Nall    Kabyle     [[qabA}iliy~/NOUN]]
    -- qbA}ly  qabA}iliy~      Nall    Kabyle     [[qabA}iliy~/ADJ]]

    noun     KaRADiS |< Iy             {- qabA}iliy~ -}     `gloss`  [ "Kabyle [ [ qabA } iliy ~ / NOUN ] ]", "Kabyle [ [ qabA } iliy ~ / ADJ ] ]" ] ]
 ...
 |> "q b .d" <| [
    ...
    noun     FaCL |< aT                {- qaboDap -}        -- `others` [ "qaba.d NAt" ]
    ...
    noun     FuCL |< aT                {- quboDap -}        -- `others` [ "quba.d N" ]
                                                            `gloss`  [ "handful", "handfuls" ],

    -- ;; qibADap_1
    -- qbAD    qibAD   Nap     levying;collecting

    noun     FiCAL |< aT               {- qibADap -}        `gloss`  [ "levying", "collecting" ],

    -- ;; qubuwDap_1
    -- qbwD    qubuwD  Nap     astringency

    noun     FuCUL |< aT               {- qubuwDap -}       `gloss`  [ "astringency" ],
    ...
    noun     InFiCAL |< Iy             {- {inoqibADiy~ -}   `gloss`  [ "systolic", "contracting [ [ { inoqibADiy ~ / ADJ ] ]" ],
    ...
    noun     MaFCUL                    {- maqobuwD -}       `gloss`  [ "arrested", "seized [ [ maqobuwD / ADJ ] ]" ],
    ...
    noun     MaFCUL                    {- maqobuwD -}       `gloss`  [ "clenched [ [ maqobuwD / ADJ ] ]" ],

    -- ;; mutaqab~iD_1
    -- mtqbD   mutaqab~iD      N-ap    contracting     [[mutaqab~iD/ADJ]]

    noun     MutaFaCCiL                {- mutaqab~iD -}     `gloss`  [ "contracting [ [ mutaqab ~ iD / ADJ ] ]" ],

    -- ;; munoqabiD_1
    -- mnqbD   munoqabiD       Nall    oppressed;depressed     [[munoqabiD/ADJ]]

    noun     MunFaCiL                  {- munoqabiD -}      `gloss`  [ "oppressed", "depressed [ [ munoqabiD / ADJ ] ]" ] ]
 ...
 |> "q b .h" <| [
    ...
    noun     MustaFCaL                 {- musotaqobaH -}    `gloss`  [ "repugnant [ [ musotaqobaH / ADJ ] ]" ] ]
 ...
 |> "q b .s" <| [
    ...
    noun     FaCL |< aT                {- qaboSap -}        -- `others` [ "qaba.s NAt", "qub.s Napdu" ]
                                                            `gloss`  [ "pinch ( measure )" ] ]
 ...
 |> "q b `" <| [
    ...
    noun     FuCaL                     {- qubaE -}          `gloss`  [ "hedgehog" ],
    ...
    noun     FuCL |< aT                {- quboEap -}        `gloss`  [ "hat", "cap" ],
    ...
    noun     MuFaCCaL                  {- muqab~aE -}       `gloss`  [ "wearing a hat [ [ muqab ~ aE / ADJ ] ]" ],

    -- ;; qabiyEap_1
    -- qbyE    qabiyE  Nap     pommel
    -- qbA}E   qabA}iE Ndip    pommels

    noun     FaCIL |< aT               {- qabiyEap -}       -- `others` [ "qabA'i` Ndip" ]
 ...
 |> "q b b" <| [
    ...
    noun     FuCL |< aT                {- qub~ap -}         -- `others` [ "qibAb N", "qubab N" ]
                                                            `gloss`  [ "dome", "cupola", "domes", "cupolas" ],

    -- ;; qubayobap_1
    -- qbyb    qubayob NapAt   small domes

    noun     FuCayL |< aT              {- qubayobap -}      `gloss`  [ "small domes" ],

    -- ;; qab~ap_1
    -- qb      qab~    NapAt   shirt collar

    noun     FaCL |< aT                {- qab~ap -}         `gloss`  [ "shirt collar" ],
    ...
    noun     MuFaCCaL                  {- muqab~ab -}       `gloss`  [ "domed", "dome-shaped", "convex [ [ muqab ~ ab / ADJ ] ]" ],

    -- ;; muqab~ab_2
    -- mqbb    muqab~ab        N-ap    bulging;swollen     [[muqab~ab/ADJ]]

    noun     MuFaCCaL                  {- muqab~ab -}       `gloss`  [ "bulging", "swollen [ [ muqab ~ ab / ADJ ] ]" ],
    ...
    verb     FaCLY                     {- qab~aY -}         -- `others` [ "qabbA PV_h", "qabbiy IV_0hAnn_yu", "qabb IV_0hwnyn_yu PV_ttAw", "qabbay PV_Atn IV_Ann_Pass_yu" ]
 ...
 |> "q b l" <| [
    ...
    verb     HaFCaL                    {- Oaqobal -}        -- `others` [ "qbil IV_yu", "qbal IV_Pass_yu" ]
    ...
    noun     FaCL |< aN                {- qabolAF -}        -- `others` [ "qabl NF" ]
                                                            `gloss`  [ "previously", "formerly [ [ qabol / ADV ] ]" ],

    -- ;; qaboliy~_1
    -- qbly    qaboliy~        N-ap    a priori     [[qaboliy~/ADJ]]

    noun     FaCL |< Iy                {- qaboliy~ -}       `gloss`  [ "a priori [ [ qaboliy ~ / ADJ ] ]" ],

    -- ;; qubolap_1
    -- qbl     qubol   Napdu   kiss
    -- qbl     qubol   NAt     kisses

    noun     FuCL |< aT                {- qubolap -}        -- `others` [ "qubl NAt" ]
                                                            `gloss`  [ "kiss", "kisses" ],
    ...
    noun     FiCL |< aT                {- qibolap -}        `gloss`  [ "qiblah ( direction faced in prayer )", "focus", "direction" ],

    -- ;; qiboliy~_1
    -- qbly    qiboliy~        N-ap    southern     [[qiboliy~/ADJ]]

    noun     FiCL |< Iy                {- qiboliy~ -}       `gloss`  [ "southern [ [ qiboliy ~ / ADJ ] ]" ],
    ...
    noun     FaCIL |< aT               {- qabiylap -}       -- `others` [ "qabA'il Ndip" ]
                                                            `gloss`  [ "tribe", "tribes" ],

    -- ;; qabaliy~_1
    -- qbly    qabaliy~        N-ap    tribal     [[qabaliy~/ADJ]]

    noun     FaCaL |< Iy               {- qabaliy~ -}       `gloss`  [ "tribal [ [ qabaliy ~ / ADJ ] ]" ],

    -- ;; qubAlap_1
    -- qbAl    qubAl   Nap     in front of;facing     [[qubAl/PREP]]

    noun     FuCAL |< aT               {- qubAlap -}        `gloss`  [ "in front of", "facing [ [ qubAl / PREP ] ]" ],

    -- ;; qabAlap_1
    -- qbAl    qabAl   Nap     guarantee;liability

    noun     FaCAL |< aT               {- qabAlap -}        `gloss`  [ "guarantee", "liability" ],

    -- ;; muqAbalap_1
    -- mqAbl   muqAbal NapAt   encounter;meeting;interview

    noun     MuFACaL |< aT             {- muqAbalap -}      `gloss`  [ "encounter", "meeting", "interview" ],

    -- ;; <iqobAl_1
    -- <qbAl   <iqobAl N/At    approach;concern for;interest in
    -- AqbAl   <iqobAl N/At    approach;concern for;interest in

    noun     HiFCAL                    {- IiqobAl -}        `gloss`  [ "approach", "concern for", "interest in" ],

    -- ;; <iqobAl_2
    -- <qbAl   <iqobAl Nprop   Iqbal;Eqbal
    -- AqbAl   <iqobAl Nprop   Iqbal;Eqbal

    noun     HiFCAL                    {- IiqobAl -}        `gloss`  [ "Iqbal", "Eqbal" ],
    ...
    noun     TaFACuL |< Iy |< aT       {- taqAbuliy~ap -}   `gloss`  [ "isomorphism [ [ taqAbuliy ~ / NOUN ] ]" ],
    ...
    noun     FawACiL                   {- qawAbil -}        `gloss`  [ "receptacles", "containers" ],

    -- ;; qAbiliy~ap_1
    -- qAbly   qAbiliy~        Nap     ability;capacity     [[qAbiliy~/NOUN]]

    noun     FACiL |< Iy |< aT         {- qAbiliy~ap -}     `gloss`  [ "ability", "capacity [ [ qAbiliy ~ / NOUN ] ]" ],
    ...
    noun     MaFCUL |< Iy |< aT        {- maqobuwliy~ap -}  `gloss`  [ "acceptability [ [ maqobuwliy ~ / NOUN ] ]" ],

    -- ;; muqAbil_1
    -- mqAbl   muqAbil N       in exchange for;in compensation for
    -- mqAbl   muqAbil N       opposite to;corresponding to;vis-a-vis

    noun     MuFACiL                   {- muqAbil -}        `gloss`  [ "in exchange for", "in compensation for", "opposite to", "corresponding to", "vis-a-vis" ],
    ...
    noun     MutaFACiL                 {- mutaqAbil -}      `gloss`  [ "isomorphic", "alternate", "opposed [ [ mutaqAbil / ADJ ] ]" ],
    ...
    noun     MustaFCaL |< Iy           {- musotaqobaliy~ -} `gloss`  [ "future [ [ musotaqobaliy ~ / ADJ ] ]" ] ]
 ...
 |> "q b q b" <| [
    ...
    verb     KaRDaS                    {- qaboqab -}        -- `others` [ "qabqib IV_yu" ]
                                                            `gloss`  [ "swell", "bulge" ],
    ...
    noun     KaRDAS                    {- qaboqAb -}        -- `others` [ "qabAqiyb Ndip" ]
                                                            `gloss`  [ "sandals", "clogs" ],

    -- ;; qaboqAbiy~_1
    -- qbqAby  qaboqAbiy~      N-ap    clog-like     [[qaboqAbiy~/ADJ]]

    noun     KaRDAS |< Iy              {- qaboqAbiy~ -}     `gloss`  [ "clog-like [ [ qaboqAbiy ~ / ADJ ] ]" ] ]
 ...
 |> "q b r" <| [
    ...
    verb     HaFCaL                    {- Oaqobar -}        -- `others` [ "qbar IV_Pass_yu", "qbir IV_yu" ]
    ...
    noun     FaCL |< Iy                {- qaboriy~ -}       `gloss`  [ "sepulchral [ [ qaboriy ~ / ADJ ] ]" ],

    -- ;; qub~ar_1
    -- qbr     qub~ar  N       lark
    -- qbr     qub~ar  Napdu   lark

    noun     FuCCaL                    {- qub~ar -}         `gloss`  [ "lark" ],
 ...
 |> "q b r .s" <| [
    ...
    noun     KuRDuS                    {- quboruS -}        -- `others` [ "qubrus Ndip" ]
                                                            `gloss`  [ "Cyprus" ],
    ...
    noun     KuRDuS |< Iy              {- quboruSiy~ -}     -- `others` [ "qabAris Nap", "qabAri.s Nap", "qubrusiyy Nall" ]
    ...
    noun     KuRDuS |< Iy              {- quboruSiy~ -}     -- `others` [ "qubrusiyy Nall" ]
 ...
 |> "q b r s" <| [
    ...
    noun     KuRDuS                    {- quborus -}        `gloss`  [ "leather" ] ]
 ...
 |> "q b s" <| [
    ...
    noun     FaCL |< aT                {- qabosap -}        `gloss`  [ "firebrand" ],

    -- ;; qAbuws_1
    -- qAbws   qAbuws  Ndu     nightmare

    noun     FACUL                     {- qAbuws -}         `gloss`  [ "nightmare" ],
    ...
    noun     FACiL                     {- qAbis -}          `gloss`  [ "Gabes ( Tun . )" ],
    ...
    noun     MuFtaCaL                  {- muqotabas -}      `gloss`  [ "borrowed", "acquired", "adapted", "quoted [ [ muqotabas / ADJ ] ]", "borrowings", "quotations [ [ muqotabas / NOUN ] ]" ] ]
 ...
 |> "q b w" <| [
    ...
    noun     FaCL |< aT                {- qabowap -}        -- `others` [ "qabaw NAt" ]
    ...
    noun     MaFCUL                    {- maqobuw~ -}       `gloss`  [ "vaulted", "arched [ [ maqobuw ~ / ADJ ] ]" ],

    -- ;; qabawiy~_1
    -- qbwy    qabawiy~        N-ap    apsidal     [[qabawiy~/ADJ]]

    noun     FaCY |< Iy                {- qabawiy~ -}       `gloss`  [ "apsidal [ [ qabawiy ~ / ADJ ] ]" ] ]
 ...
 |> "q d '" <| [
    ...
    noun     IFtiCAL                   {- {iqotidA' -}      `gloss`  [ "imitation", "emulation", "imitations", "emulations" ],
    ...
    noun     IFtiCAL |< aN             {- {iqotidA'F -}     `gloss`  [ "following the example of", "in imitation of [ [ { iqotidA'F / ADV ] ]" ] ]
 ...
 |> "q d .h" <| [
    ...
    noun     MiFCaL |< aT              {- miqodaHap -}      `gloss`  [ "flint stone", "fire iron" ],
    ...
    noun     FACiL                     {- qAdiH -}          `gloss`  [ "sparkling", "flashing [ [ qAdiH / ADJ ] ]" ] ]
 ...
 |> "q d d" <| [
    ...
    noun     FiCL |< aT                {- qid~ap -}         -- `others` [ "qidad N" ]
 ...
 |> "q d m" <| [
    ...
    verb     HaFCaL                    {- Oaqodam -}        -- `others` [ "qdam IV_Pass_yu", "qdim IV_yu" ]
    ...
    noun     FaCaL |< Iy |< aT         {- qadamiy~ap -}     `gloss`  [ "harmonium [ [ qadamiy ~ / NOUN ] ]" ],
    ...
    noun     FiCaL |< Iy |< aT         {- qidamiy~ap -}     `gloss`  [ "ancientness [ [ qidamiy ~ / NOUN ] ]" ],
    ...
    noun     HaFCaL                    {- Oaqodam -}        `gloss`  [ "older / oldest", "ancients" ],

    -- ;; >aqodamiy~ap_1
    -- >qdmy   >aqodamiy~      Nap     seniority     [[>aqodamiy~/NOUN]]
    -- Aqdmy   >aqodamiy~      Nap     seniority     [[>aqodamiy~/NOUN]]

    noun     HaFCaL |< Iy |< aT        {- Oaqodamiy~ap -}   `gloss`  [ "seniority [ [ >aqodamiy ~ / NOUN ] ]" ],
    ...
    noun     TaFCiL |< aT              {- taqodimap -}      `gloss`  [ "offer", "donation", "dedication" ],

    -- ;; taqodimap_2
    -- tqdm    taqodim NapAt   gift
    -- tqAdm   taqAdim Ndip    gifts

    noun     TaFCiL |< aT              {- taqodimap -}      -- `others` [ "taqAdim Ndip" ]
                                                            `gloss`  [ "gift", "gifts" ],
    ...
    noun     HiFCAL                    {- IiqodAm -}        `gloss`  [ "courage", "audacity" ],
    ...
    noun     TaFaCCuL |< Iy            {- taqad~umiy~ -}    `gloss`  [ "progressive [ [ taqad ~ umiy ~ / ADJ ] ]", "progressivism [ [ taqad ~ umiy ~ / NOUN ] ]" ],
    ...
    noun     FACiL |< aT               {- qAdimap -}        -- `others` [ "qawAdim Ndip" ]
                                                            `gloss`  [ "avant-garde" ],
    ...
    noun     MuFaCCiL |< aT            {- muqad~imap -}     `gloss`  [ "preface", "introduction", "front part" ],
    ...
    noun     MuFaCCaL |< aT            {- muqad~amap -}     `gloss`  [ "preface", "introduction", "front part" ],

    -- ;; muqad~amap_2
    -- mqdm    muqad~am        Nap     vanguard

    noun     MuFaCCaL |< aT            {- muqad~amap -}     `gloss`  [ "vanguard" ],
 ...
 |> "q d m s" <| [
    ...
    noun     KuRDUS                    {- qudomuws -}       -- `others` [ "qadAmiys Ndip" ]
 ...
 |> "q d r" <| [
    ...
    noun     FaCaL |< Iy               {- qadariy~ -}       `gloss`  [ "fatalistic", "Qadarite [ [ qadariy ~ / ADJ ] ]" ],

    -- ;; qadariy~ap_1
    -- qdry    qadariy~        Nap     fatalism;free will     [[qadariy~/NOUN]]

    noun     FaCaL |< Iy |< aT         {- qadariy~ap -}     `gloss`  [ "fatalism", "free will [ [ qadariy ~ / NOUN ] ]" ],
    ...
    noun     FiCL |< aT                {- qidorap -}        -- `others` [ "qidar N" ]
                                                            `gloss`  [ "jug", "pot", "jugs", "pots" ],

    -- ;; qudorap_1
    -- qdr     qudor   NapAt   capacity;ability;potential;power

    noun     FuCL |< aT                {- qudorap -}        `gloss`  [ "capacity", "ability", "potential", "power" ],
    ...
    noun     FaCIL                     {- qadiyr -}         `gloss`  [ "omnipotent ( God ) [ [ qadiyr / ADJ ] ]" ],
    ...
    noun     HaFCaL                    {- Oaqodar -}        `gloss`  [ "more / most capable" ],
    ...
    noun     MiFCAL |< Iy              {- miqodAriy~ -}     `gloss`  [ "quantitative [ [ miqodAriy ~ / ADJ ] ]" ],
    ...
    noun     TaFCIL |< Iy              {- taqodiyriy~ -}    `gloss`  [ "estimated", "appreciative [ [ taqodiyriy ~ / ADJ ] ]" ],
    ...
    noun     MuFaCCaL                  {- muqad~ar -}       `gloss`  [ "decreed", "destined", "fated [ [ muqad ~ ar / ADJ ] ]", "fate [ [ muqad ~ ar / NOUN ] ]" ],
 ...
 |> "q d s" <| [
    ...
    noun     FuCL |< Iy                {- qudosiy~ -}       `gloss`  [ "Jerusalemite [ [ qudosiy ~ / NOUN ] ]" ],
    ...
    noun     FuCL |< Iy                {- qudosiy~ -}       `gloss`  [ "holy", "saintly [ [ qudosiy ~ / ADJ ] ]" ],

    -- ;; qudosiy~ap_1
    -- qdsy    qudosiy~        Nap     sanctity;holiness     [[qudosiy~/NOUN]]

    noun     FuCL |< Iy |< aT          {- qudosiy~ap -}     `gloss`  [ "sanctity", "holiness [ [ qudosiy ~ / NOUN ] ]" ],
    ...
    noun     HaFCAL                    {- OaqodAs -}        `gloss`  [ "shrines", "sanctuaries" ],
    ...
    noun     FaCAL |< aT               {- qadAsap -}        `gloss`  [ "sanctity", "His Holiness" ],
    ...
    noun     HaFCaL                    {- Oaqodas -}        `gloss`  [ "holier / holiest", "more / most sacred" ],
    ...
    noun     MaFCiL |< Iy              {- maqodisiy~ -}     `gloss`  [ "of / from Jerusalem [ [ maqodisiy ~ / ADJ ] ]" ],
    ...
    noun     FACiL |< Iy |< aT         {- qAdisiy~ap -}     `gloss`  [ "Qadisiya [ [ qAdisiy ~ / NOUN_PROP ] ]" ],
    ...
    noun     MutaFaCCiL                {- mutaqad~is -}     `gloss`  [ "hallowed", "consecrated [ [ mutaqad ~ is / ADJ ] ]" ],

    -- ;; qAduws_1
    -- qAdws   qAduws  Ndu     water-wheel bucket;scoop
    -- qwAdys  qawAdiys        Ndip    water-wheel buckets;scoops

    noun     FACUL                     {- qAduws -}         -- `others` [ "qawAdiys Ndip" ]
 ...
 |> "q d w" <| [
    ...
    verb     FaCA                      {- qadA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "qd IV_0hwnyn", "qad PV_ttAw_intr", "qadaw PV_Atn", "qduw IV_0hAnn" ]
                                                            `gloss`  [ "be tasty" ],
    ...
    noun     IFtiCA' |< aN             {- {iqotidA'F -}     `gloss`  [ "following the example of", "in imitation of [ [ { iqotidA'F / ADV ] ]" ],
    ...
    noun     FaCAL |< aT               {- qadAwap -}        `gloss`  [ "savoriness" ],

    -- ;; qudowap_1
    -- qdw     qudow   Napdu   example;model;pattern
    -- qdw     qidow   Napdu   example;model;pattern

    noun     FuCL |< aT                {- qudowap -}        -- `others` [ "qidw Napdu" ]
 ...
 |> "q d y" <| [
    ...
    verb     FaCiL                     {- qadiy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "qday IV_Ann", "qdY IV_0", "qad PV_w_intr", "qda IV_0hwnyn" ]
                                                            `gloss`  [ "be tasty" ],

    -- ;; qadiy~_1
    -- qdy     qadiy~  N-ap    savory;tasty     [[qadiy~/ADJ]]

    noun     FaCIL                     {- qadiy~ -}         `gloss`  [ "savory", "tasty [ [ qadiy ~ / ADJ ] ]" ] ]
 ...
 |> "q f '" <| [
    ...
    noun     FaCAL                     {- qafA' -}          `gloss`  [ "neck", "nape" ],
    ...
    noun     IFtiCAL                   {- {iqotifA' -}      `gloss`  [ "following", "tracking", "imitating" ] ]
 ...
 |> "q f .s" <| [
    ...
    noun     TaFCIL |< aT              {- taqofiySap -}     `gloss`  [ "poultry coop" ] ]
 ...
 |> "q f .t n" <| [
    ...
    noun     KuRDAS                    {- qufoTAn -}        -- `others` [ "qafA.tiyn Ndip" ]
 ...
 |> "q f ^s" <| [
    ...
    noun     FaCL |< aT                {- qafo$ap -}        -- `others` [ "qafa^s NAt" ]
 ...
 |> "q f f" <| [
    ...
    noun     FuCL |< aT                {- quf~ap -}         -- `others` [ "qufaf N" ]
                                                            `gloss`  [ "basket", "baskets" ],
    ...
    noun     FaCL |< aT                {- qaf~ap -}         `gloss`  [ "feverish shiver" ],
 ...
 |> "q f l" <| [
    ...
    verb     HaFCaL                    {- Oaqofal -}        -- `others` [ "qfil IV_yu", "qfal IV_Pass_yu" ]
    ...
    noun     HiFCAL                    {- IiqofAl -}        `gloss`  [ "locking", "closing", "blocking" ],
    ...
    noun     FACiL |< aT               {- qAfilap -}        -- `others` [ "qawAfil Ndip" ]
 ...
 |> "q f q f" <| [
    ...
    verb     KaRDaS                    {- qafoqaf -}        -- `others` [ "qafqif IV_yu" ]
    ...
    verb     TaKaRDaS                  {- taqafoqaf -}      `gloss`  [ "shiver", "chatter" ],

    -- ;; qafoqafap_1
    -- qfqf    qafoqaf Nap     shivering;chattering

    noun     KaRDaS |< aT              {- qafoqafap -}      `gloss`  [ "shivering", "chattering" ] ]
 ...
 |> "q f q s" <| [
    ...
    noun     KaRDAS                    {- qafoqAs -}        `gloss`  [ "Caucasus" ] ]
 ...
 |> "q f r" <| [
    ...
    verb     HaFCaL                    {- Oaqofar -}        -- `others` [ "qfir IV_yu", "qfar IV_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- qaforap -}        -- `others` [ "qafar NAt" ]
    ...
    noun     HiFCAL                    {- IiqofAr -}        `gloss`  [ "desolateness", "devastation", "depopulation" ],

    -- ;; muqofir_1
    -- mqfr    muqofir N-ap    desolate;depopulated     [[muqofir/ADJ]]

    noun     MuFCiL                    {- muqofir -}        `gloss`  [ "desolate", "depopulated [ [ muqofir / ADJ ] ]" ] ]
 ...
 |> "q f w" <| [
    ...
    noun     FACI |< aT                {- qAfiyap -}        -- `others` [ "qawAfiy N0_Nh", "qawAf NK" ]
                                                            `gloss`  [ "rhyme", "rhymes" ] ]
 ...
 |> "q f y" <| [
    ...
    noun     FACiL |< aT               {- qAfiyap -}        -- `others` [ "qawAfiy N0_Nh", "qawAf NK" ]
                                                            `gloss`  [ "rhyme", "rhymes" ] ]
 ...
 |> "q h q h" <| [
    ...
    verb     KaRDaS                    {- qahoqah -}        -- `others` [ "qahqih IV_yu" ]
                                                            `gloss`  [ "laugh", "guffaw" ],

    -- ;; qahoqahap_1
    -- qhqh    qahoqah Nap     laughter

    noun     KaRDaS |< aT              {- qahoqahap -}      `gloss`  [ "laughter" ],

    -- ;; muqahoqih_1
    -- mqhqh   muqahoqih       Nall    laughing

    noun     MuKaRDiS                  {- muqahoqih -}      `gloss`  [ "laughing" ],

    -- ;; muqahoqih_2
    -- mqhqh   muqahoqih       N-ap    hilarious     [[muqahoqih/ADJ]]

    noun     MuKaRDiS                  {- muqahoqih -}      `gloss`  [ "hilarious [ [ muqahoqih / ADJ ] ]" ] ]
 ...
 |> "q h q r" <| [
    ...
    verb     KaRDaS                    {- qahoqar -}        -- `others` [ "qahqir IV_yu" ]
    ...
    verb     TaKaRDaS                  {- taqahoqar -}      `gloss`  [ "deteriorate", "decline" ],

    -- ;; qahoqarap_1
    -- qhqr    qahoqar Nap     decline;retreat

    noun     KaRDaS |< aT              {- qahoqarap -}      `gloss`  [ "decline", "retreat" ],

    -- ;; taqahoqur_1
    -- tqhqr   taqahoqur       N/At    recession;retreat

    noun     TaKaRDuS                  {- taqahoqur -}      `gloss`  [ "recession", "retreat" ] ]
 ...
 |> "q h r" <| [
    ...
    noun     FaCL |< aN                {- qahorAF -}        -- `others` [ "qahr NF" ]
                                                            `gloss`  [ "forcibly", "by force [ [ qahor / ADV ] ]" ],

    -- ;; quhorap_1
    -- qhr     quhor   Nap     coercion;force

    noun     FuCL |< aT                {- quhorap -}        `gloss`  [ "coercion", "force" ],

    -- ;; qahoriy~_1
    -- qhry    qahoriy~        N-ap    forced;compulsory     [[qahoriy~/ADJ]]

    noun     FaCL |< Iy                {- qahoriy~ -}       `gloss`  [ "forced", "compulsory [ [ qahoriy ~ / ADJ ] ]" ],
    ...
    noun     FACiL                     {- qAhir -}          `gloss`  [ "overpowering [ [ qAhir / ADJ ] ]" ],
    ...
    noun     FACiL |< aT               {- qAhirap -}        `gloss`  [ "Cairo" ],

    -- ;; qAhiriy~_1
    -- qAhry   qAhiriy~        Nall    Cairene     [[qAhiriy~/NOUN]]
    -- qAhry   qAhiriy~        Nall    Cairene     [[qAhiriy~/ADJ]]

    noun     FACiL |< Iy               {- qAhiriy~ -}       `gloss`  [ "Cairene [ [ qAhiriy ~ / NOUN ] ]", "Cairene [ [ qAhiriy ~ / ADJ ] ]" ],
 ...
 |> "q h w" <| [
    ...
    noun     FaCL |< aT                {- qahowap -}        -- `others` [ "qahaw NAt" ]
    ...
    noun     MaFCY                     {- maqohaY -}        -- `others` [ "maqhay NAn_Nayn", "maqAh NK", "maqAhiy N0_Nh", "maqhA Nhy" ]
                                                            `gloss`  [ "cafe", "coffeehouse", "cafes", "coffeehouses" ],

    -- ;; maqohAp_1
    -- mqhA    maqohA  Napdu   cafe;coffeehouse

    noun     MaFCY |< aT               {- maqohAp -}        `gloss`  [ "cafe", "coffeehouse" ] ]
 ...
 |> "q h y" <| [
    ...
    verb     FaCiL                     {- qahiy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "qhay IV_Ann", "qhY IV_0", "qah PV_w", "qha IV_0hwnyn" ]
    ...
    verb     HaFCY                     {- OaqohaY -}        -- `others` [ "'aqhay PV_Atn", "qh IV_0hwnyn_yu", "'aqh PV_ttAw", "'aqhA PV_h", "qhiy IV_0hAnn_yu" ]
                                                            `gloss`  [ "have no appetite" ],
 ...
 |> "q l .s" <| [
    ...
    noun     HaFCaL                    {- OaqolaS -}        `gloss`  [ "shorter" ],
 ...
 |> "q l ^s" <| [
    ...
    noun     FACUL                     {- qAluw$ -}         `gloss`  [ "galoshes" ] ]
 ...
 |> "q l ^s n" <| [
    ...
    noun     KaRDIS                    {- qalo$iyn -}       -- `others` [ "qalA^siyn Ndip" ]
 ...
 |> "q l `" <| [
    ...
    verb     HaFCaL                    {- OaqolaE -}        -- `others` [ "qli` IV_yu" ]
                                                            `gloss`  [ "take off" ],
    ...
    noun     MiFCaL |< aT              {- miqolaEap -}      `gloss`  [ "bulldozer" ],
    ...
    noun     TaFCIL |< aT              {- taqoliyEap -}     -- `others` [ "taqAliy` Ndip" ]
    ...
    noun     HiFCAL                    {- IiqolAE -}        `gloss`  [ "departure", "take-off" ],
 ...
 |> "q l ` .t" <| [
    ...
    verb     KaRDaS                    {- qaloEaT -}        -- `others` [ "qal`i.t IV_yu" ]
                                                            `gloss`  [ "sully", "soil" ],

    -- ;; qaloEaTap_1
    -- qlET    qaloEaT Nap     sullying;soiling

    noun     KaRDaS |< aT              {- qaloEaTap -}      `gloss`  [ "sullying", "soiling" ],

    -- ;; quloEuwT_1
    -- qlEwT   quloEuwT        Ndu     heretic

    noun     KuRDUS                    {- quloEuwT -}       `gloss`  [ "heretic" ] ]
 ...
 |> "q l b" <| [
    ...
    noun     FaCUL                     {- qaluwb -}         `gloss`  [ "resourceful", "versatile [ [ qaluwb / ADJ ] ]" ],

    -- ;; qal~Ab_1
    -- qlAb    qal~Ab  Nall    variable;wavering     [[qal~Ab/ADJ]]

    noun     FaCCAL                    {- qal~Ab -}         `gloss`  [ "variable", "wavering [ [ qal ~ Ab / ADJ ] ]" ],
    ...
    noun     FaCCAL |< aT              {- qal~Abap -}       `gloss`  [ "stirring machine" ],
    ...
    noun     InFiCAL |< Iy             {- {inoqilAbiy~ -}   `gloss`  [ "revolutionary [ [ { inoqilAbiy ~ / ADJ ] ]" ],
 ...
 |> "q l d" <| [
    ...
    noun     FiCAL |< aT               {- qilAdap -}        -- `others` [ "qalA'id Ndip" ]
    ...
    noun     TaFCIL |< Iy              {- taqoliydiy~ -}    `gloss`  [ "traditional", "conventional [ [ taqoliydiy ~ / ADJ ] ]" ],

    -- ;; taqoliydiy~ap_1
    -- tqlydy  taqoliydiy~     Nap     traditionalism;conventionalism     [[taqoliydiy~/NOUN]]

    noun     TaFCIL |< Iy |< aT        {- taqoliydiy~ap -}  `gloss`  [ "traditionalism", "conventionalism [ [ taqoliydiy ~ / NOUN ] ]" ],
    ...
    noun     MuFaCCaL                  {- muqal~ad -}       `gloss`  [ "imitated", "fake [ [ muqal ~ ad / ADJ ] ]" ] ]
 ...
 |> "q l f .t" <| [
    ...
    verb     KaRDaS                    {- qalofaT -}        -- `others` [ "qalfi.t IV_yu" ]
                                                            `gloss`  [ "caulk", "bungle" ],

    -- ;; qalofaTap_1
    -- qlfT    qalofaT Nap     caulking;bungling

    noun     KaRDaS |< aT              {- qalofaTap -}      `gloss`  [ "caulking", "bungling" ] ]
 ...
 |> "q l l" <| [
    ...
    verb     HaFaCL                    {- Oaqal~ -}         -- `others` [ "qill IV_V_yu", "qall IV_V_Pass_yu", "qlil IV_C_yu", "'aqlal PV_C" ]
    ...
    noun     FaCL |< aT                {- qal~ap -}         `gloss`  [ "recovery" ],

    -- ;; qul~ap_1
    -- ql      qul~    Nap     summit

    noun     FuCL |< aT                {- qul~ap -}         `gloss`  [ "summit" ],

    -- ;; qul~ap_2
    -- ql      qul~    Napdu   jug;pitcher
    -- qll     qulal   N       jugs;pitchers

    noun     FuCL |< aT                {- qul~ap -}         -- `others` [ "qulal N" ]
                                                            `gloss`  [ "jug", "pitcher", "jugs", "pitchers" ],

    -- ;; qil~ap_1
    -- ql      qil~    Nap     scarcity;lack of;small number or amount of

    noun     FiCL |< aT                {- qil~ap -}         `gloss`  [ "scarcity", "lack of", "small number or amount of" ],

    -- ;; qil~iy~ap_1
    -- qly     qil~iy~ Nap     entirety;complete     [[qil~iy~/NOUN]]

    noun     FiCL |< Iy |< aT          {- qil~iy~ap -}      `gloss`  [ "entirety", "complete [ [ qil ~ iy ~ / NOUN ] ]" ],
    ...
    noun     HiFCAL                    {- IiqolAl -}        `gloss`  [ "decrease", "diminution", "reduction" ],
    ...
    noun     IstiFCAL |< Iy            {- {isotiqolAliy~ -} `gloss`  [ "independent", "autonomous [ [ { isotiqolAliy ~ / ADJ ] ]" ],
 ...
 |> "q l m" <| [
    ...
    noun     FaCaL |< Iy               {- qalamiy~ -}       `gloss`  [ "handwritten", "by pen [ [ qalamiy ~ / ADJ ] ]" ],

    -- ;; qulAmap_1
    -- qlAm    qulAm   NapAt   clippings;shavings

    noun     FuCAL |< aT               {- qulAmap -}        `gloss`  [ "clippings", "shavings" ],

    -- ;; miqolamap_1
    -- mqlm    miqolam NapAt   pen case

    noun     MiFCaL |< aT              {- miqolamap -}      `gloss`  [ "pen case" ],
 ...
 |> "q l n s" <| [
    ...
    verb     TaKaRDaS                  {- taqalonas -}      `gloss`  [ "wear a cap" ] ]
 ...
 |> "q l q" <| [
    ...
    verb     HaFCaL                    {- Oaqolaq -}        -- `others` [ "qliq IV_yu", "qlaq IV_Pass_yu" ]
    ...
    noun     HiFCAL                    {- IiqolAq -}        `gloss`  [ "perturbation", "disturbance" ],
 ...
 |> "q l q b" <| [
    ...
    noun     KaRDaS                    {- qaloqab -}        `gloss`  [ "fur cap" ] ]
 ...
 |> "q l q l" <| [
    ...
    verb     KaRDaS                    {- qaloqal -}        -- `others` [ "qalqil IV_yu" ]
 ...
 |> "q l q s" <| [
    ...
    noun     KuRDAS                    {- quloqAs -}        `gloss`  [ "taro ( plant with edible roots )", "elephant 's ear" ] ]
 ...
 |> "q l w" <| [
    ...
    verb     FaCA                      {- qalA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "qluw IV_0hAnn", "qlay IV_Ann_Pass_yu", "qalaw PV_Atn", "ql IV_0hwnyn", "qlY IV_0_Pass_yu", "qal PV_ttAw" ]
    ...
    verb     FaCY                      {- qalaY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ "qalA PV_h", "ql IV_0hwnyn", "qalay PV_Atn", "qlY IV_0_Pass_yu", "qal PV_ttAw", "qliy IV_0hAnn" ]
                                                            `gloss`  [ "fry", "bake", "be fried", "be baked" ],
    ...
    noun     MiFCY                     {- miqolaY -}        -- `others` [ "miqlay NAn_Nayn", "miqlA Napdu Nhy", "maqAl NK", "maqAliy N0_Nh" ]
                                                            `gloss`  [ "frying pan", "frying pans" ],

    -- ;; maqoliy~_1
    -- mqly    maqoliy~        N-ap    fried     [[maqoliy~/ADJ]]

    noun     MaFCIy                    {- maqoliy~ -}       `gloss`  [ "fried [ [ maqoliy ~ / ADJ ] ]" ] ]
 ...
 |> "q l w .z" <| [
    ...
    verb     KaRDaS                    {- qalowaZ -}        -- `others` [ "qalwi.z IV_yu" ]
                                                            `gloss`  [ "twist", "wind", "screw on" ],

    -- ;; muqalowaZ_1
    -- mqlwZ   muqalowaZ       N-ap    spiral;helical     [[muqalowaZ/ADJ]]

    noun     MuKaRDaS                  {- muqalowaZ -}      `gloss`  [ "spiral", "helical [ [ muqalowaZ / ADJ ] ]" ] ]
 ...
 |> "q l w y" <| [
    ...
    noun     KiRDIS                    {- qilowiy~ -}       `gloss`  [ "alkaline [ [ qilowiy ~ / ADJ ] ]", "bases [ [ qilowiy ~ / NOUN ] ]" ] ]
 ...
 |> "q l w z" <| [
    ...
    verb     KaRDaS                    {- qalowaz -}        -- `others` [ "qalwiz IV_yu" ]
                                                            `gloss`  [ "twist", "wind", "screw on" ],
 ...
 |> "q l y" <| [
    ...
    verb     FaCiL                     {- qaliy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "qlay IV_Ann", "qlA IV_h", "qla IV_0hwnyn", "qlY IV_0", "qal PV_w" ]
                                                            `gloss`  [ "detest" ],

    -- ;; qal~Ayap_1
    -- qlAy    qal~Ay  NapAt   frying pan

    noun     FaCCAL |< aT              {- qal~Ayap -}       `gloss`  [ "frying pan" ],

    -- ;; taqoliyap_1
    -- tqly    taqoliy Nap     alkalization

    noun     TaFCiL |< aT              {- taqoliyap -}      `gloss`  [ "alkalization" ],
    ...
    noun     FiCCIL |< aT              {- qil~iy~ap -}      -- `others` [ "qalAliy N0_Nh", "qillAy NapAt", "qalAl NK" ]
                                                            `gloss`  [ "monk 's cell", "bishop 's residence [ [ qil ~ iy ~ / NOUN ] ]", "bishop 's residence", "monks ' cells" ] ]
 ...
 |> "q l y b" <| [
    ...
    noun     KaRDUS                    {- qaloyuwb -}       `gloss`  [ "Qalyub ( Egy . )" ],

    -- ;; qaloyuwbiy~ap_1
    -- qlywby  qaloyuwbiy~     Nap     Qalyubiyah (Egy. prov.)     [[qaloyuwbiy~/NOUN]]

    noun     KaRDUS |< Iy |< aT        {- qaloyuwbiy~ap -}  `gloss`  [ "Qalyubiyah ( Egy . prov . ) [ [ qaloyuwbiy ~ / NOUN ] ]" ],

    -- ;; qaloyuwbiy~_1
    -- qlywby  qaloyuwbiy~     Nall    from/of Qalyub (Egy.)     [[qaloyuwbiy~/ADJ]]

    noun     KaRDUS |< Iy              {- qaloyuwbiy~ -}    `gloss`  [ "from / of Qalyub ( Egy . ) [ [ qaloyuwbiy ~ / ADJ ] ]" ] ]
 ...
 |> "q m '" <| [
    ...
    verb     FaCuL                     {- qamuW-a -}        `imperf` [ FCaL ]
    ...
    noun     FaCIL                     {- qamiy' -}         `gloss`  [ "humble", "unattractive [ [ qamiy ' / ADJ ] ]", "unattractive" ],

    -- ;; qamA'ap_1
    -- qmA'    qamA'   Nap     humbleness;unattractiveness

    noun     FaCAL |< aT               {- qamA'ap -}        `gloss`  [ "humbleness", "unattractiveness" ] ]
 ...
 |> "q m .h" <| [
    ...
    verb     HaFCaL                    {- OaqomaH -}        -- `others` [ "qmi.h IV_yu", "qma.h IV_Pass_yu" ]
    ...
    noun     FaCL |< Iy                {- qamoHiy~ -}       `gloss`  [ "wheat [ [ qamoHiy ~ / ADJ ] ]" ],
 ...
 |> "q m .t" <| [
    ...
    noun     FaCL |< aT                {- qamoTap -}        `gloss`  [ "kerchief" ],
 ...
 |> "q m ^s" <| [
    ...
    noun     FaCL |< aT                {- qamo$ap -}        `gloss`  [ "strap", "thong", "whip" ] ]
 ...
 |> "q m `" <| [
    ...
    verb     HaFCaL                    {- OaqomaE -}        -- `others` [ "qma` IV_Pass_yu", "qmi` IV_yu" ]
    ...
    noun     FaCL |< Iy                {- qamoEiy~ -}       `gloss`  [ "repressive [ [ qamoEiy ~ / ADJ ] ]" ],
 ...
 |> "q m b z" <| [
    ...
    noun     KuRDAS                    {- qumobAz -}        -- `others` [ "qanAbiyz Ndip", "qamAbiyz Ndip", "qunbAz Ndu" ]
 ...
 |> "q m l" <| [
    ...
    noun     FaCiL                     {- qamil -}          `gloss`  [ "lice-infested [ [ qamil / ADJ ] ]" ],

    -- ;; muqomal_1
    -- mqml    muqomal N-ap    lice-infested     [[muqomal/ADJ]]

    noun     MuFCaL                    {- muqomal -}        `gloss`  [ "lice-infested [ [ muqomal / ADJ ] ]" ] ]
 ...
 |> "q m m" <| [
    ...
    noun     FiCL |< aT                {- qim~ap -}         -- `others` [ "qimam N" ]
    ...
    noun     FuCAL |< aT               {- qumAmap -}        -- `others` [ "qamA'im Ndip" ]
                                                            `gloss`  [ "rubbish" ],
    ...
    noun     MiFaCL |< aT              {- miqam~ap -}       -- `others` [ "maqAmm Ndip" ]
                                                            `gloss`  [ "broom", "brooms" ] ]
 ...
 |> "q m n" <| [
    ...
    noun     FaCiL                     {- qamin -}          `gloss`  [ "deserving", "worthy [ [ qamin / ADJ ] ]" ],
 ...
 |> "q m q m" <| [
    ...
    verb     KaRDaS                    {- qamoqam -}        -- `others` [ "qamqim IV_yu" ]
                                                            `gloss`  [ "grumble" ],
    ...
    verb     TaKaRDaS                  {- taqamoqam -}      `gloss`  [ "complain", "grumble" ],

    -- ;; qamoqamap_1
    -- qmqm    qamoqam Nap     grumbling

    noun     KaRDaS |< aT              {- qamoqamap -}      `gloss`  [ "grumbling" ],
    ...
    noun     KuRDuS                    {- qumoqum -}        -- `others` [ "qamAqim Ndip" ]
 ...
 |> "q m r" <| [
    ...
    verb     HaFCaL                    {- Oaqomar -}        -- `others` [ "qmir IV_intr_yu", "qmar IV_Pass_yu" ]
                                                            `gloss`  [ "be moonlit" ],
    ...
    noun     FaCaL |< aT               {- qamarap -}        `gloss`  [ "crescent", "moonlight" ],

    -- ;; qamariy~_1
    -- qmry    qamariy~        N-ap    lunar;moon     [[qamariy~/ADJ]]

    noun     FaCaL |< Iy               {- qamariy~ -}       `gloss`  [ "lunar", "moon [ [ qamariy ~ / ADJ ] ]" ],

    -- ;; qamariy~_2
    -- qmry    qamariy~        N-ap    satellite     [[qamariy~/ADJ]]

    noun     FaCaL |< Iy               {- qamariy~ -}       `gloss`  [ "satellite [ [ qamariy ~ / ADJ ] ]" ],

    -- ;; qamariy~ap_1
    -- qmry    qamariy~        NapAt   skylight;small window     [[qamariy~/NOUN]]

    noun     FaCaL |< Iy |< aT         {- qamariy~ap -}     `gloss`  [ "skylight", "small window [ [ qamariy ~ / NOUN ] ]" ],
    ...
    noun     HaFCaL                    {- Oaqomar -}        `gloss`  [ "moonlit" ],
    ...
    noun     MuFACaL |< aT             {- muqAmarap -}      `gloss`  [ "gambling" ],
    ...
    noun     MuFCiL                    {- muqomir -}        `gloss`  [ "moonlit [ [ muqomir / ADJ ] ]" ],

    -- ;; qamarap_2
    -- qmr     qamar   NapAt   cabin;bunk;berth;cockpit

    noun     FaCaL |< aT               {- qamarap -}        `gloss`  [ "cabin", "bunk", "berth", "cockpit" ] ]
 ...
 |> "q m r '" <| [
    ...
    noun     KaRDAS                    {- qamorA' -}        `gloss`  [ "moonlight" ] ]
 ...
 |> "q m r q" <| [
    ...
    noun     KuRDuS                    {- qumoruq -}        -- `others` [ "qamAriq Ndip" ]
                                                            `gloss`  [ "customs", "import tariff" ],

    -- ;; qumoruqiy~_1
    -- qmrqy   qumoruqiy~      N-ap    customs;import tariff     [[qumoruqiy~/ADJ]]

    noun     KuRDuS |< Iy              {- qumoruqiy~ -}     `gloss`  [ "customs", "import tariff [ [ qumoruqiy ~ / ADJ ] ]" ] ]
 ...
 |> "q m s" <| [
    ...
    noun     FACUL                     {- qAmuws -}         -- `others` [ "qawAmiys Ndip" ]
                                                            `gloss`  [ "dictionary", "lexicon", "dictionaries", "lexicons" ],

    -- ;; qAmuws_2
    -- qAmws   qAmuws  N0      Qamus

    noun     FACUL                     {- qAmuws -}         `gloss`  [ "Qamus" ],

    -- ;; qAmuwsiy~_1
    -- qAmwsy  qAmuwsiy~       N-ap    lexical;dictionary     [[qAmuwsiy~/ADJ]]

    noun     FACUL |< Iy               {- qAmuwsiy~ -}      `gloss`  [ "lexical", "dictionary [ [ qAmuwsiy ~ / ADJ ] ]" ] ]
 ...
 |> "q n '" <| [
    ...
    noun     FACiL                     {- qAni} -}          -- `others` [ "qAniy N0F", "qAn NK" ]
                                                            `gloss`  [ "crimson", "bright-red [ [ qAni } / ADJ ] ]", "bright-red" ],
    ...
    noun     IFtiCAL                   {- {iqotinA' -}      `gloss`  [ "purchase", "acquisition", "purchases", "acquisitions" ] ]
 ...
 |> "q n .s" <| [
    ...
    noun     FACiL |< aT               {- qAniSap -}        `gloss`  [ "destroyer" ],

    -- ;; qAniSap_2
    -- qAnS    qAniS   Nap     gizzard
    -- qwAnS   qawAniS Ndip    gizzards

    noun     FACiL |< aT               {- qAniSap -}        -- `others` [ "qawAni.s Ndip" ]
 ...
 |> "q n .s l" <| [
    ...
    noun     KuRDuS                    {- qunoSul -}        -- `others` [ "qanA.sil Ndip" ]
                                                            `gloss`  [ "consul", "consuls" ],

    -- ;; qunoSuliy~_1
    -- qnSly   qunoSuliy~      Nall    consular     [[qunoSuliy~/ADJ]]

    noun     KuRDuS |< Iy              {- qunoSuliy~ -}     `gloss`  [ "consular [ [ qunoSuliy ~ / ADJ ] ]" ],

    -- ;; qunoSuliy~ap_1
    -- qnSly   qunoSuliy~      NapAt   consulate     [[qunoSuliy~/NOUN]]

    noun     KuRDuS |< Iy |< aT        {- qunoSuliy~ap -}   `gloss`  [ "consulate [ [ qunoSuliy ~ / NOUN ] ]" ] ]
 ...
 |> "q n .t" <| [
    ...
    verb     HaFCaL                    {- OaqonaT -}        -- `others` [ "qni.t IV_yu", "qna.t IV_Pass_yu" ]
    ...
    noun     FaCiL                     {- qaniT -}          `gloss`  [ "despondent", "discouraged [ [ qaniT / ADJ ] ]" ],

    -- ;; qanuwT_1
    -- qnwT    qanuwT  Nall    despondent;discouraged     [[qanuwT/ADJ]]

    noun     FaCUL                     {- qanuwT -}         `gloss`  [ "despondent", "discouraged [ [ qanuwT / ADJ ] ]" ],

    -- ;; qAniT_1
    -- qAnT    qAniT   Nall    despairing;discouraged     [[qAniT/ADJ]]

    noun     FACiL                     {- qAniT -}          `gloss`  [ "despairing", "discouraged [ [ qAniT / ADJ ] ]" ] ]
 ...
 |> "q n .t r" <| [
    ...
    verb     KaRDaS                    {- qanoTar -}        -- `others` [ "qan.tir IV_yu" ]
    ...
    noun     KaRDaS |< aT              {- qanoTarap -}      -- `others` [ "qanA.tir Ndip" ]
                                                            `gloss`  [ "aqueduct", "bridge", "aqueducts", "bridges" ],

    -- ;; qanATir_1
    -- qnATr   qanATir N0      Qanatir (Egy.)

    noun     KaRADiS                   {- qanATir -}        `gloss`  [ "Qanatir ( Egy . )" ],

    -- ;; qanoTariy~_1
    -- qnTry   qanoTariy~      N-ap    arched;vaulted;arcaded     [[qanoTariy~/ADJ]]

    noun     KaRDaS |< Iy              {- qanoTariy~ -}     `gloss`  [ "arched", "vaulted", "arcaded [ [ qanoTariy ~ / ADJ ] ]" ],

    -- ;; muqanoTar_1
    -- mqnTr   muqanoTar       N-ap    arched;vaulted;arcaded

    noun     MuKaRDaS                  {- muqanoTar -}      `gloss`  [ "arched", "vaulted", "arcaded" ],
    ...
    noun     KiRDAS |< Iy              {- qinoTAriy~ -}     `gloss`  [ "multi-millionaire" ] ]
 ...
 |> "q n ^g" <| [
    ...
    noun     FaCL |< aT                {- qanojap -}        -- `others` [ "qana^g NAt", "qinA^g N" ]
 ...
 |> "q n `" <| [
    ...
    verb     HaFCaL                    {- OaqonaE -}        -- `others` [ "qni` IV_yu", "qna` IV_Pass_yu" ]
    ...
    noun     FaCAL |< aT               {- qanAEap -}        `gloss`  [ "satisfaction", "moderation" ],
    ...
    noun     HaFCiL |< aT              {- OaqoniEap -}      -- `others` [ "qinA` NAt" ]
                                                            `gloss`  [ "veils", "masks" ],

    -- ;; qanuwE_1
    -- qnwE    qanuwE  N-ap    satisfied;modest     [[qanuwE/ADJ]]

    noun     FaCUL                     {- qanuwE -}         `gloss`  [ "satisfied", "modest [ [ qanuwE / ADJ ] ]" ],
    ...
    noun     HiFCAL                    {- IiqonAE -}        `gloss`  [ "persuasion", "convincing" ],

    -- ;; <iqonAE_2
    -- <qnAE   <iqonAE N/At    belief;conviction
    -- AqnAE   <iqonAE N/At    belief;conviction

    noun     HiFCAL                    {- IiqonAE -}        `gloss`  [ "belief", "conviction" ],
    ...
    noun     FACiL                     {- qAniE -}          `gloss`  [ "satisfied", "content [ [ qAniE / ADJ ] ]" ],
 ...
 |> "q n ` n" <| [
    ...
    noun     KuRDAS                    {- qunoEAn -}        `gloss`  [ "satisfaction", "contentment" ],

    -- ;; qunoEAn_2
    -- qnEAn   qunoEAn N       belief;conviction

    noun     KuRDAS                    {- qunoEAn -}        `gloss`  [ "belief", "conviction" ] ]
 ...
 |> "q n b l" <| [
    ...
    verb     KaRDaS                    {- qanobal -}        -- `others` [ "qanbil IV_yu" ]
                                                            `gloss`  [ "bombard" ],

    -- ;; qanobal_2
    -- qnbl    qanobal Ndu     troop of horsemen

    noun     KaRDaS                    {- qanobal -}        `gloss`  [ "troop of horsemen" ],

    -- ;; qanobalap_1
    -- qnbl    qanobal Nap     bombarding;bombardment

    noun     KaRDaS |< aT              {- qanobalap -}      `gloss`  [ "bombarding", "bombardment" ],

    -- ;; qunobulap_1
    -- qnbl    qunobul Napdu   bomb;shell;grenade
    -- qnAbl   qanAbil Ndip    bombs;shells;grenades

    noun     KuRDuS |< aT              {- qunobulap -}      -- `others` [ "qanAbil Ndip" ]
 ...
 |> "q n b r" <| [
    ...
    noun     KuRDAS                    {- qunobAr -}        `gloss`  [ "bast rug", "bast runner" ],
    ...
    noun     KuRDuS                    {- qunobur -}        -- `others` [ "qanAbir Ndip" ]
                                                            `gloss`  [ "lark", "larks" ],

    -- ;; qunobuwr_1
    -- qnbwr   qunobuwr        Ndu     hump;hunch

    noun     KuRDUS                    {- qunobuwr -}       `gloss`  [ "hump", "hunch" ] ]
 ...
 |> "q n d" <| [
    ...
    noun     MaFCUL                    {- maqonuwd -}       `gloss`  [ "sweetened [ [ maqonuwd / ADJ ] ]" ],

    -- ;; muqan~ad_1
    -- mqnd    muqan~ad        N-ap    sweetened     [[muqan~ad/ADJ]]

    noun     MuFaCCaL                  {- muqan~ad -}       `gloss`  [ "sweetened [ [ muqan ~ ad / ADJ ] ]" ] ]
 ...
 |> "q n d l" <| [
    ...
    noun     KaRDUS                    {- qanoduwl -}       `gloss`  [ "aspalathus" ],

    -- ;; qinodiyl_1
    -- qndyl   qinodiyl        Ndu     lamp
    -- qnAdyl  qanAdiyl        Ndip    lamps

    noun     KiRDIS                    {- qinodiyl -}       -- `others` [ "qanAdiyl Ndip" ]
                                                            `gloss`  [ "lamp", "lamps" ],
 ...
 |> "q n d q" <| [
    ...
    noun     KaRDaS                    {- qanodaq -}        -- `others` [ "qanAdiq Ndip" ]
 ...
 |> "q n d s" <| [
    ...
    noun     KuRDuS                    {- qunodus -}        `gloss`  [ "beaver" ] ]
 ...
 |> "q n d z" <| [
    ...
    noun     KuRDuS                    {- qunoduz -}        `gloss`  [ "beaver" ],

    -- ;; qunoduwz_1
    -- qndwz   qunoduwz        N0      Kunduz;Qunduz

    noun     KuRDUS                    {- qunoduwz -}       `gloss`  [ "Kunduz", "Qunduz" ],

    -- ;; qunoduwziy~_1
    -- qndwzy  qunoduwziy~     Nall    of/from Kunduz;Qunduz

    noun     KuRDUS |< Iy              {- qunoduwziy~ -}    `gloss`  [ "of / from Kunduz", "Qunduz" ] ]
 ...
 |> "q n f _d" <| [
    ...
    noun     KuRDuS                    {- qunofu* -}        -- `others` [ "qanAfi_d Ndip" ]
 ...
 |> "q n m" <| [
    ...
    noun     FaCCUL |< aT              {- qan~uwmap -}      `gloss`  [ "qannuma ( sacred fish in ancient Egypt )" ] ]
 ...
 |> "q n n" <| [
    ...
    noun     FuCL |< aT                {- qun~ap -}         -- `others` [ "qinAn N", "qunuwn N", "qunan N" ]
                                                            `gloss`  [ "summit", "peak", "summits", "peaks" ],

    -- ;; qunuwnap_1
    -- qnwn    qunuwn  Nap     slavery;serfdom

    noun     FuCUL |< aT               {- qunuwnap -}       `gloss`  [ "slavery", "serfdom" ],
    ...
    noun     FiCCIL |< aT              {- qin~iynap -}      -- `others` [ "qanAniy N0_Nh", "qanAn NK" ]
    ...
    noun     FACUL                     {- qAnuwn -}         -- `others` [ "qawAniyn Ndip" ]
                                                            `gloss`  [ "law", "statutes", "regulations", "laws", "rules" ],

    -- ;; qAnuwniy~_1
    -- qAnwny  qAnuwniy~       Nall    legal;law-related;statutory     [[qAnuwniy~/ADJ]]

    noun     FACUL |< Iy               {- qAnuwniy~ -}      `gloss`  [ "legal", "law-related", "statutory [ [ qAnuwniy ~ / ADJ ] ]" ],

    -- ;; qAnuwniy~_2
    -- qAnwny  qAnuwniy~       N-ap    legitimate;licit;allowed;legal     [[qAnuwniy~/ADJ]]

    noun     FACUL |< Iy               {- qAnuwniy~ -}      `gloss`  [ "legitimate", "licit", "allowed", "legal [ [ qAnuwniy ~ / ADJ ] ]" ],

    -- ;; qAnuwniy~ap_1
    -- qAnwny  qAnuwniy~       Nap     legality;lawfulness     [[qAnuwniy~/NOUN]]

    noun     FACUL |< Iy |< aT         {- qAnuwniy~ap -}    `gloss`  [ "legality", "lawfulness [ [ qAnuwniy ~ / NOUN ] ]" ],
    ...
    noun     MuFaCCiL                  {- muqan~in -}       `gloss`  [ "legislative [ [ muqan ~ in / ADJ ] ]" ],

    -- ;; muqan~an_1
    -- mqnn    muqan~an        N-ap    standard;rationed     [[muqan~an/ADJ]]

    noun     MuFaCCaL                  {- muqan~an -}       `gloss`  [ "standard", "rationed [ [ muqan ~ an / ADJ ] ]" ],

    -- ;; quwniyap_1
    -- qwny    quwniy  Nap     Konya

    noun     FUCiy |< aT               {- quwniyap -}       `gloss`  [ "Konya" ] ]
 ...
 |> "q n q r" <| [
    ...
    noun     KaRDaS                    {- qanoqar -}        `gloss`  [ "kangaroo" ] ]
 ...
 |> "q n w" <| [
    ...
    verb     FaCA                      {- qanA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "qanaw PV_Atn", "qan PV_ttAw", "qnY IV_0_Pass_yu", "qnuw IV_0hAnn", "qn IV_0hwnyn", "qnay IV_Ann_Pass_yu" ]
    ...
    verb     FaCY                      {- qanaY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ "qanay PV_Atn", "qan PV_ttAw", "qniy IV_0hAnn", "qnY IV_0_Pass_yu", "qn IV_0hwnyn", "qanA PV_h" ]
    ...
    noun     FuCL |< aT                {- qunowap -}        `gloss`  [ "acquisition", "possessions", "property" ],
    ...
    noun     FaCY |< aT                {- qanAp -}          -- `others` [ "qanaw NAt", "'aqniy Nap" ]
                                                            `gloss`  [ "canal", "channel", "canals", "channels" ],

    -- ;; qanAp_2
    -- qnAp    qanAp   Nprop   Qanat

    noun     FaCY |< aT                {- qanAp -}          `gloss`  [ "Qanat" ],
    ...
    noun     HaFCY                     {- OaqonaY -}        -- `others` [ "'aqnay NAn_Nayn", "'aqnA Nhy" ]
    ...
    noun     MuFtaCY                   {- muqotanaY -}      -- `others` [ "muqtanay NAt NAn_Nayn", "muqtanA Nhy" ]
    ...
    noun     MuFtaCY                   {- muqotanaY -}      -- `others` [ "muqtanay NAt NAn_Nayn", "muqtanA Nhy" ]
                                                            `gloss`  [ "acquired [ [ muqotanaY / ADJ ] ]", "acquired" ] ]
 ...
 |> "q n y" <| [
    ...
    noun     FuCL |< aT                {- qunoyap -}        `gloss`  [ "acquisition", "possessions", "property" ],

    -- ;; qanAyap_1
    -- qnAy    qanAy   NapAt   stream;rivulet

    noun     FaCAL |< aT               {- qanAyap -}        `gloss`  [ "stream", "rivulet" ],

    -- ;; qunay~ap_1
    -- qny     qunay~  Nap     cannula

    noun     FuCayL |< aT              {- qunay~ap -}       `gloss`  [ "cannula" ],
 ...
 |> "q n z `" <| [
    ...
    noun     KuRDuS |< aT              {- qunozuEap -}      -- `others` [ "qinzi` Napdu", "qanza` Napdu", "qanAzi` Ndip" ]
 ...
 |> "q q .t" <| [
    ...
    noun     CaL                       {- qaT -}            -- `others` [ "qa.tA N0_Nhy", "qa.taN FW-WaBi" ]
                                                            `gloss`  [ "sand grouse [ [ qaTAF / NOUN ] ]", "sand grouse" ] ]
 ...
 |> "q q f" <| [
    ...
    noun     CaL |< aN                 {- qafAF -}          -- `others` [ "qifiyy N", "'aqf NK", "qufiyy N", "'aqfiy Nap N0_Nh", "qafA N0_Nhy", "'aqfA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "neck", "nape", "back", "reverse [ [ qafAF / NOUN ] ]", "reverse", "necks", "napes", "backs" ] ]
 ...
 |> "q r '" <| [
    ...
    verb     FaCaL                     {- qaraO-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "qara'A PV-|", "qra'A IV-|", "qra' IV IV_wn IV_Pass_yu IV_yn" ]
                                                            `gloss`  [ "read", "be read" ],
    ...
    verb     HaFCaL                    {- OaqoraO -}        -- `others` [ "'aqra'A PV-|", "qri' IV_yu" ]
                                                            `gloss`  [ "make read" ],
    ...
    verb     IstaFCaL                  {- {isotaqoraO -}    -- `others` [ "istaqra'A PV-|", "staqri' IV" ]
    ...
    noun     FiCAL |< aT               {- qirA'ap -}        `gloss`  [ "reading" ],
    ...
    noun     MiFCaL                    {- miqoraO -}        -- `others` [ "miqra'A N-|", "maqAri' Ndip" ]
                                                            `gloss`  [ "lectern", "rostrum", "lecterns", "rostrums" ],

    -- ;; maqora>ap_1
    -- mqr>    maqora> Napdu   reading head

    noun     MaFCaL |< aT              {- maqoraOap -}      `gloss`  [ "reading head" ],
    ...
    noun     HiFCAL                    {- IiqorA' -}        `gloss`  [ "making read" ],
    ...
    noun     MaFCUL                    {- maqoruw' -}       `gloss`  [ "readable", "read [ [ maqoruw ' / ADJ ] ]", "read" ],

    -- ;; maqoruw}iy~ap_1
    -- mqrw}y  maqoruw}iy~     Nap     legibility     [[maqoruw}iy~/NOUN]]

    noun     MaFCUL |< Iy |< aT        {- maqoruw}iy~ap -}  `gloss`  [ "legibility [ [ maqoruw } iy ~ / NOUN ] ]" ],
 ...
 |> "q r ' n" <| [
    ...
    noun     KuRDAS |< Iy              {- quro|niy~ -}      `gloss`  [ "Quranic [ [ quro | niy ~ / ADJ ] ]" ] ]
 ...
 |> "q r .d" <| [
    ...
    verb     HaFCaL                    {- OaqoraD -}        -- `others` [ "qra.d IV_Pass_yu", "qri.d IV_yu" ]
                                                            `gloss`  [ "lend", "be lent" ],
    ...
    noun     HiFCAL                    {- IiqorAD -}        `gloss`  [ "lending", "loan" ],
    ...
    noun     FuCAL |< aT               {- qurADap -}        `gloss`  [ "chips", "scraps" ],

    -- ;; qar~ADap_1
    -- qrAD    qar~AD  Napdu   clothes moth
    -- qrAD    qar~AD  N       clothes moths

    noun     FaCCAL |< aT              {- qar~ADap -}       -- `others` [ "qarrA.d N" ]
    ...
    noun     FACiL                     {- qAriD -}          `gloss`  [ "corrosive [ [ qAriD / ADJ ] ]" ],
    ...
    noun     MaFCUL                    {- maqoruwD -}       `gloss`  [ "corroded [ [ maqoruwD / ADJ ] ]" ],
 ...
 |> "q r .h" <| [
    ...
    noun     FaCiL                     {- qariH -}          `gloss`  [ "ulcerous [ [ qariH / ADJ ] ]" ],

    -- ;; qaroHap_1
    -- qrH     qaroH   Napdu   ulcer;abscess
    -- qrH     qiraH   N       ulcers;abscesses

    noun     FaCL |< aT                {- qaroHap -}        -- `others` [ "qira.h N" ]
    ...
    noun     FaCIL |< aT               {- qariyHap -}       -- `others` [ "qarA'i.h Ndip" ]
    ...
    noun     MuFaCCaL                  {- muqar~aH -}       `gloss`  [ "ulcerous", "festering [ [ muqar ~ aH / ADJ ] ]" ],

    -- ;; mutaqar~iH_1
    -- mtqrH   mutaqar~iH      N-ap    ulcerous;festering     [[mutaqar~iH/ADJ]]

    noun     MutaFaCCiL                {- mutaqar~iH -}     `gloss`  [ "ulcerous", "festering [ [ mutaqar ~ iH / ADJ ] ]" ],
    ...
    noun     MuFtaCaL                  {- muqotaraH -}      `gloss`  [ "proposed", "suggested [ [ muqotaraH / ADJ ] ]" ],
 ...
 |> "q r .s" <| [
    ...
    noun     FaCL |< aT                {- qaroSap -}        -- `others` [ "qara.s NAt" ]
    ...
    noun     FuCL |< Iy                {- quroSiy~ -}       `gloss`  [ "disk-shaped [ [ quroSiy ~ / ADJ ] ]" ],

    -- ;; quroSap_1
    -- qrS     quroS   Napdu   round loaf
    -- qrS     quraS   N       round loaves

    noun     FuCL |< aT                {- quroSap -}        -- `others` [ "qura.s N" ]
                                                            `gloss`  [ "round loaf", "round loaves" ],

    -- ;; qar~ASap_1
    -- qrAS    qar~AS  Napdu   pincers;nippers

    noun     FaCCAL |< aT              {- qar~ASap -}       `gloss`  [ "pincers", "nippers" ],

    -- ;; qAriS_1
    -- qArS    qAriS   N-ap    painful;biting;stinging     [[qAriS/ADJ]]

    noun     FACiL                     {- qAriS -}          `gloss`  [ "painful", "biting", "stinging [ [ qAriS / ADJ ] ]" ],

    -- ;; qAriSap_1
    -- qArS    qAriS   Nap     biting remark
    -- qwArS   qawAriS Ndip    biting remarks

    noun     FACiL |< aT               {- qAriSap -}        -- `others` [ "qawAri.s Ndip" ]
 ...
 |> "q r .s n" <| [
    ...
    noun     KaRDaS |< aT              {- qaroSanap -}      `gloss`  [ "piracy" ],
    ...
    noun     KuRDAS                    {- quroSAn -}        -- `others` [ "qarA.siyn Ndip", "qarA.sin Nap Ndip" ]
 ...
 |> "q r .t" <| [
    ...
    noun     TaFCIL |< aT              {- taqoriyTap -}     `gloss`  [ "scarf", "madras" ],
 ...
 |> "q r .t ^g" <| [
    ...
    noun     KaRDAS |< Iy              {- qaroTAjiy~ -}     `gloss`  [ "Carthaginian [ [ qaroTAjiy ~ / NOUN ] ]", "Carthaginian [ [ qaroTAjiy ~ / ADJ ] ]" ] ]
 ...
 |> "q r .t b" <| [
    ...
    noun     KuRDuS |< aT              {- quroTubap -}      `gloss`  [ "Cordoba" ],

    -- ;; quroTubiy~_1
    -- qrTby   quroTubiy~      Nall    Cordovan     [[quroTubiy~/NOUN]]
    -- qrTby   quroTubiy~      Nall    Cordovan     [[quroTubiy~/ADJ]]

    noun     KuRDuS |< Iy              {- quroTubiy~ -}     `gloss`  [ "Cordovan [ [ quroTubiy ~ / NOUN ] ]", "Cordovan [ [ quroTubiy ~ / ADJ ] ]" ],

    -- ;; quroTubiy~_2
    -- qrTby   quroTubiy~      N0      Qurtubi

    noun     KuRDuS |< Iy              {- quroTubiy~ -}     `gloss`  [ "Qurtubi" ] ]
 ...
 |> "q r .t l" <| [
    ...
    noun     KaRDaS                    {- qaroTal -}        -- `others` [ "qarA.til Ndip" ]
                                                            `gloss`  [ "basket", "baskets" ] ]
 ...
 |> "q r .t m" <| [
    ...
    verb     KaRDaS                    {- qaroTam -}        -- `others` [ "qar.tim IV_yu" ]
                                                            `gloss`  [ "cut off", "clip" ],
    ...
    noun     KiRDiS                    {- qiroTim -}        -- `others` [ "qur.tum N" ]
                                                            `gloss`  [ "safflower" ] ]
 ...
 |> "q r .t s" <| [
    ...
    verb     KaRDaS                    {- qaroTas -}        -- `others` [ "qar.tis IV_yu" ]
                                                            `gloss`  [ "wrap", "package" ],
    ...
    noun     KiRDAS                    {- qiroTAs -}        -- `others` [ "qarA.tiys Ndip", "qur.tAs Ndu" ]
                                                            `gloss`  [ "paper", "sheet of paper", "sheets of paper" ],

    -- ;; quroTAsiy~_1
    -- qrTAsy  quroTAsiy~      N-ap    office;desk     [[quroTAsiy~/ADJ]]

    noun     KuRDAS |< Iy              {- quroTAsiy~ -}     `gloss`  [ "office", "desk [ [ quroTAsiy ~ / ADJ ] ]" ],

    -- ;; qaroTas_2
    -- qrTs    qaroTas Ndu     paper;sheet of paper

    noun     KaRDaS                    {- qaroTas -}        `gloss`  [ "paper", "sheet of paper" ] ]
 ...
 |> "q r .z" <| [
    ...
    noun     TaFCIL |< Iy              {- taqoriyZiy~ -}    `gloss`  [ "laudatory [ [ taqoriyZiy ~ / ADJ ] ]" ],
 ...
 |> "q r ^s" <| [
    ...
    noun     FuCayL |< Iy              {- qurayo$iy~ -}     `gloss`  [ "of Quraish [ [ qurayo $ iy ~ / NOUN ] ]", "of Quraish [ [ qurayo $ iy ~ / ADJ ] ]" ],
    ...
    noun     FuCaL |< Iy               {- qura$iy~ -}       `gloss`  [ "of Quraish [ [ qura $ iy ~ / NOUN ] ]", "of Quraish [ [ qura $ iy ~ / ADJ ] ]" ],

    -- ;; qura$iy~_2
    -- qr$y    qura$iy~        N0      Qurashi

    noun     FuCaL |< Iy               {- qura$iy~ -}       `gloss`  [ "Qurashi" ],

    -- ;; muqori$_1
    -- mqr$    muqori$ Nall    wealthy     [[muqori$/ADJ]]

    noun     MuFCiL                    {- muqori$ -}        `gloss`  [ "wealthy [ [ muqori $ / ADJ ] ]" ] ]
 ...
 |> "q r `" <| [
    ...
    noun     FaCL |< aT                {- qaroEap -}        -- `others` [ "qarA`iy N0_Nh" ]
                                                            `gloss`  [ "gourd", "bottle", "flask", "gourds", "bottles", "flasks" ],

    -- ;; qaroEiy~_1
    -- qrEy    qaroEiy~        N-ap    gourd-like     [[qaroEiy~/ADJ]]

    noun     FaCL |< Iy                {- qaroEiy~ -}       `gloss`  [ "gourd-like [ [ qaroEiy ~ / ADJ ] ]" ],
    ...
    noun     FaCL |< aT                {- qaroEap -}        `gloss`  [ "knock", "strike", "ringing" ],

    -- ;; quroEap_1
    -- qrE     quroE   Nap     ballot
    -- qrE     quraE   N       ballots

    noun     FuCL |< aT                {- quroEap -}        -- `others` [ "qura` N" ]
                                                            `gloss`  [ "ballot", "ballots" ],

    -- ;; quroEap_2
    -- qrE     quroE   Nap     enlistment;draft

    noun     FuCL |< aT                {- quroEap -}        `gloss`  [ "enlistment", "draft" ],
    ...
    noun     FaCIL |< aT               {- qariyEap -}       -- `others` [ "qarA'i` Ndip" ]
                                                            `gloss`  [ "elite", "cream" ],
    ...
    noun     HaFCaL                    {- OaqoraE -}        -- `others` [ "qar`A' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "bald", "bare" ],
    ...
    noun     MiFCaL |< aT              {- miqoraEap -}      -- `others` [ "maqAri` Ndip" ]
    ...
    noun     MuFACaL |< aT             {- muqAraEap -}      `gloss`  [ "fight", "struggle against" ],
    ...
    noun     IFtiCAL |< Iy             {- {iqotirAEiy~ -}   `gloss`  [ "balloting", "voting", "election [ [ { iqotirAEiy ~ / ADJ ] ]" ],
    ...
    noun     FACiL |< aT               {- qAriEap -}        -- `others` [ "qawAri` Ndip" ]
 ...
 |> "q r b" <| [
    ...
    noun     FiCL |< aT                {- qirobap -}        -- `others` [ "qirab N" ]
    ...
    noun     FuCL |< aT                {- qurobap -}        `gloss`  [ "pious deed" ],
    ...
    noun     FaCIL |< aN               {- qariybAF -}       -- `others` [ "qariyb NF" ]
                                                            `gloss`  [ "recently", "soon [ [ qariyb / ADV ] ]" ],

    -- ;; qariybAF_2
    -- qryb    qariyb  NF      closely;near     [[qariyb/ADV]]

    noun     FaCIL |< aN               {- qariybAF -}       -- `others` [ "qariyb NF" ]
                                                            `gloss`  [ "closely", "near [ [ qariyb / ADV ] ]" ],
    ...
    noun     FaCAL |< aT               {- qarAbap -}        `gloss`  [ "affinity", "kinship", "relationship" ],

    -- ;; qurAbap_1
    -- qrAb    qurAb   Nap     almost;nearly

    noun     FuCAL |< aT               {- qurAbap -}        `gloss`  [ "almost", "nearly" ],
    ...
    noun     TaFCIL |< aN              {- taqoriybAF -}     -- `others` [ "taqriyb NF" ]
                                                            `gloss`  [ "approximately [ [ taqoriyb / ADV ] ]" ],

    -- ;; taqoriybiy~_1
    -- tqryby  taqoriybiy~     N-ap    approximate     [[taqoriybiy~/ADJ]]

    noun     TaFCIL |< Iy              {- taqoriybiy~ -}    `gloss`  [ "approximate [ [ taqoriybiy ~ / ADJ ] ]" ],

    -- ;; muqArabap_1
    -- mqArb   muqArab NapAt   approximation;juxtaposition

    noun     MuFACaL |< aT             {- muqArabap -}      `gloss`  [ "approximation", "juxtaposition" ],

    -- ;; muqArabap_2
    -- mqArb   muqArab NapAt   rapprochement

    noun     MuFACaL |< aT             {- muqArabap -}      `gloss`  [ "rapprochement" ],
    ...
    noun     MuFaCCaL                  {- muqar~ab -}       `gloss`  [ "close companion", "protege", "intimate" ],

    -- ;; muqArib_1
    -- mqArb   muqArib Nall    approximating     [[muqArib/ADJ]]

    noun     MuFACiL                   {- muqArib -}        `gloss`  [ "approximating [ [ muqArib / ADJ ] ]" ],
    ...
    noun     MuFtaCiL                  {- muqotarib -}      `gloss`  [ "approaching", "drawing near", "dense [ [ muqotarib / ADJ ] ]" ],
    ...
    noun     FawACiL |< Iy             {- qawAribiy~ -}     `gloss`  [ "boatman [ [ qawAribiy ~ / ADJ ] ]" ],
 ...
 |> "q r b n" <| [
    ...
    noun     KuRDAS                    {- qurobAn -}        -- `others` [ "qarAbiyn Ndip" ]
                                                            `gloss`  [ "Mass", "Communion" ],

    -- ;; qurobAnap_1
    -- qrbAn   qurobAn Nap     Host;Communion

    noun     KuRDAS |< aT              {- qurobAnap -}      `gloss`  [ "Host", "Communion" ],

    -- ;; qurobAniy~_1
    -- qrbAny  qurobAniy~      N-ap    sacrificial;eucharistic;sacramental     [[qurobAniy~/ADJ]]

    noun     KuRDAS |< Iy              {- qurobAniy~ -}     `gloss`  [ "sacrificial", "eucharistic", "sacramental [ [ qurobAniy ~ / ADJ ] ]" ] ]
 ...
 |> "q r d" <| [
    ...
    noun     FiCL |< Iy                {- qirodiy~ -}       `gloss`  [ "simian", "monkey [ [ qirodiy ~ / ADJ ] ]" ],
    ...
    noun     MaFCUL                    {- maqoruwd -}       `gloss`  [ "exhausted [ [ maqoruwd / ADJ ] ]" ] ]
 ...
 |> "q r d .h" <| [
    ...
    noun     KuRDuS                    {- quroduH -}        -- `others` [ "qarAdi.h Ndip" ]
    ...
    noun     KuRDUS                    {- quroduwH -}       -- `others` [ "qarAdiy.h Ndip" ]
                                                            `gloss`  [ "baboon", "baboons" ] ]
 ...
 |> "q r d b" <| [
    ...
    noun     KaRDaS                    {- qarodab -}        `gloss`  [ "bistort" ] ]
 ...
 |> "q r f" <| [
    ...
    noun     FiCL |< aT                {- qirofap -}        `gloss`  [ "cinnamon" ],

    -- ;; qirofap_2
    -- qrf     qirof   Nap     skin;rind
    -- qrf     qiraf   N       skins;rinds

    noun     FiCL |< aT                {- qirofap -}        -- `others` [ "qiraf N" ]
    ...
    noun     FaCAL |< aT               {- qarAfap -}        `gloss`  [ "Qarafa" ],

    -- ;; qariyfap_1
    -- qryf    qariyf  Nap     ill humor

    noun     FaCIL |< aT               {- qariyfap -}       `gloss`  [ "ill humor" ],

    -- ;; qarofAn_1
    -- qrfAn   qarofAn N       disgusted     [[qarofAn/ADJ]]

    noun     FaCLAn                    {- qarofAn -}        `gloss`  [ "disgusted [ [ qarofAn / ADJ ] ]" ],
    ...
    noun     HiFCAL                    {- IiqorAf -}        `gloss`  [ "disgusting" ],
    ...
    noun     MuFCiL                    {- muqorif -}        `gloss`  [ "loathsome", "disgusting [ [ muqorif / ADJ ] ]" ],
 ...
 |> "q r f .s" <| [
    ...
    verb     KaRDaS                    {- qarofaS -}        -- `others` [ "qarfi.s IV_yu" ]
                                                            `gloss`  [ "squat" ],

    -- ;; qarofaSap_1
    -- qrfS    qarofaS Nap     squatting

    noun     KaRDaS |< aT              {- qarofaSap -}      `gloss`  [ "squatting" ] ]
 ...
 |> "q r f l" <| [
    ...
    noun     KaRDAS                    {- qarofAl -}        `gloss`  [ "vetch" ],

    -- ;; qarofAlap_1
    -- qrfAl   qarofAl Napdu   vetch

    noun     KaRDAS |< aT              {- qarofAlap -}      `gloss`  [ "vetch" ] ]
 ...
 |> "q r m" <| [
    ...
    noun     FuCL |< aT                {- quromap -}        -- `others` [ "quram N" ]
 ...
 |> "q r m .t" <| [
    ...
    noun     KaRDaS |< Iy              {- qaromaTiy~ -}     -- `others` [ "qarAmi.t Nap" ]
                                                            `gloss`  [ "Karmathian [ [ qaromaTiy ~ / NOUN ] ]", "Karmathian [ [ qaromaTiy ~ / ADJ ] ]", "Karmathians" ],

    -- ;; qaromuwT_1
    -- qrmwT   qaromuwT        N       sheatfish
    -- qrAmyT  qarAmiyT        Ndip    sheatfish

    noun     KaRDUS                    {- qaromuwT -}       -- `others` [ "qarAmiy.t Ndip" ]
                                                            `gloss`  [ "sheatfish" ] ]
 ...
 |> "q r m ^s" <| [
    ...
    verb     KaRDaS                    {- qaroma$ -}        -- `others` [ "qarmi^s IV_yu" ]
                                                            `gloss`  [ "nibble", "crunch" ],

    -- ;; qaroma$ap_1
    -- qrm$    qaroma$ Nap     nibbling;crunching

    noun     KaRDaS |< aT              {- qaroma$ap -}      `gloss`  [ "nibbling", "crunching" ],

    -- ;; muqaroma$_1
    -- mqrm$   muqaroma$       N-ap    crisp;dry

    noun     MuKaRDaS                  {- muqaroma$ -}      `gloss`  [ "crisp", "dry" ] ]
 ...
 |> "q r m d" <| [
    ...
    verb     KaRDaS                    {- qaromad -}        -- `others` [ "qarmid IV_yu" ]
                                                            `gloss`  [ "plaster", "tile" ],

    -- ;; qaromadap_1
    -- qrmd    qaromad Nap     plastering;tiling

    noun     KaRDaS |< aT              {- qaromadap -}      `gloss`  [ "plastering", "tiling" ],

    -- ;; qaromad_2
    -- qrmd    qaromad N       plaster;plaster of Paris

    noun     KaRDaS                    {- qaromad -}        `gloss`  [ "plaster", "plaster of Paris" ],

    -- ;; qiromiyd_1
    -- qrmyd   qiromiyd        N       plaster of Paris

    noun     KiRDIS                    {- qiromiyd -}       `gloss`  [ "plaster of Paris" ],
    ...
    noun     KiRDIS                    {- qiromiyd -}       -- `others` [ "qarAmiyd Ndip" ]
    ...
    noun     KaRDUS                    {- qaromuwd -}       `gloss`  [ "bricks", "roof tiles", "brick", "roof tile" ],

    -- ;; muqaromad_1
    -- mqrmd   muqaromad       N-ap    covered with tiles;coated     [[muqaromad/ADJ]]

    noun     MuKaRDaS                  {- muqaromad -}      `gloss`  [ "covered with tiles", "coated [ [ muqaromad / ADJ ] ]" ] ]
 ...
 |> "q r m z" <| [
    ...
    noun     KiRDiS                    {- qiromiz -}        `gloss`  [ "kermes", "carmine" ],

    -- ;; qiromiziy~_1
    -- qrmzy   qiromiziy~      N-ap    crimson;scarlet     [[qiromiziy~/ADJ]]

    noun     KiRDiS |< Iy              {- qiromiziy~ -}     `gloss`  [ "crimson", "scarlet [ [ qiromiziy ~ / ADJ ] ]" ] ]
 ...
 |> "q r n" <| [
    ...
    verb     HaFCaL                    {- Oaqoran -}        -- `others` [ "qrin IV-n_yu", "qran IV-n_Pass_yu" ]
    ...
    noun     FaCL |< Iy                {- qaroniy~ -}       `gloss`  [ "horn-like", "corneous [ [ qaroniy ~ / ADJ ] ]" ],

    -- ;; qaroniy~_2
    -- qrny    qaroniy~        N-ap    centenary     [[qaroniy~/ADJ]]

    noun     FaCL |< Iy                {- qaroniy~ -}       `gloss`  [ "centenary [ [ qaroniy ~ / ADJ ] ]" ],

    -- ;; qaroniy~ap_1
    -- qrny    qaroniy~        Nap     cornea     [[qaroniy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- qaroniy~ap -}     `gloss`  [ "cornea [ [ qaroniy ~ / NOUN ] ]" ],

    -- ;; qaroniy~At_1
    -- qrny    qaroniy~        NAt     legumes     [[qaroniy~/NOUN]]

    noun     FaCL |< Iy |< At          {- qaroniy~At -}     -- `others` [ "qarniyy NAt" ]
                                                            `gloss`  [ "legumes [ [ qaroniy ~ / NOUN ] ]" ],
    ...
    noun     HaFCAL |< Iy              {- OaqorAniy~ -}     `gloss`  [ "similar", "alike [ [ >aqorAniy ~ / ADJ ] ]" ],

    -- ;; quronap_1
    -- qrn     quron   Napdu   corner
    -- qrn     quran   N       corners

    noun     FuCL |< aT                {- quronap -}        -- `others` [ "quran N" ]
    ...
    noun     FaCIL |< aT               {- qariynap -}       `gloss`  [ "wife" ],

    -- ;; qariynap_2
    -- qryn    qariyn  Nap     linkage
    -- qrA}n   qarA}in Ndip    linkage;connections

    noun     FaCIL |< aT               {- qariynap -}       -- `others` [ "qarA'in Ndip" ]
    ...
    noun     HaFCaL                    {- Oaqoran -}        -- `others` [ "qarnA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "horned" ],
    ...
    noun     MuFACaL |< aT             {- muqAranap -}      `gloss`  [ "comparison" ],
    ...
    noun     FACiL |< aT               {- qArinap -}        `gloss`  [ "couple", "link" ],
    ...
    noun     MuFaCCaL                  {- muqar~an -}       `gloss`  [ "pointed", "tapered [ [ muqar ~ an / ADJ ] ]" ],
    ...
    noun     MuFACiL |< aN             {- muqArinAF -}      -- `others` [ "muqArin NF" ]
                                                            `gloss`  [ "in comparison with [ [ muqArin / ADV ] ]" ],
    ...
    noun     MuFtaCiL                  {- muqotarin -}      `gloss`  [ "concomitant", "adjacent [ [ muqotarin / ADJ ] ]" ],

    -- ;; qAruwn_1
    -- qArwn   qAruwn  Ndip    nabob;Croesus

    noun     FACUL                     {- qAruwn -}         `gloss`  [ "nabob", "Croesus" ] ]
 ...
 |> "q r q .d" <| [
    ...
    verb     KaRDaS                    {- qaroqaD -}        -- `others` [ "qarqi.d IV_yu" ]
                                                            `gloss`  [ "gnaw", "gnash" ],

    -- ;; qaroqaDap_1
    -- qrqD    qaroqaD NapAt   gnawing;gnashing

    noun     KaRDaS |< aT              {- qaroqaDap -}      `gloss`  [ "gnawing", "gnashing" ] ]
 ...
 |> "q r q `" <| [
    ...
    verb     KaRDaS                    {- qaroqaE -}        -- `others` [ "qarqi` IV_yu" ]
                                                            `gloss`  [ "creak", "rumble", "crackle" ],

    -- ;; qaroqaEap_1
    -- qrqE    qaroqaE Nap     creaking;rumbling;crackling

    noun     KaRDaS |< aT              {- qaroqaEap -}      `gloss`  [ "creaking", "rumbling", "crackling" ] ]
 ...
 |> "q r q f" <| [
    ...
    verb     KaRDaS                    {- qaroqaf -}        -- `others` [ "qarqif IV_yu" ]
                                                            `gloss`  [ "shiver" ],

    -- ;; qaroqafap_1
    -- qrqf    qaroqaf Nap     shivering

    noun     KaRDaS |< aT              {- qaroqafap -}      `gloss`  [ "shivering" ],

    -- ;; quroquf_1
    -- qrqf    quroquf N       titmouse

    noun     KuRDuS                    {- quroquf -}        `gloss`  [ "titmouse" ] ]
 ...
 |> "q r q r" <| [
    ...
    noun     KaRDUS                    {- qaroquwr -}       -- `others` [ "qarAqiyr Ndip" ]
 ...
 |> "q r q s" <| [
    ...
    noun     KiRDiS                    {- qiroqis -}        `gloss`  [ "midge" ] ]
 ...
 |> "q r q w" <| [
    ...
    noun     KaRDAS |< Iy              {- qaroqAwiy~ -}     `gloss`  [ "Qarqawi" ] ]
 ...
 |> "q r r" <| [
    ...
    verb     HaFaCL                    {- Oaqar~ -}         -- `others` [ "'aqrar PV_C", "qirr IV_V_yu", "qrir IV_C_yu", "qarr IV_V_Pass_yu" ]
    ...
    noun     FiCL |< aT                {- qir~ap -}         `gloss`  [ "cold" ],

    -- ;; qur~ap_1
    -- qr      qur~    Nap     pleasure

    noun     FuCL |< aT                {- qur~ap -}         `gloss`  [ "pleasure" ],
    ...
    noun     FaCAL |< aT               {- qarArap -}        `gloss`  [ "bottom", "depth" ],
    ...
    noun     FACUL |< aT               {- qAruwrap -}       -- `others` [ "qawAriyr Ndip" ]
    ...
    noun     TaFCIL |< Iy              {- taqoriyriy~ -}    `gloss`  [ "reporting [ [ taqoriyriy ~ / ADJ ] ]" ],

    -- ;; <iqorAr_1
    -- <qrAr   <iqorAr NduAt   ratification;confirmation
    -- AqrAr   <iqorAr NduAt   ratification;confirmation

    noun     HiFCAL                    {- IiqorAr -}        `gloss`  [ "ratification", "confirmation" ],
    ...
    noun     FACL |< aT                {- qAr~ap -}         -- `others` [ "qArr NAt" ]
                                                            `gloss`  [ "continent", "continents" ],

    -- ;; qAr~iy~_1
    -- qAry    qAr~iy~ N-ap    continental     [[qAr~iy~/ADJ]]

    noun     FACL |< Iy                {- qAr~iy~ -}        `gloss`  [ "continental [ [ qAr ~ iy ~ / ADJ ] ]" ],
    ...
    noun     MaFCUL                    {- maqoruwr -}       `gloss`  [ "at ease [ [ maqoruwr / ADJ ] ]" ] ]
 ...
 |> "q r s y" <| [
    ...
    noun     KaRADiS |< aT             {- qarAsiyap -}      -- `others` [ "qarA.siyA N0", "qarA.siy Nap", "qarAsiyA N0" ]
                                                            `gloss`  [ "prunes", "plums" ] ]
 ...
 |> "q r t" <| [
    ...
    noun     FACiL                     {- qArit -}          `gloss`  [ "omnivorous [ [ qArit / ADJ ] ]" ],

    -- ;; maqoruwt_1
    -- mqrwt   maqoruwt        N-ap    bluish     [[maqoruwt/ADJ]]

    noun     MaFCUL                    {- maqoruwt -}       `gloss`  [ "bluish [ [ maqoruwt / ADJ ] ]" ] ]
 ...
 |> "q r w" <| [
    ...
    verb     FaCA                      {- qarA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "qrY IV_0_Pass_yu", "qr IV_0hwnyn", "qaraw PV_Atn", "qray IV_Ann_Pass_yu", "qruw IV_0hAnn", "qar PV_ttAw" ]
    ...
    noun     IstiFCA'                  {- {isotiqorA' -}    `gloss`  [ "investigation", "induction", "investigations" ] ]
 ...
 |> "q r y" <| [
    ...
    verb     FaCY                      {- qaraY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ "qriy IV_0hAnn", "qarA PV_h", "qrY IV_0_Pass_yu", "qaray PV_Atn", "qr IV_0hwnyn", "qar PV_ttAw" ]
    ...
    noun     FiCY                      {- qiraY -}          -- `others` [ "qirA Nhy" ]
                                                            `gloss`  [ "hospitality" ],
    ...
    noun     FaCL |< aT                {- qaroyap -}        -- `others` [ "qurY N0", "qurA Nhy" ]
    ...
    noun     FaCIL |< aT               {- qariy~ap -}       -- `others` [ "qarAyA N0_Nhy" ]
    ...
    noun     MiFCY                     {- miqoraY -}        -- `others` [ "miqrA' Nh Nayn NAn_Nayn Napdu Nhy N0_Nh", "miqrA Nhy", "miqray NAn_Nayn" ]
                                                            `gloss`  [ "hospitable" ],
    ...
    noun     FaCY |< Iy                {- qarawiy~ -}       `gloss`  [ "rural", "village [ [ qarawiy ~ / ADJ ] ]" ],

    -- ;; qarawiy~_2
    -- qrwy    qarawiy~        Nall    peasant;villager     [[qarawiy~/ADJ]]

    noun     FaCY |< Iy                {- qarawiy~ -}       `gloss`  [ "peasant", "villager [ [ qarawiy ~ / ADJ ] ]" ],

    -- ;; qarawiy~_3
    -- qrwy    qarawiy~        Nall    of/from Kairouan (Tun.)     [[qarawiy~/ADJ]]

    noun     FaCY |< Iy                {- qarawiy~ -}       `gloss`  [ "of / from Kairouan ( Tun . ) [ [ qarawiy ~ / ADJ ] ]" ] ]
 ...
 |> "q s .h" <| [
    ...
    noun     FaCAL |< aT               {- qasAHap -}        `gloss`  [ "coarseness", "thickness" ],

    -- ;; qAsiH_1
    -- qAsH    qAsiH   N-ap    coarse;thick     [[qAsiH/ADJ]]

    noun     FACiL                     {- qAsiH -}          `gloss`  [ "coarse", "thick [ [ qAsiH / ADJ ] ]" ] ]
 ...
 |> "q s .t" <| [
    ...
    verb     HaFCaL                    {- OaqosaT -}        -- `others` [ "qsi.t IV_intr_yu", "qsa.t IV_Pass_yu" ]
    ...
    noun     HaFCaL                    {- OaqosaT -}        `gloss`  [ "equitable", "fair" ],
    ...
    noun     MuFCiL                    {- muqosiT -}        `gloss`  [ "equitable", "fair [ [ muqosiT / ADJ ] ]" ] ]
 ...
 |> "q s .t l" <| [
    ...
    noun     KaRDaS                    {- qasoTal -}        -- `others` [ "qasA.til Ndip" ]
    ...
    noun     KaRDaS                    {- qasoTal -}        `gloss`  [ "chestnuts", "chestnut" ],

    -- ;; qasoTaliy~_1
    -- qsTly   qasoTaliy~      N-ap    brown;chestnut     [[qasoTaliy~/ADJ]]

    noun     KaRDaS |< Iy              {- qasoTaliy~ -}     `gloss`  [ "brown", "chestnut [ [ qasoTaliy ~ / ADJ ] ]" ],

    -- ;; qasoTAlap_1
    -- qsTAl   qasoTAl Nap     Castile

    noun     KaRDAS |< aT              {- qasoTAlap -}      `gloss`  [ "Castile" ],
    ...
    noun     KaRDIS |< Iy              {- qasoTiyliy~ -}    -- `others` [ "qasA.til Nap" ]
                                                            `gloss`  [ "Castilian [ [ qasoTiyliy ~ / NOUN ] ]", "Castilian [ [ qasoTiyliy ~ / ADJ ] ]", "Castilians" ] ]
 ...
 |> "q s .t r" <| [
    ...
    verb     KaRDaS                    {- qasoTar -}        -- `others` [ "qas.tir IV_yu" ]
                                                            `gloss`  [ "test for genuineness" ],

    -- ;; qasoTarap_1
    -- qsTr    qasoTar Nap     test for genuineness

    noun     KaRDaS |< aT              {- qasoTarap -}      `gloss`  [ "test for genuineness" ],
    ...
    noun     KaRDaS                    {- qasoTar -}        -- `others` [ "qasA.tir Ndip" ]
                                                            `gloss`  [ "catheter", "catheters" ] ]
 ...
 |> "q s .t s" <| [
    ...
    noun     KuRDAS                    {- qusoTAs -}        -- `others` [ "qasA.tiys Ndip", "qis.tAs Ndu" ]
 ...
 |> "q s m" <| [
    ...
    verb     HaFCaL                    {- Oaqosam -}        -- `others` [ "qsam IV_Pass_yu", "qsim IV_yu" ]
    ...
    noun     FiCL |< aT                {- qisomap -}        `gloss`  [ "allotment", "apportionment" ],
    ...
    noun     FaCaL |< aN               {- qasamAF -}        -- `others` [ "qasam NF" ]
                                                            `gloss`  [ "I swear ! [ [ qasam / ADV ] ]" ],

    -- ;; qasamap_1
    -- qsm     qasam   NapAt   feature

    noun     FaCaL |< aT               {- qasamap -}        `gloss`  [ "feature" ],
    ...
    noun     FaCAL |< aT               {- qasAmap -}        `gloss`  [ "beauty" ],
    ...
    noun     FaCIL                     {- qasiym -}         `gloss`  [ "elegant [ [ qasiym / ADJ ] ]" ],
    ...
    noun     FaCIL |< aT               {- qasiymap -}       -- `others` [ "qasA'im Ndip" ]
    ...
    noun     TaFCIL |< Iy              {- taqosiymiy~ -}    `gloss`  [ "fractional", "fragmentary [ [ taqosiymiy ~ / ADJ ] ]" ],

    -- ;; taqosiymap_1
    -- tqsym   taqosiym        Napdu   solo piece

    noun     TaFCIL |< aT              {- taqosiymap -}     `gloss`  [ "solo piece" ],

    -- ;; muqAsamap_1
    -- mqAsm   muqAsam NapAt   partnership;participation

    noun     MuFACaL |< aT             {- muqAsamap -}      `gloss`  [ "partnership", "participation" ],
    ...
    noun     InFiCAL |< Iy             {- {inoqisAmiy~ -}   `gloss`  [ "schismatic [ [ { inoqisAmiy ~ / ADJ ] ]" ],

    -- ;; {inoqisAmiy~ap_1
    -- <nqsAmy {inoqisAmiy~    Nap     divisibility     [[{inoqisAmiy~/NOUN]]
    -- AnqsAmy {inoqisAmiy~    Nap     divisibility     [[{inoqisAmiy~/NOUN]]

    noun     InFiCAL |< Iy |< aT       {- {inoqisAmiy~ap -} `gloss`  [ "divisibility [ [ { inoqisAmiy ~ / NOUN ] ]" ],
 ...
 |> "q s r" <| [
    ...
    noun     FaCL |< aN                {- qasorAF -}        -- `others` [ "qasr NF" ]
                                                            `gloss`  [ "by force", "necessarily [ [ qasor / ADV ] ]" ],

    -- ;; qasoriy~_1
    -- qsry    qasoriy~        Nall    coercive;constraining     [[qasoriy~/ADJ]]

    noun     FaCL |< Iy                {- qasoriy~ -}       `gloss`  [ "coercive", "constraining [ [ qasoriy ~ / ADJ ] ]" ],
 ...
 |> "q s s" <| [
    ...
    noun     FuCUL |< aT               {- qusuwsap -}       `gloss`  [ "priesthood", "ministry" ],

    -- ;; qusuwsiy~_1
    -- qswsy   qusuwsiy~       N-ap    priestly;ordination     [[qusuwsiy~/ADJ]]

    noun     FuCUL |< Iy               {- qusuwsiy~ -}      `gloss`  [ "priestly", "ordination [ [ qusuwsiy ~ / ADJ ] ]" ],
    ...
    verb     FaCLY                     {- qas~aY -}         -- `others` [ "qass IV_0hwnyn_yu PV_ttAw", "qassay PV_Atn IV_Ann_Pass_yu", "qassiy IV_0hAnn_yu", "qassA PV_h" ]
 ...
 |> "q s w" <| [
    ...
    verb     FaCA                      {- qasA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "qs IV_0hwnyn", "qasaw PV_Atn", "qas PV_ttAw_intr", "qsuw IV_0hAnn" ]
    ...
    verb     HaFCY                     {- OaqosaY -}        -- `others` [ "'aqsay PV_Atn", "qsY IV_0_Pass_yu", "qsay IV_Ann_Pass_yu", "qs IV_0hwnyn_yu", "'aqsA PV_h", "qsiy IV_0hAnn_yu", "'aqs PV_ttAw" ]
                                                            `gloss`  [ "harden", "make stubborn", "make hard-hearted", "be hardened", "be made stubborn", "be made hard-hearted" ],
    ...
    noun     FaCL |< aT                {- qasowap -}        `gloss`  [ "harshness", "severity", "brutality" ],

    -- ;; qasAwap_1
    -- qsAw    qasAw   Nap     harshness;severity;brutality

    noun     FaCAL |< aT               {- qasAwap -}        `gloss`  [ "harshness", "severity", "brutality" ],
    ...
    noun     HaFCY                     {- OaqosaY -}        -- `others` [ "'aqsay NAn_Nayn", "'aqsA Nhy" ]
    ...
    noun     MuFACY |< aT              {- muqAsAp -}        -- `others` [ "muqAsaw NAt", "muqAsay NAt" ]
 ...
 |> "q s y" <| [
    ...
    noun     FaCIL                     {- qasiy~ -}         `gloss`  [ "firm", "solid [ [ qasiy ~ / ADJ ] ]" ],
    ...
    noun     TaFCiL |< aT              {- taqosiyap -}      `gloss`  [ "tempering", "hardening" ] ]
 ...
 |> "q t .s" <| [
    ...
    verb     IFCaLL                    {- {iqotaS~ -}       -- `others` [ "qta.si.s IV_C", "qta.s.s IV_V", "iqta.sa.s PV_C" ]
                                                            `gloss`  [ "take vengeance on", "punish" ],
    ...
    noun     IFCiLAL                   {- {iqotiSAS -}      `gloss`  [ "punishment", "reprisal", "vengeance" ] ]
 ...
 |> "q t .t" <| [
    ...
    verb     IFCaLL                    {- {iqotaT~ -}       -- `others` [ "qta.ti.t IV_C", "iqta.ta.t PV_C", "qta.t.t IV_V" ]
                                                            `gloss`  [ "sharpen" ] ]
 ...
 |> "q t _t" <| [
    ...
    verb     IFCaLL                    {- {iqotav~ -}       -- `others` [ "qta_ti_t IV_C", "iqta_ta_t PV_C", "qta_t_t IV_V" ]
                                                            `gloss`  [ "uproot", "extirpate" ] ]
 ...
 |> "q t d" <| [
    ...
    verb     IFCaLL                    {- {iqotad~ -}       -- `others` [ "qtadid IV_C", "qtadd IV_V", "iqtadad PV_C" ]
                                                            `gloss`  [ "cut lengthwise", "cut into strips" ] ]
 ...
 |> "q t l" <| [
    ...
    noun     HaFCAL                    {- OaqotAl -}        `gloss`  [ "foes" ],
    ...
    noun     MaFCaL |< aT              {- maqotalap -}      `gloss`  [ "slaughter" ],
    ...
    noun     FiCAL |< Iy               {- qitAliy~ -}       `gloss`  [ "fighting", "battle [ [ qitAliy ~ / ADJ ] ]" ],

    -- ;; muqAtalap_1
    -- mqAtl   muqAtal NapAt   combat;struggle

    noun     MuFACaL |< aT             {- muqAtalap -}      `gloss`  [ "combat", "struggle" ],
    ...
    noun     MaFCUL                    {- maqotuwl -}       `gloss`  [ "dead [ [ maqotuwl / ADJ ] ]" ],
    ...
    noun     MuFACiL |< aT             {- muqAtilap -}      `gloss`  [ "fighter aircraft" ],
    ...
    noun     MustaFCiL                 {- musotaqotil -}    `gloss`  [ "heroic", "death-defying [ [ musotaqotil / ADJ ] ]" ] ]
 ...
 |> "q t m" <| [
    ...
    noun     FuCL |< aT                {- qutomap -}        `gloss`  [ "dark", "blackish" ],

    -- ;; qatamap_1
    -- qtm     qatam   Nap     dark;blackish

    noun     FaCaL |< aT               {- qatamap -}        `gloss`  [ "dark", "blackish" ],

    -- ;; qutomap_2
    -- qtm     qutom   Nap     darkness;gloom

    noun     FuCL |< aT                {- qutomap -}        `gloss`  [ "darkness", "gloom" ],

    -- ;; qatamap_2
    -- qtm     qatam   Nap     darkness;gloom

    noun     FaCaL |< aT               {- qatamap -}        `gloss`  [ "darkness", "gloom" ],
    ...
    noun     HaFCaL                    {- Oaqotam -}        `gloss`  [ "dark", "blackish" ],
    ...
    noun     FACiL                     {- qAtim -}          -- `others` [ "qawAtim Ndip" ]
                                                            `gloss`  [ "black", "dark [ [ qAtim / ADJ ] ]", "dark" ] ]
 ...
 |> "q t r" <| [
    ...
    verb     HaFCaL                    {- Oaqotar -}        -- `others` [ "qtir IV_yu" ]
    ...
    noun     FaCaL |< aT               {- qatarap -}        `gloss`  [ "dust" ],
    ...
    noun     FACiL                     {- qAtir -}          `gloss`  [ "stingy", "miserly [ [ qAtir / ADJ ] ]" ],

    -- ;; muqat~ir_1
    -- mqtr    muqat~ir        Nall    stingy;parsimonious     [[muqat~ir/ADJ]]

    noun     MuFaCCiL                  {- muqat~ir -}       `gloss`  [ "stingy", "parsimonious [ [ muqat ~ ir / ADJ ] ]" ],

    -- ;; muqotir_1
    -- mqtr    muqotir Nall    stingy;parsimonious     [[muqotir/ADJ]]

    noun     MuFCiL                    {- muqotir -}        `gloss`  [ "stingy", "parsimonious [ [ muqotir / ADJ ] ]" ],
 ...
 |> "q t t" <| [
    ...
    verb     IFtaCL                    {- {iqotat~ -}       -- `others` [ "iqtatat PV_Ct", "qtatit IV_C", "qtatt IV_V" ]
 ...
 |> "q w '" <| [
    ...
    noun     HiFCAL                    {- IiqowA' -}        `gloss`  [ "depopulation" ] ]
 ...
 |> "q w .d" <| [
    ...
    verb     FAL                       {- qAD-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "qu.d PV_C IV_C", "quw.d IV_V" ]
                                                            `gloss`  [ "demolish", "raze" ],
    ...
    noun     MuFACaL |< aT             {- muqAwaDap -}      `gloss`  [ "barter", "exchange" ] ]
 ...
 |> "q w .h" <| [
    ...
    noun     FAL |< aT                 {- qAHap -}          -- `others` [ "quw.h N" ]
 ...
 |> "q w .t" <| [
    ...
    noun     FuCL |< Iy                {- quwTiy~ -}        `gloss`  [ "Gothic [ [ quwTiy ~ / ADJ ] ]" ],

    -- ;; qawoTap_1
    -- qwT     qawoT   Nap     fruit basket

    noun     FaCL |< aT                {- qawoTap -}        `gloss`  [ "fruit basket" ],

    -- ;; quwTap_1
    -- qwT     quwT    Nap     tomatoes

    noun     FuCL |< aT                {- quwTap -}         `gloss`  [ "tomatoes" ] ]
 ...
 |> "q w ^s" <| [
    ...
    noun     FACUL                     {- qAwuw$ -}         -- `others` [ "qawAwiy^s Ndip" ]
 ...
 |> "q w `" <| [
    ...
    noun     FAL |< aT                 {- qAEap -}          -- `others` [ "qA` NAt" ]
 ...
 |> "q w b" <| [
    ...
    verb     FAL                       {- qAb-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "qub PV_C IV_C", "quwb IV_V" ]
 ...
 |> "q w b '" <| [
    ...
    noun     KuRDAS                    {- quwbA' -}         `gloss`  [ "tetter", "eczema", "herpes" ] ]
 ...
 |> "q w d" <| [
    ...
    verb     HaFAL                     {- OaqAd -}          -- `others` [ "qAd IV_V_Pass_yu", "qid IV_C_yu", "qiyd IV_V_yu", "qad IV_C_Pass_yu", "'aqad PV_C" ]
    ...
    noun     HaFCaL                    {- Oaqowad -}        `gloss`  [ "tractable", "docile", "amenable" ],

    -- ;; {inoqiyAd_1
    -- <nqyAd  {inoqiyAd       N/At    compliance;submission
    -- AnqyAd  {inoqiyAd       N/At    compliance;submission

    noun     InFiyAL                   {- {inoqiyAd -}      `gloss`  [ "compliance", "submission" ],
 ...
 |> "q w l" <| [
    ...
    noun     FAL |< aT                 {- qAlap -}          `gloss`  [ "speech", "talk" ],
    ...
    noun     FaCL |< aN                {- qawolAF -}        -- `others` [ "qawl NF" ]
                                                            `gloss`  [ "in word", "verbally", "by word [ [ qawol / ADV ] ]" ],

    -- ;; qawolap_1
    -- qwl     qawol   Napdu   remark

    noun     FaCL |< aT                {- qawolap -}        `gloss`  [ "remark" ],
    ...
    noun     MuFACaL |< aT             {- muqAwalap -}      `gloss`  [ "deal", "bargain", "settlement" ],
    ...
    noun     MaFUL |< aT               {- maquwlap -}       -- `others` [ "maquwl NAt" ]
 ...
 |> "q w l .h" <| [
    ...
    noun     KaRDaS |< aT              {- qawolaHap -}      -- `others` [ "qawAli.h Ndip" ]
 ...
 |> "q w l b" <| [
    ...
    verb     KaRDaS                    {- qawolab -}        -- `others` [ "qawlib IV_yu" ]
                                                            `gloss`  [ "mold", "cast" ],

    -- ;; qawolabap_1
    -- qwlb    qawolab Nap     casting;molding

    noun     KaRDaS |< aT              {- qawolabap -}      `gloss`  [ "casting", "molding" ] ]
 ...
 |> "q w l n" <| [
    ...
    noun     KuRDUS                    {- quwluwn -}        `gloss`  [ "bowels", "colon" ] ]
 ...
 |> "q w m" <| [
    ...
    verb     HaFAL                     {- OaqAm -}          -- `others` [ "qam IV_C_Pass_yu", "qAm IV_V_Pass_yu", "qiym IV_V_yu", "'uqiym PV_Pass-aAat", "qim IV_C_yu", "'aqam PV_C" ]
    ...
    noun     FIL |< Iy                 {- qiymiy~ -}        `gloss`  [ "non-fungible [ [ qiymiy ~ / ADJ ] ]" ],
    ...
    noun     FiCAL |< aT               {- qiwAmap -}        `gloss`  [ "guardianship" ],
    ...
    noun     FaCIL                     {- qawiym -}         `gloss`  [ "upright", "proper", "authentic [ [ qawiym / ADJ ] ]" ],
    ...
    noun     MaFAL |< aT               {- maqAmap -}        -- `others` [ "maqAm NAt" ]
    ...
    noun     HaFCaL                    {- Oaqowam -}        `gloss`  [ "straighter", "more correct", "more appropriate" ],
    ...
    noun     MuFACaL |< aT             {- muqAwamap -}      `gloss`  [ "resistance", "opposition", "struggle" ],

    -- ;; <iqAmap_1
    -- <qAm    <iqAm   Nap     residency;setting up
    -- AqAm    <iqAm   Nap     residency;setting up

    noun     HiFAL |< aT               {- IiqAmap -}        `gloss`  [ "residency", "setting up" ],

    -- ;; {isotiqAmap_1
    -- <stqAm  {isotiqAm       Nap     correctness;integrity
    -- AstqAm  {isotiqAm       Nap     correctness;integrity

    noun     IstiFAL |< aT             {- {isotiqAmap -}    `gloss`  [ "correctness", "integrity" ],
    ...
    noun     FA'iL |< aT               {- qA}imap -}        `gloss`  [ "support", "base" ],
    ...
    noun     FA'iL |< aT               {- qA}imap -}        -- `others` [ "qawA'im Ndip", "qA'im NAt" ]
                                                            `gloss`  [ "list", "index", "lists", "indexes" ],
    ...
    noun     MuFIL |< Iy               {- muqiymiy~ -}      `gloss`  [ "residential [ [ muqiymiy ~ / ADJ ] ]" ],

    -- ;; muqiymiy~ap_1
    -- mqymy   muqiymiy~       Nap     residency     [[muqiymiy~/NOUN]]

    noun     MuFIL |< Iy |< aT         {- muqiymiy~ap -}    `gloss`  [ "residency [ [ muqiymiy ~ / NOUN ] ]" ],
 ...
 |> "q w m s" <| [
    ...
    noun     KaRDaS                    {- qawomas -}        -- `others` [ "qawAmis Ndip" ]
 ...
 |> "q w n" <| [
    ...
    noun     FuCL |< aT                {- quwnap -}         -- `others` [ "quwan N" ]
                                                            `gloss`  [ "icon", "icons" ],
    ...
    noun     FACUL                     {- qAwuwn -}         -- `others` [ "qawAwiyn Ndip" ]
 ...
 |> "q w q" <| [
    ...
    verb     FAL                       {- qAq-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "quq PV_C IV_C", "quwq IV_V" ]
                                                            `gloss`  [ "cackle", "cluck" ],
    ...
    noun     FACUL                     {- qAwuwq -}         -- `others` [ "qawAwiyq Ndip" ]
                                                            `gloss`  [ "headgear" ] ]
 ...
 |> "q w q `" <| [
    ...
    verb     TaKaRDaS                  {- taqawoqaE -}      `gloss`  [ "withdraw within" ],

    -- ;; qawoqaE_1
    -- qwqE    qawoqaE N       seashells

    noun     KaRDaS                    {- qawoqaE -}        `gloss`  [ "seashells" ],

    -- ;; qawoqaEap_1
    -- qwqE    qawoqaE Napdu   snail
    -- qwAqE   qawAqiE Ndip    snails

    noun     KaRDaS |< aT              {- qawoqaEap -}      -- `others` [ "qawAqi` Ndip" ]
                                                            `gloss`  [ "snail", "snails" ] ]
 ...
 |> "q w q s" <| [
    ...
    noun     KaRDAS                    {- qawoqAs -}        `gloss`  [ "Caucasus" ],

    -- ;; qawoqAsiy~_1
    -- qwqAsy  qawoqAsiy~      Nall    Caucasian     [[qawoqAsiy~/NOUN]]
    -- qwqAsy  qawoqAsiy~      Nall    Caucasian     [[qawoqAsiy~/ADJ]]

    noun     KaRDAS |< Iy              {- qawoqAsiy~ -}     `gloss`  [ "Caucasian [ [ qawoqAsiy ~ / NOUN ] ]", "Caucasian [ [ qawoqAsiy ~ / ADJ ] ]" ] ]
 ...
 |> "q w q z" <| [
    ...
    noun     KaRDAS |< Iy              {- qawoqAziy~ -}     `gloss`  [ "Caucasian [ [ qawoqAziy ~ / NOUN ] ]", "Caucasian [ [ qawoqAziy ~ / ADJ ] ]" ] ]
 ...
 |> "q w r" <| [
    ...
    noun     FAL |< aT                 {- qArap -}          -- `others` [ "qiyrAn N", "quwr N" ]
                                                            `gloss`  [ "hill", "hills" ],
    ...
    noun     TaFCIL |< aT              {- taqowiyrap -}     `gloss`  [ "neckline" ],

    -- ;; muqaw~ar_1
    -- mqwr    muqaw~ar        N-ap    hollowed out     [[muqaw~ar/ADJ]]

    noun     MuFaCCaL                  {- muqaw~ar -}       `gloss`  [ "hollowed out [ [ muqaw ~ ar / ADJ ] ]" ],

    -- ;; miqowarap_1
    -- mqwr    miqowar Napdu   gouge

    noun     MiFCaL |< aT              {- miqowarap -}      `gloss`  [ "gouge" ] ]
 ...
 |> "q w s" <| [
    ...
    noun     FuCayL |< aT              {- quwayosap -}      `gloss`  [ "sage ( bot . )" ],

    -- ;; muqaw~as_1
    -- mqws    muqaw~as        N-ap    arched;bent;curved     [[muqaw~as/ADJ]]

    noun     MuFaCCaL                  {- muqaw~as -}       `gloss`  [ "arched", "bent", "curved [ [ muqaw ~ as / ADJ ] ]" ] ]
 ...
 |> "q w t" <| [
    ...
    verb     FAL                       {- qAt-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "quwt IV_V", "qut PV_Ct IV_C" ]
    ...
    verb     HaFAL                     {- OaqAt -}          -- `others` [ "qAt IV_V_Pass_yu", "qiyt IV_V_yu", "qit IV_C_yu", "qat IV_C_Pass_yu", "'aqat PV-t" ]
    ...
    noun     TaFCIL |< aT              {- taqowiytap -}     `gloss`  [ "snack", "quick bite" ],
    ...
    noun     MuFIL                     {- muqiyt -}         `gloss`  [ "nourisher ( God )" ],

    -- ;; muqiyt_2
    -- mqyt    muqiyt  N0      Muqit;Mouqeet

    noun     MuFIL                     {- muqiyt -}         `gloss`  [ "Muqit", "Mouqeet" ] ]
 ...
 |> "q w t b" <| [
    ...
    noun     MuKaRDaS                  {- muqawotab -}      `gloss`  [ "hunchbacked [ [ muqawotab / ADJ ] ]" ] ]
 ...
 |> "q w w" <| [
    ...
    noun     FuCL |< aT                {- quw~ap -}         -- `others` [ "quwY N0", "quwA Nhy", "quww NAt" ]
    ...
    noun     FUL |< aT                 {- quw~ap -}         -- `others` [ "quwY N0", "quwA Nhy", "quww NAt" ]
                                                            `gloss`  [ "power", "strength", "armed forces" ] ]
 ...
 |> "q w y" <| [
    ...
    verb     HaFCY                     {- OaqowaY -}        -- `others` [ "'aqw PV_ttAw_intr", "qwiy IV_0hAnn_yu", "'aqwA PV_h", "'aqway PV_Atn", "qw IV_0hwnyn_yu" ]
                                                            `gloss`  [ "be desolate" ],
    ...
    noun     FY |< Iy                  {- qawiy~ -}         -- `others` [ "'aqwiyA' Nh Nhy N0_Nh" ]
    ...
    noun     HaFCY                     {- OaqowaY -}        -- `others` [ "'aqwA Nhy", "'aqway NAn_Nayn" ]
    ...
    noun     TaFCiL |< aT              {- taqowiyap -}      -- `others` [ "taqAwiy N0_Nh", "taqAw NK" ]
    ...
    noun     HiFCA'                    {- IiqowA' -}        `gloss`  [ "depopulation" ],
    ...
    noun     MuFaCCiL                  {- muqaw~iy -}       -- `others` [ "muqaww Nuwn_Niyn NK" ]
                                                            `gloss`  [ "strengthening [ [ muqaw ~ iy / ADJ ] ]", "strengthening" ],
    ...
    noun     MuFaCCY                   {- muqaw~aY -}       -- `others` [ "muqawway NAn_Nayn", "muqawwA Napdu Nhy" ]
 ...
 |> "q y '" <| [
    ...
    verb     FAL                       {- qA'-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "qi' PV_C IV_C", "qiy' IV_V IV_wn IV_yn" ]
                                                            `gloss`  [ "vomit" ],
    ...
    verb     FaCCaL                    {- qay~aO -}         -- `others` [ "qayyi' IV_wn_yu IV_yu" ]
                                                            `gloss`  [ "make vomit" ],
    ...
    verb     TaFaCCaL                  {- taqay~aO -}       -- `others` [ "taqayya'A IV-|" ]
                                                            `gloss`  [ "vomit" ],
 ...
 |> "q y .d" <| [
    ...
    verb     FAL                       {- qAD-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "qiy.d IV_V", "qi.d PV_C IV_C" ]
    ...
    noun     MuFACaL |< aT             {- muqAyaDap -}      `gloss`  [ "barter", "exchange" ] ]
 ...
 |> "q y .h" <| [
    ...
    verb     FAL                       {- qAH-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "qiy.h IV_V", "qi.h PV_C IV_C" ]
    ...
    noun     MutaFaCCiL                {- mutaqay~iH -}     `gloss`  [ "festering", "infected [ [ mutaqay ~ iH / ADJ ] ]" ] ]
 ...
 |> "q y .s" <| [
    ...
    noun     FaCLAn |< aT              {- qayoSAnap -}      `gloss`  [ "sunfish", "moonfish" ] ]
 ...
 |> "q y .s r" <| [
    ...
    noun     KaRDaS                    {- qayoSar -}        `gloss`  [ "Qaisar" ],

    -- ;; qayoSar_2
    -- qySr    qayoSar Ndu     Caesar

    noun     KaRDaS                    {- qayoSar -}        `gloss`  [ "Caesar" ],
    ...
    noun     KaRDaS                    {- qayoSar -}        `gloss`  [ "Tzar" ],

    -- ;; qayoSariy~_1
    -- qySry   qayoSariy~      N-ap    cesarean;imperial     [[qayoSariy~/ADJ]]

    noun     KaRDaS |< Iy              {- qayoSariy~ -}     `gloss`  [ "cesarean", "imperial [ [ qayoSariy ~ / ADJ ] ]" ],

    -- ;; qayoSariy~ap_1
    -- qySry   qayoSariy~      Nap     cesarean section     [[qayoSariy~/NOUN]]

    noun     KaRDaS |< Iy |< aT        {- qayoSariy~ap -}   `gloss`  [ "cesarean section [ [ qayoSariy ~ / NOUN ] ]" ] ]
 ...
 |> "q y .t s" <| [
    ...
    noun     KiRDUS                    {- qiyTuws -}        `gloss`  [ "Cetus" ] ]
 ...
 |> "q y .z" <| [
    ...
    verb     FAL                       {- qAZ-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "qiy.z IV_V_intr", "qi.z IV_C_intr PV_C_intr" ]
    ...
    noun     FA'iL                     {- qA}iZ -}          `gloss`  [ "very hot" ] ]
 ...
 |> "q y _t r" <| [
    ...
    noun     KiRDAS                    {- qiyvAr -}         -- `others` [ "qayA_tiyr Ndip" ]
                                                            `gloss`  [ "guitar", "guitars" ] ]
 ...
 |> "q y d" <| [
    ...
    noun     FiCAL |< aT               {- qiyAdap -}        `gloss`  [ "leadership", "command" ],

    -- ;; qiyAdap_2
    -- qyAd    qiyAd   NapAt   leaders;commanders

    noun     FiCAL |< aT               {- qiyAdap -}        `gloss`  [ "leaders", "commanders" ],

    -- ;; qiyAdiy~_1
    -- qyAdy   qiyAdiy~        N-ap    leading;guiding;commanding     [[qiyAdiy~/ADJ]]

    noun     FiCAL |< Iy               {- qiyAdiy~ -}       `gloss`  [ "leading", "guiding", "commanding [ [ qiyAdiy ~ / ADJ ] ]" ],

    -- ;; qiyAdiy~_2
    -- qyAdy   qiyAdiy~        Nall    leader;commander     [[qiyAdiy~/NOUN]]

    noun     FiCAL |< Iy               {- qiyAdiy~ -}       `gloss`  [ "leader", "commander [ [ qiyAdiy ~ / NOUN ] ]" ],
    ...
    noun     FaCL |< Iy                {- qayodiy~ -}       `gloss`  [ "registration", "booking [ [ qayodiy ~ / ADJ ] ]" ],
 ...
 |> "q y d m" <| [
    ...
    noun     KaRDUS                    {- qayoduwm -}       -- `others` [ "qayAdiym Ndip" ]
 ...
 |> "q y f" <| [
    ...
    noun     FiCAL |< aT               {- qiyAfap -}        `gloss`  [ "tracking", "pursuing" ],

    -- ;; qiyAfap_2
    -- qyAf    qiyAf   Nap     costume;guise

    noun     FiCAL |< aT               {- qiyAfap -}        `gloss`  [ "costume", "guise" ],
 ...
 |> "q y l" <| [
    ...
    verb     HaFAL                     {- OaqAl -}          -- `others` [ "'aqal PV_C", "qiyl IV_V_yu", "qil IV_C_yu" ]
    ...
    noun     HiFAL |< aT               {- IiqAlap -}        `gloss`  [ "dismissal", "discharge" ],

    -- ;; {isotiqAlap_1
    -- <stqAl  {isotiqAl       NapAt   resignation;retirement
    -- AstqAl  {isotiqAl       NapAt   resignation;retirement

    noun     IstiFAL |< aT             {- {isotiqAlap -}    `gloss`  [ "resignation", "retirement" ],

    -- ;; muqAl_1
    -- mqAl    muqAl   Nall    fired;dismissed;discharged     [[muqAl/ADJ]]

    noun     MuFAL                     {- muqAl -}          `gloss`  [ "fired", "dismissed", "discharged [ [ muqAl / ADJ ] ]" ],
 ...
 |> "q y l .t" <| [
    ...
    noun     KiRDIS                    {- qiyliyT -}        `gloss`  [ "suffering from scrotal hernia" ],

    -- ;; muqayolaT_1
    -- mqylT   muqayolaT       Nall    suffering from scrotal hernia     [[muqayolaT/ADJ]]

    noun     MuKaRDaS                  {- muqayolaT -}      `gloss`  [ "suffering from scrotal hernia [ [ muqayolaT / ADJ ] ]" ] ]
 ...
 |> "q y m" <| [
    ...
    noun     FiCL |< aT                {- qiymap -}         -- `others` [ "qiyam N" ]
                                                            `gloss`  [ "value", "worth", "values", "morals", "ethics" ],
    ...
    noun     FiCL |< Iy                {- qiymiy~ -}        `gloss`  [ "non-fungible [ [ qiymiy ~ / ADJ ] ]" ],
    ...
    noun     FiCAL |< aT               {- qiyAmap -}        `gloss`  [ "resurrection" ],
    ...
    noun     MuFiCL |< Iy              {- muqiymiy~ -}      `gloss`  [ "residential [ [ muqiymiy ~ / ADJ ] ]" ],

    -- ;; muqiymiy~ap_1
    -- mqymy   muqiymiy~       Nap     residency     [[muqiymiy~/NOUN]]

    noun     MuFiCL |< Iy |< aT        {- muqiymiy~ap -}    `gloss`  [ "residency [ [ muqiymiy ~ / NOUN ] ]" ],

    -- ;; musotaqiym_1
    -- mstqym  musotaqiym      N-ap    straight;correct;righteous

    noun     MustaFiCL                 {- musotaqiym -}     `gloss`  [ "straight", "correct", "righteous" ],
 ...
 |> "q y n" <| [
    ...
    noun     FaCL                      {- qayon -}          -- `others` [ "quyuwn N" ]
                                                            `gloss`  [ "blacksmith", "blacksmiths" ],

    -- ;; qayonap_1
    -- qyn     qayon   NapAt   female singer
    -- qyAn    qiyAn   N       female singers

    noun     FaCL |< aT                {- qayonap -}        -- `others` [ "qiyAn N" ]
                                                            `gloss`  [ "female singer", "female singers" ] ]
 ...
 |> "q y q b" <| [
    ...
    noun     KaRDaS                    {- qayoqab -}        `gloss`  [ "maple" ] ]
 ...
 |> "q y r" <| [
    ...
    noun     FiCL                      {- qiyr -}           `gloss`  [ "tar", "pitch" ] ]
 ...
 |> "q y s" <| [
    ...
    noun     FiCAL |< Iy               {- qiyAsiy~ -}       `gloss`  [ "record", "analogous [ [ qiyAsiy ~ / ADJ ] ]" ],
    ...
    noun     MuFACaL |< aT             {- muqAyasap -}      `gloss`  [ "appraisal", "measurement", "comparison" ] ]
 ...
 |> "q z .h" <| [
    ...
    noun     FuCL |< aT                {- quzoHap -}        `gloss`  [ "iridescent ribbon" ],

    -- ;; quzaH_1
    -- qzH     quzaH   N       rainbow

    noun     FuCaL                     {- quzaH -}          `gloss`  [ "rainbow" ],

    -- ;; quzaHiy~_1
    -- qzHy    quzaHiy~        N-ap    iridescent     [[quzaHiy~/ADJ]]

    noun     FuCaL |< Iy               {- quzaHiy~ -}       `gloss`  [ "iridescent [ [ quzaHiy ~ / ADJ ] ]" ],

    -- ;; quzaHiy~ap_1
    -- qzHy    quzaHiy~        Nap     iris (eye)     [[quzaHiy~/NOUN]]

    noun     FuCaL |< Iy |< aT         {- quzaHiy~ap -}     `gloss`  [ "iris ( eye ) [ [ quzaHiy ~ / NOUN ] ]" ],
 ...
 |> "q z `" <| [
    ...
    noun     FuCL |< aT                {- quzoEap -}        `gloss`  [ "dwarf", "pygmy" ],

    -- ;; qaziyEap_1
    -- qzyE    qaziyE  Napdu   tuft of hair

    noun     FaCIL |< aT               {- qaziyEap -}       `gloss`  [ "tuft of hair" ] ]
 ...
 |> "q z d r" <| [
    ...
    verb     KaRDaS                    {- qazodar -}        -- `others` [ "qazdir IV_yu" ]
                                                            `gloss`  [ "plate with tin" ],

    -- ;; qazodiyr_1
    -- qzdyr   qazodiyr        N       tin plating

    noun     KaRDIS                    {- qazodiyr -}       `gloss`  [ "tin plating" ],

    -- ;; muqazodir_1
    -- mqzdr   muqazodir       Nall    tinsmith

    noun     MuKaRDiS                  {- muqazodir -}      `gloss`  [ "tinsmith" ],

    -- ;; muqazodar_1
    -- mqzdr   muqazodar       N-ap    tin plated     [[muqazodar/ADJ]]

    noun     MuKaRDaS                  {- muqazodar -}      `gloss`  [ "tin plated [ [ muqazodar / ADJ ] ]" ] ]
 ...
 |> "q z m" <| [
    ...
    noun     FaCaL |< Iy               {- qazamiy~ -}       `gloss`  [ "stunted", "dwarfed [ [ qazamiy ~ / ADJ ] ]" ],

    -- ;; qazim_1
    -- qzm     qazim   N-ap    stunted;dwarfish     [[qazim/ADJ]]

    noun     FaCiL                     {- qazim -}          `gloss`  [ "stunted", "dwarfish [ [ qazim / ADJ ] ]" ] ]
 ...
 |> "q z q z" <| [
    ...
    verb     KaRDaS                    {- qazoqaz -}        -- `others` [ "qazqiz IV_yu" ]
                                                            `gloss`  [ "crack" ],

    -- ;; qazoqazap_1
    -- qzqz    qazoqaz Nap     cracking

    noun     KaRDaS |< aT              {- qazoqazap -}      `gloss`  [ "cracking" ] ]
 ...
 |> "q z z" <| [
    ...
    noun     FaCL |< Iy                {- qaz~iy~ -}        `gloss`  [ "silky", "sericeous [ [ qaz ~ iy ~ / ADJ ] ]" ],

    -- ;; qizAzap_1
    -- qzAz    qizAz   Nap     sericulture

    noun     FiCAL |< aT               {- qizAzap -}        `gloss`  [ "sericulture" ],
    ...
    noun     FiCAL |< aT               {- qizAzap -}        -- `others` [ "qazA'iz Ndip" ]
                                                            `gloss`  [ "bottle", "bottles" ],
    ...
    noun     FACUL |< aT               {- qAzuwzap -}       `gloss`  [ "bottle", "carbonated drink" ] ]
 ...
 |> "qA'imaqAm" <| [
    ...
    noun     Identity |< Iy |< aT      {- qA}imaqAmiy~ap -} `gloss`  [ "administrative district [ [ qA } imaqAmiy ~ / NOUN ] ]" ] ]
 ...
 |> "qAqull" <| [
    ...
    noun     Identity |< aT            {- qAqul~ap -}       `gloss`  [ "cardamom", "saltwort" ] ]
 ...
 |> "qAwirm" <| [
    ...
    noun     Identity |< aT            {- qAwiromap -}      `gloss`  [ "qawirmah ( meat , fat , and onions )" ] ]
 ...
 |> "qa.tar^g" <| [
    ...
    noun     Identity |< Iy            {- qaTarojiy~ -}     `gloss`  [ "shunter", "switchman", "shunters", "switchmen [ [ qaTarojiy ~ / NOUN ] ]" ] ]
 ...
 |> "qabla'i_diN" <| [
    ...
    noun     Identity                  {- qabola}i*K -}     `gloss`  [ "before then [ [ qabola } i*K / ADV ] ]" ] ]
 ...
 |> "qablamA" <| [
    ...
    noun     Identity                  {- qabolamA -}       `gloss`  [ "before [ [ qabolamA / CONJ ] ]" ] ]
 ...
 |> "qahwAtiyy" <| [
    ...
    noun     Identity                  {- qahowAtiy~ -}     `gloss`  [ "cafe manager [ [ qahowAtiy ~ / ADJ ] ]" ],

    -- ;; qahowAtiy~_2
    -- qhwAty  qahowAtiy~      N0      Qahwati

    noun     Identity                  {- qahowAtiy~ -}     `gloss`  [ "Qahwati" ],

    -- ;; qahowAtiy~ap_1
    -- qhwAty  qahowAtiy~      Nap     cafe owners     [[qahowAtiy~/NOUN]]

    noun     Identity |< aT            {- qahowAtiy~ap -}   `gloss`  [ "cafe owners [ [ qahowAtiy ~ / NOUN ] ]" ] ]
 ...
 |> "qahwa^giyy" <| [
    ...
    noun     Identity                  {- qahowajiy~ -}     `gloss`  [ "cafe manager", "coffee cook [ [ qahowajiy ~ / ADJ ] ]" ] ]
 ...
 |> "qalansuw" <| [
    ...
    noun     Identity |< aT            {- qalanosuwap -}    -- `others` [ "qalAnis Ndip" ]
                                                            `gloss`  [ "hood", "cap", "hoods", "caps" ],

    -- ;; qalanosuwap_2
    -- qlnsw   qalanosuw       Nap     Qalansua

    noun     Identity |< aT            {- qalanosuwap -}    `gloss`  [ "Qalansua" ] ]
 ...
 |> "qan.tarm" <| [
    ...
    noun     Identity |< aT            {- qanoTaromap -}    `gloss`  [ "snaffle", "bridle" ] ]
 ...
 |> "qandahAr" <| [
    ...
    noun     Identity |< Iy            {- qanodahAriy~ -}   `gloss`  [ "from / of Kandahar [ [ qanodahAriy ~ / ADJ ] ]" ] ]
 ...
 |> "qandalaft" <| [
    ...
    noun     Identity |< Iy            {- qanodalafotiy~ -} `gloss`  [ "sexton", "sacristan [ [ qanodalafotiy ~ / NOUN ] ]" ] ]
 ...
 |> "qarabiyn" <| [
    ...
    noun     Identity |< aT            {- qarabiynap -}     `gloss`  [ "carbine" ] ]
 ...
 |> "qariyna" <| [
    ...
    noun     Identity                  {- qariyna -}        `gloss`  [ "in connection with", "together with [ [ qariyna / PREP ] ]" ] ]
 ...
 |> "qaruwA.t" <| [
    ...
    noun     Identity |< Iy            {- qaruwATiy~ -}     `gloss`  [ "Croatian [ [ qaruwATiy ~ / NOUN ] ]", "Croatian [ [ qaruwATiy ~ / ADJ ] ]" ] ]
 ...
 |> "qawurm" <| [
    ...
    noun     Identity |< aT            {- qawuromap -}      `gloss`  [ "qawurmah", "shawirma ( food )" ] ]
 ...
 |> "qayluwl" <| [
    ...
    noun     Identity |< aT            {- qayoluwlap -}     `gloss`  [ "midday nap", "siesta" ] ]
 ...
 |> "qazwiyniyy" <| [
    ...
    noun     Identity                  {- qazowiyniy~ -}    `gloss`  [ "Caspian [ [ qazowiyniy ~ / NOUN ] ]", "Caspian [ [ qazowiyniy ~ / ADJ ] ]" ] ]
 ...
 |> "qinnab" <| [
    ...
    noun     Identity |< Iy            {- qin~abiy~ -}      `gloss`  [ "hempen", "hemp [ [ qin ~ abiy ~ / ADJ ] ]" ] ]
 ...
 |> "qir.giyzstAn" <| [
    ...
    noun     Identity |< Iy            {- qirogiyzostAniy~ -} `gloss`  [ "Kyrgyzstani [ [ qirogiyzostAniy ~ / NOUN ] ]", "Kyrgyzstani [ [ qirogiyzostAniy ~ / ADJ ] ]" ] ]
 ...
 |> "qu^s`ariyr" <| [
    ...
    noun     Identity |< aT            {- qu$oEariyrap -}   `gloss`  [ "shuddering", "trembling", "goose bumps" ] ]
 ...
 |> "quddAma" <| [
    ...
    noun     Identity                  {- qud~Ama -}        -- `others` [ "quddAmi FW-Wa FW-Wa-i", "quddAm FW-Wa-o" ]
                                                            `gloss`  [ "in front of [ [ qud ~ Ama / PREP ] ]", "in front of [ [ qud ~ Ami / PREP ] ]", "in front of [ [ qud ~ Am / PREP ] ]" ] ]
 ...
 |> "qulansiy" <| [
    ...
    noun     Identity |< aT            {- qulanosiyap -}    -- `others` [ "qalAniys Ndip" ]
                                                            `gloss`  [ "hood", "cap", "hoods", "caps" ] ]
 ...
 |> "quradAt" <| [
    ...
    noun     Identity |< Iy            {- quradAtiy~ -}     `gloss`  [ "monkey trainer", "monkey trainers [ [ quradAtiy ~ / NOUN ] ]" ] ]
 ...
 |> "qusan.tin" <| [
    ...
    noun     Identity |< Iy            {- qusanoTiniy~ -}   -- `others` [ "qusan.tiyniyy Nall" ]
                                                            `gloss`  [ "from / of Constantine [ [ qusanoTiniy ~ / ADJ ] ]", "from / of Constantine [ [ qusanoTiyniy ~ / ADJ ] ]" ] ]
 ...
 |> "quwriynA'iyy" <| [
    ...
    noun     Identity                  {- quwriynA}iy~ -}   `gloss`  [ "Cyrenaic [ [ quwriynA } iy ~ / NOUN ] ]", "Cyrenaic [ [ quwriynA } iy ~ / ADJ ] ]" ] ]
 ...
 |> "quzmuw.grAfiyA" <| [
    ...
    noun     Identity                  {- quzomuwgrAfiyA -} -- `others` [ "quzmuw.grAfiyy Nap" ]
                                                            `gloss`  [ "cosmography", "cosmography [ [ quzomuwgrAfiy ~ / NOUN ] ]" ] ]
 ...
 |> "quzmuw.grAfiyy" <| [
    ...
    noun     Identity                  {- quzomuwgrAfiy~ -} `gloss`  [ "cosmographic [ [ quzomuwgrAfiy ~ / ADJ ] ]" ],

    -- ;; quzomuwgrAfiy~_2
    -- qzmwgrAfy       quzomuwgrAfiy~  Nall    cosmographer     [[quzomuwgrAfiy~/ADJ]]

    noun     Identity                  {- quzomuwgrAfiy~ -} `gloss`  [ "cosmographer [ [ quzomuwgrAfiy ~ / ADJ ] ]" ] ]
