...
$lexicon = {
  ...
  'w f y' => [
    ...
    {
      'types' => $lexicon->{'w f y'}[0]{'types'},
      'entry' => 'wafY',
      'form' => 'wafY',
      'others' => $lexicon->{'w f y'}[0]{'others'},
      'lines' => $lexicon->{'w f y'}[0]{'lines'},
      'index' => '1',
      'entity' => 'verb',
      'morphs' => 'FaCaNY',
      'glosses' => $lexicon->{'w f y'}[0]{'glosses'},
      'suffix' => '',
      'imperf' => $lexicon->{'w f y'}[0]{'imperf'},
      'glosshash' => $lexicon->{'w f y'}[0]{'glosshash'},
      'orig' => 'wafaY-i',
      'prefix' => ''
    },
    {
    ...
    {
      'types' => $lexicon->{'w f y'}[5]{'types'},
      'entry' => 'wafY',
      'form' => 'wafAT',
      'others' => $lexicon->{'w f y'}[5]{'others'},
      'lines' => $lexicon->{'w f y'}[5]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCaNY |< aT',
      'suffix' => ' |< aT',
      'glosses' => $lexicon->{'w f y'}[5]{'glosses'},
      'glosshash' => $lexicon->{'w f y'}[5]{'glosshash'},
      'orig' => 'wafAp',
      'prefix' => ''
    },
    {
  ...
  'w r \'' => [
    {
      'types' => $lexicon->{'w r y'}[0]{'types'},
      'entry' => 'warA\'',
      'form' => 'warA\'',
      'lines' => $lexicon->{'w r y'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'w r y'}[0]{'glosses'},
      'glosshash' => $lexicon->{'w r y'}[0]{'glosshash'},
      'orig' => 'warA\'',
      'prefix' => ''
    }
  ],
  ...
  'w s .t' => [
    ...
    },
    {
      ...
      'glosshash' => {
        '"central"' => 1,
        '"central [ [ wusoTA / ADJ ] ]"' => 1,
        '"central [ [ wusoTay / ADJ ] ]"' => 1,
        '"middle"' => 1,
        '"central [ [ wusoTY / ADJ ] ]"' => 1,
        '"central [ [ >awosaT / ADJ ] ]"' => 1
      },
      'orig' => 'OawosaT',
      'prefix' => ''
    },
  ...
  'w l y' => [
    ...
    },
    {
      ...
      'glosshash' => {
        '"most appropriate / suitable / deserving"' => 1,
        '"more / most appropriate / suitable / deserving"' => 1
      },
      'orig' => 'OawolaY',
      'prefix' => ''
    },
  ...
  'w .s y' => [
    ...
    {
      'types' => $lexicon->{'w .s y'}[2]{'types'},
      'entry' => 'wa.sY',
      'form' => 'wa.sAT',
      'others' => $lexicon->{'w .s y'}[2]{'others'},
      'lines' => $lexicon->{'w .s y'}[2]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCaNY |< aT',
      'suffix' => ' |< aT',
      'glosses' => $lexicon->{'w .s y'}[2]{'glosses'},
      'glosshash' => $lexicon->{'w .s y'}[2]{'glosshash'},
      'orig' => 'waSAp',
      'prefix' => ''
    },
    {
  ...
  'w q y' => [
    ...
    {
      'types' => $lexicon->{'w q y'}[0]{'types'},
      'entry' => 'waqY',
      'form' => 'waqY',
      'others' => $lexicon->{'w q y'}[0]{'others'},
      'lines' => $lexicon->{'w q y'}[0]{'lines'},
      'index' => '1',
      'entity' => 'verb',
      'morphs' => 'FaCaNY',
      'glosses' => $lexicon->{'w q y'}[0]{'glosses'},
      'suffix' => '',
      'imperf' => $lexicon->{'w q y'}[0]{'imperf'},
      'glosshash' => $lexicon->{'w q y'}[0]{'glosshash'},
      'orig' => 'waqaY-i',
      'prefix' => ''
    },
    {
    ...
    {
      'types' => $lexicon->{'w q y'}[5]{'types'},
      'entry' => 'wAqiy',
      'form' => 'wAqiy',
      'others' => $lexicon->{'w q y'}[5]{'others'},
      'lines' => $lexicon->{'w q y'}[5]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACI',
      'suffix' => '',
      'glosses' => $lexicon->{'w q y'}[5]{'glosses'},
      'glosshash' => $lexicon->{'w q y'}[5]{'glosshash'},
      'orig' => 'wAqiy',
      'prefix' => ''
    },
    {
  ...
  'w f \'' => [
    ...
    {
      'types' => $lexicon->{'w f y'}[4]{'types'},
      'entry' => 'wafA\'',
      'form' => 'wafA\'',
      'lines' => $lexicon->{'w f y'}[4]{'lines'},
      'index' => '2',
      'entity' => 'noun',
      'morphs' => 'FaCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'w f y'}[4]{'glosses'},
      'glosshash' => $lexicon->{'w f y'}[4]{'glosshash'},
      'orig' => 'wafA\'',
      'prefix' => ''
    }
  ],
  ...
  'w ` \'' => [
    {
      'types' => $lexicon->{'w ` y'}[3]{'types'},
      'entry' => 'wi`A\'',
      'form' => 'wi`A\'',
      'others' => $lexicon->{'w ` y'}[3]{'others'},
      'lines' => $lexicon->{'w ` y'}[3]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FiCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'w ` y'}[3]{'glosses'},
      'glosshash' => $lexicon->{'w ` y'}[3]{'glosshash'},
      'orig' => 'wiEA\'',
      'prefix' => ''
    }
  ],
  ...
  'w ^s y' => [
    ...
    {
      'types' => $lexicon->{'w ^s y'}[0]{'types'},
      'entry' => 'wa^sY',
      'form' => 'wa^sY',
      'others' => $lexicon->{'w ^s y'}[0]{'others'},
      'lines' => $lexicon->{'w ^s y'}[0]{'lines'},
      'index' => '1',
      'entity' => 'verb',
      'morphs' => 'FaCaNY',
      'glosses' => $lexicon->{'w ^s y'}[0]{'glosses'},
      'suffix' => '',
      'imperf' => $lexicon->{'w ^s y'}[0]{'imperf'},
      'glosshash' => $lexicon->{'w ^s y'}[0]{'glosshash'},
      'orig' => 'wa$aY-i',
      'prefix' => ''
    }
  ],
