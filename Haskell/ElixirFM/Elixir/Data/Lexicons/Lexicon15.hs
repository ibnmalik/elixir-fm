...
lexicon = listing "Lexicon properties"
 ...
 |> "'u.d.gu.t" <| [
    ...
    noun     Identity                  {- OuDoguT -}        -- `others` [ ".da.g.t N" ]
 ...
 |> "'u.d.hiyy" <| [
    ...
    noun     Identity |< aT            {- OuDoHiy~ap -}     -- `others` [ "'a.dA.hiyy N0_Nh" ]
                                                            `gloss`  [ "sacrifice [ [ >uDoHiy ~ / NOUN ] ]", "sacrifices" ] ]
 ...
 |> "'u.d.huwk" <| [
    ...
    noun     Identity |< aT            {- OuDoHuwkap -}     -- `others` [ "'a.dA.hiyk Ndip" ]
 ...
 |> "'u.dbuwr" <| [
    ...
    noun     Identity                  {- OuDobuwr -}       `gloss`  [ "file", "document" ] ]
 ...
 |> "'u.dluwl" <| [
    ...
    noun     Identity |< aT            {- OuDoluwlap -}     -- `others` [ "'a.dAliyl Ndip" ]
 ...
 |> ".d ' l" <| [
    ...
    verb     FaCuL                     {- DaWul -}          -- `others` [ ".d'ul IV_intr" ]
    ...
    noun     FiCAL |< aT               {- Di}Alap -}        `gloss`  [ "paucity", "scarcity" ],

    -- ;; Du&uwlap_1
    -- D&wl    Du&uwl  Nap     paucity;scarcity

    noun     FuCUL |< aT               {- DuWuwlap -}       `gloss`  [ "paucity", "scarcity" ],
    ...
    noun     HaFCaL                    {- OaDoOal -}        `gloss`  [ "smaller / smallest" ],

    -- ;; taDA&ul_1
    -- tDA&l   taDA&ul N/At    paucity;scarcity

    noun     TaFACuL                   {- taDAWul -}        `gloss`  [ "paucity", "scarcity" ],

    -- ;; mutaDA}il_1
    -- mtDA}l  mutaDA}il       N-ap    dwindling;declining;decreasing     [[mutaDA}il/ADJ]]

    noun     MutaFACiL                 {- mutaDA}il -}      `gloss`  [ "dwindling", "declining", "decreasing [ [ mutaDA } il / ADJ ] ]" ] ]
 ...
 |> ".d ' m" <| [
    ...
    noun     FAL |< aT                 {- DAmap -}          `gloss`  [ "checkers" ] ]
 ...
 |> ".d ' n" <| [
    ...
    noun     FaCL                      {- DaOon -}          `gloss`  [ "sheep" ],

    -- ;; Da>oniy~_1
    -- D>ny    Da>oniy~        N-ap    mutton;sheep     [[Da>oniy~/ADJ]]

    noun     FaCL |< Iy                {- DaOoniy~ -}       `gloss`  [ "mutton", "sheep [ [ Da>oniy ~ / ADJ ] ]" ],
 ...
 |> ".d ' r" <| [
    ...
    noun     FACiL                     {- DA}ir -}          `gloss`  [ "harmful", "injurious [ [ DA } ir / ADJ ] ]" ] ]
 ...
 |> ".d .g .d .g" <| [
    ...
    noun     KaRDaS |< aT              {- DagoDagap -}      `gloss`  [ "chewing", "munching", "mumbling" ] ]
 ...
 |> ".d .g .t" <| [
    ...
    noun     FaCUL                     {- DaguwT -}         `gloss`  [ "compressible", "coercible [ [ DaguwT / ADJ ] ]" ],

    -- ;; DAguwT_1
    -- DAgwT   DAguwT  N       nightmare

    noun     FACUL                     {- DAguwT -}         `gloss`  [ "nightmare" ],
    ...
    noun     MiFCaL                    {- miDogaT -}        -- `others` [ "mi.d.ga.tiyy N-ap", "ma.dA.gi.t Ndip" ]
                                                            `gloss`  [ "barometer", "barometers", "barometric [ [ miDogaTiy ~ / ADJ ] ]" ],
    ...
    noun     InFiCAL |< Iy |< aT       {- {inoDigATiy~ap -} `gloss`  [ "compressibility [ [ { inoDigATiy ~ / NOUN ] ]" ] ]
 ...
 |> ".d .h .h" <| [
    ...
    verb     FaCLY                     {- DaH~aY -}         -- `others` [ ".da.h.hiy IV_0hAnn_yu", ".da.h.h IV_0hwnyn_yu PV_ttAw", ".da.h.hA PV_h", ".da.h.hay PV_Atn IV_Ann_Pass_yu" ]
 ...
 |> ".d .h k" <| [
    ...
    noun     FuCL |< aT                {- DuHokap -}        `gloss`  [ "laughingstock", "object of ridicule" ],
    ...
    noun     MaFCaL |< aT              {- maDoHakap -}      `gloss`  [ "laughingstock", "object of ridicule" ],

    -- ;; >aDoHak_2
    -- >DHk    >aDoHak Nel     funnier/funniest;more/most ludicrous
    -- ADHk    >aDoHak Nel     funnier/funniest;more/most ludicrous

    noun     HaFCaL                    {- OaDoHak -}        `gloss`  [ "funnier / funniest", "more / most ludicrous" ],
    ...
    noun     FACiL |< aT               {- DAHikap -}        -- `others` [ ".dawA.hik Ndip" ]
                                                            `gloss`  [ "tooth", "teeth" ],
 ...
 |> ".d .h l" <| [
    ...
    noun     FaCL                      {- DaHol -}          -- `others` [ "'a.d.hAl N", ".di.hAl N" ]
                                                            `gloss`  [ "shallow", "superficial [ [ DaHol / ADJ ] ]", "superficial" ],

    -- ;; DaHAlap_1
    -- DHAl    DaHAl   Nap     shallowness;triviality

    noun     FaCAL |< aT               {- DaHAlap -}        `gloss`  [ "shallowness", "triviality" ] ]
 ...
 |> ".d .h w" <| [
    ...
    verb     FaCA                      {- DaHA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ ".d.huw IV_0hAnn", ".d.h IV_0hwnyn", ".da.h PV_ttAw", ".da.haw PV_Atn" ]
    ...
    noun     FaCL |< aT                {- DaHowap -}        -- `others` [ ".da.haw NAt" ]
    ...
    noun     FuCY                      {- DuHaY -}          -- `others` [ ".du.hA Nhy" ]
    ...
    noun     HaFCY                     {- OaDoHaY -}        `gloss`  [ "Adha Feast", "Immolation" ],

    -- ;; >aDoHAp_1
    -- >DHA    >aDoHA  Nap     sacrifice;immolation
    -- ADHA    >aDoHA  Nap     sacrifice;immolation

    noun     HaFCY |< aT               {- OaDoHAp -}        `gloss`  [ "sacrifice", "immolation" ],

    -- ;; DAHiy_1
    -- DAHy    DAHiy   N0F     visible     [[DAHiy/ADJ]]
    -- DAH     DAH     NK      visible

    noun     FACI                      {- DAHiy -}          -- `others` [ ".dA.h NK" ]
                                                            `gloss`  [ "visible [ [ DAHiy / ADJ ] ]", "visible" ],
    ...
    noun     FACY |< Iy                {- DAHawiy~ -}       `gloss`  [ "suburban [ [ DAHawiy ~ / ADJ ] ]" ] ]
 ...
 |> ".d .h y" <| [
    ...
    verb     FaCiL                     {- DaHiy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ ".d.ha IV_0hwnyn", ".d.hay IV_Ann", ".d.hY IV_0", ".da.h PV_w_intr" ]
 ...
 |> ".d .t r" <| [
    ...
    noun     IFCiLAL |< Iy             {- {iDoTirAriy~ -}   `gloss`  [ "obligatory", "forced", "emergency [ [ { iDoTirAriy ~ / ADJ ] ]" ],
 ...
 |> ".d ^g ^g" <| [
    ...
    verb     FaCL                      {- Daj~-i -}         `imperf` [ FCiL ]
                                                            -- `others` [ ".da^ga^g PV_C_intr", ".di^g^g IV_V_intr", ".d^gi^g IV_C_intr" ]
    ...
    verb     HaFaCL                    {- OaDaj~ -}         -- `others` [ "'a.d^ga^g PV_C_intr", ".di^g^g IV_V_intr_yu", ".d^gi^g IV_C_intr_yu" ]
                                                            `gloss`  [ "be noisy", "clamor" ],
    ...
    noun     FaCCAL                    {- Daj~Aj -}         `gloss`  [ "rowdy", "tumultuous [ [ Daj ~ Aj / ADJ ] ]" ],

    -- ;; Dajuwj_1
    -- Djwj    Dajuwj  N-ap    rowdy;tumultuous     [[Dajuwj/ADJ]]

    noun     FaCUL                     {- Dajuwj -}         `gloss`  [ "rowdy", "tumultuous [ [ Dajuwj / ADJ ] ]" ],

    -- ;; muDij~_1
    -- mDj     muDij~  Nall    rowdy;tumultuous     [[muDij~/ADJ]]

    noun     MuFiCL                    {- muDij~ -}         `gloss`  [ "rowdy", "tumultuous [ [ muDij ~ / ADJ ] ]" ] ]
 ...
 |> ".d ^g `" <| [
    ...
    verb     HaFCaL                    {- OaDojaE -}        -- `others` [ ".d^ga` IV_Pass_yu", ".d^gi` IV_yu" ]
    ...
    verb     IFtaCaL                   {- {iDoTajaE -}      -- `others` [ ".d.ta^gi` IV" ]
                                                            `gloss`  [ "lie down", "sleep" ],
    ...
    noun     FaCL |< aT                {- DajoEap -}        `gloss`  [ "lying position" ],

    -- ;; DujoEiy~_1
    -- DjEy    DujoEiy~        Nall    sluggard;late riser     [[DujoEiy~/ADJ]]

    noun     FuCL |< Iy                {- DujoEiy~ -}       `gloss`  [ "sluggard", "late riser [ [ DujoEiy ~ / ADJ ] ]" ],
    ...
    noun     MuFACaL |< aT             {- muDAjaEap -}      `gloss`  [ "sexual intercourse" ],
    ...
    noun     MuFtaCaL                  {- muDoTajaE -}      `gloss`  [ "couch" ] ]
 ...
 |> ".d ^g r" <| [
    ...
    verb     HaFCaL                    {- OaDojar -}        -- `others` [ ".d^gar IV_Pass_yu", ".d^gir IV_yu" ]
    ...
    noun     FaCiL                     {- Dajir -}          `gloss`  [ "irritated", "dissatisfied [ [ Dajir / ADJ ] ]" ],
    ...
    noun     MutaFaCCiL                {- mutaDaj~ir -}     `gloss`  [ "irritated", "dissatisfied [ [ mutaDaj ~ ir / ADJ ] ]" ] ]
 ...
 |> ".d _h m" <| [
    ...
    noun     TaFaCCuL |< Iy            {- taDax~umiy~ -}    `gloss`  [ "inflationary [ [ taDax ~ umiy ~ / ADJ ] ]" ],
 ...
 |> ".d ` .d `" <| [
    ...
    noun     KaRDaS |< aT              {- DaEoDaEap -}      `gloss`  [ "destruction", "debilitation" ],
 ...
 |> ".d ` n" <| [
    ...
    noun     FICAL                     {- DiyEAn -}         `gloss`  [ "loss", "waste" ] ]
 ...
 |> ".d b .t" <| [
    ...
    noun     FaCL |< Iy                {- DaboTiy~ -}       `gloss`  [ "disciplinary [ [ DaboTiy ~ / ADJ ] ]" ],
    ...
    noun     FACiL |< aT               {- DAbiTap -}        `gloss`  [ "controlling device", "restraining order" ],
    ...
    noun     HaFCaL                    {- OaDobaT -}        -- `others` [ ".dab.tA' Nh Nhy N0_Nh", ".dub.t N" ]
                                                            `gloss`  [ "ambidextrous" ],
    ...
    noun     MaFCaL |< aT              {- maDobaTap -}      -- `others` [ "ma.dAbi.t Ndip" ]
    ...
    noun     InFiCAL                   {- {inoDibAT -}      -- `others` [ "in.dibA.tiyy N-ap" ]
                                                            `gloss`  [ "discipline", "precision", "disciplinary", "disciplined [ [ { inoDibATiy ~ / ADJ ] ]" ],
 ...
 |> ".d b b" <| [
    ...
    verb     FaCL                      {- Dab~-i -}         `imperf` [ FCiL ]
                                                            -- `others` [ ".dabab PV_C", ".dbib IV_C", ".dibb IV_V" ]
    ...
    noun     FaCL |< aT                {- Dab~ap -}         `gloss`  [ "lock", "bolt" ],
    ...
    noun     FaCAL |< Iy               {- DabAbiy~ -}       `gloss`  [ "foggy", "nebulous [ [ DabAbiy ~ / ADJ ] ]" ],

    -- ;; DabAbiy~ap_1
    -- DbAby   DabAbiy~        Nap     nebulousness     [[DabAbiy~/NOUN]]

    noun     FaCAL |< Iy |< aT         {- DabAbiy~ap -}     `gloss`  [ "nebulousness [ [ DabAbiy ~ / NOUN ] ]" ],
 ...
 |> ".d b n" <| [
    ...
    verb     IFtaCaL                   {- {iDoTaban -}      -- `others` [ ".d.tabin IV-n" ]
 ...
 |> ".d b r" <| [
    ...
    noun     FiCAL |< aT               {- DibArap -}        -- `others` [ ".dabA'ir Ndip" ]
    ...
    noun     HiFCAL |< aT              {- IiDobArap -}      -- `others` [ "'a.dAbiyr Ndip" ]
                                                            `gloss`  [ "file", "dossier", "files", "dossiers" ],
    ...
    noun     HiFCAL |< Iy              {- IiDobAriy~ -}     `gloss`  [ "bureaucrat", "archivist" ] ]
 ...
 |> ".d b s" <| [
    ...
    noun     FiCL                      {- Dibos -}          `gloss`  [ "nasty", "malicious [ [ Dibos / ADJ ] ]" ] ]
 ...
 |> ".d d d" <| [
    ...
    noun     FiCL |< Iy                {- Did~iy~ -}        `gloss`  [ "anti- [ [ Did ~ iy ~ / ADJ ] ]" ],

    -- ;; Did~iy~ap_1
    -- Ddy     Did~iy~ Nap     enmity;contrariness     [[Did~iy~/NOUN]]

    noun     FiCL |< Iy |< aT          {- Did~iy~ap -}      `gloss`  [ "enmity", "contrariness [ [ Did ~ iy ~ / NOUN ] ]" ],
 ...
 |> ".d f ' r" <| [
    ...
    noun     KaRADiS                   {- DafA}ir -}        `gloss`  [ "braids" ] ]
 ...
 |> ".d f d `" <| [
    ...
    noun     KaRDaS |< Iy              {- DafodaEiy~ -}     `gloss`  [ "frog-like", "amphibian", "batrachian [ [ DafodaEiy ~ / ADJ ] ]" ],

    -- ;; DafodaEiy~At_1
    -- DfdEy   DafodaEiy~      NAt     amphibians;batrachians     [[DafodaEiy~/NOUN]]

    noun     KaRDaS |< Iy |< At        {- DafodaEiy~At -}   -- `others` [ ".dafda`iyy NAt" ]
                                                            `gloss`  [ "amphibians", "batrachians [ [ DafodaEiy ~ / NOUN ] ]" ] ]
 ...
 |> ".d f w" <| [
    ...
    noun     FaCL |< aT                {- Dafowap -}        `gloss`  [ "abundance", "affluence" ] ]
 ...
 |> ".d h d" <| [
    ...
    verb     IFtaCaL                   {- {iDoTahad -}      -- `others` [ ".d.tahid IV" ]
    ...
    noun     IFtiCAL                   {- {iDoTihAd -}      `gloss`  [ "persecution", "oppression" ],

    -- ;; muDoTahid_1
    -- mDThd   muDoTahid       Nall    oppressor;tyrant     [[muDoTahid/ADJ]]

    noun     MuFtaCiL                  {- muDoTahid -}      `gloss`  [ "oppressor", "tyrant [ [ muDoTahid / ADJ ] ]" ],
 ...
 |> ".d h y" <| [
    ...
    noun     FaCIL                     {- Dahiy~ -}         `gloss`  [ "analogous", "similar", "corresponding [ [ Dahiy ~ / ADJ ] ]" ],

    -- ;; muDAhAp_1
    -- mDAhA   muDAhA  Napdu   analogy;comparison;similarity
    -- mDAhy   muDAhay NAt     analogies;comparisons;similarities

    noun     MuFACY |< aT              {- muDAhAp -}        -- `others` [ "mu.dAhay NAt" ]
    ...
    noun     MuFACiL                   {- muDAhiy -}        -- `others` [ "mu.dAh Nuwn_Niyn NK" ]
                                                            `gloss`  [ "analogous", "similar", "corresponding [ [ muDAhiy / ADJ ] ]", "corresponding" ] ]
 ...
 |> ".d l `" <| [
    ...
    verb     IFtaCaL                   {- {iDoTalaE -}      -- `others` [ ".d.tali` IV" ]
    ...
    noun     FiCL |< Iy                {- DiloEiy~ -}       `gloss`  [ "coastal", "lateral [ [ DiloEiy ~ / ADJ ] ]" ],

    -- ;; DaliyE_1
    -- DlyE    DaliyE  N-ap    sturdy;knowledgeable     [[DaliyE/ADJ]]

    noun     FaCIL                     {- DaliyE -}         `gloss`  [ "sturdy", "knowledgeable [ [ DaliyE / ADJ ] ]" ],

    -- ;; DalAEap_1
    -- DlAE    DalAE   Nap     sturdiness

    noun     FaCAL |< aT               {- DalAEap -}        `gloss`  [ "sturdiness" ],
    ...
    noun     IFtiCAL                   {- {iDoTilAE -}      `gloss`  [ "taking on", "assuming", "undertaking", "being familiar with" ],

    -- ;; DAliE_1
    -- DAlE    DAliE   Nall    supporting;having affection for     [[DAliE/ADJ]]
    -- DAlE    DAliE   Nall    supportive;affectionate for     [[DAliE/ADJ]]

    noun     FACiL                     {- DAliE -}          `gloss`  [ "supporting", "having affection for [ [ DAliE / ADJ ] ]", "supportive", "affectionate for [ [ DAliE / ADJ ] ]" ],
    ...
    noun     MuFtaCiL                  {- muDoTaliE -}      `gloss`  [ "knowledgeable", "expert" ] ]
 ...
 |> ".d l l" <| [
    ...
    verb     HaFaCL                    {- OaDal~ -}         -- `others` [ ".dill IV_V_yu", ".dall IV_V_Pass_yu", "'a.dlal PV_C", ".dlil IV_C_yu" ]
    ...
    noun     HiFCAL                    {- IiDolAl -}        `gloss`  [ "misleading", "deception" ],
 ...
 |> ".d m d" <| [
    ...
    noun     FiCAL |< aT               {- DimAdap -}        `gloss`  [ "wrapping with bandages" ],
    ...
    noun     FiCAL |< aT               {- DimAdap -}        -- `others` [ ".damA'id Ndip" ]
                                                            `gloss`  [ "bandage", "bandages" ],
    ...
    noun     MuFaCCiL |< aT            {- muDam~idap -}     `gloss`  [ "compress", "bandage" ] ]
 ...
 |> ".d m m" <| [
    ...
    noun     FaCIL                     {- Damiym -}         `gloss`  [ "joined", "annexed [ [ Damiym / ADJ ] ]" ],

    -- ;; Damiymap_1
    -- Dmym    Damiym  Nap     addition;increase
    -- DmA}m   DamA}im Ndip    additions;increases

    noun     FaCIL |< aT               {- Damiymap -}       -- `others` [ ".damA'im Ndip" ]
    ...
    noun     MaFCUL                    {- maDomuwm -}       `gloss`  [ "joined", "annexed [ [ maDomuwm / ADJ ] ]" ] ]
 ...
 |> ".d m n" <| [
    ...
    noun     FiCL |< aN                {- DimonAF -}        `gloss`  [ "implicitly [ [ DimonAF / ADV ] ]" ],
    ...
    noun     TaFACuL |< Iy             {- taDAmuniy~ -}     `gloss`  [ "in solidarity", "cooperative [ [ taDAmuniy ~ / ADJ ] ]" ],
    ...
    noun     MuFaCCaL                  {- muDam~an -}       `gloss`  [ "included", "implied [ [ muDam ~ an / ADJ ] ]" ],
 ...
 |> ".d m r" <| [
    ...
    verb     FaCaL                     {- Damar-u -}        `imperf` [ FCuL ]
                                                            -- `others` [ ".dmur IV_intr", ".damur PV_intr" ]
    ...
    noun     FaCIL |< Iy               {- Damiyriy~ -}      `gloss`  [ "conscience [ [ Damiyriy ~ / ADJ ] ]" ],
    ...
    noun     FACiL                     {- DAmir -}          -- `others` [ ".dawAmir Ndip" ]
                                                            `gloss`  [ "atrophied", "emaciated [ [ DAmir / ADJ ] ]", "emaciated" ],

    -- ;; muDomar_1
    -- mDmr    muDomar N-ap    tacit;implied;covert     [[muDomar/ADJ]]

    noun     MuFCaL                    {- muDomar -}        `gloss`  [ "tacit", "implied", "covert [ [ muDomar / ADJ ] ]" ] ]
 ...
 |> ".d n '" <| [
    ...
    noun     HiFCAL                    {- IiDonA' -}        `gloss`  [ "debilitation", "exhaustion" ] ]
 ...
 |> ".d n k" <| [
    ...
    noun     FaCAL |< aT               {- DanAkap -}        `gloss`  [ "poverty" ],
    ...
    noun     MuFCiL                    {- muDonik -}        `gloss`  [ "exhausted", "poor [ [ muDonik / ADJ ] ]" ],

    -- ;; Daniyk_1
    -- Dnyk    Daniyk  N-ap    poor;wretched     [[Daniyk/ADJ]]

    noun     FaCIL                     {- Daniyk -}         `gloss`  [ "poor", "wretched [ [ Daniyk / ADJ ] ]" ] ]
 ...
 |> ".d n n" <| [
    ...
    noun     FaCIL                     {- Daniyn -}         -- `others` [ "'a.dinn Nap" ]
                                                            `gloss`  [ "stingy", "economical [ [ Daniyn / ADJ ] ]", "economical" ] ]
 ...
 |> ".d n y" <| [
    ...
    verb     FaCiL                     {- Daniy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ ".dnay IV_Ann", ".dnY IV_0", ".dan PV_w_intr", ".dna IV_0hwnyn" ]
    ...
    verb     HaFCY                     {- OaDonaY -}        -- `others` [ "'a.dnay PV_Atn", ".dn IV_0hwnyn_yu", ".dniy IV_0hAnn_yu", ".dnay IV_Ann_Pass_yu", ".dnY IV_0_Pass_yu", "'a.dnA PV_h", "'a.dn PV_ttAw_intr" ]
                                                            `gloss`  [ "become emaciated", "languish" ],
    ...
    noun     FaCiL                     {- Daniy -}          -- `others` [ ".dan NK" ]
                                                            `gloss`  [ "grief-stricken", "languished [ [ Daniy / ADJ ] ]", "languished" ],
    ...
    noun     HiFCA'                    {- IiDonA' -}        `gloss`  [ "debilitation", "exhaustion" ],
    ...
    noun     MuFCiL                    {- muDoniy -}        -- `others` [ "mu.dn Nuwn_Niyn NK" ]
                                                            `gloss`  [ "debilitating", "exhausting [ [ muDoniy / ADJ ] ]", "exhausting" ],
    ...
    noun     MuFCY                     {- muDonaY -}        -- `others` [ "mu.dn Nuwn_Niyn", "mu.dnay NAt NAn_Nayn", "mu.dnA Napdu Nhy" ]
                                                            `gloss`  [ "debilitated", "exhausted [ [ muDonaY / ADJ ] ]", "exhausted" ] ]
 ...
 |> ".d r ' b" <| [
    ...
    noun     KaRADiS                   {- DarA}ib -}        `gloss`  [ "taxes" ] ]
 ...
 |> ".d r .h" <| [
    ...
    noun     FaCIL |< Iy               {- DariyHiy~ -}      `gloss`  [ "sepulchral", "funerary [ [ DariyHiy ~ / ADJ ] ]" ] ]
 ...
 |> ".d r .t" <| [
    ...
    noun     FaCL |< aT                {- DaroTap -}        -- `others` [ ".dara.t NAt" ]
                                                            `gloss`  [ "fart", "farts" ],
 ...
 |> ".d r `" <| [
    ...
    verb     IFtaCaL                   {- {iDoTaraE -}      -- `others` [ ".d.tari` IV" ]
    ...
    noun     FaCL |< Iy                {- DaroEiy~ -}       `gloss`  [ "mammal [ [ DaroEiy ~ / ADJ ] ]", "mammals [ [ DaroEiy ~ / NOUN ] ]" ],
    ...
    noun     FaCAL |< aT               {- DarAEap -}        `gloss`  [ "humility", "submission" ],

    -- ;; muDAraEap_1
    -- mDArE   muDAraE NapAt   similarity;resemblance

    noun     MuFACaL |< aT             {- muDAraEap -}      `gloss`  [ "similarity", "resemblance" ],
 ...
 |> ".d r b" <| [
    ...
    verb     HaFCaL                    {- OaDorab -}        -- `others` [ ".drib IV_yu", ".drab IV_Pass_yu" ]
    ...
    verb     IFtaCaL                   {- {iDoTarab -}      -- `others` [ ".d.tarib IV_intr" ]
    ...
    noun     HaFCAL                    {- OaDorAb -}        `gloss`  [ "similar", "like" ],
    ...
    noun     MuFaCCaL |< aT            {- muDar~abap -}     `gloss`  [ "mattress", "quilt" ],
    ...
    noun     MuFACaL |< aT             {- muDArabap -}      `gloss`  [ "competition" ],

    -- ;; muDArabiy~_1
    -- mDArby  muDArabiy~      N-ap    speculative     [[muDArabiy~/ADJ]]

    noun     MuFACaL |< Iy             {- muDArabiy~ -}     `gloss`  [ "speculative [ [ muDArabiy ~ / ADJ ] ]" ],
    ...
    noun     IFtiCAL                   {- {iDoTirAb -}      `gloss`  [ "disturbance", "agitation", "disorder" ],
 ...
 |> ".d r m" <| [
    ...
    verb     IFtaCaL                   {- {iDoTaram -}      -- `others` [ ".d.tarim IV_intr" ]
                                                            `gloss`  [ "be inflamed", "flare up" ],
    ...
    noun     MuFtaCiL                  {- muDoTarim -}      `gloss`  [ "burning", "blazing" ],

    -- ;; Daromap_1
    -- Drm     Darom   Nap     fire brand

    noun     FaCL |< aT                {- Daromap -}        `gloss`  [ "fire brand" ],
 ...
 |> ".d r r" <| [
    ...
    verb     IFtaCL                    {- {iDoTar~ -}       -- `others` [ "i.d.tarar PV_C", ".d.tarir IV_C", ".d.tarr IV_V" ]
                                                            `gloss`  [ "compel", "force", "oblige" ],
    ...
    noun     FuCL |< Iy                {- Dur~iy~ -}        `gloss`  [ "polygamist [ [ Dur ~ iy ~ / ADJ ] ]" ],

    -- ;; Dur~iy~ap_1
    -- Dry     Dur~iy~ Nap     polygamy     [[Dur~iy~/NOUN]]

    noun     FuCL |< Iy |< aT          {- Dur~iy~ap -}      `gloss`  [ "polygamy [ [ Dur ~ iy ~ / NOUN ] ]" ],

    -- ;; Dar~ap_1
    -- Dr      Dar~    Napdu   plural wife
    -- DrA}r   DarA}ir Ndip    plural wives

    noun     FaCL |< aT                {- Dar~ap -}         -- `others` [ ".darA'ir Ndip" ]
    ...
    noun     IFtiCAL                   {- {iDoTirAr -}      `gloss`  [ "obligation", "emergency", "urgency" ],

    -- ;; {iDoTirAriy~_1
    -- <DTrAry {iDoTirAriy~    N-ap    obligatory;forced;emergency     [[{iDoTirAriy~/ADJ]]
    -- ADTrAry {iDoTirAriy~    N-ap    obligatory;forced;emergency     [[{iDoTirAriy~/ADJ]]

    noun     IFtiCAL |< Iy             {- {iDoTirAriy~ -}   `gloss`  [ "obligatory", "forced", "emergency [ [ { iDoTirAriy ~ / ADJ ] ]" ],

    -- ;; muDir~_1
    -- mDr     muDir~  N-ap    harmful;injurious     [[muDir~/ADJ]]

    noun     MuFiCL                    {- muDir~ -}         `gloss`  [ "harmful", "injurious [ [ muDir ~ / ADJ ] ]" ],
    ...
    verb     FaCLY                     {- Dar~aY -}         -- `others` [ ".darr IV_0hwnyn_yu PV_ttAw", ".darrA PV_h", ".darriy IV_0hAnn_yu", ".darray PV_Atn IV_Ann_Pass_yu" ]
                                                            `gloss`  [ "provoke", "excite", "be provoked", "be excited" ] ]
 ...
 |> ".d r s" <| [
    ...
    verb     HaFCaL                    {- OaDoras -}        -- `others` [ ".dras IV_Pass_yu", ".dris IV_yu" ]
 ...
 |> ".d r y" <| [
    ...
    noun     TaFCiL |< aT              {- taDoriyap -}      `gloss`  [ "provocation" ] ]
 ...
 |> ".d w '" <| [
    ...
    verb     FAL                       {- DA'-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ ".du' PV_C IV_C", ".duw' IV_V IV_wn IV_yn" ]
    ...
    verb     FaCCaL                    {- Daw~aO -}         -- `others` [ ".dawwi' IV_wn_yu IV_yu" ]
                                                            `gloss`  [ "shine", "illuminate" ],
    ...
    verb     TaFaCCaL                  {- taDaw~aO -}       -- `others` [ "ta.dawwa'A IV-|" ]
                                                            `gloss`  [ "shine", "illuminate" ],
    ...
    noun     MuFAL                     {- muDA' -}          `gloss`  [ "bright", "illuminated [ [ muDA ' / ADJ ] ]" ],
    ...
    noun     InFiCAL                   {- {inoDiwA' -}      `gloss`  [ "seeking refuge", "rallying around" ] ]
 ...
 |> ".d w .d" <| [
    ...
    noun     FaCLY                     {- DawoDaY -}        -- `others` [ ".daw.dA Nhy" ]
                                                            `gloss`  [ "tumult", "noise" ] ]
 ...
 |> ".d w .g .t" <| [
    ...
    noun     KaRADiS                   {- DawAgiT -}        -- `others` [ "ma.d.guw.t N-ap" ]
                                                            `gloss`  [ "compressors", "compressed" ] ]
 ...
 |> ".d w `" <| [
    ...
    verb     FAL                       {- DAE-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ ".duw` IV_V_intr", ".du` IV_C_intr PV_C_intr" ]
 ...
 |> ".d w r" <| [
    ...
    noun     FA'iL                     {- DA}ir -}          `gloss`  [ "harmful", "injurious [ [ DA } ir / ADJ ] ]" ],

    -- ;; mutaDaw~ir_1
    -- mtDwr   mutaDaw~ir      Nall    starving     [[mutaDaw~ir/ADJ]]

    noun     MutaFaCCiL                {- mutaDaw~ir -}     `gloss`  [ "starving [ [ mutaDaw ~ ir / ADJ ] ]" ] ]
 ...
 |> ".d w r y" <| [
    ...
    noun     KaRADiS                   {- DawAriy -}        -- `others` [ ".dawAr NK" ]
                                                            `gloss`  [ "predatory animals" ] ]
 ...
 |> ".d w y" <| [
    ...
    verb     FaCY                      {- DawaY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ ".dwY IV_0_Pass_yu", ".dwiy IV_0hAnn", ".daw PV_ttAw", ".dawA PV_h", ".dw IV_0hwnyn", ".daway PV_Atn" ]
    ...
    verb     HaFCY                     {- OaDowaY -}        -- `others` [ ".dwY IV_0_Pass_yu", ".dwiy IV_0hAnn_yu", "'a.dway PV_Atn", ".dway IV_Ann_Pass_yu", "'a.dw PV_ttAw", ".dw IV_0hwnyn_yu", "'a.dwA PV_h" ]
    ...
    noun     FACiL                     {- DAwiy -}          -- `others` [ ".dAw Nuwn_Niyn NK" ]
                                                            `gloss`  [ "weak", "thin [ [ DAwiy / ADJ ] ]", "thin" ],
    ...
    noun     MunFaCiL                  {- munoDawiy -}      -- `others` [ "mun.daw Nuwn_Niyn NK" ]
                                                            `gloss`  [ "seeking refuge", "rallying around [ [ munoDawiy / ADJ ] ]", "rallying around" ] ]
 ...
 |> ".d y '" <| [
    ...
    noun     FiCA'                     {- DiyA' -}          `gloss`  [ "light", "glow" ],
    ...
    noun     FiCA' |< Iy               {- DiyA}iy~ -}       `gloss`  [ "luminous", "clear [ [ DiwA } iy ~ / ADJ ] ]" ],

    -- ;; DiyA}iy~_1
    -- DyA}y   DiyA}iy~        N-ap    luminous;clear     [[DiwA}iy~/ADJ]]

    noun     FiCAL |< Iy               {- DiyA}iy~ -}       `gloss`  [ "luminous", "clear [ [ DiwA } iy ~ / ADJ ] ]" ],

    -- ;; DiyA}iy~ap_1
    -- DyA}y   DiyA}iy~        Nap     luminosity;clarity     [[DiwA}iy~/NOUN]]

    noun     FiCA' |< Iy |< aT         {- DiyA}iy~ap -}     `gloss`  [ "luminosity", "clarity [ [ DiwA } iy ~ / NOUN ] ]" ],

    -- ;; DiyA}iy~ap_1
    -- DyA}y   DiyA}iy~        Nap     luminosity;clarity     [[DiwA}iy~/NOUN]]

    noun     FiCAL |< Iy |< aT         {- DiyA}iy~ap -}     `gloss`  [ "luminosity", "clarity [ [ DiwA } iy ~ / NOUN ] ]" ],
 ...
 |> ".d y `" <| [
    ...
    noun     FaCL |< aT                {- DayoEap -}        `gloss`  [ "loss", "waste" ],
    ...
    noun     MaFIL |< aT               {- maDiyEap -}       `gloss`  [ "loss", "ruin" ],
    ...
    noun     MuFiCL |< aT              {- muDiyEap -}       `gloss`  [ "waste", "loss" ],

    -- ;; muDay~iE_1
    -- mDyE    muDay~iE        Nall    squandering;wasteful     [[muDay~iE/ADJ]]

    noun     MuFaCCiL                  {- muDay~iE -}       `gloss`  [ "squandering", "wasteful [ [ muDay ~ iE / ADJ ] ]" ] ]
 ...
 |> ".d y f" <| [
    ...
    noun     FiCAL |< aT               {- DiyAfap -}        `gloss`  [ "hospitality", "hosting" ],
    ...
    noun     MaFAL |< aT               {- maDAfap -}        -- `others` [ "ma.dA'if Ndip" ]
    ...
    noun     MuFiCL |< aN              {- muDiyfAF -}       -- `others` [ "mu.diyf NF" ]
                                                            `gloss`  [ "adding [ [ muDiyf / ADV ] ]" ],
    ...
    noun     MuFiCL |< aT              {- muDiyfap -}       `gloss`  [ "stewardess", "hostess" ],
    ...
    noun     IstiFAL |< aT             {- {isotiDAfap -}    `gloss`  [ "hosting" ] ]
 ...
 |> ".d y m" <| [
    ...
    verb     FAL                       {- DAm-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ ".dim PV_C IV_C", ".diym IV_V" ]
 ...
 |> ".d y q" <| [
    ...
    noun     MuFACiL                   {- muDAyiq -}        `gloss`  [ "troublesome", "annoying [ [ muDAyiq / ADJ ] ]" ],

    -- ;; mutaDAyiq_1
    -- mtDAyq  mutaDAyiq       Nall    annoyed;inconvenienced     [[mutaDAyiq/ADJ]]

    noun     MutaFACiL                 {- mutaDAyiq -}      `gloss`  [ "annoyed", "inconvenienced [ [ mutaDAyiq / ADJ ] ]" ] ]
 ...
 |> ".darab_hAn" <| [
    ...
    noun     Identity |< aT            {- DaraboxAnap -}    `gloss`  [ "money mint" ] ]
 ...
 |> "mu.dma.hill" <| [
    ...
    noun     Identity                  {- muDomaHil~ -}     `gloss`  [ "disappearing", "fading [ [ muDomaHil ~ / ADJ ] ]" ] ]
 ...
 |> "muta.dAdd" <| [
    ...
    noun     Identity                  {- mutaDAd~ -}       `gloss`  [ "opposing", "contrary", "antagonistic [ [ mutaDAd ~ / ADJ ] ]" ] ]
