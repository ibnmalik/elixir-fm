...
$lexicon = {
  ...
  '.g d w' => [
    ...
    {
      'types' => $lexicon->{'.g d w'}[2]{'types'},
      'entry' => '.gadY',
      'form' => '.gadAT',
      'others' => $lexicon->{'.g d w'}[2]{'others'},
      'lines' => $lexicon->{'.g d w'}[2]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCaNY |< aT',
      'suffix' => ' |< aT',
      'glosses' => $lexicon->{'.g d w'}[2]{'glosses'},
      'glosshash' => $lexicon->{'.g d w'}[2]{'glosshash'},
      'orig' => 'gadAp',
      'prefix' => ''
    }
  ],
  ...
  '.g b \'' => [
    {
      'types' => $lexicon->{'.g b y'}[1]{'types'},
      'entry' => '.gabA\'',
      'form' => '.gabA\'',
      'lines' => $lexicon->{'.g b y'}[1]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'.g b y'}[1]{'glosses'},
      'glosshash' => $lexicon->{'.g b y'}[1]{'glosshash'},
      'orig' => 'gabA\'',
      'prefix' => ''
    }
  ],
  ...
  '.g l b' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"majority [ [ >agolabiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"majority [ [ >agolabiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'Oagolabiy~ap',
      'prefix' => ''
    },
  ...
  '.g w \'' => [
    {
      'types' => $lexicon->{'.g w y'}[0]{'types'},
      'entry' => '\'i.gwA\'',
      'form' => '\'i.gwA\'',
      'lines' => $lexicon->{'.g w y'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'HiFCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'.g w y'}[0]{'glosses'},
      'glosshash' => $lexicon->{'.g w y'}[0]{'glosshash'},
      'orig' => 'IigowA\'',
      'prefix' => ''
    }
  ],
