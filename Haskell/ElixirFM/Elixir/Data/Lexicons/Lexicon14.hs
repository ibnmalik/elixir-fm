...
lexicon = listing "Lexicon properties"
 ...
 |> ".s l w" <| [
    ...
    noun     FaCaNY |< aT              {- SalAp -}          `others` [ ".sal_aw Nap", ".salaw NAt" ]
 ...
 |> ".sAruw_h" <| [
    ...
    noun     Identity |< Iy            {- SAruwxiy~ -}      `gloss`  [ "missile", "rocket [ [ SAruwxiy ~ / ADJ ] ]" ] ]
 ...
 |> "mi.sfY" <| [
    ...
    noun     Identity |< aT            {- miSofAp -}        `others` [ "ma.sAf NK", "ma.sAfiy N0_Nh" ]
