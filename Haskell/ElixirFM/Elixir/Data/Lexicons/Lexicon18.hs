...
lexicon = listing "Lexicon properties"
 ...
 |> "'i`n" <| [
    ...
    noun     Identity |< At            {- IiEonAt -}        `gloss`  [ "torment", "harassment" ] ]
 ...
 |> "'u`^guwb" <| [
    ...
    noun     Identity |< aT            {- OuEojuwbap -}     -- `others` [ "b'u`^guwbT FW-Wa" ]
    ...
    noun     Identity |< aT            {- OuEojuwbap -}     -- `others` [ "'a`A^giyb Ndip" ]
 ...
 |> "'u`luwm" <| [
    ...
    noun     Identity |< aT            {- OuEoluwmap -}     -- `others` [ "'a`Aliym Ndip" ]
                                                            `gloss`  [ "sign" ] ]
 ...
 |> "` ' b" <| [
    ...
    noun     FACiL                     {- EA}ib -}          `gloss`  [ "defective", "shameful [ [ EA } ib / ADJ ] ]" ] ]
 ...
 |> "` ' d" <| [
    ...
    noun     FACiL |< aT               {- EA}idap -}        -- `others` [ "`awA'id Ndip" ]
                                                            `gloss`  [ "profit", "profits", "revenues", "royalties" ],

    -- ;; EA}idiy~ap_1
    -- EA}dy   EA}idiy~        Nap     membership;belonging to     [[EA}idiy~/NOUN]]

    noun     FACiL |< Iy |< aT         {- EA}idiy~ap -}     `gloss`  [ "membership", "belonging to [ [ EA } idiy ~ / NOUN ] ]" ] ]
 ...
 |> "` ' l" <| [
    ...
    noun     FACiL |< aT               {- EA}ilap -}        -- `others` [ "`A'il NAt", "`awA'il Ndip" ]
                                                            `gloss`  [ "family", "household", "families", "households" ],

    -- ;; EA}iliy~_1
    -- EA}ly   EA}iliy~        N-ap    family;domestic     [[EA}iliy~/ADJ]]

    noun     FACiL |< Iy               {- EA}iliy~ -}       `gloss`  [ "family", "domestic [ [ EA } iliy ~ / ADJ ] ]" ] ]
 ...
 |> "` .d .d" <| [
    ...
    noun     FaCL |< aT                {- EaD~ap -}         -- `others` [ "`a.d.d NAt" ]
                                                            `gloss`  [ "bite", "bites" ],
    ...
    noun     FaCUL                     {- EaDuwD -}         `gloss`  [ "biting", "mordacious [ [ EaDuwD / ADJ ] ]" ] ]
 ...
 |> "` .d d" <| [
    ...
    noun     TaFACuL |< Iy             {- taEADudiy~ -}     `gloss`  [ "supportive", "cooperative [ [ taEADudiy ~ / ADJ ] ]" ],

    -- ;; taEADudiy~ap_1
    -- tEADdy  taEADudiy~      NapAt   cooperative association;co-op     [[taEADudiy~/NOUN]]

    noun     TaFACuL |< Iy |< aT       {- taEADudiy~ap -}   `gloss`  [ "cooperative association", "co-op [ [ taEADudiy ~ / NOUN ] ]" ],
 ...
 |> "` .d l" <| [
    ...
    verb     HaFCaL                    {- OaEoDal -}        -- `others` [ "`.dil IV_intr_yu" ]
    ...
    noun     FaCiL                     {- EaDil -}          `gloss`  [ "muscular [ [ EaDil / ADJ ] ]" ],

    -- ;; EaDalap_1
    -- EDl     EaDal   Napdu   muscle
    -- EDl     EaDal   NAt     muscles

    noun     FaCaL |< aT               {- EaDalap -}        -- `others` [ "`a.dal NAt" ]
                                                            `gloss`  [ "muscle", "muscles" ],

    -- ;; EaDaliy~_1
    -- EDly    EaDaliy~        N-ap    muscular     [[EaDaliy~/ADJ]]

    noun     FaCaL |< Iy               {- EaDaliy~ -}       `gloss`  [ "muscular [ [ EaDaliy ~ / ADJ ] ]" ],
    ...
    noun     MuFCiL                    {- muEoDil -}        `gloss`  [ "problematic", "enigmatic [ [ muEoDil / ADJ ] ]" ],

    -- ;; muEoDilap_1
    -- mEDl    muEoDil NapAt   problem;difficulty
    -- mEADl   maEADil Ndip    problems;difficulties

    noun     MuFCiL |< aT              {- muEoDilap -}      -- `others` [ "ma`A.dil Ndip" ]
 ...
 |> "` .d w" <| [
    ...
    noun     MuFaCCI                   {- muEaD~iy -}       -- `others` [ "mu`a.d.d NK" ]
                                                            `gloss`  [ "fissiparous ( reproducing by spitting ) [ [ muEaD ~ iy / ADJ ] ]", "fissiparous ( reproducing by spitting )" ] ]
 ...
 |> "` .d w y" <| [
    ...
    noun     KuRDIS                    {- EuDowiy~ -}       `gloss`  [ "organic [ [ EuDowiy ~ / ADJ ] ]" ],

    -- ;; EuDowiy~ap_1
    -- EDwy    EuDowiy~        NapAt   membership;affiliation     [[EuDowiy~/NOUN]]

    noun     KuRDIS |< aT              {- EuDowiy~ap -}     `gloss`  [ "membership", "affiliation [ [ EuDowiy ~ / NOUN ] ]" ] ]
 ...
 |> "` .d y" <| [
    ...
    noun     TaFCiL |< aT              {- taEoDiyap -}      `gloss`  [ "forming groups", "reproducing by spitting" ],
 ...
 |> "` .s '" <| [
    ...
    noun     IstiFCAL                  {- {isotiEoSA' -}    `gloss`  [ "obstinacy", "difficulty" ],
    ...
    noun     IstiFCAL                  {- {isotiEoSA' -}    `gloss`  [ "failure", "malfunction", "failures", "malfunctions" ] ]
 ...
 |> "` .s b" <| [
    ...
    verb     HaFCaL                    {- OaEoSab -}        -- `others` [ "`.sab IV_Pass_yu", "`.sib IV_yu" ]
    ...
    noun     FaCaL |< Iy               {- EaSabiy~ -}       `gloss`  [ "nervous [ [ EaSabiy ~ / ADJ ] ]" ],

    -- ;; EaSabiy~ap_1
    -- ESby    EaSabiy~        NapAt   chauvinism;fanaticism     [[EaSabiy~/NOUN]]

    noun     FaCaL |< Iy |< aT         {- EaSabiy~ap -}     `gloss`  [ "chauvinism", "fanaticism [ [ EaSabiy ~ / NOUN ] ]" ],
    ...
    noun     FaCaL |< aT               {- EaSabap -}        -- `others` [ "`a.sab NAt", "`u.sab N" ]
    ...
    noun     FiCAL |< aT               {- EiSAbap -}        -- `others` [ "`a.sA'ib Ndip", "`i.sAb NAt" ]
    ...
    noun     FuCAL |< Iy               {- EuSAbiy~ -}       `gloss`  [ "neurotic [ [ EuSAbiy ~ / ADJ ] ]" ],

    -- ;; EuSAbiy~ap_1
    -- ESAby   EuSAbiy~        Nap     neurosis     [[EuSAbiy~/NOUN]]

    noun     FuCAL |< Iy |< aT         {- EuSAbiy~ap -}     `gloss`  [ "neurosis [ [ EuSAbiy ~ / NOUN ] ]" ],
    ...
    noun     TaFaCCuL |< Iy            {- taEaS~ubiy~ -}    `gloss`  [ "fanatical", "intolerant", "chauvinist [ [ taEaS ~ ubiy ~ / ADJ ] ]" ],
 ...
 |> "` .s d" <| [
    ...
    noun     FaCIL |< aT               {- EaSiydap -}       -- `others` [ "`a.sA'id Ndip" ]
 ...
 |> "` .s f" <| [
    ...
    verb     HaFCaL                    {- OaEoSaf -}        -- `others` [ "`.sif IV_intr_yu" ]
                                                            `gloss`  [ "be stormy", "be tempestuous" ],
    ...
    noun     FaCL |< aT                {- EaSofap -}        `gloss`  [ "gust of wind", "blast" ],

    -- ;; EuSAfap_1
    -- ESAf    EuSAf   Nap     chaff;straw

    noun     FuCAL |< aT               {- EuSAfap -}        `gloss`  [ "chaff", "straw" ],
    ...
    noun     FACiL |< aT               {- EASifap -}        -- `others` [ "`awA.sif Ndip" ]
 ...
 |> "` .s f r" <| [
    ...
    noun     KuRDuS                    {- EuSofur -}        `gloss`  [ "safflower", "red dye" ],

    -- ;; muEaSofar_1
    -- mESfr   muEaSofar       N-ap    dyed in red     [[muEaSofar/ADJ]]

    noun     MuKaRDaS                  {- muEaSofar -}      `gloss`  [ "dyed in red [ [ muEaSofar / ADJ ] ]" ],
    ...
    noun     KuRDUS |< Iy |< aT        {- EuSofuwriy~ap -}  `gloss`  [ "madhouse", "insane asylum [ [ EuSofuwriy ~ / NOUN ] ]" ] ]
 ...
 |> "` .s m" <| [
    ...
    noun     FuCL |< aT                {- EuSomap -}        -- `others` [ "'a`.sAm N" ]
                                                            `gloss`  [ "collar", "necklace", "collars", "necklaces" ],

    -- ;; EiSomap_1
    -- ESm     EiSom   Nap     chastity;innocence

    noun     FiCL |< aT                {- EiSomap -}        `gloss`  [ "chastity", "innocence" ],
    ...
    noun     FiCAL |< Iy               {- EiSAmiy~ -}       `gloss`  [ "distinguished", "noble", "self-made [ [ EiSAmiy ~ / ADJ ] ]" ],

    -- ;; EiSAmiy~ap_1
    -- ESAmy   EiSAmiy~        Nap     nobility;self-made success     [[EiSAmiy~/NOUN]]

    noun     FiCAL |< Iy |< aT         {- EiSAmiy~ap -}     `gloss`  [ "nobility", "self-made success [ [ EiSAmiy ~ / NOUN ] ]" ],
    ...
    noun     FACiL |< aT               {- EASimap -}        -- `others` [ "`awA.sim Ndip" ]
    ...
    noun     MaFCUL                    {- maEoSuwm -}       `gloss`  [ "impeccable", "inviolable [ [ maEoSuwm / ADJ ] ]" ],

    -- ;; maEoSuwmiy~ap_1
    -- mESwmy  maEoSuwmiy~     Nap     chastity;innocence     [[maEoSuwmiy~/NOUN]]

    noun     MaFCUL |< Iy |< aT        {- maEoSuwmiy~ap -}  `gloss`  [ "chastity", "innocence [ [ maEoSuwmiy ~ / NOUN ] ]" ],
    ...
    noun     HaFCaL                    {- OaEoSam -}        -- `others` [ "`a.smA' Nh Nhy N0_Nh", "`u.sm N" ]
 ...
 |> "` .s r" <| [
    ...
    noun     FaCL |< Iy                {- EaSoriy~ -}       `gloss`  [ "modern", "contemporary [ [ EaSoriy ~ / ADJ ] ]" ],
    ...
    noun     FaCCAL |< aT              {- EaS~Arap -}       `gloss`  [ "press", "wringer" ],
    ...
    noun     MiFCaL |< aT              {- miEoSarap -}      -- `others` [ "ma`A.sir Ndip" ]
    ...
    noun     MutaFACiL                 {- mutaEASir -}      `gloss`  [ "synchronic [ [ mutaEASir / ADJ ] ]" ],

    -- ;; EASirap_1
    -- EASr    EASir   Nap     sphincter

    noun     FACiL |< aT               {- EASirap -}        `gloss`  [ "sphincter" ],

    -- ;; maEoSuwr_1
    -- mESwr   maEoSuwr        Nall    compressed;squeezed     [[maEoSuwr/ADJ]]

    noun     MaFCUL                    {- maEoSuwr -}       `gloss`  [ "compressed", "squeezed [ [ maEoSuwr / ADJ ] ]" ] ]
 ...
 |> "` .s r y" <| [
    ...
    noun     KaRADiS                   {- EaSAriy -}        -- `others` [ "`a.sAr NK" ]
 ...
 |> "` .s w" <| [
    ...
    noun     FaCY |< aT                {- EaSAp -}          `gloss`  [ "stick", "baton", "rod", "staff" ],

    -- ;; EuSawiy~_1
    -- ESwy    EuSawiy~        Nall    bacillary;tubercular     [[EuSawiy~/ADJ]]

    noun     FuCY |< Iy                {- EuSawiy~ -}       `gloss`  [ "bacillary", "tubercular [ [ EuSawiy ~ / ADJ ] ]" ] ]
 ...
 |> "` .s y" <| [
    ...
    noun     FaCAL |< aT               {- EaSAyap -}        `gloss`  [ "stick", "baton", "rod", "staff" ],

    -- ;; EuSay~ap_1
    -- ESy     EuSay~  NapAt   bacillus

    noun     FuCayL |< aT              {- EuSay~ap -}       `gloss`  [ "bacillus" ],
    ...
    verb     FaCY                      {- EaSaY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ "`a.say PV_Atn", "`.sY IV_0_Pass_yu", "`a.sA PV_h", "`.siy IV_0hAnn", "`.s IV_0hwnyn", "`a.s PV_ttAw" ]
    ...
    noun     FaCIL                     {- EaSiy~ -}         -- `others` [ "'a`.siyA' Nh Nhy N0_Nh" ]
    ...
    noun     MaFCiL |< aT              {- maEoSiyap -}      -- `others` [ "ma`A.siy N0_Nh", "ma`A.s NK" ]
                                                            `gloss`  [ "insubordination", "rebellion", "rebellions" ],

    -- ;; maEoSiyap_2
    -- mESy    maEoSiy Nap     disobedience;sin

    noun     MaFCiL |< aT              {- maEoSiyap -}      `gloss`  [ "disobedience", "sin" ],
    ...
    noun     FACiL                     {- EASiy -}          -- `others` [ "`u.sA Nap", "`A.s Nuwn_Niyn NK" ]
                                                            `gloss`  [ "rebellious", "insubordinate [ [ EASiy / ADJ ] ]", "insubordinate" ],
    ...
    noun     MutaFaCCiL                {- mutaEaS~iy -}     -- `others` [ "muta`a.s.s Nuwn_Niyn NK" ]
                                                            `gloss`  [ "difficult", "incurable [ [ mutaEaS ~ iy / ADJ ] ]", "incurable" ],
 ...
 |> "` .t ^s" <| [
    ...
    verb     HaFCaL                    {- OaEoTa$ -}        -- `others` [ "`.ta^s IV_Pass_yu", "`.ti^s IV_yu" ]
    ...
    noun     FACiL                     {- EATi$ -}          `gloss`  [ "thirsty", "desirous [ [ EATi $ / ADJ ] ]" ],

    -- ;; mutaEaT~i$_1
    -- mtET$   mutaEaT~i$      Nall    thirsty;desirous     [[mutaEaT~i$/ADJ]]

    noun     MutaFaCCiL                {- mutaEaT~i$ -}     `gloss`  [ "thirsty", "desirous [ [ mutaEaT ~ i $ / ADJ ] ]" ],
 ...
 |> "` .t ` .t" <| [
    ...
    noun     KaRDaS |< aT              {- EaToEaTap -}      `gloss`  [ "clamoring", "yelling" ] ]
 ...
 |> "` .t b" <| [
    ...
    verb     HaFCaL                    {- OaEoTab -}        -- `others` [ "`.tab IV_Pass_yu", "`.tib IV_yu" ]
    ...
    noun     FaCUL                     {- EaTuwb -}         `gloss`  [ "fragile [ [ EaTuwb / ADJ ] ]" ],
 ...
 |> "` .t f" <| [
    ...
    noun     FaCL |< aT                {- EaTofap -}        `gloss`  [ "turn", "bend" ],

    -- ;; EaTofap_2
    -- ETf     EaTof   Napdu   lane;alley
    -- ETf     EaTaf   NAt     lanes;alleys

    noun     FaCL |< aT                {- EaTofap -}        -- `others` [ "`a.taf NAt" ]
    ...
    noun     FaCUL                     {- EaTuwf -}         `gloss`  [ "sympathetic", "affectionate [ [ EaTuwf / ADJ ] ]" ],

    -- ;; EuTuwfap_1
    -- ETwf    EuTuwf  Nap     affection;benevolence

    noun     FuCUL |< aT               {- EuTuwfap -}       `gloss`  [ "affection", "benevolence" ],
    ...
    noun     TaFACuL |< Iy             {- taEATufiy~ -}     `gloss`  [ "sympathetic [ [ taEATufiy ~ / ADJ ] ]" ],
    ...
    noun     InFiCAL |< aT             {- {inoEiTAfap -}    `gloss`  [ "turnaround", "spin" ],
    ...
    noun     IstiFCAL |< Iy            {- {isotiEoTAfiy~ -} `gloss`  [ "propitiatory [ [ { isotiEoTAfiy ~ / ADJ ] ]" ],
    ...
    noun     FACiL                     {- EATif -}          `gloss`  [ "sympathetic", "affectionate [ [ EATif / ADJ ] ]" ],

    -- ;; EATifap_1
    -- EATf    EATif   Nap     emotion;affection
    -- EwATf   EawATif Ndip    emotions;sentiments

    noun     FACiL |< aT               {- EATifap -}        -- `others` [ "`awA.tif Ndip" ]
                                                            `gloss`  [ "emotion", "affection", "emotions", "sentiments" ],

    -- ;; EATifiy~_1
    -- EATfy   EATifiy~        Nall    emotional;affectionate     [[EATifiy~/ADJ]]

    noun     FACiL |< Iy               {- EATifiy~ -}       `gloss`  [ "emotional", "affectionate [ [ EATifiy ~ / ADJ ] ]" ],

    -- ;; EATifiy~ap_1
    -- EATfy   EATifiy~        Nap     sentimentalism;emotionalism     [[EATifiy~/NOUN]]

    noun     FACiL |< Iy |< aT         {- EATifiy~ap -}     `gloss`  [ "sentimentalism", "emotionalism [ [ EATifiy ~ / NOUN ] ]" ],

    -- ;; EawATifiy~ap_1
    -- EwATfy  EawATifiy~      Nap     sentimentalism;emotionalism     [[EawATifiy~/NOUN]]

    noun     FawACiL |< Iy |< aT       {- EawATifiy~ap -}   `gloss`  [ "sentimentalism", "emotionalism [ [ EawATifiy ~ / NOUN ] ]" ],
    ...
    noun     MustaFCiL                 {- musotaEoTif -}    `gloss`  [ "imploring", "propitiating [ [ musotaEoTif / ADJ ] ]" ] ]
 ...
 |> "` .t l" <| [
    ...
    noun     FuCL |< aT                {- EuTolap -}        `gloss`  [ "holiday", "vacation", "recess" ],

    -- ;; EaTAlap_1
    -- ETAl    EaTAl   Nap     unemployment;idleness;inertia

    noun     FaCAL |< aT               {- EaTAlap -}        `gloss`  [ "unemployment", "idleness", "inertia" ],
    ...
    noun     FACiL                     {- EATil -}          `gloss`  [ "inert", "inactive [ [ EATil / ADJ ] ]" ],
 ...
 |> "` .t r" <| [
    ...
    noun     FaCiL                     {- EaTir -}          `gloss`  [ "fragrant", "aromatic [ [ EaTir / ADJ ] ]" ],

    -- ;; EiToriy~_1
    -- ETry    EiToriy~        N-ap    fragrant;aromatic     [[EiToriy~/ADJ]]

    noun     FiCL |< Iy                {- EiToriy~ -}       `gloss`  [ "fragrant", "aromatic [ [ EiToriy ~ / ADJ ] ]" ],

    -- ;; EiToriy~ap_1
    -- ETry    EiToriy~        NapAt   aromatic     [[EiToriy~/NOUN]]

    noun     FiCL |< Iy |< aT          {- EiToriy~ap -}     `gloss`  [ "aromatic [ [ EiToriy ~ / NOUN ] ]" ],
    ...
    noun     FiCAL |< aT               {- EiTArap -}        `gloss`  [ "perfume trade" ],
    ...
    noun     MuFaCCaL                  {- muEaT~ar -}       `gloss`  [ "perfumed", "scented [ [ muEaT ~ ar / ADJ ] ]" ],

    -- ;; maEoTarap_1
    -- mETr    maEoTar NapAt   perfume shop

    noun     MaFCaL |< aT              {- maEoTarap -}      `gloss`  [ "perfume shop" ],
 ...
 |> "` .t s" <| [
    ...
    noun     FaCL |< aT                {- EaTosap -}        -- `others` [ "`a.tas NAt" ]
 ...
 |> "` .t w n" <| [
    ...
    noun     KaRDAS                    {- EaTowAn -}        `gloss`  [ "Atwan" ] ]
 ...
 |> "` .t y" <| [
    ...
    noun     FaCY |< Iy                {- EaTawiy~ -}       `gloss`  [ "Attawi" ],
    ...
    noun     FaCIL |< aT               {- EaTiy~ap -}       `gloss`  [ "Atiyya" ],

    -- ;; EaTiy~ap_2
    -- ETy     EaTiy~  Napdu   gift;present     [[EaTiy~/NOUN]]
    -- ETAyA   EaTAyA  N0_Nhy  gifts;presents

    noun     FaCIL |< aT               {- EaTiy~ap -}       -- `others` [ "`a.tAyA N0_Nhy" ]
                                                            `gloss`  [ "gift", "present [ [ EaTiy ~ / NOUN ] ]", "gifts", "presents" ],

    -- ;; muEATAp_1
    -- mEATA   muEATA  Napdu   pursuit;devotion
    -- mEATy   muEATay NAt     pursuits;devotion

    noun     MuFACY |< aT              {- muEATAp -}        -- `others` [ "mu`A.tay NAt" ]
    ...
    noun     TaFACI                    {- taEATiy -}        -- `others` [ "ta`A.t NK" ]
    ...
    noun     IstiFCA'                  {- {isotiEoTA' -}    `gloss`  [ "begging", "mendacity" ],
    ...
    noun     MuFCY                     {- muEoTaY -}        -- `others` [ "mu`.tay NAn_Nayn", "mu`.tA Napdu Nhy" ]
                                                            `gloss`  [ "given" ],
 ...
 |> "` .z '" <| [
    ...
    noun     FiCAL |< aT               {- EiZA'ap -}        -- `others` [ "`i.zA' Nh Nhy N0_Nh" ]
 ...
 |> "` .z l" <| [
    ...
    noun     MuFACaL |< aT             {- muEAZalap -}      `gloss`  [ "repetition", "gibberish", "tautology" ] ]
 ...
 |> "` .z m" <| [
    ...
    verb     HaFCaL                    {- OaEoZam -}        -- `others` [ "`.zam IV_Pass_yu", "`.zim IV_yu" ]
    ...
    noun     FiCAL |< Iy               {- EiZAmiy~ -}       `gloss`  [ "bone", "osteological [ [ EiZAmiy ~ / ADJ ] ]" ],

    -- ;; EaZomiy~_1
    -- EZmy    EaZomiy~        N-ap    bone;osseous;osteo-     [[EaZomiy~/ADJ]]

    noun     FaCL |< Iy                {- EaZomiy~ -}       `gloss`  [ "bone", "osseous", "osteo- [ [ EaZomiy ~ / ADJ ] ]" ],

    -- ;; EaZomiy~At_1
    -- EZmy    EaZomiy~        NAt     teleosts (bony fish)     [[EaZomiy~/NOUN]]

    noun     FaCL |< Iy |< At          {- EaZomiy~At -}     -- `others` [ "`a.zmiyy NAt" ]
                                                            `gloss`  [ "teleosts ( bony fish ) [ [ EaZomiy ~ / NOUN ] ]" ],

    -- ;; maEoZamap_1
    -- mEZm    maEoZam Nap     ossuary (container for bones)

    noun     MaFCaL |< aT              {- maEoZamap -}      `gloss`  [ "ossuary ( container for bones )" ],
    ...
    noun     FaCL |< aT                {- EaZomap -}        -- `others` [ "`a.zam NAt" ]
                                                            `gloss`  [ "piece of bone", "pieces of bone" ],

    -- ;; EaZomap_2
    -- EZm     EaZom   Nap     His Highness;His Majesty

    noun     FaCL |< aT                {- EaZomap -}        `gloss`  [ "His Highness", "His Majesty" ],

    -- ;; EaZomap_3
    -- EZm     EaZom   Nap     majesty;grandeur

    noun     FaCL |< aT                {- EaZomap -}        `gloss`  [ "majesty", "grandeur" ],
    ...
    noun     FaCIL |< aT               {- EaZiymap -}       -- `others` [ "`a.zA'im Ndip" ]
                                                            `gloss`  [ "misfortune", "misfortunes" ],

    -- ;; EiZAmiy~_2
    -- EZAmy   EiZAmiy~        Nall    noble;aristocratic     [[EiZAmiy~/ADJ]]

    noun     FiCAL |< Iy               {- EiZAmiy~ -}       `gloss`  [ "noble", "aristocratic [ [ EiZAmiy ~ / ADJ ] ]" ],
    ...
    noun     MuFaCCaL                  {- muEaZ~am -}       `gloss`  [ "ossified [ [ muEaZ ~ am / ADJ ] ]" ],
    ...
    noun     MutaFACiL                 {- mutaEAZim -}      `gloss`  [ "arrogant", "supercilious [ [ mutaEAZim / ADJ ] ]" ] ]
 ...
 |> "` .z y" <| [
    ...
    noun     FiCA' |< aT               {- EiZA'ap -}        -- `others` [ "`i.zA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "lizard", "lizards" ],
    ...
    noun     FiCAL |< aT               {- EiZAyap -}        -- `others` [ "`a.zAyA N0_Nhy" ]
                                                            `gloss`  [ "lizard", "lizards" ] ]
 ...
 |> "` ^g ^g" <| [
    ...
    noun     FuCL |< aT                {- Euj~ap -}         `gloss`  [ "omelet" ],
    ...
    noun     FaCAL |< aT               {- EajAjap -}        `gloss`  [ "billow of smoke", "cloud of dust" ],

    -- ;; Eaj~Aj_1
    -- EjAj    Eaj~Aj  Nall    clamoring;vociferous     [[Eaj~Aj/ADJ]]

    noun     FaCCAL                    {- Eaj~Aj -}         `gloss`  [ "clamoring", "vociferous [ [ Eaj ~ Aj / ADJ ] ]" ] ]
 ...
 |> "` ^g ` ^g" <| [
    ...
    noun     KaRDaS |< aT              {- EajoEajap -}      `gloss`  [ "bellowing", "clamor" ] ]
 ...
 |> "` ^g b" <| [
    ...
    noun     FuCAL                     {- EujAb -}          `gloss`  [ "wonderful", "amazing [ [ EujAb / ADJ ] ]" ],
    ...
    noun     FaCIL |< aT               {- Eajiybap -}       -- `others` [ "`a^gA'ib Ndip" ]
    ...
    noun     MuFCiL                    {- muEojib -}        `gloss`  [ "admirable [ [ muEojib / ADJ ] ]" ],
    ...
    noun     MutaFaCCiL                {- mutaEaj~ib -}     `gloss`  [ "amazed", "astonished [ [ mutaEaj ~ ib / ADJ ] ]" ] ]
 ...
 |> "` ^g f" <| [
    ...
    noun     FaCIL                     {- Eajiyf -}         -- `others` [ "`a^gfA Nhy", "`a^gfY N0" ]
                                                            `gloss`  [ "thin", "lean [ [ Eajiyf / ADJ ] ]", "lean" ],
    ...
    noun     HaFCaL                    {- OaEojaf -}        -- `others` [ "`i^gAf N", "`a^gfA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "thin", "lean [ [ >aEojaf / ADJ ] ]", "lean" ] ]
 ...
 |> "` ^g l" <| [
    ...
    verb     HaFCaL                    {- OaEojal -}        -- `others` [ "`^gal IV_Pass_yu", "`^gil IV_yu" ]
    ...
    noun     FaCaL |< aT               {- Eajalap -}        `gloss`  [ "hurry", "haste" ],
    ...
    noun     FaCaL |< aT               {- Eajalap -}        -- `others` [ "`a^gal NAt" ]
    ...
    noun     FaCIL                     {- Eajiyl -}         -- `others` [ "`i^gAl N" ]
                                                            `gloss`  [ "quick [ [ Eajiyl / ADJ ] ]", "quick" ],

    -- ;; Eajuwl_1
    -- Ejwl    Eajuwl  N       swift     [[Eajuwl/ADJ]]

    noun     FaCUL                     {- Eajuwl -}         `gloss`  [ "swift [ [ Eajuwl / ADJ ] ]" ],

    -- ;; EujAlap_1
    -- EjAl    EujAl   Nap     hasty work

    noun     FuCAL |< aT               {- EujAlap -}        `gloss`  [ "hasty work" ],
    ...
    noun     FaCLAn                    {- EajolAn -}        -- `others` [ "`a^glA Nhy", "`a^gAlA Nhy", "`a^gAlY N0", "`a^glY N0" ]
                                                            `gloss`  [ "swift", "hurried [ [ EajolAn / ADJ ] ]", "hurried" ],
    ...
    noun     HaFCaL                    {- OaEojal -}        -- `others` [ "`u^glY N0", "`u^glay NAt NAn_Nayn", "`u^glA Nhy" ]
    ...
    noun     IstiFCAL |< Iy            {- {isotiEojAliy~ -} `gloss`  [ "expeditious", "urgent [ [ { isotiEojAliy ~ / ADJ ] ]" ],
    ...
    noun     FACiL |< aN               {- EAjilAF -}        -- `others` [ "`A^gil NF" ]
                                                            `gloss`  [ "at once", "immediately [ [ EAjil / ADV ] ]" ],

    -- ;; muEaj~al_1
    -- mEjl    muEaj~al        N-ap    urgent;premature     [[muEaj~al/ADJ]]

    noun     MuFaCCaL                  {- muEaj~al -}       `gloss`  [ "urgent", "premature [ [ muEaj ~ al / ADJ ] ]" ],

    -- ;; muEaj~al_2
    -- mEjl    muEaj~al        N-ap    in advance     [[muEaj~al/ADJ]]

    noun     MuFaCCaL                  {- muEaj~al -}       `gloss`  [ "in advance [ [ muEaj ~ al / ADJ ] ]" ],

    -- ;; mutaEaj~il_1
    -- mtEjl   mutaEaj~il      Nall    in a hurry;hasty     [[mutaEaj~il/ADJ]]

    noun     MutaFaCCiL                {- mutaEaj~il -}     `gloss`  [ "in a hurry", "hasty [ [ mutaEaj ~ il / ADJ ] ]" ],

    -- ;; musotaEojil_1
    -- mstEjl  musotaEojil     Nall    in a hurry;hasty     [[musotaEojil/ADJ]]

    noun     MustaFCiL                 {- musotaEojil -}    `gloss`  [ "in a hurry", "hasty [ [ musotaEojil / ADJ ] ]" ],
 ...
 |> "` ^g m" <| [
    ...
    verb     HaFCaL                    {- OaEojam -}        -- `others` [ "`^gam IV_Pass_yu", "`^gim IV_yu" ]
    ...
    noun     FaCaL |< aT               {- Eajamap -}        `gloss`  [ "fruit stone" ],
    ...
    noun     FaCaL |< Iy               {- Eajamiy~ -}       -- `others` [ "'a`^gAm N" ]
                                                            `gloss`  [ "non-Arab [ [ Eajamiy ~ / ADJ ] ]", "non-Arabs" ],
    ...
    noun     FaCaL |< Iy               {- Eajamiy~ -}       -- `others` [ "'a`^gAm N" ]
                                                            `gloss`  [ "Persian [ [ Eajamiy ~ / ADJ ] ]", "Persians" ],

    -- ;; Eujomap_1
    -- Ejm     Eujom   Nap     non-Arabic expression;barbarism

    noun     FuCL |< aT                {- Eujomap -}        `gloss`  [ "non-Arabic expression", "barbarism" ],
    ...
    noun     HaFCaL                    {- OaEojam -}        -- `others` [ "'a`A^gim Ndip", "`a^gmA' Nh Nhy N0_Nh" ]
    ...
    noun     HaFCaL |< Iy              {- OaEojamiy~ -}     `gloss`  [ "non-Arab", "foreigner [ [ >aEojamiy ~ / ADJ ] ]" ],

    -- ;; >aEojamiy~_2
    -- >Ejmy   >aEojamiy~      Nall    Persian     [[>aEojamiy~/ADJ]]
    -- AEjmy   >aEojamiy~      Nall    Persian     [[>aEojamiy~/ADJ]]

    noun     HaFCaL |< Iy              {- OaEojamiy~ -}     `gloss`  [ "Persian [ [ >aEojamiy ~ / ADJ ] ]" ],
    ...
    noun     MuFCaL |< Iy              {- muEojamiy~ -}     `gloss`  [ "lexical", "dictionary [ [ muEojamiy ~ / ADJ ] ]" ] ]
 ...
 |> "` ^g n" <| [
    ...
    noun     FaCIL |< aT               {- Eajiynap -}       -- `others` [ "`a^gA'in Ndip" ]
                                                            `gloss`  [ "dough", "paste", "plastics" ],

    -- ;; Eajiyniy~_1
    -- Ejyny   Eajiyniy~       N-ap    dough-like;malleable     [[Eajiyniy~/ADJ]]

    noun     FaCIL |< Iy               {- Eajiyniy~ -}      `gloss`  [ "dough-like", "malleable [ [ Eajiyniy ~ / ADJ ] ]" ],
 ...
 |> "` ^g r" <| [
    ...
    noun     FuCL |< aT                {- Eujorap -}        -- `others` [ "`u^gar N" ]
    ...
    noun     FuCayL |< aT              {- Eujayorap -}      `gloss`  [ "nodule" ],

    -- ;; Eujariy~_1
    -- Ejry    Eujariy~        N-ap    nodular     [[Eujariy~/ADJ]]

    noun     FuCaL |< Iy               {- Eujariy~ -}       `gloss`  [ "nodular [ [ Eujariy ~ / ADJ ] ]" ],

    -- ;; Eujayoriy~_1
    -- Ejyry   Eujayoriy~      N-ap    nodular     [[Eujayoriy~/ADJ]]

    noun     FuCayL |< Iy              {- Eujayoriy~ -}     `gloss`  [ "nodular [ [ Eujayoriy ~ / ADJ ] ]" ],

    -- ;; EijArap_1
    -- EjAr    EijAr   Nap     veil

    noun     FiCAL |< aT               {- EijArap -}        `gloss`  [ "veil" ] ]
 ...
 |> "` ^g r f" <| [
    ...
    noun     KaRDaS |< aT              {- Eajorafap -}      `gloss`  [ "presumption", "arrogance" ],
    ...
    noun     MutaKaRDiS                {- mutaEajorif -}    `gloss`  [ "arrogant [ [ mutaEajorif / ADJ ] ]" ] ]
 ...
 |> "` ^g w" <| [
    ...
    noun     FaCL |< aT                {- Eajowap -}        `gloss`  [ "pressed dates", "date paste" ] ]
 ...
 |> "` ^g z" <| [
    ...
    noun     MuFCiL |< aT              {- muEojizap -}      -- `others` [ "mu`^giz NAt" ]
 ...
 |> "` ^s ' r" <| [
    ...
    noun     KaRADiS |< Iy             {- Ea$A}iriy~ -}     `gloss`  [ "tribal", "bedouin [ [ Ea $ A } iriy ~ / ADJ ] ]", "tribalism", "clannish [ [ Ea $ A } iriy ~ / NOUN ] ]" ] ]
 ...
 |> "` ^s ^s" <| [
    ...
    noun     FuCL |< aT                {- Eu$~ap -}         -- `others` [ "`u^sa^s N" ]
    ...
    verb     FaCLY                     {- Ea$~aY -}         -- `others` [ "`a^s^s IV_0hwnyn_yu PV_ttAw", "`a^s^say PV_Atn IV_Ann_Pass_yu", "`a^s^sA PV_h", "`a^s^siy IV_0hAnn_yu" ]
 ...
 |> "` ^s b" <| [
    ...
    verb     HaFCaL                    {- OaEo$ab -}        -- `others` [ "`^sib IV_yu", "`^sab IV_Pass_yu" ]
    ...
    noun     HaFCAL |< Iy              {- OaEo$Abiy~ -}     `gloss`  [ "herbalist [ [ >aEo $ Abiy ~ / ADJ ] ]" ],

    -- ;; Eu$obiy~_1
    -- E$by    Eu$obiy~        Nall    vegetation;herbal     [[Eu$obiy~/ADJ]]

    noun     FuCL |< Iy                {- Eu$obiy~ -}       `gloss`  [ "vegetation", "herbal [ [ Eu $ obiy ~ / ADJ ] ]" ],

    -- ;; Ea$ib_1
    -- E$b     Ea$ib   N-ap    grassy;green     [[Ea$ib/ADJ]]

    noun     FaCiL                     {- Ea$ib -}          `gloss`  [ "grassy", "green [ [ Ea $ ib / ADJ ] ]" ],

    -- ;; Ea$Abap_1
    -- E$Ab    Ea$Ab   Nap     vegetation

    noun     FaCAL |< aT               {- Ea$Abap -}        `gloss`  [ "vegetation" ],

    -- ;; muEo$ib_1
    -- mE$b    muEo$ib N-ap    grassy;green     [[muEo$ib/ADJ]]

    noun     MuFCiL                    {- muEo$ib -}        `gloss`  [ "grassy", "green [ [ muEo $ ib / ADJ ] ]" ] ]
 ...
 |> "` ^s m" <| [
    ...
    noun     HaFCaL                    {- OaEo$am -}        -- `others` [ "`a^smA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "dry", "thin" ] ]
 ...
 |> "` ^s q" <| [
    ...
    noun     FiCL |< Iy                {- Ei$oqiy~ -}       `gloss`  [ "erotic [ [ Ei $ oqiy ~ / ADJ ] ]" ],
    ...
    noun     TaFCIL |< aT              {- taEo$iyqap -}     -- `others` [ "ta`A^siyq Ndip" ]
    ...
    noun     MaFCUL |< aT              {- maEo$uwqap -}     `gloss`  [ "beloved", "sweetheart" ] ]
 ...
 |> "` ^s r" <| [
    ...
    noun     FaCL |< Iy                {- Ea$oriy~ -}       `gloss`  [ "decennial [ [ Ea $ oriy ~ / ADJ ] ]" ],
    ...
    noun     FuCL |< Iy                {- Eu$oriy~ -}       -- `others` [ "'a`^sAriyy N-ap" ]
                                                            `gloss`  [ "decimal [ [ Eu $ oriy ~ / ADJ ] ]", "decimal [ [ >aEo $ Ariy ~ / ADJ ] ]" ],

    -- ;; Ei$orap_1
    -- E$r     Ei$or   Nap     association;relationship

    noun     FiCL |< aT                {- Ei$orap -}        `gloss`  [ "association", "relationship" ],
    ...
    noun     FaCaL |< aT               {- Ea$arap -}        -- `others` [ "`a^sr Nap", "`a^sar N" ]
                                                            `gloss`  [ "ten" ],
    ...
    noun     FuCAL |< Iy               {- Eu$Ariy~ -}       `gloss`  [ "tenfold", "consisting of ten [ [ Eu $ Ariy ~ / ADJ ] ]" ],
    ...
    noun     FaCIL |< aT               {- Ea$iyrap -}       -- `others` [ "`a^sA'ir Ndip" ]
    ...
    noun     MuFACaL |< aT             {- muEA$arap -}      `gloss`  [ "association", "social relations" ],
    ...
    noun     FACiL |< aN               {- EA$irAF -}        -- `others` [ "`A^sir NF" ]
                                                            `gloss`  [ "in tenth place [ [ EA $ ir / ADV ] ]" ],

    -- ;; muEa$~ar_1
    -- mE$r    muEa$~ar        N-ap    in tenths;deca-     [[muEa$~ar/ADJ]]

    noun     MuFaCCaL                  {- muEa$~ar -}       `gloss`  [ "in tenths", "deca- [ [ muEa $ ~ ar / ADJ ] ]" ],
 ...
 |> "` ^s r n" <| [
    ...
    noun     KiRDIS |< Iy              {- Ei$oriyniy~ -}    `gloss`  [ "twenties [ [ Ei $ oriyniy ~ / NOUN ] ]" ] ]
 ...
 |> "` ^s t r" <| [
    ...
    noun     KaRDaS |< aT              {- Ea$otarap -}      -- `others` [ "`a^staruwt Ndip" ]
                                                            `gloss`  [ "Astarte" ] ]
 ...
 |> "` ^s w" <| [
    ...
    verb     FaCA                      {- Ea$A-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`a^s PV_ttAw_intr", "`^s IV_0hwnyn", "`^suw IV_0hAnn", "`a^saw PV_Atn" ]
    ...
    verb     HaFCY                     {- OaEo$aY -}        -- `others` [ "'a`^say PV_Atn", "`^s IV_0hwnyn_yu", "'a`^s PV_ttAw", "'a`^sA PV_h", "`^sY IV_0_Pass_yu", "`^siy IV_0hAnn_yu", "`^say IV_Ann_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- Ea$owap -}        `gloss`  [ "darkness", "blindness" ],

    -- ;; Ea$Awap_1
    -- E$Aw    Ea$Aw   Nap     darkness;blindness

    noun     FaCAL |< aT               {- Ea$Awap -}        `gloss`  [ "darkness", "blindness" ],
    ...
    noun     HaFCY                     {- OaEo$aY -}        -- `others` [ "'a`^say NAn_Nayn", "'a`^sA Nhy" ]
                                                            `gloss`  [ "blind" ] ]
 ...
 |> "` ^s y" <| [
    ...
    verb     FaCiL                     {- Ea$iy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "`a^s PV_w_intr", "`^sa IV_0hwnyn", "`^say IV_Ann", "`^sY IV_0" ]
                                                            `gloss`  [ "be night-blind" ],
    ...
    noun     FaCIL |< aT               {- Ea$iy~ap -}       -- `others` [ "`a^sAyA N0_Nhy" ]
 ...
 |> "` _d b" <| [
    ...
    verb     HaFCaL                    {- OaEo*ab -}        -- `others` [ "`_dab IV_Pass_yu", "`_dib IV_yu" ]
    ...
    noun     FuCUL |< aT               {- Eu*uwbap -}       `gloss`  [ "sweetness", "pleasantness" ],

    -- ;; >aEo*ab_2
    -- >E*b    >aEo*ab Nel     sweeter/sweetest;more/most pleasant
    -- AE*b    >aEo*ab Nel     sweeter/sweetest;more/most pleasant

    noun     HaFCaL                    {- OaEo*ab -}        `gloss`  [ "sweeter / sweetest", "more / most pleasant" ],
    ...
    noun     MuFaCCaL                  {- muEa*~ab -}       `gloss`  [ "afflicted", "tortured [ [ muEa* ~ ab / ADJ ] ]" ],
 ...
 |> "` _d l" <| [
    ...
    verb     FaCaL                     {- Ea*al-u -}        `imperf` [ FCuL ]
                                                            -- `others` [ "`_dul IV", "`_dal IV_Pass_yu" ]
 ...
 |> "` _d r" <| [
    ...
    verb     HaFCaL                    {- OaEo*ar -}        -- `others` [ "`_dar IV_Pass_yu", "`_dir IV_yu" ]
    ...
    noun     FuCL |< aT                {- Eu*orap -}        `gloss`  [ "virginity" ],

    -- ;; Eu*oriy~_1
    -- E*ry    Eu*oriy~        N-ap    platonic;chaste     [[Eu*oriy~/ADJ]]

    noun     FuCL |< Iy                {- Eu*oriy~ -}       `gloss`  [ "platonic", "chaste [ [ Eu*oriy ~ / ADJ ] ]" ],
    ...
    noun     MaFCiL |< aT              {- maEo*irap -}      -- `others` [ "ma`A_dir Ndip" ]
    ...
    noun     HiFCAL                    {- IiEo*Ar -}        `gloss`  [ "imposition", "obligation" ],
    ...
    noun     MutaFaCCiL                {- mutaEa*~ir -}     `gloss`  [ "difficult", "unfeasible [ [ mutaEa* ~ ir / ADJ ] ]" ] ]
 ...
 |> "` _d w" <| [
    ...
    verb     FaCA                      {- Ea*A-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`_d IV_0hwnyn", "`a_d PV_ttAw_intr", "`a_daw PV_Atn", "`_duw IV_0hAnn" ]
                                                            `gloss`  [ "be healthy" ],

    -- ;; Ea*Ap_1
    -- E*A     Ea*A    Nap     healthfulness;salubrity

    noun     FaCY |< aT                {- Ea*Ap -}          `gloss`  [ "healthfulness", "salubrity" ],

    -- ;; Ea*Awap_1
    -- E*Aw    Ea*Aw   Nap     healthfulness;salubrity

    noun     FaCAL |< aT               {- Ea*Awap -}        `gloss`  [ "healthfulness", "salubrity" ] ]
 ...
 |> "` _d y" <| [
    ...
    verb     FaCiL                     {- Ea*iy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "`_dY IV_0", "`a_d PV_w_intr", "`_day IV_Ann", "`_da IV_0hwnyn" ]
                                                            `gloss`  [ "be healthy" ],

    -- ;; Ea*iy~_1
    -- E*y     Ea*iy~  N-ap    healthful;salubrious     [[Ea*iy~/ADJ]]

    noun     FaCIL                     {- Ea*iy~ -}         `gloss`  [ "healthful", "salubrious [ [ Ea*iy ~ / ADJ ] ]" ] ]
 ...
 |> "` _t _t" <| [
    ...
    noun     MaFCUL                    {- maEovuwv -}       `gloss`  [ "moth-eaten", "moth-ridden [ [ maEovuwv / ADJ ] ]" ] ]
 ...
 |> "` _t m n" <| [
    ...
    noun     KuRDAS |< Iy              {- EuvomAniy~ -}     `gloss`  [ "Ottoman [ [ EuvomAniy ~ / NOUN ] ]", "Ottoman [ [ EuvomAniy ~ / ADJ ] ]" ],
 ...
 |> "` _t r" <| [
    ...
    verb     HaFCaL                    {- OaEovar -}        -- `others` [ "`_tir IV_yu", "`_tar IV_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- Eavorap -}        -- `others` [ "`a_tar NAt" ]
    ...
    noun     FACUL                     {- EAvuwr -}         -- `others` [ "`awA_tiyr Ndip" ]
                                                            `gloss`  [ "pitfall", "difficulty", "pitfalls", "difficulties" ],

    -- ;; muEav~ir_1
    -- mEvr    muEav~ir        Nall    stumbling;tripping     [[muEav~ir/ADJ]]

    noun     MuFaCCiL                  {- muEav~ir -}       `gloss`  [ "stumbling", "tripping [ [ muEav ~ ir / ADJ ] ]" ],
 ...
 |> "` _t w" <| [
    ...
    verb     FaCA                      {- EavA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`a_t PV_ttAw", "`_tuw IV_0hAnn", "`a_taw PV_Atn", "`_t IV_0hwnyn" ]
    ...
    verb     FaCY                      {- EavaY-ai -}       `imperf` [ FCaL, FCiL ]
                                                            -- `others` [ "`a_tay PV_Atn", "`_tY IV_0", "`a_ta PV_ttAw", "`_tay IV_Ann", "`_ta IV_0hwnyn", "`_t IV_0hwnyn", "`_tiy IV_0hAnn" ]
                                                            `gloss`  [ "behave wickedly" ] ]
 ...
 |> "` ` .t" <| [
    ...
    noun     CaL |< aN                 {- EaTAF -}          -- `others` [ "`a.taw NAt NAn_Nayn", "`a.tA N0_Nhy" ]
                                                            `gloss`  [ "present", "gift [ [ EaTAF / NOUN ] ]", "gift", "presents", "gifts" ] ]
 ...
 |> "` ` y" <| [
    ...
    noun     CaL |< Iy                 {- Eayiy~ -}         `gloss`  [ "stammering", "incapable [ [ Eayiy ~ / ADJ ] ]" ] ]
 ...
 |> "` b '" <| [
    ...
    verb     FaCaL                     {- EabaO-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "`ba'A IV-|", "`ba' IV IV_wn IV_yn", "`aba'A PV-|" ]
    ...
    verb     FaCCaL                    {- Eab~aO -}         -- `others` [ "`abbi' IV_yu", "`abba'A PV-|" ]
    ...
    noun     TaFCiL |< aT              {- taEobi}ap -}      `gloss`  [ "mobilization", "alert" ],

    -- ;; EAbi}_1
    -- EAb}    EAbi}   Nall    caring about;preoccupied with     [[EAbi}/ADJ]]

    noun     FACiL                     {- EAbi} -}          `gloss`  [ "caring about", "preoccupied with [ [ EAbi } / ADJ ] ]" ],
    ...
    noun     MuFaCCaL                  {- muEab~aO -}       -- `others` [ "mu`abba N-|t", "mu`abba'A N-|" ]
                                                            `gloss`  [ "packaged", "packed in sacks [ [ muEab ~ a> / ADJ ] ]", "packed in sacks" ] ]
 ...
 |> "` b .t" <| [
    ...
    noun     FaCL |< aT                {- EaboTap -}        `gloss`  [ "premature death" ],
    ...
    noun     FaCIL                     {- EabiyT -}         -- `others` [ "`ubu.t N", "`ibA.t N" ]
                                                            `gloss`  [ "prematurely dead", "fresh [ [ EabiyT / ADJ ] ]", "fresh" ],
    ...
    noun     IFtiCAL |< aN             {- {iEotibATAF -}    -- `others` [ "i`tibA.t NF" ]
                                                            `gloss`  [ "arbitrarily", "fortuitously", "unjustly [ [ { iEotibAT / ADV ] ]" ],
    ...
    noun     IFtiCAL |< Iy             {- {iEotibATiy~ -}   `gloss`  [ "arbitrary", "fortuitous", "inquisitorial [ [ { iEotibATiy ~ / ADJ ] ]" ],
    ...
    noun     IFtiCAL |< Iy |< aN       {- {iEotibATiy~AF -} -- `others` [ "i`tibA.tiyy NF" ]
                                                            `gloss`  [ "arbitrarily", "fortuitously", "unjustly [ [ { iEotibATiy ~ / ADV ] ]" ],

    -- ;; {iEotibATiy~ap_1
    -- <EtbATy {iEotibATiy~    Nap     arbitrariness     [[{iEotibATiy~/NOUN]]
    -- AEtbATy {iEotibATiy~    Nap     arbitrariness     [[{iEotibATiy~/NOUN]]

    noun     IFtiCAL |< Iy |< aT       {- {iEotibATiy~ap -} `gloss`  [ "arbitrariness [ [ { iEotibATiy ~ / NOUN ] ]" ] ]
 ...
 |> "` b _t" <| [
    ...
    noun     MuFACaL |< aT             {- muEAbavap -}      `gloss`  [ "jesting", "banter", "play" ],

    -- ;; EAbiv_1
    -- EAbv    EAbiv   Nall    scornful;frivolous;jesting     [[EAbiv/ADJ]]

    noun     FACiL                     {- EAbiv -}          `gloss`  [ "scornful", "frivolous", "jesting [ [ EAbiv / ADJ ] ]" ] ]
 ...
 |> "` b b" <| [
    ...
    verb     FaCL                      {- Eab~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`ubb IV_V", "`bub IV_C", "`abab PV_C" ]
                                                            `gloss`  [ "drink", "quaff" ],
 ...
 |> "` b d" <| [
    ...
    noun     FaCL |< Iy                {- Eabodiy~ -}       `gloss`  [ "servile [ [ Eabodiy ~ / ADJ ] ]" ],
    ...
    noun     FiCAL |< aT               {- EibAdap -}        `gloss`  [ "worship", "religious practice" ],

    -- ;; Eubuwdap_1
    -- Ebwd    Eubuwd  Nap     veneration;servitude

    noun     FuCUL |< aT               {- Eubuwdap -}       `gloss`  [ "veneration", "servitude" ],

    -- ;; Eubuwdiy~_1
    -- Ebwdy   Eubuwdiy~       Nap     veneration;servitude     [[Eubuwdiy~/NOUN]]

    noun     FuCUL |< Iy               {- Eubuwdiy~ -}      `gloss`  [ "veneration", "servitude [ [ Eubuwdiy ~ / NOUN ] ]" ],
 ...
 |> "` b l" <| [
    ...
    verb     HaFCaL                    {- OaEobal-i -}      `imperf` [ FCiL ]
                                                            -- `others` [ "`bil IV_yu" ]
    ...
    noun     FaCAL |< aT               {- EabAlap -}        `gloss`  [ "eglantine" ],

    -- ;; >aEobal_1
    -- >Ebl    >aEobal N       granite
    -- AEbl    >aEobal N       granite

    noun     HaFCaL                    {- OaEobal -}        `gloss`  [ "granite" ],

    -- ;; >aEobaliy~_1
    -- >Ebly   >aEobaliy~      N-ap    granite     [[>aEobaliy~/ADJ]]
    -- AEbly   >aEobaliy~      N-ap    granite     [[>aEobaliy~/ADJ]]

    noun     HaFCaL |< Iy              {- OaEobaliy~ -}     `gloss`  [ "granite [ [ >aEobaliy ~ / ADJ ] ]" ],

    -- ;; muEobil_1
    -- mEbl    muEobil N-ap    deciduous     [[muEobil/ADJ]]

    noun     MuFCiL                    {- muEobil -}        `gloss`  [ "deciduous [ [ muEobil / ADJ ] ]" ] ]
 ...
 |> "` b q" <| [
    ...
    noun     FaCiL                     {- Eabiq -}          `gloss`  [ "fragrant [ [ Eabiq / ADJ ] ]" ],

    -- ;; Eaboqap_1
    -- Ebq     Eaboq   Nap     chest pressure

    noun     FaCL |< aT                {- Eaboqap -}        `gloss`  [ "chest pressure" ],
 ...
 |> "` b q r" <| [
    ...
    noun     KaRDaS |< Iy              {- Eaboqariy~ -}     -- `others` [ "`abAqir Nap" ]
                                                            `gloss`  [ "genius [ [ Eaboqariy ~ / ADJ ] ]", "geniuses" ],

    -- ;; Eaboqariy~ap_1
    -- Ebqry   Eaboqariy~      Nap     ingenuity;genius     [[Eaboqariy~/NOUN]]

    noun     KaRDaS |< Iy |< aT        {- Eaboqariy~ap -}   `gloss`  [ "ingenuity", "genius [ [ Eaboqariy ~ / NOUN ] ]" ] ]
 ...
 |> "` b r" <| [
    ...
    noun     FaCL |< aT                {- Eaborap -}        -- `others` [ "`abar NAt" ]
                                                            `gloss`  [ "tear", "tears" ],
    ...
    noun     FiCL |< aT                {- Eiborap -}        -- `others` [ "`ibar N" ]
    ...
    noun     FiCL |< Iy                {- Eiboriy~ -}       `gloss`  [ "Hebrew [ [ Eiboriy ~ / NOUN ] ]", "Hebrew [ [ Eiboriy ~ / ADJ ] ]" ],

    -- ;; EibArap_1
    -- EbAr    EibAr   NapAt   expression

    noun     FiCAL |< aT               {- EibArap -}        `gloss`  [ "expression" ],
    ...
    noun     MiFCaL |< aT              {- miEobarap -}      `gloss`  [ "ferry boat" ],
    ...
    noun     TaFCIL |< Iy              {- taEobiyriy~ -}    `gloss`  [ "expressive", "expressionist [ [ taEobiyriy ~ / ADJ ] ]" ],
    ...
    noun     IFtiCAL |< Iy             {- {iEotibAriy~ -}   `gloss`  [ "consideration", "regard [ [ { iEotibAriy ~ / ADJ ] ]" ],
    ...
    noun     FACiL |< Iy |< aT         {- EAbiriy~ap -}     `gloss`  [ "fleetingness", "transience [ [ EAbiriy ~ / NOUN ] ]" ],
    ...
    noun     MuFaCCaL                  {- muEab~ar -}       `gloss`  [ "expressed [ [ muEab ~ ar / ADJ ] ]" ],
 ...
 |> "` b r n" <| [
    ...
    noun     KiRDAS |< Iy              {- EiborAniy~ -}     `gloss`  [ "Hebrew [ [ EiborAniy ~ / NOUN ] ]", "Hebrew [ [ EiborAniy ~ / ADJ ] ]" ],
    ...
    noun     KaRDaS |< aT              {- Eaboranap -}      `gloss`  [ "Hebraization" ] ]
 ...
 |> "` b s" <| [
    ...
    noun     FuCUL |< aT               {- Eubuwsap -}       `gloss`  [ "frown", "scowl" ],
    ...
    noun     FaCCAL |< Iy              {- Eab~Asiy~ -}      `gloss`  [ "Abbasid [ [ Eab ~ Asiy ~ / NOUN ] ]", "Abbasid [ [ Eab ~ Asiy ~ / ADJ ] ]" ],
    ...
    noun     FACiL                     {- EAbis -}          `gloss`  [ "frowning", "stern", "austere [ [ EAbis / ADJ ] ]" ] ]
 ...
 |> "` b w" <| [
    ...
    verb     FaCA                      {- EabA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`bY IV_0_Pass_yu", "`b IV_0hwnyn", "`bay IV_Ann_Pass_yu", "`buw IV_0hAnn", "`abaw PV_Atn", "`ab PV_ttAw" ]
    ...
    noun     FuCUL |< aT               {- Eubuw~ap -}       `gloss`  [ "package", "pack", "charge" ],

    -- ;; Eabowap_1
    -- Ebw     Eabow   Napdu   package;pack;charge
    -- Ebw     Eabaw   NAt     packages;packs;charges

    noun     FaCL |< aT                {- Eabowap -}        -- `others` [ "`abaw NAt" ]
 ...
 |> "` b y" <| [
    ...
    noun     FaCAL |< aT               {- EabAyap -}        -- `others` [ "`abA' NapAt" ]
                                                            `gloss`  [ "cloak" ],

    -- ;; EubayAt_1
    -- EbyAt   EubayAt Nprop   Ubayat

    noun     FuCaL |< At               {- EubayAt -}        `gloss`  [ "Ubayat" ] ]
 ...
 |> "` d '" <| [
    ...
    noun     IFtiCAL                   {- {iEotidA' -}      `gloss`  [ "attack", "aggression", "assault", "attacks", "assaults" ] ]
 ...
 |> "` d ' y" <| [
    ...
    noun     KaRADIS                   {- EadA}iy~ -}       `gloss`  [ "hostile", "aggressive [ [ EadA } iy ~ / ADJ ] ]" ] ]
 ...
 |> "` d d" <| [
    ...
    noun     FaCL |< Iy |< aT          {- Ead~iy~ap -}      `gloss`  [ "enumeration", "recitation [ [ Ead ~ iy ~ / NOUN ] ]" ],

    -- ;; Eid~ap_1
    -- Ed      Eid~    Nap     several;numerous;many     [[Eid~/ADJ]]

    noun     FiCL |< aT                {- Eid~ap -}         `gloss`  [ "several", "numerous", "many [ [ Eid ~ / ADJ ] ]" ],
    ...
    noun     FaCaL |< Iy               {- Eadadiy~ -}       `gloss`  [ "numerical [ [ Eadadiy ~ / ADJ ] ]" ],

    -- ;; Eud~ap_1
    -- Ed      Eud~    Nap     equipment;material

    noun     FuCL |< aT                {- Eud~ap -}         `gloss`  [ "equipment", "material" ],
    ...
    noun     HiFCAL |< Iy              {- IiEodAdiy~ -}     `gloss`  [ "preliminary", "preparatory [ [" ],
    ...
    noun     TaFaCCuL |< Iy |< aT      {- taEad~udiy~ap -}  `gloss`  [ "multiplicity", "plurality [ [ taEad ~ udiy ~ / NOUN ] ]" ],
    ...
    noun     IFtiCAL |< Iy             {- {iEotidAdiy~ -}   `gloss`  [ "confident [ [ { iEotidAdiy ~ / ADJ ] ]" ],
    ...
    noun     IstiFCAL |< Iy            {- {isotiEodAdiy~ -} `gloss`  [ "preparatory [ [ { isotiEodAdiy ~ / ADJ ] ]" ],
    ...
    noun     MuFaCCiL |< aT            {- muEad~idap -}     `gloss`  [ "female mourner" ],

    -- ;; muEotad~_1
    -- mEtd    muEotad~        Nall    confident     [[muEotad~/ADJ]]

    noun     MuFtaCL                   {- muEotad~ -}       `gloss`  [ "confident [ [ muEotad ~ / ADJ ] ]" ],
    ...
    verb     FaCLY                     {- Ead~aY -}         -- `others` [ "`addiy IV_0hAnn_yu", "`addA PV_h", "`adday PV_Atn IV_Ann_Pass_yu", "`add IV_0hwnyn_yu PV_ttAw" ]
 ...
 |> "` d l" <| [
    ...
    noun     FaCL |< Iy                {- Eadoliy~ -}       `gloss`  [ "legal", "judicial [ [ Eadoliy ~ / ADJ ] ]" ],

    -- ;; Eadoliy~ap_1
    -- Edly    Eadoliy~        Nap     legal administration     [[Eadoliy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- Eadoliy~ap -}     `gloss`  [ "legal administration [ [ Eadoliy ~ / NOUN ] ]" ],
    ...
    noun     FaCIL                     {- Eadiyl -}         -- `others` [ "`adA'il Ndip" ]
                                                            `gloss`  [ "equal", "equivalent [ [ Eadiyl / ADJ ] ]", "equivalent" ],
    ...
    noun     FaCAL |< aT               {- EadAlap -}        `gloss`  [ "justice", "fairness" ],

    -- ;; >aEodal_1
    -- >Edl    >aEodal Nel     more/most equitable;fairer/fairest
    -- AEdl    >aEodal Nel     more/most equitable;fairer/fairest

    noun     HaFCaL                    {- OaEodal -}        `gloss`  [ "more / most equitable", "fairer / fairest" ],
    ...
    noun     MuFACaL |< aT             {- muEAdalap -}      `gloss`  [ "equalizing", "balancing" ],

    -- ;; muEAdalap_2
    -- mEAdl   muEAdal Nap     equation

    noun     MuFACaL |< aT             {- muEAdalap -}      `gloss`  [ "equation" ],
    ...
    noun     IFtiCAL |< Iy             {- {iEotidAliy~ -}   `gloss`  [ "moderate", "balanced [ [ { iEotidAliy ~ / ADJ ] ]" ],
    ...
    noun     MaFCUL                    {- maEoduwl -}       `gloss`  [ "amended", "altered [ [ maEoduwl / ADJ ] ]" ],
    ...
    noun     MuFACiL                   {- muEAdil -}        `gloss`  [ "equal [ [ muEAdil / ADJ ] ]" ],

    -- ;; muEAdil_2
    -- mEAdl   muEAdil N       equalizer     [[muEAdil/ADJ]]

    noun     MuFACiL                   {- muEAdil -}        `gloss`  [ "equalizer [ [ muEAdil / ADJ ] ]" ],

    -- ;; mutaEAdil_1
    -- mtEAdl  mutaEAdil       Nall    balanced;neutral     [[mutaEAdil/ADJ]]

    noun     MutaFACiL                 {- mutaEAdil -}      `gloss`  [ "balanced", "neutral [ [ mutaEAdil / ADJ ] ]" ],
 ...
 |> "` d m" <| [
    ...
    noun     FaCaL |< Iy               {- Eadamiy~ -}       `gloss`  [ "nihilist [ [ Eadamiy ~ / ADJ ] ]" ],

    -- ;; Eadamiy~ap_1
    -- Edmy    Eadamiy~        Nap     nihilism     [[Eadamiy~/NOUN]]

    noun     FaCaL |< Iy |< aT         {- Eadamiy~ap -}     `gloss`  [ "nihilism [ [ Eadamiy ~ / NOUN ] ]" ],
    ...
    noun     FACiL                     {- EAdim -}          -- `others` [ "`awAdim Ndip" ]
                                                            `gloss`  [ "lacking", "devoid of [ [ EAdim / ADJ ] ]", "devoid of" ],
    ...
    noun     MaFCUL                    {- maEoduwm -}       `gloss`  [ "absent", "vanished [ [ maEoduwm / ADJ ] ]" ],
    ...
    noun     MunFaCiL                  {- munoEadim -}      `gloss`  [ "absent", "nonexistent", "vanished [ [ munoEadim / ADJ ] ]" ] ]
 ...
 |> "` d n" <| [
    ...
    noun     FaCL |< Iy                {- Eadoniy~ -}       `gloss`  [ "idyllic", "paradisal [ [ Eadoniy ~ / ADJ ] ]" ],
    ...
    noun     MaFCiL |< Iy              {- maEodiniy~ -}     `gloss`  [ "mineral", "metallic [ [ maEodiniy ~ / ADJ ] ]" ],
    ...
    noun     TaFCIL |< Iy              {- taEodiyniy~ -}    `gloss`  [ "mining", "metallurgy [ [ taEodiyniy ~ / ADJ ] ]" ],
 ...
 |> "` d s" <| [
    ...
    noun     FaCaL |< aT               {- Eadasap -}        -- `others` [ "`adas NAt" ]
                                                            `gloss`  [ "lens", "lenses" ],

    -- ;; Eadasiy~_1
    -- Edsy    Eadasiy~        N-ap    lens-related;lens-shaped;lenticular     [[Eadasiy~/ADJ]]

    noun     FaCaL |< Iy               {- Eadasiy~ -}       `gloss`  [ "lens-related", "lens-shaped", "lenticular [ [ Eadasiy ~ / ADJ ] ]" ] ]
 ...
 |> "` d w" <| [
    ...
    verb     FaCA                      {- EadA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`duw IV_0hAnn", "`day IV_Ann_Pass_yu", "`d IV_0hwnyn", "`ad PV_ttAw", "`adaw PV_Atn", "`dY IV_0_Pass_yu" ]
    ...
    verb     HaFCY                     {- OaEodaY -}        -- `others` [ "'a`d PV_ttAw", "`day IV_Ann_Pass_yu", "'a`day PV_Atn", "`d IV_0hwnyn_yu", "'a`dA PV_h", "`dY IV_0_Pass_yu", "`diy IV_0hAnn_yu" ]
    ...
    noun     FuCL |< aT                {- Eudowap -}        `gloss`  [ "embankment", "shore" ],
    ...
    noun     FaCAL |< aT               {- EadAwap -}        `gloss`  [ "hostility", "antagonism" ],
    ...
    noun     HaFCY                     {- OaEodaY -}        -- `others` [ "'a`dA Nhy", "'a`day NAn_Nayn" ]
    ...
    noun     MaFCY                     {- maEodaY -}        -- `others` [ "ma`dA Nhy" ]
                                                            `gloss`  [ "avoidance", "escape" ],

    -- ;; maEodiyap_1
    -- mEdy    maEodiy NapAt   ferryboat;shuttle

    noun     MaFCI |< aT               {- maEodiyap -}      `gloss`  [ "ferryboat", "shuttle" ],

    -- ;; maEAdiy_1
    -- mEAdy   maEAdiy N0_Nh   Maadi (Cairo)

    noun     MaFACI                    {- maEAdiy -}        `gloss`  [ "Maadi ( Cairo )" ],
    ...
    noun     TaFaCCI                   {- taEad~iy -}       -- `others` [ "ta`add NK" ]
    ...
    noun     FACI                      {- EAdiy -}          -- `others` [ "`awAdiy N0_Nh", "`Ad Nuwn_Niyn NK", "`awAd NK" ]
                                                            `gloss`  [ "aggressive", "hostile [ [ EAdiy / ADJ ] ]", "hostile" ],
    ...
    noun     FACI |< aT                {- EAdiyap -}        -- `others` [ "`awAdiy N0_Nh", "`awAd NK" ]
                                                            `gloss`  [ "adversity", "impediment", "adversities", "impediments" ],

    -- ;; muEad~iyap_1
    -- mEdy    muEad~iy        NapAt   ferry;boat

    noun     MuFaCCI |< aT             {- muEad~iyap -}     `gloss`  [ "ferry", "boat" ],
    ...
    noun     MuFACI                    {- muEAdiy -}        -- `others` [ "mu`Ad Nuwn_Niyn NK" ]
    ...
    noun     MuFCI                     {- muEodiy -}        -- `others` [ "mu`d Nuwn_Niyn NK" ]
    ...
    noun     MutaFaCCI                 {- mutaEad~iy -}     -- `others` [ "muta`add Nuwn_Niyn NK", "mu`tad Nuwn_Niyn NK", "mu`tadiy NapAt NAn_Nayn N0_Nh" ]
    ...
    noun     MuFCY                     {- muEodaY -}        -- `others` [ "mu`dA Napdu Nhy", "mu`d Nuwn_Niyn", "mu`day NAt NAn_Nayn" ]
 ...
 |> "` d y" <| [
    ...
    noun     FaCIL                     {- Eadiy~ -}         `gloss`  [ "hostile", "aggressive [ [ Eadiy ~ / ADJ ] ]" ],

    -- ;; maEodiyap_1
    -- mEdy    maEodiy NapAt   ferryboat;shuttle

    noun     MaFCiL |< aT              {- maEodiyap -}      `gloss`  [ "ferryboat", "shuttle" ],
    ...
    noun     TaFCiL |< aT              {- taEodiyap -}      `gloss`  [ "ferry service", "shuttle" ],
    ...
    noun     FACiL |< aT               {- EAdiyap -}        -- `others` [ "`awAdiy N0_Nh", "`awAd NK" ]
                                                            `gloss`  [ "adversity", "impediment", "adversities", "impediments" ],

    -- ;; muEad~iyap_1
    -- mEdy    muEad~iy        NapAt   ferry;boat

    noun     MuFaCCiL |< aT            {- muEad~iyap -}     `gloss`  [ "ferry", "boat" ],
 ...
 |> "` f '" <| [
    ...
    noun     FaCAL                     {- EafA' -}          `gloss`  [ "extinction", "disuse" ],
    ...
    noun     IstiFCAL                  {- {isotiEofA' -}    `gloss`  [ "apology", "resignation", "apologies", "resignations" ] ]
 ...
 |> "` f .s" <| [
    ...
    noun     FaCiL                     {- EafiS -}          `gloss`  [ "pungent", "bitter [ [ EafiS / ADJ ] ]" ],

    -- ;; EufuwSap_1
    -- EfwS    EufuwS  Nap     pungency;bitter taste

    noun     FuCUL |< aT               {- EufuwSap -}       `gloss`  [ "pungency", "bitter taste" ] ]
 ...
 |> "` f ^s" <| [
    ...
    noun     FuCAL |< aT               {- EufA$ap -}        `gloss`  [ "rubbish" ] ]
 ...
 |> "` f f" <| [
    ...
    verb     FaCL                      {- Eaf~-i -}         `imperf` [ FCiL ]
                                                            -- `others` [ "`iff IV_V", "`afaf PV_C", "`fif IV_C" ]
    ...
    noun     FiCL |< aT                {- Eif~ap -}         `gloss`  [ "abstinence", "integrity" ],
    ...
    noun     FaCL                      {- Eaf~ -}           `gloss`  [ "virtuous", "honest [ [ Eaf ~ / ADJ ] ]" ],
    ...
    noun     FaCIL                     {- Eafiyf -}         -- `others` [ "'a`iffA' Nh Nhy N0_Nh", "'a`iff Nap" ]
                                                            `gloss`  [ "virtuous", "honest [ [ Eafiyf / ADJ ] ]", "honest" ],
    ...
    noun     HaFaCL                    {- OaEaf~ -}         `gloss`  [ "more / most virtuous" ],
    ...
    noun     MutaFaCCiL                {- mutaEaf~if -}     `gloss`  [ "virtuous", "modest [ [ mutaEaf ~ if / ADJ ] ]" ],
    ...
    verb     FaCLY                     {- Eaf~aY -}         -- `others` [ "`aff IV_0hwnyn_yu PV_ttAw", "`affay PV_Atn IV_Ann_Pass_yu", "`affiy IV_0hAnn_yu", "`affA PV_h" ]
 ...
 |> "` f n" <| [
    ...
    noun     FaCiL                     {- Eafin -}          `gloss`  [ "rotten", "decomposed [ [ Eafin / ADJ ] ]" ],

    -- ;; Eufuwnap_1
    -- Efwn    Eufuwn  Nap     infection;decay

    noun     FuCUL |< aT               {- Eufuwnap -}       `gloss`  [ "infection", "decay" ],
    ...
    noun     TaFaCCuL |< Iy            {- taEaf~uniy~ -}    `gloss`  [ "can be infected", "decomposable [ [ taEaf ~ uniy ~ / ADJ ] ]" ],

    -- ;; muEaf~an_1
    -- mEfn    muEaf~an        N-ap    rotten;decayed;skeptic     [[muEaf~an/ADJ]]

    noun     MuFaCCaL                  {- muEaf~an -}       `gloss`  [ "rotten", "decayed", "skeptic [ [ muEaf ~ an / ADJ ] ]" ],

    -- ;; mutaEaf~in_1
    -- mtEfn   mutaEaf~in      Nall    rotten;decomposed;skeptic     [[mutaEaf~in/ADJ]]

    noun     MutaFaCCiL                {- mutaEaf~in -}     `gloss`  [ "rotten", "decomposed", "skeptic [ [ mutaEaf ~ in / ADJ ] ]" ] ]
 ...
 |> "` f r" <| [
    ...
    noun     FaCCAL |< aT              {- Eaf~Arap -}       `gloss`  [ "sprayer", "atomizer" ],
    ...
    noun     FuCL |< aT                {- Euforap -}        `gloss`  [ "dust-color" ],
    ...
    noun     HaFCaL                    {- OaEofar -}        -- `others` [ "`afrA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "dust-colored" ],
    ...
    noun     MuFaCCaL                  {- muEaf~ar -}       `gloss`  [ "dusty", "powdery [ [ muEaf ~ ar / ADJ ] ]" ] ]
 ...
 |> "` f r m" <| [
    ...
    noun     KaRADiS                   {- EafArim -}        `gloss`  [ "well done !", "bravo !" ] ]
 ...
 |> "` f r t" <| [
    ...
    noun     KiRDIS |< Iy              {- Eiforiytiy~ -}    `gloss`  [ "mischievous", "devilish [ [ Eiforiytiy ~ / ADJ ] ]" ],

    -- ;; Eiforiytap_1
    -- Efryt   Eiforiyt        Napdu   lifting jack

    noun     KiRDIS |< aT              {- Eiforiytap -}     `gloss`  [ "lifting jack" ],

    -- ;; Eaforatap_1
    -- Efrt    Eaforat Nap     mischief;dirty trick;devilish behavior

    noun     KaRDaS |< aT              {- Eaforatap -}      `gloss`  [ "mischief", "dirty trick", "devilish behavior" ] ]
 ...
 |> "` f w" <| [
    ...
    verb     FaCA                      {- EafA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`af PV_ttAw", "`fuw IV_0hAnn", "`fay IV_Ann_Pass_yu", "`afaw PV_Atn", "`f IV_0hwnyn", "`fY IV_0_Pass_yu" ]
    ...
    noun     FaCL |< aN                {- EafowAF -}        -- `others` [ "`afw NF" ]
                                                            `gloss`  [ "excuse me ! [ [ Eafow / INTERJ ] ]", "you 're welcome ! [ [ Eafow / INTERJ ] ]" ],
    ...
    noun     MuFACY |< aT              {- muEAfAp -}        -- `others` [ "mu`Afaw NAt", "mu`Afay NAt" ]
    ...
    noun     TaFACI                    {- taEAfiy -}        -- `others` [ "ta`Af NK" ]
                                                            `gloss`  [ "recovery", "cure" ],
    ...
    noun     FACI                      {- EAfiy -}          -- `others` [ "`Af Nuwn_Niyn NK" ]
                                                            `gloss`  [ "effaced", "obliterated [ [ EAfiy / ADJ ] ]", "obliterated" ],

    -- ;; EAfiyap_1
    -- EAfy    EAfiy   Nap     good health

    noun     FACI |< aT                {- EAfiyap -}        `gloss`  [ "good health" ],
    ...
    noun     MuFACY                    {- muEAfaY -}        -- `others` [ "mu`AfA Napdu Nhy", "mu`Afay NAt NAn_Nayn" ]
    ...
    noun     MuFCY                     {- muEofaY -}        -- `others` [ "mu`fay NAt NAn_Nayn", "mu`fA Napdu Nhy", "mu`f Nuwn_Niyn" ]
    ...
    noun     MutaFACI                  {- mutaEAfiy -}      -- `others` [ "muta`Af Nuwn_Niyn NK" ]
                                                            `gloss`  [ "recovered", "cured [ [ mutaEAfiy / ADJ ] ]", "cured" ] ]
 ...
 |> "` f w y" <| [
    ...
    noun     KaRDIS                    {- Eafowiy~ -}       `gloss`  [ "spontaneous", "instinctive [ [ Eafowiy ~ / ADJ ] ]", "spontaneously", "instinctively [ [ Eafowiy ~ / ADV ] ]" ],

    -- ;; Eafowiy~ap_1
    -- Efwy    Eafowiy~        Nap     spontaneity     [[Eafowiy~/NOUN]]

    noun     KaRDIS |< aT              {- Eafowiy~ap -}     `gloss`  [ "spontaneity [ [ Eafowiy ~ / NOUN ] ]" ],

    -- ;; Eafowiy~apF_1
    -- Efwyp   Eafowiy~apF     FW-Wa   spontaneously    [[Eafowiy~apF/ADV]]

    noun     KaRDIS |< aT |< aN        {- Eafowiy~apF -}    `gloss`  [ "spontaneously [ [ Eafowiy ~ apF / ADV ] ]" ] ]
 ...
 |> "` f y" <| [
    ...
    noun     FaCIL                     {- Eafiy~ -}         `gloss`  [ "vigorous", "robust [ [ Eafiy ~ / ADJ ] ]" ],

    -- ;; taEofiyap_1
    -- tEfy    taEofiy NapAt   effacement;obliteration

    noun     TaFCiL |< aT              {- taEofiyap -}      `gloss`  [ "effacement", "obliteration" ],
    ...
    noun     FACiL |< aT               {- EAfiyap -}        `gloss`  [ "good health" ],
 ...
 |> "` h d" <| [
    ...
    noun     FuCL |< aT                {- Euhodap -}        `gloss`  [ "responsibility", "custody" ],

    -- ;; Eahiyd_1
    -- Ehyd    Eahiyd  N/ap    ally;confederate     [[Eahiyd/ADJ]]

    noun     FaCIL                     {- Eahiyd -}         `gloss`  [ "ally", "confederate [ [ Eahiyd / ADJ ] ]" ],
    ...
    noun     MuFACaL |< aT             {- muEAhadap -}      -- `others` [ "mu`Ahad NAt" ]
 ...
 |> "` h r" <| [
    ...
    noun     FaCAL |< aT               {- EahArap -}        `gloss`  [ "adultery", "prostitution" ],
    ...
    noun     FACiL |< aT               {- EAhirap -}        -- `others` [ "`awAhir Ndip" ]
 ...
 |> "` k ^s" <| [
    ...
    noun     FaCAL |< aT               {- EakA$ap -}        `gloss`  [ "clumsiness" ],

    -- ;; Euk~A$ap_1
    -- EkA$    Euk~A$  Napdu   spider;spider web
    -- EkA$    Euk~A$  NAt     spiders;spider webs

    noun     FuCCAL |< aT              {- Euk~A$ap -}       -- `others` [ "`ukkA^s NAt" ]
 ...
 |> "` k b r" <| [
    ...
    noun     KiRDiS                    {- Eikobir -}        `gloss`  [ "pollen" ] ]
 ...
 |> "` k d" <| [
    ...
    noun     FuCL |< aT                {- Eukodap -}        `gloss`  [ "coccyx", "sacrum" ] ]
 ...
 |> "` k f" <| [
    ...
    noun     FACiL                     {- EAkif -}          `gloss`  [ "assiduous", "busily engaged [ [ EAkif / ADJ ] ]" ],
 ...
 |> "` k k" <| [
    ...
    verb     FaCL                      {- Eak~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`kuk IV_C_intr", "`akak PV_C_intr", "`ukk IV_V_intr" ]
    ...
    noun     FaCL |< aT                {- Eak~ap -}         -- `others` [ "`akkA' N0_Nh", "`akkA N0" ]
                                                            `gloss`  [ "Akka ( Acre )" ],

    -- ;; Eak~ap_2
    -- Ek      Eak~    Nap     muggy weather

    noun     FaCL |< aT                {- Eak~ap -}         `gloss`  [ "muggy weather" ],

    -- ;; Eakiyk_1
    -- Ekyk    Eakiyk  N-ap    sultry;muggy     [[Eakiyk/ADJ]]

    noun     FaCIL                     {- Eakiyk -}         `gloss`  [ "sultry", "muggy [ [ Eakiyk / ADJ ] ]" ] ]
 ...
 |> "` k r" <| [
    ...
    noun     FaCiL                     {- Eakir -}          `gloss`  [ "disturbed", "muddy", "turbid [ [ Eakir / ADJ ] ]" ],

    -- ;; EakArap_1
    -- EkAr    EakAr   Nap     sediment;dregs

    noun     FaCAL |< aT               {- EakArap -}        `gloss`  [ "sediment", "dregs" ],
    ...
    noun     MuFaCCaL                  {- muEak~ar -}       `gloss`  [ "disturbed", "perturbed", "turbid [ [ muEak ~ ar / ADJ ] ]" ],
    ...
    noun     MutaFaCCiL                {- mutaEak~ir -}     `gloss`  [ "disturbed", "perturbed [ [ mutaEak ~ ir / ADJ ] ]" ] ]
 ...
 |> "` k s" <| [
    ...
    noun     FaCL |< Iy                {- Eakosiy~ -}       `gloss`  [ "opposite", "contrary [ [ Eakosiy ~ / ADJ ] ]" ],
    ...
    noun     MuFACaL |< aT             {- muEAkasap -}      `gloss`  [ "disturbance", "molestation" ],
    ...
    noun     InFiCAL |< Iy             {- {inoEikAsiy~ -}   `gloss`  [ "reflex", "reaction [ [ { inoEikAsiy ~ / ADJ ] ]" ],
    ...
    noun     FACiL |< aT               {- EAkisap -}        `gloss`  [ "reflector" ],
    ...
    noun     MutaFACiL                 {- mutaEAkis -}      `gloss`  [ "opposing", "contrasting [ [ mutaEAkis / ADJ ] ]" ],

    -- ;; munoEakis_1
    -- mnEks   munoEakis       N-ap    reflected     [[munoEakis/ADJ]]

    noun     MunFaCiL                  {- munoEakis -}      `gloss`  [ "reflected [ [ munoEakis / ADJ ] ]" ],
    ...
    noun     FaCUL                     {- Eakuws -}         `gloss`  [ "reversible [ [ Eakuws / ADJ ] ]" ],

    -- ;; Eukuwsiy~ap_1
    -- Ekwsy   Eukuwsiy~       Nap     reversibility     [[Eukuwsiy~/NOUN]]

    noun     FuCUL |< Iy |< aT         {- Eukuwsiy~ap -}    `gloss`  [ "reversibility [ [ Eukuwsiy ~ / NOUN ] ]" ],

    -- ;; maEokuws_1
    -- mEkws   maEokuws        N-ap    reversed;opposite;counter-     [[maEokuws/ADJ]]

    noun     MaFCUL                    {- maEokuws -}       `gloss`  [ "reversed", "opposite", "counter- [ [ maEokuws / ADJ ] ]" ],

    -- ;; maEokuwsiy~ap_1
    -- mEkwsy  maEokuwsiy~     Nap     reversibility     [[maEokuwsiy~/NOUN]]

    noun     MaFCUL |< Iy |< aT        {- maEokuwsiy~ap -}  `gloss`  [ "reversibility [ [ maEokuwsiy ~ / NOUN ] ]" ] ]
 ...
 |> "` k w" <| [
    ...
    noun     FaCCAL |< Iy              {- Eak~Awiy~ -}      `gloss`  [ "from / of Acre ( Palestine ) [ [ Eak ~ Awiy ~ / ADJ ] ]" ],
 ...
 |> "` k z" <| [
    ...
    noun     FuCCAL |< aT              {- Euk~Azap -}       -- `others` [ "`akAkiyz Ndip" ]
 ...
 |> "` l '" <| [
    ...
    noun     IFtiCAL                   {- {iEotilA' -}      `gloss`  [ "ascension", "accession to office" ],
    ...
    noun     IstiFCAL                  {- {isotiEolA' -}    `gloss`  [ "superiority" ] ]
 ...
 |> "` l ^g" <| [
    ...
    noun     MuFACaL |< aT             {- muEAlajap -}      `gloss`  [ "treatment", "therapy", "processing" ],
    ...
    noun     FiCAL |< Iy               {- EilAjiy~ -}       `gloss`  [ "therapeutic [ [ EilAjiy ~ / ADJ ] ]" ],
    ...
    noun     MuFACiL |< aT             {- muEAlijap -}      `gloss`  [ "processor", "CPU" ] ]
 ...
 |> "` l b" <| [
    ...
    noun     FuCL |< aT                {- Eulobap -}        -- `others` [ "`ulab N", "`ilAb N" ]
    ...
    noun     FuCayL |< aT              {- Eulayobap -}      -- `others` [ "`ulayb NAt" ]
 ...
 |> "` l f" <| [
    ...
    verb     HaFCaL                    {- OaEolaf -}        -- `others` [ "`lif IV_yu", "`laf IV_Pass_yu" ]
                                                            `gloss`  [ "feed", "be fed" ],
    ...
    noun     FaCUL |< aT               {- Ealuwfap -}       `gloss`  [ "fodder", "forage" ],
    ...
    noun     MaFCUL                    {- maEoluwf -}       `gloss`  [ "stall-fed", "fatted [ [ maEoluwf / ADJ ] ]" ],
 ...
 |> "` l l" <| [
    ...
    noun     FiCL |< aT                {- Eil~ap -}         -- `others` [ "`ilal N" ]
    ...
    noun     FaCIL                     {- Ealiyl -}         -- `others` [ "'a`illA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "sick", "ailing [ [ Ealiyl / ADJ ] ]", "ailing" ],

    -- ;; Ealiyl_2
    -- Elyl    Ealiyl  N-ap    fresh     [[Ealiyl/ADJ]]

    noun     FaCIL                     {- Ealiyl -}         `gloss`  [ "fresh [ [ Ealiyl / ADJ ] ]" ],

    -- ;; Eil~iy~ap_1
    -- Ely     Eil~iy~ Nap     causality     [[Eil~iy~/NOUN]]

    noun     FiCL |< Iy |< aT          {- Eil~iy~ap -}      `gloss`  [ "causality [ [ Eil ~ iy ~ / NOUN ] ]" ],

    -- ;; EulAlap_1
    -- ElAl    EulAl   Nap     consolation;remnant

    noun     FuCAL |< aT               {- EulAlap -}        `gloss`  [ "consolation", "remnant" ],
    ...
    noun     MaFCUL                    {- maEoluwl -}       `gloss`  [ "ill [ [ maEoluwl / ADJ ] ]" ],
    ...
    noun     MuFaCL                    {- muEal~ -}         `gloss`  [ "sick [ [ muEal ~ / ADJ ] ]" ],

    -- ;; muEotal~_1
    -- mEtl    muEotal~        Nall    sick;defective     [[muEotal~/ADJ]]

    noun     MuFtaCL                   {- muEotal~ -}       `gloss`  [ "sick", "defective [ [ muEotal ~ / ADJ ] ]" ] ]
 ...
 |> "` l m" <| [
    ...
    verb     HaFCaL                    {- OaEolam -}        -- `others` [ "`lam IV_Pass_yu", "`lim IV_yu" ]
    ...
    noun     FiCL |< Iy                {- Eilomiy~ -}       `gloss`  [ "scientific", "scholarly", "academic [ [ Eilomiy ~ / ADJ ] ]" ],
    ...
    noun     FuCL |< aT                {- Eulomap -}        `gloss`  [ "harelip" ],
    ...
    noun     FaCCAL |< aT              {- Eal~Amap -}       `gloss`  [ "scholar" ],

    -- ;; EalAmap_1
    -- ElAm    EalAm   Napdu   mark;sign;point
    -- ElAm    EalAm   NAt     marks;signs;points

    noun     FaCAL |< aT               {- EalAmap -}        -- `others` [ "`alAm NAt" ]
    ...
    noun     FACaL |< Iy               {- EAlamiy~ -}       `gloss`  [ "international", "world-wide", "world [ [ EAlamiy ~ / ADJ ] ]", "internationally", "world-wide [ [ EAlamiy ~ / ADV ] ]" ],

    -- ;; EAlamiy~ap_1
    -- EAlmy   EAlamiy~        Nap     universality;internationalism     [[EAlamiy~/NOUN]]

    noun     FACaL |< Iy |< aT         {- EAlamiy~ap -}     `gloss`  [ "universality", "internationalism [ [ EAlamiy ~ / NOUN ] ]" ],

    -- ;; tiEolAmap_1
    -- tElAm   tiEolAm Nap     scholar

    noun     TiFCAL |< aT              {- tiEolAmap -}      `gloss`  [ "scholar" ],
    ...
    noun     TaFCIL |< Iy              {- taEoliymiy~ -}    `gloss`  [ "educational", "pedagogical", "instructional [ [ taEoliymiy ~ / ADJ ] ]" ],
    ...
    noun     HiFCAL |< Iy              {- IiEolAmiy~ -}     `gloss`  [ "information", "media [ [" ],
    ...
    noun     IstiFCAL |< Iy            {- {isotiEolAmiy~ -} `gloss`  [ "fact-finding", "information gathering [ [ { isotiEolAmiy ~ / ADJ ] ]" ],
    ...
    noun     HaFCaL                    {- OaEolam -}        `gloss`  [ "more / most knowledgeable" ],
    ...
    noun     MaFCUL |< aT              {- maEoluwmap -}     -- `others` [ "ma`luwm NAt" ]
    ...
    noun     MutaFaCCiL                {- mutaEal~im -}     `gloss`  [ "educated [ [ mutaEal ~ im / ADJ ] ]" ] ]
 ...
 |> "` l m n" <| [
    ...
    noun     KaRDaS |< aT              {- Ealomanap -}      `gloss`  [ "secularization" ],

    -- ;; EilomAniy~_1
    -- ElmAny  EilomAniy~      Nall    secular     [[EilomAniy~/ADJ]]

    noun     KiRDAS |< Iy              {- EilomAniy~ -}     `gloss`  [ "secular [ [ EilomAniy ~ / ADJ ] ]" ],

    -- ;; EilomAniy~ap_1
    -- ElmAny  EilomAniy~      Nap     secular nature     [[EilomAniy~/NOUN]]

    noun     KiRDAS |< Iy |< aT        {- EilomAniy~ap -}   `gloss`  [ "secular nature [ [ EilomAniy ~ / NOUN ] ]" ] ]
 ...
 |> "` l n" <| [
    ...
    noun     FaCaL |< Iy               {- Ealaniy~ -}       `gloss`  [ "public [ [ Ealaniy ~ / ADJ ] ]" ],

    -- ;; Ealaniy~ap_1
    -- Elny    Ealaniy~        Nap     openness     [[Ealaniy~/NOUN]]

    noun     FaCaL |< Iy |< aT         {- Ealaniy~ap -}     `gloss`  [ "openness [ [ Ealaniy ~ / NOUN ] ]" ],

    -- ;; Ealin_1
    -- Eln     Ealin   N-ap    open;public     [[Ealin/ADJ]]

    noun     FaCiL                     {- Ealin -}          `gloss`  [ "open", "public [ [ Ealin / ADJ ] ]" ],

    -- ;; EalAniy~ap_1
    -- ElAny   EalAniy~        Nap     openness;public     [[EalAniy~/NOUN]]
    -- ElAnyp  EalAniy~apF     FW-Wa   openly;publicly    [[EalAniy~apF/ADV]]

    noun     FaCAL |< Iy |< aT         {- EalAniy~ap -}     -- `others` [ "`alAniyyaTaN FW-Wa" ]
    ...
    noun     HiFCAL |< Iy              {- IiEolAniy~ -}     `gloss`  [ "publicity [ [" ],
 ...
 |> "` l q" <| [
    ...
    noun     FaCaL |< aT               {- Ealaqap -}        `gloss`  [ "coagulated" ],
    ...
    noun     FaCAL |< aT               {- EalAqap -}        -- `others` [ "`alAq NAt", "`alA'iq Ndip" ]
    ...
    noun     TaFCIL |< aT              {- taEoliyqap -}     `gloss`  [ "marginal note", "coat hanger" ],
 ...
 |> "` l q m" <| [
    ...
    noun     KaRDaS |< aT              {- Ealoqamap -}      `gloss`  [ "embittering" ],
 ...
 |> "` l w" <| [
    ...
    noun     FaCY |< aT                {- EalAp -}          -- `others` [ "`alaN FW-WaBi" ]
                                                            `gloss`  [ "anvil", "anvils [ [ EalAF / NOUN ] ]" ],

    -- ;; EilAwap_1
    -- ElAw    EilAw   Napdu   increase;raise;bonus
    -- ElAw    EilAw   NAt     bonuses;raises

    noun     FiCAL |< aT               {- EilAwap -}        -- `others` [ "`ilAw NAt" ]
                                                            `gloss`  [ "increase", "raise", "bonus", "bonuses", "raises" ],

    -- ;; EilAwapF_1
    -- ElAwp   EilAwapF        FW-Wa   in addition to     [[EilAwapF/ADV]]

    noun     FiCAL |< aT |< aN         {- EilAwapF -}       `gloss`  [ "in addition to [ [ EilAwapF / ADV ] ]" ],
    ...
    noun     FaCY |< Iy                {- Ealawiy~ -}       `gloss`  [ "Alawite [ [ Ealawiy ~ / NOUN ] ]", "Alawite [ [ Ealawiy ~ / ADJ ] ]" ],
    ...
    noun     MaFCY |< aT               {- maEolAp -}        -- `others` [ "ma`Aliy N0_Nh" ]
                                                            `gloss`  [ "greatness", "nobility", "His Excellency" ],

    -- ;; maEAliy_1
    -- mEAly   maEAliy Nprop   Ma'ale

    noun     MaFACI                    {- maEAliy -}        `gloss`  [ "Ma'ale" ],
    ...
    noun     FACI |< aT                {- EAliyap -}        -- `others` [ "`awAliy N0_Nh", "`awAl NK" ]
    ...
    noun     MuFaCCY                   {- muEal~aY -}       -- `others` [ "mu`allA Napdu Nhy", "mu`allay NAn_Nayn" ]
                                                            `gloss`  [ "raised [ [ muEal ~ aY / ADJ ] ]", "raised" ],
    ...
    noun     MutaFACI                  {- mutaEAliy -}      -- `others` [ "muta`Al Nuwn_Niyn NK" ]
    ...
    noun     MustaFCI                  {- musotaEoliy -}    -- `others` [ "musta`l NK" ]
                                                            `gloss`  [ "rising", "lofty [ [ musotaEoliy / ADJ ] ]", "lofty" ] ]
 ...
 |> "` l w y" <| [
    ...
    noun     KuRDIS                    {- Eulowiy~ -}       `gloss`  [ "upper", "superior [ [ Eulowiy ~ / ADJ ] ]" ] ]
 ...
 |> "` l y" <| [
    ...
    noun     FaCAL |< aT               {- EalAyap -}        `gloss`  [ "loftiness", "height" ],

    -- ;; Ealiy~_1
    -- Ely     Ealiy~  N-ap    supreme;high     [[Ealiy~/ADJ]]

    noun     FaCIL                     {- Ealiy~ -}         `gloss`  [ "supreme", "high [ [ Ealiy ~ / ADJ ] ]" ],

    -- ;; Ealiy~_2
    -- Ely     Ealiy~  Nprop   Ali
    -- ElY     Ealiy~  Nprop   Ali

    noun     FaCIL                     {- Ealiy~ -}         `gloss`  [ "Ali" ],

    -- ;; Eiloyap_1
    -- Ely     Eiloy   Nap     prominent

    noun     FiCL |< aT                {- Eiloyap -}        `gloss`  [ "prominent" ],
    ...
    noun     TaFCiL |< aT              {- taEoliyap -}      `gloss`  [ "raising", "elevation" ],
    ...
    noun     FACiL |< aT               {- EAliyap -}        -- `others` [ "`awAliy N0_Nh", "`awAl NK" ]
                                                            `gloss`  [ "uphill slope", "upstream", "uphill slopes" ],
 ...
 |> "` m '" <| [
    ...
    noun     FaCAL                     {- EamA' -}          `gloss`  [ "heavy clouds" ] ]
 ...
 |> "` m ' y" <| [
    ...
    noun     KaRADIS                   {- EamA}iy~ -}       `gloss`  [ "chaotic [ [ EamA } iy ~ / ADJ ] ]" ] ]
 ...
 |> "` m ^s" <| [
    ...
    noun     HaFCaL                    {- OaEoma$ -}        `gloss`  [ "sticky-eyed", "having ophthalmia" ] ]
 ...
 |> "` m d" <| [
    ...
    noun     FaCL |< Iy                {- Eamodiy~ -}       `gloss`  [ "intentional", "premeditated", "voluntary [ [ Eamodiy ~ / ADJ ] ]" ],

    -- ;; Eumodap_1
    -- Emd     Eumod   Napdu   umda (village chief)
    -- Emd     Eumad   N       umdas (village chiefs)

    noun     FuCL |< aT                {- Eumodap -}        -- `others` [ "`umad N" ]
                                                            `gloss`  [ "umda ( village chief )", "umdas ( village chiefs )" ],

    -- ;; Eumodiy~ap_1
    -- Emdy    Eumodiy~        Nap     office of mayor;town hall     [[Eumodiy~/NOUN]]

    noun     FuCL |< Iy |< aT          {- Eumodiy~ap -}     `gloss`  [ "office of mayor", "town hall [ [ Eumodiy ~ / NOUN ] ]" ],
    ...
    noun     FiCAL |< aT               {- EimAdap -}        `gloss`  [ "office of dean" ],
    ...
    noun     FACUL                     {- EAmuwd -}         -- `others` [ "`awAmiyd Ndip" ]
                                                            `gloss`  [ "column", "pillar", "columns", "pillars" ],

    -- ;; Eamuwdiy~_1
    -- Emwdy   Eamuwdiy~       N-ap    vertical;columnar     [[Eamuwdiy~/ADJ]]

    noun     FaCUL |< Iy               {- Eamuwdiy~ -}      `gloss`  [ "vertical", "columnar [ [ Eamuwdiy ~ / ADJ ] ]" ],
    ...
    noun     TaFaCCuL |< Iy            {- taEam~udiy~ -}    `gloss`  [ "intentional", "premeditated [ [ taEam ~ udiy ~ / ADJ ] ]" ],

    -- ;; taEAmudiy~ap_1
    -- tEAmdy  taEAmudiy~      Nap     self-assurance     [[taEAmudiy~/NOUN]]

    noun     TaFACuL |< Iy |< aT       {- taEAmudiy~ap -}   `gloss`  [ "self-assurance [ [ taEAmudiy ~ / NOUN ] ]" ],

    -- ;; taEAmudiy~ap_2
    -- tEAmdy  taEAmudiy~      Nap     orthogonal;perpendicular     [[taEAmudiy~/ADJ]]

    noun     TaFACuL |< Iy |< aT       {- taEAmudiy~ap -}   `gloss`  [ "orthogonal", "perpendicular [ [ taEAmudiy ~ / ADJ ] ]" ],
    ...
    noun     MutaFaCCiL                {- mutaEam~id -}     `gloss`  [ "voluntary", "deliberate [ [ mutaEam ~ id / ADJ ] ]" ],

    -- ;; mutaEAmid_1
    -- mtEAmd  mutaEAmid       N-ap    orthogonal     [[mutaEAmid/ADJ]]

    noun     MutaFACiL                 {- mutaEAmid -}      `gloss`  [ "orthogonal [ [ mutaEAmid / ADJ ] ]" ],

    -- ;; maEomuwdiy~ap_1
    -- mEmwdy  maEomuwdiy~     Nap     baptism     [[maEomuwdiy~/NOUN]]

    noun     MaFCUL |< Iy |< aT        {- maEomuwdiy~ap -}  `gloss`  [ "baptism [ [ maEomuwdiy ~ / NOUN ] ]" ],
    ...
    noun     MuFtaCaL |< Iy |< aT      {- muEotamadiy~ap -} `gloss`  [ "legation", "district [ [ muEotamadiy ~ / NOUN ] ]" ] ]
 ...
 |> "` m h" <| [
    ...
    noun     FaCiL                     {- Eamih -}          `gloss`  [ "blind", "hesitant", "indecisive [ [ Eamih / ADJ ] ]" ] ]
 ...
 |> "` m l" <| [
    ...
    noun     FaCaL |< Iy               {- Eamaliy~ -}       `gloss`  [ "practical", "pragmatic [ [ Eamaliy ~ / ADJ ] ]", "in practice [ [ Eamaliy ~ / ADV ] ]" ],

    -- ;; Eamaliy~ap_1
    -- Emly    Eamaliy~        Napdu   operation;mission;process     [[Eamaliy~/NOUN]]
    -- Emly    Eamaliy~        NAt     operations;missions;processes     [[Eamaliy~/NOUN]]

    noun     FaCaL |< Iy |< aT         {- Eamaliy~ap -}     -- `others` [ "`amaliyy NAt" ]
    ...
    noun     FuCL |< aT                {- Eumolap -}        -- `others` [ "`uml NAt" ]
    ...
    noun     FuCayL |< aT              {- Eumayolap -}      `gloss`  [ "erg" ],

    -- ;; EamAlap_1
    -- EmAl    EamAl   NapAt   labor force;employment

    noun     FaCAL |< aT               {- EamAlap -}        `gloss`  [ "labor force", "employment" ],

    -- ;; Eumuwlap_1
    -- Emwl    Eumuwl  NapAt   commission

    noun     FuCUL |< aT               {- Eumuwlap -}       `gloss`  [ "commission" ],
    ...
    noun     MuFACaL |< aT             {- muEAmalap -}      `gloss`  [ "treatment", "dealing with", "procedure" ],
    ...
    noun     FACiL |< Iy               {- EAmiliy~ -}       `gloss`  [ "factor [ [ EAmiliy ~ / ADJ ] ]" ],

    -- ;; Eum~Aliy~_1
    -- EmAly   Eum~Aliy~       N-ap    labor;workers'     [[Eum~Aliy~/ADJ]]

    noun     FuCCAL |< Iy              {- Eum~Aliy~ -}      `gloss`  [ "labor", "workers ' [ [ Eum ~ Aliy ~ / ADJ ] ]" ],
    ...
    noun     MustaFCaL                 {- musotaEomal -}    `gloss`  [ "used", "in use [ [ musotaEomal / ADJ ] ]" ] ]
 ...
 |> "` m l q" <| [
    ...
    noun     KaRDaS |< aT              {- Eamolaqap -}      `gloss`  [ "gigantism" ],
    ...
    noun     KiRDAS |< Iy              {- EimolAqiy~ -}     `gloss`  [ "gigantic", "huge", "super [ [ EimolAqiy ~ / ADJ ] ]" ] ]
 ...
 |> "` m m" <| [
    ...
    noun     FaCL |< aT                {- Eam~ap -}         `gloss`  [ "paternal aunt" ],

    -- ;; Eim~ap_1
    -- Em      Eim~    Nap     turban

    noun     FiCL |< aT                {- Eim~ap -}         `gloss`  [ "turban" ],
    ...
    noun     FuCUL |< Iy               {- Eumuwmiy~ -}      `gloss`  [ "general", "public", "common [ [ Eumuwmiy ~ / ADJ ] ]" ],

    -- ;; Eumuwmiy~ap_1
    -- Emwmy   Eumuwmiy~       NapAt   generality;universality;general character     [[Eumuwmiy~/NOUN]]

    noun     FuCUL |< Iy |< aT         {- Eumuwmiy~ap -}    `gloss`  [ "generality", "universality", "general character [ [ Eumuwmiy ~ / NOUN ] ]" ],

    -- ;; Eumuwmap_1
    -- Emwm    Eumuwm  Nap     avuncular

    noun     FuCUL |< aT               {- Eumuwmap -}       `gloss`  [ "avuncular" ],

    -- ;; EimAmap_1
    -- EmAm    EimAm   Napdu   turban;skull cap
    -- EmA}m   EamA}im Ndip    turbans;skull caps

    noun     FiCAL |< aT               {- EimAmap -}        -- `others` [ "`amA'im Ndip" ]
    ...
    noun     TaFCIL |< Iy              {- taEomiymiy~ -}    `gloss`  [ "general [ [ taEomiymiy ~ / ADJ ] ]" ],
    ...
    noun     FACL |< aT                {- EAm~ap -}         -- `others` [ "`awAmm Ndip", "`AmmaTaN FW-Wa" ]
                                                            `gloss`  [ "general public", "populace", "in general", "generally [ [ EAm ~ apF / ADV ] ]" ],

    -- ;; EAm~iy~_1
    -- EAmy    EAm~iy~ Nall    popular     [[EAm~iy~/ADJ]]

    noun     FACL |< Iy                {- EAm~iy~ -}        `gloss`  [ "popular [ [ EAm ~ iy ~ / ADJ ] ]" ],

    -- ;; EAm~iy~ap_1
    -- EAmy    EAm~iy~ NapAt   dialect;vernacular;colloquial     [[EAm~iy~/NOUN]]

    noun     FACL |< Iy |< aT          {- EAm~iy~ap -}      `gloss`  [ "dialect", "vernacular", "colloquial [ [ EAm ~ iy ~ / NOUN ] ]" ],

    -- ;; muEam~am_1
    -- mEmm    muEam~am        Nall    wearing a turban     [[muEam~am/ADJ]]

    noun     MuFaCCaL                  {- muEam~am -}       `gloss`  [ "wearing a turban [ [ muEam ~ am / ADJ ] ]" ],

    -- ;; muEotam~_1
    -- mEtm    muEotam~        Nall    wearing a turban     [[muEotam~/ADJ]]

    noun     MuFtaCL                   {- muEotam~ -}       `gloss`  [ "wearing a turban [ [ muEotam ~ / ADJ ] ]" ],
    ...
    verb     FaCLY                     {- Eam~aY -}         -- `others` [ "`ammay PV_Atn IV_Ann_Pass_yu", "`amm IV_0hwnyn_yu PV_ttAw", "`ammiy IV_0hAnn_yu", "`ammA PV_h" ]
 ...
 |> "` m n" <| [
    ...
    noun     FuCAL |< Iy               {- EumAniy~ -}       `gloss`  [ "Omani [ [ EumAniy ~ / NOUN ] ]", "Omani [ [ EumAniy ~ / ADJ ] ]" ],
 ...
 |> "` m q" <| [
    ...
    verb     HaFCaL                    {- OaEomaq -}        -- `others` [ "`maq IV_Pass_yu", "`miq IV_yu" ]
 ...
 |> "` m r" <| [
    ...
    noun     FuCaL |< Iy               {- Eumariy~ -}       `gloss`  [ "Umari" ],
    ...
    verb     HaFCaL                    {- OaEomar -}        -- `others` [ "`mir IV_yu", "`mar IV_Pass_yu" ]
    ...
    noun     FuCL |< Iy                {- Eumoriy~ -}       `gloss`  [ "age-related", "age-based ? ? [ [ Eumoriy ~ / ADJ ] ]" ],

    -- ;; Eumorap_1
    -- Emr     Eumor   Nap     Umra (pilgrimage to Mecca)

    noun     FuCL |< aT                {- Eumorap -}        `gloss`  [ "Umra ( pilgrimage to Mecca )" ],

    -- ;; EimArap_1
    -- EmAr    EimAr   Napdu   building;structure;architecture
    -- EmAr    EimAr   NAt     buildings;structures

    noun     FiCAL |< aT               {- EimArap -}        -- `others` [ "`imAr NAt" ]
    ...
    noun     FaCCAL |< Iy |< aT        {- Eam~Ariy~ap -}    `gloss`  [ "wedding palanquin [ [ Eam ~ Ariy ~ / NOUN ] ]" ],

    -- ;; >aEomar_2
    -- >Emr    >aEomar Nel     populated;flourishing
    -- AEmr    >aEomar Nel     populated;flourishing

    noun     HaFCaL                    {- OaEomar -}        `gloss`  [ "populated", "flourishing" ],
    ...
    noun     MiFCAL |< Iy              {- miEomAriy~ -}     `gloss`  [ "architectural [ [ miEomAriy ~ / ADJ ] ]" ],
    ...
    noun     TaFCIL |< aT              {- taEomiyrap -}     `gloss`  [ "filling", "filling-up" ],
    ...
    noun     IstiFCAL |< Iy            {- {isotiEomAriy~ -} `gloss`  [ "colonialist [ [ { isotiEomAriy ~ / ADJ ] ]" ],
 ...
 |> "` m r n" <| [
    ...
    noun     KuRDAS |< Iy              {- EumorAniy~ -}     `gloss`  [ "architectural", "construction [ [ EumorAniy ~ / ADJ ] ]" ] ]
 ...
 |> "` m s" <| [
    ...
    noun     FACUL                     {- EAmuws -}         `gloss`  [ "Amos ( prophet )" ] ]
 ...
 |> "` m y" <| [
    ...
    verb     FaCiL                     {- Eamiy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "`ma IV_0hwnyn", "`am PV_w_intr", "`may IV_Ann", "`mY IV_0" ]
    ...
    verb     HaFCY                     {- OaEomaY -}        -- `others` [ "'a`m PV_ttAw", "'a`may PV_Atn", "'a`mA PV_h", "`m IV_0hwnyn_yu", "`miy IV_0hAnn_yu", "`mY IV_0_Pass_yu", "`may IV_Ann_Pass_yu" ]
                                                            `gloss`  [ "make blind", "be blinded" ],
    ...
    noun     FaCIL |< aT               {- Eamiy~ap -}       `gloss`  [ "ignorance", "blindness [ [ Eamiy ~ / NOUN ] ]" ],
    ...
    noun     FaCAL |< aT               {- EamAyap -}        `gloss`  [ "ignorance", "blindness", "folly" ],

    -- ;; EamoyAn_1
    -- EmyAn   EamoyAn N       blind

    noun     FaCLAn                    {- EamoyAn -}        `gloss`  [ "blind" ],
    ...
    noun     MaFCY |< aT               {- maEomAp -}        `gloss`  [ "roadless area" ],

    -- ;; taEomiyap_1
    -- tEmy    taEomiy NapAt   camouflage

    noun     TaFCiL |< aT              {- taEomiyap -}      `gloss`  [ "camouflage" ],
    ...
    noun     TaFACI                    {- taEAmiy -}        -- `others` [ "ta`Am NK" ]
                                                            `gloss`  [ "blindness" ],
    ...
    noun     MuFaCCY                   {- muEam~aY -}       -- `others` [ "mu`ammay NAt NAn_Nayn", "mu`ammA Nhy" ]
    ...
    noun     MuFaCCY                   {- muEam~aY -}       -- `others` [ "mu`ammay NAn_Nayn", "mu`ammA Napdu Nhy" ]
                                                            `gloss`  [ "enigmatic", "camouflaged [ [ muEam ~ aY / ADJ ] ]", "camouflaged" ] ]
 ...
 |> "` m y r" <| [
    ...
    noun     KaRADiS |< aT             {- EamAyirap -}      -- `others` [ "`amAyirah N0" ]
                                                            `gloss`  [ "Amayreh" ] ]
 ...
 |> "` n .s l" <| [
    ...
    noun     KuRDuS                    {- EunoSul -}        -- `others` [ "`anA.sil Ndip" ]
 ...
 |> "` n .s r" <| [
    ...
    noun     KuRDuS |< Iy              {- EunoSuriy~ -}     `gloss`  [ "racial", "ethnic [ [ EunoSuriy ~ / ADJ ] ]" ],

    -- ;; EunoSuriy~_2
    -- EnSry   EunoSuriy~      Nall    racist     [[EunoSuriy~/ADJ]]

    noun     KuRDuS |< Iy              {- EunoSuriy~ -}     `gloss`  [ "racist [ [ EunoSuriy ~ / ADJ ] ]" ],

    -- ;; EunoSuriy~ap_1
    -- EnSry   EunoSuriy~      Nap     racism     [[EunoSuriy~/NOUN]]

    noun     KuRDuS |< Iy |< aT        {- EunoSuriy~ap -}   `gloss`  [ "racism [ [ EunoSuriy ~ / NOUN ] ]" ] ]
 ...
 |> "` n ^g h" <| [
    ...
    noun     KuRDuS |< Iy |< aT        {- Eunojuhiy~ap -}   `gloss`  [ "pride", "vanity [ [ Eunojuhiy ~ / NOUN ] ]" ] ]
 ...
 |> "` n ` n" <| [
    ...
    noun     MuKaRDaS                  {- muEanoEan -}      `gloss`  [ "handed down", "transmitted [ [ muEanoEan / ADJ ] ]" ] ]
 ...
 |> "` n b" <| [
    ...
    noun     FaCCAL |< aT              {- Ean~Abap -}       `gloss`  [ "Annaba ( Alg . )" ],
 ...
 |> "` n b r" <| [
    ...
    noun     KaRDaS |< Iy              {- Eanobariy~ -}     `gloss`  [ "liqueur", "amber", "perfumed with ambergris [ [ Eanobariy ~ / ADJ ] ]" ],
 ...
 |> "` n d" <| [
    ...
    noun     FiCL |< Iy |< aT          {- Einodiy~ap -}     `gloss`  [ "subjectivism [ [ Einodiy ~ / NOUN ] ]" ],

    -- ;; Einodiy~At_1
    -- Endy    Einodiy~        NAt     own creation;brain child     [[Einodiy~/NOUN]]

    noun     FiCL |< Iy |< At          {- Einodiy~At -}     -- `others` [ "`indiyy NAt" ]
                                                            `gloss`  [ "own creation", "brain child [ [ Einodiy ~ / NOUN ] ]" ],

    -- ;; Eaniyd_1
    -- Enyd    Eaniyd  N/ap    stubborn;opinionated     [[Eaniyd/ADJ]]

    noun     FaCIL                     {- Eaniyd -}         `gloss`  [ "stubborn", "opinionated [ [ Eaniyd / ADJ ] ]" ],
    ...
    noun     MuFACaL |< aT             {- muEAnadap -}      `gloss`  [ "resistance", "stubbornness" ],

    -- ;; muEAnid_1
    -- mEAnd   muEAnid Nall    stubborn;opinionated     [[muEAnid/ADJ]]

    noun     MuFACiL                   {- muEAnid -}        `gloss`  [ "stubborn", "opinionated [ [ muEAnid / ADJ ] ]" ] ]
 ...
 |> "` n d l" <| [
    ...
    noun     KaRDaS |< aT              {- Eanodalap -}      `gloss`  [ "nightingale 's song" ] ]
 ...
 |> "` n d m" <| [
    ...
    noun     KaRDaS |< Iy              {- Eanodamiy~ -}     `gloss`  [ "crimson", "bright red [ [ Eanodamiy ~ / ADJ ] ]" ] ]
 ...
 |> "` n f" <| [
    ...
    verb     HaFCaL                    {- OaEonaf -}        -- `others` [ "`naf IV_Pass_yu", "`nif IV_yu" ]
    ...
    noun     FuCL |< Iy                {- Eunofiy~ -}       `gloss`  [ "violent", "forceful [ [ Eunofiy ~ / ADJ ] ]" ],
    ...
    noun     FaCaL |< aT               {- Eanafap -}        `gloss`  [ "turbine" ],

    -- ;; Eanafiy~_1
    -- Enfy    Eanafiy~        N-ap    turbo     [[Eanafiy~/ADJ]]

    noun     FaCaL |< Iy               {- Eanafiy~ -}       `gloss`  [ "turbo [ [ Eanafiy ~ / ADJ ] ]" ] ]
 ...
 |> "` n f .s" <| [
    ...
    noun     KaRDaS                    {- EanofaS -}        `gloss`  [ "cantankerous [ [ EanofaS / ADJ ] ]" ],
    ...
    noun     MutaKaRDiS                {- mutaEanofiS -}    `gloss`  [ "boastful", "boasting [ [ mutaEanofiS / ADJ ] ]" ] ]
 ...
 |> "` n n" <| [
    ...
    verb     FaCL                      {- Ean~ -}           -- `others` [ "`anan PV_Cn_intr", "`inn IV_V_intr", "`unn IV_V_intr", "`nun IV-n_intr", "`nin IV-n_intr" ]
    ...
    noun     FuCL |< aT                {- Eun~ap -}         `gloss`  [ "impotence" ],

    -- ;; EanAnap_1
    -- EnAn    EanAn   Nap     impotence

    noun     FaCAL |< aT               {- EanAnap -}        `gloss`  [ "impotence" ],
    ...
    verb     FaCLY                     {- Ean~aY -}         -- `others` [ "`anniy IV_0hAnn_yu", "`ann IV_0hwnyn_yu PV_ttAw", "`annay PV_Atn IV_Ann_Pass_yu", "`annA PV_h" ]
 ...
 |> "` n q" <| [
    ...
    noun     FuCL |< Iy                {- Eunoqiy~ -}       `gloss`  [ "neck", "cervical [ [ Eunoqiy ~ / ADJ ] ]" ],
    ...
    noun     MuFACaL |< aT             {- muEAnaqap -}      `gloss`  [ "embrace", "accolade" ],
    ...
    noun     MutaFACiL                 {- mutaEAniq -}      `gloss`  [ "embracing [ [ mutaEAniq / ADJ ] ]" ] ]
 ...
 |> "` n q d" <| [
    ...
    noun     KuRDUS |< Iy              {- Eunoquwdiy~ -}    `gloss`  [ "cluster ( bomb ) [ [ Eunoquwdiy ~ / ADJ ] ]" ],
 ...
 |> "` n s" <| [
    ...
    noun     FuCUL |< aT               {- Eunuwsap -}       `gloss`  [ "celibacy" ],
 ...
 |> "` n t" <| [
    ...
    verb     HaFCaL                    {- OaEonat -}        -- `others` [ "`nat IV_Pass_yu", "`nit IV_yu" ]
                                                            `gloss`  [ "afflict", "be afflicted" ],
    ...
    noun     MutaFaCCiL                {- mutaEan~it -}     `gloss`  [ "obstinate", "stubborn [ [ mutaEan ~ it / ADJ ] ]" ] ]
 ...
 |> "` n t r" <| [
    ...
    noun     KaRDaS |< aT              {- Eanotarap -}      `gloss`  [ "heroism", "courage" ],
    ...
    noun     KaRDaS |< Iy |< aT        {- Eanotariy~ap -}   `gloss`  [ "heroic", "boasting", "swaggering" ],
    ...
    noun     MutaKaRDiS                {- mutaEanotir -}    `gloss`  [ "braggart [ [ mutaEanotir / ADJ ] ]" ] ]
 ...
 |> "` n w" <| [
    ...
    verb     FaCA                      {- EanA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`anaw PV_Atn", "`nuw IV_0hAnn", "`n IV_0hwnyn", "`an PV_ttAw" ]
                                                            `gloss`  [ "submit", "yield" ],
    ...
    verb     FaCA                      {- EanA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`nY IV_0_Pass_yu", "`anaw PV_Atn", "`nuw IV_0hAnn", "`n IV_0hwnyn", "`an PV_ttAw", "`nay IV_Ann_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- Eanowap -}        -- `others` [ "`anwaTaN FW-Wa" ]
                                                            `gloss`  [ "force", "violence", "forcibly", "violently [ [ EanowapF / ADV ] ]" ],
    ...
    noun     FACI                      {- EAniy -}          -- `others` [ "`An Nuwn_Niyn NK" ]
                                                            `gloss`  [ "subservient", "distressed [ [ EAniy / ADJ ] ]", "distressed" ],

    -- ;; EunAp_1
    -- EnA     EunA    Nap     prisoners

    noun     FuCY |< aT                {- EunAp -}          `gloss`  [ "prisoners" ] ]
 ...
 |> "` n y" <| [
    ...
    noun     FiCAL |< aT               {- EinAyap -}        `gloss`  [ "care", "attention", "concern" ],
    ...
    noun     MaFCY                     {- maEonaY -}        -- `others` [ "ma`Aniy N0_Nh", "ma`An NK", "ma`nA Nhy", "ma`nay NAn_Nayn" ]
    ...
    noun     MuFACY |< aT              {- muEAnAp -}        -- `others` [ "mu`Anay NAt" ]
    ...
    noun     TaFaCCI                   {- taEan~iy -}       -- `others` [ "ta`ann NK" ]
    ...
    noun     MaFCIy                    {- maEoniy~ -}       `gloss`  [ "concerned", "affected", "interested [ [ maEoniy ~ / ADJ ] ]" ],
    ...
    noun     MuFACiL                   {- muEAniy -}        -- `others` [ "mu`An Nuwn_Niyn NK" ]
                                                            `gloss`  [ "suffering [ [ muEAniy / ADJ ] ]", "suffering" ],
    ...
    noun     MuFtaCiL                  {- muEotaniy -}      -- `others` [ "mu`tan Nuwn_Niyn NK" ]
                                                            `gloss`  [ "concerned", "attentive [ [ muEotaniy / ADJ ] ]", "attentive" ],
    ...
    noun     MuFtaCY                   {- muEotanaY -}      -- `others` [ "mu`tanA Napdu", "mu`tan Nuwn_Niyn", "mu`tanay NAt NAn_Nayn" ]
                                                            `gloss`  [ "conscientious", "attentive [ [ muEotanaY / ADJ ] ]", "attentive" ],
    ...
    noun     MaFCY |< Iy               {- maEonawiy~ -}     `gloss`  [ "moral", "spiritual [ [ maEonawiy ~ / ADJ ] ]", "morale", "spirits [ [ maEonawiy ~ / NOUN ] ]", "morally", "spiritually [ [ maEonawiy ~ / ADV ] ]" ],

    -- ;; maEonawiy~_2
    -- mEnwy   maEonawiy~      N-ap    semantic;abstract     [[maEonawiy~/ADJ]]

    noun     MaFCY |< Iy               {- maEonawiy~ -}     `gloss`  [ "semantic", "abstract [ [ maEonawiy ~ / ADJ ] ]" ] ]
 ...
 |> "` n z" <| [
    ...
    noun     FaCL |< aT                {- Eanozap -}        -- `others` [ "`anaz NAt" ]
                                                            `gloss`  [ "goat", "goats" ],

    -- ;; Eunayozap_1
    -- Enyz    Eunayoz NapAt   kid;young goat

    noun     FuCayL |< aT              {- Eunayozap -}      `gloss`  [ "kid", "young goat" ],
    ...
    noun     FaCaL |< aT               {- Eanazap -}        `gloss`  [ "spear" ],
 ...
 |> "` q ' d" <| [
    ...
    noun     KaRADiS |< Iy             {- EaqA}idiy~ -}     `gloss`  [ "dogmatic", "ideological [ [ EaqA } idiy ~ / ADJ ] ]" ],

    -- ;; EaqA}idiy~ap_1
    -- EqA}dy  EaqA}idiy~      Nap     dogmatism     [[EaqA}idiy~/NOUN]]

    noun     KaRADiS |< Iy |< aT       {- EaqA}idiy~ap -}   `gloss`  [ "dogmatism [ [ EaqA } idiy ~ / NOUN ] ]" ] ]
 ...
 |> "` q .s" <| [
    ...
    noun     FaCIL |< aT               {- EaqiySap -}       -- `others` [ "`aqA'i.s Ndip" ]
                                                            `gloss`  [ "braid", "plait", "braids", "plaits" ],

    -- ;; maEoquwS_1
    -- mEqwS   maEoquwS        N-ap    braided;plaited     [[maEoquwS/ADJ]]

    noun     MaFCUL                    {- maEoquwS -}       `gloss`  [ "braided", "plaited [ [ maEoquwS / ADJ ] ]" ],
 ...
 |> "` q ` q" <| [
    ...
    noun     KaRDaS |< aT              {- EaqoEaqap -}      `gloss`  [ "chattering", "jabbering" ],
 ...
 |> "` q b" <| [
    ...
    noun     FaCaL |< aT               {- Eaqabap -}        -- `others` [ "`aqab NAt" ]
                                                            `gloss`  [ "obstacle", "obstacles" ],

    -- ;; Eaqabap_2
    -- Eqb     Eaqab   Nap     Aqaba (Jordan)

    noun     FaCaL |< aT               {- Eaqabap -}        `gloss`  [ "Aqaba ( Jordan )" ],
    ...
    noun     TaFCIL |< aT              {- taEoqiybap -}     `gloss`  [ "blennorrhea" ],

    -- ;; muEAqabap_1
    -- mEAqb   muEAqab NapAt   punishment;sanction

    noun     MuFACaL |< aT             {- muEAqabap -}      `gloss`  [ "punishment", "sanction" ],
    ...
    noun     FiCAL |< Iy               {- EiqAbiy~ -}       `gloss`  [ "punitive", "penal [ [ EiqAbiy ~ / ADJ ] ]" ],
    ...
    noun     TaFACuL |< Iy             {- taEAqubiy~ -}     `gloss`  [ "successive", "alternating [ [ taEAqubiy ~ / ADJ ] ]" ],
    ...
    noun     FACiL |< aT               {- EAqibap -}        -- `others` [ "`awAqib Ndip" ]
    ...
    noun     MuFACaL                   {- muEAqab -}        `gloss`  [ "penalized", "punished [ [ muEAqab / ADJ ] ]" ],
 ...
 |> "` q b l" <| [
    ...
    noun     KuRDUS |< aT              {- Euqobuwlap -}     `gloss`  [ "herpes" ] ]
 ...
 |> "` q d" <| [
    ...
    noun     FuCL |< aT                {- Euqodap -}        -- `others` [ "`uqad N" ]
                                                            `gloss`  [ "complex", "complexes" ],

    -- ;; Euqayodap_1
    -- Eqyd    Euqayod Napdu   knot;nodule

    noun     FuCayL |< aT              {- Euqayodap -}      `gloss`  [ "knot", "nodule" ],

    -- ;; Euqayodiy~_1
    -- Eqydy   Euqayodiy~      N-ap    knotted;nodular     [[Euqayodiy~/ADJ]]

    noun     FuCayL |< Iy              {- Euqayodiy~ -}     `gloss`  [ "knotted", "nodular [ [ Euqayodiy ~ / ADJ ] ]" ],
    ...
    noun     FiCAL |< aT               {- EiqAdap -}        `gloss`  [ "braiding", "trimmings" ],
    ...
    noun     FaCIL |< aT               {- Eaqiydap -}       -- `others` [ "`aqA'id Ndip" ]
                                                            `gloss`  [ "doctrine", "creed", "dogma", "doctrines", "creeds" ],

    -- ;; Eaqadiy~_1
    -- Eqdy    Eaqadiy~        Nall    dogmatic;doctrinaire     [[Eaqadiy~/ADJ]]

    noun     FaCaL |< Iy               {- Eaqadiy~ -}       `gloss`  [ "dogmatic", "doctrinaire [ [ Eaqadiy ~ / ADJ ] ]" ],

    -- ;; Eaqiydiy~ap_1
    -- Eqydy   Eaqiydiy~       Nap     dogmatism     [[Eaqiydiy~/NOUN]]

    noun     FaCIL |< Iy |< aT         {- Eaqiydiy~ap -}    `gloss`  [ "dogmatism [ [ Eaqiydiy ~ / NOUN ] ]" ],
    ...
    noun     HaFCaL                    {- OaEoqad -}        -- `others` [ "`aqdA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "complicated", "difficult [ [ >aEoqad / ADJ ] ]", "difficult" ],
    ...
    noun     TaFACuL |< Iy             {- taEAqudiy~ -}     `gloss`  [ "contractual [ [ taEAqudiy ~ / ADJ ] ]" ],
    ...
    noun     IFtiCAL |< Iy             {- {iEotiqAdiy~ -}   `gloss`  [ "dogmatic", "dogmatism [ [ { iEotiqAdiy ~ / ADJ ] ]" ],

    -- ;; {iEotiqAdiy~ap_1
    -- <EtqAdy {iEotiqAdiy~    Nap     dogmatism     [[{iEotiqAdiy~/NOUN]]
    -- AEtqAdy {iEotiqAdiy~    Nap     dogmatism     [[{iEotiqAdiy~/NOUN]]

    noun     IFtiCAL |< Iy |< aT       {- {iEotiqAdiy~ap -} `gloss`  [ "dogmatism [ [ { iEotiqAdiy ~ / NOUN ] ]" ],
    ...
    noun     MaFCUL                    {- maEoquwd -}       `gloss`  [ "agreed", "contracted [ [ maEoquwd / ADJ ] ]" ],
    ...
    noun     MaFCUL                    {- maEoquwd -}       `gloss`  [ "complicated [ [ maEoquwd / ADJ ] ]" ],
    ...
    noun     MuFaCCaL |< aT            {- muEaq~adap -}     `gloss`  [ "imbroglio", "jigsaw" ],
 ...
 |> "` q f" <| [
    ...
    noun     FuCL |< aT                {- Euqofap -}        -- `others` [ "`uqf NAt" ]
    ...
    noun     HaFCaL                    {- OaEoqaf -}        -- `others` [ "`aqfA' N0_Nh" ]
                                                            `gloss`  [ "crooked", "bent", "hooked [ [ >aEoqaf / ADJ ] ]", "hooked" ],
    ...
    noun     MaFCUL                    {- maEoquwf -}       `gloss`  [ "crooked", "hooked [ [ maEoquwf / ADJ ] ]" ],
    ...
    noun     FaCCAL |< aT              {- Eaq~Afap -}       `gloss`  [ "hook", "fangs" ] ]
 ...
 |> "` q l" <| [
    ...
    noun     FaCL |< Iy                {- Eaqoliy~ -}       `gloss`  [ "mental", "intellectual [ [ Eaqoliy ~ / ADJ ] ]" ],

    -- ;; Eaqoliy~_2
    -- Eqly    Eaqoliy~        Nall    rational     [[Eaqoliy~/ADJ]]

    noun     FaCL |< Iy                {- Eaqoliy~ -}       `gloss`  [ "rational [ [ Eaqoliy ~ / ADJ ] ]" ],

    -- ;; Eaqoliy~ap_1
    -- Eqly    Eaqoliy~        NapAt   mentality;attitude     [[Eaqoliy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- Eaqoliy~ap -}     `gloss`  [ "mentality", "attitude [ [ Eaqoliy ~ / NOUN ] ]" ],

    -- ;; EaqolAniy~_1
    -- EqlAny  EaqolAniy~      Nall    reasonable;rational     [[EaqolAniy~/ADJ]]

    noun     FaCLAn |< Iy              {- EaqolAniy~ -}     `gloss`  [ "reasonable", "rational [ [ EaqolAniy ~ / ADJ ] ]" ],

    -- ;; EaqolAniy~ap_1
    -- EqlAny  EaqolAniy~      Nap     rationalism     [[EaqolAniy~/NOUN]]

    noun     FaCLAn |< Iy |< aT        {- EaqolAniy~ap -}   `gloss`  [ "rationalism [ [ EaqolAniy ~ / NOUN ] ]" ],

    -- ;; Euqolap_1
    -- Eql     Euqol   Napdu   knot;joint;trapeze

    noun     FuCL |< aT                {- Euqolap -}        `gloss`  [ "knot", "joint", "trapeze" ],
    ...
    noun     FaCUL                     {- Eaquwl -}         `gloss`  [ "rational", "reasonable", "judicious [ [ Eaquwl / ADJ ] ]" ],
    ...
    noun     FaCIL |< aT               {- Eaqiylap -}       -- `others` [ "`aqA'il Ndip" ]
    ...
    noun     HaFCaL                    {- OaEoqal -}        `gloss`  [ "more reasonable" ],
    ...
    noun     TaFaCCuL |< Iy |< aT      {- taEaq~uliy~ap -}  `gloss`  [ "intellectualism [ [ taEaq ~ uliy ~ / NOUN ] ]" ],
    ...
    noun     IFtiCAL |< Iy             {- {iEotiqAliy~ -}   `gloss`  [ "concentration camp [ [ { iEotiqAliy ~ / ADJ ] ]" ],
    ...
    noun     MaFCUL |< Iy |< aT        {- maEoquwliy~ap -}  `gloss`  [ "plausibility", "reasonableness", "logical nature [ [ maEoquwliy ~ / NOUN ] ]" ],

    -- ;; mutaEaq~il_1
    -- mtEql   mutaEaq~il      Nall    judicious;reasonable     [[mutaEaq~il/ADJ]]

    noun     MutaFaCCiL                {- mutaEaq~il -}     `gloss`  [ "judicious", "reasonable [ [ mutaEaq ~ il / ADJ ] ]" ],
    ...
    noun     MuFtaCaL |< Iy            {- muEotaqaliy~ -}   `gloss`  [ "prison camp [ [ muEotaqaliy ~ / ADJ ] ]" ] ]
 ...
 |> "` q l n" <| [
    ...
    noun     KaRDaS |< aT              {- Eaqolanap -}      `gloss`  [ "rationalization", "intellectualization" ] ]
 ...
 |> "` q m" <| [
    ...
    noun     FuCL |< aT                {- Euqomap -}        `gloss`  [ "barrenness", "sterility" ],
    ...
    noun     FaCIL                     {- Eaqiym -}         -- `others` [ "`iqAm N", "`aqA'im Ndip", "`uqum N" ]
                                                            `gloss`  [ "sterile [ [ Eaqiym / ADJ ] ]", "sterile" ],
    ...
    noun     MuFaCCaL                  {- muEaq~am -}       `gloss`  [ "pasteurized [ [ muEaq ~ am / ADJ ] ]", "disinfected [ [ muEaq ~ am / ADJ ] ]" ],

    -- ;; miEoqamap_1
    -- mEqm    miEoqam Napdu   sterilizer
    -- mEAqm   maEAqim Ndip    sterilizers

    noun     MiFCaL |< aT              {- miEoqamap -}      -- `others` [ "ma`Aqim Ndip" ]
 ...
 |> "` q q" <| [
    ...
    verb     FaCL                      {- Eaq~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`quq IV_C", "`uqq IV_V", "`aqaq PV_C" ]
                                                            `gloss`  [ "disobey" ],
    ...
    noun     FaCIL |< Iy               {- Eaqiyqiy~ -}      `gloss`  [ "carnelian-red [ [ Eaqiyqiy ~ / ADJ ] ]" ],
    ...
    noun     HaFaCL                    {- OaEaq~ -}         `gloss`  [ "irreverent", "disobedient [ [ >aEaq ~ / ADJ ] ]", "disobedient" ],

    -- ;; EAq~_1
    -- EAq     EAq~    Nall    disobedient;irreverent     [[EAq~/ADJ]]

    noun     FACL                      {- EAq~ -}           `gloss`  [ "disobedient", "irreverent [ [ EAq ~ / ADJ ] ]" ] ]
 ...
 |> "` q r" <| [
    ...
    verb     HaFCaL                    {- OaEoqar -}        -- `others` [ "`qir IV_yu", "`qar IV_Pass_yu" ]
    ...
    noun     FaCAL |< Iy               {- EaqAriy~ -}       `gloss`  [ "mortgage", "real estate [ [ EaqAriy ~ / ADJ ] ]" ],
    ...
    noun     FaCAL |< aT               {- EaqArap -}        `gloss`  [ "barrenness", "sterility" ],

    -- ;; Eaqiyrap_1
    -- Eqyr    Eaqiyr  Nap     voice

    noun     FaCIL |< aT               {- Eaqiyrap -}       `gloss`  [ "voice" ],

    -- ;; EAquwriy~_1
    -- EAqwry  EAquwriy~       N0      Aqouri

    noun     FACUL |< Iy               {- EAquwriy~ -}      `gloss`  [ "Aqouri" ],
    ...
    noun     MuFACaL |< aT             {- muEAqarap -}      `gloss`  [ "addiction", "abandonment" ] ]
 ...
 |> "` q r b" <| [
    ...
    noun     KaRADiS                   {- EaqArib -}        `gloss`  [ "hands ( of a clock )" ],

    -- ;; EaqArib_2
    -- EqArb   EaqArib Ndip    intrigues

    noun     KaRADiS                   {- EaqArib -}        `gloss`  [ "intrigues" ],
 ...
 |> "` r '" <| [
    ...
    noun     IstiFCAL                  {- {isotiEorA' -}    `gloss`  [ "self-exposure", "exhibitionism" ] ]
 ...
 |> "` r .d" <| [
    ...
    verb     HaFCaL                    {- OaEoraD -}        -- `others` [ "`ri.d IV_yu", "`ra.d IV_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- EaroDap -}        `gloss`  [ "public showing" ],

    -- ;; EaroDiy~_1
    -- ErDy    EaroDiy~        N-ap    horizontal;latitudinal     [[EaroDiy~/ADJ]]

    noun     FaCL |< Iy                {- EaroDiy~ -}       `gloss`  [ "horizontal", "latitudinal [ [ EaroDiy ~ / ADJ ] ]" ],
    ...
    noun     FaCLAn |< Iy              {- EaroDAniy~ -}     `gloss`  [ "transversal", "latitudinal [ [ EaroDAniy ~ / ADJ ] ]" ],

    -- ;; EaraDAF_1
    -- ErD     EaraD   NF      incidentally;by chance     [[EaraD/ADV]]

    noun     FaCaL |< aN               {- EaraDAF -}        -- `others` [ "`ara.d NF" ]
                                                            `gloss`  [ "incidentally", "by chance [ [ EaraD / ADV ] ]" ],

    -- ;; EaraDiy~_1
    -- ErDy    EaraDiy~        N-ap    nonessential;fortuitous     [[EaraDiy~/ADJ]]
    -- ErDy    EaraDiy~        NAt     unessentials;accidentals     [[EaraDiy~/NOUN]]

    noun     FaCaL |< Iy               {- EaraDiy~ -}       `gloss`  [ "nonessential", "fortuitous [ [ EaraDiy ~ / ADJ ] ]", "unessentials", "accidentals [ [ EaraDiy ~ / NOUN ] ]" ],

    -- ;; EuroDap_1
    -- ErD     EuroD   Nap     target;object

    noun     FuCL |< aT                {- EuroDap -}        `gloss`  [ "target", "object" ],
    ...
    noun     FaCUL |< Iy               {- EaruwDiy~ -}      `gloss`  [ "prosodic [ [ EaruwDiy ~ / ADJ ] ]" ],
    ...
    noun     FaCIL |< aT               {- EariyDap -}       -- `others` [ "`arA'i.d Ndip" ]
    ...
    noun     TaFCIL |< Iy              {- taEoriyDiy~ -}    `gloss`  [ "exposing [ [ taEoriyDiy ~ / ADJ ] ]" ],

    -- ;; muEAraDap_1
    -- mEArD   muEAraD NapAt   opposition

    noun     MuFACaL |< aT             {- muEAraDap -}      `gloss`  [ "opposition" ],

    -- ;; <iEorAD_1
    -- <ErAD   <iEorAD N/At    avoidance
    -- AErAD   <iEorAD N/At    avoidance

    noun     HiFCAL                    {- IiEorAD -}        `gloss`  [ "avoidance" ],
    ...
    noun     IFtiCAL |< Iy             {- {iEotirADiy~ -}   `gloss`  [ "opposition", "parenthetical [ [ { iEotirADiy ~ / ADJ ] ]" ],
    ...
    noun     IstiFCAL |< Iy            {- {isotiEorADiy~ -} `gloss`  [ "review", "inspection [ [ { isotiEorADiy ~ / ADJ ] ]" ],
    ...
    noun     FACiL |< Iy               {- EAriDiy~ -}       `gloss`  [ "incidental [ [ EAriDiy ~ / ADJ ] ]" ],
    ...
    noun     MuFaCCiL                  {- muEar~iD -}       `gloss`  [ "compromising [ [ muEar ~ iD / ADJ ] ]" ],
    ...
    noun     MuFtaCiL                  {- muEotariD -}      `gloss`  [ "transversal", "lying across [ [ muEotariD / ADJ ] ]" ] ]
 ...
 |> "` r .s" <| [
    ...
    noun     FaCL |< aT                {- EaroSap -}        -- `others` [ "'a`rA.s N", "`ara.s NAt" ]
 ...
 |> "` r ^g" <| [
    ...
    verb     HaFCaL                    {- OaEoraj -}        -- `others` [ "`ra^g IV_Pass_yu", "`ri^g IV_yu" ]
    ...
    noun     FaCaL |< aT               {- Earajap -}        `gloss`  [ "limp" ],
    ...
    noun     HaFCaL                    {- OaEoraj -}        -- `others` [ "`ur^gAn N", "`ar^gA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "lame", "limping" ],
    ...
    noun     HaFCaL                    {- OaEoraj -}        `gloss`  [ "Araj" ],
    ...
    noun     MutaFaCCiL                {- mutaEar~ij -}     `gloss`  [ "twisting", "winding", "sinuous [ [ mutaEar ~ ij / ADJ ] ]" ],

    -- ;; munoEarij_1
    -- mnErj   munoEarij       N-ap    crooked;sinuous     [[munoEarij/ADJ]]

    noun     MunFaCiL                  {- munoEarij -}      `gloss`  [ "crooked", "sinuous [ [ munoEarij / ADJ ] ]" ],
 ...
 |> "` r ^s" <| [
    ...
    noun     TaFCIL |< aT              {- taEoriy$ap -}     -- `others` [ "ta`Ariy^s Ndip" ]
                                                            `gloss`  [ "trellis", "pergola", "trellises", "pergolas" ],

    -- ;; EAri$ap_1
    -- EAr$    EAri$   Nap     vine;climbing

    noun     FACiL |< aT               {- EAri$ap -}        `gloss`  [ "vine", "climbing" ],

    -- ;; muEotari$ap_1
    -- mEtr$   muEotari$       NapAt   vine;climbing

    noun     MuFtaCiL |< aT            {- muEotari$ap -}    `gloss`  [ "vine", "climbing" ] ]
 ...
 |> "` r ` r" <| [
    ...
    noun     KaRDaS |< aT              {- EaroEarap -}      `gloss`  [ "bottle cap" ] ]
 ...
 |> "` r b" <| [
    ...
    noun     FaCaL                     {- Earab -}          -- `others` [ "'a`rAb N" ]
                                                            `gloss`  [ "Arabs [ [ Earab / NOUN ] ]", "bedouins" ],

    -- ;; Earabiy~_1
    -- Erby    Earabiy~        N-ap    Arabic;Arab     [[Earabiy~/ADJ]]

    noun     FaCaL |< Iy               {- Earabiy~ -}       `gloss`  [ "Arabic", "Arab [ [ Earabiy ~ / ADJ ] ]" ],

    -- ;; Earabiy~_2
    -- Erby    Earabiy~        N/ap    Arab     [[Earabiy~/ADJ]]

    noun     FaCaL |< Iy               {- Earabiy~ -}       `gloss`  [ "Arab [ [ Earabiy ~ / ADJ ] ]" ],

    -- ;; Earabap_1
    -- Erb     Earab   Napdu   vehicle;wagon
    -- Erb     Earab   NAt     vehicles;wagons

    noun     FaCaL |< aT               {- Earabap -}        -- `others` [ "`arab NAt" ]
    ...
    noun     HaFCAL |< Iy              {- OaEorAbiy~ -}     `gloss`  [ "bedouin [ [ >aEorAbiy ~ / ADJ ] ]" ],

    -- ;; Euruwbap_1
    -- Erwb    Euruwb  NapAt   Arabism     [[Euruwb/NOUN]]

    noun     FuCUL |< aT               {- Euruwbap -}       `gloss`  [ "Arabism [ [ Euruwb / NOUN ] ]" ],

    -- ;; Euruwbap_2
    -- Erwb    Euruwb  Nap     Oruba;Uruba

    noun     FuCUL |< aT               {- Euruwbap -}       `gloss`  [ "Oruba", "Uruba" ],
    ...
    noun     MuFaCCaL                  {- muEar~ab -}       `gloss`  [ "Arabicized", "translated [ [ muEar ~ ab / ADJ ] ]" ],
    ...
    noun     MustaFCaL                 {- musotaEorab -}    `gloss`  [ "Arabized [ [ musotaEorab / ADJ ] ]" ] ]
 ...
 |> "` r b ^g" <| [
    ...
    noun     KaRDaS |< Iy              {- Earobajiy~ -}     `gloss`  [ "cart driver [ [ Earobajiy ~ / ADJ ] ]" ],
 ...
 |> "` r b d" <| [
    ...
    noun     KaRDaS |< aT              {- Earobadap -}      `gloss`  [ "contentiousness", "quarreling", "raucous" ],

    -- ;; Earobadap_2
    -- Erbd    Earobad Nap     causing disorder;raising hell

    noun     KaRDaS |< aT              {- Earobadap -}      `gloss`  [ "causing disorder", "raising hell" ],

    -- ;; Eirobiyd_1
    -- Erbyd   Eirobiyd        Nall    quarrelsome;contentious     [[Eirobiyd/ADJ]]

    noun     KiRDIS                    {- Eirobiyd -}       `gloss`  [ "quarrelsome", "contentious [ [ Eirobiyd / ADJ ] ]" ],

    -- ;; muEarobid_1
    -- mErbd   muEarobid       Nall    quarrelsome;contentious     [[muEarobid/ADJ]]

    noun     MuKaRDiS                  {- muEarobid -}      `gloss`  [ "quarrelsome", "contentious [ [ muEarobid / ADJ ] ]" ] ]
 ...
 |> "` r b s" <| [
    ...
    noun     KaRDaS |< aT              {- Earobasap -}      `gloss`  [ "disturbance", "confusion" ],
    ...
    noun     MuKaRDiS                  {- muEarobis -}      `gloss`  [ "disturbing", "confusing [ [ muEarobis / ADJ ] ]" ] ]
 ...
 |> "` r d" <| [
    ...
    noun     FaCCAL |< aT              {- Ear~Adap -}       `gloss`  [ "catapult", "machine of war" ] ]
 ...
 |> "` r f" <| [
    ...
    noun     FuCL |< Iy                {- Eurofiy~ -}       `gloss`  [ "conventional", "traditional", "secular", "martial [ [ Eurofiy ~ / ADJ ] ]" ],
    ...
    noun     FaCIL                     {- Eariyf -}         -- `others` [ "`urafA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "knowing", "aware [ [ Eariyf / ADJ ] ]", "aware" ],
    ...
    noun     TaFCIL |< aT              {- taEoriyfap -}     `gloss`  [ "notification", "information" ],

    -- ;; taEoriyfap_2
    -- tEryf   taEoriyf        Napdu   tariff
    -- tEAryf  taEAriyf        Ndip    tariffs

    noun     TaFCIL |< aT              {- taEoriyfap -}     -- `others` [ "ta`Ariyf Ndip" ]
                                                            `gloss`  [ "tariff", "tariffs" ],

    -- ;; taEoriyfiy~_1
    -- tEryfy  taEoriyfiy~     N-ap    tariff     [[taEoriyfiy~/ADJ]]

    noun     TaFCIL |< Iy              {- taEoriyfiy~ -}    `gloss`  [ "tariff [ [ taEoriyfiy ~ / ADJ ] ]" ],

    -- ;; taEorifap_1
    -- tErf    taEorif NapAt   tariff

    noun     TaFCiL |< aT              {- taEorifap -}      `gloss`  [ "tariff" ],
    ...
    noun     FACiL                     {- EArif -}          `gloss`  [ "knowing", "having knowledge of [ [ EArif / ADJ ] ]" ],
 ...
 |> "` r k" <| [
    ...
    noun     FaCL |< aT                {- Earokap -}        `gloss`  [ "fight", "quarrel" ],

    -- ;; Eariykap_1
    -- Eryk    Eariyk  Nap     disposition;temper
    -- ErA}k   EarA}ik Ndip    traits;characteristics

    noun     FaCIL |< aT               {- Eariykap -}       -- `others` [ "`arA'ik Ndip" ]
    ...
    noun     MaFCaL |< aT              {- maEorakap -}      -- `others` [ "ma`Arik Ndip" ]
    ...
    noun     MuFACaL |< aT             {- muEArakap -}      `gloss`  [ "fight", "quarrel" ],
 ...
 |> "` r m" <| [
    ...
    noun     FuCL |< aT                {- Euromap -}        -- `others` [ "`uram N" ]
                                                            `gloss`  [ "heap", "pile", "large amount", "heaps", "piles", "large amounts" ],

    -- ;; Earimap_1
    -- Erm     Earim   Nap     dike

    noun     FaCiL |< aT               {- Earimap -}        `gloss`  [ "dike" ],
 ...
 |> "` r n" <| [
    ...
    noun     FaCIL |< aT               {- Eariynap -}       -- `others` [ "`arA'in Ndip" ]
                                                            `gloss`  [ "thicket", "lair", "thickets", "lairs" ] ]
 ...
 |> "` r q" <| [
    ...
    verb     HaFCaL                    {- OaEoraq -}        -- `others` [ "`riq IV_yu", "`raq IV_Pass_yu" ]
    ...
    noun     FiCL |< Iy                {- Eiroqiy~ -}       `gloss`  [ "ethnic", "racial [ [ Eiroqiy ~ / ADJ ] ]" ],

    -- ;; Eiroqiy~ap_1
    -- Erqy    Eiroqiy~        Nap     racism;ethnocentrism     [[Eiroqiy~/NOUN]]

    noun     FiCL |< Iy |< aT          {- Eiroqiy~ap -}     `gloss`  [ "racism", "ethnocentrism [ [ Eiroqiy ~ / NOUN ] ]" ],
    ...
    noun     FaCAL |< aT               {- EarAqap -}        `gloss`  [ "noble ancestry", "deep ethnic roots" ],
    ...
    noun     FiCAL |< Iy               {- EirAqiy~ -}       `gloss`  [ "Iraqi [ [ EirAqiy ~ / NOUN ] ]", "Iraqi [ [ EirAqiy ~ / ADJ ] ]" ],

    -- ;; >aEoraq_2
    -- >Erq    >aEoraq Nel     more/most deep-rooted
    -- AErq    >aEoraq Nel     more/most deep-rooted

    noun     HaFCaL                    {- OaEoraq -}        `gloss`  [ "more / most deep-rooted" ],

    -- ;; maEoruwq_1
    -- mErwq   maEoruwq        N-ap    emaciated;gaunt     [[maEoruwq/ADJ]]

    noun     MaFCUL                    {- maEoruwq -}       `gloss`  [ "emaciated", "gaunt [ [ maEoruwq / ADJ ] ]" ],

    -- ;; muEar~aq_1
    -- mErq    muEar~aq        N-ap    striated;rooted     [[muEar~aq/ADJ]]

    noun     MuFaCCaL                  {- muEar~aq -}       `gloss`  [ "striated", "rooted [ [ muEar ~ aq / ADJ ] ]" ],

    -- ;; muEar~iq_1
    -- mErq    muEar~iq        N-ap    perspiring     [[muEar~iq/ADJ]]

    noun     MuFaCCiL                  {- muEar~iq -}       `gloss`  [ "perspiring [ [ muEar ~ iq / ADJ ] ]" ],

    -- ;; muEoriq_1
    -- mErq    muEoriq Nall    deep-rooted;ancient and noble     [[muEoriq/ADJ]]

    noun     MuFCiL                    {- muEoriq -}        `gloss`  [ "deep-rooted", "ancient and noble [ [ muEoriq / ADJ ] ]" ],

    -- ;; EaroqAn_1
    -- ErqAn   EaroqAn Ndip    perspiring     [[EaroqAn/ADJ]]

    noun     FaCLAn                    {- EaroqAn -}        `gloss`  [ "perspiring [ [ EaroqAn / ADJ ] ]" ],
 ...
 |> "` r q b" <| [
    ...
    noun     KaRDaS |< aT              {- Earoqabap -}      `gloss`  [ "hamstringing", "paralyzing" ],
    ...
    noun     KuRDUS |< Iy              {- Euroquwbiy~ -}    `gloss`  [ "false", "deceitful", "liar [ [ Euroquwbiy ~ / ADJ ] ]" ] ]
 ...
 |> "` r q l" <| [
    ...
    noun     KaRDaS |< aT              {- Earoqalap -}      -- `others` [ "`arAqiyl Ndip" ]
                                                            `gloss`  [ "obstructing", "impeding", "obstacles", "hurdles" ],

    -- ;; muEaroqil_1
    -- mErql   muEaroqil       Nall    obstructing;impeding     [[muEaroqil/ADJ]]

    noun     MuKaRDiS                  {- muEaroqil -}      `gloss`  [ "obstructing", "impeding [ [ muEaroqil / ADJ ] ]" ],

    -- ;; muEaroqal_1
    -- mErql   muEaroqal       N-ap    obstructed;impeded     [[muEaroqal/ADJ]]

    noun     MuKaRDaS                  {- muEaroqal -}      `gloss`  [ "obstructed", "impeded [ [ muEaroqal / ADJ ] ]" ],
 ...
 |> "` r r" <| [
    ...
    verb     FaCL                      {- Ear~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`urr IV_V", "`rur IV_C", "`arar PV_C" ]
                                                            `gloss`  [ "disgrace", "dishonor" ],

    -- ;; Eur~ap_1
    -- Er      Eur~    Nap     scabies;disgrace;shame

    noun     FuCL |< aT                {- Eur~ap -}         `gloss`  [ "scabies", "disgrace", "shame" ],
    ...
    noun     MaFaCL |< aT              {- maEar~ap -}       `gloss`  [ "scabies", "shame", "disgrace" ],

    -- ;; muEotar~_1
    -- mEtr    muEotar~        Nall    scabious;miserable;scoundrel     [[muEotar~/ADJ]]

    noun     MuFtaCL                   {- muEotar~ -}       `gloss`  [ "scabious", "miserable", "scoundrel [ [ muEotar ~ / ADJ ] ]" ],
    ...
    verb     FaCLY                     {- Ear~aY -}         -- `others` [ "`arrA PV_h", "`arr IV_0hwnyn_yu PV_ttAw", "`arriy IV_0hAnn_yu", "`array PV_Atn IV_Ann_Pass_yu" ]
 ...
 |> "` r s" <| [
    ...
    verb     HaFCaL                    {- OaEoras -}        -- `others` [ "`ras IV_Pass_yu", "`ris IV_yu" ]
    ...
    noun     FuCL |< Iy                {- Eurosiy~ -}       `gloss`  [ "nuptial", "wedding [ [ Eurosiy ~ / ADJ ] ]" ],
    ...
    noun     HiFCAL                    {- IiEorAs -}        `gloss`  [ "wedding feast" ] ]
 ...
 |> "` r w" <| [
    ...
    verb     FaCA                      {- EarA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`rY IV_0_Pass_yu", "`ray IV_Ann_Pass_yu", "`ar PV_ttAw", "`araw PV_Atn", "`ruw IV_0hAnn", "`r IV_0hwnyn" ]
    ...
    noun     FuCL |< aT                {- Eurowap -}        -- `others` [ "`urA Nhy", "`urY N0" ]
 ...
 |> "` r y" <| [
    ...
    verb     FaCiL                     {- Eariy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "`ra IV_0hwnyn", "`rY IV_0", "`ray IV_Ann", "`ar PV_w_intr" ]
    ...
    noun     TaFCiL |< aT              {- taEoriyap -}      `gloss`  [ "uncovering", "exposure", "unveiling" ],

    -- ;; taEar~iy_1
    -- tEry    taEar~iy        N0_Nh   nudity

    noun     TaFaCCI                   {- taEar~iy -}       `gloss`  [ "nudity" ],
    ...
    noun     MuFaCCY                   {- muEar~aY -}       -- `others` [ "mu`array NAt NAn_Nayn", "mu`arr Nuwn_Niyn", "mu`arrA Napdu Nhy" ]
                                                            `gloss`  [ "uncovered", "exposed [ [ muEar ~ aY / ADJ ] ]", "exposed" ],
    ...
    noun     MuFCY                     {- muEoraY -}        -- `others` [ "mu`rA Napdu Nhy", "mu`r Nuwn_Niyn", "ma`Ar NK", "ma`Ariy N0_Nh", "mu`ray NAt NAn_Nayn" ]
                                                            `gloss`  [ "uncovered", "exposed [ [ muEoraY / ADJ ] ]", "exposed" ],
 ...
 |> "` s ^g d" <| [
    ...
    noun     KaRDaS |< Iy              {- Easojadiy~ -}     `gloss`  [ "golden [ [ Easojadiy ~ / ADJ ] ]" ],
 ...
 |> "` s ` s" <| [
    ...
    noun     KaRDaS |< aT              {- EasoEasap -}      `gloss`  [ "darkening" ] ]
 ...
 |> "` s b r" <| [
    ...
    noun     KuRDuS                    {- Eusobur -}        `gloss`  [ "panther" ] ]
 ...
 |> "` s f" <| [
    ...
    verb     HaFCaL                    {- OaEosaf -}        -- `others` [ "`saf IV_Pass_yu", "`sif IV_yu" ]
    ...
    noun     FaCL |< Iy                {- Easofiy~ -}       `gloss`  [ "oppressive [ [ Easofiy ~ / ADJ ] ]" ],
    ...
    noun     TaFaCCuL |< Iy            {- taEas~ufiy~ -}    `gloss`  [ "tyrannical", "despotic", "arbitrary [ [ taEas ~ ufiy ~ / ADJ ] ]" ],

    -- ;; taEas~ufiy~AF_1
    -- tEsfy   taEas~ufiy~     NF      abusively;arbitrarily     [[taEas~ufiy~/ADV]]

    noun     TaFaCCuL |< Iy |< aN      {- taEas~ufiy~AF -}  -- `others` [ "ta`assufiyy NF" ]
                                                            `gloss`  [ "abusively", "arbitrarily [ [ taEas ~ ufiy ~ / ADV ] ]" ],
 ...
 |> "` s k r" <| [
    ...
    noun     KaRDaS |< aT              {- Easokarap -}      `gloss`  [ "militarization" ],
    ...
    noun     KaRDaS |< Iy              {- Easokariy~ -}     `gloss`  [ "military", "army [ [ Easokariy ~ / ADJ ] ]" ],
 ...
 |> "` s l" <| [
    ...
    noun     FaCaL |< Iy               {- Easaliy~ -}       `gloss`  [ "honey-like [ [ Easaliy ~ / ADJ ] ]", "melliferous [ [ Easaliy ~ / NOUN ] ]" ],
    ...
    noun     FaCCAL |< aT              {- Eas~Alap -}       `gloss`  [ "beehive" ],

    -- ;; maEosalap_1
    -- mEsl    maEosal NapAt   beehive

    noun     MaFCaL |< aT              {- maEosalap -}      `gloss`  [ "beehive" ],
 ...
 |> "` s l ^g" <| [
    ...
    noun     KuRDuS                    {- Eusoluj -}        -- `others` [ "`asAli^g Ndip" ]
 ...
 |> "` s r" <| [
    ...
    verb     HaFCaL                    {- OaEosar -}        -- `others` [ "`sir IV_intr_yu" ]
    ...
    noun     HaFCaL                    {- OaEosar -}        -- `others` [ "`asrA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "left-handed" ],
    ...
    noun     FaCLY |< Iy               {- Easorawiy~ -}     `gloss`  [ "left-handed [ [ Easorawiy ~ / ADJ ] ]" ],

    -- ;; maEosarap_1
    -- mEsr    maEosar Nap     difficulty;dire straits

    noun     MaFCaL |< aT              {- maEosarap -}      `gloss`  [ "difficulty", "dire straits" ],

    -- ;; <iEosAr_1
    -- <EsAr   <iEosAr N/At    poverty;insolvency;dire straits
    -- AEsAr   <iEosAr N/At    poverty;insolvency;dire straits

    noun     HiFCAL                    {- IiEosAr -}        `gloss`  [ "poverty", "insolvency", "dire straits" ],
    ...
    noun     MaFCUL                    {- maEosuwr -}       `gloss`  [ "impoverished", "indigent [ [ maEosuwr / ADJ ] ]" ],

    -- ;; muEosir_1
    -- mEsr    muEosir Nall    impoverished;indigent     [[muEosir/ADJ]]

    noun     MuFCiL                    {- muEosir -}        `gloss`  [ "impoverished", "indigent [ [ muEosir / ADJ ] ]" ],

    -- ;; mutaEas~ir_1
    -- mtEsr   mutaEas~ir      Nall    difficult;adverse     [[mutaEas~ir/ADJ]]

    noun     MutaFaCCiL                {- mutaEas~ir -}     `gloss`  [ "difficult", "adverse [ [ mutaEas ~ ir / ADJ ] ]" ] ]
 ...
 |> "` s r w" <| [
    ...
    noun     KaRDAS |< Iy              {- EasorAwiy~ -}     `gloss`  [ "left-handed [ [ EasorAwiy ~ / ADJ ] ]" ] ]
 ...
 |> "` s s" <| [
    ...
    verb     FaCL                      {- Eas~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`sus IV_C", "`uss IV_V", "`asas PV_C" ]
    ...
    noun     FaCL |< aT                {- Eas~ap -}         `gloss`  [ "guards", "bodyguards" ],
 ...
 |> "` s w" <| [
    ...
    verb     FaCA                      {- EasA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`asaw PV_Atn", "`as PV_ttAw", "`s IV_0hwnyn", "`suw IV_0hAnn" ]
                                                            `gloss`  [ "wither" ],
    ...
    noun     FaCY                      {- EasaY -}          -- `others` [ "mA`asA FW-Wa-n~a", "`asA FW-Wa-n~a", "mA`asY FW-Wa" ]
                                                            `gloss`  [ "perhaps [ [ EasaY / CONJ ] ]", "perhaps [ [ EasA / CONJ ] ]", "what perhaps [ [ mA / INTERROG_PART+EasaY / FUNC_WORD ] ]", "what perhaps [ [ mA / INTERROG_PART+EasA / FUNC_WORD ] ]" ],
    ...
    noun     FACI                      {- EAsiy -}          -- `others` [ "`As Nuwn_Niyn NK" ]
                                                            `gloss`  [ "withered [ [ EAsiy / ADJ ] ]", "withered" ] ]
 ...
 |> "` s y" <| [
    ...
    noun     FaCIL                     {- Easiy~ -}         `gloss`  [ "capable", "suited", "able [ [ Easiy ~ / ADJ ] ]" ] ]
 ...
 |> "` t ^s" <| [
    ...
    verb     IFCaLL                    {- {iEota$~ -}       -- `others` [ "`ta^s^s IV_V", "i`ta^sa^s PV_C", "`ta^si^s IV_C" ]
                                                            `gloss`  [ "build a nest", "take root" ] ]
 ...
 |> "` t b" <| [
    ...
    noun     FaCaL |< aT               {- Eatabap -}        -- `others` [ "'a`tAb N" ]
    ...
    noun     FaCCAL |< Iy              {- Eat~Abiy~ -}      `gloss`  [ "zebra [ [ Eat ~ Abiy ~ / ADJ ] ]" ],
    ...
    noun     MuFACaL |< aT             {- muEAtabap -}      `gloss`  [ "censure", "reprimand" ] ]
 ...
 |> "` t d" <| [
    ...
    verb     HaFCaL                    {- OaEotad -}        -- `others` [ "`tid IV_yu", "`tad IV_Pass_yu" ]
    ...
    noun     FaCIL                     {- Eatiyd -}         `gloss`  [ "prepared [ [ Eatiyd / ADJ ] ]" ],
    ...
    verb     IFCaLL                    {- {iEotad~ -}       -- `others` [ "i`tadad PV_C", "`tadid IV_C", "`tadd IV_V" ]
                                                            `gloss`  [ "consider", "deem" ],
    ...
    noun     IFCiLAL                   {- {iEotidAd -}      `gloss`  [ "confidence", "reliance" ],

    -- ;; {iEotidAdiy~_1
    -- <EtdAdy {iEotidAdiy~    Nall    confident     [[{iEotidAdiy~/ADJ]]
    -- AEtdAdy {iEotidAdiy~    Nall    confident     [[{iEotidAdiy~/ADJ]]

    noun     IFCiLAL |< Iy             {- {iEotidAdiy~ -}   `gloss`  [ "confident [ [ { iEotidAdiy ~ / ADJ ] ]" ],

    -- ;; muEotad~_1
    -- mEtd    muEotad~        Nall    confident     [[muEotad~/ADJ]]

    noun     MuFCaLL                   {- muEotad~ -}       `gloss`  [ "confident [ [ muEotad ~ / ADJ ] ]" ] ]
 ...
 |> "` t h" <| [
    ...
    noun     FaCAL |< aT               {- EatAhap -}        `gloss`  [ "insanity" ],
    ...
    noun     MaFCUL                    {- maEotuwh -}       -- `others` [ "ma`Atiyh Ndip" ]
                                                            `gloss`  [ "insane [ [ maEotuwh / ADJ ] ]", "insane" ] ]
 ...
 |> "` t l" <| [
    ...
    noun     FaCaL |< aT               {- Eatalap -}        `gloss`  [ "crowbar" ],

    -- ;; EitAlap_1
    -- EtAl    EitAl   Nap     porting;carrying

    noun     FiCAL |< aT               {- EitAlap -}        `gloss`  [ "porting", "carrying" ],

    -- ;; Eatiyl_1
    -- Etyl    Eatiyl  N-ap    serious;critical     [[Eatiyl/ADJ]]

    noun     FaCIL                     {- Eatiyl -}         `gloss`  [ "serious", "critical [ [ Eatiyl / ADJ ] ]" ],
    ...
    verb     IFCaLL                    {- {iEotal~ -}       -- `others` [ "`tall IV_V", "`talil IV_C", "i`talal PV_C" ]
                                                            `gloss`  [ "allege", "be ill", "be deficient" ],
    ...
    noun     IFCiLAL                   {- {iEotilAl -}      `gloss`  [ "illness", "weakness", "defectiveness" ],

    -- ;; muEotal~_1
    -- mEtl    muEotal~        Nall    sick;defective     [[muEotal~/ADJ]]

    noun     MuFCaLL                   {- muEotal~ -}       `gloss`  [ "sick", "defective [ [ muEotal ~ / ADJ ] ]" ] ]
 ...
 |> "` t l t" <| [
    ...
    noun     KaRDaS |< aT              {- Eatolatap -}      `gloss`  [ "athletics", "track and field" ] ]
 ...
 |> "` t m" <| [
    ...
    verb     HaFCaL                    {- OaEotam -}        -- `others` [ "`tam IV_Pass_yu", "`tim IV_yu" ]
    ...
    noun     FaCL |< aT                {- Eatomap -}        `gloss`  [ "darkness", "gloom" ],

    -- ;; EatAmap_1
    -- EtAm    EatAm   NapAt   darkness

    noun     FaCAL |< aT               {- EatAmap -}        `gloss`  [ "darkness" ],
    ...
    noun     HiFCAL                    {- IiEotAm -}        `gloss`  [ "darkening", "clouding" ],

    -- ;; EAtim_1
    -- EAtm    EAtim   N-ap    dark;indistinct     [[EAtim/ADJ]]

    noun     FACiL                     {- EAtim -}          `gloss`  [ "dark", "indistinct [ [ EAtim / ADJ ] ]" ],

    -- ;; muEotim_1
    -- mEtm    muEotim N-ap    somber;opaque;dark     [[muEotim/ADJ]]

    noun     MuFCiL                    {- muEotim -}        `gloss`  [ "somber", "opaque", "dark [ [ muEotim / ADJ ] ]" ],
    ...
    verb     IFCaLL                    {- {iEotam~ -}       -- `others` [ "`tamm IV_V", "i`tamam PV_C", "`tamim IV_C" ]
                                                            `gloss`  [ "wear a turban" ],

    -- ;; muEotam~_1
    -- mEtm    muEotam~        Nall    wearing a turban     [[muEotam~/ADJ]]

    noun     MuFCaLL                   {- muEotam~ -}       `gloss`  [ "wearing a turban [ [ muEotam ~ / ADJ ] ]" ] ]
 ...
 |> "` t q" <| [
    ...
    verb     HaFCaL                    {- OaEotaq -}        -- `others` [ "`taq IV_Pass_yu", "`tiq IV_yu" ]
    ...
    noun     FaCAL |< aT               {- EatAqap -}        `gloss`  [ "vintage", "age" ],

    -- ;; <iEotAq_1
    -- <EtAq   <iEotAq N/At    liberation
    -- AEtAq   <iEotAq N/At    liberation

    noun     HiFCAL                    {- IiEotAq -}        `gloss`  [ "liberation" ],
    ...
    noun     MuFaCCaL                  {- muEat~aq -}       `gloss`  [ "matured", "mellowed", "aged [ [ muEat ~ aq / ADJ ] ]" ],
 ...
 |> "` t r" <| [
    ...
    noun     MuFaCCaL                  {- muEat~ar -}       `gloss`  [ "slovenly", "foolish", "tramp [ [ muEat ~ ar / ADJ ] ]" ],

    -- ;; muEotar~_1
    -- mEtr    muEotar~        Nall    scabious;miserable;scoundrel     [[muEotar~/ADJ]]

    noun     MuFCaLL                   {- muEotar~ -}       `gloss`  [ "scabious", "miserable", "scoundrel [ [ muEotar ~ / ADJ ] ]" ] ]
 ...
 |> "` t s" <| [
    ...
    verb     IFCaLL                    {- {iEotas~ -}       -- `others` [ "`tasis IV_C", "`tass IV_V", "i`tasas PV_C" ]
                                                            `gloss`  [ "patrol by night", "make nocturnal rounds" ] ]
 ...
 |> "` t w" <| [
    ...
    verb     FaCA                      {- EatA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "`t IV_0hwnyn", "`tuw IV_0hAnn", "`ataw PV_Atn", "`at PV_ttAw_intr" ]
    ...
    noun     FACI                      {- EAtiy -}          -- `others` [ "`At Nuwn_Niyn NK", "`utA Nap" ]
                                                            `gloss`  [ "arrogant", "insolent [ [ EAtiy / ADJ ] ]", "insolent" ] ]
 ...
 |> "` t y" <| [
    ...
    noun     FaCIL                     {- Eatiy~ -}         -- `others` [ "'a`tA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "arrogant", "insolent [ [ Eatiy ~ / ADJ ] ]", "insolent" ] ]
 ...
 |> "` t z" <| [
    ...
    verb     IFCaLL                    {- {iEotaz~ -}       -- `others` [ "`taziz IV_C_intr", "i`tazaz PV_C_intr", "`tazz IV_V_intr" ]
                                                            `gloss`  [ "be proud" ],
    ...
    noun     IFCiLAL                   {- {iEotizAz -}      `gloss`  [ "pride" ],

    -- ;; muEotaz~_1
    -- mEtz    muEotaz~        Nall    proud;mighty     [[muEotaz~/ADJ]]

    noun     MuFCaLL                   {- muEotaz~ -}       `gloss`  [ "proud", "mighty [ [ muEotaz ~ / ADJ ] ]" ],
 ...
 |> "` w '" <| [
    ...
    noun     FuCAL                     {- EuwA' -}          `gloss`  [ "howling", "howls" ],

    -- ;; Eaw~A'_1
    -- EwA'    Eaw~A'  N0_Nh   Bootes (contellation)

    noun     FaCCAL                    {- Eaw~A' -}         `gloss`  [ "Bootes ( contellation )" ] ]
 ...
 |> "` w .d" <| [
    ...
    verb     HaFAL                     {- OaEAD -}          -- `others` [ "`A.d IV_V_Pass_yu", "`i.d IV_C_yu", "`a.d IV_C_Pass_yu", "`iy.d IV_V_yu", "'a`a.d PV_C" ]
    ...
    noun     FiCaL |< aN               {- EiwaDAF -}        -- `others` [ "`iwa.d NF" ]
                                                            `gloss`  [ "in lieu of", "in exchange for [ [ EiwaD / ADV ] ]" ],
    ...
    noun     TaFCIL |< Iy              {- taEowiyDiy~ -}    `gloss`  [ "compensatory", "restitutive [ [ taEowiyDiy ~ / ADJ ] ]" ],

    -- ;; taEAwuDiy~_1
    -- tEAwDy  taEAwuDiy~      N-ap    commutative     [[taEAwuDiy~/ADJ]]

    noun     TaFACuL |< Iy             {- taEAwuDiy~ -}     `gloss`  [ "commutative [ [ taEAwuDiy ~ / ADJ ] ]" ],

    -- ;; {isotiEADap_1
    -- <stEAD  {isotiEAD       NapAt   replacement;substitution;exchange
    -- AstEAD  {isotiEAD       NapAt   replacement;substitution;exchange

    noun     IstiFAL |< aT             {- {isotiEADap -}    `gloss`  [ "replacement", "substitution", "exchange" ],

    -- ;; EA}iD_1
    -- EA}D    EA}iD   Nall    compensating;replacing

    noun     FA'iL                     {- EA}iD -}          `gloss`  [ "compensating", "replacing" ],
 ...
 |> "` w .s" <| [
    ...
    noun     FaCIL                     {- EawiyS -}         `gloss`  [ "difficult", "recondite [ [ EawiyS / ADJ ] ]" ],

    -- ;; >aEowaS_1
    -- >EwS    >aEowaS Nel     more/most difficult;more/most recondite
    -- AEwS    >aEowaS Nel     more/most difficult;more/most recondite

    noun     HaFCaL                    {- OaEowaS -}        `gloss`  [ "more / most difficult", "more / most recondite" ],
 ...
 |> "` w ^g" <| [
    ...
    verb     FAL                       {- EAj-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "`u^g PV_C IV_C", "`uw^g IV_V" ]
                                                            `gloss`  [ "make a stop" ],
    ...
    noun     FAL |< Iy                 {- EAjiy~ -}         `gloss`  [ "ivory [ [ EAjiy ~ / ADJ ] ]" ],

    -- ;; EAjiy~_2
    -- EAjy    EAjiy~  N-ap    Ivorian (of/from the Ivory Coast)     [[EAjiy~/ADJ]]

    noun     FAL |< Iy                 {- EAjiy~ -}         `gloss`  [ "Ivorian ( of / from the Ivory Coast ) [ [ EAjiy ~ / ADJ ] ]" ],
    ...
    noun     HaFCaL                    {- OaEowaj -}        -- `others` [ "`uw^g N", "`aw^gA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "crooked", "bent", "twisted [ [ >aEowaj / ADJ ] ]", "twisted" ],
    ...
    noun     MuFaCCaL                  {- muEaw~aj -}       `gloss`  [ "crooked", "bent [ [ muEaw ~ aj / ADJ ] ]" ],
 ...
 |> "` w _d" <| [
    ...
    verb     HaFAL                     {- OaEA* -}          -- `others` [ "`i_d IV_C_yu", "`A_d IV_V_Pass_yu", "`a_d IV_C_Pass_yu", "`iy_d IV_V_yu", "'a`a_d PV_C" ]
    ...
    noun     FuCL |< aT                {- Euw*ap -}         -- `others` [ "`uwa_d N" ]
                                                            `gloss`  [ "amulet", "incantation", "amulets", "incantations" ],

    -- ;; maEA*_1
    -- mEA*    maEA*   N       protection;taking refuge

    noun     MaFAL                     {- maEA* -}          `gloss`  [ "protection", "taking refuge" ],
    ...
    noun     TaFCIL |< aT              {- taEowiy*ap -}     `gloss`  [ "exorcism" ],

    -- ;; taEowiy*iy~_1
    -- tEwy*y  taEowiy*iy~     N-ap    incantational     [[taEowiy*iy~/ADJ]]

    noun     TaFCIL |< Iy              {- taEowiy*iy~ -}    `gloss`  [ "incantational [ [ taEowiy*iy ~ / ADJ ] ]" ] ]
 ...
 |> "` w d" <| [
    ...
    noun     FaCL                      {- Eawod -}          `gloss`  [ "returning", "going back [ [ Eawod / ADV ] ]" ],

    -- ;; Eawodap_1
    -- Ewd     Eawod   Napdu   return

    noun     FaCL |< aT                {- Eawodap -}        `gloss`  [ "return" ],
    ...
    noun     FAL |< aT                 {- EAdap -}          -- `others` [ "`Ad NAt", "`awA'id Ndip", "`AdaTaN FW-Wa" ]
    ...
    noun     FAL |< Iy                 {- EAdiy~ -}         `gloss`  [ "ordinary", "regular", "normal [ [ EAdiy ~ / ADJ ] ]" ],
    ...
    noun     MaFAL                     {- maEAd -}          `gloss`  [ "return", "destination" ],
    ...
    noun     MuFACaL |< aT             {- muEAwadap -}      `gloss`  [ "reiteration", "repetition" ],

    -- ;; <iEAdap_1
    -- <EAd    <iEAd   NapAt   return;repetition;re-(doing)
    -- AEAd    <iEAd   NapAt   return;repetition;re-(doing)

    noun     HiFAL |< aT               {- IiEAdap -}        `gloss`  [ "return", "repetition", "re- ( doing )" ],
    ...
    noun     IFtiyAL |< Iy             {- {iEotiyAdiy~ -}   `gloss`  [ "customary", "normal", "regular [ [ { iEotiyAdiy ~ / ADJ ] ]" ],

    -- ;; {isotiEAdap_1
    -- <stEAd  {isotiEAd       NapAt   recovery;reclamation
    -- AstEAd  {isotiEAd       NapAt   recovery;reclamation

    noun     IstiFAL |< aT             {- {isotiEAdap -}    `gloss`  [ "recovery", "reclamation" ],
    ...
    noun     FuCCAL                    {- Euw~Ad -}         `gloss`  [ "visitors" ],
    ...
    noun     FA'iL |< aT               {- EA}idap -}        -- `others` [ "`awA'id Ndip" ]
                                                            `gloss`  [ "profit", "profits", "revenues", "royalties" ],

    -- ;; EA}idiy~ap_1
    -- EA}dy   EA}idiy~        Nap     membership;belonging to     [[EA}idiy~/NOUN]]

    noun     FA'iL |< Iy |< aT         {- EA}idiy~ap -}     `gloss`  [ "membership", "belonging to [ [ EA } idiy ~ / NOUN ] ]" ],

    -- ;; muEaw~ad_1
    -- mEwd    muEaw~ad        Nall    accustomed;habituated     [[muEaw~ad/ADJ]]

    noun     MuFaCCaL                  {- muEaw~ad -}       `gloss`  [ "accustomed", "habituated [ [ muEaw ~ ad / ADJ ] ]" ],
    ...
    noun     MutaFaCCiL                {- mutaEaw~id -}     `gloss`  [ "accustomed", "habituated [ [ mutaEaw ~ id / ADJ ] ]" ],

    -- ;; muEotAd_1
    -- mEtAd   muEotAd Nall    habituated;accustomed     [[muEotAd/ADJ]]

    noun     MuFtAL                    {- muEotAd -}        `gloss`  [ "habituated", "accustomed [ [ muEotAd / ADJ ] ]" ],
 ...
 |> "` w h" <| [
    ...
    verb     FaCCaL                    {- Eaw~ah -}         -- `others` [ "`awwih IV" ]
                                                            `gloss`  [ "make sick" ],
    ...
    noun     FAL |< aT                 {- EAhap -}          -- `others` [ "`Ah NAt" ]
    ...
    noun     HaFCaL                    {- OaEowah -}        -- `others` [ "`awhA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "decrepit", "handicapped" ],

    -- ;; maEuwh_1
    -- mEwh    maEuwh  N-ap    diseased;blighted;mildewed     [[maEuwh/ADJ]]

    noun     MaFUL                     {- maEuwh -}         `gloss`  [ "diseased", "blighted", "mildewed [ [ maEuwh / ADJ ] ]" ] ]
 ...
 |> "` w l" <| [
    ...
    noun     HiFAL |< aT               {- IiEAlap -}        `gloss`  [ "sustenance", "support" ],

    -- ;; EA}il_1
    -- EA}l    EA}il   N       breadwinner;sustainer

    noun     FA'iL                     {- EA}il -}          `gloss`  [ "breadwinner", "sustainer" ],
    ...
    noun     FA'iL |< aT               {- EA}ilap -}        -- `others` [ "`A'il NAt", "`awA'il Ndip" ]
                                                            `gloss`  [ "family", "household", "families", "households" ],

    -- ;; EA}iliy~_1
    -- EA}ly   EA}iliy~        N-ap    family;domestic     [[EA}iliy~/ADJ]]

    noun     FA'iL |< Iy               {- EA}iliy~ -}       `gloss`  [ "family", "domestic [ [ EA } iliy ~ / ADJ ] ]" ],

    -- ;; muEaw~il_1
    -- mEwl    muEaw~il        N-ap    determined;resolved     [[muEaw~il/ADJ]]

    noun     MuFaCCiL                  {- muEaw~il -}       `gloss`  [ "determined", "resolved [ [ muEaw ~ il / ADJ ] ]" ],

    -- ;; muEaw~al_1
    -- mEwl    muEaw~al        N-ap    reliable;trusted;authorized     [[muEaw~al/ADJ]]

    noun     MuFaCCaL                  {- muEaw~al -}       `gloss`  [ "reliable", "trusted", "authorized [ [ muEaw ~ al / ADJ ] ]" ],

    -- ;; muEAl_1
    -- mEAl    muEAl   N-ap    responsible     [[muEAl/ADJ]]

    noun     MuFAL                     {- muEAl -}          `gloss`  [ "responsible [ [ muEAl / ADJ ] ]" ],
    ...
    noun     HiFCAL                    {- IiEowAl -}        `gloss`  [ "wailing", "lamentation" ] ]
 ...
 |> "` w l m" <| [
    ...
    noun     KaRDaS |< aT              {- Eawolamap -}      `gloss`  [ "globalization" ] ]
 ...
 |> "` w m" <| [
    ...
    noun     FaCCAL |< aT              {- Eaw~Amap -}       `gloss`  [ "lifesaver", "buoy", "pontoon", "houseboat" ],
 ...
 |> "` w n" <| [
    ...
    noun     MaFUL |< aT               {- maEuwnap -}       `gloss`  [ "aid", "assistance", "support" ],

    -- ;; <iEAnap_1
    -- <EAn    <iEAn   NapAt   support;aid;assistance
    -- AEAn    <iEAn   NapAt   support;aid;assistance

    noun     HiFAL |< aT               {- IiEAnap -}        `gloss`  [ "support", "aid", "assistance" ],
    ...
    noun     TaFACuL |< Iy             {- taEAwuniy~ -}     `gloss`  [ "cooperative [ [ taEAwuniy ~ / ADJ ] ]" ],

    -- ;; {isotiEAnap_1
    -- <stEAn  {isotiEAn       NapAt   seeking help;resorting to;utilization
    -- AstEAn  {isotiEAn       NapAt   seeking help;resorting to;utilization

    noun     IstiFAL |< aT             {- {isotiEAnap -}    `gloss`  [ "seeking help", "resorting to", "utilization" ],
    ...
    noun     MuFACaL |< aT             {- muEAwanap -}      `gloss`  [ "assistance", "aid" ],
 ...
 |> "` w q" <| [
    ...
    noun     FaCCAL |< aT              {- Eaw~Aqap -}       `gloss`  [ "brake" ],

    -- ;; maEAqap_1
    -- mEAq    maEAq   Nap     puzzle box;maze

    noun     MaFAL |< aT               {- maEAqap -}        `gloss`  [ "puzzle box", "maze" ],

    -- ;; <iEAqap_1
    -- <EAq    <iEAq   NapAt   hindering;impeding
    -- AEAq    <iEAq   NapAt   hindering;impeding

    noun     HiFAL |< aT               {- IiEAqap -}        `gloss`  [ "hindering", "impeding" ],
    ...
    noun     TaFCIL |< Iy              {- taEowiyqiy~ -}    `gloss`  [ "delaying", "dilatory [ [ taEowiyqiy ~ / ADJ ] ]" ],
 ...
 |> "` w r" <| [
    ...
    noun     FaCL |< aT                {- Eaworap -}        `gloss`  [ "imperfection", "defect", "weak spot" ],

    -- ;; Eaworap_2
    -- Ewr     Eawor   Napdu   genital
    -- Ewr     Eawor   NAt     genitals

    noun     FaCL |< aT                {- Eaworap -}        -- `others` [ "`awr NAt" ]
    ...
    noun     FIL |< aT                 {- Eiyrap -}         `gloss`  [ "artificial", "false" ],
    ...
    noun     HaFCaL                    {- OaEowar -}        -- `others` [ "`awrA' Nh Nhy N0_Nh", "`uwr N" ]
                                                            `gloss`  [ "one-eyed" ],
    ...
    noun     IstiFAL |< aT             {- {isotiEArap -}    `gloss`  [ "borrowing", "lending" ],
    ...
    noun     IstiFAL |< Iy             {- {isotiEAriy~ -}   `gloss`  [ "metaphorical", "figurative [ [ { isotiEAriy ~ / ADJ ] ]" ],
 ...
 |> "` w y" <| [
    ...
    verb     FaCY                      {- EawaY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ "`wY IV_0_Pass_yu", "`w IV_0hwnyn", "`wiy IV_0hAnn", "`aw PV_ttAw", "`away PV_Atn" ]
    ...
    noun     MuFACiL |< aT             {- muEAwiyap -}      `gloss`  [ "dog ( bitch )" ] ]
 ...
 |> "` w z" <| [
    ...
    verb     HaFCaL                    {- OaEowaz -}        -- `others` [ "`wiz IV_intr_yu" ]
    ...
    noun     FAL |< aT                 {- EAzap -}          `gloss`  [ "poverty", "need" ],
    ...
    noun     HaFCaL                    {- OaEowaz -}        -- `others` [ "'a`Awiyz Ndip" ]
                                                            `gloss`  [ "poor", "needy" ],
    ...
    noun     HiFCAL                    {- IiEowAz -}        `gloss`  [ "destitution", "need" ],

    -- ;; EA}iz_1
    -- EA}z    EA}iz   N-ap    destitute;needy

    noun     FA'iL                     {- EA}iz -}          `gloss`  [ "destitute", "needy" ],
 ...
 |> "` y " <| [
    ...
    verb     HaFCY                     {- OaEoyaY -}        -- `others` [ "`yiy IV_0hAnn_yu", "`yay IV_Ann_Pass_yu", "'a`y PV_ttAw", "`yY IV_0_Pass_yu", "'a`yay PV_Atn", "`y IV_0hwnyn_yu", "'a`yA PV_0h" ]
    ...
    noun     FaCA'                     {- EayA' -}          `gloss`  [ "inability", "disease" ],
    ...
    noun     MuFCI                     {- muEoyiy -}        -- `others` [ "mu`y Nuwn_Niyn NK" ]
                                                            `gloss`  [ "tired", "exhausted [ [ muEoyiy / ADJ ] ]", "exhausted" ],
    ...
    noun     MuFCY                     {- muEoyaY -}        -- `others` [ "mu`yaw NAt NAn_Nayn", "mu`yA Napdu Nhy", "mu`y Nuwn_Niyn" ]
                                                            `gloss`  [ "exhausted [ [ muEoyaY / ADJ ] ]", "exhausted" ] ]
 ...
 |> "` y .s" <| [
    ...
    noun     IFtiCAL                   {- {iEotiyAS -}      `gloss`  [ "difficulty", "intractability" ] ]
 ...
 |> "` y ^s" <| [
    ...
    verb     HaFAL                     {- OaEA$ -}          -- `others` [ "`a^s IV_C_Pass_yu", "'a`a^s PV_C", "`iy^s IV_V_yu", "`A^s IV_V_Pass_yu", "`i^s IV_C_yu" ]
    ...
    noun     FaCL |< aT                {- Eayo$ap -}        `gloss`  [ "life", "existence" ],
    ...
    noun     MaFIL |< aT               {- maEiy$ap -}       -- `others` [ "ma`Ayi^s Ndip" ]
                                                            `gloss`  [ "livelihood" ],

    -- ;; maEiy$iy~_1
    -- mEy$y   maEiy$iy~       N-ap    livelihood     [[maEiy$iy~/ADJ]]

    noun     MaFIL |< Iy               {- maEiy$iy~ -}      `gloss`  [ "livelihood [ [ maEiy $ iy ~ / ADJ ] ]" ],

    -- ;; muEAya$ap_1
    -- mEAy$   muEAya$ NapAt   coexistence

    noun     MuFACaL |< aT             {- muEAya$ap -}      `gloss`  [ "coexistence" ],

    -- ;; <iEA$ap_1
    -- <EA$    <iEA$   NapAt   feeding;subsistence;food ration
    -- AEA$    <iEA$   NapAt   feeding;subsistence;food ration

    noun     HiFAL |< aT               {- IiEA$ap -}        `gloss`  [ "feeding", "subsistence", "food ration" ],
 ...
 |> "` y b" <| [
    ...
    verb     FAL                       {- EAb-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "`iyb IV_V_intr", "`ib IV_C_intr PV_C_intr" ]
    ...
    noun     FaCL |< aT                {- Eayobap -}        -- `others` [ "`ayb NAt" ]
    ...
    noun     FA'iL                     {- EA}ib -}          `gloss`  [ "defective", "shameful [ [ EA } ib / ADJ ] ]" ],

    -- ;; maEiyb_1
    -- mEyb    maEiyb  N-ap    deficient;shameful     [[maEiyb/ADJ]]

    noun     MaFIL                     {- maEiyb -}         `gloss`  [ "deficient", "shameful [ [ maEiyb / ADJ ] ]" ],

    -- ;; muEiyb_1
    -- mEyb    muEiyb  N-ap    deficient;shameful     [[muEiyb/ADJ]]

    noun     MuFiCL                    {- muEiyb -}         `gloss`  [ "deficient", "shameful [ [ muEiyb / ADJ ] ]" ],
 ...
 |> "` y d" <| [
    ...
    noun     FiCAL |< aT               {- EiyAdap -}        -- `others` [ "`iyAd NAt" ]
                                                            `gloss`  [ "clinic", "outpatient clinic", "clinics", "outpatient clinics" ],

    -- ;; EiyAdap_2
    -- EyAd    EiyAd   Nap     visit;consultation

    noun     FiCAL |< aT               {- EiyAdap -}        `gloss`  [ "visit", "consultation" ],

    -- ;; EiyAdiy~_1
    -- EyAdy   EiyAdiy~        Nall    clinical     [[EiyAdiy~/ADJ]]

    noun     FiCAL |< Iy               {- EiyAdiy~ -}       `gloss`  [ "clinical [ [ EiyAdiy ~ / ADJ ] ]" ],

    -- ;; {iEotiyAd_1
    -- <EtyAd  {iEotiyAd       N/At    habituation
    -- AEtyAd  {iEotiyAd       N/At    habituation

    noun     IFtiCAL                   {- {iEotiyAd -}      `gloss`  [ "habituation" ],

    -- ;; {iEotiyAdiy~_1
    -- <EtyAdy {iEotiyAdiy~    N-ap    customary;normal;regular     [[{iEotiyAdiy~/ADJ]]
    -- AEtyAdy {iEotiyAdiy~    N-ap    customary;normal;regular     [[{iEotiyAdiy~/ADJ]]

    noun     IFtiCAL |< Iy             {- {iEotiyAdiy~ -}   `gloss`  [ "customary", "normal", "regular [ [ { iEotiyAdiy ~ / ADJ ] ]" ],
    ...
    noun     FiCL |< Iy |< aT          {- Eiydiy~ap -}      `gloss`  [ "gift", "present [ [ Eiydiy ~ / NOUN ] ]" ],

    -- ;; muEAyadap_1
    -- mEAyd   muEAyad NapAt   holiday greetings

    noun     MuFACaL |< aT             {- muEAyadap -}      `gloss`  [ "holiday greetings" ] ]
 ...
 |> "` y f" <| [
    ...
    noun     FaCUL                     {- Eayuwf -}         `gloss`  [ "proud", "disdainful [ [ Eayuwf / ADJ ] ]" ] ]
 ...
 |> "` y h" <| [
    ...
    noun     MaFCUL                    {- maEoyuwh -}       `gloss`  [ "diseased", "blighted", "mildewed [ [ maEoyuwh / ADJ ] ]" ] ]
 ...
 |> "` y l" <| [
    ...
    verb     FAL                       {- EAl-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "`il IV_C_intr PV_C_intr", "`iyl IV_V_intr" ]
    ...
    verb     HaFCaL                    {- OaEoyal -}        -- `others` [ "`yil IV_yu" ]
                                                            `gloss`  [ "have a large family" ],
 ...
 |> "` y n" <| [
    ...
    noun     FaCCAL                    {- Eay~An -}         `gloss`  [ "sick", "tired [ [ Eay ~ An / ADJ ] ]" ],
    ...
    noun     FaCL |< Iy                {- Eayoniy~ -}       `gloss`  [ "ocular", "eye", "real [ [ Eayoniy ~ / ADJ ] ]" ],

    -- ;; Eiynap_1
    -- Eyn     Eiyn    Nap     advance

    noun     FiCL |< aT                {- Eiynap -}         `gloss`  [ "advance" ],

    -- ;; Eay~inap_1
    -- Eyn     Eay~in  NapAt   sample;specimen

    noun     FaCCiL |< aT              {- Eay~inap -}       `gloss`  [ "sample", "specimen" ],
    ...
    noun     MuFACaL |< aT             {- muEAyanap -}      `gloss`  [ "examination", "inspection", "observation" ],
    ...
    noun     FiCAL |< aN               {- EiyAnAF -}        -- `others` [ "`iyAn NF" ]
                                                            `gloss`  [ "visually", "by sight [ [ EiyAn / ADV ] ]" ],

    -- ;; EiyAniy~_1
    -- EyAny   EiyAniy~        N-ap    eye;ocular     [[EiyAniy~/ADJ]]

    noun     FiCAL |< Iy               {- EiyAniy~ -}       `gloss`  [ "eye", "ocular [ [ EiyAniy ~ / ADJ ] ]" ],

    -- ;; muEay~an_1
    -- mEyn    muEay~an        N-ap    fixed;determined;prescribed     [[muEay~an/ADJ]]

    noun     MuFaCCaL                  {- muEay~an -}       `gloss`  [ "fixed", "determined", "prescribed [ [ muEay ~ an / ADJ ] ]" ] ]
 ...
 |> "` y r" <| [
    ...
    noun     FiCL |< aT                {- Eiyrap -}         `gloss`  [ "artificial", "false" ],

    -- ;; muEiyr_1
    -- mEyr    muEiyr  Nall    lender

    noun     MuFiCL                    {- muEiyr -}         `gloss`  [ "lender" ],

    -- ;; musotaEiyr_1
    -- mstEyr  musotaEiyr      Nall    borrower
    -- mstEAr  musotaEAr       N-ap    borrowed;false

    noun     MustaFiCL                 {- musotaEiyr -}     -- `others` [ "musta`Ar N-ap" ]
                                                            `gloss`  [ "borrower", "borrowed", "false" ],
    ...
    noun     FaCCAL |< aT              {- Eay~Arap -}       `gloss`  [ "crane" ],
    ...
    noun     MuFACaL |< aT             {- muEAyarap -}      `gloss`  [ "calibration", "standardization" ] ]
 ...
 |> "` y s" <| [
    ...
    noun     HaFCaL                    {- OaEoyas -}        -- `others` [ "`iys N", "`aysA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "beige" ],

    -- ;; EiysaY_1
    -- EysY    EiysaY  N0      Issa;Eissa

    noun     FiCLY                     {- EiysaY -}         `gloss`  [ "Issa", "Eissa" ],

    -- ;; EiysaY_2
    -- EysY    EiysaY  Nprop   Jesus (in Islam)

    noun     FiCLY                     {- EiysaY -}         `gloss`  [ "Jesus ( in Islam )" ],

    -- ;; Eiysawiy~_1
    -- Eyswy   Eiysawiy~       Nall    Christian     [[Eiysawiy~/NOUN]]
    -- Eyswy   Eiysawiy~       Nall    Christian     [[Eiysawiy~/ADJ]]

    noun     FiCLY |< Iy               {- Eiysawiy~ -}      `gloss`  [ "Christian [ [ Eiysawiy ~ / NOUN ] ]", "Christian [ [ Eiysawiy ~ / ADJ ] ]" ] ]
 ...
 |> "` y y" <| [
    ...
    verb     FaCiL                     {- Eayiy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "`ya IV_0hwnyn", "`yay IV_Ann", "`ay PV_w_intr", "`yY IV_0", "`yA IV_0" ]
                                                            `gloss`  [ "be incapable" ],
    ...
    noun     FaCLAn                    {- Eay~An -}         `gloss`  [ "sick", "tired [ [ Eay ~ An / ADJ ] ]" ],
 ...
 |> "` z b" <| [
    ...
    noun     FiCL |< aT                {- Eizobap -}        -- `others` [ "`izab N" ]
                                                            `gloss`  [ "farm", "country estate", "farms", "country estates" ],

    -- ;; Euzobap_1
    -- Ezb     Euzob   Nap     celibacy;bachelorhood

    noun     FuCL |< aT                {- Euzobap -}        `gloss`  [ "celibacy", "bachelorhood" ],

    -- ;; Euzuwbap_1
    -- Ezwb    Euzuwb  Nap     celibacy;bachelorhood

    noun     FuCUL |< aT               {- Euzuwbap -}       `gloss`  [ "celibacy", "bachelorhood" ],

    -- ;; Euzuwbiy~ap_1
    -- Ezwby   Euzuwbiy~       Nap     celibacy;bachelorhood     [[Euzuwbiy~/NOUN]]

    noun     FuCUL |< Iy |< aT         {- Euzuwbiy~ap -}    `gloss`  [ "celibacy", "bachelorhood [ [ Euzuwbiy ~ / NOUN ] ]" ],
    ...
    noun     HaFCaL                    {- OaEozab -}        -- `others` [ "`uzb N", "`azbA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "bachelor [ [ >aEozab / ADJ ] ]", "bachelor", "unmarried" ],

    -- ;; EAzib_1
    -- EAzb    EAzib   N/ap    unmarried     [[EAzib/ADJ]]

    noun     FACiL                     {- EAzib -}          `gloss`  [ "unmarried [ [ EAzib / ADJ ] ]" ] ]
 ...
 |> "` z f" <| [
    ...
    noun     FaCUL                     {- Eazuwf -}         `gloss`  [ "disinclined", "averse [ [ Eazuwf / ADJ ] ]" ],
    ...
    noun     MaFCUL |< aT              {- maEozuwfap -}     `gloss`  [ "music piece", "recital" ] ]
 ...
 |> "` z l" <| [
    ...
    verb     HaFCaL                    {- OaEozal -}        -- `others` [ "`zil IV_yu", "`zal IV_Pass_yu" ]
    ...
    noun     FaCL |< Iy                {- Eazoliy~ -}       `gloss`  [ "movable [ [ Eazoliy ~ / ADJ ] ]" ],

    -- ;; Euzolap_1
    -- Ezl     Euzol   Nap     isolation;separation;retirement

    noun     FuCL |< aT                {- Euzolap -}        `gloss`  [ "isolation", "separation", "retirement" ],
    ...
    noun     InFiCAL |< Iy             {- {inoEizAliy~ -}   `gloss`  [ "isolationist [ [ { inoEizAliy ~ / ADJ ] ]" ],

    -- ;; {inoEizAliy~ap_1
    -- <nEzAly {inoEizAliy~    Nap     isolationism     [[{inoEizAliy~/NOUN]]
    -- AnEzAly {inoEizAliy~    Nap     isolationism     [[{inoEizAliy~/NOUN]]

    noun     InFiCAL |< Iy |< aT       {- {inoEizAliy~ap -} `gloss`  [ "isolationism [ [ { inoEizAliy ~ / NOUN ] ]" ],
    ...
    noun     FACiL |< aT               {- EAzilap -}        -- `others` [ "`awAzil Ndip" ]
    ...
    noun     MuFtaCiL                  {- muEotazil -}      `gloss`  [ "isolated", "withdrawn [ [ muEotazil / ADJ ] ]" ],
    ...
    noun     MuFtaCiL |< Iy            {- muEotaziliy~ -}   -- `others` [ "mu`tazil Nap" ]
                                                            `gloss`  [ "Mu'tazilite [ [ muEotaziliy ~ / NOUN ] ]", "Mu'tazilite [ [ muEotaziliy ~ / ADJ ] ]", "Mu'tazilites" ],
 ...
 |> "` z m" <| [
    ...
    noun     FaCL |< aT                {- Eazomap -}        -- `others` [ "`azam NAt" ]
                                                            `gloss`  [ "determination", "firm resolve" ],

    -- ;; Eazuwm_1
    -- Ezwm    Eazuwm  N/ap    determined;resolute     [[Eazuwm/ADJ]]

    noun     FaCUL                     {- Eazuwm -}         `gloss`  [ "determined", "resolute [ [ Eazuwm / ADJ ] ]" ],
    ...
    noun     FuCUL |< aT               {- Euzuwmap -}       `gloss`  [ "invitation", "banquet" ],

    -- ;; Eaziymap_1
    -- Ezym    Eaziym  Nap     determination;firm resolve
    -- EzA}m   EazA}im Ndip    determination;firm resolve

    noun     FaCIL |< aT               {- Eaziymap -}       -- `others` [ "`azA'im Ndip" ]
                                                            `gloss`  [ "determination", "firm resolve" ],
    ...
    noun     MuFtaCiL                  {- muEotazim -}      `gloss`  [ "determined", "resolved [ [ muEotazim / ADJ ] ]" ],
    ...
    noun     TaFCIL |< Iy              {- taEoziymiy~ -}    `gloss`  [ "conjuring", "incantatory [ [ taEoziymiy ~ / ADJ ] ]" ],
 ...
 |> "` z q" <| [
    ...
    noun     MiFCaL |< aT              {- miEozaqap -}      -- `others` [ "ma`Aziq Ndip" ]
 ...
 |> "` z w" <| [
    ...
    verb     FaCY                      {- EazaY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ "`az PV_ttAw", "`z IV_0hwnyn", "`ziy IV_0hAnn", "`azA PV_h", "`zY IV_0_Pass_yu", "`azay PV_Atn" ]
                                                            `gloss`  [ "ascribe", "blame", "be ascribed", "be blamed" ],
    ...
    noun     FiCL |< aT                {- Eizowap -}        `gloss`  [ "ancestry" ],
    ...
    noun     MuFaCCI                   {- muEaz~iy -}       -- `others` [ "mu`azz Nuwn_Niyn NK" ]
 ...
 |> "` z y" <| [
    ...
    verb     FaCiL                     {- Eaziy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "`az PV_w_intr", "`zY IV_0", "`zay IV_Ann", "`za IV_0hwnyn" ]
                                                            `gloss`  [ "be patiently" ],
    ...
    noun     TaFCiL |< aT              {- taEoziyap -}      -- `others` [ "ta`Aziy N0_Nh", "ta`Az NK" ]
 ...
 |> "` z z" <| [
    ...
    verb     FaCL                      {- Eaz~-i -}         `imperf` [ FCiL ]
                                                            -- `others` [ "`azaz PV_C_intr", "`izz IV_V_intr", "`ziz IV_C_intr" ]
    ...
    verb     HaFaCL                    {- OaEaz~ -}         -- `others` [ "`azz IV_V_Pass_yu", "`izz IV_V_yu", "`ziz IV_C_yu", "'a`zaz PV_C" ]
    ...
    noun     FiCL |< aT                {- Eiz~ap -}         `gloss`  [ "power", "glory", "honor" ],
    ...
    noun     FaCIL |< Iy               {- Eaziyziy~ -}      `gloss`  [ "dear", "precious [ [ Eaziyziy ~ / ADJ ] ]" ],

    -- ;; >aEaz~_2
    -- >Ez     >aEaz~  Nel     stronger/strongest;dearer/dearest
    -- AEz     >aEaz~  Nel     stronger/strongest;dearer/dearest

    noun     HaFaCL                    {- OaEaz~ -}         `gloss`  [ "stronger / strongest", "dearer / dearest" ],
    ...
    noun     MaFaCL |< aT              {- maEaz~ap -}       `gloss`  [ "affection", "esteem" ],
    ...
    noun     MuFtaCL                   {- muEotaz~ -}       `gloss`  [ "proud", "mighty [ [ muEotaz ~ / ADJ ] ]" ],
 ...
 |> "`AlamAn" <| [
    ...
    noun     Identity |< Iy            {- EAlamAniy~ -}     `gloss`  [ "secular [ [ EAlamAniy ~ / ADJ ] ]" ] ]
 ...
 |> "`Ama'i_diN" <| [
    ...
    noun     Identity                  {- EAma}i*K -}       `gloss`  [ "that year [ [ EAma } i*K / ADV ] ]" ] ]
 ...
 |> "`Ama_dAk" <| [
    ...
    noun     Identity                  {- EAma*Ak -}        `gloss`  [ "that year [ [ EAma*Ak / ADV ] ]" ] ]
 ...
 |> "`a.ta^s^g" <| [
    ...
    noun     Identity |< Iy            {- EaTa$ojiy~ -}     `gloss`  [ "stoker", "fireman [ [ EaTa $ ojiy ~ / ADJ ] ]", "stokers", "firemen [ [ EaTa $ ojiy ~ / NOUN ] ]" ] ]
 ...
 |> "`a^swA'iyy" <| [
    ...
    noun     Identity                  {- Ea$owA}iy~ -}     `gloss`  [ "random [ [ Ea $ owA } iy ~ / ADJ ] ]" ] ]
 ...
 |> "`abdAl'ilah" <| [
    ...
    noun     Identity                  {- EabodAlIilah -}   `gloss`  [ "Abdel Ilah" ] ]
 ...
 |> "`abdAlma'muwn" <| [
    ...
    noun     Identity                  {- EabodAlmaOomuwn -} `gloss`  [ "Abdel Ma'moun" ] ]
 ...
 |> "`abdAlmu'min" <| [
    ...
    noun     Identity                  {- EabodAlmuWomin -} `gloss`  [ "Abdel Mu'min" ] ]
 ...
 |> "`abdAlra'uwf" <| [
    ...
    noun     Identity                  {- EabodAlraWuwf -}  `gloss`  [ "Abdel Raouf" ] ]
 ...
 |> "`alAma" <| [
    ...
    noun     Identity                  {- EalAma -}         `gloss`  [ "on which / whom", "over which / whom [ [ EalAma / INTERROG_PART ] ]" ] ]
 ...
 |> "`amyAniyy" <| [
    ...
    noun     Identity                  {- EamoyAniy~ -}     `gloss`  [ "blind" ] ]
 ...
 |> "`aqAqiyr" <| [
    ...
    noun     Identity |< Iy            {- EaqAqiyriy~ -}    `gloss`  [ "druggist [ [ EaqAqiyriy ~ / ADJ ] ]" ] ]
 ...
 |> "`arba_hAn" <| [
    ...
    noun     Identity |< aT            {- EarobaxAnap -}    `gloss`  [ "car shed", "coach house" ] ]
 ...
 |> "`i.syAniyy" <| [
    ...
    noun     Identity                  {- EiSoyAniy~ -}     `gloss`  [ "subversive", "insurrectionist [ [ EiSoyAniy ~ / ADJ ] ]" ] ]
 ...
 |> "`inda_dAk" <| [
    ...
    noun     Identity                  {- Einoda*Ak -}      `gloss`  [ "at that time", "then [ [ Einoda*Ak / ADV ] ]" ] ]
 ...
 |> "`indahA" <| [
    ...
    noun     Identity                  {- EinodahA -}       `gloss`  [ "then", "at that moment [ [ EinodahA / ADV ] ]" ] ]
 ...
 |> "`u.smAnl" <| [
    ...
    noun     Identity |< Iy            {- EuSomAnoliy~ -}   `gloss`  [ "Ottoman", "old-fashioned [ [ EuSomAnoliy ~ / NOUN ] ]", "old-fashioned [ [ EuSomAnoliy ~ / ADJ ] ]" ] ]
 ...
 |> "`u.tArid" <| [
    ...
    noun     Identity |< Iy            {- EuTAridiy~ -}     `gloss`  [ "Mercury", "Mercurial [ [ EuTAridiy ~ / ADJ ] ]" ] ]
 ...
 |> "`udwAniyy" <| [
    ...
    noun     Identity                  {- EudowAniy~ -}     `gloss`  [ "hostile", "aggressive [ [ EudowAniy ~ / ADJ ] ]" ],

    -- ;; EudowAniy~ap_1
    -- EdwAny  EudowAniy~      Nap     aggression;belligerency     [[EudowAniy~/NOUN]]

    noun     Identity |< aT            {- EudowAniy~ap -}   `gloss`  [ "aggression", "belligerency [ [ EudowAniy ~ / NOUN ] ]" ] ]
 ...
 |> "`uliyy" <| [
    ...
    noun     Identity |< aT            {- Euliy~ap -}       -- `others` [ "`alAliy N0_Nh", "`alAl NK" ]
                                                            `gloss`  [ "upper room [ [ Euliy ~ / NOUN ] ]", "upper rooms" ] ]
 ...
 |> "`ullayq" <| [
    ...
    noun     Identity |< aT            {- Eul~ayoqap -}     `gloss`  [ "shrub", "burning bush" ] ]
 ...
 |> "`un^guhAn" <| [
    ...
    noun     Identity |< Iy |< aT      {- EunojuhAniy~ap -} `gloss`  [ "pride", "vanity [ [ EunojuhAniy ~ / NOUN ] ]" ],

    -- ;; EunojuhAniy~_1
    -- EnjhAny EunojuhAniy~    Nall    proud;vain     [[EunojuhAniy~/ADJ]]

    noun     Identity |< Iy            {- EunojuhAniy~ -}   `gloss`  [ "proud", "vain [ [ EunojuhAniy ~ / ADJ ] ]" ] ]
 ...
 |> "`uryAniyy" <| [
    ...
    noun     Identity                  {- EuroyAniy~ -}     `gloss`  [ "nudist", "naturist [ [ EuroyAniy ~ / ADJ ] ]", "nudism", "naturism [ [ EuroyAniy ~ / NOUN ] ]" ] ]
 ...
 |> "`utiyy" <| [
    ...
    noun     Identity                  {- Eutiy~ -}         `gloss`  [ "arrogance" ] ]
 ...
 |> "i`tidA'iyy" <| [
    ...
    noun     Identity                  {- {iEotidA}iy~ -}   `gloss`  [ "aggressive", "hostile [ [ { iEotidA } iy ~ / ADJ ] ]" ] ]
 ...
 |> "ma`luwmAt" <| [
    ...
    noun     Identity |< Iy            {- maEoluwmAtiy~ -}  `gloss`  [ "information science", "informatics [ [ maEoluwmAtiy ~ / ADJ ] ]" ] ]
 ...
 |> "ma`madAn" <| [
    ...
    noun     Identity |< Iy            {- maEomadAniy~ -}   `gloss`  [ "Baptist [ [ maEomadAniy ~ / NOUN ] ]", "Baptist [ [ maEomadAniy ~ / ADJ ] ]" ] ]
 ...
 |> "mu`aknan" <| [
    ...
    noun     Identity                  {- muEakonan -}      `gloss`  [ "annoyed", "irritated [ [ muEakonan / ADJ ] ]" ] ]
 ...
 |> "ta`bAw" <| [
    ...
    noun     Identity |< Iy            {- taEobAwiy~ -}     -- `others` [ "ta`bawiyy Nall" ]
                                                            `gloss`  [ "tactical [ [ taEobAwiy ~ / ADJ ] ]", "tactical [ [ taEobawiy ~ / ADJ ] ]" ] ]
 ...
 |> "ta`ill" <| [
    ...
    noun     Identity |< aT            {- taEil~ap -}       `gloss`  [ "pretext" ] ]
