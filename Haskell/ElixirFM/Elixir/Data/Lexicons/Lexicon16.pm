...
$lexicon = {
  ...
  '.t .g w' => [
    ...
    {
      'types' => $lexicon->{'.t .g w'}[1]{'types'},
      'entry' => '.ta.gY',
      'form' => '.ta.gY',
      'others' => $lexicon->{'.t .g w'}[1]{'others'},
      'lines' => $lexicon->{'.t .g w'}[1]{'lines'},
      'index' => '1',
      'entity' => 'verb',
      'morphs' => 'FaCaNY',
      'glosses' => $lexicon->{'.t .g w'}[1]{'glosses'},
      'suffix' => '',
      'imperf' => $lexicon->{'.t .g w'}[1]{'imperf'},
      'glosshash' => $lexicon->{'.t .g w'}[1]{'glosshash'},
      'orig' => 'TagaY-a',
      'prefix' => ''
    }
  ],
