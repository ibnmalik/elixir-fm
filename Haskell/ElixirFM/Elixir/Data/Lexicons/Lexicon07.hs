...
lexicon = listing "Lexicon properties"
 ...
 |> "'u_hduwd" <| [
    ...
    noun     MiFaCL |< aT              {- mixad~ap -}       `others` [ "mi_hadd Napdu" ]
 ...
 |> "_h_drf" <| [
    ...
    noun     KuRDUS |< Iy              {- xu*oruwfiy~ -}    `gloss`  [ "turbinate", "top-like" ] ]
 ...
 |> "_hrb.t" <| [
    ...
    noun     KaRDaS |< aT              {- xarobaTap -}      `others` [ "_harba.t Nap" ]
 ...
 |> "_hr_hr" <| [
    ...
    noun     KaRDaS |< aT              {- xaroxarap -}      `others` [ "_har_har NapAt" ]
                                                            `gloss`  [ "snoring" ] ]
 ...
 |> "_hr.t" <| [
    ...
    noun     FuCAL |< aT               {- xurATap -}        `others` [ "_hurA.t Nap" ]
                                                            `gloss`  [ "shavings" ],
 ...
 |> "_hr.tn" <| [
    ...
    noun     KaRADIS |< Iy             {- xarATiyniy~ -}    `gloss`  [ "wormlike", "vermiform" ] ]
 ...
 |> "_hrf" <| [
    ...
    noun     FuCAL |< aT               {- xurAfap -}        `others` [ "_hurAf NapAt" ]
                                                            `gloss`  [ "superstition", "fairy tale" ],

    -- ;; xurAfiy~_1
    -- xrAfy   xurAfiy~        Nall    fictitious;legendary     [[xurAfiy~/ADJ]]

    noun     FuCAL |< Iy               {- xurAfiy~ -}       `gloss`  [ "fictitious", "legendary" ],
 ...
 |> "_hrf^s" <| [
    ...
    noun     KaRDaS |< aT              {- xarofa$ap -}      `others` [ "_harfa^s NapAt" ]
    ...
    noun     KaRDUS |< aT              {- xarofuw$ap -}     `others` [ "_harfuw^s Napdu", "_harAfiy^s Ndip" ]
 ...
 |> "_hrm^s" <| [
    ...
    noun     KuRDAS |< aT              {- xuromA$ap -}      `others` [ "_hurmA^s NapAt" ]
                                                            `gloss`  [ "harrow" ] ]
 ...
 |> "_hzm" <| [
    ...
    noun     FuCAL |< aT               {- xuzAmap -}        `others` [ "_huzAm Nap" ]
                                                            `gloss`  [ "lavender" ] ]
 ...
 |> "_hzn" <| [
    ...
    noun     MaFACiL |< Iy             {- maxAziniy~ -}     `gloss`  [ "gendarme" ],
 ...
 |> "_hstk" <| [
    ...
    noun     KaRDaS |< aT              {- xasotakap -}      `others` [ "_hastak Nap" ]
                                                            `gloss`  [ "indisposition" ],

    -- ;; muxasotak_1
    -- mxstk   muxasotak       Nall    indisposed     [[muxasotak/ADJ]]

    noun     MuKaRDaS                  {- muxasotak -}      `gloss`  [ "indisposed" ] ]
 ...
 |> "_h^s_h^s" <| [
    ...
    noun     KaRDaS |< aT              {- xa$oxa$ap -}      `others` [ "_ha^s_ha^s Napdu" ]
    ...
    noun     KuRDIS |< aT              {- xu$oxiy$ap -}     `others` [ "_hu^s_hiy^s Nap", "_ha^sA_hiy^s Ndip" ]
 ...
 |> "_h^sr" <| [
    ...
    noun     FuCAL |< aT               {- xu$Arap -}        `others` [ "_hu^sAr Nap" ]
 ...
 |> "_h.s.s" <| [
    ...
    noun     FACL                      {- xAS~ -}           `gloss`  [ "special", "specific" ],

    -- ;; xAS~_2
    -- xAS     xAS~    Nall    private;exclusive     [[xAS~/ADJ]]

    noun     FACL                      {- xAS~ -}           `gloss`  [ "private", "exclusive" ] ]
 ...
 |> "_h.s.s" <| [
    ...
    noun     FACL |< aT                {- xAS~ap -}         `others` [ "bi_hA.s.saT FW-Wa", "_hA.s.s Nap" ]
                                                            `gloss`  [ "elite", "especially" ],

    -- ;; xAS~iy~ap_1
    -- xASy    xAS~iy~ NapAt   specialty;peculiarity     [[xAS~iy~/NOUN]]

    noun     FACL |< Iy |< aT          {- xAS~iy~ap -}      `others` [ "_hA.s.siyy NapAt" ]
 ...
 |> "_h.s_h.s" <| [
    ...
    noun     KaRDaS |< aT              {- xaSoxaSap -}      `others` [ "_ha.s_ha.s NapAt" ]
                                                            `gloss`  [ "privatization" ],

    -- ;; muxaSoxaS_1
    -- mxSxS   muxaSoxaS       N-ap    privatized     [[muxaSoxaS/ADJ]]

    noun     MuKaRDaS                  {- muxaSoxaS -}      `gloss`  [ "privatized" ] ]
 ...
 |> "_h.d_h.d" <| [
    ...
    noun     KaRDaS |< aT              {- xaDoxaDap -}      `others` [ "_ha.d_ha.d NapAt" ]
 ...
 |> "_hu.dar" <| [
    ...
    noun     FuCAL |< aT               {- xuDArap -}        `others` [ "_hu.dAr Nap" ]
                                                            `gloss`  [ "greens", "herbs" ],
 ...
 |> "_hi.drim" <| [
    ...
    noun     MuKaRDaS                  {- muxaDoram -}      `gloss`  [ "senior", "middle-aged" ] ]
 ...
 |> "_h.trf" <| [
    ...
    noun     KaRDaS |< aT              {- xaTorafap -}      `others` [ "_ha.traf Nap" ]
                                                            `gloss`  [ "delirium" ] ]
 ...
 |> "ta_haffiy" <| [
    ...
    noun     FACI                      {- xAfiy -}          `others` [ "_hAf Nuwn_Niyn NK" ]
                                                            `gloss`  [ "hidden", "secret" ],
    ...
    noun     FACI |< aT                {- xAfiyap -}        `others` [ "_hawAf NK", "_hAfiy NAt Napdu", "_hawAfiy N0_Nh" ]
                                                            `gloss`  [ "secret", "secrets" ] ]
 ...
 |> "_hl.s" <| [
    ...
    noun     FuCAL |< aT               {- xulASap -}        `others` [ "_hulA.s Nap" ]
 ...
 |> "_hlqn" <| [
    ...
    noun     KuRDAS |< Iy              {- xuloqAniy~ -}     `gloss`  [ "old-clothes dealer" ] ]
 ...
 |> "_hmm" <| [
    ...
    noun     FACL                      {- xAm~ -}           `gloss`  [ "stinking", "rotten" ],
 ...
 |> "_hmsn" <| [
    ...
    noun     KaRDIS |< Iy              {- xamosiyniy~ -}    `gloss`  [ "fifties", "fiftieth" ] ]
 ...
 |> "_hms" <| [
    ...
    noun     FuCAL |< Iy               {- xumAsiy~ -}       `gloss`  [ "fivefold", "five-part", "five-year" ],
 ...
 |> "_hm^s" <| [
    ...
    noun     FuCAL |< aT               {- xumA$ap -}        `others` [ "_humA^s NapAt" ]
                                                            `gloss`  [ "scratch", "scar" ] ]
 ...
 |> "_hnzr" <| [
    ...
    noun     KaRADIS |< Iy             {- xanAziyriy~ -}    `gloss`  [ "scrofulous" ] ]
 ...
 |> "_hnfr" <| [
    ...
    noun     KaRDaS |< aT              {- xanofarap -}      `others` [ "_hanfar NapAt" ]
 ...
 |> "_hwzq" <| [
    ...
    noun     KaRDaS |< aT              {- xawozaqap -}      `others` [ "_hawzaq NapAt" ]
 ...
 |> "_h.d" <| [
    ...
    noun     MaFAL |< aT               {- maxADap -}        `others` [ "ma_hA.d NAt Napdu", "ma_hAwi.d Ndip" ]
                                                            `gloss`  [ "ford", "fords" ] ]
 ...
 |> "_hf" <| [
    ...
    noun     MaFAL |< aT               {- maxAfap -}        `others` [ "ma_hAf Nap", "ma_hAwif Ndip" ]
 ...
 |> "_hw" <| [
    ...
    noun     FACI                      {- xAwiy -}          `others` [ "_hAw Nuwn_Niyn NK" ]
 ...
 |> "_hyr" <| [
    ...
    noun     FaCCiL                    {- xay~ir -}         `gloss`  [ "good", "virtuous", "charitable" ],
 ...
 |> "_hayluwl" <| [
    ...
    noun     Identity |< aT            {- xayoluwlap -}     `others` [ "_hayluwl Nap" ]
