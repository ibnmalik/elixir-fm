...
package Elixir::Data::Lexicons::Lexicon05;
...
$lexicon = {
  ...
  '^g w f' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"subterranean [ [ jawofiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"subterranean [ [ jawofiy ~ / ADJ ] ]"' => 1,
        '"interior"' => 1
      },
      'orig' => 'jawofiy~',
      'prefix' => ''
  ...
  '^g r d' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"for the sole reason [ [ limujar ~ ad / ADV ] ]"'
        ]
      ],
      'glosshash' => {
        '"mere"' => 1,
        '"nothing but"' => 1,
        '"for the sole reason [ [ limujar ~ ad / ADV ] ]"' => 1,
        '"for no reason except"' => 1
      },
      'orig' => 'mujar~ad',
      'prefix' => ''
    },
  ...
  '^g w `' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"of starvation [ [ juwE / ADV ] ]"'
        ]
      ],
      'glosshash' => {
        '"of starvation [ [ juwE / ADV ] ]"' => 1,
        '"of hunger"' => 1,
        '"hunger"' => 1,
        '"starvation"' => 1
      },
  ...
  '^g n w' => [
    ...
    {
      'types' => $lexicon->{'^g n w'}[0]{'types'},
      'entry' => '^ganY',
      'form' => '^ganY',
      'others' => $lexicon->{'^g n w'}[0]{'others'},
      'lines' => $lexicon->{'^g n w'}[0]{'lines'},
      'index' => '2',
      'entity' => 'verb',
      'morphs' => 'FaCaNY',
      'glosses' => $lexicon->{'^g n w'}[0]{'glosses'},
      'suffix' => '',
      'imperf' => $lexicon->{'^g n w'}[0]{'imperf'},
      'glosshash' => $lexicon->{'^g n w'}[0]{'glosshash'},
      'orig' => 'janaY-i',
      'prefix' => ''
    },
    {
  ...
  '^g n s' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"national [ [ jinosiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"national [ [ jinosiy ~ / ADJ ] ]"' => 1,
        '"racial"' => 1,
        '"ethnic"' => 1
      },
      'orig' => 'jinosiy~',
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"citizenship [ [ jinosiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"citizenship [ [ jinosiy ~ / NOUN ] ]"' => 1,
        '"nationality"' => 1
      },
      'orig' => 'jinosiy~ap',
      'prefix' => ''
  ...
  '^gazA\'ir' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"Algerian [ [ jazA } iriy ~ / NOUN ] ]"'
        ],
        [
          '"Algerian [ [ jazA } iriy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"Algerian [ [ jazA } iriy ~ / ADJ ] ]"' => 1,
        '"Algerian [ [ jazA } iriy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'jazA}iriy~',
      'prefix' => ''
    }
  ...
  '^g r n' => [
    ...
    {
      'types' => $lexicon->{'^g r n'}[0]{'types'},
      'entry' => '^garY',
      'form' => '^garY',
      'others' => $lexicon->{'^g r n'}[0]{'others'},
      'lines' => $lexicon->{'^g r n'}[0]{'lines'},
      'index' => '1',
      'entity' => 'verb',
      'morphs' => 'FaCaNY',
      'glosses' => $lexicon->{'^g r n'}[0]{'glosses'},
      'suffix' => '',
      'imperf' => $lexicon->{'^g r n'}[0]{'imperf'},
      'glosshash' => $lexicon->{'^g r n'}[0]{'glosshash'},
      'orig' => 'jaraY-i',
      'prefix' => ''
    },
    {
    ...
    {
      'types' => $lexicon->{'^g r n'}[8]{'types'},
      'entry' => '^gAriy',
      'form' => '^gAriyaN',
      'others' => $lexicon->{'^g r n'}[8]{'others'},
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"taking place [ [ jAriy / ADJ ] ]"'
        ],
        [
          '"taking place [ [ jAr / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"taking place [ [ jAriy / ADJ ] ]"' => 1,
        '"proceeding"' => 1,
        '"current"' => 1,
        '"taking place [ [ jAr / ADJ ] ]"' => 1,
        '"present"' => 1
      },
      'orig' => 'jAriy',
      'prefix' => ''
    ...
    {
      'types' => $lexicon->{'^g r n'}[10]{'types'},
      'entry' => '^gAriy',
      'form' => '^gAriy',
      'others' => $lexicon->{'^g r n'}[10]{'others'},
      'lines' => $lexicon->{'^g r n'}[10]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACI',
      'suffix' => '',
      'glosses' => $lexicon->{'^g r n'}[10]{'glosses'},
      'glosshash' => $lexicon->{'^g r n'}[10]{'glosshash'},
      'orig' => 'jAriy',
      'prefix' => ''
    }
  ],
  ...
  '^g m b r' => [
    {
      ...
      'glosshash' => {
        '"shrimp [ [ jamobariy ~ / ADJ ] ]"' => 1,
        '"shrimp [ [ jam ~ ariy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'jamobariy~',
      'prefix' => ''
    }
  ...
  '^g b l' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"mountainous [ [ jabaliy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"mountainous [ [ jabaliy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'jabaliy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"highlander [ [ jabaliy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"highlander [ [ jabaliy ~ / ADJ ] ]"' => 1,
        '"mountaineer"' => 1
      },
      'orig' => 'jabaliy~',
      'prefix' => ''
  ...
  '^g w b' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"answering [ [ jawAbiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"answering [ [ jawAbiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'jawAbiy~',
      'prefix' => ''
    },
  ...
  '^g d d' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"in earnest [ [ jid ~ iy ~ / ADV ] ]"'
        ]
      ],
      'glosshash' => {
        '"seriously"' => 1,
        '"in earnest [ [ jid ~ iy ~ / ADV ] ]"' => 1
      },
      'orig' => 'jid~iy~AF',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"earnestness [ [ jid ~ iy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"earnestness [ [ jid ~ iy ~ / NOUN ] ]"' => 1,
        '"seriousness"' => 1
      },
      'orig' => 'jid~iy~ap',
      'prefix' => ''
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"renovated [ [ mujad ~ ad / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"renovated [ [ mujad ~ ad / ADJ ] ]"' => 1,
        '"renewed"' => 1
      },
      'orig' => 'mujad~ad',
      'prefix' => ''
  ...
  '^g d m' => [
    {
      'types' => $lexicon->{'^g d \''}[0]{'types'},
      'entry' => '^gadA\'',
      'form' => '^gadA\'',
      'others' => $lexicon->{'^g d \''}[0]{'others'},
      'lines' => $lexicon->{'^g d \''}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCA\'',
      'suffix' => '',
      'glosses' => $lexicon->{'^g d \''}[0]{'glosses'},
      'glosshash' => $lexicon->{'^g d \''}[0]{'glosshash'},
      'orig' => 'jadA\'',
      'prefix' => ''
    },
    {
  ...
  '^g l w' => [
    {
      ...
      'others' => [
        'ta^gallA PV_h IV_h',
        'ta^gall PV_ttAw_intr IV_0hwnyn',
        'ta^gallay PV_Atn IV_Ann'
      ],
      'lines' => [
        ';; tajal~aY_1',
  ...
  '^g r _t m' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"bacterial [ [ jurovuwmiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"bacterial [ [ jurovuwmiy ~ / ADJ ] ]"' => 1,
        '"germ"' => 1
      },
      'orig' => 'jurovuwmiy~',
      'prefix' => ''
  ...
  '^g d y' => [
    {
      'types' => $lexicon->{'^g d m'}[1]{'types'},
      'entry' => 'mu^gdiy',
      'form' => 'mu^gdiy',
      'others' => $lexicon->{'^g d m'}[1]{'others'},
      'lines' => $lexicon->{'^g d m'}[1]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'MuFCiL',
      'suffix' => '',
      'glosses' => $lexicon->{'^g d m'}[1]{'glosses'},
      'glosshash' => $lexicon->{'^g d m'}[1]{'glosshash'},
      'orig' => 'mujodiy',
      'prefix' => ''
    },
    {
  ...
  '^g z \'' => [
    ...
    {
      'types' => $lexicon->{'^g z n'}[0]{'types'},
      'entry' => '^gazA\'',
      'form' => '^gazA\'',
      'lines' => $lexicon->{'^g z n'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'^g z n'}[0]{'glosses'},
      'glosshash' => $lexicon->{'^g z n'}[0]{'glosshash'},
      'orig' => 'jazA\'',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'^g z n'}[1]{'types'},
      'entry' => '^gazA\'',
      'form' => '^gazA\'iyy',
  ...
  '^g w w' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"atmospheric [ [ jaw ~ iy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"air"' => 1,
        '"atmospheric [ [ jaw ~ iy ~ / ADJ ] ]"' => 1,
        '"aerial"' => 1
      },
      'orig' => 'jaw~iy~',
      'prefix' => ''
  ...
  '^g n b' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"marginal [ [ jAnibiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"side"' => 1,
        '"marginal [ [ jAnibiy ~ / ADJ ] ]"' => 1,
        '"lateral"' => 1
      },
      'orig' => 'jAnibiy~',
      'prefix' => ''
    },
    {
      ...
      'glosshash' => {
        '"foreign [ [ >ajonabiy ~ / ADJ ] ]"' => 1,
        '"foreign [ [ >ajAnib / ADJ ] ]"' => 1
      },
      'orig' => 'Oajonabiy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"foreigner [ [ >ajonabiy ~ / NOUN ] ]"'
        ],
        [
          '"foreigner [ [ >ajAnib / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"foreigner [ [ >ajAnib / NOUN ] ]"' => 1,
        '"foreigner [ [ >ajonabiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'Oajonabiy~',
      'prefix' => ''
    },
  ...
  '^g l d' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"cutaneous [ [ jilodiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"cutaneous [ [ jilodiy ~ / ADJ ] ]"' => 1,
        '"dermal"' => 1
      },
      'orig' => 'jilodiy~',
      'prefix' => ''
  ...
  '^g \' `' => [
    {
      'types' => $lexicon->{'^g w `'}[1]{'types'},
      'entry' => '^gA\'i`',
      'form' => '^gA\'i`',
      'lines' => $lexicon->{'^g w `'}[1]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACiL',
      'suffix' => '',
      'glosses' => $lexicon->{'^g w `'}[1]{'glosses'},
      'glosshash' => $lexicon->{'^g w `'}[1]{'glosshash'},
      'orig' => 'jA}iE',
      'prefix' => ''
    }
  ],
  '^g h r' => [
    ...
    },
    {
      ...
      'glosshash' => {
        '"openly [ [ jahorapF / ADV ] ]"' => 1,
        '"publicly"' => 1,
        '"publicly [ [ jahor / ADV ] ]"' => 1,
        '"notoriety"' => 1
      },
      'orig' => 'jahor',
      'prefix' => ''
  ...
  '^g h d' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"holy warfare [ [ jihAdiy ~ / NOUN ] ]"'
        ],
        [
          '"holy warfare [ [ jihAdiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"holy warfare [ [ jihAdiy ~ / ADJ ] ]"' => 1,
        '"Jihadist"' => 1,
        '"holy warfare [ [ jihAdiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'jihAdiy~',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"expended ( efforts ) [ [ majohuwd / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"efforts"' => 1,
        '"expended ( efforts ) [ [ majohuwd / ADJ ] ]"' => 1,
        '"endeavors"' => 1
      },
      'orig' => 'majohuwd',
      'prefix' => ''
  ...
  '^ganba' => [
    {
      ...
      'glosshash' => {
        '"next to [ [ janoba / PREP ] ]"' => 1,
        '"next to [ [ janobi / PREP ] ]"' => 1,
        '"next to [ [ janob / PREP ] ]"' => 1
      },
      'orig' => 'janoba',
      'prefix' => ''
    }
  ...
  '^g m h r' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"republican [ [ jumohuwriy ~ / ADJ ] ]"'
        ],
        [
          '"republic [ [ jumohuwriy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"republican [ [ jumohuwriy ~ / ADJ ] ]"' => 1,
        '"republic [ [ jumohuwriy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'jumohuwriy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"throng [ [ jamAhiyriy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"throng [ [ jamAhiyriy ~ / ADJ ] ]"' => 1,
        '"mass"' => 1
      },
      'orig' => 'jamAhiyriy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"Jamahiriya [ [ jamAhiyriy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"Jamahiriya [ [ jamAhiyriy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'jamAhiyriy~ap',
      'prefix' => ''
    }
  ...
  '^g l \'' => [
    {
      'types' => $lexicon->{'^g l w'}[1]{'types'},
      'entry' => '^galA\'',
      'form' => '^galA\'',
      'lines' => $lexicon->{'^g l w'}[1]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'^g l w'}[1]{'glosses'},
      'glosshash' => $lexicon->{'^g l w'}[1]{'glosshash'},
      'orig' => 'jalA\'',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'^g l w'}[2]{'types'},
      'entry' => '\'i^glA\'',
      'form' => '\'i^glA\'',
      'lines' => $lexicon->{'^g l w'}[2]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'HiFCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'^g l w'}[2]{'glosses'},
      'glosshash' => $lexicon->{'^g l w'}[2]{'glosshash'},
      'orig' => 'IijolA\'',
      'prefix' => ''
    }
  ],
  '^g \' z' => [
    ...
    {
      'types' => $lexicon->{'^g w z'}[9]{'types'},
      'entry' => '^gA\'iz',
      'form' => '^gA\'iz',
      'lines' => $lexicon->{'^g w z'}[9]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACiL',
      'suffix' => '',
      'glosses' => $lexicon->{'^g w z'}[9]{'glosses'},
      'glosshash' => $lexicon->{'^g w z'}[9]{'glosshash'},
      'orig' => 'jA}iz',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'^g w z'}[10]{'types'},
      'entry' => '^gA\'iz',
      'form' => '^gA\'izaT',
      'others' => $lexicon->{'^g w z'}[10]{'others'},
  ...
  '^g h l' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"Jahili ( pre-Islamic ) [ [ jAhiliy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"pagan"' => 1,
        '"Jahili ( pre-Islamic ) [ [ jAhiliy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'jAhiliy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"unidentified [ [ majohuwl / ADJ ] ]"'
        ],
        [
          '"unidentified ( persons ) [ [ majohuwl / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"unidentified ( persons ) [ [ majohuwl / NOUN ] ]"' => 1,
        '"unknown"' => 1,
        '"unidentified [ [ majohuwl / ADJ ] ]"' => 1
      },
      'orig' => 'majohuwl',
      'prefix' => ''
    }
  ...
  '^g .g r f' => [
    {
      ...
      'glosses' => [
        [
          '"geographical [ [ jugorAfiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"geographical [ [ jugorAfiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'jugorAfiy~',
      'prefix' => ''
    }
  ...
  '^g _d b' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"gravitational [ [ jA*ibiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"gravitational [ [ jA*ibiy ~ / NOUN ] ]"' => 1,
        '"gravitation"' => 1
      },
      'orig' => 'jA*ibiy~ap',
      'prefix' => ''
  ...
  '^g m `' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"society [ [ jamoEiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"society [ [ jamoEiy ~ / NOUN ] ]"' => 1,
        '"association"' => 1
      },
      'orig' => 'jamoEiy~ap',
      'prefix' => ''
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"collective [ [ jamAEiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"social"' => 1,
        '"collective [ [ jamAEiy ~ / ADJ ] ]"' => 1,
        '"common"' => 1
      },
      'orig' => 'jamAEiy~',
      'prefix' => ''
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"university [ [ jAmiEiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"university [ [ jAmiEiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'jAmiEiy~',
      'prefix' => ''
    },
  ...
  '^g s m' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"material [ [ jisomiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"material [ [ jisomiy ~ / ADJ ] ]"' => 1,
        '"bodily"' => 1
      },
      'orig' => 'jisomiy~',
      'prefix' => ''
  ...
  '^g w l' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"itinerant [ [ mutajaw ~ il / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"traveling"' => 1,
        '"itinerant [ [ mutajaw ~ il / ADJ ] ]"' => 1
      },
      'orig' => 'mutajaw~il',
      'prefix' => ''
    }
  ...
  '^g w r' => [
    ...
    {
      'types' => $lexicon->{'^g \' r'}[0]{'types'},
      'entry' => '^gA\'ir',
      'form' => '^gA\'ir',
      'lines' => $lexicon->{'^g \' r'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FA\'iL',
      'suffix' => '',
      'glosses' => $lexicon->{'^g \' r'}[0]{'glosses'},
      'glosshash' => $lexicon->{'^g \' r'}[0]{'glosshash'},
      'orig' => 'jA}ir',
      'prefix' => ''
    },
    {
  ...
  '^g w h r' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"essential [ [ jawohariy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"fundamental"' => 1,
        '"essential [ [ jawohariy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'jawohariy~',
      'prefix' => ''
    },
  ...
  '^g r b' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"experimental [ [ tajoriybiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"experimental [ [ tajoriybiy ~ / ADJ ] ]"' => 1,
        '"trial"' => 1
      },
      'orig' => 'tajoriybiy~',
      'prefix' => ''
  ...
  '^g y b t' => [
    {
      ...
      'glosses' => [
        [
          '"Djibouti [ [ jiybuwtiy ~ / NOUN ] ]"'
        ],
        [
          '"Djibouti [ [ jiybuwtiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"Djibouti [ [ jiybuwtiy ~ / NOUN ] ]"' => 1,
        '"Djibouti [ [ jiybuwtiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'jiybuwtiy~',
      'prefix' => ''
    }
  ...
  '^g m l' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"aesthetic [ [ jamAliy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"aesthetic [ [ jamAliy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'jamAliy~',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"cosmetic [ [ tajomiyliy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"cosmetic [ [ tajomiyliy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'tajomiyliy~',
      'prefix' => ''
    },
  ...
  '^g s r' => [
    ...
    },
    {
      ...
      'glosshash' => {
        '"( reinforcement ) beam or bar"' => 1,
        '"( reinforcement ) beams or bars"' => 1,
        '"bridges"' => 1,
        '"bridge"' => 1
      },
      'orig' => 'jisor',
  ...
  '^g y h n' => [
    {
      'types' => $lexicon->{'^g h n'}[0]{'types'},
      'entry' => '^giyhAn',
      'form' => '^giyhAn',
      'lines' => $lexicon->{'^g h n'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'KiRDAS',
      'suffix' => '',
      'glosses' => $lexicon->{'^g h n'}[0]{'glosses'},
      'glosshash' => $lexicon->{'^g h n'}[0]{'glosshash'},
      'orig' => 'jiyhAn',
      'prefix' => ''
    }
  ],
  ...
  '^gu.grAfiyA' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"geography [ [ jugorAfiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"geography [ [ jugorAfiy ~ / NOUN ] ]"' => 1,
        '"geography"' => 1
      },
      'orig' => 'jugorAfiyA',
      'prefix' => ''
  ...
  '^g h z' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"supplied [ [ mujah ~ az / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"supplied [ [ mujah ~ az / ADJ ] ]"' => 1,
        '"equipped"' => 1
      },
      'orig' => 'mujah~az',
      'prefix' => ''
  ...
  '^g r \'' => [
    ...
    {
      'types' => $lexicon->{'^g r n'}[4]{'types'},
      'entry' => '\'i^grA\'',
      'form' => '\'i^grA\'',
      'lines' => $lexicon->{'^g r n'}[4]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'HiFCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'^g r n'}[4]{'glosses'},
      'glosshash' => $lexicon->{'^g r n'}[4]{'glosshash'},
      'orig' => 'IijorA\'',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'^g r n'}[5]{'types'},
      'entry' => '\'i^grA\'',
      'form' => '\'i^grA\'',
      'lines' => $lexicon->{'^g r n'}[5]{'lines'},
      'index' => '2',
      'entity' => 'noun',
      'morphs' => 'HiFCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'^g r n'}[5]{'glosses'},
      'glosshash' => $lexicon->{'^g r n'}[5]{'glosshash'},
      'orig' => 'IijorA\'',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'^g r n'}[6]{'types'},
      'entry' => '\'i^grA\'',
      'form' => '\'i^grA\'',
      'lines' => $lexicon->{'^g r n'}[6]{'lines'},
      'index' => '3',
      'entity' => 'noun',
      'morphs' => 'HiFCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'^g r n'}[6]{'glosses'},
      'glosshash' => $lexicon->{'^g r n'}[6]{'glosshash'},
      'orig' => 'IijorA\'',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'^g r n'}[7]{'types'},
      'entry' => '\'i^grA\'',
      'form' => '\'i^grA\'iyy',
  ...
  '^g m r k' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"tariff [ [ jumorukiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"customs"' => 1,
        '"tariff [ [ jumorukiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'jumorukiy~',
      'prefix' => ''
    }
  ...
  '^g r .h' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"surgical [ [ jirAHiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"surgical [ [ jirAHiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'jirAHiy~',
      'prefix' => ''
    },
