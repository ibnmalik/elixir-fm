...
$lexicon = {
  ...
  'n w n' => [
    ...
    {
      'types' => $lexicon->{'n w n'}[0]{'types'},
      'entry' => 'nuwn',
      'form' => 'nuwn',
      'others' => $lexicon->{'n w n'}[0]{'others'},
      'lines' => $lexicon->{'n w n'}[0]{'lines'},
      'index' => '2',
      'entity' => 'noun',
      'morphs' => 'FUL',
      'suffix' => '',
      'glosses' => $lexicon->{'n w n'}[0]{'glosses'},
      'glosshash' => $lexicon->{'n w n'}[0]{'glosshash'},
      'orig' => 'nuwn',
      'prefix' => ''
    }
  ],
  ...
  'n b \'' => [
    ...
    {
      'types' => $lexicon->{'n b \''}[1]{'types'},
      'entry' => 'nAbiy',
      'form' => 'nAbiy',
      'others' => $lexicon->{'n b \''}[1]{'others'},
      'lines' => $lexicon->{'n b \''}[1]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACI',
      'suffix' => '',
      'glosses' => $lexicon->{'n b \''}[1]{'glosses'},
      'glosshash' => $lexicon->{'n b \''}[1]{'glosshash'},
      'orig' => 'nAbiy',
      'prefix' => ''
    }
  ],
  ...
  'n m y' => [
    {
      'types' => $lexicon->{'n m b'}[0]{'types'},
      'entry' => 'muntamiy',
      'form' => 'muntamiy',
      'others' => $lexicon->{'n m b'}[0]{'others'},
      'lines' => $lexicon->{'n m b'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'MuFtaCiL',
      'suffix' => '',
      'glosses' => $lexicon->{'n m b'}[0]{'glosses'},
      'glosshash' => $lexicon->{'n m b'}[0]{'glosshash'},
      'orig' => 'munotamiy',
      'prefix' => ''
    }
  ],
  ...
  'n y r' => [
    {
      'types' => $lexicon->{'n w r'}[12]{'types'},
      'entry' => 'muniyr',
      'form' => 'muniyr',
      'lines' => $lexicon->{'n w r'}[12]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'MuFiCL',
      'suffix' => '',
      'glosses' => $lexicon->{'n w r'}[12]{'glosses'},
      'glosshash' => $lexicon->{'n w r'}[12]{'glosshash'},
      'orig' => 'muniyr',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'n w r'}[13]{'types'},
      'entry' => 'muniyr',
      'form' => 'muniyraT',
      'lines' => $lexicon->{'n w r'}[13]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'MuFiCL',
      'suffix' => ' |< aT',
      'glosses' => $lexicon->{'n w r'}[13]{'glosses'},
      'glosshash' => $lexicon->{'n w r'}[13]{'glosshash'},
      'orig' => 'muniyrap',
      'prefix' => ''
    }
  ],
  ...
  'n w .h' => [
    ...
    {
      'types' => $lexicon->{'n w .h'}[0]{'types'},
      'entry' => 'nuw.h',
      'form' => 'nuw.h',
      'lines' => $lexicon->{'n w .h'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FUL',
      'suffix' => '',
      'glosses' => $lexicon->{'n w .h'}[0]{'glosses'},
      'glosshash' => $lexicon->{'n w .h'}[0]{'glosshash'},
      'orig' => 'nuwH',
      'prefix' => ''
    }
  ],
  ...
  'n w b' => [
    ...
    {
      'types' => $lexicon->{'n w b'}[3]{'types'},
      'entry' => 'nuwb',
      'form' => 'nuwbiyy',
      'others' => $lexicon->{'n w b'}[3]{'others'},
      'lines' => $lexicon->{'n w b'}[3]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FUL',
      'suffix' => ' |< Iy',
      'glosses' => $lexicon->{'n w b'}[3]{'glosses'},
      'glosshash' => $lexicon->{'n w b'}[3]{'glosshash'},
      'orig' => 'nuwbiy~',
      'prefix' => ''
    }
  ],
  ...
  'n h w' => [
    ...
    {
      'types' => $lexicon->{'n h \''}[1]{'types'},
      'entry' => 'nihA\'',
      'form' => 'nihA\'iyy',
      'lines' => $lexicon->{'n h \''}[1]{'lines'},
      'index' => '2',
      'entity' => 'noun',
      'morphs' => 'FiCA\'',
      'suffix' => ' |< Iy',
      'glosses' => $lexicon->{'n h \''}[1]{'glosses'},
      'glosshash' => $lexicon->{'n h \''}[1]{'glosshash'},
      'orig' => 'nihA}iy~',
      'prefix' => ''
    },
    {
