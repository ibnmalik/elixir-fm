...
lexicon = listing "Lexicon properties"
 ...
 |> "'i.triy" <| [
    ...
    noun     Identity |< aT            {- IiToriyap -}      `gloss`  [ "vermicelli" ] ]
 ...
 |> "'u.truw.h" <| [
    ...
    noun     Identity |< aT            {- OuToruwHap -}     `gloss`  [ "dissertation", "thesis" ] ]
 ...
 |> "'u.truwf" <| [
    ...
    noun     Identity |< aT            {- OuToruwfap -}     `gloss`  [ "masterpiece" ] ]
 ...
 |> ".t ' .h" <| [
    ...
    noun     FACiL                     {- TA}iH -}          `gloss`  [ "lost", "stray", "loose [ [ TA } iH / ADJ ] ]" ],

    -- ;; TA}iHap_1
    -- TA}H    TA}iH   Napdu   accident;adversity
    -- TwA}H   TawA}iH Ndip    adversities;fate

    noun     FACiL |< aT               {- TA}iHap -}        -- `others` [ ".tawA'i.h Ndip" ]
 ...
 |> ".t ' .t '" <| [
    ...
    verb     KaRDaS                    {- TaOoTaO -}        -- `others` [ ".ta'.ti' IV_yu", ".ta'.ta'A PV-|" ]
                                                            `gloss`  [ "incline", "bend" ],

    -- ;; muTa>oTi}_1
    -- mT>T}   muTa>oTi}       Nall    with bowed head     [[muTa>oTi}/ADJ]]

    noun     MuKaRDiS                  {- muTaOoTi} -}      `gloss`  [ "with bowed head [ [ muTa>oTi } / ADJ ] ]" ],
    ...
    noun     MuKaRDaS                  {- muTaOoTaO -}      -- `others` [ "mu.ta'.ta'A N-|", "mu.ta'.ta N-|t" ]
                                                            `gloss`  [ "bowed", "inclined [ [ muTa>oTa> / ADJ ] ]", "inclined" ] ]
 ...
 |> ".t ' `" <| [
    ...
    noun     FACiL                     {- TA}iE -}          `gloss`  [ "compliant [ [ TA } iE / ADJ ] ]" ] ]
 ...
 |> ".t ' b" <| [
    ...
    noun     FAL |< aT                 {- TAbap -}          `gloss`  [ "ball", "splint" ],

    -- ;; TA}ibap_1
    -- TA}b    TA}ib   Nap     unobjectionable

    noun     FACiL |< aT               {- TA}ibap -}        `gloss`  [ "unobjectionable" ] ]
 ...
 |> ".t ' f" <| [
    ...
    noun     FACiL                     {- TA}if -}          `gloss`  [ "ambulant", "itinerant", "on patrol [ [ TA } if / ADJ ] ]" ],
 ...
 |> ".t ' l" <| [
    ...
    noun     FACiL                     {- TA}il -}          `gloss`  [ "immense", "huge [ [ TA } il / ADJ ] ]" ],
 ...
 |> ".t ' m n" <| [
    ...
    verb     KaRDaS                    {- TaOoman -}        -- `others` [ ".ta'min IV-n_yu" ]
                                                            `gloss`  [ "assuage", "allay" ],
    ...
    verb     TaKaRDaS                  {- taTaOoman -}      `gloss`  [ "assuage", "allay" ] ]
 ...
 |> ".t ' s" <| [
    ...
    noun     FACUL                     {- TAWuws -}         -- `others` [ ".tawAwiys Ndip", ".tAwuws Ndu" ]
 ...
 |> ".t .g t" <| [
    ...
    noun     FACUL                     {- TAguwt -}         -- `others` [ ".tawA.giyt Ndip" ]
 ...
 |> ".t .g w" <| [
    ...
    noun     FACI                      {- TAgiy -}          -- `others` [ ".tu.gA Nap", ".tA.g Nuwn_Niyn NK" ]
 ...
 |> ".t .h .t .h" <| [
    ...
    noun     KaRDaS |< aT              {- TaHoTaHap -}      `gloss`  [ "shattering", "smashing" ] ]
 ...
 |> ".t .h l" <| [
    ...
    noun     FiCAL |< Iy               {- TiHAliy~ -}       `gloss`  [ "splenic [ [ TiHAliy ~ / ADJ ] ]" ],
 ...
 |> ".t .h l b" <| [
    ...
    noun     KuRDuS                    {- TuHolub -}        -- `others` [ ".ta.hAlib Ndip" ]
                                                            `gloss`  [ "moss", "algae" ] ]
 ...
 |> ".t .h n" <| [
    ...
    noun     FiCAL |< aT               {- TiHAnap -}        `gloss`  [ "milling" ],
    ...
    noun     FaCIL |< Iy               {- TaHiyniy~ -}      `gloss`  [ "flour-like", "farinaceous [ [ TaHiyniy ~ / ADJ ] ]" ],

    -- ;; TaHiynap_1
    -- THyn    TaHiyn  Nap     tahina sauce;sesame oil

    noun     FaCIL |< aT               {- TaHiynap -}       `gloss`  [ "tahina sauce", "sesame oil" ],
    ...
    noun     FACUL                     {- TAHuwn -}         `gloss`  [ "windmill", "grinder" ],

    -- ;; TAHuwn_2
    -- TAHwn   TAHuwn  N0      Tahoun

    noun     FACUL                     {- TAHuwn -}         `gloss`  [ "Tahoun" ],

    -- ;; TAHuwnap_1
    -- TAHwn   TAHuwn  Napdu   windmill;grinder
    -- TwAHyn  TawAHiyn        Ndip    windmills;grinders

    noun     FACUL |< aT               {- TAHuwnap -}       -- `others` [ ".tawA.hiyn Ndip" ]
 ...
 |> ".t .s l q" <| [
    ...
    noun     KaRDaS |< aT              {- TaSolaqap -}      `gloss`  [ "bungling", "slipshod work" ] ]
 ...
 |> ".t _h '" <| [
    ...
    noun     FaCAL                     {- TaxA' -}          `gloss`  [ "thin wispy cloud" ],

    -- ;; TaxA'ap_1
    -- TxA'    TaxA'   Napdu   thin wispy cloud

    noun     FaCAL |< aT               {- TaxA'ap -}        `gloss`  [ "thin wispy cloud" ] ]
 ...
 |> ".t _h f" <| [
    ...
    noun     FaCAL                     {- TaxAf -}          `gloss`  [ "thin wispy cloud" ] ]
 ...
 |> ".t _h y" <| [
    ...
    noun     FaCA'                     {- TaxA' -}          `gloss`  [ "thin wispy cloud" ],

    -- ;; TaxA'ap_1
    -- TxA'    TaxA'   Napdu   thin wispy cloud

    noun     FaCA' |< aT               {- TaxA'ap -}        `gloss`  [ "thin wispy cloud" ] ]
 ...
 |> ".t ` m" <| [
    ...
    verb     HaFCaL                    {- OaToEam -}        -- `others` [ ".t`im IV_yu", ".t`am IV_Pass_yu" ]
                                                            `gloss`  [ "feed", "be fed" ],
    ...
    noun     FuCL |< aT                {- TuEomap -}        `gloss`  [ "food", "piece of bread" ],
    ...
    noun     HiFCAL                    {- IiToEAm -}        `gloss`  [ "feeding" ],

    -- ;; maToEuwm_1
    -- mTEwm   maToEuwm        Nall    tasted;known     [[maToEuwm/ADJ]]

    noun     MaFCUL                    {- maToEuwm -}       `gloss`  [ "tasted", "known [ [ maToEuwm / ADJ ] ]" ] ]
 ...
 |> ".t ` n" <| [
    ...
    noun     FACUL                     {- TAEuwn -}         `gloss`  [ "plague", "epidemic" ],

    -- ;; TAEuwniy~_1
    -- TAEwny  TAEuwniy~       Nall    plague;epidemic     [[TAEuwniy~/ADJ]]

    noun     FACUL |< Iy               {- TAEuwniy~ -}      `gloss`  [ "plague", "epidemic [ [ TAEuwniy ~ / ADJ ] ]" ],
    ...
    noun     FACiL                     {- TAEin -}          `gloss`  [ "offensive", "abusive [ [ TAEin / ADJ ] ]" ],

    -- ;; maToEuwn_1
    -- mTEwn   maToEuwn        Nall    infected;plague-stricken     [[maToEuwn/ADJ]]

    noun     MaFCUL                    {- maToEuwn -}       `gloss`  [ "infected", "plague-stricken [ [ maToEuwn / ADJ ] ]" ] ]
 ...
 |> ".t b '" <| [
    ...
    noun     FUCAL |< Iy               {- TuwbA}iy~ -}      `gloss`  [ "utopian [ [ TuwbA } iy ~ / ADJ ] ]" ] ]
 ...
 |> ".t b .t b" <| [
    ...
    noun     KaRDaS |< aT              {- TaboTabap -}      `gloss`  [ "gurgling", "lapping up" ],

    -- ;; TaboTAbap_1
    -- TbTAb   TaboTAb Nap     mallet;racket

    noun     KaRDAS |< aT              {- TaboTAbap -}      `gloss`  [ "mallet", "racket" ] ]
 ...
 |> ".t b ^s r" <| [
    ...
    noun     KaRDUS |< aT              {- Tabo$uwrap -}     -- `others` [ ".tabA^siyr Ndip" ]
                                                            `gloss`  [ "chalk" ],

    -- ;; TabA$iyriy~_1
    -- TbA$yry TabA$iyriy~     N-ap    cretaceous;chalky     [[TabA$iyriy~/ADJ]]

    noun     KaRADIS |< Iy             {- TabA$iyriy~ -}    `gloss`  [ "cretaceous", "chalky [ [ TabA $ iyriy ~ / ADJ ] ]" ] ]
 ...
 |> ".t b _h" <| [
    ...
    noun     FaCL |< aT                {- Taboxap -}        -- `others` [ ".taba_h NAt" ]
    ...
    noun     FiCAL |< aT               {- TibAxap -}        `gloss`  [ "cuisine", "cooking" ],
    ...
    noun     MiFCaL |< aT              {- miTobaxap -}      `gloss`  [ "cooking apparatus" ],

    -- ;; TAbix_1
    -- TAbx    TAbix   Nall    cook
    -- TAbx    TAbix   Nall    cooking     [[TAbix/ADJ]]

    noun     FACiL                     {- TAbix -}          `gloss`  [ "cook", "cooking [ [ TAbix / ADJ ] ]" ],
 ...
 |> ".t b `" <| [
    ...
    noun     FaCL |< Iy                {- TaboEiy~ -}       `gloss`  [ "natural", "typical [ [ TaboEiy ~ / ADJ ] ]" ],

    -- ;; TaboEiy~ap_1
    -- TbEy    TaboEiy~        Nap     ease;relaxation     [[TaboEiy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- TaboEiy~ap -}     `gloss`  [ "ease", "relaxation [ [ TaboEiy ~ / NOUN ] ]" ],
    ...
    noun     FiCAL |< Iy               {- TibAEiy~ -}       `gloss`  [ "printing", "typographical [ [ TibAEiy ~ / ADJ ] ]" ],
    ...
    noun     FaCIL |< Iy |< aT         {- TabiyEiy~ap -}    -- `others` [ ".tabiy`iyy NAt" ]
                                                            `gloss`  [ "nature", "naturalism [ [ TabiyEiy ~ / NOUN ] ]", "physics [ [ TabiyEiy ~ / NOUN ] ]" ],
    ...
    noun     MaFCaL |< Iy              {- maTobaEiy~ -}     `gloss`  [ "typographical", "printing [ [ maTobaEiy ~ / ADJ ] ]" ],
    ...
    noun     InFiCAL |< Iy             {- {inoTibAEiy~ -}   `gloss`  [ "impressionistic [ [ { inoTibAEiy ~ / ADJ ] ]", "impressionism [ [ { inoTibAEiy ~ / NOUN ] ]" ],
    ...
    noun     FACiL |< aT               {- TAbiEap -}        `gloss`  [ "printer", "printing machine" ],
 ...
 |> ".t b b" <| [
    ...
    noun     MutaFaCCiL                {- mutaTab~ib -}     `gloss`  [ "quack", "fake physician [ [ mutaTab ~ ib / ADJ ] ]" ] ]
 ...
 |> ".t b l" <| [
    ...
    noun     FaCL |< aT                {- Tabolap -}        `gloss`  [ "drum" ],

    -- ;; Taboliy~_1
    -- Tbly    Taboliy~        N-ap    drum-shaped     [[Taboliy~/ADJ]]

    noun     FaCL |< Iy                {- Taboliy~ -}       `gloss`  [ "drum-shaped [ [ Taboliy ~ / ADJ ] ]" ],

    -- ;; Taboliy~ap_1
    -- Tbly    Taboliy~        NapAt   round table;tray     [[Taboliy~/NOUN]]
    -- TbAly   TabAliy~        N0_Nh   round tables;trays

    noun     FaCL |< Iy |< aT          {- Taboliy~ap -}     -- `others` [ ".tabAliyy N0_Nh" ]
                                                            `gloss`  [ "round table", "tray [ [ Taboliy ~ / NOUN ] ]", "round tables", "trays" ],
    ...
    noun     MuFaCCaL                  {- muTab~al -}       `gloss`  [ "moist", "damp [ [ muTab ~ al / ADJ ] ]" ],
 ...
 |> ".t b n" <| [
    ...
    noun     FACUL                     {- TAbuwn -}         `gloss`  [ "oven", "bakery" ],

    -- ;; TAbuwnap_1
    -- TAbwn   TAbuwn  NapAt   oven;bakery

    noun     FACUL |< aT               {- TAbuwnap -}       `gloss`  [ "oven", "bakery" ] ]
 ...
 |> ".t b q" <| [
    ...
    verb     HaFCaL                    {- OaTobaq -}        -- `others` [ ".tbiq IV_yu", ".tbaq IV_Pass_yu" ]
    ...
    noun     FaCaL |< Iy               {- Tabaqiy~ -}       `gloss`  [ "social class", "level", "stratified [ [ Tabaqiy ~ / ADJ ] ]" ],

    -- ;; TAbuwq_1
    -- TAbwq   TAbuwq  N       bricks

    noun     FACUL                     {- TAbuwq -}         `gloss`  [ "bricks" ],
    ...
    noun     TaFCIL |< Iy              {- taTobiyqiy~ -}    `gloss`  [ "applied [ [ taTobiyqiy ~ / ADJ ] ]" ],

    -- ;; <iTobAq_1
    -- <TbAq   <iTobAq N/At    agreement
    -- ATbAq   <iTobAq N/At    agreement

    noun     HiFCAL                    {- IiTobAq -}        `gloss`  [ "agreement" ],
    ...
    noun     MuFCiL                    {- muTobiq -}        `gloss`  [ "complete", "absolute [ [ muTobiq / ADJ ] ]" ],

    -- ;; muTobaq_1
    -- mTbq    muTobaq N-ap    closed     [[muTobaq/ADJ]]

    noun     MuFCaL                    {- muTobaq -}        `gloss`  [ "closed [ [ muTobaq / ADJ ] ]" ],
 ...
 |> ".t b r" <| [
    ...
    noun     FaCaL |< Iy               {- Tabariy~ -}       `gloss`  [ "Tiberian [ [ Tabariy ~ / NOUN ] ]", "Tiberian [ [ Tabariy ~ / ADJ ] ]" ],
    ...
    noun     FaCaL |< Iy |< aT         {- Tabariy~ap -}     `gloss`  [ "Tiberias [ [ Tabariy ~ / NOUN ] ]" ],

    -- ;; TAbuwr_1
    -- TAbwr   TAbuwr  Ndu     column;battalion
    -- TwAbyr  TawAbiyr        Ndip    columns;battalions

    noun     FACUL                     {- TAbuwr -}         -- `others` [ ".tawAbiyr Ndip" ]
 ...
 |> ".t b r q" <| [
    ...
    noun     KuRDuS                    {- Tuboruq -}        `gloss`  [ "Tobruk" ],

    -- ;; Tuboruqiy~_1
    -- Tbrqy   Tuboruqiy~      Nall    of/from Tobruk

    noun     KuRDuS |< Iy              {- Tuboruqiy~ -}     `gloss`  [ "of / from Tobruk" ] ]
 ...
 |> ".t b w" <| [
    ...
    noun     FUCAL |< Iy               {- TuwbAwiy~ -}      `gloss`  [ "blessed [ [ TuwbAwiy ~ / ADJ ] ]" ],

    -- ;; TuwbAwiy~ap_1
    -- TwbAwy  TuwbAwiy~       Nap     blessedness     [[TuwbAwiy~/NOUN]]

    noun     FUCAL |< Iy |< aT         {- TuwbAwiy~ap -}    `gloss`  [ "blessedness [ [ TuwbAwiy ~ / NOUN ] ]" ] ]
 ...
 |> ".t b y" <| [
    ...
    noun     FACiL |< aT               {- TAbiyap -}        -- `others` [ ".tawAb NK", ".tawAbiy N0_Nh" ]
 ...
 |> ".t f '" <| [
    ...
    verb     FaCiL                     {- Tafi}-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ ".tfa' IV_wn IV_intr IV_yn", ".tfa'A IV-|" ]
    ...
    verb     HaFCaL                    {- OaTofaO -}        -- `others` [ ".tfa' IV_Pass_yu", "'a.tfa'A PV-|", ".tfi' IV_yu" ]
    ...
    verb     InFaCaL                   {- {inoTafaO -}      -- `others` [ "in.tafa'A PV-|", "n.tafi' IV" ]
                                                            `gloss`  [ "die out", "be extinguished" ],
    ...
    noun     MiFCaL |< aT              {- miTofaOap -}      -- `others` [ "ma.tAfi' Ndip" ]
    ...
    noun     MuFCaL                    {- muTofaO -}        -- `others` [ "mu.tfa'A N-|", "mu.tfa N-|t" ]
                                                            `gloss`  [ "extinguished [ [ muTofa> / ADJ ] ]", "extinguished" ],

    -- ;; munoTafi}_1
    -- mnTf}   munoTafi}       Nall    extinguished     [[munoTafi}/ADJ]]

    noun     MunFaCiL                  {- munoTafi} -}      `gloss`  [ "extinguished [ [ munoTafi } / ADJ ] ]" ] ]
 ...
 |> ".t f .h" <| [
    ...
    verb     HaFCaL                    {- OaTofaH -}        -- `others` [ ".tfa.h IV_Pass_yu", ".tfi.h IV_yu" ]
    ...
    noun     FaCL |< aT                {- TafoHap -}        -- `others` [ ".tafa.h NAt" ]
                                                            `gloss`  [ "skin eruption", "skin eruptions" ],

    -- ;; TafoHiy~_1
    -- TfHy    TafoHiy~        N-ap    eruptive;exanthematic     [[TafoHiy~/ADJ]]

    noun     FaCL |< Iy                {- TafoHiy~ -}       `gloss`  [ "eruptive", "exanthematic [ [ TafoHiy ~ / ADJ ] ]" ],

    -- ;; TufAHap_1
    -- TfAH    TufAH   Nap     froth;foam

    noun     FuCAL |< aT               {- TufAHap -}        `gloss`  [ "froth", "foam" ],
    ...
    noun     MiFCaL |< aT              {- miTofaHap -}      `gloss`  [ "skimmer", "ladle" ],
    ...
    noun     HiFCAL                    {- IiTofAH -}        `gloss`  [ "overfilling" ],

    -- ;; TAfiH_1
    -- TAfH    TAfiH   Nall    overflowing;replete     [[TAfiH/ADJ]]

    noun     FACiL                     {- TAfiH -}          `gloss`  [ "overflowing", "replete [ [ TAfiH / ADJ ] ]" ] ]
 ...
 |> ".t f l" <| [
    ...
    noun     FiCL |< Iy                {- Tifoliy~ -}       `gloss`  [ "infant", "infantile [ [ Tifoliy ~ / ADJ ] ]" ],

    -- ;; Tafoliy~_1
    -- Tfly    Tafoliy~        N-ap    clay     [[Tafoliy~/ADJ]]

    noun     FaCL |< Iy                {- Tafoliy~ -}       `gloss`  [ "clay [ [ Tafoliy ~ / ADJ ] ]" ],
    ...
    noun     FaCAL |< aT               {- TafAlap -}        `gloss`  [ "infancy" ],
    ...
    noun     FuCUL |< Iy               {- Tufuwliy~ -}      `gloss`  [ "infantile [ [ Tufuwliy ~ / ADJ ] ]" ],

    -- ;; Tufuwliy~ap_1
    -- Tfwly   Tufuwliy~       Nap     infancy;childhood     [[Tufuwliy~/NOUN]]

    noun     FuCUL |< Iy |< aT         {- Tufuwliy~ap -}    `gloss`  [ "infancy", "childhood [ [ Tufuwliy ~ / NOUN ] ]" ],

    -- ;; Tufayoliy~_1
    -- Tfyly   Tufayoliy~      Nall    parasitic;intruder     [[Tufayoliy~/ADJ]]

    noun     FuCayL |< Iy              {- Tufayoliy~ -}     `gloss`  [ "parasitic", "intruder [ [ Tufayoliy ~ / ADJ ] ]" ],

    -- ;; Tufayoliy~ap_1
    -- Tfyly   Tufayoliy~      NapAt   parasite

    noun     FuCayL |< Iy |< aT        {- Tufayoliy~ap -}   `gloss`  [ "parasite" ],
    ...
    noun     TaFaCCuL |< Iy            {- taTaf~uliy~ -}    `gloss`  [ "parasitic [ [ taTaf ~ uliy ~ / ADJ ] ]" ],

    -- ;; mutaTaf~il_1
    -- mtTfl   mutaTaf~il      Nall    parasitic;intruding     [[mutaTaf~il/ADJ]]

    noun     MutaFaCCiL                {- mutaTaf~il -}     `gloss`  [ "parasitic", "intruding [ [ mutaTaf ~ il / ADJ ] ]" ] ]
 ...
 |> ".t f n" <| [
    ...
    noun     FUCAL |< Iy               {- TuwfAniy~ -}      `gloss`  [ "torrential", "diluvial [ [ TuwfAniy ~ / ADJ ] ]" ] ]
 ...
 |> ".t f w" <| [
    ...
    noun     FuCAL |< aT               {- TufAwap -}        `gloss`  [ "flotsam", "emergence" ],

    -- ;; TafAwap_1
    -- TfAw    TafAw   Nap     halo

    noun     FaCAL |< aT               {- TafAwap -}        `gloss`  [ "halo" ],
    ...
    noun     FACI                      {- TAfiy -}          -- `others` [ ".tAf Nuwn_Niyn NK" ]
                                                            `gloss`  [ "floating", "emerging", "superficial [ [ TAfiy / ADJ ] ]", "superficial" ],
    ...
    noun     FACI |< aT                {- TAfiyap -}        -- `others` [ ".tawAfiy N0_Nh", ".tawAf NK" ]
 ...
 |> ".t f y" <| [
    ...
    noun     FACiL |< aT               {- TAfiyap -}        -- `others` [ ".tawAfiy N0_Nh", ".tawAf NK" ]
                                                            `gloss`  [ "buoy", "beacon", "buoys", "beacons" ] ]
 ...
 |> ".t h r" <| [
    ...
    noun     MaFCaL |< aT              {- maToharap -}      -- `others` [ "ma.tAhir Ndip" ]
    ...
    noun     TaFCIL |< Iy              {- taTohiyriy~ -}    `gloss`  [ "cleansing", "antiseptic [ [ taTohiyriy ~ / ADJ ] ]" ],
    ...
    noun     MuFaCCaL                  {- muTah~ar -}       `gloss`  [ "pure", "immaculate [ [ muTah ~ ar / ADJ ] ]" ],

    -- ;; maTohariy~_1
    -- mThry   maTohariy~      N-ap    purgatorial     [[maTohariy~/ADJ]]

    noun     MaFCaL |< Iy              {- maTohariy~ -}     `gloss`  [ "purgatorial [ [ maTohariy ~ / ADJ ] ]" ],
    ...
    noun     FaCLAn |< Iy              {- TahorAniy~ -}     `gloss`  [ "of / from Tehran [ [ TahorAniy ~ / NOUN ] ]", "of / from Tehran [ [ TahorAniy ~ / ADJ ] ]" ],
 ...
 |> ".t h w" <| [
    ...
    verb     FaCA                      {- TahA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ ".th IV_0hwnyn", ".thY IV_0_Pass_yu", ".tah PV_ttAw", ".tahaw PV_Atn", ".thay IV_Ann_Pass_yu", ".thuw IV_0hAnn" ]
    ...
    verb     FaCY                      {- TahaY-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ ".thA IV_h", ".tahay PV_Atn", ".thY IV_0", ".taha PV_ttAw", ".thay IV_Ann", ".tahA PV_h", ".tha IV_0hwnyn" ]
                                                            `gloss`  [ "cook", "stew" ],
    ...
    noun     FuCY                      {- TuhaY -}          -- `others` [ ".tuhA Nhy" ]
                                                            `gloss`  [ "cooked" ],
    ...
    noun     MaFCY                     {- maTohaY -}        -- `others` [ "ma.tAh NK", "ma.thay NAn_Nayn", "ma.thA Nhy", "ma.tAhiy N0_Nh" ]
                                                            `gloss`  [ "kitchen", "kitchens" ],
    ...
    noun     MaFCIy                    {- maTohiy~ -}       `gloss`  [ "cooked [ [ maTohiy ~ / ADJ ] ]" ],

    -- ;; maTohuw~_1
    -- mThw    maTohuw~        N-ap    cooked     [[maTohuw~/ADJ]]

    noun     MaFCUL                    {- maTohuw~ -}       `gloss`  [ "cooked [ [ maTohuw ~ / ADJ ] ]" ] ]
 ...
 |> ".t h y" <| [
    ...
    noun     FiCAL |< aT               {- TihAyap -}        `gloss`  [ "cooking" ],
 ...
 |> ".t l ' `" <| [
    ...
    noun     KaRADiS |< Iy             {- TalA}iEiy~ -}     `gloss`  [ "vanguard [ [ TalA } iEiy ~ / ADJ ] ]" ] ]
 ...
 |> ".t l .h" <| [
    ...
    noun     FaCL |< Iy |< aT          {- TaloHiy~ap -}     -- `others` [ ".talA.hiyy N0_Nh" ]
                                                            `gloss`  [ "sheet of paper [ [ TaloHiy ~ / NOUN ] ]", "sheets of paper" ],

    -- ;; TaliyH_1
    -- TlyH    TaliyH  N-ap    emaciated     [[TaliyH/ADJ]]

    noun     FaCIL                     {- TaliyH -}         `gloss`  [ "emaciated [ [ TaliyH / ADJ ] ]" ],

    -- ;; TaliyHap_1
    -- TlyH    TaliyH  Nap     ream of paper

    noun     FaCIL |< aT               {- TaliyHap -}       `gloss`  [ "ream of paper" ],

    -- ;; TAliH_1
    -- TAlH    TAliH   Nall    wicked;vicious     [[TAliH/ADJ]]

    noun     FACiL                     {- TAliH -}          `gloss`  [ "wicked", "vicious [ [ TAliH / ADJ ] ]" ] ]
 ...
 |> ".t l `" <| [
    ...
    verb     IFtaCaL                   {- {iT~alaE -}       -- `others` [ ".t.tali` IV" ]
                                                            `gloss`  [ "examine", "study" ],
    ...
    noun     IFtiCAL                   {- {iT~ilAE -}       `gloss`  [ "examination", "inspection", "knowledge" ],
    ...
    noun     IstiFCAL |< Iy            {- {isotiTolAEiy~ -} `gloss`  [ "reconnaissance [ [ { isotiTolAEiy ~ / ADJ ] ]" ],
    ...
    noun     FACiL                     {- TAliE -}          -- `others` [ ".tawAli` Ndip" ]
                                                            `gloss`  [ "rising", "ascending [ [ TAliE / ADJ ] ]", "ascending" ],

    -- ;; TAliEap_1
    -- TAlE    TAliE   Nap     outset;beginning

    noun     FACiL |< aT               {- TAliEap -}        `gloss`  [ "outset", "beginning" ],
    ...
    noun     MutaFaCCiL                {- mutaTal~iE -}     `gloss`  [ "looking", "aspiring [ [ mutaTal ~ iE / ADJ ] ]" ],
    ...
    noun     MuFtaCaL                  {- muT~alaE -}       `gloss`  [ "understood [ [ muT ~ alaE / ADJ ] ]" ] ]
 ...
 |> ".t l b" <| [
    ...
    noun     FaCL |< aT                {- Talobap -}        `gloss`  [ "litany" ],
 ...
 |> ".t l l" <| [
    ...
    noun     HiFCAL                    {- IiTolAl -}        `gloss`  [ "overlooking", "facing" ],
    ...
    noun     MaFCUL                    {- maToluwl -}       `gloss`  [ "unavenged [ [ maToluwl / ADJ ] ]" ],
    ...
    noun     MuFaCL                    {- muTal~ -}         `gloss`  [ "unavenged [ [ muTal ~ / ADJ ] ]" ] ]
 ...
 |> ".t l m" <| [
    ...
    noun     MiFCaL |< aT              {- miTolamap -}      `gloss`  [ "rolling pin" ] ]
 ...
 |> ".t l m s" <| [
    ...
    noun     KaRDaS |< aT              {- Talomasap -}      `gloss`  [ "frowning" ] ]
 ...
 |> ".t l n" <| [
    ...
    noun     FUCAL |< Iy               {- TuwlAniy~ -}      `gloss`  [ "longitudinal", "lengthwise [ [ TuwlAniy ~ / ADJ ] ]" ] ]
 ...
 |> ".t l q" <| [
    ...
    noun     FaCIL                     {- Taliyq -}         -- `others` [ ".tulaqA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "free", "released", "at large [ [ Taliyq / ADJ ] ]", "at large" ],

    -- ;; Taliyqap_1
    -- Tlyq    Taliyq  Napdu   divorcee

    noun     FaCIL |< aT               {- Taliyqap -}       `gloss`  [ "divorcee" ],

    -- ;; Taluwqap_1
    -- Tlwq    Taluwq  Nap     stallion
    -- TlA}q   TalA}iq Ndip    stallions

    noun     FaCUL |< aT               {- Taluwqap -}       -- `others` [ ".talA'iq Ndip" ]
    ...
    noun     InFiCAL |< aN             {- {inoTilAqAF -}    -- `others` [ "in.tilAq NF" ]
                                                            `gloss`  [ "proceeding ( from )", "on the basis ( of ) [ [ { inoTilAq / ADV ] ]" ],

    -- ;; {inoTilAqap_1
    -- <nTlAq  {inoTilAq       Nap     outset;launching
    -- AnTlAq  {inoTilAq       Nap     outset;launching

    noun     InFiCAL |< aT             {- {inoTilAqap -}    `gloss`  [ "outset", "launching" ],

    -- ;; TAliq_1
    -- TAlq    TAliq   N       divorced     [[TAliq/ADJ]]

    noun     FACiL                     {- TAliq -}          `gloss`  [ "divorced [ [ TAliq / ADJ ] ]" ],
    ...
    noun     MutaFaCCiL                {- mutaTal~iq -}     `gloss`  [ "cheerful [ [ mutaTal ~ iq / ADJ ] ]" ],
    ...
    noun     MuFCaL |< Iy              {- muTolaqiy~ -}     `gloss`  [ "totalitarian", "absolutist [ [ muTolaqiy ~ / ADJ ] ]" ] ]
 ...
 |> ".t l w" <| [
    ...
    noun     FaCAL |< aT               {- TalAwap -}        `gloss`  [ "splendor", "beauty" ] ]
 ...
 |> ".t l y" <| [
    ...
    verb     FaCY                      {- TalaY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ ".talA PV_h", ".tl IV_0hwnyn", ".tliy IV_0hAnn", ".tal PV_ttAw", ".tlY IV_0", ".talay PV_Atn" ]
                                                            `gloss`  [ "paint" ],
    ...
    noun     FaCIL                     {- Taliy~ -}         `gloss`  [ "glazed", "attractive [ [ Taliy ~ / ADJ ] ]" ] ]
 ...
 |> ".t l y n" <| [
    ...
    noun     KaRDaS |< aT              {- Taloyanap -}      `gloss`  [ "Italianization" ],
    ...
    noun     KaRDAS |< Iy              {- TaloyAniy~ -}     -- `others` [ ".talyAn N", ".talAyin Nap" ]
                                                            `gloss`  [ "Italian [ [ TaloyAniy ~ / ADJ ] ]", "Italians" ] ]
 ...
 |> ".t m ' n" <| [
    ...
    verb     TaKaRDaS                  {- taTamoOan -}      `gloss`  [ "be pacified", "be assuaged" ],
 ...
 |> ".t m .h" <| [
    ...
    noun     FACiL                     {- TAmiH -}          `gloss`  [ "ambitious", "desirous [ [ TAmiH / ADJ ] ]" ] ]
 ...
 |> ".t m .t m" <| [
    ...
    noun     KaRADiS                   {- TamATim -}        -- `others` [ ".tumA.t Nap" ]
 ...
 |> ".t m _t" <| [
    ...
    noun     FaCL |< Iy                {- Tamoviy~ -}       `gloss`  [ "menstrual [ [ Tamoviy ~ / ADJ ] ]" ],
 ...
 |> ".t m `" <| [
    ...
    verb     HaFCaL                    {- OaTomaE -}        -- `others` [ ".tmi` IV_yu", ".tma` IV_Pass_yu" ]
    ...
    noun     FaCCAL                    {- Tam~AE -}         `gloss`  [ "greedy [ [ Tam ~ AE / ADJ ] ]" ],

    -- ;; TamAEiy~ap_1
    -- TmAEy   TamAEiy~        Nap     greed

    noun     FaCAL |< Iy |< aT         {- TamAEiy~ap -}     `gloss`  [ "greed" ],
    ...
    noun     MaFCaL |< aT              {- maTomaEap -}      `gloss`  [ "enticement" ],

    -- ;; miTomAE_1
    -- mTmAE   miTomAE Nall    greedy     [[miTomAE/ADJ]]

    noun     MiFCAL                    {- miTomAE -}        `gloss`  [ "greedy [ [ miTomAE / ADJ ] ]" ] ]
 ...
 |> ".t m m" <| [
    ...
    noun     FACL |< aT                {- TAm~ap -}         `gloss`  [ "calamity", "disaster" ],
 ...
 |> ".t m n" <| [
    ...
    noun     MutaFACiL                 {- mutaTAmin -}      `gloss`  [ "low [ [ mutaTAmin / ADJ ] ]" ] ]
 ...
 |> ".t m r" <| [
    ...
    noun     MaFCUL                    {- maTomuwr -}       `gloss`  [ "underground [ [ maTomuwr / ADJ ] ]" ],

    -- ;; maTomuwrap_1
    -- mTmwr   maTomuwr        NapAt   underground granary

    noun     MaFCUL |< aT              {- maTomuwrap -}     `gloss`  [ "underground granary" ],
 ...
 |> ".t m s" <| [
    ...
    noun     FACiL                     {- TAmis -}          `gloss`  [ "extinct", "incomprehensible [ [ TAmis / ADJ ] ]" ] ]
 ...
 |> ".t m w" <| [
    ...
    verb     FaCA                      {- TamA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ ".tmuw IV_0hAnn", ".tam PV_ttAw", ".tamaw PV_Atn", ".tmY IV_0_Pass_yu", ".tmay IV_Ann_Pass_yu", ".tm IV_0hwnyn" ]
    ...
    verb     FaCY                      {- TamaY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ ".tamay PV_Atn", ".tam PV_ttAw", ".tmiy IV_0hAnn", ".tmY IV_0_Pass_yu", ".tm IV_0hwnyn" ]
                                                            `gloss`  [ "flow over", "be flown over" ],
    ...
    noun     FACI                      {- TAmiy -}          -- `others` [ ".tAm Nuwn_Niyn NK" ]
                                                            `gloss`  [ "flowing over [ [ TAmiy / ADJ ] ]", "flowing over" ] ]
 ...
 |> ".t n .t n" <| [
    ...
    noun     KaRDaS |< aT              {- TanoTanap -}      `gloss`  [ "ringing", "resounding" ] ]
 ...
 |> ".t n .t w" <| [
    ...
    noun     KaRDAS |< Iy              {- TanoTAwiy~ -}     `gloss`  [ "from / of Tanta [ Egy . ] [ [ TanoTAwiy ~ / ADJ ] ]" ],
 ...
 |> ".t n ^g" <| [
    ...
    noun     FaCL |< aT                {- Tanojap -}        `gloss`  [ "Tangier" ],

    -- ;; Tanojiy~_1
    -- Tnjy    Tanojiy~        Nall    from/of Tangier;Tangerine     [[Tanojiy~/ADJ]]

    noun     FaCL |< Iy                {- Tanojiy~ -}       `gloss`  [ "from / of Tangier", "Tangerine [ [ Tanojiy ~ / ADJ ] ]" ] ]
 ...
 |> ".t n ^g r" <| [
    ...
    noun     KaRDaS |< aT              {- Tanojarap -}      -- `others` [ ".tanA^gir Ndip" ]
 ...
 |> ".t n b" <| [
    ...
    verb     HaFCaL                    {- OaTonab -}        -- `others` [ ".tnab IV_Pass_yu", ".tnib IV_yu" ]
    ...
    noun     FuCuL |< Iy               {- Tunubiy~ -}       `gloss`  [ "tendinous [ [ Tunubiy ~ / ADJ ] ]" ],
    ...
    noun     HiFCAL |< Iy              {- IiTonAbiy~ -}     `gloss`  [ "exaggerated [ [" ],

    -- ;; muTonib_1
    -- mTnb    muTonib Nall    exaggerating     [[muTonib/ADJ]]

    noun     MuFCiL                    {- muTonib -}        `gloss`  [ "exaggerating [ [ muTonib / ADJ ] ]" ],

    -- ;; muTonab_1
    -- mTnb    muTonab N-ap    exaggerated     [[muTonab/ADJ]]

    noun     MuFCaL                    {- muTonab -}        `gloss`  [ "exaggerated [ [ muTonab / ADJ ] ]" ] ]
 ...
 |> ".t n b ^s" <| [
    ...
    noun     KaRDUS |< aT              {- Tanobuw$ap -}     `gloss`  [ "paddle box" ] ]
 ...
 |> ".t n b r" <| [
    ...
    noun     KuRDuS                    {- Tunobur -}        -- `others` [ ".tanAbir Ndip" ]
    ...
    noun     KuRDUS |< Iy              {- Tunobuwriy~ -}    `gloss`  [ "tambour player [ [ Tunobuwriy ~ / ADJ ] ]" ] ]
 ...
 |> ".t n f s" <| [
    ...
    noun     KuRDuS |< aT              {- Tunofusap -}      -- `others` [ ".tanAfis Ndip" ]
 ...
 |> ".t n n" <| [
    ...
    verb     HaFaCL                    {- OaTan~ -}         -- `others` [ ".tinn IV_V_yu", ".tnin IV_C_yu", "'a.tnan PV_Cn" ]
                                                            `gloss`  [ "resound" ],
    ...
    noun     FaCCAL                    {- Tan~An -}         -- `others` [ "'i.tnAn N/At" ]
 ...
 |> ".t q .t q" <| [
    ...
    noun     KaRDaS |< aT              {- TaqoTaqap -}      `gloss`  [ "rattling", "creaking" ],

    -- ;; TaqoTuwqap_1
    -- TqTwq   TaqoTuwq        Napdu   popular song;gay ditty
    -- TqATyq  TaqATiyq        Ndip    popular songs;gay ditties

    noun     KaRDUS |< aT              {- TaqoTuwqap -}     -- `others` [ ".taqA.tiyq Ndip" ]
 ...
 |> ".t q q" <| [
    ...
    noun     FaCL |< aT                {- Taq~ap -}         `gloss`  [ "crack" ] ]
 ...
 |> ".t q s" <| [
    ...
    noun     FaCL |< Iy                {- Taqosiy~ -}       `gloss`  [ "liturgical [ [ Taqosiy ~ / ADJ ] ]" ],

    -- ;; Tuquwsiy~_1
    -- Tqwsy   Tuquwsiy~       Nall    ritualistic     [[Tuquwsiy~/ADJ]]

    noun     FuCUL |< Iy               {- Tuquwsiy~ -}      `gloss`  [ "ritualistic [ [ Tuquwsiy ~ / ADJ ] ]" ] ]
 ...
 |> ".t q y" <| [
    ...
    noun     FACiL |< aT               {- TAqiyap -}        -- `others` [ ".tawAq NK", ".tawAqiy N0_Nh" ]
 ...
 |> ".t r '" <| [
    ...
    verb     HaFCaL                    {- OaToraO -}        -- `others` [ "'a.tra'A PV-|", ".tra' IV_Pass_yu", ".tri' IV_yu" ]
    ...
    noun     FaCIL                     {- Tariy' -}         `gloss`  [ "fresh", "new [ [ Tariy ' / ADJ ] ]", "new" ],
    ...
    noun     HiFCAL                    {- IiTorA' -}        `gloss`  [ "eulogy", "eulogies" ],
    ...
    noun     HiFCAL                    {- IiTorA' -}        `gloss`  [ "praise", "flattery" ] ]
 ...
 |> ".t r ' n" <| [
    ...
    noun     KuRDAS |< Iy              {- Turo|niy~ -}      `gloss`  [ "of unknown origin", "wild [ [ Turo | niy ~ / ADJ ] ]" ] ]
 ...
 |> ".t r .h" <| [
    ...
    verb     IFtaCaL                   {- {iT~araH -}       -- `others` [ ".t.tari.h IV" ]
    ...
    noun     FaCL |< aT                {- TaroHap -}        -- `others` [ ".tura.h N", ".tirA.h N" ]
    ...
    noun     FaCIL                     {- TariyH -}         -- `others` [ ".tar.hY N0", ".tar.hA Nhy" ]
                                                            `gloss`  [ "rejected [ [ TariyH / ADJ ] ]", "rejected" ],
    ...
    noun     FaCIL                     {- TariyH -}         -- `others` [ ".tar.hY N0", ".tar.hA Nhy" ]
                                                            `gloss`  [ "prostrate [ [ TariyH / ADJ ] ]", "prostrate" ],

    -- ;; TariyHap_1
    -- TryH    TariyH  Nap     task;assignment

    noun     FaCIL |< aT               {- TariyHap -}       `gloss`  [ "task", "assignment" ],

    -- ;; Tar~AHap_1
    -- TrAH    Tar~AH  Napdu   cushion
    -- TrAryH  TarAriyH        Ndip    cushions

    noun     FaCCAL |< aT              {- Tar~AHap -}       -- `others` [ ".tarAriy.h Ndip" ]
    ...
    noun     IFtiCAL                   {- {iT~irAH -}       `gloss`  [ "rejection", "repudiation" ],
    ...
    noun     MunFaCiL                  {- munoTariH -}      `gloss`  [ "discarded", "rejected", "fallen down [ [ munoTariH / ADJ ] ]" ] ]
 ...
 |> ".t r .t ^s" <| [
    ...
    noun     KaRDaS |< aT              {- TaroTa$ap -}      `gloss`  [ "splashing" ] ]
 ...
 |> ".t r .t f" <| [
    ...
    noun     KaRDUS |< aT              {- TaroTuwfap -}     `gloss`  [ "artichoke", "truffle" ] ]
 ...
 |> ".t r .t q" <| [
    ...
    noun     KaRDaS |< aT              {- TaroTaqap -}      `gloss`  [ "creaking", "crackling" ] ]
 ...
 |> ".t r .t r" <| [
    ...
    noun     KaRDaS |< aT              {- TaroTarap -}      `gloss`  [ "boasting", "swaggering" ],
 ...
 |> ".t r ^s" <| [
    ...
    noun     FaCL |< aT                {- Taro$ap -}        -- `others` [ ".tara^s NAt" ]
    ...
    noun     FuCL |< aT                {- Turo$ap -}        `gloss`  [ "deafness" ],

    -- ;; Turo$iy~_1
    -- Tr$y    Turo$iy~        N-ap    pickled     [[Turo$iy~/ADJ]]

    noun     FuCL |< Iy                {- Turo$iy~ -}       `gloss`  [ "pickled [ [ Turo $ iy ~ / ADJ ] ]" ],
    ...
    noun     HaFCaL                    {- OaTora$ -}        -- `others` [ ".tar^sA' Nh Nhy N0_Nh", ".tur^s N" ]
                                                            `gloss`  [ "deaf" ],
    ...
    noun     HaFCaL                    {- OaTora$ -}        `gloss`  [ "Atrash" ],
 ...
 |> ".t r b" <| [
    ...
    noun     FaCiL                     {- Tarib -}          -- `others` [ ".tirAb N" ]
                                                            `gloss`  [ "delighted", "moved with emotion [ [ Tarib / ADJ ] ]", "moved with emotion" ],

    -- ;; Taruwb_1
    -- Trwb    Taruwb  N-ap    lively;merry     [[Taruwb/ADJ]]

    noun     FaCUL                     {- Taruwb -}         `gloss`  [ "lively", "merry [ [ Taruwb / ADJ ] ]" ],

    -- ;; >aTorab_2
    -- >Trb    >aTorab Nel     more/most delightful;more/most melodious
    -- ATrb    >aTorab Nel     more/most delightful;more/most melodious

    noun     HaFCaL                    {- OaTorab -}        `gloss`  [ "more / most delightful", "more / most melodious" ],
    ...
    noun     HiFCAL                    {- IiTorAb -}        `gloss`  [ "diversion by music", "making music" ],
 ...
 |> ".t r b ^s" <| [
    ...
    noun     KaRADIS |< Iy             {- TarAbiy$iy~ -}    `gloss`  [ "tarboush merchant [ [ TarAbiy $ iy ~ / ADJ ] ]" ],
    ...
    noun     MuKaRDaS                  {- muTaroba$ -}      `gloss`  [ "wearing a tarboush [ [ muTaroba $ / ADJ ] ]" ],

    -- ;; mutaTarobi$_1
    -- mtTrb$  mutaTarobi$     Nall    wearing a tarboush     [[mutaTarobi$/ADJ]]

    noun     MutaKaRDiS                {- mutaTarobi$ -}    `gloss`  [ "wearing a tarboush [ [ mutaTarobi $ / ADJ ] ]" ] ]
 ...
 |> ".t r d" <| [
    ...
    verb     IFtaCaL                   {- {iT~arad -}       -- `others` [ ".t.tarid IV_intr" ]
    ...
    noun     FaCIL |< aT               {- Tariydap -}       -- `others` [ ".tarA'id Ndip" ]
    ...
    noun     IFtiCAL                   {- {iT~irAd -}       `gloss`  [ "continuity", "uniformity" ],

    -- ;; {iT~irAdiy~_1
    -- <TrAdy  {iT~irAdiy~     N-ap    continuous;regular     [[{iT~irAdiy~/ADJ]]
    -- ATrAdy  {iT~irAdiy~     N-ap    continuous;regular     [[{iT~irAdiy~/ADJ]]

    noun     IFtiCAL |< Iy             {- {iT~irAdiy~ -}    `gloss`  [ "continuous", "regular [ [ { iT ~ irAdiy ~ / ADJ ] ]" ],
    ...
    noun     IstiFCAL |< Iy            {- {isotiTorAdiy~ -} `gloss`  [ "digression", "excursus [ [ { isotiTorAdiy ~ / ADJ ] ]" ],
    ...
    noun     MuFACiL |< aT             {- muTAridap -}      `gloss`  [ "fighter", "interceptor" ],
 ...
 |> ".t r f" <| [
    ...
    noun     FaCL |< aT                {- Tarofap -}        `gloss`  [ "instant" ],

    -- ;; Turofap_1
    -- Trf     Turof   Nap     novelty;curiosity

    noun     FuCL |< aT                {- Turofap -}        `gloss`  [ "novelty", "curiosity" ],
    ...
    noun     FaCIL |< aT               {- Tariyfap -}       -- `others` [ ".tarA'if Ndip" ]
    ...
    noun     HaFCaL                    {- OaToraf -}        `gloss`  [ "more / most curious" ],
 ...
 |> ".t r m" <| [
    ...
    noun     FACiL |< aT               {- TArimap -}        `gloss`  [ "kiosk", "booth", "cabin" ],

    -- ;; TurAmap_1
    -- TrAm    TurAm   Nap     dental plaque

    noun     FuCAL |< aT               {- TurAmap -}        `gloss`  [ "dental plaque" ] ]
 ...
 |> ".t r q" <| [
    ...
    verb     HaFCaL                    {- OaToraq -}        -- `others` [ ".triq IV_yu", ".traq IV_Pass_yu" ]
                                                            `gloss`  [ "bow", "be bowed" ],
    ...
    noun     FaCL |< aT                {- Taroqap -}        -- `others` [ ".taraq NAt" ]
                                                            `gloss`  [ "knock", "knocks" ],
    ...
    noun     FuCuL |< Iy               {- Turuqiy~ -}       `gloss`  [ "dervishes [ [ Turuqiy ~ / ADJ ] ]" ],
    ...
    noun     HiFCAL |< aT              {- IiTorAqap -}      `gloss`  [ "bowing of the head" ],
    ...
    noun     FACiL |< aT               {- TAriqap -}        -- `others` [ ".tawAriq Ndip" ]
    ...
    noun     MaFCUL                    {- maToruwq -}       `gloss`  [ "much-traveled", "well-trodden [ [ maToruwq / ADJ ] ]" ],
 ...
 |> ".t r q `" <| [
    ...
    noun     KaRDaS |< aT              {- TaroqaEap -}      `gloss`  [ "cracking" ] ]
 ...
 |> ".t r r" <| [
    ...
    noun     FuCL                      {- Tur~ -}           `gloss`  [ "altogether", "one and all [ [ Tur ~ / ADV ] ]" ],

    -- ;; Tur~ap_1
    -- Tr      Tur~    Napdu   forelock;knotted cloth
    -- Trr     Turar   N       forelocks;knotted cloth

    noun     FuCL |< aT                {- Tur~ap -}         -- `others` [ ".turar N" ]
    ...
    verb     FaCLY                     {- Tar~aY -}         -- `others` [ ".tarrA PV_h", ".tarr IV_0hwnyn_yu PV_ttAw", ".tarray PV_Atn IV_Ann_Pass_yu", ".tarriy IV_0hAnn_yu" ]
 ...
 |> ".t r w" <| [
    ...
    verb     FaCuL                     {- Taruw-u -}        `imperf` [ FCuL ]
                                                            -- `others` [ ".tar PV_ttAw_intr", ".tr IV_0hwnyn", ".truw IV_0hAnn", ".taraw PV_Atn", ".tarA PV_0" ]
    ...
    verb     HaFCY                     {- OaToraY -}        -- `others` [ ".tr IV_0hwnyn_yu", "'a.trA PV_h", ".tray IV_Ann_Pass_yu", "'a.tr PV_ttAw", "'a.tray PV_Atn", ".triy IV_0hAnn_yu", ".trY IV_0_Pass_yu" ]
                                                            `gloss`  [ "flatter", "praise", "be flattered", "be praised" ],

    -- ;; TarAwap_1
    -- TrAw    TarAw   Nap     freshness;tenderness

    noun     FaCAL |< aT               {- TarAwap -}        `gloss`  [ "freshness", "tenderness" ],
    ...
    noun     HiFCA'                    {- IiTorA' -}        `gloss`  [ "praise", "flattery" ],
    ...
    noun     MuFCI                     {- muToriy -}        -- `others` [ "mu.tr Nuwn_Niyn NK" ]
                                                            `gloss`  [ "flattering [ [ muToriy / ADJ ] ]", "flattering" ] ]
 ...
 |> ".t r w d" <| [
    ...
    noun     KiRDAS |< aT              {- TirowAdap -}      `gloss`  [ "Troy" ] ]
 ...
 |> ".t r w n" <| [
    ...
    noun     KaRADiS |< aT             {- TarAwinap -}      -- `others` [ ".tarAwinah N0" ]
                                                            `gloss`  [ "Tarawneh" ] ]
 ...
 |> ".t r y" <| [
    ...
    verb     FaCiL                     {- Tariy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ ".tra IV_0hwnyn", ".tray IV_Ann", ".tar PV_w_intr", ".trY IV_0" ]
                                                            `gloss`  [ "be fresh", "be tender" ],
 ...
 |> ".t r z" <| [
    ...
    noun     FaCL |< Iy                {- Taroziy~ -}       `gloss`  [ "fashion [ [ Taroziy ~ / ADJ ] ]" ],
    ...
    noun     MuFaCCaL                  {- muTar~az -}       `gloss`  [ "embroidered [ [ muTar ~ az / ADJ ] ]" ] ]
 ...
 |> ".t w '" <| [
    ...
    noun     InFiCAL                   {- {inoTiwA' -}      `gloss`  [ "withdrawal", "withdrawals" ] ]
 ...
 |> ".t w .h" <| [
    ...
    verb     FAL                       {- TAH-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ ".tuw.h IV_V", ".tu.h PV_C IV_C" ]
                                                            `gloss`  [ "go astray" ],
    ...
    noun     FA'iL                     {- TA}iH -}          `gloss`  [ "lost", "stray", "loose [ [ TA } iH / ADJ ] ]" ],

    -- ;; TA}iHap_1
    -- TA}H    TA}iH   Napdu   accident;adversity
    -- TwA}H   TawA}iH Ndip    adversities;fate

    noun     FA'iL |< aT               {- TA}iHap -}        -- `others` [ ".tawA'i.h Ndip" ]
                                                            `gloss`  [ "accident", "adversity", "adversities", "fate" ],

    -- ;; muTaw~iHap_1
    -- mTwH    muTaw~iH        NapAt   adventure

    noun     MuFaCCiL |< aT            {- muTaw~iHap -}     `gloss`  [ "adventure" ] ]
 ...
 |> ".t w ^s" <| [
    ...
    noun     FaCAL |< Iy               {- TawA$iy~ -}       `gloss`  [ "eunuch", "castrato", "eunuchs", "castrati [ [ TawA $ iy ~ / NOUN ] ]" ],

    -- ;; muTaw~a$_1
    -- mTw$    muTaw~a$        Nall    castrated     [[muTaw~a$/ADJ]]

    noun     MuFaCCaL                  {- muTaw~a$ -}       `gloss`  [ "castrated [ [ muTaw ~ a $ / ADJ ] ]" ] ]
 ...
 |> ".t w `" <| [
    ...
    verb     HaFAL                     {- OaTAE -}          -- `others` [ ".ta` IV_C_Pass_yu", ".ti` IV_C_yu", ".tiy` IV_V_yu", "'a.ta` PV_C", ".tA` IV_V_Pass_yu" ]
    ...
    noun     MuFACaL |< aT             {- muTAwaEap -}      `gloss`  [ "compliance", "tractability" ],

    -- ;; <iTAEap_1
    -- <TAE    <iTAE   NapAt   obedience
    -- ATAE    <iTAE   NapAt   obedience

    noun     HiFAL |< aT               {- IiTAEap -}        `gloss`  [ "obedience" ],

    -- ;; taTaw~uE_1
    -- tTwE    taTaw~uE        N/At    voluntary
    -- tTwE    taTaw~uE        NF      voluntarily     [[taTaw~uE/ADV]]

    noun     TaFaCCuL                  {- taTaw~uE -}       `gloss`  [ "voluntary", "voluntarily [ [ taTaw ~ uE / ADV ] ]" ],

    -- ;; taTaw~uEiy~_1
    -- tTwEy   taTaw~uEiy~     Nall    voluntary     [[taTaw~uEiy~/ADJ]]

    noun     TaFaCCuL |< Iy            {- taTaw~uEiy~ -}    `gloss`  [ "voluntary [ [ taTaw ~ uEiy ~ / ADJ ] ]" ],

    -- ;; {isotiTAEap_1
    -- <stTAE  {isotiTAE       NapAt   capability;possibility
    -- AstTAE  {isotiTAE       NapAt   capability;possibility

    noun     IstiFAL |< aT             {- {isotiTAEap -}    `gloss`  [ "capability", "possibility" ],

    -- ;; TA}iE_1
    -- TA}E    TA}iE   N/ap    compliant     [[TA}iE/ADJ]]

    noun     FA'iL                     {- TA}iE -}          `gloss`  [ "compliant [ [ TA } iE / ADJ ] ]" ],
    ...
    noun     MuFACiL                   {- muTAwiE -}        `gloss`  [ "obedient", "compliant [ [ muTAwiE / ADJ ] ]" ],

    -- ;; muTiyE_1
    -- mTyE    muTiyE  Nall    obedient;disciplined     [[muTiyE/ADJ]]

    noun     MuFIL                     {- muTiyE -}         `gloss`  [ "obedient", "disciplined [ [ muTiyE / ADJ ] ]" ],
    ...
    noun     MuFtAL                    {- muT~AE -}         `gloss`  [ "volunteer", "unsalaried trainee" ],
 ...
 |> ".t w b '" <| [
    ...
    noun     KuRDAS |< Iy              {- TuwbA}iy~ -}      `gloss`  [ "utopian [ [ TuwbA } iy ~ / ADJ ] ]" ] ]
 ...
 |> ".t w b s" <| [
    ...
    noun     KuRDAS |< Iy              {- TuwbAsiy~ -}      `gloss`  [ "of / from Tubas" ],

    -- ;; TuwbAsiy~_2
    -- TwbAsy  TuwbAsiy~       N0      Tubasi;Toubasi;Toubassi

    noun     KuRDAS |< Iy              {- TuwbAsiy~ -}      `gloss`  [ "Tubasi", "Toubasi", "Toubassi" ] ]
 ...
 |> ".t w b w" <| [
    ...
    noun     KuRDAS |< Iy              {- TuwbAwiy~ -}      `gloss`  [ "blessed [ [ TuwbAwiy ~ / ADJ ] ]" ],

    -- ;; TuwbAwiy~ap_1
    -- TwbAwy  TuwbAwiy~       Nap     blessedness     [[TuwbAwiy~/NOUN]]

    noun     KuRDAS |< Iy |< aT        {- TuwbAwiy~ap -}    `gloss`  [ "blessedness [ [ TuwbAwiy ~ / NOUN ] ]" ] ]
 ...
 |> ".t w f" <| [
    ...
    verb     HaFAL                     {- OaTAf -}          -- `others` [ ".tAf IV_V_Pass_yu", ".tif IV_C_yu", ".tiyf IV_V_yu", "'a.taf PV_C", ".taf IV_C_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- Tawofap -}        `gloss`  [ "patrol", "round" ],

    -- ;; TAfap_1
    -- TAf     TAf     Nap     ambulant;itinerant
    -- TwAf    Taw~Af  N       ambulant;itinerant

    noun     FAL |< aT                 {- TAfap -}          -- `others` [ ".tawwAf N" ]
    ...
    noun     FA'iL                     {- TA}if -}          `gloss`  [ "ambulant", "itinerant", "on patrol [ [ TA } if / ADJ ] ]" ],
    ...
    noun     FaCCAL |< aT              {- Taw~Afap -}       `gloss`  [ "patrol boat" ],
 ...
 |> ".t w f n" <| [
    ...
    noun     KuRDAS |< Iy              {- TuwfAniy~ -}      `gloss`  [ "torrential", "diluvial [ [ TuwfAniy ~ / ADJ ] ]" ] ]
 ...
 |> ".t w l" <| [
    ...
    noun     FuCL |< Iy                {- Tuwliy~ -}        `gloss`  [ "linear", "longitudinal [ [ Tuwliy ~ / ADJ ] ]" ],
    ...
    noun     FuCAL |< aT               {- TuwAlap -}        `gloss`  [ "stable" ],
    ...
    noun     IstiFAL |< aT             {- {isotiTAlap -}    `gloss`  [ "arrogance" ],

    -- ;; TA}il_1
    -- TA}l    TA}il   N-ap    immense;huge     [[TA}il/ADJ]]

    noun     FA'iL                     {- TA}il -}          `gloss`  [ "immense", "huge [ [ TA } il / ADJ ] ]" ],
    ...
    noun     MutaFACiL                 {- mutaTAwil -}      `gloss`  [ "prolonged [ [ mutaTAwil / ADJ ] ]", "insolent [ [ mutaTAwil / ADJ ] ]" ],
 ...
 |> ".t w l n" <| [
    ...
    noun     KuRDAS |< Iy              {- TuwlAniy~ -}      `gloss`  [ "longitudinal", "lengthwise [ [ TuwlAniy ~ / ADJ ] ]" ] ]
 ...
 |> ".t w n" <| [
    ...
    noun     FuCL |< aT                {- Tuwnap -}         `gloss`  [ "Danube" ] ]
 ...
 |> ".t w q" <| [
    ...
    verb     FAL                       {- TAq-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ ".tuq IV_C_intr PV_C_intr", ".tuwq IV_V_intr" ]
    ...
    verb     HaFAL                     {- OaTAq -}          -- `others` [ ".tiq IV_C_yu", ".tiyq IV_V_yu", "'a.taq PV_C", ".taq IV_C_Pass_yu", ".tAq IV_V_Pass_yu" ]
    ...
    noun     FaCL |< Iy                {- Tawoqiy~ -}       `gloss`  [ "collar-like", "ring-shaped [ [ Tawoqiy ~ / ADJ ] ]" ],
    ...
    noun     HiFAL |< aT               {- IiTAqap -}        `gloss`  [ "capability" ],
    ...
    noun     MuFAL                     {- muTAq -}          `gloss`  [ "tolerable", "bearable [ [ muTAq / ADJ ] ]" ],
 ...
 |> ".t w r" <| [
    ...
    noun     TaFaCCuL |< Iy            {- taTaw~uriy~ -}    `gloss`  [ "evolutionary", "developmental [ [ taTaw ~ uriy ~ / ADJ ] ]" ],
 ...
 |> ".t w s" <| [
    ...
    noun     MuFaCCaL                  {- muTaw~as -}       `gloss`  [ "ornate", "decorated [ [ muTaw ~ as / ADJ ] ]" ] ]
 ...
 |> ".t w y" <| [
    ...
    noun     FaCCAL |< aT              {- Taw~Ayap -}       `gloss`  [ "frying pan" ],
    ...
    noun     FY |< Iy |< aT            {- Tawiy~ap -}       -- `others` [ ".tawAyA N0_Nhy" ]
                                                            `gloss`  [ "intention", "conviction [ [ Tawiy ~ / NOUN ] ]", "intentions", "convictions", "interior", "insides ( of )" ],

    -- ;; Tiy~ap_1
    -- Ty      Tiy~    Nap     intention;design

    noun     FIL |< aT                 {- Tiy~ap -}         `gloss`  [ "intention", "design" ],
    ...
    noun     MaFCY                     {- maTowaY -}        -- `others` [ "ma.twA Nhy", "ma.tAw NK", "ma.tway NAn_Nayn", "ma.tAwiy N0_Nh" ]
                                                            `gloss`  [ "pocket knife", "pleat", "pocket knives", "pleats", "inside", "within" ],

    -- ;; miTowAp_1
    -- mTwA    miTowA  Napdu   pocket knife

    noun     MiFCY |< aT               {- miTowAp -}        `gloss`  [ "pocket knife" ],
    ...
    noun     FACiL                     {- TAwiy -}          -- `others` [ ".tAw Nuwn_Niyn NK" ]
                                                            `gloss`  [ "starved", "emaciated [ [ TAwiy / ADJ ] ]", "emaciated" ],

    -- ;; maTowiy~_1
    -- mTwy    maTowiy~        N-ap    containing;harboring     [[maTowiy~/ADJ]]

    noun     MaFCIy                    {- maTowiy~ -}       `gloss`  [ "containing", "harboring [ [ maTowiy ~ / ADJ ] ]" ],
    ...
    noun     MunFaCY                   {- munoTawaY -}      -- `others` [ "mun.tawA Nhy", "mun.taway NAt" ]
 ...
 |> ".t y .h" <| [
    ...
    verb     FAL                       {- TAH-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ ".ti.h IV_C_intr PV_C_intr", ".tiy.h IV_V_intr" ]
                                                            `gloss`  [ "be lost" ],
 ...
 |> ".t y ^s" <| [
    ...
    verb     FAL                       {- TA$-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ ".tiy^s IV_V_intr", ".ti^s IV_C_intr PV_C_intr" ]
                                                            `gloss`  [ "be frivolous", "miss the mark" ],

    -- ;; TA}i$_1
    -- TA}$    TA}i$   Nall    reckless;out of control

    noun     FA'iL                     {- TA}i$ -}          `gloss`  [ "reckless", "out of control" ],
    ...
    noun     FiCAL |< aT               {- TiyA$ap -}        `gloss`  [ "inconstancy", "recklessness" ],

    -- ;; >aToya$_1
    -- >Ty$    >aToya$ Nel     reckless;out of control
    -- ATy$    >aToya$ Nel     reckless;out of control

    noun     HaFCaL                    {- OaToya$ -}        `gloss`  [ "reckless", "out of control" ] ]
 ...
 |> ".t y `" <| [
    ...
    noun     MuFiCL                    {- muTiyE -}         `gloss`  [ "obedient", "disciplined [ [ muTiyE / ADJ ] ]" ] ]
 ...
 |> ".t y b" <| [
    ...
    verb     HaFAL                     {- OaTAb -}          -- `others` [ ".tab IV_C_Pass_yu", ".tib IV_C_yu", ".tiyb IV_V_yu", "'a.tab PV_C", ".tAb IV_V_Pass_yu" ]
    ...
    noun     FiCL |< Iy                {- Tiybiy~ -}        `gloss`  [ "aromatic [ [ Tiybiy ~ / ADJ ] ]" ],
    ...
    noun     FiCL |< aT                {- Tiybap -}         `gloss`  [ "good nature", "goodness" ],
    ...
    noun     HaFCaL                    {- OaToyab -}        -- `others` [ "'a.tAyib Ndip" ]
    ...
    noun     MuFACaL |< aT             {- muTAyabap -}      `gloss`  [ "banter", "jesting" ],

    -- ;; TA}ibap_1
    -- TA}b    TA}ib   Nap     unobjectionable

    noun     FA'iL |< aT               {- TA}ibap -}        `gloss`  [ "unobjectionable" ],
    ...
    noun     MustaFAL                  {- musotaTAb -}      `gloss`  [ "appreciated [ [ musotaTAb / ADJ ] ]" ],

    -- ;; Tiybap_2
    -- Tybp    Tiybap  N0      Thebes

    noun     FiCL |< aT                {- Tiybap -}         `gloss`  [ "Thebes" ] ]
 ...
 |> ".t y f" <| [
    ...
    verb     FAL                       {- TAf-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ ".tif PV_C IV_C", ".tiyf IV_V" ]
                                                            `gloss`  [ "appear" ],
    ...
    noun     FaCL |< Iy                {- Tayofiy~ -}       `gloss`  [ "spectral [ [ Tayofiy ~ / ADJ ] ]", "phantom [ [ Tayofiy ~ / ADJ ] ]" ],
 ...
 |> ".t y n" <| [
    ...
    verb     FaCCaL                    {- Tay~an -}         -- `others` [ ".tayyin IV-n_yu" ]
                                                            `gloss`  [ "daub with clay" ],
    ...
    noun     FiCL                      {- Tiyn -}           -- `others` [ "'a.tyAn N" ]
                                                            `gloss`  [ "clay" ],

    -- ;; Tiynap_1
    -- Tyn     Tiyn    Nap     potter's clay

    noun     FiCL |< aT                {- Tiynap -}         `gloss`  [ "potter 's clay" ],

    -- ;; Tiyniy~_1
    -- Tyny    Tiyniy~ N-ap    clay-like     [[Tiyniy~/ADJ]]

    noun     FiCL |< Iy                {- Tiyniy~ -}        `gloss`  [ "clay-like [ [ Tiyniy ~ / ADJ ] ]" ] ]
 ...
 |> ".t y r" <| [
    ...
    noun     FaCL |< aT                {- Tayorap -}        `gloss`  [ "agitation" ],

    -- ;; Tiyrap_1
    -- Tyr     Tiyr    Nap     evil omen

    noun     FiCL |< aT                {- Tiyrap -}         `gloss`  [ "evil omen" ],
    ...
    noun     FaCaLAn |< Iy             {- TayarAniy~ -}     `gloss`  [ "aviation [ [ TayarAniy ~ / ADJ ] ]" ],
    ...
    noun     MutaFaCCiL                {- mutaTay~ir -}     `gloss`  [ "pessimist", "superstitious [ [ mutaTay ~ ir / ADJ ] ]" ],

    -- ;; musotaTiyr_1
    -- mstTyr  musotaTiyr      N-ap    imminent;scattered     [[musotaTiyr/ADJ]]

    noun     MustaFiCL                 {- musotaTiyr -}     `gloss`  [ "imminent", "scattered [ [ musotaTiyr / ADJ ] ]" ],

    -- ;; {isotiTArap_1
    -- <stTAr  {isotiTAr       Nap     being terrified
    -- AstTAr  {isotiTAr       Nap     being terrified

    noun     IstiFAL |< aT             {- {isotiTArap -}    `gloss`  [ "being terrified" ],
 ...
 |> ".t y y" <| [
    ...
    noun     FiCL |< aT                {- Tiy~ap -}         `gloss`  [ "intention", "design" ] ]
 ...
 |> ".t z l q" <| [
    ...
    noun     KuRDuS                    {- Tuzoluq -}        -- `others` [ ".tazAliq Ndip" ]
 ...
 |> ".t z n" <| [
    ...
    noun     FaCIL |< aT               {- Taziynap -}       -- `others` [ ".tazAzin Ndip" ]
                                                            `gloss`  [ "dozen", "dozens" ] ]
 ...
 |> ".tA^giykistAniyy" <| [
    ...
    noun     Identity                  {- TAjiykisotAniy~ -} -- `others` [ "tA^giykistAniyy Nall" ]
                                                            `gloss`  [ "Tajikistani [ [ TAjiykisotAniy ~ / NOUN ] ]", "Tajikistani [ [ TAjiykisotAniy ~ / ADJ ] ]", "Tajikistani [ [ tAjiykisotAniy ~ / NOUN ] ]", "Tajikistani [ [ tAjiykisotAniy ~ / ADJ ] ]" ] ]
 ...
 |> ".tAlibAn" <| [
    ...
    noun     Identity |< Iy            {- TAlibAniy~ -}     `gloss`  [ "Taleban [ [ TAlibAniy ~ / NOUN ] ]", "Taleban [ [ TAlibAniy ~ / ADJ ] ]" ],
 ...
 |> ".taban^g" <| [
    ...
    noun     Identity |< aT            {- Tabanojap -}      `gloss`  [ "pistol" ] ]
 ...
 |> ".tamyiyy" <| [
    ...
    noun     Identity                  {- Tamoyiy~ -}       `gloss`  [ "alluvial [ [ Tamoyiy ~ / ADJ ] ]" ] ]
 ...
 |> ".tarAbuls" <| [
    ...
    noun     Identity |< Iy            {- TarAbulosiy~ -}   `gloss`  [ "of / from Tripoli ( Libya ) [ [ TarAbulosiy ~ / ADJ ] ]" ],

    -- ;; TarAbulosiy~_3
    -- TrAblsy TarAbulosiy~    Nall    of/from Tripoli (Leb.)    [[TarAbulosiy~/ADJ]]

    noun     Identity |< Iy            {- TarAbulosiy~ -}   `gloss`  [ "of / from Tripoli ( Leb . ) [ [ TarAbulosiy ~ / ADJ ] ]" ] ]
 ...
 |> ".tu.hruwr" <| [
    ...
    noun     Identity |< Iy            {- TuHoruwriy~ -}    `gloss`  [ "stratosphere", "cloudy [ [ TuHoruwriy ~ / ADJ ] ]" ] ]
 ...
 |> ".tu_hruwr" <| [
    ...
    noun     Identity |< Iy            {- Tuxoruwriy~ -}    `gloss`  [ "stratosphere", "cloudy [ [ Tuxoruwriy ~ / ADJ ] ]" ] ]
 ...
 |> ".tubuw.grAfiyy" <| [
    ...
    noun     Identity                  {- TubuwgrAfiy~ -}   -- `others` [ ".tuwbuw.grAfiyy Nall" ]
                                                            `gloss`  [ "topographic [ [ TubuwgrAfiy ~ / ADJ ] ]", "topographic [ [ TuwbuwgrAfiy ~ / ADJ ] ]" ],

    -- ;; TubuwgrAfiy~ap_1
    -- TbwgrAfy        TubuwgrAfiy~    Nap     topography     [[TubuwgrAfiy~/NOUN]]
    -- TwbwgrAfy       TuwbuwgrAfiy~   Nap     topography     [[TuwbuwgrAfiy~/NOUN]]

    noun     Identity |< aT            {- TubuwgrAfiy~ap -} -- `others` [ ".tuwbuw.grAfiyy Nap" ]
                                                            `gloss`  [ "topography [ [ TubuwgrAfiy ~ / NOUN ] ]", "topography [ [ TuwbuwgrAfiy ~ / NOUN ] ]" ] ]
 ...
 |> ".tulay.til" <| [
    ...
    noun     Identity |< aT            {- TulayoTilap -}    `gloss`  [ "Toledo" ] ]
 ...
 |> ".tum'aniyn" <| [
    ...
    noun     Identity |< Iy            {- TumoOaniyniy~ -}  `gloss`  [ "calming", "tranquilizing [ [ Tumo>aniyniy ~ / ADJ ] ]" ] ]
 ...
 |> ".tum.tumAn" <| [
    ...
    noun     Identity |< Iy            {- TumoTumAniy~ -}   `gloss`  [ "uneducated", "barbaric [ [ TumoTumAniy ~ / ADJ ] ]" ] ]
 ...
 |> ".turumb" <| [
    ...
    noun     Identity |< aT            {- Turumobap -}      `gloss`  [ "pump" ] ]
 ...
 |> ".tuwb^g" <| [
    ...
    noun     Identity |< Iy            {- Tuwbojiy~ -}      `gloss`  [ "artilleryman [ [ Tuwbojiy ~ / ADJ ] ]", "artillerymen [ [ Tuwbojiy ~ / NOUN ] ]" ],

    -- ;; Tuwbojiy~ap_1
    -- Twbjy   Tuwbojiy~       Nap     artillery     [[Tuwbojiy~/NOUN]]

    noun     Identity |< Iy |< aT      {- Tuwbojiy~ap -}    `gloss`  [ "artillery [ [ Tuwbojiy ~ / NOUN ] ]" ] ]
 ...
 |> ".tuwrbiyn" <| [
    ...
    noun     Identity |< Iy            {- Tuwrobiyniy~ -}   `gloss`  [ "turbine", "turbo [ [ Tuwrobiyniy ~ / ADJ ] ]" ] ]
 ...
 |> "i.tma'ann" <| [
    ...
    verb     Identity                  {- {iTomaOan~ -}     -- `others` [ ".tma'nin IV_Cn_intr", "i.tma'nan PV_Cn_intr", ".tma'inn IV_V_intr" ]
 ...
 |> "in.tiwA'iyy" <| [
    ...
    noun     Identity                  {- {inoTiwA}iy~ -}   `gloss`  [ "withdrawal", "introverted [ [ { inoTiwA } iy ~ / ADJ ] ]" ] ]
 ...
 |> "ma.tba`^g" <| [
    ...
    noun     Identity |< Iy            {- maTobaEojiy~ -}   `gloss`  [ "printer", "typesetter [ [ maTobaEojiy ~ / ADJ ] ]" ] ]
 ...
 |> "mun.tAd" <| [
    ...
    noun     Identity |< Iy            {- munoTAdiy~ -}     `gloss`  [ "balloonist", "dirigible [ [ munoTAdiy ~ / ADJ ] ]" ] ]
 ...
 |> "ta.twAf" <| [
    ...
    noun     Identity                  {- taTowAf -}        `gloss`  [ "traveling", "itinerant", "cruise [ [ taTowAf / ADJ ] ]" ] ]
