...
$lexicon = {
  ...
  'f d y' => [
    ...
    {
      'types' => $lexicon->{'f d y'}[0]{'types'},
      'entry' => 'fadY',
      'form' => 'fadY',
      'others' => $lexicon->{'f d y'}[0]{'others'},
      'lines' => $lexicon->{'f d y'}[0]{'lines'},
      'index' => '1',
      'entity' => 'verb',
      'morphs' => 'FaCaNY',
      'glosses' => $lexicon->{'f d y'}[0]{'glosses'},
      'suffix' => '',
      'imperf' => $lexicon->{'f d y'}[0]{'imperf'},
      'glosshash' => $lexicon->{'f d y'}[0]{'glosshash'},
      'orig' => 'fadaY-i',
      'prefix' => ''
    },
    {
  ...
  'f r d' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"individual [ [ >aforAdiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"individual [ [ >aforAdiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'OaforAdiy~',
      'prefix' => ''
    },
  ...
  'f .d l' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"better / best [ [ >afoDal / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"better / best [ [ >afoDal / ADJ ] ]"' => 1
      },
      'orig' => 'OafoDal',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"precedence [ [ >afoDaliy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"preference"' => 1,
        '"precedence [ [ >afoDaliy ~ / NOUN ] ]"' => 1,
        '"priority"' => 1
      },
      'orig' => 'OafoDaliy~ap',
      'prefix' => ''
  ...
  'f t w' => [
    {
      ...
      'glosshash' => {
        '"be debated legally"' => 1,
        '"deliver a fatwa ( legal opinion )"' => 1,
        '"opine"' => 1
      },
      'orig' => 'OafotaY',
      'prefix' => ''
    ...
    {
      'types' => $lexicon->{'f t w'}[1]{'types'},
      'entry' => 'fatY',
      'form' => 'fatY',
      'others' => $lexicon->{'f t w'}[1]{'others'},
      'lines' => $lexicon->{'f t w'}[1]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCaNY',
      'suffix' => '',
      'glosses' => $lexicon->{'f t w'}[1]{'glosses'},
      'glosshash' => $lexicon->{'f t w'}[1]{'glosshash'},
      'orig' => 'fataY',
      'prefix' => ''
    },
    {
    ...
    {
      'types' => $lexicon->{'f t w'}[3]{'types'},
      'entry' => 'fatY',
      'form' => 'fatAT',
      'others' => $lexicon->{'f t w'}[3]{'others'},
      'lines' => $lexicon->{'f t w'}[3]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCaNY |< aT',
      'suffix' => ' |< aT',
      'glosses' => $lexicon->{'f t w'}[3]{'glosses'},
      'glosshash' => $lexicon->{'f t w'}[3]{'glosshash'},
      'orig' => 'fatAp',
      'prefix' => ''
    },
    {
  ...
  'f n \'' => [
    {
      'types' => $lexicon->{'f n y'}[0]{'types'},
      'entry' => '\'ifnA\'',
      'form' => '\'ifnA\'',
      'lines' => $lexicon->{'f n y'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'HiFCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'f n y'}[0]{'glosses'},
      'glosshash' => $lexicon->{'f n y'}[0]{'glosshash'},
      'orig' => 'IifonA\'',
      'prefix' => ''
    }
  ],
  ...
  'f ^s y' => [
    {
      'types' => $lexicon->{'f ^s w'}[3]{'types'},
      'entry' => 'mutafa^s^siy',
      'form' => 'mutafa^s^siy',
      'others' => $lexicon->{'f ^s w'}[3]{'others'},
      'lines' => $lexicon->{'f ^s w'}[3]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'MutaFaCCiL',
      'suffix' => '',
      'glosses' => $lexicon->{'f ^s w'}[3]{'glosses'},
      'glosshash' => $lexicon->{'f ^s w'}[3]{'glosshash'},
      'orig' => 'mutafa$~iy',
      'prefix' => ''
    }
  ],
  ...
  'f t y' => [
    ...
    {
      'types' => $lexicon->{'f t w'}[8]{'types'},
      'entry' => 'muftiy',
      'form' => 'muftiy',
      'others' => $lexicon->{'f t w'}[8]{'others'},
      'lines' => $lexicon->{'f t w'}[8]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'MuFCiL',
      'suffix' => '',
      'glosses' => $lexicon->{'f t w'}[8]{'glosses'},
      'glosshash' => $lexicon->{'f t w'}[8]{'glosshash'},
      'orig' => 'mufotiy',
      'prefix' => ''
    }
  ],
