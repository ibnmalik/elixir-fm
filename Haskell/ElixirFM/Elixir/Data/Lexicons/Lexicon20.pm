...
package Elixir::Data::Lexicons::Lexicon20;
...
$lexicon = {
  'f ` m' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"overflowing [ [ mufoEam / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"stuffed"' => 1,
        '"overflowing [ [ mufoEam / ADJ ] ]"' => 1,
        '"jam-packed"' => 1
      },
      'orig' => 'mufoEam',
      'prefix' => ''
  ...
  'f .d w' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"satellite-based [ [ faDA } iy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"satellite-based [ [ faDA } iy ~ / ADJ ] ]"' => 1,
        '"cosmic [ [ faDA } iy ~ / ADJ ] ]"' => 1,
        '"space"' => 1
      },
      'orig' => 'faDA}iy~',
      'prefix' => ''
  ...
  'f d y' => [
    ...
    },
    {
      ...
      'others' => [
        'tafAdA PV_h IV_h',
        'tafAd IV_0hwnyn PV_ttAw',
        'tafAday PV_Atn IV_Ann'
      ],
      'lines' => [
        ';; tafAdaY_1',
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"fedayeen [ [ fidA } iy ~ / NOUN ] ]"'
        ],
        [
          '"fedayeen [ [ fidA } iy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"fedayeen [ [ fidA } iy ~ / ADJ ] ]"' => 1,
        '"commando"' => 1,
        '"fedayeen [ [ fidA } iy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'fidA}iy~',
      'prefix' => ''
    }
  ...
  'f w l' => [
    ...
    {
      'types' => $lexicon->{'f w l'}[0]{'types'},
      'entry' => 'fuwl',
      'form' => 'fuwl',
      'lines' => $lexicon->{'f w l'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FUL',
      'suffix' => '',
      'glosses' => $lexicon->{'f w l'}[0]{'glosses'},
      'glosshash' => $lexicon->{'f w l'}[0]{'glosshash'},
      'orig' => 'fuwl',
      'prefix' => ''
    }
  ],
  ...
  'f ^s l' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"unsuccessful [ [ fA $ il / ADJ ] ] fA $ il /  / pos>"'
        ]
      ],
      'glosshash' => {
        '"unsuccessful [ [ fA $ il / ADJ ] ] fA $ il /  / pos>"' => 1,
        '"failing"' => 1
      },
      'orig' => 'fA$il',
      'prefix' => ''
  ...
  'f d d' => [
    {
      ...
      'glosshash' => {
        '"5.7 sq.m Lev . )"' => 1,
        '"feddan ( 4.2 sq.m . , Ar.Eg.Sud ."' => 1,
        '"feddans ( 1 feddan = 4.2 sq.m . , Ar.Eg.Sud ."' => 1
      },
      'orig' => 'fad~An',
      'prefix' => ''
    }
  ...
  'f r .t' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"lacking moderation [ [ muforiT / ADJ ] ] muforiT /  / pos>"'
        ]
      ],
      'glosshash' => {
        '"lacking moderation [ [ muforiT / ADJ ] ] muforiT /  / pos>"' => 1,
        '"excessive"' => 1
      },
      'orig' => 'muforiT',
      'prefix' => ''
  ...
  'f w h' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"eloquent [ [ mufaw ~ ah / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"eloquent [ [ mufaw ~ ah / ADJ ] ]"' => 1
      },
      'orig' => 'mufaw~ah',
      'prefix' => ''
    }
  ...
  'f ^g \'' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"unexpected [ [ fujA } iy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"unexpected [ [ fujA } iy ~ / ADJ ] ]"' => 1,
        '"surprising"' => 1
      },
      'orig' => 'fujA}iy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"unexpected [ [ mufAji } / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"unexpected [ [ mufAji } / ADJ ] ]"' => 1,
        '"surprising"' => 1
      },
      'orig' => 'mufAji}',
      'prefix' => ''
  ...
  'f .t r' => [
    {
      ...
      'glosses' => [
        [
          '"Fitr ( breaking of the Ramadan fast )"'
        ]
      ],
      'glosshash' => {
        '"Fitr ( breaking of the Ramadan fast )"' => 1
      },
      'orig' => 'fiTor',
      'prefix' => ''
    },
  ...
  'f r ^s' => [
    {
      ...
      'glosses' => [
        [
          '"furnished [ [ maforuw $ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"furnished [ [ maforuw $ / ADJ ] ]"' => 1
      },
      'orig' => 'maforuw$',
      'prefix' => ''
    }
  ...
  'f ^g r' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"exploding [ [ mutafaj ~ ir / ADJ ] ]"'
        ],
        [
          '"explosives [ [ mutafaj ~ ir / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"exploding [ [ mutafaj ~ ir / ADJ ] ]"' => 1,
        '"explosives [ [ mutafaj ~ ir / NOUN ] ]"' => 1,
        '"explosive"' => 1
      },
      'orig' => 'mutafaj~ir',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"blasting [ [ munofajir / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"blasting [ [ munofajir / ADJ ] ]"' => 1,
        '"explosive"' => 1
      },
      'orig' => 'munofajir',
      'prefix' => ''
  ...
  'fiyliybbiyn' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"Filipino [ [ filiyb ~ iyniy ~ / NOUN ] ]"'
        ],
        [
          '"Filipino [ [ filiyb ~ iyniy ~ / ADJ ] ]"'
        ],
        [
          '"Filipino [ [ fiylib ~ iyniy ~ / NOUN ] ]"'
        ],
        [
          '"Filipino [ [ fiylib ~ iyniy ~ / ADJ ] ]"'
        ],
        [
          '"Filipino [ [ filib ~ iyniy ~ / NOUN ] ]"'
        ],
        [
          '"Filipino [ [ filib ~ iyniy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"Filipino [ [ fiylib ~ iyniy ~ / NOUN ] ]"' => 1,
        '"Filipino [ [ filiyb ~ iyniy ~ / ADJ ] ]"' => 1,
        '"Philippine"' => 1,
        '"Filipino [ [ filib ~ iyniy ~ / ADJ ] ]"' => 1,
        '"Filipino [ [ fiylib ~ iyniy ~ / ADJ ] ]"' => 1,
        '"Filipino [ [ filiyb ~ iyniy ~ / NOUN ] ]"' => 1,
        '"Filipino [ [ filib ~ iyniy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'fiyliyb~iyniy~',
      'prefix' => ''
    }
  ...
  'f .s l' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"minute [ [ tafoSiyliy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"minute [ [ tafoSiyliy ~ / ADJ ] ]"' => 1,
        '"detailed"' => 1
      },
      'orig' => 'tafoSiyliy~',
      'prefix' => ''
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"elaborately [ [ mufaS ~ al / ADV ] ]"'
        ]
      ],
      'glosshash' => {
        '"detailed"' => 1,
        '"in detain"' => 1,
        '"minute [ [ mufaS ~ al / ADJ ] ]"' => 1,
        '"elaborately [ [ mufaS ~ al / ADV ] ]"' => 1,
        '"minutely"' => 1
      },
      'orig' => 'mufaS~al',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"detached [ [ munofaSil / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"detached [ [ munofaSil / ADJ ] ]"' => 1,
        '"separate"' => 1
      },
      'orig' => 'munofaSil',
      'prefix' => ''
  ...
  'f l k' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"sidereal [ [ falakiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"astronomic"' => 1,
        '"sidereal [ [ falakiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'falakiy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"astrologic [ [ falakiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"astrologic [ [ falakiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'falakiy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"astronomer [ [ falakiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"astronomer [ [ falakiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'falakiy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"astrologer [ [ falakiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"astrologer [ [ falakiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'falakiy~',
      'prefix' => ''
    }
  ...
  'f r h' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"attractive [ [ fArih / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"nimble"' => 1,
        '"attractive [ [ fArih / ADJ ] ]"' => 1,
        '"lively"' => 1
      },
      'orig' => 'fArih',
      'prefix' => ''
  ...
  'f r .d' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"hypothetical [ [ faroDiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"hypothetical [ [ faroDiy ~ / ADJ ] ]"' => 1,
        '"conjectural"' => 1
      },
      'orig' => 'faroDiy~',
      'prefix' => ''
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"prescribed [ [ maforuwD / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"prescribed [ [ maforuwD / ADJ ] ]"' => 1,
        '"imposed"' => 1
      },
      'orig' => 'maforuwD',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"presumed [ [ mufotaraD / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"supposed"' => 1,
        '"presumed [ [ mufotaraD / ADJ ] ]"' => 1
      },
      'orig' => 'mufotaraD',
      'prefix' => ''
    }
  ...
  'f .d \'' => [
    {
      'types' => $lexicon->{'f .d w'}[0]{'types'},
      'entry' => 'fa.dA\'',
      'form' => 'fa.dA\'',
      'others' => $lexicon->{'f .d w'}[0]{'others'},
      'lines' => $lexicon->{'f .d w'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'f .d w'}[0]{'glosses'},
      'glosshash' => $lexicon->{'f .d w'}[0]{'glosshash'},
      'orig' => 'faDA\'',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'f .d w'}[1]{'types'},
      'entry' => 'fa.dA\'',
      'form' => 'fa.dA\'iyy',
      'lines' => $lexicon->{'f .d w'}[1]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCAL',
      'suffix' => ' |< Iy',
      'glosses' => $lexicon->{'f .d w'}[1]{'glosses'},
      'glosshash' => $lexicon->{'f .d w'}[1]{'glosshash'},
      'orig' => 'faDA}iy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"astronaut [ [ faDA } iy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"astronaut [ [ faDA } iy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'faDA}iy~',
      'prefix' => ''
    }
  ...
  'filas.tiyn' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"Palestinian [ [ filasoTiyniy ~ / NOUN ] ]"'
        ],
        [
          '"Palestinian [ [ filasoTiyniy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"Palestinian [ [ filasoTiyniy ~ / NOUN ] ]"' => 1,
        '"Palestinian [ [ filasoTiyniy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'filasoTiyniy~',
      'prefix' => ''
    }
  ...
  'f t .h' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"tolerant [ [ munofatiH / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"responsive"' => 1,
        '"open"' => 1,
        '"tolerant [ [ munofatiH / ADJ ] ]"' => 1
      },
      'orig' => 'munofatiH',
      'prefix' => ''
    }
  ...
  'finland' => [
    {
      ...
      'glosses' => [
        [
          '"Finnish [ [ finolanodiy ~ / NOUN ] ]"'
        ],
        [
          '"Finnish [ [ finolanodiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"Finnish [ [ finolanodiy ~ / ADJ ] ]"' => 1,
        '"Finnish [ [ finolanodiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'finolanodiy~',
      'prefix' => ''
    }
  ...
  'f \' w' => [
    {
      ...
      'glosshash' => {
        '"FAO ( UN Food and Agriculture Organization )"' => 1
      },
      'orig' => 'fAw',
      'prefix' => ''
    }
  ...
  'f r d' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"individualism [ [ farodiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"individualism [ [ farodiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'farodiy~ap',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"exceptional [ [ fariyd / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"unique"' => 1,
        '"exceptional [ [ fariyd / ADJ ] ]"' => 1,
        '"incomparable"' => 1
      },
      'orig' => 'fariyd',
      'prefix' => ''
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"in isolation [ [ munofarid / ADV ] ]"'
        ]
      ],
      'glosshash' => {
        '"alone"' => 1,
        '"alone [ [ munofarid / ADJ ] ]"' => 1,
        '"in isolation [ [ munofarid / ADV ] ]"' => 1,
        '"isolated"' => 1,
        '"detached"' => 1
      },
      'orig' => 'munofarid',
  ...
  'finizuwill' => [
    {
      ...
      'glosses' => [
        [
          '"Venezuelan [ [ finizuwil ~ iy ~ / NOUN ] ]"'
        ],
        [
          '"Venezuelan [ [ finizuwil ~ iy ~ / ADJ ] ]"'
        ],
        [
          '"Venezuelan [ [ finizowiyl ~ iy ~ / NOUN ] ]"'
        ],
        [
          '"Venezuelan [ [ finizowiyl ~ iy ~ / ADJ ] ]"'
        ],
        [
          '"Venezuelan [ [ finizowiyloliy ~ / NOUN ] ]"'
        ],
        [
          '"Venezuelan [ [ finizowiyloliy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"Venezuelan [ [ finizuwil ~ iy ~ / NOUN ] ]"' => 1,
        '"Venezuelan [ [ finizowiyl ~ iy ~ / NOUN ] ]"' => 1,
        '"Venezuelan [ [ finizowiyloliy ~ / NOUN ] ]"' => 1,
        '"Venezuelan [ [ finizowiyloliy ~ / ADJ ] ]"' => 1,
        '"Venezuelan [ [ finizowiyl ~ iy ~ / ADJ ] ]"' => 1,
        '"Venezuelan [ [ finizuwil ~ iy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'finizuwil~iy~',
      'prefix' => ''
    }
  ...
  'f ^g `' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"agonizing [ [ mufaj ~ iE / ADJ ] ]"'
        ],
        [
          '"horrors [ [ mufaj ~ iE / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"horrors [ [ mufaj ~ iE / NOUN ] ]"' => 1,
        '"agonizing [ [ mufaj ~ iE / ADJ ] ]"' => 1,
        '"harrowing"' => 1
      },
      'orig' => 'mufaj~iE',
      'prefix' => ''
  ...
  'f d .h' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"oppressive [ [ fAdiH / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"burdensome"' => 1,
        '"oppressive [ [ fAdiH / ADJ ] ]"' => 1
      },
      'orig' => 'fAdiH',
      'prefix' => ''
    }
  ...
  'f w .d' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"consultation-related [ [ tafAwuDiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"consultation-related [ [ tafAwuDiy ~ / ADJ ] ]"' => 1,
        '"negotiation-related"' => 1
      },
      'orig' => 'tafAwuDiy~',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"delegation [ [ mufaw ~ aDiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"delegation [ [ mufaw ~ aDiy ~ / NOUN ] ]"' => 1,
        '"legation"' => 1
      },
      'orig' => 'mufaw~aDiy~ap',
      'prefix' => ''
  ...
  'fiyzyA\'' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"physics [ [ fiyzyA } iy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"physics"' => 1,
        '"physics [ [ fiyzyA } iy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'fiyzyA\'',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"physicist [ [ fiyzyA } iy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"physicist [ [ fiyzyA } iy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'fiyzyA}iy~',
      'prefix' => ''
    }
  ...
  'f d n' => [
    {
      'types' => $lexicon->{'f d d'}[0]{'types'},
      'entry' => 'faddAn',
      'form' => 'faddAn',
      'others' => $lexicon->{'f d d'}[0]{'others'},
      'lines' => $lexicon->{'f d d'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'f d d'}[0]{'glosses'},
      'glosshash' => $lexicon->{'f d d'}[0]{'glosshash'},
      'orig' => 'fad~An',
      'prefix' => ''
    }
  ],
  ...
  'f q m' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"growing in danger [ [ mutafAqim / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"increasingly serious"' => 1,
        '"alarming"' => 1,
        '"growing in danger [ [ mutafAqim / ADJ ] ]"' => 1
      },
      'orig' => 'mutafAqim',
      'prefix' => ''
    }
  ...
  'f _h r' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"honorary [ [ faxoriy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"honorary [ [ faxoriy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'faxoriy~',
      'prefix' => ''
    },
  ...
  'f h m' => [
    ...
    },
    {
      ...
      'glosshash' => {
        '"achieve mutual understanding"' => 1,
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"understood [ [ mafohuwm / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"understood [ [ mafohuwm / ADJ ] ]"' => 1
      },
      'orig' => 'mafohuwm',
      'prefix' => ''
    },
  ...
  'f _h _h' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"booby-trapped [ [ mufax ~ ax / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"booby-trapped [ [ mufax ~ ax / ADJ ] ]"' => 1
      },
      'orig' => 'mufax~ax',
      'prefix' => ''
    }
  ...
  'fiymA' => [
    {
      ...
      'glosses' => [
        [
          '"in what [ [ fiy / PREP+mA / REL_PRON ] ]"'
        ],
        [
          '"in what [ [ fiy / PREP+mA / INTERROG ] ]"'
        ]
      ],
      'glosshash' => {
        '"in what [ [ fiy / PREP+mA / INTERROG ] ]"' => 1,
        '"in what [ [ fiy / PREP+mA / REL_PRON ] ]"' => 1
      },
      'orig' => 'fiymA',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"during which [ [ fiymA / CONJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"while"' => 1,
        '"during which [ [ fiymA / CONJ ] ]"' => 1
      },
      'orig' => 'fiymA',
      'prefix' => ''
    }
  ...
  'f .d l' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"in addition [ [ faDol / ADV ] ]"'
        ]
      ],
      'glosshash' => {
        '"in addition [ [ faDol / ADV ] ]"' => 1
      },
      'orig' => 'faDolAF',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"preferential [ [ tafoDiyliy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"preferential [ [ tafoDiyliy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'tafoDiyliy~',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"preferred [ [ mufaD ~ al / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"favorite"' => 1,
        '"preferred [ [ mufaD ~ al / ADJ ] ]"' => 1
      },
      'orig' => 'mufaD~al',
      'prefix' => ''
    }
  ...
  'fiyatnAm' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"Vietnamese [ [ fiyatonAmiy ~ / NOUN ] ]"'
        ],
        [
          '"Vietnamese [ [ fiyatonAmiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"Vietnamese [ [ fiyatonAmiy ~ / ADJ ] ]"' => 1,
        '"Vietnamese [ [ fiyatonAmiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'fiyatonAmiy~',
      'prefix' => ''
    }
  ...
  'fuwtuw.grAf' => [
    {
      ...
      'glosses' => [
        [
          '"photographic [ [ fuwtuwgrAfiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"photographic [ [ fuwtuwgrAfiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'fuwtuwgrAfiy~',
      'prefix' => ''
    }
  ...
  'f ` l' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"actually [ [ bi / PREP+Al / DET+fiEol / ADV ] ]"'
        ]
      ],
      'glosshash' => {
        '"in effect"' => 1,
        '"actually"' => 1,
        '"in effect [ [ fiEol / ADV ] ]"' => 1,
        '"act"' => 1,
        '"actually [ [ bi / PREP+Al / DET+fiEol / ADV ] ]"' => 1,
        '"actions"' => 1,
        '"acts"' => 1,
        '"action"' => 1,
        '"doing"' => 1,
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"de facto [ [ fiEoliy ~ / ADJ ] ]"'
        ],
        [
          '"de facto [ [ fiEoliy ~ / ADV ] ]"'
        ]
      ],
      'glosshash' => {
        '"de facto [ [ fiEoliy ~ / ADJ ] ]"' => 1,
        '"de facto [ [ fiEoliy ~ / ADV ] ]"' => 1,
        '"real"' => 1,
        '"actual"' => 1
      },
      'orig' => 'fiEoliy~',
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"efficient [ [ faE ~ Al / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"efficient [ [ faE ~ Al / ADJ ] ]"' => 1,
        '"effective"' => 1
      },
      'orig' => 'faE~Al',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"in operation [ [ faE ~ Al / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"in operation [ [ faE ~ Al / ADJ ] ]"' => 1,
        '"active"' => 1
      },
      'orig' => 'faE~Al',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"efficiency [ [ faE ~ Aliy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"efficiency [ [ faE ~ Aliy ~ / NOUN ] ]"' => 1,
        '"effectiveness"' => 1
      },
      'orig' => 'faE~Aliy~ap',
      'prefix' => ''
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"activity [ [ fAEiliy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"effectiveness"' => 1,
        '"activity [ [ fAEiliy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'fAEiliy~ap',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"spurious [ [ mufotaEal / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"spurious [ [ mufotaEal / ADJ ] ]"' => 1,
        '"falsified"' => 1
      },
      'orig' => 'mufotaEal',
      'prefix' => ''
  ...
  'f k r' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"spiritual [ [ fikoriy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"mental"' => 1,
        '"spiritual [ [ fikoriy ~ / ADJ ] ]"' => 1,
        '"intellectual"' => 1
      },
      'orig' => 'fikoriy~',
      'prefix' => ''
  ...
  'f w l _d' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"steel plated [ [ fuwlA*iy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"steel plated [ [ fuwlA*iy ~ / ADJ ] ]"' => 1,
        '"steel"' => 1
      },
      'orig' => 'fuwlA*',
      'prefix' => ''
  ...
  'f l _d' => [
    {
      'types' => $lexicon->{'f w l _d'}[0]{'types'},
      'entry' => 'fuwlA_d',
      'form' => 'fuwlA_d',
      'others' => $lexicon->{'f w l _d'}[0]{'others'},
      'lines' => $lexicon->{'f w l _d'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FUCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'f w l _d'}[0]{'glosses'},
      'glosshash' => $lexicon->{'f w l _d'}[0]{'glosshash'},
      'orig' => 'fuwlA*',
      'prefix' => ''
    }
  ],
  'f r s' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"heroism [ [ furuwsiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"horsemanship"' => 1,
        '"heroism [ [ furuwsiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'furuwsiy~ap',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosshash' => {
        '"Persians"' => 1,
        '"Persian [ [ fArisiy ~ / ADJ ] ]"' => 1,
        '"Persian [ [ fArisiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'fArisiy~',
      'prefix' => ''
    }
  ...
  'f .d .h' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"scandalous [ [ fADiH / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"scandalous [ [ fADiH / ADJ ] ]"' => 1
      },
      'orig' => 'fADiH',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"ignominious [ [ mafoDuwH / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"ignominious [ [ mafoDuwH / ADJ ] ]"' => 1,
        '"dishonored"' => 1,
        '"disgraced"' => 1
      },
      'orig' => 'mafoDuwH',
    ...
    {
      'types' => $lexicon->{'f .d \''}[2]{'types'},
      'entry' => 'fa.dA\'',
      'form' => 'fa.dA\'iyy',
      'lines' => $lexicon->{'f .d \''}[2]{'lines'},
      'index' => '2',
      'entity' => 'noun',
      'morphs' => 'FaCA\'',
      'suffix' => ' |< Iy',
      'glosses' => $lexicon->{'f .d \''}[2]{'glosses'},
      'glosshash' => $lexicon->{'f .d \''}[2]{'glosshash'},
      'orig' => 'faDA}iy~',
      'prefix' => ''
    }
  ],
  ...
  'f d \'' => [
    {
      'types' => $lexicon->{'f d y'}[3]{'types'},
      'entry' => 'fidA\'',
      'form' => 'fidA\'',
      'lines' => $lexicon->{'f d y'}[3]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FiCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'f d y'}[3]{'glosses'},
      'glosshash' => $lexicon->{'f d y'}[3]{'glosshash'},
      'orig' => 'fidA\'',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'f d y'}[4]{'types'},
      'entry' => 'fidA\'',
      'form' => 'fidA\'iyy',
      'lines' => $lexicon->{'f d y'}[4]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FiCAL',
      'suffix' => ' |< Iy',
      'glosses' => $lexicon->{'f d y'}[4]{'glosses'},
      'glosshash' => $lexicon->{'f d y'}[4]{'glosshash'},
      'orig' => 'fidA}iy~',
      'prefix' => ''
    }
  ],
  ...
  'f \' z' => [
    {
      'types' => $lexicon->{'f w z'}[3]{'types'},
      'entry' => 'fA\'iz',
      'form' => 'fA\'iz',
      'lines' => $lexicon->{'f w z'}[3]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACiL',
      'suffix' => '',
      'glosses' => $lexicon->{'f w z'}[3]{'glosses'},
      'glosshash' => $lexicon->{'f w z'}[3]{'glosshash'},
      'orig' => 'fA}iz',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'f w z'}[4]{'types'},
      'entry' => 'fA\'iz',
      'form' => 'fA\'iz',
      'lines' => $lexicon->{'f w z'}[4]{'lines'},
      'index' => '2',
      'entity' => 'noun',
      'morphs' => 'FACiL',
      'suffix' => '',
      'glosses' => $lexicon->{'f w z'}[4]{'glosses'},
      'glosshash' => $lexicon->{'f w z'}[4]{'glosshash'},
      'orig' => 'fA}iz',
      'prefix' => ''
    }
  ],
  ...
  'f n n' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"technician [ [ fan ~ iy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"technician [ [ fan ~ iy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'fan~iy~',
      'prefix' => ''
    },
    ...
    {
      'types' => $lexicon->{'f n n'}[3]{'types'},
      'entry' => 'fannAn',
      'form' => 'fannAn',
      'lines' => $lexicon->{'f n n'}[3]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCLAn',
      'suffix' => '',
      'glosses' => $lexicon->{'f n n'}[3]{'glosses'},
      'glosshash' => $lexicon->{'f n n'}[3]{'glosshash'},
      'orig' => 'fan~An',
      'prefix' => ''
    }
  ],
  'f l .h' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"agricultural [ [ filAHiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"agricultural [ [ filAHiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'filAHiy~',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"peasant [ [ fal ~ AHiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"peasant [ [ fal ~ AHiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'fal~AHiy~',
      'prefix' => ''
    }
  ...
  'f r q' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"sporadic [ [ mutafar ~ iq / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"sporadic [ [ mutafar ~ iq / ADJ ] ]"' => 1,
        '"scattered"' => 1,
        '"dispersed"' => 1
      },
      'orig' => 'mutafar~iq',
  ...
  'fawra' => [
    {
      ...
      'glosses' => [
        [
          '"immediately after [ [ fawora / PREP ] ]"'
        ]
      ],
      'glosshash' => {
        '"immediately after [ [ fawora / PREP ] ]"' => 1
      },
      'orig' => 'fawora',
      'prefix' => ''
    }
  ...
  'f ^s w' => [
    {
      ...
      'form' => 'tafa^s^sY',
      'others' => [
        'tafa^s^s PV_ttAw_intr IV_0hwnyn',
        'tafa^s^say PV_Atn IV_Ann'
      ],
      'lines' => [
        ';; tafa$~aY_1',
  ...
  'f y l' => [
    ...
    {
      'types' => $lexicon->{'f y l'}[0]{'types'},
      'entry' => 'fiyl',
      'form' => 'fiyl',
      'others' => $lexicon->{'f y l'}[0]{'others'},
      'lines' => $lexicon->{'f y l'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FIL',
      'suffix' => '',
      'glosses' => $lexicon->{'f y l'}[0]{'glosses'},
      'glosshash' => $lexicon->{'f y l'}[0]{'glosshash'},
      'orig' => 'fiyl',
      'prefix' => ''
    }
  ],
  ...
  'f \' l' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"optimistic [ [ mutafA } il / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"optimistic [ [ mutafA } il / ADJ ] ]"' => 1
      },
      'orig' => 'mutafA}il',
      'prefix' => ''
    }
  ...
  'f w n' => [
    ...
    {
      'types' => $lexicon->{'f w n'}[0]{'types'},
      'entry' => 'fuwn',
      'form' => 'fuwn',
      'lines' => $lexicon->{'f w n'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FuCL',
      'suffix' => '',
      'glosses' => $lexicon->{'f w n'}[0]{'glosses'},
      'glosshash' => $lexicon->{'f w n'}[0]{'glosshash'},
      'orig' => 'fuwn',
      'prefix' => ''
    }
  ],
  'f q d' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"review [ [ tafaq ~ udiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"inspection"' => 1,
        '"review [ [ tafaq ~ udiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'tafaq~udiy~',
      'prefix' => ''
    },
  ...
  'f y .d' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"extensive [ [ musotafiyD / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"detailed"' => 1,
        '"extensive [ [ musotafiyD / ADJ ] ]"' => 1,
        '"elaborate"' => 1
      },
      'orig' => 'musotafiyD',
      'prefix' => ''
    ...
    {
      'types' => $lexicon->{'f y .d'}[5]{'types'},
      'entry' => 'mustafiy.d',
      'form' => 'mustafiy.d',
      'lines' => $lexicon->{'f y .d'}[5]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'MustaFIL',
      'suffix' => '',
      'glosses' => $lexicon->{'f y .d'}[5]{'glosses'},
      'glosshash' => $lexicon->{'f y .d'}[5]{'glosshash'},
      'orig' => 'musotafiyD',
      'prefix' => ''
    }
  ],
  ...
  'f ^s y' => [
    {
      'types' => $lexicon->{'f ^s '}[0]{'types'},
      'entry' => 'mutafa^s^siy',
      'form' => 'mutafa^s^siy',
      'others' => $lexicon->{'f ^s '}[0]{'others'},
      'lines' => $lexicon->{'f ^s '}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'MutaFaCCiL',
      'suffix' => '',
      'glosses' => $lexicon->{'f ^s '}[0]{'glosses'},
      'glosshash' => $lexicon->{'f ^s '}[0]{'glosshash'},
      'orig' => 'mutafa$~iy',
      'prefix' => ''
    }
  ],
  ...
  'f y m' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"from / of Fayyoum [ [ fay ~ uwmiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"from / of Fayyoum [ [ fay ~ uwmiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'fay~uwmiy~',
      'prefix' => ''
    }
  ...
  'fidirAl' => [
    {
      ...
      'glosses' => [
        [
          '"federation [ [ fidirAliy ~ / NOUN ] ]"'
        ],
        [
          '"federation [ [ fiydirAliy ~ / NOUN ] ]"'
        ],
        [
          '"federation [ [ fidiyrAliy ~ / NOUN ] ]"'
        ],
        [
          '"federation [ [ fiydiyrAliy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"federation [ [ fiydiyrAliy ~ / NOUN ] ]"' => 1,
        '"federation [ [ fiydirAliy ~ / NOUN ] ]"' => 1,
        '"federation [ [ fidirAliy ~ / NOUN ] ]"' => 1,
        '"federation [ [ fidiyrAliy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'fidirAliy~ap',
      'prefix' => ''
    }
  ...
  'f f ' => [
    {
      'types' => $lexicon->{'f f y'}[0]{'types'},
      'entry' => 'fiy',
      'form' => 'fiy',
      'lines' => $lexicon->{'f f y'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'CI',
      'suffix' => '',
      'glosses' => $lexicon->{'f f y'}[0]{'glosses'},
      'glosshash' => $lexicon->{'f f y'}[0]{'glosshash'},
      'orig' => 'fiy',
      'prefix' => ''
    }
  ],
  'f r `' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"sub-sectional [ [ faroEiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"sub-branch"' => 1,
        '"sub-sectional [ [ faroEiy ~ / ADJ ] ]"' => 1,
        '"subdivisional"' => 1
      },
      'orig' => 'faroEiy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"spreading out [ [ mutafar ~ iE / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"branching out"' => 1,
        '"spreading out [ [ mutafar ~ iE / ADJ ] ]"' => 1
      },
      'orig' => 'mutafar~iE',
      'prefix' => ''
    }
  ...
  'fiydirAl' => [
    {
      ...
      'glosses' => [
        [
          '"Federal [ [ fiydirAliy ~ / NOUN ] ]"'
        ],
        [
          '"Federal [ [ fiydirAliy ~ / ADJ ] ]"'
        ],
        [
          '"Federal [ [ fidirAliy ~ / NOUN ] ]"'
        ],
        [
          '"Federal [ [ fidirAliy ~ / ADJ ] ]"'
        ],
        [
          '"Federal [ [ fidiyrAliy ~ / NOUN ] ]"'
        ],
        [
          '"Federal [ [ fidiyrAliy ~ / ADJ ] ]"'
        ],
        [
          '"Federal [ [ fiydiyrAliy ~ / NOUN ] ]"'
        ],
        [
          '"Federal [ [ fiydiyrAliy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"Federal [ [ fidirAliy ~ / NOUN ] ]"' => 1,
        '"Federal [ [ fiydiyrAliy ~ / ADJ ] ]"' => 1,
        '"Federal [ [ fidiyrAliy ~ / ADJ ] ]"' => 1,
        '"Federal [ [ fiydirAliy ~ / NOUN ] ]"' => 1,
        '"Federal [ [ fidirAliy ~ / ADJ ] ]"' => 1,
        '"Federal [ [ fiydiyrAliy ~ / NOUN ] ]"' => 1,
        '"Federal [ [ fidiyrAliy ~ / NOUN ] ]"' => 1,
        '"Federal [ [ fiydirAliy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'fiydirAliy~',
      'prefix' => ''
    }
  ...
  'f t y' => [
    {
      'types' => $lexicon->{'f t \''}[1]{'types'},
      'entry' => 'muftiy',
      'form' => 'muftiy',
      'others' => $lexicon->{'f t \''}[1]{'others'},
      'lines' => $lexicon->{'f t \''}[1]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'MuFCiL',
      'suffix' => '',
      'glosses' => $lexicon->{'f t \''}[1]{'glosses'},
      'glosshash' => $lexicon->{'f t \''}[1]{'glosshash'},
      'orig' => 'mufotiy',
      'prefix' => ''
    }
  ],
  ...
  'f s d' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"corrupting [ [ mufosid / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"corrupt [ [ mufosid / ADJ ] ]"' => 1,
        '"corrupting [ [ mufosid / NOUN ] ]"' => 1
      },
      'orig' => 'mufosid',
      'prefix' => ''
    }
  ...
  'fuwlkluwr' => [
    {
      ...
      'glosses' => [
        [
          '"folkloric [ [ fuwlkluwriy ~ / ADJ ] ]"'
        ],
        [
          '"folkloric [ [ fulokluwriy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"folkloric [ [ fulokluwriy ~ / ADJ ] ]"' => 1,
        '"folkloric [ [ fuwlkluwriy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'fuwlkluwriy~',
      'prefix' => ''
    }
  ...
  'f \' q' => [
    {
      'types' => $lexicon->{'f w q'}[4]{'types'},
      'entry' => 'fA\'iq',
      'form' => 'fA\'iq',
      'lines' => $lexicon->{'f w q'}[4]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACiL',
      'suffix' => '',
      'glosses' => $lexicon->{'f w q'}[4]{'glosses'},
      'glosshash' => $lexicon->{'f w q'}[4]{'glosshash'},
      'orig' => 'fA}iq',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'f w q'}[5]{'types'},
      'entry' => 'fA\'iq',
      'form' => 'fA\'iq',
      'lines' => $lexicon->{'f w q'}[5]{'lines'},
      'index' => '2',
      'entity' => 'noun',
      'morphs' => 'FACiL',
      'suffix' => '',
      'glosses' => $lexicon->{'f w q'}[5]{'glosses'},
      'glosshash' => $lexicon->{'f w q'}[5]{'glosshash'},
      'orig' => 'fA}iq',
      'prefix' => ''
    }
  ],
  'fir`awn' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"Pharaonic [ [ firoEawoniy ~ / NOUN ] ]"'
        ],
        [
          '"Pharaonic [ [ firoEawoniy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"Pharaonic [ [ firoEawoniy ~ / NOUN ] ]"' => 1,
        '"Pharaonic [ [ firoEawoniy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'firoEawoniy~',
      'prefix' => ''
    }
  ...
  'f q r' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"vertebral [ [ faqoriy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"vertebral [ [ faqoriy ~ / ADJ ] ]"' => 1,
        '"spinal"' => 1
      },
      'orig' => 'faqoriy~',
      'prefix' => ''
  ...
  'f \' .d' => [
    {
      'types' => $lexicon->{'f y .d'}[4]{'types'},
      'entry' => 'fA\'i.d',
      'form' => 'fA\'i.d',
      'others' => $lexicon->{'f y .d'}[4]{'others'},
      'lines' => $lexicon->{'f y .d'}[4]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACiL',
      'suffix' => '',
      'glosses' => $lexicon->{'f y .d'}[4]{'glosses'},
      'glosshash' => $lexicon->{'f y .d'}[4]{'glosshash'},
      'orig' => 'fA}iD',
      'prefix' => ''
    }
  ],
  'f .t m' => [
    ...
    },
    {
      ...
      'glosshash' => {
        '"Fatimid [ [ fATimiy ~ / NOUN ] ]"' => 1,
        '"Fatimid [ [ fATimiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'fATimiy~',
      'prefix' => ''
    }
  ...
  'farans' => [
    {
      ...
      'glosses' => [
        [
          '"French [ [ faranosiy ~ / NOUN ] ]"'
        ],
        [
          '"French [ [ faranosiy ~ / ADJ ] ]"'
        ],
        [
          '"French"'
        ]
      ...
      'glosshash' => {
        '"French"' => 1,
        '"French [ [ faranosiy ~ / ADJ ] ]"' => 1,
        '"French [ [ faranosiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'faranosiy~',
      'prefix' => ''
    }
  ...
  'f w r' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"on the spot [ [ faworiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"on the spot [ [ faworiy ~ / ADJ ] ]"' => 1,
        '"instant"' => 1,
        '"immediate"' => 1
      },
      'orig' => 'faworiy~',
    ...
    {
      'types' => $lexicon->{'f \' r'}[0]{'types'},
      'entry' => 'fA\'ir',
      'form' => 'fA\'ir',
      'lines' => $lexicon->{'f \' r'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FA\'iL',
      'suffix' => '',
      'glosses' => $lexicon->{'f \' r'}[0]{'glosses'},
      'glosshash' => $lexicon->{'f \' r'}[0]{'glosshash'},
      'orig' => 'fA}ir',
      'prefix' => ''
    }
  ],
  ...
  'f y d' => [
    {
      'types' => $lexicon->{'f \' d'}[0]{'types'},
      'entry' => 'fA\'id',
      'form' => 'fA\'idaT',
      'others' => $lexicon->{'f \' d'}[0]{'others'},
      'lines' => $lexicon->{'f \' d'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FA\'iL',
      'suffix' => ' |< aT',
      'glosses' => $lexicon->{'f \' d'}[0]{'glosses'},
      'glosshash' => $lexicon->{'f \' d'}[0]{'glosshash'},
      'orig' => 'fA}idap',
      'prefix' => ''
    },
    {
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"beneficial [ [ mufiyd / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"beneficial [ [ mufiyd / ADJ ] ]"' => 1,
        '"useful"' => 1
      },
      'orig' => 'mufiyd',
      'prefix' => ''
  ...
  'f w t' => [
    ...
    {
      'types' => $lexicon->{'f \' t'}[0]{'types'},
      'entry' => 'fA\'it',
      'form' => 'fA\'it',
      'lines' => $lexicon->{'f \' t'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FA\'iL',
      'suffix' => '',
      'glosses' => $lexicon->{'f \' t'}[0]{'glosses'},
      'glosshash' => $lexicon->{'f \' t'}[0]{'glosshash'},
      'orig' => 'fA}it',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"contradictory [ [ mutafAwit / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"different"' => 1,
        '"contradictory [ [ mutafAwit / ADJ ] ]"' => 1
      },
      'orig' => 'mutafAwit',
      'prefix' => ''
    }
  ...
  'f l s f' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"philosophical [ [ falosafiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"philosophical [ [ falosafiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'falosafiy~',
      'prefix' => ''
    }
