...
lexicon = listing "Lexicon properties"
 ...
 |> ".gAbuwn" <| [
    ...
    noun     Identity |< Iy            {- gAbuwniy~ -}      `gloss`  [ "Gabon" ] ]
 ...
 |> ".gz" <| [
    ...
    noun     FAL |< Iy                 {- gAziy~ -}         `gloss`  [ "gaseous" ] ]
 ...
 |> ".gAzuwz" <| [
    ...
    noun     Identity |< aT            {- gAzuwzap -}       `others` [ ".gAzuwz Nap" ]
                                                            `gloss`  [ "soda water" ] ]
 ...
 |> ".gl" <| [
    ...
    noun     FAL |< Iy                 {- gAliy~ -}         `gloss`  [ "Gallic", "Gaul" ] ]
 ...
 |> ".gAliyr" <| [
    ...
    noun     Identity |< Iy            {- gAliyriy~ -}      `gloss`  [ "gallery" ] ]
 ...
 |> ".gAmb" <| [
    ...
    noun     Identity |< Iy            {- gAmobiy~ -}       `gloss`  [ "Gambian" ] ]
 ...
 |> ".gn" <| [
    ...
    noun     FAL |< aT                 {- gAnap -}          `others` [ ".gAn Nap", ".gAnA N0" ]
                                                            `gloss`  [ "Ghana" ],
 ...
 |> ".gbb" <| [
    ...
    verb     FaCL                      {- gab~-a -}         `imperf` [ FCaL ]
                                                            `others` [ ".gbab IV_C", ".gabb PV_V IV_V", ".gabab PV_C" ]
    ...
    verb     FaCL                      {- gab~-u -}         `imperf` [ FCuL ]
                                                            `others` [ ".gabb PV_V", ".gbub IV_C", ".gabab PV_C", ".gubb IV_V" ]
                                                            `gloss`  [ "quaff" ],
 ...
 |> "ma.gabb" <| [
    ...
    noun     Identity |< aT            {- magab~ap -}       `others` [ "ma.gabb NAt Napdu" ]
                                                            `gloss`  [ "consequence", "result", "outcome", "consequences", "results" ],

    -- ;; gub~ap_1
    -- gb      gub~    Nap     gulp

    noun     FuCL |< aT                {- gub~ap -}         `others` [ ".gubb Nap" ]
                                                            `gloss`  [ "gulp" ] ]
 ...
 |> ".gbr" <| [
    ...
    verb     HaFCaL                    {- >agobar -}        `others` [ ".gbir IV_yu", ".gbar IV_Pass_yu" ]
    ...
    noun     FuCL |< aT                {- guborap -}        `others` [ ".gubr Nap" ]
                                                            `gloss`  [ "dust color" ],

    -- ;; gabarap_1
    -- gbr     gabar   Nap     dust

    noun     FaCaL |< aT               {- gabarap -}        `others` [ ".gabar Nap" ]
                                                            `gloss`  [ "dust" ] ]
 ...
 |> ".gubAr" <| [
    ...
    noun     Identity                  {- gubAr -}          `others` [ "'a.gbir Nap" ]
                                                            `gloss`  [ "dust" ],
    ...
    noun     HaFCaL                    {- >agobar -}        `others` [ ".gabrA' Nh Nhy N0_Nh", ".gubr N" ]
                                                            `gloss`  [ "dust-colored" ],
    ...
    noun     HaFCaL                    {- >agobar -}        `others` [ ".gabrA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "earth", "Earth" ],
    ...
    noun     MuFaCCaL                  {- mugab~ar -}       `gloss`  [ "dusty" ],
 ...
 |> ".gbs" <| [
    ...
    noun     HaFCaL                    {- >agobas -}        `others` [ ".gabsA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "light-tan" ] ]
 ...
 |> ".gb^s" <| [
    ...
    noun     FaCiL                     {- gabi$ -}          `gloss`  [ "opaque", "dark" ],

    -- ;; gubo$ap_1
    -- gb$     gubo$   Nap     twilight

    noun     FuCL |< aT                {- gubo$ap -}        `others` [ ".gub^s Nap" ]
                                                            `gloss`  [ "twilight" ],
    ...
    noun     HaFCaL                    {- >agoba$ -}        `others` [ ".gub^s N", ".gab^sA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "dark", "opaque" ],

    -- ;; gabA$ap_1
    -- gbA$    gabA$   Nap     asthenopia

    noun     FaCAL |< aT               {- gabA$ap -}        `others` [ ".gabA^s Nap" ]
                                                            `gloss`  [ "asthenopia" ] ]
 ...
 |> ".gb.t" <| [
    ...
    verb     HaFCaL                    {- >agobaT -}        `others` [ ".gbi.t IV_yu", ".gba.t IV_Pass_yu" ]
    ...
    noun     FiCL |< aT                {- giboTap -}        `others` [ ".gib.t Nap" ]
    ...
    noun     MaFCUL                    {- magobuwT -}       `gloss`  [ "fortunate", "enviable" ],

    -- ;; mugotabiT_1
    -- mgtbT   mugotabiT       Nall    delighted;gratified     [[mugotabiT/ADJ]]

    noun     MuFtaCiL                  {- mugotabiT -}      `gloss`  [ "delighted", "gratified" ] ]
 ...
 |> ".gbn" <| [
    ...
    noun     MaFCUL                    {- magobuwn -}       `gloss`  [ "deceived", "defrauded" ] ]
 ...
 |> ".gby" <| [
    ...
    verb     FaCiL                     {- gabiy-a -}        `imperf` [ FCaL ]
                                                            `others` [ ".gabiy PV_no-w_intr", ".gba IV_0hwnyn", ".gab PV_w_intr", ".gbay IV_Ann", ".gbY IV_0" ]
                                                            `gloss`  [ "be ignorant" ] ]
 ...
 |> ".gbw" <| [
    ...
    noun     FaCL |< aT                {- gabowap -}        `others` [ ".gabw Nap" ]
                                                            `gloss`  [ "riddle", "enigma", "puzzle" ] ]
 ...
 |> ".gb" <| [
    ...
    noun     CaL |< Iy                 {- gabiy~ -}         `others` [ "'a.gbiyA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "ignorant", "stupid" ],
 ...
 |> ".gbw" <| [
    ...
    noun     FaCAL |< aT               {- gabAwap -}        `others` [ ".gabAw Nap" ]
                                                            `gloss`  [ "ignorance", "stupidity" ] ]
 ...
 |> ".gb" <| [
    ...
    noun     HaFCY                     {- >agobaY -}        `others` [ "'a.gbA Nhy", "'a.gbay NAn_Nayn" ]
                                                            `gloss`  [ "stupid" ] ]
 ...
 |> ".gby" <| [
    ...
    noun     TaFCiL |< aT              {- tagobiyap -}      `others` [ "ta.gbiy Nap" ]
                                                            `gloss`  [ "stupefaction" ] ]
 ...
 |> ".gtt" <| [
    ...
    verb     FaCL                      {- gat~-u -}         `imperf` [ FCuL ]
                                                            `others` [ ".gutt IV_V", ".gatat PV_Ct", ".gatt PV_V", ".gtut IV_C" ]
 ...
 |> ".g_t_t" <| [
    ...
    verb     FaCL                      {- gav~-i -}         `imperf` [ FCiL ]
                                                            `others` [ ".gi_t_t IV_V_intr", ".ga_ta_t PV_C_intr", ".g_ti_t IV_C_intr", ".ga_t_t PV_V_intr" ]
    ...
    noun     FaCIL                     {- gaviyv -}         `gloss`  [ "thin", "pus discharge" ],

    -- ;; gavAvap_1
    -- gvAv    gavAv   Nap     thinness

    noun     FaCAL |< aT               {- gavAvap -}        `others` [ ".ga_tA_t Nap" ]
                                                            `gloss`  [ "thinness" ],

    -- ;; guvuwvap_1
    -- gvwv    guvuwv  Nap     thinness

    noun     FuCUL |< aT               {- guvuwvap -}       `others` [ ".gu_tuw_t Nap" ]
                                                            `gloss`  [ "thinness" ] ]
 ...
 |> ".g_t" <| [
    ...
    verb     FaCY                      {- gavaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ ".g_tiy IV_0hAnn", ".ga_tY PV_0", ".g_t IV_0hwnyn", ".ga_tA PV_h", ".ga_tay PV_Atn", ".ga_t PV_ttAw_intr" ]
    ...
    verb     HaFCY                     {- >agovaY -}        `others` [ ".g_tiy IV_0hAnn_yu", "'a.g_tA PV_h", ".g_t IV_0hwnyn_yu", "'a.g_tay PV_Atn", ".g_tay IV_Ann_Pass_yu", ".g_tY IV_0_Pass_yu", "'a.g_t PV_ttAw" ]
 ...
 |> ".gdd" <| [
    ...
    noun     FuCL |< aT                {- gud~ap -}         `others` [ ".gudd Napdu", ".gudad N" ]
                                                            `gloss`  [ "gland", "glands" ] ]
 ...
 |> ".gudad" <| [
    ...
    noun     Identity |< Iy            {- gudadiy~ -}       `gloss`  [ "glandular" ],

    -- ;; gud~iy~_1
    -- gdy     gud~iy~ N-ap    glandular     [[gud~iy~/ADJ]]

    noun     FuCL |< Iy                {- gud~iy~ -}        `gloss`  [ "glandular" ] ]
 ...
 |> ".gdr" <| [
    ...
    noun     FaCL |< aN                {- gadorAF -}        `others` [ ".gadr NF" ]
                                                            `gloss`  [ "perfidiously", "treacherously" ],
 ...
 |> ".gdr" <| [
    ...
    noun     FaCIL |< aT               {- gadiyrap -}       `others` [ ".gadA'ir Ndip", ".gadiyr Nap" ]
                                                            `gloss`  [ "queue", "queues" ],
    ...
    noun     FaCCAL                    {- gad~Ar -}         `gloss`  [ "treacherous", "perfidious" ],

    -- ;; gad~Arap_1
    -- gdAr    gad~Ar  NapAt   revolver;pistol

    noun     FaCCAL |< aT              {- gad~Arap -}       `others` [ ".gaddAr NapAt" ]
                                                            `gloss`  [ "revolver", "pistol" ],

    -- ;; gAdir_1
    -- gAdr    gAdir   N-ap    perfidious;treacherous     [[gAdir/ADJ]]

    noun     FACiL                     {- gAdir -}          `gloss`  [ "perfidious", "treacherous" ],

    -- ;; mugAdarap_1
    -- mgAdr   mugAdar Napdu   departure
    -- mgAdr   mugAdar NAt     departures

    noun     MuFACaL |< aT             {- mugAdarap -}      `others` [ "mu.gAdar NAt Napdu" ]
 ...
 |> ".gdf" <| [
    ...
    noun     FuCL |< aT                {- gudofap -}        `others` [ ".gudf Nap", ".gudaf N" ]
 ...
 |> ".gudAf" <| [
    ...
    noun     Identity                  {- gudAf -}          `gloss`  [ "raven" ] ]
 ...
 |> "i.gdawdan" <| [
    ...
    noun     FuCL |< aT                {- gudonap -}        `others` [ ".gudn Nap" ]
                                                            `gloss`  [ "lassitude" ],
 ...
 |> ".gd" <| [
    ...
    verb     FaCA                      {- gadA-u -}         `imperf` [ FCuL ]
                                                            `others` [ ".gduw IV_0hAnn", ".gd IV_0hwnyn", ".gad PV_ttAw", ".gadA PV_0", ".gadaw PV_Atn" ]
 ...
 |> ".gdy" <| [
    ...
    verb     FaCiL                     {- gadiy-a -}        `imperf` [ FCaL ]
                                                            `others` [ ".gda IV_0hwnyn", ".gday IV_Ann", ".gadiy PV_no-w", ".gad PV_w", ".gdY IV_0" ]
 ...
 |> ".gd" <| [
    ...
    noun     CaL |< aN                 {- gadAF -}          `gloss`  [ "tomorrow" ],
 ...
 |> ".gdw" <| [
    ...
    noun     FuCL |< aT                {- gudowap -}        `others` [ ".gudw Nap" ]
                                                            `gloss`  [ "morning" ],

    -- ;; gadowap_1
    -- gdw     gadow   Nap     lunch

    noun     FaCL |< aT                {- gadowap -}        `others` [ ".gadw Nap" ]
                                                            `gloss`  [ "lunch" ] ]
 ...
 |> ".gd" <| [
    ...
    noun     CaL |< Iy |< aT           {- gadiy~ap -}       `others` [ ".gadiyy Nap", ".gadAyA N0_Nhy" ]
                                                            `gloss`  [ "morning", "mornings" ] ]
 ...
 |> "ma.gdY" <| [
    ...
    noun     Identity                  {- magodaY -}        `others` [ "ma.gdA Nhy", "ma.gday NAn_Nayn" ]
 ...
 |> ".g_d_d" <| [
    ...
    verb     FaCL                      {- ga*~-i -}         `imperf` [ FCiL ]
                                                            `others` [ ".ga_d_d PV_V", ".g_di_d IV_C", ".gi_d_d IV_V", ".ga_da_d PV_C" ]
    ...
    verb     HaFaCL                    {- >aga*~ -}         `others` [ ".g_di_d IV_C_yu", ".gi_d_d IV_V_yu", "'a.g_da_d PV_C" ]
    ...
    noun     HiFCAL                    {- <igo*A* -}        `gloss`  [ "hurrying", "festering" ] ]
 ...
 |> ".g_d'" <| [
    ...
    noun     FiCAL |< Iy               {- gi*A}iy~ -}       `gloss`  [ "food", "alimentary", "nutritional" ] ]
 ...
 |> ".g_dy" <| [
    ...
    noun     TaFCiL |< aT              {- tago*iyap -}      `others` [ "ta.g_diy NapAt" ]
 ...
 |> ".grr" <| [
    ...
    noun     HaFCAL                    {- >agorAr -}        `gloss`  [ "inexperience" ],

    -- ;; gur~ap_1
    -- gr      gur~    Nap     beginning

    noun     FuCL |< aT                {- gur~ap -}         `others` [ ".gurr Nap" ]
                                                            `gloss`  [ "beginning" ],

    -- ;; gir~ap_1
    -- gr      gir~    Nap     inadvertency;inattention

    noun     FiCL |< aT                {- gir~ap -}         `others` [ ".girr Nap" ]
                                                            `gloss`  [ "inadvertency", "inattention" ],
    ...
    noun     FaCCAL                    {- gar~Ar -}         `gloss`  [ "deceptive" ],

    -- ;; garArap_1
    -- grAr    garAr   Nap     heedlessness;manner

    noun     FaCAL |< aT               {- garArap -}        `others` [ ".garAr Nap" ]
                                                            `gloss`  [ "heedlessness", "manner" ],

    -- ;; girArap_1
    -- grAr    girAr   Napdu   sack;bag
    -- grA}r   garA}ir Ndip    sacks;bags

    noun     FiCAL |< aT               {- girArap -}        `others` [ ".girAr Napdu", ".garA'ir Ndip" ]
    ...
    noun     HaFaCL                    {- >agar~ -}         `others` [ ".garrA' Nh Nhy N0_Nh", ".gurr N" ]
                                                            `gloss`  [ "esteemed" ],

    -- ;; tagoriyriy~_1
    -- tgryry  tagoriyriy~     N-ap    insidious;deceptive     [[tagoriyriy~/ADJ]]

    noun     TaFCIL |< Iy              {- tagoriyriy~ -}    `gloss`  [ "insidious", "deceptive" ],

    -- ;; magoruwr_1
    -- mgrwr   magoruwr        Nall    deceived;deluded;conceited     [[magoruwr/ADJ]]

    noun     MaFCUL                    {- magoruwr -}       `gloss`  [ "deceived", "deluded", "conceited" ],

    -- ;; mugar~ir_1
    -- mgrr    mugar~ir        Nall    deceptive;insidious     [[mugar~ir/ADJ]]

    noun     MuFaCCiL                  {- mugar~ir -}       `gloss`  [ "deceptive", "insidious" ],

    -- ;; mugotar~_1
    -- mgtr    mugotar~        Nall    conceited;vain     [[mugotar~/ADJ]]

    noun     MuFtaCL                   {- mugotar~ -}       `gloss`  [ "conceited", "vain" ] ]
 ...
 |> ".grb" <| [
    ...
    verb     HaFCaL                    {- >agorab -}        `others` [ ".grab IV_Pass_yu", ".grib IV_yu" ]
    ...
    noun     FaCL |< aN                {- garobAF -}        `others` [ ".garb NF" ]
                                                            `gloss`  [ "westward", "in the West" ],

    -- ;; garobiy~_1
    -- grby    garobiy~        Nall    west;western;westerner     [[garobiy~/ADJ]]

    noun     FaCL |< Iy                {- garobiy~ -}       `gloss`  [ "west", "western", "westerner" ],

    -- ;; gurobap_1
    -- grb     gurob   Nap     exile

    noun     FuCL |< aT                {- gurobap -}        `others` [ ".gurb Nap" ]
                                                            `gloss`  [ "exile" ] ]
 ...
 |> ".gurAb" <| [
    ...
    noun     Identity                  {- gurAb -}          `others` [ "'a.grib Nap", "'a.grub N", ".girbAn N" ]
                                                            `gloss`  [ "crow", "crows" ],
    ...
    noun     FaCIL |< aT               {- gariybap -}       `others` [ ".garA'ib Ndip", ".gariyb Napdu" ]
    ...
    noun     FuCUL |< Iy               {- guruwbiy~ -}      `gloss`  [ "from sundown" ],

    -- ;; garAbap_1
    -- grAb    garAb   Nap     strangeness;oddness

    noun     FaCAL |< aT               {- garAbap -}        `others` [ ".garAb Nap" ]
    ...
    noun     HaFCaL                    {- >agorab -}        `gloss`  [ "stranger / strangest" ],
 ...
 |> "ma.gArib" <| [
    ...
    noun     MaFCiL |< Iy              {- magoribiy~ -}     `others` [ "ma.gArib Nap" ]
                                                            `gloss`  [ "of / from the Maghrib ( northwest Africa )" ],
    ...
    noun     IFtiCAL |< Iy             {- {igotirAbiy~ -}   `gloss`  [ "migratory", "emigration" ],
    ...
    noun     MuFaCCaL                  {- mugar~ab -}       `gloss`  [ "exiled" ],

    -- ;; mugotarib_1
    -- mgtrb   mugotarib       Nall    expatriate;foreigner
    -- mgtrb   mugotarib       Nall    exiled     [[mugotarib/ADJ]]

    noun     MuFtaCiL                  {- mugotarib -}      `gloss`  [ "expatriate", "foreigner", "exiled" ],
    ...
    noun     MustaFCaL                 {- musotagorab -}    `gloss`  [ "strange", "odd" ] ]
 ...
 |> "'u.gruwd" <| [
    ...
    noun     Identity                  {- >ugoruwd -}       `others` [ "'a.gAriyd Ndip" ]
    ...
    noun     MuFaCCiL                  {- mugar~id -}       `gloss`  [ "singing", "warbling" ] ]
 ...
 |> ".grz" <| [
    ...
    verb     HaFCaL                    {- >agoraz -}        `others` [ ".graz IV_Pass_yu", ".griz IV_yu" ]
 ...
 |> ".grs" <| [
    ...
    verb     HaFCaL                    {- >agoras -}        `others` [ ".gras IV_Pass_yu", ".gris IV_yu" ]
    ...
    noun     FaCL |< aT                {- garosap -}        `others` [ ".gars Napdu", ".garas NAt" ]
                                                            `gloss`  [ "plant", "plants" ],
    ...
    noun     FiCAL |< aT               {- girAsap -}        `others` [ ".girAs Nap" ]
                                                            `gloss`  [ "cultivation" ],
    ...
    noun     FaCIL |< aT               {- gariysap -}       `others` [ ".gariys Nap", ".garA'is Ndip" ]
    ...
    noun     MuFACaL |< aT             {- mugArasap -}      `others` [ "mu.gAras NapAt" ]
                                                            `gloss`  [ "farm leasing" ],

    -- ;; mugArisiy~_1
    -- mgArsy  mugArisiy~      Nall    farm lessee     [[mugArisiy~/ADJ]]

    noun     MuFACiL |< Iy             {- mugArisiy~ -}     `gloss`  [ "farm lessee" ] ]
 ...
 |> ".gr.d" <| [
    ...
    verb     HaFCaL                    {- >agoraD -}        `others` [ ".gra.d IV_Pass_yu", ".gri.d IV_yu" ]
    ...
    noun     HaFCAL                    {- >agorAD -}        `gloss`  [ "articles", "items" ],

    -- ;; garaDiy~_1
    -- grDy    garaDiy~        N-ap    tendency;purposeful     [[garaDiy~/ADJ]]

    noun     FaCaL |< Iy               {- garaDiy~ -}       `gloss`  [ "tendency", "purposeful" ],
    ...
    noun     MuFCiL                    {- mugoriD -}        `gloss`  [ "biased", "tendentious" ],

    -- ;; mutagar~iD_1
    -- mtgrD   mutagar~iD      Nall    biased;tendentious     [[mutagar~iD/ADJ]]

    noun     MutaFaCCiL                {- mutagar~iD -}     `gloss`  [ "biased", "tendentious" ] ]
 ...
 |> ".gir.gir" <| [
    ...
    noun     Identity                  {- girogir -}        `others` [ ".garA.gir Ndip" ]
                                                            `gloss`  [ "guinea-fowl" ] ]
 ...
 |> ".grf" <| [
    ...
    noun     FuCL |< aT                {- gurofap -}        `others` [ ".guraf N", ".gurf Napdu" ]
    ...
    noun     FaCCAL |< aT              {- gar~Afap -}       `others` [ ".garrAf NapAt" ]
                                                            `gloss`  [ "decanter", "carafe" ],

    -- ;; migorafap_1
    -- mgrf    migoraf Napdu   ladle;dipper
    -- mgArf   magArif Ndip    ladles;dippers

    noun     MiFCaL |< aT              {- migorafap -}      `others` [ "mi.graf Napdu", "ma.gArif Ndip" ]
 ...
 |> ".grq" <| [
    ...
    verb     HaFCaL                    {- >agoraq -}        `others` [ ".griq IV_yu", ".graq IV_Pass_yu" ]
 ...
 |> "mu.grawriq" <| [
    ...
    noun     Identity                  {- mugoraworiq -}    `gloss`  [ "drowning" ] ]
 ...
 |> ".grl" <| [
    ...
    noun     FuCL |< aT                {- gurolap -}        `others` [ ".gurl Nap", ".gural N" ]
 ...
 |> ".grm" <| [
    ...
    verb     FaCiL                     {- garim-a -}        `imperf` [ FCaL ]
                                                            `others` [ ".gram IV_intr", ".garim PV_intr" ]
                                                            `gloss`  [ "be obligated" ],
    ...
    verb     HaFCaL                    {- >agoram -}        `others` [ ".grim IV_yu", ".gram IV_Pass_yu" ]
    ...
    noun     HaFCaL                    {- >agoram -}        `others` [ "'u.grim PV_Pass" ]
    ...
    noun     MuFCaL                    {- mugoram -}        `gloss`  [ "infatuated", "enamored" ],

    -- ;; mugoram_2
    -- mgrm    mugoram Nall    obliged;constrained     [[mugoram/ADJ]]

    noun     MuFCaL                    {- mugoram -}        `gloss`  [ "obliged", "constrained" ] ]
 ...
 |> ".grn" <| [
    ...
    noun     FaCIL |< Iy               {- gariyniy~ -}      `gloss`  [ "silt", "alluvial" ] ]
 ...
 |> ".gr" <| [
    ...
    verb     HaFCY                     {- >agoraY -}        `others` [ ".gray IV_Ann_Pass_yu", ".grY IV_0_Pass_yu", "'a.grA PV_h", ".gr IV_0hwnyn_yu", ".griy IV_0hAnn_yu", "'a.gr PV_ttAw", "'a.gray PV_Atn" ]
    ...
    noun     HaFCY                     {- >agoraY -}        `others` [ ".gray IV_Ann", "'u.griy PV_intr", ".grY IV_0_Pass_yu", ".gr IV_0hwnyn" ]
                                                            `gloss`  [ "be seduced" ] ]
 ...
 |> ".gry" <| [
    ...
    noun     FaCCAL |< aT              {- gar~Ayap -}       `others` [ ".garrAy NapAt" ]
                                                            `gloss`  [ "glue pot" ] ]
 ...
 |> ".gr" <| [
    ...
    noun     FiCA' |< Iy               {- girA}iy~ -}       `gloss`  [ "gluey", "sticky" ],

    -- ;; girA}iy~_2
    -- grA}y   girA}iy~        N-ap    viscous;colloidal     [[girA}iy~/ADJ]]

    noun     FiCA' |< Iy               {- girA}iy~ -}       `gloss`  [ "viscous", "colloidal" ] ]
 ...
 |> ".grw" <| [
    ...
    noun     FiCaL |< Iy               {- girawiy~ -}       `gloss`  [ "gluey", "sticky" ],

    -- ;; girawiy~_2
    -- grwy    girawiy~        N-ap    viscous;colloidal     [[girawiy~/ADJ]]

    noun     FiCaL |< Iy               {- girawiy~ -}       `gloss`  [ "viscous", "colloidal" ],

    -- ;; girawiy~At_1
    -- grwy    girawiy~        NAt     colloids     [[girawiy~/NOUN]]

    noun     FiCaL |< Iy |< At         {- girawiy~At -}     `others` [ ".girawiyy NAt" ]
                                                            `gloss`  [ "colloids" ] ]
 ...
 |> "mi.grAT" <| [
    ...
    noun     Identity                  {- migorAp -}        `others` [ "mi.grA Nap" ]
                                                            `gloss`  [ "glue pot" ] ]
 ...
 |> ".gry" <| [
    ...
    noun     TaFCiL |< aT              {- tagoriyap -}      `others` [ "ta.griy Nap" ]
                                                            `gloss`  [ "gluing", "agglutination" ] ]
 ...
 |> ".gr" <| [
    ...
    noun     HiFCA'                    {- <igorA' -}        `gloss`  [ "incitement", "instigation" ] ]
 ...
 |> ".gry" <| [
    ...
    noun     MuFCiL                    {- mugoriy -}        `others` [ "mu.gr Nuwn_Niyn NK" ]
                                                            `gloss`  [ "inciting", "instigating", "alluring" ],
 ...
 |> ".grw" <| [
    ...
    noun     MaFCUL                    {- magoruw~ -}       `gloss`  [ "glued" ] ]
 ...
 |> "ma.gr" <| [
    ...
    noun     Identity |< Iy            {- magoriy~ -}       `gloss`  [ "glued" ] ]
 ...
 |> ".gzz" <| [
    ...
    verb     HaFaCL                    {- >agaz~ -}         `others` [ ".gziz IV_C_intr_yu", ".gizz IV_V_intr_yu", "'a.gzaz PV_C_intr" ]
                                                            `gloss`  [ "be thorny" ],

    -- ;; gaz~iy~_1
    -- gzy     gaz~iy~ N-ap    gauze     [[gaz~iy~/ADJ]]

    noun     FaCL |< Iy                {- gaz~iy~ -}        `gloss`  [ "gauze" ],

    -- ;; gaz~ap_1
    -- gz      gaz~    Nap     Gaza

    noun     FaCL |< aT                {- gaz~ap -}         `others` [ ".gazz Nap" ]
                                                            `gloss`  [ "Gaza" ] ]
 ...
 |> ".gzw" <| [
    ...
    noun     FaCCAL |< Iy              {- gaz~Awiy~ -}      `gloss`  [ "Gazan ( of / from Gaza )" ] ]
 ...
 |> ".gzr" <| [
    ...
    verb     FaCuL                     {- gazur-u -}        `imperf` [ FCuL ]
                                                            `others` [ ".gazur PV_intr", ".gzur IV_intr" ]
                                                            `gloss`  [ "be abundant" ],
    ...
    noun     FaCAL |< aT               {- gazArap -}        `others` [ ".gazAr Nap" ]
                                                            `gloss`  [ "abundance", "lavish amount" ],

    -- ;; >agozar_1
    -- >gzr    >agozar Nel     more/most abundant
    -- Agzr    >agozar Nel     more/most abundant

    noun     HaFCaL                    {- >agozar -}        `gloss`  [ "more / most abundant" ],

    -- ;; gazAriy~_1
    -- gzAry   gazAriy~        N-ap    pigeon     [[gazAriy~/ADJ]]

    noun     FaCAL |< Iy               {- gazAriy~ -}       `gloss`  [ "pigeon" ] ]
 ...
 |> ".gzl" <| [
    ...
    noun     FaCaL |< Iy               {- gazaliy~ -}       `gloss`  [ "amorous" ],
    ...
    noun     FaCCAL |< aT              {- gaz~Alap -}       `others` [ ".gazzAl Nap" ]
                                                            `gloss`  [ "spider" ],
    ...
    noun     MuFACaL |< aT             {- mugAzalap -}      `others` [ "mu.gAzal NapAt" ]
                                                            `gloss`  [ "flirting", "dallying" ],
 ...
 |> ".gz" <| [
    ...
    verb     FaCA                      {- gazA-u -}         `imperf` [ FCuL ]
                                                            `others` [ ".gzuw IV_0hAnn", ".gazA PV_0h", ".gzay IV_Ann_Pass_yu", ".gzY IV_0_Pass_yu", ".gaz PV_ttAw", ".gz IV_0hwnyn", ".gazaw PV_Atn" ]
 ...
 |> ".gazAT" <| [
    ...
    noun     Identity                  {- gazAp -}          `others` [ ".gazA Nap" ]
                                                            `gloss`  [ "foray", "incursion" ] ]
 ...
 |> "ma.gzY" <| [
    ...
    noun     Identity                  {- magozaY -}        `others` [ "ma.gzA Nhy", "ma.gzay NAn_Nayn", "ma.gAz NK", "ma.gAziy N0_Nh" ]
 ...
 |> "ma.gzAT" <| [
    ...
    noun     Identity                  {- magozAp -}        `others` [ "ma.gzA Nap", "ma.gAz NK", "ma.gAziy N0_Nh" ]
 ...
 |> ".gzy" <| [
    ...
    noun     FACiL                     {- gAziy -}          `others` [ ".gAz Nuwn_Niyn NK", ".guzA Nap" ]
                                                            `gloss`  [ "invader", "raider", "aggressor", "invaders", "raiders", "aggressors" ],
 ...
 |> ".gsq" <| [
    ...
    noun     FaCaL |< Iy               {- gasaqiy~ -}       `gloss`  [ "dusk", "twilight" ] ]
 ...
 |> ".gsl" <| [
    ...
    noun     FaCL |< aT                {- gasolap -}        `others` [ ".gasal NAt", ".gasl Napdu" ]
 ...
 |> ".gAsuwl" <| [
    ...
    noun     Identity                  {- gAsuwl -}         `gloss`  [ "soap", "lye" ],
    ...
    noun     FaCCAL |< aT              {- gas~Alap -}       `others` [ ".gassAl NAt Napdu" ]
 ...
 |> ".gusAl" <| [
    ...
    noun     Identity |< aT            {- gusAlap -}        `others` [ ".gusAl Nap" ]
                                                            `gloss`  [ "wash water" ],
    ...
    noun     MiFCaL |< aT              {- migosalap -}      `others` [ "mi.gsal Napdu" ]
                                                            `gloss`  [ "washing machine" ],

    -- ;; magosalap_1
    -- mgsl    magosal Nap     wash-stand

    noun     MaFCaL |< aT              {- magosalap -}      `others` [ "ma.gsal Nap" ]
                                                            `gloss`  [ "wash-stand" ],
    ...
    noun     MaFCUL                    {- magosuwl -}       `gloss`  [ "washed" ] ]
 ...
 |> ".gsn" <| [
    ...
    noun     FaCCAL |< Iy              {- gas~Aniy~ -}      `gloss`  [ "Ghassanid" ],
 ...
 |> ".g^s^s" <| [
    ...
    verb     FaCL                      {- ga$~-u -}         `imperf` [ FCuL ]
                                                            `others` [ ".ga^s^s PV_V", ".ga^sa^s PV_C", ".g^su^s IV_C", ".gu^s^s IV_V" ]
    ...
    noun     FaCCAL                    {- ga$~A$ -}         `gloss`  [ "swindler", "deceptive" ],

    -- ;; mago$uw$_1
    -- mg$w$   mago$uw$        Nall    cheated;adulterated;falsified     [[mago$uw$/ADJ]]

    noun     MaFCUL                    {- mago$uw$ -}       `gloss`  [ "cheated", "adulterated", "falsified" ] ]
 ...
 |> ".gA^s^s" <| [
    ...
    noun     Identity                  {- gA$~ -}           `others` [ ".ga^sa^s Nap" ]
 ...
 |> ".g^sm" <| [
    ...
    noun     FaCIL                     {- ga$iym -}         `others` [ ".gu^samA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "inexperienced", "unskilled", "naive", "clumsy" ],

    -- ;; gu$uwmap_1
    -- g$wm    gu$uwm  Nap     inexperience;foolishness

    noun     FuCUL |< aT               {- gu$uwmap -}       `others` [ ".gu^suwm Nap" ]
                                                            `gloss`  [ "inexperience", "foolishness" ],

    -- ;; gA$im_1
    -- gA$m    gA$im   Nall    tyrannical;iniquitous;oppressor     [[gA$im/ADJ]]

    noun     FACiL                     {- gA$im -}          `gloss`  [ "tyrannical", "iniquitous", "oppressor" ] ]
 ...
 |> ".g^s" <| [
    ...
    verb     FaCA                      {- ga$A-u -}         `imperf` [ FCuL ]
                                                            `others` [ ".g^sY IV_0_Pass_yu", ".g^s IV_0hwnyn", ".ga^saw PV_Atn", ".ga^s PV_ttAw", ".ga^sA PV_0h", ".g^say IV_Ann_Pass_yu", ".g^suw IV_0hAnn" ]
                                                            `gloss`  [ "come to" ] ]
 ...
 |> ".g^sy" <| [
    ...
    verb     FaCiL                     {- ga$iy-a -}        `imperf` [ FCaL ]
                                                            `others` [ ".g^sY IV_0 IV_Pass_yu", ".g^sa IV_0hwnyn", ".ga^s PV_w", ".ga^siy PV_no-w", ".g^sA IV_h", ".gu^siy PV_Pass-a", ".g^say IV_Ann" ]
 ...
 |> ".g^sw" <| [
    ...
    noun     FaCL |< aT                {- ga$owap -}        `others` [ ".ga^sw Nap" ]
                                                            `gloss`  [ "veil", "covering" ],

    -- ;; gi$Awap_1
    -- g$Aw    gi$Aw   Nap     covering;veil;wrap

    noun     FiCAL |< aT               {- gi$Awap -}        `others` [ ".gi^sAw Nap" ]
                                                            `gloss`  [ "covering", "veil", "wrap" ] ]
 ...
 |> ".g^s'" <| [
    ...
    noun     FiCAL |< Iy               {- gi$A}iy~ -}       `gloss`  [ "membranous", "tegumentary" ] ]
 ...
 |> "ma.g^sY" <| [
    ...
    noun     Identity                  {- mago$aY -}        `others` [ "ma.g^say NAn_Nayn", "ma.g^sA Nhy" ]
                                                            `gloss`  [ "destination", "destinations" ],

    -- ;; gA$iyap_1
    -- gA$y    gA$iy   Nap     pericardium

    noun     FACiL |< aT               {- gA$iyap -}        `others` [ ".gA^siy Nap" ]
                                                            `gloss`  [ "pericardium" ],
    ...
    noun     FACiL |< aT               {- gA$iyap -}        `others` [ ".gawA^siy N0_Nh", ".gA^siy Nap", ".gawA^s NK" ]
 ...
 |> "ma.g^s" <| [
    ...
    noun     Identity |< Iy            {- mago$iy~ -}       `gloss`  [ "unconscious", "knocked-out" ],

    -- ;; tago$iyap_1
    -- tg$y    tago$iy Nap     dimming;clouding;dulling

    noun     TaFCiL |< aT              {- tago$iyap -}      `others` [ "ta.g^siy Nap" ]
                                                            `gloss`  [ "dimming", "clouding", "dulling" ] ]
 ...
 |> ".g.s.s" <| [
    ...
    verb     HaFaCL                    {- >agaS~ -}         `others` [ ".ga.s.s IV_V_Pass_yu", ".g.si.s IV_C_yu", "'a.g.sa.s PV_C", ".gi.s.s IV_V_yu" ]
    ...
    noun     FuCL |< aT                {- guS~ap -}         `others` [ ".gu.sa.s N", ".gu.s.s NapAt" ]
 ...
 |> ".gA.s.s" <| [
    ...
    noun     Identity                  {- gAS~ -}           `gloss`  [ "crowded", "congested" ] ]
 ...
 |> ".g.sb" <| [
    ...
    noun     FaCL                      {- gaSob -}          `gloss`  [ "extortion", "coercion", "usurpation", "forcibly", "by force" ],
    ...
    noun     MaFCUL                    {- magoSuwb -}       `gloss`  [ "extorted", "usurped", "coerced" ],
    ...
    noun     MuFtaCaL                  {- mugotaSab -}      `gloss`  [ "usurped", "raped" ] ]
 ...
 |> ".g.sn" <| [
    ...
    verb     HaFCaL                    {- >agoSan -}        `others` [ ".g.san IV-n_Pass_yu", ".g.sin IV-n_yu" ]
    ...
    noun     FuCL |< aT                {- guSonap -}        `others` [ ".gu.sn NapAt" ]
                                                            `gloss`  [ "twig", "sprout" ],
 ...
 |> ".g.d.d" <| [
    ...
    verb     FaCL                      {- gaD~-u -}         `imperf` [ FCuL ]
                                                            `others` [ ".g.du.d IV_C", ".ga.da.d PV_C", ".ga.d.d PV_V", ".gu.d.d IV_V" ]
    ...
    noun     FuCL |< aT                {- guD~ap -}         `others` [ ".gu.d.d Nap" ]
                                                            `gloss`  [ "fault", "deficiency" ],

    -- ;; gaDiyD_1
    -- gDyD    gaDiyD  N-ap    fresh;tender     [[gaDiyD/ADJ]]

    noun     FaCIL                     {- gaDiyD -}         `gloss`  [ "fresh", "tender" ],
    ...
    noun     FaCIL                     {- gaDiyD -}         `others` [ "'a.gi.d.dA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "diminished", "shamed" ],

    -- ;; gaDADap_1
    -- gDAD    gaDAD   Nap     freshness;tenderness

    noun     FaCAL |< aT               {- gaDADap -}        `others` [ ".ga.dA.d Nap" ]
    ...
    noun     FaCAL |< aT               {- gaDADap -}        `others` [ ".ga.dA.d Nap", ".ga.dA'i.d Ndip" ]
                                                            `gloss`  [ "deficiency", "fault", "diminutions", "shame" ],

    -- ;; guDuwDap_1
    -- gDwD    guDuwD  Nap     freshness;succulence

    noun     FuCUL |< aT               {- guDuwDap -}       `others` [ ".gu.duw.d Nap" ]
                                                            `gloss`  [ "freshness", "succulence" ] ]
 ...
 |> ".gA.d.d" <| [
    ...
    noun     Identity                  {- gAD~ -}           `gloss`  [ "lowering" ] ]
 ...
 |> ".g.db" <| [
    ...
    verb     FaCiL                     {- gaDib-a -}        `imperf` [ FCaL ]
                                                            `others` [ ".g.dab IV_intr", ".ga.dib PV_intr" ]
                                                            `gloss`  [ "become angry" ],
    ...
    verb     HaFCaL                    {- >agoDab -}        `others` [ ".g.dib IV_yu", ".g.dab IV_Pass_yu" ]
    ...
    noun     FaCaL                     {- gaDab -}          `gloss`  [ "anger", "wrath", "in anger", "angrily" ],

    -- ;; gaDib_1
    -- gDb     gaDib   N-ap    irate;furious     [[gaDib/ADJ]]

    noun     FaCiL                     {- gaDib -}          `gloss`  [ "irate", "furious" ],

    -- ;; gaDobap_1
    -- gDb     gaDob   Nap     anger;wrath

    noun     FaCL |< aT                {- gaDobap -}        `others` [ ".ga.db Nap" ]
                                                            `gloss`  [ "anger", "wrath" ],

    -- ;; gaDuwb_1
    -- gDwb    gaDuwb  N-ap    irascible;choleric     [[gaDuwb/ADJ]]

    noun     FaCUL                     {- gaDuwb -}         `gloss`  [ "irascible", "choleric" ],

    -- ;; gaDuwbiy~_1
    -- gDwby   gaDuwbiy~       N-ap    irascible;choleric     [[gaDuwbiy~/ADJ]]

    noun     FaCUL |< Iy               {- gaDuwbiy~ -}      `gloss`  [ "irascible", "choleric" ],
 ...
 |> ".g.dr" <| [
    ...
    verb     FaCiL                     {- gaDir-a -}        `imperf` [ FCaL ]
                                                            `others` [ ".ga.dir PV_intr", ".g.dar IV_intr" ]
                                                            `gloss`  [ "become abundant", "be lavish" ],

    -- ;; gaDir_1
    -- gDr     gaDir   N-ap    abundant;lavish;fresh     [[gaDir/ADJ]]

    noun     FaCiL                     {- gaDir -}          `gloss`  [ "abundant", "lavish", "fresh" ],

    -- ;; gaDiyr_1
    -- gDyr    gaDiyr  N-ap    abundant;fresh;green     [[gaDiyr/ADJ]]

    noun     FaCIL                     {- gaDiyr -}         `gloss`  [ "abundant", "fresh", "green" ],

    -- ;; gaDArap_1
    -- gDAr    gaDAr   Nap     affluence;prosperity

    noun     FaCAL |< aT               {- gaDArap -}        `others` [ ".ga.dAr Nap" ]
                                                            `gloss`  [ "affluence", "prosperity" ] ]
 ...
 |> ".g.dn" <| [
    ...
    noun     MutaFaCCiL                {- mutagaD~in -}     `gloss`  [ "wrinkled", "frowning" ] ]
 ...
 |> ".ga.danfar" <| [
    ...
    noun     Identity |< Iy            {- gaDanofariy~ -}   `gloss`  [ "lion-like", "powerful" ] ]
 ...
 |> ".g.d" <| [
    ...
    verb     HaFCY                     {- >agoDaY -}        `others` [ ".g.day IV_Ann_Pass_yu", ".g.dY IV_0_Pass_yu", "'a.g.d PV_ttAw", "'a.g.dA PV_h", ".g.d IV_0hwnyn_yu", ".g.diy IV_0hAnn_yu", "'a.g.day PV_Atn" ]
    ...
    noun     CaL |< aN                 {- gaDAF -}          `others` [ ".ga.dA Nhy" ]
                                                            `gloss`  [ "hot spot", "predicament", "unbearable situation" ],
    ...
    noun     HiFCA'                    {- <igoDA' -}        `gloss`  [ "disregarding", "ignoring", "overlooking" ] ]
 ...
 |> "ta.gA.diy" <| [
    ...
    noun     Identity                  {- tagADiy -}        `others` [ "ta.gA.d NK" ]
 ...
 |> ".g.t.t" <| [
    ...
    verb     FaCL                      {- gaT~-u -}         `imperf` [ FCuL ]
                                                            `others` [ ".g.tu.t IV_C", ".ga.ta.t PV_C", ".gu.t.t IV_V", ".ga.t.t PV_V" ]
    ...
    verb     HaFaCL                    {- >agaT~ -}         `others` [ ".g.ti.t IV_C_yu", ".gi.t.t IV_V_yu", "'a.g.ta.t PV_C", ".ga.t.t IV_V_Pass_yu" ]
                                                            `gloss`  [ "immerse", "dip", "plunge" ],
 ...
 |> ".g.tr" <| [
    ...
    noun     FuCL |< aT                {- guTorap -}        `others` [ ".gu.tr Napdu" ]
                                                            `gloss`  [ "headcloth" ] ]
 ...
 |> ".g.ts" <| [
    ...
    noun     FaCLAn                    {- gaTosAn -}        `gloss`  [ "immersed", "submerged" ],
 ...
 |> ".g.t^s" <| [
    ...
    verb     FaCaL                     {- gaTa$-i -}        `imperf` [ FCiL ]
                                                            `others` [ ".ga.ta^s PV_intr", ".g.ti^s IV_intr" ]
                                                            `gloss`  [ "become dark" ],
    ...
    verb     FaCiL                     {- gaTi$-a -}        `imperf` [ FCaL ]
                                                            `others` [ ".g.ta^s IV_intr", ".ga.ti^s PV_intr" ]
                                                            `gloss`  [ "become dim" ],
 ...
 |> ".g.t" <| [
    ...
    noun     FiCA' |< Iy               {- giTA}iy~ -}       `gloss`  [ "covering", "wrapping" ] ]
 ...
 |> ".g.ty" <| [
    ...
    noun     TaFCiL |< aT              {- tagoTiyap -}      `others` [ "ta.g.tiy NapAt" ]
 ...
 |> ".gfr" <| [
    ...
    noun     FaCUL                     {- gafuwr -}         `gloss`  [ "forgiving" ],
    ...
    noun     FaCCAL                    {- gaf~Ar -}         `gloss`  [ "forgiving" ],
    ...
    noun     MaFCiL |< aT              {- magofirap -}      `others` [ "ma.gfir Nap" ]
                                                            `gloss`  [ "pardon", "forgiveness" ],

    -- ;; magofuwr_1
    -- mgfwr   magofuwr        N       deceased;late     [[magofuwr/ADJ]]

    noun     MaFCUL                    {- magofuwr -}       `gloss`  [ "deceased", "late" ],

    -- ;; guforap_1
    -- gfr     gufor   Nap     cover;lid

    noun     FuCL |< aT                {- guforap -}        `others` [ ".gufr Nap" ]
                                                            `gloss`  [ "cover", "lid" ],

    -- ;; gafiyr_1
    -- gfyr    gafiyr  N-ap    numerous;abundant     [[gafiyr/ADJ]]

    noun     FaCIL                     {- gafiyr -}         `gloss`  [ "numerous", "abundant" ] ]
 ...
 |> ".gfr" <| [
    ...
    noun     FiCAL |< aT               {- gifArap -}        `others` [ ".gifAr Napdu", ".gafA'ir Ndip" ]
    ...
    noun     IstiFCAL |< Iy            {- {isotigofAriy~ -} `gloss`  [ "propitiatory" ] ]
 ...
 |> ".gfq" <| [
    ...
    noun     FaCL |< aT                {- gafoqap -}        `others` [ ".gafq Nap" ]
                                                            `gloss`  [ "light sleep" ] ]
 ...
 |> ".gfl" <| [
    ...
    verb     HaFCaL                    {- >agofal -}        `others` [ ".gfal IV_Pass_yu", ".gfil IV_yu" ]
    ...
    noun     FuCL |< Iy |< aT          {- gufoliy~ap -}     `others` [ ".gufliyy Nap" ]
                                                            `gloss`  [ "anonymity" ],
    ...
    noun     FaCL |< aT                {- gafolap -}        `others` [ ".gafl Nap" ]
                                                            `gloss`  [ "negligence", "inattention" ],

    -- ;; gafolAn_1
    -- gflAn   gafolAn N       negligent     [[gafolAn/ADJ]]

    noun     FaCLAn                    {- gafolAn -}        `gloss`  [ "negligent" ],
    ...
    noun     HiFCAL                    {- <igofAl -}        `gloss`  [ "disregard", "omission", "forgetting" ],
    ...
    noun     FACiL                     {- gAfil -}          `gloss`  [ "negligent", "inattentive", "forgetful" ],

    -- ;; gufuwl_1
    -- gfwl    gufuwl  N       negligent;inattentive;forgetful     [[gufuwl/ADJ]]

    noun     FuCUL                     {- gufuwl -}         `gloss`  [ "negligent", "inattentive", "forgetful" ],

    -- ;; mugaf~al_1
    -- mgfl    mugaf~al        Nall    apathetic;gullible     [[mugaf~al/ADJ]]

    noun     MuFaCCaL                  {- mugaf~al -}       `gloss`  [ "apathetic", "gullible" ],

    -- ;; mugofal_1
    -- mgfl    mugofal N-ap    anonymous     [[mugofal/ADJ]]

    noun     MuFCaL                    {- mugofal -}        `gloss`  [ "anonymous" ],

    -- ;; mutagaf~il_1
    -- mtgfl   mutagaf~il      Nall    dolt;simpleton     [[mutagaf~il/ADJ]]

    noun     MutaFaCCiL                {- mutagaf~il -}     `gloss`  [ "dolt", "simpleton" ],

    -- ;; mutagAfil_1
    -- mtgAfl  mutagAfil       Nall    negligent;imprudent     [[mutagAfil/ADJ]]

    noun     MutaFACiL                 {- mutagAfil -}      `gloss`  [ "negligent", "imprudent" ] ]
 ...
 |> ".gf" <| [
    ...
    verb     FaCA                      {- gafA-u -}         `imperf` [ FCuL ]
                                                            `others` [ ".gfuw IV_0hAnn", ".gaf PV_ttAw", ".gafaw PV_Atn", ".gafA PV_0", ".gf IV_0hwnyn" ]
                                                            `gloss`  [ "doze off" ] ]
 ...
 |> ".gfy" <| [
    ...
    verb     FaCiL                     {- gafiy-a -}        `imperf` [ FCaL ]
                                                            `others` [ ".gaf PV_w", ".gafiy PV_no-w", ".gfay IV_Ann", ".gfa IV_0hwnyn", ".gfY IV_0" ]
                                                            `gloss`  [ "doze off" ] ]
 ...
 |> ".gf" <| [
    ...
    verb     HaFCY                     {- >agofaY -}        `others` [ ".gfiy IV_0hAnn_yu", "'a.gfA PV_h", "'a.gf PV_ttAw", ".gf IV_0hwnyn_yu", "'a.gfay PV_Atn" ]
                                                            `gloss`  [ "doze off" ] ]
 ...
 |> ".gfw" <| [
    ...
    noun     FaCL |< aT                {- gafowap -}        `others` [ ".gafaw NAt", ".gafw Napdu" ]
 ...
 |> ".gf" <| [
    ...
    noun     HiFCA'                    {- <igofA' -}        `gloss`  [ "nap", "siesta", "sleepiness" ] ]
 ...
 |> ".gqq" <| [
    ...
    verb     FaCL                      {- gaq~-i -}         `imperf` [ FCiL ]
                                                            `others` [ ".giqq IV_V", ".gaqaq PV_C", ".gaqq PV_V", ".gqiq IV_C" ]
                                                            `gloss`  [ "bubble", "boil", "gurgle" ],

    -- ;; gaqiyq_1
    -- gqyq    gaqiyq  N       bubbling;boiling;gurgling     [[gaqiyq/ADJ]]

    noun     FaCIL                     {- gaqiyq -}         `gloss`  [ "bubbling", "boiling", "gurgling" ] ]
 ...
 |> ".gll" <| [
    ...
    verb     FaCL                      {- gal~-u -}         `imperf` [ FCuL ]
                                                            `others` [ ".gull IV_V", ".gall PV_V", ".glul IV_C", ".galal PV_C" ]
    ...
    verb     FaCL                      {- gal~-i -}         `imperf` [ FCiL ]
                                                            `others` [ ".gill IV_V", ".gall PV_V", ".glil IV_C", ".galal PV_C" ]
                                                            `gloss`  [ "yield", "produce" ],
    ...
    verb     HaFaCL                    {- >agal~ -}         `others` [ ".gill IV_V_yu", ".gall IV_V_Pass_yu", ".glil IV_C_yu", "'a.glal PV_C" ]
    ...
    noun     FaCL |< aT                {- gal~ap -}         `others` [ ".gall NapAt" ]
                                                            `gloss`  [ "crops", "yield", "produce" ],

    -- ;; gilAlap_1
    -- glAl    gilAl   Napdu   gown;tunic
    -- glA}l   galA}il Ndip    gowns;tunics

    noun     FiCAL |< aT               {- gilAlap -}        `others` [ ".gilAl Napdu", ".galA'il Ndip" ]
    ...
    noun     IstiFCAL |< Iy            {- {isotigolAliy~ -} `gloss`  [ "exploitative" ],

    -- ;; magoluwl_1
    -- mglwl   magoluwl        Nall    shackled;handcuffed     [[magoluwl/ADJ]]

    noun     MaFCUL                    {- magoluwl -}       `gloss`  [ "shackled", "handcuffed" ],

    -- ;; mugil~_1
    -- mgl     mugil~  N-ap    productive;fruitful     [[mugil~/ADJ]]

    noun     MuFiCL                    {- mugil~ -}         `gloss`  [ "productive", "fruitful" ],
    ...
    noun     MustaFaCL                 {- musotagal~ -}     `gloss`  [ "exploited", "cultivated" ] ]
 ...
 |> ".glb" <| [
    ...
    noun     FaCL |< aT                {- galobap -}        `others` [ ".galb Nap" ]
    ...
    noun     HaFCaL                    {- >agolab -}        `gloss`  [ "most", "majority" ],

    -- ;; >agolabiy~ap_1
    -- >glby   >agolabiy~      Nap     majority     [[>agolabiy~/NOUN]]
    -- Aglby   >agolabiy~      Nap     majority     [[>agolabiy~/NOUN]]

    noun     HaFCaL |< Iy |< aT        {- >agolabiy~ap -}   `others` [ "'a.glabiyy Nap" ]
                                                            `gloss`  [ "majority" ],
    ...
    noun     HaFCaL |< Iy              {- >agolabiy~ -}     `gloss`  [ "majority" ],
    ...
    noun     MuFACaL |< aT             {- mugAlabap -}      `others` [ "mu.gAlab NapAt" ]
                                                            `gloss`  [ "strife", "struggle" ],
    ...
    noun     FACiL |< Iy |< aT         {- gAlibiy~ap -}     `others` [ ".gAlibiyy Nap" ]
                                                            `gloss`  [ "majority" ],
    ...
    noun     MutaFaCCiL                {- mutagal~ib -}     `gloss`  [ "victorious", "overcoming" ],

    -- ;; mutagal~ab_1
    -- mtglb   mutagal~ab      N       overcome;subdued     [[mutagal~ab/ADJ]]

    noun     MutaFaCCaL                {- mutagal~ab -}     `gloss`  [ "overcome", "subdued" ] ]
 ...
 |> ".gl.t" <| [
    ...
    verb     HaFCaL                    {- >agolaT -}        `others` [ ".gla.t IV_Pass_yu", ".gli.t IV_yu" ]
    ...
    noun     FaCL |< aT                {- galoTap -}        `others` [ ".gala.t NAt", ".gal.t Napdu" ]
                                                            `gloss`  [ "error", "blunder", "errors", "blunders" ],

    -- ;; galoTAn_1
    -- glTAn   galoTAn Ndip    wrong;erring     [[galoTAn/ADJ]]

    noun     FaCLAn                    {- galoTAn -}        `gloss`  [ "wrong", "erring" ] ]
 ...
 |> "'u.gluw.t" <| [
    ...
    noun     Identity |< aT            {- >ugoluwTap -}     `others` [ "'u.gluw.t NapAt", "'a.gAliy.t Ndip" ]
 ...
 |> ".gl.z" <| [
    ...
    verb     FaCuL                     {- galuZ-u -}        `imperf` [ FCuL ]
                                                            `others` [ ".glu.z IV_intr", ".galu.z PV_intr" ]
    ...
    verb     HaFCaL                    {- >agolaZ -}        `others` [ ".gli.z IV_intr_yu" ]
    ...
    noun     FiCL |< aT                {- giloZap -}        `others` [ ".gil.z Nap" ]
                                                            `gloss`  [ "thickness", "coarseness" ],
    ...
    noun     FaCIL                     {- galiyZ -}         `others` [ ".gilA.z N" ]
                                                            `gloss`  [ "thick", "viscous", "coarse" ],

    -- ;; gilAZap_1
    -- glAZ    gilAZ   Nap     thickness;coarseness

    noun     FiCAL |< aT               {- gilAZap -}        `others` [ ".gilA.z Nap" ]
                                                            `gloss`  [ "thickness", "coarseness" ],
    ...
    noun     HaFCaL                    {- >agolaZ -}        `gloss`  [ "thicker / thickest", "coarser / coarsest", "cruder / crudest" ],

    -- ;; mugal~aZ_1
    -- mglZ    mugal~aZ        N-ap    binding;sacred     [[mugal~aZ/ADJ]]

    noun     MuFaCCaL                  {- mugal~aZ -}       `gloss`  [ "binding", "sacred" ],
 ...
 |> ".glf" <| [
    ...
    noun     FuCL |< aT                {- gulofap -}        `others` [ ".gulf Nap" ]
                                                            `gloss`  [ "foreskin", "prepuce" ],
    ...
    noun     FiCAL |< Iy               {- gilAfiy~ -}       `gloss`  [ "covering" ],
    ...
    noun     HaFCaL                    {- >agolaf -}        `others` [ ".galfA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "rude", "uncivilized" ],
    ...
    noun     MuFaCCaL                  {- mugal~af -}       `gloss`  [ "wrapped", "covered" ],
    ...
    noun     FaCCAL |< aT              {- gal~Afap -}       `others` [ ".gallAf Nap" ]
                                                            `gloss`  [ "book-binding machine" ],
 ...
 |> ".glq" <| [
    ...
    verb     HaFCaL                    {- >agolaq -}        `others` [ ".glaq IV_Pass_yu", ".gliq IV_yu" ]
    ...
    noun     FaCiL                     {- galiq -}          `gloss`  [ "obscure", "recondite" ],

    -- ;; gilAqap_1
    -- glAq    gilAq   Nap     unpaid balance

    noun     FiCAL |< aT               {- gilAqap -}        `others` [ ".gilAq Nap" ]
                                                            `gloss`  [ "unpaid balance" ],

    -- ;; gal~Aqap_1
    -- glAq    gal~Aq  Nap     latch;lock

    noun     FaCCAL |< aT              {- gal~Aqap -}       `others` [ ".gallAq Nap" ]
                                                            `gloss`  [ "latch", "lock" ],
    ...
    noun     HiFCAL                    {- <igolAq -}        `gloss`  [ "locking", "closing", "barring" ],
    ...
    noun     MuFCaL                    {- mugolaq -}        `gloss`  [ "closed", "locked" ],

    -- ;; munogaliq_1
    -- mnglq   munogaliq       Nall    impervious;insensitive     [[munogaliq/ADJ]]

    noun     MunFaCiL                  {- munogaliq -}      `gloss`  [ "impervious", "insensitive" ],

    -- ;; musotagoliq_1
    -- mstglq  musotagoliq     Nall    cryptic;ambiguous;incomprehensible     [[musotagoliq/ADJ]]

    noun     MustaFCiL                 {- musotagoliq -}    `gloss`  [ "cryptic", "ambiguous", "incomprehensible" ] ]
 ...
 |> ".glm" <| [
    ...
    verb     FaCiL                     {- galim-a -}        `imperf` [ FCaL ]
                                                            `others` [ ".glam IV_intr", ".galim PV_intr" ]
    ...
    noun     FaCiL                     {- galim -}          `gloss`  [ "in heat", "aroused" ],

    -- ;; gulomap_1
    -- glm     gulom   Nap     sensuous desire

    noun     FuCL |< aT                {- gulomap -}        `others` [ ".gulm Nap" ]
                                                            `gloss`  [ "sensuous desire" ] ]
 ...
 |> ".gulAm" <| [
    ...
    noun     Identity                  {- gulAm -}          `others` [ ".gilmAn N" ]
 ...
 |> ".gulAm" <| [
    ...
    noun     Identity |< Iy |< aT      {- gulAmiy~ap -}     `others` [ ".gulAmiyy Nap" ]
                                                            `gloss`  [ "youthfulness" ],

    -- ;; guluwmap_1
    -- glwm    guluwm  Nap     youthfulness

    noun     FuCUL |< aT               {- guluwmap -}       `others` [ ".guluwm Nap" ]
                                                            `gloss`  [ "youthfulness" ] ]
 ...
 |> ".gl" <| [
    ...
    verb     FaCA                      {- galA-u -}         `imperf` [ FCuL ]
                                                            `others` [ ".glay IV_Ann_Pass_yu", ".galA PV_0h", ".gl IV_0hwnyn", ".gal PV_ttAw", ".glY IV_0_Pass_yu", ".gluw IV_0hAnn", ".galaw PV_Atn" ]
    ...
    verb     HaFCY                     {- >agolaY -}        `others` [ ".glay IV_Ann_Pass_yu", ".gliy IV_0hAnn_yu", ".gl IV_0hwnyn_yu", "'a.gl PV_ttAw", "'a.glay PV_Atn", "'a.glA PV_h", ".glY IV_0_Pass_yu" ]
 ...
 |> ".gl" <| [
    ...
    noun     HaFCY                     {- >agolaY -}        `others` [ "'a.glay NAn_Nayn", "'a.glA Nhy" ]
 ...
 |> "mu.gAlAT" <| [
    ...
    noun     HiFCA'                    {- <igolA' -}        `gloss`  [ "praise", "admiration" ] ]
 ...
 |> ".gulAT" <| [
    ...
    noun     Identity                  {- gulAp -}          `others` [ ".gulA Nap" ]
                                                            `gloss`  [ "extremists", "fanatics" ],
    ...
    noun     MuFACiL                   {- mugAliy -}        `others` [ "mu.gAl Nuwn_Niyn NK" ]
                                                            `gloss`  [ "extravagant", "exaggerating" ] ]
 ...
 |> ".gl" <| [
    ...
    noun     MuFACaNY                  {- mugAlaY -}        `others` [ "mu.gAlaw NAt" ]
                                                            `gloss`  [ "exaggerated", "excessive", "exaggerations", "excesses" ] ]
 ...
 |> ".gly" <| [
    ...
    noun     FaCCAL |< aT              {- gal~Ayap -}       `others` [ ".gallAy NapAt" ]
                                                            `gloss`  [ "kettle", "boiler" ] ]
 ...
 |> "ma.gl" <| [
    ...
    noun     Identity |< Iy            {- magoliy~ -}       `gloss`  [ "boiled", "broth" ] ]
 ...
 |> "mi.glAT" <| [
    ...
    noun     Identity                  {- migolAp -}        `others` [ "ma.gAliy N0_Nh", "ma.gAl NK", "mi.glA Napdu" ]
 ...
 |> ".gmm" <| [
    ...
    verb     FaCL                      {- gam~-u -}         `imperf` [ FCuL ]
                                                            `others` [ ".gamm PV_V IV_V_Pass_yu", ".gmam IV_C_Pass_yu", ".gumim PV_C_Pass", ".gumm PV_V_Pass IV_V", ".gmum IV_C", ".gamam PV_C" ]
    ...
    verb     HaFaCL                    {- >agam~ -}         `others` [ ".gamm IV_V_Pass_yu", ".gimm IV_V_yu", "'a.gmam PV_C", ".gmim IV_C_yu" ]
    ...
    noun     FuCL |< aT                {- gum~ap -}         `others` [ ".gumm Nap" ]
                                                            `gloss`  [ "anxiety", "sorrow" ],
    ...
    noun     FaCAL |< Iy               {- gamAmiy~ -}       `gloss`  [ "cloudy" ],

    -- ;; gamAmiy~ap_1
    -- gmAmy   gamAmiy~        Nap     nebulosity     [[gamAmiy~/NOUN]]

    noun     FaCAL |< Iy |< aT         {- gamAmiy~ap -}     `others` [ ".gamAmiyy Nap" ]
                                                            `gloss`  [ "nebulosity" ],

    -- ;; gimAmap_1
    -- gmAm    gimAm   Nap     blinder;muzzle

    noun     FiCAL |< aT               {- gimAmap -}        `others` [ ".gimAm Nap" ]
                                                            `gloss`  [ "blinder", "muzzle" ],
    ...
    noun     HaFaCL                    {- >agam~ -}         `others` [ ".gammA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "overcast" ],
 ...
 |> ".gAmm" <| [
    ...
    noun     Identity                  {- gAm~ -}           `gloss`  [ "overcast" ] ]
 ...
 |> ".gAmm" <| [
    ...
    noun     Identity                  {- gAm~ -}           `gloss`  [ "distressing" ],

    -- ;; magomuwm_1
    -- mgmwm   magomuwm        Nall    worried;afflicted     [[magomuwm/ADJ]]

    noun     MaFCUL                    {- magomuwm -}       `gloss`  [ "worried", "afflicted" ],

    -- ;; mugotam~_1
    -- mgtm    mugotam~        Nall    distressed;afflicted     [[mugotam~/ADJ]]

    noun     MuFtaCL                   {- mugotam~ -}       `gloss`  [ "distressed", "afflicted" ],

    -- ;; mugim~_1
    -- mgm     mugim~  N-ap    worrying;distressing     [[mugim~/ADJ]]

    noun     MuFiCL                    {- mugim~ -}         `gloss`  [ "worrying", "distressing" ],

    -- ;; mugim~_2
    -- mgm     mugim~  N-ap    overcast     [[mugim~/ADJ]]

    noun     MuFiCL                    {- mugim~ -}         `gloss`  [ "overcast" ] ]
 ...
 |> ".gmd" <| [
    ...
    verb     HaFCaL                    {- >agomad -}        `others` [ ".gmad IV_Pass_yu", ".gmid IV_yu" ]
 ...
 |> ".gmr" <| [
    ...
    verb     FaCuL                     {- gamur-u -}        `imperf` [ FCuL ]
                                                            `others` [ ".gamur PV_intr", ".gmur IV_intr" ]
                                                            `gloss`  [ "be foolish" ],
    ...
    noun     FiCAL |< Iy               {- gimAriy~ -}       `gloss`  [ "adventurous" ],
    ...
    noun     FaCL |< aT                {- gamorap -}        `others` [ ".gamar NAt", ".gamr Napdu" ]
    ...
    noun     HaFCAL                    {- >agomAr -}        `gloss`  [ "armsfull" ],

    -- ;; mugAmarap_1
    -- mgAmr   mugAmar NapAt   adventure;risk

    noun     MuFACaL |< aT             {- mugAmarap -}      `others` [ "mu.gAmar NapAt" ]
    ...
    noun     MaFCUL                    {- magomuwr -}       `gloss`  [ "covered", "burried", "submerged" ],
 ...
 |> ".gmz" <| [
    ...
    noun     FaCL |< aT                {- gamozap -}        `others` [ ".gamaz NAt", ".gamz Napdu" ]
    ...
    noun     FaCCAL |< aT              {- gam~Azap -}       `others` [ ".gammAz Nap" ]
                                                            `gloss`  [ "dimple" ],

    -- ;; gamiyzap_1
    -- gmyz    gamiyz  Nap     blemish;shortcoming

    noun     FaCIL |< aT               {- gamiyzap -}       `others` [ ".gamiyz Nap" ]
                                                            `gloss`  [ "blemish", "shortcoming" ],
 ...
 |> ".gms" <| [
    ...
    noun     FaCIL                     {- gamiys -}         `gloss`  [ "buried", "unknown" ],

    -- ;; gamuws_1
    -- gmws    gamuws  N-ap    ominous;disastrous;false     [[gamuws/ADJ]]

    noun     FaCUL                     {- gamuws -}         `gloss`  [ "ominous", "disastrous", "false" ],

    -- ;; magomuws_1
    -- mgmws   magomuws        N-ap    immersed     [[magomuws/ADJ]]

    noun     MaFCUL                    {- magomuws -}       `gloss`  [ "immersed" ] ]
 ...
 |> ".gm.s" <| [
    ...
    noun     HaFCaL                    {- >agomaS -}        `others` [ ".gam.sA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "sticky-eyed" ] ]
 ...
 |> ".gm.d" <| [
    ...
    verb     FaCuL                     {- gamuD-u -}        `imperf` [ FCuL ]
                                                            `others` [ ".gamu.d PV_intr", ".gmu.d IV_intr" ]
    ...
    verb     HaFCaL                    {- >agomaD -}        `others` [ ".gma.d IV_Pass_yu", ".gmi.d IV_yu" ]
    ...
    noun     FaCL |< aT                {- gamoDap -}        `others` [ ".gimA.d N", ".gam.d Nap" ]
    ...
    noun     HaFCaL                    {- >agomaD -}        `gloss`  [ "more / most obscure", "more / most vague" ],
 ...
 |> ".gmq" <| [
    ...
    verb     FaCiL                     {- gamiq-a -}        `imperf` [ FCaL ]
                                                            `others` [ ".gamiq PV_intr", ".gmaq IV_intr" ]
                                                            `gloss`  [ "be damp", "be moist" ],

    -- ;; gAmiq_1
    -- gAmq    gAmiq   N-ap    dark color;deep color;boldface (font)     [[gAmiq/ADJ]]

    noun     FACiL                     {- gAmiq -}          `gloss`  [ "dark color", "deep color", "boldface ( font )" ] ]
 ...
 |> ".gm" <| [
    ...
    verb     HaFCY                     {- >agomaY -}        `others` [ ".gmY IV_0_Pass_yu", "'a.gmay PV_Atn", "'a.gmA PV_h", "'a.gm PV_ttAw", "'u.gmiy PV_Pass-a" ]
 ...
 |> ".gm'" <| [
    ...
    noun     HiFCAL |< aT              {- <igomA'ap -}      `others` [ "'i.gmA' NapAt" ]
                                                            `gloss`  [ "fainting spell" ] ]
 ...
 |> "ma.gm" <| [
    ...
    noun     Identity |< Iy            {- magomiy~ -}       `gloss`  [ "fainted", "unconscious" ] ]
 ...
 |> ".gm" <| [
    ...
    noun     MuFCaNY                   {- mugomaY -}        `gloss`  [ "fainted", "unconscious" ] ]
 ...
 |> ".gnn" <| [
    ...
    verb     FaCL                      {- gan~-a -}         `imperf` [ FCaL ]
                                                            `others` [ ".ganin PV_Cn", ".gann PV_V IV_V", ".gnan IV-n" ]
    ...
    verb     HaFaCL                    {- >agan~ -}         `others` [ "'a.gnan PV_Cn", ".gnin IV_C_yu", ".ginn IV_V_yu" ]
                                                            `gloss`  [ "buzz", "drone" ],
    ...
    noun     FuCL |< aT                {- gun~ap -}         `others` [ ".gunn NapAt" ]
                                                            `gloss`  [ "nasal twang" ],
    ...
    noun     HaFaCL                    {- >agan~ -}         `others` [ ".gannA' Nh Nhy N0_Nh" ]
 ...
 |> ".gunAn" <| [
    ...
    noun     Identity                  {- gunAn -}          `gloss`  [ "buzzing", "droning" ],

    -- ;; mugin~_1
    -- mgn     mugin~  Nall    buzzing;droning     [[mugin~/ADJ]]

    noun     MuFiCL                    {- mugin~ -}         `gloss`  [ "buzzing", "droning" ] ]
 ...
 |> ".gn^g" <| [
    ...
    noun     FaCiL |< aT               {- ganijap -}        `others` [ ".gani^g Nap" ]
                                                            `gloss`  [ "coquette", "flirtatious" ],
    ...
    noun     MiFCAL                    {- migonAj -}        `gloss`  [ "coquette", "flirtatious" ] ]
 ...
 |> "'u.gnuw^g" <| [
    ...
    noun     Identity |< aT            {- >ugonuwjap -}     `others` [ "'a.gAniy^g Ndip", "'u.gnuw^g Napdu" ]
    ...
    noun     MutaFaCCiL                {- mutagan~ij -}     `gloss`  [ "flirting" ] ]
 ...
 |> ".gundur" <| [
    ...
    noun     Identity                  {- gunodur -}        `gloss`  [ "chubby" ],
 ...
 |> ".gundaq^g" <| [
    ...
    noun     Identity |< Iy            {- gunodaqojiy~ -}   `gloss`  [ "armorer", "gunsmith" ] ]
 ...
 |> ".gan.gariyn" <| [
    ...
    noun     Identity |< aT            {- ganogariynap -}   `others` [ ".gan.gariyn Nap" ]
                                                            `gloss`  [ "gangrene" ] ]
 ...
 |> ".gan.gariyn" <| [
    ...
    noun     Identity |< Iy            {- ganogariyniy~ -}  `gloss`  [ "gangrenous" ] ]
 ...
 |> ".gnm" <| [
    ...
    verb     HaFCaL                    {- >agonam -}        `others` [ ".gnam IV_Pass_yu", ".gnim IV_yu" ]
    ...
    noun     FaCIL |< aT               {- ganiymap -}       `others` [ ".ganA'im Ndip", ".ganiym Napdu" ]
                                                            `gloss`  [ "spoils", "booty" ],
 ...
 |> ".gn.s" <| [
    ...
    noun     FuCUL |< Iy               {- gunuwSiy~ -}      `gloss`  [ "gnostic", "gnosticism" ] ]
 ...
 |> ".gny" <| [
    ...
    verb     FaCiL                     {- ganiy-a -}        `imperf` [ FCaL ]
                                                            `others` [ ".gna IV_0hwnyn", ".gan PV_w_intr", ".gnay IV_Ann", ".ganiy PV_no-w_intr", ".gnY IV_0" ]
                                                            `gloss`  [ "become rich" ] ]
 ...
 |> ".ginY" <| [
    ...
    noun     CaL |< Iy                 {- ganiy~ -}         `others` [ "'a.gniyA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "rich", "wealthy" ],
    ...
    noun     FiCA' |< Iy               {- ginA}iy~ -}       `gloss`  [ "singing", "vocal", "lyrical" ] ]
 ...
 |> "'u.gniy" <| [
    ...
    noun     Identity |< aT            {- >ugoniyap -}      `others` [ "'u.gniyy NapAt", "'a.gAn NK", "'a.gAniy N0_Nh", "'u.gniy NapAt" ]
                                                            `gloss`  [ "song", "melody", "songs", "melodies" ] ]
 ...
 |> "ma.gnY" <| [
    ...
    noun     Identity                  {- magonaY -}        `others` [ "ma.gnay NAn_Nayn", "ma.gnA Nhy", "ma.gAniy N0_Nh", "ma.gAn NK" ]
 ...
 |> ".gny" <| [
    ...
    noun     FACiL |< aT               {- gAniyap -}        `others` [ ".gawAniy N0_Nh", ".gawAn NK", ".gAniy NapAt" ]
 ...
 |> ".gn" <| [
    ...
    noun     MustaFCaNY                {- musotagonaY -}    `gloss`  [ "dispensable", "useless" ] ]
 ...
 |> ".gnn" <| [
    ...
    noun     MuFaCCaNY                 {- mugan~aY -}       `others` [ "mu.gannA Napdu Nhy", "mu.gannay NAn_Nayn" ]
                                                            `gloss`  [ "sung" ] ]
 ...
 |> ".guwAtiymAl" <| [
    ...
    noun     Identity |< Iy            {- guwAtiymAliy~ -}  `gloss`  [ "Guatemalan" ] ]
 ...
 |> ".g_t" <| [
    ...
    verb     HaFAL                     {- >agAv -}          `others` [ ".gi_t IV_C_yu", ".gA_t IV_V_Pass_yu", ".ga_t IV_C_Pass_yu", ".giy_t IV_V_yu", "'a.ga_t PV_C" ]
 ...
 |> ".g_t" <| [
    ...
    noun     HiFAL |< aT               {- <igAvap -}        `others` [ "'i.gA_t NapAt" ]
                                                            `gloss`  [ "aid", "relief assistance" ],

    -- ;; {isotigAvap_1
    -- <stgAv  {isotigAv       NapAt   appeal for aid;call for help
    -- AstgAv  {isotigAv       NapAt   appeal for aid;call for help

    noun     IstiFAL |< aT             {- {isotigAvap -}    `others` [ "isti.gA_t NapAt" ]
                                                            `gloss`  [ "appeal for aid", "call for help" ],
 ...
 |> ".gr" <| [
    ...
    verb     FAL                       {- gAr-u -}          `imperf` [ FCuL ]
                                                            `others` [ ".gur PV_C IV_C", ".guwr IV_V", ".gAr PV_V" ]
                                                            `gloss`  [ "penetrate" ],
    ...
    verb     HaFAL                     {- >agAr -}          `others` [ ".gir IV_C_yu", ".gar IV_C_Pass_yu", ".giyr IV_V_yu", ".gAr IV_V_Pass_yu", "'a.gar PV_C" ]
 ...
 |> ".gr" <| [
    ...
    noun     FAL |< aT                 {- gArap -}          `others` [ ".gAr NAt Napdu" ]
 ...
 |> "ma.gAr" <| [
    ...
    noun     Identity                  {- magAr -}          `others` [ "ma.gA'ir Ndip", "ma.gAwir Ndip" ]
 ...
 |> ".gr" <| [
    ...
    noun     HiFAL |< aT               {- <igArap -}        `others` [ "'i.gAr NapAt" ]
                                                            `gloss`  [ "attack", "raid" ] ]
 ...
 |> ".gw^s" <| [
    ...
    noun     FuCayL |< aT              {- guwayo$ap -}      `others` [ ".gawA'i^s Ndip", ".guway^s NapAt" ]
 ...
 |> ".g.s" <| [
    ...
    verb     FAL                       {- gAS-u -}          `imperf` [ FCuL ]
                                                            `others` [ ".gA.s PV_V", ".gu.s PV_C IV_C", ".guw.s IV_V" ]
 ...
 |> ".gw.s" <| [
    ...
    noun     FaCCAL |< aT              {- gaw~ASap -}       `others` [ ".gawwA.s NapAt" ]
                                                            `gloss`  [ "submarine" ],

    -- ;; gaw~ASiy~_1
    -- gwASy   gaw~ASiy~       Nall    submarine;diving     [[gaw~ASiy~/ADJ]]

    noun     FaCCAL |< Iy              {- gaw~ASiy~ -}      `gloss`  [ "submarine", "diving" ] ]
 ...
 |> "ma.gA.s" <| [
    ...
    noun     Identity                  {- magAS -}          `gloss`  [ "diving place" ] ]
 ...
 |> ".g'.s" <| [
    ...
    noun     FACiL                     {- gA}iS -}          `gloss`  [ "immersed", "diving", "under-water" ] ]
 ...
 |> ".gw.t" <| [
    ...
    noun     FuCL |< aT                {- guwTap -}         `others` [ ".guw.t Nap" ]
 ...
 |> ".g'.t" <| [
    ...
    noun     FACiL |< Iy               {- gA}iTiy~ -}       `gloss`  [ "fecal" ] ]
 ...
 |> ".gw.t" <| [
    ...
    noun     FuCL |< Iy                {- guwTiy~ -}        `gloss`  [ "Gothic" ] ]
 ...
 |> ".g.g" <| [
    ...
    noun     FAL |< aT                 {- gAgap -}          `others` [ ".gA.g Nap" ]
                                                            `gloss`  [ "riffraff", "rabble", "tumult" ] ]
 ...
 |> ".gl" <| [
    ...
    verb     FAL                       {- gAl-u -}          `imperf` [ FCuL ]
                                                            `others` [ ".gul PV_C IV_C", ".guwl IV_V", ".gAl PV_V" ]
    ...
    noun     FUL                       {- guwl -}           `others` [ ".giylAn N", "'a.gwAl N" ]
                                                            `gloss`  [ "ghoul", "monster", "ghouls", "monsters" ],

    -- ;; guwl_2
    -- gwl     guwl    N0      Ghoul

    noun     FUL                       {- guwl -}           `gloss`  [ "Ghoul" ],

    -- ;; giylap_1
    -- gyl     giyl    Nap     assassination

    noun     FIL |< aT                 {- giylap -}         `others` [ ".giyl Nap" ]
                                                            `gloss`  [ "assassination" ],
 ...
 |> ".g'l" <| [
    ...
    noun     FACiL |< aT               {- gA}ilap -}        `others` [ ".gA'il Nap", ".gawA'il Ndip" ]
 ...
 |> ".gl" <| [
    ...
    noun     MuFtAL                    {- mugotAl -}        `gloss`  [ "assassinated", "murdered" ] ]
 ...
 |> ".gw" <| [
    ...
    verb     FaCY                      {- gawaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ ".gawA PV_h", ".gwY IV_0_Pass_yu", ".gaway PV_Atn", ".gw IV_0hwnyn", ".gawY PV_0", ".gwiy IV_0hAnn", ".gaw PV_ttAw" ]
 ...
 |> ".gwy" <| [
    ...
    verb     FaCiL                     {- gawiy-a -}        `imperf` [ FCaL ]
                                                            `others` [ ".gwA IV_h", ".gwY IV_0", ".gway IV_Ann", ".gwa IV_0hwnyn", ".gaw PV_w", ".gawiy PV_no-w" ]
                                                            `gloss`  [ "covet" ] ]
 ...
 |> ".gw" <| [
    ...
    verb     HaFCY                     {- >agowaY -}        `others` [ "'a.gwA PV_h", ".gwY IV_0_Pass_yu", "'a.gw PV_ttAw", "'a.gway PV_Atn", ".gway IV_Ann_Pass_yu", ".gw IV_0hwnyn_yu", ".gwiy IV_0hAnn_yu" ]
 ...
 |> ".gyy" <| [
    ...
    noun     FaCL |< aT                {- gay~ap -}         `others` [ ".gayy NapAt" ]
                                                            `gloss`  [ "error", "sin" ] ]
 ...
 |> ".gwy" <| [
    ...
    noun     FaCAL |< aT               {- gawAyap -}        `others` [ ".gawAy Nap" ]
                                                            `gloss`  [ "error", "sin" ] ]
 ...
 |> "'u.gw" <| [
    ...
    noun     Identity |< Iy |< aT      {- >ugowiy~ap -}     `others` [ "'u.gwiyy Napdu", "'a.gAwiyy N0_Nh" ]
 ...
 |> ".gw'" <| [
    ...
    noun     HiFCAL                    {- <igowA' -}        `gloss`  [ "seduction", "allurement" ] ]
 ...
 |> "mu.gawwAT" <| [
    ...
    noun     Identity                  {- mugaw~Ap -}       `others` [ "ma.gAw NK", "ma.gAwiy N0_Nh", "ma.gwA Napdu", "mu.gawway NAt", "mu.gawwA Napdu" ]
                                                            `gloss`  [ "pitfall", "trap", "pitfalls", "traps" ],
 ...
 |> ".gy" <| [
    ...
    noun     FAL |< aT                 {- gAyap -}          `others` [ ".gAy NAt Napdu" ]
    ...
    noun     FAL |< aT                 {- gAyap -}          `others` [ "lil.gAyaT FW-Wa", ".gAy Nap" ]
                                                            `gloss`  [ "utmost", "extreme", "extremely", "greatly" ] ]
 ...
 |> ".g'" <| [
    ...
    noun     FAL |< Iy                 {- gA}iy~ -}         `gloss`  [ "final", "finalism" ],

    -- ;; gA}iy~ap_1
    -- gA}y    gA}iy~  Nap     finality     [[gA}iy~/NOUN]]

    noun     FAL |< Iy |< aT           {- gA}iy~ap -}       `others` [ ".gA'iyy Nap" ]
                                                            `gloss`  [ "finality" ] ]
 ...
 |> ".gb" <| [
    ...
    verb     FAL                       {- gAb-i -}          `imperf` [ FCiL ]
                                                            `others` [ ".gib IV_C_intr PV_C_intr", ".gAb PV_V_intr", ".giyb IV_V_intr" ]
                                                            `gloss`  [ "be absent" ] ]
 ...
 |> ".gyb" <| [
    ...
    noun     FaCL |< Iy                {- gayobiy~ -}       `gloss`  [ "hidden", "invisible", "secret", "occult" ],

    -- ;; gayobiy~ap_1
    -- gyby    gayobiy~        Nap     metaphysics     [[gayobiy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- gayobiy~ap -}     `others` [ ".gaybiyy Nap" ]
                                                            `gloss`  [ "metaphysics" ] ]
 ...
 |> ".gb" <| [
    ...
    noun     FAL |< aT                 {- gAbap -}          `others` [ ".gAb N NapAt" ]
                                                            `gloss`  [ "forest", "jungle" ],

    -- ;; gAbiy~_1
    -- gAby    gAbiy~  N-ap    forested;wooded     [[gAbiy~/ADJ]]

    noun     FAL |< Iy                 {- gAbiy~ -}         `gloss`  [ "forested", "wooded" ] ]
 ...
 |> ".gyb" <| [
    ...
    noun     FaCL |< aT                {- gayobap -}        `others` [ ".gayb Nap" ]
                                                            `gloss`  [ "absence" ],

    -- ;; giybap_1
    -- gyb     giyb    Nap     slander

    noun     FiCL |< aT                {- giybap -}         `others` [ ".giyb Nap" ]
                                                            `gloss`  [ "slander" ],
    ...
    noun     FiCAL |< Iy               {- giyAbiy~ -}       `gloss`  [ "absent", "in absentia" ],
 ...
 |> ".gyb" <| [
    ...
    noun     TaFaCCuL |< Iy |< aT      {- tagay~ubiy~ap -}  `others` [ "ta.gayyubiyy Nap" ]
                                                            `gloss`  [ "absenteeism" ],
 ...
 |> ".gyb" <| [
    ...
    noun     MuFaCCaL                  {- mugay~ab -}       `gloss`  [ "hidden", "concealed", "occult", "metaphysical" ],
 ...
 |> ".g_t" <| [
    ...
    verb     FAL                       {- gAv-i -}          `imperf` [ FCiL ]
                                                            `others` [ ".gi_t PV_C IV_C", ".gA_t PV_V", ".giy_t IV_V" ]
                                                            `gloss`  [ "send rain" ] ]
 ...
 |> ".gyd" <| [
    ...
    noun     HaFCaL                    {- >agoyad -}        `others` [ ".gaydA' Nh Nhy N0_Nh", ".giyd N" ]
                                                            `gloss`  [ "flexible", "delicate" ],
 ...
 |> ".gd" <| [
    ...
    noun     FAL |< aT                 {- gAdap -}          `others` [ ".gAd Nap" ]
                                                            `gloss`  [ "Ghada" ],
    ...
    noun     FAL |< aT                 {- gAdap -}          `others` [ ".gAd NapAt", ".giyd N" ]
 ...
 |> ".gyr" <| [
    ...
    noun     FaCL                      {- gayor -}          `gloss`  [ "not", "other" ],
 ...
 |> ".gyr" <| [
    ...
    noun     FaCL |< Iy                {- gayoriy~ -}       `gloss`  [ "altruist", "altruism" ],

    -- ;; gayorap_1
    -- gyr     gayor   Nap     jealousy;zeal

    noun     FaCL |< aT                {- gayorap -}        `others` [ ".gayr Nap" ]
                                                            `gloss`  [ "jealousy", "zeal" ],
    ...
    noun     FaCUL                     {- gayuwr -}         `gloss`  [ "jealous" ],
    ...
    noun     TaFCIL |< aT              {- tagoyiyrap -}     `others` [ "ta.gyiyr Nap", "ta.gAyiyr Ndip" ]
    ...
    noun     TaFaCCuL |< Iy |< aT      {- tagay~uriy~ap -}  `others` [ "ta.gayyuriyy Nap" ]
                                                            `gloss`  [ "variability" ],
    ...
    noun     MuFACiL                   {- mugAyir -}        `gloss`  [ "different from", "competing with", "at odds with" ],
    ...
    noun     MutaFACiL                 {- mutagAyir -}      `gloss`  [ "differing", "heterogeneous" ] ]
 ...
 |> ".g.d" <| [
    ...
    verb     FAL                       {- gAD-i -}          `imperf` [ FCiL ]
                                                            `others` [ ".gA.d PV_V", ".gi.d PV_C IV_C", ".giy.d IV_V" ]
 ...
 |> ".gy.d" <| [
    ...
    noun     FaCL |< aT                {- gayoDap -}        `others` [ ".gay.d NapAt", "'a.gyA.d N", ".giyA.d N" ]
 ...
 |> ".g.z" <| [
    ...
    verb     FAL                       {- gAZ-i -}          `imperf` [ FCiL ]
                                                            `others` [ ".giy.z IV_V", ".gA.z PV_V", ".gi.z PV_C IV_C" ]
 ...
 |> ".g.z" <| [
    ...
    verb     HaFAL                     {- >agAZ -}          `others` [ ".ga.z IV_C_Pass_yu", "'a.ga.z PV_C", ".gA.z IV_V_Pass_yu", ".giy.z IV_V_yu", ".gi.z IV_C_yu" ]
 ...
 |> ".gy.z" <| [
    ...
    noun     MuFiCL                    {- mugiyZ -}         `gloss`  [ "irate", "furious" ] ]
 ...
 |> "mun.gA.z" <| [
    ...
    noun     Identity                  {- munogAZ -}        `gloss`  [ "irate", "furious" ] ]
 ...
 |> ".g.z" <| [
    ...
    noun     MuFtAL                    {- mugotAZ -}        `gloss`  [ "irate", "furious" ],

    -- ;; <igAZap_1
    -- <gAZ    <igAZ   NapAt   exasperation;irritation
    -- AgAZ    <igAZ   NapAt   exasperation;irritation

    noun     HiFAL |< aT               {- <igAZap -}        `others` [ "'i.gA.z NapAt" ]
                                                            `gloss`  [ "exasperation", "irritation" ] ]
 ...
 |> ".gm" <| [
    ...
    verb     FAL                       {- gAm-i -}          `imperf` [ FCiL ]
                                                            `others` [ ".gim IV_C_intr PV_C_intr", ".gAm PV_V_intr", ".giym IV_V_intr" ]
 ...
 |> ".gm" <| [
    ...
    verb     HaFAL                     {- >agAm -}          `others` [ "'a.gam PV_C_intr", ".gim IV_C_intr_yu", ".gAm IV_V_Pass_yu", ".giym IV_V_intr_yu", ".gam IV_C_Pass_yu" ]
                                                            `gloss`  [ "become overcast / blurred" ] ]
 ...
 |> ".gym" <| [
    ...
    noun     FaCL |< aT                {- gayomap -}        `others` [ ".gaym Napdu", ".giyAm N", ".guyuwm N" ]
                                                            `gloss`  [ "cloud", "clouds" ] ]
 ...
 |> ".g'm" <| [
    ...
    noun     FACiL                     {- gA}im -}          `gloss`  [ "clouded", "overcast", "blurred" ] ]
 ...
 |> ".gym" <| [
    ...
    noun     MutaFaCCiL                {- mutagay~im -}     `gloss`  [ "clouded", "overcast", "blurred" ] ]
 ...
 |> ".gyn" <| [
    ...
    noun     FaCL |< aT                {- gayonap -}        `others` [ ".gayn NapAt" ]
                                                            `gloss`  [ "dimple" ],
    ...
    noun     HaFCaL                    {- >agoyan -}        `others` [ ".gaynA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "bushy", "dense" ] ]
 ...
 |> ".gn" <| [
    ...
    noun     FIL |< Iy                 {- giyniy~ -}        `gloss`  [ "Guinean" ] ]
