...
lexicon = listing "Lexicon properties"
 ...
 |> "'abA.ti.h" <| [
    ...
    noun     Identity                  {- OabATiH -}        `gloss`  [ "wide valley", "plain" ] ]
 ...
 |> "'abA.tir" <| [
    ...
    noun     Identity |< aT            {- OabATirap -}      `gloss`  [ "emperors" ] ]
 ...
 |> "'abA.tiyl" <| [
    ...
    noun     Identity                  {- OabATiyl -}       `gloss`  [ "vanities", "falsehood" ] ]
 ...
 |> "'abA`id" <| [
    ...
    noun     Identity                  {- OabAEid -}        `gloss`  [ "farther", "farthest" ] ]
 ...
 |> "'abAdiyd" <| [
    ...
    noun     Identity                  {- OabAdiyd -}       `gloss`  [ "scattered" ] ]
 ...
 |> "'ubsuw.t" <| [
    ...
    noun     Identity |< aT            {- OubosuwTap -}     -- `others` [ "'abAsiy.t Ndip", "'ibsiy.t Ndu" ]
 ...
 |> "b ' .g" <| [
    ...
    noun     FAL |< aT                 {- bAgap -}          `gloss`  [ "celluloid", "tortoise shell" ] ]
 ...
 |> "b ' b '" <| [
    ...
    verb     KaRDaS                    {- baOobaO -}        -- `others` [ "ba'bi' IV_yu", "ba'ba'A PV-|" ]
                                                            `gloss`  [ "babble" ],
    ...
    noun     KuRDuS                    {- buWobuW -}        `gloss`  [ "pupil", "source" ] ]
 ...
 |> "b ' l" <| [
    ...
    noun     FAL |< aT                 {- bAlap -}          `gloss`  [ "bale", "bundle" ],
 ...
 |> "b ' n" <| [
    ...
    noun     FaCUL |< aT               {- baWuwnap -}       `gloss`  [ "Ba'una ( 10th Coptic month , June 8-July 7 )" ],
    ...
    noun     FACiL |< aT               {- bA}inap -}        `gloss`  [ "dowry" ] ]
 ...
 |> "b ' q" <| [
    ...
    noun     FACiL |< aT               {- bA}iqap -}        -- `others` [ "bawA'iq Ndip" ]
 ...
 |> "b ' r" <| [
    ...
    verb     FaCaL                     {- baOar-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "b'ar IV" ]
    ...
    noun     FuCL |< Iy                {- buWoriy~ -}       `gloss`  [ "focal [ [ bu&oriy ~ / ADJ ] ]" ],
 ...
 |> "b ' s" <| [
    ...
    verb     FaCaL                     {- baOas-u -}        `imperf` [ FCuL ]
                                                            -- `others` [ "b'us IV_intr" ]
    ...
    verb     IFtaCaL                   {- {ibotaOas -}      -- `others` [ "bta'is IV_intr" ]
 ...
 |> "b ' z" <| [
    ...
    noun     FaCL                      {- baOoz -}          -- `others` [ "bi'zAn N", "bu'uwz N" ]
 ...
 |> "b .d `" <| [
    ...
    verb     HaFCaL                    {- OaboDaE -}        -- `others` [ "b.di` IV_yu" ]
                                                            `gloss`  [ "invest" ],
    ...
    noun     HiFCAL                    {- IiboDAE -}        `gloss`  [ "partnership", "investment" ],
 ...
 |> "b .g '" <| [
    ...
    noun     FuCAL                     {- bugA' -}          `gloss`  [ "desire", "endeavor" ],
    ...
    noun     IFtiCAL |< aN             {- {ibotigA'F -}     `gloss`  [ "with the aim of", "for the purpose of [ [ { ibotigA'F / ADV ] ]" ] ]
 ...
 |> "b .g .d" <| [
    ...
    verb     HaFCaL                    {- OabogaD -}        -- `others` [ "b.ga.d IV_Pass_yu", "b.gi.d IV_yu" ]
 ...
 |> "b .g ^s" <| [
    ...
    noun     FaCL |< aT                {- bago$ap -}        -- `others` [ "ba.ga^s NAt" ]
                                                            `gloss`  [ "shower", "showers" ],

    -- ;; bugo$ap_1
    -- bg$     bugo$   NapAt   bughsha (Yemeni copper coin)

    noun     FuCL |< aT                {- bugo$ap -}        `gloss`  [ "bughsha ( Yemeni copper coin )" ],

    -- ;; bugA$ap_1
    -- bgA$    bugA$   NapAt   boughashah ("cigar" pastries with walnut filling)

    noun     FuCAL |< aT               {- bugA$ap -}        `gloss`  [ "boughashah ( `` cigar '' pastries with walnut filling )" ] ]
 ...
 |> "b .g _t" <| [
    ...
    noun     FuCAL                     {- bugAv -}          -- `others` [ "bi.g_tAn N" ]
                                                            `gloss`  [ "sparrows" ] ]
 ...
 |> "b .g _t r" <| [
    ...
    noun     KaRDaS |< aT              {- bagovarap -}      `gloss`  [ "agitation", "aversion" ] ]
 ...
 |> "b .g d" <| [
    ...
    noun     FiCA'                     {- bigA' -}          `gloss`  [ "prostitution" ],
    ...
    noun     FuCA'                     {- bugA' -}          `gloss`  [ "desire", "endeavor" ],
    ...
    noun     MaFCY                     {- mabogaY -}        -- `others` [ "mabA.giy N0_Nh", "mab.gA Nhy", "mabA.g NK", "mab.gay NAn_Nayn" ]
    ...
    noun     IFtiCA'                   {- {ibotigA' -}      `gloss`  [ "desire", "wish" ],

    -- ;; {ibotigA'F_1
    -- <btgA'  {ibotigA'F      FW-Wa   with the aim of;for the purpose of     [[{ibotigA'F/ADV]]
    -- AbtgA'  {ibotigA'F      FW-Wa   with the aim of;for the purpose of     [[{ibotigA'F/ADV]]

    noun     IFtiCA' |< aN             {- {ibotigA'F -}     `gloss`  [ "with the aim of", "for the purpose of [ [ { ibotigA'F / ADV ] ]" ],
    ...
    noun     FACI                      {- bAgiy -}          -- `others` [ "bu.gA Nap", "bA.g Nuwn_Niyn NK" ]
    ...
    noun     MuFtaCY                   {- mubotagaY -}      -- `others` [ "mubta.gay NAt NAn_Nayn", "mubta.gA Nhy" ]
    ...
    noun     FUCAL |< aT               {- buwgAdap -}       -- `others` [ "buw.gA.d Nap" ]
                                                            `gloss`  [ "potash", "lye" ] ]
 ...
 |> "b .g r" <| [
    ...
    noun     FaCL |< aT                {- bagorap -}        `gloss`  [ "rain shower" ],
 ...
 |> "b .g t" <| [
    ...
    noun     FaCL |< aT                {- bagotap -}        -- `others` [ "ba.gat NAt" ]
                                                            `gloss`  [ "surprise", "surprises" ],

    -- ;; bagotiy~_1
    -- bgty    bagotiy~        N-ap    sudden;unexpected     [[bagotiy~/ADJ]]

    noun     FaCL |< Iy                {- bagotiy~ -}       `gloss`  [ "sudden", "unexpected [ [ bagotiy ~ / ADJ ] ]" ],

    -- ;; mubAgatap_1
    -- mbAgt   mubAgat NapAt   sudden arrival;surprise

    noun     MuFACaL |< aT             {- mubAgatap -}      `gloss`  [ "sudden arrival", "surprise" ],

    -- ;; bAgit_1
    -- bAgt    bAgit   N-ap    sudden;unexpected     [[bAgit/ADJ]]

    noun     FACiL                     {- bAgit -}          `gloss`  [ "sudden", "unexpected [ [ bAgit / ADJ ] ]" ],

    -- ;; mubAgit_1
    -- mbAgt   mubAgit Nall    sudden;unexpected     [[mubAgit/ADJ]]

    noun     MuFACiL                   {- mubAgit -}        `gloss`  [ "sudden", "unexpected [ [ mubAgit / ADJ ] ]" ] ]
 ...
 |> "b .g z" <| [
    ...
    noun     FUCAL                     {- buwgAz -}         -- `others` [ "bawA.giyz Ndip" ]
 ...
 |> "b .h .h" <| [
    ...
    verb     HaFaCL                    {- OabaH~ -}         -- `others` [ "'ab.ha.h PV_C", "bi.h.h IV_V_yu", "b.hi.h IV_C_yu" ]
                                                            `gloss`  [ "make hoarse" ],
    ...
    noun     FuCL |< aT                {- buH~ap -}         -- `others` [ "bu.huw.h Nap", "bu.hA.h N", "ba.hA.h Nap" ]
                                                            `gloss`  [ "hoarseness" ],
    ...
    noun     HaFaCL                    {- OabaH~ -}         -- `others` [ "ba.h.hA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "hoarse" ],
 ...
 |> "b .h _t r" <| [
    ...
    noun     KaRDaS |< aT              {- baHovarap -}      `gloss`  [ "waste", "dissipation" ],
 ...
 |> "b .h b .h" <| [
    ...
    noun     KuRDUS |< aT              {- buHobuwHap -}     -- `others` [ "ba.hAbiy.h Ndip" ]
 ...
 |> "b .h r" <| [
    ...
    noun     FaCL |< aT                {- baHorap -}        `gloss`  [ "pond", "pool" ],
    ...
    noun     FaCLAn |< Iy              {- baHorAniy~ -}     -- `others` [ "ba.hArin Nap" ]
                                                            `gloss`  [ "Bahraini [ [ baHorAniy ~ / NOUN ] ]", "Bahraini [ [ baHorAniy ~ / ADJ ] ]", "Bahrainis" ] ]
 ...
 |> "b .h r n" <| [
    ...
    noun     KaRDAS |< Iy              {- baHorAniy~ -}     -- `others` [ "ba.hArin Nap" ]
                                                            `gloss`  [ "Bahraini [ [ baHorAniy ~ / NOUN ] ]", "Bahraini [ [ baHorAniy ~ / ADJ ] ]", "Bahrainis" ] ]
 ...
 |> "b .h t" <| [
    ...
    noun     FaCL |< aN                {- baHotAF -}        -- `others` [ "ba.ht NF" ]
                                                            `gloss`  [ "purely", "exclusively [ [ baHot / ADV ] ]" ],

    -- ;; mubAHatap_1
    -- mbAHt   mubAHat NapAt   promise

    noun     MuFACaL |< aT             {- mubAHatap -}      `gloss`  [ "promise" ] ]
 ...
 |> "b .h t r" <| [
    ...
    noun     KuRDuS                    {- buHotur -}        `gloss`  [ "stocky", "pudgy" ],

    -- ;; buHoturiy~_1
    -- bHtry   buHoturiy~      N0      Buhturi

    noun     KuRDuS |< Iy              {- buHoturiy~ -}     `gloss`  [ "Buhturi" ],

    -- ;; buHoturiy~_2
    -- bHtry   buHoturiy~      Nall    stocky;pudgy     [[buHoturiy~/ADJ]]

    noun     KuRDuS |< Iy              {- buHoturiy~ -}     `gloss`  [ "stocky", "pudgy [ [ buHoturiy ~ / ADJ ] ]" ] ]
 ...
 |> "b .s .s" <| [
    ...
    noun     FaCL |< aT                {- baS~ap -}         `gloss`  [ "embers" ],
 ...
 |> "b .s _h" <| [
    ...
    noun     FaCaL |< aT               {- baSaxap -}        `gloss`  [ "Easter", "Passion Week" ] ]
 ...
 |> "b .s b .s" <| [
    ...
    noun     KaRDaS |< aT              {- baSobaSap -}      `gloss`  [ "wagging" ],

    -- ;; baSobaSap_2
    -- bSbS    baSobaS Nap     ogling;staring

    noun     KaRDaS |< aT              {- baSobaSap -}      `gloss`  [ "ogling", "staring" ] ]
 ...
 |> "b .s l" <| [
    ...
    noun     FuCayL |< aT              {- buSayolap -}      `gloss`  [ "bulb", "small onion" ] ]
 ...
 |> "b .s q" <| [
    ...
    noun     FuCAL                     {- buSAq -}          `gloss`  [ "spit", "saliva" ],

    -- ;; miboSaqap_1
    -- mbSq    miboSaq Nap     spittoon
    -- mbASq   mabASiq Ndip    spittoons

    noun     MiFCaL |< aT              {- miboSaqap -}      -- `others` [ "mabA.siq Ndip" ]
 ...
 |> "b .s r" <| [
    ...
    verb     HaFCaL                    {- OaboSar -}        -- `others` [ "b.sir IV_yu" ]
                                                            `gloss`  [ "see", "notice" ],
    ...
    noun     HaFCAL                    {- OaboSAr -}        `gloss`  [ "perceptions", "views", "glances" ],
    ...
    noun     FaCAL |< aT               {- baSArap -}        `gloss`  [ "perception" ],
    ...
    noun     FaCIL |< aT               {- baSiyrap -}       -- `others` [ "ba.sA'ir Ndip" ]
    ...
    noun     FACiL |< aT               {- bASirap -}        -- `others` [ "bawA.sir Ndip" ]
                                                            `gloss`  [ "eye", "eyes" ],
    ...
    noun     FiCAL |< aT               {- biSArap -}        -- `others` [ "bu.sAr Nap" ]
                                                            `gloss`  [ "porridge" ] ]
 ...
 |> "b .s w" <| [
    ...
    noun     FaCL |< aT                {- baSowap -}        -- `others` [ "ba.saw NAt" ]
                                                            `gloss`  [ "ember", "embers" ] ]
 ...
 |> "b .t '" <| [
    ...
    verb     FaCuL                     {- baTuW-u -}        `imperf` [ FCuL ]
    ...
    verb     FaCCaL                    {- baT~aO -}         -- `others` [ "ba.t.ti' IV_yu", "ba.t.ta'A PV-|" ]
    ...
    verb     HaFCaL                    {- OaboTaO -}        -- `others` [ "'ab.ta'A PV-|", "b.ta' IV_Pass_yu", "b.ti' IV_yu" ]
    ...
    verb     TaFaCCaL                  {- tabaT~aO -}       -- `others` [ "taba.t.ta'A PV-|_intr IV-|" ]
                                                            `gloss`  [ "be slow", "be late" ],
    ...
    verb     TaFACaL                   {- tabATaO -}        -- `others` [ "tabA.ta'A PV-|_intr IV-|" ]
                                                            `gloss`  [ "be slow", "be late" ],
    ...
    verb     IstaFCaL                  {- {isotaboTaO -}    -- `others` [ "stab.ti' IV", "istab.ta'A PV-|" ]
    ...
    noun     HaFCaL                    {- OaboTaO -}        -- `others` [ "'ab.ta'A N-|" ]
    ...
    noun     TaFCiL |< aT              {- taboTi}ap -}      `gloss`  [ "delaying", "slowing down" ],
 ...
 |> "b .t .h" <| [
    ...
    noun     HaFCaL                    {- OaboTaH -}        `gloss`  [ "flat", "level" ],

    -- ;; baTiyHap_1
    -- bTyH    baTiyH  Napdu   wide valley;plain
    -- bTA}H   baTA}iH Ndip    wide valley;plain

    noun     FaCIL |< aT               {- baTiyHap -}       -- `others` [ "ba.tA'i.h Ndip" ]
 ...
 |> "b .t .t" <| [
    ...
    noun     MiFaCL                    {- mibaT~ -}         `gloss`  [ "scalpel" ],

    -- ;; mibaT~ap_1
    -- mbT     mibaT~  Napdu   scalpel

    noun     MiFaCL |< aT              {- mibaT~ap -}       `gloss`  [ "scalpel" ],
 ...
 |> "b .t ^s" <| [
    ...
    noun     FaCL |< aT                {- baTo$ap -}        -- `others` [ "ba.ta^s NAt" ]
 ...
 |> "b .t b .t" <| [
    ...
    noun     KaRDaS |< aT              {- baTobaTap -}      `gloss`  [ "quacking" ] ]
 ...
 |> "b .t k" <| [
    ...
    noun     FACI |< aT                {- bATiyap -}        -- `others` [ "bawA.t NK", "bawA.tiy N0_Nh" ]
 ...
 |> "b .t l" <| [
    ...
    verb     HaFCaL                    {- OaboTal -}        -- `others` [ "b.til IV_yu" ]
 ...
 |> "b .t l s" <| [
    ...
    noun     KaRADiS |< aT             {- baTAlisap -}      `gloss`  [ "Ptolemies" ] ]
 ...
 |> "b .t m" <| [
    ...
    noun     FuCL |< Iy                {- buTomiy~ -}       `gloss`  [ "terebinths [ [ buTomiy ~ / NOUN ] ]" ] ]
 ...
 |> "b .t n" <| [
    ...
    verb     HaFCaL                    {- OaboTan -}        -- `others` [ "b.tan IV-n_Pass_yu", "b.tin IV-n_yu" ]
    ...
    noun     FaCL |< Iy                {- baToniy~ -}       `gloss`  [ "abdominal", "belly [ [ baToniy ~ / ADJ ] ]" ],

    -- ;; biTonap_1
    -- bTn     biTon   Nap     gluttony

    noun     FiCL |< aT                {- biTonap -}        `gloss`  [ "gluttony" ],
    ...
    noun     FaCAL |< aT               {- baTAnap -}        -- `others` [ "bi.tAn Nap" ]
                                                            `gloss`  [ "lining", "inside" ],
    ...
    noun     FACiL |< Iy               {- bATiniy~ -}       `gloss`  [ "interior", "internal [ [ bATiniy ~ / ADJ ] ]" ],
    ...
    noun     IstiFCAL |< Iy            {- {isotiboTAniy~ -} `gloss`  [ "introspective [ [ { isotiboTAniy ~ / ADJ ] ]" ],

    -- ;; bATuwn_1
    -- bATwn   bATuwn  N       concrete

    noun     FACUL                     {- bATuwn -}         `gloss`  [ "concrete" ] ]
 ...
 |> "b .t r" <| [
    ...
    verb     HaFCaL                    {- OaboTar -}        -- `others` [ "b.tir IV_yu" ]
 ...
 |> "b .t r k" <| [
    ...
    noun     KaRDaS |< Iy |< aT        {- baTorakiy~ap -}   `gloss`  [ "patriarchate [ [ baTorakiy ~ / NOUN ] ]" ],

    -- ;; baTorakap_1
    -- bTrk    baTorak Nap     patriarchate

    noun     KaRDaS |< aT              {- baTorakap -}      `gloss`  [ "patriarchate" ] ]
 ...
 |> "b .t r s" <| [
    ...
    noun     KuRDuS |< Iy              {- buTorusiy~ -}     `gloss`  [ "St. Peter [ [ buTorusiy ~ / ADJ ] ]" ] ]
 ...
 |> "b .t y" <| [
    ...
    noun     FACiL |< aT               {- bATiyap -}        -- `others` [ "bawA.t NK", "bawA.tiy N0_Nh" ]
                                                            `gloss`  [ "pitcher", "jug", "pitchers", "jugs" ] ]
 ...
 |> "b ^g d" <| [
    ...
    noun     FaCL |< aT                {- bajodap -}        `gloss`  [ "heart", "essence", "source" ],

    -- ;; bijAdiy~_1
    -- bjAdy   bijAdiy~        N-ap    garnet     [[bijAdiy~/ADJ]]

    noun     FiCAL |< Iy               {- bijAdiy~ -}       `gloss`  [ "garnet [ [ bijAdiy ~ / ADJ ] ]" ] ]
 ...
 |> "b ^g r" <| [
    ...
    noun     HaFCaL                    {- Oabojar -}        `gloss`  [ "obese", "corpulent" ] ]
 ...
 |> "b ^s ^s" <| [
    ...
    noun     FaCAL |< aT               {- ba$A$ap -}        `gloss`  [ "gaiety", "smile" ],

    -- ;; bA$~_1
    -- bA$     bA$~    Nall    smiling;happy

    noun     FACL                      {- bA$~ -}           `gloss`  [ "smiling", "happy" ] ]
 ...
 |> "b ^s k" <| [
    ...
    verb     IFtaCaL                   {- {ibota$ak -}      -- `others` [ "bta^sik IV" ]
                                                            `gloss`  [ "lie", "deceive" ],
 ...
 |> "b ^s m" <| [
    ...
    verb     HaFCaL                    {- Oabo$am -}        -- `others` [ "b^sim IV_yu" ]
 ...
 |> "b ^s m r" <| [
    ...
    noun     KaRADiS |< Iy             {- ba$Amiriy~ -}     `gloss`  [ "laceworker [ [ ba $ Amiriy ~ / ADJ ] ]" ] ]
 ...
 |> "b ^s n" <| [
    ...
    noun     FaCL |< aT                {- ba$onap -}        `gloss`  [ "sorghum" ] ]
 ...
 |> "b ^s n q" <| [
    ...
    noun     KaRDUS |< aT              {- ba$onuwqap -}     -- `others` [ "ba^sniyq Nap", "ba^sAniq Ndip" ]
 ...
 |> "b ^s r" <| [
    ...
    noun     FuCL |< aT                {- bu$orap -}        -- `others` [ "bu^srY N0", "bu^sray NAt NAn_Nayn", "bu^srA Nhy" ]
                                                            `gloss`  [ "good news" ],
    ...
    noun     FiCAL |< aT               {- bi$Arap -}        -- `others` [ "ba^sA'ir Ndip" ]
                                                            `gloss`  [ "good news" ],
    ...
    noun     TaFCIL |< Iy              {- tabo$iyriy~ -}    `gloss`  [ "missionary [ [ tabo $ iyriy ~ / ADJ ] ]" ],
    ...
    noun     MiFCaL |< aT              {- mibo$arap -}      -- `others` [ "mabA^sir Ndip" ]
    ...
    noun     MuFACaL |< aT |< aN       {- mubA$arapF -}     `gloss`  [ "directly", "immediately [ [ mubA $ arapF / ADV ] ]" ],
 ...
 |> "b ^s s" <| [
    ...
    noun     FACY |< Iy                {- bA$awiy~ -}       `gloss`  [ "rank of pasha [ [ bA $ awiy ~ / ADJ ] ]" ] ]
 ...
 |> "b ^s t" <| [
    ...
    noun     FiCL |< aT                {- bi$otap -}        `gloss`  [ "cloak" ] ]
 ...
 |> "b ^s t n" <| [
    ...
    noun     KaRDUS                    {- ba$otuwn -}       -- `others` [ "bA^stuwn N0" ]
                                                            `gloss`  [ "Pashtun [ [ ba $ otuwn / NOUN ] ]", "Pashtun [ [ ba $ otuwn / ADJ ] ]" ] ]
 ...
 |> "b _d '" <| [
    ...
    verb     FaCaL                     {- ba*aO-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "ba_da'A PV-|", "b_da' IV IV_wn IV_yn", "b_da'A IV-|" ]
                                                            `gloss`  [ "revile", "abuse" ],
    ...
    noun     FaCIL                     {- ba*iy' -}         `gloss`  [ "disgusting", "obscene [ [ ba*iy ' / ADJ ] ]", "obscene" ],
 ...
 |> "b _d _d" <| [
    ...
    noun     FaCAL |< aT               {- ba*A*ap -}        `gloss`  [ "slovenliness", "squalor" ] ]
 ...
 |> "b _d r" <| [
    ...
    noun     FuCayL |< aT              {- bu*ayorap -}      `gloss`  [ "germ", "seed" ],
 ...
 |> "b _d s" <| [
    ...
    noun     FaCA'                     {- ba*A' -}          `gloss`  [ "obscenity", "contempt" ] ]
 ...
 |> "b _h _h" <| [
    ...
    noun     FuCayL |< aT              {- buxayoxap -}      `gloss`  [ "squirt", "syringe" ],

    -- ;; mibax~ap_1
    -- mbx     mibax~  NapAt   nozzle;sprayer

    noun     MiFaCL |< aT              {- mibax~ap -}       `gloss`  [ "nozzle", "sprayer" ] ]
 ...
 |> "b _h l" <| [
    ...
    noun     MaFCaL |< aT              {- maboxalap -}      `gloss`  [ "avarice" ] ]
 ...
 |> "b _h n q" <| [
    ...
    noun     KuRDuS                    {- buxonuq -}        -- `others` [ "ba_hAniq Ndip" ]
 ...
 |> "b _h q" <| [
    ...
    noun     HaFCaL                    {- Oaboxaq -}        -- `others` [ "ba_hqA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "one-eyed" ] ]
 ...
 |> "b _h r" <| [
    ...
    noun     FuCAL |< Iy               {- buxAriy~ -}       `gloss`  [ "Bukhari" ],
    ...
    noun     HaFCaL                    {- Oaboxar -}        `gloss`  [ "foul-breathed" ],

    -- ;; miboxarap_1
    -- mbxr    miboxar Napdu   fumigator;censer
    -- mbAxr   mabAxir Ndip    fumigators;censers

    noun     MiFCaL |< aT              {- miboxarap -}      -- `others` [ "mabA_hir Ndip" ]
 ...
 |> "b _h s" <| [
    ...
    noun     HaFCaL                    {- Oaboxas -}        `gloss`  [ "smaller", "lower" ],
    ...
    verb     FaCA                      {- baxA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "ba_haw PV_Atn", "b_h IV_0hwnyn", "ba_h PV_ttAw", "b_huw IV_0hAnn" ]
                                                            `gloss`  [ "abate", "subside" ] ]
 ...
 |> "b _h t r" <| [
    ...
    noun     KaRDaS |< aT              {- baxotarap -}      `gloss`  [ "swaggering", "strutting" ],
 ...
 |> "b ` .d" <| [
    ...
    noun     TaFCIL |< Iy              {- taboEiyDiy~ -}    `gloss`  [ "divisive [ [ taboEiyDiy ~ / ADJ ] ]" ],
 ...
 |> "b ` _t" <| [
    ...
    noun     FACUL                     {- bAEuwv -}         `gloss`  [ "Easter" ],
 ...
 |> "b ` b `" <| [
    ...
    noun     KuRDuS                    {- buEobuE -}        -- `others` [ "ba`Abi` Ndip" ]
 ...
 |> "b ` d" <| [
    ...
    noun     HaFCAL |< Iy |< aT        {- OaboEAdiy~ap -}   `gloss`  [ "country estate [ [ >aboEAdiy ~ / NOUN ] ]" ],
    ...
    noun     MuFACaL |< aT             {- mubAEadap -}      `gloss`  [ "alienation", "sowing dissent" ],
    ...
    noun     MaFCaL |< aT              {- maboEadap -}      `gloss`  [ "distance", "remoteness" ] ]
 ...
 |> "b ` l" <| [
    ...
    noun     FaCL |< aT                {- baEolap -}        -- `others` [ "ba`al NAt" ]
                                                            `gloss`  [ "wife", "wives" ],
 ...
 |> "b ` z q" <| [
    ...
    noun     KaRDaS |< aT              {- baEozaqap -}      `gloss`  [ "scattering", "squandering" ],
 ...
 |> "b b _h" <| [
    ...
    noun     CaL                       {- bax -}            `gloss`  [ "bravo ! [ [ bax / INTERJ ] ]" ] ]
 ...
 |> "b b h" <| [
    ...
    noun     CaL |< Iy                 {- bahiy~ -}         `gloss`  [ "beautiful", "brilliant [ [ bahiy ~ / ADJ ] ]" ] ]
 ...
 |> "b d '" <| [
    ...
    verb     FACaL                     {- bAdaO -}          -- `others` [ "bAda'A PV-|", "bAdi' IV_yu" ]
                                                            `gloss`  [ "initiate", "lead" ],
    ...
    verb     HaFCaL                    {- OabodaO -}        -- `others` [ "'abda'A PV-|", "bdi' IV_yu" ]
    ...
    verb     IFtaCaL                   {- {ibotadaO -}      -- `others` [ "btadi' IV", "ibtada'A PV-|" ]
                                                            `gloss`  [ "begin", "start" ],
    ...
    noun     FaCL |< aT                {- badoOap -}        `gloss`  [ "beginning", "start" ],

    -- ;; badiy}ap_1
    -- bdy}    badiy}  Napdu   beginning;start

    noun     FaCIL |< aT               {- badiy}ap -}       `gloss`  [ "beginning", "start" ],

    -- ;; badA'ap_1
    -- bdA'    badA'   NapAt   beginning;start

    noun     FaCAL |< aT               {- badA'ap -}        `gloss`  [ "beginning", "start" ],

    -- ;; badA}iy~_1
    -- bdA}y   badA}iy~        Nall    initial;original     [[badA}iy~/ADJ]]

    noun     FaCAL |< Iy               {- badA}iy~ -}       `gloss`  [ "initial", "original [ [ badA } iy ~ / ADJ ] ]" ],
    ...
    noun     FaCAL |< Iy |< aT         {- badA}iy~ap -}     -- `others` [ "bidA'iyy Nap" ]
                                                            `gloss`  [ "primitiveness [ [ badA } iy ~ / NOUN ] ]", "primitiveness [ [ bidA } iy ~ / NOUN ] ]" ],
    ...
    noun     MaFCaL |< Iy |< aN        {- maboda}iy~AF -}   -- `others` [ "mabda'iyy NF" ]
                                                            `gloss`  [ "in principle [ [ maboda } iy ~ / ADV ] ]", "in principle [ [ maboda>iy ~ / ADV ] ]" ],
    ...
    noun     IFtiCAL |< aN             {- {ibotidA'F -}     `gloss`  [ "beginning from", "as of [ [ { ibotidA'F / ADJ ] ]" ],
    ...
    noun     IFtiCAL |< Iy             {- {ibotidA}iy~ -}   `gloss`  [ "elementary", "preparatory [ [ { ibotidA } iy ~ / ADJ ] ]" ],
    ...
    noun     MuFtaCaL                  {- mubotadaO -}      -- `others` [ "mubtada N-|t", "mubtada'A N-|" ]
 ...
 |> "b d ' h" <| [
    ...
    noun     KaRADiS                   {- badA}ih -}        `gloss`  [ "self-evident truths" ] ]
 ...
 |> "b d `" <| [
    ...
    noun     HaFCAL                    {- OabodAE -}        `gloss`  [ "wonders", "novelties" ],
    ...
    noun     FaCIL |< Iy               {- badiyEiy~ -}      `gloss`  [ "rhetorical [ [ badiyEiy ~ / ADJ ] ]" ],

    -- ;; >abodaE_2
    -- >bdE    >abodaE Nel     more/most amazing
    -- AbdE    >abodaE Nel     more/most amazing

    noun     HaFCaL                    {- OabodaE -}        `gloss`  [ "more / most amazing" ],
    ...
    noun     IFtiCAL |< Iy             {- {ibotidAEiy~ -}   `gloss`  [ "innovative [ [ { ibotidAEiy ~ / ADJ ] ]" ],
 ...
 |> "b d d" <| [
    ...
    noun     IstiFCAL |< Iy            {- {isotibodAdiy~ -} `gloss`  [ "arbitrary", "authoritarian [ [ { isotibodAdiy ~ / ADJ ] ]" ],
    ...
    noun     IstiFCAL |< Iy |< aT      {- {isotibodAdiy~ap -} `gloss`  [ "authoritarianism", "autocracy [ [ { isotibodAdiy ~ / NOUN ] ]" ],
 ...
 |> "b d h" <| [
    ...
    noun     FaCAL |< aT               {- badAhap -}        `gloss`  [ "spontaneity" ],

    -- ;; badAhapF_1
    -- bdAhp   badAhapF        FW-Wa   spontaneously    [[badAhapF/ADV]]

    noun     FaCAL |< aT |< aN         {- badAhapF -}       `gloss`  [ "spontaneously [ [ badAhapF / ADV ] ]" ],

    -- ;; badiyhap_1
    -- bdyh    badiyh  NapAt   intuitive grasp

    noun     FaCIL |< aT               {- badiyhap -}       `gloss`  [ "intuitive grasp" ],
 ...
 |> "b d l" <| [
    ...
    verb     HaFCaL                    {- Oabodal -}        -- `others` [ "bdil IV_yu" ]
    ...
    noun     FaCaL |< Iy |< aT         {- badaliy~ap -}     `gloss`  [ "compensation [ [ badaliy ~ / NOUN ] ]" ],
    ...
    noun     HiFCAL                    {- IibodAl -}        `gloss`  [ "substitute", "replace" ],

    -- ;; <ibodAl_2
    -- <bdAl   <ibodAl NduAt   substitution;replacement
    -- AbdAl   <ibodAl NduAt   substitution;replacement

    noun     HiFCAL                    {- IibodAl -}        `gloss`  [ "substitution", "replacement" ],
 ...
 |> "b d n" <| [
    ...
    noun     FuCUL |< aT               {- buduwnap -}       `gloss`  [ "corpulence", "obesity" ],
 ...
 |> "b d r" <| [
    ...
    noun     FaCL |< aT                {- badorap -}        -- `others` [ "bidAr N", "badar NAt" ]
    ...
    noun     FiCAL |< aN               {- bidArAF -}        -- `others` [ "bidAr NF" ]
                                                            `gloss`  [ "quickly", "hastily [ [ bidAr / ADV ] ]" ],
 ...
 |> "b d s" <| [
    ...
    noun     FaCA' |< aT               {- badA'ap -}        `gloss`  [ "beginning", "start" ],

    -- ;; badA}iy~_1
    -- bdA}y   badA}iy~        Nall    initial;original     [[badA}iy~/ADJ]]

    noun     FaCA' |< Iy               {- badA}iy~ -}       `gloss`  [ "initial", "original [ [ badA } iy ~ / ADJ ] ]" ],
    ...
    noun     FaCA' |< Iy |< aT         {- badA}iy~ap -}     -- `others` [ "bidA'iyy Nap" ]
                                                            `gloss`  [ "primitiveness [ [ badA } iy ~ / NOUN ] ]", "primitiveness [ [ bidA } iy ~ / NOUN ] ]" ],
    ...
    noun     IFtiCA'                   {- {ibotidA' -}      `gloss`  [ "beginning", "start", "starts" ],

    -- ;; {ibotidA'F_1
    -- <btdA'  {ibotidA'F      FW-Wa   beginning from;as of     [[{ibotidA'F/ADJ]]
    -- AbtdA'  {ibotidA'F      FW-Wa   beginning from;as of     [[{ibotidA'F/ADJ]]

    noun     IFtiCA' |< aN             {- {ibotidA'F -}     `gloss`  [ "beginning from", "as of [ [ { ibotidA'F / ADJ ] ]" ],

    -- ;; {ibotidA}iy~_1
    -- <btdA}y {ibotidA}iy~    Nall    elementary;preparatory     [[{ibotidA}iy~/ADJ]]
    -- AbtdA}y {ibotidA}iy~    Nall    elementary;preparatory     [[{ibotidA}iy~/ADJ]]

    noun     IFtiCA' |< Iy             {- {ibotidA}iy~ -}   `gloss`  [ "elementary", "preparatory [ [ { ibotidA } iy ~ / ADJ ] ]" ],
    ...
    noun     FaCY |< aT                {- badAp -}          -- `others` [ "badaw NAt" ]
    ...
    noun     FaCY |< Iy                {- badawiy~ -}       -- `others` [ "budA Nap", "badw N" ]
 ...
 |> "b d w" <| [
    ...
    noun     FaCAL |< aT               {- badAwap -}        -- `others` [ "bidAw Nap" ]
 ...
 |> "b d y" <| [
    ...
    noun     FACiL |< aT               {- bAdiyap -}        `gloss`  [ "desert" ],
 ...
 |> "b f t" <| [
    ...
    noun     FaCL |< aT                {- bafotap -}        `gloss`  [ "calico" ] ]
 ...
 |> "b h '" <| [
    ...
    noun     FaCAL                     {- bahA' -}          `gloss`  [ "beauty", "brilliancy" ],
 ...
 |> "b h (" <| [
    ...
    noun     MuFACY |< aT              {- mubAhAp -}        `gloss`  [ "pride", "boastfulness" ],
    ...
    noun     TaFACI                    {- tabAhiy -}        -- `others` [ "tabAh NK" ]
    ...
    noun     MutaFACI                  {- mutabAhiy -}      -- `others` [ "mutabAh Nuwn_Niyn NK" ]
 ...
 |> "b h .z" <| [
    ...
    verb     HaFCaL                    {- OabohaZ -}        -- `others` [ "bha.z IV_Pass_yu", "bhi.z IV_yu" ]
 ...
 |> "b h ^g" <| [
    ...
    verb     HaFCaL                    {- Oabohaj -}        -- `others` [ "bhi^g IV_yu", "bha^g IV_Pass_yu" ]
    ...
    noun     MaFCaL |< aT              {- mabohajap -}      -- `others` [ "mabAhi^g Ndip" ]
 ...
 |> "b h d l" <| [
    ...
    noun     KaRDaS |< aT              {- bahodalap -}      `gloss`  [ "insult", "affront" ],
 ...
 |> "b h l" <| [
    ...
    noun     HaFCaL                    {- Oabohal -}        `gloss`  [ "savin", "savine ( evergreen shrub )" ],

    -- ;; mubAhalap_1
    -- mbAhl   mubAhal Nap     cursing

    noun     MuFACaL |< aT             {- mubAhalap -}      `gloss`  [ "cursing" ],
 ...
 |> "b h m" <| [
    ...
    verb     HaFCaL                    {- Oaboham -}        -- `others` [ "bhim IV_yu", "bham IV_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- bahomap -}        `gloss`  [ "sheep" ],
 ...
 |> "b h q" <| [
    ...
    noun     HaFCaL                    {- Oabohaq -}        -- `others` [ "bahqA' N0" ]
                                                            `gloss`  [ "herpetic" ] ]
 ...
 |> "b h r" <| [
    ...
    verb     HaFCaL                    {- Oabohar -}        -- `others` [ "bhir IV_yu", "bhar IV_Pass_yu" ]
 ...
 |> "b h r ^g" <| [
    ...
    noun     KaRDaS |< aT              {- bahorajap -}      `gloss`  [ "hollow pomp" ],
 ...
 |> "b h t" <| [
    ...
    verb     HaFCaL                    {- Oabohat -}        -- `others` [ "bhit IV_yu", "bhat IV_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- bahotap -}        `gloss`  [ "amazement" ],
 ...
 |> "b h t r" <| [
    ...
    noun     KaRDaS |< aT              {- bahotarap -}      `gloss`  [ "lying" ] ]
 ...
 |> "b h y" <| [
    ...
    verb     FaCiL                     {- bahiy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "bhY IV_0", "bah PV_w_intr", "bha IV_0hwnyn", "bhay IV_Ann" ]
                                                            `gloss`  [ "be beautiful" ],
 ...
 |> "b h z" <| [
    ...
    noun     FaCL |< aT                {- bahozap -}        -- `others` [ "bahaz NAt" ]
 ...
 |> "b k '" <| [
    ...
    noun     FaCIL                     {- bakiy' -}         -- `others` [ "bikA' N0" ]
                                                            `gloss`  [ "sparing", "sparce [ [ bakiy ' / ADJ ] ]", "sparce" ],
    ...
    noun     MaFCY                     {- mabokaY -}        -- `others` [ "mabkA Nhy" ]
                                                            `gloss`  [ "wailing" ],
    ...
    noun     MuFaCCI                   {- mubak~iy -}       -- `others` [ "mubkiy N0F_Nh NapAt NAn_Nayn", "mubakk Nuwn_Niyn NK", "mubk Nuwn_Niyn NK" ]
 ...
 |> "b k b ^s" <| [
    ...
    noun     KiRDAS |< Iy              {- bikobA$iy~ -}     `gloss`  [ "lieutenant colonel [ [ bikobA $ iy ~ / ADJ ] ]" ] ]
 ...
 |> "b k l" <| [
    ...
    noun     FuCL |< aT                {- bukolap -}        -- `others` [ "bukal N" ]
                                                            `gloss`  [ "clasp", "clasps" ] ]
 ...
 |> "b k m" <| [
    ...
    verb     HaFCaL                    {- Oabokam -}        -- `others` [ "bkim IV_yu", "bkam IV_Pass_yu" ]
    ...
    noun     HaFCaL                    {- Oabokam -}        -- `others` [ "bukm N", "bakmA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "silent", "mute" ] ]
 ...
 |> "b k r" <| [
    ...
    verb     HaFCaL                    {- Oabokar -}        -- `others` [ "bkir IV_intr_yu" ]
    ...
    noun     FiCL                      {- bikor -}          -- `others` [ "'abkAr N" ]
                                                            `gloss`  [ "eldest", "first-born [ [ bikor / ADJ ] ]", "first-born [ [ >abokAr / ADJ ] ]" ],

    -- ;; bikoriy~_1
    -- bkry    bikoriy~        Nall    first-born     [[bikoriy~/ADJ]]

    noun     FiCL |< Iy                {- bikoriy~ -}       `gloss`  [ "first-born [ [ bikoriy ~ / ADJ ] ]" ],
    ...
    noun     FuCL |< aT                {- bukorap -}        `gloss`  [ "tomorrow" ],
    ...
    noun     FaCAL |< aT               {- bakArap -}        `gloss`  [ "virginity" ],

    -- ;; bak~Arap_1
    -- bkAr    bak~Ar  NapAt   pulley

    noun     FaCCAL |< aT              {- bak~Arap -}       `gloss`  [ "pulley" ],

    -- ;; bukuwrap_1
    -- bkwr    bukuwr  Nap     primogeniture
    -- bkwry   bukuwriy~       Nap     primogeniture     [[bukuwriy~/NOUN]]

    noun     FuCUL |< aT               {- bukuwrap -}       -- `others` [ "bukuwriyy Nap" ]
                                                            `gloss`  [ "primogeniture", "primogeniture [ [ bukuwriy ~ / NOUN ] ]" ],

    -- ;; bAkuwrap_1
    -- bAkwr   bAkuwr  Nap     first works
    -- bwAkyr  bawAkiyr        Ndip    first works

    noun     FACUL |< aT               {- bAkuwrap -}       -- `others` [ "bawAkiyr Ndip" ]
                                                            `gloss`  [ "first works" ],
    ...
    noun     HaFCaL                    {- Oabokar -}        `gloss`  [ "earlier / earliest" ],
    ...
    noun     IFtiCAL |< Iy             {- {ibotikAriy~ -}   `gloss`  [ "original", "inventive [ [ { ibotikAriy ~ / ADJ ] ]" ],
    ...
    noun     IFtiCAL |< Iy |< aT       {- {ibotikAriy~ap -} `gloss`  [ "originality", "inventiveness [ [ { ibotikAriy ~ / NOUN ] ]" ],
    ...
    noun     FACiL |< aT               {- bAkirap -}        -- `others` [ "bawAkir Ndip" ]
    ...
    noun     FICAL                     {- biykAr -}         `gloss`  [ "compass", "dividers" ] ]
 ...
 |> "b k t r" <| [
    ...
    noun     KaRDIS |< Iy              {- bakotiyriy~ -}    `gloss`  [ "bacterial [ [ bakotiyriy ~ / ADJ ] ]" ] ]
 ...
 |> "b k y" <| [
    ...
    verb     FaCiL                     {- bakiy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "bkY IV_0", "bak PV_w", "bka IV_0hwnyn", "bkay IV_Ann", "bkA IV_h" ]
                                                            `gloss`  [ "mourn" ],
 ...
 |> "b l '" <| [
    ...
    noun     FaCAL                     {- balA' -}          `gloss`  [ "tribulation", "affliction" ],
    ...
    noun     IFtiCAL                   {- {ibotilA' -}      `gloss`  [ "affliction", "tribulation", "afflictions", "tribulations" ] ]
 ...
 |> "b l .g" <| [
    ...
    noun     FuCL |< aT                {- bulogap -}        `gloss`  [ "competency", "adequacy" ],
    ...
    noun     FuCL |< aT                {- bulogap -}        -- `others` [ "bula.g N" ]
 ...
 |> "b l .g m" <| [
    ...
    noun     KaRDaS |< Iy              {- balogamiy~ -}     `gloss`  [ "mucous", "phlegmy [ [ balogamiy ~ / ADJ ] ]" ] ]
 ...
 |> "b l .t" <| [
    ...
    noun     FaCAL |< aT               {- balATap -}        -- `others` [ "'abli.t Nap", "balA.t N" ]
    ...
    noun     FaCCUL |< aT              {- bal~uwTap -}      `gloss`  [ "acorn", "oak" ],
    ...
    noun     FaCL |< aT                {- baloTap -}        -- `others` [ "bula.t N", "bala.t NAt" ]
                                                            `gloss`  [ "ax", "axes" ] ]
 ...
 |> "b l .t ^g" <| [
    ...
    noun     KaRDaS |< Iy              {- baloTajiy~ -}     `gloss`  [ "ruffian [ [ baloTajiy ~ / ADJ ] ]" ] ]
 ...
 |> "b l .z" <| [
    ...
    noun     FACUL |< aT               {- bAluwZap -}       `gloss`  [ "cream" ] ]
 ...
 |> "b l ^g" <| [
    ...
    verb     HaFCaL                    {- Oabolaj -}        -- `others` [ "bli^g IV_yu" ]
                                                            `gloss`  [ "dawn", "shine" ],
    ...
    noun     HaFCaL                    {- Oabolaj -}        `gloss`  [ "bright", "beautiful" ],
 ...
 |> "b l ^s f" <| [
    ...
    noun     KaRDaS |< aT              {- balo$afap -}      `gloss`  [ "Bolshevization" ],
    ...
    noun     KaRDaS |< Iy |< aT        {- balo$afiy~ap -}   `gloss`  [ "Bolshevism [ [ balo $ afiy ~ / NOUN ] ]" ] ]
 ...
 |> "b l `" <| [
    ...
    verb     HaFCaL                    {- OabolaE -}        -- `others` [ "bli` IV_yu", "bla` IV_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- baloEap -}        `gloss`  [ "gulp" ],
    ...
    noun     FaCCAL |< aT              {- bal~AEap -}       -- `others` [ "balAliy` Ndip", "balluw` NapAt" ]
    ...
    noun     FACUL                     {- bAluwE -}         -- `others` [ "bawAliy` Ndip" ]
 ...
 |> "b l ` m" <| [
    ...
    noun     KuRDuS                    {- buloEum -}        -- `others` [ "balA`im Ndip" ]
 ...
 |> "b l b l" <| [
    ...
    noun     KuRDuS                    {- bulobul -}        -- `others` [ "balAbil Ndip" ]
 ...
 |> "b l d" <| [
    ...
    noun     HaFCaL                    {- Oabolad -}        `gloss`  [ "stupid" ],
 ...
 |> "b l f r" <| [
    ...
    noun     KaRDUS |< Iy              {- balofuwriy~ -}    `gloss`  [ "Balfour [ [ balofuwriy ~ / ADJ ] ]" ] ]
 ...
 |> "b l h" <| [
    ...
    noun     HaFCaL                    {- Oabolah -}        -- `others` [ "balhA' Nh Nhy N0_Nh", "bulh N" ]
                                                            `gloss`  [ "doltish", "dumb" ] ]
 ...
 |> "b l l" <| [
    ...
    verb     HaFaCL                    {- Oabal~ -}         -- `others` [ "blil IV_C_yu", "'ablal PV_C", "bill IV_V_yu" ]
    ...
    noun     FaCIL |< aT               {- baliylap -}       `gloss`  [ "porridge" ],

    -- ;; <ibolAl_1
    -- <blAl   <ibolAl NduAt   recovery;convalescence
    -- AblAl   <ibolAl NduAt   recovery;convalescence

    noun     HiFCAL                    {- IibolAl -}        `gloss`  [ "recovery", "convalescence" ],
 ...
 |> "b l m" <| [
    ...
    verb     HaFCaL                    {- Oabolam -}        -- `others` [ "blim IV_intr_yu" ]
                                                            `gloss`  [ "be silent" ],
    ...
    noun     HaFCAL                    {- OabolAm -}        `gloss`  [ "sailing barges" ] ]
 ...
 |> "b l m r" <| [
    ...
    noun     KaRDaS |< aT              {- balomarap -}      `gloss`  [ "polymerization" ] ]
 ...
 |> "b l n" <| [
    ...
    noun     FACUL                     {- bAluwn -}         `gloss`  [ "balloon" ],

    -- ;; bal~An_1
    -- blAn    bal~An  N/ap    bath-maid

    noun     FaCCAL                    {- bal~An -}         `gloss`  [ "bath-maid" ],
 ...
 |> "b l q" <| [
    ...
    noun     HaFCaL                    {- Oabolaq -}        -- `others` [ "balqA' N0_Nh" ]
    ...
    noun     FaCLAn |< Iy              {- baloqAniy~ -}     `gloss`  [ "Balkan [ [ baloqAniy ~ / NOUN ] ]", "Balkan [ [ baloqAniy ~ / ADJ ] ]" ] ]
 ...
 |> "b l q n" <| [
    ...
    noun     KaRDAS |< Iy              {- baloqAniy~ -}     `gloss`  [ "Balkan [ [ baloqAniy ~ / NOUN ] ]", "Balkan [ [ baloqAniy ~ / ADJ ] ]" ],
 ...
 |> "b l r" <| [
    ...
    noun     FaCCUL                    {- bal~uwr -}        -- `others` [ "balluwriyy N-ap" ]
                                                            `gloss`  [ "crystal", "crystal [ [ bal ~ uwriy ~ / ADJ ] ]" ] ]
 ...
 |> "b l s m" <| [
    ...
    noun     KaRDaS |< Iy              {- balosamiy~ -}     `gloss`  [ "balsamic [ [ balosamiy ~ / ADJ ] ]" ] ]
 ...
 |> "b l w" <| [
    ...
    noun     FaCY                      {- balaY -}          `gloss`  [ "indeed", "certainly [ [ balaY / INTERJ ] ]" ],
    ...
    verb     FaCA                      {- balA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "bluw IV_0hAnn", "balaw PV_Atn", "bal PV_ttAw", "blay IV_Ann_Pass_yu", "blY IV_0_Pass_yu", "bl IV_0hwnyn" ]
    ...
    noun     FaCLY                     {- balowaY -}        -- `others` [ "balwA Nhy" ]
    ...
    verb     HaFCY                     {- OabolaY -}        -- `others` [ "'ablay PV_Atn", "'ablA PV_h", "blay IV_Ann_Pass_yu", "blY IV_0_Pass_yu", "bliy IV_0hAnn_yu", "'abl PV_ttAw", "bl IV_0hwnyn_yu" ]
    ...
    noun     FiCY                      {- bilaY -}          -- `others` [ "bilA Nh" ]
    ...
    noun     MuFACY |< aT              {- mubAlAp -}        -- `others` [ "mubAlay NAt" ]
    ...
    noun     FACI                      {- bAliy -}          -- `others` [ "bAl Nuwn_Niyn NK" ]
    ...
    noun     MuFACI                    {- mubAliy -}        -- `others` [ "mubAl Nuwn_Niyn NK" ]
    ...
    noun     MuFtaCI                   {- mubotaliy -}      -- `others` [ "mubtal Nuwn_Niyn NK" ]
    ...
    noun     MuFtaCY                   {- mubotalaY -}      -- `others` [ "mubtalay NAt NAn_Nayn", "mubtal Nuwn_Niyn", "mubtalA Napdu Nhy" ]
 ...
 |> "b l y" <| [
    ...
    verb     FaCiL                     {- baliy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "bla IV_0hwnyn", "bal PV_w", "blay IV_Ann", "blY IV_0" ]
                                                            `gloss`  [ "deteriorate" ],

    -- ;; baliy~_1
    -- bly     baliy~  N       dilapidated;worn

    noun     FaCIL                     {- baliy~ -}         `gloss`  [ "dilapidated", "worn" ],
    ...
    noun     FaCIL |< aT               {- baliy~ap -}       -- `others` [ "balAyA N0 Nhy" ]
                                                            `gloss`  [ "tribulation", "affliction [ [ baliy ~ / NOUN ] ]", "tribulations", "afflictions" ],
 ...
 |> "b m b y" <| [
    ...
    noun     KaRDIS                    {- bamobiy~ -}       `gloss`  [ "hot pink [ [ bamobiy ~ / ADJ ] ]" ] ]
 ...
 |> "b n '" <| [
    ...
    noun     FiCAL |< aN               {- binA'F -}         `gloss`  [ "based on", "according to [ [ binA'F / ADV ] ]" ],

    -- ;; binA}iy~_1
    -- bnA}y   binA}iy~        Nall    structural;architectural     [[binA}iy~/ADJ]]

    noun     FiCAL |< Iy               {- binA}iy~ -}       `gloss`  [ "structural", "architectural [ [ binA } iy ~ / ADJ ] ]" ],
    ...
    verb     HaFAL                     {- OabA' -}          -- `others` [ "'aba' PV_C", "bi' IV_C_yu", "biy' IV_V_yu IV_wn_yu" ]
    ...
    noun     MaFAL |< aT               {- mabA'ap -}        `gloss`  [ "abode", "habitation" ] ]
 ...
 |> "b n (" <| [
    ...
    noun     FaCY |< Iy                {- banawiy~ -}       `gloss`  [ "filial [ [ banawiy ~ / ADJ ] ]" ],
    ...
    noun     TaFaCCI                   {- taban~iy -}       -- `others` [ "tabann NK" ]
                                                            `gloss`  [ "adoption" ],
    ...
    noun     FiCA' |< aN               {- binA'F -}         `gloss`  [ "based on", "according to [ [ binA'F / ADV ] ]" ],

    -- ;; binA}iy~_1
    -- bnA}y   binA}iy~        Nall    structural;architectural     [[binA}iy~/ADJ]]

    noun     FiCA' |< Iy               {- binA}iy~ -}       `gloss`  [ "structural", "architectural [ [ binA } iy ~ / ADJ ] ]" ],
    ...
    noun     MaFCY                     {- mabonaY -}        -- `others` [ "mabnay NAn_Nayn", "mabAniy N0_Nh", "mabAn NK", "mabnA Nhy" ]
                                                            `gloss`  [ "building", "structure", "buildings", "structures" ],
    ...
    noun     FACI                      {- bAniy -}          -- `others` [ "bunA Nap", "bAn Nuwn_Niyn NK" ]
 ...
 |> "b n .g z" <| [
    ...
    noun     KaRDAS |< Iy              {- banogAziy~ -}     `gloss`  [ "Benghazi [ [ banogAziy ~ / NOUN ] ]", "Benghazi [ [ banogAziy ~ / ADJ ] ]" ] ]
 ...
 |> "b n .s r" <| [
    ...
    noun     KiRDiS                    {- binoSir -}        -- `others` [ "banA.sir Ndip" ]
 ...
 |> "b n .t" <| [
    ...
    noun     FuCL |< aT                {- bunoTap -}        -- `others` [ "buna.t N" ]
 ...
 |> "b n b ^s" <| [
    ...
    noun     KiRDAS |< Iy              {- binobA$iy~ -}     `gloss`  [ "lieutenant colonel [ [ binobA $ iy ~ / ADJ ] ]" ] ]
 ...
 |> "b n d q" <| [
    ...
    noun     KuRDuS |< Iy |< aT        {- bunoduqiy~ap -}   `gloss`  [ "Venice [ [ bunoduqiy ~ / NOUN_PROP ] ]" ],
 ...
 |> "b n d r" <| [
    ...
    noun     KaRDIS |< aT              {- banodiyrap -}     `gloss`  [ "banner" ] ]
 ...
 |> "b n q" <| [
    ...
    noun     FiCaL |< aT               {- binaqap -}        -- `others` [ "baniyq Nap" ]
                                                            `gloss`  [ "gore", "gusset" ] ]
 ...
 |> "b n r s" <| [
    ...
    noun     KaRADiS                   {- banAris -}        `gloss`  [ "Benares" ] ]
 ...
 |> "b n w" <| [
    ...
    noun     FuCUL |< aT               {- bunuw~ap -}       `gloss`  [ "sonship", "filiation" ] ]
 ...
 |> "b n y" <| [
    ...
    noun     FaCiL                     {- baniy -}          `gloss`  [ "sons / children of [ [ baniy / NOUN ] ]" ],
 ...
 |> "b q '" <| [
    ...
    noun     IstiFCAL                  {- {isotiboqA' -}    `gloss`  [ "maintenance", "continuation" ] ]
 ...
 |> "b q ^g" <| [
    ...
    noun     FuCL |< aT                {- buqojap -}        -- `others` [ "buqa^g N" ]
 ...
 |> "b q ^s" <| [
    ...
    noun     FuCL |< aT                {- buqo$ap -}        `gloss`  [ "buqsha ( Yemeni copper coin )" ] ]
 ...
 |> "b q `" <| [
    ...
    noun     HaFCaL                    {- OaboqaE -}        `gloss`  [ "spotted", "speckled" ],

    -- ;; bAqiEap_1
    -- bAqE    bAqiE   Nap     sly;shrewd
    -- bwAqE   bawAqiE Ndip    sly;shrewd

    noun     FACiL |< aT               {- bAqiEap -}        -- `others` [ "bawAqi` Ndip" ]
                                                            `gloss`  [ "sly", "shrewd" ] ]
 ...
 |> "b q b q" <| [
    ...
    noun     KaRDaS |< aT              {- baqobaqap -}      `gloss`  [ "gurgling", "prattle" ],
    ...
    noun     KaRDUS |< aT              {- baqobuwqap -}     `gloss`  [ "blister" ] ]
 ...
 |> "b q d" <| [
    ...
    noun     HaFCY                     {- OaboqaY -}        -- `others` [ "'abqA Nhy", "'abqay NAn_Nayn" ]
    ...
    noun     MutaFaCCI                 {- mutabaq~iy -}     -- `others` [ "mutabaqq Nuwn_Niyn NK" ]
 ...
 |> "b q l" <| [
    ...
    noun     FaCL |< Iy                {- baqoliy~ -}       `gloss`  [ "leguminous [ [ baqoliy ~ / ADJ ] ]" ],
 ...
 |> "b q l w" <| [
    ...
    noun     KaRDAS |< aT              {- baqolAwap -}      -- `others` [ "baqlAwA N0" ]
                                                            `gloss`  [ "baklava" ] ]
 ...
 |> "b q r" <| [
    ...
    verb     HaFCaL                    {- Oaboqar -}        -- `others` [ "bqir IV_yu", "bqar IV_Pass_yu" ]
    ...
    noun     FaCaL |< Iy               {- baqariy~ -}       `gloss`  [ "bovine", "cow [ [ baqariy ~ / ADJ ] ]" ],
 ...
 |> "b q r .t" <| [
    ...
    noun     KuRDAS |< Iy              {- buqrATiy~ -}      `gloss`  [ "Hippocratic [ [ buqrATiy ~ / ADJ ] ]" ] ]
 ...
 |> "b q s m" <| [
    ...
    noun     KuRDuS |< At              {- buqosumAt -}      -- `others` [ "buqsum NAt" ]
                                                            `gloss`  [ "rusk", "biscuit" ] ]
 ...
 |> "b r '" <| [
    ...
    verb     FaCaL                     {- baraO-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "bara'A PV-|", "bra' IV IV_wn IV_yn", "bra'A IV-|" ]
                                                            `gloss`  [ "create" ],
    ...
    verb     FaCiL                     {- bari}-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "bra' IV IV_wn IV_yn", "bra'A IV-|" ]
    ...
    verb     HaFCaL                    {- OaboraO -}        -- `others` [ "bra' IV_Pass_yu", "'abra'A PV-|", "bri' IV_yu" ]
    ...
    verb     IstaFCaL                  {- {isotaboraO -}    -- `others` [ "stabri' IV", "istabra'A PV-|" ]
    ...
    noun     MuFACaL |< aT             {- mubAraOap -}      -- `others` [ "mubAra N-|t" ]
    ...
    noun     HiFCAL                    {- IiborA' -}        `gloss`  [ "acquittal", "exoneration", "acquittals", "exonerations" ],
 ...
 |> "b r .g l" <| [
    ...
    noun     KuRDuS                    {- burogul -}        `gloss`  [ "bulgur" ] ]
 ...
 |> "b r .h" <| [
    ...
    verb     HaFCaL                    {- OaboraH -}        -- `others` [ "bri.h IV_yu" ]
                                                            `gloss`  [ "do good" ],
    ...
    noun     FaCAL |< aN               {- barAHAF -}        -- `others` [ "barA.h NF" ]
                                                            `gloss`  [ "openly", "patently [ [ barAH / ADV ] ]" ],

    -- ;; mubAraHap_1
    -- mbArH   mubAraH NapAt   departure

    noun     MuFACaL |< aT             {- mubAraHap -}      `gloss`  [ "departure" ],
 ...
 |> "b r .s" <| [
    ...
    noun     FuCL |< aT                {- buroSap -}        `gloss`  [ "stock exchange" ] ]
 ...
 |> "b r ^g m" <| [
    ...
    noun     KuRDuS |< aT              {- burojumap -}      -- `others` [ "barA^gim Ndip" ]
 ...
 |> "b r ^s" <| [
    ...
    noun     HaFCaL                    {- Oabora$ -}        `gloss`  [ "spotted", "speckled" ],
 ...
 |> "b r ^s m" <| [
    ...
    noun     KaRDaS |< aT              {- baro$amap -}      `gloss`  [ "riveting" ],

    -- ;; buro$Amap_1
    -- br$Am   buro$Am NapAt   rivet

    noun     KuRDAS |< aT              {- buro$Amap -}      `gloss`  [ "rivet" ],
    ...
    noun     KaRDUS |< Iy              {- baro$uwmiy~ -}    `gloss`  [ "prickly pear [ [ baro $ uwmiy ~ / ADJ ] ]" ] ]
 ...
 |> "b r _t n" <| [
    ...
    noun     KuRDuS                    {- burovun -}        -- `others` [ "barA_tin Ndip" ]
 ...
 |> "b r `" <| [
    ...
    noun     FaCAL |< aT               {- barAEap -}        `gloss`  [ "skill", "proficiency" ],

    -- ;; buruwEap_1
    -- brwE    buruwE  Nap     eminence

    noun     FuCUL |< aT               {- buruwEap -}       `gloss`  [ "eminence" ],

    -- ;; >aboraE_1
    -- >brE    >aboraE Nel     more/most eminent;more/most skillful
    -- AbrE    >aboraE Nel     more/most eminent;more/most skillful

    noun     HaFCaL                    {- OaboraE -}        `gloss`  [ "more / most eminent", "more / most skillful" ],
 ...
 |> "b r ` m" <| [
    ...
    noun     KuRDuS                    {- buroEum -}        -- `others` [ "barA`im Ndip" ]
 ...
 |> "b r b" <| [
    ...
    noun     FiCL |< aT                {- birobap -}        -- `others` [ "birbY N0", "barAb NK", "barAbiy N0_Nh", "birbA Nhy" ]
 ...
 |> "b r b r" <| [
    ...
    noun     KaRDaS |< Iy |< aT        {- barobariy~ap -}   `gloss`  [ "barbarism", "savagery [ [ barobariy ~ / NOUN ] ]" ],
 ...
 |> "b r d" <| [
    ...
    verb     HaFCaL                    {- Oaborad -}        -- `others` [ "brid IV_yu" ]
                                                            `gloss`  [ "mail" ],
    ...
    noun     FaCaL |< aT               {- baradap -}        `gloss`  [ "hailstone" ],
    ...
    noun     FaCL |< Iy |< aT          {- barodiy~ap -}     -- `others` [ "buradA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "ague", "fever attack [ [ barodiy ~ / NOUN ] ]", "fever attack" ],
    ...
    noun     FaCCAL |< aT              {- bar~Adap -}       `gloss`  [ "refrigerator" ],
    ...
    noun     FiCAL |< aT               {- birAdap -}        `gloss`  [ "tool cutting" ],

    -- ;; burAdap_1
    -- brAd    burAd   Nap     iron filings

    noun     FuCAL |< aT               {- burAdap -}        `gloss`  [ "iron filings" ],
    ...
    noun     FACUL                     {- bAruwd -}         `gloss`  [ "gunpowder" ],

    -- ;; bAruwdiy~_1
    -- bArwdy  bAruwdiy~       N0      Baroudi

    noun     FACUL |< Iy               {- bAruwdiy~ -}      `gloss`  [ "Baroudi" ],

    -- ;; bAruwdap_1
    -- bArwd   bAruwd  Napdu   rifle;carbine
    -- bwAryd  bawAriyd        Ndip    rifles;carbines

    noun     FACUL |< aT               {- bAruwdap -}       -- `others` [ "bawAriyd Ndip" ]
    ...
    noun     FaCL |< Iy                {- barodiy~ -}       -- `others` [ "burdiyy Nall" ]
                                                            `gloss`  [ "papyrus [ [ barodiy ~ / ADJ ] ]", "papyrus [ [ burodiy ~ / ADJ ] ]" ],

    -- ;; barodiy~ap_2
    -- brdy    barodiy~        NapAt   papyrology     [[barodiy~/NOUN]]
    -- brdy    burodiy~        NapAt   papyrology     [[burodiy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- barodiy~ap -}     -- `others` [ "burdiyy NapAt" ]
                                                            `gloss`  [ "papyrology [ [ barodiy ~ / NOUN ] ]", "papyrology [ [ burodiy ~ / NOUN ] ]" ],
 ...
 |> "b r d _h" <| [
    ...
    noun     KaRDaS |< aT              {- barodaxap -}      `gloss`  [ "polishing", "burnishing" ] ]
 ...
 |> "b r d `" <| [
    ...
    noun     KaRDaS |< aT              {- barodaEap -}      -- `others` [ "barAdi` Ndip" ]
                                                            `gloss`  [ "saddle cloth", "pack-saddle", "saddle cloths", "pack-saddles" ],

    -- ;; barAdiEiy~_1
    -- brAdEy  barAdiEiy~      Nall    saddle maker     [[barAdiEiy~/ADJ]]

    noun     KaRADiS |< Iy             {- barAdiEiy~ -}     `gloss`  [ "saddle maker [ [ barAdiEiy ~ / ADJ ] ]" ] ]
 ...
 |> "b r d r" <| [
    ...
    noun     KaRDUS |< aT              {- baroduwrap -}     `gloss`  [ "curbstone", "curb" ] ]
 ...
 |> "b r h" <| [
    ...
    noun     FuCL |< aT                {- burohap -}        -- `others` [ "burah NAt" ]
                                                            `gloss`  [ "instant", "moment", "instants", "moments" ],

    -- ;; burayohap_1
    -- bryh    burayoh Nap     a little while

    noun     FuCayL |< aT              {- burayohap -}      `gloss`  [ "a little while" ],

    -- ;; burohiy~_1
    -- brhy    burohiy~        N-ap    momentarily     [[burohiy~/ADJ]]

    noun     FuCL |< Iy                {- burohiy~ -}       `gloss`  [ "momentarily [ [ burohiy ~ / ADJ ] ]" ] ]
 ...
 |> "b r h m" <| [
    ...
    noun     KaRDaS |< aT              {- barohamap -}      `gloss`  [ "Brahmanism" ],

    -- ;; barohamiy~_1
    -- brhmy   barohamiy~      Nall    Brahman     [[barohamiy~/NOUN]]
    -- brhmy   barohamiy~      Nall    Brahman     [[barohamiy~/ADJ]]

    noun     KaRDaS |< Iy              {- barohamiy~ -}     `gloss`  [ "Brahman [ [ barohamiy ~ / NOUN ] ]", "Brahman [ [ barohamiy ~ / ADJ ] ]" ],

    -- ;; barohamiy~ap_1
    -- brhmy   barohamiy~      Nap     Brahmanism     [[barohamiy~/NOUN]]

    noun     KaRDaS |< Iy |< aT        {- barohamiy~ap -}   `gloss`  [ "Brahmanism [ [ barohamiy ~ / NOUN ] ]" ] ]
 ...
 |> "b r h n" <| [
    ...
    noun     KaRDaS |< aT              {- barohanap -}      `gloss`  [ "proving", "demonstration" ],
 ...
 |> "b r k" <| [
    ...
    verb     HaFCaL                    {- Oaborak -}        -- `others` [ "brik IV_yu" ]
                                                            `gloss`  [ "make kneel" ],
    ...
    noun     FiCL |< aT                {- birokap -}        -- `others` [ "birak N" ]
                                                            `gloss`  [ "pool", "pools" ],
    ...
    noun     HaFCaL                    {- Oaborak -}        `gloss`  [ "more / most blessed" ],
 ...
 |> "b r m" <| [
    ...
    noun     FaCCAL |< aT              {- bar~Amap -}       `gloss`  [ "drill", "drilling machine" ],
    ...
    noun     FuCL |< aT                {- buromap -}        -- `others` [ "buram N", "birAm N" ]
    ...
    noun     FuCL |< Iy                {- buromiy~ -}       `gloss`  [ "Burmese [ [ buromiy ~ / NOUN ] ]", "Burmese [ [ buromiy ~ / ADJ ] ]" ] ]
 ...
 |> "b r m '" <| [
    ...
    noun     KaRDAS |< Iy              {- baromA}iy~ -}     -- `others` [ "barmAwiyy Nall" ]
                                                            `gloss`  [ "amphibious [ [ baromA } iy ~ / ADJ ] ]", "amphibious [ [ baromAwiy ~ / ADJ ] ]" ] ]
 ...
 |> "b r m d" <| [
    ...
    noun     KiRDUS |< Iy              {- biromuwdiy~ -}    `gloss`  [ "Bermudan [ [ biromuwdiy ~ / NOUN ] ]", "Bermudan [ [ biromuwdiy ~ / ADJ ] ]" ],
 ...
 |> "b r n" <| [
    ...
    noun     FACUL                     {- bAruwn -}         `gloss`  [ "Baron", "baron" ],

    -- ;; bar~Aniy~_1
    -- brAny   bar~Aniy~       Nall    exterior;external     [[bar~Aniy~/ADJ]]

    noun     FaCCAL |< Iy              {- bar~Aniy~ -}      `gloss`  [ "exterior", "external [ [ bar ~ Aniy ~ / ADJ ] ]" ],
    ...
    noun     FaCL |< Iy |< aT          {- baroniy~ap -}     -- `others` [ "barAniy N" ]
                                                            `gloss`  [ "clay vessel [ [ baroniy ~ / NOUN ] ]", "clay vessels" ],
 ...
 |> "b r n s" <| [
    ...
    noun     KuRDuS                    {- buronus -}        -- `others` [ "barAniys Ndip", "burnuws N", "barAnis Ndip" ]
                                                            `gloss`  [ "burnoose", "burnooses" ],

    -- ;; barAnis_1
    -- brAns   barAnis N       Pyrenees

    noun     KaRADiS                   {- barAnis -}        `gloss`  [ "Pyrenees" ] ]
 ...
 |> "b r n z" <| [
    ...
    noun     KaRDaS |< aT              {- baronazap -}      `gloss`  [ "bronzing" ],
 ...
 |> "b r q" <| [
    ...
    verb     HaFCaL                    {- Oaboraq -}        -- `others` [ "briq IV_yu" ]
                                                            `gloss`  [ "flash", "shine" ],
    ...
    noun     FaCL |< Iy                {- baroqiy~ -}       `gloss`  [ "telegraph", "telegraphic [ [ baroqiy ~ / ADJ ] ]" ],
 ...
 |> "b r q ^s" <| [
    ...
    noun     KiRDiS                    {- biroqi$ -}        -- `others` [ "barAqi^s Ndip" ]
                                                            `gloss`  [ "bishop bird" ],

    -- ;; baroqa$ap_1
    -- brq$    baroqa$ Nap     variegation;colorful

    noun     KaRDaS |< aT              {- baroqa$ap -}      `gloss`  [ "variegation", "colorful" ],
 ...
 |> "b r q `" <| [
    ...
    noun     KuRDuS                    {- buroquE -}        -- `others` [ "barAqi` Ndip" ]
                                                            `gloss`  [ "veil", "veils" ] ]
 ...
 |> "b r r" <| [
    ...
    verb     HaFaCL                    {- Oabar~ -}         -- `others` [ "birr IV_V_yu", "'abrar PV_C", "brir IV_C_yu" ]
                                                            `gloss`  [ "fulfill" ],
    ...
    noun     FACL                      {- bAr~ -}           -- `others` [ "barar Nap", "'abrAr N" ]
    ...
    noun     MaFaCL |< aT              {- mabar~ap -}       -- `others` [ "mabArr Ndip" ]
    ...
    noun     TaFCIL |< aN              {- taboriyrAF -}     -- `others` [ "tabriyr NF" ]
                                                            `gloss`  [ "in justification", "as a pretext [ [ taboriyr / ADV ] ]" ],

    -- ;; taboriyriy~_1
    -- tbryry  taboriyriy~     N-ap    justifying;extenuating     [[taboriyriy~/ADJ]]

    noun     TaFCIL |< Iy              {- taboriyriy~ -}    `gloss`  [ "justifying", "extenuating [ [ taboriyriy ~ / ADJ ] ]" ],
    ...
    noun     FaCLAn |< Iy              {- bar~Aniy~ -}      `gloss`  [ "exterior", "external [ [ bar ~ Aniy ~ / ADJ ] ]" ],
    ...
    noun     FUCiy                     {- buwriy -}         `gloss`  [ "bugle", "signal horn" ] ]
 ...
 |> "b r s" <| [
    ...
    noun     HiFCA'                    {- IiborA' -}        `gloss`  [ "acquittal", "exoneration", "acquittals", "exonerations" ],
    ...
    noun     IstiFCA'                  {- {isotiborA' -}    `gloss`  [ "purification", "purifications" ],
 ...
 |> "b r w" <| [
    ...
    noun     FaCL |< aT                {- barowap -}        -- `others` [ "baraw NAt" ]
                                                            `gloss`  [ "waste", "scrap" ] ]
 ...
 |> "b r y" <| [
    ...
    noun     HaFCiLA'                  {- OaboriyA' -}      `gloss`  [ "innocent", "exempt" ],
    ...
    verb     FaCY                      {- baraY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ "briy IV_0hAnn", "brY IV_0_Pass_yu", "bar PV_ttAw", "br IV_0hwnyn", "barA PV_h", "baray PV_Atn" ]
    ...
    noun     FaCIL |< aT               {- bariy~ap -}       -- `others` [ "barAyA N0 Nhy" ]
                                                            `gloss`  [ "creation", "creature [ [ bariy ~ / NOUN ] ]", "creatures" ],
 ...
 |> "b r z" <| [
    ...
    noun     FuCayL |< aT              {- burayozap -}      `gloss`  [ "bureiza ( 10-piaster coin )" ],
    ...
    noun     MuFACaL |< aT             {- mubArazap -}      `gloss`  [ "contest", "duel", "competition" ],
    ...
    noun     MuFaCCiL                  {- mubar~iz -}       `gloss`  [ "surpassing [ [ mubar ~ iz / ADJ ] ]", "winner" ],
    ...
    noun     FaCIL |< aT               {- bariyzap -}       -- `others` [ "barA'iz Ndip" ]
 ...
 |> "b s '" <| [
    ...
    verb     FaCaL                     {- basaO-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "bsa'A IV-|", "bsa' IV IV_wn IV_yn", "basa'A PV-|" ]
 ...
 |> "b s ' .t" <| [
    ...
    noun     KaRADiS                   {- basA}iT -}        `gloss`  [ "basic facts", "elements" ] ]
 ...
 |> "b s .t" <| [
    ...
    noun     FaCL |< aT                {- basoTap -}        -- `others` [ "basa.t NAt" ]
    ...
    noun     FaCIL |< aT               {- basiyTap -}       `gloss`  [ "no problem", "okay [ [ basiyTap / INTERJ ] ]" ],
    ...
    noun     InFiCAL |< aT             {- {inobisATap -}    `gloss`  [ "extension" ],
 ...
 |> "b s _h" <| [
    ...
    noun     FaCL |< aT                {- basoxap -}        `gloss`  [ "Easter", "Passion Week" ] ]
 ...
 |> "b s b s" <| [
    ...
    noun     KaRDUS |< aT              {- basobuwsap -}     -- `others` [ "basAbis Ndip" ]
 ...
 |> "b s k" <| [
    ...
    noun     FACL                      {- bAsk -}           `gloss`  [ "Basques [ [ bAsk / NOUN ] ]", "Basque [ [ bAsk / ADJ ] ]" ] ]
 ...
 |> "b s l" <| [
    ...
    noun     FaCAL |< aT               {- basAlap -}        -- `others` [ "istibsAl N/At" ]
                                                            `gloss`  [ "courage" ],
 ...
 |> "b s m" <| [
    ...
    noun     IFtiCAL |< aT             {- {ibotisAmap -}    `gloss`  [ "smile" ] ]
 ...
 |> "b s m l" <| [
    ...
    noun     KaRDaS |< aT              {- basomalap -}      `gloss`  [ "`` bismillah '' ( in the name of God , the Merciful , the Compassionate )" ] ]
 ...
 |> "b s n" <| [
    ...
    noun     FuCayL |< aT              {- busayonap -}      `gloss`  [ "kitty" ] ]
 ...
 |> "b s r" <| [
    ...
    noun     FACUL                     {- bAsuwr -}         -- `others` [ "bawAsiyr Ndip" ]
                                                            `gloss`  [ "hemorrhoids" ] ]
 ...
 |> "b s s" <| [
    ...
    noun     FaCL |< aT                {- bas~ap -}         -- `others` [ "bisAs N" ]
                                                            `gloss`  [ "cat", "cats" ] ]
 ...
 |> "b s t n" <| [
    ...
    noun     KaRDaS |< aT              {- basotanap -}      `gloss`  [ "gardening" ],
 ...
 |> "b s t r" <| [
    ...
    noun     KaRDaS |< aT              {- basotarap -}      `gloss`  [ "pasteurization" ],
 ...
 |> "b t `" <| [
    ...
    noun     HaFCaL                    {- OabotaE -}        `gloss`  [ "altogether", "entire" ],
 ...
 |> "b t l" <| [
    ...
    noun     FaCUL |< Iy               {- batuwliy~ -}      `gloss`  [ "virgin", "virginal [ [ batuwliy ~ / ADJ ] ]" ],

    -- ;; batuwliy~ap_1
    -- btwly   batuwliy~       Nap     virginity     [[batuwliy~/NOUN]]

    noun     FaCUL |< Iy |< aT         {- batuwliy~ap -}    `gloss`  [ "virginity [ [ batuwliy ~ / NOUN ] ]" ],
    ...
    noun     FaCL |< aT |< aN          {- batolapF -}       `gloss`  [ "definitively", "decisively [ [ batolapF / ADV ] ]" ],

    -- ;; batalap_1
    -- btl     batal   NapAt   petal

    noun     FaCaL |< aT               {- batalap -}        `gloss`  [ "petal" ],
    ...
    verb     IFCaLL                    {- {ibotal~ -}       -- `others` [ "btall IV_V_intr", "btalil IV_C_intr", "ibtalal PV_C_intr" ]
                                                            `gloss`  [ "be wet", "be humid" ],

    -- ;; mubotal~_1
    -- mbtl    mubotal~        Nall    wet;drenched

    noun     MuFCaLL                   {- mubotal~ -}       `gloss`  [ "wet", "drenched" ] ]
 ...
 |> "b t r" <| [
    ...
    noun     HaFCaL                    {- Oabotar -}        -- `others` [ "batrA' Nh Nhy N0_Nh", "butr N" ]
    ...
    noun     FICAL                     {- biytAr -}         `gloss`  [ "Bitar", "Betar" ] ]
 ...
 |> "b t t" <| [
    ...
    noun     FaCL |< aN                {- bat~AF -}         -- `others` [ "batt NF" ]
                                                            `gloss`  [ "definitely", "once and for all [ [ bat ~ / ADV ] ]" ],
    ...
    noun     FaCL |< aT |< aN          {- bat~apF -}        `gloss`  [ "absolutely [ [ bat ~ apF / ADV ] ]" ],

    -- ;; bat~iy~_1
    -- bty     bat~iy~ Nall    definite     [[bat~iy~/ADJ]]

    noun     FaCL |< Iy                {- bat~iy~ -}        `gloss`  [ "definite [ [ bat ~ iy ~ / ADJ ] ]" ],
    ...
    noun     FiCL |< Iy |< aT          {- bit~iy~ap -}      -- `others` [ "batAt NK", "batAtiy N0_Nh" ]
                                                            `gloss`  [ "barrel", "tub [ [ bit ~ iy ~ / NOUN ] ]", "barrels", "tubs" ],
 ...
 |> "b t z" <| [
    ...
    verb     IFCaLL                    {- {ibotaz~ -}       -- `others` [ "btaziz IV_C", "btazz IV_V", "ibtazaz PV_C" ]
    ...
    noun     IFCiLAL                   {- {ibotizAz -}      `gloss`  [ "embezzlement", "extortion" ] ]
 ...
 |> "b w '" <| [
    ...
    verb     FaCCaL                    {- baw~aO -}         -- `others` [ "bawwi' IV_yu" ]
 ...
 |> "b w .g d" <| [
    ...
    noun     KuRDAS |< aT              {- buwgAdap -}       -- `others` [ "buw.gA.d Nap" ]
                                                            `gloss`  [ "potash", "lye" ] ]
 ...
 |> "b w .h" <| [
    ...
    verb     FAL                       {- bAH-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "buw.h IV_V", "bu.h PV_C IV_C" ]
    ...
    noun     HiFAL |< aT               {- IibAHap -}        `gloss`  [ "permission", "licentiousness" ],
    ...
    noun     HiFAL |< Iy |< aT         {- IibAHiy~ap -}     `gloss`  [ "freethinking", "anarchism [ [" ],

    -- ;; {isotibAHap_1
    -- <stbAH  {isotibAH       NapAt   appropriation;seizure
    -- AstbAH  {isotibAH       NapAt   appropriation;seizure

    noun     IstiFAL |< aT             {- {isotibAHap -}    `gloss`  [ "appropriation", "seizure" ],
 ...
 |> "b w .t" <| [
    ...
    noun     FuCAL                     {- buwAT -}          `gloss`  [ "can", "box ( boite )" ],

    -- ;; buwTap_1
    -- bwT     buwT    Nap     crucible;melting pot

    noun     FuCL |< aT                {- buwTap -}         `gloss`  [ "crucible", "melting pot" ] ]
 ...
 |> "b w .z" <| [
    ...
    noun     FuCL |< aT                {- buwZap -}         `gloss`  [ "ice-cream ( Levant )" ],

    -- ;; buwZap_2
    -- bwZ     buwZ    Nap     beer (Egy.)

    noun     FuCL |< aT                {- buwZap -}         `gloss`  [ "beer ( Egy . )" ] ]
 ...
 |> "b w ^s" <| [
    ...
    verb     FAL                       {- bA$-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "buw^s IV_V_intr", "bu^s IV_C_intr PV_C_intr" ]
                                                            `gloss`  [ "be boisterous" ],
 ...
 |> "b w _d" <| [
    ...
    noun     FuCL |< Iy                {- buw*iy~ -}        `gloss`  [ "Buddhist [ [ buw*iy ~ / NOUN ] ]", "Buddhist [ [ buw*iy ~ / ADJ ] ]", "Buddhism [ [ buw*iy ~ / NOUN ] ]" ],
    ...
    noun     FUL |< Iy                 {- buw*iy~ -}        `gloss`  [ "Buddhist [ [ buw*iy ~ / NOUN ] ]", "Buddhist [ [ buw*iy ~ / ADJ ] ]", "Buddhism [ [ buw*iy ~ / NOUN ] ]" ] ]
 ...
 |> "b w _h" <| [
    ...
    verb     FAL                       {- bAx-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "bu_h PV_C IV_C", "buw_h IV_V" ]
                                                            `gloss`  [ "subside", "spoil" ],
    ...
    noun     FuCAL                     {- buwAx -}          `gloss`  [ "evaporation", "steam" ],

    -- ;; bA}ix_1
    -- bA}x    bA}ix   Nall    spoiled;insipid

    noun     FA'iL                     {- bA}ix -}          `gloss`  [ "spoiled", "insipid" ] ]
 ...
 |> "b w b" <| [
    ...
    noun     FiCAL |< aT               {- biwAbap -}        `gloss`  [ "gatekeeper" ],
 ...
 |> "b w b n" <| [
    ...
    noun     KuRDIS |< aT              {- buwbiynap -}      `gloss`  [ "spool", "reel" ] ]
 ...
 |> "b w d y" <| [
    ...
    noun     KaRADiS                   {- bawAdiy -}        -- `others` [ "bawAd NK" ]
                                                            `gloss`  [ "nomads", "Bedouins" ] ]
 ...
 |> "b w h m" <| [
    ...
    noun     KuRDIS |< Iy              {- buwhiymiy~ -}     `gloss`  [ "Bohemian [ [ buwhiymiy ~ / NOUN ] ]", "Bohemian [ [ buwhiymiy ~ / ADJ ] ]" ] ]
 ...
 |> "b w l" <| [
    ...
    verb     FAL                       {- bAl-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "bul PV_C IV_C", "buwl IV_V" ]
                                                            `gloss`  [ "urinate" ],
    ...
    verb     HaFAL                     {- OabAl -}          -- `others` [ "'abal PV_C", "biyl IV_V_yu", "bil IV_C_yu" ]
    ...
    noun     FIL |< aT                 {- biylap -}         `gloss`  [ "urine" ],

    -- ;; baw~Alap_1
    -- bwAl    baw~Al  Nap     pissoir

    noun     FaCCAL |< aT              {- baw~Alap -}       `gloss`  [ "pissoir" ],

    -- ;; mabowalap_1
    -- mbwl    mabowal NapAt   urinal
    -- mbAwl   mabAwil Ndip    urinals

    noun     MaFCaL |< aT              {- mabowalap -}      -- `others` [ "mabAwil Ndip" ]
                                                            `gloss`  [ "urinal", "urinals" ],

    -- ;; mibowalap_1
    -- mbwl    mibowal NapAt   bedpan

    noun     MiFCaL |< aT              {- mibowalap -}      `gloss`  [ "bedpan" ] ]
 ...
 |> "b w l d" <| [
    ...
    noun     KuRDAS                    {- buwlAd -}         -- `others` [ "buwlA_d N" ]
                                                            `gloss`  [ "steel" ] ]
 ...
 |> "b w l f" <| [
    ...
    noun     KuRDIS |< Iy              {- buwliyfiy~ -}     `gloss`  [ "Bolivian [ [ buwliyfiy ~ / NOUN ] ]", "Bolivian [ [ buwliyfiy ~ / ADJ ] ]" ] ]
 ...
 |> "b w l s" <| [
    ...
    noun     KuRDIS |< aT              {- buwliysap -}      -- `others` [ "bawAlis Ndip" ]
                                                            `gloss`  [ "policy", "insurance", "policies" ],

    -- ;; buwliysiy~_1
    -- bwlysy  buwliysiy~      Nall    police;detective     [[buwliysiy~/ADJ]]

    noun     KuRDIS |< Iy              {- buwliysiy~ -}     `gloss`  [ "police", "detective [ [ buwliysiy ~ / ADJ ] ]" ] ]
 ...
 |> "b w q" <| [
    ...
    noun     FAL |< aT                 {- bAqap -}          `gloss`  [ "bouquet" ],

    -- ;; bA}iqap_1
    -- bA}q    bA}iq   Nap     misfortune
    -- bwA}q   bawA}iq Ndip    misfortunes

    noun     FA'iL |< aT               {- bA}iqap -}        -- `others` [ "bawA'iq Ndip" ]
                                                            `gloss`  [ "misfortune", "misfortunes" ] ]
 ...
 |> "b w q l" <| [
    ...
    noun     KuRDAS                    {- buwqAl -}         -- `others` [ "bawAqiyl Ndip" ]
                                                            `gloss`  [ "mug", "mugs" ] ]
 ...
 |> "b w q y" <| [
    ...
    noun     KaRADiS                   {- bawAqiy -}        `gloss`  [ "Bawaqi" ] ]
 ...
 |> "b w r" <| [
    ...
    verb     FAL                       {- bAr-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "bur IV_C_intr PV_C_intr", "buwr IV_V_intr" ]
    ...
    verb     HaFAL                     {- OabAr -}          -- `others` [ "bir IV_C_yu", "bar IV_C_Pass_yu", "'abar PV_C", "bAr IV_V_Pass_yu", "biyr IV_V_yu" ]
                                                            `gloss`  [ "destroy", "be destroyed" ],

    -- ;; buwr_1
    -- bwr     buwr    N       fallow

    noun     FuCL                      {- buwr -}           `gloss`  [ "fallow" ],
    ...
    noun     FA'iL                     {- bA}ir -}          `gloss`  [ "fallow", "uncultivated" ],
 ...
 |> "b w r ^g" <| [
    ...
    noun     KuRDUS |< Iy              {- buwruwjiy~ -}     `gloss`  [ "bugler [ [ buwruwjiy ~ / ADJ ] ]" ] ]
 ...
 |> "b w r n" <| [
    ...
    noun     KuRDAS |< Iy              {- buwrAniy~ -}      `gloss`  [ "vegetable stew" ] ]
 ...
 |> "b w s" <| [
    ...
    verb     FAL                       {- bAs-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "buws IV_V", "bus PV_C IV_C" ]
                                                            `gloss`  [ "kiss" ],
    ...
    noun     FaCL |< aT                {- bawosap -}        -- `others` [ "buws NapAt" ]
                                                            `gloss`  [ "kiss" ] ]
 ...
 |> "b w t w" <| [
    ...
    noun     KuRDuS                    {- buwtuw -}         `gloss`  [ "Bhutto" ] ]
 ...
 |> "b w z" <| [
    ...
    noun     TaFCIL |< aT              {- tabowiyzap -}     `gloss`  [ "sullen look" ],
 ...
 |> "b y .d" <| [
    ...
    verb     FAL                       {- bAD-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "bi.d PV_C IV_C", "biy.d IV_V" ]
    ...
    noun     FaCL |< aT                {- bayoDap -}        `gloss`  [ "main part" ],

    -- ;; bayoDiy~_1
    -- byDy    bayoDiy~        Nall    oval     [[bayoDiy~/ADJ]]

    noun     FaCL |< Iy                {- bayoDiy~ -}       `gloss`  [ "oval [ [ bayoDiy ~ / ADJ ] ]" ],

    -- ;; bayoDawiy~_1
    -- byDwy   bayoDawiy~      Nall    oval     [[bayoDawiy~/ADJ]]

    noun     FaCLY |< Iy               {- bayoDawiy~ -}     `gloss`  [ "oval [ [ bayoDawiy ~ / ADJ ] ]" ],
    ...
    noun     TaFCIL |< aT              {- taboyiyDap -}     `gloss`  [ "fair copy" ],
    ...
    noun     FA'iL                     {- bA}iD -}          -- `others` [ "bawA'i.d Ndip" ]
                                                            `gloss`  [ "egg-laying" ],
    ...
    noun     MuFaCCaL |< aT            {- mubay~aDap -}     `gloss`  [ "fair copy" ] ]
 ...
 |> "b y .g n" <| [
    ...
    noun     KiRDiS                    {- biygin -}         `gloss`  [ "Begin" ] ]
 ...
 |> "b y .t r" <| [
    ...
    noun     KaRDaS |< aT              {- bayoTarap -}      `gloss`  [ "veterinary" ] ]
 ...
 |> "b y `" <| [
    ...
    noun     FAL |< aT                 {- bAEap -}          `gloss`  [ "merchants", "vendors" ],
    ...
    noun     FiCL |< aT                {- biyEap -}         `gloss`  [ "church", "synagogue" ] ]
 ...
 |> "b y b" <| [
    ...
    noun     FiCL                      {- biyb -}           `gloss`  [ "pipe", "tube" ] ]
 ...
 |> "b y d" <| [
    ...
    noun     FiCAL |< aT               {- biyAdap -}        `gloss`  [ "infantry" ],

    -- ;; biyAdiy~_1
    -- byAdy   biyAdiy~        Nall    infantryman;foot soldier     [[biyAdiy~/ADJ]]

    noun     FiCAL |< Iy               {- biyAdiy~ -}       `gloss`  [ "infantryman", "foot soldier [ [ biyAdiy ~ / ADJ ] ]" ],
    ...
    verb     FAL                       {- bAd-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "bid PV_C IV_C", "biyd IV_V" ]
    ...
    noun     FA'iL                     {- bA}id -}          `gloss`  [ "bygone", "temporal" ],
 ...
 |> "b y d r" <| [
    ...
    noun     KiRDAS                    {- biydAr -}         `gloss`  [ "Bidar" ],
 ...
 |> "b y k r" <| [
    ...
    noun     KaRDiS                    {- bayokir -}        `gloss`  [ "Baker" ] ]
 ...
 |> "b y l" <| [
    ...
    noun     FiCL |< aT                {- biylap -}         `gloss`  [ "urine" ],
    ...
    noun     FiCL                      {- biyl -}           `gloss`  [ "ball bearing", "marble" ] ]
 ...
 |> "b y n" <| [
    ...
    noun     FACUL                     {- bAyuwn -}         `gloss`  [ "Baioun" ],
    ...
    noun     FaCCiL                    {- bay~in -}         `gloss`  [ "clear", "evident", "explicit" ],
    ...
    noun     HaFCiLA'                  {- OaboyinA' -}      `gloss`  [ "eloquent" ],

    -- ;; bay~inap_1
    -- byn     bay~in  NapAt   proof;evidence

    noun     FaCCiL |< aT              {- bay~inap -}       `gloss`  [ "proof", "evidence" ],
    ...
    noun     HaFCaL                    {- Oaboyan -}        `gloss`  [ "clearer", "clearest" ],
    ...
    noun     HiFAL |< aT               {- IibAnap -}        `gloss`  [ "exposition", "illustration" ],
    ...
    noun     TaFACuL |< Iy             {- tabAyuniy~ -}     `gloss`  [ "conflicting [ [ tabAyuniy ~ / ADJ ] ]" ],

    -- ;; {isotibAnap_1
    -- <stbAn  {isotibAn       NapAt   clarification;explanation
    -- AstbAn  {isotibAn       NapAt   clarification;explanation

    noun     IstiFAL |< aT             {- {isotibAnap -}    `gloss`  [ "clarification", "explanation" ],
    ...
    noun     FA'iL                     {- bA}in -}          -- `others` [ "bAyin Nall" ]
                                                            `gloss`  [ "plain", "evident" ],

    -- ;; bA}inap_1
    -- bA}n    bA}in   Nap     dowry

    noun     FA'iL |< aT               {- bA}inap -}        `gloss`  [ "dowry" ],
    ...
    noun     MaFCUL |< aT              {- maboyuwnap -}     `gloss`  [ "distance" ] ]
 ...
 |> "b y r" <| [
    ...
    noun     FaCCAL |< aT              {- bay~Arap -}       `gloss`  [ "plantation", "grove" ],
 ...
 |> "b y r n" <| [
    ...
    noun     KiRDUS                    {- biyruwn -}        `gloss`  [ "Peron" ] ]
 ...
 |> "b y s" <| [
    ...
    noun     FaCL |< aT                {- bayosap -}        -- `others` [ "baysah N0" ]
 ...
 |> "b y t" <| [
    ...
    verb     HaFAL                     {- OabAt -}          -- `others` [ "bat IV_C_Pass_yu", "biyt IV_V_yu", "bit IV_C_yu", "'abat PV_Ct", "bAt IV_V_Pass_yu" ]
    ...
    noun     FaCL |< Iy                {- bayotiy~ -}       `gloss`  [ "domestic [ [ bayotiy ~ / ADJ ] ]" ],
    ...
    noun     FA'iL                     {- bA}it -}          `gloss`  [ "stale", "unpromoted" ],
 ...
 |> "b z l" <| [
    ...
    noun     FuCAL                     {- buzAl -}          `gloss`  [ "tap", "spigot", "faucet" ],
 ...
 |> "b z q" <| [
    ...
    noun     FuCAL                     {- buzAq -}          `gloss`  [ "spittle", "saliva" ],

    -- ;; baz~Aqap_1
    -- bzAq    baz~Aq  NapAt   cobra;snail

    noun     FaCCAL |< aT              {- baz~Aqap -}       `gloss`  [ "cobra", "snail" ],

    -- ;; baz~Aqap_2
    -- bzAq    baz~Aq  NapAt   spittoon

    noun     FaCCAL |< aT              {- baz~Aqap -}       `gloss`  [ "spittoon" ],

    -- ;; mibozaqap_1
    -- mbzq    mibozaq NapAt   spittoon

    noun     MiFCaL |< aT              {- mibozaqap -}      `gloss`  [ "spittoon" ] ]
 ...
 |> "b z r" <| [
    ...
    noun     FuCayL |< aT              {- buzayorap -}      `gloss`  [ "spore" ] ]
 ...
 |> "b z y" <| [
    ...
    noun     FACI                      {- bAziy -}          -- `others` [ "bawAz NK", "buzA Nap", "bawAziy N0_Nh", "bAz NK" ]
                                                            `gloss`  [ "falcon", "falcons" ] ]
 ...
 |> "b z z" <| [
    ...
    noun     FiCAL |< aT               {- bizAzap -}        `gloss`  [ "cloth trade" ],
    ...
    noun     FaCCAL |< aT              {- baz~Azap -}       `gloss`  [ "pacifier", "baby 's bottle" ],
 ...
 |> "bA_tuwluw^g" <| [
    ...
    noun     Identity |< Iy            {- bAvuwluwjiy~ -}   `gloss`  [ "pathological [ [ bAvuwluwjiy ~ / ADJ ] ]" ] ]
 ...
 |> "bAbY" <| [
    ...
    noun     Identity |< Iy |< aT      {- bAbawiy~ap -}     `gloss`  [ "papacy [ [ bAbawiy ~ / NOUN ] ]" ] ]
 ...
 |> "bAbih" <| [
    ...
    noun     Identity                  {- bAbih -}          `gloss`  [ "Babih" ] ]
 ...
 |> "bAktiyr" <| [
    ...
    noun     Identity |< Iy            {- bAkotiyriy~ -}    `gloss`  [ "bacterial [ [ bAkotiyriy ~ / ADJ ] ]" ] ]
 ...
 |> "bAniyk" <| [
    ...
    noun     Identity                  {- bAniyk -}         `gloss`  [ "Banik" ] ]
 ...
 |> "bAnuwrAm" <| [
    ...
    noun     Identity |< Iy            {- bAnuwrAmiy~ -}    `gloss`  [ "panoramic [ [ bAnuwrAmiy ~ / ADJ ] ]" ] ]
 ...
 |> "ba.tlaymuws" <| [
    ...
    noun     Identity |< Iy            {- baTolayomuwsiy~ -} -- `others` [ "ba.tlamiyuwsiyy Nall" ]
                                                            `gloss`  [ "Ptolemaic [ [ baTolayomuwsiy ~ / NOUN ] ]", "Ptolemaic [ [ baTolayomuwsiy ~ / ADJ ] ]", "Ptolemaic [ [ baTolamiyuwsiy ~ / NOUN ] ]", "Ptolemaic [ [ baTolamiyuwsiy ~ / ADJ ] ]" ] ]
 ...
 |> "ba.trak_hAn" <| [
    ...
    noun     Identity |< aT            {- baTorakoxAnap -}  `gloss`  [ "patriarchal seat" ] ]
 ...
 |> "ba.triyark" <| [
    ...
    noun     Identity |< Iy |< aT      {- baToriyarokiy~ap -} `gloss`  [ "patriarchate [ [ baToriyarkiy ~ / NOUN ] ]" ] ]
 ...
 |> "ba`labakk" <| [
    ...
    noun     Identity |< Iy            {- baEolabak~iy~ -}  `gloss`  [ "from / of Baalbek [ [ baEolabak ~ iy ~ / ADJ ] ]" ],
 ...
 |> "bab.gA'" <| [
    ...
    noun     Identity                  {- babogA' -}        -- `others` [ "babba.gA' Nh Nhy N0_Nh", "bab.gAw NAt", "babba.gAw NAt" ]
 ...
 |> "babr" <| [
    ...
    noun     Identity                  {- babor -}          -- `others` [ "bubuwr N" ]
                                                            `gloss`  [ "tiger", "tigers" ] ]
 ...
 |> "badAri" <| [
    ...
    noun     Identity                  {- badAri -}         -- `others` [ "AlbadAri FW-Wa" ]
                                                            `gloss`  [ "hurry ! [ [ badAri / INTERJ ] ]", "hurry ! [ [ AlobadAri / INTERJ ] ]" ] ]
 ...
 |> "bahlawAn" <| [
    ...
    noun     Identity |< Iy            {- baholawAniy~ -}   `gloss`  [ "acrobatic [ [ baholawAniy ~ / ADJ ] ]" ] ]
 ...
 |> "bakitt" <| [
    ...
    noun     Identity |< aT            {- bakit~ap -}       `gloss`  [ "packet" ] ]
 ...
 |> "bal.grAd" <| [
    ...
    noun     Identity |< Iy            {- balogrAdiy~ -}    -- `others` [ "bal^grAdiyy Nall" ]
                                                            `gloss`  [ "Belgrade [ [ balogrAdiy ~ / ADJ ] ]", "Belgrade [ [ balojrAdiy ~ / ADJ ] ]" ] ]
 ...
 |> "balansiy" <| [
    ...
    noun     Identity |< aT            {- balanosiyap -}    -- `others` [ "balansiyA N0" ]
                                                            `gloss`  [ "Valencia" ] ]
 ...
 |> "balha" <| [
    ...
    noun     Identity                  {- baloha -}         `gloss`  [ "not to mention [ [ baloha / ADV ] ]" ] ]
 ...
 |> "baluw^siyy" <| [
    ...
    noun     Identity                  {- baluw$iy~ -}      `gloss`  [ "Baluchi" ] ]
 ...
 |> "banAduwr" <| [
    ...
    noun     Identity |< aT            {- banAduwrap -}     -- `others` [ "banduwr Nap" ]
                                                            `gloss`  [ "tomatoes" ] ]
 ...
 |> "banafsa^g" <| [
    ...
    noun     Identity |< Iy            {- banafosajiy~ -}   `gloss`  [ "violet [ [ banafosajiy ~ / ADJ ] ]" ] ]
 ...
 |> "barquwq" <| [
    ...
    noun     Identity |< Iy            {- baroquwqiy~ -}    `gloss`  [ "plum", "purple [ [ baroquwqiy ~ / ADJ ] ]" ] ]
 ...
 |> "barriym" <| [
    ...
    noun     Identity |< aT            {- bar~iymap -}      `gloss`  [ "drill", "auger", "bit" ],

    -- ;; bar~iymiy~ap_1
    -- brymy   bar~iymiy~      Nap     drill-shaped;spirochete     [[bar~iymiy~/NOUN]]

    noun     Identity |< Iy |< aT      {- bar~iymiy~ap -}   `gloss`  [ "drill-shaped", "spirochete [ [ bar ~ iymiy ~ / NOUN ] ]" ] ]
 ...
 |> "bas.turm" <| [
    ...
    noun     Identity |< aT            {- basoTurmap -}     `gloss`  [ "basturma ( grilled marinated meat )" ] ]
 ...
 |> "bastill" <| [
    ...
    noun     Identity |< aT            {- basotil~ap -}     `gloss`  [ "tub" ] ]
 ...
 |> "bastuwniyy" <| [
    ...
    noun     Identity                  {- bastuwniy~ -}     `gloss`  [ "spades" ] ]
 ...
 |> "bayruwtiyy" <| [
    ...
    noun     Identity                  {- bayoruwtiy~ -}    `gloss`  [ "Beirouti", "Bairuti" ] ]
 ...
 |> "bi-" <| [
    ...
    noun     Identity                  {- bi- -}            -- `others` [ "bikum FW-Wa", "bihim FW-Wa", "biki FW-Wa", "binA FW-Wa", "biya FW-Wa", "bikunna FW-Wa", "bihinna FW-Wa", "bihimA FW-Wa", "bika FW-Wa", "bihi FW-Wa", "bihA FW-Wa", "bikumA FW-Wa" ]
                                                            `gloss`  [ "with / by + it / him [ [ bi / PREP+hi / PRON_3MS ] ]", "with / by + them both [ [ bi / PREP+himA / PRON_3D ] ]", "with / by + it / them / her [ [ bi / PREP+hA / PRON_3FS ] ]", "with / by + them [ masc.pl . ] [ [ bi / PREP+him / PRON_3MP ] ]", "with / by + them [ fem.pl . ] [ [ bi / PREP+hin ~ a / PRON_3FP ] ]", "with / by + you [ masc.sg . ] [ [ bi / PREP+ka / PRON_2MS ] ]", "with / by + you [ fem.sg . ] [ [ bi / PREP+ki / PRON_2FS ] ]", "with / by + you both [ [ bi / PREP+kumA / PRON_2D ] ]", "with / by + you [ masc.pl . ] [ [ bi / PREP+kum / PRON_2MP ] ]", "with / by + you [ fem.pl . ] [ [ bi / PREP+kun ~ a / PRON_2FP ] ]", "with / by + me [ [ bi / PREP+ya / PRON_1S ] ]", "with / by + us [ [ bi / PREP+nA / PRON_1P ] ]" ] ]
 ...
 |> "bi^sill" <| [
    ...
    noun     Identity |< aT            {- bi$il~ap -}       `gloss`  [ "bacillus" ] ]
 ...
 |> "bilA^sakk" <| [
    ...
    noun     Identity                  {- bilA$ak~ -}       `gloss`  [ "undoubtedly [ [ bilA $ ak ~ / ADV ] ]" ] ]
 ...
 |> "biliyziyy" <| [
    ...
    noun     Identity                  {- biliyziy~ -}      `gloss`  [ "Belizean", "Belizian" ] ]
 ...
 |> "billawriyy" <| [
    ...
    noun     Identity                  {- bil~aworiy~ -}    `gloss`  [ "crystalline [ [ bil ~ aworiy ~ / ADJ ] ]" ] ]
 ...
 |> "bimA" <| [
    ...
    noun     Identity                  {- bimA -}           `gloss`  [ "by / with + what [ [ bi / PREP+mA / REL_PRON ] ]" ],

    -- ;; bimA_2
    -- bmA     bimA    FW-Wa   by/with + what/which   [[bi/PREP+mA/INTERROG_PART]]

    noun     Identity                  {- bimA -}           `gloss`  [ "by / with + what / which [ [ bi / PREP+mA / INTERROG_PART ] ]" ] ]
 ...
 |> "bima" <| [
    ...
    noun     Identity                  {- bima -}           `gloss`  [ "with what [ [ be / PREP+ma / INTERROG_PART ] ]" ] ]
 ...
 |> "bimbA^siyy" <| [
    ...
    noun     Identity                  {- bimobA$iy~ -}     `gloss`  [ "lieutenant colonel [ [ bimobA $ iy ~ / ADJ ] ]" ] ]
 ...
 |> "binsilfAn" <| [
    ...
    noun     Identity |< Iy            {- binosilofAniy~ -} `gloss`  [ "Pennsylvanian [ [ binosilofAniy ~ / NOUN ] ]", "Pennsylvanian [ [ binosilofAniy ~ / ADJ ] ]" ] ]
 ...
 |> "bismi" <| [
    ...
    noun     Identity                  {- bisomi -}         `gloss`  [ "in / by + ( the ) Name of [ [ bi / PREP+somi / NOUN ] ]" ] ]
 ...
 |> "biyanAl" <| [
    ...
    noun     Identity |< Iy            {- biyanAliy~ -}     `gloss`  [ "biennial [ [ biyanAliy ~ / ADJ ] ]" ] ]
 ...
 |> "biyruwniyy" <| [
    ...
    noun     Identity                  {- biyruwniy~ -}     `gloss`  [ "Biruni", "Birouni" ] ]
 ...
 |> "biyruwqrA.tiyy" <| [
    ...
    noun     Identity                  {- biyruwqrATiy~ -}  `gloss`  [ "bureaucratic [ [ biyruwqrATiy ~ / ADJ ] ]" ],
 ...
 |> "biyrwAniyy" <| [
    ...
    noun     Identity                  {- biyrwAniy~ -}     `gloss`  [ "Peruvian [ [ biyrwAniy ~ / NOUN ] ]", "Peruvian [ [ biyrwAniy ~ / ADJ ] ]" ] ]
 ...
 |> "biyzan.t" <| [
    ...
    noun     Identity |< Iy            {- biyzanoTiy~ -}    `gloss`  [ "Byzantine [ [ biyzanoTiy ~ / NOUN ] ]", "Byzantine [ [ biyzanoTiy ~ / ADJ ] ]" ] ]
 ...
 |> "bizan.tiyy" <| [
    ...
    noun     Identity                  {- bizanoTiy~ -}     `gloss`  [ "Byzantine [ [ bizanoTiy ~ / NOUN ] ]", "Byzantine [ [ bizanoTiy ~ / ADJ ] ]" ] ]
 ...
 |> "bizill" <| [
    ...
    noun     Identity |< aT            {- bizil~ap -}       -- `others` [ "bizillA N0", "bisill Nap" ]
                                                            `gloss`  [ "green peas" ] ]
 ...
 |> "bluwtuwniyy" <| [
    ...
    noun     Identity                  {- bluwtuwniy~ -}    `gloss`  [ "plutonium [ [ bluwtuwniy ~ / ADJ ] ]" ] ]
 ...
 |> "bluwtuwqrA.tiyy" <| [
    ...
    noun     Identity                  {- bluwtuwqrATiy~ -} `gloss`  [ "plutocrat" ],

    -- ;; bluwtuwqrATiy~_2
    -- blwtwqrATy      bluwtuwqrATiy~  Nall    plutocratic     [[bluwtuwqrATiy~/ADJ]]

    noun     Identity                  {- bluwtuwqrATiy~ -} `gloss`  [ "plutocratic [ [ bluwtuwqrATiy ~ / ADJ ] ]" ],

    -- ;; bluwtuwqrATiy~ap_1
    -- blwtwqrATy      bluwtuwqrATiy~  Napdu   plutocracy     [[bluwtuwqrATiy~/ADJ]]
    -- blwtwqrATy      bluwtuwqrATiy~  NAt     plutocracies     [[bluwtuwqrATiy~/ADJ]]

    noun     Identity |< aT            {- bluwtuwqrATiy~ap -} -- `others` [ "bluwtuwqrA.tiyy NAt" ]
                                                            `gloss`  [ "plutocracy [ [ bluwtuwqrATiy ~ / ADJ ] ]", "plutocracies [ [ bluwtuwqrATiy ~ / ADJ ] ]" ] ]
 ...
 |> "brAfuw" <| [
    ...
    noun     Identity                  {- brAfuw -}         `gloss`  [ "bravo [ [ brAVuw / INTERJ ] ]" ] ]
 ...
 |> "bruwf" <| [
    ...
    noun     Identity |< aT            {- bruwfap -}        `gloss`  [ "test", "trial run", "proof" ] ]
 ...
 |> "bruwliytAriyy" <| [
    ...
    noun     Identity                  {- bruwliytAriy~ -}  `gloss`  [ "proletarian [ [ bruwliytAriy ~ / ADJ ] ]" ] ]
 ...
 |> "bruwtistAntiyy" <| [
    ...
    noun     Identity                  {- bruwtisotAnotiy~ -} -- `others` [ "bruwtistAnt N", "bruwtistAntiyniyy Nall" ]
                                                            `gloss`  [ "Protestant [ [ bruwtisotAntiy ~ / NOUN ] ]", "Protestant [ [ bruwtisotAntiy ~ / ADJ ] ]", "Protestant [ [ bruwtisotAntiyniy ~ / NOUN ] ]", "Protestant [ [ bruwtisotAntiyniy ~ / ADJ ] ]", "Protestants" ] ]
 ...
 |> "bruwtuwkuwliyy" <| [
    ...
    noun     Identity                  {- bruwtuwkuwliy~ -} `gloss`  [ "protocol [ [ bruwtuwkuwliy ~ / ADJ ] ]" ] ]
 ...
 |> "bsiykuwluw^g" <| [
    ...
    noun     Identity |< Iy            {- bsiykuwluwjiy~ -} `gloss`  [ "psychological [ [ bsiykuwluwjiy ~ / ADJ ] ]" ] ]
 ...
 |> "bu`kuwk" <| [
    ...
    noun     Identity |< aT            {- buEokuwkap -}     `gloss`  [ "club", "society" ] ]
 ...
 |> "bulahniy" <| [
    ...
    noun     Identity |< aT            {- bulahoniyap -}    `gloss`  [ "wealth", "abundance" ] ]
 ...
 |> "bunduqAn" <| [
    ...
    noun     Identity |< Iy            {- bunoduqAniy~ -}   `gloss`  [ "Venetian [ [ bunoduqAniy ~ / NOUN ] ]", "Venetian [ [ bunoduqAniy ~ / ADJ ] ]" ] ]
 ...
 |> "bur^sAm^g" <| [
    ...
    noun     Identity |< Iy            {- buro$Amojiy~ -}   `gloss`  [ "riveter [ [ buro $ Amojiy ~ / ADJ ] ]", "riveting [ [ buro $ Amojiy ~ / NOUN ] ]" ] ]
 ...
 |> "burnay.t" <| [
    ...
    noun     Identity |< aT            {- buronayoTap -}    -- `others` [ "barAniy.t Ndip" ]
 ...
 |> "burtuw.gAl" <| [
    ...
    noun     Identity |< Iy            {- burotuwgAliy~ -}  `gloss`  [ "Portuguese [ [ burotuwgAliy ~ / NOUN ] ]", "Portuguese [ [ burotuwgAliy ~ / ADJ ] ]" ] ]
 ...
 |> "buruw^giyy" <| [
    ...
    noun     Identity                  {- buruwjiy~ -}      `gloss`  [ "trumpeter", "bugler [ [ buruwjiy ~ / ADJ ] ]" ] ]
 ...
 |> "buruwsiyy" <| [
    ...
    noun     Identity                  {- buruwsiy~ -}      `gloss`  [ "Prussian [ [ buruwsiy ~ / NOUN ] ]", "Prussian [ [ buruwsiy ~ / ADJ ] ]" ] ]
 ...
 |> "bustAniyy" <| [
    ...
    noun     Identity                  {- busotAniy~ -}     `gloss`  [ "Boustani" ],
 ...
 |> "buw_hArist" <| [
    ...
    noun     Identity |< Iy            {- buwxArisotiy~ -}  `gloss`  [ "of / from Bucharest [ [ buwxArisotiy ~ / ADJ ] ]" ] ]
 ...
 |> "buway_hir" <| [
    ...
    noun     Identity |< aT            {- buwayoxirap -}    `gloss`  [ "small steamship" ] ]
 ...
 |> "buwdAbist" <| [
    ...
    noun     Identity |< Iy            {- buwdAbisotiy~ -}  `gloss`  [ "of / from Budapest [ [ buwdAbisotiy ~ / ADJ ] ]" ] ]
 ...
 |> "buwdaq" <| [
    ...
    noun     Identity |< aT            {- buwdaqap -}       -- `others` [ "bawAdiq Ndip" ]
 ...
 |> "buwdr" <| [
    ...
    noun     Identity |< aT            {- buwdrap -}        `gloss`  [ "powder" ] ]
 ...
 |> "buwr^guwAz" <| [
    ...
    noun     Identity |< Iy            {- buwrojuwAziy~ -}  -- `others` [ "bur^guwAziyy Nall" ]
                                                            `gloss`  [ "bourgeois [ [ buwrojuwAziy ~ / ADJ ] ]", "bourgeois [ [ burojuwAziy ~ / ADJ ] ]" ],
 ...
 |> "buwrm" <| [
    ...
    noun     Identity |< Iy            {- buwromiy~ -}      `gloss`  [ "Burmese [ [ buwromiy ~ / NOUN ] ]", "Burmese [ [ buwromiy ~ / ADJ ] ]" ] ]
 ...
 |> "buwrsa`iyd" <| [
    ...
    noun     Identity |< Iy            {- buwrosaEiydiy~ -} `gloss`  [ "from / of Port Said [ [ buwrosaEiydiy ~ / ADJ ] ]" ] ]
 ...
 |> "buwrsuwdAn" <| [
    ...
    noun     Identity |< Iy            {- buwrosuwdAniy~ -} `gloss`  [ "from / of Port Sudan [ [ buwrosuwdAniy ~ / ADJ ] ]" ] ]
 ...
 |> "buwrund" <| [
    ...
    noun     Identity |< Iy            {- buwrunodiy~ -}    -- `others` [ "buruwndiyy Nall", "buwruwndiyy Nall", "burundiyy Nall" ]
                                                            `gloss`  [ "Burundian [ [ buwruwnodiy ~ / ADJ ] ]", "Burundian [ [ buruwnodiy ~ / ADJ ] ]", "Burundian [ [ burunodiy ~ / ADJ ] ]" ] ]
 ...
 |> "buws.t" <| [
    ...
    noun     Identity |< aT            {- buwsoTap -}       -- `others` [ "buwst Nap" ]
                                                            `gloss`  [ "mail" ] ]
 ...
 |> "buws.ta^g" <| [
    ...
    noun     Identity |< Iy            {- buwsoTajiy~ -}    `gloss`  [ "mailman [ [ buwsoTajiy ~ / ADJ ] ]" ] ]
 ...
 |> "buwtaq" <| [
    ...
    noun     Identity |< aT            {- buwtaqap -}       -- `others` [ "bawAtiq Ndip" ]
                                                            `gloss`  [ "crucible", "melting pot", "crucibles", "melting pots" ] ]
 ...
 |> "ibti.gA'a" <| [
    ...
    noun     Identity                  {- {ibotigA'a -}     `gloss`  [ "with the aim of", "for the purpose of [ [ { ibotigA'a / PREP ] ]" ] ]
