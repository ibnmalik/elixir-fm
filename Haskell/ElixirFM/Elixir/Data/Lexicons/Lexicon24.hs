...
lexicon = listing "Lexicon properties"
 ...
 |> "'amAliyd" <| [
    ...
    noun     Identity                  {- OamAliyd -}       `gloss`  [ "tender twigs" ] ]
 ...
 |> "'imlA'iyy" <| [
    ...
    noun     Identity                  {- IimolA}iy~ -}     `gloss`  [ "orthographic", "spelling [ [" ] ]
 ...
 |> "'um.huw.d" <| [
    ...
    noun     Identity |< aT            {- OumoHuwDap -}     `gloss`  [ "sincere advice" ] ]
 ...
 |> "'umluw.h" <| [
    ...
    noun     Identity |< aT            {- OumoluwHap -}     -- `others` [ "'amAliy.h Ndip" ]
 ...
 |> "imra'" <| [
    ...
    noun     Identity |< aT            {- {imoraOap -}      `gloss`  [ "woman" ] ]
 ...
 |> "imru'" <| [
    ...
    noun     Identity                  {- AimoruW -}        -- `others` [ "imri' FW-WaBi", "imra' FW-WaBi" ]
                                                            `gloss`  [ "Imru ' [ [ Aimoru& / NOUN_PROP ] ]", "Imra ' [ [ Aimora> / NOUN_PROP ] ]", "Imri ' [ [ Aimori } / NOUN_PROP ] ]" ] ]
 ...
 |> "istim" <| [
    ...
    noun     Identity |< At |< aT      {- {isotimAtap -}    `gloss`  [ "defiance of death", "desperate effort" ] ]
 ...
 |> "m ' '" <| [
    ...
    noun     FiCY |< Iy                {- mi}awiy~ -}       -- `others` [ "miA'awiyy Nall" ]
 ...
 |> "m ' .z" <| [
    ...
    noun     FAL |< aT                 {- mAZap -}          `gloss`  [ "appetizers" ] ]
 ...
 |> "m ' ^g" <| [
    ...
    noun     FACiL                     {- mA}ij -}          `gloss`  [ "surging", "swelling", "stormy [ [ mA } ij / ADJ ] ]" ] ]
 ...
 |> "m ' l" <| [
    ...
    noun     FACiL                     {- mA}il -}          `gloss`  [ "biased", "partial [ [ mA } il / ADJ ] ]" ],

    -- ;; mA}il_3
    -- mA}l    mA}il   N-ap    italic     [[mA}il/ADJ]]

    noun     FACiL                     {- mA}il -}          `gloss`  [ "italic [ [ mA } il / ADJ ] ]" ] ]
 ...
 |> "m ' m" <| [
    ...
    noun     CiL |< At |< aT           {- IimAtap -}        `gloss`  [ "mortification", "killing" ] ]
 ...
 |> "m ' m '" <| [
    ...
    verb     KaRDaS                    {- maOomaO -}        -- `others` [ "ma'mi' IV_yu", "ma'ma'A PV-|" ]
                                                            `gloss`  [ "bleat" ] ]
 ...
 |> "m ' n" <| [
    ...
    verb     FaCaL                     {- maOan-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "m'an IV-n" ]
    ...
    noun     FaCL                      {- maOon -}          `gloss`  [ "sustaining", "providing" ],
    ...
    noun     FaCL |< aT                {- maOonap -}        -- `others` [ "mu'uwn N", "ma'an NAt" ]
    ...
    noun     FuCL |< aT                {- muWonap -}        -- `others` [ "mu'an N", "ma'uwn Nap" ]
                                                            `gloss`  [ "provisions", "supplies", "materiel" ] ]
 ...
 |> "m ' q" <| [
    ...
    noun     FaCL                      {- maOoq -}          -- `others` [ "ma'qay NAn_Nayn", "ma'qA Nhy", "'AmAq N", "ma'Aq NK", "ma'qY N0", "ma'Aqiy N0_Nh" ]
                                                            `gloss`  [ "inner corner of the eye", "inner corners of the eyes", "inner corners of the eye" ],

    -- ;; ma>oqap_1
    -- m>q     ma>oq   Nap     sobbing;sob

    noun     FaCL |< aT                {- maOoqap -}        `gloss`  [ "sobbing", "sob" ],
 ...
 |> "m ' t" <| [
    ...
    noun     FACiL                     {- mA}it -}          -- `others` [ "mAyit Nall" ]
                                                            `gloss`  [ "moribund", "mortal [ [ mA } it / ADJ ] ]", "mortal" ] ]
 ...
 |> "m ' z" <| [
    ...
    noun     FAL |< aT                 {- mAzap -}          -- `others` [ "mAzaw NAt", "mAzA N0" ]
 ...
 |> "m .d '" <| [
    ...
    noun     FaCAL                     {- maDA' -}          -- `others` [ "'am.dA Nhy", "'am.day NAn_Nayn", "'am.dY N0" ]
    ...
    noun     HiFCAL                    {- IimoDA' -}        `gloss`  [ "accomplishment", "completion" ] ]
 ...
 |> "m .d .d" <| [
    ...
    verb     FaCL                      {- maD~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "m.du.d IV_C", "mu.d.d IV_V", "ma.da.d PV_C" ]
    ...
    verb     FaCL                      {- maD~-a -}         `imperf` [ FCaL ]
                                                            -- `others` [ "m.da.d IV_C_intr", "ma.di.d PV_C_intr" ]
    ...
    noun     FaCAL |< aT               {- maDADap -}        `gloss`  [ "agony" ],

    -- ;; mumiD~_1
    -- mmD     mumiD~  Nall    agonizing;tormenting     [[mumiD~/ADJ]]

    noun     MuFiCL                    {- mumiD~ -}         `gloss`  [ "agonizing", "tormenting [ [ mumiD ~ / ADJ ] ]" ],
 ...
 |> "m .d .g" <| [
    ...
    noun     FuCL |< aT                {- muDogap -}        -- `others` [ "mu.da.g N" ]
                                                            `gloss`  [ "morsel", "bite", "morsels", "bites" ],

    -- ;; muDAgap_1
    -- mDAg    muDAg   Nap     chewed;quid

    noun     FuCAL |< aT               {- muDAgap -}        `gloss`  [ "chewed", "quid" ] ]
 ...
 |> "m .d m .d" <| [
    ...
    verb     KaRDaS                    {- maDomaD -}        -- `others` [ "ma.dmi.d IV_yu" ]
                                                            `gloss`  [ "rinse", "gargle" ],
    ...
    verb     TaKaRDaS                  {- tamaDomaD -}      `gloss`  [ "rinse", "gargle" ],

    -- ;; maDomaDap_1
    -- mDmD    maDomaD Nap     rinsing;gargling

    noun     KaRDaS |< aT              {- maDomaDap -}      `gloss`  [ "rinsing", "gargling" ] ]
 ...
 |> "m .d r" <| [
    ...
    noun     FuCaL                     {- muDar -}          `gloss`  [ "Mudar ( ancestral Arabs )" ],

    -- ;; muDar_2
    -- mDr     muDar   Ndip    Mudar

    noun     FuCaL                     {- muDar -}          `gloss`  [ "Mudar" ] ]
 ...
 |> "m .d y" <| [
    ...
    noun     TaFCiL |< aT              {- tamoDiyap -}      `gloss`  [ "spending", "execution", "completion" ],
    ...
    noun     HiFCA'                    {- IimoDA' -}        `gloss`  [ "accomplishment", "completion" ],
    ...
    noun     MuFCY                     {- mumoDaY -}        -- `others` [ "mum.d Nuwn_Niyn", "mum.dA Napdu Nhy", "mum.day NAt NAn_Nayn" ]
 ...
 |> "m .g .s" <| [
    ...
    noun     FaCIL                     {- magiyS -}         `gloss`  [ "colic [ [ magiyS / ADJ ] ]" ],

    -- ;; mamoguwS_1
    -- mmgwS   mamoguwS        Nall    colicky     [[mamoguwS/ADJ]]

    noun     MaFCUL                    {- mamoguwS -}       `gloss`  [ "colicky [ [ mamoguwS / ADJ ] ]" ] ]
 ...
 |> "m .g .t" <| [
    ...
    noun     MutaFaCCiL                {- mutamag~iT -}     `gloss`  [ "elastic", "stretchable [ [ mutamag ~ iT / ADJ ] ]" ] ]
 ...
 |> "m .g .t s" <| [
    ...
    verb     KaRDaS                    {- magoTas -}        -- `others` [ "ma.g.tis IV_yu" ]
                                                            `gloss`  [ "magnetize" ],
    ...
    verb     TaKaRDaS                  {- tamagoTas -}      `gloss`  [ "be magnetized" ],

    -- ;; magoTasap_1
    -- mgTs    magoTas Nap     magnetism;magnetization

    noun     KaRDaS |< aT              {- magoTasap -}      `gloss`  [ "magnetism", "magnetization" ],

    -- ;; mumagoTas_1
    -- mmgTs   mumagoTas       N-ap    magnetized;magnetic     [[mumagoTas/ADJ]]

    noun     MuKaRDaS                  {- mumagoTas -}      `gloss`  [ "magnetized", "magnetic [ [ mumagoTas / ADJ ] ]" ] ]
 ...
 |> "m .g l" <| [
    ...
    noun     FaCUL                     {- maguwl -}         -- `others` [ "mu.guwl N" ]
    ...
    noun     FaCUL |< Iy               {- maguwliy~ -}      -- `others` [ "mu.guwliyy Nall" ]
                                                            `gloss`  [ "Mongol", "Mogul [ [ maguwliy ~ / NOUN ] ]", "Mogul [ [ muguwliy ~ / NOUN ] ]", "Mogul [ [ maguwliy ~ / ADJ ] ]", "Mogul [ [ muguwliy ~ / ADJ ] ]" ] ]
 ...
 |> "m .g n" <| [
    ...
    noun     FuCL |< aT                {- mugonap -}        `gloss`  [ "mahogany" ],
 ...
 |> "m .g n .t" <| [
    ...
    verb     KaRDaS                    {- magonaT -}        -- `others` [ "ma.gni.t IV_yu" ]
                                                            `gloss`  [ "magnetize" ],
    ...
    verb     TaKaRDaS                  {- tamagonaT -}      `gloss`  [ "be magnetized" ],

    -- ;; magonaTap_1
    -- mgnT    magonaT Nap     magnetism;magnetization

    noun     KaRDaS |< aT              {- magonaTap -}      `gloss`  [ "magnetism", "magnetization" ],

    -- ;; mumagonaT_1
    -- mmgnT   mumagonaT       N-ap    magnetized;magnetic     [[mumagonaT/ADJ]]

    noun     MuKaRDaS                  {- mumagonaT -}      `gloss`  [ "magnetized", "magnetic [ [ mumagonaT / ADJ ] ]" ] ]
 ...
 |> "m .g n s" <| [
    ...
    noun     KaRDIS |< Iy              {- magoniysiy~ -}    `gloss`  [ "magnesium [ [ magoniysiy ~ / ADJ ] ]" ] ]
 ...
 |> "m .g r" <| [
    ...
    noun     FuCL |< aT                {- mugorap -}        `gloss`  [ "reddish" ],

    -- ;; >amogar_1
    -- >mgr    >amogar Nel     reddish
    -- Amgr    >amogar Nel     reddish

    noun     HaFCaL                    {- Oamogar -}        `gloss`  [ "reddish" ] ]
 ...
 |> "m .g r b" <| [
    ...
    verb     KaRDaS                    {- magorab -}        -- `others` [ "ma.grib IV_yu" ]
                                                            `gloss`  [ "Moroccanize" ],

    -- ;; magorabap_1
    -- mgrb    magorab Nap     Moroccanization

    noun     KaRDaS |< aT              {- magorabap -}      `gloss`  [ "Moroccanization" ] ]
 ...
 |> "m .g z" <| [
    ...
    noun     FaCAL |< aT               {- magAzap -}        `gloss`  [ "shop", "store" ] ]
 ...
 |> "m .h '" <| [
    ...
    noun     InFiCAL                   {- {inomiHA' -}      -- `others` [ "immi.hA' NAt Nh Nayn NAn_Nayn Nhy N0_Nh" ]
 ...
 |> "m .h .d" <| [
    ...
    verb     HaFCaL                    {- OamoHaD -}        -- `others` [ "m.hi.d IV_intr_yu" ]
                                                            `gloss`  [ "be sincere toward" ],
 ...
 |> "m .h .h" <| [
    ...
    verb     FaCLY                     {- maH~aY -}         -- `others` [ "ma.h.hiy IV_0hAnn_yu", "ma.h.h IV_0hwnyn_yu PV_ttAw", "ma.h.hay PV_Atn IV_Ann_Pass_yu", "ma.h.hA PV_h" ]
 ...
 |> "m .h .s" <| [
    ...
    verb     HaFCaL                    {- OamoHaS -}        -- `others` [ "m.hi.s IV_yu" ]
    ...
    noun     FaCIL                     {- maHiyS -}         `gloss`  [ "shining", "flashing [ [ maHiyS / ADJ ] ]" ],
 ...
 |> "m .h k" <| [
    ...
    verb     FaCaL                     {- maHak-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "m.hak IV_intr", "ma.hik PV_intr" ]
    ...
    verb     HaFCaL                    {- OamoHak -}        -- `others` [ "m.hik IV_intr_yu" ]
                                                            `gloss`  [ "be contentious", "be quarrelsome" ],
    ...
    noun     MuFACaL |< aT             {- mumAHakap -}      `gloss`  [ "wrangle", "dispute", "bickering" ],
 ...
 |> "m .h l" <| [
    ...
    verb     FaCaL                     {- maHal-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "m.hal IV_intr", "ma.hil PV_intr" ]
    ...
    verb     HaFCaL                    {- OamoHal -}        -- `others` [ "m.hil IV_intr_yu" ]
    ...
    noun     FACiL                     {- mAHil -}          `gloss`  [ "barren", "sterile", "bleak [ [ mAHil / ADJ ] ]" ],

    -- ;; mumoHil_1
    -- mmHl    mumoHil N-ap    barren;sterile;bleak     [[mumoHil/ADJ]]

    noun     MuFCiL                    {- mumoHil -}        `gloss`  [ "barren", "sterile", "bleak [ [ mumoHil / ADJ ] ]" ] ]
 ...
 |> "m .h n" <| [
    ...
    noun     IFtiCAL |< Iy             {- {imotiHAniy~ -}   `gloss`  [ "test", "trial", "examination [ [ { imotiHAniy ~ / ADJ ] ]" ],
    ...
    noun     MuFtaCaL                  {- mumotaHan -}      `gloss`  [ "examined", "tested", "test taker [ [ mumotaHan / ADJ ] ]" ],
 ...
 |> "m .h q" <| [
    ...
    verb     HaFCaL                    {- OamoHaq -}        -- `others` [ "m.hiq IV_yu" ]
                                                            `gloss`  [ "wane", "vanish" ],
 ...
 |> "m .h w" <| [
    ...
    verb     FaCA                      {- maHA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "m.hY IV_0_Pass_yu", "ma.h PV_ttAw", "m.hay IV_Ann_Pass_yu", "m.h IV_0hwnyn", "ma.haw PV_Atn", "m.huw IV_0hAnn" ]
    ...
    noun     MiFCY |< aT               {- mimoHAp -}        -- `others` [ "mamA.hiy N0_Nh", "mamA.h NK" ]
    ...
    noun     FACI |< aT                {- mAHiyap -}        `gloss`  [ "eraser" ],

    -- ;; mamoHuw~_1
    -- mmHw    mamoHuw~        N-ap    erased;wiped out     [[mamoHuw~/ADJ]]

    noun     MaFCUL                    {- mamoHuw~ -}       `gloss`  [ "erased", "wiped out [ [ mamoHuw ~ / ADJ ] ]" ] ]
 ...
 |> "m .h w r" <| [
    ...
    verb     KaRDaS                    {- maHowar -}        -- `others` [ "ma.hwir IV_yu" ]
                                                            `gloss`  [ "make rotate" ],
    ...
    noun     TaKaRDuS                  {- tamaHowur -}      `gloss`  [ "revolving", "rotating" ],

    -- ;; mutamaHowir_1
    -- mtmHwr  mutamaHowir     N-ap    revolving;rotating     [[mutamaHowir/ADJ]]

    noun     MutaKaRDiS                {- mutamaHowir -}    `gloss`  [ "revolving", "rotating [ [ mutamaHowir / ADJ ] ]" ] ]
 ...
 |> "m .h y" <| [
    ...
    noun     FaCCAL |< aT              {- maH~Ayap -}       `gloss`  [ "eraser" ],

    -- ;; mAHiyap_1
    -- mAHy    mAHiy   NapAt   eraser

    noun     FACiL |< aT               {- mAHiyap -}        `gloss`  [ "eraser" ] ]
 ...
 |> "m .s .s" <| [
    ...
    verb     FaCL                      {- maS~-a -}         `imperf` [ FCaL ]
                                                            -- `others` [ "m.sa.s IV_C", "ma.si.s PV_C" ]
    ...
    noun     FuCAL |< aT               {- muSASap -}        `gloss`  [ "sucker" ],

    -- ;; maSASap_1
    -- mSAS    maSAS   Nap     screech owl;vampire

    noun     FaCAL |< aT               {- maSASap -}        `gloss`  [ "screech owl", "vampire" ],

    -- ;; maSiyS_1
    -- mSyS    maSiyS  N-ap    moist;damp     [[maSiyS/ADJ]]

    noun     FaCIL                     {- maSiyS -}         `gloss`  [ "moist", "damp [ [ maSiyS / ADJ ] ]" ],
    ...
    noun     MaFCUL                    {- mamoSuwS -}       `gloss`  [ "drained", "emaciated [ [ mamoSuwS / ADJ ] ]" ],
 ...
 |> "m .s l" <| [
    ...
    noun     FaCL |< Iy                {- maSoliy~ -}       `gloss`  [ "serous", "serum [ [ maSoliy ~ / ADJ ] ]" ] ]
 ...
 |> "m .s m .s" <| [
    ...
    verb     KaRDaS                    {- maSomaS -}        -- `others` [ "ma.smi.s IV_yu" ]
                                                            `gloss`  [ "suck", "absorb" ],
    ...
    verb     TaKaRDaS                  {- tamaSomaS -}      `gloss`  [ "sip", "slosh in the mouth" ] ]
 ...
 |> "m .s r" <| [
    ...
    noun     MutaFaCCiL                {- mutamaS~ir -}     `gloss`  [ "Egyptianized [ [ mutamaS ~ ir / ADJ ] ]" ] ]
 ...
 |> "m .t .t" <| [
    ...
    verb     FaCL                      {- maT~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "ma.ta.t PV_C", "mu.t.t IV_V", "m.tu.t IV_C" ]
 ...
 |> "m .t l" <| [
    ...
    noun     FaCIL |< aT               {- maTiylap -}       -- `others` [ "ma.tA'il Ndip" ]
                                                            `gloss`  [ "wrought iron" ],
 ...
 |> "m .t r" <| [
    ...
    verb     HaFCaL                    {- OamoTar -}        -- `others` [ "m.tar IV_Pass_yu", "m.tir IV_yu" ]
    ...
    noun     FaCL |< aT                {- maTorap -}        -- `others` [ "ma.tiyr N-ap", "ma.tar NAt NapAt", "ma.tir N-ap" ]
 ...
 |> "m .t r n" <| [
    ...
    verb     KaRDaS                    {- maToran -}        -- `others` [ "ma.trin IV-n_yu" ]
    ...
    verb     TaKaRDaS                  {- tamaToran -}      `gloss`  [ "be installed as archbishop" ],
    ...
    noun     KuRDAS                    {- muTorAn -}        `gloss`  [ "Mutran" ],

    -- ;; maToranap_1
    -- mTrn    maToran Nap     archbishopric

    noun     KaRDaS |< aT              {- maToranap -}      `gloss`  [ "archbishopric" ],

    -- ;; maToraniy~ap_1
    -- mTrny   maToraniy~      NapAt   archbishopric;archdiocese     [[maToraniy~/NOUN]]

    noun     KaRDaS |< Iy |< aT        {- maToraniy~ap -}   `gloss`  [ "archbishopric", "archdiocese [ [ maToraniy ~ / NOUN ] ]" ],

    -- ;; muTorAniy~ap_1
    -- mTrAny  muTorAniy~      NapAt   archbishopric;archdiocese     [[muTorAniy~/NOUN]]

    noun     KuRDAS |< Iy |< aT        {- muTorAniy~ap -}   `gloss`  [ "archbishopric", "archdiocese [ [ muTorAniy ~ / NOUN ] ]" ] ]
 ...
 |> "m .t w" <| [
    ...
    verb     FaCA                      {- maTA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "ma.t PV_ttAw", "m.tuw IV_0hAnn", "m.t IV_0hwnyn", "ma.taw PV_Atn" ]
                                                            `gloss`  [ "hurry" ],
    ...
    verb     HaFCY                     {- OamoTaY -}        -- `others` [ "m.tY IV_0_Pass_yu", "m.t IV_0hwnyn_yu", "'am.tay PV_Atn", "'am.t PV_ttAw", "m.tiy IV_0hAnn_yu", "'am.tA PV_h", "m.tay IV_Ann_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- maTowap -}        `gloss`  [ "hour", "time", "moment" ] ]
 ...
 |> "m .t y" <| [
    ...
    noun     FaCIL |< aT               {- maTiy~ap -}       -- `others` [ "ma.tAyA N0_Nhy" ]
 ...
 |> "m ^g ^g" <| [
    ...
    verb     FaCL                      {- maj~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "m^gu^g IV_C", "ma^ga^g PV_C", "mu^g^g IV_V" ]
 ...
 |> "m ^g d" <| [
    ...
    verb     FaCaL                     {- majad-u -}        `imperf` [ FCuL ]
                                                            -- `others` [ "m^gud IV_intr", "ma^gud PV_intr" ]
                                                            `gloss`  [ "be glorious" ],
    ...
    verb     HaFCaL                    {- Oamojad -}        -- `others` [ "m^gid IV_yu", "m^gad IV_Pass_yu" ]
    ...
    noun     FaCIL |< Iy               {- majiydiy~ -}      `gloss`  [ "medjidie ( Ottoman silver coin ) [ [ majiydiy ~ / ADJ ] ]" ],

    -- ;; >amojad_2
    -- >mjd    >amojad N0      Amjad;Amgad

    noun     HaFCaL                    {- Oamojad -}        `gloss`  [ "Amjad", "Amgad" ],
 ...
 |> "m ^g d l" <| [
    ...
    noun     KaRDaS                    {- majodal -}        `gloss`  [ "Majdal" ] ]
 ...
 |> "m ^g d y" <| [
    ...
    noun     KaRDiS                    {- majodiy -}        `gloss`  [ "Majdi", "Magdi" ] ]
 ...
 |> "m ^g m ^g" <| [
    ...
    verb     KaRDaS                    {- majomaj -}        -- `others` [ "ma^gmi^g IV" ]
                                                            `gloss`  [ "scribble", "scrawl" ],

    -- ;; majomajap_1
    -- mjmj    majomaj NapAt   scribbling;scrawling

    noun     KaRDaS |< aT              {- majomajap -}      `gloss`  [ "scribbling", "scrawling" ],

    -- ;; mumajomaj_1
    -- mmjmj   mumajomaj       N-ap    illegible;scribbled;scrawled

    noun     MuKaRDaS                  {- mumajomaj -}      `gloss`  [ "illegible", "scribbled", "scrawled" ] ]
 ...
 |> "m ^g n" <| [
    ...
    noun     FaCAL |< aT               {- majAnap -}        `gloss`  [ "buffoonery", "clowning" ],

    -- ;; majAnap_2
    -- mjAn    majAn   NapAt   prank;antic

    noun     FaCAL |< aT               {- majAnap -}        `gloss`  [ "prank", "antic" ],
    ...
    noun     FaCCAL |< Iy |< aT        {- maj~Aniy~ap -}    `gloss`  [ "gratuitousness [ [ maj ~ Aniy ~ / NOUN ] ]" ],
    ...
    noun     FuCUL |< Iy               {- mujuwniy~ -}      `gloss`  [ "sarcastic", "cynic [ [ mujuwniy ~ / ADJ ] ]" ],
 ...
 |> "m ^g r" <| [
    ...
    noun     FACUL                     {- mAjuwr -}         -- `others` [ "mawA^giyr Ndip" ]
 ...
 |> "m ^g r .t" <| [
    ...
    noun     KaRDIS                    {- majoriyT -}       `gloss`  [ "Madrid" ] ]
 ...
 |> "m ^g s" <| [
    ...
    noun     FaCUL |< Iy               {- majuwsiy~ -}      `gloss`  [ "Magian", "Magus [ [ majuwsiy ~ / NOUN ] ]", "Magus [ [ majuwsiy ~ / ADJ ] ]" ],

    -- ;; majuwsiy~ap_1
    -- mjwsy   majuwsiy~       Nap     Mazdaism     [[majuwsiy~/NOUN]]

    noun     FaCUL |< Iy |< aT         {- majuwsiy~ap -}    `gloss`  [ "Mazdaism [ [ majuwsiy ~ / NOUN ] ]" ] ]
 ...
 |> "m ^s .h" <| [
    ...
    noun     FaCL |< aT                {- ma$oHap -}        `gloss`  [ "extreme unction" ] ]
 ...
 |> "m ^s .t" <| [
    ...
    noun     FuCL |< Iy                {- mu$oTiy~ -}       `gloss`  [ "indented", "jagged", "comb-like [ [ mu $ oTiy ~ / ADJ ] ]" ],
    ...
    noun     FACiL |< aT               {- mA$iTap -}        `gloss`  [ "lady 's maid", "coiffeuse" ],

    -- ;; muma$~aT_1
    -- mm$T    muma$~aT        N-ap    combed     [[muma$~aT/ADJ]]

    noun     MuFaCCaL                  {- muma$~aT -}       `gloss`  [ "combed [ [ muma $ ~ aT / ADJ ] ]" ] ]
 ...
 |> "m ^s ^s" <| [
    ...
    verb     FaCL                      {- ma$~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "m^su^s IV_C", "ma^sa^s PV_C", "mu^s^s IV_V" ]
                                                            `gloss`  [ "macerate", "soak" ],
    ...
    verb     FaCLY                     {- ma$~aY -}         -- `others` [ "ma^s^s IV_0hwnyn_yu PV_ttAw", "ma^s^siy IV_0hAnn_yu", "ma^s^say PV_Atn IV_Ann_Pass_yu", "ma^s^sA PV_h" ]
                                                            `gloss`  [ "make walk", "adjust", "be made to walk", "be adjusted" ],

    -- ;; muw$iy_1
    -- mw$y    muw$iy  Nprop   Moshe

    noun     MUCI                      {- muw$iy -}         `gloss`  [ "Moshe" ],
 ...
 |> "m ^s m ^s" <| [
    ...
    noun     KiRDiS                    {- mi$omi$ -}        `gloss`  [ "apricot" ],

    -- ;; mi$omi$iy~_1
    -- m$m$y   mi$omi$iy~      N-ap    apricot-colored     [[mi$omi$iy~/ADJ]]

    noun     KiRDiS |< Iy              {- mi$omi$iy~ -}     `gloss`  [ "apricot-colored [ [ mi $ omi $ iy ~ / ADJ ] ]" ] ]
 ...
 |> "m ^s q" <| [
    ...
    noun     FiCL |< aT                {- mi$oqap -}        -- `others` [ "mi^saq N" ]
                                                            `gloss`  [ "wool", "cotton", "rag", "rags" ],

    -- ;; ma$iyq_1
    -- m$yq    ma$iyq  N-ap    slender;slim     [[ma$iyq/ADJ]]

    noun     FaCIL                     {- ma$iyq -}         `gloss`  [ "slender", "slim [ [ ma $ iyq / ADJ ] ]" ],
    ...
    noun     IFtiCAL                   {- {imoti$Aq -}      `gloss`  [ "slenderness" ],

    -- ;; mamo$uwq_1
    -- mm$wq   mamo$uwq        Nall    slender;slim     [[mamo$uwq/ADJ]]

    noun     MaFCUL                    {- mamo$uwq -}       `gloss`  [ "slender", "slim [ [ mamo $ uwq / ADJ ] ]" ] ]
 ...
 |> "m ^s w r" <| [
    ...
    verb     TaKaRDaS                  {- tama$owar -}      `gloss`  [ "walk", "promenade" ],

    -- ;; tama$owur_1
    -- tm$wr   tama$owur       N       walking;promenading

    noun     TaKaRDuS                  {- tama$owur -}      `gloss`  [ "walking", "promenading" ],

    -- ;; mi$owAr_3
    -- m$wAr   mi$owAr N       walk;promenade

    noun     KiRDAS                    {- mi$owAr -}        `gloss`  [ "walk", "promenade" ],

    -- ;; mutama$owir_1
    -- mtm$wr  mutama$owir     Nall    walking;promenading     [[mutama$owir/ADJ]]

    noun     MutaKaRDiS                {- mutama$owir -}    `gloss`  [ "walking", "promenading [ [ mutama $ owir / ADJ ] ]" ] ]
 ...
 |> "m ^s y" <| [
    ...
    verb     HaFCY                     {- Oamo$aY -}        -- `others` [ "m^siy IV_0hAnn_yu", "'am^s PV_ttAw", "m^s IV_0hwnyn_yu", "m^sY IV_0_Pass_yu", "'am^say PV_Atn", "'am^sA PV_h", "m^say IV_Ann_Pass_yu" ]
                                                            `gloss`  [ "make walk", "adjust", "be made to walk", "be adjusted" ],
    ...
    noun     FiCL |< aT                {- mi$oyap -}        `gloss`  [ "pace", "step" ],

    -- ;; ma$~Ayap_1
    -- m$Ay    ma$~Ay  NapAt   hall;corridor;footpath

    noun     FaCCAL |< aT              {- ma$~Ayap -}       `gloss`  [ "hall", "corridor", "footpath" ],
    ...
    noun     MaFCY                     {- mamo$aY -}        -- `others` [ "mamA^s NK", "mam^sA Nhy", "mam^say NAn_Nayn", "mamA^siy N0_Nh" ]
                                                            `gloss`  [ "corridor", "promenade", "corridors", "promenades" ],

    -- ;; tamA$iy_1
    -- tmA$y   tamA$iy NF      in accordance with;in conformity with     [[tamA$iy/ADV]]

    noun     TaFACI                    {- tamA$iy -}        `gloss`  [ "in accordance with", "in conformity with [ [ tamA $ iy / ADV ] ]" ],
 ...
 |> "m _d h b" <| [
    ...
    verb     TaKaRDaS                  {- tama*ohab -}      `gloss`  [ "follow ( as a disciple )" ],

    -- ;; tama*ohub_1
    -- tm*hb   tama*ohub       N       following (as a disciple)

    noun     TaKaRDuS                  {- tama*ohub -}      `gloss`  [ "following ( as a disciple )" ],

    -- ;; mutama*ohib_1
    -- mtm*hb  mutama*ohib     Nall    following (as a disciple)     [[mutama*ohib/ADJ]]

    noun     MutaKaRDiS                {- mutama*ohib -}    `gloss`  [ "following ( as a disciple ) [ [ mutama*ohib / ADJ ] ]" ] ]
 ...
 |> "m _d q" <| [
    ...
    noun     FaCIL                     {- ma*iyq -}         `gloss`  [ "diluted", "mixed with water [ [ ma*iyq / ADJ ] ]" ],
 ...
 |> "m _h .d" <| [
    ...
    verb     FaCaL                     {- maxaD-uia -}      `imperf` [ FCuL, FCiL, FCaL ]
                                                            -- `others` [ "m_ha.d IV", "m_hu.d IV", "m_hi.d IV" ]
    ...
    noun     FaCCAL |< aT              {- max~ADap -}       `gloss`  [ "churn" ],

    -- ;; mimoxaDap_1
    -- mmxD    mimoxaD Napdu   churn
    -- mmAxD   mamAxiD Ndip    churns

    noun     MiFCaL |< aT              {- mimoxaDap -}      -- `others` [ "mamA_hi.d Ndip" ]
                                                            `gloss`  [ "churn", "churns" ] ]
 ...
 |> "m _h .t" <| [
    ...
    noun     FuCAL |< Iy               {- muxATiy~ -}       `gloss`  [ "snotty", "mucous [ [ muxATiy ~ / ADJ ] ]" ] ]
 ...
 |> "m _h .t r" <| [
    ...
    verb     TaKaRDaS                  {- tamaxoTar -}      `gloss`  [ "walk gracefully" ],

    -- ;; tamaxoTur_1
    -- tmxTr   tamaxoTur       N       walking gracefully

    noun     TaKaRDuS                  {- tamaxoTur -}      `gloss`  [ "walking gracefully" ],

    -- ;; mutamaxoTir_1
    -- mtmxTr  mutamaxoTir     Nall    walking gracefully

    noun     MutaKaRDiS                {- mutamaxoTir -}    `gloss`  [ "walking gracefully" ] ]
 ...
 |> "m _h l" <| [
    ...
    noun     FiCL |< aT                {- mixolap -}        -- `others` [ "mi_hal N" ]
 ...
 |> "m _h m .d" <| [
    ...
    verb     KaRDaS                    {- maxomaD -}        -- `others` [ "ma_hmi.d IV_yu" ]
 ...
 |> "m _h r" <| [
    ...
    noun     FACiL |< aT               {- mAxirap -}        -- `others` [ "mawA_hir Ndip" ]
                                                            `gloss`  [ "ship", "ships" ],
    ...
    noun     FACUL                     {- mAxuwr -}         -- `others` [ "mawA_hir Ndip" ]
 ...
 |> "m _h r q" <| [
    ...
    verb     KaRDaS                    {- maxoraq -}        -- `others` [ "ma_hriq IV_yu" ]
                                                            `gloss`  [ "brag", "cheat" ],

    -- ;; maxoraqap_2
    -- mxrq    maxoraq Nap     bragging;cheating

    noun     KaRDaS |< aT              {- maxoraqap -}      `gloss`  [ "bragging", "cheating" ] ]
 ...
 |> "m _t l" <| [
    ...
    noun     FiCL |< Iy                {- mivoliy~ -}       `gloss`  [ "replaceable [ [ mivoliy ~ / ADJ ] ]" ],
    ...
    noun     FaCAL |< aT               {- mavAlap -}        `gloss`  [ "perfection", "exemplariness" ],

    -- ;; mavAlap_2
    -- mvAl    mavAl   NapAt   task;assignment
    -- mvA}l   mavA}il Ndip    tasks;assignments

    noun     FaCAL |< aT               {- mavAlap -}        -- `others` [ "ma_tA'il Ndip" ]
    ...
    noun     TaFCIL |< Iy |< aT        {- tamoviyliy~ap -}  `gloss`  [ "soap opera", "feature film [ [ tamoviyliy ~ / NOUN ] ]" ],

    -- ;; mumAvalap_1
    -- mmAvl   mumAval NapAt   resemblance;analogy

    noun     MuFACaL |< aT             {- mumAvalap -}      `gloss`  [ "resemblance", "analogy" ],
    ...
    noun     FACiL |< aT               {- mAvilap -}        `gloss`  [ "chandelier" ],
    ...
    noun     MuFaCCiL |< Iy |< aT      {- mumav~iliy~ap -}  `gloss`  [ "representation [ [ mumav ~ iliy ~ / NOUN ] ]" ],
    ...
    noun     MuFtaCiL                  {- mumotavil -}      `gloss`  [ "obedient", "compliant [ [ mumotavil / ADJ ] ]" ] ]
 ...
 |> "m _t n" <| [
    ...
    noun     FaCAL |< aT               {- mavAnap -}        `gloss`  [ "bladder" ] ]
 ...
 |> "m ` '" <| [
    ...
    noun     FuCAL                     {- muEA' -}          `gloss`  [ "mewing", "meow" ],
 ...
 |> "m ` .d" <| [
    ...
    noun     MuFtaCiL                  {- mumotaEiD -}      `gloss`  [ "annoyed", "upset", "excited [ [ mumotaEiD / ADJ ] ]" ] ]
 ...
 |> "m ` d" <| [
    ...
    noun     FaCiL |< aT               {- maEidap -}        -- `others` [ "mi`d Napdu", "mi`ad N" ]
    ...
    noun     FaCL |< Iy                {- maEodiy~ -}       -- `others` [ "mi`diyy N-ap" ]
                                                            `gloss`  [ "gastric", "stomach [ [ maEodiy ~ / ADJ ] ]", "stomach [ [ miEodiy ~ / ADJ ] ]" ],
 ...
 |> "m ` d n" <| [
    ...
    verb     KaRDaS                    {- maEodan -}        -- `others` [ "ma`din IV-n_yu" ]
                                                            `gloss`  [ "cover with metal", "mineralize" ],

    -- ;; maEodanap_1
    -- mEdn    maEodan Nap     covering with metal;mineralizing

    noun     KaRDaS |< aT              {- maEodanap -}      `gloss`  [ "covering with metal", "mineralizing" ] ]
 ...
 |> "m ` m `" <| [
    ...
    noun     KaRDaS |< aT              {- maEomaEap -}      `gloss`  [ "confusion", "uproar" ],

    -- ;; maEAmiE_1
    -- mEAmE   maEAmiE Ndip    wars;battles;turmoil

    noun     KaRADiS                   {- maEAmiE -}        `gloss`  [ "wars", "battles", "turmoil" ],

    -- ;; maEomaEiy~_1
    -- mEmEy   maEomaEiy~      Nall    yes-man     [[maEomaEiy~/ADJ]]

    noun     KaRDaS |< Iy              {- maEomaEiy~ -}     `gloss`  [ "yes-man [ [ maEomaEiy ~ / ADJ ] ]" ] ]
 ...
 |> "m ` n" <| [
    ...
    noun     FACUL                     {- mAEuwn -}         -- `others` [ "mawA`iyn Ndip" ]
    ...
    noun     FACUL |< aT               {- mAEuwnap -}       -- `others` [ "mawA`iyn Ndip" ]
                                                            `gloss`  [ "barge", "barges" ],
    ...
    noun     MuFCiL                    {- mumoEin -}        `gloss`  [ "engrossed", "assiduous [ [ mumoEin / ADJ ] ]" ] ]
 ...
 |> "m ` r" <| [
    ...
    verb     HaFCaL                    {- OamoEar -}        -- `others` [ "m`ir IV_intr_yu" ]
                                                            `gloss`  [ "become poor" ],
 ...
 |> "m ` y" <| [
    ...
    noun     FiCY                      {- miEaY -}          -- `others` [ "mi`A Nhy" ]
                                                            `gloss`  [ "intestines", "entrails" ],
    ...
    noun     FiCY |< Iy                {- miEawiy~ -}       `gloss`  [ "intestinal", "enteric [ [ miEawiy ~ / ADJ ] ]" ] ]
 ...
 |> "m ` y r" <| [
    ...
    verb     KaRDaS                    {- maEoyar -}        -- `others` [ "ma`yir IV_yu" ]
                                                            `gloss`  [ "standardize" ],

    -- ;; maEoyarap_1
    -- mEyr    maEoyar Nap     standardization

    noun     KaRDaS |< aT              {- maEoyarap -}      `gloss`  [ "standardization" ] ]
 ...
 |> "m ` z" <| [
    ...
    noun     FACiL |< aT               {- mAEizap -}        `gloss`  [ "nanny goat" ],
 ...
 |> "m d '" <| [
    ...
    noun     MICAL                     {- miydA' -}         `gloss`  [ "measure", "amount", "length" ],
    ...
    noun     FICAL                     {- miydA' -}         `gloss`  [ "measure", "amount", "length" ] ]
 ...
 |> "m d ' n" <| [
    ...
    noun     KaRADiS                   {- madA}in -}        `gloss`  [ "Mada'in" ] ]
 ...
 |> "m d d" <| [
    ...
    noun     FACL |< Iy |< aT          {- mAd~iy~ap -}      `gloss`  [ "materialism [ [ mAd ~ iy ~ / NOUN ] ]" ],
    ...
    noun     MuFaCCaL                  {- mumad~ad -}       `gloss`  [ "stretched out", "extended [ [ mumad ~ ad / ADJ ] ]" ],
 ...
 |> "m d l n" <| [
    ...
    noun     KiRDiS                    {- midolin -}        `gloss`  [ "middling", "mediocre" ] ]
 ...
 |> "m d l y" <| [
    ...
    noun     KaRADiS |< aT             {- madAliyap -}      `gloss`  [ "medal" ] ]
 ...
 |> "m d n" <| [
    ...
    noun     TaFCIL |< Iy              {- tamodiyniy~ -}    `gloss`  [ "civilizing", "urbanizing [ [ tamodiyniy ~ / ADJ ] ]" ],
    ...
    noun     TaFaCCuL |< Iy            {- tamad~uniy~ -}    `gloss`  [ "civilized [ [ tamad ~ uniy ~ / ADJ ] ]" ],

    -- ;; mutamad~in_1
    -- mtmdn   mutamad~in      Nall    civilized;sophisticated     [[mutamad~in/ADJ]]

    noun     MutaFaCCiL                {- mutamad~in -}     `gloss`  [ "civilized", "sophisticated [ [ mutamad ~ in / ADJ ] ]" ] ]
 ...
 |> "m d r" <| [
    ...
    noun     FaCaL |< aT               {- madarap -}        `gloss`  [ "clod of earth", "lump of clay" ] ]
 ...
 |> "m d r s" <| [
    ...
    noun     KaRDAS                    {- madorAs -}        `gloss`  [ "Madras" ] ]
 ...
 |> "m d y" <| [
    ...
    verb     HaFCY                     {- OamodaY -}        -- `others` [ "md IV_0hwnyn_yu", "mdiy IV_0hAnn_yu", "'amday PV_Atn", "mdY IV_0_Pass_yu", "'amd PV_ttAw", "'amdA PV_h", "mday IV_Ann_Pass_yu" ]
                                                            `gloss`  [ "grant a delay or extension", "be granted a delay or extension" ],
    ...
    noun     FuCL |< aT                {- mudoyap -}        -- `others` [ "mudA Nhy", "mudY N0", "mady Nap", "midy Nap" ]
                                                            `gloss`  [ "knife", "knives" ],

    -- ;; madawiy~_1
    -- mdwy    madawiy~        Nall    cutler     [[madawiy~/ADJ]]

    noun     FaCY |< Iy                {- madawiy~ -}       `gloss`  [ "cutler [ [ madawiy ~ / ADJ ] ]" ],
    ...
    noun     TaFACI                    {- tamAdiy -}        -- `others` [ "tamAd NK" ]
 ...
 |> "m d y n" <| [
    ...
    verb     TaKaRDaS                  {- tamadoyan -}      `gloss`  [ "be civilized", "be sophisticated" ],

    -- ;; tamadoyun_1
    -- tmdyn   tamadoyun       N/At    civilization;refinement

    noun     TaKaRDuS                  {- tamadoyun -}      `gloss`  [ "civilization", "refinement" ],

    -- ;; tamadoyuniy~_1
    -- tmdyny  tamadoyuniy~    Nall    civilizing     [[tamadoyuniy/ADJ]]

    noun     TaKaRDuS |< Iy            {- tamadoyuniy~ -}   `gloss`  [ "civilizing [ [ tamadoyuniy / ADJ ] ]" ],

    -- ;; mutamadoyin_1
    -- mtmdyn  mutamadoyin     Nall    civilized;sophisticated

    noun     MutaKaRDiS                {- mutamadoyin -}    `gloss`  [ "civilized", "sophisticated" ] ]
 ...
 |> "m h k" <| [
    ...
    noun     FaCL |< aT                {- mahokap -}        -- `others` [ "muhk Nap" ]
 ...
 |> "m h l" <| [
    ...
    noun     FaCL                      {- mahol -}          `gloss`  [ "slowness", "slow down ! [ [ mahol / INTERJ ] ]", "leisurely" ],
 ...
 |> "m h n" <| [
    ...
    noun     FiCL |< Iy                {- mihoniy~ -}       `gloss`  [ "professionally active [ [ mihoniy ~ / ADJ ] ]" ],
 ...
 |> "m h r" <| [
    ...
    verb     FaCaL                     {- mahar-ua -}       `imperf` [ FCuL, FCaL ]
                                                            -- `others` [ "mhur IV_intr", "mhar IV_intr" ]
    ...
    verb     HaFCaL                    {- Oamohar -}        -- `others` [ "mhir IV_yu", "mhar IV_Pass_yu" ]
    ...
    noun     FuCL |< aT                {- muhorap -}        -- `others` [ "muhar N" ]
                                                            `gloss`  [ "filly", "fillies" ],
    ...
    noun     FACiL                     {- mAhir -}          -- `others` [ "mahar Nap" ]
                                                            `gloss`  [ "skilful", "proficient [ [ mAhir / ADJ ] ]", "proficient" ],
    ...
    noun     MaFCUL                    {- mamohuwr -}       `gloss`  [ "sealed", "stamped [ [ mamohuwr / ADJ ] ]" ] ]
 ...
 |> "m h w" <| [
    ...
    noun     FaCY |< aT                {- mahAp -}          -- `others` [ "mahay NAt", "mahaw NAt" ]
 ...
 |> "m k d m" <| [
    ...
    verb     KaRDaS                    {- makodam -}        -- `others` [ "makdim IV_yu" ]
 ...
 |> "m k k" <| [
    ...
    noun     FaCL |< Iy                {- mak~iy~ -}        `gloss`  [ "Meccan [ [ mak ~ iy ~ / NOUN ] ]", "Meccan [ [ mak ~ iy ~ / ADJ ] ]" ],
    ...
    noun     FACUL                     {- mAkuwk -}         -- `others` [ "mawAkiyk Ndip" ]
                                                            `gloss`  [ "shuttle", "shuttles" ],

    -- ;; mAkuwkiy~_1
    -- mAkwky  mAkuwkiy~       Nall    shuttle     [[mAkuwkiy~/ADJ]]

    noun     FACUL |< Iy               {- mAkuwkiy~ -}      `gloss`  [ "shuttle [ [ mAkuwkiy ~ / ADJ ] ]" ] ]
 ...
 |> "m k n" <| [
    ...
    noun     FuCL |< aT                {- mukonap -}        -- `others` [ "makin Nap" ]
    ...
    noun     FaCIL                     {- makiyn -}         -- `others` [ "mukanA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "strong", "influential [ [ makiyn / ADJ ] ]", "influential" ],
    ...
    noun     FaCaL |< Iy               {- makaniy~ -}       `gloss`  [ "mechanical [ [ makaniy ~ / ADJ ] ]" ] ]
 ...
 |> "m k n k" <| [
    ...
    verb     KaRDaS                    {- makonak -}        -- `others` [ "maknik IV_yu" ]
                                                            `gloss`  [ "mechanize", "motorize" ],

    -- ;; makonakap_1
    -- mknk    makonak Nap     mechanization;motorization

    noun     KaRDaS |< aT              {- makonakap -}      `gloss`  [ "mechanization", "motorization" ] ]
 ...
 |> "m k r" <| [
    ...
    noun     FaCL |< aT                {- makorap -}        `gloss`  [ "stratagem", "ruse" ],
    ...
    noun     FaCCAL                    {- mak~Ar -}         `gloss`  [ "cunning", "sly [ [ mak ~ Ar / ADJ ] ]" ],
    ...
    noun     FaCUL                     {- makuwr -}         `gloss`  [ "cunning", "sly [ [ makuwr / ADJ ] ]" ],
    ...
    noun     FACiL                     {- mAkir -}          -- `others` [ "makar Nap" ]
                                                            `gloss`  [ "sly", "cunning [ [ mAkir / ADJ ] ]", "cunning" ] ]
 ...
 |> "m l '" <| [
    ...
    verb     FaCiL                     {- mali}-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "mla' IV IV_wn IV_yn", "mla'A IV-|" ]
                                                            `gloss`  [ "be filled" ],
    ...
    verb     FACaL                     {- mAlaO -}          -- `others` [ "mAla'A PV-|", "mAli' IV_yu" ]
    ...
    verb     HaFCaL                    {- OamolaO -}        -- `others` [ "'amla'A PV-|", "mla' IV_Pass_yu", "mli' IV_yu" ]
    ...
    verb     TaFaCCaL                  {- tamal~aO -}       -- `others` [ "tamalla'A PV-|_intr IV-|" ]
    ...
    verb     IFtaCaL                   {- {imotalaO -}      -- `others` [ "mtali' IV_intr", "imtala'A PV-|_intr" ]
                                                            `gloss`  [ "be filled", "become full" ],
    ...
    noun     HiFCAL                    {- IimolA' -}        `gloss`  [ "filling", "filling out" ],
    ...
    noun     MuFACiL                   {- mumAli} -}        `gloss`  [ "prejudiced", "biased [ [ mumAli } / ADJ ] ]", "collaborator" ],
    ...
    noun     HiFCAL                    {- IimolA' -}        `gloss`  [ "dictation", "orthography" ] ]
 ...
 |> "m l .h" <| [
    ...
    verb     FaCaL                     {- malaH-ua -}       `imperf` [ FCuL, FCaL ]
                                                            -- `others` [ "mla.h IV_intr", "mlu.h IV_intr" ]
                                                            `gloss`  [ "become salty" ],
    ...
    verb     HaFCaL                    {- OamolaH -}        -- `others` [ "mli.h IV_intr_yu" ]
                                                            `gloss`  [ "be salty" ],
    ...
    noun     FiCL |< Iy                {- miloHiy~ -}       `gloss`  [ "salty", "saline [ [ miloHiy ~ / ADJ ] ]" ],

    -- ;; miloHap_1
    -- mlH     miloH   Nap     commitment;obligation

    noun     FiCL |< aT                {- miloHap -}        `gloss`  [ "commitment", "obligation" ],

    -- ;; muloHap_1
    -- mlH     muloH   Nap     anecdote;witticism
    -- mlH     mulaH   N       anecdotes;witticisms

    noun     FuCL |< aT                {- muloHap -}        -- `others` [ "mula.h N" ]
    ...
    noun     FaCAL |< aT               {- malAHap -}        `gloss`  [ "saltiness", "salinity", "beauty" ],
    ...
    noun     FuCUL |< aT               {- muluwHap -}       `gloss`  [ "saltiness", "salt content" ],

    -- ;; maliyH_1
    -- mlyH    maliyH  N-ap    salty;briny;saline     [[maliyH/ADJ]]

    noun     FaCIL                     {- maliyH -}         `gloss`  [ "salty", "briny", "saline [ [ maliyH / ADJ ] ]" ],
    ...
    noun     FaCIL                     {- maliyH -}         -- `others` [ "milA.h N", "'amlA.h N" ]
                                                            `gloss`  [ "pretty", "cute", "attractive [ [ maliyH / ADJ ] ]", "attractive" ],
    ...
    noun     HaFCaL                    {- OamolaH -}        -- `others` [ "mal.hA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "saline", "salty" ],
    ...
    noun     MaFCaL |< aT              {- mamolaHap -}      -- `others` [ "mamAli.h Ndip" ]
    ...
    noun     FACiL                     {- mAliH -}          -- `others` [ "mawAli.h Ndip" ]
                                                            `gloss`  [ "salty", "briny [ [ mAliH / ADJ ] ]", "salted nuts", "citrus fruits" ],

    -- ;; mamoluwH_1
    -- mmlwH   mamoluwH        N-ap    salted;salty     [[mamoluwH/ADJ]]

    noun     MaFCUL                    {- mamoluwH -}       `gloss`  [ "salted", "salty [ [ mamoluwH / ADJ ] ]" ],

    -- ;; mumal~aH_1
    -- mmlH    mumal~aH        N-ap    salted;salty     [[mumal~aH/ADJ]]

    noun     MuFaCCaL                  {- mumal~aH -}       `gloss`  [ "salted", "salty [ [ mumal ~ aH / ADJ ] ]" ],

    -- ;; musotamolaH_1
    -- mstmlH  musotamolaH     N-ap    witty;clever     [[musotamolaH/ADJ]]

    noun     MustaFCaL                 {- musotamolaH -}    `gloss`  [ "witty", "clever [ [ musotamolaH / ADJ ] ]" ] ]
 ...
 |> "m l .s" <| [
    ...
    noun     FaCiL                     {- maliS -}          `gloss`  [ "smooth", "slippery [ [ maliS / ADJ ] ]" ],

    -- ;; maliyS_1
    -- mlyS    maliyS  N-ap    smooth;slippery     [[maliyS/ADJ]]

    noun     FaCIL                     {- maliyS -}         `gloss`  [ "smooth", "slippery [ [ maliyS / ADJ ] ]" ],
 ...
 |> "m l .t" <| [
    ...
    noun     FACL |< Iy                {- mAloTiy~ -}       `gloss`  [ "Maltese [ [ mAloTiy ~ / NOUN ] ]", "Maltese [ [ mAloTiy ~ / ADJ ] ]" ],
    ...
    noun     HaFCaL                    {- OamolaT -}        -- `others` [ "mul.t N" ]
                                                            `gloss`  [ "hairless" ] ]
 ...
 |> "m l _h" <| [
    ...
    noun     FaCIL                     {- maliyx -}         `gloss`  [ "insipid", "tasteless [ [ maliyx / ADJ ] ]" ],

    -- ;; muluwxiy~ap_1
    -- mlwxy   muluwxiy~       Nap     molokhiyya (traditional Egyptian soup made of a spinach-green nettle-like plant)

    noun     FuCUL |< Iy |< aT         {- muluwxiy~ap -}    `gloss`  [ "molokhiyya ( traditional Egyptian soup made of a spinach-green nettle-like plant )" ],

    -- ;; muluwxiy~ap_2
    -- mlwxy   muluwxiy~       Nap     Jew's mallow

    noun     FuCUL |< Iy |< aT         {- muluwxiy~ap -}    `gloss`  [ "Jew 's mallow" ] ]
 ...
 |> "m l d" <| [
    ...
    noun     HaFCaL                    {- Oamolad -}        -- `others` [ "maldA' Nh Nhy N0_Nh" ]
 ...
 |> "m l k" <| [
    ...
    verb     HaFCaL                    {- Oamolak -}        -- `others` [ "mlik IV_yu", "mlak IV_Pass_yu" ]
    ...
    noun     FuCL |< Iy                {- mulokiy~ -}       `gloss`  [ "proprietary", "civilian [ [ mulokiy ~ / ADJ ] ]" ],
    ...
    noun     FaCaL |< aT               {- malakap -}        `gloss`  [ "aptitude", "faculty" ],
    ...
    noun     FuCUL |< Iy               {- muluwkiy~ -}      `gloss`  [ "royal", "monarchic [ [ muluwkiy ~ / ADJ ] ]" ],

    -- ;; muluwkiy~ap_1
    -- mlwky   muluwkiy~       Nap     monarchic rule;royalty     [[muluwkiy~/NOUN]]

    noun     FuCUL |< Iy |< aT         {- muluwkiy~ap -}    `gloss`  [ "monarchic rule", "royalty [ [ muluwkiy ~ / NOUN ] ]" ],
    ...
    noun     FaCCAL |< Iy              {- mal~Akiy~ -}      `gloss`  [ "private [ [ mal ~ Akiy ~ / ADJ ] ]" ],
    ...
    noun     FaCIL |< aT               {- maliykap -}       `gloss`  [ "queen" ],
    ...
    noun     FACiL |< Iy               {- mAlikiy~ -}       `gloss`  [ "Malikite [ [ mAlikiy ~ / NOUN ] ]", "Malikite [ [ mAlikiy ~ / ADJ ] ]" ],

    -- ;; mAlikiy~ap_1
    -- mAlky   mAlikiy~        Nap     Malikite school     [[mAlikiy~/NOUN]]

    noun     FACiL |< Iy |< aT         {- mAlikiy~ap -}     `gloss`  [ "Malikite school [ [ mAlikiy ~ / NOUN ] ]" ],
 ...
 |> "m l l" <| [
    ...
    verb     HaFaCL                    {- Oamal~ -}         -- `others` [ "'amlal PV_C", "mall IV_V_Pass_yu", "mill IV_V_yu", "mlil IV_C_yu" ]
    ...
    noun     FaCL |< aT                {- mal~ap -}         `gloss`  [ "hot ashes", "live embers" ],
    ...
    noun     FuCL |< aT                {- mul~ap -}         -- `others` [ "mulal N" ]
    ...
    noun     FaCAL |< aT               {- malAlap -}        `gloss`  [ "boredom", "impatience" ],

    -- ;; maluwl_1
    -- mlwl    maluwl  N-ap    bored;fed-up     [[maluwl/ADJ]]

    noun     FaCUL                     {- maluwl -}         `gloss`  [ "bored", "fed-up [ [ maluwl / ADJ ] ]" ],

    -- ;; mamoluwl_1
    -- mmlwl   mamoluwl        Nall    offensive;disgusting     [[mamoluwl/ADJ]]

    noun     MaFCUL                    {- mamoluwl -}       `gloss`  [ "offensive", "disgusting [ [ mamoluwl / ADJ ] ]" ],

    -- ;; mumil~_1
    -- mml     mumil~  Nall    boring;tedious     [[mumil~/ADJ]]

    noun     MuFiCL                    {- mumil~ -}         `gloss`  [ "boring", "tedious [ [ mumil ~ / ADJ ] ]" ],
    ...
    verb     FaCLY                     {- mal~aY -}         -- `others` [ "malliy IV_0hAnn_yu", "mallay PV_Atn IV_Ann_Pass_yu", "mallA PV_h" ]
 ...
 |> "m l m l" <| [
    ...
    verb     KaRDaS                    {- malomal -}        -- `others` [ "malmil IV_intr_yu" ]
                                                            `gloss`  [ "hurry", "hasten" ],
    ...
    verb     KaRDaS                    {- malomal -}        -- `others` [ "malmil IV_yu" ]
                                                            `gloss`  [ "make restless" ],
    ...
    verb     TaKaRDaS                  {- tamalomal -}      `gloss`  [ "mumble", "toss and turn", "fidget" ],

    -- ;; malomalap_1
    -- mlml    malomal Nap     restlessness;nervousness

    noun     KaRDaS |< aT              {- malomalap -}      `gloss`  [ "restlessness", "nervousness" ],

    -- ;; tamalomul_1
    -- tmlml   tamalomul       N/At    murmuring;grumbling;fidgeting

    noun     TaKaRDuS                  {- tamalomul -}      `gloss`  [ "murmuring", "grumbling", "fidgeting" ] ]
 ...
 |> "m l q" <| [
    ...
    noun     FACaL |< aT               {- mAlaqap -}        `gloss`  [ "Malaga" ],
    ...
    verb     HaFCaL                    {- Oamolaq -}        -- `others` [ "mliq IV_intr_yu" ]
                                                            `gloss`  [ "become poor" ],
    ...
    noun     FaCaL |< aT               {- malaqap -}        -- `others` [ "'amlAq N" ]
                                                            `gloss`  [ "league", "leagues" ],

    -- ;; mimolaqap_1
    -- mmlq    mimolaq Nap     roller;leveler

    noun     MiFCaL |< aT              {- mimolaqap -}      `gloss`  [ "roller", "leveler" ],
 ...
 |> "m l s" <| [
    ...
    noun     FaCAL |< aT               {- malAsap -}        `gloss`  [ "smoothness" ],
    ...
    noun     HaFCaL                    {- Oamolas -}        -- `others` [ "malsA' Nh Nhy N0_Nh", "muls N" ]
                                                            `gloss`  [ "smooth", "sleek" ] ]
 ...
 |> "m l w" <| [
    ...
    verb     FaCA                      {- malA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "mluw IV_0hAnn", "malaw PV_Atn" ]
                                                            `gloss`  [ "walk briskly" ],
    ...
    verb     HaFCY                     {- OamolaY -}        -- `others` [ "'aml PV_ttAw", "'amlay PV_Atn", "mlay IV_Ann_Pass_yu", "'amlA PV_h", "mlY IV_0_Pass_yu", "mliy IV_0hAnn_yu" ]
    ...
    noun     FaCL |< aT                {- malowap -}        -- `others` [ "malaw NAt" ]
    ...
    noun     MiFCY |< aT               {- mimolAp -}        `gloss`  [ "dictaphone" ],
    ...
    noun     HiFCA'                    {- IimolA' -}        `gloss`  [ "dictation", "orthography" ] ]
 ...
 |> "m l w y" <| [
    ...
    noun     KaRADiS                   {- malAwiy -}        `gloss`  [ "Malawi" ],

    -- ;; malAwiy~_1
    -- mlAwy   malAwiy~        Nall    Malawian     [[malAwiy~/NOUN]]
    -- mlAwy   malAwiy~        Nall    Malawian     [[malAwiy~/ADJ]]

    noun     KaRADIS                   {- malAwiy~ -}       `gloss`  [ "Malawian [ [ malAwiy ~ / NOUN ] ]", "Malawian [ [ malAwiy ~ / ADJ ] ]" ] ]
 ...
 |> "m l y" <| [
    ...
    noun     FiCAL |< aT               {- milAyap -}        -- `others` [ "mulA' NapAt" ]
    ...
    noun     FaCIL |< aT               {- maliy~ap -}       -- `others` [ "malAyA N0_Nhy" ]
                                                            `gloss`  [ "female bedouin dress [ [ maliy ~ / NOUN ] ]", "female bedouin dresses" ] ]
 ...
 |> "m m _d" <| [
    ...
    noun     CuL                       {- mu* -}            -- `others` [ "mu_d_dAk FW-Wa" ]
                                                            `gloss`  [ "since [ [ mu* / PREP ] ]", "since then [ [ mu* ~ Ak / PREP ] ]", "since then [ [ mu*o*Ak / PREP ] ]" ] ]
 ...
 |> "m m `" <| [
    ...
    noun     CaL |< Iy |< aT           {- maEiy~ap -}       `gloss`  [ "company", "escort [ [ maEiy ~ / NOUN ] ]" ] ]
 ...
 |> "m m m" <| [
    ...
    noun     CuL |< At                 {- mumAt -}          `gloss`  [ "obsolete", "antiquated [ [ mumAt / ADJ ] ]" ],

    -- ;; muwmiyap_1
    -- mwmy    muwmiy  Nap     bitumen

    noun     MUCI |< aT                {- muwmiyap -}       `gloss`  [ "bitumen" ],

    -- ;; muwmiyap_2
    -- mwmy    muwmiy  NapAt   mummy

    noun     MUCI |< aT                {- muwmiyap -}       `gloss`  [ "mummy" ] ]
 ...
 |> "m m y" <| [
    ...
    noun     MUCiL |< aT               {- muwmiyap -}       `gloss`  [ "bitumen" ],

    -- ;; muwmiyap_2
    -- mwmy    muwmiy  NapAt   mummy

    noun     MUCiL |< aT               {- muwmiyap -}       `gloss`  [ "mummy" ] ]
 ...
 |> "m n '" <| [
    ...
    noun     HiFCAL                    {- IimonA' -}        `gloss`  [ "ejaculation", "ejaculations" ],
 ...
 |> "m n .s n" <| [
    ...
    noun     KaRDUS                    {- manoSuwn -}       `gloss`  [ "monsoon" ],

    -- ;; manoSuwniy~_1
    -- mnSwny  manoSuwniy~     Nall    monsoon     [[manoSuwniy~/ADJ]]

    noun     KaRDUS |< Iy              {- manoSuwniy~ -}    `gloss`  [ "monsoon [ [ manoSuwniy ~ / ADJ ] ]" ] ]
 ...
 |> "m n .t q" <| [
    ...
    verb     KaRDaS                    {- manoTaq -}        -- `others` [ "man.tiq IV_yu" ]
                                                            `gloss`  [ "gird" ],
    ...
    verb     TaKaRDaS                  {- tamanoTaq -}      `gloss`  [ "be girded", "be wrapped" ] ]
 ...
 |> "m n .t r" <| [
    ...
    verb     KaRDaS                    {- manoTar -}        -- `others` [ "man.tir IV_yu" ]
 ...
 |> "m n ^s b" <| [
    ...
    noun     KaRDUS |< Iy |< aT        {- man$uwbiy~ap -}   `gloss`  [ "monk 's cell [ [ man $ uwbiy ~ / NOUN ] ]" ] ]
 ...
 |> "m n ^s r" <| [
    ...
    noun     KaRDUS |< Iy              {- mano$uwriy~ -}    `gloss`  [ "Manchurian [ [ mano $ uwriy ~ / NOUN ] ]", "Manchurian [ [ mano $ uwriy ~ / ADJ ] ]" ] ]
 ...
 |> "m n `" <| [
    ...
    noun     HaFCaL                    {- OamonaE -}        `gloss`  [ "insurmountable" ],
    ...
    noun     FACiL                     {- mAniE -}          `gloss`  [ "preventing", "forbidding [ [ mAniE / ADJ ] ]" ],
    ...
    noun     MaFCUL |< Iy |< aT        {- mamonuwEiy~ap -}  `gloss`  [ "forbiddenness [ [ mamonuwEiy ~ / NOUN ] ]" ],

    -- ;; mumotaniE_1
    -- mmtnE   mumotaniE       Nall    abstaining;refraining     [[mumotaniE/ADJ]]

    noun     MuFtaCiL                  {- mumotaniE -}      `gloss`  [ "abstaining", "refraining [ [ mumotaniE / ADJ ] ]" ] ]
 ...
 |> "m n d l" <| [
    ...
    noun     KaRDaS                    {- manodal -}        `gloss`  [ "fortunetelling" ],
 ...
 |> "m n h" <| [
    ...
    noun     FiCL                      {- minoh -}          `gloss`  [ "Minh ( in `` Ho Chi Minh '' ) [ [ minoh / NOUN_PROP ] ]" ] ]
 ...
 |> "m n n" <| [
    ...
    noun     FACY |< Iy                {- mAnawiy~ -}       `gloss`  [ "Manichaean [ [ mAnawiy ~ / NOUN ] ]", "Manichaean [ [ mAnawiy ~ / ADJ ] ]", "Manichaeism [ [ mAnawiy ~ / NOUN ] ]" ],
 ...
 |> "m n t l" <| [
    ...
    noun     KiRDUS                    {- minotuwl -}       `gloss`  [ "menthol" ] ]
 ...
 |> "m n w" <| [
    ...
    noun     HiFCA'                    {- IimonA' -}        `gloss`  [ "ejaculation", "ejaculations" ],
    ...
    noun     TaFaCCI                   {- taman~iy -}       -- `others` [ "tamann NK" ]
    ...
    noun     IstiFCA'                  {- {isotimonA' -}    `gloss`  [ "masturbation" ],
    ...
    noun     MutaFaCCI                 {- mutaman~iy -}     -- `others` [ "mutamann Nuwn_Niyn NK" ]
 ...
 |> "m n y" <| [
    ...
    noun     FaCIL |< aT               {- maniy~ap -}       -- `others` [ "manAyA N0_Nhy" ]
                                                            `gloss`  [ "destiny", "fate of death [ [ maniy ~ / NOUN ] ]", "fate of death" ],
    ...
    noun     TaFCiL |< aT              {- tamoniyap -}      `gloss`  [ "ejaculation" ],
 ...
 |> "m q `" <| [
    ...
    noun     MuFtaCaL                  {- mumotaqaE -}      `gloss`  [ "pale", "pallid [ [ mumotaqaE / ADJ ] ]" ] ]
 ...
 |> "m q n q" <| [
    ...
    noun     KaRADiS                   {- maqAniq -}        `gloss`  [ "sausages", "mutton sausages" ] ]
 ...
 |> "m q t" <| [
    ...
    noun     FaCIL                     {- maqiyt -}         `gloss`  [ "hated", "loathsome [ [ maqiyt / ADJ ] ]" ],

    -- ;; mamoquwt_1
    -- mmqwt   mamoquwt        Nall    hated;loathsome     [[mamoquwt/ADJ]]

    noun     MaFCUL                    {- mamoquwt -}       `gloss`  [ "hated", "loathsome [ [ mamoquwt / ADJ ] ]" ] ]
 ...
 |> "m r '" <| [
    ...
    verb     FaCaL                     {- maraO-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "mra'A IV-|", "mra' IV_wn IV_intr IV_yn", "mara'A PV-|_intr" ]
                                                            `gloss`  [ "be wholesome" ],
    ...
    verb     FaCuL                     {- maruW-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "mru' IV_intr IV_yn" ]
    ...
    verb     IstaFCaL                  {- {isotamoraO -}    -- `others` [ "stamri' IV", "istamra'A PV-|" ]
                                                            `gloss`  [ "enjoy", "savor" ],
    ...
    noun     FaCIL                     {- mariy' -}         `gloss`  [ "healthy", "salubrious [ [ mariy ' / ADJ ] ]", "salubrious" ],
    ...
    noun     FaCIL                     {- mariy' -}         -- `others` [ "'amri' Nap", "muruw' Nhy N0_Nh" ]
    ...
    noun     FiCAL                     {- mirA' -}          `gloss`  [ "quarrel", "dispute" ] ]
 ...
 |> "m r .d" <| [
    ...
    verb     HaFCaL                    {- OamoraD -}        -- `others` [ "mra.d IV_Pass_yu", "mri.d IV_yu" ]
    ...
    noun     MutaFaCCiL                {- mutamar~iD -}     `gloss`  [ "sickly", "in poor health [ [ mutamar ~ iD / ADJ ] ]" ] ]
 ...
 |> "m r .g" <| [
    ...
    verb     HaFCaL                    {- Oamorag -}        -- `others` [ "mri.g IV_yu", "mra.g IV_Pass_yu" ]
 ...
 |> "m r .s" <| [
    ...
    noun     FuCL |< Iy                {- muroSiy~ -}       `gloss`  [ "Morse [ [ muroSiy ~ / NOUN ] ]", "Morse [ [ muroSiy ~ / ADJ ] ]" ] ]
 ...
 |> "m r .t" <| [
    ...
    noun     HaFCaL                    {- OamoraT -}        -- `others` [ "mur.t N", "mar.tA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "hairless" ] ]
 ...
 |> "m r ^g" <| [
    ...
    noun     FaCLAn |< Iy |< At        {- marojAniy~At -}   -- `others` [ "mar^gAniyy NAt" ]
                                                            `gloss`  [ "coral polyps", "anthozoans [ [ marojAniy ~ / NOUN ] ]" ] ]
 ...
 |> "m r ^g .h" <| [
    ...
    verb     KaRDaS                    {- marojaH -}        -- `others` [ "mar^gi.h IV_yu" ]
                                                            `gloss`  [ "rock", "shake" ],
    ...
    verb     TaKaRDaS                  {- tamarojaH -}      `gloss`  [ "swing back and forth", "dangle", "be in suspense" ] ]
 ...
 |> "m r _h" <| [
    ...
    noun     FiCCIL |< Iy              {- mir~iyxiy~ -}     `gloss`  [ "Martian [ [ mir ~ iyxiy ~ / NOUN ] ]", "Martian [ [ mir ~ iyxiy ~ / ADJ ] ]" ] ]
 ...
 |> "m r `" <| [
    ...
    noun     FuCL |< aT                {- muroEap -}        `gloss`  [ "grease", "oil" ],

    -- ;; mariyE_1
    -- mryE    mariyE  N-ap    fertile;productive     [[mariyE/ADJ]]

    noun     FaCIL                     {- mariyE -}         `gloss`  [ "fertile", "productive [ [ mariyE / ADJ ] ]" ],

    -- ;; mimorAE_1
    -- mmrAE   mimorAE N-ap    flourishing;prosperous     [[mimorAE/ADJ]]

    noun     MiFCAL                    {- mimorAE -}        `gloss`  [ "flourishing", "prosperous [ [ mimorAE / ADJ ] ]" ] ]
 ...
 |> "m r d" <| [
    ...
    verb     FaCaL                     {- marad-u -}        `imperf` [ FCuL ]
                                                            -- `others` [ "mrud IV_intr", "marud PV_intr" ]
    ...
    noun     FaCIL                     {- mariyd -}         -- `others` [ "muradA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "rebellious", "recalcitrant [ [ mariyd / ADJ ] ]", "recalcitrant" ],
    ...
    noun     HaFCaL                    {- Oamorad -}        -- `others` [ "murd N" ]
                                                            `gloss`  [ "beardless" ],
    ...
    noun     HaFCaL                    {- Oamorad -}        -- `others` [ "murd N", "mardA' Nh Nhy N0_Nh" ]
 ...
 |> "m r k z" <| [
    ...
    noun     TaKaRDuS                  {- tamarokuz -}      `gloss`  [ "concentration", "consolidation", "centralization" ],
    ...
    noun     KaRDIS                    {- marokiyz -}       `gloss`  [ "marquis" ] ]
 ...
 |> "m r m .t" <| [
    ...
    verb     KaRDaS                    {- maromaT -}        -- `others` [ "marmi.t IV_yu" ]
                                                            `gloss`  [ "damage", "spoil" ] ]
 ...
 |> "m r m r" <| [
    ...
    verb     KaRDaS                    {- maromar -}        -- `others` [ "marmir IV_intr_yu" ]
    ...
    verb     TaKaRDaS                  {- tamaromar -}      `gloss`  [ "murmur", "mumble", "grumble" ],

    -- ;; tamaromur_1
    -- tmrmr   tamaromur       N/At    bitterness;embitterment

    noun     TaKaRDuS                  {- tamaromur -}      `gloss`  [ "bitterness", "embitterment" ],

    -- ;; maromar_2
    -- mrmr    maromar N       marble

    noun     KaRDaS                    {- maromar -}        `gloss`  [ "marble" ],

    -- ;; maromariy~_1
    -- mrmry   maromariy~      N-ap    marble     [[maromariy~/ADJ]]

    noun     KaRDaS |< Iy              {- maromariy~ -}     `gloss`  [ "marble [ [ maromariy ~ / ADJ ] ]" ] ]
 ...
 |> "m r m s" <| [
    ...
    noun     KiRDIS                    {- miromiys -}       `gloss`  [ "rhinoceros" ] ]
 ...
 |> "m r n" <| [
    ...
    noun     MuFaCCaL                  {- mumar~an -}       `gloss`  [ "skilled", "trained [ [ mumar ~ an / ADJ ] ]" ],

    -- ;; mutamar~in_1
    -- mtmrn   mutamar~in      Nall    skilled;trained     [[mutamar~in/ADJ]]

    noun     MutaFaCCiL                {- mutamar~in -}     `gloss`  [ "skilled", "trained [ [ mutamar ~ in / ADJ ] ]" ],

    -- ;; mAruwn_1
    -- mArwn   mAruwn  N       Maronites

    noun     FACUL                     {- mAruwn -}         `gloss`  [ "Maronites" ],
    ...
    noun     FACUL |< Iy               {- mAruwniy~ -}      -- `others` [ "mawArin Nap" ]
    ...
    noun     FaCIL |< Iy               {- mariyniy~ -}      `gloss`  [ "Merinids [ [ mariyniy ~ / NOUN ] ]", "Merinids [ [ mariyniy ~ / ADJ ] ]" ] ]
 ...
 |> "m r q" <| [
    ...
    noun     FuCUL |< Iy               {- muruwqiy~ -}      `gloss`  [ "Quran reciter [ [ muruwqiy ~ / NOUN ] ]", "Quran reciter [ [ muruwqiy ~ / ADJ ] ]" ],

    -- ;; muruwqiy~_2
    -- mrwqy   muruwqiy~       Nall    pallbearer     [[muruwqiy~/NOUN]]
    -- mrwqy   muruwqiy~       Nall    pallbearer     [[muruwqiy~/ADJ]]

    noun     FuCUL |< Iy               {- muruwqiy~ -}      `gloss`  [ "pallbearer [ [ muruwqiy ~ / NOUN ] ]", "pallbearer [ [ muruwqiy ~ / ADJ ] ]" ],
 ...
 |> "m r q s" <| [
    ...
    noun     KuRDuS                    {- muroqus -}        `gloss`  [ "Murqus" ],

    -- ;; muroqus_2
    -- mrqs    muroqus Nprop   Mark

    noun     KuRDuS                    {- muroqus -}        `gloss`  [ "Mark" ],

    -- ;; muroqusiy~_1
    -- mrqsy   muroqusiy~      Nall    St. Mark's     [[muroqusiy~/NOUN]]
    -- mrqsy   muroqusiy~      Nall    St. Mark's     [[muroqusiy~/ADJ]]

    noun     KuRDuS |< Iy              {- muroqusiy~ -}     `gloss`  [ "St. Mark 's [ [ muroqusiy ~ / NOUN ] ]", "St. Mark 's [ [ muroqusiy ~ / ADJ ] ]" ] ]
 ...
 |> "m r r" <| [
    ...
    verb     HaFaCL                    {- Oamar~ -}         -- `others` [ "mirr IV_V_yu", "'amrar PV_C", "mrir IV_C_yu" ]
                                                            `gloss`  [ "let pass through", "make bitter" ],
    ...
    noun     TaFCIL |< aT              {- tamoriyrap -}     `gloss`  [ "pass ( ball , in sports )" ],
    ...
    noun     IstiFCAL |< Iy |< aT      {- {isotimorAriy~ap -} `gloss`  [ "continuity [ [ { isotimorAriy ~ / NOUN ] ]" ],
    ...
    noun     FaCAL |< aT               {- marArap -}        `gloss`  [ "gall bladder" ],
    ...
    noun     FaCIL |< aT               {- mariyrap -}       -- `others` [ "marA'ir Ndip" ]
    ...
    noun     HaFaCL                    {- Oamar~ -}         `gloss`  [ "more / most bitter" ],

    -- ;; mamoruwr_1
    -- mmrwr   mamoruwr        Nall    bad-tempered;irritable     [[mamoruwr/ADJ]]

    noun     MaFCUL                    {- mamoruwr -}       `gloss`  [ "bad-tempered", "irritable [ [ mamoruwr / ADJ ] ]" ] ]
 ...
 |> "m r s" <| [
    ...
    noun     FaCaL |< aT               {- marasap -}        -- `others` [ "'amrAs N" ]
                                                            `gloss`  [ "rope", "cord" ],
    ...
    noun     FaCAL |< aT               {- marAsap -}        `gloss`  [ "strength", "power" ],
    ...
    noun     FaCIL |< Iy               {- mariysiy~ -}      `gloss`  [ "hot south wind [ [ mariysiy ~ / ADJ ] ]" ],
 ...
 |> "m r s n" <| [
    ...
    noun     KaRDIS                    {- marosiyn -}       `gloss`  [ "myrtle" ] ]
 ...
 |> "m r w" <| [
    ...
    noun     FuCUL |< aT               {- muruw~ap -}       -- `others` [ "muruw' Nap" ]
    ...
    noun     FaCL |< aT                {- marowap -}        -- `others` [ "marw N" ]
 ...
 |> "m r w n" <| [
    ...
    noun     KaRDAS |< Iy              {- marowAniy~ -}     `gloss`  [ "Marwani" ] ]
 ...
 |> "m r w y" <| [
    ...
    noun     KaRDIS                    {- marowiy~ -}       `gloss`  [ "from / of Merv [ [ marowiy ~ / ADJ ] ]" ] ]
 ...
 |> "m r y" <| [
    ...
    noun     FuCL |< aT                {- muroyap -}        -- `others` [ "miry Nap" ]
 ...
 |> "m r y m" <| [
    ...
    noun     KaRDaS                    {- maroyam -}        `gloss`  [ "Mary" ],

    -- ;; maroyamiy~ap_1
    -- mrymy   maroyamiy~      Nap     sage     [[maroyamiy~/NOUN]]

    noun     KaRDaS |< Iy |< aT        {- maroyamiy~ap -}   `gloss`  [ "sage [ [ maroyamiy ~ / NOUN ] ]" ] ]
 ...
 |> "m s ' y" <| [
    ...
    noun     KaRADIS |< aT             {- masA}iy~ap -}     `gloss`  [ "Masaia", "Masaya" ] ]
 ...
 |> "m s .h" <| [
    ...
    noun     FaCL |< aT                {- masoHap -}        `gloss`  [ "rubbing", "anointing" ],

    -- ;; masoHap_2
    -- msH     masoH   Nap     trace;touch

    noun     FaCL |< aT                {- masoHap -}        `gloss`  [ "trace", "touch" ],
    ...
    noun     FaCCAL |< aT              {- mas~AHap -}       `gloss`  [ "windshield wiper" ],

    -- ;; mas~AHap_2
    -- msAH    mas~AH  NapAt   plane (tool)

    noun     FaCCAL |< aT              {- mas~AHap -}       `gloss`  [ "plane ( tool )" ],
    ...
    noun     FaCIL                     {- masiyH -}         -- `others` [ "musa.hA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "anointed [ [ masiyH / ADJ ] ]", "anointed" ],
    ...
    noun     MaFCUL                    {- mamosuwH -}       `gloss`  [ "wiped off", "cleaned [ [ mamosuwH / ADJ ] ]", "smoothed [ [ mamosuwH / ADJ ] ]" ] ]
 ...
 |> "m s .t r" <| [
    ...
    noun     KaRDaS |< aT              {- masoTarap -}      -- `others` [ "masA.tir Ndip" ]
 ...
 |> "m s _h" <| [
    ...
    noun     FuCL |< aT                {- musoxap -}        `gloss`  [ "clown", "buffoon" ],

    -- ;; masiyx_1
    -- msyx    masiyx  N-ap    transformed;disfigured;insipid     [[masiyx/ADJ]]

    noun     FaCIL                     {- masiyx -}         `gloss`  [ "transformed", "disfigured", "insipid [ [ masiyx / ADJ ] ]" ],

    -- ;; mamosuwx_1
    -- mmswx   mamosuwx        Nall    transformed;spoiled;disfigured     [[mamosuwx/ADJ]]

    noun     MaFCUL                    {- mamosuwx -}       `gloss`  [ "transformed", "spoiled", "disfigured [ [ mamosuwx / ADJ ] ]" ] ]
 ...
 |> "m s _h r" <| [
    ...
    verb     KaRDaS                    {- masoxar -}        -- `others` [ "mas_hir IV_yu" ]
    ...
    verb     TaKaRDaS                  {- tamasoxar -}      `gloss`  [ "mock" ] ]
 ...
 |> "m s k" <| [
    ...
    noun     FaCL |< aT                {- masokap -}        -- `others` [ "masak NAt" ]
    ...
    noun     FiCL |< aT                {- misokap -}        `gloss`  [ "touch", "glimpse" ],

    -- ;; musokap_1
    -- msk     musok   Napdu   handle;grip

    noun     FuCL |< aT                {- musokap -}        `gloss`  [ "handle", "grip" ],

    -- ;; masAkap_1
    -- msAk    masAk   Nap     avarice

    noun     FaCAL |< aT               {- masAkap -}        `gloss`  [ "avarice" ],
    ...
    noun     MustaFCiL                 {- musotamosik -}    `gloss`  [ "composed", "calm and collected [ [ musotamosik / ADJ ] ]" ] ]
 ...
 |> "m s k w" <| [
    ...
    noun     KuRDuS                    {- musokuw -}        `gloss`  [ "Moscow" ] ]
 ...
 |> "m s m r" <| [
    ...
    verb     KaRDaS                    {- masomar -}        -- `others` [ "masmir IV_yu" ]
                                                            `gloss`  [ "nail up" ] ]
 ...
 |> "m s n" <| [
    ...
    noun     FACUL                     {- mAsuwn -}         `gloss`  [ "Freemason" ] ]
 ...
 |> "m s r" <| [
    ...
    noun     FACUL |< aT               {- mAsuwrap -}       -- `others` [ "mawAsiyr Ndip", "masuwr Napdu" ]
    ...
    noun     FiCLY                     {- misoraY -}        `gloss`  [ "Misra" ] ]
 ...
 |> "m s s" <| [
    ...
    noun     FaCL |< aT                {- mas~ap -}         -- `others` [ "misAs N" ]
    ...
    noun     FaCIL                     {- masiys -}         `gloss`  [ "urgent [ [ masiys / ADJ ] ]" ],
    ...
    verb     FaCLY                     {- mas~aY -}         -- `others` [ "massA PV_h", "mass IV_0hwnyn_yu PV_ttAw", "massay PV_Atn IV_Ann_Pass_yu", "massiy IV_0hAnn_yu" ]
                                                            `gloss`  [ "wish good evening", "be wished good evening" ],

    -- ;; muwsaY_1
    -- mwsY    muwsaY  Nprop   Mousa;Moussa

    noun     MUCY                      {- muwsaY -}         `gloss`  [ "Mousa", "Moussa" ],

    -- ;; muwsaY_2
    -- mwsY    muwsaY  Nprop   Moses

    noun     MUCY                      {- muwsaY -}         `gloss`  [ "Moses" ],

    -- ;; muwsawiy~_1
    -- mwswy   muwsawiy~       N0      Moussaoui

    noun     MUCY |< Iy                {- muwsawiy~ -}      `gloss`  [ "Moussaoui" ],

    -- ;; muwsawiy~_2
    -- mwswy   muwsawiy~       N-ap    Mosaic;Moses     [[muwsawiy~/ADJ]]

    noun     MUCY |< Iy                {- muwsawiy~ -}      `gloss`  [ "Mosaic", "Moses [ [ muwsawiy ~ / ADJ ] ]" ] ]
 ...
 |> "m s w" <| [
    ...
    verb     HaFCY                     {- OamosaY -}        -- `others` [ "msay IV_Ann_Pass_yu", "msY IV_0_Pass_yu", "'amsay PV_Atn", "msiy IV_0hAnn_yu", "ms IV_0hwnyn_yu", "'amsA PV_h", "'ams PV_ttAw" ]
    ...
    noun     MuFCI                     {- mumosiy -}        -- `others` [ "mums Nuwn_Niyn NK" ]
    ...
    noun     MuFCY                     {- mumosaY -}        -- `others` [ "mumsA Nhy" ]
                                                            `gloss`  [ "evening time" ] ]
 ...
 |> "m t .s" <| [
    ...
    verb     IFCaLL                    {- {imotaS~ -}       -- `others` [ "mta.si.s IV_C", "mta.s.s IV_V", "imta.sa.s PV_C" ]
                                                            `gloss`  [ "absorb", "sip", "lap up" ],
    ...
    noun     IFCiLAL                   {- {imotiSAS -}      `gloss`  [ "absorption", "suction" ],

    -- ;; mumotaS~_1
    -- mmtS    mumotaS~        N-ap    absorbing;absorbent

    noun     MuFCaLL                   {- mumotaS~ -}       `gloss`  [ "absorbing", "absorbent" ] ]
 ...
 |> "m t `" <| [
    ...
    noun     HaFCaL                    {- OamotaE -}        `gloss`  [ "more / most enjoyable", "recreational" ],
    ...
    noun     MuFaCCaL                  {- mumat~aE -}       `gloss`  [ "pleased [ [ mumat ~ aE / ADJ ] ]" ],
 ...
 |> "m t d" <| [
    ...
    verb     IFCaLL                    {- {imotad~ -}       -- `others` [ "imtadad PV_C", "mtadd IV_V", "mtadid IV_C" ]
                                                            `gloss`  [ "extend", "reach", "spread" ],
    ...
    noun     IFCiLAL                   {- {imotidAd -}      `gloss`  [ "extension", "expansion" ],

    -- ;; {imotidAd_2
    -- <mtdAd  {imotidAd       N/At    extent;scope
    -- AmtdAd  {imotidAd       N/At    extent;scope

    noun     IFCiLAL                   {- {imotidAd -}      `gloss`  [ "extent", "scope" ],
 ...
 |> "m t l" <| [
    ...
    verb     IFCaLL                    {- {imotal~ -}       -- `others` [ "mtall IV_V", "mtalil IV_C", "imtalal PV_C" ]
                                                            `gloss`  [ "convert to", "embrace a religion" ] ]
 ...
 |> "m t t" <| [
    ...
    noun     FACL |< aT                {- mAt~ap -}         `gloss`  [ "family ties", "kinship" ],

    -- ;; mat~aY_1
    -- mtY     mat~aY  Nprop   Matthew

    noun     FaCLY                     {- mat~aY -}         `gloss`  [ "Matthew" ] ]
 ...
 |> "m t y" <| [
    ...
    noun     FaCY                      {- mataY -}          `gloss`  [ "when [ [ mataY / REL_PRON ] ]" ],

    -- ;; mataY_2
    -- mtY     mataY   FW-Wa   when         [[mataY/INTERROG_PART]]

    noun     FaCY                      {- mataY -}          `gloss`  [ "when [ [ mataY / INTERROG_PART ] ]" ],

    -- ;; mataY_3
    -- mtY     mataY   FW-Wa   when         [[mataY/CONJ]]

    noun     FaCY                      {- mataY -}          `gloss`  [ "when [ [ mataY / CONJ ] ]" ],
 ...
 |> "m t z" <| [
    ...
    verb     IFCaLL                    {- {imotaz~ -}       -- `others` [ "mtaziz IV_C", "mtazz IV_V", "imtazaz PV_C" ]
    ...
    noun     IFCiLAL                   {- {imotizAz -}      `gloss`  [ "adsorption ( surface accumulation )" ] ]
 ...
 |> "m w '" <| [
    ...
    noun     FAL |< Iy |< aT           {- mA}iy~ap -}       -- `others` [ "mAwiyy Nap" ]
                                                            `gloss`  [ "juice", "sap [ [ mA } iy ~ / NOUN ] ]", "sap [ [ mAwiy ~ / NOUN ] ]" ] ]
 ...
 |> "m w ^g" <| [
    ...
    verb     FAL                       {- mAj-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "muw^g IV_V", "mu^g PV_C IV_C" ]
    ...
    noun     FaCCAL |< aT              {- maw~Ajap -}       `gloss`  [ "transmitter" ],
    ...
    noun     FA'iL                     {- mA}ij -}          `gloss`  [ "surging", "swelling", "stormy [ [ mA } ij / ADJ ] ]" ],

    -- ;; mumaw~aj_1
    -- mmwj    mumaw~aj        N-ap    undulated;wavy     [[mumaw~aj/ADJ]]

    noun     MuFaCCaL                  {- mumaw~aj -}       `gloss`  [ "undulated", "wavy [ [ mumaw ~ aj / ADJ ] ]" ],

    -- ;; mutamaw~ij_1
    -- mtmwj   mutamaw~ij      N-ap    undulating;waving;wavelike     [[mutamaw~ij/ADJ]]

    noun     MutaFaCCiL                {- mutamaw~ij -}     `gloss`  [ "undulating", "waving", "wavelike [ [ mutamaw ~ ij / ADJ ] ]" ],

    -- ;; mutamAwij_1
    -- mtmAwj  mutamAwij       N-ap    fluctuating;undulating     [[mutamAwij/ADJ]]

    noun     MutaFACiL                 {- mutamAwij -}      `gloss`  [ "fluctuating", "undulating [ [ mutamAwij / ADJ ] ]" ] ]
 ...
 |> "m w d l" <| [
    ...
    noun     KuRDIS                    {- muwdiyl -}        -- `others` [ "muwdil N/At" ]
                                                            `gloss`  [ "model", "pattern" ] ]
 ...
 |> "m w h" <| [
    ...
    verb     HaFAL                     {- OamAh -}          -- `others` [ "mAh IV_V_Pass_yu", "mih IV_C_yu", "mah IV_C_Pass_yu", "miyh IV_V_yu", "'amah PV_C" ]
    ...
    noun     TaFCIL |< Iy              {- tamowiyhiy~ -}    `gloss`  [ "fake", "false [ [ tamowiyhiy ~ / ADJ ] ]" ] ]
 ...
 |> "m w n _h" <| [
    ...
    noun     KuRDIS                    {- muwniyx -}        `gloss`  [ "Munich" ] ]
 ...
 |> "m w n k" <| [
    ...
    noun     KuRDIS                    {- muwniyk -}        `gloss`  [ "Monique" ] ]
 ...
 |> "m w r" <| [
    ...
    verb     FAL                       {- mAr-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "mur PV_C IV_C", "muwr IV_V" ]
    ...
    noun     TaFaCCuL |< aN            {- tamaw~urAF -}     -- `others` [ "tamawwur NF" ]
                                                            `gloss`  [ "back and forth [ [ tamaw ~ ur / ADV ] ]" ],

    -- ;; {isotimArap_1
    -- <stmAr  {isotimAr       NapAt   form;questionnaire
    -- AstmAr  {isotimAr       NapAt   form;questionnaire

    noun     IstiFAL |< aT             {- {isotimArap -}    `gloss`  [ "form", "questionnaire" ],
 ...
 |> "m w r n" <| [
    ...
    noun     KuRDIS |< aT              {- muwriynap -}      `gloss`  [ "wooden beam" ] ]
 ...
 |> "m w s" <| [
    ...
    noun     FuCLY |< Iy               {- muwsawiy~ -}      `gloss`  [ "Mosaic", "Moses [ [ muwsawiy ~ / ADJ ] ]" ] ]
 ...
 |> "m w s q" <| [
    ...
    noun     KuRDIS |< Iy |< aT        {- muwsiyqiy~ap -}   `gloss`  [ "musicality [ [ muwsiyqiy ~ / NOUN ] ]" ] ]
 ...
 |> "m w t" <| [
    ...
    verb     IstaFAL                   {- {isotamAt -}      -- `others` [ "stamit IV_C", "stamiyt IV_V", "istamat PV_Ct" ]
    ...
    noun     FaCLAn                    {- mawotAn -}        -- `others` [ "muwtAn N" ]
                                                            `gloss`  [ "dying", "epidemic" ],

    -- ;; miytap_1
    -- myt     miyt    Nap     death

    noun     FIL |< aT                 {- miytap -}         `gloss`  [ "death" ],

    -- ;; mA}it_1
    -- mA}t    mA}it   Nall    moribund;mortal     [[mA}it/ADJ]]
    -- mAyt    mAyit   Nall    moribund;mortal

    noun     FA'iL                     {- mA}it -}          -- `others` [ "mAyit Nall" ]
                                                            `gloss`  [ "moribund", "mortal [ [ mA } it / ADJ ] ]", "mortal" ],
    ...
    noun     MustaFIL                  {- musotamiyt -}     `gloss`  [ "death-defying", "martyr [ [ musotamiyt / ADJ ] ]" ] ]
 ...
 |> "m w t r" <| [
    ...
    noun     KuRDUS                    {- muwtuwr -}        `gloss`  [ "motor" ] ]
 ...
 |> "m w z" <| [
    ...
    noun     FaCL |< Iy                {- mawoziy~ -}       `gloss`  [ "banana [ [ mawoziy ~ / ADJ ] ]" ] ]
 ...
 |> "m y .h" <| [
    ...
    verb     FAL                       {- mAH-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "mi.h PV_C IV_C", "miy.h IV_V" ]
                                                            `gloss`  [ "strut", "waddle" ],
 ...
 |> "m y .t" <| [
    ...
    verb     FAL                       {- mAT-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "miy.t IV_V", "mi.t PV_C IV_C" ]
    ...
    verb     HaFAL                     {- OamAT -}          -- `others` [ "ma.t IV_C_Pass_yu", "mi.t IV_C_yu", "miy.t IV_V_yu", "'ama.t PV_C", "mA.t IV_V_Pass_yu" ]
 ...
 |> "m y `" <| [
    ...
    verb     FaCCaL                    {- may~aE -}         -- `others` [ "mayyi` IV_yu" ]
    ...
    verb     HaFAL                     {- OamAE -}          -- `others` [ "ma` IV_C_Pass_yu", "miy` IV_V_yu", "mi` IV_C_yu", "'ama` PV_C", "mA` IV_V_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- mayoEap -}        `gloss`  [ "storax", "prime", "indulgence" ],

    -- ;; muyuwEap_1
    -- mywE    muyuwE  Nap     liquid state;softness;flaccidity

    noun     FuCUL |< aT               {- muyuwEap -}       `gloss`  [ "liquid state", "softness", "flaccidity" ],
    ...
    noun     HiFAL |< aT               {- IimAEap -}        `gloss`  [ "melting", "liquefaction" ],
    ...
    noun     FA'iL                     {- mA}iE -}          `gloss`  [ "melting", "liquid" ],
    ...
    noun     FA'iL                     {- mA}iE -}          -- `others` [ "mawA'i` Ndip", "mawAyi` Ndip" ]
                                                            `gloss`  [ "fluid", "fluids" ] ]
 ...
 |> "m y d" <| [
    ...
    verb     FAL                       {- mAd-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "mid PV_C IV_C", "miyd IV_V" ]
    ...
    noun     FiCL |< aT                {- miydap -}         `gloss`  [ "lintel", "breastsummer ( arch . )" ],
    ...
    noun     FA'iL                     {- mA}id -}          -- `others` [ "maydY N0", "maydA Nhy" ]
                                                            `gloss`  [ "seasick", "sea-sick" ],
 ...
 |> "m y d '" <| [
    ...
    noun     KiRDAS                    {- miydA' -}         `gloss`  [ "measure", "amount", "length" ] ]
 ...
 |> "m y d l" <| [
    ...
    noun     KiRDiS                    {- miydil -}         `gloss`  [ "Middle" ] ]
 ...
 |> "m y d z" <| [
    ...
    noun     KiRDUS                    {- miyduwz -}        `gloss`  [ "Meadows" ] ]
 ...
 |> "m y l" <| [
    ...
    verb     HaFAL                     {- OamAl -}          -- `others` [ "'amal PV_C", "mal IV_C_Pass_yu", "miyl IV_V_yu", "mAl IV_V_Pass_yu" ]
    ...
    noun     FA'iL                     {- mA}il -}          `gloss`  [ "biased", "partial [ [ mA } il / ADJ ] ]" ],

    -- ;; mA}il_3
    -- mA}l    mA}il   N-ap    italic     [[mA}il/ADJ]]

    noun     FA'iL                     {- mA}il -}          `gloss`  [ "italic [ [ mA } il / ADJ ] ]" ],
 ...
 |> "m y m y" <| [
    ...
    noun     KaRADiS                   {- mayAmiy -}        `gloss`  [ "Miami" ] ]
 ...
 |> "m y r" <| [
    ...
    noun     FACUL                     {- mAyuwr -}         `gloss`  [ "Mayor", "Major" ],
    ...
    verb     FAL                       {- mAr-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "mir PV_C IV_C", "miyr IV_V" ]
    ...
    verb     HaFAL                     {- OamAr -}          -- `others` [ "mAr IV_V_Pass_yu", "mar IV_C_Pass_yu", "'amar PV_C", "mir IV_C_yu", "miyr IV_V_yu" ]
    ...
    noun     FiCL |< aT                {- miyrap -}         -- `others` [ "miyar N" ]
 ...
 |> "m y r n" <| [
    ...
    noun     KaRDUS                    {- mayoruwn -}       `gloss`  [ "chrism" ] ]
 ...
 |> "m y r y" <| [
    ...
    noun     KiRDiS                    {- miyriy -}         `gloss`  [ "state" ] ]
 ...
 |> "m y s" <| [
    ...
    verb     FAL                       {- mAs-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "miys IV_V", "mis PV_C IV_C" ]
                                                            `gloss`  [ "swagger" ],
 ...
 |> "m y t" <| [
    ...
    noun     FaCL |< aT                {- mayotap -}        `gloss`  [ "corpse", "non-kosher meat" ],

    -- ;; miytap_1
    -- myt     miyt    Nap     death

    noun     FiCL |< aT                {- miytap -}         `gloss`  [ "death" ],
    ...
    noun     MustaFiCL                 {- musotamiyt -}     `gloss`  [ "death-defying", "martyr [ [ musotamiyt / ADJ ] ]" ] ]
 ...
 |> "m y z" <| [
    ...
    verb     FAL                       {- mAz-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "miyz IV_V", "miz PV_C IV_C" ]
    ...
    noun     HaFCaL                    {- Oamoyaz -}        `gloss`  [ "preferable" ],
 ...
 |> "m z .h" <| [
    ...
    noun     FuCAL |< aT               {- muzAHap -}        `gloss`  [ "joking", "jesting" ],

    -- ;; mazoHap_1
    -- mzH     mazoH   Napdu   joke;prank

    noun     FaCL |< aT                {- mazoHap -}        `gloss`  [ "joke", "prank" ],
 ...
 |> "m z _h" <| [
    ...
    noun     FACUL |< Iy               {- mAzuwxiy~ -}      `gloss`  [ "masochist [ [ mAzuwxiy ~ / ADJ ] ]", "masochism [ [ mAzuwxiy ~ / NOUN ] ]" ] ]
 ...
 |> "m z `" <| [
    ...
    noun     FuCL |< aT                {- muzoEap -}        -- `others` [ "muza` N", "miza` N", "miz` Nap" ]
 ...
 |> "m z m z" <| [
    ...
    verb     KaRDaS                    {- mazomaz -}        -- `others` [ "mazmiz IV_yu" ]
                                                            `gloss`  [ "sip" ] ]
 ...
 |> "m z n" <| [
    ...
    noun     FACI |< aT                {- mAziyap -}        `gloss`  [ "merit", "virtue", "advantage" ] ]
 ...
 |> "m z q" <| [
    ...
    noun     FiCL |< aT                {- mizoqap -}        -- `others` [ "mizaq N" ]
 ...
 |> "m z t" <| [
    ...
    noun     FACUL                     {- mAzuwt -}         -- `others` [ "mAzuw.t N0" ]
 ...
 |> "m z y" <| [
    ...
    noun     FACiL |< aT               {- mAziyap -}        `gloss`  [ "merit", "virtue", "advantage" ] ]
 ...
 |> "m z z" <| [
    ...
    verb     FaCL                      {- maz~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "mzuz IV_C", "muzz IV_V", "mazaz PV_C" ]
                                                            `gloss`  [ "sip", "suck" ],
    ...
    noun     FaCL |< aT                {- maz~ap -}         `gloss`  [ "appetizers", "entrees" ] ]
 ...
 |> "mA`uwn^g" <| [
    ...
    noun     Identity |< Iy            {- mAEuwnojiy~ -}    `gloss`  [ "boatman", "bargeman", "boatmen", "bargemen [ [ mAEuwnojiy ~ / NOUN ] ]" ] ]
 ...
 |> "mAhiyy" <| [
    ...
    noun     Identity |< aT            {- mAhiy~ap -}       `gloss`  [ "salary", "income", "pay [ [ mAhiy ~ / NOUN ] ]" ] ]
 ...
 |> "mAniyfAtuwr" <| [
    ...
    noun     Identity |< aT            {- mAniyfAtuwrap -}  `gloss`  [ "manufactured goods", "textiles" ] ]
 ...
 |> "mAniyliyy" <| [
    ...
    noun     Identity                  {- mAniyliy~ -}      `gloss`  [ "Manilan [ [ mAniyliy ~ / NOUN ] ]", "Manilan [ [ mAniyliy ~ / ADJ ] ]" ] ]
 ...
 |> "mAri^sAl" <| [
    ...
    noun     Identity |< Iy |< aT      {- mAri$Aliy~ap -}   `gloss`  [ "rank of marshal", "position of marshal [ [ mAri $ Aliy ~ / NOUN ] ]" ] ]
 ...
 |> "mArkis" <| [
    ...
    noun     Identity |< Iy            {- mArokisiy~ -}     `gloss`  [ "Marxist [ [ mArokisiy ~ / NOUN ] ]", "Marxist [ [ mArokisiy ~ / ADJ ] ]" ],

    -- ;; mArokisiy~ap_1
    -- mArksy  mArokisiy~      NapAt   Marxism     [[mArokisiy~/NOUN]]

    noun     Identity |< Iy |< aT      {- mArokisiy~ap -}   `gloss`  [ "Marxism [ [ mArokisiy ~ / NOUN ] ]" ] ]
 ...
 |> "mAsuw_hiyy" <| [
    ...
    noun     Identity                  {- mAsuwxiy~ -}      `gloss`  [ "masochist [ [ mAsuwxiy ~ / ADJ ] ]", "masochism [ [ mAsuwxiy ~ / NOUN ] ]" ] ]
 ...
 |> "mAsuwkiyy" <| [
    ...
    noun     Identity                  {- mAsuwkiy~ -}      -- `others` [ "mAsuw^siyy Nall" ]
                                                            `gloss`  [ "masochist [ [ mAsuwkiy ~ / ADJ ] ]", "masochist [ [ mAsuw $ iy ~ / ADJ ] ]" ],

    -- ;; mAsuwkiy~ap_1
    -- mAswky  mAsuwkiy~       Nap     masochism     [[mAsuwkiy~/NOUN]]
    -- mAsw$y  mAsuw$iy~       Nap     masochism     [[mAsuw$iy~/NOUN]]

    noun     Identity |< aT            {- mAsuwkiy~ap -}    -- `others` [ "mAsuw^siyy Nap" ]
                                                            `gloss`  [ "masochism [ [ mAsuwkiy ~ / NOUN ] ]", "masochism [ [ mAsuw $ iy ~ / NOUN ] ]" ] ]
 ...
 |> "mAsuwniyy" <| [
    ...
    noun     Identity                  {- mAsuwniy~ -}      `gloss`  [ "Freemason", "Masonic [ [ mAsuwniy ~ / NOUN ] ]", "Masonic [ [ mAsuwniy ~ / ADJ ] ]" ],

    -- ;; mAsuwniy~ap_1
    -- mAswny  mAsuwniy~       Nap     Freemasonry     [[mAsuwniy~/NOUN]]

    noun     Identity |< aT            {- mAsuwniy~ap -}    `gloss`  [ "Freemasonry [ [ mAsuwniy ~ / NOUN ] ]" ] ]
 ...
 |> "m_t" <| [
    ...
    noun     Identity                  {- mv -}             `gloss`  [ "fem . [ [ mv / ABBREV ] ]" ] ]
 ...
 |> "ma.gna.tiys" <| [
    ...
    noun     Identity |< Iy            {- magonaTiysiy~ -}  -- `others` [ "ma.gnA.tiysiyy Nall" ]
                                                            `gloss`  [ "magnetic", "hypnotic [ [ magonaTiysiy ~ / ADJ ] ]", "hypnotic [ [ magonATiysiy ~ / ADJ ] ]" ],

    -- ;; magonaTiysiy~ap_1
    -- mgnTysy magonaTiysiy~   Nap     magnetism     [[magonaTiysiy~/NOUN]]
    -- mgnATysy        magonATiysiy~   Nap     magnetism     [[magonATiysiy~/NOUN]]

    noun     Identity |< Iy |< aT      {- magonaTiysiy~ap -} -- `others` [ "ma.gnA.tiysiyy Nap" ]
                                                            `gloss`  [ "magnetism [ [ magonaTiysiy ~ / NOUN ] ]", "magnetism [ [ magonATiysiy ~ / NOUN ] ]" ] ]
 ...
 |> "ma`karuwn" <| [
    ...
    noun     Identity |< aT            {- maEokaruwnap -}   -- `others` [ "ma`karuwnah N0" ]
                                                            `gloss`  [ "macaroni" ] ]
 ...
 |> "mahra^gAn" <| [
    ...
    noun     Identity |< Iy            {- mahorajAniy~ -}   `gloss`  [ "festival [ [ mahorajAniy ~ / ADJ ] ]" ] ]
 ...
 |> "makaruwn" <| [
    ...
    noun     Identity |< aT            {- makaruwnap -}     `gloss`  [ "macaroni" ] ]
 ...
 |> "malAyuwiyy" <| [
    ...
    noun     Identity                  {- malAyuwiy~ -}     `gloss`  [ "Malayan [ [ malAyuwiy ~ / NOUN ] ]", "Malayan [ [ malAyuwiy ~ / ADJ ] ]" ] ]
 ...
 |> "mala.gA^s" <| [
    ...
    noun     Identity |< Iy            {- malagA$iy~ -}     `gloss`  [ "Madagascan [ [ malagA $ iy ~ / NOUN ] ]", "Madagascan [ [ malagA $ iy ~ / ADJ ] ]" ] ]
 ...
 |> "malakuwt" <| [
    ...
    noun     Identity |< Iy            {- malakuwtiy~ -}    `gloss`  [ "divine", "heavenly [ [ malakuwtiy ~ / ADJ ] ]" ] ]
 ...
 |> "maqduwniyy" <| [
    ...
    noun     Identity                  {- maqoduwniy~ -}    -- `others` [ "makduwniyy Nall" ]
                                                            `gloss`  [ "Macedonian [ [ maqoduwniy ~ / ADJ ] ]", "Macedonian [ [ makoduwniy ~ / ADJ ] ]" ] ]
 ...
 |> "marrAki^s" <| [
    ...
    noun     Identity |< Iy            {- mar~Aki$iy~ -}    `gloss`  [ "Moroccan [ [ mar ~ Aki $ iy ~ / NOUN ] ]", "Moroccan [ [ mar ~ Aki $ iy ~ / ADJ ] ]" ] ]
 ...
 |> "marrAku^s" <| [
    ...
    noun     Identity |< Iy            {- mar~Aku$iy~ -}    `gloss`  [ "Moroccan [ [ mar ~ Aku $ iy ~ / NOUN ] ]", "Moroccan [ [ mar ~ Aku $ iy ~ / ADJ ] ]" ] ]
 ...
 |> "mastill" <| [
    ...
    noun     Identity |< aT            {- masotil~ap -}     `gloss`  [ "tub" ] ]
 ...
 |> "may.huw.h" <| [
    ...
    noun     Identity |< aT            {- mayoHuwHap -}     `gloss`  [ "strutting", "waddling" ] ]
 ...
 |> "mi^slawz" <| [
    ...
    noun     Identity |< Iy            {- mi$olawoziy~ -}   `gloss`  [ "apricot-colored [ [ mi $ olawoziy ~ / ADJ ] ]" ] ]
 ...
 |> "milyuwnAr" <| [
    ...
    noun     Identity |< Iy            {- miloyuwnAriy~ -}  -- `others` [ "milyuwniyr N/At" ]
                                                            `gloss`  [ "millionaire [ [ miloyuwnAriy ~ / ADJ ] ]", "millionaire" ] ]
 ...
 |> "mimmA" <| [
    ...
    noun     Identity                  {- mim~A -}          `gloss`  [ "from + what [ [ min / PREP+mA / REL_PRON ] ]" ] ]
 ...
 |> "mimma" <| [
    ...
    noun     Identity                  {- mim~a -}          `gloss`  [ "from + what [ [ min / PREP+ma / INTERROG_PART ] ]" ] ]
 ...
 |> "mimman" <| [
    ...
    noun     Identity                  {- mim~an -}         `gloss`  [ "from + whom [ [ min / PREP+man / REL_PRON ] ]" ],

    -- ;; mim~an_2
    -- mmn     mim~an  FW-Wa   from + whom   [[min/PREP+man/INTERROG_PART]]

    noun     Identity                  {- mim~an -}         `gloss`  [ "from + whom [ [ min / PREP+man / INTERROG_PART ] ]" ] ]
 ...
 |> "miriyy" <| [
    ...
    noun     Identity                  {- miriy~ -}         `gloss`  [ "Meri", "Miri" ] ]
 ...
 |> "miydA'a" <| [
    ...
    noun     Identity                  {- miydA'a -}        -- `others` [ "bimiydA'i FW-Wa-i", "miydA'i FW-Wa FW-Wa-i" ]
                                                            `gloss`  [ "in front of", "facing [ [ miydA'a / PREP ] ]", "facing [ [ miydA'i / PREP ] ]", "facing [ [ miydA } i / PREP ] ]", "facing [ [ bimiydA } i / PREP ] ]" ] ]
 ...
 |> "miydAwiyy" <| [
    ...
    noun     Identity                  {- miydAwiy~ -}      `gloss`  [ "Midaoui", "Midawi" ] ]
 ...
 |> "miykAniyk" <| [
    ...
    noun     Identity |< Iy |< aT      {- miykAniykiy~ap -} `gloss`  [ "mechanics [ [ miykAniykiy ~ / NOUN ] ]" ] ]
 ...
 |> "miykAnizm" <| [
    ...
    noun     Identity                  {- miykAnizm -}      -- `others` [ "miykAniykiyy N-ap", "miykAniyk N0", "miykAniyy N-ap", "miykAniykA N0" ]
                                                            `gloss`  [ "mechanism", "mechanical [ [ miykAniy ~ / ADJ ] ]", "mechanics", "mechanical", "motorized [ [ miykAniykiy ~ / ADJ ] ]" ] ]
 ...
 |> "miykruwskuwb" <| [
    ...
    noun     Identity |< Iy            {- miykoruwskuwbiy~ -} `gloss`  [ "microscopic [ [ miykoruwskuwbiy ~ / ADJ ] ]" ] ]
 ...
 |> "miytAfiyziyq" <| [
    ...
    noun     Identity |< Iy            {- miytAfiyziyqiy~ -} `gloss`  [ "metaphysical [ [ miytAfiyziyqiy ~ / ADJ ] ]" ] ]
 ...
 |> "miyzuwbuwtAmiyy" <| [
    ...
    noun     Identity                  {- miyzuwbuwtAmiy~ -} `gloss`  [ "Mesopotamian [ [ miyzuwbuwtAmiy ~ / NOUN ] ]", "Mesopotamian [ [ miyzuwbuwtAmiy ~ / ADJ ] ]" ] ]
 ...
 |> "mudiyl" <| [
    ...
    noun     Identity                  {- mudiyl -}         `gloss`  [ "model", "type", "models", "types" ] ]
 ...
 |> "mumAss" <| [
    ...
    noun     Identity |< aT            {- mumAs~ap -}       `gloss`  [ "contact", "adjacency" ],
 ...
 |> "mursiy" <| [
    ...
    noun     Identity |< aT            {- murosiyap -}      `gloss`  [ "Murcia" ] ]
 ...
 |> "muskuwfiyy" <| [
    ...
    noun     Identity                  {- musokuwfiy~ -}    `gloss`  [ "Muscovite [ [ musokuwfiy ~ / NOUN ] ]", "Muscovite [ [ musokuwfiy ~ / ADJ ] ]" ] ]
 ...
 |> "muwriysk" <| [
    ...
    noun     Identity |< Iy            {- muwriyskiy~ -}    `gloss`  [ "Morisco [ [ muwriyskiy ~ / NOUN ] ]", "Morisco [ [ muwriyskiy ~ / ADJ ] ]" ] ]
 ...
 |> "muwsAwiyy" <| [
    ...
    noun     Identity                  {- muwsAwiy~ -}      `gloss`  [ "Moussaoui" ] ]
 ...
 |> "muwskuw" <| [
    ...
    noun     Identity |< Iy            {- muwsokuwiy~ -}    `gloss`  [ "Muscovite [ [ muwsokuwiy ~ / NOUN ] ]", "Muscovite [ [ muwsokuwiy ~ / ADJ ] ]" ] ]
