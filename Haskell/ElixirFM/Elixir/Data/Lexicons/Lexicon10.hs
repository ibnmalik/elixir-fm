...
lexicon = listing "Lexicon properties"
 ...
 |> "r ' " <| [
    ...
    noun     FiCaNY |< Iy              {- ri}awiy~ -}       `gloss`  [ "pulmonary [ [ ri } awiy ~ / ADJ ] ]" ] ]
 ...
 |> "r ` w" <| [
    ...
    noun     FaCaNY |< Iy              {- raEawiy~ -}       `gloss`  [ "pastoral", "bucolic [ [ raEawiy ~ / ADJ ] ]" ],
 ...
 |> "r ` y" <| [
    ...
    noun     MuFACaNY |< aT            {- murAEAp -}        `others` [ "murA`ay NAt" ]
