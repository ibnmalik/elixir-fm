...
$lexicon = {
  ...
  '.h d r' => [
    ...
    {
      'types' => $lexicon->{'.h d r'}[2]{'types'},
      'entry' => '.hAdiy',
      'form' => '.hAdiy',
      'others' => $lexicon->{'.h d r'}[2]{'others'},
      'lines' => $lexicon->{'.h d r'}[2]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACI',
      'suffix' => '',
      'glosses' => $lexicon->{'.h d r'}[2]{'glosses'},
      'glosshash' => $lexicon->{'.h d r'}[2]{'glosshash'},
      'orig' => 'HAdiy',
      'prefix' => ''
    }
  ],
  ...
  '.h w t' => [
    ...
    {
      'types' => $lexicon->{'.h w t'}[0]{'types'},
      'entry' => '.huwt',
      'form' => '.huwt',
      'lines' => $lexicon->{'.h w t'}[0]{'lines'},
      'index' => '4',
      'entity' => 'noun',
      'morphs' => 'FUL',
      'suffix' => '',
      'glosses' => $lexicon->{'.h w t'}[0]{'glosses'},
      'glosshash' => $lexicon->{'.h w t'}[0]{'glosshash'},
      'orig' => 'Huwt',
      'prefix' => ''
    }
  ],
  ...
  '.h m ' => [
    {
      'types' => $lexicon->{'.h m y'}[4]{'types'},
      'entry' => 'mu.hAmiy',
      'form' => 'mu.hAmiy',
      'others' => $lexicon->{'.h m y'}[4]{'others'},
      'lines' => $lexicon->{'.h m y'}[4]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'MuFACiN',
      'suffix' => '',
      'glosses' => $lexicon->{'.h m y'}[4]{'glosses'},
      'glosshash' => $lexicon->{'.h m y'}[4]{'glosshash'},
      'orig' => 'muHAmiy',
      'prefix' => ''
    }
  ],
