...
lexicon = listing "Lexicon properties"
 ...
 |> "hA" <| [
    ...
    noun     Identity                  {- hA -}             `gloss`  [ "look", "now" ],
 ...
 |> "hArb" <| [
    ...
    noun     Identity                  {- hArob -}          `gloss`  [ "harp" ] ]
 ...
 |> "hAnz" <| [
    ...
    noun     Identity                  {- hAnoz -}          `gloss`  [ "Hans" ] ]
 ...
 |> "hAns" <| [
    ...
    noun     Identity                  {- hAnos -}          `gloss`  [ "Hans" ] ]
 ...
 |> "h'h'" <| [
    ...
    verb     FaCCaL                    {- ha>oha> -}        `others` [ "ha'hi' IV_yu", "ha'ha'A PV-|" ]
                                                            `gloss`  [ "laugh" ] ]
 ...
 |> "hAyt" <| [
    ...
    noun     Identity |< Iy            {- hAytiy~ -}        `gloss`  [ "Haitian" ] ]
 ...
 |> "hbb" <| [
    ...
    verb     FaCL                      {- hab~-u -}         `imperf` [ FCuL ]
                                                            `others` [ "habab PV_C", "habb PV_V", "hbub IV_C", "hubb IV_V" ]
    ...
    verb     HaFaCL                    {- >ahab~ -}         `others` [ "hbib IV_C_yu", "habb IV_V_Pass_yu", "'ahbab PV_C", "hibb IV_V_yu" ]
    ...
    noun     FaCL |< aT                {- hab~ap -}         `others` [ "habb Nap" ]
                                                            `gloss`  [ "breeze", "gust" ],
 ...
 |> "mahabb" <| [
    ...
    noun     Identity                  {- mahab~ -}         `gloss`  [ "windy side", "wind direction" ],

    -- ;; muhab~ab_1
    -- mhbb    muhab~ab        N-ap    sooty     [[muhab~ab/ADJ]]

    noun     MuFaCCaL                  {- muhab~ab -}       `gloss`  [ "sooty" ] ]
 ...
 |> "hbr" <| [
    ...
    noun     FaCL |< aT                {- haborap -}        `others` [ "habr Nap" ]
                                                            `gloss`  [ "slice of meat" ],

    -- ;; hubayorap_1
    -- hbyr    hubayor Nap     hyena

    noun     FuCayL |< aT              {- hubayorap -}      `others` [ "hubayr Nap" ]
                                                            `gloss`  [ "hyena" ] ]
 ...
 |> "hb.t" <| [
    ...
    verb     FaCaL                     {- habaT-ui -}       `imperf` [ FCuL, FCiL ]
                                                            `others` [ "hbu.t IV", "haba.t PV", "hbi.t IV" ]
    ...
    verb     HaFCaL                    {- >ahobaT -}        `others` [ "hba.t IV_Pass_yu", "hbi.t IV_yu" ]
    ...
    noun     FaCL |< aT                {- haboTap -}        `others` [ "hab.t Napdu" ]
                                                            `gloss`  [ "descent", "decline", "drop" ],
    ...
    noun     FaCIL                     {- habiyT -}         `gloss`  [ "emaciated", "worn out" ] ]
 ...
 |> "'uhbuw.t" <| [
    ...
    noun     Identity |< aT            {- >uhobuwTap -}     `others` [ "'uhbuw.t Napdu", "'ahAbiy.t Ndip" ]
    ...
    noun     FACiL                     {- hAbiT -}          `gloss`  [ "landing", "descending", "falling" ],

    -- ;; mahobuwT_1
    -- mhbwT   mahobuwT        Nall    emaciated;worn out     [[mahobuwT/ADJ]]

    noun     MaFCUL                    {- mahobuwT -}       `gloss`  [ "emaciated", "worn out" ] ]
 ...
 |> "hbl" <| [
    ...
    verb     FaCiL                     {- habil-a -}        `imperf` [ FCaL ]
                                                            `others` [ "habil PV_intr", "hbal IV_intr" ]
 ...
 |> "hiball" <| [
    ...
    noun     FaCIL                     {- habiyl -}         `gloss`  [ "fool", "dolt" ],
    ...
    noun     HaFCaL                    {- >ahobal -}        `others` [ "hubl N", "hablA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "dim-witted", "imbecile", "imbeciles" ],
    ...
    noun     MaFCaL |< Iy              {- mahobaliy~ -}     `gloss`  [ "vaginal" ],
    ...
    noun     MaFCUL                    {- mahobuwl -}       `gloss`  [ "fool", "imbecile" ] ]
 ...
 |> "hbhb" <| [
    ...
    verb     FaCCaL                    {- habohab -}        `others` [ "habhib IV_yu" ]
                                                            `gloss`  [ "bark", "howl" ],

    -- ;; habohAb_1
    -- hbhAb   habohAb Ndu     mirage

    noun     FaCCAL                    {- habohAb -}        `gloss`  [ "mirage" ],

    -- ;; habohAb_2
    -- hbhAb   habohAb Nall    nimble

    noun     FaCCAL                    {- habohAb -}        `gloss`  [ "nimble" ] ]
 ...
 |> "hb" <| [
    ...
    verb     FaCA                      {- habA-u -}         `imperf` [ FCuL ]
                                                            `others` [ "habaw PV_Atn", "hb IV_0hwnyn", "hab PV_ttAw", "habA PV_0", "hbuw IV_0hAnn" ]
 ...
 |> "hbw" <| [
    ...
    noun     FaCL |< aT                {- habowap -}        `others` [ "habaw NAt", "habw Napdu" ]
 ...
 |> "htr" <| [
    ...
    verb     HaFCaL                    {- >ahotar -}        `others` [ "htir IV_intr_yu" ]
                                                            `gloss`  [ "become senile" ],
    ...
    noun     MuFACaL |< aT             {- muhAtarap -}      `others` [ "muhAtar Nap" ]
                                                            `gloss`  [ "revilement", "insult" ],
    ...
    noun     MuFCaL                    {- muhotar -}        `gloss`  [ "driveling", "senile" ],

    -- ;; musotahotir_1
    -- msthtr  musotahotir     Nall    reckless;irresponsible     [[musotahotir/ADJ]]

    noun     MustaFCiL                 {- musotahotir -}    `gloss`  [ "reckless", "irresponsible" ],

    -- ;; musotahotar_1
    -- msthtr  musotahotar     Nall    infatuated     [[musotahotar/ADJ]]

    noun     MustaFCaL                 {- musotahotar -}    `gloss`  [ "infatuated" ] ]
 ...
 |> "hAtuwr" <| [
    ...
    noun     Identity                  {- hAtuwr -}         `gloss`  [ "Hator ( 3rd Coptic month , Nov. 10-Dec. 9 )" ] ]
 ...
 |> "htf" <| [
    ...
    noun     FaCL |< aT                {- hatofap -}        `others` [ "hatf Nap" ]
                                                            `gloss`  [ "shout", "call" ] ]
 ...
 |> "hutAf" <| [
    ...
    noun     Identity                  {- hutAf -}          `gloss`  [ "shouting", "cheering", "shouts" ],
    ...
    noun     FACiL |< Iy               {- hAtifiy~ -}       `gloss`  [ "telephone", "telephonic", "by phone" ] ]
 ...
 |> "htk" <| [
    ...
    noun     FaCIL |< aT               {- hatiykap -}       `others` [ "hatiyk Nap" ]
    ...
    noun     MutaFaCCiL                {- mutahat~ik -}     `gloss`  [ "impudent", "shameless" ],

    -- ;; musotahotik_1
    -- msthtk  musotahotik     Nall    impudent;shameless     [[musotahotik/ADJ]]

    noun     MustaFCiL                 {- musotahotik -}    `gloss`  [ "impudent", "shameless" ] ]
 ...
 |> "hutAm" <| [
    ...
    noun     Identity |< aT            {- hutAmap -}        `others` [ "hutAm Nap" ]
                                                            `gloss`  [ "fragment" ],
    ...
    noun     HaFCaL                    {- >ahotam -}        `others` [ "hutm N", "hatmA' Nh Nhy N0_Nh" ]
 ...
 |> "htmr" <| [
    ...
    noun     FaCCaL |< aT              {- hatomarap -}      `others` [ "hatmar Nap" ]
                                                            `gloss`  [ "loquaciousness", "garrulousness", "logorrhea" ] ]
 ...
 |> "h^g^g" <| [
    ...
    verb     FaCL                      {- haj~-u -}         `imperf` [ FCuL ]
                                                            `others` [ "hu^g^g IV_V", "ha^ga^g PV_C", "ha^g^g PV_V", "h^gu^g IV_C" ]
 ...
 |> "h^g'" <| [
    ...
    verb     FaCaL                     {- haja>-a -}        `imperf` [ FCaL ]
                                                            `others` [ "ha^ga'A PV-|_intr", "ha^ga' PV->_intr PV_w_intr", "h^ga'A IV-|", "h^ga' IV IV_wn IV_yn" ]
    ...
    verb     HaFCaL                    {- >ahoja> -}        `others` [ "'ah^ga'A PV-|", "h^ga' IV_Pass_yu", "h^gi' IV_yu" ]
 ...
 |> "h^gr" <| [
    ...
    verb     HaFCaL                    {- >ahojar -}        `others` [ "h^gar IV_Pass_yu", "h^gir IV_yu" ]
    ...
    noun     FiCL |< aT                {- hijorap -}        `others` [ "hi^gr Nap" ]
                                                            `gloss`  [ "emigration", "exodus", "Hegira" ],

    -- ;; hijoriy~_1
    -- hjry    hijoriy~        N-ap    Hijri;Hegira (calendar)     [[hijoriy~/ADJ]]

    noun     FiCL |< Iy                {- hijoriy~ -}       `gloss`  [ "Hijri", "Hegira ( calendar )" ] ]
 ...
 |> "h^gr'" <| [
    ...
    noun     FaCCAL                    {- hajorA' -}        `others` [ "hawA^gir Ndip" ]
 ...
 |> "h^gr" <| [
    ...
    noun     FaCIL |< aT               {- hajiyrap -}       `others` [ "ha^giyr Nap" ]
                                                            `gloss`  [ "midday heat", "noon" ],
    ...
    noun     MaFCaL |< Iy              {- mahojariy~ -}     `gloss`  [ "exiled", "living overseas" ] ]
 ...
 |> "mahA^gir" <| [
    ...
    noun     Identity                  {- mahAjir -}        `gloss`  [ "obscenities" ],
    ...
    noun     MuFACaL |< aT             {- muhAjarap -}      `others` [ "muhA^gar NapAt" ]
                                                            `gloss`  [ "emigration" ],

    -- ;; hAjirap_1
    -- hAjr    hAjir   Nap     noon;meridian

    noun     FACiL |< aT               {- hAjirap -}        `others` [ "hA^gir Nap" ]
                                                            `gloss`  [ "noon", "meridian" ],

    -- ;; hAjiriy~_1
    -- hAjry   hAjiriy~        N-ap    meridional;outstanding     [[hAjiriy~/ADJ]]

    noun     FACiL |< Iy               {- hAjiriy~ -}       `gloss`  [ "meridional", "outstanding" ],
    ...
    noun     MaFCUL                    {- mahojuwr -}       `gloss`  [ "archaic" ],
 ...
 |> "h^gs" <| [
    ...
    verb     FaCaL                     {- hajas-ui -}       `imperf` [ FCuL, FCiL ]
                                                            `others` [ "h^gis IV", "ha^gas PV", "h^gus IV" ]
    ...
    noun     FaCL |< aT                {- hajosap -}        `others` [ "ha^gas NAt", "ha^gs Napdu" ]
 ...
 |> "h^g`" <| [
    ...
    verb     HaFCaL                    {- >ahojaE -}        `others` [ "h^ga` IV_Pass_yu", "h^gi` IV_yu" ]
                                                            `gloss`  [ "satiate", "appease", "be satiated", "be appeased" ],
    ...
    noun     FaCL |< aT                {- hajoEap -}        `others` [ "ha^g` Nap" ]
                                                            `gloss`  [ "sleep" ],
 ...
 |> "h^gm" <| [
    ...
    verb     HaFCaL                    {- >ahojam -}        `others` [ "h^gim IV_yu", "h^gam IV_Pass_yu" ]
    ...
    noun     FuCUL |< Iy               {- hujuwmiy~ -}      `gloss`  [ "offensive", "attack", "assault" ],

    -- ;; muhAjamap_1
    -- mhAjm   muhAjam NapAt   raid;attack;charge

    noun     MuFACaL |< aT             {- muhAjamap -}      `others` [ "muhA^gam NapAt" ]
                                                            `gloss`  [ "raid", "attack", "charge" ],
 ...
 |> "h^gn" <| [
    ...
    verb     FaCuL                     {- hajun-u -}        `imperf` [ FCuL ]
                                                            `others` [ "h^gun IV-n_intr", "ha^gun PV-n_intr" ]
                                                            `gloss`  [ "be incorrect" ],
    ...
    noun     FuCL |< aT                {- hujonap -}        `others` [ "hu^gn Nap" ]
                                                            `gloss`  [ "fault", "defect" ],
 ...
 |> "mahA^giyn" <| [
    ...
    noun     Identity                  {- mahAjiyn -}       `gloss`  [ "half-breeds", "mulattos" ] ]
 ...
 |> "mahA^gin" <| [
    ...
    noun     Identity                  {- mahAjin -}        `gloss`  [ "half-breeds", "mulattos" ],
    ...
    noun     FaCIL |< aT               {- hajiynap -}       `others` [ "ha^giyn Napdu", "ha^gA'in Ndip" ]
 ...
 |> "h^g" <| [
    ...
    verb     FaCA                      {- hajA-u -}         `imperf` [ FCuL ]
                                                            `others` [ "ha^g PV_ttAw", "h^gY IV_0_Pass_yu", "h^gay IV_Ann_Pass_yu", "ha^gaw PV_Atn", "h^guw IV_0hAnn", "h^g IV_0hwnyn", "ha^gA PV_0h" ]
 ...
 |> "h^gw" <| [
    ...
    noun     FaCL |< Iy                {- hajowiy~ -}       `gloss`  [ "defamatory", "disparaging" ] ]
 ...
 |> "h^g'" <| [
    ...
    noun     FiCAL |< Iy               {- hijA}iy~ -}       `gloss`  [ "satirical", "invective" ],

    -- ;; hijA}iy~_2
    -- hjA}y   hijA}iy~        N-ap    alphabetical     [[hijA}iy~/ADJ]]

    noun     FiCAL |< Iy               {- hijA}iy~ -}       `gloss`  [ "alphabetical" ] ]
 ...
 |> "'uh^guww" <| [
    ...
    noun     Identity |< aT            {- >uhojuw~ap -}     `others` [ "'uh^giyy Napdu", "'uh^guww Napdu", "'ahA^giyy N0_Nh" ]
                                                            `gloss`  [ "satirical poem", "lampoon", "satirical poems", "lampoons" ] ]
 ...
 |> "h^gy" <| [
    ...
    noun     TaFCiL |< aT              {- tahojiyap -}      `others` [ "tah^giy Nap" ]
                                                            `gloss`  [ "spelling" ] ]
 ...
 |> "taha^g^giy" <| [
    ...
    noun     Identity                  {- tahaj~iy -}       `others` [ "taha^g^g NK" ]
                                                            `gloss`  [ "spelling" ],
 ...
 |> "hdd" <| [
    ...
    verb     FaCL                      {- had~-i -}         `imperf` [ FCiL ]
                                                            `others` [ "hadd PV_V_intr", "hdid IV_C_intr", "hadad PV_C_intr", "hidd IV_V_intr" ]
    ...
    verb     FaCL                      {- had~-u -}         `imperf` [ FCuL ]
                                                            `others` [ "hadd PV_V", "hudd IV_V", "hadad PV_C", "hdud IV_C" ]
    ...
    noun     FaCL |< aT                {- had~ap -}         `others` [ "hadd Nap" ]
                                                            `gloss`  [ "thud", "crash" ],
 ...
 |> "hadAdayk" <| [
    ...
    noun     Identity                  {- hadAdayok -}      `gloss`  [ "slowly !", "gently !" ] ]
 ...
 |> "mihadd" <| [
    ...
    noun     Identity |< aT            {- mihad~ap -}       `others` [ "mihadd Napdu" ]
                                                            `gloss`  [ "rock crusher", "jaw breaker" ],
    ...
    noun     TaFCIL |< Iy              {- tahodiydiy~ -}    `gloss`  [ "threatening", "menacing" ],
    ...
    noun     MaFCUL                    {- mahoduwd -}       `gloss`  [ "demolished", "wrecked" ],

    -- ;; muhad~id_1
    -- mhdd    muhad~id        Nall    threatening;menacing     [[muhad~id/ADJ]]

    noun     MuFaCCiL                  {- muhad~id -}       `gloss`  [ "threatening", "menacing" ],

    -- ;; muhad~ad_1
    -- mhdd    muhad~ad        Nall    threatened;intimidated     [[muhad~ad/ADJ]]

    noun     MuFaCCaL                  {- muhad~ad -}       `gloss`  [ "threatened", "intimidated" ] ]
 ...
 |> "hd'" <| [
    ...
    verb     FaCaL                     {- hada>-a -}        `imperf` [ FCaL ]
                                                            `others` [ "hda'A IV-|", "hda' IV IV_wn IV_yn", "hada' PV-> PV_w", "hada'A PV-|" ]
    ...
    verb     FaCCaL                    {- had~a> -}         `others` [ "hadda'A PV-|", "haddi' IV_yu" ]
    ...
    verb     HaFCaL                    {- >ahoda> -}        `others` [ "hdi' IV_yu", "'ahda'A PV-|", "hda' IV_Pass_yu" ]
    ...
    noun     HaFCaL                    {- >ahoda> -}        `others` [ "'ahda'A N-|" ]
                                                            `gloss`  [ "more / most quiet", "calmer / calmest", "most quiet", "calmest" ],

    -- ;; tahodi}ap_1
    -- thd}    tahodi} Nap     calming;appeasement

    noun     TaFCiL |< aT              {- tahodi}ap -}      `others` [ "tahdi' Nap" ]
                                                            `gloss`  [ "calming", "appeasement" ],
    ...
    noun     FACiL                     {- hAdi} -}          `gloss`  [ "calm", "quiet", "peaceful" ],
 ...
 |> "hdb" <| [
    ...
    noun     FuCCAL |< aT              {- hud~Abap -}       `others` [ "huddAb Napdu" ]
                                                            `gloss`  [ "fringe", "border" ] ]
 ...
 |> "hudA^g" <| [
    ...
    noun     Identity                  {- hudAj -}          `gloss`  [ "walking", "shuffling", "hobbling" ] ]
 ...
 |> "hwd^g" <| [
    ...
    noun     FaCCaL                    {- hawodaj -}        `others` [ "hawAdi^g Ndip" ]
 ...
 |> "hdr" <| [
    ...
    verb     FaCaL                     {- hadar-u -}        `imperf` [ FCuL ]
                                                            `others` [ "hdur IV_intr", "hadar PV_intr" ]
                                                            `gloss`  [ "be in vain" ],
    ...
    verb     HaFCaL                    {- >ahodar -}        `others` [ "hdar IV_Pass_yu", "hdir IV_yu" ]
    ...
    noun     FaCCAL                    {- had~Ar -}         `gloss`  [ "torrential", "swirling" ],

    -- ;; had~Arap_1
    -- hdAr    had~Ar  Nap     waterfall

    noun     FaCCAL |< aT              {- had~Arap -}       `others` [ "haddAr Nap" ]
                                                            `gloss`  [ "waterfall" ],
    ...
    noun     HiFCAL                    {- <ihodAr -}        `gloss`  [ "abandoning", "relinquishing" ],

    -- ;; hAdir_1
    -- hAdr    hAdir   Nall    raging;roaring     [[hAdir/ADJ]]

    noun     FACiL                     {- hAdir -}          `gloss`  [ "raging", "roaring" ],

    -- ;; mahoduwr_1
    -- mhdwr   mahoduwr        N-ap    squandered;unavenged     [[mahoduwr/ADJ]]

    noun     MaFCUL                    {- mahoduwr -}       `gloss`  [ "squandered", "unavenged" ],

    -- ;; muhodar_1
    -- mhdr    muhodar N-ap    void;invalid     [[muhodar/ADJ]]

    noun     MuFCaL                    {- muhodar -}        `gloss`  [ "void", "invalid" ] ]
 ...
 |> "hdr^g" <| [
    ...
    verb     FaCCaL                    {- hadoraj -}        `others` [ "hadri^g IV_yu" ]
                                                            `gloss`  [ "hydrogenate", "treat with hydrogen" ],

    -- ;; hadorajap_1
    -- hdrj    hadoraj Nap     hydrogenation

    noun     FaCCaL |< aT              {- hadorajap -}      `others` [ "hadra^g Nap" ]
                                                            `gloss`  [ "hydrogenation" ] ]
 ...
 |> "hdf" <| [
    ...
    verb     FaCaL                     {- hadaf-i -}        `imperf` [ FCiL ]
                                                            `others` [ "hdaf IV_Pass_yu", "hdif IV", "hadaf PV" ]
    ...
    verb     HaFCaL                    {- >ahodaf -}        `others` [ "hdaf IV_Pass_yu", "hdif IV_yu" ]
 ...
 |> "hdl" <| [
    ...
    noun     HaFCaL                    {- >ahodal -}        `others` [ "hudl N", "hadlA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "hanging loosely" ],

    -- ;; muhad~al_1
    -- mhdl    muhad~al        N-ap    hanging loosely     [[muhad~al/ADJ]]

    noun     MuFaCCaL                  {- muhad~al -}       `gloss`  [ "hanging loosely" ] ]
 ...
 |> "hdm" <| [
    ...
    noun     FaCL |< Iy                {- hadomiy~ -}       `gloss`  [ "destructive" ],

    -- ;; >ahodAm_1
    -- >hdAm   >ahodAm N       old clothes
    -- AhdAm   >ahodAm N       old clothes

    noun     HaFCAL                    {- >ahodAm -}        `gloss`  [ "old clothes" ],
    ...
    noun     FaCCAL                    {- had~Am -}         `gloss`  [ "destructive" ] ]
 ...
 |> "hudAm" <| [
    ...
    noun     Identity                  {- hudAm -}          `gloss`  [ "seasickness" ],
    ...
    noun     FACiL                     {- hAdim -}          `gloss`  [ "crushing", "destructive", "demolishing" ],

    -- ;; mahoduwm_1
    -- mhdwm   mahoduwm        N-ap    razed;demolished     [[mahoduwm/ADJ]]

    noun     MaFCUL                    {- mahoduwm -}       `gloss`  [ "razed", "demolished" ],

    -- ;; muhad~am_1
    -- mhdm    muhad~am        N-ap    razed;demolished     [[muhad~am/ADJ]]

    noun     MuFaCCaL                  {- muhad~am -}       `gloss`  [ "razed", "demolished" ],

    -- ;; mutahad~im_1
    -- mthdm   mutahad~im      N-ap    razed;demolished     [[mutahad~im/ADJ]]

    noun     MutaFaCCiL                {- mutahad~im -}     `gloss`  [ "razed", "demolished" ],

    -- ;; musotahodim_1
    -- msthdm  musotahodim     N-ap    dilapidated;in ruins     [[musotahodim/ADJ]]

    noun     MustaFCiL                 {- musotahodim -}    `gloss`  [ "dilapidated", "in ruins" ] ]
 ...
 |> "hdn" <| [
    ...
    noun     FuCL |< aT                {- hudonap -}        `others` [ "hudn NapAt" ]
                                                            `gloss`  [ "truce", "armistice" ],

    -- ;; hudonap_2
    -- hdn     hudon   NapAt   pause;intermission

    noun     FuCL |< aT                {- hudonap -}        `others` [ "hudn NapAt" ]
                                                            `gloss`  [ "pause", "intermission" ],

    -- ;; hidAnap_1
    -- hdAn    hidAn   Nap     truce;armistice

    noun     FiCAL |< aT               {- hidAnap -}        `others` [ "hidAn Nap" ]
                                                            `gloss`  [ "truce", "armistice" ],
    ...
    noun     MuFACaL |< aT             {- muhAdanap -}      `others` [ "muhAdan NapAt" ]
                                                            `gloss`  [ "conclusion of a truce", "truce negotiations" ] ]
 ...
 |> "hdhd" <| [
    ...
    verb     FaCCaL                    {- hadohad -}        `others` [ "hadhid IV_yu" ]
                                                            `gloss`  [ "dandle" ] ]
 ...
 |> "hudhud" <| [
    ...
    noun     Identity                  {- hudohud -}        `others` [ "hadAhid Ndip" ]
 ...
 |> "hd" <| [
    ...
    verb     FaCY                      {- hadaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "hdiy IV_0hAnn", "had PV_ttAw", "hd IV_0hwnyn", "hadA PV_h", "hdY IV_0_Pass_yu", "haday PV_Atn", "hadY PV_0" ]
    ...
    verb     HaFCY                     {- >ahodaY -}        `others` [ "hdiy IV_0hAnn_yu", "hd IV_0hwnyn_yu", "hday IV_Ann_Pass_yu", "'ahd PV_ttAw", "'ahday PV_Atn", "'ahdA PV_h", "hdY IV_0_Pass_yu" ]
 ...
 |> "hudY" <| [
    ...
    noun     Identity                  {- hudaY -}          `others` [ "hudA Nhy" ]
    ...
    noun     FaCL |< aT                {- hadoyap -}        `others` [ "hidy Nap", "hady Nap" ]
 ...
 |> "hd" <| [
    ...
    noun     CaL |< Iy |< aT           {- hadiy~ap -}       `others` [ "hadAyA N0_Nhy", "hadiyy Napdu" ]
 ...
 |> "hdy" <| [
    ...
    noun     FiCAL |< aT               {- hidAyap -}        `others` [ "hidAy NapAt" ]
                                                            `gloss`  [ "guidance" ] ]
 ...
 |> "hd" <| [
    ...
    noun     HaFCY                     {- >ahodaY -}        `others` [ "'ahday NAn_Nayn", "'ahdA Nhy" ]
    ...
    noun     HiFCA'                    {- <ihodA' -}        `gloss`  [ "presenting", "leading" ] ]
 ...
 |> "mahd" <| [
    ...
    noun     Identity |< Iy            {- mahodiy~ -}       `gloss`  [ "Mahdi" ] ]
 ...
 |> "mahd" <| [
    ...
    noun     Identity |< Iy            {- mahodiy~ -}       `gloss`  [ "rightly guided" ] ]
 ...
 |> "mahd" <| [
    ...
    noun     Identity |< Iy            {- mahodiy~ -}       `gloss`  [ "presented", "given" ] ]
 ...
 |> "hd" <| [
    ...
    noun     MuFCaNY                   {- muhodaY -}        `others` [ "muhdA Napdu", "muhday NAt NAn_Nayn" ]
 ...
 |> "h_a_dA" <| [
    ...
    noun     Identity                  {- h`*A -}           `others` [ "h_a_diy FW-WaBi", "h_a'ulA'i FW-WaBi", "h_a_dihi FW-WaBi", "hAtAni FW-Wa", "h_a_dayni FW-WaBi", "hAtihi FW-WaBi", "h_a_dAni FW-Wa", "hAtayni FW-WaBi" ]
                                                            `gloss`  [ "this", "this / these", "these two", "these" ] ]
 ...
 |> "h_db" <| [
    ...
    noun     TaFCIL |< Iy              {- taho*iybiy~ -}    `gloss`  [ "educational", "didactic" ],
    ...
    noun     MuFaCCaL                  {- muha*~ab -}       `gloss`  [ "polite", "courteous" ],

    -- ;; mutaha*~ib_1
    -- mth*b   mutaha*~ib      Nall    polite;courteous     [[mutaha*~ib/ADJ]]

    noun     MutaFaCCiL                {- mutaha*~ib -}     `gloss`  [ "polite", "courteous" ] ]
 ...
 |> "h_dr" <| [
    ...
    verb     FaCaL                     {- ha*ar-ui -}       `imperf` [ FCuL, FCiL ]
                                                            `others` [ "h_dir IV", "ha_dar PV", "h_dur IV" ]
 ...
 |> "h_drm" <| [
    ...
    verb     FaCCaL                    {- ha*oram -}        `others` [ "ha_drim IV_yu" ]
 ...
 |> "hu_dluwl" <| [
    ...
    noun     Identity |< Iy            {- hu*oluwliy~ -}    `gloss`  [ "hyperbola" ] ]
 ...
 |> "h_d" <| [
    ...
    verb     FaCY                      {- ha*aY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "ha_d PV_ttAw", "ha_dY PV_0", "h_d IV_0hwnyn", "h_diy IV_0hAnn", "ha_day PV_Atn" ]
                                                            `gloss`  [ "be delirious" ] ]
 ...
 |> "hu_dA'" <| [
    ...
    noun     Identity                  {- hu*A' -}          `gloss`  [ "delirium" ] ]
 ...
 |> "hrr" <| [
    ...
    verb     FaCL                      {- har~-i -}         `imperf` [ FCiL ]
                                                            `others` [ "hirr IV_V", "hrir IV_C", "harar PV_C", "harr PV_V" ]
    ...
    noun     FiCL |< aT                {- hir~ap -}         `others` [ "hirr Napdu", "hirar N" ]
    ...
    noun     FuCayL |< aT              {- hurayorap -}      `others` [ "hurayr Napdu" ]
                                                            `gloss`  [ "kitten" ] ]
 ...
 |> "hr'" <| [
    ...
    verb     FaCaL                     {- hara>-a -}        `imperf` [ FCaL ]
                                                            `others` [ "hra' IV IV_wn IV_yn", "hra'A IV-|", "hara' PV-> PV_w", "hara'A PV-|" ]
    ...
    verb     FaCCaL                    {- har~a> -}         `others` [ "harra'A PV-|", "harri' IV_yu" ]
                                                            `gloss`  [ "tear", "wear out" ],
    ...
    verb     TaFaCCaL                  {- tahar~a> -}       `others` [ "taharra'A PV-|_intr IV-|" ]
    ...
    verb     IFtaCaL                   {- {ihotara> -}      `others` [ "htari' IV_intr", "ihtara'A PV-|_intr" ]
                                                            `gloss`  [ "be tattered", "be worn out" ] ]
 ...
 |> "hurA'" <| [
    ...
    noun     Identity                  {- hurA' -}          `gloss`  [ "prattle", "idle talk" ],

    -- ;; mutahar~i}_1
    -- mthr}   mutahar~i}      N-ap    torn;tattered     [[mutahar~i}/ADJ]]

    noun     MutaFaCCiL                {- mutahar~i} -}     `gloss`  [ "torn", "tattered" ],

    -- ;; muhotari}_1
    -- mhtr}   muhotari}       N-ap    torn;tattered     [[muhotari}/ADJ]]

    noun     MuFtaCiL                  {- muhotari} -}      `gloss`  [ "torn", "tattered" ] ]
 ...
 |> "hrb" <| [
    ...
    verb     HaFCaL                    {- >ahorab -}        `others` [ "hrab IV_Pass_yu", "hrib IV_yu" ]
    ...
    noun     FACiL                     {- hArib -}          `gloss`  [ "fugitive", "runaway", "on the run" ],
 ...
 |> "hr^g" <| [
    ...
    verb     FaCaL                     {- haraj-i -}        `imperf` [ FCiL ]
                                                            `others` [ "hri^g IV_intr", "hara^g PV_intr" ]
 ...
 |> "hr^gl" <| [
    ...
    noun     FaCCaL |< aT              {- harojalap -}      `others` [ "har^gal Nap" ]
                                                            `gloss`  [ "chaos", "confusion", "muddle" ] ]
 ...
 |> "hrs" <| [
    ...
    noun     FaCIL |< aT               {- hariysap -}       `others` [ "hariys Nap" ]
                                                            `gloss`  [ "harisa ( hot chili paste )" ],
    ...
    noun     MaFCUL                    {- mahoruws -}       `gloss`  [ "mashed", "puree" ] ]
 ...
 |> "hirsik" <| [
    ...
    noun     Identity                  {- hirosik -}        `gloss`  [ "Herzegovina" ] ]
 ...
 |> "hr^s" <| [
    ...
    noun     MaFCUL                    {- mahoruw$ -}       `gloss`  [ "deteriorated", "battered" ] ]
 ...
 |> "hr.tq" <| [
    ...
    verb     FaCCaL                    {- haroTaq -}        `others` [ "har.tiq IV_intr_yu" ]
                                                            `gloss`  [ "become a heretic" ],

    -- ;; haroTaqap_1
    -- hrTq    haroTaq Nap     heresy

    noun     FaCCaL |< aT              {- haroTaqap -}      `others` [ "har.taq Nap" ]
                                                            `gloss`  [ "heresy" ],
    ...
    noun     FaCCUL |< Iy              {- haroTuwqiy~ -}    `others` [ "harA.tiq Nap" ]
                                                            `gloss`  [ "heretic", "heretics" ] ]
 ...
 |> "harA.tiq" <| [
    ...
    noun     Identity |< Iy            {- harATiqiy~ -}     `gloss`  [ "heretic" ] ]
 ...
 |> "hr`" <| [
    ...
    verb     HaFCaL                    {- >ahoraE -}        `others` [ "hri` IV_intr_yu" ]
                                                            `gloss`  [ "be hurried", "be rushed" ],
 ...
 |> "hurA`" <| [
    ...
    noun     Identity                  {- hurAE -}          `gloss`  [ "hurry", "haste" ] ]
 ...
 |> "hrq" <| [
    ...
    verb     HaFCaL                    {- >ahoraq -}        `others` [ "hriq IV_yu", "hraq IV_Pass_yu" ]
 ...
 |> "muhrAq" <| [
    ...
    noun     Identity                  {- muhorAq -}        `gloss`  [ "spilled", "poured out" ] ]
 ...
 |> "mahraqAn" <| [
    ...
    noun     HiFCAL                    {- <ihorAq -}        `gloss`  [ "spilling", "shedding" ],
 ...
 |> "hrm" <| [
    ...
    noun     FaCiL                     {- harim -}          `gloss`  [ "senile", "decrepit" ],
 ...
 |> "hrms" <| [
    ...
    verb     FaCCaL                    {- haromas -}        `others` [ "harmis IV_intr_yu" ]
 ...
 |> "hrhr" <| [
    ...
    verb     FaCCaL                    {- harohar -}        `others` [ "harhir IV_yu" ]
 ...
 |> "hr" <| [
    ...
    verb     FaCA                      {- harA-u -}         `imperf` [ FCuL ]
                                                            `others` [ "hruw IV_0hAnn", "haraw PV_Atn", "hray IV_Ann_Pass_yu", "hr IV_0hwnyn", "har PV_ttAw", "hrY IV_0_Pass_yu", "harA PV_0h" ]
 ...
 |> "hrw" <| [
    ...
    noun     FiCAL |< aT               {- hirAwap -}        `others` [ "hirAw NAt Napdu" ]
 ...
 |> "harAwiy" <| [
    ...
    noun     Identity                  {- harAwiy -}        `gloss`  [ "Hrawi" ] ]
 ...
 |> "harAT" <| [
    ...
    noun     Identity                  {- harAp -}          `others` [ "harA Nap" ]
                                                            `gloss`  [ "Herat ( Afgh . )" ],

    -- ;; harawiy~_1
    -- hrwy    harawiy~        Nall    of/from Herat (Afgh.)     [[harawiy~/ADJ]]

    noun     FaCaL |< Iy               {- harawiy~ -}       `gloss`  [ "of / from Herat ( Afgh . )" ] ]
 ...
 |> "hrwl" <| [
    ...
    verb     FaCCaL                    {- harowal -}        `others` [ "harwil IV_yu" ]
                                                            `gloss`  [ "walk fast", "hurry" ],

    -- ;; harowalap_1
    -- hrwl    harowal Nap     quick pace;haste

    noun     FaCCaL |< aT              {- harowalap -}      `others` [ "harwal Nap" ]
                                                            `gloss`  [ "quick pace", "haste" ],

    -- ;; muharowil_1
    -- mhrwl   muharowil       Nall    hurrying;in a hurry     [[muharowil/ADJ]]

    noun     MuFaCCiL                  {- muharowil -}      `gloss`  [ "hurrying", "in a hurry" ] ]
 ...
 |> "hry" <| [
    ...
    noun     FACiL                     {- hAriy -}          `others` [ "hAr Nuwn_Niyn NK" ]
                                                            `gloss`  [ "unsteady", "tottering", "reeling" ] ]
 ...
 |> "hzz" <| [
    ...
    verb     FaCL                      {- haz~-u -}         `imperf` [ FCuL ]
                                                            `others` [ "hazaz PV_C", "hzuz IV_C", "huzz IV_V", "hazz PV_V" ]
    ...
    noun     FaCL |< aT                {- haz~ap -}         `others` [ "hazz NapAt" ]
                                                            `gloss`  [ "tremor", "shock", "vibration" ],
 ...
 |> "mahazz" <| [
    ...
    noun     Identity |< aT            {- mahaz~ap -}       `others` [ "mahazz Nap" ]
                                                            `gloss`  [ "excitement", "agitation" ],
    ...
    noun     IFtiCAL |< aT             {- {ihotizAzap -}    `others` [ "ihtizAz NapAt" ]
                                                            `gloss`  [ "tremor", "convulsion", "vibration" ],

    -- ;; {ihotizAziy~_1
    -- <htzAzy {ihotizAziy~    N-ap    shock;tremor     [[{ihotizAziy~/ADJ]]
    -- AhtzAzy {ihotizAziy~    N-ap    shock;tremor     [[{ihotizAziy~/ADJ]]

    noun     IFtiCAL |< Iy             {- {ihotizAziy~ -}   `gloss`  [ "shock", "tremor" ],

    -- ;; mahozuwz_1
    -- mhzwz   mahozuwz        N-ap    shaky;shaken     [[mahozuwz/ADJ]]

    noun     MaFCUL                    {- mahozuwz -}       `gloss`  [ "shaky", "shaken" ],

    -- ;; muhotaz~_1
    -- mhtz    muhotaz~        Nall    trembling;shaking;quivering     [[muhotaz~/ADJ]]

    noun     MuFtaCL                   {- muhotaz~ -}       `gloss`  [ "trembling", "shaking", "quivering" ] ]
 ...
 |> "hz'" <| [
    ...
    verb     FaCaL                     {- haza>-a -}        `imperf` [ FCaL ]
                                                            `others` [ "hza' IV IV_wn IV_yn", "hza'A IV-|", "haza'A PV-|", "haza' PV-> PV_w" ]
                                                            `gloss`  [ "scoff", "mock" ],
    ...
    verb     FaCiL                     {- hazi}-a -}        `imperf` [ FCaL ]
                                                            `others` [ "hza' IV IV_wn IV_yn", "hza'A IV-|", "hazi' PV" ]
                                                            `gloss`  [ "scoff", "mock" ],
    ...
    verb     TaFaCCaL                  {- tahaz~a> -}       `others` [ "tahazza'A IV-| PV-|" ]
                                                            `gloss`  [ "deride", "mock" ],
    ...
    verb     IstaFCaL                  {- {isotahoza> -}    `others` [ "istahza'A PV-|", "stahzi' IV" ]
                                                            `gloss`  [ "deride", "mock" ],
    ...
    noun     FuCuL                     {- huzu& -}          `gloss`  [ "derision", "contempt" ],

    -- ;; huzo}iy~_1
    -- hz}y    huzo}iy~        Nall    derisive;mocking     [[huzo}iy~/ADJ]]

    noun     FuCL |< Iy                {- huzo}iy~ -}       `gloss`  [ "derisive", "mocking" ],

    -- ;; huzo>ap_1
    -- hz>     huzo>   Napdu   object of ridicule;laughingstock

    noun     FuCL |< aT                {- huzo>ap -}        `others` [ "huz' Napdu" ]
                                                            `gloss`  [ "object of ridicule", "laughingstock" ] ]
 ...
 |> "huza'" <| [
    ...
    noun     Identity |< aT            {- huza>ap -}        `others` [ "huza' Nap" ]
                                                            `gloss`  [ "scoffer", "scorner", "mocker" ],

    -- ;; mahoza>ap_1
    -- mhz>    mahoza> Nap     derision;mockery

    noun     MaFCaL |< aT              {- mahoza>ap -}      `others` [ "mahza' Nap" ]
                                                            `gloss`  [ "derision", "mockery" ],
 ...
 |> "'uhzuw^g" <| [
    ...
    noun     Identity |< aT            {- >uhozuwjap -}     `others` [ "'uhzuw^g Napdu", "'ahAziy^g Ndip" ]
                                                            `gloss`  [ "song", "songs" ] ]
 ...
 |> "hzl" <| [
    ...
    verb     FaCaL                     {- hazal-i -}        `imperf` [ FCiL ]
                                                            `others` [ "hazal PV_intr", "hzil IV_intr", "hzal IV_Pass_yu" ]
    ...
    verb     FaCiL                     {- hazil-a -}        `imperf` [ FCaL ]
                                                            `others` [ "hzal IV_intr", "hazil PV_intr" ]
    ...
    verb     FaCaL                     {- hazal-u -}        `imperf` [ FCuL ]
                                                            `others` [ "hazal PV_intr", "hzul IV_intr" ]
                                                            `gloss`  [ "be emaciated", "lose weight" ],
    ...
    verb     HaFCaL                    {- >ahozal -}        `others` [ "hzil IV_yu", "hzal IV_Pass_yu" ]
    ...
    noun     FaCL |< Iy                {- hazoliy~ -}       `gloss`  [ "comical", "amusing" ],
 ...
 |> "huzAl" <| [
    ...
    noun     Identity                  {- huzAl -}          `gloss`  [ "emaciation" ],
    ...
    noun     FaCIL                     {- haziyl -}         `others` [ "hazlY N0", "hazlA Nhy" ]
                                                            `gloss`  [ "emaciated", "gaunt" ],

    -- ;; mahozalap_1
    -- mhzl    mahozal NapAt   comedy;farce
    -- mhAzl   mahAzil Ndip    comedies;farces

    noun     MaFCaL |< aT              {- mahozalap -}      `others` [ "mahAzil Ndip", "mahzal NapAt" ]
    ...
    noun     FACiL                     {- hAzil -}          `gloss`  [ "humorous", "comical" ],

    -- ;; mahozuwl_1
    -- mhzwl   mahozuwl        N/ap    emaciated;gaunt;weak     [[mahozuwl/ADJ]]

    noun     MaFCUL                    {- mahozuwl -}       `gloss`  [ "emaciated", "gaunt", "weak" ] ]
 ...
 |> "hzm" <| [
    ...
    noun     FaCIL |< aT               {- haziymap -}       `others` [ "hazA'im Ndip", "haziym Napdu" ]
    ...
    noun     InFiCAL |< Iy             {- {inohizAmiy~ -}   `gloss`  [ "defeatist" ],

    -- ;; {inohizAmiy~ap_1
    -- <nhzAmy {inohizAmiy~    Nap     defeatism     [[{inohizAmiy~/NOUN]]
    -- AnhzAmy {inohizAmiy~    Nap     defeatism     [[{inohizAmiy~/NOUN]]

    noun     InFiCAL |< Iy |< aT       {- {inohizAmiy~ap -} `others` [ "inhizAmiyy Nap" ]
                                                            `gloss`  [ "defeatism" ] ]
 ...
 |> "hzhz" <| [
    ...
    verb     FaCCaL                    {- hazohaz -}        `others` [ "hazhiz IV_yu" ]
    ...
    verb     TaFaCCaL                  {- tahazohaz -}      `gloss`  [ "be shaken", "be convulsed" ],

    -- ;; hazohazap_1
    -- hzhz    hazohaz Napdu   agitation;tremor;shock
    -- hzAhz   hazAhiz Ndip    tremors;shocks

    noun     FaCCaL |< aT              {- hazohazap -}      `others` [ "hazAhiz Ndip", "hazhaz Napdu" ]
    ...
    noun     FaCCaL |< aT              {- hazohazap -}      `others` [ "hazAhiz Ndip", "hazhaz Nap" ]
 ...
 |> "hss" <| [
    ...
    verb     FaCL                      {- has~-i -}         `imperf` [ FCiL ]
                                                            `others` [ "hsis IV_C", "hiss IV_V", "hasas PV_C", "hass PV_V" ]
                                                            `gloss`  [ "whisper" ],
 ...
 |> "hstr" <| [
    ...
    noun     FiCCIL |< Iy              {- hisotiyriy~ -}    `others` [ "hiystiyriyy Nall" ]
                                                            `gloss`  [ "hysterical" ] ]
 ...
 |> "h^s^s" <| [
    ...
    verb     FaCL                      {- ha$~-iu -}        `imperf` [ FCiL, FCuL ]
                                                            `others` [ "ha^s^s PV_V_intr", "hu^s^s IV_V_intr", "hi^s^s IV_V_intr", "ha^sa^s PV_C_intr", "h^su^s IV_C_intr", "h^si^s IV_C_intr" ]
    ...
    noun     FaCAL |< aT               {- ha$A$ap -}        `others` [ "ha^sA^s Nap" ]
                                                            `gloss`  [ "cheerfulness", "gaiety" ] ]
 ...
 |> "hA^s^s" <| [
    ...
    noun     Identity                  {- hA$~ -}           `gloss`  [ "cheerful" ] ]
 ...
 |> "h^sm" <| [
    ...
    noun     FaCIL                     {- ha$iym -}         `gloss`  [ "fragile", "frail" ],
    ...
    noun     FACiL |< Iy               {- hA$imiy~ -}       `gloss`  [ "Hashemite" ],
    ...
    noun     MuFaCCaL                  {- muha$~am -}       `gloss`  [ "smashed", "shattered" ] ]
 ...
 |> "h.s.s" <| [
    ...
    verb     FaCL                      {- haS~-u -}         `imperf` [ FCuL ]
                                                            `others` [ "hu.s.s IV_V", "ha.sa.s PV_C", "h.su.s IV_C", "ha.s.s PV_V" ]
                                                            `gloss`  [ "trample" ],
 ...
 |> "h.db" <| [
    ...
    verb     FaCaL                     {- haDab-i -}        `imperf` [ FCiL ]
                                                            `others` [ "h.dib IV_intr", "ha.dab PV_intr" ]
                                                            `gloss`  [ "be verbose" ],
    ...
    noun     FaCL |< aT                {- haDobap -}        `others` [ "hi.dAb N", "ha.db Napdu" ]
 ...
 |> "h.dm" <| [
    ...
    noun     FaCL |< Iy                {- haDomiy~ -}       `gloss`  [ "digestive", "alimentary" ],
    ...
    noun     FaCIL                     {- haDiym -}         `gloss`  [ "slender", "slim" ],

    -- ;; haDiymap_1
    -- hDym    haDiym  Nap     injustice;encroachment

    noun     FaCIL |< aT               {- haDiymap -}       `others` [ "ha.diym Nap" ]
                                                            `gloss`  [ "injustice", "encroachment" ],
    ...
    noun     MaFCUL                    {- mahoDuwm -}       `gloss`  [ "oppressed", "outraged" ],

    -- ;; mahoDuwm_2
    -- mhDwm   mahoDuwm        Nall    digestible     [[mahoDuwm/ADJ]]

    noun     MaFCUL                    {- mahoDuwm -}       `gloss`  [ "digestible" ] ]
 ...
 |> "h.t`" <| [
    ...
    verb     HaFCaL                    {- >ahoTaE -}        `others` [ "h.ti` IV_yu" ]
 ...
 |> "hy.tl" <| [
    ...
    noun     FaCCaL                    {- hayoTal -}        `others` [ "hayA.til Nap Ndip" ]
                                                            `gloss`  [ "fox", "foxes" ] ]
 ...
 |> "hff" <| [
    ...
    verb     FaCL                      {- haf~-i -}         `imperf` [ FCiL ]
                                                            `others` [ "haff PV_V", "hiff IV_V", "hafaf PV_C", "hfif IV_C" ]
                                                            `gloss`  [ "howl", "yearn" ],
 ...
 |> "mihaff" <| [
    ...
    noun     Identity                  {- mihaf~ -}         `gloss`  [ "fan", "feather duster" ],

    -- ;; mahofuwf_1
    -- mhfwf   mahofuwf        Nall    light-headed;irresponsible     [[mahofuwf/ADJ]]

    noun     MaFCUL                    {- mahofuwf -}       `gloss`  [ "light-headed", "irresponsible" ] ]
 ...
 |> "hft" <| [
    ...
    noun     FACiL                     {- hAfit -}          `gloss`  [ "erroneous", "wrong" ],

    -- ;; mahofuwt_1
    -- mhfwt   mahofuwt        Nall    baffled;startled;perplexed     [[mahofuwt/ADJ]]

    noun     MaFCUL                    {- mahofuwt -}       `gloss`  [ "baffled", "startled", "perplexed" ] ]
 ...
 |> "hfhf" <| [
    ...
    verb     FaCCaL                    {- hafohaf -}        `others` [ "hafhif IV_intr_yu" ]
    ...
    verb     TaFaCCaL                  {- tahafohaf -}      `gloss`  [ "be slender", "be slim" ],

    -- ;; hafohafap_1
    -- hfhf    hafohaf Nap     whispering of the wind

    noun     FaCCaL |< aT              {- hafohafap -}      `others` [ "hafhaf Nap" ]
                                                            `gloss`  [ "whispering of the wind" ],

    -- ;; hafohAf_1
    -- hfhAf   hafohAf Nall    slender;fluttering

    noun     FaCCAL                    {- hafohAf -}        `gloss`  [ "slender", "fluttering" ],

    -- ;; muhafohaf_1
    -- mhfhf   muhafohaf       N-ap    slender;slim     [[muhafohaf/ADJ]]

    noun     MuFaCCaL                  {- muhafohaf -}      `gloss`  [ "slender", "slim" ] ]
 ...
 |> "hf" <| [
    ...
    verb     FaCA                      {- hafA-u -}         `imperf` [ FCuL ]
                                                            `others` [ "hf IV_0hwnyn", "hafA PV_0", "hafaw PV_Atn", "hfuw IV_0hAnn", "haf PV_ttAw" ]
 ...
 |> "hfw" <| [
    ...
    noun     FaCL |< aT                {- hafowap -}        `others` [ "hafw Napdu", "hafaw NAt" ]
 ...
 |> "hktr" <| [
    ...
    noun     FiCCAL                    {- hikotAr -}        `gloss`  [ "hectare" ] ]
 ...
 |> "'uhkuwm" <| [
    ...
    noun     Identity |< aT            {- >uhokuwmap -}     `others` [ "'uhkuwm Nap" ]
                                                            `gloss`  [ "derision", "mockery" ],
    ...
    noun     TaFaCCuL |< Iy            {- tahak~umiy~ -}    `gloss`  [ "sarcastic", "scornful" ],

    -- ;; mutahak~im_1
    -- mthkm   mutahak~im      Nall    sarcastic;scornful     [[mutahak~im/ADJ]]

    noun     MutaFaCCiL                {- mutahak~im -}     `gloss`  [ "sarcastic", "scornful" ] ]
 ...
 |> "hl" <| [
    ...
    noun     CaL                       {- hal -}            `gloss`  [ "does / do ?", "did ?", "is / are ?" ] ]
 ...
 |> "hallA" <| [
    ...
    noun     Identity                  {- hal~A -}          `gloss`  [ "does n't / do n't ?", "did n't ?", "is n't / are n't ?" ] ]
 ...
 |> "hll" <| [
    ...
    verb     FaCL                      {- hal~-i -}         `imperf` [ FCiL ]
                                                            `others` [ "hlil IV_C", "hill IV_V", "hall PV_V", "halal PV_C" ]
                                                            `gloss`  [ "begin", "appear" ],
    ...
    verb     HaFaCL                    {- >ahal~ -}         `others` [ "hlil IV_C_yu", "hill IV_V_yu", "hall IV_V_Pass_yu", "'ahlal PV_C" ]
    ...
    noun     FaCaL |< aT               {- halalap -}        `others` [ "halal NapAt" ]
                                                            `gloss`  [ "halala ( 1 / 100 of a Saudi riyal )" ],
    ...
    noun     FiCAL |< Iy               {- hilAliy~ -}       `gloss`  [ "crescent-shaped", "lunar" ],

    -- ;; hilAliy~_2
    -- hlAly   hilAliy~        Nall    Hilal fans     [[hilAliy~/NOUN]]
    -- hlAly   hilAliy~        Nall    Hilal fans     [[hilAliy~/ADJ]]

    noun     FiCAL |< Iy               {- hilAliy~ -}       `gloss`  [ "Hilal fans" ],
    ...
    noun     IstiFCAL |< Iy            {- {isotiholAliy~ -} `gloss`  [ "introductory", "opening", "initial" ],

    -- ;; muhal~al_1
    -- mhll    muhal~al        N-ap    crescent-shaped;lunar     [[muhal~al/ADJ]]

    noun     MuFaCCaL                  {- muhal~al -}       `gloss`  [ "crescent-shaped", "lunar" ],

    -- ;; mutahal~il_1
    -- mthll   mutahal~il      Nall    jubilant;rejoicing     [[mutahal~il/ADJ]]

    noun     MutaFaCCiL                {- mutahal~il -}     `gloss`  [ "jubilant", "rejoicing" ],
 ...
 |> "hlb" <| [
    ...
    verb     FaCiL                     {- halib-a -}        `imperf` [ FCaL ]
                                                            `others` [ "hlab IV_intr", "halib PV_intr" ]
                                                            `gloss`  [ "be hirsute" ],
    ...
    noun     HaFCaL                    {- >aholab -}        `others` [ "hulb N", "halbA' Nh Nhy N0_Nh" ]
 ...
 |> "hulAb" <| [
    ...
    noun     Identity |< aT            {- hulAbap -}        `others` [ "hulAb Nap" ]
                                                            `gloss`  [ "lochia" ],

    -- ;; muhal~abiy~ap_1
    -- mhlby   muhal~abiy~     Nap     mahallabiya (rice pudding topped with pistachios)     [[muhal~abiy~/NOUN]]

    noun     MuFaCCaL |< Iy |< aT      {- muhal~abiy~ap -}  `others` [ "muhallabiyy Nap" ]
                                                            `gloss`  [ "mahallabiya ( rice pudding topped with pistachios )" ] ]
 ...
 |> "haliyla^g" <| [
    ...
    noun     Identity |< Iy            {- haliylajiy~ -}    `gloss`  [ "elliptical" ] ]
 ...
 |> "'ihliyla^g" <| [
    ...
    noun     Identity                  {- <iholiylaj -}     `gloss`  [ "ellipse" ] ]
 ...
 |> "'ihliyla^g" <| [
    ...
    noun     Identity |< Iy            {- <iholiylajiy~ -}  `gloss`  [ "elliptical" ] ]
 ...
 |> "'ihlayla^g" <| [
    ...
    noun     Identity                  {- <iholayolaj -}    `gloss`  [ "ellipse" ] ]
 ...
 |> "'ihlayla^g" <| [
    ...
    noun     Identity |< Iy            {- <iholayolajiy~ -} `gloss`  [ "elliptical" ] ]
 ...
 |> "hls" <| [
    ...
    verb     HaFCaL                    {- >aholas -}        `others` [ "hlis IV_yu", "hlas IV_Pass_yu" ]
 ...
 |> "hl`" <| [
    ...
    verb     FaCiL                     {- haliE-a -}        `imperf` [ FCaL ]
                                                            `others` [ "hla` IV_intr", "hali` PV_intr" ]
    ...
    noun     FaCUL                     {- haluwE -}         `gloss`  [ "impatient", "anxious", "dismayed" ] ]
 ...
 |> "hlft" <| [
    ...
    noun     FaCCUL                    {- halofuwt -}       `others` [ "halAfiyt Ndip" ]
 ...
 |> "hlqm" <| [
    ...
    verb     FaCCaL                    {- haloqam -}        `others` [ "halqim IV_yu" ]
 ...
 |> "hlk" <| [
    ...
    verb     HaFCaL                    {- >aholak -}        `others` [ "hlak IV_Pass_yu", "hlik IV_yu" ]
    ...
    noun     FaCL |< aT                {- halokap -}        `others` [ "halk Nap", "halak Nap" ]
    ...
    noun     MaFCaL |< aT              {- maholakap -}      `others` [ "mahluk Nap", "mahAlik Ndip", "mahlik Nap", "mahlak Nap" ]
 ...
 |> "tahluk" <| [
    ...
    noun     Identity |< aT            {- taholukap -}      `others` [ "tahluk Nap" ]
                                                            `gloss`  [ "ruin", "perilous situation" ],
    ...
    noun     IstiFCAL |< Iy            {- {isotiholAkiy~ -} `gloss`  [ "consumer" ],
    ...
    noun     FACiL                     {- hAlik -}          `others` [ "halkA Nhy", "hulAk N", "halkY N0", "hullak N" ]
                                                            `gloss`  [ "mortal", "perishable", "doomed" ],
    ...
    noun     MuFCiL                    {- muholik -}        `gloss`  [ "destructive", "fatal", "ruinous" ],
    ...
    noun     MustaFCaL                 {- musotaholak -}    `gloss`  [ "consumed", "used-up", "consumer goods" ] ]
 ...
 |> "halumma" <| [
    ...
    noun     Identity                  {- halum~a -}        `gloss`  [ "come on !" ] ]
 ...
 |> "hulAm" <| [
    ...
    noun     Identity                  {- hulAm -}          `gloss`  [ "gelatin", "jelly" ] ]
 ...
 |> "hulAm" <| [
    ...
    noun     Identity |< Iy            {- hulAmiy~ -}       `gloss`  [ "gelatinous", "jelly-like" ] ]
 ...
 |> "hlhl" <| [
    ...
    verb     FaCCaL                    {- halohal -}        `others` [ "halhil IV_yu" ]
    ...
    noun     FaCCaL                    {- halohal -}        `others` [ "hulAhil N-ap" ]
    ...
    noun     FaCCUL |< aT              {- halohuwlap -}     `others` [ "halhuwl Napdu", "halAhiyl Ndip" ]
                                                            `gloss`  [ "worn dress", "tatters", "worn dresses" ],

    -- ;; muhalohal_1
    -- mhlhl   muhalohal       N-ap    shabby;dilapidated;threadbare     [[muhalohal/ADJ]]

    noun     MuFaCCaL                  {- muhalohal -}      `gloss`  [ "shabby", "dilapidated", "threadbare" ] ]
 ...
 |> "hlws" <| [
    ...
    noun     FaCCaL |< aT              {- halowasap -}      `others` [ "halwas NapAt" ]
                                                            `gloss`  [ "hallucination", "vision" ],

    -- ;; muhalowis_1
    -- mhlws   muhalowis       Ndu     hallucinogen
    -- mhlws   muhalowis       NAt     hallucinogens

    noun     MuFaCCiL                  {- muhalowis -}      `gloss`  [ "hallucinogen", "hallucinogens" ],

    -- ;; muhalowis_2
    -- mhlws   muhalowis       N-ap    hallucinogenic     [[muhalowis/ADJ]]

    noun     MuFaCCiL                  {- muhalowis -}      `gloss`  [ "hallucinogenic" ] ]
 ...
 |> "hlyn" <| [
    ...
    noun     FaCCaL |< aT              {- haloyanap -}      `others` [ "halyan Nap" ]
                                                            `gloss`  [ "Hellenization" ] ]
 ...
 |> "hiliynist" <| [
    ...
    noun     Identity |< Iy            {- hiliynisotiy~ -}  `gloss`  [ "Hellenistic" ] ]
 ...
 |> "hm" <| [
    ...
    noun     CuL                       {- hum -}            `gloss`  [ "they [ masc.pl ]" ] ]
 ...
 |> "hmm" <| [
    ...
    verb     FaCL                      {- ham~-u -}         `imperf` [ FCuL ]
                                                            `others` [ "hmum IV_C", "hamam PV_C", "humm IV_V", "hamm PV_V" ]
    ...
    verb     HaFaCL                    {- >aham~ -}         `others` [ "'ahmam PV_C", "hmim IV_C_yu", "himm IV_V_yu", "hamm IV_V_Pass_yu" ]
    ...
    noun     FiCL |< aT                {- him~ap -}         `others` [ "himm Nap", "himam N" ]
 ...
 |> "mahamm" <| [
    ...
    noun     Identity |< aT            {- maham~ap -}       `others` [ "mahAmm Ndip", "mahamm NapAt" ]
    ...
    noun     TaFCIL |< aT              {- tahomiymap -}     `others` [ "tahmiym Napdu" ]
                                                            `gloss`  [ "lullaby" ],
 ...
 |> "hAmm" <| [
    ...
    noun     Identity                  {- hAm~ -}           `gloss`  [ "important", "significant" ],

    -- ;; mahomuwm_1
    -- mhmwm   mahomuwm        Nall    concerned;preoccupied;interested     [[mahomuwm/ADJ]]

    noun     MaFCUL                    {- mahomuwm -}       `gloss`  [ "concerned", "preoccupied", "interested" ],

    -- ;; muhim~_1
    -- mhm     muhim~  Nall    important;serious     [[muhim~/ADJ]]

    noun     MuFiCL                    {- muhim~ -}         `gloss`  [ "important", "serious" ],

    -- ;; muhim~ap_1
    -- mhm     muhim~  Napdu   important matter
    -- mhm     muhim~  NAt     equipment;material;supplies

    noun     MuFiCL |< aT              {- muhim~ap -}       `others` [ "muhimm NAt Napdu" ]
    ...
    noun     MuFtaCL                   {- muhotam~ -}       `gloss`  [ "interested", "concerned", "tasks", "functions", "duties" ] ]
 ...
 |> "humA" <| [
    ...
    noun     Identity                  {- humA -}           `gloss`  [ "they ( both )" ] ]
 ...
 |> "hm^g" <| [
    ...
    verb     FaCiL                     {- hamij-a -}        `imperf` [ FCaL ]
                                                            `others` [ "hma^g IV_intr", "hami^g PV_intr" ]
                                                            `gloss`  [ "be hungry" ],
    ...
    noun     FaCaL |< Iy               {- hamajiy~ -}       `gloss`  [ "rude", "uncivilized", "barbaric" ],

    -- ;; hamajiy~ap_1
    -- hmjy    hamajiy~        Nap     barbarism;rudeness     [[hamajiy~/NOUN]]

    noun     FaCaL |< Iy |< aT         {- hamajiy~ap -}     `others` [ "hama^giyy Nap" ]
                                                            `gloss`  [ "barbarism", "rudeness" ],

    -- ;; hAmij_1
    -- hAmj    hAmij   N-ap    voracious;ravenous     [[hAmij/ADJ]]

    noun     FACiL                     {- hAmij -}          `gloss`  [ "voracious", "ravenous" ] ]
 ...
 |> "hmd" <| [
    ...
    verb     HaFCaL                    {- >ahomad -}        `others` [ "hmid IV_yu", "hmad IV_Pass_yu" ]
    ...
    noun     FACiL                     {- hAmid -}          `gloss`  [ "calm", "quiet" ],

    -- ;; hAmid_2
    -- hAmd    hAmid   Nall    extinct;lifeless     [[hAmid/ADJ]]

    noun     FACiL                     {- hAmid -}          `gloss`  [ "extinct", "lifeless" ] ]
 ...
 |> "hmr" <| [
    ...
    verb     FaCaL                     {- hamar-ui -}       `imperf` [ FCuL, FCiL ]
                                                            `others` [ "hmir IV", "hamar PV", "hmur IV" ]
                                                            `gloss`  [ "pour", "shed" ],
    ...
    noun     FaCL |< aT                {- hamorap -}        `others` [ "hamr Nap" ]
                                                            `gloss`  [ "torrent", "shower" ],

    -- ;; munohamir_1
    -- mnhmr   munohamir       Nall    raining down;pouring down (in torrents)     [[munohamir/ADJ]]

    noun     MunFaCiL                  {- munohamir -}      `gloss`  [ "raining down", "pouring down ( in torrents )" ] ]
 ...
 |> "hmz" <| [
    ...
    verb     FaCaL                     {- hamaz-ui -}       `imperf` [ FCuL, FCiL ]
                                                            `others` [ "hmiz IV", "hmuz IV", "hamaz PV" ]
                                                            `gloss`  [ "prod", "prick" ],
    ...
    noun     FaCL |< aT                {- hamozap -}        `others` [ "hamz Napdu", "hamaz NAt" ]
 ...
 |> "hms" <| [
    ...
    noun     FaCL |< aT                {- hamosap -}        `others` [ "hamas NAt", "hams Napdu" ]
 ...
 |> "hawAmis" <| [
    ...
    noun     Identity                  {- hawAmis -}        `gloss`  [ "whispered words" ],

    -- ;; mahomuws_1
    -- mhmws   mahomuws        N-ap    muffled;whispered     [[mahomuws/ADJ]]

    noun     MaFCUL                    {- mahomuws -}       `gloss`  [ "muffled", "whispered" ] ]
 ...
 |> "hm^s" <| [
    ...
    noun     FACiL |< Iy               {- hAmi$iy~ -}       `gloss`  [ "peripheral", "marginal", "sidelined" ],

    -- ;; muham~a$_1
    -- mhm$    muham~a$        N-ap    annotated     [[muham~a$/ADJ]]

    noun     MuFaCCaL                  {- muham~a$ -}       `gloss`  [ "annotated" ] ]
 ...
 |> "hmk" <| [
    ...
    noun     MunFaCiL                  {- munohamik -}      `gloss`  [ "engrossed", "dedicated", "preoccupied" ] ]
 ...
 |> "hml" <| [
    ...
    verb     FaCaL                     {- hamal-ui -}       `imperf` [ FCuL, FCiL ]
                                                            `others` [ "hmul IV", "hamal PV", "hmil IV" ]
                                                            `gloss`  [ "shed tears" ],
    ...
    verb     HaFCaL                    {- >ahomal -}        `others` [ "hmal IV_Pass_yu", "hmil IV_yu" ]
    ...
    noun     HiFCAL                    {- <ihomAl -}        `gloss`  [ "neglect", "oversight", "carelessness" ],
    ...
    noun     MuFCiL                    {- muhomil -}        `gloss`  [ "negligent", "careless", "inattentive" ],

    -- ;; muhomal_1
    -- mhml    muhomal N-ap    neglected;overlooked;abandoned     [[muhomal/ADJ]]
    -- mhml    muhomal NAt     waste     [[muhomal/NOUN]]

    noun     MuFCaL                    {- muhomal -}        `gloss`  [ "neglected", "overlooked", "abandoned", "waste" ] ]
 ...
 |> "hml^g" <| [
    ...
    verb     FaCCaL                    {- hamolaj -}        `others` [ "hamli^g IV_yu" ]
                                                            `gloss`  [ "amble" ],
    ...
    noun     FiCCAL                    {- himolAj -}        `others` [ "hamAliy^g Ndip" ]
 ...
 |> "hmhm" <| [
    ...
    verb     FaCCaL                    {- hamoham -}        `others` [ "hamhim IV_yu" ]
                                                            `gloss`  [ "say `` ahem ''" ],
    ...
    noun     FaCCaL |< aT              {- hamohamap -}      `others` [ "hamAhim Ndip", "hamham NapAt" ]
 ...
 |> "hm" <| [
    ...
    verb     FaCA                      {- hamA-u -}         `imperf` [ FCuL ]
                                                            `others` [ "hamA PV_0", "hmuw IV_0hAnn", "ham PV_ttAw", "hm IV_0hwnyn", "hamaw PV_Atn" ]
                                                            `gloss`  [ "flow", "pour" ] ]
 ...
 |> "humAyuwn" <| [
    ...
    noun     Identity |< Iy            {- humAyuwniy~ -}    `gloss`  [ "imperial" ] ]
 ...
 |> "hunna" <| [
    ...
    noun     Identity                  {- hun~a -}          `gloss`  [ "they [ fem.pl . ]" ] ]
 ...
 |> "hnn" <| [
    ...
    verb     FaCL                      {- han~-i -}         `imperf` [ FCiL ]
                                                            `others` [ "hinn IV_V_intr", "hnin IV-n", "hanan PV_Cn_intr", "hann PV_V_intr" ]
 ...
 |> "hn'" <| [
    ...
    verb     FaCaL                     {- hana>-uia -}      `imperf` [ FCuL, FCiL, FCaL ]
                                                            `others` [ "hna'A IV-|", "hni' IV_intr", "hana'A PV-|_intr", "hnu' IV_intr", "hna' IV_wn IV_intr IV_yn", "hana' PV->_intr PV_w_intr" ]
    ...
    verb     TaFaCCaL                  {- tahan~a> -}       `others` [ "tahanna'A IV-| PV-|" ]
                                                            `gloss`  [ "enjoy", "savor" ],
    ...
    noun     FaCIL                     {- haniy' -}         `gloss`  [ "healthful", "beneficial", "pleasant" ],

    -- ;; haniy}_1
    -- hny}    haniy}  NF      bon appètit!     [[haniy}/ADV]]

    noun     FaCIL                     {- haniy} -}         `gloss`  [ "bon app_etit !" ],
    ...
    noun     TaFCiL |< aT              {- tahoni}ap -}      `others` [ "tahAniy N0_Nh", "tahAn NK", "tahni' Napdu", "tahAni' Ndip" ]
                                                            `gloss`  [ "congratulations", "greetings" ],

    -- ;; hAni}_1
    -- hAn}    hAni}   Nall    delighted;glad     [[hAni}/ADJ]]

    noun     FACiL                     {- hAni} -}          `gloss`  [ "delighted", "glad" ] ]
 ...
 |> "hn'" <| [
    ...
    noun     FACiL |< aT               {- hAni}ap -}        `others` [ "hAni' Napdu" ]
                                                            `gloss`  [ "servant girl", "maid" ],
 ...
 |> "hn" <| [
    ...
    noun     CaL |< Iy                 {- haniy~ -}         `gloss`  [ "pleasant", "delicious" ] ]
 ...
 |> "hanA^gir" <| [
    ...
    noun     Identity                  {- hanAjir -}        `gloss`  [ "Hanager" ] ]
 ...
 |> "hnd" <| [
    ...
    noun     FiCL |< Iy                {- hinodiy~ -}       `others` [ "hunuwd N" ]
                                                            `gloss`  [ "Indian", "Indians" ],

    -- ;; hinodiy~ap_1
    -- hndy    hinodiy~        Nap     Hindi     [[hinodiy~/NOUN]]

    noun     FiCL |< Iy |< aT          {- hinodiy~ap -}     `others` [ "hindiyy Nap" ]
                                                            `gloss`  [ "Hindi" ],
 ...
 |> "hndw" <| [
    ...
    noun     FiCCAL |< Iy              {- hinodAwiy~ -}     `gloss`  [ "Hindawi" ] ]
 ...
 |> "hndz" <| [
    ...
    noun     FiCCAL                    {- hinodAz -}        `gloss`  [ "measure" ],

    -- ;; hinodAzap_1
    -- hndAz   hinodAz Napdu   cubit

    noun     FiCCAL |< aT              {- hinodAzap -}      `others` [ "hindAz Napdu" ]
                                                            `gloss`  [ "cubit" ] ]
 ...
 |> "hnds" <| [
    ...
    noun     FaCCaL |< aT              {- hanodasap -}      `others` [ "handas Nap" ]
                                                            `gloss`  [ "engineering" ],

    -- ;; hanodasiy~_1
    -- hndsy   hanodasiy~      N-ap    engineering;technical     [[hanodasiy~/ADJ]]

    noun     FaCCaL |< Iy              {- hanodasiy~ -}     `gloss`  [ "engineering", "technical" ],

    -- ;; hinodAsap_1
    -- hndAs   hinodAs Napdu   cubit

    noun     FiCCAL |< aT              {- hinodAsap -}      `others` [ "hindAs Napdu" ]
                                                            `gloss`  [ "cubit" ],

    -- ;; muhanodis_1
    -- mhnds   muhanodis       Nall    engineer;technician

    noun     MuFaCCiL                  {- muhanodis -}      `gloss`  [ "engineer", "technician" ] ]
 ...
 |> "hinduws" <| [
    ...
    noun     Identity |< Iy            {- hinoduwsiy~ -}    `others` [ "hinduws N" ]
                                                            `gloss`  [ "Hindu", "Hindus" ] ]
 ...
 |> "hinduws" <| [
    ...
    noun     Identity |< Iy |< aT      {- hinoduwsiy~ap -}  `others` [ "hinduwsiyy Nap", "hinduwkiyy Nap" ]
                                                            `gloss`  [ "Hinduism" ] ]
 ...
 |> "hndm" <| [
    ...
    verb     FaCCaL                    {- hanodam -}        `others` [ "handim IV_yu" ]
    ...
    verb     TaFaCCaL                  {- tahanodam -}      `gloss`  [ "be arranged", "be adjusted" ],

    -- ;; hanodamap_1
    -- hndm    hanodam Nap     orderliness;neatness;harmony

    noun     FaCCaL |< aT              {- hanodamap -}      `others` [ "handam Nap" ]
                                                            `gloss`  [ "orderliness", "neatness", "harmony" ],

    -- ;; hinodAm_1
    -- hndAm   hinodAm N       orderliness;neatness;harmony

    noun     FiCCAL                    {- hinodAm -}        `gloss`  [ "orderliness", "neatness", "harmony" ],

    -- ;; muhanodam_1
    -- mhndm   muhanodam       Nall    orderly;neat;tidy     [[muhanodam/ADJ]]

    noun     MuFaCCaL                  {- muhanodam -}      `gloss`  [ "orderly", "neat", "tidy" ] ]
 ...
 |> "hinriy" <| [
    ...
    noun     Identity                  {- hinoriy -}        `gloss`  [ "Henry", "Henri" ] ]
 ...
 |> "han^siyr" <| [
    ...
    noun     Identity                  {- hano$iyr -}       `others` [ "hanA^siyr Ndip" ]
 ...
 |> "hn.gr" <| [
    ...
    noun     FuCCAL |< Iy              {- hunogAriy~ -}     `others` [ "hun^gAriyy Nall" ]
                                                            `gloss`  [ "Hungarian" ] ]
 ...
 |> "hawAnim" <| [
    ...
    noun     Identity |< Iy            {- hawAnimiy~ -}     `gloss`  [ "ladylike" ] ]
 ...
 |> "hnh" <| [
    ...
    noun     FuCayL |< aT              {- hunayohap -}      `others` [ "hunayh NapAt" ]
                                                            `gloss`  [ "instant", "moment", "little while" ] ]
 ...
 |> "hnhn" <| [
    ...
    verb     FaCCaL                    {- hanohan -}        `others` [ "hanhin IV-n_yu" ]
    ...
    noun     FaCCUL |< aT              {- hanohuwnap -}     `others` [ "hanhuwn NAt Napdu" ]
 ...
 |> "hn" <| [
    ...
    noun     CaL |< aT                 {- hanap -}          `others` [ "han NapAt", "hanaw NAt" ]
 ...
 |> "huwa" <| [
    ...
    noun     Identity                  {- huwa -}           `gloss`  [ "it / he" ] ]
 ...
 |> "mAhuwa" <| [
    ...
    noun     Identity                  {- mAhuwa -}         `gloss`  [ "what" ] ]
 ...
 |> "hw" <| [
    ...
    noun     CuL |< Iy |< aT           {- huwiy~ap -}       `others` [ "huwiyy NapAt" ]
                                                            `gloss`  [ "identity card", "identity" ] ]
 ...
 |> "hw" <| [
    ...
    noun     CuL                       {- huw -}            `gloss`  [ "Ho ( in `` Ho Chi Minh '' )" ] ]
 ...
 |> "huwbiy" <| [
    ...
    noun     Identity                  {- huwbiy -}         `gloss`  [ "Hobby" ] ]
 ...
 |> "huwbiyr" <| [
    ...
    noun     Identity                  {- huwbiyr -}        `gloss`  [ "Hubert" ] ]
 ...
 |> "hwt" <| [
    ...
    noun     FaCL |< aT                {- hawotap -}        `others` [ "huwat N", "huwt Napdu", "hawt Napdu" ]
 ...
 |> "huwtuw" <| [
    ...
    noun     Identity                  {- huwtuw -}         `gloss`  [ "Hutu" ] ]
 ...
 |> "hw^g" <| [
    ...
    noun     HaFCaL                    {- >ahowaj -}        `others` [ "haw^gA' Nh Nhy N0_Nh", "huw^g N" ]
 ...
 |> "hw^g'" <| [
    ...
    noun     FaCCAL                    {- hawojA' -}        `others` [ "huw^g N" ]
 ...
 |> "hd" <| [
    ...
    verb     FAL                       {- hAd-u -}          `imperf` [ FCuL ]
                                                            `others` [ "hud IV_C_intr PV_C_intr", "hAd PV_V_intr", "huwd IV_V_intr" ]
                                                            `gloss`  [ "be a Jew" ] ]
 ...
 |> "hwd" <| [
    ...
    noun     FaCAL |< aT               {- hawAdap -}        `others` [ "hawAd Nap" ]
                                                            `gloss`  [ "indulgence", "leniency" ],
    ...
    noun     MuFACaL |< aT             {- muhAwadap -}      `others` [ "muhAwad NapAt" ]
                                                            `gloss`  [ "moderation", "mitigation" ],
    ...
    noun     MutaFACiL                 {- mutahAwid -}      `gloss`  [ "moderate" ],
 ...
 |> "hr" <| [
    ...
    verb     FAL                       {- hAr-u -}          `imperf` [ FCuL ]
                                                            `others` [ "hur IV_C_intr PV_C_intr", "huwr IV_V_intr", "hAr PV_V_intr" ]
                                                            `gloss`  [ "collapse" ],
    ...
    verb     FAL                       {- hAr-u -}          `imperf` [ FCuL ]
                                                            `others` [ "hur PV_C IV_C", "huwr IV_V", "hAr PV_V" ]
                                                            `gloss`  [ "topple" ] ]
 ...
 |> "hwr" <| [
    ...
    noun     MutaFaCCiL                {- mutahaw~ir -}     `gloss`  [ "reckless", "foolhardy", "rash" ] ]
 ...
 |> "munhAr" <| [
    ...
    noun     Identity                  {- munohAr -}        `gloss`  [ "suffering a breakdown", "collapsing" ] ]
 ...
 |> "hwz" <| [
    ...
    noun     HaFCAL                    {- >ahowAz -}        `gloss`  [ "Ahwaz" ] ]
 ...
 |> "hws" <| [
    ...
    verb     FaCiL                     {- hawis-a -}        `imperf` [ FCaL ]
                                                            `others` [ "hwas IV_intr", "hawis PV_intr" ]
 ...
 |> "hws" <| [
    ...
    noun     FaCL |< aT                {- hawosap -}        `others` [ "haws Nap" ]
                                                            `gloss`  [ "clamor", "shouting", "uproar" ],
    ...
    noun     FaCaL |< Iy               {- hawasiy~ -}       `gloss`  [ "maniacal", "manic" ],
    ...
    noun     HaFCaL                    {- >ahowas -}        `gloss`  [ "foolish", "crazy", "dazzled" ],
    ...
    noun     MuFaCCaL                  {- muhaw~as -}       `gloss`  [ "foolish", "crazy", "dazzled" ],
 ...
 |> "h^s" <| [
    ...
    verb     FAL                       {- hA$-u -}          `imperf` [ FCuL ]
                                                            `others` [ "hu^s IV_C_intr PV_C_intr", "huw^s IV_V_intr", "hA^s PV_V_intr" ]
 ...
 |> "hw^s" <| [
    ...
    verb     FaCiL                     {- hawi$-a -}        `imperf` [ FCaL ]
                                                            `others` [ "hwa^s IV_intr", "hawi^s PV_intr" ]
                                                            `gloss`  [ "be excited", "be agitated" ],
    ...
    noun     FaCL |< aT                {- hawo$ap -}        `others` [ "haw^s Nap" ]
                                                            `gloss`  [ "uproar", "riot", "fracas" ],
 ...
 |> "huw^siy" <| [
    ...
    noun     Identity                  {- huw$iy -}         `gloss`  [ "Ho Chi" ] ]
 ...
 |> "h`" <| [
    ...
    verb     FAL                       {- hAE-ua -}         `imperf` [ FCuL, FCaL ]
                                                            `others` [ "ha` IV_C", "hA` PV_V IV_V", "huw` IV_V", "hu` PV_C IV_C", "hi` PV_C" ]
                                                            `gloss`  [ "vomit" ] ]
 ...
 |> "huw.guw" <| [
    ...
    noun     Identity                  {- huwguw -}         `gloss`  [ "Hugo" ] ]
 ...
 |> "huwkiy" <| [
    ...
    noun     Identity                  {- huwkiy -}         `gloss`  [ "hockey" ] ]
 ...
 |> "hwl" <| [
    ...
    noun     FaCL |< aT                {- hawolap -}        `others` [ "hawl Nap" ]
                                                            `gloss`  [ "terrifying thing", "object of fear" ],
 ...
 |> "h'l" <| [
    ...
    noun     FACiL                     {- hA}il -}          `gloss`  [ "huge", "formidable", "appalling" ] ]
 ...
 |> "hm" <| [
    ...
    noun     FAL |< aT                 {- hAmap -}          `others` [ "hAm NapAt" ]
                                                            `gloss`  [ "head", "vertex", "summit" ] ]
 ...
 |> "hn" <| [
    ...
    verb     FAL                       {- hAn-u -}          `imperf` [ FCuL ]
                                                            `others` [ "hun IV_C_intr", "hAn PV_V_intr", "huwn IV_V_intr" ]
 ...
 |> "hn" <| [
    ...
    verb     HaFAL                     {- >ahAn -}          `others` [ "hAn IV_V_Pass_yu", "hiyn IV_V_yu", "'ahan PV-n", "hin IV-n_yu IV-n_Pass_yu" ]
 ...
 |> "hwn" <| [
    ...
    noun     FaCL                      {- hawon -}          `gloss`  [ "leisure", "ease", "slowly", "leisurely" ],
 ...
 |> "hn" <| [
    ...
    noun     FIL |< aT                 {- hiynap -}         `others` [ "hiyn Nap" ]
                                                            `gloss`  [ "ease", "comfort", "leisure" ] ]
 ...
 |> "hayyin" <| [
    ...
    noun     Identity                  {- hay~in -}         `others` [ "'ahwinA' Nh Nhy N0_Nh", "hayn N-ap" ]
 ...
 |> "hwn" <| [
    ...
    noun     HaFCaL                    {- >ahowan -}        `others` [ "hawnA' Nh Nhy N0_Nh" ]
 ...
 |> "hyn" <| [
    ...
    noun     HaFCaL                    {- >ahoyan -}        `gloss`  [ "smaller / smallest", "lesser / least", "contemptible" ] ]
 ...
 |> "mahAn" <| [
    ...
    noun     Identity |< aT            {- mahAnap -}        `others` [ "mahAn Nap" ]
                                                            `gloss`  [ "contempt", "humiliation", "disgrace" ] ]
 ...
 |> "hn" <| [
    ...
    noun     HiFAL |< aT               {- <ihAnap -}        `others` [ "'ihAn NapAt" ]
                                                            `gloss`  [ "insult", "contempt" ] ]
 ...
 |> "hn" <| [
    ...
    noun     IstiFAL |< aT             {- {isotihAnap -}    `others` [ "istihAn NapAt" ]
                                                            `gloss`  [ "indifference", "contempt" ],

    -- ;; muhiyn_1
    -- mhyn    muhiyn  Nall    insulting;contemptuous     [[muhiyn/ADJ]]

    noun     MuFIL                     {- muhiyn -}         `gloss`  [ "insulting", "contemptuous" ] ]
 ...
 |> "hwn" <| [
    ...
    noun     MutaFACiL                 {- mutahAwin -}      `gloss`  [ "indifferent", "negligent" ] ]
 ...
 |> "hn" <| [
    ...
    noun     MustaFIL                  {- musotahiyn -}     `gloss`  [ "indifferent", "scornful" ] ]
 ...
 |> "hw" <| [
    ...
    verb     FaCY                      {- hawaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "hw IV_0hwnyn", "hwY IV_0_Pass_yu", "haway PV_Atn", "haw PV_ttAw", "hwiy IV_0hAnn", "hawA PV_h", "hawY PV_0" ]
 ...
 |> "hwy" <| [
    ...
    verb     FaCiL                     {- hawiy-a -}        `imperf` [ FCaL ]
                                                            `others` [ "hwA IV_h", "haw PV_w", "hwY IV_0", "hawiy PV_no-w", "hwa IV_0hwnyn", "hway IV_Ann" ]
                                                            `gloss`  [ "love", "like" ] ]
 ...
 |> "hw" <| [
    ...
    verb     HaFCY                     {- >ahowaY -}        `others` [ "'ahw PV_ttAw", "hw IV_0hwnyn_yu", "hwiy IV_0hAnn_yu", "hwY IV_0_Pass_yu", "'ahway PV_Atn", "'ahwA PV_h", "hway IV_Ann_Pass_yu" ]
 ...
 |> "hw" <| [
    ...
    noun     FUL |< aT                 {- huw~ap -}         `others` [ "huwA Nhy", "huww NapAt", "huwY N0" ]
    ...
    noun     CuL |< Iy                 {- huwiy~ -}         `gloss`  [ "fall", "tumble" ],
    ...
    noun     FaCA' |< Iy               {- hawA}iy~ -}       `gloss`  [ "antenna" ],

    -- ;; hawA}iy~_2
    -- hwA}y   hawA}iy~        N-ap    air;aerial;atmospheric     [[hawA}iy~/ADJ]]

    noun     FaCA' |< Iy               {- hawA}iy~ -}       `gloss`  [ "air", "aerial", "atmospheric" ] ]
 ...
 |> "hwy" <| [
    ...
    noun     FiCAL |< aT               {- hiwAyap -}        `others` [ "hiwAy NapAt" ]
                                                            `gloss`  [ "hobby", "passion" ],

    -- ;; haw~Ayap_1
    -- hwAy    haw~Ay  NapAt   ventilator;fan

    noun     FaCCAL |< aT              {- haw~Ayap -}       `others` [ "hawwAy NapAt" ]
                                                            `gloss`  [ "ventilator", "fan" ] ]
 ...
 |> "hw" <| [
    ...
    noun     HaFCY                     {- >ahowaY -}        `others` [ "'ahway NAn_Nayn", "'ahwA Nhy" ]
 ...
 |> "'uhw" <| [
    ...
    noun     Identity |< Iy |< aT      {- >uhowiy~ap -}     `others` [ "'uhwiyy Napdu" ]
                                                            `gloss`  [ "abyss", "chasm" ] ]
 ...
 |> "mahwY" <| [
    ...
    noun     Identity                  {- mahowaY -}        `others` [ "mahAwiy N0_Nh", "mahAw NK", "mahwA Napdu Nhy", "mahway NAn_Nayn" ]
 ...
 |> "mihwAT" <| [
    ...
    noun     Identity                  {- mihowAp -}        `others` [ "mihwA Napdu" ]
                                                            `gloss`  [ "ventilator", "fan" ] ]
 ...
 |> "hwy" <| [
    ...
    noun     TaFCiL |< aT              {- tahowiyap -}      `others` [ "tahwiy Nap" ]
                                                            `gloss`  [ "ventilation" ] ]
 ...
 |> "hwy" <| [
    ...
    noun     FACiL |< aT               {- hAwiyap -}        `others` [ "hAwiy Napdu" ]
 ...
 |> "hiya" <| [
    ...
    noun     Identity                  {- hiya -}           `gloss`  [ "it / they / she" ] ]
 ...
 |> "hayyA" <| [
    ...
    noun     Identity                  {- hay~A -}          `gloss`  [ "let 's go !" ] ]
 ...
 |> "hy'" <| [
    ...
    verb     FaCCaL                    {- hay~a> -}         `others` [ "hayyi' IV_wn_yu IV_yu" ]
    ...
    verb     FACaL                     {- hAya> -}          `others` [ "hAyi' IV_wn_yu IV_yu" ]
                                                            `gloss`  [ "agree with" ],
    ...
    verb     TaFaCCaL                  {- tahay~a> -}       `others` [ "tahayya'A IV-|" ]
    ...
    verb     TaFACaL                   {- tahAya> -}        `gloss`  [ "adapt to each other", "accommodate each other" ],
    ...
    noun     TaFaCCuL                  {- tahay~u& -}       `gloss`  [ "mobilization" ],

    -- ;; tahAyu&_1
    -- thAy&   tahAyu& NduAt   mutual adaptation;mutual adjustment
    -- thAy}   tahAyu} NduAt   mutual adaptation;mutual adjustment

    noun     TaFACuL                   {- tahAyu& -}        `gloss`  [ "mutual adaptation", "mutual adjustment" ],
    ...
    noun     MuFaCCaL                  {- muhay~a> -}       `others` [ "muhayya N-|t", "muhayya'A N-|" ]
                                                            `gloss`  [ "prepared" ] ]
 ...
 |> "hb" <| [
    ...
    verb     FAL                       {- hAb-a -}          `imperf` [ FCaL ]
                                                            `others` [ "hib PV_C", "hAb PV_V IV_V", "hab IV_C" ]
                                                            `gloss`  [ "fear", "respect" ] ]
 ...
 |> "hb" <| [
    ...
    verb     HaFAL                     {- >ahAb -}          `others` [ "'ahab PV_C", "hib IV_C_yu", "hAb IV_V_Pass_yu", "hab IV_C_Pass_yu", "hiyb IV_V_yu" ]
 ...
 |> "hyb" <| [
    ...
    noun     FaCL |< aT                {- hayobap -}        `others` [ "hayb Nap" ]
                                                            `gloss`  [ "fear", "respect" ],
 ...
 |> "mahAb" <| [
    ...
    noun     Identity                  {- mahAb -}          `gloss`  [ "object of reverence" ] ]
 ...
 |> "mahAb" <| [
    ...
    noun     Identity |< aT            {- mahAbap -}        `others` [ "mahAb Nap" ]
                                                            `gloss`  [ "fear", "respect" ],
 ...
 |> "hb" <| [
    ...
    noun     MaFIL                     {- mahiyb -}         `gloss`  [ "dreaded", "awful" ],

    -- ;; mahuwb_1
    -- mhwb    mahuwb  Nall    dreaded;awful     [[mahuwb/ADJ]]

    noun     MaFUL                     {- mahuwb -}         `gloss`  [ "dreaded", "awful" ],

    -- ;; muhiyb_1
    -- mhyb    muhiyb  Nall    awesome;dignified     [[muhiyb/ADJ]]

    noun     MuFIL                     {- muhiyb -}         `gloss`  [ "awesome", "dignified" ] ]
 ...
 |> "hyb" <| [
    ...
    noun     MutaFaCCiL                {- mutahay~ib -}     `gloss`  [ "fearful", "timorous" ] ]
 ...
 |> "hb" <| [
    ...
    noun     FIL |< Iy                 {- hiybiy~ -}        `others` [ "hibbiyy Nall" ]
                                                            `gloss`  [ "hippie" ] ]
 ...
 |> "hybz" <| [
    ...
    noun     FiCCIL                    {- hiybiyz -}        `others` [ "hibbiyz N0" ]
                                                            `gloss`  [ "hippies" ] ]
 ...
 |> "hayta" <| [
    ...
    noun     Identity                  {- hayota -}         `gloss`  [ "come here !" ],

    -- ;; hiyt_1
    -- hyt     hiyt    FW      Heat     [[hiyt/NOUN_PROP]]

    noun     FiCL                      {- hiyt -}           `gloss`  [ "Heat" ] ]
 ...
 |> "hy_tm" <| [
    ...
    noun     FaCCaL                    {- hayovam -}        `gloss`  [ "Haitham" ] ]
 ...
 |> "h^g" <| [
    ...
    verb     FAL                       {- hAj-i -}          `imperf` [ FCiL ]
                                                            `others` [ "hi^g IV_C_intr PV_C_intr", "hA^g PV_V_intr", "hiy^g IV_V_intr" ]
 ...
 |> "h^g" <| [
    ...
    verb     HaFAL                     {- >ahAj -}          `others` [ "ha^g IV_C_Pass_yu", "hi^g IV_C_yu", "'aha^g PV_C", "hA^g IV_V_Pass_yu", "hiy^g IV_V_yu" ]
 ...
 |> "hy^g'" <| [
    ...
    noun     FaCCAL                    {- hayojA' -}        `gloss`  [ "combat", "battle" ] ]
 ...
 |> "h'^g" <| [
    ...
    noun     FACiL                     {- hA}ij -}          `gloss`  [ "agitated", "furious", "raging" ] ]
 ...
 |> "hy^g" <| [
    ...
    noun     MuFaCCiL                  {- muhay~ij -}       `gloss`  [ "provoking", "inciting" ],
    ...
    noun     MutaFaCCiL                {- mutahay~ij -}     `gloss`  [ "agitated", "impassioned" ] ]
 ...
 |> "h^g" <| [
    ...
    noun     MuFtAL                    {- muhotAj -}        `gloss`  [ "agitated", "impassioned" ] ]
 ...
 |> "hiydruw^giyn" <| [
    ...
    noun     Identity |< Iy            {- hiydruwjiyniy~ -} `others` [ "haydruw^giyniyy Nall" ]
                                                            `gloss`  [ "hydrogen", "hydrogenous" ] ]
 ...
 |> "haydruwluw^g" <| [
    ...
    noun     Identity |< Iy            {- hayodruwluwjiy~ -} `gloss`  [ "hydrological" ] ]
 ...
 |> "haydruwluw^g" <| [
    ...
    noun     Identity |< Iy            {- hayodruwluwjiy~ -} `gloss`  [ "hydrologist" ] ]
 ...
 |> "haydruwliyk" <| [
    ...
    noun     Identity |< Iy            {- hayodruwliykiy~ -} `gloss`  [ "hydraulic" ] ]
 ...
 |> "hayyir" <| [
    ...
    noun     Identity                  {- hay~ir -}         `gloss`  [ "imprudent", "rash" ] ]
 ...
 |> "hiyrA.tiyq" <| [
    ...
    noun     Identity |< Iy            {- hiyrATiyqiy~ -}   `gloss`  [ "hieratic" ] ]
 ...
 |> "hiyruw.gliyf" <| [
    ...
    noun     Identity |< Iy            {- hiyruwgliyfiy~ -} `gloss`  [ "hieroglyphic" ] ]
 ...
 |> "h^s" <| [
    ...
    verb     FAL                       {- hA$-i -}          `imperf` [ FCiL ]
                                                            `others` [ "hi^s IV_C_intr PV_C_intr", "hiy^s IV_V_intr", "hA^s PV_V_intr" ]
                                                            `gloss`  [ "be agitated", "be excited" ],

    -- ;; hiy$_1
    -- hy$     hiy$    N       thicket;brush

    noun     FIL                       {- hiy$ -}           `gloss`  [ "thicket", "brush" ] ]
 ...
 |> "hy^s" <| [
    ...
    noun     FaCL |< aT                {- hayo$ap -}        `others` [ "hay^s Nap" ]
                                                            `gloss`  [ "turmoil", "excitement" ] ]
 ...
 |> "h.d" <| [
    ...
    verb     FAL                       {- hAD-i -}          `imperf` [ FCiL ]
                                                            `others` [ "hA.d PV_V_intr", "hiy.d IV_V_intr", "hi.d IV_C_intr PV_C_intr" ]
 ...
 |> "h.d" <| [
    ...
    noun     MaFIL                     {- mahiyD -}         `gloss`  [ "broken", "powerless" ] ]
 ...
 |> "h.t" <| [
    ...
    verb     FAL                       {- hAT-i -}          `imperf` [ FCiL ]
                                                            `others` [ "hi.t PV_C IV_C", "hA.t PV_V", "hiy.t IV_V" ]
 ...
 |> "hf" <| [
    ...
    verb     FAL                       {- hAf-a -}          `imperf` [ FCaL ]
                                                            `others` [ "hif PV_C", "haf IV_C", "hAf PV_V IV_V" ]
                                                            `gloss`  [ "run away" ],
 ...
 |> "hyf" <| [
    ...
    noun     HaFCaL                    {- >ahoyaf -}        `others` [ "hiyf N", "hayfA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "slender", "frail" ] ]
 ...
 |> "hiyfiy" <| [
    ...
    noun     Identity                  {- hiyfiy -}         `gloss`  [ "Heavy" ] ]
 ...
 |> "hykl" <| [
    ...
    noun     FaCCaL                    {- hayokal -}        `others` [ "hayAkil Ndip" ]
                                                            `gloss`  [ "framework", "structure", "skeleton" ],

    -- ;; hayokaliy~_1
    -- hykly   hayokaliy~      N-ap    structural;skeletal;framework     [[hayokaliy~/ADJ]]

    noun     FaCCaL |< Iy              {- hayokaliy~ -}     `gloss`  [ "structural", "skeletal", "framework" ],

    -- ;; hayokalap_1
    -- hykl    hayokal Nap     structuring;composing

    noun     FaCCaL |< aT              {- hayokalap -}      `others` [ "haykal Nap" ]
                                                            `gloss`  [ "structuring", "composing" ] ]
 ...
 |> "hl" <| [
    ...
    verb     FAL                       {- hAl-i -}          `imperf` [ FCiL ]
                                                            `others` [ "hil PV_C IV_C", "hiyl IV_V", "hAl PV_V" ]
                                                            `gloss`  [ "pour", "strew" ] ]
 ...
 |> "hl" <| [
    ...
    verb     HaFAL                     {- >ahAl -}          `others` [ "hil IV_C_yu", "hiyl IV_V_yu", "'ahal PV_C", "hal IV_C_Pass_yu", "hAl IV_V_Pass_yu" ]
 ...
 |> "hyl" <| [
    ...
    noun     FaCUL |< Iy               {- hayuwliy~ -}      `gloss`  [ "material" ] ]
 ...
 |> "hayuwlAn" <| [
    ...
    noun     Identity |< Iy            {- hayuwlAniy~ -}    `gloss`  [ "material" ] ]
 ...
 |> "hyln" <| [
    ...
    noun     FiCCIL |< Iy |< aT        {- hiyliyniy~ap -}   `others` [ "hiyliyniyy Nap" ]
                                                            `gloss`  [ "Hellenism" ] ]
 ...
 |> "hm" <| [
    ...
    verb     FAL                       {- hAm-i -}          `imperf` [ FCiL ]
                                                            `others` [ "him IV_C_intr PV_C_intr", "hAm PV_V_intr", "hiym IV_V_intr" ]
 ...
 |> "hymn" <| [
    ...
    verb     FaCCaL                    {- hayoman -}        `others` [ "haymin IV-n_yu" ]
                                                            `gloss`  [ "guard", "watch", "control" ],

    -- ;; hayomanap_1
    -- hymn    hayoman Nap     surveillance;control;supremacy

    noun     FaCCaL |< aT              {- hayomanap -}      `others` [ "hayman Nap" ]
                                                            `gloss`  [ "surveillance", "control", "supremacy" ],

    -- ;; muhayomin_1
    -- mhymn   muhayomin       Nall    controlling;supervising;guarding;watching     [[muhayomin/ADJ]]

    noun     MuFaCCiL                  {- muhayomin -}      `gloss`  [ "controlling", "supervising", "guarding", "watching" ],

    -- ;; muhayomin_2
    -- mhymn   muhayomin       N/ap    guardian;protector

    noun     MuFaCCiL                  {- muhayomin -}      `gloss`  [ "guardian", "protector" ] ]
 ...
 |> "hynm" <| [
    ...
    verb     FaCCaL                    {- hayonam -}        `others` [ "haynim IV_yu" ]
                                                            `gloss`  [ "murmur softly" ] ]
 ...
 |> "hyh" <| [
    ...
    noun     FaCL |< At                {- hayohAt -}        `gloss`  [ "how !" ] ]
 ...
 |> "hiyuwrAkAn" <| [
    ...
    -- ;; hiyuwrAkAn_1
    -- hywrAkAn        hiyuwrAkAn      Nprop   Huracán

    noun     Identity                  {- hiyuwrAkAn -}     `gloss`  [ "Hurac_an" ] ]
