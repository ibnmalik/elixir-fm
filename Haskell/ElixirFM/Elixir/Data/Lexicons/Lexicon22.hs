...
lexicon = listing "Lexicon properties"
 ...
 |> "'ikliyl" <| [
    ...
    noun     Identity                  {- Iikoliyl -}       -- `others` [ "'akAliyl Ndip", "'akill Nap" ]
    ...
    noun     Identity |< Iy            {- Iikoliyliy~ -}    `gloss`  [ "coronal [ [" ] ]
 ...
 |> "'uk_duwb" <| [
    ...
    noun     Identity |< aT            {- Ouko*uwbap -}     -- `others` [ "'akA_diyb Ndip" ]
                                                            `gloss`  [ "lie", "lies" ] ]
 ...
 |> "k ' b" <| [
    ...
    verb     HaFCaL                    {- OakoOab -}        -- `others` [ "k'ib IV_yu" ]
    ...
    verb     IFtaCaL                   {- {ikotaOab -}      -- `others` [ "kta'ib IV_intr" ]
                                                            `gloss`  [ "be depressed", "be dejected" ],

    -- ;; ka>ob_1
    -- k>b     ka>ob   N       depression

    noun     FaCL                      {- kaOob -}          `gloss`  [ "depression" ],

    -- ;; ka>obap_1
    -- k>b     ka>ob   Nap     depression

    noun     FaCL |< aT                {- kaOobap -}        `gloss`  [ "depression" ],

    -- ;; ka|bap_1
    -- k|b     ka|b    Nap     depression

    noun     FaCAL |< aT               {- ka|bap -}         `gloss`  [ "depression" ],
    ...
    noun     FaCiL                     {- ka}ib -}          `gloss`  [ "depressed [ [ ka } ib / ADJ ] ]" ],

    -- ;; ka}iyb_1
    -- k}yb    ka}iyb  Nall    depressed     [[ka}iyb/ADJ]]

    noun     FaCIL                     {- ka}iyb -}         `gloss`  [ "depressed [ [ ka } iyb / ADJ ] ]" ],

    -- ;; mukota}ib_1
    -- mkt}b   mukota}ib       Nall    depressed;dejected     [[mukota}ib/ADJ]]

    noun     MuFtaCiL                  {- mukota}ib -}      `gloss`  [ "depressed", "dejected [ [ mukota } ib / ADJ ] ]" ] ]
 ...
 |> "k ' d" <| [
    ...
    verb     FaCaL                     {- kaOad-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "k'ad IV_intr" ]
    ...
    noun     FaCUL                     {- kaWuwd -}         `gloss`  [ "insurmountable [ [ ka&uwd / ADJ ] ]", "insurmountable" ] ]
 ...
 |> "k ' d '" <| [
    ...
    noun     KaRDAS                    {- kaOodA' -}        `gloss`  [ "sadness", "distress" ] ]
 ...
 |> "k ' k '" <| [
    ...
    verb     TaKaRDaS                  {- takaOokaO -}      -- `others` [ "taka'ka'A PV-|_intr IV-|" ]
    ...
    noun     TaKaRDuS                  {- takaOokuW -}      `gloss`  [ "gathering", "assembling" ] ]
 ...
 |> "k ' s" <| [
    ...
    noun     FaCL                      {- kaOos -}          -- `others` [ "ku'uws N", "ki'As N" ]
                                                            `gloss`  [ "cup", "cups" ] ]
 ...
 |> "k .g n" <| [
    ...
    noun     FICAL                     {- kiygAn -}         `gloss`  [ "Keegan" ] ]
 ...
 |> "k .h .h" <| [
    ...
    verb     FaCL                      {- kaH~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "ku.h.h IV_V", "ka.ha.h PV_C", "k.hu.h IV_C" ]
                                                            `gloss`  [ "cough" ] ]
 ...
 |> "k .h k .h" <| [
    ...
    noun     KaRDaS |< aT              {- kaHokaHap -}      `gloss`  [ "coughing" ],

    -- ;; kaHokaHap_2
    -- kHkH    kaHokaH Napdu   cough
    -- kHkH    kaHokaH NAt     coughs

    noun     KaRDaS |< aT              {- kaHokaHap -}      -- `others` [ "ka.hka.h NAt" ]
                                                            `gloss`  [ "cough", "coughs" ] ]
 ...
 |> "k .h l" <| [
    ...
    noun     FuCL |< Iy                {- kuHoliy~ -}       `gloss`  [ "aqua blue [ [ kuHoliy ~ / ADJ ] ]" ],

    -- ;; kuHolap_1
    -- kHl     kuHol   Nap     pointing;filling;grouting

    noun     FuCL |< aT                {- kuHolap -}        `gloss`  [ "pointing", "filling", "grouting" ],
    ...
    noun     HaFCaL                    {- OakoHal -}        -- `others` [ "ka.hlA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "black" ],
    ...
    noun     FuCUL |< Iy               {- kuHuwliy~ -}      `gloss`  [ "alcoholic [ [ kuHuwliy ~ / ADJ ] ]", "alcoholic beverages [ [ kuHuwliy ~ / NOUN ] ]" ],
 ...
 |> "k .z .z" <| [
    ...
    verb     FaCL                      {- kaZ~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "ku.z.z IV_V", "ka.za.z PV_C", "k.zu.z IV_C" ]
    ...
    noun     FiCL |< aT                {- kiZ~ap -}         `gloss`  [ "gorging", "overstuffing" ],
    ...
    noun     IFtiCAL                   {- {ikotiZAZ -}      -- `others` [ "mukta.z.z N-ap" ]
                                                            `gloss`  [ "overcrowding", "overfilling", "overcrowded", "jam-packed [ [ mukotaZ ~ / ADJ ] ]" ] ]
 ...
 |> "k .z r" <| [
    ...
    noun     FuCL |< Iy                {- kuZoriy~ -}       `gloss`  [ "adrenal [ [ kuZoriy ~ / ADJ ] ]" ] ]
 ...
 |> "k ^s .h" <| [
    ...
    noun     FuCAL |< aT               {- ku$AHap -}        `gloss`  [ "secret enmity", "grudge" ],
    ...
    noun     FACiL                     {- kA$iH -}          `gloss`  [ "harboring a grudge [ [ kA $ iH / ADJ ] ]" ] ]
 ...
 |> "k ^s .t" <| [
    ...
    noun     MiFCaL |< aT              {- miko$aTap -}      -- `others` [ "makA^si.t Ndip" ]
 ...
 |> "k ^s ^s" <| [
    ...
    verb     FaCL                      {- ka$~-i -}         `imperf` [ FCiL ]
                                                            -- `others` [ "ka^sa^s PV_C", "k^si^s IV_C", "ki^s^s IV_V" ]
                                                            `gloss`  [ "recoil" ],

    -- ;; ku$~ap_1
    -- k$      ku$~    Napdu   lock of hair

    noun     FuCL |< aT                {- ku$~ap -}         `gloss`  [ "lock of hair" ] ]
 ...
 |> "k ^s f" <| [
    ...
    noun     FaCL |< Iy                {- ka$ofiy~ -}       `gloss`  [ "scouting", "boy scouts [ [ ka $ ofiy ~ / ADJ ] ]" ],
    ...
    noun     FiCAL |< aT               {- ki$Afap -}        `gloss`  [ "scouting", "reconnaissance", "exploration" ],

    -- ;; ki$Afiy~_1
    -- k$Afy   ki$Afiy~        N-ap    scouting;boy scouts     [[ki$Afiy~/ADJ]]

    noun     FiCAL |< Iy               {- ki$Afiy~ -}       `gloss`  [ "scouting", "boy scouts [ [ ki $ Afiy ~ / ADJ ] ]" ],
    ...
    noun     IstiFCAL |< Iy            {- {isotiko$Afiy~ -} `gloss`  [ "reconnaissance [ [ { isotiko $ Afiy ~ / ADJ ] ]" ],
 ...
 |> "k ^s k ^s" <| [
    ...
    noun     KiRDiS |< Iy              {- ki$oki$iy~ -}     `gloss`  [ "burlesque", "popular [ [ ki $ oki $ iy ~ / ADJ ] ]" ] ]
 ...
 |> "k ^s m ^s" <| [
    ...
    noun     KiRDiS                    {- ki$omi$ -}        `gloss`  [ "currants" ] ]
 ...
 |> "k ^s r" <| [
    ...
    noun     FiCL |< aT                {- ki$orap -}        `gloss`  [ "grimace" ],

    -- ;; tako$iyrap_1
    -- tk$yr   tako$iyr        NapAt   flesh of the teeth;bearing the teeth

    noun     TaFCIL |< aT              {- tako$iyrap -}     `gloss`  [ "flesh of the teeth", "bearing the teeth" ],

    -- ;; mukA$ir_1
    -- mkA$r   mukA$ir N       nearest     [[mukA$ir/ADJ]]

    noun     MuFACiL                   {- mukA$ir -}        `gloss`  [ "nearest [ [ mukA $ ir / ADJ ] ]" ] ]
 ...
 |> "k _d b" <| [
    ...
    verb     HaFCaL                    {- Oako*ab -}        -- `others` [ "k_dab IV_Pass_yu", "k_dib IV_yu" ]
    ...
    noun     FiCL |< aT                {- ki*obap -}        `gloss`  [ "lie", "untruth" ],

    -- ;; ka*uwb_1
    -- k*wb    ka*uwb  N-ap    liar     [[ka*uwb/ADJ]]

    noun     FaCUL                     {- ka*uwb -}         `gloss`  [ "liar [ [ ka*uwb / ADJ ] ]" ],
    ...
    noun     HaFCaL                    {- Oako*ab -}        `gloss`  [ "bigger / biggest liar" ],
    ...
    noun     MaFCUL                    {- mako*uwb -}       `gloss`  [ "false", "trumped up [ [ mako*uwb / ADJ ] ]" ] ]
 ...
 |> "k _h y" <| [
    ...
    noun     FiCL |< aT                {- kixoyap -}        -- `others` [ "kawA_h NK", "kawA_hiy N0_Nh", "kA_hiy Napdu" ]
 ...
 |> "k _t _t" <| [
    ...
    verb     FaCL                      {- kav~-i -}         `imperf` [ FCiL ]
                                                            -- `others` [ "k_ti_t IV_C_intr", "ka_ta_t PV_C_intr", "ki_t_t IV_V_intr" ]
    ...
    noun     FaCAL |< aT               {- kavAvap -}        `gloss`  [ "thickness", "density" ],
    ...
    noun     FaCL                      {- kav~ -}           `gloss`  [ "thick", "dense [ [ kav ~ / ADJ ] ]" ],

    -- ;; kaviyv_1
    -- kvyv    kaviyv  N-ap    thick;dense     [[kaviyv/ADJ]]

    noun     FaCIL                     {- kaviyv -}         `gloss`  [ "thick", "dense [ [ kaviyv / ADJ ] ]" ] ]
 ...
 |> "k _t d" <| [
    ...
    noun     FACUL                     {- kAvuwd -}         `gloss`  [ "cathode" ] ]
 ...
 |> "k _t f" <| [
    ...
    noun     HaFCaL                    {- Oakovaf -}        `gloss`  [ "more / most intense / concentrated" ],

    -- ;; kavAfap_1
    -- kvAf    kavAf   Nap     density;compactness

    noun     FaCAL |< aT               {- kavAfap -}        `gloss`  [ "density", "compactness" ],
    ...
    noun     MutaFACiL                 {- mutakAvif -}      `gloss`  [ "gathering", "concentrating [ [ mutakAvif / ADJ ] ]" ] ]
 ...
 |> "k _t l k" <| [
    ...
    noun     KaRDaS |< aT              {- kavolakap -}      `gloss`  [ "Catholicism", "Catholics" ] ]
 ...
 |> "k _t r" <| [
    ...
    noun     HaFCaL                    {- Oakovar -}        `gloss`  [ "more", "most [ [ >akovar / ADJ ] ]" ],
    ...
    verb     HaFCaL                    {- Oakovar -}        -- `others` [ "k_tir IV_yu", "k_tar IV_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- kavorap -}        `gloss`  [ "abundance", "frequency" ],
    ...
    noun     HaFCaL |< Iy |< aT        {- Oakovariy~ap -}   `gloss`  [ "majority [ [ >akovariy ~ / NOUN ] ]" ],
    ...
    noun     HiFCAL                    {- IikovAr -}        `gloss`  [ "increase", "frequentness" ],
    ...
    noun     MutaFaCCiL                {- mutakav~ir -}     `gloss`  [ "pluralistic [ [ mutakav ~ ir / ADJ ] ]" ],

    -- ;; mutakAvir_1
    -- mtkAvr  mutakAvir       Nall    numerous;extensive     [[mutakAvir/ADJ]]

    noun     MutaFACiL                 {- mutakAvir -}      `gloss`  [ "numerous", "extensive [ [ mutakAvir / ADJ ] ]" ] ]
 ...
 |> "k ` b" <| [
    ...
    noun     FaCL |< aT                {- kaEobap -}        `gloss`  [ "Kaaba ( in Mecca )" ],

    -- ;; kaEobap_2
    -- kEb     kaEob   Napdu   cube

    noun     FaCL |< aT                {- kaEobap -}        `gloss`  [ "cube" ],

    -- ;; kaEobiy~_1
    -- kEby    kaEobiy~        N-ap    cubic     [[kaEobiy~/ADJ]]

    noun     FaCL |< Iy                {- kaEobiy~ -}       `gloss`  [ "cubic [ [ kaEobiy ~ / ADJ ] ]" ],
    ...
    noun     TaFCIL |< aT              {- takoEiybap -}     `gloss`  [ "trellis", "arbor" ],

    -- ;; takoEiybiy~_1
    -- tkEyby  takoEiybiy~     N-ap    cubic;cubistic     [[takoEiybiy~/ADJ]]

    noun     TaFCIL |< Iy              {- takoEiybiy~ -}    `gloss`  [ "cubic", "cubistic [ [ takoEiybiy ~ / ADJ ] ]" ],

    -- ;; kAEib_1
    -- kAEb    kAEib   N/ap    full and round     [[kAEib/ADJ]]

    noun     FACiL                     {- kAEib -}          `gloss`  [ "full and round [ [ kAEib / ADJ ] ]" ],
 ...
 |> "k ` b l" <| [
    ...
    noun     KaRDaS |< aT              {- kaEobalap -}      `gloss`  [ "tripping up", "making stumble" ] ]
 ...
 |> "k ` b r" <| [
    ...
    noun     KuRDuS |< aT              {- kuEoburap -}      -- `others` [ "ka`buwr Napdu", "ka`Abir Ndip" ]
                                                            `gloss`  [ "knot", "knob", "node", "knots", "knobs", "nodes" ],

    -- ;; mukaEobar_1
    -- mkEbr   mukaEobar       N-ap    knotty;knobby;gnarled     [[mukaEobar/ADJ]]

    noun     MuKaRDaS                  {- mukaEobar -}      `gloss`  [ "knotty", "knobby", "gnarled [ [ mukaEobar / ADJ ] ]" ] ]
 ...
 |> "k b ^s" <| [
    ...
    noun     FaCL |< aT                {- kabo$ap -}        `gloss`  [ "handful", "ladle" ],

    -- ;; kubo$ap_1
    -- kb$     kubo$   Napdu   hook;clamp

    noun     FuCL |< aT                {- kubo$ap -}        `gloss`  [ "hook", "clamp" ] ]
 ...
 |> "k b b" <| [
    ...
    verb     FaCL                      {- kab~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "kbub IV_C", "kabab PV_C", "kubb IV_V" ]
    ...
    verb     HaFaCL                    {- Oakab~ -}         -- `others` [ "'akbab PV_C", "kabb IV_V_Pass_yu", "kibb IV_V_yu", "kbib IV_C_yu" ]
    ...
    noun     FuCL |< aT                {- kub~ap -}         -- `others` [ "kubab N" ]
    ...
    noun     FaCAL |< aT               {- kabAbap -}        `gloss`  [ "cubeb ( a climbing plant )" ],

    -- ;; kubayobap_1
    -- kbyb    kubayob Nap     small kebab (grilled meat dish)

    noun     FuCayL |< aT              {- kubayobap -}      `gloss`  [ "small kebab ( grilled meat dish )" ],
    ...
    noun     MiFaCL |< aT              {- mikab~ap -}       `gloss`  [ "food lid" ],

    -- ;; <ikobAb_1
    -- <kbAb   <ikobAb N/At    devotion;dedication;occupation
    -- AkbAb   <ikobAb N/At    devotion;dedication;occupation

    noun     HiFCAL                    {- IikobAb -}        `gloss`  [ "devotion", "dedication", "occupation" ],

    -- ;; mukib~_1
    -- mkb     mukib~  Nall    devoted;dedicated     [[mukib~/ADJ]]

    noun     MuFiCL                    {- mukib~ -}         `gloss`  [ "devoted", "dedicated [ [ mukib ~ / ADJ ] ]" ],
 ...
 |> "k b k b" <| [
    ...
    noun     KaRDaS |< aT              {- kabokabap -}      `gloss`  [ "capsizing", "reverting" ] ]
 ...
 |> "k b l" <| [
    ...
    noun     FaCUL |< Iy               {- kabuwliy~ -}      -- `others` [ "kAbuwliyy N-ap", "kawAbiyl Ndip" ]
                                                            `gloss`  [ "bracket", "shed roof [ [ kabuwliy ~ / ADJ ] ]", "shed roof [ [ kAbuwliy ~ / ADJ ] ]", "brackets", "shed roofs" ],
 ...
 |> "k b r" <| [
    ...
    verb     HaFCaL                    {- Oakobar -}        -- `others` [ "kbar IV_Pass_yu", "kbir IV_yu" ]
    ...
    noun     FaCL |< aT                {- kaborap -}        `gloss`  [ "old age" ],
    ...
    noun     FaCIL |< aT               {- kabiyrap -}       -- `others` [ "kabiyr NAt", "kabA'ir Ndip" ]
    ...
    noun     HaFCaL                    {- Oakobar -}        `gloss`  [ "larger / largest", "greater / greatest [ [ >akobar / ADJ ] ]" ],
    ...
    noun     HaFCaL                    {- Oakobar -}        -- `others` [ "'akAbir Ndip" ]
                                                            `gloss`  [ "senior", "important [ [ >akobar / ADJ ] ]", "seniors", "leaders" ],

    -- ;; >akobar_4
    -- >kbr    >akobar N0      Akbar
    -- Akbr    >akobar N0      Akbar

    noun     HaFCaL                    {- Oakobar -}        `gloss`  [ "Akbar" ],
    ...
    noun     HiFCAL                    {- IikobAr -}        `gloss`  [ "deference", "esteem" ],
    ...
    noun     MuFaCCaL                  {- mukab~ar -}       `gloss`  [ "enlarged", "magnified [ [ mukab ~ ar / ADJ ] ]" ],

    -- ;; mukAbir_1
    -- mkAbr   mukAbir Nall    arrogant     [[mukAbir/ADJ]]

    noun     MuFACiL                   {- mukAbir -}        `gloss`  [ "arrogant [ [ mukAbir / ADJ ] ]" ],

    -- ;; mutakab~ir_1
    -- mtkbr   mutakab~ir      Nall    arrogant     [[mutakab~ir/ADJ]]

    noun     MutaFaCCiL                {- mutakab~ir -}     `gloss`  [ "arrogant [ [ mutakab ~ ir / ADJ ] ]" ],

    -- ;; mutakAbir_1
    -- mtkAbr  mutakAbir       Nall    arrogant     [[mutakAbir/ADJ]]

    noun     MutaFACiL                 {- mutakAbir -}      `gloss`  [ "arrogant [ [ mutakAbir / ADJ ] ]" ] ]
 ...
 |> "k b r t" <| [
    ...
    noun     KaRDaS |< aT              {- kaboratap -}      `gloss`  [ "sulfurization" ],
    ...
    noun     KiRDIS |< Iy              {- kiboriytiy~ -}    `gloss`  [ "sulfuric", "sulfur [ [ kiboriytiy ~ / ADJ ] ]" ],
 ...
 |> "k b s" <| [
    ...
    noun     FaCL |< aT                {- kabosap -}        `gloss`  [ "raid", "surprise attack" ],
    ...
    noun     FACUL                     {- kAbuws -}         -- `others` [ "kawAbiys Ndip" ]
                                                            `gloss`  [ "nightmare", "nightmares" ],

    -- ;; kAbuwsiy~_1
    -- kAbwsy  kAbuwsiy~       N-ap    nightmarish

    noun     FACUL |< Iy               {- kAbuwsiy~ -}      `gloss`  [ "nightmarish" ],
    ...
    noun     FACiL |< aT               {- kAbisap -}        `gloss`  [ "compressor" ],

    -- ;; makobuws_1
    -- mkbws   makobuws        N-ap    raided;attacked     [[makobuws/ADJ]]

    noun     MaFCUL                    {- makobuws -}       `gloss`  [ "raided", "attacked [ [ makobuws / ADJ ] ]" ],
 ...
 |> "k b t" <| [
    ...
    noun     MaFCUL                    {- makobuwt -}       `gloss`  [ "stifled", "subdued", "repressed [ [ makobuwt / ADJ ] ]" ],
 ...
 |> "k b t l" <| [
    ...
    noun     KaRDUS |< aT              {- kabotuwlap -}     `gloss`  [ "lump", "chunk", "pellet" ],
 ...
 |> "k b w" <| [
    ...
    verb     FaCA                      {- kabA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "kabaw PV_Atn", "kab PV_ttAw", "kbuw IV_0hAnn", "kb IV_0hwnyn" ]
                                                            `gloss`  [ "stumble" ],
    ...
    verb     FaCA                      {- kabA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "kabaw PV_Atn", "kab PV_ttAw", "kbY IV_0_Pass_yu", "kbay IV_Ann_Pass_yu", "kbuw IV_0hAnn", "kb IV_0hwnyn" ]
    ...
    verb     HaFCY                     {- OakobaY -}        -- `others` [ "kbiy IV_0hAnn_yu", "kbY IV_0_Pass_yu", "'akb PV_ttAw", "'akbA PV_h", "kbay IV_Ann_Pass_yu", "kb IV_0hwnyn_yu", "'akbay PV_Atn" ]
    ...
    noun     FaCL |< aT                {- kabowap -}        -- `others` [ "kabaw NAt" ]
    ...
    noun     FACI                      {- kAbiy -}          -- `others` [ "kAb NK" ]
                                                            `gloss`  [ "dull", "dim", "weak [ [ kAbiy / ADJ ] ]", "weak" ] ]
 ...
 |> "k b y" <| [
    ...
    noun     FuCCAL |< aT              {- kub~Ayap -}       -- `others` [ "kubbAy NAt" ]
 ...
 |> "k d .h" <| [
    ...
    noun     FACiL                     {- kAdiH -}          `gloss`  [ "toiling", "working hard [ [ kAdiH / ADJ ] ]" ] ]
 ...
 |> "k d d" <| [
    ...
    noun     FaCUL                     {- kaduwd -}         `gloss`  [ "hard-working", "industrious", "diligent [ [ kaduwd / ADJ ] ]" ],

    -- ;; makoduwd_1
    -- mkdwd   makoduwd        Nall    worn out;exhausted     [[makoduwd/ADJ]]

    noun     MaFCUL                    {- makoduwd -}       `gloss`  [ "worn out", "exhausted [ [ makoduwd / ADJ ] ]" ],
    ...
    verb     FaCLY                     {- kad~aY -}         -- `others` [ "kadd IV_0hwnyn_yu PV_ttAw", "kaddA PV_h", "kaddiy IV_0hAnn_yu", "kadday PV_Atn IV_Ann_Pass_yu" ]
                                                            `gloss`  [ "beg", "be begged" ] ]
 ...
 |> "k d m" <| [
    ...
    noun     FaCL |< aT                {- kadomap -}        -- `others` [ "kadam NAt" ]
 ...
 |> "k d r" <| [
    ...
    noun     FuCL |< aT                {- kudorap -}        `gloss`  [ "muddiness", "impurity" ],

    -- ;; kadarap_1
    -- kdr     kadar   Nap     dirt;filth

    noun     FaCaL |< aT               {- kadarap -}        `gloss`  [ "dirt", "filth" ],

    -- ;; kadir_1
    -- kdr     kadir   N-ap    muddy     [[kadir/ADJ]]

    noun     FaCiL                     {- kadir -}          `gloss`  [ "muddy [ [ kadir / ADJ ] ]" ],

    -- ;; kadir_2
    -- kdr     kadir   N-ap    worried     [[kadir/ADJ]]

    noun     FaCiL                     {- kadir -}          `gloss`  [ "worried [ [ kadir / ADJ ] ]" ],

    -- ;; kadiyr_1
    -- kdyr    kadiyr  N       muddy     [[kadiyr/ADJ]]

    noun     FaCIL                     {- kadiyr -}         `gloss`  [ "muddy [ [ kadiyr / ADJ ] ]" ],

    -- ;; kadiyr_2
    -- kdyr    kadiyr  N       worried     [[kadiyr/ADJ]]

    noun     FaCIL                     {- kadiyr -}         `gloss`  [ "worried [ [ kadiyr / ADJ ] ]" ],
    ...
    noun     HaFCaL                    {- Oakodar -}        -- `others` [ "kadrA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "dingy [ [ >akodar / ADJ ] ]", "dingy" ],
    ...
    noun     MutaFaCCiL                {- mutakad~ir -}     `gloss`  [ "angry", "annoyed", "offended [ [ mutakad ~ ir / ADJ ] ]" ],
 ...
 |> "k d s" <| [
    ...
    noun     FuCAL |< aT               {- kudAsap -}        `gloss`  [ "heap", "pile", "stack" ],
 ...
 |> "k d y" <| [
    ...
    verb     FaCY                      {- kadaY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ "kdiy IV_0hAnn", "kaday PV_Atn", "kadA PV_h", "kd IV_0hwnyn", "kad PV_ttAw" ]
    ...
    verb     HaFCY                     {- OakodaY -}        -- `others` [ "kdiy IV_0hAnn_yu", "'akd PV_ttAw", "'akdA PV_h", "kdY IV_0_Pass_yu", "'akday PV_Atn", "kday IV_Ann_Pass_yu", "kd IV_0hwnyn_yu" ]
    ...
    noun     FuCL |< aT                {- kudoyap -}        `gloss`  [ "begging" ] ]
 ...
 |> "k f '" <| [
    ...
    verb     FaCaL                     {- kafaO-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "kfa'A IV-|", "kfa' IV IV_wn IV_yn", "kafa'A PV-|" ]
    ...
    verb     FACaL                     {- kAfaO -}          -- `others` [ "kAfa'A PV-|", "kAfi' IV_yu" ]
    ...
    verb     HaFCaL                    {- OakofaO -}        -- `others` [ "kfa' IV_Pass_yu", "'akfa'A PV-|", "kfi' IV_yu" ]
    ...
    verb     TaFACaL                   {- takAfaO -}        -- `others` [ "takAfa'A IV-| PV-|" ]
    ...
    verb     InFaCaL                   {- {inokafaO -}      -- `others` [ "nkafi' IV", "inkafa'A PV-|" ]
    ...
    noun     FaCAL |< aT               {- kafA'ap -}        `gloss`  [ "competence", "suitability", "proficiency" ],
    ...
    noun     MuFACaL |< aT             {- mukAfaOap -}      -- `others` [ "mukAfa N-|t" ]
    ...
    noun     TaFACuL                   {- takAfuW -}        `gloss`  [ "equality", "equal" ],
    ...
    noun     MuFACiL                   {- mukAfi} -}        `gloss`  [ "equal", "commensurate [ [ mukAfi } / ADJ ] ]" ],
    ...
    noun     IFtiCAL                   {- {ikotifA' -}      `gloss`  [ "sufficiency", "contentment" ] ]
 ...
 |> "k f .h" <| [
    ...
    noun     FiCAL |< Iy               {- kifAHiy~ -}       `gloss`  [ "battle", "fighting [ [ kifAHiy ~ / ADJ ] ]" ],

    -- ;; mukAfaHap_1
    -- mkAfH   mukAfaH NapAt   confrontation;battle

    noun     MuFACaL |< aT             {- mukAfaHap -}      `gloss`  [ "confrontation", "battle" ] ]
 ...
 |> "k f f" <| [
    ...
    noun     FiCL |< aT                {- kif~ap -}         -- `others` [ "kifaf N", "kifAf N", "kaff Napdu" ]
                                                            `gloss`  [ "palm of the hand", "palms of the hands" ],
    ...
    noun     FuCL |< aT                {- kuf~ap -}         -- `others` [ "kufaf N" ]
    ...
    noun     FiCAL |< aT               {- kifAfap -}        `gloss`  [ "hemming", "hem" ],

    -- ;; kafiyf_1
    -- kfyf    kafiyf  N/ap    blind     [[kafiyf/ADJ]]

    noun     FaCIL                     {- kafiyf -}         `gloss`  [ "blind [ [ kafiyf / ADJ ] ]" ],
 ...
 |> "k f k f" <| [
    ...
    noun     KaRDaS |< aT              {- kafokafap -}      `gloss`  [ "holding back" ] ]
 ...
 |> "k f l" <| [
    ...
    verb     HaFCaL                    {- Oakofal -}        -- `others` [ "kfil IV_yu", "kfal IV_Pass_yu" ]
    ...
    noun     FaCAL |< aT               {- kafAlap -}        `gloss`  [ "bail", "deposit", "collateral" ],
    ...
    noun     MaFCUL                    {- makofuwl -}       `gloss`  [ "covered", "backed [ [ makofuwl / ADJ ] ]" ] ]
 ...
 |> "k f r" <| [
    ...
    verb     HaFCaL                    {- Oakofar -}        -- `others` [ "kfar IV_Pass_yu", "kfir IV_yu" ]
    ...
    noun     FaCCAL |< aT              {- kaf~Arap -}       `gloss`  [ "penance", "atonement" ],
    ...
    noun     FACUL                     {- kAfuwr -}         `gloss`  [ "camphor" ] ]
 ...
 |> "k f s" <| [
    ...
    noun     HaFCaL                    {- Oakofas -}        -- `others` [ "kufs N", "kafsA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "bandy-legged" ] ]
 ...
 |> "k f t" <| [
    ...
    noun     FuCL |< aT                {- kufotap -}        `gloss`  [ "kufta ( patties of ground lamb or beef combined with herbs and spices then fried )" ],
    ...
    noun     MuFaCCaL                  {- mukaf~at -}       `gloss`  [ "inlaid", "coated", "plated [ [ mukaf ~ at / ADJ ] ]" ] ]
 ...
 |> "k f y" <| [
    ...
    noun     FiCAL |< aT               {- kifAyap -}        `gloss`  [ "sufficiency", "competence" ],

    -- ;; kafiy~_1
    -- kfy     kafiy~  N-ap    sufficient;enough     [[kafiy~/ADJ]]

    noun     FaCIL                     {- kafiy~ -}         `gloss`  [ "sufficient", "enough [ [ kafiy ~ / ADJ ] ]" ],

    -- ;; mukAfAp_1
    -- mkAfA   mukAfA  Napdu   reward;gratification
    -- mkAfy   mukAfay NAt     rewards

    noun     MuFACY |< aT              {- mukAfAp -}        -- `others` [ "mukAfay NAt" ]
 ...
 |> "k h m" <| [
    ...
    noun     FaCAL |< aT               {- kahAmap -}        `gloss`  [ "dullness", "lassitude" ] ]
 ...
 |> "k h n" <| [
    ...
    noun     FaCAL |< aT               {- kahAnap -}        `gloss`  [ "prediction", "prophecy" ],

    -- ;; kihAnap_1
    -- khAn    kihAn   Nap     soothsaying

    noun     FiCAL |< aT               {- kihAnap -}        `gloss`  [ "soothsaying" ],
 ...
 |> "k h r .t" <| [
    ...
    noun     KaRDaS |< aT              {- kahoraTap -}      `gloss`  [ "electromagnetizing" ] ]
 ...
 |> "k h r b" <| [
    ...
    noun     KaRDaS |< aT              {- kahorabap -}      `gloss`  [ "electricity", "electrification" ],
    ...
    noun     KaRDaS |< Iy              {- kahorabiy~ -}     `gloss`  [ "electrician [ [ kahorabiy ~ / ADJ ] ]" ],

    -- ;; kahorabiy~_2
    -- khrby   kahorabiy~      N-ap    electrical     [[kahorabiy~/ADJ]]

    noun     KaRDaS |< Iy              {- kahorabiy~ -}     `gloss`  [ "electrical [ [ kahorabiy ~ / ADJ ] ]" ],

    -- ;; kahAribiy~_1
    -- khArby  kahAribiy~      N-ap    electron     [[kahAribiy~/ADJ]]

    noun     KaRADiS |< Iy             {- kahAribiy~ -}     `gloss`  [ "electron [ [ kahAribiy ~ / ADJ ] ]" ],
 ...
 |> "k h w" <| [
    ...
    noun     FACI |< aT                {- kAhiyap -}        -- `others` [ "kawAhiy N0_Nh", "kawAh NK" ]
 ...
 |> "k h y" <| [
    ...
    noun     FACiL |< aT               {- kAhiyap -}        -- `others` [ "kawAhiy N0_Nh", "kawAh NK" ]
                                                            `gloss`  [ "officer", "deputy", "officers", "deputies" ],

    -- ;; kihAyap_1
    -- khAy    kihAy   Nap     kihaya (adm. distr.)

    noun     FiCAL |< aT               {- kihAyap -}        `gloss`  [ "kihaya ( adm. distr . )" ] ]
 ...
 |> "k k r" <| [
    ...
    noun     CuL |< aT                 {- kurap -}          -- `others` [ "kurY N0", "kurA Nhy" ]
 ...
 |> "k l '" <| [
    ...
    verb     FaCaL                     {- kalaO-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "kala'A PV-|", "kla'A IV-|", "kla' IV IV_wn IV_yn" ]
    ...
    verb     IFtaCaL                   {- {ikotalaO -}      -- `others` [ "ktali' IV_intr", "iktala'A PV-|_intr" ]
                                                            `gloss`  [ "be sleepless" ],
    ...
    noun     FaCaL                     {- kalaO -}          -- `others` [ "'aklA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "pasture", "herbage", "pastures" ],

    -- ;; kaluw'_1
    -- klw'    kaluw'  N-ap    sleepless     [[kaluw'/ADJ]]

    noun     FaCUL                     {- kaluw' -}         `gloss`  [ "sleepless [ [ kaluw ' / ADJ ] ]" ] ]
 ...
 |> "k l .h" <| [
    ...
    verb     HaFCaL                    {- OakolaH -}        -- `others` [ "kla.h IV_Pass_yu", "kli.h IV_yu" ]
    ...
    noun     FaCaL |< aT               {- kalaHap -}        `gloss`  [ "facial expression" ],

    -- ;; kAliH_1
    -- kAlH    kAliH   Nall    stern;somber     [[kAliH/ADJ]]

    noun     FACiL                     {- kAliH -}          `gloss`  [ "stern", "somber [ [ kAliH / ADJ ] ]" ],

    -- ;; kAliH_2
    -- kAlH    kAliH   N-ap    dark;dingy     [[kAliH/ADJ]]

    noun     FACiL                     {- kAliH -}          `gloss`  [ "dark", "dingy [ [ kAliH / ADJ ] ]" ] ]
 ...
 |> "k l b" <| [
    ...
    noun     FaCL |< aT                {- kalobap -}        -- `others` [ "kalab NAt" ]
                                                            `gloss`  [ "bitch ( dog )", "bitches ( dogs )" ],

    -- ;; kalobiy~_1
    -- klby    kalobiy~        N-ap    canine     [[kalobiy~/ADJ]]

    noun     FaCL |< Iy                {- kalobiy~ -}       `gloss`  [ "canine [ [ kalobiy ~ / ADJ ] ]" ],
    ...
    noun     FuCCAL |< aT              {- kul~Abap -}       `gloss`  [ "forceps", "pincers", "tongs" ],
    ...
    noun     FaCIL                     {- kaliyb -}         -- `others` [ "kalbA Nhy", "kalbY N0" ]
                                                            `gloss`  [ "rabid", "raging [ [ kaliyb / ADJ ] ]", "raging" ],
    ...
    noun     MaFCUL                    {- makoluwb -}       `gloss`  [ "rabid", "frenzied [ [ makoluwb / ADJ ] ]" ] ]
 ...
 |> "k l d" <| [
    ...
    noun     FaCLAn |< Iy              {- kalodAniy~ -}     `gloss`  [ "Chaldean [ [ kalodAniy ~ / NOUN ] ]", "Chaldean [ [ kalodAniy ~ / ADJ ] ]" ],

    -- ;; kalodAniy~_2
    -- kldAny  kalodAniy~      Nall    astrologer     [[kalodAniy~/NOUN]]

    noun     FaCLAn |< Iy              {- kalodAniy~ -}     `gloss`  [ "astrologer [ [ kalodAniy ~ / NOUN ] ]" ] ]
 ...
 |> "k l f" <| [
    ...
    noun     FuCL |< aT                {- kulofap -}        -- `others` [ "kulaf N" ]
    ...
    noun     FaCCAL |< Iy              {- kal~Afiy~ -}      `gloss`  [ "donkey hirer [ [ kal ~ Afiy ~ / ADJ ] ]" ],
    ...
    noun     HaFCaL                    {- Oakolaf -}        -- `others` [ "kalfA' Nh Nhy N0_Nh", "kulf N" ]
                                                            `gloss`  [ "freckled", "ginger [ [ >akolaf / ADJ ] ]", "ginger" ],
    ...
    noun     TaFCiL |< aT              {- takolifap -}      `gloss`  [ "cost computation" ],
    ...
    noun     MuFaCCaL |< aT            {- mukal~afap -}     `gloss`  [ "terrier" ],

    -- ;; mutakal~af_1
    -- mtklf   mutakal~af      N-ap    formal;ceremonious;artificial     [[mutakal~af/ADJ]]

    noun     MutaFaCCaL                {- mutakal~af -}     `gloss`  [ "formal", "ceremonious", "artificial [ [ mutakal ~ af / ADJ ] ]" ] ]
 ...
 |> "k l k l" <| [
    ...
    noun     KaRDaS |< aT              {- kalokalap -}      `gloss`  [ "callosity", "callus" ],

    -- ;; mukalokal_1
    -- mklkl   mukalokal       N-ap    callous     [[mukalokal/ADJ]]

    noun     MuKaRDaS                  {- mukalokal -}      `gloss`  [ "callous [ [ mukalokal / ADJ ] ]" ] ]
 ...
 |> "k l l" <| [
    ...
    verb     HaFaCL                    {- Oakal~ -}         -- `others` [ "'aklal PV_C", "kall IV_V_Pass_yu", "klil IV_C_yu", "kill IV_V_yu" ]
    ...
    noun     FuCL |< Iy                {- kul~iy~ -}        `gloss`  [ "total", "complete", "entire [ [ kul ~ iy ~ / ADJ ] ]" ],

    -- ;; kul~iy~ap_1
    -- kly     kul~iy~ NapAt   faculty;college;institute     [[kul~iy~/NOUN]]

    noun     FuCL |< Iy |< aT          {- kul~iy~ap -}      `gloss`  [ "faculty", "college", "institute [ [ kul ~ iy ~ / NOUN ] ]" ],

    -- ;; kul~iy~ap_2
    -- kly     kul~iy~ Nap     entirety     [[kul~iy~/NOUN]]
    -- kly     kul~iy~ NAt     general aspects;major features     [[kul~iy~/NOUN]]

    noun     FuCL |< Iy |< aT          {- kul~iy~ap -}      -- `others` [ "kulliyy NAt" ]
    ...
    noun     FuCL |< aT                {- kul~ap -}         -- `others` [ "kulal N" ]
    ...
    noun     FiCL |< aT                {- kil~ap -}         -- `others` [ "kilal N" ]
    ...
    noun     FaCAL |< aT               {- kalAlap -}        `gloss`  [ "fatigue" ],

    -- ;; kaliyl_1
    -- klyl    kaliyl  N       exhausted;weak     [[kaliyl/ADJ]]

    noun     FaCIL                     {- kaliyl -}         `gloss`  [ "exhausted", "weak [ [ kaliyl / ADJ ] ]" ],
    ...
    noun     FACL                      {- kAl~ -}           `gloss`  [ "tired", "languid [ [ kAl ~ / ADJ ] ]" ],

    -- ;; mukal~al_1
    -- mkll    mukal~al        Nall    crowned     [[mukal~al/ADJ]]

    noun     MuFaCCaL                  {- mukal~al -}       `gloss`  [ "crowned [ [ mukal ~ al / ADJ ] ]" ],

    -- ;; mukal~al_2
    -- mkll    mukal~al        Nall    married     [[mukal~al/ADJ]]

    noun     MuFaCCaL                  {- mukal~al -}       `gloss`  [ "married [ [ mukal ~ al / ADJ ] ]" ] ]
 ...
 |> "k l m" <| [
    ...
    noun     FaCiL |< aT               {- kalimap -}        -- `others` [ "kalim NAt" ]
    ...
    noun     FaCAL |< Iy               {- kalAmiy~ -}       `gloss`  [ "verbal", "spoken", "oral [ [ kalAmiy ~ / ADJ ] ]" ],

    -- ;; tikolAm_1
    -- tklAm   tikolAm N-ap    eloquent;garrulous     [[tikolAm/ADJ]]

    noun     TiFCAL                    {- tikolAm -}        `gloss`  [ "eloquent", "garrulous [ [ tikolAm / ADJ ] ]" ],
    ...
    noun     FaCaLAn |< Iy             {- kalamAniy~ -}     -- `others` [ "kalmAniyy N-ap" ]
                                                            `gloss`  [ "eloquent [ [ kalamAniy ~ / ADJ ] ]", "eloquent [ [ kalomAniy ~ / ADJ ] ]" ],

    -- ;; mukAlamap_1
    -- mkAlm   mukAlam Napdu   conversation;discussion
    -- mkAlm   mukAlam NAt     conversations;discussions

    noun     MuFACaL |< aT             {- mukAlamap -}      -- `others` [ "mukAlam NAt" ]
    ...
    noun     MutaFaCCiL                {- mutakal~im -}     `gloss`  [ "speaking", "speaker", "spokesman [ [ mutakal ~ im / ADJ ] ]" ] ]
 ...
 |> "k l n" <| [
    ...
    noun     FACUL                     {- kAluwn -}         `gloss`  [ "gallon" ],

    -- ;; kAluwn_2
    -- kAlwn   kAluwn  N       door lock
    -- kwAlyn  kawAliyn        Ndip    door locks

    noun     FACUL                     {- kAluwn -}         -- `others` [ "kawAliyn Ndip" ]
    ...
    noun     FawACIL |< Iy             {- kawAliyniy~ -}    `gloss`  [ "locksmith", "locksmiths [ [ kawAliyniy ~ / NOUN ] ]" ],
 ...
 |> "k l s" <| [
    ...
    noun     FiCL |< Iy                {- kilosiy~ -}       `gloss`  [ "calcic", "limy", "lime [ [ kilosiy ~ / ADJ ] ]" ],

    -- ;; kal~Asap_1
    -- klAs    kal~As  Nap     limekiln

    noun     FaCCAL |< aT              {- kal~Asap -}       `gloss`  [ "limekiln" ],
    ...
    noun     FaCL |< aT                {- kalosap -}        -- `others` [ "kals NAt" ]
                                                            `gloss`  [ "stockings" ] ]
 ...
 |> "k l w" <| [
    ...
    noun     FuCL |< aT                {- kulowap -}        -- `others` [ "kulY N0", "kuly NapAt", "kulA Nhy" ]
 ...
 |> "k l w r" <| [
    ...
    noun     KaRDaS |< aT              {- kalowarap -}      `gloss`  [ "chlorination" ] ]
 ...
 |> "k l w y" <| [
    ...
    noun     KiRDIS                    {- kilowiy~ -}       `gloss`  [ "renal", "kidney [ [ kilowiy ~ / ADJ ] ]" ] ]
 ...
 |> "k m .h" <| [
    ...
    verb     HaFCaL                    {- OakomaH -}        -- `others` [ "kmi.h IV_yu", "kma.h IV_Pass_yu" ]
 ...
 |> "k m ^s" <| [
    ...
    noun     FaCL |< aT                {- kamo$ap -}        `gloss`  [ "handful" ],
    ...
    noun     FaCIL                     {- kamiy$ -}         `gloss`  [ "adroit", "skilled [ [ kamiy $ / ADJ ] ]" ],

    -- ;; kam~A$ap_1
    -- kmA$    kam~A$  NapAt   pair of pliers

    noun     FaCCAL |< aT              {- kam~A$ap -}       `gloss`  [ "pair of pliers" ],
    ...
    noun     MunFaCiL                  {- munokami$ -}      `gloss`  [ "absorbed", "preoccupied", "introverted [ [ munokami $ / ADJ ] ]" ] ]
 ...
 |> "k m _h" <| [
    ...
    verb     HaFCaL                    {- Oakomax -}        -- `others` [ "kmi_h IV_intr_yu" ]
                                                            `gloss`  [ "be haughty", "turn up the nose" ],
 ...
 |> "k m b ^s" <| [
    ...
    noun     KaRDUS |< aT              {- kamobuw$ap -}     `gloss`  [ "prompter 's box" ] ]
 ...
 |> "k m d" <| [
    ...
    verb     HaFCaL                    {- Oakomad -}        -- `others` [ "kmid IV_yu", "kmad IV_Pass_yu" ]
    ...
    noun     FuCL |< aT                {- kumodap -}        `gloss`  [ "swarthiness", "sadness" ],

    -- ;; kamid_1
    -- kmd     kamid   N-ap    sad;grieved     [[kamid/ADJ]]

    noun     FaCiL                     {- kamid -}          `gloss`  [ "sad", "grieved [ [ kamid / ADJ ] ]" ],

    -- ;; kamiyd_1
    -- kmyd    kamiyd  N-ap    sad;grieved     [[kamiyd/ADJ]]

    noun     FaCIL                     {- kamiyd -}         `gloss`  [ "sad", "grieved [ [ kamiyd / ADJ ] ]" ],
    ...
    noun     HaFCaL                    {- Oakomad -}        `gloss`  [ "dark-colored", "swarthy" ],
    ...
    noun     MuFaCCaL |< aT            {- mukam~adap -}     `gloss`  [ "hot compress", "warm bandage" ] ]
 ...
 |> "k m h" <| [
    ...
    noun     HaFCaL                    {- Oakomah -}        -- `others` [ "kumh N", "kamhA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "born blind" ] ]
 ...
 |> "k m l" <| [
    ...
    verb     FaCaL                     {- kamal-u -}        `imperf` [ FCuL ]
                                                            -- `others` [ "kamul PV_intr", "kmul IV_intr" ]
    ...
    verb     HaFCaL                    {- Oakomal -}        -- `others` [ "kmil IV_yu", "kmal IV_Pass_yu" ]
    ...
    noun     FaCAL |< Iy               {- kamAliy~ -}       `gloss`  [ "luxurious", "de luxe [ [ kamAliy ~ / ADJ ] ]", "luxuries", "amenities [ [ kamAliy ~ / NOUN ] ]" ],

    -- ;; kamAlap_1
    -- kmAl    kamAl   Nap     supplement;addition

    noun     FaCAL |< aT               {- kamAlap -}        `gloss`  [ "supplement", "addition" ],

    -- ;; >akomal_2
    -- >kml    >akomal Nel     more/most complete/perfect
    -- Akml    >akomal Nel     more/most complete/perfect

    noun     HaFCaL                    {- Oakomal -}        `gloss`  [ "more / most complete / perfect" ],
    ...
    noun     TaFCIL |< Iy              {- takomiyliy~ -}    `gloss`  [ "completing", "supplementary [ [ takomiyliy ~ / ADJ ] ]" ],

    -- ;; takomilap_1
    -- tkml    takomil Nap     supplement

    noun     TaFCiL |< aT              {- takomilap -}      `gloss`  [ "supplement" ],

    -- ;; <ikomAl_1
    -- <kmAl   <ikomAl N/At    completion;conclusion;perfection
    -- AkmAl   <ikomAl N/At    completion;conclusion;perfection

    noun     HiFCAL                    {- IikomAl -}        `gloss`  [ "completion", "conclusion", "perfection" ],
    ...
    noun     TaFACuL |< Iy             {- takAmuliy~ -}     `gloss`  [ "integrative", "all-inclusive", "merging [ [ takAmuliy ~ / ADJ ] ]" ],
 ...
 |> "k m m" <| [
    ...
    noun     FaCL |< Iy                {- kam~iy~ -}        `gloss`  [ "quantitative [ [ kam ~ iy ~ / ADJ ] ]" ],

    -- ;; kam~iy~ap_1
    -- kmy     kam~iy~ NapAt   quantity;amount     [[kam~iy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- kam~iy~ap -}      `gloss`  [ "quantity", "amount [ [ kam ~ iy ~ / NOUN ] ]" ],
    ...
    noun     FiCAL |< aT               {- kimAmap -}        -- `others` [ "kamA'im Ndip" ]
                                                            `gloss`  [ "mask", "masks" ] ]
 ...
 |> "k m n" <| [
    ...
    noun     FuCL |< aT                {- kumonap -}        `gloss`  [ "black cataract" ],
    ...
    noun     FICAL                     {- kiymAn -}         `gloss`  [ "piles of trash", "rubbish" ] ]
 ...
 |> "k m r" <| [
    ...
    noun     FaCaL |< aT               {- kamarap -}        `gloss`  [ "beam", "girder" ],
 ...
 |> "k m r k" <| [
    ...
    noun     KuRDuS                    {- kumoruk -}        -- `others` [ "kamArik Ndip" ]
                                                            `gloss`  [ "customs", "control", "tariffs" ],

    -- ;; kumorukiy~_1
    -- kmrky   kumorukiy~      Nall    customs;tariffs     [[kumorukiy~/ADJ]]

    noun     KuRDuS |< Iy              {- kumorukiy~ -}     `gloss`  [ "customs", "tariffs [ [ kumorukiy ~ / ADJ ] ]" ] ]
 ...
 |> "k m s r" <| [
    ...
    noun     KuRDAS |< Iy              {- kumosAriy~ -}     `gloss`  [ "conductor", "ticket man", "conductors", "ticket men [ [ kumosAriy ~ / NOUN ] ]" ] ]
 ...
 |> "k m y" <| [
    ...
    noun     FaCIL                     {- kamiy~ -}         -- `others` [ "'akmA' Nh Nhy N0_Nh", "kumA Nap" ]
                                                            `gloss`  [ "armed", "brave [ [ kamiy ~ / ADJ ] ]", "brave" ] ]
 ...
 |> "k n ' s" <| [
    ...
    noun     KaRADiS |< Iy             {- kanA}isiy~ -}     `gloss`  [ "ecclesiastic [ [ kanA } isiy ~ / ADJ ] ]" ] ]
 ...
 |> "k n `" <| [
    ...
    noun     FaCLAn |< Iy              {- kanoEAniy~ -}     `gloss`  [ "Canaanite [ [ kanoEAniy ~ / NOUN ] ]", "Canaanite [ [ kanoEAniy ~ / ADJ ] ]" ],
 ...
 |> "k n b" <| [
    ...
    noun     FaCaL |< aT               {- kanabap -}        `gloss`  [ "sofa" ] ]
 ...
 |> "k n d" <| [
    ...
    noun     FaCaL |< Iy               {- kanadiy~ -}       `gloss`  [ "Canadian [ [ kanadiy ~ / NOUN ] ]", "Canadian [ [ kanadiy ~ / ADJ ] ]" ] ]
 ...
 |> "k n d r" <| [
    ...
    noun     KuRDuS                    {- kunodur -}        `gloss`  [ "frankincense" ],

    -- ;; kunodurap_1
    -- kndr    kunodur Napdu   shoe
    -- knAdr   kanAdir Ndip    shoes

    noun     KuRDuS |< aT              {- kunodurap -}      -- `others` [ "kanAdir Ndip" ]
                                                            `gloss`  [ "shoe", "shoes" ] ]
 ...
 |> "k n f" <| [
    ...
    verb     HaFCaL                    {- Oakonaf -}        -- `others` [ "knaf IV_Pass_yu", "knif IV_yu" ]
    ...
    noun     FuCAL |< aT               {- kunAfap -}        `gloss`  [ "kunafa ( pastry )" ],
    ...
    noun     MuFtaCaL                  {- mukotanaf -}      `gloss`  [ "surrounded", "enclosed [ [ mukotanaf / ADJ ] ]" ] ]
 ...
 |> "k n k" <| [
    ...
    noun     FaCaL |< aT               {- kanakap -}        `gloss`  [ "coffee pot" ] ]
 ...
 |> "k n n" <| [
    ...
    verb     FaCL                      {- kan~-i -}         `imperf` [ FCiL ]
                                                            -- `others` [ "knin IV-n", "kanan PV_Cn", "kinn IV_V" ]
                                                            `gloss`  [ "conceal", "hide" ],
    ...
    verb     HaFaCL                    {- Oakan~ -}         -- `others` [ "knin IV_C_yu", "kann IV_V_Pass_yu", "'aknan PV_Cn", "kinn IV_V_yu" ]
    ...
    noun     FaCL |< aT                {- kan~ap -}         -- `others` [ "kanA'in Ndip" ]
    ...
    verb     FaCLY                     {- kan~aY -}         -- `others` [ "kannA PV_h", "kann IV_0hwnyn_yu PV_ttAw", "kannay PV_Atn IV_Ann_Pass_yu", "kanniy IV_0hAnn_yu" ]
 ...
 |> "k n s" <| [
    ...
    noun     FuCAL |< aT               {- kunAsap -}        `gloss`  [ "sweepings", "rubbish" ],
    ...
    noun     FACiL |< aT               {- kAnisap -}        `gloss`  [ "sweeper ( of mines )" ] ]
 ...
 |> "k n t r" <| [
    ...
    noun     KuRDUS |< Iy              {- kunotuwriy~ -}    `gloss`  [ "contour", "outline [ [ kunotuwriy ~ / ADJ ] ]" ] ]
 ...
 |> "k n w" <| [
    ...
    verb     FaCY                      {- kanaY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ "kanA PV_h", "kniy IV_0hAnn", "kanay PV_Atn", "knY IV_0_Pass_yu" ]
    ...
    noun     MaFCIy                    {- makoniy~ -}       `gloss`  [ "alluded to [ [ makoniy ~ / ADJ ] ]" ],
    ...
    noun     MuFaCCY                   {- mukan~aY -}       -- `others` [ "mukannA Napdu Nhy", "mukannay NAt NAn_Nayn", "mukann Nuwn_Niyn" ]
                                                            `gloss`  [ "nicknamed [ [ mukan ~ aY / ADJ ] ]", "nicknamed" ] ]
 ...
 |> "k n y" <| [
    ...
    noun     FuCL |< aT                {- kunoyap -}        -- `others` [ "kunA Nhy", "kunY N0" ]
                                                            `gloss`  [ "nickname", "nicknames" ],

    -- ;; kinAyap_1
    -- knAy    kinAy   Nap     allusion;equivocal

    noun     FiCAL |< aT               {- kinAyap -}        `gloss`  [ "allusion", "equivocal" ] ]
 ...
 |> "k n z" <| [
    ...
    noun     FiCL |< aT                {- kinozap -}        `gloss`  [ "pullover" ],
    ...
    noun     MuFtaCiL                  {- mukotaniz -}      `gloss`  [ "firm", "sturdy [ [ mukotaniz / ADJ ] ]" ],
    ...
    noun     MuFtaCaL                  {- mukotanaz -}      `gloss`  [ "accumulated", "amassed [ [ mukotanaz / ADJ ] ]" ] ]
 ...
 |> "k r '" <| [
    ...
    noun     HiFCAL                    {- IikorA' -}        `gloss`  [ "renting", "leasing" ],
    ...
    noun     IFtiCAL                   {- {ikotirA' -}      `gloss`  [ "renting", "leasing" ] ]
 ...
 |> "k r ^g" <| [
    ...
    noun     FuCL |< Iy                {- kurojiy~ -}       `gloss`  [ "Georgian [ [ kurojiy ~ / NOUN ] ]", "Georgian [ [ kurojiy ~ / ADJ ] ]" ],
 ...
 |> "k r ^s" <| [
    ...
    noun     FiCL |< aT                {- kiro$ap -}        -- `others` [ "kuruw^s N" ]
                                                            `gloss`  [ "tripe ( dish )" ],

    -- ;; kurayo$ap_1
    -- kry$    kurayo$ Nap     crepe (fabric)

    noun     FuCayL |< aT              {- kurayo$ap -}      `gloss`  [ "crepe ( fabric )" ],

    -- ;; >akora$_1
    -- >kr$    >akora$ Nel     pot-bellied;paunchy
    -- Akr$    >akora$ Nel     pot-bellied;paunchy

    noun     HaFCaL                    {- Oakora$ -}        `gloss`  [ "pot-bellied", "paunchy" ],

    -- ;; mukori$_1
    -- mkr$    mukori$ Nall    pot-bellied;paunchy     [[mukori$/ADJ]]

    noun     MuFCiL                    {- mukori$ -}        `gloss`  [ "pot-bellied", "paunchy [ [ mukori $ / ADJ ] ]" ],

    -- ;; mutakar~i$_1
    -- mtkr$   mutakar~i$      Nall    pot-bellied;paunchy     [[mutakar~i$/ADJ]]

    noun     MutaFaCCiL                {- mutakar~i$ -}     `gloss`  [ "pot-bellied", "paunchy [ [ mutakar ~ i $ / ADJ ] ]" ] ]
 ...
 |> "k r _h" <| [
    ...
    noun     FaCLAn |< aT              {- karoxAnap -}      -- `others` [ "karA_hiyn Ndip" ]
 ...
 |> "k r _t" <| [
    ...
    verb     HaFCaL                    {- Oakorav -}        -- `others` [ "kri_t IV_yu", "kra_t IV_Pass_yu" ]
    ...
    noun     FACiL |< aT               {- kArivap -}        -- `others` [ "kawAri_t Ndip" ]
 ...
 |> "k r `" <| [
    ...
    noun     TaFCIL |< aT              {- takoriyEap -}     `gloss`  [ "belching", "eructation" ],
 ...
 |> "k r b" <| [
    ...
    verb     HaFCaL                    {- Oakorab -}        -- `others` [ "krab IV_Pass_yu", "krib IV_yu" ]
    ...
    noun     FuCL |< aT                {- kurobap -}        -- `others` [ "kurab N" ]
                                                            `gloss`  [ "worry", "fear", "worries", "fears" ],

    -- ;; makoruwb_1
    -- mkrwb   makoruwb        Nall    worried;alarmed     [[makoruwb/ADJ]]

    noun     MaFCUL                    {- makoruwb -}       `gloss`  [ "worried", "alarmed [ [ makoruwb / ADJ ] ]" ],

    -- ;; mukotarib_1
    -- mktrb   mukotarib       Nall    worried;alarmed     [[mukotarib/ADJ]]

    noun     MuFtaCiL                  {- mukotarib -}      `gloss`  [ "worried", "alarmed [ [ mukotarib / ADJ ] ]" ],
    ...
    noun     FaCUL |< Iy               {- karuwbiy~ -}      `gloss`  [ "cherubim [ [ karuwbiy ~ / ADJ ] ]" ] ]
 ...
 |> "k r b ^g" <| [
    ...
    noun     KaRDUS |< aT              {- karobuwjap -}     -- `others` [ "karAbiy^g Ndip" ]
                                                            `gloss`  [ "pastry" ] ]
 ...
 |> "k r b l" <| [
    ...
    noun     KaRDaS |< aT              {- karobalap -}      `gloss`  [ "sifting" ],

    -- ;; karobalap_2
    -- krbl    karobal NapAt   sieve;mesh

    noun     KaRDaS |< aT              {- karobalap -}      `gloss`  [ "sieve", "mesh" ] ]
 ...
 |> "k r b n" <| [
    ...
    noun     KaRDaS |< aT              {- karobanap -}      `gloss`  [ "carbonization" ],
 ...
 |> "k r d s" <| [
    ...
    noun     KaRDaS |< aT              {- karodasap -}      `gloss`  [ "piling up", "cramming together" ] ]
 ...
 |> "k r h" <| [
    ...
    verb     HaFCaL                    {- Oakorah -}        -- `others` [ "krih IV_yu", "krah IV_Pass_yu" ]
    ...
    noun     FaCiL                     {- karih -}          `gloss`  [ "loathsome", "offensive [ [ karih / ADJ ] ]" ],

    -- ;; kariyh_1
    -- kryh    kariyh  N/ap    unpleasant;repulsive     [[kariyh/ADJ]]

    noun     FaCIL                     {- kariyh -}         `gloss`  [ "unpleasant", "repulsive [ [ kariyh / ADJ ] ]" ],

    -- ;; karAhap_1
    -- krAh    karAh   Nap     loathsomeness;odiousness

    noun     FaCAL |< aT               {- karAhap -}        `gloss`  [ "loathsomeness", "odiousness" ],

    -- ;; karAhiy~ap_1
    -- krAhy   karAhiy~        Nap     antipathy;dislike     [[karAhiy~/NOUN]]

    noun     FaCAL |< Iy |< aT         {- karAhiy~ap -}     `gloss`  [ "antipathy", "dislike [ [ karAhiy ~ / NOUN ] ]" ],

    -- ;; kariyhap_1
    -- kryh    kariyh  Napdu   adversity;misfortune
    -- krA}h   karA}ih Ndip    adversities;misfortunes

    noun     FaCIL |< aT               {- kariyhap -}       -- `others` [ "karA'ih Ndip" ]
    ...
    noun     MaFCaL |< aT              {- makorahap -}      `gloss`  [ "hatred", "abhorrence" ],

    -- ;; <ikorAh_1
    -- <krAh   <ikorAh N/At    coercion;force
    -- AkrAh   <ikorAh N/At    coercion;force

    noun     HiFCAL                    {- IikorAh -}        `gloss`  [ "coercion", "force" ],
    ...
    noun     HiFCAL |< Iy              {- IikorAhiy~ -}     `gloss`  [ "compulsory", "enforced", "coercive [ [" ],
    ...
    noun     FACiL                     {- kArih -}          `gloss`  [ "reluctant", "unwilling [ [ kArih / ADJ ] ]" ],

    -- ;; makoruwh_1
    -- mkrwh   makoruwh        Nall    detested;loathsome     [[makoruwh/ADJ]]

    noun     MaFCUL                    {- makoruwh -}       `gloss`  [ "detested", "loathsome [ [ makoruwh / ADJ ] ]" ],
    ...
    noun     MuFCaL                    {- mukorah -}        `gloss`  [ "forced", "compelled [ [ mukorah / ADJ ] ]" ],

    -- ;; mutakar~ih_1
    -- mtkrh   mutakar~ih      Nall    reluctant;unwilling     [[mutakar~ih/ADJ]]

    noun     MutaFaCCiL                {- mutakar~ih -}     `gloss`  [ "reluctant", "unwilling [ [ mutakar ~ ih / ADJ ] ]" ] ]
 ...
 |> "k r k" <| [
    ...
    noun     FaCaL |< aT               {- karakap -}        `gloss`  [ "distilling apparatus" ],
    ...
    noun     FaCCAL |< aT              {- kar~Akap -}       `gloss`  [ "dredging machine", "penitentiary" ] ]
 ...
 |> "k r k b" <| [
    ...
    noun     KaRDaS |< aT              {- karokabap -}      `gloss`  [ "disorder", "confusion" ] ]
 ...
 |> "k r k m" <| [
    ...
    noun     KuRDuS                    {- kurokum -}        `gloss`  [ "turmeric", "curcumin" ] ]
 ...
 |> "k r k r" <| [
    ...
    noun     KaRDaS |< aT              {- karokarap -}      `gloss`  [ "rumbling", "gurgling", "guffaw" ] ]
 ...
 |> "k r m" <| [
    ...
    verb     HaFCaL                    {- Oakoram -}        -- `others` [ "krim IV_yu", "kram IV_Pass_yu" ]
    ...
    noun     FuCL |< aT                {- kuromap -}        `gloss`  [ "in honor of", "for the sake of" ],

    -- ;; karAmap_1
    -- krAm    karAm   Nap     dignity;generosity

    noun     FaCAL |< aT               {- karAmap -}        `gloss`  [ "dignity", "generosity" ],

    -- ;; karAmap_2
    -- krAm    karAm   Nap     Karama

    noun     FaCAL |< aT               {- karAmap -}        `gloss`  [ "Karama" ],
    ...
    noun     FaCIL |< aT               {- kariymap -}       -- `others` [ "karA'im Ndip" ]
    ...
    noun     FaCIL |< aT               {- kariymap -}       `gloss`  [ "Karima", "Kareema" ],
    ...
    noun     HaFCaL                    {- Oakoram -}        `gloss`  [ "Akram" ],
    ...
    noun     HaFCaL                    {- Oakoram -}        -- `others` [ "'akArim Ndip" ]
    ...
    noun     TaFCiL |< aT              {- takorimap -}      `gloss`  [ "honoring", "tribute" ],
    ...
    noun     HiFCAL                    {- IikorAm -}        `gloss`  [ "honor", "respect", "hospitality", "in honor of [ [" ],

    -- ;; <ikorAmiy~ap_1
    -- <krAmy  <ikorAmiy~      NapAt   honorarium;bonus     [[<ikorAmiy~/NOUN]]
    -- AkrAmy  <ikorAmiy~      NapAt   honorarium;bonus     [[<ikorAmiy~/NOUN]]

    noun     HiFCAL |< Iy |< aT        {- IikorAmiy~ap -}   `gloss`  [ "honorarium", "bonus [ [" ],
 ...
 |> "k r m ^s" <| [
    ...
    noun     KaRDaS |< aT              {- karoma$ap -}      `gloss`  [ "wrinkle", "crease", "pucker" ] ]
 ...
 |> "k r m l" <| [
    ...
    noun     KaRDaS |< Iy              {- karomaliy~ -}     `gloss`  [ "Carmelite [ [ karomaliy ~ / NOUN ] ]", "Carmelite [ [ karomaliy ~ / ADJ ] ]" ],
 ...
 |> "k r m n" <| [
    ...
    noun     KuRDAS                    {- kuromAn -}        `gloss`  [ "in honor of", "for the sake of [ [ kuromAn / ADV ] ]" ] ]
 ...
 |> "k r n f" <| [
    ...
    noun     KuRDAS |< aT              {- kuronAfap -}      `gloss`  [ "gunstock", "rifle butt" ] ]
 ...
 |> "k r r" <| [
    ...
    verb     FaCL                      {- kar~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "krur IV_C", "karar PV_C", "kurr IV_V" ]
                                                            `gloss`  [ "recur" ],
    ...
    noun     FuCCAL |< Iy |< aT        {- kur~Ariy~ap -}    `gloss`  [ "spool", "reel [ [ kur ~ Ariy ~ / NOUN ] ]" ],
 ...
 |> "k r s" <| [
    ...
    noun     MuFaCCaL                  {- mukar~as -}       `gloss`  [ "consecrated", "dedicated [ [ mukar ~ as / ADJ ] ]" ],

    -- ;; karuwsap_1
    -- krws    karuws  NapAt   state carriage;coach

    noun     FaCUL |< aT               {- karuwsap -}       `gloss`  [ "state carriage", "coach" ] ]
 ...
 |> "k r s f" <| [
    ...
    noun     KaRDaS |< aT              {- karosafap -}      `gloss`  [ "hamstringing", "hocking" ] ]
 ...
 |> "k r s y" <| [
    ...
    noun     KuRDIS                    {- kurosiy~ -}       -- `others` [ "karAsiy N0_Nh", "karAsiyy N", "karAs NK" ]
 ...
 |> "k r t n" <| [
    ...
    noun     KaRDaS |< aT              {- karotanap -}      `gloss`  [ "quarantine" ],
 ...
 |> "k r w" <| [
    ...
    verb     FaCA                      {- karA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "krY IV_0_Pass_yu", "kray IV_Ann_Pass_yu", "kar PV_ttAw", "kr IV_0hwnyn", "karaw PV_Atn", "kruw IV_0hAnn" ]
    ...
    noun     FuCY |< Iy                {- kurawiy~ -}       `gloss`  [ "soccer-related", "( sports ) ball-related [ [ kurawiy ~ / ADJ ] ]" ],

    -- ;; kurawiy~_2
    -- krwy    kurawiy~        N-ap    globular;spherical     [[kurawiy~/ADJ]]
    -- kwrwy   kuwrawiy~       N-ap    globular;spherical     [[kuwrawiy~/ADJ]]

    noun     FuCY |< Iy                {- kurawiy~ -}       -- `others` [ "kuwrawiyy N-ap" ]
                                                            `gloss`  [ "globular", "spherical [ [ kurawiy ~ / ADJ ] ]", "spherical [ [ kuwrawiy ~ / ADJ ] ]" ],

    -- ;; kurawiy~At_1
    -- krwy    kurawiy~        NAt     cocci;spherical bacteria     [[kurawiy~/NOUN]]

    noun     FuCY |< Iy |< At          {- kurawiy~At -}     -- `others` [ "kurawiyy NAt" ]
                                                            `gloss`  [ "cocci", "spherical bacteria [ [ kurawiy ~ / NOUN ] ]" ],

    -- ;; kurawiy~ap_1
    -- krwy    kurawiy~        Nap     sphericity;roundness     [[kurawiy~/NOUN]]

    noun     FuCY |< Iy |< aT          {- kurawiy~ap -}     `gloss`  [ "sphericity", "roundness [ [ kurawiy ~ / NOUN ] ]" ],
 ...
 |> "k r y" <| [
    ...
    noun     FuCayL |< aT              {- kuray~ap -}       `gloss`  [ "globule", "pellet", "corpuscle" ],
    ...
    verb     FaCY                      {- karaY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ "krY IV_0_Pass_yu", "kar PV_ttAw", "karA PV_h", "karay PV_Atn", "kr IV_0hwnyn", "kriy IV_0hAnn" ]
                                                            `gloss`  [ "excavate", "be excavated" ],
    ...
    verb     FaCiL                     {- kariy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "krY IV_0", "kray IV_Ann", "kar PV_w", "kra IV_0hwnyn" ]
                                                            `gloss`  [ "sleep" ],
    ...
    verb     HaFCY                     {- OakoraY -}        -- `others` [ "krY IV_0_Pass_yu", "'akr PV_ttAw", "kr IV_0hwnyn_yu", "'akrA PV_h", "'akray PV_Atn", "kray IV_Ann_Pass_yu", "kriy IV_0hAnn_yu" ]
                                                            `gloss`  [ "rent", "lease", "be rented", "be leased" ],
    ...
    noun     HiFCA'                    {- IikorA' -}        `gloss`  [ "renting", "leasing" ],
    ...
    noun     MuFCY                     {- mukoraY -}        -- `others` [ "mukray NAt NAn_Nayn", "mukrA Napdu Nhy" ]
 ...
 |> "k r z" <| [
    ...
    noun     FaCaL |< aT               {- karazap -}        `gloss`  [ "cherry tree" ],

    -- ;; karaziy~_1
    -- krzy    karaziy~        N-ap    cherry-red     [[karaziy~/ADJ]]

    noun     FaCaL |< Iy               {- karaziy~ -}       `gloss`  [ "cherry-red [ [ karaziy ~ / ADJ ] ]" ],
 ...
 |> "k s .h" <| [
    ...
    noun     FuCAL |< aT               {- kusAHap -}        `gloss`  [ "rubbish", "sweepings" ],
    ...
    noun     MiFCaL |< aT              {- mikosaHap -}      `gloss`  [ "broom", "sweeper" ],
    ...
    noun     FACiL |< aT               {- kAsiHap -}        -- `others` [ "kAsi.h NAt" ]
 ...
 |> "k s b" <| [
    ...
    verb     HaFCaL                    {- Oakosab -}        -- `others` [ "ksib IV_yu" ]
    ...
    noun     FuCL |< aT                {- kusobap -}        `gloss`  [ "kusba ( oil cake )" ],
    ...
    noun     HiFCAL                    {- IikosAb -}        `gloss`  [ "imparting to", "allowing to gain" ],
 ...
 |> "k s d" <| [
    ...
    verb     FaCaL                     {- kasad-u -}        `imperf` [ FCuL ]
                                                            -- `others` [ "kasud PV_intr", "ksud IV_intr" ]
    ...
    verb     HaFCaL                    {- Oakosad -}        -- `others` [ "ksid IV_intr_yu" ]
    ...
    noun     MuFACaL |< aT             {- mukAsadap -}      `gloss`  [ "dumping" ],

    -- ;; kAsid_1
    -- kAsd    kAsid   N-ap    stagnant;selling poorly;not in demand     [[kAsid/ADJ]]

    noun     FACiL                     {- kAsid -}          `gloss`  [ "stagnant", "selling poorly", "not in demand [ [ kAsid / ADJ ] ]" ],

    -- ;; kasiyd_1
    -- ksyd    kasiyd  N-ap    stagnant;selling poorly;not in demand     [[kasiyd/ADJ]]

    noun     FaCIL                     {- kasiyd -}         `gloss`  [ "stagnant", "selling poorly", "not in demand [ [ kasiyd / ADJ ] ]" ] ]
 ...
 |> "k s f" <| [
    ...
    noun     FACiL                     {- kAsif -}          `gloss`  [ "dejected", "gloomy [ [ kAsif / ADJ ] ]" ],

    -- ;; kasiyf_1
    -- ksyf    kasiyf  N/ap    dejected;gloomy     [[kasiyf/ADJ]]

    noun     FaCIL                     {- kasiyf -}         `gloss`  [ "dejected", "gloomy [ [ kasiyf / ADJ ] ]" ] ]
 ...
 |> "k s k s" <| [
    ...
    noun     KuRDuS                    {- kusokus -}        `gloss`  [ "couscous" ],

    -- ;; kusokusiy~_1
    -- ksksy   kusokusiy~      N-ap    couscous     [[kusokusiy~/ADJ]]

    noun     KuRDuS |< Iy              {- kusokusiy~ -}     `gloss`  [ "couscous [ [ kusokusiy ~ / ADJ ] ]" ],
 ...
 |> "k s l" <| [
    ...
    noun     MutaFACiL                 {- mutakAsil -}      `gloss`  [ "lazy [ [ mutakAsil / ADJ ] ]" ] ]
 ...
 |> "k s m" <| [
    ...
    noun     MuFaCCaL                  {- mukas~am -}       `gloss`  [ "well-shaped", "shapely [ [ mukas ~ am / ADJ ] ]" ] ]
 ...
 |> "k s r" <| [
    ...
    noun     FaCL |< aT                {- kasorap -}        `gloss`  [ "defeat", "collapse" ],

    -- ;; kasorap_2
    -- ksr     kasor   Napdu   kasra (Arabic short vowel "i")

    noun     FaCL |< aT                {- kasorap -}        `gloss`  [ "kasra ( Arabic short vowel `` i '' )" ],

    -- ;; kisorap_1
    -- ksr     kisor   NapAt   fragment;small piece

    noun     FiCL |< aT                {- kisorap -}        `gloss`  [ "fragment", "small piece" ],
    ...
    noun     FaCIL                     {- kasiyr -}         -- `others` [ "kasArA Nhy", "kasArY N0", "kasrA Nhy", "kasrY N0" ]
                                                            `gloss`  [ "broken", "fractured", "defeated [ [ kasiyr / ADJ ] ]", "defeated" ],

    -- ;; kas~Arap_1
    -- ksAr    kas~Ar  Nap     nutcracker

    noun     FaCCAL |< aT              {- kas~Arap -}       `gloss`  [ "nutcracker" ],
    ...
    noun     FuCayL |< aT              {- kusayorap -}      `gloss`  [ "diopter ( unit for measuring lens power )" ],
    ...
    noun     FACiL                     {- kAsir -}          -- `others` [ "kawAsir Ndip" ]
                                                            `gloss`  [ "predatory", "rapacious [ [ kAsir / ADJ ] ]", "rapacious" ],

    -- ;; makosuwr_1
    -- mkswr   makosuwr        Nall    broken;cracked     [[makosuwr/ADJ]]

    noun     MaFCUL                    {- makosuwr -}       `gloss`  [ "broken", "cracked [ [ makosuwr / ADJ ] ]" ],

    -- ;; makosuwr_2
    -- mkswr   makosuwr        Nall    defeated     [[makosuwr/ADJ]]

    noun     MaFCUL                    {- makosuwr -}       `gloss`  [ "defeated [ [ makosuwr / ADJ ] ]" ],

    -- ;; makosuwr_3
    -- mkswr   makosuwr        N-ap    bankrupt     [[makosuwr/ADJ]]

    noun     MaFCUL                    {- makosuwr -}       `gloss`  [ "bankrupt [ [ makosuwr / ADJ ] ]" ],

    -- ;; mukas~ar_1
    -- mksr    mukas~ar        N-ap    fragmented;broken     [[mukas~ar/ADJ]]

    noun     MuFaCCaL                  {- mukas~ar -}       `gloss`  [ "fragmented", "broken [ [ mukas ~ ar / ADJ ] ]" ],
    ...
    noun     FiCLY                     {- kisoraY -}        -- `others` [ "kisrA Nhy", "'akAsir Nap Ndip" ]
 ...
 |> "k s w" <| [
    ...
    verb     FaCA                      {- kasA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "ks IV_0hwnyn", "ksuw IV_0hAnn", "ksay IV_Ann_Pass_yu", "ksY IV_0_Pass_yu", "kasaw PV_Atn", "kas PV_ttAw" ]
    ...
    verb     HaFCY                     {- OakosaY -}        -- `others` [ "ks IV_0hwnyn_yu", "ksay IV_Ann_Pass_yu", "ksY IV_0_Pass_yu", "'aksA PV_h", "'aksay PV_Atn", "ksiy IV_0hAnn_yu", "'aks PV_ttAw" ]
                                                            `gloss`  [ "clothe", "attire", "be clothed", "be attired" ],
    ...
    noun     FiCL |< aT                {- kisowap -}        `gloss`  [ "kiswah ( Kaaba cover )" ],
    ...
    noun     FiCL |< aT                {- kisowap -}        -- `others` [ "kisA Nhy", "kisY N0", "kusA Nhy", "kasAwiy N0_Nh", "kusY N0", "kasAw NK" ]
    ...
    noun     FiCA'                     {- kisA' -}          -- `others` [ "'aksiy Nap" ]
                                                            `gloss`  [ "clothes", "garment" ] ]
 ...
 |> "k s y" <| [
    ...
    verb     FaCiL                     {- kasiy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "ksa IV_0hwnyn", "ksay IV_Ann", "ksY IV_0", "kas PV_w" ]
                                                            `gloss`  [ "get dressed" ],
 ...
 |> "k t ' b" <| [
    ...
    noun     KaRADiS |< Iy             {- katA}ibiy~ -}     `gloss`  [ "brigade", "corps [ [ katA } ibiy ~ / NOUN ] ]", "corps [ [ katA } ibiy ~ / ADJ ] ]" ],

    -- ;; katA}ibiy~_2
    -- ktA}by  katA}ibiy~      Nall    Phalangist     [[katA}ibiy~/NOUN]]
    -- ktA}by  katA}ibiy~      Nall    Phalangist     [[katA}ibiy~/ADJ]]

    noun     KaRADiS |< Iy             {- katA}ibiy~ -}     `gloss`  [ "Phalangist [ [ katA } ibiy ~ / NOUN ] ]", "Phalangist [ [ katA } ibiy ~ / ADJ ] ]" ] ]
 ...
 |> "k t .d" <| [
    ...
    verb     IFCaLL                    {- {ikotaD~ -}       -- `others` [ "kta.d.d IV_V_intr", "kta.di.d IV_C_intr", "ikta.da.d PV_C_intr" ]
                                                            `gloss`  [ "be overfilled", "be replete" ] ]
 ...
 |> "k t .z" <| [
    ...
    verb     IFCaLL                    {- {ikotaZ~ -}       -- `others` [ "kta.zi.z IV_C_intr", "ikta.za.z PV_C_intr", "kta.z.z IV_V_intr" ]
                                                            `gloss`  [ "be overcrowded", "be overstuffed" ],
    ...
    noun     IFCiLAL                   {- {ikotiZAZ -}      -- `others` [ "mukta.z.z N-ap" ]
                                                            `gloss`  [ "overcrowding", "overfilling", "overcrowded", "jam-packed [ [ mukotaZ ~ / ADJ ] ]" ] ]
 ...
 |> "k t ^s n" <| [
    ...
    noun     KuRDIS |< aT              {- kuto$iynap -}     `gloss`  [ "card game" ] ]
 ...
 |> "k t `" <| [
    ...
    noun     HaFCaL                    {- OakotaE -}        -- `others` [ "kut` N" ]
 ...
 |> "k t b" <| [
    ...
    verb     HaFCaL                    {- Oakotab -}        -- `others` [ "ktib IV_yu", "ktab IV_Pass_yu" ]
    ...
    noun     FuCuL |< Iy               {- kutubiy~ -}       `gloss`  [ "bookseller", "booksellers [ [ kutubiy ~ / NOUN ] ]" ],
    ...
    noun     FaCIL |< aT               {- katiybap -}       -- `others` [ "katA'ib Ndip" ]
    ...
    noun     MaFCaL |< Iy              {- makotabiy~ -}     `gloss`  [ "office [ [ makotabiy ~ / ADJ ] ]" ],

    -- ;; makotabap_1
    -- mktb    makotab NapAt   library;bookstore
    -- mkAtb   makAtib Ndip    libraries;bookstores

    noun     MaFCaL |< aT              {- makotabap -}      -- `others` [ "makAtib Ndip" ]
    ...
    noun     MuFACaL |< aT             {- mukAtabap -}      `gloss`  [ "correspondence" ],
    ...
    noun     IstiFCAL                  {- {isotikotAb -}    -- `others` [ "istiktAbiyy N-ap" ]
                                                            `gloss`  [ "dictation", "dictation [ [ { isotikotAbiy ~ / ADJ ] ]" ],
    ...
    noun     FACiL                     {- kAtib -}          `gloss`  [ "writing [ [ kAtib / ADJ ] ]" ],
 ...
 |> "k t d" <| [
    ...
    verb     IFCaLL                    {- {ikotad~ -}       -- `others` [ "ktadd IV_V", "iktadad PV_C", "ktadid IV_C" ]
                                                            `gloss`  [ "wear out", "overwork", "exhaust" ] ]
 ...
 |> "k t f" <| [
    ...
    noun     HaFCaL                    {- Oakotaf -}        -- `others` [ "kutf N", "katfA' Nh Nhy N0_Nh" ]
    ...
    noun     MutaFACiL                 {- mutakAtif -}      `gloss`  [ "mutually supportive", "in mutual solidarity [ [ mutakAtif / ADJ ] ]" ],
 ...
 |> "k t l" <| [
    ...
    noun     FuCL |< aT                {- kutolap -}        -- `others` [ "kutal N" ]
                                                            `gloss`  [ "bloc", "group", "blocs", "groups" ],

    -- ;; kutolawiy~_1
    -- ktlwy   kutolawiy~      Nall    bloc     [[kutolawiy~/ADJ]]

    noun     FuCLY |< Iy               {- kutolawiy~ -}     `gloss`  [ "bloc [ [ kutolawiy ~ / ADJ ] ]" ],
    ...
    noun     MutaFaCCiL                {- mutakat~il -}     `gloss`  [ "agglomerated", "forming blocs [ [ mutakat ~ il / ADJ ] ]" ] ]
 ...
 |> "k t m" <| [
    ...
    noun     FaCIL                     {- katiym -}         `gloss`  [ "shut tight", "sealed [ [ katiym / ADJ ] ]" ],

    -- ;; katuwm_1
    -- ktwm    katuwm  N-ap    secretive;silent     [[katuwm/ADJ]]

    noun     FaCUL                     {- katuwm -}         `gloss`  [ "secretive", "silent [ [ katuwm / ADJ ] ]" ],
 ...
 |> "k t n" <| [
    ...
    noun     FaCCAL |< Iy              {- kat~Aniy~ -}      `gloss`  [ "linen [ [ kat ~ Aniy ~ / ADJ ] ]" ],
    ...
    verb     IFCaLL                    {- {ikotan~ -}       -- `others` [ "ktanin IV_Cn_intr", "ktann IV_V_intr", "iktanan PV_Cn_intr" ]
                                                            `gloss`  [ "be concealed", "be hidden" ] ]
 ...
 |> "k t t" <| [
    ...
    verb     FaCL                      {- kat~-i -}         `imperf` [ FCiL ]
                                                            -- `others` [ "katat PV_Ct", "ktit IV_C", "kitt IV_V" ]
                                                            `gloss`  [ "hum softly" ],
 ...
 |> "k w ^s" <| [
    ...
    noun     FuCL |< aT                {- kuw$ap -}         -- `others` [ "kuwa^s N" ]
                                                            `gloss`  [ "kiln", "kilns" ] ]
 ...
 |> "k w _t" <| [
    ...
    noun     FaCL |< aT                {- kawovap -}        `gloss`  [ "abundance", "fertility" ] ]
 ...
 |> "k w b" <| [
    ...
    noun     FuCL                      {- kuwb -}           -- `others` [ "'akwAb N" ]
                                                            `gloss`  [ "cup", "glass", "cups", "glasses" ],

    -- ;; kuwbap_1
    -- kwb     kuwb    Napdu   cup;glass

    noun     FuCL |< aT                {- kuwbap -}         `gloss`  [ "cup", "glass" ],

    -- ;; kuwbiy~_1
    -- kwby    kuwbiy~ Nall    Cuban     [[kuwbiy~/NOUN]]
    -- kwby    kuwbiy~ Nall    Cuban     [[kuwbiy~/ADJ]]

    noun     FuCL |< Iy                {- kuwbiy~ -}        `gloss`  [ "Cuban [ [ kuwbiy ~ / NOUN ] ]", "Cuban [ [ kuwbiy ~ / ADJ ] ]" ],

    -- ;; kuwbiy~_1
    -- kwby    kuwbiy~ Nall    Cuban     [[kuwbiy~/NOUN]]
    -- kwby    kuwbiy~ Nall    Cuban     [[kuwbiy~/ADJ]]

    noun     FUL |< Iy                 {- kuwbiy~ -}        `gloss`  [ "Cuban [ [ kuwbiy ~ / NOUN ] ]", "Cuban [ [ kuwbiy ~ / ADJ ] ]" ] ]
 ...
 |> "k w d" <| [
    ...
    noun     FAL                       {- kAd -}            -- `others` [ "biAlkAd FW-Wa", "AlkAd FW-Wa" ]
                                                            `gloss`  [ "almost [ [ Al / DET+kAd / NOUN ] ]", "almost [ [ bi / PREP+Al / DET+kAd / NOUN ] ]" ],
    ...
    noun     FaCL |< aT                {- kawodap -}        -- `others` [ "'akwAd N" ]
                                                            `gloss`  [ "pile", "heap", "piles", "heaps" ],

    -- ;; kuwdiy~_1
    -- kwdy    kuwdiy~ N-ap    enciphered;encoded     [[kuwdiy~/ADJ]]

    noun     FuCL |< Iy                {- kuwdiy~ -}        `gloss`  [ "enciphered", "encoded [ [ kuwdiy ~ / ADJ ] ]" ] ]
 ...
 |> "k w f" <| [
    ...
    noun     FuCL |< aT                {- kuwfap -}         `gloss`  [ "Kufa", "Koufa ( Iraq )" ],

    -- ;; kuwfiy~_1
    -- kwfy    kuwfiy~ Nall    of/from Kufa (Iraq);Kufic     [[kuwfiy~/ADJ]]

    noun     FuCL |< Iy                {- kuwfiy~ -}        `gloss`  [ "of / from Kufa ( Iraq )", "Kufic [ [ kuwfiy ~ / ADJ ] ]" ],
    ...
    noun     FuCL |< Iy |< aT          {- kuwfiy~ap -}      `gloss`  [ "kaffiyeh [ [ kuwfiy ~ / NOUN ] ]" ] ]
 ...
 |> "k w k b" <| [
    ...
    noun     KaRDaS |< aT              {- kawokabap -}      `gloss`  [ "star" ],

    -- ;; kawokabiy~_1
    -- kwkby   kawokabiy~      Nall    stellar;planet     [[kawokabiy~/ADJ]]

    noun     KaRDaS |< Iy              {- kawokabiy~ -}     `gloss`  [ "stellar", "planet [ [ kawokabiy ~ / ADJ ] ]" ] ]
 ...
 |> "k w l n" <| [
    ...
    noun     KuRDAS                    {- kuwlAn -}         `gloss`  [ "papyrus" ],
 ...
 |> "k w m" <| [
    ...
    noun     FaCL |< aT                {- kawomap -}        -- `others` [ "kuwam N", "kuwm NapAt" ]
 ...
 |> "k w m r" <| [
    ...
    noun     KuRDAS                    {- kuwmAr -}         `gloss`  [ "Kumar" ] ]
 ...
 |> "k w n" <| [
    ...
    verb     FAL                       {- kAn -}            -- `others` [ "kuwn IV_V CV_V", "'akAn PV_V", "kun CV_C PV_Cn IV-n" ]
                                                            `gloss`  [ "was", "were", "whether ... was / were [ [ >a / INTERROG_PART+kAn / VERB_PERFECT+a / PVSUFF_SUBJ:3MS ] ]", "is", "are", "be" ],
    ...
    noun     FaCL |< Iy                {- kawoniy~ -}       `gloss`  [ "cosmic [ [ kawoniy ~ / ADJ ] ]" ],
    ...
    noun     MaFAL |< aT               {- makAnap -}        `gloss`  [ "position", "standing" ],

    -- ;; makAniy~_1
    -- mkAny   makAniy~        Nall    local     [[makAniy~/ADJ]]

    noun     MaFAL |< Iy               {- makAniy~ -}       `gloss`  [ "local [ [ makAniy ~ / ADJ ] ]" ],

    -- ;; makAniy~ap_1
    -- mkAny   makAniy~        Nap     spatiality     [[makAniy~/NOUN]]

    noun     MaFAL |< Iy |< aT         {- makAniy~ap -}     `gloss`  [ "spatiality [ [ makAniy ~ / NOUN ] ]" ],
    ...
    noun     TaFCIL |< Iy              {- takowiyniy~ -}    `gloss`  [ "formative [ [ takowiyniy ~ / ADJ ] ]" ],
    ...
    noun     FA'iL                     {- kA}in -}          `gloss`  [ "creature", "living being" ],
 ...
 |> "k w r" <| [
    ...
    noun     FuCL |< aT                {- kuwrap -}         -- `others` [ "kuwar N" ]
                                                            `gloss`  [ "small village" ],
    ...
    noun     FuCAL |< aT               {- kuwArap -}        -- `others` [ "kawA'ir Ndip" ]
    ...
    noun     MuFaCCaL                  {- mukaw~ar -}       `gloss`  [ "spherical [ [ mukaw ~ ar / ADJ ] ]" ] ]
 ...
 |> "k w r ^g" <| [
    ...
    noun     KaRDaS |< aT              {- kawrajap -}       `gloss`  [ "bulk", "wholesale" ] ]
 ...
 |> "k w r l" <| [
    ...
    noun     KuRDAS                    {- kuwrAl -}         `gloss`  [ "choir" ],
 ...
 |> "k w r y" <| [
    ...
    noun     KaRADiS                   {- kawAriy -}        `gloss`  [ "Kawari" ],

    -- ;; kuwriy~ap_1
    -- kwry    kuwriy~ Napdu   Korea

    noun     KuRDIS |< aT              {- kuwriy~ap -}      `gloss`  [ "Korea" ],

    -- ;; kuwriy~_1
    -- kwry    kuwriy~ Nall    Korean     [[kuwriy~/NOUN]]
    -- kwry    kuwriy~ Nall    Korean     [[kuwriy~/ADJ]]

    noun     KuRDIS                    {- kuwriy~ -}        `gloss`  [ "Korean [ [ kuwriy ~ / NOUN ] ]", "Korean [ [ kuwriy ~ / ADJ ] ]" ] ]
 ...
 |> "k w s" <| [
    ...
    noun     HaFCaL                    {- Oakowas -}        `gloss`  [ "prettier / prettiest" ] ]
 ...
 |> "k w t" <| [
    ...
    noun     FuCayL |< Iy              {- kuwayotiy~ -}     `gloss`  [ "Kuwaiti [ [ kuwayotiy ~ / NOUN ] ]", "Kuwaiti [ [ kuwayotiy ~ / ADJ ] ]" ],

    -- ;; kuwt_1
    -- kwt     kuwt    N0      Cote

    noun     FuCL                      {- kuwt -}           `gloss`  [ "Cote" ] ]
 ...
 |> "k w w" <| [
    ...
    noun     FuCL |< aT                {- kuw~ap -}         -- `others` [ "kuwY N0", "kuwA Nhy", "kiwA' Nh Nhy N0_Nh" ]
    ...
    noun     FUL |< aT                 {- kuw~ap -}         -- `others` [ "kuwY N0", "kuwA Nhy", "kiwA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "aperture", "skylight", "apertures", "skylights" ] ]
 ...
 |> "k w y" <| [
    ...
    verb     FaCY                      {- kawaY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ "kw IV_0hwnyn", "kwiy IV_0hAnn", "kawA PV_h", "kaw PV_ttAw", "kwY IV_0_Pass_yu", "kaway PV_Atn" ]
    ...
    noun     FY |< Iy |< aT            {- kawiy~ap -}       `gloss`  [ "crease [ [ kawiy ~ / NOUN ] ]" ],
    ...
    noun     MiFCY |< aT               {- mikowAp -}        -- `others` [ "makwA Nhy", "makway NAn_Nayn", "makAwiy N0_Nh", "makAw NK", "makwY N0" ]
    ...
    noun     MaFCY                     {- makowaY -}        -- `others` [ "makwA Nhy", "makway NAn_Nayn" ]
 ...
 |> "k y d" <| [
    ...
    verb     FAL                       {- kAd-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "kiyd IV_V", "kid PV_C IV_C" ]
                                                            `gloss`  [ "deceive", "harm" ],
    ...
    noun     FaCL |< Iy                {- kayodiy~ -}       `gloss`  [ "deceptive", "deceitful", "fraudulent [ [ kayodiy ~ / ADJ ] ]" ],

    -- ;; makiydap_1
    -- mkyd    makiyd  Napdu   stratagem;ruse;conspiracy
    -- mkAyd   makAyid Ndip    stratagems;ruses;schemes

    noun     MaFIL |< aT               {- makiydap -}       -- `others` [ "makAyid Ndip" ]
 ...
 |> "k y f" <| [
    ...
    noun     FaCL |< Iy                {- kayofiy~ -}       `gloss`  [ "arbitrary", "optional", "qualitative [ [ kayofiy ~ / ADJ ] ]" ],

    -- ;; kayofiy~ap_1
    -- kyfy    kayofiy~        Nap     manner;mode;way     [[kayofiy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- kayofiy~ap -}     `gloss`  [ "manner", "mode", "way [ [ kayofiy ~ / NOUN ] ]" ],
    ...
    noun     MuFaCCiL |< aT            {- mukay~ifap -}     `gloss`  [ "air conditioner" ],
 ...
 |> "k y f n" <| [
    ...
    noun     KiRDiS                    {- kiyfin -}         `gloss`  [ "Kevin" ] ]
 ...
 |> "k y k" <| [
    ...
    noun     FaCL |< aT                {- kayokap -}        -- `others` [ "kayAkiy N0" ]
                                                            `gloss`  [ "egg", "eggs" ],
    ...
    noun     FiCL |< aT                {- kiykap -}         -- `others` [ "kiykA N0" ]
                                                            `gloss`  [ "game of tag" ],

    -- ;; kiykap_2
    -- kyk     kiyk    Nap     cake

    noun     FiCL |< aT                {- kiykap -}         `gloss`  [ "cake" ] ]
 ...
 |> "k y l" <| [
    ...
    verb     FAL                       {- kAl-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "kiyl IV_V", "kil PV_C IV_C" ]
                                                            `gloss`  [ "measure" ],
    ...
    noun     FaCL |< aT                {- kayolap -}        `gloss`  [ "keila ( dry measure )" ],
    ...
    noun     FaCL |< Iy                {- kayoliy~ -}       -- `others` [ "makiyl N" ]
                                                            `gloss`  [ "measurable", "volumetrical [ [ kayoliy ~ / ADJ ] ]", "volumetric" ],
    ...
    noun     MiFCaL |< aT              {- mikoyalap -}      -- `others` [ "makAyil Ndip" ]
 ...
 |> "k y l y" <| [
    ...
    noun     KiRDiS                    {- kiyliy -}         `gloss`  [ "Kelly" ] ]
 ...
 |> "k y n" <| [
    ...
    noun     IstiFAL |< aT             {- {isotikAnap -}    `gloss`  [ "submission", "resignation" ],

    -- ;; musotakiyn_1
    -- mstkyn  musotakiyn      Nall    submissive;resigned;humble

    noun     MustaFiCL                 {- musotakiyn -}     `gloss`  [ "submissive", "resigned", "humble" ],
 ...
 |> "k y n y" <| [
    ...
    noun     KiRDIS                    {- kiyniy~ -}        `gloss`  [ "Kenyan [ [ kiyniy ~ / NOUN ] ]", "Kenyan [ [ kiyniy ~ / ADJ ] ]" ] ]
 ...
 |> "k y s" <| [
    ...
    verb     FAL                       {- kAs-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "kiys IV_V_intr", "kis IV_C_intr PV_C_intr" ]
                                                            `gloss`  [ "be clever" ],
    ...
    noun     FaCCiL                    {- kay~is -}         -- `others` [ "kaysA Nhy", "kiyAs N", "kaysY N0", "'akyAs N" ]
                                                            `gloss`  [ "astute", "elegant [ [ kay ~ is / ADJ ] ]", "elegant" ],

    -- ;; kiyAsap_1
    -- kyAs    kiyAs   Nap     adroitness;elegance

    noun     FiCAL |< aT               {- kiyAsap -}        `gloss`  [ "adroitness", "elegance" ],
    ...
    noun     HaFCaL                    {- Oakoyas -}        -- `others` [ "kiysay NAt", "kiysY N0", "kiys N", "kiysA Nhy" ]
                                                            `gloss`  [ "smart", "sly [ [ >akoyas / ADJ ] ]", "sly" ],
    ...
    noun     MuFaCCaL                  {- mukay~as -}       `gloss`  [ "shrewd", "astute [ [ mukay ~ as / ADJ ] ]" ] ]
 ...
 |> "k y t y" <| [
    ...
    noun     KiRDiS                    {- kiytiy -}         `gloss`  [ "Kitty" ] ]
 ...
 |> "k y y" <| [
    ...
    noun     FaCL |< aT                {- kay~ap -}         `gloss`  [ "burn", "brand" ] ]
 ...
 |> "k z k z" <| [
    ...
    noun     KaRDaS |< aT              {- kazokazap -}      `gloss`  [ "gnashing of teeth" ] ]
 ...
 |> "k z z" <| [
    ...
    verb     FaCL                      {- kaz~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "kazuz PV_C", "kuzz IV_V", "kzuz IV_C" ]
    ...
    noun     FaCAL |< aT               {- kazAzap -}        `gloss`  [ "dryness", "stinginess" ] ]
 ...
 |> "kAbiyn" <| [
    ...
    noun     Identity |< aT            {- kAbiynap -}       -- `others` [ "kabA'in Ndip" ]
 ...
 |> "kAbul" <| [
    ...
    noun     Identity |< Iy            {- kAbuliy~ -}       -- `others` [ "kAbuwliyy Nall" ]
                                                            `gloss`  [ "of / from Kabul [ [ kAbuliy ~ / NOUN ] ]", "of / from Kabul [ [ kAbuliy ~ / ADJ ] ]" ],
    ...
    noun     Identity |< Iy            {- kAbuliy~ -}       -- `others` [ "kAbuwliyy N0" ]
                                                            `gloss`  [ "Kabuli [ [ kAbuliy ~ / NOUN ] ]", "Kabuli [ [ kAbuliy ~ / ADJ ] ]" ] ]
 ...
 |> "kAliyfuwrniyy" <| [
    ...
    noun     Identity                  {- kAliyfuwroniy~ -} `gloss`  [ "Californian [ [ kAliyfuwroniy ~ / NOUN ] ]", "Californian [ [ kAliyfuwroniy ~ / ADJ ] ]" ] ]
 ...
 |> "kAmbuwdiyy" <| [
    ...
    noun     Identity                  {- kAmobuwdiy~ -}    -- `others` [ "kambuwdiyy Nall", "kambuwd^g N0" ]
                                                            `gloss`  [ "Cambodian", "Kampuchean [ [ kAmobuwdiy ~ / NOUN ] ]", "Kampuchean [ [ kAmobuwdiy ~ / ADJ ] ]", "Kampuchean [ [ kamobuwdiy ~ / NOUN ] ]", "Kampuchean [ [ kamobuwdiy ~ / ADJ ] ]", "Cambodians", "Kampucheans" ] ]
 ...
 |> "kAnkuwn" <| [
    ...
    noun     Identity                  {- kAnokuwn -}       `gloss`  [ "Cancun" ] ]
 ...
 |> "kAriykAtuwr" <| [
    ...
    noun     Identity |< Iy            {- kAriykAtuwriy~ -} -- `others` [ "kAriykAtiyriyy Nall" ]
                                                            `gloss`  [ "caricature", "cartoon [ [ kAriykAtuwriy ~ / ADJ ] ]", "cartoon [ [ kAriykAtiyriy ~ / ADJ ] ]" ] ]
 ...
 |> "kAtidrA'" <| [
    ...
    noun     Identity |< Iy |< aT      {- kAtidrA}iy~ap -}  `gloss`  [ "cathedral [ [ kAtidrA } iy ~ / NOUN ] ]" ] ]
 ...
 |> "kAzA_hstAn" <| [
    ...
    noun     Identity |< Iy            {- kAzAxostAniy~ -}  -- `others` [ "kAza_hstAniyy Nall" ]
                                                            `gloss`  [ "Kazakhstani [ [ kAzAxostAniy ~ / NOUN ] ]", "Kazakhstani [ [ kAzAxostAniy ~ / ADJ ] ]", "Kazakhstani [ [ kAzaxostAniy ~ / NOUN ] ]", "Kazakhstani [ [ kAzaxostAniy ~ / ADJ ] ]" ] ]
 ...
 |> "kahanuwt" <| [
    ...
    noun     Identity |< Iy            {- kahanuwtiy~ -}    `gloss`  [ "priestly", "sacerdotal [ [ kahanuwtiy ~ / ADJ ] ]" ],

    -- ;; kahanuwtiy~ap_1
    -- khnwty  kahanuwtiy~     Nap     priesthood     [[kahanuwtiy~/NOUN]]

    noun     Identity |< Iy |< aT      {- kahanuwtiy~ap -}  `gloss`  [ "priesthood [ [ kahanuwtiy ~ / NOUN ] ]" ] ]
 ...
 |> "kahra.tiys" <| [
    ...
    noun     Identity |< Iy            {- kahoraTiysiy~ -}  `gloss`  [ "electromagnetic [ [ kahoraTiysiy ~ / ADJ ] ]", "electromagnetism [ [ kahoraTiysiy ~ / NOUN ] ]" ] ]
 ...
 |> "kahrabA'" <| [
    ...
    noun     Identity |< Iy            {- kahorabA}iy~ -}   `gloss`  [ "electrician [ [ kahorabA } iy ~ / ADJ ] ]" ] ]
 ...
 |> "kahramAn" <| [
    ...
    noun     Identity                  {- kahoramAn -}      -- `others` [ "kahramAniyy N-ap" ]
                                                            `gloss`  [ "amber", "amber [ [ kahoramAniy ~ / ADJ ] ]" ] ]
 ...
 |> "kamAn^g" <| [
    ...
    noun     Identity |< Iy            {- kamAnojiy~ -}     `gloss`  [ "violinist", "fiddler [ [ kamAnojiy ~ / ADJ ] ]" ] ]
 ...
 |> "kambiyAl" <| [
    ...
    noun     Identity |< aT            {- kamobiyAlap -}    `gloss`  [ "bill of exchange", "loan payment" ] ]
 ...
 |> "kambyuwtiriyy" <| [
    ...
    noun     Identity                  {- kamobyuwtiriy~ -} -- `others` [ "kuwmbyuwtiriyy Nall" ]
                                                            `gloss`  [ "computer [ [ kamobyuwtiriy ~ / ADJ ] ]", "computer [ [ kuwmobyuwtiriy ~ / ADJ ] ]" ] ]
 ...
 |> "karAfatt" <| [
    ...
    noun     Identity |< aT            {- karAfat~ap -}     `gloss`  [ "necktie" ] ]
 ...
 |> "karAri.t" <| [
    ...
    noun     Identity |< Iy            {- karAriTiy~ -}     `gloss`  [ "carrier", "drayman [ [ karAriTiy ~ / ADJ ] ]" ] ]
 ...
 |> "kar_hAn^g" <| [
    ...
    noun     Identity |< Iy            {- karoxAnojiy~ -}   `gloss`  [ "artisan", "worker [ [ karoxAnojiy ~ / ADJ ] ]" ] ]
 ...
 |> "karnAfAl" <| [
    ...
    noun     Identity |< Iy            {- karonAfAliy~ -}   `gloss`  [ "carnival-related", "carnival-like [ [ karonAfAliy ~ / ADJ ] ]" ] ]
 ...
 |> "karriy.t" <| [
    ...
    noun     Identity |< aT            {- kar~iyTap -}      -- `others` [ "karAri.t Ndip" ]
                                                            `gloss`  [ "cart", "wagon", "carts", "wagons" ] ]
 ...
 |> "kasaruwn" <| [
    ...
    noun     Identity |< aT            {- kasaruwnap -}     `gloss`  [ "casserole" ] ]
 ...
 |> "kastanA'" <| [
    ...
    noun     Identity |< Iy            {- kasotanA}iy~ -}   `gloss`  [ "chestnut-colored", "maroon [ [ kasotanA } iy ~ / ADJ ] ]" ] ]
 ...
 |> "kaylA" <| [
    ...
    noun     Identity                  {- kayolA -}         -- `others` [ "likaylA FW-Wa" ]
                                                            `gloss`  [ "in order not to [ [ kayolA / CONJ ] ]", "in order not to [ [ likayolA / CONJ ] ]" ] ]
 ...
 |> "kaymA" <| [
    ...
    noun     Identity                  {- kaymA -}          -- `others` [ "likaymA FW-Wa" ]
                                                            `gloss`  [ "in order to [ [ kayomA / CONJ ] ]", "in order to [ [ likayomA / CONJ ] ]" ] ]
 ...
 |> "kayta" <| [
    ...
    noun     Identity                  {- kayota -}         `gloss`  [ "such", "thus [ [ kayota / ADV ] ]" ] ]
 ...
 |> "kazaruwn" <| [
    ...
    noun     Identity |< aT            {- kazaruwnap -}     `gloss`  [ "casserole" ] ]
 ...
 |> "killimAn" <| [
    ...
    noun     Identity |< Iy            {- kil~imAniy~ -}    `gloss`  [ "eloquent [ [ kil ~ imAniy ~ / ADJ ] ]" ] ]
 ...
 |> "kirsinn" <| [
    ...
    noun     Identity |< aT            {- kirosin~ap -}     -- `others` [ "kirsann N" ]
                                                            `gloss`  [ "vetch ( plant )" ] ]
 ...
 |> "kitAb_hAn" <| [
    ...
    noun     Identity |< aT            {- kitAboxAnap -}    -- `others` [ "kutub_hAn NapAt" ]
 ...
 |> "kiymiyA'iyyA.t" <| [
    ...
    noun     Identity                  {- kiymiyA}iy~AT -}  -- `others` [ "kiymiyAwiyy NAt", "kiymiyA'iyy NAt" ]
                                                            `gloss`  [ "chemicals [ [ kiymiyA } iy ~ / NOUN ] ]", "chemicals [ [ kiymiyAwiy ~ / NOUN ] ]" ] ]
 ...
 |> "km" <| [
    ...
    noun     Identity                  {- km -}             `gloss`  [ "kilometer ( s ) [ [ km / ABBREV ] ]" ] ]
 ...
 |> "kruwk" <| [
    ...
    noun     Identity |< Iy            {- kruwkiy~ -}       `gloss`  [ "sketch [ [ kruwkiy ~ / NOUN ] ]" ] ]
 ...
 |> "kruwn" <| [
    ...
    noun     Identity |< aT            {- kruwnap -}        `gloss`  [ "krone" ] ]
 ...
 |> "kuhayrib" <| [
    ...
    noun     Identity |< Iy            {- kuhayoribiy~ -}   `gloss`  [ "electron [ [ kuhayoribiy ~ / ADJ ] ]" ] ]
 ...
 |> "kuhna^g" <| [
    ...
    noun     Identity |< Iy            {- kuhonajiy~ -}     `gloss`  [ "ragman", "rag picker [ [ kuhonajiy ~ / ADJ ] ]" ] ]
 ...
 |> "kulAwiyy" <| [
    ...
    noun     Identity                  {- kulAwiy~ -}       `gloss`  [ "renal", "kidney [ [ kalAwiy ~ / ADJ ] ]" ] ]
 ...
 |> "kundar^g" <| [
    ...
    noun     Identity |< Iy            {- kunodarojiy~ -}   `gloss`  [ "cobbler [ [ kunodarojiy ~ / ADJ ] ]" ] ]
 ...
 |> "kunfidrAl" <| [
    ...
    noun     Identity |< Iy            {- kunofidrAliy~ -}  -- `others` [ "kunfiydrAliyy Nall", "kuwnfidrAliyy Nall", "kuwnfiydrAliyy Nall" ]
                                                            `gloss`  [ "confederate [ [ kunofidrAliy ~ / ADJ ] ]", "confederate [ [ kuwnofidrAliy ~ / ADJ ] ]", "confederate [ [ kunofiydrAliy ~ / ADJ ] ]", "confederate [ [ kuwnofiydrAliy ~ / ADJ ] ]" ],
    ...
    noun     Identity |< Iy |< aT      {- kunofidrAliy~ap -} -- `others` [ "kunfiydrAliyy Nap", "kuwnfidrAliyy Nap", "kuwnfiydrAliyy Nap" ]
 ...
 |> "kurantiyn" <| [
    ...
    noun     Identity |< aT            {- kuranotiynap -}   `gloss`  [ "quarantine" ] ]
 ...
 |> "kurdistAn" <| [
    ...
    noun     Identity |< Iy            {- kurodisotAniy~ -} `gloss`  [ "Kurdistani [ [ kurodisotAniy ~ / NOUN ] ]", "Kurdistani [ [ kurodisotAniy ~ / ADJ ] ]" ] ]
 ...
 |> "kuriyy" <| [
    ...
    noun     Identity                  {- kuriy~ -}         `gloss`  [ "globular", "spherical [ [ kuriy ~ / ADJ ] ]" ] ]
 ...
 |> "kuruwAt" <| [
    ...
    noun     Identity |< Iy            {- kuruwAtiy~ -}     `gloss`  [ "Croatian", "Croat [ [ kuruwAtiy ~ / NOUN ] ]", "Croat [ [ kuruwAtiy ~ / ADJ ] ]" ] ]
 ...
 |> "kusbar" <| [
    ...
    noun     Identity |< aT            {- kusobarap -}      -- `others` [ "kusbur Nap" ]
                                                            `gloss`  [ "coriander" ] ]
 ...
 |> "kuwAfiyr" <| [
    ...
    noun     Identity |< aT            {- kuwAfiyrap -}     `gloss`  [ "lady hairdresser" ] ]
 ...
 |> "kuwhlir" <| [
    ...
    noun     Identity                  {- kuwholir -}       `gloss`  [ "Kohler", "Koehler" ] ]
 ...
 |> "kuwmisyuwn^g" <| [
    ...
    noun     Identity |< Iy            {- kuwmisyuwnjiy~ -} `gloss`  [ "commission merchant [ [ kuwmisywnjiy ~ / ADJ ] ]" ] ]
 ...
 |> "kuwmiydiyy" <| [
    ...
    noun     Identity                  {- kuwmiydiy~ -}     `gloss`  [ "comic", "comedic [ [ kuwmiydiy ~ / ADJ ] ]" ] ]
 ...
 |> "kuwmsAr" <| [
    ...
    noun     Identity |< Iy            {- kuwmosAriy~ -}    `gloss`  [ "conductor", "ticket man", "conductors", "ticket men [ [ kuwmsAriy ~ / NOUN ] ]" ] ]
 ...
 |> "kuwn.guwl" <| [
    ...
    noun     Identity |< Iy            {- kuwnoguwliy~ -}   `gloss`  [ "Congolese [ [ kuwnoguwliy ~ / NOUN ] ]", "Congolese [ [ kuwnoguwliy ~ / ADJ ] ]" ] ]
 ...
 |> "kuwnt" <| [
    ...
    noun     Identity |< Iy |< aT      {- kuwnotiy~ap -}    `gloss`  [ "county" ] ]
 ...
 |> "kuwstAriyk" <| [
    ...
    noun     Identity |< Iy            {- kuwsotAriykiy~ -} `gloss`  [ "Costa Rican [ [ kuwsotAriykiy ~ / NOUN ] ]", "Costa Rican [ [ kuwsotAriykiy ~ / ADJ ] ]" ] ]
 ...
 |> "kuwt^siyn" <| [
    ...
    noun     Identity |< aT            {- kuwto$iynap -}    `gloss`  [ "card game" ] ]
 ...
 |> "kuzbar" <| [
    ...
    noun     Identity |< aT            {- kuzobarap -}      -- `others` [ "kuzbur Nap" ]
                                                            `gloss`  [ "coriander" ] ]
 ...
 |> "makruh" <| [
    ...
    noun     Identity |< aT            {- makoruhap -}      `gloss`  [ "hatred", "abhorrence" ] ]
 ...
 |> "makrum" <| [
    ...
    noun     Identity |< aT            {- makorumap -}      -- `others` [ "makArim Ndip" ]
 ...
 |> "makwa^giyy" <| [
    ...
    noun     Identity                  {- makowajiy~ -}     `gloss`  [ "ironing man", "laundryman [ [ makowajiy ~ / ADJ ] ]" ] ]
 ...
 |> "muk.hul" <| [
    ...
    noun     Identity |< aT            {- mukoHulap -}      -- `others` [ "makA.hil Ndip" ]
 ...
 |> "mukayyisAt" <| [
    ...
    noun     Identity |< Iy            {- mukay~isAtiy~ -}  `gloss`  [ "bath attendant", "masseur [ [ mukay ~ isAtiy ~ / ADJ ] ]" ] ]
 ...
 |> "mukfahirr" <| [
    ...
    noun     Identity                  {- mukofahir~ -}     `gloss`  [ "overcast", "gloomy", "melancholic [ [ mukofahir ~ / ADJ ] ]" ] ]
 ...
 |> "takrAr" <| [
    ...
    noun     Identity |< Iy            {- takorAriy~ -}     `gloss`  [ "repeated", "frequent [ [ takorAriy ~ / ADJ ] ]" ] ]
 ...
 |> "tikillAm" <| [
    ...
    noun     Identity                  {- tikil~Am -}       `gloss`  [ "eloquent", "garrulous [ [ tikil ~ Am / ADJ ] ]" ] ]
