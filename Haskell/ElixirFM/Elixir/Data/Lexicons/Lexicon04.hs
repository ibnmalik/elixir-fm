...
lexicon = listing "Lexicon properties"
 ...
 |> "AlAi_tnA" <| [
    ...
    noun     Identity                  {- Al{ivonA -}       -- `others` [ "AlAi_tnay FW-Wa" ]
                                                            `gloss`  [ "the + ( 1st word in `` twelve '' ) [ [ Al / DET+ { ivon / ADJ+A / NSUFF_MASC_DU_NOM_POSS ] ]", "the + ( 1st word in `` twelve '' ) [ [ Al / DET+ { ivon / ADJ+ayo / NSUFF_MASC_DU_ACCGEN_POSS ] ]" ] ]
 ...
 |> "AlAi_tnAni" <| [
    ...
    noun     Identity                  {- Al{ivonAni -}     -- `others` [ "AlAi_tnayni FW-Wa" ]
                                                            `gloss`  [ "the + two [ [ Al / DET+ { ivon / ADJ+Ani / NSUFF_MASC_DU_NOM ] ]", "the + two [ [ Al / DET+ { ivon / ADJ+ayoni / NSUFF_MASC_DU_ACCGEN ] ]" ] ]
 ...
 |> "AlAi_tnatA" <| [
    ...
    noun     Identity                  {- Al{ivonatA -}     -- `others` [ "AlAi_tnatay FW-Wa" ]
                                                            `gloss`  [ "the + ( 1st word in `` twelve '' ) [ [ Al / DET+ { ivon / ADJ+A / NSUFF_FEM_DU_NOM_POSS ] ]", "the + ( 1st word in `` twelve '' ) [ [ Al / DET+ { ivon / ADJ+atayo / NSUFF_FEM_DU_ACCGEN_POSS ] ]" ] ]
 ...
 |> "AlAi_tnatAni" <| [
    ...
    noun     Identity                  {- Al{ivonatAni -}   -- `others` [ "AlAi_tnatayni FW-Wa" ]
                                                            `gloss`  [ "the + two [ [ Al / DET+ { ivon / ADJ+atAni / NSUFF_FEM_DU_NOM ] ]", "the + two [ [ Al / DET+ { ivon / ADJ+atayoni / NSUFF_FEM_DU_ACCGEN ] ]" ] ]
 ...
 |> "_t ' r" <| [
    ...
    verb     HaFCaL                    {- OavoOar -}        -- `others` [ "_t'ir IV_yu" ]
    ...
    verb     IFtaCaL                   {- {iv~aOar -}       -- `others` [ "_t_ta'ir IV" ]
                                                            `gloss`  [ "take revenge", "be avenged" ],
    ...
    verb     IstaFCaL                  {- {isotavoOar -}    -- `others` [ "sta_t'ir IV" ]
    ...
    noun     FACiL |< aT               {- vA}irap -}        -- `others` [ "_tawA'ir Ndip" ]
                                                            `gloss`  [ "tumult", "rage" ] ]
 ...
 |> "_t ' y" <| [
    ...
    noun     FaCY                      {- vaOaY -}          -- `others` [ "_ta'A Nh" ]
                                                            `gloss`  [ "scars" ] ]
 ...
 |> "_t .g '" <| [
    ...
    noun     FuCAL                     {- vugA' -}          `gloss`  [ "bleating" ] ]
 ...
 |> "_t .g w" <| [
    ...
    verb     FaCA                      {- vagA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "_t.g IV_0hwnyn", "_t.guw IV_0hAnn", "_ta.gaw PV_Atn", "_ta.ga PV_ttAw" ]
                                                            `gloss`  [ "bleat" ],
 ...
 |> "_t ^g ^g" <| [
    ...
    verb     FaCL                      {- vaj~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "_tu^g^g IV_V_intr", "_ta^ga^g PV_C_intr", "_t^gu^g IV_C_intr" ]
                                                            `gloss`  [ "flow", "stream" ],
 ...
 |> "_t _h n" <| [
    ...
    verb     HaFCaL                    {- Oavoxan -}        -- `others` [ "_t_han IV-n_Pass_yu", "_t_hin IV-n_yu" ]
    ...
    noun     FaCAL |< aT               {- vaxAnap -}        `gloss`  [ "thickness", "density" ],

    -- ;; vuxuwnap_1
    -- vxwn    vuxuwn  Nap     thickness;density

    noun     FuCUL |< aT               {- vuxuwnap -}       `gloss`  [ "thickness", "density" ],
 ...
 |> "_t ` b n" <| [
    ...
    noun     KuRDAS |< Iy              {- vuEobAniy~ -}     `gloss`  [ "serpentine", "snakelike [ [ vuEobAniy ~ / ADJ ] ]" ] ]
 ...
 |> "_t ` l" <| [
    ...
    noun     FuCAL |< aT               {- vuEAlap -}        `gloss`  [ "fox", "vixen" ] ]
 ...
 |> "_t ` l b" <| [
    ...
    noun     KaRDaS |< Iy              {- vaEolabiy~ -}     `gloss`  [ "fox-like [ [ vaEolabiy ~ / ADJ ] ]" ] ]
 ...
 |> "_t b n" <| [
    ...
    noun     FuCL |< aT                {- vubonap -}        -- `others` [ "_tibAn N", "_tuban N" ]
    ...
    noun     MaFCaL |< aT              {- mavobanap -}      -- `others` [ "ma_tAbin Ndip" ]
 ...
 |> "_t b t" <| [
    ...
    noun     FaCAL |< Iy               {- vabAtiy~ -}       `gloss`  [ "stable", "static [ [ vabAtiy ~ / ADJ ] ]" ],

    -- ;; vabAtiy~ap_1
    -- vbAty   vabAtiy~        Nap     stability     [[vabAtiy~/NOUN]]

    noun     FaCAL |< Iy |< aT         {- vabAtiy~ap -}     `gloss`  [ "stability [ [ vabAtiy ~ / NOUN ] ]" ],
    ...
    noun     HaFCaL                    {- Oavobat -}        `gloss`  [ "more / most reliable", "steadier" ],
    ...
    noun     HiFCAL |< Iy              {- IivobAtiy~ -}     `gloss`  [ "confirmatory [ [" ],
 ...
 |> "_t f l" <| [
    ...
    verb     HaFCaL                    {- Oavofal -}        -- `others` [ "_tfil IV_yu" ]
 ...
 |> "_t f n" <| [
    ...
    noun     FiCL |< aT                {- vifonap -}        -- `others` [ "_tifan N" ]
 ...
 |> "_t k l" <| [
    ...
    verb     HaFCaL                    {- Oavokal -}        -- `others` [ "_tkil IV_yu" ]
                                                            `gloss`  [ "bereave" ],
 ...
 |> "_t l ^g" <| [
    ...
    verb     HaFCaL                    {- Oavolaj -}        -- `others` [ "_tli^g IV_yu" ]
                                                            `gloss`  [ "snow", "freeze" ],
    ...
    noun     FaCL |< Iy                {- valojiy~ -}       `gloss`  [ "snowy", "icy [ [ valojiy ~ / ADJ ] ]" ],
    ...
    noun     MaFCaL |< aT              {- mavolajap -}      -- `others` [ "ma_tAli^g Ndip" ]
 ...
 |> "_t l _t" <| [
    ...
    noun     FACUL                     {- vAluwv -}         `gloss`  [ "triad", "trinity" ],
    ...
    noun     TaFCIL |< Iy              {- tavoliyviy~ -}    `gloss`  [ "trigonometrical [ [ tavoliyviy ~ / ADJ ] ]" ],
 ...
 |> "_t l _t n" <| [
    ...
    noun     KaRADIS |< Iy             {- valAviyniy~ -}    `gloss`  [ "thirties [ [ valAviyniy ~ / NOUN ] ]" ] ]
 ...
 |> "_t l b" <| [
    ...
    noun     MaFCaL |< aT              {- mavolabap -}      -- `others` [ "ma_tAlib Ndip" ]
 ...
 |> "_t l l" <| [
    ...
    verb     FaCL                      {- val~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "_talal PV_C", "_tull IV_V", "_tlul IV_C" ]
 ...
 |> "_t l m" <| [
    ...
    noun     FuCL |< aT                {- vulomap -}        -- `others` [ "_tulam N" ]
 ...
 |> "_t m l" <| [
    ...
    verb     HaFCaL                    {- Oavomal -}        -- `others` [ "_tmal IV_Pass_yu", "_tmil IV_yu" ]
    ...
    noun     FaCaL |< aT               {- vamalap -}        `gloss`  [ "intoxication" ],
 ...
 |> "_t m n" <| [
    ...
    noun     FuCL |< aT                {- vumonap -}        -- `others` [ "_tuman NAt" ]
 ...
 |> "_t m n y" <| [
    ...
    noun     KaRADiS                   {- vamAniy -}        -- `others` [ "_tamAn Numb NK" ]
 ...
 |> "_t m r" <| [
    ...
    noun     IstiFCAL |< Iy            {- {isotivomAriy~ -} `gloss`  [ "investment [ [ { isotivomAriy ~ / ADJ ] ]" ],
 ...
 |> "_t n '" <| [
    ...
    noun     FaCAL                     {- vanA' -}          `gloss`  [ "appreciation", "praise" ],
    ...
    noun     InFiCAL |< aT             {- {inovinA'ap -}    `gloss`  [ "bend", "curve" ],
 ...
 |> "_t n ' y" <| [
    ...
    noun     KaRADIS                   {- vanA}iy~ -}       `gloss`  [ "laudatory", "eulogistic [ [ vanA } iy ~ / ADJ ] ]" ] ]
 ...
 |> "_t n d w" <| [
    ...
    noun     KuRDuS |< aT              {- vunoduwap -}      -- `others` [ "_tanAdiy N0_Nh", "_tanAd NK" ]
                                                            `gloss`  [ "breast", "breasts" ] ]
 ...
 |> "_t n n" <| [
    ...
    noun     FuCL |< aT                {- vun~ap -}         -- `others` [ "_tunan N" ]
    ...
    verb     FaCLY                     {- van~aY -}         -- `others` [ "_tannA PV_h", "_tannay PV_Atn IV_Ann_Pass_yu", "_tann IV_0hwnyn_yu PV_ttAw", "_tanniy IV_0hAnn_yu" ]
 ...
 |> "_t n y" <| [
    ...
    noun     FaCY |< Iy                {- vanawiy~ -}       `gloss`  [ "dualist [ [ vanawiy ~ / ADJ ] ]" ],

    -- ;; vanawiy~ap_1
    -- vnwy    vanawiy~        NapAt   dualism     [[vanawiy~/NOUN]]

    noun     FaCY |< Iy |< aT          {- vanawiy~ap -}     `gloss`  [ "dualism [ [ vanawiy ~ / NOUN ] ]" ],
    ...
    verb     HaFCY                     {- OavonaY -}        -- `others` [ "'a_tnay PV_Atn", "_tn IV_0hwnyn_yu", "_tnay IV_Ann_Pass_yu", "'a_tn PV_ttAw", "_tniy IV_0hAnn_yu", "'a_tnA PV_h", "_tnY IV_0_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- vanoyap -}        -- `others` [ "_tanay NAt" ]
    ...
    noun     FaCIL |< aT               {- vaniy~ap -}       `gloss`  [ "incisor", "path [ [ vaniy ~ / NOUN ] ]" ],
    ...
    noun     TaFCiL |< aT              {- tavoniyap -}      `gloss`  [ "repetition", "praise" ],
    ...
    noun     InFiCA'                   {- {inovinA' -}      `gloss`  [ "folding", "bending" ],

    -- ;; {inovinA'ap_1
    -- <nvnA'  {inovinA'       NapAt   bend;curve
    -- AnvnA'  {inovinA'       NapAt   bend;curve

    noun     InFiCA' |< aT             {- {inovinA'ap -}    `gloss`  [ "bend", "curve" ],
    ...
    noun     IstiFCA'                  {- {isotivonA' -}    `gloss`  [ "exception", "exclusion", "exceptions", "exclusions" ],
    ...
    noun     MuFaCCY                   {- muvan~aY -}       -- `others` [ "mu_tannA Napdu Nhy", "mu_tann Nuwn_Niyn", "mu_tannay NAt NAn_Nayn" ]
    ...
    noun     MustaFCY                  {- musotavonaY -}    -- `others` [ "musta_tn Nuwn_Niyn", "musta_tnay NAt NAn_Nayn", "musta_tnA Napdu Nhy" ]
 ...
 |> "_t q b" <| [
    ...
    verb     FaCaL                     {- vaqab-u -}        `imperf` [ FCuL ]
                                                            -- `others` [ "_tuqib PV_Pass", "_tqub IV" ]
    ...
    verb     HaFCaL                    {- Oavoqab -}        -- `others` [ "_tqab IV_Pass_yu", "_tqib IV_yu" ]
    ...
    noun     FuCL |< aT                {- vuqobap -}        -- `others` [ "_tuqab N" ]
    ...
    noun     FaCCAL |< aT              {- vaq~Abap -}       `gloss`  [ "drilling rig", "drilling machine" ],

    -- ;; <ivoqAb_1
    -- <vqAb   <ivoqAb NduAt   lighting;kindling
    -- AvqAb   <ivoqAb NduAt   lighting;kindling

    noun     HiFCAL                    {- IivoqAb -}        `gloss`  [ "lighting", "kindling" ],
 ...
 |> "_t q f" <| [
    ...
    noun     MuFACaL |< aT             {- muvAqafap -}      `gloss`  [ "fencing", "swordplay" ],
 ...
 |> "_t q l" <| [
    ...
    verb     HaFCaL                    {- Oavoqal -}        -- `others` [ "_tqal IV_Pass_yu", "_tqil IV_yu" ]
    ...
    noun     HaFCaL                    {- Oavoqal -}        `gloss`  [ "heavier", "more oppressive" ],
 ...
 |> "_t r r" <| [
    ...
    verb     FaCL                      {- var~-ui -}        `imperf` [ FCuL, FCiL ]
                                                            -- `others` [ "_turr IV_V", "_trir IV_C", "_tarar PV_C", "_trur IV_C", "_tirr IV_V" ]
 ...
 |> "_t r t" <| [
    ...
    verb     HaFCY                     {- OavoraY -}        -- `others` [ "_tray IV_Ann_Pass_yu", "_tr IV_0hwnyn_yu", "_trY IV_0_Pass_yu", "'a_tr PV_ttAw", "'a_trA PV_h", "_triy IV_0hAnn_yu", "'a_tray PV_Atn" ]
 ...
 |> "_t r y" <| [
    ...
    verb     FaCiL                     {- variy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "_tray IV_Ann", "_tar PV_w_intr", "_tra IV_0hwnyn", "_trY IV_0" ]
                                                            `gloss`  [ "become wealthy" ],

    -- ;; vuray~ap_1
    -- vry     vuray~  NapAt   chandelier

    noun     FuCayL |< aT              {- vuray~ap -}       `gloss`  [ "chandelier" ] ]
 ...
 |> "_t w b" <| [
    ...
    verb     FAL                       {- vAb-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "_tuwb IV_V", "_tub PV_C IV_C" ]
    ...
    verb     HaFAL                     {- OavAb -}          -- `others` [ "'a_tab PV_C", "_tiyb IV_V_yu", "_tab IV_C_Pass_yu", "_tAb IV_V_Pass_yu", "_tib IV_C_yu" ]
    ...
    noun     MaFCaL |< aT              {- mavowabap -}      -- `others` [ "ma_tAwib Ndip" ]
    ...
    verb     FaCY                      {- vawaY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ "_tw IV_0hwnyn", "_twY IV_0", "_tawA PV_h", "_twiy IV_0hAnn", "_taw PV_ttAw", "_taway PV_Atn" ]
    ...
    verb     HaFCY                     {- OavowaY -}        -- `others` [ "_tway IV_Ann_Pass_yu", "_twY IV_0_Pass_yu", "'a_twA PV_h", "_tw IV_0hwnyn_yu", "'a_tway PV_Atn", "'a_tw PV_ttAw", "_twiy IV_0hAnn_yu" ]
                                                            `gloss`  [ "reside", "lodge", "be housed", "be lodged" ],

    -- ;; vawiy~_1
    -- vwy     vawiy~  Ndu     guest room

    noun     FY |< Iy                  {- vawiy~ -}         `gloss`  [ "guest room" ],

    -- ;; vuwaY_1
    -- vwY     vuwaY   N0      road-signs;signposts
    -- vwA     vuwA    Nhy     road-signs;signposts

    noun     FuCY                      {- vuwaY -}          -- `others` [ "_tuwA Nhy" ]
    ...
    noun     MaFCY                     {- mavowaY -}        -- `others` [ "ma_tway NAn_Nayn", "ma_tAw NK", "ma_tAwiy N0_Nh", "ma_twA Nhy" ]
 ...
 |> "_t w r" <| [
    ...
    noun     FaCLY |< Iy               {- vaworawiy~ -}     `gloss`  [ "revolutionary [ [ vaworawiy ~ / ADJ ] ]" ],
    ...
    noun     FA'iL                     {- vA}ir -}          -- `others` [ "_tuwwAr N" ]
                                                            `gloss`  [ "insurgent", "insurgents", "revolutionaries" ],
    ...
    noun     FA'iL |< aT               {- vA}irap -}        -- `others` [ "_tawA'ir Ndip" ]
                                                            `gloss`  [ "tumult", "rage" ],
    ...
    noun     MuFIL |< At               {- muviyrAt -}       -- `others` [ "mu_tiyr NAt" ]
                                                            `gloss`  [ "stimulants" ] ]
 ...
 |> "_t w w" <| [
    ...
    noun     FuCL |< aT                {- vuw~ap -}         `gloss`  [ "road sign", "signpost" ],

    -- ;; vuw~ap_1
    -- vw      vuw~    Nap     road sign;signpost

    noun     FUL |< aT                 {- vuw~ap -}         `gloss`  [ "road sign", "signpost" ],
    ...
    verb     FaCLY                     {- vaw~aY -}         -- `others` [ "_tawway PV_Atn IV_Ann_Pass_yu", "_tawwA PV_h", "_tawwiy IV_0hAnn_yu", "_taww IV_0hwnyn_yu PV_ttAw" ]
                                                            `gloss`  [ "give lodging", "provide housing", "be given lodging", "be housed" ] ]
 ...
 |> "_tamAnimA'" <| [
    ...
    noun     Identity |< aT            {- vamAnimA}ap -}    `gloss`  [ "eight-hundred" ] ]
 ...
 |> "_tu'abA'" <| [
    ...
    noun     Identity                  {- vuWabA' -}        `gloss`  [ "yawning", "fatigue" ] ]
 ...
 |> "_tu'luwl" <| [
    ...
    noun     Identity                  {- vuWoluwl -}       -- `others` [ "_ta'Aliyl Ndip" ]
                                                            `gloss`  [ "wart", "warts" ] ]
 ...
 |> "biAlAi_tnatay" <| [
    ...
    noun     Identity                  {- biAl{ivonatayo -} `gloss`  [ "with / by + the + ( 1st word in `` twelve '' ) [ [ bi / PREP+Al / DET+ { ivon / ADJ+atayo / NSUFF_FEM_DU_ACCGEN_POSS ] ]" ] ]
 ...
 |> "biAlAi_tnatayni" <| [
    ...
    noun     Identity                  {- biAl{ivonatayoni -} `gloss`  [ "with / by + the + two [ [ bi / PREP+Al / DET+ { ivon / ADJ+atayoni / NSUFF_FEM_DU_ACCGEN ] ]" ] ]
 ...
 |> "biAlAi_tnay" <| [
    ...
    noun     Identity                  {- biAl{ivonayo -}   `gloss`  [ "with / by + the + ( 1st word in `` twelve '' ) [ [ bi / PREP+Al / DET+ { ivon / ADJ+ayo / NSUFF_MASC_DU_ACCGEN_POSS ] ]" ] ]
 ...
 |> "biAlAi_tnayni" <| [
    ...
    noun     Identity                  {- biAl{ivonayoni -} `gloss`  [ "with / by + the + two [ [ bi / PREP+Al / DET+ { ivon / ADJ+ayoni / NSUFF_MASC_DU_ACCGEN ] ]" ] ]
 ...
 |> "i_tnA" <| [
    ...
    noun     Identity                  {- {ivonA -}         -- `others` [ "i_tnay FW-WaBi" ]
                                                            `gloss`  [ "( 1st word in `` twelve '' ) [ [ { ivon / ADJ+A / NSUFF_MASC_DU_NOM_POSS ] ]", "( 1st word in `` twelve '' ) [ [ { ivon / ADJ+ayo / NSUFF_MASC_DU_ACCGEN_POSS ] ]" ] ]
 ...
 |> "i_tnAni" <| [
    ...
    noun     Identity                  {- {ivonAni -}       -- `others` [ "i_tnayni FW-WaBi" ]
                                                            `gloss`  [ "two [ [ { ivon / ADJ+Ani / NSUFF_MASC_DU_NOM ] ]", "two [ [ { ivon / ADJ+ayoni / NSUFF_MASC_DU_ACCGEN ] ]" ] ]
 ...
 |> "i_tnatA" <| [
    ...
    noun     Identity                  {- {ivonatA -}       -- `others` [ "i_tnatay FW-WaBi" ]
                                                            `gloss`  [ "( 1st word in `` twelve '' ) [ [ { ivon / ADJ+atA / NSUFF_FEM_DU_NOM_POSS ] ]", "( 1st word in `` twelve '' ) [ [ { ivon / ADJ+atayo / NSUFF_FEM_DU_ACCGEN_POSS ] ]" ] ]
 ...
 |> "i_tnatAni" <| [
    ...
    noun     Identity                  {- {ivonatAni -}     -- `others` [ "i_tnatayni FW-WaBi" ]
                                                            `gloss`  [ "two [ [ { ivon / ADJ+atAni / NSUFF_FEM_DU_NOM ] ]", "two [ [ { ivon / ADJ+atayoni / NSUFF_FEM_DU_ACCGEN ] ]" ] ]
 ...
 |> "isti_tnA'iyy" <| [
    ...
    noun     Identity                  {- {isotivonA}iy~ -} `gloss`  [ "exceptional", "extraordinary [ [ { isotivonA } iy ~ / ADJ ] ]" ] ]
 ...
 |> "kaAlAi_tnatay" <| [
    ...
    noun     Identity                  {- kaAl{ivonatayo -} `gloss`  [ "as / like + the + ( 1st word in `` twelve '' ) [ [ ka / PREP+Al / DET+ { ivon / ADJ+atayo / NSUFF_FEM_DU_ACCGEN_POSS ] ]" ] ]
 ...
 |> "kaAlAi_tnatayni" <| [
    ...
    noun     Identity                  {- kaAl{ivonatayoni -} `gloss`  [ "as / like + the + two [ [ ka / PREP+Al / DET+ { ivon / ADJ+atayoni / NSUFF_FEM_DU_ACCGEN ] ]" ] ]
 ...
 |> "kaAlAi_tnay" <| [
    ...
    noun     Identity                  {- kaAl{ivonayo -}   `gloss`  [ "as / like + the + ( 1st word in `` twelve '' ) [ [ ka / PREP+Al / DET+ { ivon / ADJ+ayo / NSUFF_MASC_DU_ACCGEN_POSS ] ]" ] ]
 ...
 |> "kaAlAi_tnayni" <| [
    ...
    noun     Identity                  {- kaAl{ivonayoni -} `gloss`  [ "as / like + the + two [ [ ka / PREP+Al / DET+ { ivon / ADJ+ayoni / NSUFF_MASC_DU_ACCGEN ] ]" ] ]
 ...
 |> "lilAi_tnatay" <| [
    ...
    noun     Identity                  {- lil{ivonatayo -}  `gloss`  [ "to / for + the + ( 1st word in `` twelve '' ) [ [ li / PREP+Al / DET+ { ivon / ADJ+atayo / NSUFF_FEM_DU_ACCGEN_POSS ] ]" ] ]
 ...
 |> "lilAi_tnatayni" <| [
    ...
    noun     Identity                  {- lilo{ivonatayoni -} `gloss`  [ "to / for + the + two [ [ li / PREP+Al / DET+ { ivon / ADJ+atayoni / NSUFF_FEM_DU_ACCGEN ] ]" ] ]
 ...
 |> "lilAi_tnay" <| [
    ...
    noun     Identity                  {- lil{ivonayo -}    `gloss`  [ "to / for + the + ( 1st word in `` twelve '' ) [ [ li / PREP+Al / DET+ { ivon / ADJ+ayo / NSUFF_MASC_DU_ACCGEN_POSS ] ]" ] ]
 ...
 |> "lilAi_tnayni" <| [
    ...
    noun     Identity                  {- lilo{ivonayoni -} `gloss`  [ "to / for + the + two [ [ li / PREP+Al / DET+ { ivon / ADJ+ayoni / NSUFF_MASC_DU_ACCGEN ] ]" ] ]
 ...
 |> "ta_ta'lal" <| [
    ...
    verb     Identity                  {- tavaOolal -}      `gloss`  [ "be covered with warts" ] ]
