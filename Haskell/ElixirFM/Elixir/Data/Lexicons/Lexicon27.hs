...
lexicon = listing "Lexicon properties"
 ...
 |> "wAbuwr" <| [
    ...
    noun     Identity                  {- wAbuwr -}         `gloss`  [ "steam engine" ] ]
 ...
 |> "w.h" <| [
    ...
    noun     FAL |< aT                 {- wAHap -}          `others` [ "wA.h NAt Napdu" ]
                                                            `gloss`  [ "oasis", "oases" ] ]
 ...
 |> "w'd" <| [
    ...
    verb     FaCaL                     {- wa>ad -}          `others` [ "w'ad IV_Pass_yu", "wu'id PV_Pass", "'id IV" ]
    ...
    verb     TaFaCCaL                  {- tawa>~ad -}       `gloss`  [ "slow down", "hesitate" ] ]
 ...
 |> "itta'ad" <| [
    ...
    verb     Identity                  {- {it~a>ad -}       `others` [ "tta'id IV" ]
 ...
 |> "tu'ad" <| [
    ...
    noun     Identity |< aT            {- tu&adap -}        `others` [ "tu'ad Nap" ]
                                                            `gloss`  [ "slowness", "unhurried" ],
 ...
 |> "w'r" <| [
    ...
    verb     FaCaL                     {- wa>ar -}          `others` [ "'ir IV", "w'ar IV_Pass_yu", "wu'ir PV_Pass" ]
    ...
    verb     IstaFCaL                  {- {isotawo>ar -}    `others` [ "staw'ir IV_intr" ]
                                                            `gloss`  [ "be frightened" ],

    -- ;; wa>or_1
    -- w>r     wa>or   N       frightening

    noun     FaCL                      {- wa>or -}          `gloss`  [ "frightening" ] ]
 ...
 |> "wb'" <| [
    ...
    verb     FaCiL                     {- wabi}-a -}        `imperf` [ FCaL ]
                                                            `others` [ "wba'A IV-|", "wba' IV_wn IV_intr IV_yn", "wabi' PV_intr" ]
    ...
    verb     FaCuL                     {- wabu&-u -}        `imperf` [ FCuL ]
                                                            `others` [ "wabu' PV_intr", "wbu' IV_intr IV_yn" ]
                                                            `gloss`  [ "be diseased", "be infested" ],
    ...
    noun     FaCaL                     {- waba> -}          `others` [ "'awbA' Nh Nhy N0_Nh", "waba'A N-|" ]
    ...
    noun     FaCAL |< Iy               {- wabA}iy~ -}       `gloss`  [ "epidemical", "plague-like" ],

    -- ;; wabi}_1
    -- wb}     wabi}   Nall    plague-stricken;infested     [[wabi}/ADJ]]

    noun     FaCiL                     {- wabi} -}          `gloss`  [ "plague-stricken", "infested" ],
    ...
    noun     FaCIL                     {- wabiy' -}         `gloss`  [ "plague-stricken", "infested" ],
    ...
    noun     MaFCUL                    {- mawobuw' -}       `gloss`  [ "plague-stricken", "infested" ] ]
 ...
 |> "wb_h" <| [
    ...
    noun     MuFaCCiL                  {- muwab~ix -}       `gloss`  [ "reprimanding", "rebuking" ] ]
 ...
 |> "wbr" <| [
    ...
    verb     FaCiL                     {- wabir-a -}        `imperf` [ FCaL ]
                                                            `others` [ "wbar IV_intr", "wabir PV_intr" ]
                                                            `gloss`  [ "be hirsute" ],
    ...
    noun     FaCaL |< Iy               {- wabariy~ -}       `gloss`  [ "terry", "toweling" ],
    ...
    noun     HaFCaL                    {- >awobar -}        `others` [ "wabrA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "hairy", "fluffy" ],

    -- ;; muwab~ar_1
    -- mwbr    muwab~ar        N-ap    woolly     [[muwab~ar/ADJ]]

    noun     MuFaCCaL                  {- muwab~ar -}       `gloss`  [ "woolly" ] ]
 ...
 |> "wb^s" <| [
    ...
    noun     HaFCAL                    {- >awobA$ -}        `gloss`  [ "riffraf", "rabble" ] ]
 ...
 |> "wbq" <| [
    ...
    verb     FaCiL                     {- wabiq-a -}        `imperf` [ FCaL ]
                                                            `others` [ "wabiq PV_intr", "wbaq IV_intr" ]
                                                            `gloss`  [ "perish" ],
    ...
    verb     HaFCaL                    {- >awobaq -}        `others` [ "wbiq IV_yu", "wbaq IV_Pass_yu" ]
    ...
    noun     MuFCiL |< aT              {- muwbiqap -}       `others` [ "muwbiq NapAt" ]
                                                            `gloss`  [ "grave offense", "mortal sin" ] ]
 ...
 |> "wbl" <| [
    ...
    verb     FaCuL                     {- wabul-u -}        `imperf` [ FCuL ]
                                                            `others` [ "wbul IV_intr", "wabul PV_intr" ]
 ...
 |> "wbh" <| [
    ...
    verb     FaCaL                     {- wabah-a -}        `imperf` [ FCaL ]
                                                            `others` [ "wabah PV", "wabih PV", "wbah IV" ]
    ...
    verb     HaFCaL                    {- >awobah -}        `others` [ "wbih IV_yu", "wbah IV_Pass_yu" ]
 ...
 |> "wtr" <| [
    ...
    verb     HaFCaL                    {- >awotar -}        `others` [ "wtir IV_yu", "wtar IV_Pass_yu" ]
    ...
    noun     FaCL                      {- wator -}          `gloss`  [ "separately", "one by one" ],

    -- ;; watoriy~_1
    -- wtry    watoriy~        N-ap    uneven number;odd number     [[watoriy~/ADJ]]

    noun     FaCL |< Iy                {- watoriy~ -}       `gloss`  [ "uneven number", "odd number" ],
    ...
    noun     FaCaL |< Iy               {- watariy~ -}       `gloss`  [ "stringed", "string" ],

    -- ;; watiyrap_1
    -- wtyr    watiyr  Napdu   manner;method;style
    -- wtA}r   watA}ir Ndip    manner;method;style

    noun     FaCIL |< aT               {- watiyrap -}       `others` [ "watiyr Napdu", "watA'ir Ndip" ]
 ...
 |> "tatrY" <| [
    ...
    noun     MutaFaCCiL                {- mutawat~ir -}     `gloss`  [ "strained", "tense" ],
    ...
    noun     MutaFACiL                 {- mutawAtir -}      `gloss`  [ "continuous" ] ]
 ...
 |> "w_t'" <| [
    ...
    verb     FaCaL                     {- wava>-a -}        `imperf` [ FCaL ]
                                                            `others` [ "wa_ta' PV-> PV_w", "_ta'A IV-|", "wa_ta'A PV-|", "_ta' IV IV_wn IV_yn" ]
                                                            `gloss`  [ "bruise", "sprain" ],
    ...
    verb     HaFCaL                    {- >awova> -}        `others` [ "'aw_ta'A PV-|", "w_ta' IV_Pass_yu", "w_ti' IV_yu" ]
 ...
 |> "w_tb" <| [
    ...
    verb     HaFCaL                    {- >awovab -}        `others` [ "w_tab IV_Pass_yu", "w_tib IV_yu" ]
    ...
    noun     FaCL |< aT                {- wavobap -}        `others` [ "wa_tab NAt", "wa_tb Napdu" ]
    ...
    noun     MutaFaCCiL                {- mutawav~ib -}     `gloss`  [ "vigorous", "energetic" ] ]
 ...
 |> "w_tr" <| [
    ...
    verb     FaCuL                     {- wavur-u -}        `imperf` [ FCuL ]
                                                            `others` [ "w_tur IV_intr", "wa_tur PV_intr" ]
                                                            `gloss`  [ "be soft" ],
 ...
 |> "miy_tar" <| [
    ...
    noun     Identity |< aT            {- miyvarap -}       `others` [ "mayA_tiq Ndip", "mawA_tir Ndip", "miy_tar Napdu" ]
 ...
 |> "w_tq" <| [
    ...
    verb     FaCiL                     {- waviq-ia -}       `imperf` [ FCiL, FCaL ]
                                                            `others` [ "_tiq IV", "w_taq IV_Pass_yu", "wa_tiq PV" ]
    ...
    verb     HaFCaL                    {- >awovaq -}        `others` [ "w_taq IV_Pass_yu", "w_tiq IV_yu" ]
 ...
 |> "w_tq" <| [
    ...
    noun     CiL |< aT                 {- viqap -}          `others` [ "_tiq Nap" ]
 ...
 |> "w_tq" <| [
    ...
    noun     FaCAL |< aT               {- wavAqap -}        `others` [ "wa_tAq Nap" ]
    ...
    noun     FaCIL                     {- waviyq -}         `others` [ "wi_tAq N" ]
                                                            `gloss`  [ "secure", "reliable" ],

    -- ;; waviyqap_1
    -- wvyq    waviyq  Napdu   document;charter
    -- wvA}q   wavA}iq Ndip    documents;charters

    noun     FaCIL |< aT               {- waviyqap -}       `others` [ "wa_tA'iq Ndip", "wa_tiyq Napdu" ]
 ...
 |> "wa_tA'iq" <| [
    ...
    noun     Identity |< Iy            {- wavA}iqiy~ -}     `gloss`  [ "documentary", "document" ],
    ...
    noun     HaFCaL                    {- >awovaq -}        `gloss`  [ "firmer / firmest", "stronger / strongest" ],
 ...
 |> "w_tq" <| [
    ...
    noun     MICAL |< Iy               {- miyvAqiy~ -}      `gloss`  [ "treaty", "pact", "charter" ] ]
 ...
 |> "w_tq" <| [
    ...
    noun     TaFCiL |< aT              {- tawoviqap -}      `others` [ "taw_tiq Nap" ]
                                                            `gloss`  [ "security", "guaranty" ],

    -- ;; wAviq_1
    -- wAvq    wAviq   Nall    certain;confident     [[wAviq/ADJ]]

    noun     FACiL                     {- wAviq -}          `gloss`  [ "certain", "confident" ],

    -- ;; mawovuwq_1
    -- mwvwq   mawovuwq        N-ap    trusted;reliable     [[mawovuwq/ADJ]]

    noun     MaFCUL                    {- mawovuwq -}       `gloss`  [ "trusted", "reliable" ],
 ...
 |> "w_tn" <| [
    ...
    noun     FaCaL |< Iy               {- wavaniy~ -}       `gloss`  [ "pagan", "idolatrous" ],

    -- ;; wavaniy~ap_1
    -- wvny    wavaniy~        Nap     idolatry     [[wavaniy~/NOUN]]

    noun     FaCaL |< Iy |< aT         {- wavaniy~ap -}     `others` [ "wa_taniyy Nap" ]
                                                            `gloss`  [ "idolatry" ] ]
 ...
 |> "w^gb" <| [
    ...
    verb     FaCaL                     {- wajab-i -}        `imperf` [ FCiL ]
                                                            `others` [ "^gib IV_intr", "wa^gab PV_intr" ]
    ...
    verb     HaFCaL                    {- >awojab -}        `others` [ "w^gib IV_yu", "w^gab IV_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- wajobap -}        `others` [ "wa^gab NAt", "wa^gb Napdu" ]
 ...
 |> "w^gb" <| [
    ...
    noun     HICAL                     {- <iyjAb -}         `gloss`  [ "affirmative", "obligation", "compliance" ],

    -- ;; <iyjAbAF_1
    -- <yjAb   <iyjAb  NF      in accordance with     [[<iyjAb/ADV]]
    -- AyjAb   <iyjAb  NF      in accordance with     [[<iyjAb/ADV]]

    noun     HICAL |< aN               {- <iyjAbAF -}       `others` [ "'iy^gAb NF" ]
    ...
    noun     HICAL |< Iy |< aT         {- <iyjAbiy~ap -}    `others` [ "'iy^gAbiyy Nap" ]
                                                            `gloss`  [ "positive attitude", "positive nature" ] ]
 ...
 |> "w^gb" <| [
    ...
    noun     FACiL                     {- wAjib -}          `gloss`  [ "necessary", "incumbent", "obligatory" ],
    ...
    noun     MuFCiL |< aT              {- muwjibap -}       `others` [ "muw^gib Napdu" ]
                                                            `gloss`  [ "cause", "reason", "motive" ],
 ...
 |> "w^gd" <| [
    ...
    verb     FaCaL                     {- wajad-i -}        `imperf` [ FCiL ]
                                                            `others` [ "w^gad IV_Pass_yu", "^gid IV", "wu^gid PV_Pass", "wa^gad PV" ]
    ...
    verb     HaFCaL                    {- >awojad -}        `others` [ "w^gid IV_yu" ]
                                                            `gloss`  [ "find", "obtain" ],
 ...
 |> "w^gdn" <| [
    ...
    noun     FiCCAL                    {- wijodAn -}        `gloss`  [ "emotion", "conscience" ],

    -- ;; wijodAn_2
    -- wjdAn   wijodAn N0      Wijdan;Wigdan

    noun     FiCCAL                    {- wijodAn -}        `gloss`  [ "Wijdan", "Wigdan" ],

    -- ;; wijodAniy~_1
    -- wjdAny  wijodAniy~      N-ap    emotional;affective     [[wijodAniy~/ADJ]]

    noun     FiCCAL |< Iy              {- wijodAniy~ -}     `gloss`  [ "emotional", "affective" ] ]
 ...
 |> "w^gd" <| [
    ...
    noun     FuCUL |< Iy               {- wujuwdiy~ -}      `gloss`  [ "existential" ],

    -- ;; wujuwdiy~ap_1
    -- wjwdy   wujuwdiy~       Nap     existentialism     [[wujuwdiy~/NOUN]]

    noun     FuCUL |< Iy |< aT         {- wujuwdiy~ap -}    `others` [ "wu^guwdiyy Nap" ]
                                                            `gloss`  [ "existentialism" ],

    -- ;; mawojidap_1
    -- mwjd    mawojid Nap     feeling;emotion;resentment

    noun     MaFCiL |< aT              {- mawojidap -}      `others` [ "maw^gid Nap" ]
                                                            `gloss`  [ "feeling", "emotion", "resentment" ] ]
 ...
 |> "w^gd" <| [
    ...
    noun     HICAL                     {- <iyjAd -}         `gloss`  [ "discovery", "finding" ] ]
 ...
 |> "w^gr" <| [
    ...
    noun     FaCL |< aT                {- wajorap -}        `others` [ "wa^gr Nap", "wa^gar Nap" ]
                                                            `gloss`  [ "pitfall" ],
 ...
 |> "w^gz" <| [
    ...
    verb     FaCaL                     {- wajaz-i -}        `imperf` [ FCiL ]
                                                            `others` [ "^giz IV_intr", "wa^gaz PV_intr" ]
    ...
    verb     HaFCaL                    {- >awojaz -}        `others` [ "w^gaz IV_Pass_yu", "w^giz IV_intr_yu" ]
                                                            `gloss`  [ "be concise", "be brief", "summarize", "be summarized" ],

    -- ;; wajAzap_1
    -- wjAz    wajAz   Nap     brevity;conciseness

    noun     FaCAL |< aT               {- wajAzap -}        `others` [ "wa^gAz Nap" ]
                                                            `gloss`  [ "brevity", "conciseness" ],
    ...
    noun     FaCIL                     {- wajiyz -}         `gloss`  [ "short", "brief", "summarized" ] ]
 ...
 |> "w^gz" <| [
    ...
    noun     HICAL                     {- <iyjAz -}         `gloss`  [ "shortness", "brevity" ],
 ...
 |> "w^gs" <| [
    ...
    verb     FaCaL                     {- wajas-i -}        `imperf` [ FCiL ]
                                                            `others` [ "^gis IV_intr", "wa^gas PV_intr" ]
    ...
    verb     HaFCaL                    {- >awojas -}        `others` [ "w^gas IV_Pass_yu", "w^gis IV_intr_yu" ]
 ...
 |> "w^g`" <| [
    ...
    verb     HaFCaL                    {- >awojaE -}        `others` [ "w^gi` IV_yu", "w^ga` IV_Pass_yu" ]
                                                            `gloss`  [ "hurt", "be hurt" ],
    ...
    noun     FaCIL                     {- wajiyE -}         `gloss`  [ "painful", "grievous" ],
    ...
    noun     MaFCUL                    {- mawojuwE -}       `gloss`  [ "suffering", "feeling pain" ] ]
 ...
 |> "w^gf" <| [
    ...
    verb     FaCaL                     {- wajaf-i -}        `imperf` [ FCiL ]
                                                            `others` [ "wa^gaf PV_intr", "^gif IV_intr" ]
    ...
    verb     HaFCaL                    {- >awojaf -}        `others` [ "w^gaf IV_Pass_yu", "w^gif IV_yu" ]
 ...
 |> "w^gl" <| [
    ...
    verb     FaCiL                     {- wajil-a -}        `imperf` [ FCaL ]
                                                            `others` [ "w^gal IV_intr", "wa^gil PV_intr" ]
    ...
    verb     HaFCaL                    {- >awojal -}        `others` [ "w^gal IV_Pass_yu", "w^gil IV_yu" ]
 ...
 |> "w^gm" <| [
    ...
    verb     FaCaL                     {- wajam-i -}        `imperf` [ FCiL ]
                                                            `others` [ "wa^gam PV_intr", "^gim IV_intr" ]
 ...
 |> "w^gn" <| [
    ...
    noun     FaCL |< aT                {- wajonap -}        `others` [ "wa^gan NAt", "wa^gn Napdu" ]
                                                            `gloss`  [ "cheek", "cheeks" ] ]
 ...
 |> "w^gh" <| [
    ...
    noun     CiL |< aT                 {- jihap -}          `others` [ "^gih NAt NapAt" ]
 ...
 |> "^gihaw" <| [
    ...
    noun     Identity |< Iy            {- jihawiy~ -}       `gloss`  [ "provincial", "regional" ] ]
 ...
 |> "w^gh" <| [
    ...
    noun     FaCL |< Iy                {- wajohiy~ -}       `gloss`  [ "facial" ],
    ...
    noun     FiCL |< aT                {- wijohap -}        `others` [ "wu^guh NAt", "wi^gh Napdu", "wu^gh Napdu" ]
                                                            `gloss`  [ "point of view", "angle", "points of view", "angles" ],

    -- ;; wajAhap_1
    -- wjAh    wajAh   Nap     prestige;distinction

    noun     FaCAL |< aT               {- wajAhap -}        `others` [ "wa^gAh Nap" ]
                                                            `gloss`  [ "prestige", "distinction" ],

    -- ;; wijAhiy~_1
    -- wjAhy   wijAhiy~        N-ap    contradictory     [[wijAhiy~/ADJ]]

    noun     FiCAL |< Iy               {- wijAhiy~ -}       `gloss`  [ "contradictory" ],
    ...
    noun     FaCIL                     {- wajiyh -}         `others` [ "wu^gahA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "prominent", "distinguished", "socialites" ] ]
 ...
 |> "tu^gAha" <| [
    ...
    noun     TaFCIL |< Iy              {- tawojiyhiy~ -}    `gloss`  [ "directing", "guiding" ],

    -- ;; muwAjahap_1
    -- mwAjh   muwAjah Napdu   encounter;confrontation
    -- mwAjh   muwAjah NAt     encounters;confrontations

    noun     MuFACaL |< aT             {- muwAjahap -}      `others` [ "muwA^gah NAt Napdu" ]
 ...
 |> "itti^gAh" <| [
    ...
    noun     FACiL |< aT               {- wAjihap -}        `others` [ "wA^gih NapAt" ]
    ...
    noun     MuFaCCaL                  {- muwaj~ah -}       `gloss`  [ "directed", "aimed" ],
 ...
 |> "w.hd" <| [
    ...
    noun     CiL |< aT                 {- Hidap -}          `others` [ ".hid Nap" ]
 ...
 |> "w.hd" <| [
    ...
    noun     FaCL                      {- waHod -}          `gloss`  [ "alone", "only" ],

    -- ;; waHodap_1
    -- wHd     waHod   Nap     unity

    noun     FaCL |< aT                {- waHodap -}        `others` [ "wa.hd Nap" ]
                                                            `gloss`  [ "unity" ],
    ...
    noun     FaCL |< aT                {- waHodap -}        `gloss`  [ "Wahda", "Wihda" ],

    -- ;; waHodap_4
    -- wHd     waHod   Napdu   unit
    -- wHd     waHad   NAt     units

    noun     FaCL |< aT                {- waHodap -}        `others` [ "wa.had NAt", "wa.hd Napdu" ]
                                                            `gloss`  [ "unit", "units" ] ]
 ...
 |> "w.hdw" <| [
    ...
    noun     FaCCaL |< Iy              {- waHodawiy~ -}     `gloss`  [ "unionist" ] ]
 ...
 |> "w.hd" <| [
    ...
    noun     FaCLAn |< Iy              {- waHodAniy~ -}     `gloss`  [ "single", "individual" ],

    -- ;; waHodAniy~ap_1
    -- wHdAny  waHodAniy~      Nap     singleness;individualness     [[waHodAniy~/NOUN]]

    noun     FaCLAn |< Iy |< aT        {- waHodAniy~ap -}   `others` [ "wa.hdAniyy Nap" ]
                                                            `gloss`  [ "singleness", "individualness" ],
    ...
    noun     FaCIL                     {- waHiyd -}         `gloss`  [ "only", "sole", "alone", "exclusive" ],

    -- ;; >awoHad_1
    -- >wHd    >awoHad Nel     unique;singular
    -- AwHd    >awoHad Nel     unique;singular

    noun     HaFCaL                    {- >awoHad -}        `gloss`  [ "unique", "singular" ],
 ...
 |> "itti.hAd" <| [
    ...
    noun     Identity |< Iy            {- {it~iHAdiy~ -}    `gloss`  [ "unionist", "federal" ],

    -- ;; wAHid_1
    -- wAHd    wAHid   N-ap    one;single     [[wAHid/ADJ]]

    noun     FACiL                     {- wAHid -}          `gloss`  [ "one", "single" ],

    -- ;; wAHid_2
    -- wAHd    wAHid   N-ap    one     [[wAHid/NOUN]]

    noun     FACiL                     {- wAHid -}          `gloss`  [ "one" ],

    -- ;; wAHidiy~ap_1
    -- wAHdy   wAHidiy~        Nap     monism     [[wAHidiy~/NOUN]]

    noun     FACiL |< Iy |< aT         {- wAHidiy~ap -}     `others` [ "wA.hidiyy Nap" ]
                                                            `gloss`  [ "monism" ],

    -- ;; muwaH~ad_1
    -- mwHd    muwaH~ad        Nall    united;standardized     [[muwaH~ad/ADJ]]

    noun     MuFaCCaL                  {- muwaH~ad -}       `gloss`  [ "united", "standardized" ],

    -- ;; mutawaH~id_1
    -- mtwHd   mutawaH~id      Nall    solitary;isolated     [[mutawaH~id/ADJ]]

    noun     MutaFaCCiL                {- mutawaH~id -}     `gloss`  [ "solitary", "isolated" ] ]
 ...
 |> "mutta.hid" <| [
    ...
    noun     Identity                  {- mut~aHid -}       `gloss`  [ "united" ] ]
 ...
 |> "mutta.hid" <| [
    ...
    noun     Identity |< aT            {- mut~aHidap -}     `others` [ "mutta.hid Nap" ]
                                                            `gloss`  [ "United" ],
 ...
 |> "w.h^s" <| [
    ...
    verb     HaFCaL                    {- >awoHa$ -}        `others` [ "w.hi^s IV_intr_yu" ]
    ...
    noun     FaCL                      {- waHo$ -}          `gloss`  [ "wild", "deserted" ],
    ...
    noun     FaCL |< aT                {- waHo$ap -}        `others` [ "wa.h^s Nap" ]
                                                            `gloss`  [ "loneliness", "desolation" ],

    -- ;; waHo$iy~_1
    -- wH$y    waHo$iy~        Nall    brutal;savage     [[waHo$iy~/ADJ]]

    noun     FaCL |< Iy                {- waHo$iy~ -}       `gloss`  [ "brutal", "savage" ],

    -- ;; waHo$iy~ap_1
    -- wH$y    waHo$iy~        Nap     brutality     [[waHo$iy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- waHo$iy~ap -}     `others` [ "wa.h^siyy Nap" ]
                                                            `gloss`  [ "brutality" ] ]
 ...
 |> "w.h^s" <| [
    ...
    noun     HICAL                     {- <iyHA$ -}         `gloss`  [ "loneliness", "desolation" ] ]
 ...
 |> "w.h^s" <| [
    ...
    noun     MUCiL                     {- muwHi$ -}         `gloss`  [ "dreary", "depressing" ] ]
 ...
 |> "w.h^s" <| [
    ...
    noun     MutaFaCCiL                {- mutawaH~i$ -}     `gloss`  [ "savage", "barbaric" ],

    -- ;; musotawoHi$_1
    -- mstwH$  musotawoHi$     Nall    savage;barbaric;lonesome     [[musotawoHi$/ADJ]]

    noun     MustaFCiL                 {- musotawoHi$ -}    `gloss`  [ "savage", "barbaric", "lonesome" ] ]
 ...
 |> "w.hl" <| [
    ...
    verb     FaCiL                     {- waHil-a -}        `imperf` [ FCaL ]
                                                            `others` [ "w.hal IV_intr", "wa.hil PV_intr" ]
    ...
    verb     HaFCaL                    {- >awoHal -}        `others` [ "w.hal IV_Pass_yu", "w.hil IV_yu" ]
    ...
    noun     FaCiL                     {- waHil -}          `gloss`  [ "muddy", "dirty" ],
    ...
    noun     MuFaCCaL                  {- muwaH~al -}       `gloss`  [ "muddy" ],

    -- ;; muwHil_1
    -- mwHl    muwHil  Nall    muddy     [[muwHil/ADJ]]

    noun     MuFCiL                    {- muwHil -}         `gloss`  [ "muddy" ] ]
 ...
 |> "w.hm" <| [
    ...
    verb     FaCiL                     {- waHim-ai -}       `imperf` [ FCaL, FCiL ]
                                                            `others` [ ".him IV", "wa.him PV", "w.ham IV" ]
                                                            `gloss`  [ "crave", "desire" ],
    ...
    noun     FaCCY                     {- waHomaY -}        `others` [ "wa.hAmY N0", "wa.hmA Nhy", "wa.hAmA Nhy" ]
 ...
 |> "w.hw.h" <| [
    ...
    verb     FaCCaL                    {- waHowaH -}        `others` [ "wa.hwi.h IV_yu" ]
    ...
    verb     TaFaCCaL                  {- tawaHowaH -}      `gloss`  [ "tremble", "shiver", "shudder" ],

    -- ;; waHowaHap_1
    -- wHwH    waHowaH Nap     trembling;shivering;shuddering

    noun     FaCCaL |< aT              {- waHowaHap -}      `others` [ "wa.hwa.h Nap" ]
                                                            `gloss`  [ "trembling", "shivering", "shuddering" ] ]
 ...
 |> "w.h" <| [
    ...
    verb     FaCY                      {- waHaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ ".h IV_0hwnyn", "wa.hA PV_h", "wa.hay PV_Atn", "wa.hY PV_0", "wa.h PV_ttAw", ".hiy IV_0hAnn", "w.hY IV_0_Pass_yu" ]
    ...
    verb     HaFCY                     {- >awoHaY -}        `others` [ "'aw.hA PV_h", "'aw.h PV_ttAw", "'aw.hay PV_Atn", "w.hay IV_Ann_Pass_yu", "w.h IV_0hwnyn_yu", "w.hiy IV_0hAnn_yu", "w.hY IV_0_Pass_yu" ]
    ...
    noun     HaFCY                     {- >awoHaY -}        `others` [ "'uw.hiy PV_Pass-aAat", "w.hY IV_0_Pass_yu" ]
                                                            `gloss`  [ "occur" ],
 ...
 |> "'.h'" <| [
    ...
    noun     FICAL                     {- <iyHA' -}         `gloss`  [ "suggestion", "inspiration", "suggestions" ] ]
 ...
 |> "w.h" <| [
    ...
    noun     MuFCaNY                   {- muwHaY -}         `others` [ "muw.hay NAt NAn_Nayn", "muw.hA Nhy" ]
 ...
 |> "w_hz" <| [
    ...
    noun     FaCL |< aT                {- waxozap -}        `others` [ "wa_hz Napdu" ]
                                                            `gloss`  [ "sting", "prick", "twinge" ],
    ...
    noun     FACiL                     {- wAxiz -}          `gloss`  [ "stinging", "pricking" ] ]
 ...
 |> "w_h.t" <| [
    ...
    verb     FaCaL                     {- waxaT-i -}        `imperf` [ FCiL ]
                                                            `others` [ "_hi.t IV_intr", "wa_ha.t PV_intr" ]
 ...
 |> "w_hm" <| [
    ...
    verb     FaCuL                     {- waxum-u -}        `imperf` [ FCuL ]
                                                            `others` [ "w_hum IV_intr", "wa_hum PV_intr" ]
                                                            `gloss`  [ "be unhealthy" ],
    ...
    noun     FaCiL                     {- waxim -}          `gloss`  [ "unhealthy", "indigestible" ],

    -- ;; waxiym_1
    -- wxym    waxiym  N-ap    unhealthy;indigestible     [[waxiym/ADJ]]

    noun     FaCIL                     {- waxiym -}         `gloss`  [ "unhealthy", "indigestible" ],

    -- ;; waxiym_2
    -- wxym    waxiym  N-ap    evil;fatal     [[waxiym/ADJ]]

    noun     FaCIL                     {- waxiym -}         `gloss`  [ "evil", "fatal" ],

    -- ;; waxAmap_1
    -- wxAm    waxAm   Nap     unhealthiness;evil nature

    noun     FaCAL |< aT               {- waxAmap -}        `others` [ "wa_hAm Nap" ]
                                                            `gloss`  [ "unhealthiness", "evil nature" ],

    -- ;; >awoxam_1
    -- >wxm    >awoxam Nel     worse/worst
    -- Awxm    >awoxam Nel     worse/worst

    noun     HaFCaL                    {- >awoxam -}        `gloss`  [ "worse / worst" ],

    -- ;; musotawoxam_1
    -- mstwxm  musotawoxam     N-ap    unwholesome;indigestible     [[musotawoxam/ADJ]]

    noun     MustaFCaL                 {- musotawoxam -}    `gloss`  [ "unwholesome", "indigestible" ] ]
 ...
 |> "w_h" <| [
    ...
    verb     FaCY                      {- waxaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "_h IV_0hwnyn", "w_hY IV_0_Pass_yu", "wa_h PV_ttAw", "wa_hY PV_0", "_hiy IV_0hAnn", "wa_hay PV_Atn", "wa_hA PV_h" ]
 ...
 |> "tawa_h_hiy" <| [
    ...
    noun     Identity                  {- tawax~iy -}       `others` [ "tawa_h_h NK" ]
 ...
 |> "tawAdd" <| [
    ...
    noun     HaFCAL                    {- >awodAd -}        `gloss`  [ "affectionate" ],
    ...
    noun     FiCAL |< Iy               {- widAdiy~ -}       `gloss`  [ "friendly", "amicable" ],

    -- ;; widAdiy~ap_1
    -- wdAdy   widAdiy~        NapAt   association     [[widAdiy~/NOUN]]

    noun     FiCAL |< Iy |< aT         {- widAdiy~ap -}     `others` [ "widAdiyy NapAt" ]
                                                            `gloss`  [ "association" ],
 ...
 |> "wd`" <| [
    ...
    verb     HaFCaL                    {- >awodaE -}        `others` [ "wda` IV_Pass_yu", "wdi` IV_yu" ]
 ...
 |> "d`" <| [
    ...
    noun     CaL |< aT                 {- daEap -}          `others` [ "da` Nap" ]
                                                            `gloss`  [ "indifference", "gentleness" ] ]
 ...
 |> "wd`" <| [
    ...
    noun     FaCAL |< aN               {- wadAEAF -}        `others` [ "wadA` NF" ]
                                                            `gloss`  [ "farewell !", "good-bye !" ],

    -- ;; wadAEap_1
    -- wdAE    wadAE   Nap     gentleness;meekness

    noun     FaCAL |< aT               {- wadAEap -}        `others` [ "wadA` Nap" ]
                                                            `gloss`  [ "gentleness", "meekness" ],
    ...
    noun     FaCIL |< aT               {- wadiyEap -}       `others` [ "wadA'i` Ndip", "wadiy` Napdu" ]
 ...
 |> "wyd`" <| [
    ...
    noun     MiFCaL |< aT              {- miydaEap -}       `others` [ "miyda` Napdu" ]
                                                            `gloss`  [ "apron", "smock" ] ]
 ...
 |> "w'd`" <| [
    ...
    noun     FICAL                     {- <iydAE -}         `gloss`  [ "depositing", "consigning", "deposition" ] ]
 ...
 |> "wyd`" <| [
    ...
    noun     IstiFCAL                  {- {isotiydAE -}     `gloss`  [ "depositing", "consigning", "deposition" ] ]
 ...
 |> "wd`" <| [
    ...
    noun     FACiL                     {- wAdiE -}          `gloss`  [ "gentle", "mild-tempered" ],
    ...
    noun     MuFCiL                    {- muwdiE -}         `gloss`  [ "mild-tempered" ],
 ...
 |> "wdq" <| [
    ...
    noun     FaCIL |< aT               {- wadiyqap -}       `others` [ "wadiyq Napdu" ]
                                                            `gloss`  [ "lawn", "meadow" ] ]
 ...
 |> "wd" <| [
    ...
    verb     FaCY                      {- wadaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "wadY PV_0", "wdY IV_0_Pass_yu", "waday PV_Atn", "wadA PV_h", "diy IV_0hAnn", "wad PV_ttAw" ]
    ...
    verb     HaFCY                     {- >awodaY -}        `others` [ "wday IV_Ann_Pass_yu", "wdY IV_0_Pass_yu", "'awd PV_ttAw", "wdiy IV_0hAnn_yu", "'awdA PV_h", "'awday PV_Atn", "wd IV_0hwnyn_yu" ]
 ...
 |> "d" <| [
    ...
    noun     CI |< aT                  {- diyap -}          `others` [ "diy NapAt" ]
                                                            `gloss`  [ "blood money", "indemnity", "wergild" ] ]
 ...
 |> "wrb" <| [
    ...
    noun     MuFACaL |< aT             {- muwArabap -}      `others` [ "muwArab NapAt" ]
                                                            `gloss`  [ "equivocation", "ambiguity" ],

    -- ;; maworuwb_1
    -- mwrwb   maworuwb        N-ap    oblique;diagonal     [[maworuwb/ADJ]]

    noun     MaFCUL                    {- maworuwb -}       `gloss`  [ "oblique", "diagonal" ],

    -- ;; muwArab_1
    -- mwArb   muwArab N-ap    partly open     [[muwArab/ADJ]]

    noun     MuFACaL                   {- muwArab -}        `gloss`  [ "partly open" ] ]
 ...
 |> "wr_t" <| [
    ...
    verb     FaCiL                     {- wariv-i -}        `imperf` [ FCiL ]
                                                            `others` [ "wra_t IV_Pass_yu", "wuri_t PV_Pass", "wari_t PV", "ri_t IV" ]
    ...
    verb     HaFCaL                    {- >aworav -}        `others` [ "wra_t IV_Pass_yu", "wri_t IV_yu" ]
 ...
 |> "'ir_t" <| [
    ...
    noun     Identity                  {- <irv -}           `gloss`  [ "heritage", "legacy" ],
    ...
    noun     FiCAL |< aT               {- wirAvap -}        `others` [ "wirA_t Nap" ]
                                                            `gloss`  [ "inheritance", "legacy" ],

    -- ;; wirAviy~_1
    -- wrAvy   wirAviy~        N-ap    hereditary;congenital     [[wirAviy~/ADJ]]

    noun     FiCAL |< Iy               {- wirAviy~ -}       `gloss`  [ "hereditary", "congenital" ],
 ...
 |> "wr_t" <| [
    ...
    noun     FACiL                     {- wAriv -}          `gloss`  [ "inheriting" ],
    ...
    noun     MaFCUL                    {- maworuwv -}       `gloss`  [ "inherited", "hereditary" ],
    ...
    noun     MuFaCCiL |< aT            {- muwar~ivap -}     `others` [ "muwarri_t NapAt" ]
                                                            `gloss`  [ "gene" ],
 ...
 |> "wrd" <| [
    ...
    verb     FaCaL                     {- warad-i -}        `imperf` [ FCiL ]
                                                            `others` [ "warad PV_intr", "rid IV_intr" ]
    ...
    verb     HaFCaL                    {- >aworad -}        `others` [ "wrid IV_yu", "wrad IV_Pass_yu" ]
    ...
    noun     MaFCiL |< aT              {- maworidap -}      `others` [ "mawrid Nap" ]
                                                            `gloss`  [ "landing place", "wharf" ],
 ...
 |> "wrd" <| [
    ...
    noun     HICAL                     {- <iyrAd -}         `gloss`  [ "revenue", "yield", "profit", "revenues", "yields", "profits" ] ]
 ...
 |> "wrd" <| [
    ...
    noun     FACiL                     {- wArid -}          `gloss`  [ "appearing", "mentioned" ],
    ...
    noun     MustaFCaL                 {- musotaworad -}    `gloss`  [ "imported", "imports" ] ]
 ...
 |> "wrd" <| [
    ...
    noun     FaCL |< Iy                {- warodiy~ -}       `gloss`  [ "rosy", "pink" ],
    ...
    noun     MuFaCCaL                  {- muwar~ad -}       `gloss`  [ "rosy", "red" ],

    -- ;; mutawar~id_1
    -- mtwrd   mutawar~id      N-ap    rosy;red     [[mutawar~id/ADJ]]

    noun     MutaFaCCiL                {- mutawar~id -}     `gloss`  [ "rosy", "red" ],

    -- ;; warodiy~ap_1
    -- wrdy    warodiy~        Nap     work shift;shift rotation     [[warodiy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- warodiy~ap -}     `others` [ "wardiyy Nap" ]
                                                            `gloss`  [ "work shift", "shift rotation" ] ]
 ...
 |> "wrs" <| [
    ...
    -- ;; >aworAs_1
    -- >wrAs   >aworAs N       Aurès (mountains in Algeria)
    -- AwrAs   >aworAs N       Aurès (mountains in Algeria)

    noun     HaFCAL                    {- >aworAs -}        `gloss`  [ "Aur_es ( mountains in Algeria )" ] ]
 ...
 |> "wr^s" <| [
    ...
    noun     FaCiL                     {- wari$ -}          `gloss`  [ "lively", "brisk" ],

    -- ;; wAri$_1
    -- wAr$    wAri$   Nall    obtrusive;interfering     [[wAri$/ADJ]]

    noun     FACiL                     {- wAri$ -}          `gloss`  [ "obtrusive", "interfering" ],

    -- ;; waro$ap_1
    -- wr$     waro$   NapAt   workshop
    -- wr$     wira$   N       workshops

    noun     FaCL |< aT                {- waro$ap -}        `others` [ "war^s NapAt", "wira^s N" ]
 ...
 |> "wr.t" <| [
    ...
    verb     HaFCaL                    {- >aworaT -}        `others` [ "wra.t IV_Pass_yu", "wri.t IV_yu" ]
    ...
    noun     FaCL |< aT                {- waroTap -}        `others` [ "wara.t NAt", "wirA.t N", "war.t Napdu" ]
    ...
    noun     MuFaCCaL                  {- muwar~aT -}       `gloss`  [ "involved", "entangled" ],

    -- ;; mutawar~iT_1
    -- mtwrT   mutawar~iT      Nall    involved;implicated;entangled     [[mutawar~iT/ADJ]]

    noun     MutaFaCCiL                {- mutawar~iT -}     `gloss`  [ "involved", "implicated", "entangled" ] ]
 ...
 |> "wr`" <| [
    ...
    verb     FaCiL                     {- wariE-i -}        `imperf` [ FCiL ]
                                                            `others` [ "ri` IV_intr", "wari` PV_intr" ]
                                                            `gloss`  [ "be pious" ],
 ...
 |> "wrf" <| [
    ...
    verb     HaFCaL                    {- >aworaf -}        `others` [ "wrif IV_yu", "wraf IV_Pass_yu" ]
                                                            `gloss`  [ "stretch", "extend", "be stretched", "be extended" ],

    -- ;; wArif_1
    -- wArf    wArif   Nall    extending;stretching;sprouting     [[wArif/ADJ]]

    noun     FACiL                     {- wArif -}          `gloss`  [ "extending", "stretching", "sprouting" ] ]
 ...
 |> "wrq" <| [
    ...
    verb     HaFCaL                    {- >aworaq -}        `others` [ "wriq IV_yu" ]
                                                            `gloss`  [ "sprout leaves" ],
    ...
    noun     FaCaL |< Iy               {- waraqiy~ -}       `gloss`  [ "paper" ],
    ...
    noun     FACiL                     {- wAriq -}          `gloss`  [ "leafy", "verdant", "green" ],
    ...
    noun     MuFCiL                    {- muwriq -}         `gloss`  [ "verdant", "leafy", "green" ] ]
 ...
 |> "wrm" <| [
    ...
    verb     FaCiL                     {- warim-i -}        `imperf` [ FCiL ]
                                                            `others` [ "warim PV_intr", "rim IV_intr" ]
    ...
    verb     HaFCaL                    {- >aworam -}        `others` [ "wrim IV_yu", "wram IV_Pass_yu" ]
    ...
    noun     FACiL                     {- wArim -}          `gloss`  [ "swollen" ],

    -- ;; muwar~am_1
    -- mwrm    muwar~am        N-ap    swollen     [[muwar~am/ADJ]]

    noun     MuFaCCaL                  {- muwar~am -}       `gloss`  [ "swollen" ],

    -- ;; mutawar~im_1
    -- mtwrm   mutawar~im      N-ap    swollen     [[mutawar~im/ADJ]]

    noun     MutaFaCCiL                {- mutawar~im -}     `gloss`  [ "swollen" ] ]
 ...
 |> "wrn^s" <| [
    ...
    verb     FaCCaL                    {- warona$ -}        `others` [ "warni^s IV_yu" ]
 ...
 |> "warniy^s" <| [
    ...
    noun     Identity                  {- waroniy$ -}       `gloss`  [ "varnish", "lacquer" ] ]
 ...
 |> "wr" <| [
    ...
    verb     FaCY                      {- waraY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "warY PV_0", "warA PV_h", "waray PV_Atn", "wrY IV_0_Pass_yu", "riy IV_0hAnn", "war PV_ttAw" ]
 ...
 |> "wr" <| [
    ...
    verb     HaFCY                     {- >aworaY -}        `others` [ "wriy IV_0hAnn_yu", "wray IV_Ann_Pass_yu", "wr IV_0hwnyn_yu", "'awray PV_Atn", "'awrA PV_h", "wrY IV_0_Pass_yu", "'awr PV_ttAw" ]
                                                            `gloss`  [ "kindle", "light", "be kindled", "be lit" ] ]
 ...
 |> "warA'u" <| [
    ...
    noun     Identity                  {- warA'u -}         `gloss`  [ "behind" ],

    -- ;; warA}iy~_1
    -- wrA}y   warA}iy~        N-ap    rear;back     [[warA}iy~/ADJ]]

    noun     FaCA' |< Iy               {- warA}iy~ -}       `gloss`  [ "rear", "back" ],
    ...
    noun     HaFCY                     {- >aworaY -}        `others` [ "'awray NAn_Nayn", "'awrA Nhy" ]
                                                            `gloss`  [ "hiding better" ] ]
 ...
 |> "wry" <| [
    ...
    noun     TaFCiL |< aT              {- taworiyap -}      `others` [ "tawriy Nap" ]
                                                            `gloss`  [ "hiding", "dissimulation" ] ]
 ...
 |> "wzz" <| [
    ...
    verb     FaCL                      {- waz~-u -}         `imperf` [ FCuL ]
                                                            `others` [ "wzuz IV_C", "wazz PV_V", "wazaz PV_C", "wuzz IV_V" ]
                                                            `gloss`  [ "incite" ],
    ...
    noun     FaCL |< aT                {- waz~ap -}         `others` [ "wazz N Napdu" ]
                                                            `gloss`  [ "goose" ] ]
 ...
 |> "wzr" <| [
    ...
    verb     HaFCaL                    {- >awozar -}        `others` [ "wzar IV_Pass_yu", "wzir IV_yu" ]
    ...
    noun     FiCAL |< aT               {- wizArap -}        `others` [ "wizAr NAt Napdu" ]
                                                            `gloss`  [ "ministry", "ministries" ],

    -- ;; wizAriy~_1
    -- wzAry   wizAriy~        Nall    ministry;ministerial     [[wizAriy~/ADJ]]

    noun     FiCAL |< Iy               {- wizAriy~ -}       `gloss`  [ "ministry", "ministerial" ] ]
 ...
 |> "wz`" <| [
    ...
    noun     HaFCAL                    {- >awozAE -}        `gloss`  [ "crowds", "groups" ],

    -- ;; waziyEap_1
    -- wzyE    waziyE  Napdu   share;allotment
    -- wzA}E   wazA}iE Ndip    shares;allotments

    noun     FaCIL |< aT               {- waziyEap -}       `others` [ "wazA'i` Ndip", "waziy` Napdu" ]
    ...
    noun     MuFaCCaL                  {- muwaz~aE -}       `gloss`  [ "distributed", "scattered" ],

    -- ;; mutawaz~iE_1
    -- mtwzE   mutawaz~iE      Nall    scattered;distributed     [[mutawaz~iE/ADJ]]

    noun     MutaFaCCiL                {- mutawaz~iE -}     `gloss`  [ "scattered", "distributed" ] ]
 ...
 |> "wzn" <| [
    ...
    noun     CiL |< aT                 {- zinap -}          `others` [ "zin Nap" ]
 ...
 |> "wzn" <| [
    ...
    noun     FaCL |< aT                {- wazonap -}        `others` [ "wazan NAt", "wazn Napdu" ]
                                                            `gloss`  [ "weight", "weights" ],

    -- ;; wazoniy~_1
    -- wzny    wazoniy~        N-ap    weight;weighty     [[wazoniy~/ADJ]]

    noun     FaCL |< Iy                {- wazoniy~ -}       `gloss`  [ "weight", "weighty" ],
    ...
    noun     FaCIL                     {- waziyn -}         `gloss`  [ "weighty", "ponderous" ] ]
 ...
 |> "wzn" <| [
    ...
    noun     MICAL |< Iy |< aT         {- miyzAniy~ap -}    `others` [ "miyzAniyy NAt Napdu" ]
                                                            `gloss`  [ "budget", "budgets" ],

    -- ;; miyzAniy~ap_2
    -- myzAny  miyzAniy~       Napdu   budget;balance     [[miyzAniy~/NOUN]]

    noun     MICAL |< Iy |< aT         {- miyzAniy~ap -}    `others` [ "miyzAniyy Napdu" ]
                                                            `gloss`  [ "budget", "balance" ] ]
 ...
 |> "wzn" <| [
    ...
    noun     MuFACaL |< aT             {- muwAzanap -}      `others` [ "muwAzan NapAt" ]
                                                            `gloss`  [ "budget" ],
 ...
 |> "ittizAn" <| [
    ...
    noun     MaFCUL                    {- mawozuwn -}       `gloss`  [ "weighed", "balanced", "judicious" ],
    ...
    noun     MutaFACiL                 {- mutawAzin -}      `gloss`  [ "balanced" ] ]
 ...
 |> "muttazin" <| [
    ...
    noun     Identity                  {- mut~azin -}       `gloss`  [ "balanced", "harmonious" ] ]
 ...
 |> "wz" <| [
    ...
    verb     FACY                      {- wAzaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "wAzY IV_0_Pass_yu PV_0", "wAz PV_ttAw_intr IV_0hwnyn_yu", "wAzay PV_Atn IV_Ann_Pass_yu", "wAziy IV_0hAnn_yu", "wAzA PV_h" ]
 ...
 |> "tawAziy" <| [
    ...
    noun     Identity                  {- tawAziy -}        `others` [ "tawAz NK" ]
 ...
 |> "wzy" <| [
    ...
    noun     MutaFACiL                 {- mutawAziy -}      `others` [ "mutawAz Nuwn_Niyn NK" ]
                                                            `gloss`  [ "parallel", "equivalent", "egalitarian" ] ]
 ...
 |> "ws_h" <| [
    ...
    verb     FaCiL                     {- wasix-a -}        `imperf` [ FCaL ]
                                                            `others` [ "wsa_h IV_intr", "wasi_h PV_intr" ]
                                                            `gloss`  [ "be soiled" ],
    ...
    verb     HaFCaL                    {- >awosax -}        `others` [ "wsi_h IV_yu", "wsa_h IV_Pass_yu" ]
 ...
 |> "ittasa_h" <| [
    ...
    noun     FaCiL                     {- wasix -}          `gloss`  [ "dirty", "sullied" ],

    -- ;; wasAxap_1
    -- wsAx    wasAx   Nap     filth;squalor

    noun     FaCAL |< aT               {- wasAxap -}        `others` [ "wasA_h Nap" ]
                                                            `gloss`  [ "filth", "squalor" ] ]
 ...
 |> "wsd" <| [
    ...
    noun     FiCAL |< aT               {- wisAdap -}        `others` [ "wisAd NapAt", "wasA'id Ndip" ]
                                                            `gloss`  [ "cushion", "pillow", "cushions", "pillows" ],

    -- ;; muwas~ad_1
    -- mwsd    muwas~ad        N-ap    easy;smooth     [[muwas~ad/ADJ]]

    noun     MuFaCCaL                  {- muwas~ad -}       `gloss`  [ "easy", "smooth" ] ]
 ...
 |> "was.ta" <| [
    ...
    noun     FaCaL |< Iy               {- wasaTiy~ -}       `gloss`  [ "environmental" ],

    -- ;; wasoTAniy~_1
    -- wsTAny  wasoTAniy~      Nall    middle;central;intermediate     [[wasoTAniy~/ADJ]]

    noun     FaCLAn |< Iy              {- wasoTAniy~ -}     `gloss`  [ "middle", "central", "intermediate" ],

    -- ;; wasoTiy~ap_1
    -- wsTy    wasoTiy~        NapAt   patio     [[wasoTiy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- wasoTiy~ap -}     `others` [ "was.tiyy NapAt" ]
                                                            `gloss`  [ "patio" ],

    -- ;; wisATap_1
    -- wsAT    wisAT   NapAt   mediation;intercession

    noun     FiCAL |< aT               {- wisATap -}        `others` [ "wisA.t NapAt" ]
    ...
    noun     FaCIL |< aT               {- wasiyTap -}       `others` [ "wasA'i.t Ndip", "wasiy.t Napdu" ]
    ...
    noun     HaFCaL                    {- >awosaT -}        `gloss`  [ "Middle" ],
    ...
    noun     HaFCaL                    {- >awosaT -}        `others` [ "wus.tA Nhy", "'awAsi.t Ndip", "wus.tay NAt NAn_Nayn", "wus.tY N0" ]
                                                            `gloss`  [ "middle", "central" ],

    -- ;; >awosaTiy~_1
    -- >wsTy   >awosaTiy~      Nall    Middle
    -- AwsTy   >awosaTiy~      Nall    Middle

    noun     HaFCaL |< Iy              {- >awosaTiy~ -}     `gloss`  [ "Middle" ],
    ...
    noun     FACiL |< aT               {- wAsiTap -}        `others` [ "wasA'i.t Ndip", "wAsi.t Napdu" ]
                                                            `gloss`  [ "means", "device", "devices" ],

    -- ;; mutawas~iT_1
    -- mtwsT   mutawas~iT      Nall    middle;central;average     [[mutawas~iT/ADJ]]

    noun     MutaFaCCiL                {- mutawas~iT -}     `gloss`  [ "middle", "central", "average" ],

    -- ;; mutawas~iTiy~_1
    -- mtwsTy  mutawas~iTiy~   Nall    middle;central;average     [[mutawas~iTiy~/ADJ]]

    noun     MutaFaCCiL |< Iy          {- mutawas~iTiy~ -}  `gloss`  [ "middle", "central", "average" ] ]
 ...
 |> "ws`" <| [
    ...
    verb     FaCuL                     {- wasuE-u -}        `imperf` [ FCuL ]
                                                            `others` [ "wasu` PV_intr", "wsu` IV_intr" ]
    ...
    verb     FaCiL                     {- wasiE-a -}        `imperf` [ FCaL ]
                                                            `others` [ "wasi` PV_intr", "sa` IV_intr" ]
    ...
    verb     HaFCaL                    {- >awosaE -}        `others` [ "wsi` IV_yu", "wsa` IV_Pass_yu" ]
 ...
 |> "wts`" <| [
    ...
    verb     IFtaCaL                   {- {it~asaE -}       `others` [ "ttasi` IV" ]
 ...
 |> "s`" <| [
    ...
    noun     CaL |< aT                 {- saEap -}          `others` [ "sa` Nap" ]
 ...
 |> "ws`" <| [
    ...
    noun     TaFCiL |< aT              {- tawosiEap -}      `others` [ "tawsi` Nap" ]
    ...
    noun     TaFaCCuL |< Iy            {- tawas~uEiy~ -}    `gloss`  [ "expansionist" ] ]
 ...
 |> "wts`" <| [
    ...
    noun     IFtiCAL                   {- {it~isAE -}       `gloss`  [ "expansion", "extension" ] ]
 ...
 |> "ws`" <| [
    ...
    noun     FACiL                     {- wAsiE -}          `gloss`  [ "wide", "extensive", "broad" ],
    ...
    noun     MaFCUL |< aT              {- mawosuwEap -}     `others` [ "mawsuw` NAt Napdu" ]
                                                            `gloss`  [ "encyclopedia", "encyclopedias" ],

    -- ;; mawosuwEiy~_1
    -- mwswEy  mawosuwEiy~     Nall    encyclopedic     [[mawosuwEiy~/ADJ]]

    noun     MaFCUL |< Iy              {- mawosuwEiy~ -}    `gloss`  [ "encyclopedic" ],

    -- ;; muwsiE_1
    -- mwsE    muwsiE  Nall    wealthy     [[muwsiE/ADJ]]

    noun     MuFCiL                    {- muwsiE -}         `gloss`  [ "wealthy" ] ]
 ...
 |> "wts`" <| [
    ...
    noun     MuFtaCiL                  {- mut~asiE -}       `gloss`  [ "extensive", "abundant", "generous" ],

    -- ;; mut~asaE_1
    -- mtsE    mut~asaE        N       space;room

    noun     MuFtaCaL                  {- mut~asaE -}       `gloss`  [ "space", "room" ] ]
 ...
 |> "wsq" <| [
    ...
    verb     HaFCaL                    {- >awosaq -}        `others` [ "wsaq IV_Pass_yu", "wsiq IV_yu" ]
 ...
 |> "muttasiq" <| [
    ...
    noun     Identity                  {- mut~asiq -}       `gloss`  [ "well-ordered", "harmonious" ] ]
 ...
 |> "wiskiy" <| [
    ...
    noun     Identity                  {- wisokiy -}        `gloss`  [ "whisky" ] ]
 ...
 |> "wsl" <| [
    ...
    noun     FaCIL |< aT               {- wasiylap -}       `others` [ "wasA'il Ndip", "wasiyl Napdu" ]
 ...
 |> "wsm" <| [
    ...
    noun     CiL |< aT                 {- simap -}          `others` [ "sim NAt Napdu" ]
 ...
 |> "wsm" <| [
    ...
    noun     FaCAL |< aT               {- wasAmap -}        `others` [ "wasAm Nap" ]
    ...
    noun     MaFCiL |< Iy              {- mawosimiy~ -}     `gloss`  [ "seasonal" ] ]
 ...
 |> "miysam" <| [
    ...
    noun     MaFCUL                    {- mawosuwm -}       `gloss`  [ "marked", "branded" ] ]
 ...
 |> "wsws" <| [
    ...
    verb     FaCCaL                    {- wasowas -}        `others` [ "waswis IV_yu" ]
                                                            `gloss`  [ "whisper", "tempt" ],
    ...
    verb     TaFaCCaL                  {- tawasowas -}      `gloss`  [ "be apprehensive", "be suspicious" ],
    ...
    noun     FaCCaL |< aT              {- wasowasap -}      `others` [ "waswas Nap Napdu", "wasAwis Ndip" ]
 ...
 |> "ws" <| [
    ...
    verb     HaFCY                     {- >awosaY -}        `others` [ "wsay IV_Ann_Pass_yu", "ws IV_0hwnyn_yu", "'awsA PV_h", "wsY IV_0_Pass_yu", "'aws PV_ttAw", "'awsay PV_Atn", "wsiy IV_0hAnn_yu" ]
 ...
 |> "muwAsAT" <| [
    ...
    noun     MuFCaNY                   {- muwsaY -}         `others` [ "mawAs NK", "mawAsiy N0_Nh", "muwsA Nhy", "muwsay NAn_Nayn" ]
 ...
 |> "w^s^g" <| [
    ...
    noun     FaCIL |< aT               {- wa$iyjap -}       `others` [ "wa^sA'i^g Ndip", "wa^siy^g Nap" ]
                                                            `gloss`  [ "close tie", "close ties" ],

    -- ;; mutawA$ij_1
    -- mtwA$j  mutawA$ij       Nall    connected;interrelated     [[mutawA$ij/ADJ]]

    noun     MutaFACiL                 {- mutawA$ij -}      `gloss`  [ "connected", "interrelated" ] ]
 ...
 |> "itta^sa.h" <| [
    ...
    noun     FiCAL |< aT               {- wi$AHap -}        `others` [ "wi^sA.h Nap" ]
                                                            `gloss`  [ "sword" ],
    ...
    noun     MuFaCCaL |< aT            {- muwa$~aHap -}     `others` [ "muwa^s^sa.h NapAt" ]
                                                            `gloss`  [ "muwashshah ( poetic genre )" ] ]
 ...
 |> "mutta^si.h" <| [
    ...
    noun     Identity                  {- mut~a$iH -}       `gloss`  [ "wearing", "attired" ] ]
 ...
 |> "w^sr" <| [
    ...
    noun     MaFCUL |< Iy              {- mawo$uwriy~ -}    `gloss`  [ "prismatic", "prism-like" ] ]
 ...
 |> "w^s`" <| [
    ...
    noun     FaCIL |< aT               {- wa$iyEap -}       `others` [ "wa^sA'i` Ndip", "wa^siy` Napdu" ]
 ...
 |> "w^sk" <| [
    ...
    verb     HaFCaL                    {- >awo$ak -}        `others` [ "w^sik IV_intr_yu", "w^sak IV_Pass_yu" ]
    ...
    noun     FaCIL                     {- wa$iyk -}         `gloss`  [ "imminent", "near" ] ]
 ...
 |> "w^sm" <| [
    ...
    noun     FaCIL |< aT               {- wa$iymap -}       `others` [ "wa^siym Nap" ]
                                                            `gloss`  [ "hostility", "malice" ] ]
 ...
 |> "w^sn" <| [
    ...
    noun     FaCL |< aT                {- wa$onap -}        `others` [ "wa^sn Nap", "wi^sn Nap" ]
 ...
 |> "w^sw^s" <| [
    ...
    verb     FaCCaL                    {- wa$owa$ -}        `others` [ "wa^swi^s IV_yu" ]
                                                            `gloss`  [ "whisper" ],
    ...
    verb     TaFaCCaL                  {- tawa$owa$ -}      `gloss`  [ "whisper" ],

    -- ;; wa$owa$ap_1
    -- w$w$    wa$owa$ Nap     whispering

    noun     FaCCaL |< aT              {- wa$owa$ap -}      `others` [ "wa^swa^s Nap" ]
                                                            `gloss`  [ "whispering" ] ]
 ...
 |> "w^s" <| [
    ...
    verb     FaCY                      {- wa$aY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "wa^sA PV_h", "^siy IV_0hAnn", "wa^say PV_Atn", "wa^sY PV_0", "w^sY IV_0_Pass_yu", "wa^s PV_ttAw" ]
 ...
 |> "^s" <| [
    ...
    noun     CI |< aT                  {- $iyap -}          `others` [ "^siy NapAt" ]
                                                            `gloss`  [ "blemish", "defect" ] ]
 ...
 |> "w^sy" <| [
    ...
    noun     FiCAL |< aT               {- wi$Ayap -}        `others` [ "wi^sAy Nap" ]
                                                            `gloss`  [ "defamation", "slander" ],

    -- ;; tawo$iyap_1
    -- tw$y    tawo$iy Nap     embellishment;embroidery

    noun     TaFCiL |< aT              {- tawo$iyap -}      `others` [ "taw^siy Nap" ]
                                                            `gloss`  [ "embellishment", "embroidery" ],
 ...
 |> "w.sb" <| [
    ...
    verb     FaCiL                     {- waSib-a -}        `imperf` [ FCaL ]
                                                            `others` [ "wa.sib PV_intr", "w.sab IV_intr" ]
    ...
    noun     FACiL                     {- wASib -}          `gloss`  [ "lasting", "permanent" ] ]
 ...
 |> "w.sd" <| [
    ...
    verb     HaFCaL                    {- >awoSad -}        `others` [ "w.sad IV_Pass_yu", "w.sid IV_yu" ]
 ...
 |> "w.sf" <| [
    ...
    noun     CiL |< aT                 {- Sifap -}          `others` [ ".sif NAt Napdu" ]
 ...
 |> "w.sf" <| [
    ...
    noun     FaCL |< aT                {- waSofap -}        `others` [ "wa.sf Nap" ]
                                                            `gloss`  [ "description", "portrayal" ],

    -- ;; waSofap_2
    -- wSf     waSof   Napdu   medical prescription

    noun     FaCL |< aT                {- waSofap -}        `others` [ "wa.sf Napdu" ]
                                                            `gloss`  [ "medical prescription" ],

    -- ;; waSofiy~_1
    -- wSfy    waSofiy~        N-ap    descriptive     [[waSofiy~/ADJ]]

    noun     FaCL |< Iy                {- waSofiy~ -}       `gloss`  [ "descriptive" ],

    -- ;; waSofiy~ap_1
    -- wSfy    waSofiy~        Nap     descriptiveness     [[waSofiy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- waSofiy~ap -}     `others` [ "wa.sfiyy Nap" ]
                                                            `gloss`  [ "descriptiveness" ],
    ...
    noun     FaCIL |< aT               {- waSiyfap -}       `others` [ "wa.siyf NapAt", "wa.sA'if Ndip" ]
    ...
    noun     FACiL |< aT               {- wASifap -}        `others` [ "wA.sif NapAt" ]
                                                            `gloss`  [ "descriptor", "key word" ],
    ...
    noun     MuFACaL |< aT             {- muwASafap -}      `others` [ "muwA.saf NapAt" ]
                                                            `gloss`  [ "description" ],
    ...
    noun     MuFACaL |< aT             {- muwASafap -}      `others` [ "muwA.saf NAt Napdu" ]
 ...
 |> "w.sl" <| [
    ...
    verb     FaCaL                     {- waSal-i -}        `imperf` [ FCiL ]
                                                            `others` [ ".sil IV", "wa.sal PV", "w.sal IV_Pass_yu" ]
    ...
    verb     HaFCaL                    {- >awoSal -}        `others` [ "w.sil IV_yu", "w.sal IV_Pass_yu" ]
 ...
 |> "w.sl" <| [
    ...
    noun     CiL |< aT                 {- Silap -}          `others` [ ".sil NAt Napdu" ]
 ...
 |> "w.sl" <| [
    ...
    noun     FaCL |< aT                {- waSolap -}        `others` [ "wa.sl Nap" ]
                                                            `gloss`  [ "wasla ( Arabic diacritic )" ],

    -- ;; wuSolap_1
    -- wSl     wuSol   NapAt   link;connection

    noun     FuCL |< aT                {- wuSolap -}        `others` [ "wu.sl NapAt" ]
                                                            `gloss`  [ "link", "connection" ],

    -- ;; wuSoliy~ap_1
    -- wSly    wuSoliy~        Nap     connecting road     [[wuSoliy~/NOUN]]

    noun     FuCL |< Iy |< aT          {- wuSoliy~ap -}     `others` [ "wu.sliyy Nap" ]
                                                            `gloss`  [ "connecting road" ],
    ...
    noun     FuCUL |< Iy               {- wuSuwliy~ -}      `gloss`  [ "careerist", "parvenu" ],

    -- ;; wuSuwliy~ap_1
    -- wSwly   wuSuwliy~       Nap     careerism;pushiness     [[wuSuwliy~/NOUN]]

    noun     FuCUL |< Iy |< aT         {- wuSuwliy~ap -}    `others` [ "wu.suwliyy Nap" ]
                                                            `gloss`  [ "careerism", "pushiness" ],
    ...
    noun     TaFCIL |< aT              {- tawoSiylap -}     `others` [ "taw.siyl NapAt" ]
                                                            `gloss`  [ "connection", "contact" ],

    -- ;; tawoSiyliy~ap_1
    -- twSyly  tawoSiyliy~     Nap     conductivity     [[tawoSiyliy~/NOUN]]

    noun     TaFCIL |< Iy |< aT        {- tawoSiyliy~ap -}  `others` [ "taw.siyliyy Nap" ]
                                                            `gloss`  [ "conductivity" ],
    ...
    noun     MuFACaL |< aT             {- muwASalap -}      `others` [ "muwA.sal Nap" ]
                                                            `gloss`  [ "continuation", "continue" ],

    -- ;; muwASalap_2
    -- mwASl   muwASal NapAt   communication;connection

    noun     MuFACaL |< aT             {- muwASalap -}      `others` [ "muwA.sal NapAt" ]
 ...
 |> "w.sl" <| [
    ...
    noun     HICAL                     {- <iySAl -}         `gloss`  [ "connection", "transportation", "transmission" ] ]
 ...
 |> "itti.sAl" <| [
    ...
    noun     MaFCUL                    {- mawoSuwl -}       `gloss`  [ "connected", "bound", "tied" ],

    -- ;; muwaS~il_1
    -- mwSl    muwaS~il        N-ap    connecting;conductive     [[muwaS~il/ADJ]]

    noun     MuFaCCiL                  {- muwaS~il -}       `gloss`  [ "connecting", "conductive" ],
    ...
    noun     MutaFACiL                 {- mutawASil -}      `gloss`  [ "continuous", "unceasing", "connected" ] ]
 ...
 |> "w.sm" <| [
    ...
    noun     FaCL |< aT                {- waSomap -}        `others` [ "wa.sm Napdu" ]
 ...
 |> "w.sw.s" <| [
    ...
    verb     FaCCaL                    {- waSowaS -}        `others` [ "wa.swi.s IV_yu" ]
    ...
    noun     FaCCaL                    {- waSowaS -}        `others` [ "wa.sAwi.s Ndip", "wa.swA.s Ndu" ]
                                                            `gloss`  [ "peep hole", "peep holes" ],

    -- ;; waSowaSap_1
    -- wSwS    waSowaS Napdu   peek;furtive glance

    noun     FaCCaL |< aT              {- waSowaSap -}      `others` [ "wa.swa.s Napdu" ]
                                                            `gloss`  [ "peek", "furtive glance" ] ]
 ...
 |> "w.s" <| [
    ...
    verb     HaFCY                     {- >awoSaY -}        `others` [ "'aw.say PV_Atn", "w.s IV_0hwnyn_yu", "'aw.sA PV_h", "w.sY IV_0_Pass_yu", "w.siy IV_0hAnn_yu", "'aw.s PV_ttAw", "w.say IV_Ann_Pass_yu" ]
    ...
    noun     CaL |< Iy                 {- waSiy~ -}         `others` [ "'aw.siyA' Nh Nhy N0_Nh" ]
    ...
    noun     CaL |< Iy |< aT           {- waSiy~ap -}       `others` [ "wa.sAyA N0_Nhy", "wa.siyy Napdu" ]
                                                            `gloss`  [ "advice" ],

    -- ;; waSiy~ap_2
    -- wSy     waSiy~  Napdu   legal will;testament

    noun     CaL |< Iy |< aT           {- waSiy~ap -}       `others` [ "wa.siyy Napdu" ]
                                                            `gloss`  [ "legal will", "testament" ] ]
 ...
 |> "w.sy" <| [
    ...
    noun     FiCAL |< aT               {- wiSAyap -}        `others` [ "wi.sAy Nap" ]
                                                            `gloss`  [ "guardianship", "trusteeship" ],

    -- ;; tawoSiyap_1
    -- twSy    tawoSiy Napdu   advice;recommendation
    -- twSy    tawoSiy NAt     advice;recommendations

    noun     TaFCiL |< aT              {- tawoSiyap -}      `others` [ "taw.siy NAt Napdu" ]
 ...
 |> "wy.s" <| [
    ...
    noun     HiFCA'                    {- <iySA' -}         `gloss`  [ "recommendation", "order", "mandate" ] ]
 ...
 |> "w.s.s" <| [
    ...
    noun     MuFaCCaNY                 {- muwaS~aY -}       `others` [ "muwa.s.sA Nhy" ]
 ...
 |> "w.s" <| [
    ...
    noun     MuFCaNY                   {- muwSaY -}         `gloss`  [ "bequeathed", "willed" ] ]
 ...
 |> "mawA.siy" <| [
    ...
    noun     Identity                  {- mawASiy -}        `gloss`  [ "Mawasi" ] ]
 ...
 |> "w.d'" <| [
    ...
    verb     FaCuL                     {- waDu&-u -}        `imperf` [ FCuL ]
                                                            `others` [ "wa.du' PV_intr", "w.du' IV_intr IV_yn" ]
    ...
    verb     TaFaCCaL                  {- tawaD~a> -}       `others` [ "tawa.d.da'A PV-|_intr IV-|" ]
    ...
    noun     FaCAL |< aT               {- waDA'ap -}        `others` [ "wa.dA' Nap" ]
    ...
    noun     TaFaCCuL                  {- tawaD~u& -}       `gloss`  [ "ritual ablution" ] ]
 ...
 |> "w.d'" <| [
    ...
    noun     MICAL |< aT               {- miyDA'ap -}       `others` [ "miy.dA' NapAt" ]
                                                            `gloss`  [ "ablution basin" ] ]
 ...
 |> "w.d.h" <| [
    ...
    verb     FaCaL                     {- waDaH-i -}        `imperf` [ FCiL ]
                                                            `others` [ "wa.da.h PV_intr", ".di.h IV_intr" ]
    ...
    verb     HaFCaL                    {- >awoDaH -}        `others` [ "w.di.h IV_yu", "w.da.h IV_Pass_yu" ]
 ...
 |> "itta.da.h" <| [
    ...
    noun     FaCCAL                    {- waD~AH -}         `gloss`  [ "bright", "clear" ],
    ...
    noun     HaFCaL                    {- >awoDaH -}        `gloss`  [ "clearer / clearest" ],
 ...
 |> "w.d.h" <| [
    ...
    noun     HICAL                     {- <iyDAH -}         `gloss`  [ "explanation", "clarification", "explanations", "clarifications" ],

    -- ;; <iyDAHiy~_1
    -- <yDAHy  <iyDAHiy~       N-ap    clarifying;explanatory     [[<iyDAHiy~/ADJ]]
    -- AyDAHy  <iyDAHiy~       N-ap    clarifying;explanatory     [[<iyDAHiy~/ADJ]]

    noun     HICAL |< Iy               {- <iyDAHiy~ -}      `gloss`  [ "clarifying", "explanatory" ] ]
 ...
 |> "w.d.h" <| [
    ...
    noun     FACiL                     {- wADiH -}          `gloss`  [ "clear", "obvious", "visible" ],
 ...
 |> "w.d`" <| [
    ...
    verb     HaFCaL                    {- >awoDaE -}        `others` [ "w.di` IV_yu" ]
                                                            `gloss`  [ "suffer losses" ],
 ...
 |> "wt.d`" <| [
    ...
    verb     IFtaCaL                   {- {it~aDaE -}       `others` [ "tta.di` IV_intr" ]
                                                            `gloss`  [ "be humble" ] ]
 ...
 |> "w.d`" <| [
    ...
    noun     FaCL |< aT                {- waDoEap -}        `others` [ "wi.d` Napdu", "wa.d` Napdu" ]
                                                            `gloss`  [ "situation", "position" ],

    -- ;; waDoEiy~_1
    -- wDEy    waDoEiy~        N-ap    situational;positive     [[waDoEiy~/ADJ]]

    noun     FaCL |< Iy                {- waDoEiy~ -}       `gloss`  [ "situational", "positive" ],

    -- ;; waDoEiy~ap_1
    -- wDEy    waDoEiy~        NapAt   status;position     [[waDoEiy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- waDoEiy~ap -}     `others` [ "wa.d`iyy NapAt" ]
                                                            `gloss`  [ "status", "position" ] ]
 ...
 |> ".d`" <| [
    ...
    noun     CaL |< aT                 {- DaEap -}          `others` [ ".da` Nap", ".di` Nap" ]
 ...
 |> "w.d`" <| [
    ...
    noun     FaCAL |< aT               {- waDAEap -}        `others` [ "wa.dA` Nap" ]
                                                            `gloss`  [ "lowliness", "humility" ],
    ...
    noun     FaCIL                     {- waDiyE -}         `others` [ "wu.da`A' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "lowly", "inferior", "humble" ],

    -- ;; waDiyEap_1
    -- wDyE    waDiyE  Nap     deposit;trust;charge
    -- wDA}E   waDA}iE Ndip    deposits;trusts;charges

    noun     FaCIL |< aT               {- waDiyEap -}       `others` [ "wa.diy` Nap", "wa.dA'i` Ndip" ]
                                                            `gloss`  [ "deposit", "trust", "charge", "deposits", "trusts", "charges" ],
    ...
    noun     MaFCiL |< Iy              {- mawoDiEiy~ -}     `gloss`  [ "local" ],
 ...
 |> "wt.d`" <| [
    ...
    noun     IFtiCAL                   {- {it~iDAE -}       `gloss`  [ "modesty", "humility", "lowliness" ] ]
 ...
 |> "w.d`" <| [
    ...
    noun     MaFCUL                    {- mawoDuwE -}       `gloss`  [ "placed", "located" ],

    -- ;; mawoDuwEiy~_1
    -- mwDwEy  mawoDuwEiy~     Nall    objective     [[mawoDuwEiy~/ADJ]]

    noun     MaFCUL |< Iy              {- mawoDuwEiy~ -}    `gloss`  [ "objective" ],

    -- ;; mawoDuwEiy~ap_1
    -- mwDwEy  mawoDuwEiy~     Nap     objectivity     [[mawoDuwEiy~/NOUN]]

    noun     MaFCUL |< Iy |< aT        {- mawoDuwEiy~ap -}  `others` [ "maw.duw`iyy Nap" ]
                                                            `gloss`  [ "objectivity" ],
    ...
    noun     MutaFACiL                 {- mutawADiE -}      `gloss`  [ "humble", "modest" ] ]
 ...
 |> "w.t'" <| [
    ...
    verb     FaCiL                     {- waTi}-a -}        `imperf` [ FCaL ]
                                                            `others` [ ".ta' IV IV_wn IV_yn", ".ta'A IV-|", "wa.ta'A PV-|", "wa.ti' PV", "wa.ta' PV-> PV_w" ]
    ...
    verb     FaCCaL                    {- waT~a> -}         `others` [ "wa.t.ti' IV_yu", "wa.t.ta'A PV-|" ]
    ...
    verb     FACaL                     {- wATa> -}          `others` [ "wA.ti' IV_yu", "wA.ta'A PV-|" ]
                                                            `gloss`  [ "agree with" ],
    ...
    verb     HaFCaL                    {- >awoTa> -}        `others` [ "'aw.ta'A PV-|", "w.ti' IV_yu", "w.ta' IV_Pass_yu" ]
    ...
    verb     TaFACaL                   {- tawATa> -}        `others` [ "tawA.ta'A PV-|_intr IV-|" ]
    ...
    noun     FaCL |< aT                {- waTo>ap -}        `others` [ "wa.t' Nap" ]
                                                            `gloss`  [ "pressure", "coercion", "vehemence" ],
    ...
    noun     FaCIL                     {- waTiy' -}         `gloss`  [ "low", "flat" ],
    ...
    noun     HaFCaL                    {- >awoTa> -}        `others` [ "'aw.ta'A N-|" ]
    ...
    noun     MaFCaL                    {- mawoTa> -}        `others` [ "maw.ti' Ndu", "mawA.ti' Ndip", "maw.ta'A N-|" ]
                                                            `gloss`  [ "foothold", "footing", "footholds" ],

    -- ;; tawoTi}ap_1
    -- twT}    tawoTi} Nap     preliminary step;paving the way;lowering

    noun     TaFCiL |< aT              {- tawoTi}ap -}      `others` [ "taw.ti' Nap" ]
                                                            `gloss`  [ "preliminary step", "paving the way", "lowering" ],

    -- ;; muwATa>ap_1
    -- mwAT>   muwATa> Napdu   agreement;collusion
    -- mwAT    muwATa  N-|t    agreements;collusions

    noun     MuFACaL |< aT             {- muwATa>ap -}      `others` [ "muwA.ta N-|t", "muwA.ta' Napdu" ]
    ...
    noun     TaFACuL                   {- tawATu& -}        `gloss`  [ "connivance", "collusion" ],

    -- ;; wATi}_1
    -- wAT}    wATi}   Nall    low;subdued     [[wATi}/ADJ]]

    noun     FACiL                     {- wATi} -}          `gloss`  [ "low", "subdued" ],
 ...
 |> "w.td" <| [
    ...
    noun     FaCIL                     {- waTiyd -}         `gloss`  [ "strong", "solid", "unshakable" ],

    -- ;; >awoTAd_1
    -- >wTAd   >awoTAd N       mountains
    -- AwTAd   >awoTAd N       mountains

    noun     HaFCAL                    {- >awoTAd -}        `gloss`  [ "mountains" ] ]
 ...
 |> "miy.tad" <| [
    ...
    noun     Identity |< aT            {- miyTadap -}       `others` [ "miy.tad Nap" ]
                                                            `gloss`  [ "rammer", "tamper" ],
    ...
    noun     MuFaCCaL                  {- muwaT~ad -}       `gloss`  [ "strong", "solid", "sturdy" ] ]
 ...
 |> "w.tf" <| [
    ...
    noun     HaFCaL                    {- >awoTaf -}        `others` [ "wa.tfA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "bushy-browed" ] ]
 ...
 |> "w.tf'" <| [
    ...
    noun     FaCCAL                    {- waTofA' -}        `gloss`  [ "heavy clouds" ] ]
 ...
 |> "w.tn" <| [
    ...
    noun     FaCaL |< Iy               {- waTaniy~ -}       `gloss`  [ "national" ],

    -- ;; waTaniy~_2
    -- wTny    waTaniy~        Nall    nationalist     [[waTaniy~/ADJ]]

    noun     FaCaL |< Iy               {- waTaniy~ -}       `gloss`  [ "nationalist" ],

    -- ;; waTaniy~ap_1
    -- wTny    waTaniy~        Nap     nationalism;patriotism     [[waTaniy~/NOUN]]

    noun     FaCaL |< Iy |< aT         {- waTaniy~ap -}     `others` [ "wa.taniyy Nap" ]
                                                            `gloss`  [ "nationalism", "patriotism" ],
    ...
    noun     MuFACaL |< aT             {- muwATanap -}      `others` [ "muwA.tan Nap" ]
                                                            `gloss`  [ "citizenship" ] ]
 ...
 |> "w.tn" <| [
    ...
    noun     IstICAL |< Iy             {- {isotiyTAniy~ -}  `gloss`  [ "settlement", "colonial" ] ]
 ...
 |> "w.tn" <| [
    ...
    noun     MutaFaCCiL                {- mutawaT~in -}     `gloss`  [ "endemic" ],
    ...
    noun     MustaFCaL |< aT           {- musotawoTanap -}  `others` [ "mustaw.tan NAt Napdu" ]
 ...
 |> "w.tw.t" <| [
    ...
    noun     FaCCAL                    {- waTowAT -}        `others` [ "wa.tAwiy.t Ndip", "wa.tAwi.t Ndip" ]
                                                            `gloss`  [ "bat", "bats" ] ]
 ...
 |> "w.ty" <| [
    ...
    noun     TaFCiL |< aT              {- tawoTiyap -}      `others` [ "taw.tiy Nap" ]
                                                            `gloss`  [ "lowering" ],
 ...
 |> "w.zb" <| [
    ...
    noun     MuFACaL |< aT             {- muwAZabap -}      `others` [ "muwA.zab NapAt" ]
                                                            `gloss`  [ "diligence", "persistence" ],
 ...
 |> "w.zf" <| [
    ...
    noun     FaCIL |< aT               {- waZiyfap -}       `others` [ "wa.zA'if Ndip", "wa.ziyf Napdu" ]
                                                            `gloss`  [ "job", "position", "function", "jobs", "positions", "functions" ],

    -- ;; waZiyfiy~_1
    -- wZyfy   waZiyfiy~       Nall    functional     [[waZiyfiy~/ADJ]]

    noun     FaCIL |< Iy               {- waZiyfiy~ -}      `gloss`  [ "functional" ],

    -- ;; waZiyfiy~ap_1
    -- wZyfy   waZiyfiy~       Nap     functionality     [[waZiyfiy~/NOUN]]

    noun     FaCIL |< Iy |< aT         {- waZiyfiy~ap -}    `others` [ "wa.ziyfiyy Nap" ]
                                                            `gloss`  [ "functionality" ],
    ...
    noun     MuFaCCaL                  {- muwaZ~af -}       `gloss`  [ "employed", "hired" ] ]
 ...
 |> "w`b" <| [
    ...
    verb     HaFCaL                    {- >awoEab -}        `others` [ "w`ib IV_yu", "w`ab IV_Pass_yu" ]
 ...
 |> "`b" <| [
    ...
    noun     IstICAL |< Iy             {- {isotiyEAbiy~ -}  `gloss`  [ "comprehensive", "assimilating", "all-encompassing" ] ]
 ...
 |> "w`_t'" <| [
    ...
    noun     FaCCAL                    {- waEovA' -}        `gloss`  [ "difficulty", "inconvenience" ] ]
 ...
 |> "w`d" <| [
    ...
    verb     FaCaL                     {- waEad-i -}        `imperf` [ FCiL ]
                                                            `others` [ "w`ad IV_Pass_yu", "wa`ad PV", "`id IV" ]
    ...
    verb     HaFCaL                    {- >awoEad -}        `others` [ "w`id IV_yu" ]
                                                            `gloss`  [ "promise" ],
 ...
 |> "wt`d" <| [
    ...
    verb     IFtaCaL                   {- {it~aEad -}       `others` [ "tta`id IV" ]
 ...
 |> "`d" <| [
    ...
    noun     CiL |< aT                 {- Eidap -}          `others` [ "`id Napdu" ]
                                                            `gloss`  [ "promise" ] ]
 ...
 |> "w`d" <| [
    ...
    noun     FaCIL |< Iy               {- waEiydiy~ -}      `gloss`  [ "threatening", "menacing" ],
 ...
 |> "wy`d" <| [
    ...
    noun     MiFCAL                    {- miyEAd -}         `others` [ "mawA`iyd Ndip" ]
                                                            `gloss`  [ "promise", "promises" ],
 ...
 |> "w`d" <| [
    ...
    noun     MuFACaL |< aT             {- muwAEadap -}      `others` [ "muwA`ad NapAt" ]
                                                            `gloss`  [ "appointment", "arrangement" ] ]
 ...
 |> "w`d" <| [
    ...
    noun     TaFaCCuL |< Iy            {- tawaE~udiy~ -}    `gloss`  [ "threatening", "menacing" ],

    -- ;; wAEid_1
    -- wAEd    wAEid   Nall    promising     [[wAEid/ADJ]]

    noun     FACiL                     {- wAEid -}          `gloss`  [ "promising" ],

    -- ;; mawoEuwd_1
    -- mwEwd   mawoEuwd        N-ap    promised;appointed;stipulated     [[mawoEuwd/ADJ]]

    noun     MaFCUL                    {- mawoEuwd -}       `gloss`  [ "promised", "appointed", "stipulated" ],
    ...
    noun     MutaFaCCiL                {- mutawaE~id -}     `gloss`  [ "promising", "threatening" ] ]
 ...
 |> "w`r" <| [
    ...
    verb     FaCaL                     {- waEar-i -}        `imperf` [ FCiL ]
                                                            `others` [ "`ir IV_intr", "w`ir IV_intr", "wa`ar PV_intr" ]
    ...
    noun     FuCUL |< aT               {- wuEuwrap -}       `others` [ "wu`uwr Nap" ]
    ...
    noun     HaFCaL                    {- >awoEar -}        `gloss`  [ "rougher / roughest", "more / most rugged" ] ]
 ...
 |> "w`z" <| [
    ...
    verb     HaFCaL                    {- >awoEaz -}        `others` [ "w`iz IV_yu", "w`az IV_Pass_yu" ]
 ...
 |> "w`z" <| [
    ...
    noun     MuFCaL                    {- muwEaz -}         `gloss`  [ "inspired", "suggested" ] ]
 ...
 |> "wy`s" <| [
    ...
    noun     MiFCAL                    {- miyEAs -}         `gloss`  [ "quicksand" ] ]
 ...
 |> "wt`.z" <| [
    ...
    verb     IFtaCaL                   {- {it~aEaZ -}       `others` [ "tta`i.z IV_intr" ]
 ...
 |> "`.z" <| [
    ...
    noun     CiL |< aT                 {- EiZap -}          `others` [ "`i.z NapAt" ]
                                                            `gloss`  [ "sermon", "admonition" ] ]
 ...
 |> "w`.z" <| [
    ...
    noun     FaCL |< aT                {- waEoZap -}        `others` [ "wa`.z Napdu" ]
                                                            `gloss`  [ "admonition", "sermon" ],

    -- ;; mawoEiZap_1
    -- mwEZ    mawoEiZ Napdu   exhortation;lecture
    -- mwAEZ   mawAEiZ Ndip    exhortations;lectures

    noun     MaFCiL |< aT              {- mawoEiZap -}      `others` [ "maw`i.z Napdu", "mawA`i.z Ndip" ]
 ...
 |> "w`q" <| [
    ...
    noun     FaCiL                     {- waEiq -}          `gloss`  [ "irritable", "petulant" ] ]
 ...
 |> "w`k" <| [
    ...
    noun     FaCiL                     {- waEik -}          `gloss`  [ "indisposed" ],

    -- ;; waEokap_1
    -- wEk     waEok   Nap     indisposition;sultriness

    noun     FaCL |< aT                {- waEokap -}        `others` [ "wa`k Nap" ]
    ...
    noun     MaFCUL                    {- mawoEuwk -}       `gloss`  [ "indisposed" ],

    -- ;; mutawaE~ik_1
    -- mtwEk   mutawaE~ik      Nall    indisposed     [[mutawaE~ik/ADJ]]

    noun     MutaFaCCiL                {- mutawaE~ik -}     `gloss`  [ "indisposed" ] ]
 ...
 |> "w`w`" <| [
    ...
    verb     FaCCaL                    {- waEowaE -}        `others` [ "wa`wi` IV_yu" ]
                                                            `gloss`  [ "howl", "yelp" ],

    -- ;; waEowaEap_1
    -- wEwE    waEowaE NapAt   howling;yelping

    noun     FaCCaL |< aT              {- waEowaEap -}      `others` [ "wa`wa` NapAt" ]
                                                            `gloss`  [ "howling", "yelping" ] ]
 ...
 |> "w`" <| [
    ...
    verb     FaCY                      {- waEaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "w`Y IV_0", "wa`Y PV_0", "`iy IV_0hAnn", "wa`ay PV_Atn", "wa`A PV_h", "wa` PV_ttAw_intr" ]
 ...
 |> "w`" <| [
    ...
    verb     HaFCY                     {- >awoEaY -}        `others` [ "'aw` PV_ttAw", "w`Y IV_0_Pass_yu", "'aw`A PV_h", "w` IV_0hwnyn_yu", "w`ay IV_Ann_Pass_yu", "'aw`ay PV_Atn", "w`iy IV_0hAnn_yu" ]
 ...
 |> "w`y" <| [
    ...
    noun     TaFCiL |< aT              {- tawoEiyap -}      `others` [ "taw`iy Nap" ]
    ...
    noun     FACiL                     {- wAEiy -}          `others` [ "wA` Nuwn_Niyn NK" ]
                                                            `gloss`  [ "aware", "alert", "conscious" ],

    -- ;; wAEiyap_1
    -- wAEy    wAEiy   Nap     consciousness

    noun     FACiL |< aT               {- wAEiyap -}        `others` [ "wA`iy Nap" ]
                                                            `gloss`  [ "consciousness" ] ]
 ...
 |> "w.gr" <| [
    ...
    verb     FaCaL                     {- wagar-i -}        `imperf` [ FCiL ]
                                                            `others` [ ".gir IV_intr", "w.gir IV_intr", "wa.gar PV_intr" ]
    ...
    verb     HaFCaL                    {- >awogar -}        `others` [ "w.gir IV_yu" ]
 ...
 |> "w.gl" <| [
    ...
    verb     FaCaL                     {- wagal-i -}        `imperf` [ FCiL ]
                                                            `others` [ "w.gal IV_Pass_yu", "wa.gal PV", ".gil IV" ]
    ...
    verb     HaFCaL                    {- >awogal -}        `others` [ "w.gil IV_yu" ]
    ...
    noun     MuFCiL                    {- muwgil -}         `gloss`  [ "deep-reaching", "deep-rooted" ] ]
 ...
 |> "wf" <| [
    ...
    noun     FaCA                      {- wafA -}           `gloss`  [ "WAFA ( Palestine News Agency )" ] ]
 ...
 |> "wfd" <| [
    ...
    verb     HaFCaL                    {- >awofad -}        `others` [ "wfad IV_Pass_yu", "wfid IV_yu" ]
    ...
    noun     FaCL |< Iy                {- wafodiy~ -}       `gloss`  [ "Wafdist" ],

    -- ;; wifAdap_1
    -- wfAd    wifAd   Nap     arrival

    noun     FiCAL |< aT               {- wifAdap -}        `others` [ "wifAd Nap" ]
                                                            `gloss`  [ "arrival" ] ]
 ...
 |> "wfd" <| [
    ...
    noun     HICAL                     {- <iyfAd -}         `gloss`  [ "deputation", "delegation", "dispatch" ] ]
 ...
 |> "wfd" <| [
    ...
    noun     FACiL                     {- wAfid -}          `gloss`  [ "arriving", "coming" ],
 ...
 |> "wfr" <| [
    ...
    verb     FaCaL                     {- wafar-i -}        `imperf` [ FCiL ]
                                                            `others` [ "wafar PV_intr", "fir IV_intr" ]
                                                            `gloss`  [ "be plentiful" ],
    ...
    verb     HaFCaL                    {- >awofar -}        `others` [ "wfir IV_yu", "wfar IV_Pass_yu" ]
    ...
    noun     FACiL                     {- wAfir -}          `gloss`  [ "ample", "abundant", "abounding in" ],

    -- ;; mawofuwr_1
    -- mwfwr   mawofuwr        Nall    ample;abundant;abounding in     [[mawofuwr/ADJ]]

    noun     MaFCUL                    {- mawofuwr -}       `gloss`  [ "ample", "abundant", "abounding in" ],

    -- ;; mutawaf~ir_1
    -- mtwfr   mutawaf~ir      Nall    available;abundant     [[mutawaf~ir/ADJ]]

    noun     MutaFaCCiL                {- mutawaf~ir -}     `gloss`  [ "available", "abundant" ],

    -- ;; mutawAfir_1
    -- mtwAfr  mutawAfir       Nall    available;abundant     [[mutawAfir/ADJ]]

    noun     MutaFACiL                 {- mutawAfir -}      `gloss`  [ "available", "abundant" ] ]
 ...
 |> "wfz" <| [
    ...
    noun     MutaFaCCiL                {- mutawaf~iz -}     `gloss`  [ "alert", "quick" ] ]
 ...
 |> "wf.d" <| [
    ...
    noun     FaCL |< aT                {- wafoDap -}        `others` [ "wifA.d N", "waf.d Napdu" ]
 ...
 |> "wf`" <| [
    ...
    noun     FaCIL |< aT               {- wafiyEap -}       `others` [ "wafiy` Nap" ]
                                                            `gloss`  [ "pen wiper" ] ]
 ...
 |> "wfq" <| [
    ...
    verb     FaCaL                     {- wafaq-i -}        `imperf` [ FCiL ]
                                                            `others` [ "wafaq PV_intr", "fiq IV_intr" ]
 ...
 |> "wifqa" <| [
    ...
    noun     Identity                  {- wifoqa -}         `others` [ "wifq NF" ]
                                                            `gloss`  [ "according to", "in accordance with", "pursuant to" ],

    -- ;; wafoqap_1
    -- wfq     wafoq   Nap     task item;work piece

    noun     FaCL |< aT                {- wafoqap -}        `others` [ "wafq Nap" ]
                                                            `gloss`  [ "task item", "work piece" ],

    -- ;; >awofaq_1
    -- >wfq    >awofaq Nel     more/most suitable
    -- Awfq    >awofaq Nel     more/most suitable

    noun     HaFCaL                    {- >awofaq -}        `gloss`  [ "more / most suitable" ],
    ...
    noun     FiCAL |< Iy               {- wifAqiy~ -}       `gloss`  [ "agreement", "accord" ],

    -- ;; muwAfaqap_1
    -- mwAfq   muwAfaq NapAt   agreement

    noun     MuFACaL |< aT             {- muwAfaqap -}      `others` [ "muwAfaq NapAt" ]
                                                            `gloss`  [ "agreement" ],
 ...
 |> "ittifAq" <| [
    ...
    noun     Identity |< Iy            {- {it~ifAqiy~ -}    `gloss`  [ "conventional" ] ]
 ...
 |> "ittifAq" <| [
    ...
    noun     Identity |< Iy |< aT      {- {it~ifAqiy~ap -}  `others` [ "ittifAqiyy NAt Napdu" ]
                                                            `gloss`  [ "treaty", "accord", "treaties", "accords" ],

    -- ;; muwaf~aq_1
    -- mwfq    muwaf~aq        Nall    successful;granted success     [[muwaf~aq/ADJ]]

    noun     MuFaCCaL                  {- muwaf~aq -}       `gloss`  [ "successful", "granted success" ],

    -- ;; muwAfiq_1
    -- mwAfq   muwAfiq Nall    agreeing;consenting;corresponding to     [[muwAfiq/ADJ]]

    noun     MuFACiL                   {- muwAfiq -}        `gloss`  [ "agreeing", "consenting", "corresponding to" ],

    -- ;; mutawaf~iq_1
    -- mtwfq   mutawaf~iq      Nall    successful     [[mutawaf~iq/ADJ]]

    noun     MutaFaCCiL                {- mutawaf~iq -}     `gloss`  [ "successful" ] ]
 ...
 |> "muttafaq" <| [
    ...
    noun     Identity                  {- mut~afaq -}       `gloss`  [ "agreed" ] ]
 ...
 |> "muttifaq" <| [
    ...
    noun     Identity                  {- mut~ifaq -}       `gloss`  [ "in agreement" ] ]
 ...
 |> "wf" <| [
    ...
    verb     FaCY                      {- wafaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "waf PV_ttAw", "wafA PV_h", "wfY IV_0_Pass_yu", "wafY PV_0", "fiy IV_0hAnn", "wafay PV_Atn" ]
 ...
 |> "wf" <| [
    ...
    verb     HaFCY                     {- >awofaY -}        `others` [ "wf IV_0hwnyn_yu", "'awfA PV_h", "'awfay PV_Atn", "wfY IV_0_Pass_yu", "'awf PV_ttAw", "wfay IV_Ann_Pass_yu", "wfiy IV_0hAnn_yu" ]
 ...
 |> "wafAT" <| [
    ...
    noun     CaL |< Iy                 {- wafiy~ -}         `others` [ "'awfiyA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "faithful", "complete" ],
    ...
    noun     HaFCY                     {- >awofaY -}        `others` [ "'awfA Nhy", "'awfay NAn_Nayn" ]
 ...
 |> "wfy" <| [
    ...
    noun     TaFCiL |< aT              {- tawofiyap -}      `others` [ "tawfiy Nap" ]
                                                            `gloss`  [ "satisfaction", "fulfillment" ] ]
 ...
 |> "'f'" <| [
    ...
    noun     FICAL                     {- <iyfA' -}         `gloss`  [ "fulfillment", "payment" ] ]
 ...
 |> "wyf" <| [
    ...
    noun     IstiFCA'                  {- {isotiyfA' -}     `gloss`  [ "fulfillment", "completion" ] ]
 ...
 |> "wqq" <| [
    ...
    noun     FuCL |< aT                {- wuq~ap -}         `others` [ "wiqq NapAt", "wuqq NapAt" ]
 ...
 |> "wqb" <| [
    ...
    verb     FaCaL                     {- waqab-i -}        `imperf` [ FCiL ]
                                                            `others` [ "qib IV_intr", "waqab PV_intr" ]
    ...
    noun     FaCL |< aT                {- waqobap -}        `others` [ "waqab NAt", "waqb Napdu" ]
                                                            `gloss`  [ "cavity", "cavities" ] ]
 ...
 |> "wqt" <| [
    ...
    noun     FaCL                      {- waqot -}          `others` [ "'awqAt N", "waqtamA FW-Wa", "waqta_dAk FW-Wa", "waqta'i_diN FW-Wa" ]
                                                            `gloss`  [ "time", "moment", "period of time", "at that time", "whenever", "moments", "times" ] ]
 ...
 |> "'uwayq" <| [
    ...
    noun     Identity |< At            {- >uwayoqAt -}      `others` [ "'uwayq NAt" ]
                                                            `gloss`  [ "short times", "good times" ],

    -- ;; waqotiy~_1
    -- wqty    waqotiy~        N-ap    temporal;temporary;provisional     [[waqotiy~/ADJ]]

    noun     FaCL |< Iy                {- waqotiy~ -}       `gloss`  [ "temporal", "temporary", "provisional" ],
 ...
 |> "wmq" <| [
    ...
    noun     FIL |< At                 {- miyqAt -}         `others` [ "mawAqiyt Ndip" ]
 ...
 |> "wqt" <| [
    ...
    noun     MaFCUL                    {- mawoquwt -}       `gloss`  [ "appointed ( time )", "scheduled" ],

    -- ;; mawoquwt_2
    -- mwqwt   mawoquwt        N-ap    time (bomb);equipped with a time fuse     [[mawoquwt/ADJ]]

    noun     MaFCUL                    {- mawoquwt -}       `gloss`  [ "time ( bomb )", "equipped with a time fuse" ],
    ...
    noun     MuFaCCaL                  {- muwaq~at -}       `gloss`  [ "temporary", "provisional", "temporarily", "provisionally" ],

    -- ;; muwaq~at_2
    -- mwqt    muwaq~at        N-ap    time (bomb);equipped with a time fuse     [[muwaq~at/ADJ]]

    noun     MuFaCCaL                  {- muwaq~at -}       `gloss`  [ "time ( bomb )", "equipped with a time fuse" ] ]
 ...
 |> "wq.h" <| [
    ...
    verb     FaCuL                     {- waquH-u -}        `imperf` [ FCuL ]
                                                            `others` [ "wqu.h IV_intr", "waqu.h PV_intr" ]
                                                            `gloss`  [ "be shameless" ],
    ...
    verb     FaCiL                     {- waqiH-a -}        `imperf` [ FCaL ]
                                                            `others` [ "wqa.h IV_intr", "waqi.h PV_intr" ]
                                                            `gloss`  [ "be shameless" ],
    ...
    verb     FaCaL                     {- waqaH-i -}        `imperf` [ FCiL ]
                                                            `others` [ "waqa.h PV_intr", "qi.h IV_intr" ]
                                                            `gloss`  [ "be shameless" ],
 ...
 |> "wq.h" <| [
    ...
    noun     CiL |< aT                 {- qiHap -}          `others` [ "qi.h NapAt" ]
                                                            `gloss`  [ "insolence", "impudence" ] ]
 ...
 |> "wq.h" <| [
    ...
    noun     FaCiL                     {- waqiH -}          `gloss`  [ "insolent", "impertinent" ],
    ...
    noun     FaCIL                     {- waqiyH -}         `gloss`  [ "insolent", "impertinent" ],

    -- ;; waqAHap_1
    -- wqAH    waqAH   Nap     insolence;impertinence

    noun     FaCAL |< aT               {- waqAHap -}        `others` [ "waqA.h Nap" ]
                                                            `gloss`  [ "insolence", "impertinence" ],

    -- ;; wuquwHap_1
    -- wqwH    wuquwH  Nap     insolence;impertinence

    noun     FuCUL |< aT               {- wuquwHap -}       `others` [ "wuquw.h Nap" ]
                                                            `gloss`  [ "insolence", "impertinence" ] ]
 ...
 |> "wqd" <| [
    ...
    verb     HaFCaL                    {- >awoqad -}        `others` [ "wqad IV_Pass_yu", "wqid IV_yu" ]
 ...
 |> "ittaqad" <| [
    ...
    noun     FaCL |< aT                {- waqodap -}        `others` [ "waqd Nap" ]
                                                            `gloss`  [ "fire", "blaze" ],
 ...
 |> "wqd" <| [
    ...
    noun     HICAL                     {- <iyqAd -}         `gloss`  [ "ignition", "kindling" ] ]
 ...
 |> "ittiqAd" <| [
    ...
    noun     MaFCUL                    {- mawoquwd -}       `gloss`  [ "burning", "ignited" ],

    -- ;; muwqid_1
    -- mwqd    muwqid  N-ap    scorching hot     [[muwqid/ADJ]]

    noun     MuFCiL                    {- muwqid -}         `gloss`  [ "scorching hot" ],

    -- ;; mutawaq~id_1
    -- mtwqd   mutawaq~id      Nall    burning;blazing     [[mutawaq~id/ADJ]]

    noun     MutaFaCCiL                {- mutawaq~id -}     `gloss`  [ "burning", "blazing" ] ]
 ...
 |> "muttaqid" <| [
    ...
    noun     Identity                  {- mut~aqid -}       `gloss`  [ "burning", "blazing" ],
 ...
 |> "wq_d" <| [
    ...
    noun     FaCIL                     {- waqiy* -}         `gloss`  [ "fatally ill" ],

    -- ;; mawoquw*_1
    -- mwqw*   mawoquw*        Nall    fatally ill     [[mawoquw*/ADJ]]

    noun     MaFCUL                    {- mawoquw* -}       `gloss`  [ "fatally ill" ] ]
 ...
 |> "wqr" <| [
    ...
    verb     FaCuL                     {- waqur-u -}        `imperf` [ FCuL ]
                                                            `others` [ "wqur IV_intr", "waqur PV_intr" ]
                                                            `gloss`  [ "be dignified" ],
    ...
    verb     HaFCaL                    {- >awoqar -}        `others` [ "wqir IV_yu", "wqar IV_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- waqorap -}        `others` [ "waqr Napdu" ]
                                                            `gloss`  [ "cavity", "hollow" ],
    ...
    noun     FaCUL                     {- waquwr -}         `gloss`  [ "dignified", "venerable" ],
    ...
    noun     MuFaCCaL                  {- muwaq~ar -}       `gloss`  [ "respected", "venerable" ] ]
 ...
 |> "wuqqi`" <| [
    ...
    verb     HaFCaL                    {- >awoqaE -}        `others` [ "wqi` IV_yu", "wqa` IV_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- waqoEap -}        `others` [ "waqa` NAt", "waq` Napdu" ]
    ...
    noun     FaCIL |< aT               {- waqiyEap -}       `others` [ "waqA'i` Ndip", "waqiy` Napdu" ]
    ...
    noun     MaFCaL |< aT              {- mawoqaEap -}      `others` [ "mawqa` Napdu" ]
                                                            `gloss`  [ "battlefield" ] ]
 ...
 |> "wyq`" <| [
    ...
    noun     MiFCaL |< aT              {- miyqaEap -}       `others` [ "miyqa` Nap" ]
                                                            `gloss`  [ "grindstone" ] ]
 ...
 |> "wq`" <| [
    ...
    noun     TaFCIL |< Iy              {- tawoqiyEiy~ -}    `gloss`  [ "signature", "rhythmical" ],
 ...
 |> "wq`" <| [
    ...
    noun     FACiL |< aT               {- wAqiEap -}        `others` [ "wAqi` NapAt" ]
                                                            `gloss`  [ "incident" ],

    -- ;; wAqiEiy~_1
    -- wAqEy   wAqiEiy~        N-ap    realistic     [[wAqiEiy~/ADJ]]

    noun     FACiL |< Iy               {- wAqiEiy~ -}       `gloss`  [ "realistic" ],

    -- ;; wAqiEiy~ap_1
    -- wAqEy   wAqiEiy~        Nap     realism;reality     [[wAqiEiy~/NOUN]]

    noun     FACiL |< Iy |< aT         {- wAqiEiy~ap -}     `others` [ "wAqi`iyy Nap" ]
                                                            `gloss`  [ "realism", "reality" ],

    -- ;; muwaq~iE_1
    -- mwqE    muwaq~iE        Nall    signing;signatory     [[muwaq~iE/ADJ]]

    noun     MuFaCCiL                  {- muwaq~iE -}       `gloss`  [ "signing", "signatory" ],

    -- ;; muwaq~aE_1
    -- mwqE    muwaq~aE        N-ap    signed     [[muwaq~aE/ADJ]]

    noun     MuFaCCaL                  {- muwaq~aE -}       `gloss`  [ "signed" ],

    -- ;; mutawaq~aE_1
    -- mtwqE   mutawaq~aE      Nall    expected;anticipated     [[mutawaq~aE/ADJ]]

    noun     MutaFaCCaL                {- mutawaq~aE -}     `gloss`  [ "expected", "anticipated" ],

    -- ;; mutawaq~iE_1
    -- mtwqE   mutawaq~iE      Nall    expecting;anticipating     [[mutawaq~iE/ADJ]]

    noun     MutaFaCCiL                {- mutawaq~iE -}     `gloss`  [ "expecting", "anticipating" ] ]
 ...
 |> "wqf" <| [
    ...
    verb     HaFCaL                    {- >awoqaf -}        `others` [ "'uwqif PV_Pass", "wqaf IV_Pass_yu", "wqif IV_yu" ]
    ...
    noun     FaCL |< Iy                {- waqofiy~ -}       `gloss`  [ "waqf ( religious endowment )" ],

    -- ;; waqofiy~ap_1
    -- wqfy    waqofiy~        Nap     religious endowments     [[waqofiy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- waqofiy~ap -}     `others` [ "waqfiyy Nap" ]
                                                            `gloss`  [ "religious endowments" ],

    -- ;; waqofap_1
    -- wqf     waqof   Nap     stance;posture

    noun     FaCL |< aT                {- waqofap -}        `others` [ "waqf Nap" ]
 ...
 |> "wqf" <| [
    ...
    noun     HICAL                     {- <iyqAf -}         `gloss`  [ "stopping", "halting" ] ]
 ...
 |> "wqf" <| [
    ...
    noun     FACiL                     {- wAqif -}          `gloss`  [ "standing" ],

    -- ;; wAqif_2
    -- wAqf    wAqif   N-ap    stopped     [[wAqif/ADJ]]

    noun     FACiL                     {- wAqif -}          `gloss`  [ "stopped" ],

    -- ;; mawoquwf_1
    -- mwqwf   mawoquwf        Nall    stopped;suspended     [[mawoquwf/ADJ]]

    noun     MaFCUL                    {- mawoquwf -}       `gloss`  [ "stopped", "suspended" ],

    -- ;; muwaq~af_1
    -- mwqf    muwaq~af        Nall    detained;stopped     [[muwaq~af/ADJ]]

    noun     MuFaCCaL                  {- muwaq~af -}       `gloss`  [ "detained", "stopped" ],
 ...
 |> "wqwq" <| [
    ...
    verb     FaCCaL                    {- waqowaq -}        `others` [ "waqwiq IV_yu" ]
                                                            `gloss`  [ "bark" ],

    -- ;; waqowaqap_1
    -- wqwq    waqowaq NapAt   barking

    noun     FaCCaL |< aT              {- waqowaqap -}      `others` [ "waqwaq NapAt" ]
                                                            `gloss`  [ "barking" ],

    -- ;; waqowAq_1
    -- wqwAq   waqowAq Ndu     cuckoo

    noun     FaCCAL                    {- waqowAq -}        `gloss`  [ "cuckoo" ],
    ...
    noun     FaCCAL                    {- waqowAq -}        `others` [ "wAqwAq N0" ]
 ...
 |> "wq" <| [
    ...
    verb     FaCY                      {- waqaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "waqay PV_Atn", "q IV_0hwnyn", "waq PV_ttAw", "wqY IV_0_Pass_yu", "waqA PV_h", "qiy IV_0hAnn", "waqY PV_0" ]
 ...
 |> "wtq" <| [
    ...
    verb     IFtaCY                    {- {it~aqaY -}       `others` [ "ittaq PV_ttAw", "ittaqay PV_Atn", "ttaq IV_0hwnyn", "ittaqA PV_h", "ttaqY IV_0_Pass_yu", "ttaqiy IV_0hAnn" ]
                                                            `gloss`  [ "beware", "be on guard" ] ]
 ...
 |> "wqy" <| [
    ...
    noun     FiCAL |< aT               {- wiqAyap -}        `others` [ "wiqAy Nap" ]
 ...
 |> "wqy" <| [
    ...
    noun     FaCCAL |< aT              {- waq~Ayap -}       `others` [ "waqqAy NapAt" ]
 ...
 |> "wq" <| [
    ...
    noun     FiCA' |< Iy               {- wiqA}iy~ -}       `others` [ "waqA'iyy Nall" ]
                                                            `gloss`  [ "protective", "preservative" ],

    -- ;; wiqA}iy~ap_1
    -- wqA}y   wiqA}iy~        Nap     prevention;protection     [[wiqA}iy~/NOUN]]

    noun     FiCA' |< Iy |< aT         {- wiqA}iy~ap -}     `others` [ "wiqA'iyy Nap" ]
                                                            `gloss`  [ "prevention", "protection" ],

    -- ;; waqiy~_1
    -- wqy     waqiy~  Nall    protecting;guardian     [[waqiy~/ADJ]]

    noun     CaL |< Iy                 {- waqiy~ -}         `gloss`  [ "protecting", "guardian" ] ]
 ...
 |> "wqy" <| [
    ...
    noun     FACiL                     {- wAqiy -}          `others` [ "wAq Nuwn_Niyn NK" ]
                                                            `gloss`  [ "preserving", "guarding", "protecting" ],

    -- ;; wAqiyap_1
    -- wAqy    wAqiy   Napdu   shelter;shield

    noun     FACiL |< aT               {- wAqiyap -}        `others` [ "wAqiy Napdu" ]
                                                            `gloss`  [ "shelter", "shield" ] ]
 ...
 |> "wq" <| [
    ...
    noun     CiL |< Iy |< aT           {- wiqiy~ap -}       `others` [ "wiqiyy NapAt" ]
                                                            `gloss`  [ "uqiya ( measure = 1 / 12 ratl", "Beirut : 213 gr", "Jerusalem 240 gr .", "Aleppo 320 gr . )" ] ]
 ...
 |> "wk'" <| [
    ...
    verb     TaFaCCaL                  {- tawak~a> -}       `others` [ "tawakka'A PV-|_intr IV-|" ]
 ...
 |> "ittaka'" <| [
    ...
    verb     Identity                  {- {it~aka> -}       `others` [ "ittaka'A PV-|", "ttaki' IV" ]
                                                            `gloss`  [ "lean", "recline", "be supported" ] ]
 ...
 |> "tuka'" <| [
    ...
    noun     Identity |< aT            {- tuka>ap -}        `others` [ "tuka' Napdu" ]
                                                            `gloss`  [ "support", "prop", "staff" ],

    -- ;; tawak~u&_1
    -- twk&    tawak~u&        N/At    resting;leaning;reclining
    -- twk}    tawak~u}        N/At    resting;leaning;reclining

    noun     TaFaCCuL                  {- tawak~u& -}       `gloss`  [ "resting", "leaning", "reclining" ] ]
 ...
 |> "wtk" <| [
    ...
    noun     IFtiCA'                   {- {it~ikA' -}       `gloss`  [ "resting", "leaning", "reclining" ] ]
 ...
 |> "muttaka'" <| [
    ...
    noun     Identity                  {- mut~aka> -}       `others` [ "muttaka N-|t", "muttaka'A N-|" ]
 ...
 |> "wkd" <| [
    ...
    noun     FaCIL                     {- wakiyd -}         `gloss`  [ "confirmed", "substantiated" ],
    ...
    noun     TaFCIL |< Iy              {- tawokiydiy~ -}    `gloss`  [ "affirmative", "confirming" ],

    -- ;; muwak~ad_1
    -- mwkd    muwak~ad        Nall    certain;definite     [[muwak~ad/ADJ]]

    noun     MuFaCCaL                  {- muwak~ad -}       `gloss`  [ "certain", "definite" ],

    -- ;; mutawak~id_1
    -- mtwkd   mutawak~id      Nall    certain;convinced     [[mutawak~id/ADJ]]

    noun     MutaFaCCiL                {- mutawak~id -}     `gloss`  [ "certain", "convinced" ] ]
 ...
 |> "wkr" <| [
    ...
    noun     FaCL |< aT                {- wakorap -}        `others` [ "wukar N", "wakr Napdu" ]
                                                            `gloss`  [ "nest" ] ]
 ...
 |> "wks" <| [
    ...
    noun     FaCL |< aT                {- wakosap -}        `others` [ "waks Napdu" ]
                                                            `gloss`  [ "drop in value", "depreciation" ] ]
 ...
 |> "wk`" <| [
    ...
    verb     FaCuL                     {- wakuE-a -}        `imperf` [ FCaL ]
                                                            `others` [ "wku` IV_intr", "waku` PV_intr" ]
                                                            `gloss`  [ "be sturdy", "be strong" ],

    -- ;; wakAEap_1
    -- wkAE    wakAE   Nap     being strong;strength

    noun     FaCAL |< aT               {- wakAEap -}        `others` [ "wakA` Nap" ]
                                                            `gloss`  [ "being strong", "strength" ] ]
 ...
 |> "wyk`" <| [
    ...
    noun     MiFCaL |< aT              {- miykaEap -}       `others` [ "miyka` Nap" ]
                                                            `gloss`  [ "plowshare" ] ]
 ...
 |> "wkl" <| [
    ...
    verb     HaFCaL                    {- >awokal -}        `others` [ "wkil IV_yu", "wkal IV_Pass_yu" ]
 ...
 |> "ittakal" <| [
    ...
    noun     FiCAL |< aT               {- wikAlap -}        `others` [ "wakAl NAt Napdu", "wikAl NAt Napdu" ]
    ...
    noun     FiCAL |< aT               {- wikAlap -}        `others` [ "wakAl Nap", "wikAl Nap" ]
                                                            `gloss`  [ "proxy" ] ]
 ...
 |> "tukal" <| [
    ...
    noun     Identity |< aT            {- tukalap -}        `others` [ "tukal Nap" ]
                                                            `gloss`  [ "not self-reliant" ],
 ...
 |> "wkl" <| [
    ...
    noun     HICAL                     {- <iykAl -}         `gloss`  [ "entrusting", "assigning", "authorizing", "empowering" ] ]
 ...
 |> "wkn" <| [
    ...
    noun     FuCL |< aT                {- wukonap -}        `others` [ "wakan NAt", "wakn Napdu", "wukn Napdu" ]
                                                            `gloss`  [ "nest", "nests" ] ]
 ...
 |> "wk" <| [
    ...
    verb     FaCY                      {- wakaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "kiy IV_0hAnn", "wkY IV_0_Pass_yu", "wakA PV_h", "wakay PV_Atn", "wak PV_ttAw", "wakY PV_0" ]
 ...
 |> "wl^g" <| [
    ...
    verb     HaFCaL                    {- >awolaj -}        `others` [ "wla^g IV_Pass_yu", "wli^g IV_yu" ]
 ...
 |> "wl^g" <| [
    ...
    noun     CiL |< aT                 {- lijap -}          `others` [ "li^g Nap_L" ]
                                                            `gloss`  [ "entering", "penetration" ] ]
 ...
 |> "wl^g" <| [
    ...
    noun     FaCIL |< aT               {- waliyjap -}       `others` [ "waliy^g Napdu" ]
                                                            `gloss`  [ "intimate friend", "confidant" ] ]
 ...
 |> "wl^g" <| [
    ...
    noun     HICAL                     {- <iylAj -}         `gloss`  [ "insertion", "intromission", "intercalation" ] ]
 ...
 |> "wld" <| [
    ...
    verb     FaCaL                     {- walad-i -}        `imperf` [ FCiL ]
                                                            `others` [ "wlad IV_Pass_yu", "walad PV", "wulid PV_Pass", "lid IV" ]
 ...
 |> "wld" <| [
    ...
    noun     CiL |< aT                 {- lidap -}          `others` [ "lid Nap_L" ]
                                                            `gloss`  [ "childbirth", "birth" ],

    -- ;; lidap_2
    -- ld      lid     NapAt_L contemporary
    -- ld      lid     Nuwn_Niyn_L     contemporaries

    noun     CiL |< aT                 {- lidap -}          `others` [ "lid NapAt_L Nuwn_Niyn_L" ]
 ...
 |> "wld" <| [
    ...
    noun     FaCL |< aT                {- walodap -}        `others` [ "wald Nap" ]
                                                            `gloss`  [ "childbirth" ],
    ...
    noun     FaCIL |< aT               {- waliydap -}       `others` [ "waliyd Napdu", "walA'id Ndip" ]
                                                            `gloss`  [ "result", "product", "child", "results", "products", "children" ],
    ...
    noun     FiCAL |< aT               {- wilAdap -}        `others` [ "wilAd Nap" ]
                                                            `gloss`  [ "birth", "childbearing" ],

    -- ;; wilAdiy~_1
    -- wlAdy   wilAdiy~        N-ap    birth;childbearing     [[wilAdiy~/ADJ]]

    noun     FiCAL |< Iy               {- wilAdiy~ -}       `gloss`  [ "birth", "childbearing" ],

    -- ;; wal~Adap_1
    -- wlAd    wal~Ad  Nap     productive;fertile

    noun     FaCCAL |< aT              {- wal~Adap -}       `others` [ "wallAd Nap" ]
                                                            `gloss`  [ "productive", "fertile" ],
    ...
    noun     FuCUL |< Iy |< aT         {- wuluwdiy~ap -}    `others` [ "wuluwdiyy Nap" ]
                                                            `gloss`  [ "childishness", "puerility" ],
 ...
 |> "wld" <| [
    ...
    noun     MICAL |< Iy               {- miylAdiy~ -}      `gloss`  [ "A.D .", "Christian Era" ] ]
 ...
 |> "wld" <| [
    ...
    noun     FACiL |< Iy               {- wAlidiy~ -}       `gloss`  [ "parental" ],
    ...
    noun     MuFaCCiL |< aT            {- muwal~idap -}     `others` [ "muwallid NapAt" ]
                                                            `gloss`  [ "midwife" ],
 ...
 |> "wldn" <| [
    ...
    noun     FaCCaL |< aT              {- walodanap -}      `others` [ "waldan Nap" ]
                                                            `gloss`  [ "childhood", "puerility" ] ]
 ...
 |> "wls" <| [
    ...
    verb     FaCaL                     {- walas-i -}        `imperf` [ FCiL ]
                                                            `others` [ "lis IV", "wlas IV_Pass_yu", "walas PV" ]
    ...
    verb     HaFCaL                    {- >awolas -}        `others` [ "wlis IV_yu", "wlas IV_Pass_yu" ]
    ...
    noun     MuFACaL |< aT             {- muwAlasap -}      `others` [ "muwAlas NapAt" ]
                                                            `gloss`  [ "fraud", "duplicity" ] ]
 ...
 |> "wl`" <| [
    ...
    verb     HaFCaL                    {- >awolaE -}        `others` [ "wla` IV_Pass_yu", "wli` IV_yu" ]
    ...
    noun     HaFCaL                    {- >awolaE -}        `others` [ "'uwli` PV_Pass", "wla` IV_Pass_yu" ]
    ...
    noun     FaCiL                     {- waliE -}          `gloss`  [ "passionate" ],
    ...
    noun     FaCCAL |< aT              {- wal~AEap -}       `others` [ "wallA` NapAt" ]
                                                            `gloss`  [ "lighter" ],
 ...
 |> "wlf" <| [
    ...
    noun     MuFACaL |< aT             {- muwAlafap -}      `others` [ "muwAlaf NapAt" ]
                                                            `gloss`  [ "harmony", "concord" ],
 ...
 |> "wlm" <| [
    ...
    verb     HaFCaL                    {- >awolam -}        `others` [ "wlim IV_yu", "wlam IV_Pass_yu" ]
    ...
    noun     FaCIL |< aT               {- waliymap -}       `others` [ "walA'im Ndip", "waliym Napdu" ]
 ...
 |> "wlh" <| [
    ...
    verb     FaCiL                     {- walih-ai -}       `imperf` [ FCaL, FCiL ]
                                                            `others` [ "walih PV_intr", "wlah IV_intr", "lih IV_intr" ]
                                                            `gloss`  [ "become insane" ],
    ...
    verb     HaFCaL                    {- >awolah -}        `others` [ "wlah IV_Pass_yu", "wlih IV_yu" ]
    ...
    noun     FaCLAn                    {- walohAn -}        `gloss`  [ "bewildered", "passionately in love" ],
    ...
    noun     FACiL                     {- wAlih -}          `gloss`  [ "bewildered", "deeply afflicted" ],

    -- ;; mutawal~ih_1
    -- mtwlh   mutawal~ih      Nall    bewildered;hare-brained     [[mutawal~ih/ADJ]]

    noun     MutaFaCCiL                {- mutawal~ih -}     `gloss`  [ "bewildered", "hare-brained" ] ]
 ...
 |> "wlwl" <| [
    ...
    verb     FaCCaL                    {- walowal -}        `others` [ "walwil IV_yu" ]
                                                            `gloss`  [ "wail", "lament" ],
    ...
    noun     FaCCaL |< aT              {- walowalap -}      `others` [ "walwal Nap", "walAwil Ndip" ]
 ...
 |> "wly" <| [
    ...
    verb     FaCiL                     {- waliy-i -}        `imperf` [ FCiL ]
                                                            `others` [ "l IV_0hwnyn", "waliy PV_no-w", "liy IV_0hAnn" ]
 ...
 |> "wl" <| [
    ...
    verb     HaFCY                     {- >awolaY -}        `others` [ "'awl PV_ttAw", "'awlay PV_Atn", "wliy IV_0hAnn_yu", "'awlA PV_h", "wlay IV_Ann_Pass_yu", "wl IV_0hwnyn_yu", "wlY IV_0_Pass_yu" ]
 ...
 |> "wl" <| [
    ...
    noun     CaL |< Iy                 {- waliy~ -}         `others` [ "'awliyA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "successor", "heir", "patron", "responsible", "guardian" ],

    -- ;; waliy~ap_1
    -- wly     waliy~  Nap     woman saint     [[waliy~/NOUN]]

    noun     CaL |< Iy |< aT           {- waliy~ap -}       `others` [ "waliyy Nap" ]
                                                            `gloss`  [ "woman saint" ],
    ...
    noun     FaCA' |< Iy               {- walA}iy~ -}       `gloss`  [ "amicable", "friendly" ] ]
 ...
 |> "wly" <| [
    ...
    noun     FiCAL |< aT               {- wilAyap -}        `others` [ "wilAy NapAt" ]
 ...
 |> "mawlAT" <| [
    ...
    noun     Identity                  {- mawolAp -}        `others` [ "mawlay NAt", "mawlA Napdu" ]
 ...
 |> "wly" <| [
    ...
    noun     TaFCiL |< aT              {- tawoliyap -}      `others` [ "tawliy Nap" ]
 ...
 |> "muwAlAT" <| [
    ...
    noun     Identity                  {- muwAlAp -}        `others` [ "muwAlA Napdu", "muwAlay NAt" ]
 ...
 |> "wl'" <| [
    ...
    noun     HICAL                     {- <iylA' -}         `gloss`  [ "marriage annulment", "marriage annulments" ] ]
 ...
 |> "tawalliy" <| [
    ...
    noun     Identity                  {- tawal~iy -}       `others` [ "tawall NK" ]
 ...
 |> "tawAliy" <| [
    ...
    noun     Identity                  {- tawAliy -}        `others` [ "tawAl NK" ]
 ...
 |> "wly" <| [
    ...
    noun     MuFACiL |< aT             {- muwAliyap -}      `others` [ "muwAliy Nap" ]
                                                            `gloss`  [ "clientele", "following" ],
 ...
 |> "wlw" <| [
    ...
    noun     MaFCaL |< Iy              {- mawolawiy~ -}     `gloss`  [ "Mawlawi dervish" ] ]
 ...
 |> "matAwil" <| [
    ...
    noun     Identity |< aT            {- matAwilap -}      `others` [ "matAwil Nap" ]
                                                            `gloss`  [ "Metuali ( Shiite sect )" ] ]
 ...
 |> "wm'" <| [
    ...
    verb     HaFCaL                    {- >awoma> -}        `others` [ "wma' IV_Pass_yu", "wmi' IV_yu", "'awma'A PV-|" ]
 ...
 |> "wm'" <| [
    ...
    noun     MuFCaL                    {- muwma> -}         `gloss`  [ "referred to", "above-mentioned" ] ]
 ...
 |> "wms" <| [
    ...
    noun     MuFCiL |< aT              {- muwmisap -}       `others` [ "muwmis NapAt" ]
                                                            `gloss`  [ "prostitute" ] ]
 ...
 |> "wm.d" <| [
    ...
    verb     HaFCaL                    {- >awomaD -}        `others` [ "wmi.d IV_yu", "wma.d IV_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- wamoDap -}        `others` [ "wama.d NAt", "wam.d Napdu" ]
                                                            `gloss`  [ "flash", "flashes" ],
 ...
 |> "mawmAT" <| [
    ...
    noun     Identity                  {- mawomAp -}        `others` [ "mawAmiy N0_Nh", "mawmA Napdu", "mawmA' Nh Nhy N0_Nh", "mawAm NK" ]
 ...
 |> "wnn" <| [
    ...
    verb     FaCL                      {- wan~-i -}         `imperf` [ FCiL ]
                                                            `others` [ "wnin IV-n", "winn IV_V", "wann PV_V", "wanan PV_Cn" ]
                                                            `gloss`  [ "buzz", "drone" ],
 ...
 |> "wndl" <| [
    ...
    noun     FaCCaL                    {- wanodal -}        `gloss`  [ "Vandals" ] ]
 ...
 |> "wny" <| [
    ...
    verb     FaCiL                     {- waniy-a -}        `imperf` [ FCaL ]
                                                            `others` [ "wnY IV_0", "wna IV_0hwnyn", "wnay IV_Ann", "wan PV_w_intr", "waniy PV_no-w_intr" ]
 ...
 |> "wn" <| [
    ...
    verb     FaCY                      {- wanaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "niy IV_0hAnn", "wanA PV_h", "wanay PV_Atn", "wanY PV_0", "wan PV_ttAw_intr" ]
                                                            `gloss`  [ "become weak", "be despondent" ] ]
 ...
 |> "whb" <| [
    ...
    verb     FaCaL                     {- wahab-a -}        `imperf` [ FCaL ]
                                                            `others` [ "wahab PV", "hab IV", "whab IV_Pass_yu" ]
    ...
    verb     HaFCaL                    {- >awohab -}        `others` [ "whib IV_yu", "whab IV_Pass_yu" ]
 ...
 |> "whb" <| [
    ...
    noun     CiL |< aT                 {- hibap -}          `others` [ "hib NapAt" ]
                                                            `gloss`  [ "gift", "grant" ] ]
 ...
 |> "whb" <| [
    ...
    noun     FaCL |< aT                {- wahobap -}        `others` [ "wahb Nap" ]
                                                            `gloss`  [ "gratuity" ],
    ...
    noun     FaCCAL |< Iy              {- wah~Abiy~ -}      `gloss`  [ "Wahhabi" ],

    -- ;; wah~Abiy~ap_1
    -- whAby   wah~Abiy~       Nap     Wahhabism     [[wah~Abiy~/NOUN]]

    noun     FaCCAL |< Iy |< aT        {- wah~Abiy~ap -}    `others` [ "wahhAbiyy Nap" ]
                                                            `gloss`  [ "Wahhabism" ],
    ...
    noun     MaFCiL |< aT              {- mawohibap -}      `others` [ "mawhib Napdu", "mawAhib Ndip", "mawhab Napdu" ]
 ...
 |> "whb" <| [
    ...
    noun     HICAL                     {- <iyhAb -}         `gloss`  [ "donation", "granting" ],

    -- ;; <iyhAb_2
    -- <yhAb   <iyhAb  N0      Ihab;Ehab
    -- AyhAb   <iyhAb  N0      Ihab;Ehab

    noun     HICAL                     {- <iyhAb -}         `gloss`  [ "Ihab", "Ehab" ] ]
 ...
 |> "whb" <| [
    ...
    noun     MaFCUL                    {- mawohuwb -}       `gloss`  [ "given", "granted" ],

    -- ;; mawohuwb_2
    -- mwhwb   mawohuwb        Nall    talented;gifted     [[mawohuwb/ADJ]]

    noun     MaFCUL                    {- mawohuwb -}       `gloss`  [ "talented", "gifted" ],
 ...
 |> "wh^g" <| [
    ...
    verb     HaFCaL                    {- >awohaj -}        `others` [ "wha^g IV_Pass_yu", "whi^g IV_yu" ]
 ...
 |> "whd" <| [
    ...
    noun     FaCL |< aT                {- wahodap -}        `others` [ "wihAd N", "wahd Napdu", "wuhad N" ]
    ...
    noun     HaFCaL                    {- >awohad -}        `gloss`  [ "low-lying", "depressed" ] ]
 ...
 |> "whr" <| [
    ...
    noun     FaCL |< aT                {- wahorap -}        `others` [ "wahr Nap" ]
                                                            `gloss`  [ "consternation", "fear" ],
 ...
 |> "whl" <| [
    ...
    verb     FaCiL                     {- wahil-a -}        `imperf` [ FCaL ]
                                                            `others` [ "wahil PV_intr", "whal IV_intr" ]
    ...
    noun     FaCL |< aT                {- waholap -}        `others` [ "wahl Nap" ]
 ...
 |> "whm" <| [
    ...
    verb     FaCiL                     {- wahim-a -}        `imperf` [ FCaL ]
                                                            `others` [ "wham IV_intr", "wahim PV_intr" ]
                                                            `gloss`  [ "be deluded" ],
 ...
 |> "tuhm" <| [
    ...
    noun     Identity |< aT            {- tuhomap -}        `others` [ "tuhm Napdu", "tuham N" ]
    ...
    noun     FaCL |< Iy                {- wahomiy~ -}       `gloss`  [ "imagined", "imaginary", "fake", "bogus" ],

    -- ;; wahomiy~ap_1
    -- whmy    wahomiy~        Nap     conjecture;delusion     [[wahomiy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- wahomiy~ap -}     `others` [ "wahmiyy Nap" ]
                                                            `gloss`  [ "conjecture", "delusion" ] ]
 ...
 |> "whm" <| [
    ...
    noun     HICAL                     {- <iyhAm -}         `gloss`  [ "deception", "delusion" ] ]
 ...
 |> "ittihAm" <| [
    ...
    noun     Identity |< Iy            {- {it~ihAmiy~ -}    `gloss`  [ "accusing", "indicting" ],

    -- ;; wAhimap_1
    -- wAhm    wAhim   Nap     imagination;delusion

    noun     FACiL |< aT               {- wAhimap -}        `others` [ "wAhim Nap" ]
                                                            `gloss`  [ "imagination", "delusion" ],

    -- ;; mawohuwm_1
    -- mwhwm   mawohuwm        Nall    imagined;imaginary     [[mawohuwm/ADJ]]

    noun     MaFCUL                    {- mawohuwm -}       `gloss`  [ "imagined", "imaginary" ] ]
 ...
 |> "whn" <| [
    ...
    verb     FaCaL                     {- wahan-i -}        `imperf` [ FCiL ]
                                                            `others` [ "wahin PV-n_intr", "hin IV-n_intr", "wahan PV-n_intr" ]
    ...
    verb     FaCuL                     {- wahun-u -}        `imperf` [ FCuL ]
                                                            `others` [ "wahun PV-n_intr", "whun IV-n_intr" ]
                                                            `gloss`  [ "be weak", "lack the strength for" ],
    ...
    verb     HaFCaL                    {- >awohan -}        `others` [ "whin IV-n_yu", "whan IV-n_Pass_yu" ]
    ...
    noun     FACiL                     {- wAhin -}          `others` [ "wuhun N" ]
                                                            `gloss`  [ "feeble", "debilitated", "despondent" ] ]
 ...
 |> "why" <| [
    ...
    verb     FaCiL                     {- wahiy-a -}        `imperf` [ FCaL ]
                                                            `others` [ "wah PV_w_intr", "wahiy PV_no-w_intr", "wha IV_0hwnyn", "whay IV_Ann", "whY IV_0" ]
 ...
 |> "wh" <| [
    ...
    verb     FaCY                      {- wahaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "wahY PV_0", "wah PV_ttAw_intr", "wahay PV_Atn", "wahA PV_h", "hiy IV_0hAnn" ]
                                                            `gloss`  [ "be frail", "be fragile" ],
 ...
 |> "wy" <| [
    ...
    noun     CaL                       {- way -}            `others` [ "waykunna FW-Wa", "waykum FW-Wa", "wayka FW-Wa", "waykumA FW-Wa", "wayki FW-Wa" ]
                                                            `gloss`  [ "shame on", "shame on + you [ masc.sg . ]", "shame on + you [ fem.sg . ]", "shame on + you both", "shame on + you [ masc.pl . ]", "shame on + you [ fem.pl . ]" ] ]
 ...
 |> "wyb" <| [
    ...
    noun     FaCL |< aT                {- wayobap -}        `others` [ "wayb NapAt" ]
                                                            `gloss`  [ "wayba ( dry measure = 33 liters )" ] ]
 ...
 |> "wiytuwn" <| [
    ...
    noun     Identity                  {- wiytuwn -}        `gloss`  [ "Wheaton" ] ]
 ...
 |> "way.ha" <| [
    ...
    noun     Identity                  {- wayoHa -}         `others` [ "way.haka FW-Wa", "way.hakumA FW-Wa", "way.haki FW-Wa", "way.hakunna FW-Wa", "way.hakum FW-Wa", "way.haN FW-Wa" ]
                                                            `gloss`  [ "woe unto", "woe unto + you [ masc.sg . ]", "woe unto + you [ fem.sg . ]", "woe unto + you both", "woe unto + you [ masc.pl . ]", "woe unto + you [ fem.pl . ]" ] ]
 ...
 |> "wyk" <| [
    ...
    noun     FiCL |< aT                {- wiykap -}         `others` [ "wiyk Nap" ]
                                                            `gloss`  [ "okra", "gumbo" ] ]
 ...
 |> "wyl" <| [
    ...
    noun     FaCL |< aT                {- wayolap -}        `others` [ "wayl NapAt" ]
                                                            `gloss`  [ "misfortune" ] ]
