...
lexicon = listing "Lexicon properties"
 ...
 |> "zA'uwq" <| [
    ...
    noun     Identity                  {- zA'uwq -}         `others` [ "zAwuwq N" ]
 ...
 |> "z'r" <| [
    ...
    verb     FaCaL                     {- za>ar -}          `others` [ "z'ir IV", "z'ar IV" ]
                                                            `gloss`  [ "roar", "bellow" ],

    -- ;; za>or_1
    -- z>r     za>or   N       roaring;bellowing

    noun     FaCL                      {- za>or -}          `gloss`  [ "roaring", "bellowing" ],
 ...
 |> "z'.t" <| [
    ...
    verb     FaCaL                     {- za>aT -}          `others` [ "z'a.t IV" ]
 ...
 |> "zn" <| [
    ...
    noun     FAL |< aT                 {- zAnap -}          `others` [ "zAn NapAt" ]
                                                            `gloss`  [ "spear", "pole" ] ]
 ...
 |> "zbb" <| [
    ...
    noun     HaFaCL                    {- >azab~ -}         `others` [ "zubb N", "zabbA' Nh Nhy N0_Nh" ]
 ...
 |> "zbd" <| [
    ...
    verb     HaFCaL                    {- >azobad -}        `others` [ "zbid IV_yu" ]
                                                            `gloss`  [ "froth", "become foamy" ],
    ...
    noun     FuCL |< aT                {- zubodap -}        `others` [ "zubd Nap", "zubad N" ]
    ...
    noun     FaCL |< Iy |< aT          {- zabodiy~ap -}     `others` [ "zabAd NK", "zabdiyy Napdu", "zabAdiy N0_Nh" ]
                                                            `gloss`  [ "bowl", "bowls" ],
 ...
 |> "zbr" <| [
    ...
    verb     FaCaL                     {- zabar-ui -}       `imperf` [ FCuL, FCiL ]
                                                            `others` [ "zbir IV", "zbur IV", "zabar PV" ]
                                                            `gloss`  [ "scold" ],
    ...
    noun     FuCL |< aT                {- zuborap -}        `others` [ "zubr Napdu" ]
                                                            `gloss`  [ "piece of iron" ] ]
 ...
 |> "zubar" <| [
    ...
    noun     Identity                  {- zubar -}          `gloss`  [ "pieces of iron" ],
 ...
 |> "zawAbir" <| [
    ...
    noun     Identity |< Iy            {- zawAbiriy~ -}     `gloss`  [ "Zouabri" ] ]
 ...
 |> "zibri^g" <| [
    ...
    noun     Identity                  {- ziborij -}        `gloss`  [ "ornament", "decoration" ] ]
 ...
 |> "zwb`" <| [
    ...
    noun     FaCCaL |< aT              {- zawobaEap -}      `others` [ "zawba` Napdu", "zawAbi` Ndip" ]
 ...
 |> "zubAl" <| [
    ...
    noun     MaFCaL |< aT              {- mazobalap -}      `others` [ "mazbal Napdu", "mazAbil Ndip" ]
 ...
 |> "zbn" <| [
    ...
    noun     FaCUL                     {- zabuwn -}         `gloss`  [ "fierce", "foolish" ],
    ...
    noun     FiCAL |< aT               {- zibAnap -}        `others` [ "zibAn Nap" ]
                                                            `gloss`  [ "clientele" ] ]
 ...
 |> "zabAniy" <| [
    ...
    noun     Identity |< aT            {- zabAniyap -}      `others` [ "zabAniy Nap" ]
                                                            `gloss`  [ "myrmidons" ] ]
 ...
 |> "zby" <| [
    ...
    noun     FuCL |< aT                {- zuboyap -}        `others` [ "zubA Nhy", "zuby Nap", "zubY N0" ]
 ...
 |> "z^g^g" <| [
    ...
    verb     FaCL                      {- zaj~-u -}         `imperf` [ FCuL ]
                                                            `others` [ "z^gu^g IV_C", "za^ga^g PV_C", "za^g^g PV_V", "zu^g^g IV_V" ]
 ...
 |> "zu^gA^g" <| [
    ...
    noun     FiCAL |< aT               {- zijAjap -}        `others` [ "zi^gA^g Nap" ]
                                                            `gloss`  [ "glaziery" ],
    ...
    noun     MuFaCCaL                  {- muzaj~aj -}       `gloss`  [ "glazed", "enameled" ] ]
 ...
 |> "izda^gar" <| [
    ...
    verb     Identity                  {- {izodajar -}      `others` [ "zda^gir IV_intr" ]
                                                            `gloss`  [ "be driven back", "be restrained", "be rebuked" ],
    ...
    noun     FaCL |< Iy                {- zajoriy~ -}       `gloss`  [ "reformatory", "penitentiary" ],
    ...
    noun     FACiL |< aT               {- zAjirap -}        `others` [ "zA^gir Napdu", "zawA^gir Ndip" ]
 ...
 |> "z^gl" <| [
    ...
    noun     FaCaL |< Iy               {- zajaliy~ -}       `gloss`  [ "zajal ( poetry )" ],
    ...
    noun     FACiL                     {- zAjil -}          `gloss`  [ "carrier", "homing" ] ]
 ...
 |> "z^g" <| [
    ...
    verb     FaCA                      {- zajA-u -}         `imperf` [ FCuL ]
                                                            `others` [ "za^gaw PV_Atn", "z^guw IV_0hAnn", "za^gA PV_0h", "z^gay IV_Ann_Pass_yu", "za^g PV_ttAw", "z^g IV_0hwnyn", "z^gY IV_0_Pass_yu" ]
 ...
 |> "z^g" <| [
    ...
    verb     HaFCY                     {- >azojaY -}        `others` [ "z^giy IV_0hAnn_yu", "z^gay IV_Ann_Pass_yu", "'az^gA PV_h", "z^g IV_0hwnyn_yu", "z^gY IV_0_Pass_yu", "'az^g PV_ttAw", "'az^gay PV_Atn" ]
                                                            `gloss`  [ "shove", "jostle", "be shoved", "be jostled" ] ]
 ...
 |> "z^gy" <| [
    ...
    noun     TaFCiL |< aT              {- tazojiyap -}      `others` [ "taz^giy Nap" ]
                                                            `gloss`  [ "pastime" ] ]
 ...
 |> "z^g" <| [
    ...
    noun     MuFCaNY                   {- muzojaY -}        `others` [ "muz^gA Nhy" ]
 ...
 |> "z.hr" <| [
    ...
    verb     FaCaL                     {- zaHar-ia -}       `imperf` [ FCiL, FCaL ]
                                                            `others` [ "z.har IV", "za.har PV", "z.hir IV" ]
                                                            `gloss`  [ "groan", "moan" ],
 ...
 |> "z.hz.h" <| [
    ...
    verb     FaCCaL                    {- zaHozaH -}        `others` [ "za.hzi.h IV_yu" ]
                                                            `gloss`  [ "remove", "snatch" ],
    ...
    verb     TaFaCCaL                  {- tazaHozaH -}      `gloss`  [ "be removed", "be snatched" ],

    -- ;; zaHozaHap_1
    -- zHzH    zaHozaH Nap     removing;snatching

    noun     FaCCaL |< aT              {- zaHozaHap -}      `others` [ "za.hza.h Nap" ]
                                                            `gloss`  [ "removing", "snatching" ] ]
 ...
 |> "z.hf" <| [
    ...
    noun     FaCCAL |< aT              {- zaH~Afap -}       `others` [ "za.h.hAf NapAt" ]
                                                            `gloss`  [ "reptile", "ground leveler", "ski" ],

    -- ;; zAHif_1
    -- zAHf    zAHif   N-ap    creeping;crawling     [[zAHif/ADJ]]
    -- zAHf    zAHif   N-ap    advancing;marching     [[zAHif/ADJ]]

    noun     FACiL                     {- zAHif -}          `gloss`  [ "creeping", "crawling", "advancing", "marching" ] ]
 ...
 |> "zawA.hif" <| [
    ...
    noun     Identity                  {- zawAHif -}        `gloss`  [ "reptiles" ] ]
 ...
 |> "za.hAyik" <| [
    ...
    noun     Identity |< aT            {- zaHAyikap -}      `others` [ "za.hAyikah N0" ]
                                                            `gloss`  [ "Zahaikeh" ] ]
 ...
 |> "zu.hal" <| [
    ...
    noun     Identity                  {- zuHal -}          `gloss`  [ "Saturn" ],
 ...
 |> "z.hlw" <| [
    ...
    noun     FaCCaL |< Iy              {- zaHolawiy~ -}     `others` [ "za.hlAwiyy Nall" ]
                                                            `gloss`  [ "of / from Zahle ( Leb . )" ],

    -- ;; zaHolawiy~_2
    -- zHlwy   zaHolawiy~      N0      Zahlaoui;Zahlawi
    -- zHlAwy  zaHolAwiy~      N0      Zahlaoui;Zahlawi

    noun     FaCCaL |< Iy              {- zaHolawiy~ -}     `others` [ "za.hlAwiyy N0" ]
 ...
 |> "z.hlq" <| [
    ...
    verb     FaCCaL                    {- zaHolaq -}        `others` [ "za.hliq IV_yu" ]
                                                            `gloss`  [ "slide", "roll" ],
    ...
    verb     TaFaCCaL                  {- tazaHolaq -}      `gloss`  [ "slide", "slip" ],

    -- ;; tazaHolaq_2
    -- tzHlq   tazaHolaq       PV      skate;ski
    -- tzHlq   tazaHolaq       IV      skate;ski

    verb     TaFaCCaL                  {- tazaHolaq -}      `gloss`  [ "skate", "ski" ],

    -- ;; zaHolaqap_1
    -- zHlq    zaHolaq Nap     sliding;skating;skiing

    noun     FaCCaL |< aT              {- zaHolaqap -}      `others` [ "za.hlaq Nap" ]
                                                            `gloss`  [ "sliding", "skating", "skiing" ],

    -- ;; tazaHoluq_1
    -- tzHlq   tazaHoluq       NduAt   skating;skiing;sliding

    noun     TaFaCCuL                  {- tazaHoluq -}      `gloss`  [ "skating", "skiing", "sliding" ] ]
 ...
 |> "izda.ham" <| [
    ...
    verb     Identity                  {- {izodaHam -}      `others` [ "zda.him IV_intr" ]
                                                            `gloss`  [ "be crowded" ],

    -- ;; zaHomap_1
    -- zHm     zaHom   Nap     crowded;jam

    noun     FaCL |< aT                {- zaHomap -}        `others` [ "za.hm Nap" ]
                                                            `gloss`  [ "crowded", "jam" ],
    ...
    noun     MuFACaL |< aT             {- muzAHamap -}      `others` [ "muzA.ham NapAt" ]
 ...
 |> "zd.hm" <| [
    ...
    noun     IFCiLAL                   {- {izodiHAm -}      `gloss`  [ "crowd", "jam" ] ]
 ...
 |> "muzda.him" <| [
    ...
    noun     Identity                  {- muzodaHim -}      `gloss`  [ "crowded", "jammed" ] ]
 ...
 |> "muzda.ham" <| [
    ...
    noun     Identity                  {- muzodaHam -}      `gloss`  [ "crowd", "jam" ] ]
 ...
 |> "z_h_h" <| [
    ...
    noun     FaCL |< aT                {- zax~ap -}         `others` [ "za_h_h NapAt" ]
                                                            `gloss`  [ "hail", "downpour", "shower", "rain" ] ]
 ...
 |> "z_hrf" <| [
    ...
    verb     FaCCaL                    {- zaxoraf -}        `others` [ "za_hrif IV_yu" ]
    ...
    verb     TaFaCCaL                  {- tazaxoraf -}      `gloss`  [ "be adorned", "be embellished" ] ]
 ...
 |> "zu_hruf" <| [
    ...
    noun     FaCCaL |< aT              {- zaxorafap -}      `others` [ "za_hraf NapAt" ]
 ...
 |> "zu_hruf" <| [
    ...
    noun     Identity |< Iy            {- zuxorufiy~ -}     `gloss`  [ "ornamental", "decorative" ],

    -- ;; muzaxorif_1
    -- mzxrf   muzaxorif       Nall    interior decorator

    noun     MuFaCCiL                  {- muzaxorif -}      `gloss`  [ "interior decorator" ],

    -- ;; muzaxoraf_1
    -- mzxrf   muzaxoraf       N-ap    ornamented     [[muzaxoraf/ADJ]]

    noun     MuFaCCaL                  {- muzaxoraf -}      `gloss`  [ "ornamented" ] ]
 ...
 |> "z_hm" <| [
    ...
    verb     FaCiL                     {- zaxim-a -}        `imperf` [ FCaL ]
                                                            `others` [ "za_him PV", "z_ham IV" ]
                                                            `gloss`  [ "stink" ],

    -- ;; zaxim_1
    -- zxm     zaxim   Nall    stinking     [[zaxim/ADJ]]

    noun     FaCiL                     {- zaxim -}          `gloss`  [ "stinking" ],
    ...
    noun     HaFCaL                    {- >azoxam -}        `others` [ "za_hmA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "stinking" ],

    -- ;; zaxomap_1
    -- zxm     zaxom   Nap     pick (music)

    noun     FaCL |< aT                {- zaxomap -}        `others` [ "za_hm Nap" ]
                                                            `gloss`  [ "pick ( music )" ],
    ...
    noun     FaCaL |< aT               {- zaxamap -}        `others` [ "za_ham Nap" ]
                                                            `gloss`  [ "stench" ] ]
 ...
 |> "zrr" <| [
    ...
    verb     FaCL                      {- zar~-u -}         `imperf` [ FCuL ]
                                                            `others` [ "zarar PV_C", "zurr IV_V", "zarr PV_V", "zrur IV_C" ]
 ...
 |> "zrb" <| [
    ...
    noun     FuCL |< Iy |< aT          {- zurobiy~ap -}     `others` [ "zarAbiyy N", "zurbiyy Napdu" ]
    ...
    noun     FaCIL |< aT               {- zariybap -}       `others` [ "zarA'ib Ndip", "zariyb Napdu" ]
 ...
 |> "zAruwb" <| [
    ...
    noun     Identity                  {- zAruwb -}         `others` [ "zawAriyb Ndip" ]
 ...
 |> "zrbl" <| [
    ...
    noun     FaCCUL                    {- zarobuwl -}       `others` [ "zarAbiyl Ndip" ]
                                                            `gloss`  [ "shoe", "shoes" ] ]
 ...
 |> "zrbn" <| [
    ...
    noun     FaCCUL                    {- zarobuwn -}       `others` [ "zarAbiyn Ndip" ]
                                                            `gloss`  [ "shoe", "shoes" ] ]
 ...
 |> "izdarad" <| [
    ...
    verb     Identity                  {- {izodarad -}      `others` [ "zdarid IV" ]
                                                            `gloss`  [ "swallow" ],

    -- ;; zarodap_1
    -- zrd     zarod   Nap     zarda (sweet dish)

    noun     FaCL |< aT                {- zarodap -}        `others` [ "zard Nap" ]
                                                            `gloss`  [ "zarda ( sweet dish )" ],
    ...
    noun     FaCaL |< aT               {- zaradap -}        `others` [ "zarad Nap" ]
                                                            `gloss`  [ "chain link" ],

    -- ;; zaradiy~ap_1
    -- zrdy    zaradiy~        NapAt   cutting pliers     [[zaradiy~/NOUN]]

    noun     FaCaL |< Iy |< aT         {- zaradiy~ap -}     `others` [ "zaradiyy NapAt" ]
                                                            `gloss`  [ "cutting pliers" ],

    -- ;; zar~Adiy~ap_1
    -- zrAdy   zar~Adiy~       NapAt   cutting pliers     [[zar~Adiy~/NOUN]]

    noun     FaCCAL |< Iy |< aT        {- zar~Adiy~ap -}    `others` [ "zarrAdiyy NapAt" ]
                                                            `gloss`  [ "cutting pliers" ],
 ...
 |> "zarAdu^st" <| [
    ...
    noun     Identity |< Iy            {- zarAdu$otiy~ -}   `gloss`  [ "Zoroastrian", "Zoroastrianism" ] ]
 ...
 |> "zrzr" <| [
    ...
    verb     FaCCaL                    {- zarozar -}        `others` [ "zarzir IV_yu" ]
                                                            `gloss`  [ "chirp" ] ]
 ...
 |> "zurzur" <| [
    ...
    noun     Identity                  {- zurozur -}        `others` [ "zurzuwr Ndu", "zarAziyr Ndip" ]
 ...
 |> "zurzuwr" <| [
    ...
    noun     Identity |< Iy            {- zurozuwriy~ -}    `gloss`  [ "dapple-gray ( horse )", "gray with white patches" ] ]
 ...
 |> "izdara`" <| [
    ...
    verb     Identity                  {- {izodaraE -}      `others` [ "zdari` IV" ]
                                                            `gloss`  [ "plant", "sow" ],
    ...
    noun     FiCAL |< aT               {- zirAEap -}        `others` [ "zirA` Nap" ]
                                                            `gloss`  [ "agriculture", "cultivation" ],

    -- ;; zirAEiy~_1
    -- zrAEy   zirAEiy~        Nall    agricultural;farming     [[zirAEiy~/ADJ]]

    noun     FiCAL |< Iy               {- zirAEiy~ -}       `gloss`  [ "agricultural", "farming" ],

    -- ;; zariyEap_1
    -- zryE    zariyE  Nap     crop;planted

    noun     FaCIL |< aT               {- zariyEap -}       `others` [ "zariy` Nap" ]
                                                            `gloss`  [ "crop", "planted" ],
 ...
 |> "mazAri`" <| [
    ...
    noun     Identity                  {- mazAriE -}        `gloss`  [ "Farms" ] ]
 ...
 |> "mazra`An" <| [
    ...
    noun     Identity |< Iy            {- mazoraEAniy~ -}   `gloss`  [ "farmer" ],

    -- ;; tazoriyE_1
    -- tzryE   tazoriyE        NduAt   agriculturalization (vis-à-vis industrialization)

    noun     TaFCIL                    {- tazoriyE -}       `gloss`  [ "agriculturalization ( vis-_a-vis industrialization )" ],

    -- ;; muzAraEap_1
    -- mzArE   muzAraE NapAt   temporary sharecropping

    noun     MuFACaL |< aT             {- muzAraEap -}      `others` [ "muzAra` NapAt" ]
                                                            `gloss`  [ "temporary sharecropping" ],
    ...
    noun     MaFCUL                    {- mazoruwE -}       `gloss`  [ "cultivated", "planted", "transplanted" ],

    -- ;; mazoruwEap_1
    -- mzrwE   mazoruwE        NapAt   farm;planted field

    noun     MaFCUL |< aT              {- mazoruwEap -}     `others` [ "mazruw` NapAt" ]
 ...
 |> "zrf" <| [
    ...
    noun     FaCAL |< aT               {- zarAfap -}        `others` [ "zarAf NapAt" ]
                                                            `gloss`  [ "group", "cluster" ],
    ...
    noun     FaCAL |< aT               {- zarAfap -}        `others` [ "zarAfA Nhy", "zarAf Napdu", "zarAfY N0", "zarA'if Ndip" ]
 ...
 |> "zrq" <| [
    ...
    verb     FaCiL                     {- zariq-a -}        `imperf` [ FCaL ]
                                                            `others` [ "zraq IV_intr", "zariq PV_intr" ]
    ...
    noun     FuCL |< aT                {- zuroqap -}        `others` [ "zurq Nap" ]
                                                            `gloss`  [ "blue color" ],
    ...
    noun     HaFCaL                    {- >azoraq -}        `others` [ "zuruq N", "zarqA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "blue" ],
 ...
 |> "zrqn" <| [
    ...
    noun     FaCCUL                    {- zaroquwn -}       `gloss`  [ "bright red" ] ]
 ...
 |> "zrk^s" <| [
    ...
    verb     FaCCaL                    {- zaroka$ -}        `others` [ "zarki^s IV_yu" ]
                                                            `gloss`  [ "embellish", "decorate" ],

    -- ;; zaroka$_2
    -- zrk$    zaroka$ N       brocade

    noun     FaCCaL                    {- zaroka$ -}        `gloss`  [ "brocade" ],

    -- ;; muzaroka$_1
    -- mzrk$   muzaroka$       Nall    brocaded;embellished

    noun     MuFaCCaL                  {- muzaroka$ -}      `gloss`  [ "brocaded", "embellished" ] ]
 ...
 |> "zrn_h" <| [
    ...
    noun     FiCCIL                    {- zironiyx -}       `gloss`  [ "arsenic" ] ]
 ...
 |> "zrhn" <| [
    ...
    noun     FaCCUL |< Iy              {- zarohuwniy~ -}    `gloss`  [ "Zerhouni", "Zarhouni" ] ]
 ...
 |> "zrwl" <| [
    ...
    noun     FiCCAL                    {- zirowAl -}        `gloss`  [ "Zeroual" ] ]
 ...
 |> "zr" <| [
    ...
    verb     FaCY                      {- zaraY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "zr IV_0hwnyn", "zarY PV_0", "zriy IV_0hAnn", "zrY IV_0_Pass_yu", "zaray PV_Atn", "zarA PV_h", "zar PV_ttAw" ]
    ...
    verb     HaFCY                     {- >azoraY -}        `others` [ "zr IV_0hwnyn_yu", "zriy IV_0hAnn_yu", "zray IV_Ann_Pass_yu", "zrY IV_0_Pass_yu", "'azrA PV_h", "'azr PV_ttAw", "'azray PV_Atn" ]
 ...
 |> "izdarY" <| [
    ...
    verb     Identity                  {- {izodaraY -}      `others` [ "izdarA PV_h", "zdar IV_0hwnyn", "zdariy IV_0hAnn", "izdaray PV_Atn", "zdarY IV_0", "izdar PV_ttAw" ]
                                                            `gloss`  [ "despise", "defy" ] ]
 ...
 |> "zr" <| [
    ...
    noun     CaL |< Iy                 {- zariy~ -}         `gloss`  [ "despicable", "miserable" ] ]
 ...
 |> "zry" <| [
    ...
    noun     FiCAL |< aT               {- zirAyap -}        `others` [ "zirAy Nap" ]
                                                            `gloss`  [ "disdain", "disparagement" ] ]
 ...
 |> "zr'" <| [
    ...
    noun     HiFCAL                    {- <izorA' -}        `gloss`  [ "contempt", "disregard" ] ]
 ...
 |> "zdr'" <| [
    ...
    noun     IFCiLAL                   {- {izodirA' -}      `gloss`  [ "contempt", "disregard" ] ]
 ...
 |> "zr" <| [
    ...
    noun     MuFCaNY                   {- muzoraY -}        `others` [ "muzr Nuwn_Niyn", "muzray NAt NAn_Nayn", "muzrA Napdu Nhy" ]
                                                            `gloss`  [ "despicable", "contemptible" ] ]
 ...
 |> "z`br" <| [
    ...
    verb     FaCCaL                    {- zaEobar -}        `others` [ "za`bir IV_yu" ]
                                                            `gloss`  [ "deceive", "cheat" ] ]
 ...
 |> "z`b.t" <| [
    ...
    noun     FaCCUL                    {- zaEobuwT -}       `others` [ "za`Abiy.t Ndip" ]
 ...
 |> "z`tr" <| [
    ...
    noun     FaCCaL                    {- zaEotar -}        `gloss`  [ "wild Thyme" ] ]
 ...
 |> "z`^g" <| [
    ...
    verb     HaFCaL                    {- >azoEaj -}        `others` [ "z`i^g IV_yu", "z`a^g IV_Pass_yu" ]
    ...
    noun     HiFCAL                    {- <izoEAj -}        `gloss`  [ "disturbance", "harassment" ],
    ...
    noun     MuFCiL                    {- muzoEij -}        `gloss`  [ "annoying", "troublesome" ],

    -- ;; munozaEij_1
    -- mnzEj   munozaEij       Nall    angry;annoyed;bothered     [[munozaEij/ADJ]]

    noun     MunFaCiL                  {- munozaEij -}      `gloss`  [ "angry", "annoyed", "bothered" ] ]
 ...
 |> "z`r" <| [
    ...
    noun     HaFCaL                    {- >azoEar -}        `others` [ "za`rA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "thin-haired" ],
    ...
    noun     HaFCaL                    {- >azoEar -}        `others` [ "zu`rAn N" ]
    ...
    noun     FaCAL |< aT               {- zaEArap -}        `others` [ "za`Ar Nap" ]
                                                            `gloss`  [ "maliciousness", "meanness" ] ]
 ...
 |> "z`z`" <| [
    ...
    verb     FaCCaL                    {- zaEozaE -}        `others` [ "za`zi` IV_yu" ]
    ...
    verb     TaFaCCaL                  {- tazaEozaE -}      `gloss`  [ "be convulsed", "shake" ],

    -- ;; zaEozaE_2
    -- zEzE    zaEozaE N/ap    convulsing;shaking     [[zaEozaE/ADJ]]

    noun     FaCCaL                    {- zaEozaE -}        `gloss`  [ "convulsing", "shaking" ] ]
 ...
 |> "zu`Af" <| [
    ...
    noun     MuFCiL                    {- muzoEif -}        `gloss`  [ "lethal", "killing instantly" ] ]
 ...
 |> "z`q" <| [
    ...
    noun     FaCL |< aT                {- zaEoqap -}        `others` [ "za`aq NAt", "za`q Napdu" ]
 ...
 |> "z`l" <| [
    ...
    verb     FaCiL                     {- zaEil-a -}        `imperf` [ FCaL ]
                                                            `others` [ "za`il PV_intr", "z`al IV_intr" ]
                                                            `gloss`  [ "be angry" ],
    ...
    verb     HaFCaL                    {- >azoEal -}        `others` [ "z`al IV_Pass_yu", "z`il IV_yu" ]
    ...
    noun     FaCLAn                    {- zaEolAn -}        `gloss`  [ "angry", "annoyed" ] ]
 ...
 |> "zA`uwl" <| [
    ...
    noun     Identity |< aT            {- zAEuwlap -}       `others` [ "zA`uwl Nap" ]
                                                            `gloss`  [ "annoyance", "anger" ] ]
 ...
 |> "z`m" <| [
    ...
    noun     FaCAL |< aT               {- zaEAmap -}        `others` [ "za`Am NAt Napdu" ]
    ...
    noun     MaFCaL |< aT              {- mazoEamap -}      `others` [ "mazA`im Ndip", "maz`am Napdu" ]
                                                            `gloss`  [ "allegation", "claim", "allegations", "claims" ],

    -- ;; zAEim_1
    -- zAEm    zAEim   Nall    claiming;alleging     [[zAEim/ADJ]]

    noun     FACiL                     {- zAEim -}          `gloss`  [ "claiming", "alleging" ],

    -- ;; mazoEuwm_1
    -- mzEwm   mazoEuwm        Nall    alleged;claimed;so-called     [[mazoEuwm/ADJ]]

    noun     MaFCUL                    {- mazoEuwm -}       `gloss`  [ "alleged", "claimed", "so-called" ] ]
 ...
 |> "zi`nif" <| [
    ...
    noun     Identity |< aT            {- ziEonifap -}      `others` [ "za`Anif Ndip", "zi`nif Napdu" ]
 ...
 |> "za`Anif" <| [
    ...
    noun     Identity                  {- zaEAnif -}        `gloss`  [ "fins", "flippers" ] ]
 ...
 |> "z.gb" <| [
    ...
    noun     HaFCaL                    {- >azogab -}        `gloss`  [ "fuzzy", "fluffy" ] ]
 ...
 |> "z.gbr" <| [
    ...
    noun     FaCCaL                    {- zagobar -}        `gloss`  [ "nap ( of a fabric )", "entirety" ] ]
 ...
 |> "z.gd" <| [
    ...
    noun     FaCL |< aT                {- zagodap -}        `others` [ "za.gd Napdu", "za.gad NAt" ]
 ...
 |> "za.grib" <| [
    ...
    noun     Identity                  {- zagorib -}        `gloss`  [ "Zaghreb" ] ]
 ...
 |> "z.grd" <| [
    ...
    verb     FaCCaL                    {- zagorad -}        `others` [ "za.grid IV_yu" ]
                                                            `gloss`  [ "ululate" ],
    ...
    noun     FaCCaL |< aT              {- zagoradap -}      `others` [ "za.grad NapAt", "za.gAriyd Ndip" ]
 ...
 |> "z.gr.t" <| [
    ...
    verb     FaCCaL                    {- zagoraT -}        `others` [ "za.gri.t IV_yu" ]
                                                            `gloss`  [ "ululate" ],
    ...
    noun     FaCCaL |< aT              {- zagoraTap -}      `others` [ "za.gra.t NapAt", "za.gAriy.t Ndip" ]
                                                            `gloss`  [ "ululation", "ululations" ] ]
 ...
 |> "z.gz.g" <| [
    ...
    verb     FaCCaL                    {- zagozag -}        `others` [ "za.gzi.g IV_yu" ]
 ...
 |> "zu.gu.t.t" <| [
    ...
    noun     Identity |< aT            {- zuguT~ap -}       `others` [ "zu.gu.t.t NapAt" ]
                                                            `gloss`  [ "hiccup" ] ]
 ...
 |> "z.gl" <| [
    ...
    verb     FaCCaL                    {- zagolal -}        `others` [ "za.glil IV_yu" ]
 ...
 |> "zu.gluwl" <| [
    ...
    noun     FaCCUL                    {- zagoluwl -}       `gloss`  [ "Zaghloul" ] ]
 ...
 |> "zff" <| [
    ...
    verb     FaCL                      {- zaf~-i -}         `imperf` [ FCiL ]
                                                            `others` [ "ziff IV_V", "zaff PV_V", "zfif IV_C", "zafaf PV_C" ]
                                                            `gloss`  [ "hurry" ],
    ...
    verb     FaCL                      {- zaf~-u -}         `imperf` [ FCuL ]
                                                            `others` [ "zuff PV_V_Pass IV_V", "zaff PV_V IV_V_Pass_yu", "zfaf IV_C_Pass_yu", "zufaf PV_C_Pass", "zfuf IV_C", "zafaf PV_C" ]
    ...
    noun     FaCL |< aT                {- zaf~ap -}         `others` [ "zaff NapAt" ]
                                                            `gloss`  [ "procession" ],

    -- ;; zaf~apF_1
    -- zfp     zaf~apF FW-Wa   once;one time     [[zaf~apF/ADV]]

    noun     FaCL |< aT |< aN          {- zaf~apF -}        `gloss`  [ "once", "one time" ],
    ...
    noun     FaCUL                     {- zafuwf -}         `gloss`  [ "quick", "swift", "fleet" ],
 ...
 |> "zft" <| [
    ...
    noun     FiCL                      {- zifot -}          `gloss`  [ "crappy", "cruddy", "crummy" ],

    -- ;; mizofatap_1
    -- mzft    mizofat Napdu   asphalting machine
    -- mzAft   mazAfit Ndip    asphalting machines

    noun     MiFCaL |< aT              {- mizofatap -}      `others` [ "mazAfit Ndip", "mizfat Napdu" ]
 ...
 |> "zfr" <| [
    ...
    noun     FaCiL                     {- zafir -}          `gloss`  [ "greasy" ],

    -- ;; zaforap_1
    -- zfr     zafor   Napdu   sigh;moan
    -- zfr     zafar   NAt     sighs;moans

    noun     FaCL |< aT                {- zaforap -}        `others` [ "zafar NAt", "zafr Napdu" ]
 ...
 |> "zfzf" <| [
    ...
    verb     FaCCaL                    {- zafozaf -}        `others` [ "zafzif IV" ]
                                                            `gloss`  [ "whistle ( wind )" ],

    -- ;; zafozafap_1
    -- zfzf    zafozaf NapAt   whistling (of the wind)

    noun     FaCCaL |< aT              {- zafozafap -}      `others` [ "zafzaf NapAt" ]
                                                            `gloss`  [ "whistling ( of the wind )" ] ]
 ...
 |> "zflt" <| [
    ...
    noun     FaCCaL |< aT              {- zafolatap -}      `others` [ "zaflat Nap" ]
                                                            `gloss`  [ "paving", "asphalting" ],

    -- ;; muzafolat_1
    -- mzflt   muzafolat       N-ap    paved;asphalted     [[muzafolat/ADJ]]

    noun     MuFaCCaL                  {- muzafolat -}      `gloss`  [ "paved", "asphalted" ] ]
 ...
 |> "zqq" <| [
    ...
    verb     FaCL                      {- zaq~-u -}         `imperf` [ FCuL ]
                                                            `others` [ "zaqaq PV_C", "zquq IV_C", "zaqq PV_V", "zuqq IV_V" ]
 ...
 |> "zqzq" <| [
    ...
    verb     FaCCaL                    {- zaqozaq -}        `others` [ "zaqziq IV_yu" ]
                                                            `gloss`  [ "chirp", "feed", "dandle" ],

    -- ;; zaqozaqap_1
    -- zqzq    zaqozaq NapAt   chirping;feeding;dandling

    noun     FaCCaL |< aT              {- zaqozaqap -}      `others` [ "zaqzaq NapAt" ]
                                                            `gloss`  [ "chirping", "feeding", "dandling" ],

    -- ;; zaqozAq_1
    -- zqzAq   zaqozAq N       pewit;lapwing

    noun     FaCCAL                    {- zaqozAq -}        `gloss`  [ "pewit", "lapwing" ] ]
 ...
 |> "zaqAziyq" <| [
    ...
    noun     Identity                  {- zaqAziyq -}       `gloss`  [ "Zagazig" ] ]
 ...
 |> "zql" <| [
    ...
    noun     FaCL |< aT                {- zaqolap -}        `others` [ "zaqal NAt", "zaql Napdu" ]
                                                            `gloss`  [ "truncheon", "truncheons" ],

    -- ;; zuqoliy~_1
    -- zqly    zuqoliy~        NapAt   truncheon     [[zuqoliy~/NOUN]]

    noun     FuCL |< Iy                {- zuqoliy~ -}       `gloss`  [ "truncheon" ],

    -- ;; zaqiylap_1
    -- zqyl    zaqiyl  Napdu   path;trail
    -- zqA}l   zaqA}il Ndip    paths;trails

    noun     FaCIL |< aT               {- zaqiylap -}       `others` [ "zaqA'il Ndip", "zaqiyl Napdu" ]
 ...
 |> "zqm" <| [
    ...
    verb     HaFCaL                    {- >azoqam -}        `others` [ "zqim IV_yu", "zqam IV_Pass_yu" ]
 ...
 |> "izdaqam" <| [
    ...
    verb     Identity                  {- {izodaqam -}      `others` [ "zdaqim IV" ]
                                                            `gloss`  [ "swallow", "gulp" ],
 ...
 |> "zkb" <| [
    ...
    noun     FaCIL |< aT               {- zakiybap -}       `others` [ "zakA'ib Ndip", "zakiyb Napdu" ]
 ...
 |> "zkr" <| [
    ...
    noun     FuCL |< aT                {- zukorap -}        `others` [ "zukar N", "zukr Napdu" ]
 ...
 |> "zukAm" <| [
    ...
    noun     FaCL |< aT                {- zakomap -}        `others` [ "zakm Nap" ]
                                                            `gloss`  [ "common cold" ],

    -- ;; mazokuwm_1
    -- mzkwm   mazokuwm        Nall    suffering from a cold     [[mazokuwm/ADJ]]

    noun     MaFCUL                    {- mazokuwm -}       `gloss`  [ "suffering from a cold" ] ]
 ...
 |> "zkn" <| [
    ...
    noun     FaCAL |< aT               {- zakAnap -}        `others` [ "zakAn Nap" ]
                                                            `gloss`  [ "flair", "intuition" ] ]
 ...
 |> "zk" <| [
    ...
    verb     FaCA                      {- zakA-u -}         `imperf` [ FCuL ]
                                                            `others` [ "zkuw IV_0hAnn", "zakA PV_0", "zk IV_0hwnyn", "zakaw PV_Atn", "zak PV_ttAw" ]
 ...
 |> "zky" <| [
    ...
    verb     FaCiL                     {- zakiy-a -}        `imperf` [ FCaL ]
                                                            `others` [ "zka IV_0hwnyn", "zkay IV_Ann", "zkY IV_0", "zakiy PV_no-w", "zak PV_w" ]
                                                            `gloss`  [ "grow", "increase" ] ]
 ...
 |> "zk" <| [
    ...
    verb     HaFCY                     {- >azokaY -}        `others` [ "'azk PV_ttAw", "zkay IV_Ann_Pass_yu", "zkY IV_0_Pass_yu", "'azkA PV_h", "zkiy IV_0hAnn_yu", "zk IV_0hwnyn_yu", "'azkay PV_Atn" ]
 ...
 |> "zk" <| [
    ...
    noun     CaL |< aN                 {- zakAF -}          `others` [ "zakA N0_Nhy" ]
                                                            `gloss`  [ "alms", "purity", "honesty", "integrity" ],
    ...
    noun     CaL |< Iy                 {- zakiy~ -}         `others` [ "'azkiyA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "pure", "blameless" ],
    ...
    noun     HaFCY                     {- >azokaY -}        `others` [ "'azkA Nhy", "'azkay NAn_Nayn" ]
 ...
 |> "zky" <| [
    ...
    noun     TaFCiL |< aT              {- tazokiyap -}      `others` [ "tazkiy Nap" ]
 ...
 |> "zll" <| [
    ...
    verb     FaCL                      {- zal~-ia -}        `imperf` [ FCiL, FCaL ]
                                                            `others` [ "zalil PV_C", "zlil IV_C", "zill IV_V", "zlal IV_C", "zall PV_V IV_V", "zalal PV_C" ]
                                                            `gloss`  [ "err", "slip" ],
    ...
    verb     HaFaCL                    {- >azal~ -}         `others` [ "zlil IV_C_yu", "zill IV_V_yu", "'azlal PV_C" ]
    ...
    noun     FaCL |< aT                {- zal~ap -}         `others` [ "zall NAt Napdu" ]
 ...
 |> "zl^g" <| [
    ...
    verb     FaCaL                     {- zalaj-a -}        `imperf` [ FCaL ]
                                                            `others` [ "zla^g IV", "zali^g PV", "zala^g PV" ]
                                                            `gloss`  [ "slide", "glide" ],
 ...
 |> "zlzl" <| [
    ...
    verb     FaCCaL                    {- zalozal -}        `others` [ "zalzil IV_yu" ]
                                                            `gloss`  [ "convulse", "shake" ],
    ...
    verb     TaFaCCaL                  {- tazalozal -}      `gloss`  [ "quake" ],

    -- ;; zalozalap_1
    -- zlzl    zalozal NapAt   earthquake
    -- zlAzl   zalAzil Ndip    earthquake

    noun     FaCCaL |< aT              {- zalozalap -}      `others` [ "zalzal NapAt", "zalAzil Ndip" ]
                                                            `gloss`  [ "earthquake" ],

    -- ;; zilozAl_1
    -- zlzAl   zilozAl Ndu     earthquake

    noun     FiCCAL                    {- zilozAl -}        `gloss`  [ "earthquake" ],

    -- ;; zilozAliy~_1
    -- zlzAly  zilozAliy~      Nall    seismic     [[zilozAliy~/ADJ]]

    noun     FiCCAL |< Iy              {- zilozAliy~ -}     `gloss`  [ "seismic" ],

    -- ;; muzalozil_1
    -- mzlzl   muzalozil       Nall    convulsing;shaking     [[muzalozil/ADJ]]

    noun     MuFaCCiL                  {- muzalozil -}      `gloss`  [ "convulsing", "shaking" ] ]
 ...
 |> "zl.t" <| [
    ...
    noun     FaCaL |< aT               {- zalaTap -}        `others` [ "zala.t Napdu" ]
                                                            `gloss`  [ "pebble", "gravel" ] ]
 ...
 |> "zl`" <| [
    ...
    noun     FaCL |< aT                {- zaloEap -}        `others` [ "zila` N", "zal` Napdu" ]
 ...
 |> "zl`m" <| [
    ...
    noun     FaCCUL                    {- zaloEuwm -}       `others` [ "zalA`iym Ndip" ]
 ...
 |> "zlf" <| [
    ...
    verb     HaFCaL                    {- >azolaf -}        `others` [ "zlaf IV_Pass_yu", "zlif IV_yu" ]
 ...
 |> "izdalaf" <| [
    ...
    verb     Identity                  {- {izodalaf -}      `others` [ "zdalif IV" ]
                                                            `gloss`  [ "flatter" ],
    ...
    noun     FuCL |< aT                {- zulofap -}        `others` [ "zulf Nap" ]
 ...
 |> "zlq" <| [
    ...
    verb     HaFCaL                    {- >azolaq -}        `others` [ "zliq IV_yu", "zlaq IV_Pass_yu" ]
    ...
    noun     FaCiL                     {- zaliq -}          `gloss`  [ "slippery" ],

    -- ;; zaloqap_1
    -- zlq     zaloq   Napdu   skid;slip
    -- zlq     zalaq   NAt     skidding;slipping

    noun     FaCL |< aT                {- zaloqap -}        `others` [ "zalaq NAt", "zalq Napdu" ]
                                                            `gloss`  [ "skid", "slip", "skidding", "slipping" ],

    -- ;; zalAqap_1
    -- zlAq    zalAq   Nap     slipperiness

    noun     FaCAL |< aT               {- zalAqap -}        `others` [ "zalAq Nap" ]
                                                            `gloss`  [ "slipperiness" ],

    -- ;; zal~Aqap_1
    -- zlAq    zal~Aq  NapAt   sleigh;sled

    noun     FaCCAL |< aT              {- zal~Aqap -}       `others` [ "zallAq NapAt" ]
                                                            `gloss`  [ "sleigh", "sled" ],
    ...
    noun     MiFCaL |< aT              {- mizolaqap -}      `others` [ "mizlaq NapAt", "mazAliq Ndip" ]
    ...
    noun     MunFaCiL                  {- munozaliq -}      `gloss`  [ "sliding", "skating / skiing", "drifting" ] ]
 ...
 |> "zulluwm" <| [
    ...
    noun     Identity |< aT            {- zul~uwmap -}      `others` [ "zulluwm Nap", "zalAliym Ndip" ]
 ...
 |> "zmm" <| [
    ...
    noun     MaFCUL                    {- mazomuwm -}       `gloss`  [ "bridled" ] ]
 ...
 |> "zmt" <| [
    ...
    noun     MutaFaCCiL                {- mutazam~it -}     `gloss`  [ "prim", "composed" ] ]
 ...
 |> "zm^gr" <| [
    ...
    verb     FaCCaL                    {- zamojar -}        `others` [ "zam^gir IV_yu" ]
                                                            `gloss`  [ "roar", "bellow", "bark" ],

    -- ;; zamojarap_1
    -- zmjr    zamojar NapAt   roaring;bellowing;barking

    noun     FaCCaL |< aT              {- zamojarap -}      `others` [ "zam^gar NapAt" ]
                                                            `gloss`  [ "roaring", "bellowing", "barking" ] ]
 ...
 |> "zmr" <| [
    ...
    verb     FaCaL                     {- zamar-ui -}       `imperf` [ FCuL, FCiL ]
                                                            `others` [ "zmur IV", "zamar PV", "zmir IV" ]
    ...
    noun     FuCL |< aT                {- zumorap -}        `others` [ "zumr Nap", "zumar N" ]
    ...
    noun     FaCCAL |< aT              {- zam~Arap -}       `others` [ "zamAmiyr Ndip", "zammAr Napdu" ]
 ...
 |> "zumurrud" <| [
    ...
    noun     Identity |< Iy            {- zumur~udiy~ -}    `gloss`  [ "emerald-like" ] ]
 ...
 |> "zmzm" <| [
    ...
    verb     FaCCaL                    {- zamozam -}        `others` [ "zamzim IV_yu" ]
                                                            `gloss`  [ "rumble", "murmur" ],

    -- ;; zamozam_2
    -- zmzm    zamozam N       Zamzam (water well in Mecca)

    noun     FaCCaL                    {- zamozam -}        `gloss`  [ "Zamzam ( water well in Mecca )" ],

    -- ;; zamozam_3
    -- zmzm    zamozam N       abundant

    noun     FaCCaL                    {- zamozam -}        `gloss`  [ "abundant" ],

    -- ;; zamozamiy~ap_1
    -- zmzmy   zamozamiy~      Nap     canteen;thermos     [[zamozamiy~/NOUN]]

    noun     FaCCaL |< Iy |< aT        {- zamozamiy~ap -}   `others` [ "zamzamiyy Nap" ]
                                                            `gloss`  [ "canteen", "thermos" ],

    -- ;; zamozamap_1
    -- zmzm    zamozam NapAt   lion's roar;roll of thunder
    -- zmAzm   zamAzim Ndip    lion's roars;rolls of thunder

    noun     FaCCaL |< aT              {- zamozamap -}      `others` [ "zamzam NapAt", "zamAzim Ndip" ]
 ...
 |> "zm`" <| [
    ...
    verb     HaFCaL                    {- >azomaE -}        `others` [ "zmi` IV_intr_yu" ]
                                                            `gloss`  [ "be determined", "be resolved", "decide" ],

    -- ;; muzomiE_1
    -- mzmE    muzomiE Nall    determined;resolved;decided     [[muzomiE/ADJ]]

    noun     MuFCiL                    {- muzomiE -}        `gloss`  [ "determined", "resolved", "decided" ] ]
 ...
 |> "zml" <| [
    ...
    noun     FuCL |< aT                {- zumolap -}        `others` [ "zuml Nap" ]
                                                            `gloss`  [ "company of people", "party of people" ],
    ...
    noun     FaCIL |< aT               {- zamiylap -}       `others` [ "zamiyl Nap" ]
                                                            `gloss`  [ "sister" ],

    -- ;; zamAlap_1
    -- zmAl    zamAl   Nap     companionship;comradeship

    noun     FaCAL |< aT               {- zamAlap -}        `others` [ "zamAl Nap" ]
                                                            `gloss`  [ "companionship", "comradeship" ] ]
 ...
 |> "zamAlik" <| [
    ...
    noun     Identity |< Iy            {- zamAlikiy~ -}     `gloss`  [ "of / from Zamalek" ] ]
 ...
 |> "zmn" <| [
    ...
    verb     FaCiL                     {- zamin-a -}        `imperf` [ FCaL ]
                                                            `others` [ "zman IV-n_intr", "zamin PV-n_intr" ]
    ...
    verb     HaFCaL                    {- >azoman -}        `others` [ "zmin IV-n_yu" ]
    ...
    noun     FaCaL |< aN               {- zamanAF -}        `others` [ "zaman NF" ]
                                                            `gloss`  [ "for some time", "for a while" ],

    -- ;; zamanap_1
    -- zmn     zaman   NapAt   period of time

    noun     FaCaL |< aT               {- zamanap -}        `others` [ "zaman NapAt" ]
    ...
    noun     FaCaL |< Iy               {- zamaniy~ -}       `gloss`  [ "temporal", "time" ],
    ...
    noun     FaCAL |< aT               {- zamAnap -}        `others` [ "zamAn Nap" ]
                                                            `gloss`  [ "chronic illness" ],
    ...
    noun     MuFCiL                    {- muzomin -}        `gloss`  [ "enduring", "chronic" ],

    -- ;; mutazAmin_1
    -- mtzAmn  mutazAmin       Nall    simultaneous;coincidental     [[mutazAmin/ADJ]]

    noun     MutaFACiL                 {- mutazAmin -}      `gloss`  [ "simultaneous", "coincidental" ] ]
 ...
 |> "zmhr" <| [
    ...
    verb     FaCCaL                    {- zamohar -}        `others` [ "zamhir IV_intr_yu" ]
 ...
 |> "znn" <| [
    ...
    verb     FaCL                      {- zan~-u -}         `imperf` [ FCuL ]
                                                            `others` [ "znun IV-n", "zunn IV_V", "zanan PV_Cn", "zann PV_V" ]
                                                            `gloss`  [ "drone", "buzz" ],
 ...
 |> "zn'" <| [
    ...
    verb     FaCaL                     {- zana>-a -}        `imperf` [ FCaL ]
                                                            `others` [ "zana'A PV-|_intr", "zna'A IV-|", "zna' IV_wn IV_intr IV_yn", "zana' PV->_intr PV_w_intr" ]
    ...
    verb     FaCaL                     {- zana>-a -}        `imperf` [ FCaL ]
                                                            `others` [ "zana'A PV-|", "zna'A IV-|", "zna' IV IV_wn IV_yn", "zana' PV-> PV_w" ]
                                                            `gloss`  [ "retain" ],
    ...
    verb     FaCCaL                    {- zan~a> -}         `others` [ "zanna'A PV-|", "zanni' IV_yu" ]
                                                            `gloss`  [ "restrict", "suppress" ],

    -- ;; zano>ap_1
    -- zn>     zano>   Nap     retention

    noun     FaCL |< aT                {- zano>ap -}        `others` [ "zan' Nap" ]
                                                            `gloss`  [ "retention" ] ]
 ...
 |> "znbr" <| [
    ...
    verb     TaFaCCaL                  {- tazanobar -}      `gloss`  [ "behave haughtily" ] ]
 ...
 |> "zunbuwr" <| [
    ...
    noun     Identity                  {- zunobuwr -}       `others` [ "zanAbiyr Ndip" ]
 ...
 |> "znbq" <| [
    ...
    noun     FaCCaL                    {- zanobaq -}        `others` [ "zanAbiq Ndip" ]
 ...
 |> "zanbiyl" <| [
    ...
    noun     Identity                  {- zanobiyl -}       `others` [ "zanAbiyl Ndip" ]
 ...
 |> "zn^g" <| [
    ...
    noun     FaCL |< Iy                {- zanojiy~ -}       `gloss`  [ "black" ] ]
 ...
 |> "zn_h" <| [
    ...
    verb     FaCiL                     {- zanix-a -}        `imperf` [ FCaL ]
                                                            `others` [ "zani_h PV_intr", "zna_h IV_intr" ]
                                                            `gloss`  [ "become rancid" ],

    -- ;; zanix_1
    -- znx     zanix   N-ap    rancid     [[zanix/ADJ]]

    noun     FaCiL                     {- zanix -}          `gloss`  [ "rancid" ] ]
 ...
 |> "zndq" <| [
    ...
    verb     TaFaCCaL                  {- tazanodaq -}      `gloss`  [ "be a freethinker", "be an atheist" ],

    -- ;; zanodaqap_1
    -- zndq    zanodaq Nap     atheism

    noun     FaCCaL |< aT              {- zanodaqap -}      `others` [ "zandaq Nap" ]
                                                            `gloss`  [ "atheism" ],
    ...
    noun     FiCCIL                    {- zinodiyq -}       `others` [ "zanAdiq Nap" ]
 ...
 |> "znzn" <| [
    ...
    noun     FiCCAL |< aT              {- zinozAnap -}      `others` [ "zinzAn NAt Napdu" ]
 ...
 |> "zn.tr" <| [
    ...
    noun     FiCCAL |< Iy |< aT        {- zinoTAriy~ap -}   `others` [ "zin.tAriyy Nap" ]
                                                            `gloss`  [ "dysentery" ] ]
 ...
 |> "znq" <| [
    ...
    noun     FaCaL |< aT               {- zanaqap -}        `others` [ "zanaq NAt Napdu", "zinaq N" ]
 ...
 |> "zanmard" <| [
    ...
    noun     Identity |< aT            {- zanomarodap -}    `others` [ "zanmard Nap" ]
                                                            `gloss`  [ "virago", "termagant" ] ]
 ...
 |> "zn" <| [
    ...
    verb     FaCY                      {- zanaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "zanay PV_Atn", "zniy IV_0hAnn", "zn IV_0hwnyn", "zan PV_ttAw", "zanY PV_0" ]
                                                            `gloss`  [ "fornicate" ] ]
 ...
 |> "zuhdiy" <| [
    ...
    noun     FaCIL                     {- zahiyd -}         `gloss`  [ "moderate", "small" ],

    -- ;; zahAdap_1
    -- zhAd    zahAd   Nap     moderateness;smallness

    noun     FaCAL |< aT               {- zahAdap -}        `others` [ "zahAd Nap" ]
                                                            `gloss`  [ "moderateness", "smallness" ],
 ...
 |> "zhr" <| [
    ...
    verb     HaFCaL                    {- >azohar -}        `others` [ "zhir IV_yu" ]
                                                            `gloss`  [ "glow", "blossom" ] ]
 ...
 |> "izdahar" <| [
    ...
    verb     Identity                  {- {izodahar -}      `others` [ "zdahir IV" ]
    ...
    noun     FuCL |< aT                {- zuhorap -}        `others` [ "zuhr Nap" ]
                                                            `gloss`  [ "brilliancy" ],
 ...
 |> "zuhar" <| [
    ...
    noun     Identity |< Iy            {- zuhariy~ -}       `gloss`  [ "venereal" ],

    -- ;; zahoriy~ap_1
    -- zhry    zahoriy~        NapAt   flower vase     [[zahoriy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- zahoriy~ap -}     `others` [ "zahriyy NapAt" ]
                                                            `gloss`  [ "flower vase" ],
 ...
 |> "zhrw" <| [
    ...
    noun     FaCCAL |< Iy              {- zahorAwiy~ -}     `gloss`  [ "cheerful", "merry" ],

    -- ;; zahorAwiy~_2
    -- zhrAwy  zahorAwiy~      N0      Zahrawi;Zahraoui

    noun     FaCCAL |< Iy              {- zahorAwiy~ -}     `gloss`  [ "Zahrawi", "Zahraoui" ] ]
 ...
 |> "zhr" <| [
    ...
    noun     HaFCaL                    {- >azohar -}        `gloss`  [ "Azhar" ],

    -- ;; >azohar_3
    -- >zhr    >azohar Nel     more/most radiant
    -- Azhr    >azohar Nel     more/most radiant

    noun     HaFCaL                    {- >azohar -}        `gloss`  [ "more / most radiant" ],
    ...
    noun     HaFCaL |< Iy              {- >azohariy~ -}     `gloss`  [ "Azharite" ],

    -- ;; >azohariy~_2
    -- >zhry   >azohariy~      N0      Azhari
    -- Azhry   >azohariy~      N0      Azhari

    noun     HaFCaL |< Iy              {- >azohariy~ -}     `gloss`  [ "Azhari" ],
 ...
 |> "mazAhir" <| [
    ...
    noun     Identity                  {- mazAhir -}        `gloss`  [ "lute-like instrument", "tambourine" ],

    -- ;; mazohariy~ap_1
    -- mzhry   mazohariy~      Nap     flower pot;vase     [[mazohariy~/NOUN]]

    noun     MaFCaL |< Iy |< aT        {- mazohariy~ap -}   `others` [ "mazhariyy Nap" ]
                                                            `gloss`  [ "flower pot", "vase" ],
    ...
    noun     HiFCAL                    {- <izohAr -}        `gloss`  [ "florescence" ] ]
 ...
 |> "zdhr" <| [
    ...
    noun     IFCiLAL                   {- {izodihAr -}      `gloss`  [ "prosperity", "thriving" ] ]
 ...
 |> "zhr" <| [
    ...
    noun     FACiL                     {- zAhir -}          `gloss`  [ "radiant", "bright" ],

    -- ;; muzohar_1
    -- mzhr    muzohar N-ap    flowered     [[muzohar/ADJ]]

    noun     MuFCaL                    {- muzohar -}        `gloss`  [ "flowered" ],

    -- ;; muzohir_1
    -- mzhr    muzohir Nall    blooming;bright     [[muzohir/ADJ]]

    noun     MuFCiL                    {- muzohir -}        `gloss`  [ "blooming", "bright" ] ]
 ...
 |> "muzdahir" <| [
    ...
    noun     Identity                  {- muzodahir -}      `gloss`  [ "prospering", "flourishing" ] ]
 ...
 |> "zhf" <| [
    ...
    verb     FaCaL                     {- zahaf-a -}        `imperf` [ FCaL ]
                                                            `others` [ "zhaf IV_intr", "zahaf PV_intr" ]
 ...
 |> "izdahaf" <| [
    ...
    verb     Identity                  {- {izodahaf -}      `others` [ "zdahif IV_intr" ]
                                                            `gloss`  [ "be on the verge of" ] ]
 ...
 |> "zhq" <| [
    ...
    verb     HaFCaL                    {- >azohaq -}        `others` [ "zhaq IV_Pass_yu", "zhiq IV_yu" ]
    ...
    noun     HiFCAL                    {- <izohAq -}        `gloss`  [ "destroying", "killing" ] ]
 ...
 |> "zhm" <| [
    ...
    noun     FaCiL                     {- zahim -}          `gloss`  [ "malodorous" ],

    -- ;; zuhomap_1
    -- zhm     zuhom   Nap     offensive odor

    noun     FuCL |< aT                {- zuhomap -}        `others` [ "zuhm Nap" ]
                                                            `gloss`  [ "offensive odor" ],

    -- ;; zuhuwmap_1
    -- zhwm    zuhuwm  Nap     offensive odor

    noun     FuCUL |< aT               {- zuhuwmap -}       `others` [ "zuhuwm Nap" ]
                                                            `gloss`  [ "offensive odor" ] ]
 ...
 |> "zh" <| [
    ...
    verb     FaCA                      {- zahA-u -}         `imperf` [ FCuL ]
                                                            `others` [ "zah PV_ttAw", "zahaw PV_Atn", "zahA PV_0", "zh IV_0hwnyn", "zhuw IV_0hAnn" ]
 ...
 |> "zuhiy" <| [
    ...
    verb     HaFCY                     {- >azohaY -}        `others` [ "zhiy IV_0hAnn_yu", "'azhA PV_h", "zh IV_0hwnyn_yu", "'azh PV_ttAw", "'azhay PV_Atn" ]
 ...
 |> "izdahY" <| [
    ...
    verb     Identity                  {- {izodahaY -}      `others` [ "zdah IV_0hwnyn", "zdahiy IV_0hAnn", "zdahY IV_0_Pass_yu", "izdahay PV_Atn", "izdahA PV_h", "izdah PV_ttAw_intr" ]
                                                            `gloss`  [ "be conceited", "be boastful" ] ]
 ...
 |> "zh" <| [
    ...
    noun     CaL |< Iy                 {- zahiy~ -}         `gloss`  [ "splendid", "brilliant" ],
 ...
 |> "zuhA'a" <| [
    ...
    noun     Identity                  {- zuhA'a -}         `gloss`  [ "roughly", "approximately" ],
    ...
    noun     HaFCY                     {- >azohaY -}        `others` [ "'azhA Nhy", "'azhay NAn_Nayn" ]
    ...
    noun     HiFCA'                    {- <izohA' -}        `gloss`  [ "prosperity", "flourishing", "splendor" ] ]
 ...
 |> "zdh'" <| [
    ...
    noun     IFCiLAL                   {- {izodihA' -}      `gloss`  [ "flourishing", "radiance", "pride" ] ]
 ...
 |> "zhw" <| [
    ...
    noun     MaFCUL                    {- mazohuw~ -}       `gloss`  [ "haughty", "vainglorious" ] ]
 ...
 |> "izdawa^g" <| [
    ...
    verb     Identity                  {- {izodawaj -}      `others` [ "zdawi^g IV_intr" ]
    ...
    noun     FaCL |< aT                {- zawojap -}        `others` [ "zaw^g NapAt" ]
                                                            `gloss`  [ "wife" ],

    -- ;; zawojiy~_1
    -- zwjy    zawojiy~        Nall    marital;paired     [[zawojiy~/ADJ]]

    noun     FaCL |< Iy                {- zawojiy~ -}       `gloss`  [ "marital", "paired" ],
 ...
 |> "z^g" <| [
    ...
    noun     FIL |< aT                 {- ziyjap -}         `others` [ "ziy^g NAt Napdu" ]
                                                            `gloss`  [ "marriage", "marriages" ],

    -- ;; ziyjiy~_1
    -- zyjy    ziyjiy~ Nall    marital     [[ziyjiy~/ADJ]]

    noun     FIL |< Iy                 {- ziyjiy~ -}        `gloss`  [ "marital" ],
 ...
 |> "zw^g" <| [
    ...
    noun     MuFACaL |< aT             {- muzAwajap -}      `others` [ "muzAwa^g NapAt" ]
                                                            `gloss`  [ "pairing", "coupling" ],
 ...
 |> "zw^g" <| [
    ...
    noun     MutaFaCCiL                {- mutazaw~ij -}     `gloss`  [ "married" ] ]
 ...
 |> "muzdawi^g" <| [
    ...
    noun     Identity                  {- muzodawij -}      `gloss`  [ "double", "dual" ] ]
 ...
 |> "z.h" <| [
    ...
    verb     FAL                       {- zAH-u -}          `imperf` [ FCuL ]
                                                            `others` [ "zA.h PV_V", "zuw.h IV_V", "zu.h PV_C IV_C" ]
                                                            `gloss`  [ "depart" ] ]
 ...
 |> "zd" <| [
    ...
    verb     HaFAL                     {- >azAd -}          `others` [ "zad IV_C_Pass_yu", "zid IV_C_yu", "'azad PV_C", "zAd IV_V_Pass_yu", "ziyd IV_V_yu" ]
 ...
 |> "zwd" <| [
    ...
    noun     MuFaCCaL                  {- muzaw~ad -}       `gloss`  [ "supplied", "equipped", "armed" ],
    ...
    noun     HaFCAL                    {- >azowAd -}        `others` [ "'azwid Nap" ]
    ...
    noun     FUCAL |< aT               {- zuw~Adap -}       ,

    -- ;; zuw~Adap_1
    -- zwAd    zuw~Ad  Nap     provisions

    noun     FuCCAL |< aT              {- zuw~Adap -}       `others` [ "zuwwAd Nap" ]
                                                            `gloss`  [ "provisions" ],
 ...
 |> "zr" <| [
    ...
    verb     FAL                       {- zAr-u -}          `imperf` [ FCuL ]
                                                            `others` [ "zuwr IV_V", "zAr PV_V", "zur PV_C IV_C" ]
                                                            `gloss`  [ "visit" ] ]
 ...
 |> "zr" <| [
    ...
    verb     HaFAL                     {- >azAr -}          `others` [ "zir IV_C_yu", "zar IV_C_Pass_yu", "'azar PV_C", "zAr IV_V_Pass_yu", "ziyr IV_V_yu" ]
 ...
 |> "zwr" <| [
    ...
    noun     FaCL |< aT                {- zaworap -}        `others` [ "zawr Nap" ]
                                                            `gloss`  [ "visit" ] ]
 ...
 |> "zyr" <| [
    ...
    noun     FiCAL |< aT               {- ziyArap -}        `others` [ "ziyAr NapAt" ]
                                                            `gloss`  [ "visit" ] ]
 ...
 |> "zwr" <| [
    ...
    noun     HaFCaL                    {- >azowar -}        `others` [ "zawrA' Nh Nhy N0_Nh" ]
    ...
    noun     HaFCaL                    {- >azowar -}        `others` [ "zawrA' Nh Nhy N0_Nh", "zuwr N" ]
                                                            `gloss`  [ "cross-eyed" ] ]
 ...
 |> "z'r" <| [
    ...
    noun     FACiL                     {- zA}ir -}          `gloss`  [ "visiting" ] ]
 ...
 |> "zr" <| [
    ...
    noun     MaFUL                     {- mazuwr -}         `gloss`  [ "visited" ] ]
 ...
 |> "zwr" <| [
    ...
    noun     MuFaCCaL                  {- muzaw~ar -}       `gloss`  [ "falsified", "forged" ] ]
 ...
 |> "zwrq" <| [
    ...
    noun     FaCCaL                    {- zaworaq -}        `others` [ "zawAriq Ndip" ]
 ...
 |> "z.g" <| [
    ...
    verb     FAL                       {- zAg-u -}          `imperf` [ FCuL ]
                                                            `others` [ "zu.g PV_C IV_C", "zuw.g IV_V", "zA.g PV_V" ]
 ...
 |> "zwf'" <| [
    ...
    noun     FuCCAL                    {- zuwfA' -}         `others` [ "zuwfY N0" ]
                                                            `gloss`  [ "hyssop" ] ]
 ...
 |> "mAzAla" <| [
    ...
    noun     Identity                  {- mAzAla -}         `others` [ "mAziltunna FW-Wa", "mAziltu FW-Wa", "mAzAlat FW-Wa", "mAzAlA FW-Wa", "mAzilti FW-Wa", "mAziltumA FW-Wa", "mAzAlatA FW-Wa", "mAziltum FW-Wa", "mAzilta FW-Wa", "mAzilnA FW-Wa", "mAzAluwA FW-Wa", "mAzilna FW-Wa" ]
                                                            `gloss`  [ "not + stop / cease + he / it ( he / it continues )", "not + stop / cease + they ( they both continue )", "not + stop / cease + they ( they continue )", "not + stop / cease + it / she / they ( it / she / they continue ( s ) )", "not + stop / cease + you ( you continue )", "not + stop / cease + you ( you both continue )", "not + stop / cease + I ( I continue )", "not + stop / cease + we ( we continue )" ] ]
 ...
 |> "zl" <| [
    ...
    verb     FAL                       {- zAl-u -}          `imperf` [ FCuL ]
                                                            `others` [ "zul PV_C IV_C", "zuwl IV_V", "zAl PV_V" ]
                                                            `gloss`  [ "disappear" ],
    ...
    verb     FAL                       {- zAl-a -}          `imperf` [ FCaL ]
                                                            `others` [ "zil PV_C", "zal IV_C", "zAl PV_V IV_V" ]
 ...
 |> "zl" <| [
    ...
    verb     HaFAL                     {- >azAl -}          `others` [ "zil IV_C_yu", "zal IV_C_Pass_yu", "'azal PV_C", "ziyl IV_V_yu", "zAl IV_V_Pass_yu" ]
 ...
 |> "zwl" <| [
    ...
    noun     FaCAL |< Iy               {- zawAliy~ -}       `gloss`  [ "Zawal ( method of reckoning time )" ],

    -- ;; mizowalap_1
    -- mzwl    mizowal Napdu   sundial
    -- mzAwl   mazAwil Ndip    sundials

    noun     MiFCaL |< aT              {- mizowalap -}      `others` [ "mizwal Napdu", "mazAwil Ndip" ]
                                                            `gloss`  [ "sundial", "sundials" ],

    -- ;; muzAwalap_1
    -- mzAwl   muzAwal NapAt   pursuit;practice

    noun     MuFACaL |< aT             {- muzAwalap -}      `others` [ "muzAwal NapAt" ]
 ...
 |> "zl" <| [
    ...
    noun     HiFAL |< aT               {- <izAlap -}        `others` [ "'izAl Nap" ]
 ...
 |> "z'l" <| [
    ...
    noun     FACiL                     {- zA}il -}          `gloss`  [ "transitory", "ephemeral" ] ]
 ...
 |> "zl^g" <| [
    ...
    noun     FuCUL |< Iy               {- zuluwjiy~ -}      `gloss`  [ "zoological" ] ]
 ...
 |> "zm" <| [
    ...
    verb     FAL                       {- zAm-u -}          `imperf` [ FCuL ]
                                                            `others` [ "zAm PV_V", "zuwm IV_V", "zum PV_C IV_C" ]
                                                            `gloss`  [ "growl", "snarl" ] ]
 ...
 |> "zw" <| [
    ...
    verb     FaCY                      {- zawaY-i -}        `imperf` [ FCiL ]
                                                            `others` [ "zw IV_0hwnyn", "zaw PV_ttAw", "zawY PV_0", "zwY IV_0_Pass_yu", "zwiy IV_0hAnn", "zawA PV_h", "zaway PV_Atn" ]
 ...
 |> "zy'" <| [
    ...
    noun     HaFCAL                    {- >azoyA' -}        `gloss`  [ "fashion", "clothes", "uniforms" ] ]
 ...
 |> "zybq" <| [
    ...
    noun     FaCCaL                    {- zayobaq -}        `gloss`  [ "quicksilver", "mercury" ] ]
 ...
 |> "zyt" <| [
    ...
    noun     FaCL |< Iy                {- zayotiy~ -}       `gloss`  [ "oily", "oil-bearing" ] ]
 ...
 |> "zyt" <| [
    ...
    noun     MaFCaL |< aT              {- mazoyatap -}      `others` [ "mazyat Nap" ]
                                                            `gloss`  [ "oiler", "oil can" ],
    ...
    noun     MuFaCCaL                  {- muzay~at -}       `gloss`  [ "lubricated", "oiled" ] ]
 ...
 |> "zytn" <| [
    ...
    noun     FaCCUL                    {- zayotuwn -}       `gloss`  [ "olives", "olive tree" ],

    -- ;; zayotuwnap_1
    -- zytwn   zayotuwn        Nap     Zaitouna

    noun     FaCCUL |< aT              {- zayotuwnap -}     `others` [ "zaytuwn Nap" ]
                                                            `gloss`  [ "Zaitouna" ],
    ...
    noun     FaCCUL |< aT              {- zayotuwnap -}     `others` [ "zaytuwn NAt Napdu" ]
                                                            `gloss`  [ "olive", "olives" ],
    ...
    noun     FaCCUL |< Iy              {- zayotuwniy~ -}    `gloss`  [ "Zaitounites" ],

    -- ;; zayotuwniy~_2
    -- zytwny  zayotuwniy~     N-ap    olive-like;olive     [[zayotuwniy~/ADJ]]

    noun     FaCCUL |< Iy              {- zayotuwniy~ -}    `gloss`  [ "olive-like", "olive" ] ]
 ...
 |> "z.h" <| [
    ...
    verb     FAL                       {- zAH-i -}          `imperf` [ FCiL ]
                                                            `others` [ "zi.h PV_C IV_C", "zA.h PV_V", "ziy.h IV_V" ]
                                                            `gloss`  [ "depart" ],
    ...
    verb     HaFAL                     {- >azAH -}          `others` [ "zA.h IV_V_Pass_yu", "zi.h IV_C_yu", "za.h IV_C_Pass_yu", "'aza.h PV_C", "ziy.h IV_V_yu" ]
 ...
 |> "z.h" <| [
    ...
    noun     HiFAL |< aT               {- <izAHap -}        `others` [ "'izA.h NapAt" ]
                                                            `gloss`  [ "removal", "abolition" ] ]
 ...
 |> "zd" <| [
    ...
    verb     FAL                       {- zAd-i -}          `imperf` [ FCiL ]
                                                            `others` [ "zad IV_C_Pass_yu", "zid PV_C IV_C", "ziyd IV_V", "zAd PV_V IV_V_Pass_yu" ]
 ...
 |> "izdAd" <| [
    ...
    verb     Identity                  {- {izodAd -}        `others` [ "zdad IV_C", "zdAd IV_V", "izdad PV_C" ]
                                                            `gloss`  [ "increase" ] ]
 ...
 |> "zyd" <| [
    ...
    noun     FiCAL |< aT               {- ziyAdap -}        `others` [ "ziyAd Nap" ]
    ...
    noun     HaFCaL                    {- >azoyad -}        `gloss`  [ "higher / highest", "greater / greatest" ] ]
 ...
 |> "zd" <| [
    ...
    noun     MaFIL                     {- maziyd -}         `gloss`  [ "increased" ] ]
 ...
 |> "zyd" <| [
    ...
    noun     MuFACaL |< aT             {- muzAyadap -}      `others` [ "muzAyad NapAt" ]
 ...
 |> "zdyd" <| [
    ...
    noun     IFCiLAL                   {- {izodiyAd -}      `gloss`  [ "increase", "intensification" ] ]
 ...
 |> "zd" <| [
    ...
    noun     IstiFAL |< aT             {- {isotizAdap -}    `others` [ "istizAd Nap" ]
                                                            `gloss`  [ "desire for increase" ] ]
 ...
 |> "z'd" <| [
    ...
    noun     FACiL |< aT               {- zA}idap -}        `others` [ "zA'id Napdu" ]
                                                            `gloss`  [ "appendage", "appendix" ],

    -- ;; zA}idiy~_1
    -- zA}dy   zA}idiy~        N-ap    hyperbolic     [[zA}idiy~/ADJ]]

    noun     FACiL |< Iy               {- zA}idiy~ -}       `gloss`  [ "hyperbolic" ] ]
 ...
 |> "zyd" <| [
    ...
    noun     MutaFACiL                 {- mutazAyid -}      `gloss`  [ "increasing", "growing" ] ]
 ...
 |> "muzdAd" <| [
    ...
    noun     Identity                  {- muzodAd -}        `gloss`  [ "born" ] ]
 ...
 |> "zyr" <| [
    ...
    noun     HaFCAL                    {- >azoyAr -}        `others` [ "ziyAr N" ]
                                                            `gloss`  [ "water pots" ] ]
 ...
 |> "z.g" <| [
    ...
    verb     FAL                       {- zAg-i -}          `imperf` [ FCiL ]
                                                            `others` [ "ziy.g IV_V", "zA.g PV_V", "zi.g PV_C IV_C" ]
    ...
    verb     HaFAL                     {- >azAg -}          `others` [ "'aza.g PV_C", "ziy.g IV_V_yu", "za.g IV_C_Pass_yu", "zA.g IV_V_Pass_yu", "zi.g IV_C_yu" ]
 ...
 |> "zyf" <| [
    ...
    noun     HaFCaL                    {- >azoyaf -}        `gloss`  [ "falser / falsest", "more / most spurious" ],
 ...
 |> "z'f" <| [
    ...
    noun     FACiL                     {- zA}if -}          `gloss`  [ "forged", "spurious", "fake" ] ]
 ...
 |> "zyf" <| [
    ...
    noun     MuFaCCaL                  {- muzay~af -}       `gloss`  [ "forged", "counterfeit", "pseudo" ] ]
 ...
 |> "zymn" <| [
    ...
    noun     FiCCIL                    {- ziymiyn -}        `gloss`  [ "Zemin" ] ]
 ...
 |> "zn" <| [
    ...
    verb     FAL                       {- zAn-i -}          `imperf` [ FCiL ]
                                                            `others` [ "zin PV_Cn IV-n", "ziyn IV_V", "zAn PV_V" ]
 ...
 |> "izdAn" <| [
    ...
    verb     Identity                  {- {izodAn -}        `others` [ "zdan IV-n_intr", "zdAn IV_V_intr", "izdan PV_Cn_intr" ]
    ...
    noun     FaCL |< aT                {- zayonap -}        `others` [ "zayn Nap" ]
                                                            `gloss`  [ "Zeina" ],

    -- ;; ziynap_1
    -- zyn     ziyn    NapAt   embellishment;decoration

    noun     FiCL |< aT                {- ziynap -}         `others` [ "ziyn NapAt" ]
    ...
    noun     FiCAL |< aT               {- ziyAnap -}        `others` [ "ziyAn Nap" ]
                                                            `gloss`  [ "hairdressing" ],
    ...
    noun     MuFaCCiL |< aT            {- muzay~inap -}     `others` [ "muzayyin NapAt" ]
                                                            `gloss`  [ "hairdresser" ],

    -- ;; muzay~an_1
    -- mzyn    muzay~an        N-ap    adorned;decorated     [[muzay~an/ADJ]]

    noun     MuFaCCaL                  {- muzay~an -}       `gloss`  [ "adorned", "decorated" ] ]
 ...
 |> "muzdAn" <| [
    ...
    noun     Identity                  {- muzodAn -}        `gloss`  [ "adorned", "decorated" ] ]
 ...
 |> "zynb" <| [
    ...
    noun     FaCCaL                    {- zayonab -}        `gloss`  [ "Zeinab", "Zenobia" ] ]
