...
package Elixir::Data::Lexicons::Lexicon10;
...
$lexicon = {
  'r \' ^g' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"widespread [ [ rA } ij / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"widespread [ [ rA } ij / ADJ ] ]"' => 1,
        '"circulating"' => 1
      },
      'orig' => 'rA}ij',
      'prefix' => ''
  ...
  'r _h w' => [
    {
      ...
      'form' => 'tarA_hY',
      'others' => [
        'tarA_h IV_0hwnyn PV_ttAw',
        'tarA_hay PV_Atn IV_Ann',
        'tarA_hA PV_h IV_h'
      ],
      'lines' => [
        ';; tarAxaY_1',
  ...
  'r w \'' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"narrator [ [ riwA } iy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"novelist"' => 1,
        '"narrator [ [ riwA } iy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'riwA}iy~',
      'prefix' => ''
    }
  ...
  'r _h .s' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"officially registered [ [ murax ~ aS / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"officially registered [ [ murax ~ aS / ADJ ] ]"' => 1,
        '"licensed"' => 1
      },
      'orig' => 'murax~aS',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"low-priced [ [ murotaxaS / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"low-priced [ [ murotaxaS / ADJ ] ]"' => 1,
        '"cheap"' => 1
      },
      'orig' => 'murotaxaS',
      'prefix' => ''
  ...
  'r b .h' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"interest [ [ riboHiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"interest [ [ riboHiy ~ / ADJ ] ]"' => 1,
        '"profit"' => 1
      },
      'orig' => 'riboHiy~',
      'prefix' => ''
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"profitable [ [ murobiH / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"lucrative"' => 1,
        '"profitable [ [ murobiH / ADJ ] ]"' => 1
      },
      'orig' => 'murobiH',
      'prefix' => ''
    }
  ...
  'r y b' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"ribo ( in `` deoxy-ribo-nucleic acid \'\' ) [ [ riybiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"ribo ( in `` deoxy-ribo-nucleic acid \'\' ) [ [ riybiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'riybiy~',
      'prefix' => ''
    }
  ...
  'r w k' => [
    ...
    {
      'types' => $lexicon->{'r w k'}[0]{'types'},
      'entry' => 'ruwk',
      'form' => 'ruwk',
      'lines' => $lexicon->{'r w k'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FUL',
      'suffix' => '',
      'glosses' => $lexicon->{'r w k'}[0]{'glosses'},
      'glosshash' => $lexicon->{'r w k'}[0]{'glosshash'},
      'orig' => 'ruwk',
      'prefix' => ''
    }
  ],
  ...
  'r y .d' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"mathematical [ [ riyADiy ~ / ADJ ] ]"'
        ],
        [
          '"mathematician [ [ riyADiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"mathematician [ [ riyADiy ~ / ADJ ] ]"' => 1,
        '"mathematical [ [ riyADiy ~ / ADJ ] ]"' => 1,
        '"sports"' => 1,
        '"sportive"' => 1
      },
      'orig' => 'riyADiy~',
  ...
  'r \' q' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"unblemished [ [ rA } iq / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"pure"' => 1,
        '"clear"' => 1,
        '"unblemished [ [ rA } iq / ADJ ] ]"' => 1
      },
      'orig' => 'rA}iq',
      'prefix' => ''
    }
  ...
  'r m z' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"symbolic [ [ ramoziy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"symbolic [ [ ramoziy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'ramoziy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"symbolism [ [ ramoziy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"symbolism [ [ ramoziy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'ramoziy~ap',
      'prefix' => ''
    }
  ...
  'r w `' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"magnificent [ [ rA } iE / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"splendid"' => 1,
        '"magnificent [ [ rA } iE / ADJ ] ]"' => 1,
        '"marvelous"' => 1
      },
      'orig' => 'rA}iE',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"dreadful [ [ muraw ~ iE / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"dreadful [ [ muraw ~ iE / ADJ ] ]"' => 1,
        '"terrible"' => 1
      },
      'orig' => 'muraw~iE',
      'prefix' => ''
  ...
  'r w s' => [
    {
      ...
      'glosshash' => {
        '"Russians"' => 1,
        '"Russian [ [ ruwsiy ~ / ADJ ] ]"' => 1,
        '"Russian [ [ ruwsiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'ruwsiy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"Russian ( language ) [ [ ruwsiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"Russian ( language ) [ [ ruwsiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'ruwsiy~ap',
      'prefix' => ''
    },
  ...
  'ruwmAns' => [
    {
      ...
      'glosses' => [
        [
          '"romantic [ [ ruwmAnosiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"romantic [ [ ruwmAnosiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'ruwmAnosiy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"romanticism [ [ ruwmAnosiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"romanticism [ [ ruwmAnosiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'ruwmAnosiy~ap',
      'prefix' => ''
    }
  ...
  'r k b' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"consisting [ [ murak ~ ab / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"consisting [ [ murak ~ ab / ADJ ] ]"' => 1,
        '"installed"' => 1,
        '"composed"' => 1
      },
      'orig' => 'murak~ab',
  ...
  'r _t ' => [
    ...
    {
      'types' => $lexicon->{'r _t '}[0]{'types'},
      'entry' => 'ra_tY',
      'form' => 'ra_tY',
      'others' => $lexicon->{'r _t '}[0]{'others'},
      'lines' => $lexicon->{'r _t '}[0]{'lines'},
      'index' => '1',
      'entity' => 'verb',
      'morphs' => 'FaCaNY',
      'suffix' => '',
      'glosses' => $lexicon->{'r _t '}[0]{'glosses'},
      'glosshash' => $lexicon->{'r _t '}[0]{'glosshash'},
      'orig' => 'ravaY',
      'prefix' => ''
    }
  ],
  'r b w' => [
    {
      ...
      'others' => [
        'rabbA PV_h',
        'rabb IV_0hwnyn_yu PV_ttAw',
        'rabbay PV_Atn IV_Ann_Pass_yu',
        'rabbiy IV_0hAnn_yu'
      ],
      'lines' => [
        ';; rab~aY_1',
  ...
  'r y .h' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"comfortable [ [ muriyH / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"soothing"' => 1,
        '"comfortable [ [ muriyH / ADJ ] ]"' => 1,
        '"restful"' => 1
      },
      'orig' => 'muriyH',
      'prefix' => ''
  ...
  'r w y' => [
    ...
    {
      'types' => $lexicon->{'r w y'}[0]{'types'},
      'entry' => 'rawY',
      'form' => 'rawY',
      'others' => $lexicon->{'r w y'}[0]{'others'},
      'lines' => $lexicon->{'r w y'}[0]{'lines'},
      'index' => '1',
      'entity' => 'verb',
      'morphs' => 'FaCaNY',
      'glosses' => $lexicon->{'r w y'}[0]{'glosses'},
      'suffix' => '',
      'imperf' => $lexicon->{'r w y'}[0]{'imperf'},
      'glosshash' => $lexicon->{'r w y'}[0]{'glosshash'},
      'orig' => 'rawaY-i',
      'prefix' => ''
    },
    {
    ...
    {
      'types' => $lexicon->{'r w \''}[0]{'types'},
      'entry' => 'riwA\'',
      'form' => 'riwA\'iyy',
      'lines' => $lexicon->{'r w \''}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FiCA\'',
      'suffix' => ' |< Iy',
      'glosses' => $lexicon->{'r w \''}[0]{'glosses'},
      'glosshash' => $lexicon->{'r w \''}[0]{'glosshash'},
      'orig' => 'riwA}iy~',
      'prefix' => ''
    },
    {
  ...
  'r n n' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"reverberating [ [ ran ~ An / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"reverberating [ [ ran ~ An / ADJ ] ]"' => 1,
        '"resounding"' => 1,
        '"ringing"' => 1,
        '"resonating"' => 1
      },
    ...
    {
      'types' => $lexicon->{'r n n'}[0]{'types'},
      'entry' => 'rannAn',
      'form' => 'rannAn',
      'lines' => $lexicon->{'r n n'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCLAn',
      'suffix' => '',
      'glosses' => $lexicon->{'r n n'}[0]{'glosses'},
      'glosshash' => $lexicon->{'r n n'}[0]{'glosshash'},
      'orig' => 'ran~An',
      'prefix' => ''
    }
  ],
  'r w .h n' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"spirituality [ [ ruwHAniy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"spirituality [ [ ruwHAniy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'ruwHAniy~ap',
      'prefix' => ''
    }
  ...
  'r s m' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"official [ [ rasomiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"official [ [ rasomiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'rasomiy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"officially [ [ rasomiy ~ / ADV ] ]"'
        ]
      ],
      'glosshash' => {
        '"officially [ [ rasomiy ~ / ADV ] ]"' => 1
      },
      'orig' => 'rasomiy~AF',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"sketched [ [ marosuwm / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"drawn"' => 1,
        '"sketched [ [ marosuwm / ADJ ] ]"' => 1
      },
      'orig' => 'marosuwm',
      'prefix' => ''
    }
  ...
  'r w m' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"okay [ [ yurAm / FUNC_WORD ] ]"'
        ],
        [
          '"okay [ [ mAyurAm / FUNC_WORD ] ]"'
        ]
      ],
      'suffix' => '',
      'imperf' => [
      ...
      'glosshash' => {
        '"okay [ [ yurAm / FUNC_WORD ] ]"' => 1,
        '"fine"' => 1,
        '"covet"' => 1,
        '"desire"' => 1,
        '"okay [ [ mAyurAm / FUNC_WORD ] ]"' => 1,
        '"wish"' => 1
      },
      'orig' => 'rAm-u',
      'prefix' => ''
    ...
    {
      'types' => $lexicon->{'r w m'}[1]{'types'},
      'entry' => 'ruwm',
      'form' => 'ruwm',
      'others' => $lexicon->{'r w m'}[1]{'others'},
      'lines' => $lexicon->{'r w m'}[1]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FuCL',
      'suffix' => '',
      'glosses' => $lexicon->{'r w m'}[1]{'glosses'},
      'glosshash' => $lexicon->{'r w m'}[1]{'glosshash'},
      'orig' => 'ruwm',
      'prefix' => ''
    },
    {
    ...
    {
      'types' => $lexicon->{'r w m'}[3]{'types'},
      'entry' => 'ruwm',
      'form' => 'ruwmiyy',
      'lines' => $lexicon->{'r w m'}[3]{'lines'},
      'index' => '3',
      'entity' => 'noun',
      'morphs' => 'FuCL',
      'suffix' => ' |< Iy',
      'glosses' => $lexicon->{'r w m'}[3]{'glosses'},
      'glosshash' => $lexicon->{'r w m'}[3]{'glosshash'},
      'orig' => 'ruwmiy~',
      'prefix' => ''
    }
  ],
  ...
  'r f `' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"top-level [ [ rafiyE / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"high-ranking"' => 1,
        '"top-level [ [ rafiyE / ADJ ] ]"' => 1
      },
      'orig' => 'rafiyE',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"hoisted [ [ marofuwE / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"raised"' => 1,
        '"hoisted [ [ marofuwE / ADJ ] ]"' => 1,
        '"lifted"' => 1
      },
      'orig' => 'marofuwE',
      'prefix' => ''
  ...
  'r m y' => [
    ...
    {
      'types' => $lexicon->{'r m y'}[0]{'types'},
      'entry' => 'ramY',
      'form' => 'ramY',
      'others' => $lexicon->{'r m y'}[0]{'others'},
      'lines' => $lexicon->{'r m y'}[0]{'lines'},
      'index' => '1',
      'entity' => 'verb',
      'morphs' => 'FaCaNY',
      'glosses' => $lexicon->{'r m y'}[0]{'glosses'},
      'suffix' => '',
      'imperf' => $lexicon->{'r m y'}[0]{'imperf'},
      'glosshash' => $lexicon->{'r m y'}[0]{'glosshash'},
      'orig' => 'ramaY-i',
      'prefix' => ''
    },
    {
  ...
  'r _h \'' => [
    {
      'types' => $lexicon->{'r _h w'}[1]{'types'},
      'entry' => 'ra_hA\'',
      'form' => 'ra_hA\'',
      'lines' => $lexicon->{'r _h w'}[1]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'r _h w'}[1]{'glosses'},
      'glosshash' => $lexicon->{'r _h w'}[1]{'glosshash'},
      'orig' => 'raxA\'',
      'prefix' => ''
    }
  ],
  ...
  'r \' w' => [
    {
      ...
      'glosses' => [
        [
          '"pulmonary [ [ ri } awiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"pulmonary [ [ ri } awiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'ri}awiy~',
      'prefix' => ''
    }
  ...
  'r b n' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"divinities [ [ rab ~ Aniy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"divine [ [ rab ~ Aniy ~ / ADJ ] ]"' => 1,
        '"divinities [ [ rab ~ Aniy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'rab~Aniy~',
      'prefix' => ''
    }
  ...
  'r b `' => [
    ...
    },
    {
      ...
      'glosshash' => {
        '"pasture"' => 1,
        '"places of entertainment"' => 1,
        '"meadow"' => 1,
        '"pastures"' => 1,
        '"place of entertainment"' => 1,
        '"meadows"' => 1
      },
      'orig' => 'marobaE',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"in the fourth place [ [ rAbiE / ADV ] ]"'
        ]
      ],
      'glosshash' => {
        '"fourthly"' => 1,
        '"in the fourth place [ [ rAbiE / ADV ] ]"' => 1,
        '"fourth [ [ rAbiE / ADJ ] ]"' => 1
      },
      'orig' => 'rAbiE',
      'prefix' => ''
  ...
  'r b .t' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"connected [ [ marobuwT / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"tied"' => 1,
        '"connected [ [ marobuwT / ADJ ] ]"' => 1
      },
      'orig' => 'marobuwT',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"closely related [ [ mutarAbiT / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"closely related [ [ mutarAbiT / ADJ ] ]"' => 1,
        '"closely tied together"' => 1
      },
      'orig' => 'mutarAbiT',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"linked [ [ murotabiT / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"connected"' => 1,
        '"linked [ [ murotabiT / ADJ ] ]"' => 1
      },
      'orig' => 'murotabiT',
      'prefix' => ''
    }
  ...
  'r ^g b' => [
    {
      'types' => $lexicon->{'r ^g \''}[1]{'types'},
      'entry' => '\'ir^gA\'',
      'form' => '\'ir^gA\'',
      'lines' => $lexicon->{'r ^g \''}[1]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'HiFCA\'',
      'suffix' => '',
      'glosses' => $lexicon->{'r ^g \''}[1]{'glosses'},
      'glosshash' => $lexicon->{'r ^g \''}[1]{'glosshash'},
      'orig' => 'IirojA\'',
      'prefix' => ''
    },
    {
  ...
  'r m ' => [
    {
      'types' => $lexicon->{'r m y'}[6]{'types'},
      'entry' => 'mutarAmiy',
      'form' => 'mutarAmiy',
      'others' => $lexicon->{'r m y'}[6]{'others'},
      'lines' => $lexicon->{'r m y'}[6]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'MutaFACiN',
      'suffix' => '',
      'glosses' => $lexicon->{'r m y'}[6]{'glosses'},
      'glosshash' => $lexicon->{'r m y'}[6]{'glosshash'},
      'orig' => 'mutarAmiy',
      'prefix' => ''
    }
  ],
  'r s w' => [
    ...
    {
      'types' => $lexicon->{'r s \''}[0]{'types'},
      'entry' => '\'irsA\'',
      'form' => '\'irsA\'',
      'lines' => $lexicon->{'r s \''}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'HiFCA\'',
      'suffix' => '',
      'glosses' => $lexicon->{'r s \''}[0]{'glosses'},
      'glosshash' => $lexicon->{'r s \''}[0]{'glosshash'},
      'orig' => 'IirosA\'',
      'prefix' => ''
    }
  ],
  ...
  'r w .h' => [
    ...
    {
      'types' => $lexicon->{'r w .h'}[6]{'types'},
      'entry' => 'ruw.h',
      'form' => 'ruw.h',
      'others' => $lexicon->{'r w .h'}[6]{'others'},
      'lines' => $lexicon->{'r w .h'}[6]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FuCL',
      'suffix' => '',
      'glosses' => $lexicon->{'r w .h'}[6]{'glosses'},
      'glosshash' => $lexicon->{'r w .h'}[6]{'glosshash'},
      'orig' => 'ruwH',
      'prefix' => ''
    },
    {
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"spiritual [ [ ruwHiy ~ / ADJ ] ]"'
        ],
        [
          '"alcoholic [ [ ruwHiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"spiritual [ [ ruwHiy ~ / ADJ ] ]"' => 1,
        '"alcoholic [ [ ruwHiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'ruwHiy~',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'r w .h'}[9]{'types'},
      'entry' => 'ruw.h',
      'form' => 'ruw.hiyy',
      'lines' => $lexicon->{'r w .h'}[9]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FuCL',
      'suffix' => ' |< Iy',
      'glosses' => $lexicon->{'r w .h'}[9]{'glosses'},
      'glosshash' => $lexicon->{'r w .h'}[9]{'glosshash'},
      'orig' => 'ruwHiy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"spirituality [ [ ruwHiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"spirituality [ [ ruwHiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'ruwHiy~ap',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'r w .h'}[11]{'types'},
      'entry' => 'ruw.h',
      'form' => 'ruw.hiyyaT',
      'lines' => $lexicon->{'r w .h'}[11]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FuCL',
      'suffix' => ' |< Iy |< aT',
      'glosses' => $lexicon->{'r w .h'}[11]{'glosses'},
      'glosshash' => $lexicon->{'r w .h'}[11]{'glosshash'},
      'orig' => 'ruwHiy~ap',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'r y .h'}[0]{'types'},
      'entry' => 'riy.h',
      'form' => 'riy.h',
      'others' => $lexicon->{'r y .h'}[0]{'others'},
      'lines' => $lexicon->{'r y .h'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FIL',
      'suffix' => '',
      'glosses' => $lexicon->{'r y .h'}[0]{'glosses'},
      'glosshash' => $lexicon->{'r y .h'}[0]{'glosshash'},
      'orig' => 'riyH',
      'prefix' => ''
    },
    {
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"helicopter [ [ mirowaHiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"propeller"' => 1,
        '"helicopter [ [ mirowaHiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'mirowaHiy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"helicopter [ [ mirowaHiy ~ / NOUN ] ]"'
        ],
        [
          '"helicopters [ [ mirowaHiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"helicopter [ [ mirowaHiy ~ / NOUN ] ]"' => 1,
        '"helicopters [ [ mirowaHiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'mirowaHiy~ap',
      'prefix' => ''
    },
    ...
    {
      'types' => $lexicon->{'r y .h'}[2]{'types'},
      'entry' => 'muriy.h',
      'form' => 'muriy.h',
      'lines' => $lexicon->{'r y .h'}[2]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'MuFIL',
      'suffix' => '',
      'glosses' => $lexicon->{'r y .h'}[2]{'glosses'},
      'glosshash' => $lexicon->{'r y .h'}[2]{'glosshash'},
      'orig' => 'muriyH',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"satisfied [ [ murotAH / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"resting"' => 1,
        '"relaxed"' => 1,
        '"satisfied [ [ murotAH / ADJ ] ]"' => 1
      },
      'orig' => 'murotAH',
      'prefix' => ''
    }
  ...
  'marw' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"reports [ [ marowiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"tales"' => 1,
        '"reports [ [ marowiy ~ / NOUN ] ]"' => 1,
        '"stories"' => 1
      },
      'orig' => 'marowiy~At',
      'prefix' => ''
  ...
  'r m n' => [
    {
      ...
      'glosses' => [
        [
          '"Romanian [ [ ruwmAniy ~ / NOUN ] ]"'
        ],
        [
          '"Romanian [ [ ruwmAniy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"Romanian [ [ ruwmAniy ~ / NOUN ] ]"' => 1,
        '"Romanian [ [ ruwmAniy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'ruwmAniy~',
      'prefix' => ''
    }
  ...
  'r q ' => [
    ...
    {
      'types' => $lexicon->{'r q '}[0]{'types'},
      'entry' => 'rAqiy',
      'form' => 'rAqiy',
      'others' => $lexicon->{'r q '}[0]{'others'},
      'lines' => $lexicon->{'r q '}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACI',
      'suffix' => '',
      'glosses' => $lexicon->{'r q '}[0]{'glosses'},
      'glosshash' => $lexicon->{'r q '}[0]{'glosshash'},
      'orig' => 'rAqiy',
      'prefix' => ''
    }
  ],
  ...
  'r f .d' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"refused [ [ marofuwD / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"rejected"' => 1,
        '"refused [ [ marofuwD / ADJ ] ]"' => 1
      },
      'orig' => 'marofuwD',
      'prefix' => ''
    }
  ...
  'r h f' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"delicate [ [ murohaf / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"delicate [ [ murohaf / ADJ ] ]"' => 1,
        '"thin"' => 1,
        '"sharp"' => 1
      },
      'orig' => 'murohaf',
  ...
  'r ^g .h' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"preponderant [ [ rAjiH / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"probable"' => 1,
        '"preponderant [ [ rAjiH / ADJ ] ]"' => 1,
        '"likely"' => 1
      },
      'orig' => 'rAjiH',
      'prefix' => ''
  ...
  'r .g b' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"sought after [ [ maroguwb / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"sought after [ [ maroguwb / ADJ ] ]"' => 1,
        '"desired"' => 1
      },
      'orig' => 'maroguwb',
      'prefix' => ''
  ...
  'r ^g `' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"retroactive [ [ rajoEiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"retroactive [ [ rajoEiy ~ / ADJ ] ]"' => 1,
        '"reactionary"' => 1
      },
      'orig' => 'rajoEiy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"reaction [ [ rajoEiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"reactionary conservatism"' => 1,
        '"reaction [ [ rajoEiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'rajoEiy~ap',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"qualified [ [ marojiEiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"qualified [ [ marojiEiy ~ / ADJ ] ]"' => 1,
        '"authoritative"' => 1
      },
      'orig' => 'marojiEiy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"authority [ [ marojiEiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"authority [ [ marojiEiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'marojiEiy~ap',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"falling behind [ [ mutarAjiE / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"falling behind [ [ mutarAjiE / ADJ ] ]"' => 1,
        '"retreating"' => 1
      },
      'orig' => 'mutarAjiE',
      'prefix' => ''
  ...
  'r \' s' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"principal [ [ ra } iysiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"main"' => 1,
        '"principal [ [ ra } iysiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'ra}iysiy~',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"executive [ [ ri } Asiy ~ / ADJ ] ]"'
        ],
        [
          '"executive [ [ riyAsiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"executive [ [ riyAsiy ~ / ADJ ] ]"' => 1,
        '"presidential"' => 1,
        '"executive [ [ ri } Asiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'ri}Asiy~',
      'prefix' => ''
    },
  ...
  'r \' d' => [
    {
      'types' => $lexicon->{'r w d'}[3]{'types'},
      'entry' => 'rA\'id',
      'form' => 'rA\'id',
      'others' => $lexicon->{'r w d'}[3]{'others'},
      'lines' => $lexicon->{'r w d'}[3]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACiL',
      'suffix' => '',
      'glosses' => $lexicon->{'r w d'}[3]{'glosses'},
      'glosshash' => $lexicon->{'r w d'}[3]{'glosshash'},
      'orig' => 'rA}id',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'r w d'}[4]{'types'},
      'entry' => 'rA\'id',
      'form' => 'rA\'id',
      'lines' => $lexicon->{'r w d'}[4]{'lines'},
      'index' => '2',
      'entity' => 'noun',
      'morphs' => 'FACiL',
      'suffix' => '',
      'glosses' => $lexicon->{'r w d'}[4]{'glosses'},
      'glosshash' => $lexicon->{'r w d'}[4]{'glosshash'},
      'orig' => 'rA}id',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'r w d'}[5]{'types'},
      'entry' => 'rA\'id',
      'form' => 'rA\'id',
      'lines' => $lexicon->{'r w d'}[5]{'lines'},
      'index' => '3',
      'entity' => 'noun',
      'morphs' => 'FACiL',
      'suffix' => '',
      'glosses' => $lexicon->{'r w d'}[5]{'glosses'},
      'glosshash' => $lexicon->{'r w d'}[5]{'glosshash'},
      'orig' => 'rA}id',
      'prefix' => ''
    }
  ],
  ...
  'r .h b' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"welcoming [ [ taroHiybiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"welcoming [ [ taroHiybiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'taroHiybiy~',
      'prefix' => ''
    }
  ...
  'rahiyna' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"depending on [ [ rahiyna / PREP ] ]"'
        ]
      ],
      'glosshash' => {
        '"subject to"' => 1,
        '"depending on [ [ rahiyna / PREP ] ]"' => 1
      },
      'orig' => 'rahiyna',
      'prefix' => ''
    }
  ...
  'r h q' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"suppressed [ [ murohaq / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"suppressed [ [ murohaq / ADJ ] ]"' => 1,
        '"oppressed"' => 1,
        '"overburdened"' => 1
      },
      'orig' => 'murohaq',
  ...
  'r f h' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"amusement [ [ tarofiyhiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"entertainment"' => 1,
        '"recreation"' => 1,
        '"amusement [ [ tarofiyhiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'tarofiyhiy~',
      'prefix' => ''
    }
  ...
  'r q b' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"surveillance [ [ raqAbiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"censorship"' => 1,
        '"surveillance [ [ raqAbiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'raqAbiy~',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"anticipated [ [ murotaqab / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"anticipated [ [ murotaqab / ADJ ] ]"' => 1,
        '"expected"' => 1
      },
      'orig' => 'murotaqab',
      'prefix' => ''
  ...
  'r l m' => [
    {
      'types' => $lexicon->{'r l y'}[0]{'types'},
      'entry' => 'rAliy',
      'form' => 'rAliy',
      'lines' => $lexicon->{'r l y'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACI',
      'suffix' => '',
      'glosses' => $lexicon->{'r l y'}[0]{'glosses'},
      'glosshash' => $lexicon->{'r l y'}[0]{'glosshash'},
      'orig' => 'rAliy',
      'prefix' => ''
    },
    {
  ...
  'r d d' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"in answer to [ [ rad ~ / ADV ] ]"'
        ]
      ],
      'glosshash' => {
        '"in reply to"' => 1,
        '"in answer to [ [ rad ~ / ADV ] ]"' => 1
      },
      'orig' => 'rad~AF',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"profitability [ [ maroduwdiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"profitability [ [ maroduwdiy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'maroduwdiy~ap',
      'prefix' => ''
    },
    {
      ...
      'form' => 'raddY',
      'others' => [
        'radday PV_Atn IV_Ann_Pass_yu',
        'radd IV_0hwnyn_yu PV_ttAw',
        'raddA PV_h',
        'raddiy IV_0hAnn_yu'
      ],
      'lines' => [
  ...
  'r ` d' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"thunderous [ [ raEodiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"thunderous [ [ raEodiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'raEodiy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"trembling [ [ murotaEid / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"trembling [ [ murotaEid / ADJ ] ]"' => 1
      },
      'orig' => 'murotaEid',
      'prefix' => ''
    }
  ...
  'r \' .h' => [
    {
      'types' => $lexicon->{'r w .h'}[17]{'types'},
      'entry' => 'rA\'i.h',
      'form' => 'rA\'i.haT',
      'others' => $lexicon->{'r w .h'}[17]{'others'},
      'lines' => $lexicon->{'r w .h'}[17]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACiL',
      'suffix' => ' |< aT',
      'glosses' => $lexicon->{'r w .h'}[17]{'glosses'},
      'glosshash' => $lexicon->{'r w .h'}[17]{'glosshash'},
      'orig' => 'rA}iHap',
      'prefix' => ''
    }
  ],
  ...
  'r ` y' => [
    ...
    },
    {
      ...
      'others' => [
        'rA`iy IV_0hAnn_yu',
        'rA` IV_0hwnyn_yu PV_ttAw',
        'rA`ay PV_Atn IV_Ann_Pass_yu',
        'rA`A PV_h'
      ],
      'lines' => [
        ';; rAEaY_1',
  ...
  'r ^g w' => [
    ...
    {
      'types' => $lexicon->{'r ^g \''}[3]{'types'},
      'entry' => 'ra^gA\'',
      'form' => 'ra^gA\'',
      'lines' => $lexicon->{'r ^g \''}[3]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCA\'',
      'suffix' => '',
      'glosses' => $lexicon->{'r ^g \''}[3]{'glosses'},
      'glosshash' => $lexicon->{'r ^g \''}[3]{'glosshash'},
      'orig' => 'rajA\'',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'r ^g \''}[4]{'types'},
      'entry' => 'ra^gA\'',
      'form' => 'ra^gA\'',
      'lines' => $lexicon->{'r ^g \''}[4]{'lines'},
      'index' => '2',
      'entity' => 'noun',
      'morphs' => 'FaCA\'',
      'suffix' => '',
      'glosses' => $lexicon->{'r ^g \''}[4]{'glosses'},
      'glosshash' => $lexicon->{'r ^g \''}[4]{'glosshash'},
      'orig' => 'rajA\'',
      'prefix' => ''
    },
    {
  ...
  'r y `' => [
    {
      'types' => $lexicon->{'r w `'}[6]{'types'},
      'entry' => 'muriy`',
      'form' => 'muriy`',
      'lines' => $lexicon->{'r w `'}[6]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'MuFiCL',
      'suffix' => '',
      'glosses' => $lexicon->{'r w `'}[6]{'glosses'},
      'glosshash' => $lexicon->{'r w `'}[6]{'glosshash'},
      'orig' => 'muriyE',
      'prefix' => ''
    },
    {
  ...
  'r k z' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"central [ [ marokaziy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"central [ [ marokaziy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'marokaziy~',
      'prefix' => ''
    },
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"condensed [ [ murak ~ az / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"centralized"' => 1,
        '"concentrated"' => 1,
        '"condensed [ [ murak ~ az / ADJ ] ]"' => 1
      },
      'orig' => 'murak~az',
      'prefix' => ''
    },
  ...
  'ruwman.tiyq' => [
    {
      ...
      'glosses' => [
        [
          '"romantic [ [ ruwmanoTiyqiy ~ / ADJ ] ]"'
        ],
        [
          '"romanticism [ [ ruwmanoTiyqiy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"romanticism [ [ ruwmanoTiyqiy ~ / NOUN ] ]"' => 1,
        '"romantic [ [ ruwmanoTiyqiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'ruwmanoTiyqiy~',
      'prefix' => ''
    }
  ...
  'r b k' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"entangled [ [ murotabik / ADJ ] ]"'
        ],
        [
          '"embarrassed [ [ murotabik / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"entangled [ [ murotabik / ADJ ] ]"' => 1,
        '"embarrassed [ [ murotabik / ADJ ] ]"' => 1,
        '"involved"' => 1
      },
      'orig' => 'murotabik',
      'prefix' => ''
  ...
  'r .h n' => [
    {
      'types' => $lexicon->{'r w .h n'}[0]{'types'},
      'entry' => 'ruw.hAn',
      'form' => 'ruw.hAniyy',
      'lines' => $lexicon->{'r w .h n'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FUCAL',
      'suffix' => ' |< Iy',
      'glosses' => $lexicon->{'r w .h n'}[0]{'glosses'},
      'glosshash' => $lexicon->{'r w .h n'}[0]{'glosshash'},
      'orig' => 'ruwHAniy~',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'r w .h n'}[1]{'types'},
      'entry' => 'ruw.hAn',
      'form' => 'ruw.hAniyyaT',
      'lines' => $lexicon->{'r w .h n'}[1]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FUCAL',
      'suffix' => ' |< Iy |< aT',
      'glosses' => $lexicon->{'r w .h n'}[1]{'glosses'},
      'glosshash' => $lexicon->{'r w .h n'}[1]{'glosshash'},
      'orig' => 'ruwHAniy~ap',
      'prefix' => ''
    },
    {
  ...
  'r m .d' => [
    ...
    },
    {
      ...
      'glosses' => [
        [
          '"Ramadan-related [ [ ramaDAniy ~ / NOUN ] ]"'
        ],
        [
          '"Ramadan-related [ [ ramaDAniy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"Ramadan-related [ [ ramaDAniy ~ / ADJ ] ]"' => 1,
        '"Ramadan-related [ [ ramaDAniy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'ramaDAniy~',
      'prefix' => ''
    }
  ...
  'tarbaw' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"educational [ [ tarobawiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"pedagogical"' => 1,
        '"educational [ [ tarobawiy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'tarobawiy~',
      'prefix' => ''
    }
  ...
  'r .d y' => [
    ...
    {
      'types' => $lexicon->{'r .d \''}[0]{'types'},
      'entry' => 'ri.dA\'',
      'form' => 'ri.dA\'',
      'lines' => $lexicon->{'r .d \''}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FiCA\'',
      'suffix' => '',
      'glosses' => $lexicon->{'r .d \''}[0]{'glosses'},
      'glosshash' => $lexicon->{'r .d \''}[0]{'glosshash'},
      'orig' => 'riDA\'',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'r .d \''}[1]{'types'},
      'entry' => '\'ir.dA\'',
      'form' => '\'ir.dA\'',
      'lines' => $lexicon->{'r .d \''}[1]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'HiFCA\'',
      'suffix' => '',
      'glosses' => $lexicon->{'r .d \''}[1]{'glosses'},
      'glosshash' => $lexicon->{'r .d \''}[1]{'glosshash'},
      'orig' => 'IiroDA\'',
      'prefix' => ''
    },
    {
  ...
  'ra\'smAl' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"capitalist [ [ ra>osmAliy ~ / ADJ ] ]"'
        ],
        [
          '"capitalist [ [ rAsomAliy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"capitalist [ [ rAsomAliy ~ / ADJ ] ]"' => 1,
        '"capital"' => 1,
        '"capitalist [ [ ra>osmAliy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'raOosmAliy~',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        [
          '"capitalism [ [ ra>osmAliy ~ / NOUN ] ]"'
        ],
        [
          '"capitalism [ [ rAsomAliy ~ / NOUN ] ]"'
        ]
      ],
      'glosshash' => {
        '"capitalism [ [ ra>osmAliy ~ / NOUN ] ]"' => 1,
        '"capitalism [ [ rAsomAliy ~ / NOUN ] ]"' => 1
      },
      'orig' => 'raOosmAliy~ap',
      'prefix' => ''
    }
  ...
  'r w b' => [
    ...
    {
      'types' => $lexicon->{'r w b'}[0]{'types'},
      'entry' => 'ruwb',
      'form' => 'ruwbiyyaT',
      'lines' => $lexicon->{'r w b'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FuCL',
      'suffix' => ' |< Iy |< aT',
      'glosses' => $lexicon->{'r w b'}[0]{'glosses'},
      'glosshash' => $lexicon->{'r w b'}[0]{'glosshash'},
      'orig' => 'ruwbiy~ap',
      'prefix' => ''
    }
  ],
  ...
  'rubbamA' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"maybe [ [ la / EMPHATIC_PARTICLE+rub ~ amA / ADV ] ]"'
        ]
      ],
      'glosshash' => {
        '"maybe [ [ rub ~ amA / ADV ] ]"' => 1,
        '"perhaps"' => 1,
        '"maybe [ [ la / EMPHATIC_PARTICLE+rub ~ amA / ADV ] ]"' => 1
      },
      'orig' => 'rub~amA',
      'prefix' => ''
    }
  ...
  'r s ' => [
    {
      'types' => $lexicon->{'r s y'}[0]{'types'},
      'entry' => 'rAsiy',
      'form' => 'rAsiy',
      'others' => $lexicon->{'r s y'}[0]{'others'},
      'lines' => $lexicon->{'r s y'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACI',
      'suffix' => '',
      'glosses' => $lexicon->{'r s y'}[0]{'glosses'},
      'glosshash' => $lexicon->{'r s y'}[0]{'glosshash'},
      'orig' => 'rAsiy',
      'prefix' => ''
    },
    {
  ...
  'r \' \'' => [
    {
      'types' => $lexicon->{'r \' y'}[6]{'types'},
      'entry' => 'ri\'A\'',
      'form' => 'ri\'A\'',
      'others' => $lexicon->{'r \' y'}[6]{'others'},
      'lines' => $lexicon->{'r \' y'}[6]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FiCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'r \' y'}[6]{'glosses'},
      'glosshash' => $lexicon->{'r \' y'}[6]{'glosshash'},
      'orig' => 'ri}A\'',
      'prefix' => ''
    }
  ],
  ...
  'r m q' => [
    {
      ...
      'glosshash' => {
        '"last sign of life"' => 1,
        '"last breaths of life"' => 1,
        '"last signs of life"' => 1,
        '"last breath of life"' => 1
      },
      'orig' => 'ramaq',
      'prefix' => ''
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"notable [ [ maromuwq / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"highly-regarded"' => 1,
        '"notable [ [ maromuwq / ADJ ] ]"' => 1,
        '"distinguished"' => 1
      },
      'orig' => 'maromuwq',
      'prefix' => ''
  ...
  'r b b' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"rabab ( lute-like instrument played with a bow )"'
        ]
      ],
      'glosshash' => {
        '"rebec"' => 1,
        '"rabab ( lute-like instrument played with a bow )"' => 1
      },
      'orig' => 'rabAb',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'r b n'}[0]{'types'},
      'entry' => 'rabbAn',
      'form' => 'rabbAniyy',
      'lines' => $lexicon->{'r b n'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCLAn',
      'suffix' => ' |< Iy',
      'glosses' => $lexicon->{'r b n'}[0]{'glosses'},
      'glosshash' => $lexicon->{'r b n'}[0]{'glosshash'},
      'orig' => 'rab~Aniy~',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'r b w'}[0]{'types'},
      'entry' => 'rabbY',
      'form' => 'rabbY',
      'others' => $lexicon->{'r b w'}[0]{'others'},
      'lines' => $lexicon->{'r b w'}[0]{'lines'},
      'index' => '1',
      'entity' => 'verb',
      'morphs' => 'FaCLY',
      'suffix' => '',
      'glosses' => $lexicon->{'r b w'}[0]{'glosses'},
      'glosshash' => $lexicon->{'r b w'}[0]{'glosshash'},
      'orig' => 'rab~aY',
      'prefix' => ''
    }
  ],
  'rAdiykAl' => [
    {
      ...
      'glosses' => [
        [
          '"radical [ [ rAdiykAliy ~ / ADJ ] ]"'
        ],
        [
          '"radical [ [ rAdikAliy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"radical [ [ rAdikAliy ~ / ADJ ] ]"' => 1,
        '"radical [ [ rAdiykAliy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'rAdiykAliy~',
      'prefix' => ''
    }
  ...
  'r d \'' => [
    ...
    {
      'types' => $lexicon->{'r d b'}[0]{'types'},
      'entry' => 'radA\'',
      'form' => 'radA\'aT',
      'lines' => $lexicon->{'r d b'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCAL',
      'suffix' => ' |< aT',
      'glosses' => $lexicon->{'r d b'}[0]{'glosses'},
      'glosshash' => $lexicon->{'r d b'}[0]{'glosshash'},
      'orig' => 'radA\'ap',
      'prefix' => ''
    }
  ],
  'r w t n' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"bureaucratic [ [ ruwtiyniy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"routine"' => 1,
        '"bureaucratic [ [ ruwtiyniy ~ / ADJ ] ]"' => 1
      },
      'orig' => 'ruwtiyniy~',
      'prefix' => ''
    }
  ...
  'r \' `' => [
    {
      'types' => $lexicon->{'r w `'}[4]{'types'},
      'entry' => 'rA\'i`',
      'form' => 'rA\'i`',
      'lines' => $lexicon->{'r w `'}[4]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACiL',
      'suffix' => '',
      'glosses' => $lexicon->{'r w `'}[4]{'glosses'},
      'glosshash' => $lexicon->{'r w `'}[4]{'glosshash'},
      'orig' => 'rA}iE',
      'prefix' => ''
    }
  ],
  ...
  'r w m n' => [
    {
      'types' => $lexicon->{'r m n'}[0]{'types'},
      'entry' => 'ruwmAn',
      'form' => 'ruwmAniyy',
      'lines' => $lexicon->{'r m n'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'KuRDAS',
      'suffix' => ' |< Iy',
      'glosses' => $lexicon->{'r m n'}[0]{'glosses'},
      'glosshash' => $lexicon->{'r m n'}[0]{'glosshash'},
      'orig' => 'ruwmAniy~',
      'prefix' => ''
    }
  ],
  ...
  'r _h m' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"melodious [ [ raxiym / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"melodious [ [ raxiym / ADJ ] ]"' => 1,
        '"mellow"' => 1
      },
      'orig' => 'raxiym',
      'prefix' => ''
  ...
  'r k m' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"amassed [ [ mutarAkim / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"accumulated"' => 1,
        '"gathered"' => 1,
        '"amassed [ [ mutarAkim / ADJ ] ]"' => 1
      },
      'orig' => 'mutarAkim',
      'prefix' => ''
    }
  ...
  'r y .h n' => [
    {
      'types' => $lexicon->{'r y .h'}[1]{'types'},
      'entry' => 'ray.hAn',
      'form' => 'ray.hAn',
      'others' => $lexicon->{'r y .h'}[1]{'others'},
      'lines' => $lexicon->{'r y .h'}[1]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'KaRDAS',
      'suffix' => '',
      'glosses' => $lexicon->{'r y .h'}[1]{'glosses'},
      'glosshash' => $lexicon->{'r y .h'}[1]{'glosshash'},
      'orig' => 'rayoHAn',
      'prefix' => ''
    },
    {
      'types' => $lexicon->{'r .h n'}[2]{'types'},
      'entry' => 'riy.hAn',
      'form' => 'riy.hAniyy',
      'lines' => $lexicon->{'r .h n'}[2]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'KiRDAS',
      'suffix' => ' |< Iy',
      'glosses' => $lexicon->{'r .h n'}[2]{'glosses'},
      'glosshash' => $lexicon->{'r .h n'}[2]{'glosshash'},
      'orig' => 'riyoHAniy~',
      'prefix' => ''
    }
  ],
  'r w ^g' => [
    ...
    {
      'types' => $lexicon->{'r \' ^g'}[0]{'types'},
      'entry' => 'rA\'i^g',
      'form' => 'rA\'i^g',
      'lines' => $lexicon->{'r \' ^g'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FA\'iL',
      'suffix' => '',
      'glosses' => $lexicon->{'r \' ^g'}[0]{'glosses'},
      'glosshash' => $lexicon->{'r \' ^g'}[0]{'glosshash'},
      'orig' => 'rA}ij',
      'prefix' => ''
    },
    {
  ...
  'r d y' => [
    {
      'types' => $lexicon->{'r d d'}[12]{'types'},
      'entry' => 'raddY',
      'form' => 'raddY',
      'others' => $lexicon->{'r d d'}[12]{'others'},
      'lines' => $lexicon->{'r d d'}[12]{'lines'},
      'index' => '1',
      'entity' => 'verb',
      'morphs' => 'FaCCY',
      'suffix' => '',
      'glosses' => $lexicon->{'r d d'}[12]{'glosses'},
      'glosshash' => $lexicon->{'r d d'}[12]{'glosshash'},
      'orig' => 'rad~aY',
      'prefix' => ''
    },
    {
    ...
    },
    {
      ...
      'form' => 'taraddY',
      'others' => [
        'taradd IV_0hwnyn PV_ttAw',
        'taradday PV_Atn IV_Ann'
      ],
      'lines' => [
        ';; tarad~aY_1',
  ...
  'r h n' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"mortgaged [ [ marohuwn / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"pawned"' => 1,
        '"pledged"' => 1,
        '"mortgaged [ [ marohuwn / ADJ ] ]"' => 1
      },
      'orig' => 'marohuwn',
      'prefix' => ''
    },
  ...
  'mar`' => [
    {
      ...
      'glosses' => [
        ...
        [
          '"complied with [ [ maroEiy ~ / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"complied with [ [ maroEiy ~ / ADJ ] ]"' => 1,
        '"observed"' => 1
      },
      'orig' => 'maroEiy~',
      'prefix' => ''
  ...
  'r y l' => [
    {
      'types' => $lexicon->{'r w y l'}[0]{'types'},
      'entry' => 'ruwyAl',
      'form' => 'ruwyAl',
      'lines' => $lexicon->{'r w y l'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FUCAL',
      'suffix' => '',
      'glosses' => $lexicon->{'r w y l'}[0]{'glosses'},
      'glosshash' => $lexicon->{'r w y l'}[0]{'glosshash'},
      'orig' => 'ruwyAl',
      'prefix' => ''
    },
    {
      ...
      'glosshash' => {
        '"riyal ( S.Ar.=100 halala , Qatar=100 dirham , Yemen=100 fils )"' => 1,
        '"riyal ( Egy . : 20 piasters )"' => 1
      },
      'orig' => 'riyAl',
      'prefix' => ''
    }
  ...
  'r t b' => [
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"regulated [ [ murat ~ ab / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"organized"' => 1,
        '"regulated [ [ murat ~ ab / ADJ ] ]"' => 1,
        '"arranged"' => 1
      },
      'orig' => 'murat~ab',
      'prefix' => ''
    ...
    },
    {
      ...
      'glosses' => [
        ...
        [
          '"regulated [ [ mutarat ~ ib / ADJ ] ]"'
        ]
      ],
      'glosshash' => {
        '"organized"' => 1,
        '"regulated [ [ mutarat ~ ib / ADJ ] ]"' => 1,
        '"arranged"' => 1
      },
      'orig' => 'mutarat~ib',
      'prefix' => ''
  ...
  'r y y' => [
    ...
    {
      'types' => $lexicon->{'r y n'}[0]{'types'},
      'entry' => 'rayyAn',
      'form' => 'rayyAn',
      'lines' => $lexicon->{'r y n'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FaCLAn',
      'suffix' => '',
      'glosses' => $lexicon->{'r y n'}[0]{'glosses'},
      'glosshash' => $lexicon->{'r y n'}[0]{'glosshash'},
      'orig' => 'ray~An',
      'prefix' => ''
    }
  ]
