...
lexicon = listing "Lexicon properties"
 ...
 |> "'a^st" <| [
    ...
    noun     Identity |< At            {- Oa$otAt -}        `gloss`  [ "varieties", "dispersed", "scattered" ] ]
 ...
 |> "'i^sAr^g" <| [
    ...
    noun     Identity |< Iy            {- Ii$Arojiy~ -}     `gloss`  [ "signalman", "signalmen" ] ]
 ...
 |> "'i^sbiyn" <| [
    ...
    noun     Identity                  {- Ii$obiyn -}       -- `others` [ "'a^sAbiyn Ndip" ]
    ...
    noun     Identity |< aT            {- Ii$obiynap -}     `gloss`  [ "godmother", "bridesmaid" ] ]
 ...
 |> "^s ' .z" <| [
    ...
    noun     FACiL                     {- $A}iZ -}          `gloss`  [ "red hot", "ablaze [ [ $ A } iZ / ADJ ] ]" ] ]
 ...
 |> "^s ' b" <| [
    ...
    noun     FACiL                     {- $A}ib -}          `gloss`  [ "gray-haired", "old [ [ $ A } ib / ADJ ] ]" ] ]
 ...
 |> "^s ' h" <| [
    ...
    noun     FACiL                     {- $A}ih -}          `gloss`  [ "distorted [ [ $ A } ih / ADJ ] ]" ] ]
 ...
 |> "^s ' m" <| [
    ...
    verb     IstaFCaL                  {- {isota$oOam -}    -- `others` [ "sta^s'im IV" ]
                                                            `gloss`  [ "regard as an evil omen" ],

    -- ;; $u&om_1
    -- $&m     $u&om   N       calamity;evil omen

    noun     FuCL                      {- $uWom -}          `gloss`  [ "calamity", "evil omen" ],
    ...
    noun     HaFCaL                    {- Oa$oOam -}        -- `others` [ "^su'mY N0", "^su'may NAt NAn_Nayn" ]
                                                            `gloss`  [ "sinister", "calamitous [ [ >a $ o>am / ADJ ] ]", "calamitous" ],
    ...
    noun     MaFCUL                    {- ma$oWuwm -}       -- `others` [ "ma^sA'iym Ndip", "ma^suwm N/ap" ]
                                                            `gloss`  [ "inauspicious", "accursed [ [ ma $ o&uwm / ADJ ] ]", "accursed" ],
 ...
 |> "^s ' q" <| [
    ...
    noun     FACiL                     {- $A}iq -}          `gloss`  [ "exciting", "interesting [ [ $ A } iq / ADJ ] ]" ] ]
 ...
 |> "^s ' w" <| [
    ...
    verb     FaCaL                     {- $aOaw-u -}        `imperf` [ FCuL ]
                                                            -- `others` [ "^s'uw IV_0hAnn", "^s'Y IV_0_Pass_yu", "^s' IV_0hwnyn IV_wn" ]
                                                            `gloss`  [ "outrace", "overtake", "be outraced", "be overtaken" ],

    -- ;; $a>ow_1
    -- $>w     $a>ow   N       summit;goal

    noun     FaCL                      {- $aOow -}          `gloss`  [ "summit", "goal" ] ]
 ...
 |> "^s .g b" <| [
    ...
    noun     MuFACaL |< aT             {- mu$Agabap -}      -- `others` [ "ma^sA.gib Ndip" ]
 ...
 |> "^s .g f" <| [
    ...
    verb     FaCaL                     {- $agaf-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "^su.gif PV_Pass", "^s.gaf IV IV_Pass_yu" ]
    ...
    noun     FaCaL |< Iy               {- $agafiy~ -}       `gloss`  [ "interesting [ [ $ agafiy ~ / ADJ ] ]" ],

    -- ;; $agif_1
    -- $gf     $agif   Nall    passionate;zealous;infatuated     [[$agif/ADJ]]

    noun     FaCiL                     {- $agif -}          `gloss`  [ "passionate", "zealous", "infatuated [ [ $ agif / ADJ ] ]" ],
    ...
    noun     FaCUL                     {- $aguwf -}         `gloss`  [ "enamored", "fascinated", "infatuated [ [ $ aguwf / ADJ ] ]" ],

    -- ;; ma$oguwf_1
    -- m$gwf   ma$oguwf        Nall    fond of;enamored;infatuated     [[ma$oguwf/ADJ]]

    noun     MaFCUL                    {- ma$oguwf -}       `gloss`  [ "fond of", "enamored", "infatuated [ [ ma $ oguwf / ADJ ] ]" ] ]
 ...
 |> "^s .g l" <| [
    ...
    noun     FaCCAL                    {- $ag~Al -}         `gloss`  [ "laborer", "worker [ [ $ ag ~ Al / NOUN ] ]" ],

    -- ;; $ag~Al_2
    -- $gAl    $ag~Al  Nall    busy;occupied     [[$ag~Al/ADJ]]

    noun     FaCCAL                    {- $ag~Al -}         `gloss`  [ "busy", "occupied [ [ $ ag ~ Al / ADJ ] ]" ],
    ...
    noun     FACUL                     {- $Aguwl -}         `gloss`  [ "mainsheet" ],
    ...
    noun     MaFCaL |< aT              {- ma$ogalap -}      `gloss`  [ "work", "activity", "occupation" ],
    ...
    noun     TaFCIL |< Iy              {- ta$ogiyliy~ -}    `gloss`  [ "operational [ [ ta $ ogiyliy ~ / ADJ ] ]", "employment", "hiring [ [ ta $ ogiyliy ~ / ADJ ] ]" ],
    ...
    noun     FACiL                     {- $Agil -}          `gloss`  [ "working", "functioning [ [ $ Agil / ADJ ] ]" ],
    ...
    noun     MaFCUL |< Iy |< aT        {- ma$oguwliy~ap -}  `gloss`  [ "anxiety", "apprehension [ [ ma $ oguwliy ~ / NOUN ] ]" ],
    ...
    noun     MuFtaCiL                  {- mu$otagil -}      `gloss`  [ "busy", "occupied [ [ mu $ otagil / ADJ ] ]", "functioning", "in operation [ [ mu $ otagil / ADJ ] ]" ],
 ...
 |> "^s .h .h" <| [
    ...
    verb     FaCL                      {- $aH~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "^s.hi.h IV_C_intr", "^si.h.h IV_V_intr", "^sa.ha.h PV_C_intr", "^s.hu.h IV_C_intr", "^su.h.h IV_V_intr" ]
    ...
    verb     FACL                      {- $AH~ -}           -- `others` [ "^sA.hi.h IV_C_yu", "^sA.ha.h PV_C" ]
                                                            `gloss`  [ "withhold", "be stingy" ],

    -- ;; $uH~_1
    -- $H      $uH~    N       avarice;greed;paucity

    noun     FuCL                      {- $uH~ -}           `gloss`  [ "avarice", "greed", "paucity" ],
 ...
 |> "^s .h .t" <| [
    ...
    noun     FaCL |< aT                {- $aHoTap -}        -- `others` [ "^sa.ha.t NAt" ]
                                                            `gloss`  [ "stripe", "braid", "stripes", "braids" ],

    -- ;; $aH~ATap_1
    -- $HAT    $aH~AT  NapAt   match;lighter

    noun     FaCCAL |< aT              {- $aH~ATap -}       `gloss`  [ "match", "lighter" ],

    -- ;; $AHiT_1
    -- $AHT    $AHiT   N/ap    remote;distant;stranded     [[$AHiT/ADJ]]

    noun     FACiL                     {- $AHiT -}          `gloss`  [ "remote", "distant", "stranded [ [ $ AHiT / ADJ ] ]" ] ]
 ...
 |> "^s .h b" <| [
    ...
    verb     FaCaL                     {- $aHab-ua -}       `imperf` [ FCuL, FCaL ]
                                                            -- `others` [ "^s.hub IV_intr", "^s.hab IV_intr" ]
                                                            `gloss`  [ "become pale", "be haggard" ],

    -- ;; $uHuwbap_1
    -- $Hwb    $uHuwb  Nap     becoming pale;being haggard

    noun     FuCUL |< aT               {- $uHuwbap -}       `gloss`  [ "becoming pale", "being haggard" ],
 ...
 |> "^s .h m" <| [
    ...
    noun     FaCAL |< aT               {- $aHAmap -}        `gloss`  [ "fattening" ],
    ...
    noun     FaCL |< aT                {- $aHomap -}        `gloss`  [ "lump" ],

    -- ;; $aHomiy~_1
    -- $Hmy    $aHomiy~        N/ap    fatty;sebaceous     [[$aHomiy~/ADJ]]

    noun     FaCL |< Iy                {- $aHomiy~ -}       `gloss`  [ "fatty", "sebaceous [ [ $ aHomiy ~ / ADJ ] ]" ],

    -- ;; $aHim_1
    -- $Hm     $aHim   N-ap    pulpy     [[$aHim/ADJ]]

    noun     FaCiL                     {- $aHim -}          `gloss`  [ "pulpy [ [ $ aHim / ADJ ] ]" ],

    -- ;; $aHiym_1
    -- $Hym    $aHiym  N-ap    fatty     [[$aHiym/ADJ]]

    noun     FaCIL                     {- $aHiym -}         `gloss`  [ "fatty [ [ $ aHiym / ADJ ] ]" ],

    -- ;; mi$oHamap_1
    -- m$Hm    mi$oHam Nap     grease box (wheel)
    -- m$AHm   ma$AHim Ndip    grease boxes (wheels)

    noun     MiFCaL |< aT              {- mi$oHamap -}      -- `others` [ "ma^sA.him Ndip" ]
    ...
    noun     MuFaCCaL                  {- mu$aH~am -}       `gloss`  [ "fat", "greasy [ [ mu $ aH ~ am / ADJ ] ]" ],

    -- ;; mu$oHim_1
    -- m$Hm    mu$oHim N-ap    mushy;pulpy     [[mu$oHim/ADJ]]

    noun     MuFCiL                    {- mu$oHim -}        `gloss`  [ "mushy", "pulpy [ [ mu $ oHim / ADJ ] ]" ] ]
 ...
 |> "^s .h n" <| [
    ...
    verb     HaFCaL                    {- Oa$oHan -}        -- `others` [ "^s.hin IV-n_yu", "^s.han IV-n_Pass_yu" ]
    ...
    noun     FACiL                     {- $AHin -}          `gloss`  [ "loaded", "freighted [ [ $ AHin / ADJ ] ]" ],
    ...
    noun     MaFCUL                    {- ma$oHuwn -}       `gloss`  [ "loaded", "freighted [ [ ma $ oHuwn / ADJ ] ]", "cargo", "freight" ],
 ...
 |> "^s .h n '" <| [
    ...
    noun     KaRDAS                    {- $aHonA' -}        `gloss`  [ "rancor", "enmity" ] ]
 ...
 |> "^s .h r" <| [
    ...
    noun     MaFCaL |< Iy |< aT        {- ma$oHariy~ap -}   -- `others` [ "ma^s.hariyy NAt" ]
                                                            `gloss`  [ "charcoal burner", "charcoal burners" ],

    -- ;; mu$aH~ar_1
    -- m$Hr    mu$aH~ar        N/ap    sooty     [[mu$aH~ar/ADJ]]

    noun     MuFaCCaL                  {- mu$aH~ar -}       `gloss`  [ "sooty [ [ mu $ aH ~ ar / ADJ ] ]" ] ]
 ...
 |> "^s .h w r" <| [
    ...
    noun     KaRDaS |< aT              {- $aHowarap -}      `gloss`  [ "blackening ( with soot )" ],
 ...
 |> "^s .s .s" <| [
    ...
    noun     FiCL                      {- $iS~ -}           -- `others` [ "^su.suw.s N" ]
 ...
 |> "^s .s r" <| [
    ...
    noun     FaCaL |< aT               {- $aSarap -}        `gloss`  [ "gazelle" ] ]
 ...
 |> "^s .t .h" <| [
    ...
    noun     FaCL |< aT                {- $aToHap -}        -- `others` [ "^sa.ta.h NAt" ]
 ...
 |> "^s .t .t" <| [
    ...
    verb     FaCL                      {- $aT~-iu -}        `imperf` [ FCiL, FCuL ]
                                                            -- `others` [ "^su.t.t IV_V_intr", "^s.ti.t IV_C_intr", "^si.t.t IV_V_intr", "^sa.ta.t PV_C_intr", "^s.tu.t IV_C_intr" ]
    ...
    verb     IFtaCL                    {- {i$otaT~ -}       -- `others` [ "^sta.ti.t IV_C_intr", "i^sta.ta.t PV_C_intr", "^sta.t.t IV_V_intr" ]
                                                            `gloss`  [ "be excessive", "go too far" ],
    ...
    noun     FaCL                      {- $aT~ -}           -- `others` [ "^su.tuw.t N" ]
                                                            `gloss`  [ "shore", "bank", "shores", "banks" ],

    -- ;; $aT~iy~_1
    -- $Ty     $aT~iy~ N-ap    littoral     [[$aT~iy~/ADJ]]

    noun     FaCL |< Iy                {- $aT~iy~ -}        `gloss`  [ "littoral [ [ $ aT ~ iy ~ / ADJ ] ]" ],

    -- ;; $aT~ap_1
    -- $T      $aT~    Nap     hot pepper

    noun     FaCL |< aT                {- $aT~ap -}         `gloss`  [ "hot pepper" ],
    ...
    noun     FaCIL |< aT               {- $aTiyTap -}       `gloss`  [ "hot pepper" ],
 ...
 |> "^s .t f" <| [
    ...
    noun     FuCL |< aT                {- $uTofap -}        -- `others` [ "^su.taf N" ]
 ...
 |> "^s .t r" <| [
    ...
    noun     FiCL |< aT                {- $iTorap -}        `gloss`  [ "side", "half" ],

    -- ;; $aTArap_1
    -- $TAr    $aTAr   Nap     cleverness

    noun     FaCAL |< aT               {- $aTArap -}        `gloss`  [ "cleverness" ],

    -- ;; $aTiyrap_1
    -- $Tyr    $aTiyr  Napdu   sandwich
    -- $TA}r   $aTA}ir Ndip    sandwiches

    noun     FaCIL |< aT               {- $aTiyrap -}       -- `others` [ "^sa.tA'ir Ndip" ]
                                                            `gloss`  [ "sandwich", "sandwiches" ],

    -- ;; mu$ATarap_1
    -- m$ATr   mu$ATar NapAt   participation;sharing

    noun     MuFACaL |< aT             {- mu$ATarap -}      `gloss`  [ "participation", "sharing" ],
    ...
    noun     FACiL                     {- $ATir -}          -- `others` [ "^su.t.tAr N" ]
                                                            `gloss`  [ "clever", "smart", "cute [ [ $ ATir / ADJ ] ]", "cute" ] ]
 ...
 |> "^s .z f" <| [
    ...
    noun     FaCiL                     {- $aZif -}          `gloss`  [ "austere", "harsh [ [ $ aZif / ADJ ] ]" ] ]
 ...
 |> "^s .z y" <| [
    ...
    verb     FaCiL                     {- $aZiy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "^s.za IV_0hwnyn", "^s.zay IV_Ann", "^s.zY IV_0", "^sa.z PV_w_intr" ]
 ...
 |> "^s ^g ^g" <| [
    ...
    verb     FaCL                      {- $aj~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "^s^gi^g IV_C", "^s^gu^g IV_C", "^si^g^g IV_V", "^su^g^g IV_V", "^sa^ga^g PV_C" ]
                                                            `gloss`  [ "fracture" ],
    ...
    noun     FaCL |< aT                {- $aj~ap -}         -- `others` [ "^si^gA^g N" ]
    ...
    verb     FaCLY                     {- $aj~aY -}         -- `others` [ "^sa^g^g IV_0hwnyn_yu PV_ttAw", "^sa^g^gay PV_Atn IV_Ann_Pass_yu", "^sa^g^gA PV_h", "^sa^g^giy IV_0hAnn_yu" ]
 ...
 |> "^s ^g `" <| [
    ...
    noun     FaCIL                     {- $ajiyE -}         -- `others` [ "^su^ga`A' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "brave [ [ $ ajiyE / ADJ ] ]", "brave" ],

    -- ;; $ajiyEap_1
    -- $jyE    $ajiyE  Napdu   brave     [[$ajiyE/ADJ]]
    -- $jA}E   $ajA}iE Ndip    brave

    noun     FaCIL |< aT               {- $ajiyEap -}       -- `others` [ "^sa^gA'i` Ndip" ]
                                                            `gloss`  [ "brave [ [ $ ajiyE / ADJ ] ]", "brave" ],
    ...
    noun     HaFCaL                    {- Oa$ojaE -}        -- `others` [ "^sa^g`A' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "courageous [ [ >a $ ojaE / ADJ ] ]", "courageous" ],
 ...
 |> "^s ^g b" <| [
    ...
    verb     HaFCaL                    {- Oa$ojab -}        -- `others` [ "^s^gab IV_Pass_yu", "^s^gib IV_yu" ]
 ...
 |> "^s ^g n" <| [
    ...
    verb     HaFCaL                    {- Oa$ojan -}        -- `others` [ "^s^gin IV-n_yu", "^s^gan IV-n_Pass_yu" ]
 ...
 |> "^s ^g r" <| [
    ...
    noun     FaCiL                     {- $ajir -}          `gloss`  [ "wooded [ [ $ ajir / ADJ ] ]" ],
    ...
    noun     FuCayL |< aT              {- $ujayorap -}      -- `others` [ "^su^gayr NAt" ]
                                                            `gloss`  [ "shrub", "shrubs" ],
    ...
    noun     HaFCaL                    {- Oa$ojar -}        -- `others` [ "^sa^grA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "wooded [ [ >a $ ojar / ADJ ] ]", "wooded" ],
    ...
    noun     MuFACaL |< aT             {- mu$Ajarap -}      `gloss`  [ "quarrel", "dispute", "melee" ],

    -- ;; mu$ojir_1
    -- m$jr    mu$ojir N-ap    wooded;forested     [[mu$ojir/ADJ]]

    noun     MuFCiL                    {- mu$ojir -}        `gloss`  [ "wooded", "forested [ [ mu $ ojir / ADJ ] ]" ],
 ...
 |> "^s ^g w" <| [
    ...
    verb     FaCA                      {- $ajA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "^s^gY IV_0_Pass_yu", "^s^gay IV_Ann_Pass_yu", "^s^guw IV_0hAnn", "^sa^g PV_ttAw", "^s^g IV_0hwnyn", "^sa^gaw PV_Atn" ]
                                                            `gloss`  [ "sadden", "distress", "be saddened", "be distressed" ],
    ...
    verb     HaFCY                     {- Oa$ojaY -}        -- `others` [ "^s^gY IV_0_Pass_yu", "'a^s^gA PV_h", "^s^g IV_0hwnyn_yu", "^s^gay IV_Ann_Pass_yu", "'a^s^gay PV_Atn", "'a^s^g PV_ttAw", "^s^giy IV_0hAnn_yu" ]
    ...
    noun     FaCL                      {- $ajow -}          `gloss`  [ "grief", "anxiety", "distress" ],

    -- ;; $ajawiy~_1
    -- $jwy    $ajawiy~        N/ap    worried;distressed     [[$ajawiy~/ADJ]]

    noun     FaCY |< Iy                {- $ajawiy~ -}       `gloss`  [ "worried", "distressed [ [ $ ajawiy ~ / ADJ ] ]" ],
    ...
    noun     MuFaCCI                   {- mu$aj~iy -}       -- `others` [ "mu^sa^g^g Nuwn_Niyn NK" ]
                                                            `gloss`  [ "touching", "pathetic [ [ mu $ aj ~ iy / ADJ ] ]", "pathetic" ] ]
 ...
 |> "^s ^g y" <| [
    ...
    verb     FaCiL                     {- $ajiy-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "^s^gY IV_0", "^s^gay IV_Ann", "^sa^g PV_w_intr", "^s^ga IV_0hwnyn" ]
    ...
    noun     FaCiL                     {- $ajiy -}          -- `others` [ "^sa^g NK" ]
                                                            `gloss`  [ "worried", "grieved [ [ $ ajiy / ADJ ] ]", "grieved" ],

    -- ;; $ajiy~_1
    -- $jy     $ajiy~  N/ap    worried;grieved;sentimental     [[$ajiy~/ADJ]]

    noun     FaCIL                     {- $ajiy~ -}         `gloss`  [ "worried", "grieved", "sentimental [ [ $ ajiy ~ / ADJ ] ]" ],
    ...
    noun     MuFaCCiL                  {- mu$aj~iy -}       -- `others` [ "mu^sa^g^g Nuwn_Niyn NK" ]
                                                            `gloss`  [ "touching", "pathetic [ [ mu $ aj ~ iy / ADJ ] ]", "pathetic" ] ]
 ...
 |> "^s ^s ^g" <| [
    ...
    noun     CaL |< aN                 {- $ajAF -}          `gloss`  [ "sadness", "distress", "anxiety [ [ $ ajAF / NOUN ] ]" ] ]
 ...
 |> "^s ^s _d" <| [
    ...
    noun     CaL |< aN                 {- $a*AF -}          -- `others` [ "^sa_dY N0", "^sa_dA N0_Nhy" ]
                                                            `gloss`  [ "perfume", "aroma", "fragrance", "bouquet [ [ $ a*AF / NOUN ] ]", "bouquet" ] ]
 ...
 |> "^s ^s m" <| [
    ...
    noun     CaL |< At |< aT           {- $amAtap -}        `gloss`  [ "gloating", "malicious joy" ] ]
 ...
 |> "^s ^s q" <| [
    ...
    noun     CaL |< aN                 {- $aqAF -}          -- `others` [ "^saqA N0_Nhy" ]
                                                            `gloss`  [ "hardship", "distress", "suffering", "misery [ [ $ aqAF / NOUN ] ]", "misery" ] ]
 ...
 |> "^s _d r" <| [
    ...
    noun     FaCL |< aT                {- $a*orap -}        -- `others` [ "^sa_dar NAt", "^su_duwr N" ]
 ...
 |> "^s _d w" <| [
    ...
    noun     FaCL                      {- $a*ow -}          `gloss`  [ "fragrance of musk" ] ]
 ...
 |> "^s _d y" <| [
    ...
    noun     FaCIL                     {- $a*iy~ -}         `gloss`  [ "fragrant", "aromatic [ [ $ a*iy ~ / ADJ ] ]" ] ]
 ...
 |> "^s _h .s" <| [
    ...
    verb     HaFCaL                    {- Oa$oxaS -}        -- `others` [ "^s_hi.s IV_yu", "^s_ha.s IV_Pass_yu" ]
    ...
    noun     TaFCIL |< Iy              {- ta$oxiySiy~ -}    `gloss`  [ "diagnostic [ [ ta $ oxiySiy ~ / ADJ ] ]" ],

    -- ;; $AxiS_1
    -- $AxS    $AxiS   N-ap    fixed;looming     [[$AxiS/ADJ]]

    noun     FACiL                     {- $AxiS -}          `gloss`  [ "fixed", "looming [ [ $ AxiS / ADJ ] ]" ],

    -- ;; $axiyS_1
    -- $xyS    $axiyS  N/ap    important;voluminous;dominant     [[$axiyS/ADJ]]

    noun     FaCIL                     {- $axiyS -}         `gloss`  [ "important", "voluminous", "dominant [ [ $ axiyS / ADJ ] ]" ],
 ...
 |> "^s _h ^s _h" <| [
    ...
    noun     KaRDaS |< aT              {- $axo$axap -}      `gloss`  [ "rattle", "rustle" ],
 ...
 |> "^s _h _h" <| [
    ...
    verb     FaCL                      {- $ax~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "^sa_ha_h PV_C", "^s_hu_h IV_C", "^su_h_h IV_V" ]
                                                            `gloss`  [ "urinate" ],
    ...
    noun     FaCL                      {- $ax~ -}           -- `others` [ "^sa_hA_h N" ]
                                                            `gloss`  [ "urine" ],

    -- ;; mi$ax~ap_1
    -- m$x     mi$ax~  NapAt   latrine;pissoir

    noun     MiFaCL |< aT              {- mi$ax~ap -}       `gloss`  [ "latrine", "pissoir" ],

    -- ;; mi$oxaxap_1
    -- m$xx    mi$oxax NapAt   latrine;pissoir

    noun     MiFCaL |< aT              {- mi$oxaxap -}      `gloss`  [ "latrine", "pissoir" ] ]
 ...
 |> "^s _h b .t" <| [
    ...
    noun     KaRDaS |< aT              {- $axobaTap -}      `gloss`  [ "scribbling", "scrawling" ] ]
 ...
 |> "^s _h m" <| [
    ...
    noun     HaFCaL                    {- Oa$oxam -}        -- `others` [ "^sa_hmA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "gray" ] ]
 ...
 |> "^s ` ' r" <| [
    ...
    noun     KaRADiS |< Iy             {- $aEA}iriy~ -}     `gloss`  [ "ritualistic", "ceremonial [ [ $ aEA } iriy ~ / ADJ ] ]" ] ]
 ...
 |> "^s ` ^s `" <| [
    ...
    noun     MuKaRDaS                  {- mu$aEo$aE -}      `gloss`  [ "tipsy [ [ mu $ aEo $ aE / ADJ ] ]" ],
 ...
 |> "^s ` _t" <| [
    ...
    noun     FaCiL                     {- $aEiv -}          `gloss`  [ "unkempt [ [ $ aEiv / ADJ ] ]" ],
    ...
    noun     HaFCaL                    {- Oa$oEav -}        -- `others` [ "^sa`_tA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "unkempt [ [ >a $ oEav / ADJ ] ]", "unkempt" ],

    -- ;; mu$aE~av_1
    -- m$Ev    mu$aE~av        N-ap    unkempt     [[mu$aE~av/ADJ]]

    noun     MuFaCCaL                  {- mu$aE~av -}       `gloss`  [ "unkempt [ [ mu $ aE ~ av / ADJ ] ]" ] ]
 ...
 |> "^s ` `" <| [
    ...
    verb     HaFaCL                    {- Oa$aE~ -}         -- `others` [ "^sa`` IV_V_Pass_yu", "'a^s`a` PV_C", "^s`i` IV_C_yu", "^si`` IV_V_yu" ]
    ...
    noun     FaCAL                     {- $aEAE -}          `gloss`  [ "confused [ [ $ aEAE / ADJ ] ]" ],

    -- ;; <i$oEAE_1
    -- <$EAE   <i$oEAE N/At    radiation;irradiation
    -- A$EAE   <i$oEAE N/At    radiation;irradiation

    noun     HiFCAL                    {- Ii$oEAE -}        `gloss`  [ "radiation", "irradiation" ],
    ...
    noun     MustaFiCL                 {- musota$iE~ -}     `gloss`  [ "fluorescent [ [ musota $ iE ~ / ADJ ] ]" ] ]
 ...
 |> "^s ` b" <| [
    ...
    noun     FuCUL |< Iy               {- $uEuwbiy~ -}      `gloss`  [ "Shu'ubi [ [ $ uEuwbiy ~ / NOUN ] ]", "Shu'ubi [ [ $ uEuwbiy ~ / ADJ ] ]", "cosmopolitan", "globalist [ [ $ uEuwbiy ~ / ADJ ] ]" ],

    -- ;; $uEuwbiy~ap_1
    -- $Ewby   $uEuwbiy~       Nap     Shu'ubism     [[$uEuwbiy~/NOUN]]

    noun     FuCUL |< Iy |< aT         {- $uEuwbiy~ap -}    `gloss`  [ "Shu'ubism [ [ $ uEuwbiy ~ / NOUN ] ]" ],
    ...
    noun     FiCL |< aT                {- $iEobap -}        `gloss`  [ "reef" ],
    ...
    noun     HaFCaL                    {- Oa$oEab -}        `gloss`  [ "Ash'ab ( legendary miser )" ],

    -- ;; >a$oEabiy~_1
    -- >$Eby   >a$oEabiy~      Nall    miser;greedy     [[>a$oEabiy~/ADJ]]
    -- A$Eby   >a$oEabiy~      Nall    miser;greedy     [[>a$oEabiy~/ADJ]]

    noun     HaFCaL |< Iy              {- Oa$oEabiy~ -}     `gloss`  [ "miser", "greedy [ [ >a $ oEabiy ~ / ADJ ] ]" ],
    ...
    noun     MutaFaCCiL                {- muta$aE~ib -}     `gloss`  [ "ramified", "versatile [ [ muta $ aE ~ ib / ADJ ] ]" ],

    -- ;; muno$aEib_1
    -- mn$Eb   muno$aEib       Nall    branching     [[muno$aEib/ADJ]]

    noun     MunFaCiL                  {- muno$aEib -}      `gloss`  [ "branching [ [ muno $ aEib / ADJ ] ]" ] ]
 ...
 |> "^s ` b _d" <| [
    ...
    noun     KaRDaS |< aT              {- $aEoba*ap -}      `gloss`  [ "sleight of hand", "jugglery" ],
 ...
 |> "^s ` f" <| [
    ...
    noun     FaCL |< aT                {- $aEofap -}        -- `others` [ "^si`Af N" ]
 ...
 |> "^s ` l" <| [
    ...
    noun     FuCL |< aT                {- $uEolap -}        -- `others` [ "^su`al N" ]
    ...
    noun     FaCIL |< aT               {- $aEiylap -}       -- `others` [ "^sa`A'il Ndip" ]
    ...
    noun     IFtiCAL |< Iy             {- {i$otiEAliy~ -}   `gloss`  [ "combustible", "flammable [ [ { i $ otiEAliy ~ / ADJ ] ]" ],
 ...
 |> "^s ` n" <| [
    ...
    verb     HaFCaL                    {- Oa$oEan -}        -- `others` [ "^s`an IV-n_Pass_yu", "^s`in IV-n_yu" ]
 ...
 |> "^s ` r" <| [
    ...
    noun     FuCUL |< Iy               {- $uEuwriy~ -}      `gloss`  [ "conscious [ [ $ uEuwriy ~ / ADJ ] ]" ],
    ...
    noun     FiCAL |< Iy               {- $iEAriy~ -}       `gloss`  [ "emblematic", "symbolic [ [ $ iEAriy ~ / ADJ ] ]" ],
    ...
    noun     FaCIL |< aT               {- $aEiyrap -}       -- `others` [ "^sa`A'ir Ndip" ]
    ...
    noun     FaCL |< Iy                {- $aEoriy~ -}       `gloss`  [ "hair", "capillary [ [ $ aEoriy ~ / ADJ ] ]" ],
    ...
    noun     FaCIL |< aT               {- $aEiyrap -}       `gloss`  [ "bead ( gun sight )" ],

    -- ;; ma$oEuwr_1
    -- m$Ewr   ma$oEuwr        N-ap    split;cracked     [[ma$oEuwr/ADJ]]

    noun     MaFCUL                    {- ma$oEuwr -}       `gloss`  [ "split", "cracked [ [ ma $ oEuwr / ADJ ] ]" ],
    ...
    noun     HaFCaL                    {- Oa$oEar -}        -- `others` [ "^sa`rA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "hirsute [ [ >a $ oEar / ADJ ] ]", "hirsute" ],

    -- ;; $aEorAniy~_1
    -- $ErAny  $aEorAniy~      N-ap    hirsute     [[$aEorAniy~/ADJ]]

    noun     FaCLAn |< Iy              {- $aEorAniy~ -}     `gloss`  [ "hirsute [ [ $ aEorAniy ~ / ADJ ] ]" ],
 ...
 |> "^s ` r n" <| [
    ...
    noun     KaRDAS |< Iy              {- $aEorAniy~ -}     `gloss`  [ "hirsute [ [ $ aEorAniy ~ / ADJ ] ]" ],

    -- ;; $aEorAniy~_2
    -- $ErAny  $aEorAniy~      N0      Sharani

    noun     KaRDAS |< Iy              {- $aEorAniy~ -}     `gloss`  [ "Sharani" ] ]
 ...
 |> "^s ` w _d" <| [
    ...
    noun     KaRDaS |< aT              {- $aEowa*ap -}      `gloss`  [ "sleight of hand", "jugglery" ],
 ...
 |> "^s b ^s b" <| [
    ...
    noun     KiRDiS                    {- $ibo$ib -}        -- `others` [ "^sabA^sib Ndip" ]
                                                            `gloss`  [ "slippers" ] ]
 ...
 |> "^s b _t" <| [
    ...
    noun     MutaFaCCiL                {- muta$ab~iv -}     `gloss`  [ "tenacious", "stubborn [ [ muta $ ab ~ iv / ADJ ] ]" ] ]
 ...
 |> "^s b `" <| [
    ...
    verb     HaFCaL                    {- Oa$obaE -}        -- `others` [ "^sba` IV_Pass_yu", "^sbi` IV_yu" ]
    ...
    noun     FuCL |< aT                {- $uboEap -}        `gloss`  [ "a fill" ],
    ...
    noun     HiFCAL                    {- Ii$obAE -}        `gloss`  [ "satiation", "saturation", "gratification" ],
 ...
 |> "^s b b" <| [
    ...
    verb     FaCL                      {- $ab~-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "^sabab PV_C", "^sbub IV_C", "^subb IV_V" ]
                                                            `gloss`  [ "kindle" ],
    ...
    verb     FaCCaL                    {- $ab~ab -}         -- `others` [ "^sabbib IV_yu" ]
                                                            `gloss`  [ "flirt" ],
    ...
    verb     TaFaCCaL                  {- ta$ab~ab -}       `gloss`  [ "rhapsodize" ],
    ...
    noun     FaCL                      {- $ab~ -}           `gloss`  [ "alum", "styptic pencil" ],
    ...
    noun     FuCUL                     {- $ubuwb -}         `gloss`  [ "outbreak" ],

    -- ;; $ab~Abap_1
    -- $bAb    $ab~Ab  Nap     reed flute

    noun     FaCCAL |< aT              {- $ab~Abap -}       `gloss`  [ "reed flute" ],
    ...
    noun     MaFCUL                    {- ma$obuwb -}       `gloss`  [ "kindled", "ignited [ [ ma $ obuwb / ADJ ] ]" ] ]
 ...
 |> "^s b k" <| [
    ...
    noun     FaCaL |< Iy               {- $abakiy~ -}       `gloss`  [ "net-like", "network [ [ $ abakiy ~ / ADJ ] ]" ],
    ...
    noun     FaCIL |< aT               {- $abiykap -}       -- `others` [ "^sabA'ik Ndip", "^sabAyik Ndip" ]
    ...
    noun     MuFaCCaL                  {- mu$ab~ak -}       `gloss`  [ "plaited", "adorned with latticework [ [ mu $ ab ~ ak / ADJ ] ]" ],

    -- ;; mu$otabik_1
    -- m$tbk   mu$otabik       Nall    skirmishing;clashing     [[mu$otabik/ADJ]]

    noun     MuFtaCiL                  {- mu$otabik -}      `gloss`  [ "skirmishing", "clashing [ [ mu $ otabik / ADJ ] ]" ],

    -- ;; mu$otabik_2
    -- m$tbk   mu$otabik       Nall    involved;entangled     [[mu$otabik/ADJ]]

    noun     MuFtaCiL                  {- mu$otabik -}      `gloss`  [ "involved", "entangled [ [ mu $ otabik / ADJ ] ]" ],
 ...
 |> "^s b l" <| [
    ...
    verb     HaFCaL                    {- Oa$obal -}        -- `others` [ "^sbal IV_Pass_yu", "^sbil IV_yu" ]
 ...
 |> "^s b n" <| [
    ...
    noun     FaCIL |< aT               {- $abiynap -}       `gloss`  [ "godmother", "bridesmaid" ] ]
 ...
 |> "^s b q" <| [
    ...
    noun     FaCaL |< Iy               {- $abaqiy~ -}       `gloss`  [ "lewd", "shameless [ [ $ abaqiy ~ / ADJ ] ]" ],

    -- ;; $abiq_1
    -- $bq     $abiq   N/ap    lewd;licentious     [[$abiq/ADJ]]

    noun     FaCiL                     {- $abiq -}          `gloss`  [ "lewd", "licentious [ [ $ abiq / ADJ ] ]" ],
 ...
 |> "^s b r" <| [
    ...
    noun     FaCCUL |< aT              {- $ab~uwrap -}      `gloss`  [ "fog", "mist" ],

    -- ;; $Abuwrap_1
    -- $Abwr   $Abuwr  Nap     fog;mist

    noun     FACUL |< aT               {- $Abuwrap -}       `gloss`  [ "fog", "mist" ] ]
 ...
 |> "^s b r q" <| [
    ...
    noun     KaRDaS |< aT              {- $aboraqap -}      `gloss`  [ "tearing to shreds", "pocket money" ] ]
 ...
 |> "^s b w" <| [
    ...
    noun     FaCY |< aT                {- $abAp -}          -- `others` [ "^sabaw NAt" ]
 ...
 |> "^s d ' d" <| [
    ...
    noun     KaRADiS                   {- $adA}id -}        `gloss`  [ "hardship", "adversity" ] ]
 ...
 |> "^s d d" <| [
    ...
    verb     FACL                      {- $Ad~ -}           -- `others` [ "^sAdid IV_C_yu", "^sAdad PV_C" ]
                                                            `gloss`  [ "argue" ],
    ...
    verb     TaFaCCaL                  {- ta$ad~ad -}       `gloss`  [ "become intense" ],
    ...
    verb     TaFACL                    {- ta$Ad~ -}         -- `others` [ "ta^sAdad PV_C", "ta^sAdid IV_C" ]
                                                            `gloss`  [ "argue" ],
    ...
    verb     IFtaCL                    {- {i$otad~ -}       -- `others` [ "i^stadad PV_C", "^stadd IV_V", "^stadid IV_C" ]
                                                            `gloss`  [ "intensify" ],
    ...
    noun     FaCAL                     {- $adAd -}          -- `others` [ "'a^sidd Nap" ]
                                                            `gloss`  [ "saddle", "saddles" ],

    -- ;; $ad~Ad_1
    -- $dAd    $ad~Ad  N0      Shaddad

    noun     FaCCAL                    {- $ad~Ad -}         `gloss`  [ "Shaddad" ],
    ...
    noun     IFtiCAL                   {- {i$otidAd -}      `gloss`  [ "intensification", "aggravation" ],

    -- ;; ma$oduwd_1
    -- m$dwd   ma$oduwd        N-ap    tight;tense     [[ma$oduwd/ADJ]]

    noun     MaFCUL                    {- ma$oduwd -}       `gloss`  [ "tight", "tense [ [ ma $ oduwd / ADJ ] ]" ],
 ...
 |> "^s d f" <| [
    ...
    noun     FACUL                     {- $Aduwf -}         -- `others` [ "^sawAdiyf Ndip" ]
 ...
 |> "^s d h" <| [
    ...
    noun     MaFCUL                    {- ma$oduwh -}       `gloss`  [ "confused", "baffled [ [ ma $ oduwh / ADJ ] ]" ] ]
 ...
 |> "^s d q" <| [
    ...
    noun     HaFCaL                    {- Oa$odaq -}        -- `others` [ "^sadqA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "loud-mouthed [ [ >a $ odaq / ADJ ] ]", "loud-mouthed" ],
 ...
 |> "^s d w" <| [
    ...
    noun     FACI                      {- $Adiy -}          -- `others` [ "^sAd Nuwn_Niyn NK" ]
                                                            `gloss`  [ "educated", "trained [ [ $ Adiy / ADJ ] ]", "trained" ],
    ...
    noun     FACI                      {- $Adiy -}          -- `others` [ "^sAd Nuwn_Niyn NK" ]
                                                            `gloss`  [ "singing", "chanting [ [ $ Adiy / ADJ ] ]", "chanting" ],
    ...
    noun     FACI |< aT                {- $Adiyap -}        `gloss`  [ "songstress", "singer" ] ]
 ...
 |> "^s d y" <| [
    ...
    noun     FACiL                     {- $Adiy -}          -- `others` [ "^sAd Nuwn_Niyn NK" ]
                                                            `gloss`  [ "educated", "trained [ [ $ Adiy / ADJ ] ]", "trained" ],
    ...
    noun     FACiL |< aT               {- $Adiyap -}        `gloss`  [ "songstress", "singer" ] ]
 ...
 |> "^s f '" <| [
    ...
    noun     IstiFCAL                  {- {isoti$ofA' -}    `gloss`  [ "hospitalization" ] ]
 ...
 |> "^s f .t" <| [
    ...
    noun     FaCL |< Iy                {- $afoTiy~ -}       `gloss`  [ "siphoning out", "vacuuming [ [ $ afoTiy ~ / ADJ ] ]" ],

    -- ;; $afoTap_1
    -- $fT     $afoT   Napdu   sip
    -- $fT     $afaT   NAt     sips

    noun     FaCL |< aT                {- $afoTap -}        -- `others` [ "^safa.t NAt" ]
                                                            `gloss`  [ "sip", "sips" ],

    -- ;; $af~ATap_1
    -- $fAT    $af~AT  NapAt   siphon;vacuum

    noun     FaCCAL |< aT              {- $af~ATap -}       `gloss`  [ "siphon", "vacuum" ],

    -- ;; ma$ofuwT_1
    -- m$fwT   ma$ofuwT        N-ap    siphoned out;vacuumed     [[ma$ofuwT/ADJ]]

    noun     MaFCUL                    {- ma$ofuwT -}       `gloss`  [ "siphoned out", "vacuumed [ [ ma $ ofuwT / ADJ ] ]" ] ]
 ...
 |> "^s f `" <| [
    ...
    noun     FaCL |< Iy                {- $afoEiy~ -}       `gloss`  [ "even numbers [ [ $ afoEiy ~ / ADJ ] ]" ],

    -- ;; $ufoEap_1
    -- $fE     $ufoE   Nap     preemption

    noun     FuCL |< aT                {- $ufoEap -}        `gloss`  [ "preemption" ],
    ...
    noun     FaCIL |< Iy               {- $afiyEiy~ -}      `gloss`  [ "patronal [ [ $ afiyEiy ~ / ADJ ] ]" ],

    -- ;; $afAEap_1
    -- $fAE    $afAE   Nap     mediation;intercession

    noun     FaCAL |< aT               {- $afAEap -}        `gloss`  [ "mediation", "intercession" ],
    ...
    noun     TaFaCCuL |< Iy            {- ta$af~uEiy~ -}    `gloss`  [ "propitiatory [ [ ta $ af ~ uEiy ~ / ADJ ] ]" ],
    ...
    noun     FACiL |< Iy               {- $AfiEiy~ -}       `gloss`  [ "Shafi'i [ [ $ AfiEiy ~ / NOUN ] ]", "Shafi'i [ [ $ AfiEiy ~ / ADJ ] ]" ],

    -- ;; ma$ofuwE_1
    -- m$fwE   ma$ofuwE        N-ap    accompanied;combined     [[ma$ofuwE/ADJ]]

    noun     MaFCUL                    {- ma$ofuwE -}       `gloss`  [ "accompanied", "combined [ [ ma $ ofuwE / ADJ ] ]" ] ]
 ...
 |> "^s f f" <| [
    ...
    verb     FaCL                      {- $af~-i -}         `imperf` [ FCiL ]
                                                            -- `others` [ "^siff IV_V_intr", "^safaf PV_C_intr", "^sfif IV_C_intr" ]
    ...
    verb     IFtaCL                    {- {i$otaf~ -}       -- `others` [ "i^stafaf PV_C", "^stafif IV_C", "^staff IV_V" ]
    ...
    verb     IstaFaCL                  {- {isota$af~ -}     -- `others` [ "sta^sfif IV_C", "sta^siff IV_V", "ista^sfaf PV_C" ]
    ...
    noun     FiCL                      {- $if~ -}           -- `others` [ "^sufuwf N" ]
                                                            `gloss`  [ "gauze", "veil", "veils" ],

    -- ;; $afaf_1
    -- $ff     $afaf   N       transparency

    noun     FaCaL                     {- $afaf -}          `gloss`  [ "transparency" ],

    -- ;; $afiyf_1
    -- $fyf    $afiyf  N-ap    translucent;transparent     [[$afiyf/ADJ]]

    noun     FaCIL                     {- $afiyf -}         `gloss`  [ "translucent", "transparent [ [ $ afiyf / ADJ ] ]" ],
    ...
    noun     FuCUL                     {- $ufuwf -}         `gloss`  [ "translucence", "transparency" ],
    ...
    noun     IstiFCAL                  {- {isoti$ofAf -}    `gloss`  [ "tracing" ] ]
 ...
 |> "^s f h" <| [
    ...
    verb     FACaL                     {- $Afah -}          -- `others` [ "^sAfih IV_yu" ]
    ...
    noun     FaCY |< Iy                {- $afawiy~ -}       `gloss`  [ "oral", "verbal [ [ $ afawiy ~ / ADJ ] ]", "orally", "verbally [ [ $ afawiy ~ / ADV ] ]" ],

    -- ;; $ifAhAF_1
    -- $fAh    $ifAh   NF      orally;verbally     [[$ifAh/ADV]]

    noun     FiCAL |< aN               {- $ifAhAF -}        -- `others` [ "^sifAh NF" ]
                                                            `gloss`  [ "orally", "verbally [ [ $ ifAh / ADV ] ]" ],

    -- ;; mu$Afahap_1
    -- m$Afh   mu$Afah NapAt   verbal;oral;speech

    noun     MuFACaL |< aT             {- mu$Afahap -}      `gloss`  [ "verbal", "oral", "speech" ],

    -- ;; mu$AfahapF_1
    -- m$Afhp  mu$AfahapF      FW-Wa   orally;verbally    [[mu$AfahapF/ADV]]

    noun     MuFACaL |< aT |< aN       {- mu$AfahapF -}     `gloss`  [ "orally", "verbally [ [ mu $ AfahapF / ADV ] ]" ] ]
 ...
 |> "^s f q" <| [
    ...
    verb     HaFCaL                    {- Oa$ofaq -}        -- `others` [ "^sfiq IV_yu", "^sfaq IV_Pass_yu" ]
    ...
    noun     FaCaL |< Iy               {- $afaqiy~ -}       `gloss`  [ "dusk", "twilight [ [ $ afaqiy ~ / ADJ ] ]" ],
    ...
    noun     FaCIL                     {- $afiyq -}         `gloss`  [ "compassionate", "sympathetic [ [ $ afiyq / ADJ ] ]" ],
    ...
    noun     HiFCAL                    {- Ii$ofAq -}        `gloss`  [ "pity", "sympathy" ],

    -- ;; mu$ofiq_1
    -- m$fq    mu$ofiq Nall    compassionate;sympathetic     [[mu$ofiq/ADJ]]

    noun     MuFCiL                    {- mu$ofiq -}        `gloss`  [ "compassionate", "sympathetic [ [ mu $ ofiq / ADJ ] ]" ] ]
 ...
 |> "^s f r" <| [
    ...
    noun     FaCL                      {- $afor -}          -- `others` [ "'a^sfAr N" ]
    ...
    noun     FaCL |< aT                {- $aforap -}        -- `others` [ "^safar NAt", "^sifAr N" ]
                                                            `gloss`  [ "blade", "edge", "blades", "edges" ],

    -- ;; $afiyr_1
    -- $fyr    $afiyr  Ndu     eyelid;fringe;edge

    noun     FaCIL                     {- $afiyr -}         `gloss`  [ "eyelid", "fringe", "edge" ],

    -- ;; mi$ofar_1
    -- m$fr    mi$ofar Ndu     snout;lip
    -- m$Afr   ma$Afir Ndip    snout;lips

    noun     MiFCaL                    {- mi$ofar -}        -- `others` [ "ma^sAfir Ndip" ]
                                                            `gloss`  [ "snout", "lip", "lips" ],

    -- ;; $ifor_1
    -- $fr     $ifor   N       cipher;code

    noun     FiCL                      {- $ifor -}          `gloss`  [ "cipher", "code" ],

    -- ;; $iforiy~_1
    -- $fry    $iforiy~        N-ap    ciphered;in code     [[$iforiy~/ADJ]]

    noun     FiCL |< Iy                {- $iforiy~ -}       `gloss`  [ "ciphered", "in code [ [ $ iforiy ~ / ADJ ] ]" ],

    -- ;; $iforap_1
    -- $fr     $ifor   NapAt   cipher;code

    noun     FiCL |< aT                {- $iforap -}        `gloss`  [ "cipher", "code" ] ]
 ...
 |> "^s f t r" <| [
    ...
    noun     KaRDUS |< aT              {- $afotuwrap -}     -- `others` [ "^safAtiyr Ndip" ]
 ...
 |> "^s f w" <| [
    ...
    noun     MaFCY                     {- ma$ofaY -}        -- `others` [ "ma^sAfiy N0_Nh", "ma^sAf NK", "ma^sfay NAt NAn_Nayn", "ma^sfA Nhy" ]
    ...
    noun     TaFaCCI                   {- ta$af~iy -}       -- `others` [ "ta^saff NK" ]
    ...
    noun     MustaFCY                  {- musota$ofaY -}    -- `others` [ "musta^sfA Nhy", "musta^sfay NAt NAn_Nayn" ]
 ...
 |> "^s h '" <| [
    ...
    noun     IFtiCAL                   {- {i$otihA' -}      `gloss`  [ "greed", "appetite" ] ]
 ...
 |> "^s h b" <| [
    ...
    noun     FiCAL |< Iy               {- $ihAbiy~ -}       `gloss`  [ "meteorite [ [ $ ihAbiy ~ / ADJ ] ]" ],
 ...
 |> "^s h b '" <| [
    ...
    noun     KaRDAS                    {- $ahobA' -}        `gloss`  [ "Aleppo" ] ]
 ...
 |> "^s h d" <| [
    ...
    noun     FaCAL |< aT               {- $ahAdap -}        `gloss`  [ "martyrdom" ],
    ...
    noun     FACiL |< aT               {- $Ahidap -}        `gloss`  [ "index finger" ],

    -- ;; ma$ohuwd_1
    -- m$hwd   ma$ohuwd        N/ap    attested;observed;flagrante delicto     [[ma$ohuwd/ADJ]]

    noun     MaFCUL                    {- ma$ohuwd -}       `gloss`  [ "attested", "observed", "flagrante delicto [ [ ma $ ohuwd / ADJ ] ]" ],
    ...
    noun     MuFACaL                   {- mu$Ahad -}        `gloss`  [ "visible", "perceptible [ [ mu $ Ahad / ADJ ] ]" ],
    ...
    noun     HiFCAL                    {- Ii$ohAd -}        `gloss`  [ "written certification" ],
    ...
    noun     IstiFCAL |< Iy            {- {isoti$ohAdiy~ -} `gloss`  [ "martyr ( `` suicide '' in Western media ) [ [ { isoti $ ohAdiy ~ / NOUN ] ]", "martyr ( `` suicide '' in Western media ) [ [ { isoti $ ohAdiy ~ / ADJ ] ]" ] ]
 ...
 |> "^s h h" <| [
    ...
    verb     FaCLY                     {- $ah~aY -}         -- `others` [ "^sahhA PV_h", "^sahhiy IV_0hAnn_yu", "^sahh IV_0hwnyn_yu PV_ttAw", "^sahhay PV_Atn IV_Ann_Pass_yu" ]
 ...
 |> "^s h l" <| [
    ...
    noun     FuCL |< aT                {- $uholap -}        `gloss`  [ "deep-blue", "navy blue" ],
    ...
    noun     HaFCaL                    {- Oa$ohal -}        -- `others` [ "^sahlA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "deep-blue", "navy blue [ [ >a $ ohal / ADJ ] ]", "navy blue" ],
 ...
 |> "^s h m" <| [
    ...
    noun     FaCAL |< aT               {- $ahAmap -}        `gloss`  [ "audacity", "gallantry" ] ]
 ...
 |> "^s h q" <| [
    ...
    noun     FaCL |< aT                {- $ahoqap -}        `gloss`  [ "gasp", "sigh" ],
 ...
 |> "^s h r" <| [
    ...
    noun     MuFACaL |< aT             {- mu$Aharap -}      -- `others` [ "mu^sAharaTaN FW-Wa" ]
                                                            `gloss`  [ "monthly salary", "monthly payment", "monthly [ [ mu $ AharapF / ADV ] ]" ],
    ...
    noun     MuFaCCaL                  {- mu$ah~ar -}       `gloss`  [ "famous", "notorious [ [ mu $ ah ~ ar / ADJ ] ]" ] ]
 ...
 |> "^s h w" <| [
    ...
    noun     FaCLAn                    {- $ahowAn -}        -- `others` [ "^sahAwA Nhy", "^sahwA Nhy", "^sahwY N0", "^sahAwY N0" ]
                                                            `gloss`  [ "covetous", "debauched [ [ $ ahowAn / ADJ ] ]", "debauched" ],
 ...
 |> "^s h w y" <| [
    ...
    noun     KaRDIS                    {- $ahowiy~ -}       `gloss`  [ "sensual [ [ $ ahowiy ~ / ADJ ] ]" ] ]
 ...
 |> "^s h y" <| [
    ...
    noun     TaFaCCI                   {- ta$ah~iy -}       -- `others` [ "ta^sahh NK" ]
                                                            `gloss`  [ "greed" ],
    ...
    noun     MuFaCCiL                  {- mu$ah~iy -}       -- `others` [ "mu^sahh NK" ]
    ...
    noun     MuFtaCiL                  {- mu$otahiy -}      -- `others` [ "mu^stah Nuwn_Niyn NK" ]
                                                            `gloss`  [ "covetous", "greedy [ [ mu $ otahiy / ADJ ] ]", "greedy" ],
    ...
    noun     MuFtaCY                   {- mu$otahaY -}      -- `others` [ "mu^stahA Nhy", "mu^stahay NAt NAn_Nayn" ]
                                                            `gloss`  [ "desirable", "coveted [ [ mu $ otahaY / ADJ ] ]", "coveted", "desiderata", "coveted things" ],

    -- ;; ta$ohiyap_1
    -- t$hy    ta$ohiy Nap     arousing the appetite

    noun     TaFCiL |< aT              {- ta$ohiyap -}      `gloss`  [ "arousing the appetite" ] ]
 ...
 |> "^s k '" <| [
    ...
    noun     FiCAL                     {- $ikA' -}          `gloss`  [ "complaining" ],
    ...
    noun     FaCCAL                    {- $ak~A' -}         `gloss`  [ "querulous", "complaining [ [ $ ak ~ A ' / ADJ ] ]", "complaining" ],
    ...
    noun     IFtiCAL                   {- {i$otikA' -}      `gloss`  [ "complaint", "recrimination", "complaints", "recriminations" ] ]
 ...
 |> "^s k ^s" <| [
    ...
    noun     FACUL                     {- $Akuw$ -}         -- `others` [ "^sakuw^s N", "^sawAkiy^s Ndip" ]
 ...
 |> "^s k h" <| [
    ...
    noun     MuFACaL |< aT             {- mu$Akahap -}      `gloss`  [ "resembling", "resemblance" ] ]
 ...
 |> "^s k k" <| [
    ...
    noun     FuCUL |< Iy               {- $ukuwkiy~ -}      `gloss`  [ "skeptic [ [ $ ukuwkiy ~ / ADJ ] ]", "skepticism [ [ $ ukuwkiy ~ / NOUN ] ]" ],

    -- ;; $ak~ap_1
    -- $k      $ak~    Nap     stab;sting

    noun     FaCL |< aT                {- $ak~ap -}         `gloss`  [ "stab", "sting" ],
    ...
    noun     TaFaCCuL                  {- ta$ak~uk -}       `gloss`  [ "doubt", "uncertainty" ],

    -- ;; $Ak~_1
    -- $Ak     $Ak~    N/ap    doubting;skeptic     [[$Ak~/ADJ]]
    -- $kAk    $uk~Ak  N       doubting;skeptics

    noun     FACL                      {- $Ak~ -}           -- `others` [ "^sukkAk N" ]
                                                            `gloss`  [ "doubting", "skeptic [ [ $ Ak ~ / ADJ ] ]", "skeptics" ],
 ...
 |> "^s k l" <| [
    ...
    verb     HaFCaL                    {- Oa$okal -}        -- `others` [ "^skil IV_intr_yu" ]
    ...
    noun     FaCL |< aT                {- $akolap -}        -- `others` [ "^sakal NAt" ]
                                                            `gloss`  [ "diacritic", "diacritical mark", "diacritics", "diacritical marks" ],

    -- ;; $akoliy~_1
    -- $kly    $akoliy~        Nall    formal;figurative     [[$akoliy~/ADJ]]

    noun     FaCL |< Iy                {- $akoliy~ -}       `gloss`  [ "formal", "figurative [ [ $ akoliy ~ / ADJ ] ]" ],

    -- ;; $akoliy~ap_1
    -- $kly    $akoliy~        NapAt   formalism;formality     [[$akoliy~/NOUN]]

    noun     FaCL |< Iy |< aT          {- $akoliy~ap -}     `gloss`  [ "formalism", "formality [ [ $ akoliy ~ / NOUN ] ]" ],
    ...
    noun     MuFACaL |< aT             {- mu$Akalap -}      `gloss`  [ "resemblance", "similarity" ],
    ...
    noun     FACiL |< aT               {- $Akilap -}        -- `others` [ "^sawAkil Ndip" ]
    ...
    noun     MuFaCCaL                  {- mu$ak~al -}       `gloss`  [ "variegated [ [ mu $ ak ~ al / ADJ ] ]" ],

    -- ;; mu$ak~al_3
    -- m$kl    mu$ak~al        N-ap    diacriticized (with short vowels and diacritics)     [[mu$ak~al/ADJ]]

    noun     MuFaCCaL                  {- mu$ak~al -}       `gloss`  [ "diacriticized ( with short vowels and diacritics ) [ [ mu $ ak ~ al / ADJ ] ]" ],
    ...
    noun     MutaFACiL                 {- muta$Akil -}      `gloss`  [ "similar", "uniform", "isomorphic [ [ muta $ Akil / ADJ ] ]" ],
    ...
    noun     FuCUL |< At |< aT         {- $ukuwlAtap -}     -- `others` [ "^sukuwlA.t NapAt", "^sukulA.t NapAt", "^siykuwlAt NapAt", "^suwkuwlAt NapAt" ]
                                                            `gloss`  [ "chocolate" ] ]
 ...
 |> "^s k r" <| [
    ...
    noun     FuCL |< aN                {- $ukorAF -}        -- `others` [ "^sukr NF" ]
                                                            `gloss`  [ "thank you", "thanks [ [ $ ukor / ADV ] ]" ],

    -- ;; $ukoriy~_1
    -- $kry    $ukoriy~        N-ap    of thanks     [[$ukoriy~/ADJ]]

    noun     FuCL |< Iy                {- $ukoriy~ -}       `gloss`  [ "of thanks [ [ $ ukoriy ~ / ADJ ] ]" ],
    ...
    noun     MaFCUL                    {- ma$okuwr -}       `gloss`  [ "praiseworthy", "deserving thanks [ [ ma $ okuwr / ADJ ] ]" ],

    -- ;; $ikArap_1
    -- $kAr    $ikAr   NapAt   gunny sack
    -- $kA}r   $akA}ir Ndip    gunny sacks

    noun     FiCAL |< aT               {- $ikArap -}        -- `others` [ "^sakA'ir Ndip" ]
 ...
 |> "^s k r n" <| [
    ...
    noun     KuRDAS                    {- $ukorAn -}        `gloss`  [ "gratitude", "thanks" ] ]
 ...
 |> "^s k s" <| [
    ...
    noun     FaCAL |< aT               {- $akAsap -}        `gloss`  [ "malice", "unfriendliness" ],

    -- ;; mu$Akasap_1
    -- m$Aks   mu$Akas NapAt   quarrel;dispute

    noun     MuFACaL |< aT             {- mu$Akasap -}      `gloss`  [ "quarrel", "dispute" ],
    ...
    noun     MuFACiL                   {- mu$Akis -}        `gloss`  [ "quarrelsome [ [ mu $ Akis / ADJ ] ]" ] ]
 ...
 |> "^s k w" <| [
    ...
    noun     FaCL                      {- $akow -}          `gloss`  [ "complaining" ],

    -- ;; $akowap_1
    -- $kw     $akow   Napdu   complaint;grievance
    -- $kw     $akaw   NAt     complaints;grievances

    noun     FaCL |< aT                {- $akowap -}        -- `others` [ "^sakaw NAt" ]
    ...
    noun     FaCY |< aT                {- $akAp -}          `gloss`  [ "complaint", "grievance" ],
    ...
    noun     FACI                      {- $Akiy -}          -- `others` [ "^sAk Nuwn_Niyn NK" ]
                                                            `gloss`  [ "complaining [ [ $ Akiy / ADJ ] ]", "complaining" ],
    ...
    noun     MaFCUL                    {- ma$okuw~ -}       `gloss`  [ "complained of [ [ ma $ okuw ~ / ADJ ] ]" ],

    -- ;; ma$okuw~_2
    -- m$kw    ma$okuw~        N       defendant

    noun     MaFCUL                    {- ma$okuw~ -}       `gloss`  [ "defendant" ],
    ...
    noun     MuFtaCI                   {- mu$otakiy -}      -- `others` [ "mu^stak Nuwn_Niyn NK" ]
                                                            `gloss`  [ "complainant", "plaintiff" ],

    -- ;; mu$otakaY_1
    -- m$tkY   mu$otakaY       N0      complained of     [[mu$otakaY/ADJ]]

    noun     MuFtaCY                   {- mu$otakaY -}      `gloss`  [ "complained of [ [ mu $ otakaY / ADJ ] ]" ],

    -- ;; mu$otakaY_2
    -- m$tkY   mu$otakaY       N0      defendant

    noun     MuFtaCY                   {- mu$otakaY -}      `gloss`  [ "defendant" ],
    ...
    noun     MiFCY |< aT               {- mi$okAp -}        -- `others` [ "ma^sAkiy N0_Nh", "ma^sAk NK", "mi^skaw NAt" ]
 ...
 |> "^s k y" <| [
    ...
    noun     FaCIL |< aT               {- $akiy~ap -}       `gloss`  [ "complaint", "grievance [ [ $ akiy ~ / NOUN ] ]" ],
    ...
    noun     FACiL                     {- $Akiy -}          -- `others` [ "^sAk Nuwn_Niyn NK" ]
                                                            `gloss`  [ "complaining [ [ $ Akiy / ADJ ] ]", "complaining" ],
    ...
    noun     MuFtaCiL                  {- mu$otakiy -}      -- `others` [ "mu^stak Nuwn_Niyn NK" ]
                                                            `gloss`  [ "complainant", "plaintiff" ] ]
 ...
 |> "^s l ^s l" <| [
    ...
    noun     KaRDaS |< aT              {- $alo$alap -}      `gloss`  [ "dripping", "trickling" ] ]
 ...
 |> "^s l b" <| [
    ...
    noun     FaCaL |< Iy               {- $alabiy~ -}       `gloss`  [ "handsome", "dandy [ [ $ alabiy ~ / ADJ ] ]" ] ]
 ...
 |> "^s l b y" <| [
    ...
    noun     KiRDAS |< aT              {- $ilobAyap -}      `gloss`  [ "Shelbaya", "Shilbaya" ] ]
 ...
 |> "^s l f" <| [
    ...
    noun     FiCL |< aT                {- $ilofap -}        `gloss`  [ "razor blade" ],
 ...
 |> "^s l h b" <| [
    ...
    noun     KaRDUS                    {- $alohuwb -}       `gloss`  [ "Shalhoub" ] ]
 ...
 |> "^s l l" <| [
    ...
    verb     InFaCL                    {- {ino$al~ -}       -- `others` [ "n^salil IV_C_intr", "in^salal PV_C_intr", "n^sall IV_V_intr" ]
    ...
    noun     MaFCUL                    {- ma$oluwl -}       `gloss`  [ "paralyzed", "impotent", "inert [ [ ma $ oluwl / ADJ ] ]" ],

    -- ;; mu$il~_1
    -- m$l     mu$il~  N-ap    paralyzing;neutralizing;inhibiting     [[mu$il~/ADJ]]

    noun     MuFiCL                    {- mu$il~ -}         `gloss`  [ "paralyzing", "neutralizing", "inhibiting [ [ mu $ il ~ / ADJ ] ]" ],

    -- ;; $il~ap_1
    -- $l      $il~    Napdu   group;clique
    -- $ll     $ilal   N       groups;cliques

    noun     FiCL |< aT                {- $il~ap -}         -- `others` [ "^silal N" ]
    ...
    noun     MuFaCL                    {- mu$al~ -}         `gloss`  [ "paralyzed [ [ mu $ al ~ / ADJ ] ]" ] ]
 ...
 |> "^s l t" <| [
    ...
    noun     FaCL |< aT                {- $alotap -}        -- `others` [ "^silat N", "^salat NAt" ]
 ...
 |> "^s m .t" <| [
    ...
    noun     FaCaL                     {- $amaT -}          `gloss`  [ "turning gray [ [ $ amaT / ADJ ] ]" ],
    ...
    noun     HaFCaL                    {- Oa$omaT -}        -- `others` [ "^sam.tA' Nh Nhy N0_Nh", "^sum.t N" ]
                                                            `gloss`  [ "gray-haired [ [ >a $ omaT / ADJ ] ]", "gray-haired" ],
 ...
 |> "^s m ^s m" <| [
    ...
    noun     KaRDaS |< aT              {- $amo$amap -}      `gloss`  [ "sniffing" ] ]
 ...
 |> "^s m _h" <| [
    ...
    noun     MutaFACiL                 {- muta$Amix -}      `gloss`  [ "haughty", "lofty [ [ muta $ Amix / ADJ ] ]" ] ]
 ...
 |> "^s m `" <| [
    ...
    noun     FaCL |< aT                {- $amoEap -}        -- `others` [ "^sama` NAt" ]
                                                            `gloss`  [ "candle", "candles" ],

    -- ;; $amoEiy~_1
    -- $mEy    $amoEiy~        N-ap    wax;made of wax     [[$amoEiy~/ADJ]]

    noun     FaCL |< Iy                {- $amoEiy~ -}       `gloss`  [ "wax", "made of wax [ [ $ amoEiy ~ / ADJ ] ]" ],
    ...
    noun     MuFaCCaL                  {- mu$am~aE -}       `gloss`  [ "impermeable", "waterproof [ [ mu $ am ~ aE / ADJ ] ]" ] ]
 ...
 |> "^s m l" <| [
    ...
    noun     FaCL |< aT                {- $amolap -}        -- `others` [ "^samal NAt" ]
                                                            `gloss`  [ "cloak", "cloaks" ],
    ...
    noun     FaCL |< Iy |< aT          {- $amoliy~ap -}     -- `others` [ "^samA'il Ndip" ]
    ...
    noun     HaFCaL                    {- Oa$omal -}        `gloss`  [ "more / most comprehensive" ],
    ...
    noun     MuFtaCiL                  {- mu$otamil -}      `gloss`  [ "including", "comprising", "containing [ [ mu $ otamil / ADJ ] ]" ],
 ...
 |> "^s m m" <| [
    ...
    verb     TaFaCCaL                  {- ta$am~am -}       `gloss`  [ "smell", "sniff" ],
    ...
    verb     IFtaCL                    {- {i$otam~ -}       -- `others` [ "^stamm IV_V", "i^stamam PV_C", "^stamim IV_C" ]
                                                            `gloss`  [ "smell", "sniff" ],

    -- ;; $am~_1
    -- $m      $am~    N       smelling;sniffing;sense of smell

    noun     FaCL                      {- $am~ -}           `gloss`  [ "smelling", "sniffing", "sense of smell" ],

    -- ;; $am~iy~_1
    -- $my     $am~iy~ N-ap    olfactory     [[$am~iy~/ADJ]]

    noun     FaCL |< Iy                {- $am~iy~ -}        `gloss`  [ "olfactory [ [ $ am ~ iy ~ / ADJ ] ]" ],

    -- ;; $amam_1
    -- $mm     $amam   N       pride

    noun     FaCaL                     {- $amam -}          `gloss`  [ "pride" ],

    -- ;; $am~Am_1
    -- $mAm    $am~Am  N-ap    muskmelon;cantaloupe

    noun     FaCCAL                    {- $am~Am -}         `gloss`  [ "muskmelon", "cantaloupe" ],
    ...
    noun     HaFaCL                    {- Oa$am~ -}         -- `others` [ "^sammA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "proud [ [ >a $ am ~ / ADJ ] ]", "proud" ],

    -- ;; ma$omuwm_1
    -- m$mwm   ma$omuwm        N-ap    smelly;odorous     [[ma$omuwm/ADJ]]

    noun     MaFCUL                    {- ma$omuwm -}       `gloss`  [ "smelly", "odorous [ [ ma $ omuwm / ADJ ] ]" ],

    -- ;; $amiym_1
    -- $mym    $amiym  N-ap    fragrance

    noun     FaCIL                     {- $amiym -}         `gloss`  [ "fragrance" ] ]
 ...
 |> "^s m r" <| [
    ...
    noun     FuCL |< aT                {- $umorap -}        `gloss`  [ "fennel" ],
    ...
    noun     MuFaCCiL                  {- mu$am~ir -}       `gloss`  [ "industrious", "busily at work [ [ mu $ am ~ ir / ADJ ] ]" ],

    -- ;; mu$am~ar_1
    -- m$mr    mu$am~ar        N-ap    gathered up;tucked     [[mu$am~ar/ADJ]]

    noun     MuFaCCaL                  {- mu$am~ar -}       `gloss`  [ "gathered up", "tucked [ [ mu $ am ~ ar / ADJ ] ]" ] ]
 ...
 |> "^s m s" <| [
    ...
    verb     HaFCaL                    {- Oa$omas -}        -- `others` [ "^smis IV_intr_yu" ]
                                                            `gloss`  [ "be sunny" ],
    ...
    noun     FaCL |< Iy |< aT          {- $amosiy~ap -}     -- `others` [ "^samAs NK", "^samAsiy N0_Nh" ]
                                                            `gloss`  [ "sunshade", "umbrella", "parasol [ [ $ amosiy ~ / NOUN ] ]", "sunshades", "umbrellas", "parasols" ],

    -- ;; $Amis_1
    -- $Ams    $Amis   N-ap    sunny     [[$Amis/ADJ]]

    noun     FACiL                     {- $Amis -}          `gloss`  [ "sunny [ [ $ Amis / ADJ ] ]" ],
    ...
    noun     FACiL                     {- $Amis -}          -- `others` [ "^sawAmis Ndip" ]
                                                            `gloss`  [ "rebellious", "disobedient [ [ $ Amis / ADJ ] ]", "disobedient" ],
    ...
    noun     FaCUL                     {- $amuws -}         `gloss`  [ "rebellious", "disobedient [ [ $ amuws / ADJ ] ]" ],

    -- ;; mu$omis_1
    -- m$ms    mu$omis N-ap    sunny     [[mu$omis/ADJ]]

    noun     MuFCiL                    {- mu$omis -}        `gloss`  [ "sunny [ [ mu $ omis / ADJ ] ]" ],
 ...
 |> "^s m t" <| [
    ...
    verb     HaFCaL                    {- Oa$omat -}        -- `others` [ "^smat IV_Pass_yu", "^smit IV_yu" ]
    ...
    noun     FACiL                     {- $Amit -}          -- `others` [ "^sawAmit Ndip", "^summAt N" ]
                                                            `gloss`  [ "malicious", "gloating [ [ $ Amit / ADJ ] ]", "gloating" ] ]
 ...
 |> "^s m w h" <| [
    ...
    noun     KaRDAS                    {- $amowAh -}        `gloss`  [ "chamois" ] ]
 ...
 |> "^s n '" <| [
    ...
    verb     FaCaL                     {- $anaO-a -}        `imperf` [ FCaL ]
                                                            -- `others` [ "^sana'A PV-|", "^sna' IV IV_wn IV_yn", "^sna'A IV-|" ]
                                                            `gloss`  [ "hate" ],

    -- ;; $anA'ap_1
    -- $nA'    $anA'   Nap     hatred

    noun     FaCAL |< aT               {- $anA'ap -}        `gloss`  [ "hatred" ],
    ...
    noun     FACiL                     {- $Ani} -}          -- `others` [ "^sunnA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "hating", "malevolent [ [ $ Ani } / ADJ ] ]", "malevolent" ] ]
 ...
 |> "^s n .t" <| [
    ...
    noun     FiCAL |< aT               {- $inATap -}        `gloss`  [ "polymerization" ] ]
 ...
 |> "^s n ^g" <| [
    ...
    noun     TaFaCCuL |< Iy            {- ta$an~ujiy~ -}    `gloss`  [ "spasmodic", "spastic [ [ ta $ an ~ ujiy ~ / ADJ ] ]" ] ]
 ...
 |> "^s n ^s n" <| [
    ...
    noun     KaRDaS |< aT              {- $ano$anap -}      `gloss`  [ "rustling", "crackling" ] ]
 ...
 |> "^s n _h b" <| [
    ...
    noun     KuRDUS |< aT              {- $unoxuwbap -}     -- `others` [ "^sanA_hiyb Ndip" ]
 ...
 |> "^s n `" <| [
    ...
    noun     FaCAL |< aT               {- $anAEap -}        `gloss`  [ "hideousness", "repulsiveness" ],

    -- ;; $unoEap_1
    -- $nE     $unoE   Nap     hideousness;repulsiveness

    noun     FuCL |< aT                {- $unoEap -}        `gloss`  [ "hideousness", "repulsiveness" ],

    -- ;; $aniE_1
    -- $nE     $aniE   N-ap    hideous;repulsive     [[$aniE/ADJ]]

    noun     FaCiL                     {- $aniE -}          `gloss`  [ "hideous", "repulsive [ [ $ aniE / ADJ ] ]" ],
 ...
 |> "^s n h q" <| [
    ...
    noun     KaRDaS |< aT              {- $anohaqap -}      `gloss`  [ "braying" ] ]
 ...
 |> "^s n n" <| [
    ...
    noun     FuCUL                     {- $unuwn -}         `gloss`  [ "waterskins" ],

    -- ;; mi$an~ap_1
    -- m$n     mi$an~  Nap     basket

    noun     MiFaCL |< aT              {- mi$an~ap -}       `gloss`  [ "basket" ] ]
 ...
 |> "^s n q" <| [
    ...
    noun     MiFCaL |< aT              {- mi$onaqap -}      -- `others` [ "ma^sAniq Ndip" ]
                                                            `gloss`  [ "gallows" ],

    -- ;; ma$onuwq_1
    -- m$nwq   ma$onuwq        Nall    hanged     [[ma$onuwq/ADJ]]

    noun     MaFCUL                    {- ma$onuwq -}       `gloss`  [ "hanged [ [ ma $ onuwq / ADJ ] ]" ],

    -- ;; mi$onaqiy~_1
    -- m$nqy   mi$onaqiy~      N-ap    sinister     [[mi$onaqiy~/ADJ]]

    noun     MiFCaL |< Iy              {- mi$onaqiy~ -}     `gloss`  [ "sinister [ [ mi $ onaqiy ~ / ADJ ] ]" ] ]
 ...
 |> "^s n r q" <| [
    ...
    noun     KaRADiS                   {- $anAriq -}        `gloss`  [ "cocoons", "hemp" ] ]
 ...
 |> "^s q '" <| [
    ...
    noun     FaCAL                     {- $aqA' -}          `gloss`  [ "suffering", "distress", "effort" ] ]
 ...
 |> "^s q .h" <| [
    ...
    verb     HaFCaL                    {- Oa$oqaH -}        -- `others` [ "^sqi.h IV_yu", "^sqa.h IV_Pass_yu" ]
    ...
    noun     HiFCAL                    {- Ii$oqAH -}        `gloss`  [ "removal", "distancing" ] ]
 ...
 |> "^s q ^s q" <| [
    ...
    noun     KaRDaS |< aT              {- $aqo$aqap -}      `gloss`  [ "chirping", "twittering" ],

    -- ;; $aqA$iq_1
    -- $qA$q   $aqA$iq Ndip    prattle

    noun     KaRADiS                   {- $aqA$iq -}        `gloss`  [ "prattle" ] ]
 ...
 |> "^s q _d f" <| [
    ...
    noun     KuRDuS                    {- $uqo*uf -}        -- `others` [ "^saqA_dif Ndip" ]
                                                            `gloss`  [ "sedan", "sedans" ] ]
 ...
 |> "^s q f" <| [
    ...
    noun     FuCAL |< aT               {- $uqAfap -}        `gloss`  [ "potsherds" ] ]
 ...
 |> "^s q l" <| [
    ...
    noun     FACUL                     {- $Aquwl -}         `gloss`  [ "plumb line" ] ]
 ...
 |> "^s q l b" <| [
    ...
    noun     KaRDaS |< aT              {- $aqolabap -}      `gloss`  [ "somersault" ],
 ...
 |> "^s q q" <| [
    ...
    verb     FaCCaL                    {- $aq~aq -}         -- `others` [ "^saqqiq IV_yu" ]
                                                            `gloss`  [ "split", "cut through" ],
    ...
    verb     TaFaCCaL                  {- ta$aq~aq -}       `gloss`  [ "be split" ],
    ...
    verb     InFaCL                    {- {ino$aq~ -}       -- `others` [ "in^saqaq PV_C_intr", "n^saqq IV_V_intr", "n^saqiq IV_C_intr" ]
                                                            `gloss`  [ "split off" ],
    ...
    verb     IFtaCL                    {- {i$otaq~ -}       -- `others` [ "i^staqaq PV_C", "^staqiq IV_C", "^staqq IV_V" ]
                                                            `gloss`  [ "derive" ],
    ...
    noun     MaFCUL                    {- ma$oquwq -}       `gloss`  [ "split open", "separated [ [ ma $ oquwq / ADJ ] ]" ],

    -- ;; mu$aq~aq_1
    -- m$qq    mu$aq~aq        N-ap    cracked

    noun     MuFaCCaL                  {- mu$aq~aq -}       `gloss`  [ "cracked" ],
 ...
 |> "^s q r" <| [
    ...
    noun     FuCL |< aT                {- $uqorap -}        `gloss`  [ "blond", "fair-skinned" ],
 ...
 |> "^s q r q" <| [
    ...
    noun     KaRDaS |< aT              {- $aqoraqap -}      `gloss`  [ "cheerfulness" ] ]
 ...
 |> "^s q w" <| [
    ...
    verb     FaCA                      {- $aqA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "^sqY IV_0_Pass_yu", "^squw IV_0hAnn", "^saqaw PV_Atn", "^sq IV_0hwnyn", "^sqay IV_Ann_Pass_yu", "^saq PV_ttAw" ]
                                                            `gloss`  [ "sadden", "distress", "be saddened", "be distressed" ],
    ...
    verb     HaFCY                     {- Oa$oqaY -}        -- `others` [ "^sqY IV_0_Pass_yu", "^sqiy IV_0hAnn_yu", "'a^sqA PV_h", "'a^sq PV_ttAw", "'a^sqay PV_Atn", "^sq IV_0hwnyn_yu", "^sqay IV_Ann_Pass_yu" ]
                                                            `gloss`  [ "sadden", "distress", "be saddened", "be distressed" ],

    -- ;; $aqow_1
    -- $qw     $aqow   N       misfortune;distress

    noun     FaCL                      {- $aqow -}          `gloss`  [ "misfortune", "distress" ],

    -- ;; $aqowap_1
    -- $qw     $aqow   Nap     misfortune;distress

    noun     FaCL |< aT                {- $aqowap -}        `gloss`  [ "misfortune", "distress" ],
    ...
    noun     FaCAL |< aT               {- $aqAwap -}        `gloss`  [ "misfortune", "distress" ],
    ...
    noun     HaFCY                     {- Oa$oqaY -}        -- `others` [ "'a^sqay NAn_Nayn", "'a^sqA Nhy" ]
                                                            `gloss`  [ "more / most wretched [ [ >a $ oqaY / ADJ ] ]", "more / most wretched", "most wretched" ] ]
 ...
 |> "^s q y" <| [
    ...
    verb     FaCiL                     {- $aqiy -}          -- `others` [ "^sqY IV_0", "^sqa IV_0hwnyn", "^sqay IV_Ann", "^saq PV_w_intr" ]
 ...
 |> "^s r '" <| [
    ...
    noun     IFtiCAL                   {- {i$otirA' -}      `gloss`  [ "purchase", "purchases" ] ]
 ...
 |> "^s r .h" <| [
    ...
    noun     FaCL |< Iy                {- $aroHiy~ -}       `gloss`  [ "explanatory", "illustrative [ [ $ aroHiy ~ / ADJ ] ]" ],
    ...
    noun     MaFCaL |< aT              {- ma$oraHap -}      `gloss`  [ "operating room", "operating table" ],
    ...
    noun     TaFCIL |< Iy              {- ta$oriyHiy~ -}    `gloss`  [ "dissecting", "anatomical [ [ ta $ oriyHiy ~ / ADJ ] ]" ],
 ...
 |> "^s r .t" <| [
    ...
    noun     FaCL |< aN                {- $aroTAF -}        -- `others` [ "^sar.t NF" ]
                                                            `gloss`  [ "on the condition", "provided [ [ $ aroT / ADV ] ]" ],
    ...
    noun     FaCL |< Iy                {- $aroTiy~ -}       `gloss`  [ "conditional [ [ $ aroTiy ~ / ADJ ] ]" ],

    -- ;; $aroTap_1
    -- $rT     $aroT   Nap     line;dash

    noun     FaCL |< aT                {- $aroTap -}        `gloss`  [ "line", "dash" ],
    ...
    noun     MuFACaL |< aT             {- mu$AraTap -}      `gloss`  [ "agreement", "stipulation" ],
    ...
    noun     IFtiCAL |< Iy |< aT       {- {i$otirATiy~ap -} `gloss`  [ "clause", "condition [ [ { i $ otirATiy ~ / NOUN ] ]" ],
 ...
 |> "^s r .t n" <| [
    ...
    noun     KaRDaS |< aT              {- $aroTanap -}      `gloss`  [ "consecration", "ordination", "simony" ],

    -- ;; $aroTuwniy~_1
    -- $rTwny  $aroTuwniy~     Nap     consecration;ordination;simony     [[$aroTuwniy~/NOUN]]

    noun     KaRDUS |< Iy              {- $aroTuwniy~ -}    `gloss`  [ "consecration", "ordination", "simony [ [ $ aroTuwniy ~ / NOUN ] ]" ],
 ...
 |> "^s r ^g" <| [
    ...
    noun     FaCaL |< Iy               {- $arajiy~ -}       `gloss`  [ "anal [ [ $ arajiy ~ / ADJ ] ]" ],
 ...
 |> "^s r ^s r" <| [
    ...
    noun     KaRADiS                   {- $arA$ir -}        `gloss`  [ "soul", "self" ] ]
 ...
 |> "^s r _d m" <| [
    ...
    noun     KiRDiS |< aT              {- $iro*imap -}      -- `others` [ "^sarA_diym Ndip", "^sarA_dim Ndip" ]
 ...
 |> "^s r `" <| [
    ...
    verb     HaFCaL                    {- Oa$oraE -}        -- `others` [ "^sri` IV_yu", "^sra` IV_Pass_yu" ]
    ...
    noun     FaCL |< Iy |< aN          {- $aroEiy~AF -}     -- `others` [ "^sar`iyy NF" ]
                                                            `gloss`  [ "legally", "legitimately [ [ $ aroEiy ~ / ADV ] ]" ],
    ...
    noun     FiCAL |< Iy               {- $irAEiy~ -}       `gloss`  [ "sailing [ [ $ irAEiy ~ / ADJ ] ]" ],

    -- ;; $ar~AEap_1
    -- $rAE    $ar~AE  Nap     peep hole

    noun     FaCCAL |< aT              {- $ar~AEap -}       `gloss`  [ "peep hole" ],
    ...
    noun     MaFCaL |< aT              {- ma$oraEap -}      -- `others` [ "ma^sAri` Ndip" ]
    ...
    noun     IFtiCAL |< Iy             {- {i$otirAEiy~ -}   `gloss`  [ "legislative [ [ { i $ otirAEiy ~ / ADJ ] ]" ],
    ...
    noun     MaFCUL |< Iy |< aT        {- ma$oruwEiy~ap -}  `gloss`  [ "legitimacy", "legality [ [ ma $ oruwEiy ~ / NOUN ] ]" ],
 ...
 |> "^s r b" <| [
    ...
    verb     HaFCaL                    {- Oa$orab -}        -- `others` [ "^srab IV_Pass_yu", "^srib IV_yu" ]
    ...
    noun     FaCL |< aT                {- $arobap -}        -- `others` [ "^surb Napdu", "^surab NAt" ]
    ...
    noun     FaCCAL                    {- $ar~Ab -}         `gloss`  [ "imbiber [ [ $ ar ~ Ab / ADJ ] ]" ],

    -- ;; $ariyb_1
    -- $ryb    $ariyb  N/ap    potable;drikable     [[$ariyb/ADJ]]

    noun     FaCIL                     {- $ariyb -}         `gloss`  [ "potable", "drikable [ [ $ ariyb / ADJ ] ]" ],

    -- ;; $ur~Abap_1
    -- $rAb    $ur~Ab  Nap     tassel;tuft
    -- $rAryb  $arAriyb        Ndip    tassels;tufts

    noun     FuCCAL |< aT              {- $ur~Abap -}       -- `others` [ "^sarAriyb Ndip" ]
                                                            `gloss`  [ "tassel", "tuft", "tassels", "tufts" ],

    -- ;; $ir~iyb_1
    -- $ryb    $ir~iyb N-ap    drunkard     [[$ir~iyb/ADJ]]

    noun     FiCCIL                    {- $ir~iyb -}        `gloss`  [ "drunkard [ [ $ ir ~ iyb / ADJ ] ]" ],
    ...
    noun     MaFCaL |< Iy |< aT        {- ma$orabiy~ap -}   `gloss`  [ "mashrabiya ( oriel window ) [ [ ma $ orabiy ~ / NOUN ] ]" ],

    -- ;; ma$orabiy~ap_2
    -- m$rby   ma$orabiy~      Nap     Mashrabiya

    noun     MaFCaL |< Iy |< aT        {- ma$orabiy~ap -}   `gloss`  [ "Mashrabiya" ],
    ...
    noun     FACiL                     {- $Arib -}          `gloss`  [ "drinking [ [ $ Arib / ADJ ] ]" ],
 ...
 |> "^s r b n" <| [
    ...
    noun     KaRDIS                    {- $arobiyn -}       `gloss`  [ "cedar" ] ]
 ...
 |> "^s r d" <| [
    ...
    verb     HaFCaL                    {- Oa$orad -}        -- `others` [ "^srad IV_Pass_yu", "^srid IV_yu" ]
    ...
    noun     FaCIL                     {- $ariyd -}         `gloss`  [ "dispossessed", "homeless [ [ $ ariyd / ADJ ] ]" ],
 ...
 |> "^s r f" <| [
    ...
    noun     FaCaL |< Iy               {- $arafiy~ -}       `gloss`  [ "honorary [ [ $ arafiy ~ / ADJ ] ]" ],
    ...
    noun     FiCAL |< aT               {- $irAfap -}        `gloss`  [ "office of sherif" ],
    ...
    noun     FuCCAL |< aT              {- $ur~Afap -}       -- `others` [ "^surrAf NAt" ]
    ...
    noun     FaCIL |< Iy               {- $ariyfiy~ -}      `gloss`  [ "sherif [ [ $ ariyfiy ~ / ADJ ] ]" ],
    ...
    noun     TaFCIL |< aT              {- ta$oriyfap -}     `gloss`  [ "bestowal of honors", "honoring" ],
    ...
    noun     MuFACaL |< aT             {- mu$Arafap -}      `gloss`  [ "supervision", "overview" ],
    ...
    noun     HiFCAL |< Iy              {- Ii$orAfiy~ -}     `gloss`  [ "supervisory", "directing" ],
 ...
 |> "^s r h" <| [
    ...
    noun     FaCiL                     {- $arih -}          `gloss`  [ "greedy", "gluttonous [ [ $ arih / ADJ ] ]" ],

    -- ;; $arAhap_1
    -- $rAh    $arAh   Nap     greed;gluttony

    noun     FaCAL |< aT               {- $arAhap -}        `gloss`  [ "greed", "gluttony" ] ]
 ...
 |> "^s r k" <| [
    ...
    verb     HaFCaL                    {- Oa$orak -}        -- `others` [ "^srik IV_yu", "^srak IV_Pass_yu" ]
    ...
    noun     IFtiCAL |< Iy             {- {i$otirAkiy~ -}   `gloss`  [ "socialist [ [ { i $ otirAkiy ~ / ADJ ] ]" ],

    -- ;; {i$otirAkiy~ap_1
    -- <$trAky {i$otirAkiy~    Nap     socialism     [[{i$otirAkiy~/NOUN]]
    -- A$trAky {i$otirAkiy~    Nap     socialism     [[{i$otirAkiy~/NOUN]]

    noun     IFtiCAL |< Iy |< aT       {- {i$otirAkiy~ap -} `gloss`  [ "socialism [ [ { i $ otirAkiy ~ / NOUN ] ]" ],
 ...
 |> "^s r k s" <| [
    ...
    noun     KaRDaS |< Iy              {- $arokasiy~ -}     -- `others` [ "^sarAkis Nap" ]
                                                            `gloss`  [ "Circassian [ [ $ arokasiy ~ / NOUN ] ]", "Circassian [ [ $ arokasiy ~ / ADJ ] ]", "Circassians" ] ]
 ...
 |> "^s r m" <| [
    ...
    noun     HaFCaL                    {- Oa$oram -}        -- `others` [ "^sarmA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "harelipped" ] ]
 ...
 |> "^s r m .t" <| [
    ...
    noun     KaRDUS |< aT              {- $aromuwTap -}     -- `others` [ "^sarAmiy.t Ndip" ]
                                                            `gloss`  [ "rag", "rags" ],
 ...
 |> "^s r n" <| [
    ...
    noun     FACUL                     {- $Aruwn -}         `gloss`  [ "Sharon" ],

    -- ;; $ar~Aniy~_1
    -- $rAny   $ar~Aniy~       Nall    evil;malicious;wicked     [[$ar~Aniy~/ADJ]]

    noun     FaCCAL |< Iy              {- $ar~Aniy~ -}      `gloss`  [ "evil", "malicious", "wicked [ [ $ ar ~ Aniy ~ / ADJ ] ]" ] ]
 ...
 |> "^s r n q" <| [
    ...
    noun     KaRDaS |< aT              {- $aronaqap -}      -- `others` [ "^sarAniq Ndip" ]
 ...
 |> "^s r q" <| [
    ...
    noun     FaCAL |< Iy               {- $arAqiy~ -}       `gloss`  [ "unirrigated land [ [ $ arAqiy ~ / ADJ ] ]" ],
    ...
    noun     FaCCAL |< aT              {- $ar~Aqap -}       `gloss`  [ "intake port", "intake pipe" ],
    ...
    noun     TaFCIL                    {- ta$oriyq -}       `gloss`  [ "Orientalization", "Easternization [ [ ta $ oriyq / NOUN ] ]" ],
    ...
    noun     HiFCAL |< aT              {- Ii$orAqap -}      `gloss`  [ "flash" ],
    ...
    noun     IstiFCAL |< Iy            {- {isoti$orAqiy~ -} `gloss`  [ "Orientalist [ [ { isoti $ orAqiy ~ / NOUN ] ]", "Orientalist [ [ { isoti $ orAqiy ~ / ADJ ] ]" ],
 ...
 |> "^s r r" <| [
    ...
    verb     FaCL                      {- $ar~-a -}         `imperf` [ FCaL ]
                                                            -- `others` [ "^srar IV_C_intr", "^sarir PV_C_intr" ]
    ...
    verb     FaCuL                     {- $arur-u -}        `imperf` [ FCuL ]
                                                            -- `others` [ "^srur IV_C_intr" ]
                                                            `gloss`  [ "be evil", "be malicious" ],
    ...
    noun     FaCL                      {- $ar~ -}           -- `others` [ "^suruwr N" ]
                                                            `gloss`  [ "evil", "malice" ],

    -- ;; $ar~Aniy~_1
    -- $rAny   $ar~Aniy~       Nall    evil;malicious;wicked     [[$ar~Aniy~/ADJ]]

    noun     FaCLAn |< Iy              {- $ar~Aniy~ -}      `gloss`  [ "evil", "malicious", "wicked [ [ $ ar ~ Aniy ~ / ADJ ] ]" ],

    -- ;; $ir~ap_1
    -- $r      $ir~    Nap     evil;malice

    noun     FiCL |< aT                {- $ir~ap -}         `gloss`  [ "evil", "malice" ],

    -- ;; $uruwrap_1
    -- $rwrp   $uruwrap        N0      Shurura (?? Saudi region)

    noun     FuCUL |< aT               {- $uruwrap -}       `gloss`  [ "Shurura ( ? ? Saudi region )" ],
    ...
    noun     FiCCIL                    {- $ir~iyr -}        `gloss`  [ "wicked", "evil", "bad", "Satan" ],

    -- ;; $arar_1
    -- $rr     $arar   N       sparks
    -- $rr     $arar   Napdu   spark

    noun     FaCaL                     {- $arar -}          `gloss`  [ "sparks", "spark" ],

    -- ;; $arariy~_1
    -- $rry    $arariy~        N-ap    spark     [[$arariy~/ADJ]]

    noun     FaCaL |< Iy               {- $arariy~ -}       `gloss`  [ "spark [ [ $ arariy ~ / ADJ ] ]" ],
    ...
    noun     FaCCAL                    {- $ar~Ar -}         `gloss`  [ "sparkling", "emitting sparks [ [ $ ar ~ Ar / ADJ ] ]" ] ]
 ...
 |> "^s r s f" <| [
    ...
    noun     KaRADiS |< Iy             {- $arAsifiy~ -}     `gloss`  [ "epigastric [ [ $ arAsifiy ~ / ADJ ] ]" ] ]
 ...
 |> "^s r w" <| [
    ...
    noun     FaCL |< aT                {- $arowap -}        `gloss`  [ "purchase", "buying" ],

    -- ;; $arowaY_1
    -- $rwY    $arowaY N0      peer
    -- $rwA    $arowA  Nhy     peer

    noun     FaCLY                     {- $arowaY -}        -- `others` [ "^sarwA Nhy" ]
                                                            `gloss`  [ "peer" ] ]
 ...
 |> "^s r y" <| [
    ...
    verb     FaCY                      {- $araY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ "^saray PV_Atn", "^sriy IV_0hAnn", "^srY IV_0_Pass_yu", "^sar PV_ttAw", "^sr IV_0hwnyn", "^sarA PV_h" ]
    ...
    noun     FaCL                      {- $aroy -}          `gloss`  [ "colocynth" ],
    ...
    noun     FiCY                      {- $iraY -}          -- `others` [ "^sirA Nhy", "'a^sriy Nap" ]
                                                            `gloss`  [ "purchase" ],
    ...
    noun     FACiL                     {- $Ariy -}          `gloss`  [ "lightning rod" ],
    ...
    noun     MuFtaCiL                  {- mu$otariy -}      `gloss`  [ "Jupiter" ],
    ...
    noun     MuFtaCY                   {- mu$otaraY -}      -- `others` [ "mu^staray NAt", "mu^staraw NAt", "mu^starA Nhy" ]
                                                            `gloss`  [ "purchased goods" ],

    -- ;; mu$otarayAt_1
    -- m$try   mu$otaray       NAt     purchases;purchasing

    noun     MuFtaCaL |< At            {- mu$otarayAt -}    -- `others` [ "mu^staray NAt" ]
 ...
 |> "^s r z" <| [
    ...
    noun     FICAL |< Iy               {- $iyrAziy~ -}      `gloss`  [ "from / of Shiraz [ [ $ iyrAziy ~ / ADJ ] ]" ] ]
 ...
 |> "^s s y" <| [
    ...
    noun     FACiL                     {- $Asiy -}          -- `others` [ "^sAsiyh NAt N" ]
                                                            `gloss`  [ "chassis" ] ]
 ...
 |> "^s t .t" <| [
    ...
    verb     IFCaLL                    {- {i$otaT~ -}       -- `others` [ "^sta.ti.t IV_C_intr", "i^sta.ta.t PV_C_intr", "^sta.t.t IV_V_intr" ]
                                                            `gloss`  [ "be excessive", "go too far" ] ]
 ...
 |> "^s t d" <| [
    ...
    verb     IFCaLL                    {- {i$otad~ -}       -- `others` [ "i^stadad PV_C", "^stadd IV_V", "^stadid IV_C" ]
                                                            `gloss`  [ "intensify" ],
    ...
    noun     IFCiLAL                   {- {i$otidAd -}      `gloss`  [ "intensification", "aggravation" ] ]
 ...
 |> "^s t f" <| [
    ...
    verb     IFCaLL                    {- {i$otaf~ -}       -- `others` [ "i^stafaf PV_C", "^stafif IV_C", "^staff IV_V" ]
                                                            `gloss`  [ "drink up", "consume" ] ]
 ...
 |> "^s t l" <| [
    ...
    noun     FaCL |< aT                {- $atolap -}        -- `others` [ "^satl N", "^sutuwl N", "^satal NAt" ]
 ...
 |> "^s t m" <| [
    ...
    noun     FaCIL                     {- $atiym -}         `gloss`  [ "insulted [ [ $ atiym / ADJ ] ]" ],
    ...
    noun     MuFACaL |< aT             {- mu$Atamap -}      `gloss`  [ "vilification", "insult" ],
    ...
    verb     IFCaLL                    {- {i$otam~ -}       -- `others` [ "^stamm IV_V", "i^stamam PV_C", "^stamim IV_C" ]
                                                            `gloss`  [ "smell", "sniff" ] ]
 ...
 |> "^s t n" <| [
    ...
    noun     FaCCAL                    {- $at~An -}         `gloss`  [ "what a difference", "how different" ] ]
 ...
 |> "^s t q" <| [
    ...
    verb     IFCaLL                    {- {i$otaq~ -}       -- `others` [ "i^staqaq PV_C", "^staqiq IV_C", "^staqq IV_V" ]
                                                            `gloss`  [ "derive" ],
    ...
    noun     IFCiLAL                   {- {i$otiqAq -}      `gloss`  [ "derivation" ],

    -- ;; {i$otiqAqiy~_1
    -- <$tqAqy {i$otiqAqiy~    N-ap    derivational     [[{i$otiqAqiy~/ADJ]]
    -- A$tqAqy {i$otiqAqiy~    N-ap    derivational     [[{i$otiqAqiy~/ADJ]]

    noun     IFCiLAL |< Iy             {- {i$otiqAqiy~ -}   `gloss`  [ "derivational [ [ { i $ otiqAqiy ~ / ADJ ] ]" ],
 ...
 |> "^s t t" <| [
    ...
    verb     FaCL                      {- $at~-i -}         `imperf` [ FCiL ]
                                                            -- `others` [ "^satat PV_Ct", "^stit IV_C", "^sitt IV_V" ]
    ...
    verb     FaCCaL                    {- $at~at -}         -- `others` [ "^sattit IV_yu" ]
                                                            `gloss`  [ "disperse", "scatter" ],
    ...
    verb     HaFaCL                    {- Oa$at~ -}         -- `others` [ "'a^stat PV_Ct", "^stit IV_C_yu", "^satt IV_V_Pass_yu", "^sitt IV_V_yu" ]
    ...
    verb     TaFaCCaL                  {- ta$at~at -}       `gloss`  [ "be dispersed", "be scattered" ],

    -- ;; $at~_1
    -- $t      $at~    N-ap    dispersed;scattered

    noun     FaCL                      {- $at~ -}           `gloss`  [ "dispersed", "scattered" ],
    ...
    noun     FaCLAn                    {- $at~An -}         `gloss`  [ "what a difference", "how different" ],
    ...
    verb     FaCLY                     {- $at~aY -}         -- `others` [ "^sattA PV_h", "^satt IV_0hwnyn_yu PV_ttAw", "^sattiy IV_0hAnn_yu", "^sattay PV_Atn IV_Ann_Pass_yu" ]
 ...
 |> "^s t w" <| [
    ...
    verb     FaCA                      {- $atA-u -}         `imperf` [ FCuL ]
                                                            -- `others` [ "^sataw PV_Atn", "^st IV_0hwnyn", "^sat PV_ttAw", "^stuw IV_0hAnn" ]
    ...
    noun     MaFCY                     {- ma$otaY -}        -- `others` [ "ma^stay NAn_Nayn", "ma^stA Nhy", "ma^sAtiy N0_Nh", "ma^sAt NK" ]
                                                            `gloss`  [ "winter residence", "winter resort", "winter residences", "winter resorts" ],

    -- ;; ma$otAp_1
    -- m$tA    ma$otA  Napdu   village of settled Bedouins

    noun     MaFCY |< aT               {- ma$otAp -}        `gloss`  [ "village of settled Bedouins" ],
    ...
    noun     FACI                      {- $Atiy -}          -- `others` [ "^sAt NK" ]
                                                            `gloss`  [ "wintry", "hibernal [ [ $ Atiy / ADJ ] ]", "hibernal" ],
    ...
    noun     MuFaCCY                   {- mu$at~aY -}       -- `others` [ "mu^sattay NAt NAn_Nayn", "mu^sattA Nhy" ]
                                                            `gloss`  [ "winter residence", "winter resort", "winter residences", "winter resorts" ],

    -- ;; $atawiy~_1
    -- $twy    $atawiy~        Nall    winter;wintery     [[$atawiy~/ADJ]]

    noun     FaCY |< Iy                {- $atawiy~ -}       `gloss`  [ "winter", "wintery [ [ $ atawiy ~ / ADJ ] ]" ] ]
 ...
 |> "^s w '" <| [
    ...
    noun     FiCAL                     {- $iwA' -}          `gloss`  [ "roasted", "broiled [ [ $ iwA ' / ADJ ] ]", "broiled" ],
    ...
    noun     FaCCAL                    {- $aw~A' -}         `gloss`  [ "seller of roast meat", "rotisseur" ] ]
 ...
 |> "^s w .z" <| [
    ...
    noun     FA'iL                     {- $A}iZ -}          `gloss`  [ "red hot", "ablaze [ [ $ A } iZ / ADJ ] ]" ] ]
 ...
 |> "^s w ^s" <| [
    ...
    noun     HaFCaL                    {- Oa$owa$ -}        -- `others` [ "^saw^sA' Nh Nhy N0_Nh", "'a^sAwi^s Ndip", "^suw^s N" ]
                                                            `gloss`  [ "brave", "hero [ [ >a $ owa $ / ADJ ] ]", "hero", "heroes", "proud", "audacious" ],
    ...
    noun     FuCL |< aT                {- $uw$ap -}         `gloss`  [ "tuft", "crest" ],

    -- ;; $awA$_1
    -- $wA$    $awA$   N       muddle;confusion

    noun     FaCAL                     {- $awA$ -}          `gloss`  [ "muddle", "confusion" ],

    -- ;; ta$owiy$_1
    -- t$wy$   ta$owiy$        NduAt   disturbance;distortion

    noun     TaFCIL                    {- ta$owiy$ -}       `gloss`  [ "disturbance", "distortion" ],

    -- ;; mu$aw~a$_1
    -- m$w$    mu$aw~a$        N-ap    disturbed;distorted     [[mu$aw~a$/ADJ]]

    noun     MuFaCCaL                  {- mu$aw~a$ -}       `gloss`  [ "disturbed", "distorted [ [ mu $ aw ~ a $ / ADJ ] ]" ],

    -- ;; mu$aw~i$_1
    -- m$w$    mu$aw~i$        Nall    distorting;confusing     [[mu$aw~i$/ADJ]]

    noun     MuFaCCiL                  {- mu$aw~i$ -}       `gloss`  [ "distorting", "confusing [ [ mu $ aw ~ i $ / ADJ ] ]" ],
 ...
 |> "^s w ^s r" <| [
    ...
    noun     KaRDaS |< aT              {- $awo$arap -}      `gloss`  [ "noise", "loud quarrel" ] ]
 ...
 |> "^s w _d r" <| [
    ...
    noun     KaRDaS                    {- $awo*ar -}        `gloss`  [ "chador" ] ]
 ...
 |> "^s w b" <| [
    ...
    noun     FaCL                      {- $awob -}          `gloss`  [ "diluting", "mixing" ],
    ...
    noun     FaCL                      {- $awob -}          -- `others` [ "'a^swAb N" ]
    ...
    noun     MaFUL                     {- ma$uwb -}         `gloss`  [ "mixed", "impure", "altered [ [ ma $ uwb / ADJ ] ]" ] ]
 ...
 |> "^s w f" <| [
    ...
    verb     FaCCaL                    {- $aw~af -}         -- `others` [ "^sawwif IV_yu" ]
                                                            `gloss`  [ "adorn" ],
    ...
    verb     TaFaCCaL                  {- ta$aw~af -}       `gloss`  [ "anticipate", "listen attentively" ],
    ...
    noun     FaCL |< aT                {- $awofap -}        `gloss`  [ "spectacle" ] ]
 ...
 |> "^s w h" <| [
    ...
    verb     FAL                       {- $Ah-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "^suh IV_C_intr PV_C_intr", "^suwh IV_V_intr" ]
    ...
    verb     TaFaCCaL                  {- ta$aw~ah -}       `gloss`  [ "be distorted", "be tarnished" ],

    -- ;; $awah_1
    -- $wh     $awah   N       distortion

    noun     FaCaL                     {- $awah -}          `gloss`  [ "distortion" ],
    ...
    noun     HaFCaL                    {- Oa$owah -}        -- `others` [ "^suwh N", "^sawhA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "distorted", "deformed [ [ >a $ owah / ADJ ] ]", "deformed" ],
    ...
    noun     FA'iL                     {- $A}ih -}          `gloss`  [ "distorted [ [ $ A } ih / ADJ ] ]" ],
    ...
    noun     FY |< aT                  {- $Ap -}            -- `others` [ "^siwAh N", "^siyAh N" ]
                                                            `gloss`  [ "sheep" ] ]
 ...
 |> "^s w k" <| [
    ...
    verb     FaCCaL                    {- $aw~ak -}         -- `others` [ "^sawwik IV_yu" ]
                                                            `gloss`  [ "sting", "prick" ],
    ...
    verb     HaFAL                     {- Oa$Ak -}          -- `others` [ "^siyk IV_V_yu", "^sAk IV_V_Pass_yu", "^sik IV_C_yu", "'a^sak PV_C", "^sak IV_C_Pass_yu" ]
    ...
    noun     FaCL |< aT                {- $awokap -}        `gloss`  [ "fork" ],

    -- ;; $awokap_2
    -- $wk     $awok   NapAt   thorn

    noun     FaCL |< aT                {- $awokap -}        `gloss`  [ "thorn" ],

    -- ;; $awokap_3
    -- $wk     $awok   Nap     bravery

    noun     FaCL |< aT                {- $awokap -}        `gloss`  [ "bravery" ],

    -- ;; $awokiy~_1
    -- $wky    $awokiy~        N-ap    thorny;prickly     [[$awokiy~/ADJ]]

    noun     FaCL |< Iy                {- $awokiy~ -}       `gloss`  [ "thorny", "prickly [ [ $ awokiy ~ / ADJ ] ]" ],
    ...
    noun     FaCiL                     {- $awik -}          `gloss`  [ "thorny", "prickly [ [ $ awik / ADJ ] ]" ] ]
 ...
 |> "^s w l" <| [
    ...
    noun     FACUL                     {- $Awuwl -}         `gloss`  [ "Shaul", "Saul" ],
    ...
    verb     FAL                       {- $Al-u -}          `imperf` [ FCuL ]
                                                            -- `others` [ "^sul PV_C IV_C", "^suwl IV_V" ]
                                                            `gloss`  [ "carry", "lift" ],
    ...
    verb     FaCCaL                    {- $aw~al -}         -- `others` [ "^sawwil IV_intr_yu" ]
                                                            `gloss`  [ "be sparse" ],
    ...
    verb     FACaL                     {- $Awal -}          -- `others` [ "^sAwil IV_yu" ]
                                                            `gloss`  [ "attack" ],
    ...
    verb     HaFAL                     {- Oa$Al -}          -- `others` [ "^sal IV_C_Pass_yu", "'a^sal PV_C", "^sAl IV_V_Pass_yu", "^siyl IV_V_yu", "^sil IV_C_yu" ]
                                                            `gloss`  [ "carry", "lift", "be carried", "be lifted" ],

    -- ;; $awolap_1
    -- $wl     $awol   NapAt   comma;sting

    noun     FaCL |< aT                {- $awolap -}        `gloss`  [ "comma", "sting" ],

    -- ;; $aw~Al_1
    -- $wAl    $aw~Al  N/At    Shawwal (month)
    -- $wAwyl  $awAwiyl        Ndip    months of Shawwal

    noun     FaCCAL                    {- $aw~Al -}         -- `others` [ "^sawAwiyl Ndip" ]
    ...
    noun     MiFCaL                    {- mi$owal -}        `gloss`  [ "sickle" ],

    -- ;; mi$owalap_1
    -- m$wl    mi$owal Nap     shot put

    noun     MiFCaL |< aT              {- mi$owalap -}      `gloss`  [ "shot put" ],

    -- ;; $awil_1
    -- $wl     $awil   Nall    expeditious;swift     [[$awil/ADJ]]

    noun     FaCiL                     {- $awil -}          `gloss`  [ "expeditious", "swift [ [ $ awil / ADJ ] ]" ],

    -- ;; $uwAl_1
    -- $wAl    $uwAl   N/At    sack

    noun     FuCAL                     {- $uwAl -}          `gloss`  [ "sack" ] ]
 ...
 |> "^s w l q" <| [
    ...
    noun     KaRDaS |< Iy              {- $awolaqiy~ -}     `gloss`  [ "sweet-toothed [ [ $ awolaqiy ~ / ADJ ] ]" ] ]
 ...
 |> "^s w m" <| [
    ...
    noun     FuCL |< aT                {- $uwmap -}         `gloss`  [ "stick", "cudgel" ] ]
 ...
 |> "^s w q" <| [
    ...
    verb     FaCCaL                    {- $aw~aq -}         -- `others` [ "^sawwiq IV_yu" ]
    ...
    verb     TaFaCCaL                  {- ta$aw~aq -}       `gloss`  [ "desire", "covet" ],
    ...
    noun     TaFCIL                    {- ta$owiyq -}       `gloss`  [ "excitation", "suspense" ],

    -- ;; ta$aw~uq_1
    -- t$wq    ta$aw~uq        N/At    desire;curiosity

    noun     TaFaCCuL                  {- ta$aw~uq -}       `gloss`  [ "desire", "curiosity" ],
    ...
    noun     FA'iL                     {- $A}iq -}          `gloss`  [ "exciting", "interesting [ [ $ A } iq / ADJ ] ]" ],

    -- ;; mu$aw~iq_1
    -- m$wq    mu$aw~iq        N-ap    stimulating;interesting     [[mu$aw~iq/ADJ]]

    noun     MuFaCCiL                  {- mu$aw~iq -}       `gloss`  [ "stimulating", "interesting [ [ mu $ aw ~ iq / ADJ ] ]" ],

    -- ;; mu$aw~aq_1
    -- m$wq    mu$aw~aq        N-ap    desirous     [[mu$aw~aq/ADJ]]

    noun     MuFaCCaL                  {- mu$aw~aq -}       `gloss`  [ "desirous [ [ mu $ aw ~ aq / ADJ ] ]" ],

    -- ;; mu$otAq_1
    -- m$tAq   mu$otAq Nall    yearning;desirous     [[mu$otAq/ADJ]]

    noun     MuFtAL                    {- mu$otAq -}        `gloss`  [ "yearning", "desirous [ [ mu $ otAq / ADJ ] ]" ] ]
 ...
 |> "^s w q y" <| [
    ...
    noun     KaRDiS                    {- $awoqiy -}        `gloss`  [ "Shawqi" ] ]
 ...
 |> "^s w r" <| [
    ...
    noun     MiFCAL                    {- mi$owAr -}        `gloss`  [ "cycle", "stroke" ],
    ...
    noun     HiFAL |< Iy               {- Ii$Ariy~ -}       -- `others` [ "'i^sAryy N-ap" ]
    ...
    noun     IstiFAL |< aT             {- {isoti$Arap -}    `gloss`  [ "consultation" ],
    ...
    noun     IstiFAL |< Iy             {- {isoti$Ariy~ -}   `gloss`  [ "advisory", "consultative", "consulting [ [ { isoti $ Ariy ~ / ADJ ] ]" ],
    ...
    noun     MustaFAL |< Iy |< aT      {- musota$Ariy~ap -} `gloss`  [ "chancellery" ],
 ...
 |> "^s w r b" <| [
    ...
    noun     MuKaRDaS                  {- mu$aworab -}      `gloss`  [ "mustachioed [ [ mu $ aworab / ADJ ] ]" ] ]
 ...
 |> "^s w y" <| [
    ...
    verb     FaCY                      {- $awaY-i -}        `imperf` [ FCiL ]
                                                            -- `others` [ "^swY IV_0_Pass_yu", "^saw PV_ttAw", "^saway PV_Atn", "^sw IV_0hwnyn", "^swiy IV_0hAnn", "^sawA PV_h" ]
    ...
    noun     FiCA'                     {- $iwA' -}          `gloss`  [ "roasted", "broiled [ [ $ iwA ' / ADJ ] ]", "broiled" ],

    -- ;; $awiy~_1
    -- $wy     $awiy~  N-ap    roasted;broiled     [[$awiy~/ADJ]]

    noun     FY |< Iy                  {- $awiy~ -}         `gloss`  [ "roasted", "broiled [ [ $ awiy ~ / ADJ ] ]" ],
    ...
    noun     FaCY |< aT                {- $awAp -}          -- `others` [ "^sawY N0", "^sawA Nhy" ]
                                                            `gloss`  [ "scalp", "scalps" ],

    -- ;; $aw~Ayap_1
    -- $wAy    $aw~Ay  NapAt   grill;gridiron

    noun     FaCCAL |< aT              {- $aw~Ayap -}       `gloss`  [ "grill", "gridiron" ],
    ...
    noun     MiFCY |< aT               {- mi$owAp -}        -- `others` [ "ma^sAwiy N0_Nh", "ma^sAw NK" ]
    ...
    noun     MaFCIy                    {- ma$owiy~ -}       `gloss`  [ "roasted", "broiled [ [ ma $ owiy ~ / ADJ ] ]", "grilled food [ [ ma $ owiy ~ / NOUN ] ]" ],

    -- ;; $uway~ap_1
    -- $wy     $uway~  Nap     a little bit

    noun     FuCayL |< aT              {- $uway~ap -}       `gloss`  [ "a little bit" ] ]
 ...
 |> "^s y '" <| [
    ...
    verb     TaFaCCaL                  {- ta$ay~aO -}       -- `others` [ "ta^sayya'A PV-|_intr IV-|" ]
                                                            `gloss`  [ "calm down" ],
    ...
    noun     FaCL |< Iy                {- $ayo}iy~ -}       `gloss`  [ "objective", "factual [ [ $ ayo } iy ~ / ADJ ] ]" ],

    -- ;; $ayo}iy~ap_1
    -- $y}y    $ayo}iy~        Nap     objective;target

    noun     FaCL |< Iy |< aT          {- $ayo}iy~ap -}     `gloss`  [ "objective", "target" ],

    -- ;; ta$oyi}ap_1
    -- t$y}    ta$oyi} NapAt   reification

    noun     TaFCiL |< aT              {- ta$oyi}ap -}      `gloss`  [ "reification" ],
    ...
    noun     TaFaCCuL                  {- ta$ay~u' -}       `gloss`  [ "reification" ],
 ...
 |> "^s y .h" <| [
    ...
    verb     HaFAL                     {- Oa$AH -}          -- `others` [ "^si.h IV_C_yu", "'a^sa.h PV_C", "^sA.h IV_V_Pass_yu", "^sa.h IV_C_Pass_yu", "^siy.h IV_V_yu" ]
                                                            `gloss`  [ "avert the eyes", "turn away", "be averted ( eyes )", "be turned away" ],

    -- ;; $iyH_1
    -- $yH     $iyH    N       absinthe

    noun     FiCL                      {- $iyH -}           `gloss`  [ "absinthe" ],

    -- ;; $iyHiy~_1
    -- $yHy    $iyHiy~ N0      Shehhi

    noun     FiCL |< Iy                {- $iyHiy~ -}        `gloss`  [ "Shehhi" ],

    -- ;; $ay~AH_1
    -- $yAH    $ay~AH  N       blotting paper

    noun     FaCCAL                    {- $ay~AH -}         `gloss`  [ "blotting paper" ],

    -- ;; $ay~AHap_1
    -- $yAH    $ay~AH  Nap     blotter

    noun     FaCCAL |< aT              {- $ay~AHap -}       `gloss`  [ "blotter" ] ]
 ...
 |> "^s y .t" <| [
    ...
    verb     FAL                       {- $AT-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "^si.t IV_C_intr PV_C_intr", "^siy.t IV_V_intr" ]
                                                            `gloss`  [ "be burned" ],
    ...
    verb     FaCCaL                    {- $ay~aT -}         -- `others` [ "^sayyi.t IV_yu" ]
                                                            `gloss`  [ "scorch", "sear" ],
    ...
    verb     HaFAL                     {- Oa$AT -}          -- `others` [ "^si.t IV_C_yu", "^sa.t IV_C_Pass_yu", "'a^sa.t PV_C", "^sA.t IV_V_Pass_yu", "^siy.t IV_V_yu" ]
    ...
    verb     TaFaCCaL                  {- ta$ay~aT -}       `gloss`  [ "be burned" ],
    ...
    noun     TaFCIL                    {- ta$oyiyT -}       `gloss`  [ "burning" ],

    -- ;; <i$ATap_1
    -- <$AT    <i$AT   NapAt   burning
    -- A$AT    <i$AT   NapAt   burning

    noun     HiFAL |< aT               {- Ii$ATap -}        `gloss`  [ "burning" ],

    -- ;; {isoti$ATap_1
    -- <st$AT  {isoti$AT       NapAt   burning
    -- Ast$AT  {isoti$AT       NapAt   burning

    noun     IstiFAL |< aT             {- {isoti$ATap -}    `gloss`  [ "burning" ],

    -- ;; mu$ay~aT_1
    -- m$yT    mu$ay~aT        N-ap    burned     [[mu$ay~aT/ADJ]]

    noun     MuFaCCaL                  {- mu$ay~aT -}       `gloss`  [ "burned [ [ mu $ ay ~ aT / ADJ ] ]" ] ]
 ...
 |> "^s y .t n" <| [
    ...
    noun     KaRDaS |< aT              {- $ayoTanap -}      `gloss`  [ "devilry", "villainy", "evil" ] ]
 ...
 |> "^s y _h" <| [
    ...
    verb     TaFaCCaL                  {- ta$ay~ax -}       `gloss`  [ "grow old", "become a sheikh" ],
    ...
    noun     FaCL |< aT                {- $ayoxap -}        `gloss`  [ "matron", "elderly woman" ],

    -- ;; $iyAxap_1
    -- $yAx    $iyAx   Nap     position of Sheikh

    noun     FiCAL |< aT               {- $iyAxap -}        `gloss`  [ "position of Sheikh" ],
    ...
    noun     MaFCaL |< Iy              {- ma$oyaxiy~ -}     `gloss`  [ "senatorial [ [ ma $ oyaxiy ~ / ADJ ] ]" ],

    -- ;; ma$oyaxiy~_2
    -- m$yxy   ma$oyaxiy~      Nall    Presbyterian     [[ma$oyaxiy~/ADJ]]

    noun     MaFCaL |< Iy              {- ma$oyaxiy~ -}     `gloss`  [ "Presbyterian [ [ ma $ oyaxiy ~ / ADJ ] ]" ] ]
 ...
 |> "^s y `" <| [
    ...
    noun     MuFACaL |< aT             {- mu$AyaEap -}      `gloss`  [ "partisanship", "affiliation" ],
    ...
    noun     HiFAL |< Iy |< aT         {- Ii$AEiy~ap -}     `gloss`  [ "collectivism [ [" ],
    ...
    noun     FACiL |< aT               {- $AyiEap -}        -- `others` [ "^sAyi` NAt" ]
                                                            `gloss`  [ "rumor", "rumors" ],
    ...
    noun     MuFAL                     {- mu$AE -}          `gloss`  [ "widespread", "well-known [ [ mu $ AE / ADJ ] ]" ],

    -- ;; muta$ay~iE_1
    -- mt$yE   muta$ay~iE      Nall    partisan;biased     [[muta$ay~iE/ADJ]]

    noun     MutaFaCCiL                {- muta$ay~iE -}     `gloss`  [ "partisan", "biased [ [ muta $ ay ~ iE / ADJ ] ]" ],
 ...
 |> "^s y b" <| [
    ...
    verb     FAL                       {- $Ab-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "^sib IV_C_intr PV_C_intr", "^siyb IV_V_intr" ]
    ...
    verb     FaCCaL                    {- $ay~ab -}         -- `others` [ "^sayyib IV_yu" ]
    ...
    verb     HaFAL                     {- Oa$Ab -}          -- `others` [ "^sab IV_C_Pass_yu", "^sAb IV_V_Pass_yu", "^sib IV_C_yu", "^siyb IV_V_yu", "'a^sab PV_C" ]
                                                            `gloss`  [ "make old", "make the hair turn gray", "be made old", "be turned gray ( hair )" ],

    -- ;; $ayob_1
    -- $yb     $ayob   N       gray hair;old age

    noun     FaCL                      {- $ayob -}          `gloss`  [ "gray hair", "old age" ],

    -- ;; $A}ib_1
    -- $A}b    $A}ib   Nall    gray-haired;old     [[$A}ib/ADJ]]

    noun     FA'iL                     {- $A}ib -}          `gloss`  [ "gray-haired", "old [ [ $ A } ib / ADJ ] ]" ],
    ...
    noun     HaFCaL                    {- Oa$oyab -}        -- `others` [ "^saybA' Nh Nhy N0_Nh", "^siyb N" ]
                                                            `gloss`  [ "gray-haired", "old [ [ >a $ oyab / ADJ ] ]", "old" ],

    -- ;; $iybap_1
    -- $ybp    $iybap  N0      Shibh;Shibah

    noun     FiCL |< aT                {- $iybap -}         `gloss`  [ "Shibh", "Shibah" ],

    -- ;; $ayobAn_1
    -- $ybAn   $ayobAn N-ap    old

    noun     FaCLAn                    {- $ayobAn -}        `gloss`  [ "old" ],

    -- ;; $ayobAniy~_1
    -- $ybAny  $ayobAniy~      N-ap    old     [[$ayobAniy~/ADJ]]

    noun     FaCLAn |< Iy              {- $ayobAniy~ -}     `gloss`  [ "old [ [ $ ayobAniy ~ / ADJ ] ]" ],

    -- ;; $ayobap_1
    -- $yb     $ayob   Nap     absinthe

    noun     FaCL |< aT                {- $ayobap -}        `gloss`  [ "absinthe" ] ]
 ...
 |> "^s y b '" <| [
    ...
    noun     KaRDAS                    {- $ayobA' -}        `gloss`  [ "Shaiba" ] ]
 ...
 |> "^s y d" <| [
    ...
    noun     FiCL                      {- $iyd -}           `gloss`  [ "plaster", "mortar" ],
    ...
    noun     MuFaCCaL                  {- mu$ay~ad -}       `gloss`  [ "lofty [ [ mu $ ay ~ ad / ADJ ] ]" ],

    -- ;; mu$ay~id_1
    -- m$yd    mu$ay~id        Nall    builder;constructor

    noun     MuFaCCiL                  {- mu$ay~id -}       `gloss`  [ "builder", "constructor" ] ]
 ...
 |> "^s y f" <| [
    ...
    noun     HaFCAL                    {- Oa$oyAf -}        `gloss`  [ "slices", "cuts" ],
 ...
 |> "^s y k" <| [
    ...
    noun     FiCAL |< aT               {- $iyAkap -}        `gloss`  [ "elegance" ],

    -- ;; >a$oyak_1
    -- >$yk    >a$oyak Nel     more/most chic     [[>a$oyak/ADJ]]
    -- A$yk    >a$oyak Nel     more/most chic

    noun     HaFCaL                    {- Oa$oyak -}        `gloss`  [ "more / most chic [ [ >a $ oyak / ADJ ] ]", "more / most chic" ] ]
 ...
 |> "^s y l" <| [
    ...
    noun     FaCL |< aT                {- $ayolap -}        `gloss`  [ "burden", "load" ],

    -- ;; $iyAlap_1
    -- $yAl    $iyAl   Nap     transportation;porterage

    noun     FiCAL |< aT               {- $iyAlap -}        `gloss`  [ "transportation", "porterage" ],

    -- ;; $ay~Al_1
    -- $yAl    $ay~Al  Nall    porter;carrier

    noun     FaCCAL                    {- $ay~Al -}         `gloss`  [ "porter", "carrier" ],

    -- ;; $iyliy~_1
    -- $yly    $iyliy~ Nall    Chilean     [[$iyliy~/NOUN]]
    -- $yly    $iyliy~ Nall    Chilean     [[$iyliy~/ADJ]]

    noun     FIL |< Iy                 {- $iyliy~ -}        `gloss`  [ "Chilean [ [ $ iyliy ~ / NOUN ] ]", "Chilean [ [ $ iyliy ~ / ADJ ] ]" ],

    -- ;; $iyliy~_1
    -- $yly    $iyliy~ Nall    Chilean     [[$iyliy~/NOUN]]
    -- $yly    $iyliy~ Nall    Chilean     [[$iyliy~/ADJ]]

    noun     FiCL |< Iy                {- $iyliy~ -}        `gloss`  [ "Chilean [ [ $ iyliy ~ / NOUN ] ]", "Chilean [ [ $ iyliy ~ / ADJ ] ]" ] ]
 ...
 |> "^s y m" <| [
    ...
    verb     FAL                       {- $Am-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "^siym IV_V_intr", "^sim IV_C_intr PV_C_intr" ]
 ...
 |> "^s y m y" <| [
    ...
    noun     KiRDiS |< aT              {- $iymiyap -}       -- `others` [ "^sayAmiy N0" ]
 ...
 |> "^s y n" <| [
    ...
    noun     FACL                      {- $Ayon -}          `gloss`  [ "Sean", "Shine" ],
    ...
    verb     FAL                       {- $An-i -}          `imperf` [ FCiL ]
                                                            -- `others` [ "^sin PV_Cn IV-n", "^siyn IV_V" ]
    ...
    verb     FaCCaL                    {- $ay~an -}         -- `others` [ "^sayyin IV-n_yu" ]
                                                            `gloss`  [ "disfigure", "disgrace" ],

    -- ;; $ayon_1
    -- $yn     $ayon   N       disfigurement;disgracing

    noun     FaCL                      {- $ayon -}          `gloss`  [ "disfigurement", "disgracing" ],
    ...
    noun     MuFaCCiL                  {- mu$ay~in -}       `gloss`  [ "disgraceful [ [ mu $ ay ~ in / ADJ ] ]" ],

    -- ;; $ay~in_1
    -- $yn     $ay~in  N-ap    disgraceful     [[$ay~in/ADJ]]

    noun     FaCCiL                    {- $ay~in -}         `gloss`  [ "disgraceful [ [ $ ay ~ in / ADJ ] ]" ],

    -- ;; $iyn_1
    -- $yn     $iyn    NduAt   shin (Arabic letter)

    noun     FiCL                      {- $iyn -}           `gloss`  [ "shin ( Arabic letter )" ],

    -- ;; $iyn_2
    -- $yn     $iyn    N0      Shin (1st word in "Shin Bet")

    noun     FiCL                      {- $iyn -}           `gloss`  [ "Shin ( 1st word in `` Shin Bet '' )" ] ]
 ...
 |> "^s y q" <| [
    ...
    noun     FaCCiL                    {- $ay~iq -}         `gloss`  [ "desirous", "thrilling [ [ $ ay ~ iq / ADJ ] ]" ],

    -- ;; {i$otiyAq_1
    -- <$tyAq  {i$otiyAq       N/At    desire;craving
    -- A$tyAq  {i$otiyAq       N/At    desire;craving

    noun     IFtiCAL                   {- {i$otiyAq -}      `gloss`  [ "desire", "craving" ] ]
 ...
 |> "^s y r" <| [
    ...
    noun     FiCL |< aT                {- $iyrap -}         `gloss`  [ "refreshment" ] ]
 ...
 |> "^s y r z" <| [
    ...
    noun     KiRDAS |< Iy              {- $iyrAziy~ -}      `gloss`  [ "from / of Shiraz [ [ $ iyrAziy ~ / ADJ ] ]" ] ]
 ...
 |> "^s y w `" <| [
    ...
    verb     TaKaRDaS                  {- ta$ayowaE -}      `gloss`  [ "become communist", "be pro-communist" ] ]
 ...
 |> "^s y y" <| [
    ...
    noun     FaCL                      {- $ay~ -}           `gloss`  [ "roasting", "grilling" ],

    -- ;; $ay~At_1
    -- $yAt    $ay~At  N       shoe-shine

    noun     FaCL |< At                {- $ay~At -}         `gloss`  [ "shoe-shine" ] ]
 ...
 |> "^s z r" <| [
    ...
    noun     HaFCaL                    {- Oa$ozar -}        -- `others` [ "^sazrA' Nh Nhy N0_Nh" ]
                                                            `gloss`  [ "askance looking", "distrustful [ [ >a $ ozar / ADJ ] ]", "distrustful" ] ]
 ...
 |> "^sAhAn" <| [
    ...
    noun     Identity |< Iy            {- $AhAniy~ -}       `gloss`  [ "Shah-related", "imperial [ [ $ AhAniy ~ / NOUN ] ]", "imperial [ [ $ AhAniy ~ / ADJ ] ]" ] ]
 ...
 |> "^sAwirm" <| [
    ...
    noun     Identity |< aT            {- $Awirmap -}       -- `others` [ "^sawirmA N0", "^sawirm Nap", "^sAwirmA N0" ]
 ...
 |> "^sAwiy^s" <| [
    ...
    noun     Identity                  {- $Awiy$ -}         -- `others` [ "^sAwiy^siyy Nap" ]
                                                            `gloss`  [ "police sergeant", "police sergeants [ [ $ Awiy $ iy ~ / NOUN ] ]" ] ]
 ...
 |> "^sa.g.giyl" <| [
    ...
    noun     Identity                  {- $ag~iyl -}        `gloss`  [ "hard-working", "laboring [ [ $ ag ~ iyl / ADJ ] ]" ] ]
 ...
 |> "^sa.tra" <| [
    ...
    noun     Identity                  {- $aTora -}         `gloss`  [ "towards [ [ $ aTora / PREP ] ]" ] ]
 ...
 |> "^sa.tran^g" <| [
    ...
    noun     Identity |< Iy            {- $aToranojiy~ -}   `gloss`  [ "chess [ [ $ aToranojiy ~ / ADJ ] ]" ] ]
 ...
 |> "^sa^sa_hAn" <| [
    ...
    noun     Identity                  {- $a$axAn -}        `gloss`  [ "gun barrel" ],

    -- ;; $a$axAnap_1
    -- $$xAn   $a$axAn Nap     firearms

    noun     Identity |< aT            {- $a$axAnap -}      `gloss`  [ "firearms" ] ]
 ...
 |> "^sa^sm" <| [
    ...
    noun     Identity |< aT            {- $a$omap -}        `gloss`  [ "toilet" ] ]
 ...
 |> "^sa`niyn" <| [
    ...
    noun     Identity |< aT            {- $aEoniynap -}     -- `others` [ "^sa`Aniyn Ndip" ]
                                                            `gloss`  [ "palm branch" ] ]
 ...
 |> "^sahwAniyy" <| [
    ...
    noun     Identity                  {- $ahowAniy~ -}     `gloss`  [ "covetous", "debauched [ [ $ ahowAniy ~ / ADJ ] ]" ] ]
 ...
 |> "^say_huw_h" <| [
    ...
    noun     Identity |< Iy            {- $ayoxuwxiy~ -}    `gloss`  [ "old age", "senior [ [ $ ayoxuwxiy ~ / ADJ ] ]" ] ]
 ...
 |> "^si^sm" <| [
    ...
    noun     Identity                  {- $i$om -}          `gloss`  [ "eye powder" ] ]
 ...
 |> "^si^sn" <| [
    ...
    noun     Identity |< Iy            {- $i$oniy~ -}       `gloss`  [ "specimen", "sampling" ] ]
 ...
 |> "^sifA'iyy" <| [
    ...
    noun     Identity                  {- $ifA}iy~ -}       `gloss`  [ "healing", "curative", "medicinal [ [ $ ifA } iy ~ / ADJ ] ]" ] ]
 ...
 |> "^sifAhiyy" <| [
    ...
    noun     Identity                  {- $ifAhiy~ -}       `gloss`  [ "oral", "verbal [ [ $ ifAhiy ~ / ADJ ] ]" ] ]
 ...
 |> "^siryAniyy" <| [
    ...
    noun     Identity                  {- $iroyAniy~ -}     `gloss`  [ "arterial [ [ $ iroyAniy ~ / ADJ ] ]" ] ]
 ...
 |> "^siyzuwfrAn" <| [
    ...
    noun     Identity |< Iy            {- $iyzuwfrAniy~ -}  `gloss`  [ "schizophrenic [ [ $ iyzuwfrAniy ~ / ADJ ] ]" ] ]
 ...
 |> "^su'buwb" <| [
    ...
    noun     Identity                  {- $uWobuwb -}       -- `others` [ "^sa'Abiyb Ndip" ]
 ...
 |> "^su_hliyl" <| [
    ...
    noun     Identity |< aT            {- $uxoliylap -}     `gloss`  [ "rattle" ] ]
 ...
 |> "^sukuwlAt" <| [
    ...
    noun     Identity |< Iy            {- $ukuwlAtiy~ -}    -- `others` [ "^suwkuwlAtiyy Nall", "^sukuwlA.tiyy Nall", "^siykuwlAtiyy Nall", "^sukulA.tiyy Nall" ]
                                                            `gloss`  [ "chocolate [ [ $ ukuwlAtiy ~ / ADJ ] ]", "chocolate [ [ $ uwkuwlAtiy ~ / ADJ ] ]", "chocolate [ [ $ iykuwlAtiy ~ / ADJ ] ]", "chocolate [ [ $ ukuwlATiy ~ / ADJ ] ]", "chocolate [ [ $ ukulATiy ~ / ADJ ] ]" ] ]
 ...
 |> "^suwfiyniyy" <| [
    ...
    noun     Identity                  {- $uwfiyniy~ -}     `gloss`  [ "chauvinist [ [ $ uwfiyniy ~ / ADJ ] ]" ],

    -- ;; $uwfiyniy~ap_1
    -- $wfyny  $uwfiyniy~      Nap     chauvinism

    noun     Identity |< aT            {- $uwfiyniy~ap -}   `gloss`  [ "chauvinism" ] ]
 ...
 |> "i^sma'azz" <| [
    ...
    verb     Identity                  {- {i$omaOaz~ -}     -- `others` [ "^sma'ziz IV_C_intr", "i^sma'zaz PV_C_intr", "^sma'izz IV_V_intr" ]
 ...
 |> "i^sra'abb" <| [
    ...
    verb     Identity                  {- {i$oraOab~ -}     -- `others` [ "i^sra'bab PV_C", "^sra'bib IV_C", "^sra'ibb IV_V" ]
 ...
 |> "isti^sfA'iyy" <| [
    ...
    noun     Identity                  {- {isoti$ofA}iy~ -} `gloss`  [ "hospitalization [ [ { isoti $ ofA } iy ~ / ADJ ] ]" ] ]
 ...
 |> "mu^sA.h.h" <| [
    ...
    noun     Identity |< aT            {- mu$AH~ap -}       `gloss`  [ "contestable", "disputable [ [ mu $ AH ~ / ADJ ] ]" ] ]
 ...
 |> "mu^sma_hirr" <| [
    ...
    noun     Identity                  {- mu$omaxir~ -}     `gloss`  [ "lofty", "towering [ [ mu $ omaxir ~ / ADJ ] ]" ] ]
 ...
 |> "ta^sriyfAt" <| [
    ...
    noun     Identity |< Iy            {- ta$oriyfAtiy~ -}  `gloss`  [ "ceremonial [ [ ta $ oriyfAtiy ~ / ADJ ] ]" ] ]
