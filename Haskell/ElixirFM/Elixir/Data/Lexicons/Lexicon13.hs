...
lexicon = listing "Lexicon properties"
 ...
 |> "^s ^s f" <| [
    ...
    CaL |< aN                 `noun`       {- $afAF -}          [ "brink", "verge", "edge", "edges" ] ]
 ...
 |> "^s ^s t" <| [
    ...
    CaL |< At                 `noun`       {- $atAt -}          [ "dispersed", "scattered" ] ]
 ...
 |> "^s ` r w" <| [
    ...
    KaRDAS |< Iy              `noun`       {- $aEorAwiy~ -}     [ "Sha'rawi" ] ]
 ...
 |> "^s r q w" <| [
    ...
    KaRDAS |< Iy              `noun`       {- $aroqAwiy~ -}     [ "Sharqawi" ] ]
