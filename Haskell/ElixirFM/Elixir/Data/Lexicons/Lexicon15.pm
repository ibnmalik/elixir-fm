...
$lexicon = {
  ...
  '.d \' q' => [
    {
      'types' => $lexicon->{'.d y q'}[8]{'types'},
      'entry' => '.dA\'iq',
      'form' => '.dA\'iqaT',
      'others' => $lexicon->{'.d y q'}[8]{'others'},
      'lines' => $lexicon->{'.d y q'}[8]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACiL',
      'suffix' => ' |< aT',
      'glosses' => $lexicon->{'.d y q'}[8]{'glosses'},
      'glosshash' => $lexicon->{'.d y q'}[8]{'glosshash'},
      'orig' => 'DA}iqap',
      'prefix' => ''
    }
  ],
  ...
  '.d .t r' => [
    {
      'types' => $lexicon->{'.d r r'}[7]{'types'},
      'entry' => 'mu.d.tarr',
      'form' => 'mu.d.tarr',
      'lines' => $lexicon->{'.d r r'}[7]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'MuFCaLL',
      'suffix' => '',
      'glosses' => $lexicon->{'.d r r'}[7]{'glosses'},
      'glosshash' => $lexicon->{'.d r r'}[7]{'glosshash'},
      'orig' => 'muDoTar~',
      'prefix' => ''
    }
  ],
  ...
  '.d .h ' => [
    {
      'types' => $lexicon->{'.d .h y'}[0]{'types'},
      'entry' => '.dA.hiy',
      'form' => '.dA.hiyaT',
      'others' => $lexicon->{'.d .h y'}[0]{'others'},
      'lines' => $lexicon->{'.d .h y'}[0]{'lines'},
      'index' => '1',
      'entity' => 'noun',
      'morphs' => 'FACI',
      'suffix' => ' |< aT',
      'glosses' => $lexicon->{'.d .h y'}[0]{'glosses'},
      'glosshash' => $lexicon->{'.d .h y'}[0]{'glosshash'},
      'orig' => 'DAHiyap',
      'prefix' => ''
    },
    {
