...
module Elixir.Data.Moony.Complex.M (section) where
...
cluster_2   = cluster
 ...
 |> "k w y" <| [
    ...
    MaFCY |<< "^g" |< Iy      `noun`    {- <makwa^gIy> -}      [ unwords [ ['i','r','o','n','i','n','g'], ['m','a','n'] ], ['l','a','u','n','d','r','y','m','a','n'] ]
                              `plural`     MaFCY |<< "^g" |< Iy |< Un,

    MaFCY |<< "^g" |< Iy |< aT `noun`    {- <makwa^gIyaT> -}    [ unwords [ ['i','r','o','n','i','n','g'], ['l','a','d','y'] ], ['l','a','u','n','d','r','y','w','o','m','a','n'] ]
                              `plural`     MaFCY |<< "^g" |< Iy |< At,
...
cluster_4   = cluster
 ...
 |> ['k','a','y'] <| [
    ...
    "li-" >>| _____           `conj`    {- <li-kay> -}         [ unwords [ ['i','n'], ['o','r','d','e','r'], ['t','o'] ] ],

    _____ |<< "mA"            `conj`    {- <kaymA> -}          [ unwords [ ['i','n'], ['o','r','d','e','r'], ['t','o'] ] ],

    "li-" >>| _____ |<< "mA"  `conj`    {- <li-kaymA> -}       [ unwords [ ['i','n'], ['o','r','d','e','r'], ['t','o'] ] ] ]
...
cluster_5   = cluster
 ...
 |> "k y t" <| [
    ...
    FaCL |<< "a"              `part`    {- <kayta> -}          [ ['s','u','c','h'], ['t','h','u','s'] ] ]
...
cluster_8   = cluster
 ...
 |> "k y s" <| [
    ...
    MuFaCCiL |< At |< Iy      `noun`    {- <mukayyisAtIy> -}   [ unwords [ ['b','a','t','h'], ['a','t','t','e','n','d','a','n','t'] ], ['m','a','s','s','e','u','r'] ]
                              `plural`     MuFaCCiL |< At |< Iy |< Un
                              `femini`     MuFaCCiL |< At |< Iy |< aT,
...
cluster_9   = cluster
 ...
 |> "k y f" <| [
    ...
    FaCL |<< "a"              `pron`    {- <kayfa> -}          [ ['h','o','w'] ],

    FaCL |<< "a" |<< "mA"     `conj`    {- <kayfamA> -}        [ ['w','h','i','c','h','e','v','e','r'], ['h','o','w','e','v','e','r'] ],
    ...
    MuFaCCaL                  `adj`     {- <mukayyaf> -}       [ ['c','o','n','d','i','t','i','o','n','e','d'] ] ]
...
cluster_17  = cluster
 ...
 |> "m ' q" <| [
    ...
    FuCL                      `noun`    {- <mu'q> -}           [ unwords [ ['i','n','n','e','r'], ['c','o','r','n','e','r'], ['o','f'], ['t','h','e'], ['e','y','e'] ] ]
                              `plural`     HAFAL ]
...
cluster_27  = cluster
 ...
 |> ['m','I','^','g','A','w','A','t'] <| [
    ...
    _____                     `noun`    {- <mI^gAwAt> -}       [ ['m','e','g','a','w','a','t','t'] ] ]
...
cluster_30  = cluster
 ...
 |> "m .h w" <| [
    ...
    FaCA                      `verb`    {- <ma.hA> -}          [ unwords [ ['w','i','p','e'], ['o','u','t'] ], ['e','r','a','d','i','c','a','t','e'], ['e','x','t','e','r','m','i','n','a','t','e'] ]
                              `imperf`     FCU,

    FaCCY                     `verb`    {- <ma.h.hY> -}        [ unwords [ ['w','i','p','e'], ['o','u','t'] ], ['e','r','a','d','i','c','a','t','e'], ['e','x','t','e','r','m','i','n','a','t','e'] ],
...
cluster_37  = cluster
 ...
 |> "m d y" <| [
    ...
    FACY                      `verb`    {- <mAdY> -}           [ unwords [ ['g','r','a','n','t'], "a", ['d','e','l','a','y'], ['o','r'], ['e','x','t','e','n','s','i','o','n'] ] ],

    HaFCY                     `verb`    {- <'amdY> -}          [ unwords [ ['g','r','a','n','t'], "a", ['d','e','l','a','y'], ['o','r'], ['e','x','t','e','n','s','i','o','n'] ] ],
    ...
    FICA' |<< "a"             `prep`    {- <mIdA'a> -}         [ unwords [ ['i','n'], ['f','r','o','n','t'], ['o','f'] ], ['f','a','c','i','n','g'] ],

    FICA'                     `noun`    {- <mIdA'> -}          [ ['m','e','a','s','u','r','e'], ['a','m','o','u','n','t'], ['l','e','n','g','t','h'] ],

    FICA' |< Iy               `noun`    {- <mIdA'Iy> -}        [ ['M','i','d','a','o','u','i'], ['M','i','d','a','w','i'] ],
    ...
    FaCY |< Iy                `noun`    {- <madawIy> -}        [ ['c','u','t','l','e','r'] ],

    TaFACI                    `noun`    {- <tamAdI> -}         [ unwords [ ['l','o','n','g'], ['r','u','n'] ] ]
                              `plural`     TaFACI |< At,

    TaFACI |<< "aN"           `noun`    {- <tamAdiyaN> -}      [ ['e','v','e','n','t','u','a','l','l','y'] ] ]
...
cluster_38  = cluster
 ...
 |> "m d y n" <| [
    ...
    MutaKaRDiS                `adj`     {- <mutamadyin> -}     [ ['c','i','v','i','l','i','z','e','d'], ['s','o','p','h','i','s','t','i','c','a','t','e','d'] ] ]
...
cluster_40  = cluster
 ...
 |> "m r '" <| [
    ...
    FuCUL |< aT               `noun`    {- <murU'aT> -}        [ ['m','a','n','l','i','n','e','s','s'], ['c','h','i','v','a','l','r','y'] ],

    FuCUw |< aT               `noun`    {- <murUwaT> -}        [ ['m','a','n','l','i','n','e','s','s'], ['c','h','i','v','a','l','r','y'] ],

    FaCwAn                    `noun`    {- <marwAn> -}         [ ['M','a','r','w','a','n'] ],

    FaCwAn |< Iy              `adj`     {- <marwAnIy> -}       [ ['M','a','r','w','a','n','i'] ] ]
...
cluster_42  = cluster
 ...
 |> "m r r" <| [
    ...
    IstaFaCL                  `verb`    {- <istamarr> -}       [ ['c','o','n','t','i','n','u','e'], ['l','a','s','t'] ],
...
cluster_56  = cluster
 ...
 |> "m ^s y" <| [
    ...
    FaCw                      `noun`    {- <ma^sw> -}          [ ['l','a','x','a','t','i','v','e'] ],
    ...
    TaFaCCI |<< "aN"          `noun`    {- <tama^s^siyaN> -}   [ unwords [ ['i','n'], ['a','c','c','o','r','d','a','n','c','e'], ['w','i','t','h'] ], unwords [ ['i','n'], ['c','o','n','f','o','r','m','i','t','y'], ['w','i','t','h'] ] ],

    FACI                      `noun`    {- <mA^sI> -}          [ ['i','n','f','a','n','t','r','y'], ['p','e','d','e','s','t','r','i','a','n'] ]
                              `plural`     FuCY |< aT
                              `femini`     FACI |< aT,

    FACI                      `adj`     {- <mA^sI> -}          [ ['g','o','i','n','g'], ['w','a','l','k','i','n','g'], unwords [ ['o','n'], ['f','o','o','t'] ] ],
...
cluster_58  = cluster
 ...
 |> "m .s .s" <| [
    ...
    MuFtaCL                   `adj`     {- <mumta.s.s> -}      [ ['a','b','s','o','r','b','i','n','g'], ['a','b','s','o','r','b','e','n','t'] ] ]
...
cluster_75  = cluster
 ...
 |> "m l l" <| [
    ...
    FaCL                      `adj`     {- <mall> -}           [ ['b','o','r','e','d'], unwords [ ['f','e','d'], "-", ['u','p'] ] ],
...
cluster_86  = cluster
 ...
 |> ['m','U','n','d','i','y','A','l'] <| [
    ...
    _____                     `noun`    {- <mUndiyAl> -}       [ unwords [ ['m','o','n','d','i','a','l'], "(", ['w','o','r','l','d'], ['c','u','p'], ")" ] ]
                              `plural`     _____ |< At,
