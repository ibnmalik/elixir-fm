...
cluster_9   = cluster
 ...
 |> ".g s s" <| [
    ...
    FuCL                      `noun`    {- <.guss> -}          [ ['d','e','s','p','i','c','a','b','l','e'] ] ]
...
cluster_11  = cluster
 ...
 |> "f .d .d" <| [
    ...
    MuFaCCaL                  `noun`    {- <mufa.d.da.d> -}    [ unwords [ ['s','i','l','v','e','r'], "-", ['p','l','a','t','e','d'] ] ] ]
...
cluster_13  = cluster
 ...
 |> "f .s .s" <| [
    ...
    MuFaCCaL                  `noun`    {- <mufa.s.sa.s> -}    [ ['l','o','b','e','d'] ] ]
...
cluster_21  = cluster
 ...
 |> "f l l" <| [
    ...
    FaCL                      `noun`    {- <fall> -}           [ ['v','a','n','q','u','i','s','h','e','d'], ['r','o','u','t','e','d'] ]
                              `plural`     FuCCAL
                              `plural`     HaFCAL,
...
cluster_24  = cluster
 ...
 |> "f s .t .t" <| [
    ...
    KuRDAS                    `noun`    {- <fus.tA.t> -}       [ ['c','a','m','p'], unwords [ ['i','d','e','o','l','o','g','i','c','a','l'], ['g','r','o','u','p'] ] ]
                              `plural`     KaRADIS,

    KuRDAS                    `noun`    {- <fus.tA.t> -}       [ ['t','e','n','t'], ['p','a','v','i','l','i','o','n'] ]
                              `plural`     KaRADIS ]
...
cluster_33  = cluster
 ...
 |> "q _t '" <| [
    ...
    FuCCAL                    `noun`    {- <qu_t_tA'> -}       [ unwords [ ['c','u','c','u','m','b','e','r'], "(", "s", ")" ] ] ]
...
cluster_59  = cluster
 ...
 |> "k z z" <| [
    ...
    FaCL                      `noun`    {- <kazz> -}           [ unwords [ ['d','r','i','e','d'], ['u','p'] ], ['s','h','r','i','v','e','l','e','d'], ['s','t','i','n','g','y'] ]
                              `plural`     FuCL,
