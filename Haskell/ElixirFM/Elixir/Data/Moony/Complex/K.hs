...
cluster_6   = cluster
 ...
 |> "f w f" <| [
    ...
    MuFaCCaL                  `adj`     {- <mufawwaf> -}       [ unwords [ ['w','h','i','t','e'], "-", ['s','t','r','i','p','e','d'] ] ] ]
...
cluster_7   = cluster
 ...
 |> "f w q" <| [
    ...
    MutaFaCCiL                `adj`     {- <mutafawwiq> -}     [ ['s','u','p','e','r','i','o','r'], ['o','u','t','s','t','a','n','d','i','n','g'] ],
...
cluster_13  = cluster
 ...
 |> ['f','i','y','a','t','n','A','m'] <| [
    ...
    _____                     `xtra`    {- <fiyatnAm> -}       [ ['V','i','e','t','n','a','m'] ],
...
cluster_15  = cluster
 ...
 |> "f y d" <| [
    ...
    MustaFIL                  `adj`     {- <mustafId> -}       [ ['b','e','n','e','f','i','t','i','n','g'], ['b','e','n','e','f','i','c','i','a','r','y'], ['p','r','o','f','i','t','i','n','g'] ],

    MustaFAL                  `adj`     {- <mustafAd> -}       [ ['p','r','o','f','i','t','e','d'], ['d','e','d','u','c','e','d'], ['i','n','f','e','r','r','e','d'] ] ]
...
cluster_16  = cluster
 ...
 |> "f y ^s" <| [
    ...
    FIL                       `adj`     {- <fI^s> -}           [ ['w','e','a','k'], ['i','m','p','o','t','e','n','t'] ]
                              `plural`     HaFCAL ]
...
cluster_17  = cluster
 ...
 |> "f y .d" <| [
    ...
    IstiFAL |< aT             `noun`    {- <istifA.daT> -}     [ ['a','b','u','n','d','a','n','c','e'], ['p','r','o','f','u','s','i','o','n'] ],

    FA'iL                     `adj`     {- <fA'i.d> -}         [ ['a','b','u','n','d','a','n','t'], ['c','o','p','i','o','u','s'], ['p','l','e','n','t','i','f','u','l'], ['p','r','o','f','u','s','e'] ],

    FA'iL                     `noun`    {- <fA'i.d> -}         [ ['s','u','r','p','l','u','s'], ['o','v','e','r','f','l','o','w'], ['i','n','t','e','r','e','s','t'] ]
                              `plural`     FawA'iL,
...
cluster_18  = cluster
 ...
 |> "f y .z" <| [
    ...
    FACiL                     `noun`    {- <fAyi.z> -}         [ ['u','s','u','r','y'], ['i','n','t','e','r','e','s','t'] ],

    FACiL |<< "^g" |< Iy      `noun`    {- <fAyi.z^gIy> -}     [ ['u','s','u','r','e','r'] ]
                              `plural`     FACiL |<< "^g" |< Iy |< aT
...
cluster_24  = cluster
 ...
 |> "f y n" <| [
    ...
    FaCLAn                    `adj`     {- <faynAn> -}         [ unwords [ ['l','o','n','g'], "-", ['h','a','i','r','e','d'] ] ] ]
...
cluster_25  = cluster
 ...
 |> "f y h q" <| [
    ...
    MutaKaRDiS                `adj`     {- <mutafayhiq> -}     [ ['p','e','d','a','n','t'], ['p','u','r','i','s','t'], unwords [ ['w','i','n','d'], "-", ['b','a','g'] ] ] ]
...
cluster_34  = cluster
 ...
 |> "q t t" <| [
    ...
    FaCCAL                    `noun`    {- <qattAt> -}         [ ['s','l','a','n','d','e','r','e','r'], ['l','i','a','r'] ]
                              `plural`     FaCCAL |< Un
...
cluster_38  = cluster
 ...
 |> "q d d" <| [
    ...
    MaFCUL                    `adj`     {- <maqdUd> -}         [ unwords [ ['c','u','t'], ['i','n'], ['s','t','r','i','p','s'] ] ],

    MuFaCCaL                  `adj`     {- <muqaddad> -}       [ unwords [ ['j','e','r','k','e','d'], "(", ['m','e','a','t'], ")" ] ] ]
...
cluster_39  = cluster
 ...
 |> "q d w" <| [
    ...
    FaCIy                     `adj`     {- <qadIy> -}          [ ['s','a','v','o','r','y'], ['t','a','s','t','y'] ],
...
cluster_42  = cluster
 ...
 |> "q r '" <| [
    ...
    IstaFCaL                  `verb`    {- <istaqra'> -}       [ ['e','x','a','m','i','n','e'], ['e','x','p','l','o','r','e'], ['i','n','v','e','s','t','i','g','a','t','e'], ['s','t','u','d','y'] ],
    ...
    IstiFCAL                  `noun`    {- <istiqrA'> -}       [ ['i','n','d','u','c','t','i','o','n'], ['i','n','v','e','s','t','i','g','a','t','i','o','n'], ['e','x','a','m','i','n','a','t','i','o','n'], ['e','x','p','l','o','r','a','t','i','o','n'] ]
                              `plural`     IstiFCAL |< At,
...
cluster_47  = cluster
 ...
 |> "q r w" <| [
    ...
    IstaFCY                   `verb`    {- <istaqrY> -}        [ ['e','x','a','m','i','n','e'], ['e','x','p','l','o','r','e'], ['i','n','v','e','s','t','i','g','a','t','e'], ['s','t','u','d','y'] ],

    FaCL                      `noun`    {- <qarw> -}           [ unwords [ ['w','a','t','e','r','i','n','g'], ['t','r','o','u','g','h'] ] ]
                              `plural`     FuCUL,

    FuC'                      `noun`    {- <qur'> -}           [ ['m','e','n','s','e','s'], ['m','e','n','s','t','r','u','a','t','i','o','n'] ]
                              `plural`     FuCU',

    FayCaLAn                  `noun`    {- <qayrawAn> -}       [ ['c','a','r','a','v','a','n'] ]
                              `plural`     FayCaLAn |< At,

    FayCaLAn                  `noun`    {- <qayrawAn> -}       [ ['K','a','i','r','o','u','a','n'] ],

    FaCA |< Iy                `adj`     {- <qarawIy> -}        [ unwords [ ['o','f'], "/", ['f','r','o','m'], ['K','a','i','r','o','u','a','n'] ] ],

    IstiFCA'                  `noun`    {- <istiqrA'> -}       [ ['i','n','d','u','c','t','i','o','n'], ['i','n','v','e','s','t','i','g','a','t','i','o','n'], ['e','x','a','m','i','n','a','t','i','o','n'], ['e','x','p','l','o','r','a','t','i','o','n'] ]
                              `plural`     IstiFCA' |< At,
...
cluster_48  = cluster
 ...
 |> ['q','a','r','u','w','A','.','t'] <| [
    ...
    _____ |< iyA              `xtra`    {- <qaruwA.tiyA> -}    [ ['C','r','o','a','t','i','a'] ],
...
cluster_53  = cluster
 ...
 |> "q s s" <| [
    ...
    FaCL                      `noun`    {- <qass> -}           [ ['c','l','e','r','g','y','m','a','n'], ['r','e','v','e','r','e','n','d'] ]
                              `plural`     FuCuL
                              `plural`     FuCUL,
...
cluster_57  = cluster
 ...
 |> "q .s .s" <| [
    ...
    MaFCUL                    `noun`    {- <maq.sU.s> -}       [ ['e','a','r','l','o','c','k'], unwords [ ['l','o','c','k'], ['o','f'], ['h','a','i','r'], ['b','y'], ['t','h','e'], ['e','a','r'] ] ]
                              `plural`     MaFACIL,
...
cluster_58  = cluster
 ...
 |> "q .s w" <| [
    ...
    FaCIy                     `adj`     {- <qa.sIy> -}         [ ['d','i','s','t','a','n','t'], ['r','e','m','o','t','e'] ]
                              `plural`     HaFCA',

    HaFCY                     `adj`     {- <'aq.sY> -}         [ unwords [ ['f','a','r'], "/", ['f','a','r','t','h','e','r'], "/", ['f','a','r','t','h','e','s','t'] ], unwords [ ['r','e','m','o','t','e','r'], "/", ['r','e','m','o','t','e','s','t'] ], ['m','a','x','i','m','u','m'], ['m','a','x','i','m','a','l'], ['u','t','m','o','s','t'], ['u','l','t','i','m','a','t','e'] ]
                              `plural`     HaFACI
                              `femini`     FuCLY
                              `femini`     FuCyY,
...
cluster_67  = cluster
 ...
 |> "q l l" <| [
    ...
    FiCL |< Iy |< aT          `noun`    {- <qillIyaT> -}       [ unwords [ ['m','o','n','k','\'','s'], ['c','e','l','l'] ], unwords [ ['b','i','s','h','o','p','\'','s'], ['r','e','s','i','d','e','n','c','e'] ] ]
                              `plural`     FiCL |< Iy |< At,
 ...
 |> "q l l" <| [
    ...
    FaCL |<< "a" |<< "mA"     `adv`     {- <qallamA> -}        [ ['r','a','r','e','l','y'], ['s','e','l','d','o','m'] ],
...
cluster_72  = cluster
 ...
 |> "q l y" <| [
    ...
    FiCw                      `noun`    {- <qilw> -}           [ ['a','l','k','a','l','i'] ],

    FiCw |< Iy                `adj`     {- <qilwIy> -}         [ ['a','l','k','a','l','i','n','e'], ['b','a','s','e'] ],
...
cluster_79  = cluster
 ...
 |> "q n w" <| [
    ...
    FuCy |< aT                `noun`    {- <qunyaT> -}         [ ['a','c','q','u','i','s','i','t','i','o','n'], ['p','o','s','s','e','s','s','i','o','n','s'], ['p','r','o','p','e','r','t','y'] ],

    FaCA |< aT                `noun`    {- <qanAT> -}          [ ['c','a','n','a','l'], ['c','h','a','n','n','e','l'] ]
                              `plural`     HaFCI |< aT
                              `plural`     FaCA |< At,

    FaCAy |< aT               `noun`    {- <qanAyaT> -}        [ ['s','t','r','e','a','m'], ['r','i','v','u','l','e','t'] ],

    FuCayy |< aT              `noun`    {- <qunayyaT> -}       [ ['c','a','n','n','u','l','a'] ],

    FaCY |< aT                `noun`    {- <qanAT> -}          [ ['Q','a','n','a','t'] ],

    HaFCY                     `adj`     {- <'aqnY> -}          [ ['b','e','n','t'], ['c','r','o','o','k','e','d'], ['h','o','o','k','e','d'] ],
...
cluster_80  = cluster
 ...
 |> "q h w" <| [
    ...
    FaCL |<< "a" |<< "^g" |< Iy `noun`    {- <qahwa^gIy> -}      [ unwords [ ['c','a','f','e'], ['m','a','n','a','g','e','r'] ], unwords [ ['c','o','f','f','e','e'], ['c','o','o','k'] ] ]
                              `plural`     FaCL |<< "a" |<< "^g" |< Iy |< Un
                           
    `derives` otherwise,

    FaCL |< At |< Iy          `noun`    {- <qahwAtIy> -}       [ unwords [ ['c','a','f','e'], ['m','a','n','a','g','e','r'] ], unwords [ ['c','a','f','e'], ['o','w','n','e','r'] ] ]
                              `plural`     FaCL |< At |< Iy |< Un
...
cluster_84  = cluster
 ...
 |> ['q','u','w','a','t','l'] <| [
    ...
    _____ |< Iy               `noun`    {- <quwatlIy> -}       [ ['Q','u','w','a','t','l','i'] ] ]
...
cluster_86  = cluster
 ...
 |> "q w d" <| [
    ...
    Fa'UL                     `adj`     {- <qa'Ud> -}          [ ['t','r','a','c','t','a','b','l','e'], ['d','o','c','i','l','e'], ['m','a','n','a','g','e','a','b','l','e'] ],

    HaFCaL                    `adj`     {- <'aqwad> -}         [ ['t','r','a','c','t','a','b','l','e'], ['d','o','c','i','l','e'], ['a','m','e','n','a','b','l','e'] ],
...
cluster_99  = cluster
 ...
 |> "q w l" <| [
    ...
    MuFACaL |< aT             `noun`    {- <muqAwalaT> -}      [ ['c','o','n','t','r','a','c','t'], ['d','e','a','l'], ['b','a','r','g','a','i','n'], ['s','e','t','t','l','e','m','e','n','t'] ]
                              `plural`     MuFACaL |< At,
