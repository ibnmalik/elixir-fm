...
cluster_33  = cluster
 ...
 |> "k s b" <| [
    ...
    MuFtaCaL                  `noun`    {- <muktasab> -}       [ ['a','c','h','i','e','v','e','m','e','n','t'], ['a','c','c','o','m','p','l','i','s','h','m','e','n','t'] ]
                              `plural`     MuFtaCaL |< At,

    MuFtaCaL                  `adj`     {- <muktasab> -}       [ ['a','c','q','u','i','r','e','d'], ['g','a','i','n','e','d'] ] ]
...
cluster_97  = cluster
 ...
 |> ['k','I','l','U','s','I','k','l'] <| [
    ...
    _____                     `noun`    {- <kIlUsIkl> -}       [ ['k','i','l','o','c','y','c','l','e'] ] ]
