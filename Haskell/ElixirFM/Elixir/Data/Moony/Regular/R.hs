...
cluster_11  = cluster
 ...
 |> "k t b" <| [
    ...
    FaCaL                     `verb`    {- <katab> -}          [ ['w','r','i','t','e'], unwords [ ['b','e'], ['f','a','t','e','d'] ], unwords [ ['b','e'], ['d','e','s','t','i','n','e','d'] ] ]
                              `imperf`     FCuL
                              `masdar`     FaCL
                              `masdar`     FiCL |< aT
                              `masdar`     FiCAL |< aT,
...
cluster_42  = cluster
 ...
 |> "ka_d_alik" <| [
    ...
    _____ |<< "a"             `adv`     {- <ka_d_alika> -}     [ ['l','i','k','e','w','i','s','e'], ['a','l','s','o'] ] ]
...
cluster_75  = cluster
 ...
 |> "k r k" <| [
    ...
    FuCL |< Iy                `noun`    {- <kurkIy> -}         [ unwords [ ['c','r','a','n','e'], "(", ['z','o','o','l','.'], ")" ], unwords [ ['c','r','a','n','e','s'], "(", ['z','o','o','l','.'], ")" ] ]
                              `plural`     FaCALI ]
