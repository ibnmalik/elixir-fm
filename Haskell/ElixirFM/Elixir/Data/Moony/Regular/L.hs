...
module Elixir.Data.Moony.Regular.L where
...
cluster_27  = cluster
 ...
 |> "`abdAlla.tIf" <| [
    ...
    _____                     `noun`    {- <`abdAlla.tIf> -}   [ unwords [ ['A','b','d','e','l'], ['L','a','t','e','e','f'] ] ],
...
cluster_102 = cluster
 ...
 |> "`ankabUt" <| [
    ...
    _____                     `noun`    {- <`ankabUt> -}       [ ['s','p','i','d','e','r'] ],

    _____ |< Iy               `adj`     {- <`ankabUtIy> -}     [ unwords [ ['s','p','i','d','e','r'], "-", ['l','i','k','e'] ], ['a','r','a','c','h','n','o','i','d'] ],

    _____ |< Iy |< At         `noun`    {- <`ankabUtIyAt> -}   [ ['a','r','a','c','h','n','i','d','s'] ] ]
