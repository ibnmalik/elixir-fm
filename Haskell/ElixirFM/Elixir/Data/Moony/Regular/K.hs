...
module Elixir.Data.Moony.Regular.K where
...
cluster_16  = cluster
 ...
 |> "` f r m" <| [
    ...
    KaRADiS                   `noun`    {- <`afArim> -}        [ unwords [ ['w','e','l','l'], ['d','o','n','e'], "!" ], unwords [ ['b','r','a','v','o'], "!" ] ] ]
...
cluster_36  = cluster
 ...
 |> "` l m" <| [
    ...
    MaFCUL                    `adj`     {- <ma`lUm> -}         [ ['k','n','o','w','n'], unwords [ ['c','e','r','t','a','i','n','l','y'], "!" ] ],
...
cluster_49  = cluster
 ...
 |> "` m r" <| [
    ...
    FuCL |< Iy                `adj`     {- <`umrIy> -}         [ unwords [ ['a','g','e'], "-", ['r','e','l','a','t','e','d'] ], unwords [ ['a','g','e'], "-", ['b','a','s','e','d'], "?", "?" ] ],
...
cluster_89  = cluster
 ...
 |> "` r b" <| [
    ...
    FaCCaL                    `verb`    {- <`arrab> -}         [ ['A','r','a','b','i','c','i','z','e'] ],

    HaFCaL                    `verb`    {- <'a`rab> -}         [ ['e','x','p','r','e','s','s'], ['m','a','n','i','f','e','s','t'], ['i','n','d','i','c','a','t','e'] ],

    TaFaCCaL                  `verb`    {- <ta`arrab> -}       [ unwords [ ['b','e'], ['A','r','a','b','i','c','i','z','e','d'] ], unwords [ ['b','e'], ['t','r','a','n','s','l','a','t','e','d'] ] ],
    ...
    MustaFCaL                 `adj`     {- <musta`rab> -}      [ ['A','r','a','b','i','z','e','d'] ] ]
...
cluster_99  = cluster
 ...
 |> "` r q" <| [
    ...
    FiCL                      `noun`    {- <`irq> -}           [ ['r','o','o','t'], ['a','n','c','e','s','t','r','y'] ]
                              `plural`     FuCUL,
    ...
    HaFCaL                    `noun`    {- <'a`raq> -}         [ unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['d','e','e','p'], "-", ['r','o','o','t','e','d'] ] ],
...
cluster_103 = cluster
 ...
 |> "` s ^g d" <| [
    ...
    MuKaRDaS                  `noun`    {- <mu`as^gad> -}      [ ['g','i','l','d','e','d'] ]
                              `plural`     MuKaRDaS |< Un
...
cluster_112 = cluster
 ...
 |> "` s k r" <| [
    ...
    KaRDaS |< Iy              `adj`     {- <`askarIy> -}       [ ['s','o','l','d','i','e','r'], ['p','r','i','v','a','t','e'] ],
...
cluster_115 = cluster
 ...
 |> "` t b" <| [
    ...
    FuCayL |< Iy              `adj`     {- <`utaybIy> -}       [ ['O','t','a','i','b','i'] ],

    FaCCAL |< Iy              `adj`     {- <`attAbIy> -}       [ ['z','e','b','r','a'] ],

    FaCCAL |< Iy              `adj`     {- <`attAbIy> -}       [ ['A','t','t','a','b','i'] ],
...
cluster_125 = cluster
 ...
 |> "` z l" <| [
    ...
    FACiL                     `noun`    {- <`Azil> -}          [ ['i','n','s','u','l','a','t','i','n','g'] ],
