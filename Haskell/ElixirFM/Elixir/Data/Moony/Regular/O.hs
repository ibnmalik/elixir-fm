...
cluster_3   = cluster
 ...
 |> "q b l" <| [
    ...
    FaCL |<< "a" |<< "mA"     `conj`    {- <qablamA> -}        [ ['b','e','f','o','r','e'] ],
    ...
    MuFACiL                   `adj`     {- <muqAbil> -}        [ ['f','a','c','i','n','g'], ['o','p','p','o','s','i','t','e'] ],

    MuFACiL                   `noun`    {- <muqAbil> -}        [ ['e','q','u','i','v','a','l','e','n','t'], unwords [ ['c','o','u','n','t','e','r'], "-" ], ['c','o','m','p','e','n','s','a','t','i','o','n'], ['r','e','c','o','m','p','e','n','s','e'] ],

    MuFACiL |<< "a"           `prep`    {- <muqAbila> -}       [ unwords [ ['i','n'], ['e','x','c','h','a','n','g','e'], ['f','o','r'] ], unwords [ ['i','n'], ['c','o','m','p','e','n','s','a','t','i','o','n'], ['f','o','r'] ], unwords [ ['o','p','p','o','s','i','t','e'], ['t','o'] ], unwords [ ['c','o','r','r','e','s','p','o','n','d','i','n','g'], ['t','o'] ], unwords [ ['v','i','s'], "-", "a", "-", ['v','i','s'] ] ],
...
cluster_9   = cluster
 ...
 |> "q t l" <| [
    ...
    FiCL                      `noun`    {- <qitl> -}           [ ['e','n','e','m','y'], ['f','o','e'], ['a','d','v','e','r','s','a','r','y'], ['o','p','p','o','n','e','n','t'] ]
                              `plural`     HaFCAL,

    FaCIL                     `noun`    {- <qatIl> -}          [ ['c','a','s','u','a','l','t','y'], ['k','i','l','l','e','d'], ['d','e','a','d'] ]
                              `plural`     FaCLY,

    FaCIL                     `adj`     {- <qatIl> -}          [ ['k','i','l','l','e','d'], ['d','e','a','d'], ['f','a','l','l','e','n'] ]
                              `plural`     FaCLY,
...
cluster_20  = cluster
 ...
 |> "q d r" <| [
    ...
    MuFaCCaL                  `noun`    {- <muqaddar> -}       [ ['e','s','t','i','m','a','t','e'], ['f','a','t','e'] ]
                              `plural`     MuFaCCaL |< At,

    MuFaCCaL                  `adj`     {- <muqaddar> -}       [ ['e','s','t','i','m','a','t','e','d'], ['c','a','l','c','u','l','a','t','e','d'] ],

    MuFaCCaL                  `adj`     {- <muqaddar> -}       [ ['d','e','c','r','e','e','d'], ['d','e','s','t','i','n','e','d'], ['f','a','t','e','d'] ],
...
cluster_21  = cluster
 ...
 |> "q d s" <| [
    ...
    FaCCUL                    `adj`     {- <qaddUs> -}         [ unwords [ ['m','o','s','t'], ['h','o','l','y'] ] ],
...
cluster_38  = cluster
 ...
 |> "q r s" <| [
    ...
    FaCALI |< aT              `noun`    {- <qarAsiyaT> -}      [ ['p','r','u','n','e'], ['p','l','u','m'] ],
...
cluster_46  = cluster
 ...
 |> "q r .t m" <| [
    ...
    KuRDuSAn                  `noun`    {- <qur.tumAn> -}      [ ['o','a','t','s'] ] ]
...
cluster_71  = cluster
 ...
 |> ['q','u','r','.','t','u','b'] <| [
    ...
    _____ |< aT               `noun`    {- <qur.tubaT> -}      [ ['C','o','r','d','o','b','a'] ],

    _____ |< Iy               `adj`     {- <qur.tubIy> -}      [ ['C','o','r','d','o','v','a','n'] ],

    _____ |< Iy               `noun`    {- <qur.tubIy> -}      [ ['Q','u','r','t','u','b','i'] ] ]
...
cluster_72  = cluster
 ...
 |> ['q','a','r','.','t','A','^','g'] <| [
    ...
    _____                     `xtra`    {- <qar.tA^g> -}       [ ['C','a','r','t','h','a','g','e'] ],

    _____ |< Iy               `adj`     {- <qar.tA^gIy> -}     [ ['C','a','r','t','h','a','g','i','n','i','a','n'] ],

    _____ |< Iy               `noun`    {- <qar.tA^gIy> -}     [ ['C','a','r','t','h','a','g','i','n','i','a','n'] ]
                              `plural`     _____ |< Iy |< Un
                              `femini`     _____ |< Iy |< aT ]
...
cluster_73  = cluster
 ...
 |> ['q','i','r','.','g','I','z','s','t','A','n'] <| [
    ...
    _____                     `xtra`    {- <qir.gIzstAn> -}    [ ['K','y','r','g','y','z','s','t','a','n'] ],

    _____ |< Iy               `adj`     {- <qir.gIzstAnIy> -}  [ ['K','y','r','g','y','z','s','t','a','n','i'] ],

    _____ |< Iy               `noun`    {- <qir.gIzstAnIy> -}  [ ['K','y','r','g','y','z','s','t','a','n','i'] ]
                              `plural`     _____ |< Iy |< Un
                              `femini`     _____ |< Iy |< aT ]
...
cluster_84  = cluster
 ...
 |> ['q','u','z','m','U','.','g','r','A','f'] <| [
    ...
    _____ |< iyA              `noun`    {- <quzmU.grAfiyA> -}  [ ['c','o','s','m','o','g','r','a','p','h','y'] ],

    _____ |< Iy               `adj`     {- <quzmU.grAfIy> -}   [ ['c','o','s','m','o','g','r','a','p','h','i','c'] ],

    _____ |< Iy               `noun`    {- <quzmU.grAfIy> -}   [ ['c','o','s','m','o','g','r','a','p','h','e','r'] ]
                              `plural`     _____ |< Iy |< Un
                              `femini`     _____ |< Iy |< aT ]
...
cluster_86  = cluster
 ...
 |> "q s r" <| [
    ...
    FACiL                     `adj`     {- <qAsir> -}          [ ['c','o','n','s','t','r','a','i','n','i','n','g'], ['s','u','b','j','u','g','a','t','i','n','g'] ] ]
...
cluster_87  = cluster
 ...
 |> "q s .t" <| [
    ...
    HaFCaL                    `verb`    {- <'aqsa.t> -}        [ unwords [ ['b','e'], ['e','q','u','i','t','a','b','l','e'] ], unwords [ ['r','a','t','i','o','n'], ['e','q','u','i','t','a','b','l','y'] ] ],

    FiCL                      `noun`    {- <qis.t> -}          [ ['f','a','i','r','n','e','s','s'], ['e','q','u','i','t','y'] ],

    FiCL                      `adj`     {- <qis.t> -}          [ ['e','q','u','i','t','a','b','l','e'], ['f','a','i','r'] ],
    ...
    HaFCaL                    `adj`     {- <'aqsa.t> -}        [ ['e','q','u','i','t','a','b','l','e'], ['f','a','i','r'] ],
...
cluster_89  = cluster
 ...
 |> "q s .t s" <| [
    ...
    KiRDAS                    `noun`    {- <qis.tAs> -}        [ ['b','a','l','a','n','c','e'], ['s','c','a','l','e','s'] ]
                              `plural`     KaRADIS ]
...
cluster_91  = cluster
 ...
 |> "q s m" <| [
    ...
    FuwayCiL |< aT            `noun`    {- <quwaysimaT> -}     [ ['Q','u','w','e','i','s','m','a'] ],
    ...
    MaFCiL                    `noun`    {- <maqsim> -}         [ ['c','o','m','p','a','r','t','m','e','n','t'], ['d','i','s','t','r','i','b','u','t','i','o','n'] ]
                              `plural`     MaFACiL,
    ...
    FACiL |< Iy               `noun`    {- <qAsimIy> -}        [ ['Q','a','s','i','m','i'], ['K','a','s','s','i','m','i'] ],
...
cluster_93  = cluster
 ...
 |> "q ^s b" <| [
    ...
    FaCIL                     `adj`     {- <qa^sIb> -}         [ ['p','o','l','i','s','h','e','d'], ['b','u','r','n','i','s','h','e','d'], ['c','l','e','a','n'] ]
                              `plural`     FuCuL,
...
cluster_100 = cluster
 ...
 |> "q ^s ` r" <| [
    ...
    KuRaDSIS |< aT            `noun`    {- <qu^sa`rIraT> -}    [ ['s','h','u','d','d','e','r','i','n','g'], ['t','r','e','m','b','l','i','n','g'], unwords [ ['g','o','o','s','e'], ['b','u','m','p','s'] ] ],
