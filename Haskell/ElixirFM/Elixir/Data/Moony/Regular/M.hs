...
cluster_19  = cluster
 ...
 |> "f r ^g n" <| [
    ...
    KiRDaS                    `noun`    {- <fir^gan> -}        [ ['c','u','r','r','y','c','o','m','b'], ['b','r','u','s','h'] ] ]
...
cluster_20  = cluster
 ...
 |> "f r .h" <| [
    ...
    FaCaL                     `noun`    {- <fara.h> -}         [ ['j','o','y'], ['h','a','p','p','i','n','e','s','s'], ['f','e','s','t','i','v','i','t','y'] ]
                              `plural`     HaFCAL,
...
cluster_22  = cluster
 ...
 |> "f r d" <| [
    ...
    FuCAL |<< "aN"            `noun`    {- <furAdaN> -}        [ ['i','n','d','i','v','i','d','u','a','l','l','y'], unwords [ ['o','n','e'], ['a','t'], "a", ['t','i','m','e'] ] ],
...
cluster_24  = cluster
 ...
 |> "f r z" <| [
    ...
    MuFCaL                    `adj`     {- <mufraz> -}         [ ['p','a','r','t','i','t','i','o','n','e','d'], unwords [ ['i','n'], ['l','o','t','s'] ] ],
    ...
    FayCUL                    `noun`    {- <fayrUz> -}         [ ['t','u','r','q','u','o','i','s','e'] ],
...
cluster_27  = cluster
 ...
 |> "f r s" <| [
    ...
    FACiL                     `noun`    {- <fAris> -}          [ ['k','n','i','g','h','t'], ['c','a','v','a','l','r','y'] ]
                              `plural`     FawACiL
                              `plural`     FuCLAn
...
cluster_50  = cluster
 ...
 |> "f r m l" <| [
    ...
    KaRDaS |<< "^g" |< Iy     `noun`    {- <farmal^gIy> -}     [ ['b','r','a','k','e','m','a','n'] ]
                              `plural`     KaRDaS |<< "^g" |< Iy |< aT ]
...
cluster_51  = cluster
 ...
 |> "f r m n" <| [
    ...
    KiRDAS                    `noun`    {- <firmAn> -}         [ unwords [ ['f','i','r','m','a','n'], "(", ['O','t','t','o','m','a','n'], ['d','e','c','r','e','e'], "/", ['e','d','i','c','t'], ")" ] ]
                              `plural`     KaRADIS,
...
cluster_63  = cluster
 ...
 |> ['f','U','r','^','s','I','n'] <| [
    ...
    _____ |< aT               `noun`    {- <fUr^sInaT> -}      [ ['h','a','i','r','p','i','n'] ] ]
...
cluster_76  = cluster
 ...
 |> "f s f t" <| [
    ...
    KuRDAS                    `noun`    {- <fusfAt> -}         [ ['p','h','o','s','p','h','a','t','e'] ],

    KuRDAS |< Iy              `adj`     {- <fusfAtIy> -}       [ ['p','h','o','s','p','h','a','t','e'] ] ]

 |> ['f','U','s','f','A','t'] <| [

    _____                     `noun`    {- <fUsfAt> -}         [ ['p','h','o','s','p','h','a','t','e'] ],

    _____ |< Iy               `adj`     {- <fUsfAtIy> -}       [ ['p','h','o','s','p','h','a','t','e'] ] ]
...
cluster_80  = cluster
 ...
 |> "f s l" <| [
    ...
    FaCL                      `adj`     {- <fasl> -}           [ ['i','g','n','o','b','l','e'], ['d','e','c','e','i','t','f','u','l'] ]
                              `plural`     FuCUL,
...
cluster_88  = cluster
 ...
 |> "f .s .h" <| [
    ...
    HaFCaL                    `adj`     {- <'af.sa.h> -}       [ unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['e','l','o','q','u','e','n','t'] ], ['p','u','r','e'], ['u','n','c','o','r','r','u','p','t','e','d'] ]
                              `femini`     FuCLY,

    FuCLY                     `noun`    {- <fu.s.hY> -}        [ unwords [ ['S','t','a','n','d','a','r','d'], "/", ['C','l','a','s','s','i','c','a','l'], ['A','r','a','b','i','c'] ] ],
...
cluster_91  = cluster
 ...
 |> "f .s l" <| [
    ...
    FaCIL |< aT               `noun`    {- <fa.sIlaT> -}       [ ['g','r','o','u','p'], ['g','e','n','u','s'], ['s','p','e','c','i','e','s'], ['f','a','m','i','l','y'], ['c','e','l','l'], ['b','r','a','n','c','h'], ['p','l','a','t','o','o','n'], ['s','q','u','a','d','r','o','n'] ]
                              `plural`     FaCA'iL,
...
cluster_100 = cluster
 ...
 |> "f .t r" <| [
    ...
    FaCA'iL |< Iy             `noun`    {- <fa.tA'irIy> -}     [ unwords [ ['p','a','s','t','r','y'], ['b','a','k','e','r'] ] ]
