...
cluster_9   = cluster
 ...
 |> "` t m" <| [
    ...
    HaFCaL                    `verb`    {- <'a`tam> -}         [ ['d','a','r','k','e','n'], unwords [ ['b','l','a','c','k'], ['o','u','t'] ] ],
...
cluster_20  = cluster
 ...
 |> "` ^g l" <| [
    ...
    MuFaCCaL                  `adj`     {- <mu`a^g^gal> -}     [ ['u','r','g','e','n','t'], ['p','r','e','m','a','t','u','r','e'], unwords [ ['i','n'], ['a','d','v','a','n','c','e'] ] ],
...
cluster_22  = cluster
 ...
 |> "` ^g m" <| [
    ...
    FaCaL |< Iy               `adj`     {- <`a^gamIy> -}       [ ['n','o','n','-','A','r','a','b'], ['P','e','r','s','i','a','n'] ]
                              `plural`     HaFCAL
                              `plural`     FaCaL |< Iy |< Un,
...
cluster_34  = cluster
 ...
 |> "` r b" <| [
    ...
    FaCL |<< "a" |<< "^g" |< Iy `noun`    {- <`arba^gIy> -}      [ unwords [ ['c','a','r','t'], ['d','r','i','v','e','r'] ] ],

    FaCL |<< "a" |<< "^g" |< Iy `noun`    {- <`arba^gIy> -}      [ ['A','r','b','a','j','i'] ],

    FaCL |<< "a" |<< "_hAn" |< aT `noun`    {- <`arba_hAnaT> -}    [ unwords [ ['c','a','r'], ['s','h','e','d'] ], unwords [ ['c','o','a','c','h'], ['h','o','u','s','e'] ] ],
...
cluster_38  = cluster
 ...
 |> "` r ^g" <| [
    ...
    MaFCaL                    `noun`    {- <ma`ra^g> -}        [ unwords [ ['p','l','a','c','e'], ['o','f'], ['a','s','c','e','n','t'] ] ]
                              `plural`     MaFACiL,

    MiFCaL                    `noun`    {- <mi`ra^g> -}        [ ['l','a','d','d','e','r'], ['s','t','a','i','r','s'] ]
                              `plural`     MaFACiL,
    ...
    TaFCIL                    `noun`    {- <ta`rI^g> -}        [ ['c','u','r','v','a','t','u','r','e'], ['w','i','n','d','i','n','g'], ['s','e','r','p','e','n','t','i','n','e'] ]
                              `plural`     TaFACIL,
...
cluster_42  = cluster
 ...
 |> "` r s" <| [
    ...
    HaFCaL                    `verb`    {- <'a`ras> -}         [ unwords [ ['g','i','v','e'], "a", ['w','e','d','d','i','n','g'], ['f','e','a','s','t'] ] ],
    ...
    FaCUL                     `noun`    {- <`arUs> -}          [ ['b','r','i','d','e'], ['n','e','w','l','y','w','e','d'] ]
                              `plural`     FaCA'iL,
...
cluster_45  = cluster
 ...
 |> "` r .d" <| [
    ...
    FaCaL |< Iy               `adj`     {- <`ara.dIy> -}       [ ['n','o','n','e','s','s','e','n','t','i','a','l'], ['f','o','r','t','u','i','t','o','u','s'] ],
...
cluster_48  = cluster
 ...
 |> "` r f" <| [
    ...
    IFtaCaL                   `verb`    {- <i`taraf> -}        [ ['a','c','k','n','o','w','l','e','d','g','e'], ['r','e','c','o','g','n','i','z','e'], ['a','d','m','i','t'], ['c','o','n','f','e','s','s'] ],
...
cluster_51  = cluster
 ...
 |> "` r q l" <| [
    ...
    KaRDaS |< aT              `noun`    {- <`arqalaT> -}       [ ['o','b','s','t','a','c','l','e'], ['h','u','r','d','l','e'] ]
                              `plural`     KaRADIS,
...
cluster_61  = cluster
 ...
 |> "` z l" <| [
    ...
    HaFCaL                    `verb`    {- <'a`zal> -}         [ ['r','e','s','i','g','n'], unwords [ ['s','t','e','p'], ['d','o','w','n'] ] ],
...
cluster_70  = cluster
 ...
 |> "` s f" <| [
    ...
    TaFaCCuL |< Iy            `adj`     {- <ta`assufIy> -}     [ ['t','y','r','a','n','n','i','c','a','l'], ['d','e','s','p','o','t','i','c'], ['a','b','u','s','i','v','e'], ['a','r','b','i','t','r','a','r','y'] ],
...
cluster_89  = cluster
 ...
 |> ['`','u','.','s','m','A','n'] <| [
    ...
    _____ |<< "l" |< Iy       `adj`     {- <`u.smAnlIy> -}     [ ['O','t','t','o','m','a','n'], unwords [ ['o','l','d'], "-", ['f','a','s','h','i','o','n','e','d'] ] ] ]
...
cluster_98  = cluster
 ...
 |> "` .t ^s" <| [
    ...
    FaCaL |<< "^g" |< Iy      `noun`    {- <`a.ta^s^gIy> -}    [ ['s','t','o','k','e','r'], ['f','i','r','e','m','a','n'] ]
...
cluster_100 = cluster
 ...
 |> "` .t f" <| [
    ...
    MutaFACiL                 `adj`     {- <muta`A.tif> -}     [ ['s','y','m','p','a','t','h','i','z','e','r'], ['s','y','m','p','a','t','h','i','z','i','n','g'], ['s','y','m','p','a','t','h','e','t','i','c'] ],
