...
cluster_7   = cluster
 ...
 |> "_h z n" <| [
    ...
    FaCaL |<< "dAr"           `noun`    {- <_hazandAr> -}      [ ['t','r','e','a','s','u','r','e','r'] ],

    FaCaL |<< "dAr"           `noun`    {- <_hazandAr> -}      [ ['K','h','a','z','a','n','d','a','r'] ],

    FaCaL |<< "dAr" |< Iy     `noun`    {- <_hazandArIy> -}    [ ['t','r','e','a','s','u','r','e','r'] ],

    FaCaL |<< "dAr" |< Iy     `noun`    {- <_hazandArIy> -}    [ ['K','h','a','z','a','n','d','a','r','i'] ],
...
cluster_34  = cluster
 ...
 |> "_h .t b" <| [
    ...
    FaCIL                     `noun`    {- <_ha.tIb> -}        [ ['f','i','a','n','c','e'] ]
                              `plural`     FuCaLA',

    FaCIL |< aT               `noun`    {- <_ha.tIbaT> -}      [ ['f','i','a','n','c','e','e'] ]
                              `plural`     FaCIL |< At,
...
cluster_35  = cluster
 ...
 |> "_h .t r" <| [
    ...
    MuFACiL                   `adj`     {- <mu_hA.tir> -}      [ ['d','a','r','i','n','g'], ['v','e','n','t','u','r','e','s','o','m','e'], ['a','d','v','e','n','t','u','r','e','r'] ],
...
cluster_52  = cluster
 ...
 |> "_h l _h l" <| [
    ...
    MuKaRDaS                  `adj`     {- <mu_hal_hal> -}     [ ['r','a','r','e','f','i','e','d'] ],

    MutaKaRDiS                `adj`     {- <muta_hal_hil> -}   [ ['r','a','r','e','f','i','e','d'] ] ]
...
cluster_53  = cluster
 ...
 |> "_h l d" <| [
    ...
    FaCL |<< "Un"             `noun`    {- <_haldUn> -}        [ ['K','h','a','l','d','o','u','n'] ],
    ...
    FACiL |< Iy               `noun`    {- <_hAlidIy> -}       [ ['K','h','a','l','i','d','i'] ],

    MuFCiL                    `adj`     {- <mu_hlid> -}        [ ['i','n','c','l','i','n','e','d'], ['t','e','n','d','i','n','g'] ] ]
...
cluster_54  = cluster
 ...
 |> "_h l s" <| [
    ...
    FuCL |< aT |<< "aN"       `noun`    {- <_hulsaTaN> -}      [ unwords [ ['b','y'], ['s','t','e','a','l','t','h'] ], ['s','u','r','r','e','p','t','i','t','i','o','u','s','l','y'], ['f','u','r','t','i','v','e','l','y'] ],
...
cluster_57  = cluster
 ...
 |> "_h l `" <| [
    ...
    FaCCAL                    `adj`     {- <_hallA`> -}        [ ['u','n','r','u','l','y'], ['w','i','l','d'] ],

    FaCAL |< aT               `noun`    {- <_halA`aT> -}       [ ['l','i','c','e','n','t','i','o','u','s','n','e','s','s'], ['r','e','c','r','e','a','t','i','o','n'] ],

    FACiL                     `adj`     {- <_hAli`> -}         [ ['l','i','b','e','r','t','i','n','e'] ],

    MaFCUL                    `adj`     {- <ma_hlU`> -}        [ ['u','n','r','e','s','t','r','a','i','n','e','d'], ['i','r','r','e','s','p','o','n','s','i','b','l','e'] ] ]
...
cluster_58  = cluster
 ...
 |> "_h l f" <| [
    ...
    MuFaCCaL                  `adj`     {- <mu_hallaf> -}      [ ['l','e','f','t','o','v','e','r'], unwords [ ['l','e','f','t'], ['b','e','h','i','n','d'] ] ],
...
cluster_59  = cluster
 ...
 |> "_h l q" <| [
    ...
    HaFCaL                    `verb`    {- <'a_hlaq> -}        [ unwords [ ['w','e','a','r'], ['o','u','t'] ] ],
    ...
    HaFCaL                    `adj`     {- <'a_hlaq> -}        [ unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['a','p','p','r','o','p','r','i','a','t','e'] ] ],
    ...
    HaFCAL |< Iy              `adj`     {- <'a_hlAqIy> -}      [ ['m','o','r','a','l'], ['e','t','h','i','c','a','l'] ],

    lA >| HaFCAL |< Iy        `adj`     {- <lA-'a_hlAqIy> -}   [ ['i','m','m','o','r','a','l'], ['a','m','o','r','a','l'] ],

    FuCLAn |< Iy              `noun`    {- <_hulqAnIy> -}      [ unwords [ ['o','l','d'], "-", ['c','l','o','t','h','e','s'], ['d','e','a','l','e','r'] ] ],

    FACiL                     `noun`    {- <_hAliq> -}         [ ['K','h','a','l','i','q'] ],

    FACiL                     `noun`    {- <_hAliq> -}         [ ['c','r','e','a','t','o','r'] ],

    FACiL                     `adj`     {- <_hAliq> -}         [ ['c','r','e','a','t','i','v','e'] ],
    ...
    MuFtaCaL                  `adj`     {- <mu_htalaq> -}      [ ['f','a','b','r','i','c','a','t','e','d'], ['f','i','c','t','i','t','i','o','u','s'] ],
...
cluster_67  = cluster
 ...
 |> "_h m r" <| [
    ...
    FaCIL |< aT               `noun`    {- <_hamIraT> -}       [ ['e','n','z','y','m','e'], ['y','e','a','s','t'] ]
                              `plural`     FaCA'iL,
    ...
    MuFtaCiL                  `adj`     {- <mu_htamir> -}      [ ['f','e','r','m','e','n','t','i','n','g'], ['f','e','r','m','e','n','t','e','d'], ['a','l','c','o','h','o','l','i','c'] ] ]
...
cluster_68  = cluster
 ...
 |> "_h m s" <| [
    ...
    FaCL |< In |< Iy          `adj`     {- <_hamsInIy> -}      [ ['f','i','f','t','i','e','s'] ] ]
...
cluster_82  = cluster
 ...
 |> "_h n ^s" <| [
    ...
    FaCCUL |< Iy              `noun`    {- <_hannU^sIy> -}     [ ['K','h','a','n','n','o','u','c','h','i'] ] ]
