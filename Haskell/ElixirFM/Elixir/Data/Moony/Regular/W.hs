...
module Elixir.Data.Moony.Regular.W (lexicon) where
...
cluster_66  = cluster
 ...
 |> "yU.gUslAfiyA" <| [
    ...
    _____                     `noun`    {- <yU.gUslAfiyA> -}   [ ['Y','u','g','o','s','l','a','v','i','a'] ] ]
...
cluster_75  = cluster
 ...
 |> "yawma_dAk" <| [
    ...
    _____                     `noun`    {- <yawma_dAk> -}      [ unwords [ ['o','n'], ['t','h','a','t'], ['d','a','y'] ] ] ]
...
cluster_76  = cluster
 ...
 |> "yawma'i_diN" <| [
    ...
    _____                     `noun`    {- <yawma'i_diN> -}    [ unwords [ ['o','n'], ['t','h','a','t'], ['d','a','y'] ] ] ]
