...
cluster_1   = cluster
 ...
 |> "klImints" <| [
    ...
    _____                     `xtra`    {- <klImints> -}       [ ['C','l','e','m','e','n','t','s'] ] ]
...
cluster_2   = cluster
 ...
 |> "klIntUn" <| [
    ...
    _____                     `xtra`    {- <klIntUn> -}        [ ['C','l','i','n','t','o','n'] ] ]
...
cluster_3   = cluster
 ...
 |> "kl.g" <| [
    ...
    _____                     `ynit`    {- <kl.g> -}           [ ['k','i','l','o','g','r','a','m'] ] ]
...
cluster_4   = cluster
 ...
 |> "klm" <| [
    ...
    _____                     `ynit`    {- <klm> -}            [ ['k','i','l','o','m','e','t','e','r'] ] ]
...
cluster_5   = cluster
 ...
 |> "km" <| [
    ...
    _____                     `ynit`    {- <km> -}             [ ['k','i','l','o','m','e','t','e','r'] ] ]
...
cluster_14  = cluster
 ...
 |> "mItAfIzIqA" <| [
    ...
    _____                     `noun`    {- <mItAfIzIqA> -}     [ ['m','e','t','a','p','h','y','s','i','c','s'] ] ]
...
cluster_22  = cluster
 ...
 |> "mItsUbI^sI" <| [
    ...
    _____                     `xtra`    {- <mItsUbI^sI> -}     [ ['M','i','t','s','u','b','i','s','h','i'] ] ]
...
cluster_23  = cluster
 ...
 |> "mAtsArIllI" <| [
    ...
    _____                     `xtra`    {- <mAtsArIllI> -}     [ ['M','a','z','z','a','r','e','l','l','i'] ] ]
...
cluster_25  = cluster
 ...
 |> "mIt^sil" <| [
    ...
    _____                     `xtra`    {- <mIt^sil> -}        [ ['M','i','t','c','h','e','l','l'] ] ]
...
cluster_26  = cluster
 ...
 |> "mAt^sAlA" <| [
    ...
    _____                     `xtra`    {- <mAt^sAlA> -}       [ ['M','a','t','c','a','l','a'] ] ]
...
cluster_27  = cluster
 ...
 |> "mAtfIf" <| [
    ...
    _____                     `xtra`    {- <mAtfIf> -}         [ ['M','a','t','v','e','e','v'] ] ]
...
cluster_30  = cluster
 ...
 |> "m _t l" <| [
    ...
    FACiL                     `noun`    {- <mA_til> -}         [ ['v','i','s','i','b','l','e'], ['e','v','i','d','e','n','t'] ]
                              `plural`     FACiL |< Un
    ...
    MuFaCCiL                  `noun`    {- <muma_t_til> -}     [ ['a','c','t','o','r'], ['a','c','t','r','e','s','s'] ]
                              `plural`     MuFaCCiL |< At,
...
cluster_35  = cluster
 ...
 |> "m ^g d" <| [
    ...
    FaCIL |< Iy               `adj`     {- <ma^gIdIy> -}       [ ['M','a','j','e','e','d','i'], ['M','e','g','u','i','d','i'] ],

    FaCIL |< Iy               `adj`     {- <ma^gIdIy> -}       [ unwords [ ['m','e','d','j','i','d','i','e'], "(", ['O','t','t','o','m','a','n'], ['s','i','l','v','e','r'], ['c','o','i','n'], ")" ] ],
...
cluster_36  = cluster
 ...
 |> "ma^gdal" <| [
    ...
    _____                     `xtra`    {- <ma^gdal> -}        [ ['M','a','j','d','a','l'] ] ]
...
cluster_40  = cluster
 ...
 |> "m ^g s" <| [
    ...
    FaCUL |< Iy               `adj`     {- <ma^gUsIy> -}       [ ['M','a','g','i','a','n'], ['M','a','g','u','s'] ],
...
cluster_45  = cluster
 ...
 |> "m ^g n" <| [
    ...
    FaCCAL                    `noun`    {- <ma^g^gAn> -}       [ ['f','r','e','e'], ['g','r','a','t','i','s'] ]
                              `plural`     FaCCAL |< Un
...
cluster_48  = cluster
 ...
 |> "m .h .d" <| [
    ...
    FaCL                      `noun`    {- <ma.h.d> -}         [ ['m','e','r','e'], unwords [ ['n','o','t','h','i','n','g'], ['b','u','t'] ], ['s','o','l','e','l','y'], ['e','x','c','l','u','s','i','v','e','l','y'] ],
...
cluster_50  = cluster
 ...
 |> "m .h k" <| [
    ...
    FaCiL                     `noun`    {- <ma.hik> -}         [ ['q','u','a','r','r','e','l','s','o','m','e'], ['b','i','c','k','e','r','i','n','g'] ],

    MuFACaL |< aT             `noun`    {- <mumA.hakaT> -}     [ ['w','r','a','n','g','l','e'], ['d','i','s','p','u','t','e'], ['b','i','c','k','e','r','i','n','g'] ],

    FACiL                     `noun`    {- <mA.hik> -}         [ ['q','u','a','r','r','e','l','s','o','m','e'], ['c','o','n','t','e','n','t','i','o','u','s'], ['b','i','c','k','e','r','i','n','g'] ]
                              `plural`     FACiL |< Un
                           
    `derives` otherwise,

    MuFACiL                   `noun`    {- <mumA.hik> -}       [ ['q','u','a','r','r','e','l','s','o','m','e'], ['c','o','n','t','e','n','t','i','o','u','s'], ['b','i','c','k','e','r','i','n','g'] ]
                              `plural`     MuFACiL |< Un
...
cluster_52  = cluster
 ...
 |> "m .h n" <| [
    ...
    FuCayL |< Iy              `adj`     {- <mu.haynIy> -}      [ ['M','u','h','a','i','n','i'], ['M','a','h','a','y','n','i'] ] ]
...
cluster_55  = cluster
 ...
 |> "m _h r" <| [
    ...
    FACiL                     `noun`    {- <mA_hir> -}         [ unwords [ ['p','l','o','w','i','n','g'], ['t','h','r','o','u','g','h'] ], ['t','r','a','v','e','r','s','i','n','g'] ],
...
cluster_59  = cluster
 ...
 |> "m _h .t r" <| [
    ...
    MutaKaRDiS                `noun`    {- <mutama_h.tir> -}   [ unwords [ ['w','a','l','k','i','n','g'], ['g','r','a','c','e','f','u','l','l','y'] ] ]
...
cluster_63  = cluster
 ...
 |> "mA_hlAs" <| [
    ...
    _____                     `xtra`    {- <mA_hlAs> -}        [ ['M','a','c','h','l','a','s'] ] ]
...
cluster_70  = cluster
 ...
 |> "mada.ga^sqar" <| [
    ...
    _____                     `xtra`    {- <mada.ga^sqar> -}   [ ['M','a','d','a','g','a','s','c','a','r'] ] ]
...
cluster_72  = cluster
 ...
 |> "m d l" <| [
    ...
    FaCALI |< aT              `noun`    {- <madAliyaT> -}      [ ['m','e','d','a','l'] ],

    FuCIL                     `noun`    {- <mudIl> -}          [ ['m','o','d','e','l'], ['t','y','p','e'] ]
                              `plural`     FuCIL |< At ]
...
cluster_75  = cluster
 ...
 |> "m d l n" <| [
    ...
    KiRDiS                    `noun`    {- <midlin> -}         [ ['m','i','d','d','l','i','n','g'], ['m','e','d','i','o','c','r','e'] ] ]
...
cluster_76  = cluster
 ...
 |> "m d m" <| [
    ...
    FaCAL                     `noun`    {- <madAm> -}          [ ['m','a','d','a','m','e'], ['m','a','d','a','m'] ] ]
...
cluster_77  = cluster
 ...
 |> "m d n" <| [
    ...
    FaCaL |< Iy               `adj`     {- <madanIy> -}        [ ['M','a','d','a','n','i'] ],
...
cluster_78  = cluster
 ...
 |> "mAdAn^gIt" <| [
    ...
    _____                     `xtra`    {- <mAdAn^gIt> -}      [ ['M','a','d','a','n','j','e','e','t'] ] ]
...
cluster_81  = cluster
 ...
 |> "mAdlIn" <| [
    ...
    _____                     `xtra`    {- <mAdlIn> -}         [ ['M','a','d','e','l','e','i','n','e'] ] ]
...
cluster_84  = cluster
 ...
 |> "m _d r" <| [
    ...
    FaCiL                     `noun`    {- <ma_dir> -}         [ ['s','p','o','i','l','e','d'], ['r','o','t','t','e','n'] ] ]
...
cluster_85  = cluster
 ...
 |> "m _d q" <| [
    ...
    FaCCAL                    `noun`    {- <ma_d_dAq> -}       [ ['i','n','s','i','n','c','e','r','e'], ['h','y','p','o','c','r','i','t','e'] ]
                              `plural`     MuFACiL |< Un
                              `plural`     FaCCAL |< Un
...
cluster_89  = cluster
 ...
 |> "mArt" <| [
    ...
    _____                     `xtra`    {- <mArt> -}           [ ['M','a','r','c','h'], ['M','a','r','c','e','l','o'] ] ]
...
cluster_91  = cluster
 ...
 |> "mUrItAn" <| [
    ...
    _____ |< iyA              `noun`    {- <mUrItAniyA> -}     [ ['M','a','u','r','i','t','a','n','i','a'] ],
...
cluster_92  = cluster
 ...
 |> "mArAtsInA" <| [
    ...
    _____                     `xtra`    {- <mArAtsInA> -}      [ ['M','a','r','a','z','z','i','n','a'] ] ]
...
cluster_100 = cluster
 ...
 |> "murdU_h" <| [
    ...
    _____                     `xtra`    {- <murdU_h> -}        [ ['M','u','r','d','o','c','h'] ] ]
...
cluster_101 = cluster
 ...
 |> "mArAdUnA" <| [
    ...
    _____                     `xtra`    {- <mArAdUnA> -}       [ ['M','a','r','a','d','o','n','a'] ] ]
