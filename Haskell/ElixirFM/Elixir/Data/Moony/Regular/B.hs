...
cluster_2   = cluster
 ...
 |> "'imbiriyAl" <| [
    ...
    _____ |< Iy               `adj`     {- <'imbiriyAlIy> -}   [ ['i','m','p','e','r','i','a','l'] ],

    _____ |< Iy               `noun`    {- <'imbiriyAlIy> -}   [ ['i','m','p','e','r','i','a','l','i','s','t'] ]
                              `plural`     _____ |< Iy |< Un
...
cluster_3   = cluster
 ...
 |> "' b .t r" <| [
    ...
    KaRADiS |< aT             `noun`    {- <'abA.tiraT> -}     [ ['e','m','p','e','r','o','r','s'] ] ]



 |> "'imbirA.tUr" <| [

    _____                     `noun`    {- <'imbirA.tUr> -}    [ ['e','m','p','e','r','o','r'] ]
                              `plural`     _____ |< At,

    _____ |< Iy               `adj`     {- <'imbirA.tUrIy> -}  [ ['i','m','p','e','r','i','a','l'] ],

    _____ |< Iy |< aT         `noun`    {- <'imbirA.tUrIyaT> -} [ ['e','m','p','i','r','e'] ]
                              `plural`     _____ |< Iy |< At ]
...
cluster_5   = cluster
 ...
 |> "'illA" <| [
    ...
    _____                     `part`    {- <'illA> -}          [ ['h','o','w','e','v','e','r'], ['e','x','c','e','p','t'] ] ]
...
cluster_12  = cluster
 ...
 |> "'isbirAntU" <| [
    ...
    _____                     `noun`    {- <'isbirAntU> -}     [ ['E','s','p','e','r','a','n','t','o'] ] ]
...
cluster_13  = cluster
 ...
 |> "'isbidA^g" <| [
    ...
    _____                     `noun`    {- <'isbidA^g> -}      [ unwords [ ['w','h','i','t','e'], ['l','e','a','d'] ], ['c','e','r','u','s','e'] ] ]
...
cluster_14  = cluster
 ...
 |> "'isbAn" <| [
    ...
    _____ |< iyA              `noun`    {- <'isbAniyA> -}      [ ['S','p','a','i','n'] ],

    _____ |< Iy               `adj`     {- <'isbAnIy> -}       [ ['S','p','a','n','i','s','h'], ['S','p','a','n','i','a','r','d'] ]
                              `plural`     _____ |< Iy |< Un
                              `plural`     _____,

    _____ |< Iy               `noun`    {- <'isbAnIy> -}       [ ['S','p','a','n','i','s','h'], ['S','p','a','n','i','a','r','d'] ]
                              `plural`     _____ |< Iy |< Un
                              `plural`     _____
...
cluster_15  = cluster
 ...
 |> "'isbAna_h" <| [
    ...
    _____                     `noun`    {- <'isbAna_h> -}      [ ['s','p','i','n','a','c','h'] ] ]
...
cluster_16  = cluster
 ...
 |> "'isbA^gItI" <| [
    ...
    _____                     `noun`    {- <'isbA^gItI> -}     [ ['s','p','a','g','h','e','t','t','i'] ] ]
...
cluster_17  = cluster
 ...
 |> "'is.taqis" <| [
    ...
    _____                     `noun`    {- <'is.taqis> -}      [ ['e','l','e','m','e','n','t'] ]
                              `plural`     _____ |< At ]
...
cluster_18  = cluster
 ...
 |> "'is.tabl" <| [
    ...
    _____                     `noun`    {- <'is.tabl> -}       [ ['s','t','a','b','l','e'], ['b','a','r','n'] ]
                              `plural`     _____ |< At ]
...
cluster_19  = cluster
 ...
 |> "'is.tAnbUl" <| [
    ...
    _____                     `noun`    {- <'is.tAnbUl> -}     [ ['I','s','t','a','n','b','u','l'] ],

    _____ |< Iy               `adj`     {- <'is.tAnbUlIy> -}   [ unwords [ ['o','f'], "/", ['f','r','o','m'], ['I','s','t','a','n','b','u','l'] ] ],

    _____ |< Iy               `noun`    {- <'is.tAnbUlIy> -}   [ unwords [ ['o','f'], "/", ['f','r','o','m'], ['I','s','t','a','n','b','u','l'] ] ]
                              `plural`     _____ |< Iy |< Un
...
cluster_21  = cluster
 ...
 |> "' r d b" <| [
    ...
    KaRDaSS |< aT             `noun`    {- <'ardabbaT> -}      [ ['c','e','s','s','p','o','o','l'] ]
                              `plural`     KaRADiS ]
...
cluster_22  = cluster
 ...
 |> "'irbiyAn" <| [
    ...
    _____                     `noun`    {- <'irbiyAn> -}       [ ['c','r','a','w','f','i','s','h'], ['l','o','b','s','t','e','r'] ] ]
...
cluster_23  = cluster
 ...
 |> "'iqlIdis" <| [
    ...
    _____                     `noun`    {- <'iqlIdis> -}       [ ['E','u','c','l','i','d'] ] ]
...
cluster_25  = cluster
 ...
 |> "'iskutland" <| [
    ...
    _____ |<< "A"             `noun`    {- <'iskutlandA> -}    [ ['S','c','o','t','l','a','n','d'] ],

    _____ |< Iy               `adj`     {- <'iskutlandIy> -}   [ ['S','c','o','t','t','i','s','h'] ],

    _____ |< Iy               `noun`    {- <'iskutlandIy> -}   [ ['S','c','o','t','t','i','s','h'] ]
                              `plural`     _____ |< Iy |< Un
...
cluster_26  = cluster
 ...
 |> "'iskit^s" <| [
    ...
    _____                     `noun`    {- <'iskit^s> -}       [ ['s','k','e','t','c','h'] ]
                              `plural`     _____ |< At ]
...
cluster_27  = cluster
 ...
 |> "'iskarbU.t" <| [
    ...
    _____                     `noun`    {- <'iskarbU.t> -}     [ ['s','c','u','r','v','y'] ],

    _____ |< Iy               `adj`     {- <'iskarbU.tIy> -}   [ ['s','c','u','r','v','y'] ] ]
...
cluster_28  = cluster
 ...
 |> "'iskandar" <| [
    ...
    _____                     `noun`    {- <'iskandar> -}      [ ['I','s','k','a','n','d','a','r'], ['E','s','k','a','n','d','a','r'] ],

    _____ |< Iy |< aT         `noun`    {- <'iskandarIyaT> -}  [ ['A','l','e','x','a','n','d','r','i','a'] ],

    _____ |< Iy               `adj`     {- <'iskandarIy> -}    [ ['A','l','e','x','a','n','d','r','i','a','n'] ] ]
...
cluster_29  = cluster
 ...
 |> "'iskandInAf" <| [
    ...
    _____ |< iyA              `noun`    {- <'iskandInAfiyA> -} [ ['S','c','a','n','d','i','n','a','v','i','a'] ],

    _____ |< Iy               `adj`     {- <'iskandInAfIy> -}  [ ['S','c','a','n','d','i','n','a','v','i','a','n'] ],

    _____ |< Iy               `noun`    {- <'iskandInAfIy> -}  [ ['S','c','a','n','d','i','n','a','v','i','a','n'] ]
                              `plural`     _____ |< Iy |< Un
...
cluster_30  = cluster
 ...
 |> "'iskaml" <| [
    ...
    _____ |< aT               `noun`    {- <'iskamlaT> -}      [ ['s','t','o','o','l'] ] ]
...
cluster_31  = cluster
 ...
 |> "'iskUdU" <| [
    ...
    _____                     `noun`    {- <'iskUdU> -}        [ unwords [ ['e','s','c','u','d','o'], "(", ['m','o','n','e','t','a','r','y'], ['u','n','i','t'], ")" ] ] ]
...
cluster_33  = cluster
 ...
 |> "'iskImA'" <| [
    ...
    _____ |< Iy               `adj`     {- <'iskImA'Iy> -}     [ ['E','s','k','i','m','o'] ] ]
...
cluster_34  = cluster
 ...
 |> "'iskAlUb" <| [
    ...
    _____                     `noun`    {- <'iskAlUb> -}       [ ['e','s','c','a','l','o','p','e'], ['c','u','t','l','e','t'] ] ]
...
cluster_35  = cluster
 ...
 |> "'isfan^g" <| [
    ...
    _____                     `noun`    {- <'isfan^g> -}       [ ['s','p','o','n','g','e'] ],

    _____ |< Iy               `adj`     {- <'isfan^gIy> -}     [ ['p','o','r','o','u','s'], ['s','p','o','n','g','y'] ] ]
...
cluster_36  = cluster
 ...
 |> "'isfAna_h" <| [
    ...
    _____                     `noun`    {- <'isfAna_h> -}      [ ['s','p','i','n','a','c','h'] ] ]
...
cluster_37  = cluster
 ...
 |> "'isbirtU" <| [
    ...
    _____                     `noun`    {- <'isbirtU> -}       [ ['a','l','c','o','h','o','l'] ] ]
...
cluster_38  = cluster
 ...
 |> "'istUdiyU" <| [
    ...
    _____                     `noun`    {- <'istUdiyU> -}      [ ['s','t','u','d','i','o'] ]
                              `plural`     _____ |< At ]
...
cluster_39  = cluster
 ...
 |> "'istAtIk" <| [
    ...
    _____ |< Iy               `adj`     {- <'istAtIkIy> -}     [ ['s','t','a','t','i','c'] ],

    _____ |<< "A"             `noun`    {- <'istAtIkA> -}      [ ['s','t','a','t','i','c','s'] ] ]
...
cluster_40  = cluster
 ...
 |> "'isrA'Il" <| [
    ...
    _____                     `noun`    {- <'isrA'Il> -}       [ ['I','s','r','a','e','l'] ],

    _____ |< Iy               `adj`     {- <'isrA'IlIy> -}     [ ['I','s','r','a','e','l','i'] ],

    _____ |< Iy               `noun`    {- <'isrA'IlIy> -}     [ ['I','s','r','a','e','l','i'] ]
                              `plural`     _____ |< Iy |< Un
...
cluster_41  = cluster
 ...
 |> "'isqarbU.t" <| [
    ...
    _____                     `noun`    {- <'isqarbU.t> -}     [ ['s','c','u','r','v','y'] ],

    _____ |< Iy               `adj`     {- <'isqarbU.tIy> -}   [ ['s','c','u','r','v','y'] ] ]
...
cluster_42  = cluster
 ...
 |> "'ismA`Il" <| [
    ...
    _____                     `noun`    {- <'ismA`Il> -}       [ ['I','s','h','m','a','e','l'], ['I','s','m','a','i','l'] ],

    _____ |< Iy               `adj`     {- <'ismA`IlIy> -}     [ unwords [ ['f','r','o','m'], "/", ['o','f'], ['I','s','m','a','i','l','i','a'] ] ],

    _____ |< Iy               `noun`    {- <'ismA`IlIy> -}     [ unwords [ ['f','r','o','m'], "/", ['o','f'], ['I','s','m','a','i','l','i','a'] ] ]
                              `plural`     _____ |< Iy |< Un
                           
    `derives` otherwise,

    _____ |< Iy               `noun`    {- <'ismA`IlIy> -}     [ ['I','s','m','a','i','l','i'] ],

    _____ |< Iy |< aT         `noun`    {- <'ismA`IlIyaT> -}   [ ['I','s','m','a','i','l','i','a'] ] ]
...
cluster_43  = cluster
 ...
 |> "'islAnd" <| [
    ...
    _____ |< Iy               `adj`     {- <'islAndIy> -}      [ ['I','c','e','l','a','n','d','i','c'] ] ]
...
cluster_44  = cluster
 ...
 |> "'islAmbUl" <| [
    ...
    _____ |< Iy               `noun`    {- <'islAmbUlIy> -}    [ ['I','s','l','a','m','b','u','l','i'] ],

    _____ |< Iy               `adj`     {- <'islAmbUlIy> -}    [ unwords [ ['f','r','o','m'], "/", ['o','f'], ['I','s','t','a','n','b','u','l'] ] ],

    _____ |< Iy               `noun`    {- <'islAmbUlIy> -}    [ unwords [ ['f','r','o','m'], "/", ['o','f'], ['I','s','t','a','n','b','u','l'] ] ]
                              `plural`     _____ |< Iy |< Un
...
cluster_45  = cluster
 ...
 |> "'iskwA^s" <| [
    ...
    _____                     `noun`    {- <'iskwA^s> -}       [ unwords [ ['s','q','u','a','s','h'], "(", ['s','p','o','r','t'], ")" ] ] ]
...
cluster_49  = cluster
 ...
 |> "'u.tru.gull" <| [
    ...
    _____ |< aT               `noun`    {- <'u.tru.gullaT> -}  [ ['t','u','r','t','l','e','d','o','v','e'] ] ]
...
cluster_52  = cluster
 ...
 |> "'iwazz" <| [
    ...
    _____ |< aT               `noun`    {- <'iwazzaT> -}       [ ['g','o','o','s','e'], ['g','e','e','s','e'] ] ]
...
cluster_53  = cluster
 ...
 |> "'istu.gmAy" <| [
    ...
    _____ |< aT               `noun`    {- <'istu.gmAyaT> -}   [ unwords [ ['b','l','i','n','d'], "-", ['m','a','n','s','\''], ['b','u','f','f'] ] ] ]
...
cluster_54  = cluster
 ...
 |> "'istrU^gIn" <| [
    ...
    _____                     `noun`    {- <'istrU^gIn> -}     [ ['e','s','t','r','o','g','e','n'] ],

    _____ |< Iy               `adj`     {- <'istrU^gInIy> -}   [ ['e','s','t','r','o','g','e','n'] ] ]
...
cluster_55  = cluster
 ...
 |> "'istrAtI^g" <| [
    ...
    _____ |< Iy               `adj`     {- <'istrAtI^gIy> -}   [ ['s','t','r','a','t','e','g','i','c'] ],

    _____ |< Iy |< aT         `noun`    {- <'istrAtI^gIyaT> -} [ ['s','t','r','a','t','e','g','y'] ],

    _____ |< iyA              `noun`    {- <'istrAtI^giyA> -}  [ ['s','t','r','a','t','e','g','y'] ] ]
...
cluster_56  = cluster
 ...
 |> "'istarlIn" <| [
    ...
    _____ |< Iy               `adj`     {- <'istarlInIy> -}    [ ['s','t','e','r','l','i','n','g'] ] ]
...
cluster_57  = cluster
 ...
 |> "'istanbUl" <| [
    ...
    _____                     `noun`    {- <'istanbUl> -}      [ ['I','s','t','a','n','b','u','l'] ],

    _____ |< Iy               `adj`     {- <'istanbUlIy> -}    [ unwords [ ['f','r','o','m'], "/", ['o','f'], ['I','s','t','a','n','b','u','l'] ] ],

    _____ |< Iy               `noun`    {- <'istanbUlIy> -}    [ unwords [ ['f','r','o','m'], "/", ['o','f'], ['I','s','t','a','n','b','u','l'] ] ]
                              `plural`     _____ |< Iy |< Un
...
cluster_58  = cluster
 ...
 |> "'istabraq" <| [
    ...
    _____                     `noun`    {- <'istabraq> -}      [ ['b','r','o','c','a','d','e'] ] ]
...
cluster_59  = cluster
 ...
 |> "'istUn" <| [
    ...
    _____ |< iyA              `noun`    {- <'istUniyA> -}      [ ['E','s','t','o','n','i','a'] ],

    _____ |< Iy               `adj`     {- <'istUnIy> -}       [ ['E','s','t','o','n','i','a','n'] ],

    _____ |< Iy               `noun`    {- <'istUnIy> -}       [ ['E','s','t','o','n','i','a','n'] ]
                              `plural`     _____ |< Iy |< Un
...
cluster_60  = cluster
 ...
 |> "'us.tuwAn" <| [
    ...
    _____ |< aT               `noun`    {- <'us.tuwAnaT> -}    [ ['c','y','l','i','n','d','e','r'], ['d','i','s','k'], ['c','o','l','u','m','n','s'] ]
                              `plural`     _____ |< At,

    _____ |< Iy               `adj`     {- <'us.tuwAnIy> -}    [ ['c','y','l','i','n','d','r','i','c','a','l'], unwords [ ['d','i','s','k'], "-", ['l','i','k','e'] ] ] ]
...
cluster_61  = cluster
 ...
 |> "'urdunn" <| [
    ...
    _____                     `noun`    {- <'urdunn> -}        [ ['J','o','r','d','a','n'] ],

    _____ |< Iy               `adj`     {- <'urdunnIy> -}      [ ['J','o','r','d','a','n','i','a','n'] ],

    _____ |< Iy               `noun`    {- <'urdunnIy> -}      [ ['J','o','r','d','a','n','i','a','n'] ]
                              `plural`     _____ |< Iy |< Un
...
cluster_62  = cluster
 ...
 |> "'ur_tUduks" <| [
    ...
    _____                     `noun`    {- <'ur_tUduks> -}     [ ['O','r','t','h','o','d','o','x'] ],

    _____ |< Iy               `adj`     {- <'ur_tUduksIy> -}   [ ['O','r','t','h','o','d','o','x'] ] ]
...
cluster_63  = cluster
 ...
 |> "'ur^guwAn" <| [
    ...
    _____                     `noun`    {- <'ur^guwAn> -}      [ ['p','u','r','p','l','e'] ],

    _____ |< Iy               `adj`     {- <'ur^guwAnIy> -}    [ ['p','u','r','p','l','e'] ] ]
...
cluster_68  = cluster
 ...
 |> "'uktUbir" <| [
    ...
    _____                     `noun`    {- <'uktUbir> -}       [ ['O','c','t','o','b','e','r'] ] ]
...
cluster_69  = cluster
 ...
 |> "'uksi^gIn" <| [
    ...
    _____ |< Iy               `adj`     {- <'uksi^gInIy> -}    [ ['o','x','y','g','e','n','a','t','e','d'] ] ]
...
cluster_70  = cluster
 ...
 |> "ka'ann" <| [
    ...
    _____ |<< "a"             `conj`    {- <ka'anna> -}        [ unwords [ ['a','s'], ['i','f'] ] ] ]
...
cluster_71  = cluster
 ...
 |> "bi'asr" <| [
    ...
    _____ |<< "i"             `noun`    {- <bi'asri> -}        [ ['c','o','m','p','l','e','t','e','l','y'], unwords [ ['a','l','l'], ['o','f'] ] ] ]
...
cluster_72  = cluster
 ...
 |> "bi'ann" <| [
    ...
    _____ |<< "a"             `part`    {- <bi'anna> -}        [ unwords [ ['w','i','t','h'], ['t','h','a','t'] ] ] ]
...
cluster_73  = cluster
 ...
 |> "bi'an" <| [
    ...
    _____                     `part`    {- <bi'an> -}          [ unwords [ ['w','i','t','h'], ['t','h','a','t'] ] ] ]
...
cluster_74  = cluster
 ...
 |> "'usturAl" <| [
    ...
    _____ |< iyA              `noun`    {- <'usturAliyA> -}    [ ['A','u','s','t','r','a','l','i','a'] ],
...
cluster_75  = cluster
 ...
 |> "'ustriyA" <| [
    ...
    _____                     `noun`    {- <'ustriyA> -}       [ ['A','u','s','t','r','i','a'] ] ]
...
cluster_76  = cluster
 ...
 |> "ka'annamA" <| [
    ...
    _____                     `conj`    {- <ka'annamA> -}      [ unwords [ ['a','s'], ['i','f'] ] ] ]
...
cluster_80  = cluster
 ...
 |> "b .d `" <| [
    ...
    FaCaL                     `verb`    {- <ba.da`> -}         [ ['d','i','s','s','e','c','t'], ['o','p','e','r','a','t','e'] ]
                              `imperf`     FCaL,

    FaCCaL                    `verb`    {- <ba.d.da`> -}       [ ['d','i','s','s','e','c','t'] ],

    FACaL                     `verb`    {- <bA.da`> -}         [ unwords [ ['h','a','v','e'], ['s','e','x'], ['w','i','t','h'] ] ],

    HaFCaL                    `verb`    {- <'ab.da`> -}        [ ['i','n','v','e','s','t'] ],

    TaFaCCaL                  `verb`    {- <taba.d.da`> -}     [ unwords [ ['d','o'], ['b','u','s','i','n','e','s','s'] ] ],

    IstaFCaL                  `verb`    {- <istab.da`> -}      [ ['t','r','a','d','e'], unwords [ ['d','o'], ['b','u','s','i','n','e','s','s'] ] ],

    FaCL                      `noun`    {- <ba.d`> -}          [ ['a','m','p','u','t','a','t','i','o','n'] ],
    ...
    MiFCaL                    `noun`    {- <mib.da`> -}        [ ['s','c','a','l','p','e','l'] ]
                              `plural`     MaFACiL,

    HiFCAL                    `noun`    {- <'ib.dA`> -}        [ ['p','a','r','t','n','e','r','s','h','i','p'], ['i','n','v','e','s','t','m','e','n','t'] ]
                              `plural`     HiFCAL |< At,

    MuFCiL                    `noun`    {- <mub.di`> -}        [ unwords [ ['l','i','m','i','t','e','d'], ['p','a','r','t','n','e','r'] ] ]
                              `plural`     MuFCiL |< Un
                           
    `derives` otherwise,

    MustaFCiL                 `noun`    {- <mustab.di`> -}     [ ['m','a','n','a','g','e','r'] ]
                              `plural`     MustaFCiL |< Un
...
cluster_81  = cluster
 ...
 |> "b .g .d" <| [
    ...
    FaCiL                     `verb`    {- <ba.gi.d> -}        [ ['d','e','s','p','i','s','e'], ['h','a','t','e'] ]
                              `imperf`     FCaL,

    FaCuL                     `verb`    {- <ba.gu.d> -}        [ unwords [ ['b','e'], ['h','a','t','e','f','u','l'] ] ]
                              `imperf`     FCuL,

    FaCCaL                    `verb`    {- <ba.g.ga.d> -}      [ unwords [ ['m','a','k','e'], ['h','a','t','e','f','u','l'] ] ],

    FACaL                     `verb`    {- <bA.ga.d> -}        [ ['l','o','a','t','h','e'] ],

    HaFCaL                    `verb`    {- <'ab.ga.d> -}       [ ['d','e','t','e','s','t'], ['h','a','t','e'] ],

    TaFACaL                   `verb`    {- <tabA.ga.d> -}      [ ['d','e','t','e','s','t'], ['h','a','t','e'] ],

    FuCL                      `noun`    {- <bu.g.d> -}         [ ['h','a','t','r','e','d'] ],

    FiCL |< aT                `noun`    {- <bi.g.daT> -}       [ ['h','a','t','r','e','d'] ],

    FaCLA'                    `noun`    {- <ba.g.dA'> -}       [ ['h','a','t','r','e','d'] ],

    FaCIL                     `noun`    {- <ba.gI.d> -}        [ ['o','d','i','o','u','s'], ['l','o','a','t','h','s','o','m','e'] ]
                              `plural`     FaCIL |< Un
                           
    `derives` otherwise,

    TaFACuL                   `noun`    {- <tabA.gu.d> -}      [ unwords [ ['m','u','t','u','a','l'], ['h','a','t','r','e','d'] ] ]
                              `plural`     TaFACuL |< At,

    MaFCUL                    `noun`    {- <mab.gU.d> -}       [ ['d','e','t','e','s','t','e','d'], ['o','d','i','o','u','s'] ]
                              `plural`     MaFCUL |< Un
                           
    `derives` otherwise,

    MuFCiL                    `noun`    {- <mub.gi.d> -}       [ ['h','a','t','i','n','g'], ['d','e','t','e','s','t','i','n','g'] ]
                              `plural`     MuFCiL |< Un
                           
    `derives` otherwise,

    MuFCaL                    `noun`    {- <mub.ga.d> -}       [ ['d','e','t','e','s','t','e','d'], ['o','d','i','o','u','s'] ]
                              `plural`     MuFCaL |< Un
...
cluster_82  = cluster
 ...
 |> "b .g r" <| [
    ...
    FaCaL                     `verb`    {- <ba.gar> -}         [ unwords [ ['f','o','r','e','c','a','s','t'], ['r','a','i','n'] ] ]
                              `imperf`     FCuL,

    FuCUL                     `noun`    {- <bu.gUr> -}         [ unwords [ ['f','o','r','e','c','a','s','t','i','n','g'], ['r','a','i','n'] ] ],

    FaCL |< aT                `noun`    {- <ba.graT> -}        [ unwords [ ['r','a','i','n'], ['s','h','o','w','e','r'] ] ],

    MaFCUL                    `noun`    {- <mab.gUr> -}        [ ['d','r','e','n','c','h','e','d'], ['s','o','a','k','e','d'] ]
                              `plural`     MaFCUL |< Un
...
cluster_83  = cluster
 ...
 |> "b .g l" <| [
    ...
    FaCL                      `noun`    {- <ba.gl> -}          [ ['m','u','l','e'], unwords [ ['s','h','e'], "-", ['a','s','s'] ] ]
                              `plural`     HaFCAL
                              `plural`     FiCAL,

    FaCCAL                    `noun`    {- <ba.g.gAl> -}       [ ['m','u','l','e','t','e','e','r'] ]
                              `plural`     FaCCAL |< Un
...
cluster_84  = cluster
 ...
 |> "b .g d" <| [
    ...
    FUCAL |< aT               `noun`    {- <bU.gAdaT> -}       [ ['p','o','t','a','s','h'], ['l','y','e'] ] ]
...
cluster_85  = cluster
 ...
 |> "b .g _t r" <| [
    ...
    KaRDaS |< aT              `noun`    {- <ba.g_taraT> -}     [ ['a','g','i','t','a','t','i','o','n'], ['a','v','e','r','s','i','o','n'] ] ]
...
cluster_86  = cluster
 ...
 |> "b .g _t" <| [
    ...
    FuCAL                     `noun`    {- <bu.gA_t> -}        [ ['s','p','a','r','r','o','w','s'] ]
                              `plural`     FiCLAn ]
...
cluster_87  = cluster
 ...
 |> "b .g ^s" <| [
    ...
    FaCaL                     `verb`    {- <ba.ga^s> -}        [ ['s','h','o','w','e','r'] ]
                              `imperf`     FCaL,

    FaCL |< aT                `noun`    {- <ba.g^saT> -}       [ ['s','h','o','w','e','r'] ]
                              `plural`     FaCaL |< At,

    FuCL |< aT                `noun`    {- <bu.g^saT> -}       [ unwords [ ['b','u','g','h','s','h','a'], "(", ['Y','e','m','e','n','i'], ['c','o','p','p','e','r'], ['c','o','i','n'], ")" ] ],

    FuCAL |< aT               `noun`    {- <bu.gA^saT> -}      [ ['b','o','u','g','h','a','s','h','a','h'] ] ]
...
cluster_88  = cluster
 ...
 |> "b .g t" <| [
    ...
    FaCaL                     `verb`    {- <ba.gat> -}         [ ['s','u','r','p','r','i','s','e'], unwords [ ['a','r','r','i','v','e'], ['s','u','d','d','e','n','l','y'] ] ]
                              `imperf`     FCaL,

    FACaL                     `verb`    {- <bA.gat> -}         [ ['s','u','r','p','r','i','s','e'], unwords [ ['a','r','r','i','v','e'], ['s','u','d','d','e','n','l','y'] ] ],

    InFaCaL                   `verb`    {- <inba.gat> -}       [ unwords [ ['b','e'], ['s','u','r','p','r','i','s','e','d'] ] ],

    FaCL |< aT                `noun`    {- <ba.gtaT> -}        [ ['s','u','r','p','r','i','s','e'] ]
                              `plural`     FaCaL |< At,

    FaCL |< Iy                `adj`     {- <ba.gtIy> -}        [ ['s','u','d','d','e','n'], ['u','n','e','x','p','e','c','t','e','d'] ],

    MuFACaL |< aT             `noun`    {- <mubA.gataT> -}     [ unwords [ ['s','u','d','d','e','n'], ['a','r','r','i','v','a','l'] ], ['s','u','r','p','r','i','s','e'] ],

    FACiL                     `adj`     {- <bA.git> -}         [ ['s','u','d','d','e','n'], ['u','n','e','x','p','e','c','t','e','d'] ],

    MuFACiL                   `adj`     {- <mubA.git> -}       [ ['s','u','d','d','e','n'], ['u','n','e','x','p','e','c','t','e','d'] ] ]
...
cluster_89  = cluster
 ...
 |> "b .g z" <| [
    ...
    FUCAL                     `noun`    {- <bU.gAz> -}         [ ['s','t','r','a','i','t'], ['h','a','r','b','o','r'] ]
                              `plural`     FawACIL ]
...
cluster_94  = cluster
 ...
 |> "b .h _t r" <| [
    ...
    MuKaRDiS                  `noun`    {- <muba.h_tir> -}     [ ['s','q','u','a','n','d','e','r','e','r'], ['d','i','s','s','i','p','a','t','i','n','g'] ]
                              `plural`     MuKaRDiS |< Un
...
cluster_96  = cluster
 ...
 |> "b .s _h" <| [
    ...
    FaCaL |< aT               `noun`    {- <ba.sa_haT> -}      [ ['E','a','s','t','e','r'], unwords [ ['P','a','s','s','i','o','n'], ['W','e','e','k'] ] ] ]
...
cluster_98  = cluster
 ...
 |> "b .h t" <| [
    ...
    FaCL |<< "aN"             `adv`     {- <ba.htaN> -}        [ ['p','u','r','e','l','y'], ['e','x','c','l','u','s','i','v','e','l','y'] ],
...
cluster_99  = cluster
 ...
 |> "b .s q" <| [
    ...
    FaCaL                     `verb`    {- <ba.saq> -}         [ ['s','p','i','t'] ]
                              `imperf`     FCuL,

    FaCL                      `noun`    {- <ba.sq> -}          [ ['s','p','i','t'], ['s','a','l','i','v','a'] ],

    FuCAL                     `noun`    {- <bu.sAq> -}         [ ['s','p','i','t'], ['s','a','l','i','v','a'] ],

    MiFCaL |< aT              `noun`    {- <mib.saqaT> -}      [ ['s','p','i','t','t','o','o','n'] ]
                              `plural`     MaFACiL ]
...
cluster_100 = cluster
 ...
 |> "b .s m" <| [
    ...
    FaCaL                     `verb`    {- <ba.sam> -}         [ ['i','m','p','r','i','n','t'], ['s','t','a','m','p'] ]
                              `imperf`     FCuL,

    FaCL |< aT                `noun`    {- <ba.smaT> -}        [ ['f','i','n','g','e','r','p','r','i','n','t'], ['i','m','p','r','i','n','t'] ]
                              `plural`     FaCaL |< At ]
...
cluster_101 = cluster
 ...
 |> "b .s l" <| [
    ...
    FaCaL                     `noun`    {- <ba.sal> -}         [ ['o','n','i','o','n'] ]
                              `plural`     FaCaL |< At,

    FaCaL |< Iy               `adj`     {- <ba.salIy> -}       [ ['b','u','l','b','o','u','s'], unwords [ ['o','n','i','o','n'], "-", ['l','i','k','e'] ] ],

    FuCayL |< aT              `noun`    {- <bu.saylaT> -}      [ ['b','u','l','b'], unwords [ ['s','m','a','l','l'], ['o','n','i','o','n'] ] ]
                              `plural`     FuCayL |< At ]
...
cluster_102 = cluster
 ...
 |> "b .s b .s" <| [
    ...
    KaRDaS                    `verb`    {- <ba.sba.s> -}       [ unwords [ ['w','a','g'], "(", ['t','a','i','l'], ")" ] ],

    KaRDaS                    `verb`    {- <ba.sba.s> -}       [ ['o','g','l','e'], ['s','t','a','r','e'] ],

    KaRDaS |< aT              `noun`    {- <ba.sba.saT> -}     [ ['w','a','g','g','i','n','g'] ],

    KaRDaS |< aT              `noun`    {- <ba.sba.saT> -}     [ ['o','g','l','i','n','g'], ['s','t','a','r','i','n','g'] ] ]
...
cluster_103 = cluster
 ...
 |> "b .s r" <| [
    ...
    FaCL |< Iy                `adj`     {- <ba.srIy> -}        [ unwords [ ['o','f'], "/", ['f','r','o','m'], ['B','a','s','r','a'] ] ],

    FaCL |< Iy                `noun`    {- <ba.srIy> -}        [ unwords [ ['o','f'], "/", ['f','r','o','m'], ['B','a','s','r','a'] ] ]
                              `plural`     FaCL |< Iy |< Un
                           
    `derives` otherwise,

    FaCL |< Iy                `noun`    {- <ba.srIy> -}        [ ['B','a','s','r','i'] ],

    FaCL |< aT                `noun`    {- <ba.sraT> -}        [ ['B','a','s','r','a'] ] ]



 |> "b .s r" <| [

    FaCuL                     `verb`    {- <ba.sur> -}         [ ['p','e','r','c','e','i','v','e'], ['u','n','d','e','r','s','t','a','n','d'], ['r','e','a','l','i','z','e'], ['s','e','e'] ]
                              `imperf`     FCuL,

    FaCiL                     `verb`    {- <ba.sir> -}         [ ['p','e','r','c','e','i','v','e'], ['u','n','d','e','r','s','t','a','n','d'], ['r','e','a','l','i','z','e'], ['s','e','e'] ]
                              `imperf`     FCaL,

    FaCCaL                    `verb`    {- <ba.s.sar> -}       [ unwords [ ['m','a','k','e'], ['s','e','e'] ], ['e','n','l','i','g','h','t','e','n'] ],

    HaFCaL                    `verb`    {- <'ab.sar> -}        [ ['s','e','e'], ['n','o','t','i','c','e'] ],

    TaFaCCaL                  `verb`    {- <taba.s.sar> -}     [ ['e','n','v','i','s','a','g','e'], ['p','o','n','d','e','r'] ],

    IstaFCaL                  `verb`    {- <istab.sar> -}      [ unwords [ ['b','e'], ['r','a','t','i','o','n','a','l'] ], ['r','e','f','l','e','c','t'] ],

    FaCaL                     `noun`    {- <ba.sar> -}         [ ['v','i','s','i','o','n'], ['g','l','a','n','c','e'] ],

    HaFCAL                    `noun`    {- <'ab.sAr> -}        [ ['p','e','r','c','e','p','t','i','o','n','s'], ['v','i','e','w','s'], ['g','l','a','n','c','e','s'] ],

    FaCaL |< Iy               `adj`     {- <ba.sarIy> -}       [ ['v','i','s','u','a','l'], ['o','p','t','i','c','a','l'] ],

    FaCaL |< Iy |< At         `noun`    {- <ba.sarIyAt> -}     [ ['o','p','t','i','c','s'] ],

    FaCAL |< aT               `noun`    {- <ba.sAraT> -}       [ ['p','e','r','c','e','p','t','i','o','n'] ],

    FaCIL                     `adj`     {- <ba.sIr> -}         [ ['s','e','e','i','n','g'], ['d','i','s','c','e','r','n','i','n','g'] ]
                              `plural`     FuCaLA'
                              `plural`     FaCIL |< Un,

    FaCIL |< aT               `noun`    {- <ba.sIraT> -}       [ ['i','n','s','i','g','h','t'], ['d','i','s','c','e','r','n','m','e','n','t'] ]
                              `plural`     FaCA'iL,

    HaFCaL                    `adj`     {- <'ab.sar> -}        [ unwords [ ['m','o','r','e'], "/", ['m','o','s','t'], ['d','i','s','c','e','r','n','i','n','g'] ] ],

    TaFCiL |< aT              `noun`    {- <tab.siraT> -}      [ ['e','n','l','i','g','h','t','e','n','m','e','n','t'], ['i','n','s','t','r','u','c','t','i','o','n'] ],

    HiFCAL                    `noun`    {- <'ib.sAr> -}        [ ['p','e','r','c','e','p','t','i','o','n'], ['v','i','s','i','o','n'] ]
                              `plural`     HiFCAL |< At,

    HiFCAL |< Iy              `adj`     {- <'ib.sArIy> -}      [ ['o','p','t','i','c','a','l'] ],

    TaFaCCuL                  `noun`    {- <taba.s.sur> -}     [ ['r','e','f','l','e','c','t','i','o','n'], ['c','o','n','s','i','d','e','r','a','t','i','o','n'] ]
                              `plural`     TaFaCCuL |< At,

    IstiFCAL                  `noun`    {- <istib.sAr> -}      [ ['i','n','s','i','g','h','t'], ['p','s','y','c','h','o','l','o','g','y'] ]
                              `plural`     IstiFCAL |< At,

    FACiL                     `noun`    {- <bA.sir> -}         [ ['B','a','s','i','r'] ],

    FACiL                     `noun`    {- <bA.sir> -}         [ unwords [ ['A','l','l'], "-", ['s','e','e','i','n','g'], "(", ['G','o','d'], ")" ] ],

    FACiL |< aT               `noun`    {- <bA.siraT> -}       [ ['e','y','e'] ]
                              `plural`     FawACiL,

    MutaFaCCiL                `adj`     {- <mutaba.s.sir> -}   [ ['i','n','s','i','g','h','t','f','u','l'], ['i','n','f','o','r','m','e','d'] ],

    FiCAL |< aT               `noun`    {- <bi.sAraT> -}       [ ['p','o','r','r','i','d','g','e'] ],

    FuCAL |< aT               `noun`    {- <bu.sAraT> -}       [ ['p','o','r','r','i','d','g','e'] ] ]
...
cluster_104 = cluster
 ...
 |> "b .t ^s" <| [
    ...
    FaCaL                     `verb`    {- <ba.ta^s> -}        [ ['a','t','t','a','c','k'], ['s','t','r','i','k','e'], ['l','u','n','g','e'] ]
                              `imperf`     FCiL
                              `imperf`     FCuL,

    FaCL                      `noun`    {- <ba.t^s> -}         [ ['f','o','r','c','e'], ['o','p','p','r','e','s','s','i','o','n'] ],

    FaCL |< aT                `noun`    {- <ba.t^saT> -}       [ ['i','m','p','a','c','t'] ]
                              `plural`     FaCaL |< At ]
...
cluster_105 = cluster
 ...
 |> "b .t .h" <| [
    ...
    FaCaL                     `verb`    {- <ba.ta.h> -}        [ unwords [ ['k','n','o','c','k'], ['d','o','w','n'] ], unwords [ ['l','a','y'], ['d','o','w','n'] ], ['f','l','o','o','r'] ]
                              `imperf`     FCaL,

    TaFaCCaL                  `verb`    {- <taba.t.ta.h> -}    [ unwords [ ['l','i','e'], ['d','o','w','n'] ], unwords [ ['b','e'], ['f','l','o','o','r','e','d'] ] ],

    InFaCaL                   `verb`    {- <inba.ta.h> -}      [ unwords [ ['l','i','e'], ['d','o','w','n'] ], unwords [ ['b','e'], ['f','l','o','o','r','e','d'] ] ],

    HaFCaL                    `noun`    {- <'ab.ta.h> -}       [ ['f','l','a','t'], ['l','e','v','e','l'] ],

    HaFACiL                   `noun`    {- <'abA.ti.h> -}      [ unwords [ ['w','i','d','e'], ['v','a','l','l','e','y'] ], ['p','l','a','i','n'] ],

    FaCLA'                    `noun`    {- <ba.t.hA'> -}       [ unwords [ ['w','i','d','e'], ['v','a','l','l','e','y'] ], ['p','l','a','i','n'] ]
                              `plural`     FiCAL,

    FaCIL |< aT               `noun`    {- <ba.tI.haT> -}      [ unwords [ ['w','i','d','e'], ['v','a','l','l','e','y'] ], ['p','l','a','i','n'] ]
                              `plural`     FaCA'iL,

    MunFaCiL                  `adj`     {- <munba.ti.h> -}     [ ['p','r','o','s','t','r','a','t','e'], unwords [ ['l','y','i','n','g'], ['d','o','w','n'] ] ],

    MunFaCiL                  `adj`     {- <munba.ti.h> -}     [ ['p','l','a','i','n'], ['f','l','a','t'] ],

    InFiCAL                   `noun`    {- <inbi.tA.h> -}      [ ['p','r','o','s','t','r','a','t','i','o','n'], unwords [ ['l','y','i','n','g'], ['d','o','w','n'] ] ]
                              `plural`     InFiCAL |< At ]
...
cluster_106 = cluster
 ...
 |> "b .t l" <| [
    ...
    FaCaL                     `verb`    {- <ba.tal> -}         [ unwords [ ['b','e','c','o','m','e'], ['v','o','i','d'] ] ]
                              `imperf`     FCuL,

    FaCuL                     `verb`    {- <ba.tul> -}         [ unwords [ ['b','e'], ['h','e','r','o','i','c'] ] ]
                              `imperf`     FCuL,

    FaCCaL                    `verb`    {- <ba.t.tal> -}       [ ['t','h','w','a','r','t'], ['a','b','o','l','i','s','h'] ],

    HaFCaL                    `verb`    {- <'ab.tal> -}        [ ['n','e','u','t','r','a','l','i','z','e'], ['i','n','v','a','l','i','d','a','t','e'] ],

    FuCL                      `noun`    {- <bu.tl> -}          [ ['n','u','l','l','i','t','y'] ],

    FiCAL |< aT               `noun`    {- <bi.tAlaT> -}       [ ['i','d','l','e','n','e','s','s'], ['j','o','b','l','e','s','s','n','e','s','s'], ['u','n','e','m','p','l','o','y','e','m','e','n','t'] ],

    FaCAL |< aT               `noun`    {- <ba.tAlaT> -}       [ ['i','d','l','e','n','e','s','s'], ['j','o','b','l','e','s','s','n','e','s','s'], ['u','n','e','m','p','l','o','y','m','e','n','t'] ],

    FaCCAL                    `adj`     {- <ba.t.tAl> -}       [ ['i','n','a','c','t','i','v','e'], ['j','o','b','l','e','s','s'] ],

    FuCLAn                    `noun`    {- <bu.tlAn> -}        [ ['n','u','l','l','i','t','y'], ['f','a','l','s','i','t','y'] ],

    HiFCAL                    `noun`    {- <'ib.tAl> -}        [ ['t','h','w','a','r','t','i','n','g'], ['a','b','o','l','i','t','i','o','n'] ]
                              `plural`     HiFCAL |< At,

    FACiL                     `adj`     {- <bA.til> -}         [ ['v','o','i','d'], ['f','a','l','s','e'] ],

    HaFACIL                   `noun`    {- <'abA.tIl> -}       [ ['v','a','n','i','t','i','e','s'], ['f','a','l','s','e','h','o','o','d'] ],

    MuFCiL                    `noun`    {- <mub.til> -}        [ ['p','r','a','t','t','l','e','r'], ['l','i','a','r'] ]
                              `plural`     MuFCiL |< Un
                           
    `derives` otherwise,

    MuFCaL                    `adj`     {- <mub.tal> -}        [ ['f','a','l','s','e'], ['f','u','t','i','l','e'] ],

    MutaFaCCiL                `adj`     {- <mutaba.t.til> -}   [ ['u','n','e','m','p','l','o','y','e','d'] ],

    FaCaL                     `noun`    {- <ba.tal> -}         [ ['h','e','r','o'], ['c','h','a','m','p','i','o','n'], ['s','t','a','r'] ]
                              `plural`     HaFCAL
    ...
    FaCAL                     `noun`    {- <ba.tAl> -}         [ ['h','e','r','o','i','s','m'] ] ]
...
cluster_107 = cluster
 ...
 |> "b .t b .t" <| [
    ...
    KaRDaS                    `verb`    {- <ba.tba.t> -}       [ ['q','u','a','c','k'] ],

    KaRDaS |< aT              `noun`    {- <ba.tba.taT> -}     [ ['q','u','a','c','k','i','n','g'] ] ]
...
cluster_108 = cluster
 ...
 |> "b .t m" <| [
    ...
    FuCL                      `noun`    {- <bu.tm> -}          [ ['t','e','r','e','b','i','n','t','h'] ],

    FuCL |< Iy                `noun`    {- <bu.tmIy> -}        [ ['t','e','r','e','b','i','n','t','h','s'] ] ]
...
cluster_109 = cluster
 ...
 |> "b .t l s" <| [
    ...
    KaRADiS |< aT             `noun`    {- <ba.tAlisaT> -}     [ ['P','t','o','l','e','m','i','e','s'] ] ]
...
cluster_110 = cluster
 ...
 |> "bA.tUn" <| [
    ...
    _____                     `noun`    {- <bA.tUn> -}         [ ['c','o','n','c','r','e','t','e'] ] ]



 |> "b .t n" <| [

    FaCaL                     `verb`    {- <ba.tan> -}         [ ['h','i','d','e'], ['c','o','n','c','e','a','l'] ]
                              `imperf`     FCuL,

    FaCuL                     `verb`    {- <ba.tun> -}         [ unwords [ ['b','e'], ['p','a','u','n','c','h','y'] ] ]
                              `imperf`     FCuL,

    FaCCaL                    `verb`    {- <ba.t.tan> -}       [ ['c','o','v','e','r'], ['r','e','s','u','r','f','a','c','e'] ],

    HaFCaL                    `verb`    {- <'ab.tan> -}        [ ['h','i','d','e'], ['c','o','n','c','e','a','l'], unwords [ ['b','e'], ['h','i','d','d','e','n'] ] ],

    TaFaCCaL                  `verb`    {- <taba.t.tan> -}     [ unwords [ ['b','e'], ['l','i','n','e','d'] ] ],

    IstaFCaL                  `verb`    {- <istab.tan> -}      [ ['d','e','l','v','e'], ['p','e','n','e','t','r','a','t','e'] ],

    FaCL                      `noun`    {- <ba.tn> -}          [ ['s','t','o','m','a','c','h'], ['d','e','p','t','h'], ['i','n','t','e','r','i','o','r'] ]
                              `plural`     HaFCuL,

    FuCUL                     `noun`    {- <bu.tUn> -}         [ ['i','n','t','e','r','i','o','r'] ],

    FaCL |< Iy                `adj`     {- <ba.tnIy> -}        [ ['a','b','d','o','m','i','n','a','l'], ['b','e','l','l','y'] ],

    FiCL |< aT                `noun`    {- <bi.tnaT> -}        [ ['g','l','u','t','t','o','n','y'] ],

    FiCAL                     `noun`    {- <bi.tAn> -}         [ ['g','i','r','t','h'], ['p','a','u','n','c','h','y'] ],

    FaCAL |< aT               `noun`    {- <ba.tAnaT> -}       [ ['l','i','n','i','n','g'], ['i','n','s','i','d','e'] ],

    FiCAL |< aT               `noun`    {- <bi.tAnaT> -}       [ ['l','i','n','i','n','g'], ['i','n','s','i','d','e'] ],

    FaCIL                     `adj`     {- <ba.tIn> -}         [ ['p','a','u','n','c','h','y'] ],

    MiFCAL                    `noun`    {- <mib.tAn> -}        [ ['p','a','u','n','c','h','y'] ],

    FuCayL                    `noun`    {- <bu.tayn> -}        [ ['v','e','n','t','r','i','c','l','e'] ]
                              `plural`     FuCayL |< At,

    FaCCAL |< Iy |< aT        `noun`    {- <ba.t.tAnIyaT> -}   [ ['b','l','a','n','k','e','t'] ]
                              `plural`     FaCACIL
                              `plural`     FaCCAL |< Iy |< At,

    FACiL                     `adj`     {- <bA.tin> -}         [ ['i','n','n','e','r'], ['h','i','d','d','e','n'] ]
                              `plural`     FawACiL,

    FACiL |< Iy               `adj`     {- <bA.tinIy> -}       [ ['i','n','t','e','r','i','o','r'], ['i','n','t','e','r','n','a','l'] ],

    MaFCUL                    `adj`     {- <mab.tUn> -}        [ ['i','n','d','i','s','p','o','s','e','d'] ],

    MuFaCCaL                  `adj`     {- <muba.t.tan> -}     [ ['l','i','n','e','d'], ['f','i','l','l','e','d'] ],

    IstiFCAL                  `noun`    {- <istib.tAn> -}      [ ['i','n','t','r','o','s','p','e','c','t','i','o','n'] ]
                              `plural`     IstiFCAL |< At,

    IstiFCAL |< Iy            `adj`     {- <istib.tAnIy> -}    [ ['i','n','t','r','o','s','p','e','c','t','i','v','e'] ] ]
...
cluster_111 = cluster
 ...
 |> "b .t s" <| [
    ...
    FaCACiL                   `noun`    {- <ba.tA.tis> -}      [ ['p','o','t','a','t','o','e','s'] ] ]
...
cluster_112 = cluster
 ...
 |> "bu.trus" <| [
    ...
    _____ |< Iy               `adj`     {- <bu.trusIy> -}      [ unwords [ ['S','t','.'], ['P','e','t','e','r'] ] ],

    _____                     `noun`    {- <bu.trus> -}        [ ['P','e','t','e','r'] ],

    _____                     `noun`    {- <bu.trus> -}        [ ['B','o','u','t','r','o','s'] ] ]
...
cluster_113 = cluster
 ...
 |> "b .t r q" <| [
    ...
    KiRDIS                    `noun`    {- <bi.trIq> -}        [ ['p','a','t','r','i','c','i','a','n'], ['p','e','n','g','u','i','n'] ]
                              `plural`     KaRADIS
                              `plural`     KaRADiS |< aT ]
...
cluster_114 = cluster
 ...
 |> "b .t r k" <| [
    ...
    KaRDaS                    `noun`    {- <ba.trak> -}        [ ['P','a','t','r','i','a','r','c','h'] ]
                              `plural`     KaRADiS |< aT,

    KaRDIS                    `noun`    {- <ba.trIk> -}        [ ['P','a','t','r','i','a','r','c','h'] ]
                              `plural`     KaRADiS |< aT,

    KaRDaS |< Iy |< aT        `noun`    {- <ba.trakIyaT> -}    [ ['p','a','t','r','i','a','r','c','h','a','t','e'] ],

    KaRDaS |< aT              `noun`    {- <ba.trakaT> -}      [ ['p','a','t','r','i','a','r','c','h','a','t','e'] ] ]
...
cluster_115 = cluster
 ...
 |> "b .t r _h" <| [
    ...
    KaRDaS                    `noun`    {- <ba.tra_h> -}       [ ['r','o','e'], ['c','a','v','i','a','r'] ]
                              `plural`     KaRADiS ]
...
cluster_116 = cluster
 ...
 |> "ba.t.tAr" <| [
    ...
    _____ |< Iy |< aT         `noun`    {- <ba.t.tArIyaT> -}   [ ['b','a','t','t','e','r','y'] ]
                              `plural`     _____ |< Iy |< At ]
 ...
 |> "b .t r" <| [
    ...
    FaCiL                     `verb`    {- <ba.tir> -}         [ unwords [ ['b','e'], ['w','i','l','d'] ], unwords [ ['b','e'], ['v','a','i','n'] ] ]
                              `imperf`     FCaL,

    FaCiL                     `verb`    {- <ba.tir> -}         [ ['d','i','s','r','e','g','a','r','d'], ['d','i','s','d','a','i','n'] ]
                              `imperf`     FCaL,

    HaFCaL                    `verb`    {- <'ab.tar> -}        [ unwords [ ['m','a','k','e'], ['v','a','i','n'] ], unwords [ ['m','a','k','e'], ['p','r','o','u','d'] ] ],
...
cluster_117 = cluster
 ...
 |> "b .t q" <| [
    ...
    FiCAL |< aT               `noun`    {- <bi.tAqaT> -}       [ ['c','a','r','d'], ['t','a','g'], ['b','a','l','l','o','t'] ]
                              `plural`     FiCAL |< At
                              `plural`     FaCA'iL ]
...
cluster_122 = cluster
 ...
 |> "b .z r" <| [
    ...
    FaCL                      `noun`    {- <ba.zr> -}          [ ['c','l','i','t','o','r','i','s'] ]
                              `plural`     FuCUL ]
...
cluster_129 = cluster
 ...
 |> "b ^s k r" <| [
    ...
    KaRDUS                    `noun`    {- <ba^skUr> -}        [ unwords [ ['f','i','r','e'], ['i','r','o','n'] ] ]
                              `plural`     KaRADIS ]
...
cluster_130 = cluster
 ...
 |> "b ^s k" <| [
    ...
    FACaL                     `noun`    {- <bA^sak> -}         [ unwords [ ['s','p','a','r','r','o','w'], ['h','a','w','k'] ] ],
...
cluster_134 = cluster
 ...
 |> "b ^s m r" <| [
    ...
    KaRADiS |< Iy             `adj`     {- <ba^sAmirIy> -}     [ ['l','a','c','e','w','o','r','k','e','r'] ] ]
...
cluster_135 = cluster
 ...
 |> "b ^s r " <| [
    ...
    MuFACaL |< aT |<< "aN"    `adv`     {- <mubA^saraTaN> -}   [ ['d','i','r','e','c','t','l','y'], ['i','m','m','e','d','i','a','t','e','l','y'] ],
...
cluster_146 = cluster
 ...
 |> "b _h s" <| [
    ...
    HaFCaL                    `noun`    {- <'ab_has> -}        [ ['s','m','a','l','l','e','r'], ['l','o','w','e','r'] ],
...
cluster_147 = cluster
 ...
 |> "b _h r" <| [
    ...
    FaCCaL                    `verb`    {- <ba_h_har> -}       [ ['f','u','m','i','g','a','t','e'], unwords [ ['b','u','r','n'], ['i','n','c','e','n','s','e'] ], ['v','a','p','o','r','i','z','e'], unwords [ ['b','e'], ['b','u','r','n','e','d'], "(", ['i','n','c','e','n','s','e'], ")" ] ],
...
cluster_151 = cluster
 ...
 |> "b ` ^g" <| [
    ...
    FaCaL                     `verb`    {- <ba`a^g> -}         [ ['d','i','s','e','m','b','o','w','e','l'], ['d','e','n','t'] ]
                              `imperf`     FCaL,

    TaFaCCaL                  `verb`    {- <taba``a^g> -}      [ ['c','r','a','c','k'], ['b','u','r','s','t'] ],

    InFaCaL                   `verb`    {- <inba`a^g> -}       [ ['c','r','a','c','k'], ['b','u','r','s','t'] ],

    MunFaCiL                  `adj`     {- <munba`i^g> -}      [ ['c','r','a','c','k','i','n','g'], ['b','u','r','s','t','i','n','g'] ],

    MaFCUL                    `adj`     {- <mab`U^g> -}        [ ['d','i','s','e','m','b','o','w','e','l','e','d'] ] ]
...
cluster_152 = cluster
 ...
 |> "b ` .d" <| [
    ...
    FaCCaL                    `verb`    {- <ba``a.d> -}        [ ['d','i','v','i','d','e'], ['p','o','r','t','i','o','n'], unwords [ ['b','e'], ['a','p','p','o','r','t','i','o','n','e','d'] ] ],

    TaFaCCaL                  `verb`    {- <taba``a.d> -}      [ unwords [ ['b','e'], ['d','i','v','i','d','e','d'] ], unwords [ ['b','e'], ['p','o','r','t','i','o','n','e','d'] ] ],
    ...
    TaFCIL |< Iy              `adj`     {- <tab`I.dIy> -}      [ ['d','i','v','i','s','i','v','e'] ],

    MaFCUL                    `noun`    {- <mab`U.d> -}        [ unwords [ ['m','o','s','q','u','i','t','o'], "-", ['i','n','f','e','s','t','e','d'] ] ] ]
...
cluster_154 = cluster
 ...
 |> "b ` _t" <| [
    ...
    FaCL                      `noun`    {- <ba`_t> -}          [ ['B','a','a','t','h'] ],

    FaCL                      `noun`    {- <ba`_t> -}          [ ['d','e','l','e','g','a','t','i','o','n'] ]
                              `plural`     FuCUL,

    FaCL |< Iy                `adj`     {- <ba`_tIy> -}        [ ['B','a','a','t','h','i','s','t'] ],

    FaCL |< Iy                `noun`    {- <ba`_tIy> -}        [ ['B','a','a','t','h','i','s','t'] ]
                              `plural`     FaCL |< Iy |< Un
                           
    `derives` otherwise,

    FaCL |< aT                `noun`    {- <ba`_taT> -}        [ ['d','e','l','e','g','a','t','i','o','n'], ['m','i','s','s','i','o','n'] ]
                              `plural`     FaCaL |< At,

    FACUL                     `noun`    {- <bA`U_t> -}         [ ['E','a','s','t','e','r'] ],

    MaFCaL                    `noun`    {- <mab`a_t> -}        [ ['c','a','u','s','e'], ['f','a','c','t','o','r'] ]
                              `plural`     MaFACiL,

    FACiL                     `noun`    {- <bA`i_t> -}         [ ['s','e','n','d','i','n','g'], ['s','e','n','d','e','r'] ]
                              `plural`     FACiL |< Un
                           
    `derives` otherwise,

    FACiL                     `noun`    {- <bA`i_t> -}         [ ['i','n','c','e','n','t','i','v','e'], ['m','o','t','i','v','e'] ]
                              `plural`     FawACiL,

    MaFCUL                    `noun`    {- <mab`U_t> -}        [ ['e','n','v','o','y'], ['r','e','p','r','e','s','e','n','t','a','t','i','v','e'] ]
                              `plural`     MaFCUL |< Un
                           
    `derives` otherwise,

    MunFaCaL                  `adj`     {- <munba`a_t> -}      [ ['s','e','n','t'] ],

    MunFaCaL                  `noun`    {- <munba`a_t> -}      [ ['s','o','u','r','c','e'] ]
                              `plural`     MunFaCaL |< At,

    InFiCAL                   `noun`    {- <inbi`A_t> -}       [ ['r','e','v','i','v','a','l'], ['r','e','s','u','r','r','e','c','t','i','o','n'] ]
                              `plural`     InFiCAL |< At,

    MunFaCiL                  `adj`     {- <munba`i_t> -}      [ ['r','e','s','u','r','g','e','n','t'] ] ]
...
cluster_155 = cluster
 ...
 |> "b ` b `" <| [
    ...
    KuRDuS                    `noun`    {- <bu`bu`> -}         [ ['m','o','n','s','t','e','r'], ['s','p','e','c','t','e','r'] ]
                              `plural`     KaRADiS ]
...
cluster_156 = cluster
 ...
 |> "b ` _t r" <| [
    ...
    KaRDaS                    `verb`    {- <ba`_tar> -}        [ ['s','c','a','t','t','e','r'], ['d','i','s','p','e','r','s','e'] ],

    TaKaRDaS                  `verb`    {- <taba`_tar> -}      [ unwords [ ['b','e'], ['s','c','a','t','t','e','r','e','d'] ], unwords [ ['b','e'], ['d','i','s','p','e','r','s','e','d'] ] ],

    MuKaRDaS                  `adj`     {- <muba`_tar> -}      [ ['s','c','a','t','t','e','r','e','d'], ['d','i','s','p','e','r','s','e','d'] ],

    TaKaRDuS                  `noun`    {- <taba`_tur> -}      [ ['s','c','a','t','t','e','r','i','n','g'], ['d','i','s','p','e','r','s','a','l'] ]
                              `plural`     TaKaRDuS |< At ]
...
cluster_157 = cluster
 ...
 |> "b ` d" <| [
    ...
    HaFCaL                    `verb`    {- <'ab`ad> -}         [ ['r','e','m','o','v','e'], ['e','x','p','e','l'] ],

    TaFACaL                   `verb`    {- <tabA`ad> -}        [ ['d','i','v','e','r','g','e'], ['s','e','p','a','r','a','t','e'] ],

    IFtaCaL                   `verb`    {- <ibta`ad> -}        [ unwords [ ['m','o','v','e'], ['a','w','a','y'] ], ['e','s','c','h','e','w'] ],

    IstaFCaL                  `verb`    {- <istab`ad> -}       [ unwords [ ['r','u','l','e'], ['o','u','t'] ], ['r','e','j','e','c','t'] ],

    FuCL                      `noun`    {- <bu`d> -}           [ ['d','i','m','e','n','s','i','o','n'], ['d','i','s','t','a','n','c','e'] ]
                              `plural`     HaFCAL,

    FaCIL                     `adj`     {- <ba`Id> -}          [ ['r','e','m','o','t','e'], ['d','i','s','t','a','n','t'], ['f','a','r'] ]
                              `plural`     FaCIL |< Un
                              `plural`     FuCaLA',

    FuCayL |<< "a"            `prep`    {- <bu`ayda> -}        [ unwords [ ['s','h','o','r','t','l','y'], ['a','f','t','e','r'] ], unwords [ ['s','o','o','n'], ['a','f','t','e','r'] ] ],

    HaFCaL                    `adj`     {- <'ab`ad> -}         [ ['f','a','r','t','h','e','r'], ['f','a','r','t','h','e','s','t'] ],

    HaFACiL                   `noun`    {- <'abA`id> -}        [ ['f','a','r','t','h','e','r'], ['f','a','r','t','h','e','s','t'] ],

    HaFCAL |< Iy |< aT        `noun`    {- <'ab`AdIyaT> -}     [ unwords [ ['c','o','u','n','t','r','y'], ['e','s','t','a','t','e'] ] ],

    FiCAL                     `noun`    {- <bi`Ad> -}          [ ['d','i','s','t','a','n','c','e'] ],

    TaFCIL                    `noun`    {- <tab`Id> -}         [ ['b','a','n','i','s','h','m','e','n','t'] ]
                              `plural`     TaFCIL |< At,

    MuFACaL |< aT             `noun`    {- <mubA`adaT> -}      [ ['a','l','i','e','n','a','t','i','o','n'], unwords [ ['s','o','w','i','n','g'], ['d','i','s','s','e','n','t'] ] ],

    HiFCAL                    `noun`    {- <'ib`Ad> -}         [ ['d','e','p','o','r','t','a','t','i','o','n'], ['e','x','i','l','e'], ['r','e','m','o','v','a','l'] ]
                              `plural`     HiFCAL |< At,

    TaFACuL                   `noun`    {- <tabA`ud> -}        [ ['e','s','t','r','a','n','g','e','m','e','n','t'] ]
                              `plural`     TaFACuL |< At,

    IFtiCAL                   `noun`    {- <ibti`Ad> -}        [ ['a','v','o','i','d','i','n','g'], ['e','s','c','h','e','w','i','n','g'] ]
                              `plural`     IFtiCAL |< At,

    IstiFCAL                  `noun`    {- <istib`Ad> -}       [ unwords [ ['r','u','l','i','n','g'], ['o','u','t'] ], ['d','i','s','t','a','n','c','i','n','g'] ]
                              `plural`     IstiFCAL |< At,

    MuFCaL                    `adj`     {- <mub`ad> -}         [ ['d','e','p','o','r','t','e','d'], ['d','e','p','o','r','t','e','e'] ],

    MutaFACiL                 `adj`     {- <mutabA`id> -}      [ ['s','e','p','a','r','a','t','e'], ['i','n','f','r','e','q','u','e','n','t'] ],

    MustaFCaL                 `adj`     {- <mustab`ad> -}      [ ['i','m','p','r','o','b','a','b','l','e'], ['u','n','l','i','k','e','l','y'] ],

    MaFCaL |< aT              `noun`    {- <mab`adaT> -}       [ ['d','i','s','t','a','n','c','e'], ['r','e','m','o','t','e','n','e','s','s'] ] ]
...
cluster_158 = cluster
 ...
 |> "b ` z q" <| [
    ...
    KaRDaS                    `verb`    {- <ba`zaq> -}         [ ['s','c','a','t','t','e','r'], ['s','q','u','a','n','d','e','r'] ],

    KaRDaS |< aT              `noun`    {- <ba`zaqaT> -}       [ ['s','c','a','t','t','e','r','i','n','g'], ['s','q','u','a','n','d','e','r','i','n','g'] ],

    MuKaRDiS                  `noun`    {- <muba`ziq> -}       [ ['s','q','u','a','n','d','e','r','e','r'], ['s','p','e','n','d','t','h','r','i','f','t'] ]
                              `plural`     MuKaRDiS |< Un
...
cluster_159 = cluster
 ...
 |> "b ` r" <| [
    ...
    FaCL                      `noun`    {- <ba`r> -}           [ ['d','u','n','g'], ['d','r','o','p','p','i','n','g','s'] ]
                              `plural`     HaFCAL ]
...
cluster_160 = cluster
 ...
 |> "b ` q" <| [
    ...
    FaCaL                     `verb`    {- <ba`aq> -}          [ ['i','r','r','i','g','a','t','e'], ['w','a','t','e','r'] ]
                              `imperf`     FCuL,

    InFaCaL                   `verb`    {- <inba`aq> -}        [ ['s','p','r','i','n','k','l','e'] ] ]
...
cluster_161 = cluster
 ...
 |> "b ` l" <| [
    ...
    FaCL                      `noun`    {- <ba`l> -}           [ ['h','u','s','b','a','n','d'] ]
                              `plural`     FuCUL |< aT
                              `plural`     FiCAL,

    FaCL                      `noun`    {- <ba`l> -}           [ ['B','a','a','l'] ],

    FaCL |< aT                `noun`    {- <ba`laT> -}         [ ['w','i','f','e'] ]
                              `plural`     FaCaL |< At,

    FaCL |< Iy                `adj`     {- <ba`lIy> -}         [ ['u','n','i','r','r','i','g','a','t','e','d'] ] ]
...
cluster_163 = cluster
 ...
 |> "b d h" <| [
    ...
    FaCAL |< aT |<< "aN"      `adv`     {- <badAhaTaN> -}      [ ['s','p','o','n','t','a','n','e','o','u','s','l','y'] ],
...
cluster_169 = cluster
 ...
 |> "b d r" <| [
    ...
    FiCAL |<< "aN"            `adv`     {- <bidAraN> -}        [ ['q','u','i','c','k','l','y'], ['h','a','s','t','i','l','y'] ],
