...
module Elixir.Data.Moony.Foreign.G (section) where
...
cluster_30  = cluster
 ...
 |> ['^','g','A','t','U','r','A','b','A','t','A','r','A','b','U','n','.','g'] <| [
...
cluster_32  = cluster
 ...
 |> ['^','g','A','d','-','a','l','-','l','_','a','h'] <| [
    ...
    _____                     `zero`    {- <^gAd-al-l_ah> -}   [ ['J','a','d','a','l','l','a','h'], ['G','a','d','a','l','l','a','h'] ] ]
...
cluster_35  = cluster
 ...
 |> ['^','g','A','r','-','a','l','-','l','_','a','h'] <| [
    ...
    _____                     `zero`    {- <^gAr-al-l_ah> -}   [ ['J','a','r','a','l','l','a','h'] ] ]
...
cluster_48  = cluster
 ...
 |> ['^','g','U','z','I','f'] <| [
    ...
    _____ |<< "A"             `xtra`    {- <^gUzIfA> -}        [ ['J','o','s','e','f','a'] ] ]
...
cluster_72  = cluster
 ...
 |> ['^','g','I','l','b','i','r','t'] <| [
    ...
    _____ |<< "U"             `xtra`    {- <^gIlbirtU> -}      [ ['G','i','l','b','e','r','t','o'] ] ]
