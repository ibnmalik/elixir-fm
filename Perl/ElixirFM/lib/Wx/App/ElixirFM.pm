...
sub resolve {
    ...
    return Exec::ElixirFM::elixir 'resolve', ['--lists'], @_;
}
...
sub GONOW {
    ...
    my $data = resolve decode "buckwalter", $text->GetValue();

    $html->SetPage("<pre>" . (Wx::App::ElixirFM::escape $data) . "</pre>");
